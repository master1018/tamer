public class UnitTest {
    ...
    public UnitTest(SortedSet ss) { } 
    @ArrayTypesWithDefault ( )
    public UnitTest(SortedMap sm) { } 
    @ArrayTypesWithDefault (
        b =    1,
        s =    2,
        i =    3,
    ...
    public UnitTest(RandomAccess r) { } 
    @Marker public UnitTest() { } 
