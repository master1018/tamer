public abstract class ClassSyntax {
    public interface GetCPIndex {
        int getCPIndex(int tag, String name);  
    }
    ...
    static {
        ...
        at.put("Class.EnclosingMethod", "<EnclosingMethod><class=>RCH<desc=>RDH");
    ...
    protected Element cpool;          
    protected Element klass;          
    protected Element currentMember;  
    protected Element currentCode;    
}
