public class MediaNames {
    ...
    public static final String VIDEO_HTTP3GP = "http:
    public static final String VIDEO_RTSP3GP = "rtsp:
    public static final String VIDEO_RTSP3GP2 = "rtsp:
  ...
  public static final String TEST_PATH_5 = "mem:
