public class Resources_it extends java.util.ListResourceBundle {
    private static final Object[][] contents = {
        ...
        {"Generates.certificate.from.a.certificate.request",
                "Genera un certificato da una richiesta di certificato"}, 
        {"Generates.CRL", "Genera CRL"}, 
        {"Imports.entries.from.a.JDK.1.1.x.style.identity.database",
                "Importa le voci da un database delle identit\u00E0 di tipo JDK 1.1.x"}, 
        {"Imports.a.certificate.or.a.certificate.chain",
                "Importa un certificato o una catena di certificati"}, 
        {"Imports.one.or.all.entries.from.another.keystore",
                "Importa una o tutte le voci da un altro keystore"}, 
        {"Clones.a.key.entry",
                "Duplica una voce di chiave"}, 
        {"Changes.the.key.password.of.an.entry",
                "Modifica la password della chiave per una voce"}, 
        {"Lists.entries.in.a.keystore",
                "Elenca le voci in un keystore"}, 
        {"Prints.the.content.of.a.certificate",
                "Visualizza i contenuti di un certificato"}, 
        {"Prints.the.content.of.a.certificate.request",
                "Visualizza i contenuti di una richiesta di certificato"}, 
        {"Prints.the.content.of.a.CRL.file",
                "Visualizza i contenuti di un file CRL"}, 
        {"Generates.a.self.signed.certificate",
                "Genera certificato con firma automatica"}, 
        {"Changes.the.store.password.of.a.keystore",
                "Modifica la password di area di memorizzazione di un keystore"}, 
        {"alias.name.of.the.entry.to.process",
                "nome alias della voce da elaborare"}, 
        {"destination.alias",
                "alias di destinazione"}, 
        {"destination.key.password",
                "password chiave di destinazione"}, 
        {"destination.keystore.name",
                "nome keystore di destinazione"}, 
        {"destination.keystore.password.protected",
                "password keystore di destinazione protetta"}, 
        {"destination.keystore.provider.name",
                "nome provider keystore di destinazione"}, 
        {"destination.keystore.password",
                "password keystore di destinazione"}, 
        {"destination.keystore.type",
                "tipo keystore di destinazione"}, 
        {"distinguished.name",
                "nome distinto"}, 
        {"X.509.extension",
                "estensione X.509"}, 
        ...
        {"input.file.name",
                "nome file di input"}, 
        {"key.algorithm.name",
                "nome algoritmo chiave"}, 
        {"key.password",
                "password chiave"}, 
        {"key.bit.size",
                "dimensione bit chiave"}, 
        {"keystore.name",
                "nome keystore"}, 
        {"new.password",
                "nuova password"}, 
        ...
        {"password.through.protected.mechanism",
                "password mediante meccanismo protetto"}, 
        {"provider.argument",
                "argomento provider"}, 
        {"provider.class.name",
                "nome classe provider"}, 
        {"provider.name",
                "nome provider"}, 
        {"provider.classpath",
                "classpath provider"}, 
        ...
        {"signature.algorithm.name",
                "nome algoritmo firma"}, 
        {"source.alias",
                "alias origine"}, 
        {"source.key.password",
                "password chiave di origine"}, 
        {"source.keystore.name",
                "nome keystore di origine"}, 
        {"source.keystore.password.protected",
                "password keystore di origine protetta"}, 
        {"source.keystore.provider.name",
                "nome provider keystore di origine"}, 
        {"source.keystore.password",
                "password keystore di origine"}, 
        {"source.keystore.type",
                "tipo keystore di origine"}, 
        {"SSL.server.host.and.port",
                "host e porta server SSL"}, 
        {"signed.jar.file",
                "file jar firmato"}, 
        {"certificate.validity.start.date.time",
                "data/ora di inizio validit\u00E0 certificato"}, 
        {"keystore.password",
                "password keystore"}, 
        {"keystore.type",
                "tipo keystore"}, 
        {"trust.certificates.from.cacerts",
                "considera sicuri i certificati da cacerts"}, 
        {"verbose.output",
                "output descrittivo"}, 
        {"validity.number.of.days",
                "numero di giorni di validit\u00E0"}, 
        {"Serial.ID.of.cert.to.revoke",
                 "ID seriale del certificato da revocare"}, 
