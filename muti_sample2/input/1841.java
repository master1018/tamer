public class test {
    public void play() {
        ...
        try {
            ...
            org.w3c.dom.Element e = doc.createElementNS("http:
            e.setAttribute("xmlns", "http:
            e.setAttribute("version", "1");
            doc.appendChild(e);
            if (frame.getData() != null) {
                org.w3c.dom.Element d = (org.w3c.dom.Element) e.appendChild(doc.createElementNS("http:
