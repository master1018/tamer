        ...
        try {
            ...
            if (action.equals("test")) {
                ...
                for (int i = 0; i < numbertoexport; i++) {
                    ...
                    rssWriter.setImagelink("http:
                    rssWriter.setAbout("http:
                ...
                if (spectra.size() == 0) {
                    ...
                    for (int k = 0; k < spectra.size(); k++) {
                        ...
                        ((Element) spectrumel).setNamespaceURI("http:
                    }
                ...
                for (int i = 0; i < v.size(); i++) {
                    if (i % 500 == 0) {
                        ...
                        zipout.write(new String("<html><body><h1>This is a list of strcutures in <a href=\"http:
                    }
