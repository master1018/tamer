public class test {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            HttpPut createLayerPut = new HttpPut(String.format("http:
            ...
            HttpPost createStylePost = new HttpPost("http:
            ...
            HttpPut uploadSldPut = new HttpPut(String.format("http:
            ...
            HttpPut setDefaultStylePut = new HttpPut(String.format("http:
