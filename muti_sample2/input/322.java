public class test {
    ...
    public String encrypt(String did, String username, String password, String input, boolean uniquekey, String algorithm, int keysize) throws SkceWSException {
        ...
        try {
            ...
            if (DEFAULT_DIGEST.equalsIgnoreCase("http:
                digest = MessageDigest.getInstance("SHA-256");
            } else if (DEFAULT_DIGEST.equalsIgnoreCase("http:
            ...
            root.setAttribute("xsi:schemaLocation", "http:
            root.setAttribute("xmlns:xenc", "http:
            root.setAttribute("xmlns:ds", "http:
            root.setAttribute("xmlns:skles", "http:
