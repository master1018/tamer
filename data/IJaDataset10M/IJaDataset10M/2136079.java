...
public class IPhoneRoute {
    ...
    private static final Logger logger = Logger.getLogger(IPhoneRoute.class.getName());
    ...
    public void exportToFile(ArrayList<String> days) {
        ...
        try {
            ...
            for (String day : days) {
                ...
                for (int i = 0; i < locations.size(); i++) {
                    ...
                    bufferedWriter.write("    <name>" + location.getFullDateString() + " [" + (i + 1) + "/" + locations.size() + "]</name>\n");
            ...
            for (String day : days) {
                ...
                bufferedWriter.write("      <![CDATA[" + day + " (" + locations.size() + "points)]]>\n");
                bufferedWriter.write("    </description>\n");
        ...
        JOptionPane.showMessageDialog(null, "Exporting " + days.size() + " day(s)" + " of data to '" + filename + "' was " + (exported ? "successful!" : "unsuccessful!"));
    }
