...
class TextToTransitionCriteria implements Converter {
    ...
    public Object convertSourceToTargetClass(Object source, Class targetClass) throws Exception {
        ...
        if (!StringUtils.hasText(encodedCriteria) || WildcardTransitionCriteria.WILDCARD_EVENT_ID.equals(encodedCriteria)) {
    ...
    protected TransitionCriteria createBooleanExpressionTransitionCriteria(String encodedCriteria, ExpressionParser parser) throws ConversionExecutionException {
        Expression expression = parser.parseExpression(encodedCriteria, new FluentParserContext().template().evaluate(RequestContext.class));
