...
class BluetoothEmulator implements BluetoothStack {
    ...
    public int searchServices(int[] attrSet, UUID[] uuidSet, RemoteDevice device, DiscoveryListener listener) throws BluetoothStateException {
        return SearchServicesThread.startSearchServices(this, new EmulatorSearchServices(activeLocalDevice(), this), attrSet, uuidSet, device, listener);
    }
    ...
    public boolean populateServicesRecordAttributeValues(ServiceRecordImpl serviceRecord, int[] attrIDs) throws IOException {
        ...
        return EmulatorSearchServices.populateServicesRecordAttributeValues(activeLocalDevice(), serviceRecord, attrIDs, RemoteDeviceHelper.getAddress(serviceRecord.getHostDevice()), serviceRecord.getHandle());
    }
    ...
    public long rfServerAcceptAndOpenRfServerConnection(long handle) throws IOException {
        ...
        while (!success) {
            ...
            try {
                long remoteAddress = localDevice.getDeviceManagerService().getRemoteAddress(localDevice.getAddress(), connectionHandle);
