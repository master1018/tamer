package com.acv.dao.catalog.products.deliveries.model;
...
/**
 * {@link DeliveryI18n} specific i18n model class. This class extends {@link GenericI18n} class
 * and so implements the {@link Map} interface.
 *
 * @author Mickael Guesnon
 * @hibernate.class table="DELIVERY_I18N" lazy = "true" mutable = "false"
 * @hibernate.cache usage = "read-only"
 * @hibernate.composite-id unsaved-value="none"
 */
public class DeliveryI18n extends GenericI18n {
    ...
    public boolean equals(Object obj) {
        ...
        if (HibernateProxyHelper.getClassWithoutInitializingProxy(obj).equals(HibernateProxyHelper.getClassWithoutInitializingProxy(this))) {
            final DeliveryI18n other = (DeliveryI18n) obj;
