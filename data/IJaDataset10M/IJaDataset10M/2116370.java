...
public class MetaContactChatTransport implements ChatTransport, ContactPresenceStatusListener {
    ...
    public MetaContactChatTransport(ChatSession chatSession, Contact contact) {
        this.parentChatSession = chatSession;
        this.contact = contact;
        presenceOpSet = (OperationSetPresence) contact.getProtocolProvider().getOperationSet(OperationSetPresence.class);
    ...
    public boolean allowsInstantMessage() {
        Object imOpSet = contact.getProtocolProvider().getOperationSet(OperationSetBasicInstantMessaging.class);
        if (imOpSet != null) return true; else return false;
    }
    ...
    public boolean allowsSmsMessage() {
        Object smsOpSet = contact.getProtocolProvider().getOperationSet(OperationSetSmsMessaging.class);
        if (smsOpSet != null) return true; else return false;
    }
    ...
    public boolean allowsTypingNotifications() {
        ...
        if (tnOpSet != null) return true; else return false;
    }
    ...
    public int sendTypingNotification(int typingState) {
        ...
        OperationSetTypingNotifications tnOperationSet = (OperationSetTypingNotifications) contact.getProtocolProvider().getOperationSet(OperationSetTypingNotifications.class);
    ...
    public void contactPresenceStatusChanged(ContactPresenceStatusChangeEvent evt) {
        ...
        if (sourceContact.equals(contact) && (evt.getOldStatus() != evt.getNewStatus())) {
