...
public class JavaHTMLizer {
    ...
    private static final String[] RESERVED_WORDS = new String[] { "return", "new", "public", "static", "final", "void", "synchronized", "class", "enum", "private", "protected", "import", "package", "try", "catch", "finally", "for", "while", "switch", "case", "byte", "short", "int", "long", "float", "double", "boolean", "extends", "implements", "super", "true", "false", "this" };
