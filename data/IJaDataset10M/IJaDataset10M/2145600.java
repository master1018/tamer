 ...
 *       &lt;group ref="{http://www.imsglobal.org/xsd/imsqti_v2p0}responseIf.ContentGroup"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "responseIf.Type", propOrder = { "and", "gt", "ordered", "divide", "customOperator", "random", "substring", "variable", "equalRounded", "integerToFloat", "_null", "index", "integerDivide", "gte", "durationLT", "contains", "member", "lt", "correct", "match", "product", "multiple", "power", "mapResponsePoint", "mapResponse", "randomFloat", "stringMatch", "not", "integerModulus", "subtract", "durationGTE", "anyN", "round", "baseValue", "_default", "inside", "equal", "fieldValue", "randomInteger", "isNull", "patternMatch", "lte", "sum", "truncate", "or", "delete", "responseRuleElementGroup" })
public class ResponseIfType {
    ...
    @XmlElements({ @XmlElement(name = "exitResponse", type = ExitResponseType.class), @XmlElement(name = "responseCondition", type = ResponseConditionType.class), @XmlElement(name = "setOutcomeValue", type = SetOutcomeValueType.class) })
