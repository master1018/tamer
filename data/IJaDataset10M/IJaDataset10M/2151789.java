package hub.metrik.lang.petri.debugger.edit.policies;

import hub.metrik.lang.petri.Place;
import hub.metrik.lang.petri.Transition;
import hub.metrik.lang.petri.debugger.edit.helpers.PetriBaseEditHelper;
import hub.metrik.lang.petri.debugger.part.PetriVisualIDRegistry;
 ...
 * @generated
 */
public class PetriBaseItemSemanticEditPolicy extends SemanticEditPolicy {
    ...
    public Command getCommand(Request request) {
        if (request instanceof ReconnectRequest) {
            ...
            if (view instanceof View) {
                Integer id = new Integer(PetriVisualIDRegistry.getVisualID((View) view));
    ...
    protected Command getSemanticCommand(IEditCommandRequest request) {
        ...
        if (semanticCommand != null) {
            ...
            completedRequest.setParameter(PetriBaseEditHelper.EDIT_POLICY_COMMAND, command);
        }
        if (elementType != null) {
    ...
    public static class LinkConstraints {
		 ...
		 * @generated
		 */
        public static boolean canCreateTransitionSnk_3001(Transition source, Place target) {
            if (source != null) {
                if (source.getSnk().contains(target)) {
                    return false;
                }
            }
            return canExistTransitionSnk_3001(source, target);
        }

        /**
		 * @generated
		 */
        public static boolean canCreatePlaceSnk_3002(Place source, Transition target) {
            if (source != null) {
                if (source.getSnk().contains(target)) {
                    return false;
                }
            }
            return canExistPlaceSnk_3002(source, target);
        }

        /**
		 * @generated
		 */
        public static boolean canExistTransitionSnk_3001(Transition source, Place target) {
            return true;
        }
		 ...
		 * @generated
		 */
        public static boolean canExistPlaceSnk_3002(Place source, Transition target) {
            return true;
        }
    }
}
