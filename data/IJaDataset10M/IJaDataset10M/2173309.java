package kr.ac.ssu.imc.durubi.report.designer.workbench.effect;
...
public class DRPopupButton extends JButton implements MouseListener, PopupMenuListener {

    private Component invoker;

    private JPopupMenu menu;

    private Vector<Object> vectorItems;
    ...
    public DRPopupButton(ImageIcon icon, Component invoker) {
        super(icon);
    ...
    public void addItems(Object[] items) {
        ...
        if (vectorItems == null) vectorItems = new Vector<Object>(length, 1);
    ...
    public void addItem(Object anObject) {
        if (vectorItems == null) vectorItems = new Vector<Object>(1, 1);
