...
public final class Log {
    ...
    public static void setLoggerFactory(final LoggerFactory loggerFactory) throws IllegalArgumentException {
        synchronized (LOG_REGISTRY) {
            ...
            for (final Entry<String, Log> entry : LOG_REGISTRY.entrySet()) entry.getValue().setLogger(loggerFactory.createLogger(entry.getKey()));
        }
    }
    ...
    public void debug(final String msgFormat, final Object arg1) {
        if (logger.isDebug()) logger.debug(StringUtils.replaceAll(msgFormat, "{1}", arg1 == null ? "null" : arg1.toString()));
    }
    ...
    public void debug(final String msgFormat, final Object arg1, final Throwable t) {
        if (logger.isDebug()) logger.debug(StringUtils.replaceAll(msgFormat, "{1}", arg1 == null ? "null" : arg1.toString()), t);
    }
    ...
    public void error(final String msgFormat, final Object arg1) {
        if (logger.isError()) logger.error(StringUtils.replaceAll(msgFormat, "{1}", arg1 == null ? "null" : arg1.toString()));
    }
    ...
    public void error(final String msgFormat, final Object arg1, final Throwable t) {
        if (logger.isError()) logger.error(StringUtils.replaceAll(msgFormat, "{1}", arg1 == null ? "null" : arg1.toString()), t);
    }
    ...
    public void info(final String msgFormat, final Object arg1) {
        if (logger.isInfo()) logger.info(StringUtils.replaceAll(msgFormat, "{1}", arg1 == null ? "null" : arg1.toString()));
    }
    ...
    public void info(final String msgFormat, final Object arg1, final Throwable t) {
        if (logger.isInfo()) logger.info(StringUtils.replaceAll(msgFormat, "{1}", arg1 == null ? "null" : arg1.toString()), t);
    }
    ...
    public void trace(final String msgFormat, final Object arg1) {
        if (logger.isDebug()) logger.trace(StringUtils.replaceAll(msgFormat, "{1}", arg1 == null ? "null" : arg1.toString()));
    }
    ...
    public void trace(final String msgFormat, final Object arg1, final Throwable t) {
        if (logger.isDebug()) logger.trace(StringUtils.replaceAll(msgFormat, "{1}", arg1 == null ? "null" : arg1.toString()), t);
    }
    ...
    public void warn(final String msgFormat, final Object arg1) {
        if (logger.isWarn()) logger.warn(StringUtils.replaceAll(msgFormat, "{1}", arg1 == null ? "null" : arg1.toString()));
    }
    ...
    public void warn(final String msgFormat, final Object arg1, final Throwable t) {
        if (logger.isWarn()) logger.warn(StringUtils.replaceAll(msgFormat, "{1}", arg1 == null ? "null" : arg1.toString()), t);
    }
