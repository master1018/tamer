...
public abstract class UnitStatusFormatter {
    ...
    public static String format(Entity e) {
        ...
        sb.append("--- Armor: ").append(e.getTotalArmor()).append("/").append(e.getTotalOArmor()).append("-------------------------------------------").append(CommonConstants.NL);
        sb.append("--- Internal: ").append(e.getTotalInternal()).append("/").append(e.getTotalOInternal()).append("----------------------------------------").append(CommonConstants.NL);
    ...
    private static String formatHeader(Entity e) {
        ...
        sb.append("Model: ").append(e.getChassis()).append(" - ").append(e.getModel()).append(CommonConstants.NL);
    ...
    private static String formatAmmo(Entity e) {
        ...
        for (Mounted ammo : e.getAmmo()) {
            ...
            sb.append(": ").append(ammo.getShotsLeft()).append(CommonConstants.NL);
        }
        return sb.toString();
    }
        ...
        for (int x = 0; x < e.locations(); x++) {
            ...
            for (int y = 0; y < e.getNumberOfCriticals(x); y++) {
                ...
                if (cs.getType() == CriticalSlot.TYPE_SYSTEM) {
                    ...
                    sb.append(cs.isHit() ? "*" : "").append(cs.isDestroyed() ? "*" : "").append(cs.isBreached() ? "x" : "").append(m.getDesc());
                }
            }
            sb.append(CommonConstants.NL);
        }
    ...
    private static String formatArmorTank(Tank t) {
        StringBuffer sb = new StringBuffer(1024);
        sb.append("      ARMOR               INTERNAL").append(CommonConstants.NL).append("    __________           __________").append(CommonConstants.NL).append("    |\\      /|           |\\      /|").append(CommonConstants.NL);
        sb.append("    | \\ ").append(renderArmor(t.getArmor(Tank.LOC_FRONT))).append(" / |           | \\ ");
        sb.append(renderArmor(t.getInternal(Tank.LOC_FRONT))).append(" / |").append(CommonConstants.NL).append("    |  \\__/  |           |  \\__/  |").append(CommonConstants.NL);
        ...
        sb.append(renderArmor(t.getInternal(Tank.LOC_RIGHT))).append("|").append(CommonConstants.NL);
        sb.append("    | /____\\ |           | /____\\ |").append(CommonConstants.NL).append("    | / ").append(renderArmor(t.getArmor(Tank.LOC_REAR))).append(" \\ |           | / ");
        sb.append(renderArmor(t.getInternal(Tank.LOC_REAR))).append(" \\ |").append(CommonConstants.NL).append("    |/______\\|           |/______\\|").append(CommonConstants.NL);
        sb.append(CommonConstants.NL);
        return sb.toString();
    }
    ...
    private static String formatArmorInfantry(Infantry i) {
        ...
        sb.append("Surviving troopers: ").append(renderArmor(i.getInternal(0))).append(CommonConstants.NL);
        return sb.toString();
    }
    ...
    private static String formatArmorBattleArmor(BattleArmor b) {
        ...
        for (int i = 1; i < b.locations(); i++) {
            sb.append("Trooper ").append(i).append(": ").append(renderArmor(b.getArmor(i))).append(" / ").append(renderArmor(b.getInternal(i)));
            sb.append(CommonConstants.NL);
        }
        return sb.toString();
    }
    ...
    private static String formatArmorProtomech(Protomech m) {
        ...
        sb.append(" (").append(renderArmor(m.getArmor(Protomech.LOC_HEAD), 1)).append(")                  ");
        if (m.hasMainGun()) {
        ...
        sb.append(" (");
        sb.append(renderArmor(m.getInternal(Protomech.LOC_HEAD), 1)).append(")");
        sb.append(CommonConstants.NL);
        if (m.hasMainGun()) {
            sb.append("         \\/ \\                   \\/ \\");
            sb.append(CommonConstants.NL);
        ...
        if (!m.isQuad()) {
            sb.append("      (").append(renderArmor(m.getArmor(Protomech.LOC_LARM), 1));
            sb.append(" /").append(renderArmor(m.getArmor(Protomech.LOC_TORSO))).append(" \\").append(renderArmor(m.getArmor(Protomech.LOC_RARM)));
            sb.append(")            (");
            sb.append(renderArmor(m.getInternal(Protomech.LOC_LARM), 1)).append(" /").append(renderArmor(m.getInternal(Protomech.LOC_TORSO))).append(" \\");
            sb.append(renderArmor(m.getInternal(Protomech.LOC_RARM))).append(")");
            sb.append(CommonConstants.NL);
        }
        sb.append("         | | |                  | | |");
        sb.append(CommonConstants.NL);
        sb.append("        ( ").append(renderArmor(m.getArmor(Protomech.LOC_LEG)));
        sb.append("  )                ( ");
    ...
    private static String formatArmorGunEmplacement(GunEmplacement ge) {
        StringBuffer sb = new StringBuffer(1024);
        sb.append("            ----------").append(CommonConstants.NL).append("           |          |").append(CommonConstants.NL).append("  CF       |    ").append(renderArmor(ge.getArmor(GunEmplacement.LOC_GUNS))).append("    |").append(CommonConstants.NL).append("           |          |").append(CommonConstants.NL).append("         -----------------").append(CommonConstants.NL);
        return sb.toString();
    }
