 ...
 */
public abstract class MailFolderViewMVC extends View {
     ...
     */
    protected abstract void handleAppInitEvent(AppEvent event);
     ...
     * the server.
     */
    protected abstract void handleAppNavmailEvent(AppEvent event, FolderDMO data);
}
