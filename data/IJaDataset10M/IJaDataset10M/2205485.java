...
public class Logger {
    ...
    */
    public void clearLogger(String caller) {
        ...
        printLog(outp, false);
        if (logThreshold < INFO) printDbg(outp, false); else {
    ...
    */
    public void putMsg(int level, String msg) {
        if (level == FATAL) {
            ...
            printLog(outp, true);
            if (logThreshold < INFO) printDbg(outp, true);
    ...
    */
    public static synchronized String getCaller() {
        ...
        for (int i = 0; i < callStack.length; i++) if (callStack[i].contains("getCaller:")) return callStack[i + 2];
    ...
    */
    public static int levelFmString(String level) {
        int lvl;
        if (level.equals("DEEP_DBUG")) lvl = DEEP_DBUG; else if (level.equals("MID_DBUG")) lvl = MID_DBUG; else if (level.equals("LITE_DBUG")) lvl = LITE_DBUG; else if (level.equals("INFO")) lvl = INFO; else if (level.equals("WARN")) lvl = WARN; else if (level.equals("FATAL")) lvl = FATAL; else if (level.equals("OFF")) lvl = OFF; else lvl = ERROR;
        return lvl;
    }
    ...
    private class DateCalendar extends GregorianCalendar {
       ...
       */
        public String toString() {
            ...
            String datetimeString = String.valueOf(year) + "." + String.valueOf(month) + "." + String.valueOf(day) + "." + String.valueOf(hour24) + "." + String.valueOf(min) + "." + String.valueOf(sec);
