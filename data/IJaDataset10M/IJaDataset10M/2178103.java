...
public class ApplitudeMgr {
     ...
     */
    public static ZZCell[] getApplitudes(ZZCell c) {
     ...
     */
    public static ZZCell[] getApplitudesByName(String[] app_names, ZZCell c) {
        Vector v = new Vector();
        int i;
    ...
    private static void unregister(ZZCell d, String name) {
        ...
        if (a == null) return;
        d = a.s("d.1", -1);
        for (ZZCell e = d.s("d.2"); e.s("d.1") == null; e = d.s("d.2")) e.delete();
        d.delete();
        for (ZZCell c = a.s("d.clone"); c != null; c = a.s("d.clone")) c.delete();
        a.delete();
    }
     ...
     */
    public static ZZCell register(ZZSpace sp, String name, String[] dims, String view, ZZCell binds) {
        if (dims.length < 1) throw new ZZError("Cannot register applitude without dims!");
        ...
        if (binds != null) bindc.connect("d.1", 1, binds); else bindc.N("d.1");
    ...
    public static ZZCell putDefApps(ZZCell home) {
        ...
        ZZCell zz = register(sp, "ZigZag", new String[] { "d.1", "d.2", "d.3" }, "VanishingView", null);
        ...
        register(sp, "Notemap", new String[] { "d.map-1", "d.map-2" }, "Notemap.Star", nbinds);
        return c;
    }
     ...
     */
    public static ZZCell getWindowApp(ZZCell win) {
     ...
     */
    public static ZZCell[] getWindowApplitudes(ZZCell win) {
     ...
     */
    public static FlobView getView(ZZCell app) {
        ZZCell vc = ZZDefaultSpace.findInheritableParam(app.s("d.1"), "View");
        if (vc != null) vc = vc.s("d.1");
        if (vc == null) throw new ZZError("No view found for applitude " + app);
     ...
     */
    public static void clicked(ZZCell win, ZZScene xi, Point pt) {
        Flob[] fs = new Flob[1];
     ...
     */
    public static ZZCell getAppBindsForWin(ZZCell win) {
    ...
    public static void setAppBindsForWin(ZZCell win, ZZCell to) {
        ZZCell app = getWindowApp(win);
        if (app == null) {
    ...
    public static void rotateWindowApp(ZZCell win, int dir) {
        ZZCell app = getWindowApp(win);
        if (dir < 0) {
            app = app.s("d.2", -1);
            if (app.s("d.2", -1) == null) app = app.h("d.2", 1);
        } else {
            if (app.s("d.2") != null) app = app.s("d.2"); else app = app.h("d.2").s("d.2");
        }
