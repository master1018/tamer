...
public class BasicHyperlinkUI extends BasicButtonUI {
    ...
    private void paintUnderline(Graphics g, AbstractButton b, Rectangle rect, String text) {
        ...
        g.drawLine(rect.x + getTextShiftOffset(), (rect.y + rect.height) - descent + 1 + getTextShiftOffset(), rect.x + rect.width + getTextShiftOffset(), (rect.y + rect.height) - descent + 1 + getTextShiftOffset());
    }
