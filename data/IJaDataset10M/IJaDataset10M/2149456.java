...
public class TagProcessResult {
    ...
    private TagProcessResult(final TagProcessDOMAction action, final List<SubstitutionTag> substitutionTags, final Map<String, Object> localVariables, final Object selectionTarget, final boolean selectionTargetSet, final ITextInliner textInliner, final boolean textInlinerSet) {
        super();
        this.action = action;
        this.substitutionTags = (substitutionTags == null ? EMPTY_TAGS : Collections.unmodifiableList(new ArrayList<SubstitutionTag>(substitutionTags)));
