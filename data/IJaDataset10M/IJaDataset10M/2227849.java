...
public class SplitBySiteTraitLogger extends TreeTraitProvider.Helper implements Citable {
    ...
    public static XMLObjectParser PARSER = new AbstractXMLObjectParser() {
        ...
        private final XMLSyntaxRule[] rules = { new ElementRule(AncestralStateBeagleTreeLikelihood.class, "The tree which is to be logged"), AttributeRule.newStringRule(TRAIT_NAME), AttributeRule.newBooleanRule(SCALE, true) };
    ...
    public List<Citation> getCitations() {
        ...
        citations.add(CommonCitations.SUCHARD_2012);
        return citations;
    }
}
