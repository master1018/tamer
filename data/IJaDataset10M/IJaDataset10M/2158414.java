...
public final class AndGate extends Gate {
    ...
    private static final long serialVersionUID = -2283643205792338099L;
    ...
    public AndGate(final int x, final int y) {
        ...
        this.y4 = y1 + 30;
        this.xInputPin1 = x1;
        this.yInputPin1 = y1 + (y3 - y1) / 3;
        this.xInputPin2 = x1;
        this.yInputPin2 = y1 + 2 * (y3 - y1) / 3;
        this.xOutputPin = x4 + 15;
        this.yOutputPin = y4 - 15;
    }
    ...
    public void draw(final Graphics g) {
        ...
        g.drawArc((x2 - 15), y2, 30, 30, 90, -180);
        ...
        g.drawString(d, getOriginX() - g.getFontMetrics().stringWidth(d) / 2, y1 - 5);
    }

    public boolean contains(final int x, final int y) {
        return x >= x1 && x <= (x4 + 15) && y >= y1 && y <= y3;
    }
