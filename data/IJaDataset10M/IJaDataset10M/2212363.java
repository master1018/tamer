...
/**
 * ATAssertion bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class ATAssertion implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://docs.oasis-open.org/ws-tx/wsat/2006/06", "ATAssertion", "ns1");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
        ...
        if (serializeType) {
            java.lang.String namespacePrefix = registerPrefix(xmlWriter, "http://docs.oasis-open.org/ws-tx/wsat/2006/06");
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":ATAssertion", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ATAssertion", xmlWriter);
            }
        }
        if (localExtraAttributes != null) {
    ...
    public static class Factory {
		 ...
		 * outer element
		 */
        public static ATAssertion parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ATAssertion object = new ATAssertion();
            int event;
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ATAssertion".equals(type)) {
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ATAssertion) de.vsis.coordination.demo.participant1.stubs.wsat.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
