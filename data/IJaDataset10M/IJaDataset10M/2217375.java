...
public class BrowserVersion implements Serializable {
     ...
     */
    @Deprecated
    public static final BrowserVersion FIREFOX_3 = new BrowserVersion(NETSCAPE, "5.0 (Windows; en-US)", "Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.0.19) Gecko/2010031422 Firefox/3.0.19", 3, "FF3", null);

    /** Firefox 3.6. */
    public static final BrowserVersion FIREFOX_3_6 = new BrowserVersion(NETSCAPE, "5.0 (Windows; en-US)", "Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.2.8) Gecko/20100722 Firefox/3.6.8", (float) 3.6, "FF3.6", null);

    /** Firefox Warning: highly experimental!!! */
    public static final BrowserVersion FIREFOX_8 = new BrowserVersion(NETSCAPE, "5.0 (Windows; en-US)", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.7; rv:8.0.1) Gecko/20100101 Firefox/8.0.1", (float) 8.0, "FF8", null);

    /** Internet Explorer 6. */
    public static final BrowserVersion INTERNET_EXPLORER_6 = new BrowserVersion(INTERNET_EXPLORER, "4.0 (compatible; MSIE 6.0b; Windows 98)", "Mozilla/4.0 (compatible; MSIE 6.0; Windows 98)", 6, "IE6", null);

    /** Internet Explorer 7. */
    public static final BrowserVersion INTERNET_EXPLORER_7 = new BrowserVersion(INTERNET_EXPLORER, "4.0 (compatible; MSIE 7.0; Windows NT 5.1)", "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1)", 7, "IE7", null);

    /** Internet Explorer 8. */
    public static final BrowserVersion INTERNET_EXPLORER_8 = new BrowserVersion(INTERNET_EXPLORER, "4.0 (compatible; MSIE 8.0; Windows NT 6.0)", "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.0)", 8, "IE8", null);

    /** Chrome 16. Warning: highly experimental!!! */
    public static final BrowserVersion CHROME_16 = new BrowserVersion("Netscape", "5.0 (Macintosh; Intel Mac OS X 10_7_2) AppleWebKit/535.7" + " (KHTML, like Gecko) Chrome/16.0.912.63 Safari/535.7", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_2) AppleWebKit/535.7" + " (KHTML, like Gecko) Chrome/16.0.912.63 Safari/535.7", 15, "Chrome16", null);
    ...
    static {
        ...
        final PluginConfiguration flash = new PluginConfiguration("Shockwave Flash", "Shockwave Flash 9.0 r31", "libflashplayer.so");
     ...
     */
    public BrowserVersion(final String applicationName, final String applicationVersion, final String userAgent, final float browserVersionNumeric) {
     ...
     */
    public BrowserVersion(final String applicationName, final String applicationVersion, final String userAgent, final float browserVersionNumeric, final BrowserVersionFeatures[] features) {
     ...
     * @param features the browser features
     */
    private BrowserVersion(final String applicationName, final String applicationVersion, final String userAgent, final float browserVersionNumeric, final String nickname, final BrowserVersionFeatures[] features) {
    ...
    private void initDefaultFeatures() {
        ...
        try {
            stream = getClass().getResourceAsStream("/com/gargoylesoftware/htmlunit/javascript/configuration/" + nickname_ + ".properties");
            props.load(stream);
        ...
        for (final Object key : props.keySet()) {
            try {
                ...
                throw new RuntimeException("Invalid entry '" + key + "' found in configuration file for BrowserVersion: " + nickname_);
            }
        }
    }
