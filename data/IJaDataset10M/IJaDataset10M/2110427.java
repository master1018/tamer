...
public class MenuBar extends JMenuBar implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == openItem) panel.openFile(); else if (source == saveAsItem) panel.saveFile(); else if (source == closeAllItem) panel.closeAllAction(); else if (source == reloadItem) panel.processFiles(); else if (source == prefItem) panel.preferencesAction(); else if (source == quitItem) panel.quitAction(); else if (source == collapseNodeItem) panel.collapseCurrentNode(); else if (source == collapseTreeItem) panel.collapseTreeAction(); else if (source == refreshItem) panel.refresh(); else if (source == datalogItem) panel.datalogAction(); else if (source == findItem) panel.findNextAction(); else if (source == aboutItem) panel.aboutAction();
    }
