...
public class TTLCache<KEY, VALUE> {
    ...
    /** the cache */
    private Hashtable<KEY, CacheEntry<VALUE>> cache = new Hashtable<KEY, CacheEntry<VALUE>>();
     ...
     */
    public TTLCache(long timeThresholdInMilliseconds, int sizeLimit, boolean updateTimeOnGet) {
