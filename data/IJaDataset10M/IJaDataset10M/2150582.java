...
public class RemoteHttpServletContextFactory extends JavaBridgeFactory implements IContextFactory, Serializable {
    ...
    public RemoteHttpServletContextFactory(Servlet servlet, ServletContext ctx, HttpServletRequest proxy, HttpServletRequest req, HttpServletResponse res) {
        ...
        this.id = ContextFactory.EMPTY_CONTEXT_NAME;
    }
    ...
    public IContext getContext() {
        ...
        if (impl != null) context = impl.getContext(); else setContext(createContext());
    ...
    private IContext createContext() {
        ...
        ctx.setAttribute(IContext.SERVLET_REQUEST, new HttpServletRequestWrapper(req) {
            ...
            public HttpSession getSession(boolean clientIsNew) {
                ...
                if (clientIsNew && !session.isNew()) throw new IllegalStateException("To obtain a new session call java_session() at the beginning of your PHP script.");
                return session;
            }
