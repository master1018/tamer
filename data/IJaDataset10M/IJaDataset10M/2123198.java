...
public class TokenFitnessMetric implements BenchmarkMetric {
    ...
    public String description() {
        return "The <b>token-based fitness</b> metric <b>f</b> relates the amount of missing tokens during <i>log replay</i> to the amount of consumed tokens, and " + "the amount of remaining tokens to the amount of produced tokens. If the log could be replayed correctly, that is, there were no tokens missing nor remaining, it evaluates to 1. " + "Use the <i>Conformance Checker</i> to see diagnostic visualizations.";
    }
