...
public class VM implements Warn {
                    ...
                    if (c[i - 1] == '{') {
                        ...
                        if (braceLevel == 1 && i < n) if (c[i] == '\\') {
                            ...
                            while (i < n && braceLevel > 0) {
                                if (c[i] == '}') braceLevel--; else if (c[i] == '{') braceLevel++;
                                i++;
                            }
                            result++;
                        }
    ...
    protected boolean assign(BstEntry context, Object o1, Object o2) {
        if (!(o1 instanceof Identifier) || !(o2 instanceof String || o2 instanceof Integer)) throw new VMException("Invalid parameters");
        ...
        public void execute(BstEntry context) {
            for (int i = 0; i < tree.getChildCount(); i++) {
                ...
                try {
                    ...
                    if (file != null) {
                        System.err.println("ERROR " + e.getMessage() + " (" + file.getPath() + ":" + c.getLine() + ")");
                    } else {
