...
public abstract class JdbcExampleSbb implements Sbb {
    ...
    public void onJdbcTaskExecutionThrowableEvent(JdbcTaskExecutionThrowableEvent event, ActivityContextInterface aci) {
        tracer.info("Received a JdbcTaskExecutionThrowableEvent, as result of executed task " + event.getTask(), event.getThrowable());
    ...
    public void setSbbContext(SbbContext context) {
        ...
        this.jdbcRA = (JdbcResourceAdaptorSbbInterface) contextExt.getResourceAdaptorInterface(JdbcResourceAdaptorSbbInterface.RATYPE_ID, "JDBCRA");
