...
public class EntryPanel extends JPanel {
    ...
    private boolean canMoveItems() {
        if (type == TYPE_MIME_TYPES) return false;
        return true;
    }
        ...
        if (addButton == null) {
            ...
            addButton.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    final String value2;
                    if (getEntryTextField2() != null) value2 = getEntryTextField2().getText(); else value2 = null;
        ...
        if (entryList == null) {
            ...
            entryList.addListSelectionListener(new ListSelectionListener() {
                ...
                public void valueChanged(ListSelectionEvent e) {
                    if (!e.getValueIsAdjusting()) updateDetailsPane(entryList.getSelectedIndex(), entryList.getSelectedValue());
                }
            });
        }
        return entryList;
    ...
    private JTextField getEntryTextField2() {
        if (type != TYPE_MIME_TYPES) return null;
    ...
    private JPanel getEntryTopPanel() {
        if (entryTopPanel == null) {
            ...
            if (usesSecondEntryTextField()) entryTopPanel.add(getEntryTextField2());
        }
            ...
            case TYPE_MIME_TYPES:
                ...
                if (extensions.size() > 0) {
                    for (int i = 0; i < extensions.size(); ++i) {
                        if (MimeManager.removeMimeType((String) extensions.get(i))) ++numRemoved;
                    }
                }
                if (numRemoved > 0) {
                    getEntryListModel().removeElement(entry);
    ...
    private void updateDetailsPane(int selectedIndex, Object selectedValue) {
        if (detailsListener == null) return;
