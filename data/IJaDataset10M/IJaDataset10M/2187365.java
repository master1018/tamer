...
public class TestUnitBeans extends AbstractBaseUtils {
    ...
    public void initService() {
        this.myDashboardBean = createDashboardBean("Store all surveys created", "Survey Dash", Boolean.TRUE, 8, "AAA", Boolean.TRUE, 2);
    }
    ...
    **/
    ...
    public void testUnitAnswerBean() {
        final QuestionAnswerBean unitAnswer = createUnitAnswerBean(1L, "yes", "HASH", 2L);
    ...
    */
    ...
    public void testUnitPatternBean() {
        final QuestionPatternBean unitPattern = createUnitPatternBean("b", "", "", 2L, "", "", "", 1, "");
    ...
    public void testHomeBean() {
        final Date myDate = new Date();
        QuestionPatternBean qPatternBean = createUnitPatternBean("TextBoxPattern", "TextBox", "", 1L, "txt", "", "txt", 1, "textBox");
        assertNotNull(qPatternBean);
        final QuestionAnswerBean qAnswer2 = createUnitAnswerBean(2L, "No", "defg", null);
        ...
        QuestionBean qBean = createUnitQuestionBean(1L, "First question", "1", qAnswerBean, qPatternBean);
        assertNotNull(qBean);
