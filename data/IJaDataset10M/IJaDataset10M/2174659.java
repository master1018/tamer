...
public class SetTest extends JDOPersistenceTestCase {
    ...
    public SetTest(String name) {
        super(name);
        if (!initialised) {
            addClassesToSchema(new Class[] { Set2Item.class, Set2ItemChild.class, Set1.class, Set1Child.class, Set2.class, ContainerItemChild.class, ContainerItem.class });
            initialised = true;
        }
    }
     ...
     **/
    public void testNormalPersistByCollection() throws Exception {
        try {
     ...
     * Test case to check the clearing out of elements.
     **/
    public void testNormalContains() throws Exception {
        try {
    ...
    public void testNormalInheritance() throws Exception {
        try {
            SCOCollectionTests.checkElementInheritance(pmf, Set1.class, java.util.Set.class, ContainerItem.class, ContainerItemChild.class);
        } finally {
            clean(Set1.class);
            clean(ContainerItem.class);
        }
    ...
    public void testInverseClearIsEmpty() throws Exception {
        try {
            SCOCollectionTests.checkClearCollection(pmf, Set2.class, Set2Item.class);
        } finally {
            clean(Set2.class);
            clean(Set2Item.class);
        }
    ...
    public void testInverseInheritance() throws Exception {
        try {
            SCOCollectionTests.checkElementInheritance(pmf, Set2.class, java.util.Set.class, Set2Item.class, Set2ItemChild.class);
        } finally {
            clean(Set2.class);
    ...
    public void testInverseQuery() throws Exception {
        try {
            SCOCollectionTests.checkQuery(pmf, Set2.class, Set2Item.class, vendorID);
        } finally {
            clean(Set2.class);
            clean(Set2Item.class);
        }
    ...
    public void testInversePersistByCollectionDFG() throws Exception {
        try {
    ...
    public void testInversePersistByElementDFG() throws Exception {
        try {
