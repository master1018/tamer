...
public interface IOclReferenceResolveResult<ReferenceType> {
	 ...
	 */
    public java.util.Collection<fr.inria.uml4tst.papyrus.ocl4tst.ocl.resource.ocl.IOclQuickFix> getQuickFixes();

    /**
	 * Adds a quick fix to the set of quick fixes that can be used to resolve the
	 * resolving error.
	 */
    public void addQuickFix(fr.inria.uml4tst.papyrus.ocl4tst.ocl.resource.ocl.IOclQuickFix quickFix);
	 ...
	 */
    public java.util.Collection<fr.inria.uml4tst.papyrus.ocl4tst.ocl.resource.ocl.IOclReferenceMapping<ReferenceType>> getMappings();
}
