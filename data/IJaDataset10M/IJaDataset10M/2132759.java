...
public class Unification {
    ...
    public static boolean isUnifiable(Feature a, Feature b) {
        if (a == null && b == null) {
            ...
            if (a.equals(b)) {
                ...
                if (unify(a.getC(), b.getC()) && unify(a.getN(), b.getN()) && unify(a.getG(), b.getG()) && unify(a.getP(), b.getP())) {
                    return true;
                }
                return false;
            }
    ...
    private static boolean unify(MorphologicalProperty a, MorphologicalProperty b) {
        if (a == null || b == null) {
            return true;
        } else {
            if (a.equals(b)) {
