...
public abstract class GrappaSupport implements GrappaConstants {
    ...
    private static final short CN = 0x01;

    private static final short WS = 0x02;

    private static final short SP = 0x04;

    private static final short PU = 0x08;

    private static final short DG = 0x10;

    private static final short OD = 0x20;

    private static final short UC = 0x40;

    private static final short HD = 0x80;

    private static final short LC = 0x100;

    private static final short ctype[] = { CN, CN, CN, CN, CN, CN, CN, CN, CN, CN | WS, CN | WS, CN | WS, CN | WS, CN | WS, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, CN, WS | SP, PU, PU, PU, PU, PU, PU, PU, PU, PU, PU, PU, PU, PU, PU, PU, DG | OD, DG | OD, DG | OD, DG | OD, DG | OD, DG | OD, DG | OD, DG | OD, DG, DG, PU, PU, PU, PU, PU, PU, PU, UC | HD, UC | HD, UC | HD, UC | HD, UC | HD, UC | HD, UC, UC, UC, UC, UC, UC, UC, UC, UC, UC, UC, UC, UC, UC, UC, UC, UC, UC, UC, UC, PU, PU, PU, PU, PU, PU, LC | HD, LC | HD, LC | HD, LC | HD, LC | HD, LC | HD, LC, LC, LC, LC, LC, LC, LC, LC, LC, LC, LC, LC, LC, LC, LC, LC, LC, LC, LC, LC, PU, PU, PU, PU, CN };
    ...
    public static boolean centerPanel(Point2D cpt, GrappaPanel gpanel) {
        if (cpt == null || gpanel == null) return false;
