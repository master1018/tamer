...
public class PySetDerived extends PySet implements Slotted {
    ...
    public PyString __str__() {
        ...
        if (impl != null) {
            ...
            if (res instanceof PyString) return (PyString) res;
    ...
    public PyLong __long__() {
        ...
        if (impl != null) {
            PyObject res = impl.__get__(this, self_type).__call__();
            if (res instanceof PyLong) return (PyLong) res;
    ...
    public PyComplex __complex__() {
        ...
        if (impl != null) {
            PyObject res = impl.__get__(this, self_type).__call__();
            if (res instanceof PyComplex) return (PyComplex) res;
    ...
    public PyObject __iadd__(PyObject other) {
        ...
        if (impl != null) return impl.__get__(this, self_type).__call__(other);
    ...
    public PyObject __int__() {
        ...
        if (impl != null) {
            PyObject res = impl.__get__(this, self_type).__call__();
            if (res instanceof PyInteger || res instanceof PyLong) return (PyObject) res;
    ...
    public String toString() {
        ...
        if (impl != null) {
            PyObject res = impl.__get__(this, self_type).__call__();
            if (!(res instanceof PyString)) throw Py.TypeError("__repr__ should return a string");
    ...
    public int hashCode() {
        ...
        if (self_type.lookup("__eq__") != null || self_type.lookup("__cmp__") != null) throw Py.TypeError("unhashable type");
    ...
    public PyObject __iternext__() {
        ...
        if (impl != null) {
            try {
                ...
                if (Py.matchException(exc, Py.StopIteration)) return null;
                throw exc;
            }
        }
    ...
    public PyObject __finditem__(PyObject key) {
        ...
        if (impl != null) try {
            ...
            if (Py.matchException(exc, Py.LookupError)) return null;
            throw exc;
        }
    ...
    public PyObject __call__(PyObject args[], String keywords[]) {
        ...
        if (ts.recursion_depth++ > ts.systemState.getrecursionlimit()) throw Py.RuntimeError("maximum __call__ recursion depth exceeded");
        try {
            PyType self_type = getType();
    ...
    public void dispatch__init__(PyType type, PyObject[] args, String[] keywords) {
        ...
        if (self_type.isSubType(type)) {
            ...
            if (impl != null) impl.__get__(this, self_type).__call__(args, keywords);
        }
    }
}
