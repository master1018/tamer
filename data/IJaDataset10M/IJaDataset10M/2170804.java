            ...
            for (Iterator it = list.iterator(); it.hasNext(); ) {
                ...
                if (!half[1].contains("其他")) {
                    ...
                    if (isReadOnly(property)) {
                        ...
                        buffer.append("<input  style='border:#B3B3B3 1px solid;'   onclick=\"this.style.borderColor='#406B9B'\" onmouseover=\"this.style.borderColor='#99E300'\" onmouseout=\"this.style.borderColor='#A1BCA3'\"  type='text' name='").append(property.getFullColName()).append("'");
