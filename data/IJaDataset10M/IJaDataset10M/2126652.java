package de.vsis.coordination.demo.participant2.stubs.wsba;

/**
 * BAAtomicOutcomeAssertion bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class BAAtomicOutcomeAssertion implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://docs.oasis-open.org/ws-tx/wsba/2006/06", "BAAtomicOutcomeAssertion", "ns1");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":BAAtomicOutcomeAssertion", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "BAAtomicOutcomeAssertion", xmlWriter);
            }
        }
        if (localExtraAttributes != null) {
    ...
    public static class Factory {
		 ...
		 * outer element
		 */
        public static BAAtomicOutcomeAssertion parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            BAAtomicOutcomeAssertion object = new BAAtomicOutcomeAssertion();
            int event;
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"BAAtomicOutcomeAssertion".equals(type)) {
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (BAAtomicOutcomeAssertion) de.vsis.coordination.demo.participant2.stubs.fluglinie.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
