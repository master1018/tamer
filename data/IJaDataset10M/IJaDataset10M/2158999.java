...
public class BasicFile implements QuantTask {
    ...
    public final void performBasicCounts() {
        ...
        resetStatus();
        int rc = 0;
        final ReadCSV csv = new ReadCSV(this.inputFilename.toString(), this.expectInputHeaders, this.inputFormat);
	 ...
	 */
    public final void setProduceOutputHeaders(final boolean theProduceOutputHeaders) {
