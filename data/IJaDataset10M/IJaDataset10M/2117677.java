...
public class Table extends AbstractTableModel implements Serializable {
    ...
    public void setInterpolation(double interpolation) {
        ...
        if (propChangeSupport != null) {
            propChangeSupport.firePropertyChange("interpolation", new Double(oldVal), new Double(interpolation));
        }
    }
    ...
    public void setMin(double min, boolean truncate) {
        ...
        for (Iterator iter = points.iterator(); iter.hasNext(); ) {
            ...
            if (truncate) {
                ...
                newVal = LineUtils.rescale(point.getValue(), oldVal, this.max, this.min, this.max, -1);
            }
            point.setLocation(point.getTime(), newVal);
        }
        if (propChangeSupport != null) {
            propChangeSupport.firePropertyChange("min", new Double(oldVal), new Double(this.min));
        }
    }
    ...
    public void setMax(double max, boolean truncate) {
        ...
        for (Iterator iter = points.iterator(); iter.hasNext(); ) {
            ...
            if (truncate) {
                ...
                newVal = LineUtils.rescale(point.getValue(), this.min, oldVal, this.min, this.max, -1.0f);
            }
            point.setLocation(point.getTime(), newVal);
        }
        if (propChangeSupport != null) {
            propChangeSupport.firePropertyChange("max", new Double(oldVal), new Double(this.max));
        }
    }
    ...
    public void setInterpolationType(int interpolationType) {
        ...
        if (propChangeSupport != null) {
            propChangeSupport.firePropertyChange("interpolationType", new Double(oldVal), new Double(interpolationType));
        }
    }
