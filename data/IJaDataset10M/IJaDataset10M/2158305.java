...
public class JarExplorer extends JFrame {
    ...
    private static final String APP_NAME = "JarExplorer 0.6 Beta";
    ...
    public JarExplorer() {
        ...
        mainSp = new JSplitPane(JSplitPane.VERTICAL_SPLIT, jarFilePanel = new JarFilePanel(), resultsPanel = new SearchResultsPanel());
