...
public class SPARQLQueryTest extends TestCase {
    ...
    private boolean readExpectedBooleanQueryResult() throws Exception {
        BooleanQueryResultFormat bqrFormat = BooleanQueryResultParserRegistry.getInstance().getFileFormatForFileName(resultFileURL);
        if (bqrFormat != null) {
            InputStream in = new URL(resultFileURL).openStream();
            try {
    ...
    public static class Factory {
        ...
        public SPARQLQueryTest createSPARQLQueryTest(String testURI, String name, String queryFileURL, String resultFileURL, Dataset dataSet) {
            return new SPARQLQueryTest(testURI, name, queryFileURL, resultFileURL, dataSet);
        }
    }

    public static TestSuite suite(String manifestFileURL) throws Exception {
