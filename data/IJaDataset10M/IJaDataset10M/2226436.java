...
public abstract class AbstractLinearImage implements Image {
    ...
    public String toString() {
        return "AbstractLinearImage{" + "arrayHeight=" + arrayHeight + ", arrayWidth=" + arrayWidth + ", aspectRatio=" + aspectRatio + ", height=" + height + ", originX=" + originX + ", originY=" + originY + ", width=" + width + '}';
    }
