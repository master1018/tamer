...
public class OAIDigitalObjectManagerDCBase extends DigitalObjectManagerBase {
    ...
    public static final String PATH_KEY = "manager.path";
    ...
    public List<URI> list(URI pdURI) {
        ...
        try {
            ...
            log.info("OAIDigitalObjectManagerDCBase dom.list error: " + e.getMessage());
        }
        return retVal;
    }
        ...
        for (URI uri : tmpRetVal) {
            ...
            if (uri != null) {
                ...
                if (leafname != null) {
                    ...
                    if (parts != null && parts.length > 0) leafname = parts[parts.length - 1];
                }
            }
            log.info("OAIDigitalObjectManagerDCBase listFileLocation() leafname: " + leafname + ", pdURI.toString(): " + pdURI.toString() + ", uri.toString(): " + uri.toString());
    ...
    /**
		 ...
		 */
    private void store(URI pdURI, DigitalObject digitalObject) throws DigitalObjectNotStoredException {
        if (digitalObject.getTitle() == null) {
            throw new DigitalObjectNotStoredException("The DigitalObject titel was not found!");
        }
    ...
    /**
		 ...
		 * @throws URISyntaxException
		 */
    protected static URI createNewPathUri(URI oldPathUri, String newPath) throws URISyntaxException {
        return new URI(oldPathUri.getScheme(), oldPathUri.getUserInfo(), oldPathUri.getHost(), oldPathUri.getPort(), newPath, null, null);
    }
}
