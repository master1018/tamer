...
final class IndexFileDeleter {
   ...
   *  infoStream != null */
    ...
    void setInfoStream(PrintStream infoStream) {
        ...
        if (infoStream != null) message("setInfoStream deletionPolicy=" + policy);
    }
   ...
   */
    ...
    private void deletePendingFiles() throws IOException {
        if (deletable != null) {
            ...
            for (int i = 0; i < size; i++) {
                if (infoStream != null) message("delete pending file " + oldDeletable.get(i));
   ...
   */
    ...
    void deleteFiles(List files) throws IOException {
        ...
        for (int i = 0; i < size; i++) deleteFile((String) files.get(i));
    }
   ...
   *  (have not yet been incref'd). */
    void deleteNewFiles(Collection files) throws IOException {
        ...
        while (it.hasNext()) {
            ...
            if (!refCounts.containsKey(fileName)) deleteFile(fileName);
        }
    }
   ...
   * equals.
   */
    private static final class CommitPoint extends IndexCommit implements Comparable {
