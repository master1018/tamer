package org.primordion.user.app.database.school.building.client;
...
*/
public class BuildingController extends XhSchool implements IXhDatabaseController {
    ...
    /**
	 * The signal that should be sent to retrieve records.
	 * Possible values include SIG_RETRIEVE_ALL and SIG_RETRIEVE_ALL_PICKER.
	 */
    private int retrieveSignal = SIG_RETRIEVE_ALL;
