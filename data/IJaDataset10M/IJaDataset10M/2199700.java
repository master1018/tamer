 ...
 * @cdk.githash
 */
public class DebugMoleculeSet extends MoleculeSet implements IMoleculeSet {

    private static final long serialVersionUID = -2925577323304207688L;

    ILoggingTool logger = LoggingToolFactory.createLoggingTool(DebugMoleculeSet.class);
