...
public class SojoControllerInterfaceImplTest extends TestBase {
    ...
    public void testJsonViewWithControllerInterfaceImpl() throws Exception {
        ...
        String expected = "{\"num\":1,\"bean\":{\"date2\":\"" + date2 + "\",\"number\":2,\"date1\":\"" + date1 + "\",\"string\":\"beanstring\"},\"arr\":[1,2,3],\"string\":\"test\",\"map\":{\"num\":1,\"string\":\"test\",\"date1\":\"" + date1 + "\"},\"date1\":1}";
        assertEqualsJson(expected, response.getContentAsString());
    }
