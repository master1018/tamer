...
public class FlightPanel extends Panel {
    ...
    public static String[] datasetLabels_ = { "Smaller", "Small", "Medium", "Large" };

    public static final String[] vertexFiles_ = { "support/data/ultrasparse_graph.dat", "support/data/sparse_graph.dat", "support/data/graph.dat", "support/data/full_graph.dat" };

    public static final String[] edgeFiles_ = { "support/data/ultrasparse_flights.dat", "support/data/sparse_flights.dat", "support/data/flights.dat", "support/data/full_flights.dat" };
    ...
    private void init() {
        ...
        for (int i = 0; i < DS_MAX; i++) {
            ...
            datasetCheckboxes_[i].addItemListener(new FlightListener(i + FlightListener.FL_ITEM_FIRST, graph_, queryData_, this, datasetStat_, vertexFiles_[i], edgeFiles_[i], docBase_));
            if (i % 2 == 0) {
        ...
        hourChoice_.addItemListener(new FlightListener(FlightListener.FL_HOUR, null, queryData_, this, null));
        minuteChoice_.addItemListener(new FlightListener(FlightListener.FL_MINUTE, null, queryData_, this, null));
        ampmChoice_.addItemListener(new FlightListener(FlightListener.FL_AMPM, null, queryData_, this, null));
        ...
        clearButton_.addActionListener(new FlightListener(FlightListener.FL_CLEAR, graph_, queryData_, this, null));
        queryButton_.addActionListener(new FlightListener(FlightListener.FL_QUERY, graph_, queryData_, this, mapStatusLabel_));
        quitButton_.addActionListener(new FlightListener(FlightListener.FL_QUIT, null, null, null, null));
    }
}
