...
public class Triple {
	 ...
	 */
    public Triple(String subject, Property property, Value value, Rule rule, String... comment) throws URISyntaxException, MalformedURLException {
    ...
    public Triple changePropertyAndValue(Property newPropertyName, Value newValue) throws Exception {
        Triple triple = this.copy();
        triple.setProperty(newPropertyName);
        triple.setValue(newValue);
        return triple;
