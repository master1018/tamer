...
public class EStringToTypeMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<String, Type> {
    ...
    public Type getTypedValue() {
        if (value != null && value.eIsProxy()) {
            ...
            if (value != oldValue) {
                if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.RESOLVE, CachePackage.ESTRING_TO_TYPE_MAP_ENTRY__VALUE, oldValue, value));
            }
        }
        return value;
    }
    ...
    public void setTypedKey(String newKey) {
        String oldKey = key;
        key = newKey;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, CachePackage.ESTRING_TO_TYPE_MAP_ENTRY__KEY, oldKey, key));
    }
    ...
    public void setTypedValue(Type newValue) {
        Type oldValue = value;
        value = newValue;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, CachePackage.ESTRING_TO_TYPE_MAP_ENTRY__VALUE, oldValue, value));
    }
