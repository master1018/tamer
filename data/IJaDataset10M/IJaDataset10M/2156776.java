...
public class Country extends BaseMagentoModel {
    ...
    public boolean equals(Object obj) {
        ...
        if (iso2Code == null) {
            if (other.iso2Code != null) return false;
        } else if (!iso2Code.equals(other.iso2Code)) return false;
        if (iso3Code == null) {
            if (other.iso3Code != null) return false;
        } else if (!iso3Code.equals(other.iso3Code)) return false;
        if (name == null) {
