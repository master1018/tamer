package de.icehorsetools.iceoffice.workflow.combinationsection;
...
import de.icehorsetools.dataAccess.objects.Combinationsection;

public class CombinationsectionDeleteWf extends ADefaultMessageBoxWorkflow {

    private static final Logger LOG = Logger.getLogger(CombinationsectionDeleteWf.class);
    ...
    public boolean areObjectsValidForWorkflow(List xObjects, UnitOfWork xCurrentUnitOfWork) {
        return xObjects != null && xObjects.size() == 1 && xObjects.get(0) instanceof Combinationsection;
    }
