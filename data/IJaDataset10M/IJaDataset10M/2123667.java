...
public class ArticleImpl extends EObjectImpl implements Article {
    ...
    public void setName(String newName) {
        String oldName = name;
        name = newName;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, WebpagePackage.ARTICLE__NAME, oldName, name));
    }
    ...
    public void setCreated(Calendar newCreated) {
        ...
        created = newCreated;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, WebpagePackage.ARTICLE__CREATED, oldCreated, created));
    }
