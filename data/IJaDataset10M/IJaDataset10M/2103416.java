...
public class DescribeLayoutItem implements java.io.Serializable {
    ...
    public DescribeLayoutItem(boolean editable, java.lang.String label, com.sforce.soap.partner.DescribeLayoutComponent[] layoutComponents, boolean placeholder, boolean required) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = true && this.editable == other.isEditable() && ((this.label == null && other.getLabel() == null) || (this.label != null && this.label.equals(other.getLabel()))) && ((this.layoutComponents == null && other.getLayoutComponents() == null) || (this.layoutComponents != null && java.util.Arrays.equals(this.layoutComponents, other.getLayoutComponents()))) && this.placeholder == other.isPlaceholder() && this.required == other.isRequired();
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getLayoutComponents() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getLayoutComponents()); i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(DescribeLayoutItem.class, true);
