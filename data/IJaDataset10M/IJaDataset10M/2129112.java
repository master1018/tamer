...
public class DisplaySignalValueEvent extends AWTEvent {
     ...
     */
    public DisplaySignalValueEvent(Object o, int location, int AValue, int CValue, int GValue, int TValue) {
     ...
     */
    public DisplaySignalValueEvent(Object o, int location, int AValue, int CValue, int GValue, int TValue, int fifthDyeValue) {
     ...
     */
    public boolean fifthDyeDataExists() {
        return fifthDyeExists;
    }
}
