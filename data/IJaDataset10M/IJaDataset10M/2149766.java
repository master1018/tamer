...
public class AbstractAppletTest {
    ...
    public static void setUp() {
        ...
        viewer = AppletLauncher.applet(jcpApplet).withParameters(parameters).start();
    ...
    protected void restoreModelToEmpty() {
        ...
        basic.getMoleculeSet().addAtomContainer(basic.getBuilder().newInstance(IMolecule.class));
    ...
    protected void restoreModelWithBasicmol() {
        ...
        try {
            ...
            CDKHydrogenAdder hAdder = CDKHydrogenAdder.getInstance(basic.getMoleculeSet().getAtomContainer(0).getBuilder());
