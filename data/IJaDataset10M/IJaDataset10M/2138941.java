...
public class CxlRejRespTo extends FIXMLField {

    public static final String TAG = "434";
    public static final int DATA_TYPE = FIXDataConverter.CHAR;
    public static final String ENUM_OrdCxlReq = "1";
    public static final String ENUM_OrdCxlRepReq = "2";

    public static final String ENUM = "|1|2";
	...
	public void setValue(String s) throws ModelException {
	    if ( s == null || s.indexOf('|') != -1 || ENUM.indexOf(s) == -1 )
	        throw new ModelException("Invalid value (" + s + ") for field CxlRejRespTo.");
        _Value = s;	        
	}
	...
	public void initValue(Object s) throws ModelException {
	    if ( _Value != null ) 
	        throw new ModelException("Value has already been initialized for field CxlRejRespTo.");
        setValue((String)s);	        
	}
	...
	public String toFIXML(String ident) {
	    ...
	    return ident + "<CxlRejRespTo FIXTag=\"434\" DataType=\"char\">"
	            + _Value + "</CxlRejRespTo>";
