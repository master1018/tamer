...
public class SearchDatabaseTask extends TaskAdapter<Void, List<List<Object>>> {
    ...
    private List<Object> prepareRowContent(String[] parts) {
        ...
        for (int i = 0; i < parts.length; i++) {
            ...
            } else if (headers[i + 2].equals(DatabaseSearchTableModel.TableHeader.EXPERIMENT_ACCESSION) || headers[i + 2].equals(DatabaseSearchTableModel.TableHeader.TAXONOMY_ID) || headers[i + 2].equals(DatabaseSearchTableModel.TableHeader.NUMBER_OF_SPECTRA) || headers[i + 2].equals(DatabaseSearchTableModel.TableHeader.NUMBER_OF_PEPTIDE) || headers[i + 2].equals(DatabaseSearchTableModel.TableHeader.NUMBER_OF_PROTEIN)) {
