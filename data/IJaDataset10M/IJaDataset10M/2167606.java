...
public class JDOMXPathUtils {
	 ...
	 */
    public static List<?> evalXPaths(String xpathExpression, Element nodeContext) throws JDOMException {
        XPath xpath;
	 ...
	 *             if there was an error querying
	 */
    public static Object evalXPath(String xpathExpression, Element nodeContext) throws JDOMException {
	 ...
	 */
    public static List<String> evalXPathStrings(String xpathExpression, Element nodeContext) throws JDOMException {
	 ...
	 * @see evalXPath
	 */
    public static String evalXPathString(String xpathExpression, Element nodeContext) throws JDOMException {
