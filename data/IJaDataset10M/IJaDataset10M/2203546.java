...
public class QuakeLib {
     ...
     * @return true if the event was handled.
     */
    public native boolean motionEvent(long eventTime, int action, float x, float y, float pressure, float size, int deviceId);
    ...
    /**
      ...
      * @return true if the event was handled.
      */
    public native boolean trackballEvent(long eventTime, int action, float x, float y);
