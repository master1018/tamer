...
public class DefaultCredentialsProvider implements CredentialsProvider, Serializable {
    ...
    private final HashMap<AuthScopeProxy, CredentialsFactory> credentialsMap_ = new HashMap<AuthScopeProxy, CredentialsFactory>();
     ...
     */
    public void addCredentials(final String username, final String password, final String host, final int port, final String realm) {
    ...
    public synchronized void setCredentials(final AuthScope authscope, final Credentials credentials) {
        ...
        if (credentials instanceof UsernamePasswordCredentials) {
            ...
            factory = new UsernamePasswordCredentialsFactory(userCredentials.getUserName(), userCredentials.getPassword());
        } else if (credentials instanceof NTCredentials) {
            final NTCredentials ntCredentials = (NTCredentials) credentials;
            factory = new NTCredentialsFactory(ntCredentials.getUserName(), ntCredentials.getPassword(), ntCredentials.getWorkstation(), ntCredentials.getDomain());
        } else {
     ...
     */
    private static Credentials matchCredentials(final HashMap<AuthScopeProxy, CredentialsFactory> map, final AuthScope authscope) {
    ...
    private static class NTCredentialsFactory implements CredentialsFactory, Serializable {
        ...
        public NTCredentialsFactory(final String username, final String password, final String workstation, final String domain) {
            username_ = username;
            password_ = password;
