...
public class Host {
	 ...
	 */
    public Host(String ipAddress, int port, int sharedFileCount, int sharedFileSize, HostState state) {
    ...
    public Host(PongMessage pongMessage, HostState state) {
        this(pongMessage.getIPAddress(), pongMessage.getPort(), pongMessage.getSharedFileCount(), pongMessage.getSharedFileSize(), state);
    }
    ...
    public boolean equals(Object obj) {
        ...
        Host rhs = (Host) obj;
        return getIPAddress().equals(rhs.getIPAddress()) && getPort() == rhs.getPort();
    }
