...
public class GrammarData {
    ...
    public String toString() {
        ...
        buffer.append("General{").append("id=").append(id).append(", grammarName=").append(grammarName).append(", grammarClass=").append(grammarClass).append(", grammar=").append(grammar).append("}");
