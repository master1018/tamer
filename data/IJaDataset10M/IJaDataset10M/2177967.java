...
public class GibbsPruneAndRegraft extends SimpleMetropolizedGibbsOperator {
    ...
    private double GibbsProposal(Prior prior, Likelihood likelihood) throws OperatorFailedException {
    ...
    private double prunedGibbsProposal(Prior prior, Likelihood likelihood) throws OperatorFailedException {
        final int nodeCount = tree.getNodeCount();
        final NodeRef root = tree.getRoot();
    ...
    private double calculateTreeLikelihood(Prior prior, Likelihood likelihood, TreeModel tree) {
