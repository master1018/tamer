...
public class RootModel extends AbstractDBModel implements IPropertySource {
    ...
    public IPropertyDescriptor[] getPropertyDescriptors() {
        return new IPropertyDescriptor[] { new TextPropertyDescriptor(P_JDBC_INFO, DBPlugin.getResourceString("property.schema")), new FontPropertyDescriptor(P_FONT, DBPlugin.getResourceString("property.font")) };
    }
