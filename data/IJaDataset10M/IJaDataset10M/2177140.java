...
public class Triple implements Serializable {
    ...
    public static Triple fromArray(Node[] na) {
        if (na.length == 3) return new Triple(na[0], na[1], na[2]); else if (na.length == 4) return Quad.fromArray(na); else return null;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (result) {
            Triple s = (Triple) o;
            result &= s._sub.equals(_sub) && s._pred.equals(_pred) && s._obj.equals(_obj);
        }
        return result;
    }
