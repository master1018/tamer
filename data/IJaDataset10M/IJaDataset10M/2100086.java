...
import net.sourceforge.ondex.ovtk2.ui.contentsdisplay.GDSAttributePlugin;
 ...
 * 
 */
public class EvidencePlugin extends AbstractContentDisplayPlugin implements GDSAttributePlugin {
    ...
    public String[] getAttributeNames() {
        ...
        for (int i = 0; i < count; i++) {
            if (i == 0) attrNames[i] = "evidence"; else attrNames[i] = "evidence_" + i;
        }
        return attrNames;
    }
            ...
            if (g != null) {
                ...
                for (int i = 1; i < count; i++) {
                    ...
                    if (confAN != null) {
                        ...
                        if (g != null) b.append(compileSplit(g));
                    }
                }
            }
        }
