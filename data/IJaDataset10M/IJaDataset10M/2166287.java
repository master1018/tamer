...
public class Dates {
    ...
    public static String dateFormatForJSCalendar(Locale locale) {
        ...
        String date = df.format(create(1, 2, 1971));
        boolean always4InYear = "es".equals(locale.getLanguage()) || "pl".equals(locale.getLanguage());
        String result = date.replaceAll("01", "%d").replaceAll("02", "%m").replaceAll("1971", "%Y").replaceAll("71", always4InYear ? "%Y" : "%y").replaceAll("1", "%d").replaceAll("2", "%m");
        return result;
    }

    public static String dateTimeFormatForJSCalendar(Locale locale) {
        DateFormat df = DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT, locale);
        String datetime = df.format(create(1, 2, 1971, 15, 59, 0));
        boolean always4InYear = "es".equals(locale.getLanguage()) || "pl".equals(locale.getLanguage());
        String result = datetime.replaceAll("15", "%H").replaceAll("03", "%I").replaceAll("3", "%l").replaceAll("59", "%M").replaceAll("PM", "%p").replaceAll("pm", "%P").replaceAll("01", "%d").replaceAll("02", "%m").replaceAll("1971", "%Y").replaceAll("71", always4InYear ? "%Y" : "%y").replaceAll("1", "%e").replaceAll("2", "%m");
        return result;
    }
