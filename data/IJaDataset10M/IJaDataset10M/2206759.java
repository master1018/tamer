 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({ EthernetIpBufferUtilTest.class, UnconnectedMessageManagerRequestTest.class, EthernetIpRegisterSessionRequestTest.class, SimpleControlLogixCommunicatorTest.class, UnconnectedMessagingTest.class, ArrayTest.class, ExtensiveRWTest.class })
