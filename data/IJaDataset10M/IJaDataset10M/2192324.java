...
public class LevelXing {
    ...
    private String signalAName = "";

    private String signalBName = "";

    private String signalCName = "";

    private String signalDName = "";

    private String signalAMastName = "";

    private String signalBMastName = "";

    private String signalCMastName = "";

    private String signalDMastName = "";

    private String sensorAName = "";

    private String sensorBName = "";

    private String sensorCName = "";

    private String sensorDName = "";
	...
	*/
    ...
    public void setSignalDName(String signalName) {
        signalDName = signalName;
    }

    public String getSignalAMastName() {
        return signalAMastName;
    }

    public void setSignalAMastName(String signalName) {
        signalAMastName = signalName;
    }

    public String getSignalBMastName() {
        return signalBMastName;
    }

    public void setSignalBMastName(String signalName) {
        signalBMastName = signalName;
    }

    public String getSignalCMastName() {
        return signalCMastName;
    }

    public void setSignalCMastName(String signalName) {
        signalCMastName = signalName;
    }

    public String getSignalDMastName() {
        return signalDMastName;
    }

    public void setSignalDMastName(String signalName) {
        signalDMastName = signalName;
    }
    ...
    public boolean isMainlineAC() {
        if (((connectA != null) && (((TrackSegment) connectA).getMainline())) || ((connectB != null) && (((TrackSegment) connectB).getMainline()))) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean isMainlineBD() {
        if (((connectB != null) && (((TrackSegment) connectB).getMainline())) || ((connectD != null) && (((TrackSegment) connectD).getMainline()))) {
            return true;
        } else {
            return false;
        }
    ...
    public void scaleCoords(float xFactor, float yFactor) {
        Point2D pt = new Point2D.Double(round(center.getX() * xFactor), round(center.getY() * yFactor));
        center = pt;
        pt = new Point2D.Double(round(dispA.getX() * xFactor), round(dispA.getY() * yFactor));
        dispA = pt;
        pt = new Point2D.Double(round(dispB.getX() * xFactor), round(dispB.getY() * yFactor));
        dispB = pt;
    }
    ...
    public void setObjects(LayoutEditor p) {
        ...
        if (tBlockNameAC.length() > 0) {
            ...
            if (blockAC != null) {
                ...
                if (blockAC != blockBD) blockAC.incrementUse();
            } else {
        ...
        if (tBlockNameBD.length() > 0) {
            ...
            if (blockBD != null) {
                ...
                if (blockAC != blockBD) blockBD.incrementUse();
            } else {
    ...
    protected void showPopUp(MouseEvent e) {
        ...
        if ((blockNameAC == null) || (blockNameAC.equals(""))) popup.add(rb.getString("NoBlock1")); else {
            popup.add(rb.getString("Block1ID") + ": " + getLayoutBlockAC().getID());
            blockACAssigned = true;
        }
        if ((blockNameBD == null) || (blockNameBD.equals(""))) popup.add(rb.getString("NoBlock2")); else {
        ...
        for (int i = 0; i < 4; i++) {
            if (boundaryBetween[i] != null) blockBoundaries = true;
        }
        if (blockBoundaries) {
    ...
    void xingEdit1BlockPressed(ActionEvent a) {
        ...
        if (blockAC == null) {
            JOptionPane.showMessageDialog(editLevelXingFrame, rb.getString("Error1"), rb.getString("Error"), JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    public void removeSignalMastLogic(SignalMast sm) {
        ...
        for (int i = 0; i < sml.size(); i++) {
            ...
            if (s != null) s.removeConflictingLogic(sm, this);
        }
    }
