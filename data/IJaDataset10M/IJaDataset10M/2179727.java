...
public class Rank extends _Rank {
    ...
    private static SQLTemplate maxRank = new SQLTemplate(Rank.class, "SELECT " + "#result('rank.ID' 'int' 'id') " + "FROM rank " + "ORDER BY id DESC");

    private static SQLTemplate minRank = new SQLTemplate(Rank.class, "SELECT " + "#result('rank.ID' 'int' 'id') " + "FROM rank " + "ORDER BY id ASC");
