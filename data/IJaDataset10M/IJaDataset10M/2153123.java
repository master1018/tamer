...
public class SourceSelectionDialog extends javax.swing.JDialog implements ActionListener {
    ...
    private void initComponents() {
        ...
        Utility.buildRelativeConstraints(gbc, 1, 2, 100, 100, GridBagConstraints.BOTH, GridBagConstraints.WEST);
        ...
        Utility.buildRelativeConstraints(gbc, GridBagConstraints.REMAINDER, 1, 0, 0, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);
        getContentPane().add(addButton, gbc);
        JButton removeButton = new JButton(PropertyFactory.getString("in_remove"));
        removeButton.setActionCommand(ACTION_REMOVE);
        removeButton.setEnabled(false);
        Utility.buildRelativeConstraints(gbc, GridBagConstraints.REMAINDER, 1, 0, 0, GridBagConstraints.HORIZONTAL, GridBagConstraints.NORTH);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                SourceSelectionDialog dialog = new SourceSelectionDialog(new javax.swing.JFrame(), true);
