...
public abstract class Interactive implements ServerUser {
     ...
     */
    public static String createKeyName(String nom) throws InvalidNameException {
     ...
     */
    public static Interactive findUser(String nom) {
     ...
     */
    public final synchronized void processInput() {
        if (input_thread != null) {
     ...
     * @see #input
     */
    public final synchronized void redirectInput(Input ob) {
    ...
    public final String getAddressName() {
        if (CMProps.getVar(CMProps.SYSTEM_MUDDOMAIN).length() > 0) return CMProps.getVar(CMProps.SYSTEM_MUDDOMAIN).toLowerCase();
