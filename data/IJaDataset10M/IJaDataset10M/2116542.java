...
public class OrderCancelRequest extends Message {
    ...
    public OrderCancelRequest(quickfix.field.OrigClOrdID aOrigClOrdID, quickfix.field.ClOrdID aClOrdID, quickfix.field.Symbol aSymbol, quickfix.field.Side aSide) {
        getHeader().setField(new MsgType("F"));
        set(aOrigClOrdID);
        set(aClOrdID);
        set(aSymbol);
