...
public class GsmDataConnection extends DataConnection {
    ...
    protected void onConnect(ConnectionParams cp) {
        ...
        phone.mCM.setupDataCall(Integer.toString(RILConstants.SETUP_DATA_TECH_GSM), Integer.toString(RILConstants.DATA_PROFILE_DEFAULT), apn.apn, apn.user, apn.password, Integer.toString(authType), msg);
    }
    ...
    public String toString() {
        return "State=" + getCurrentState().getName() + " Apn=" + apn + " create=" + createTime + " lastFail=" + lastFailTime + " lastFailCause=" + lastFailCause;
    }
    ...
    protected boolean isDnsOk(String[] domainNameServers) {
        if (NULL_IP.equals(dnsServers[0]) && NULL_IP.equals(dnsServers[1]) && !((GSMPhone) phone).isDnsCheckDisabled()) {
