...
public class Asn1ObjectIdentifier extends DerObject {
    ...
    Asn1ObjectIdentifier(int baseTag, byte[] data) throws IOException {
    ...
    public Asn1ObjectIdentifier(String oid) throws IllegalArgumentException {
    ...
    private static void writeField(OutputStream out, long fieldValue) throws IOException {
        if (fieldValue >= (1L << 7)) {
            if (fieldValue >= (1L << 14)) {
                if (fieldValue >= (1L << 21)) {
                    if (fieldValue >= (1L << 28)) {
    ...
    private static void writeField(OutputStream out, BigInteger fieldValue) throws IOException {
    ...
    private static byte[] toByteArray(String oid) throws IllegalArgumentException {
