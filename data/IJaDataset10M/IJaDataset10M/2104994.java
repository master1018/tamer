...
import net.sourceforge.jasymcaandroid.PlotGraph;
...
class LambdaHOLD extends Lambda {
    ...
    public int lambda(Stack st) throws ParseException, JasymcaException {
        ...
        if (!LambdaPLOT.pg.Hold_b) LambdaPLOT.pg.setVisible(false);
        if (pc.ps != null) {
...
class LambdaXLABEL extends Lambda {
    ...
    public int lambda(Stack st) throws ParseException, JasymcaException {
        int narg = getNarg(st);
        Object arg = st.pop();
        if (!(arg instanceof String)) throw new JasymcaException("Argument must be string.");
        if (LambdaPLOT.pg != null) LambdaPLOT.pg.setXlabel((String) arg);
        return 0;
    }
}
...
class LambdaYLABEL extends Lambda {
    ...
    public int lambda(Stack st) throws ParseException, JasymcaException {
        ...
        Object arg = st.pop();
        if (!(arg instanceof String)) throw new JasymcaException("Argument must be string.");
        if (LambdaPLOT.pg != null) LambdaPLOT.pg.setYlabel((String) arg);
        return 0;
    }
}
...
class LambdaTITLE extends Lambda {
    ...
    public int lambda(Stack st) throws ParseException, JasymcaException {
        ...
        Object arg = st.pop();
        if (!(arg instanceof String)) throw new JasymcaException("Argument must be string.");
        if (LambdaPLOT.pg != null) LambdaPLOT.pg.setTlabel((String) arg);
        return 0;
    }
}
