   ...
   */
    ...
    private EntityWs2 lookup(String id, IncludesWs2 includes) throws MBWS2Exception {
        ...
        if (resType.equals(LABEL)) {
            ...
            inc.setWorkRelations(includes.isWorkRelations());
            inc.setArtistCredits(includes.isArtistCredits());
            if (inc.isArtistCredits()) inc.setRecordings(true);
    ...
    public LabelWs2 getLabelById(String id, LabelIncludesWs2 includes) throws MBWS2Exception {
        ...
        if (md.getLabelWs2() == null) throw new ResponseException("Server didn't return label!");
    ...
    public ArtistWs2 getArtistById(String id, ArtistIncludesWs2 includes) throws MBWS2Exception {
        ...
        if (md.getArtistWs2() == null) throw new ResponseException("Server didn't return artist!");
    ...
    public ReleaseGroupWs2 getReleaseGroupById(String id, ReleaseGroupIncludesWs2 includes) throws MBWS2Exception {
        ...
        if (md.getReleaseGroupWs2() == null) throw new ResponseException("Server didn't return release-group!");
    ...
    public ReleaseWs2 getReleaseById(String id, ReleaseIncludesWs2 includes) throws MBWS2Exception {
        ...
        if (md.getReleaseWs2() == null) throw new ResponseException("Server didn't return release!");
    ...
    public RecordingWs2 getRecordingById(String id, RecordingIncludesWs2 includes) throws MBWS2Exception {
        ...
        if (md.getRecordingWs2() == null) throw new ResponseException("Server didn't return recording!");
    ...
    public WorkWs2 getWorkById(String id, WorkIncludesWs2 includes) throws MBWS2Exception {
        ...
        if (md.getWorkWs2() == null) throw new ResponseException("Server didn't return work!");
    ...
    public CollectionWs2 getCollectionById(String id, CollectionIncludesWs2 includes) throws MBWS2Exception {
        ...
        if (md.getCollectionWs2() == null) throw new ResponseException("Server didn't return Collection!");
        return md.getCollectionWs2();
    }

    public PuidWs2 getPuidById(PuidWs2 puid, RecordingIncludesWs2 includes) throws MBWS2Exception {
    ...
    public DiscWs2 getDiscById(DiscWs2 disc, ReleaseIncludesWs2 includes, DiscTocFilterWs2 filter) throws MBWS2Exception {
    ...
    public ReleaseListWs2 getReleaseListByDiscId(String id, String toc, ReleaseIncludesWs2 includes, DiscTocFilterWs2 filter) throws MBWS2Exception {
        String uuid;
        try {
            uuid = MbUtils.extractUuid(id, DISC);
        } catch (IllegalArgumentException e) {
        ...
        Metadata md = getFromWebService(DISCID, uuid, includes, filter);
        if (md.getReleaseListWs2() == null) throw new ResponseException("Server didn't return releases!");
        if (md.getDiscWs2() != null) return md.getDiscWs2().getReleaseList(); else return md.getReleaseListWs2();
    }
}
