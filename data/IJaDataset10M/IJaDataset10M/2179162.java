...
public class UtilRDS {
	 ...
	 * @return
	 */
    public static final DocumentoRDS cloneDocumentoRDS(DocumentoRDS doc) {
	 ...
	 * @return
	 */
    public static final UsoRDS obtenerNumeroEntrada(List usos) {
	 ...
	 * @return
	 */
    public static final UsoRDS obtenerNumeroSalida(List usos) {
        if (usos == null) return null;
