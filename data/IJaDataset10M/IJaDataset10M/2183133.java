...
public class InvisibleRectangles {
    ...
    public static void main(String[] args) {
        ...
        try {
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("results/in_action/chapter10/invisible_rectangles.pdf"));
            document.open();
            document.add(new Paragraph("Two paths for identical rectangles are constructed, but we forgot to paint them."));
