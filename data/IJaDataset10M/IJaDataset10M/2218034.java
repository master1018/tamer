...
public class ReflectiveFactoryReaderTest extends TestCase {
    ...
    public void testReadsGenericsInGenericType() {
        ...
        assertEquals("java.util.Map<? extends java.util.Set<java.lang.Long>, org.hamcrest.Factory>", method.getGenerifiedType());
    }
    ...
    public void testReadsGenerifiedParameterTypes() {
        ...
        assertEquals("java.util.Collection<? extends java.lang.Comparable>", method.getParameters().get(0).getType());
        assertEquals("java.util.Set<java.lang.String[]>[]", method.getParameters().get(1).getType());
    }
    ...
    public void testReadsGenericTypeParameters() {
        ...
        assertEquals("V extends java.util.List<java.lang.String> & java.lang.Comparable<java.lang.String>", method.getGenericTypeParameters().get(1));
