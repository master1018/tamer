...
public class AtomContainerManipulatorTest extends CDKTestCase {
    ...
    public void testRemoveHydrogensBorane() throws IOException, ClassNotFoundException, CDKException {
        ...
        borane.addBond(2, 3, CDKConstants.BONDORDER_SINGLE);
        borane.addBond(2, 4, CDKConstants.BONDORDER_SINGLE);
        borane.addBond(3, 5, CDKConstants.BONDORDER_SINGLE);
        borane.addBond(4, 5, CDKConstants.BONDORDER_SINGLE);
    ...
    public void testGetHeavyAtoms_IAtomContainer() {
        ...
        for (int i = 0; i < 4; i++) container.addAtom(builder.newAtom("H"));
