...
public class SQLQueryParser {
   ...
   */
    private void parse(XConnection xconn, int override) {
        ...
        if (override == NO_INLINE_PARSER) m_InlineVariables = false; else if (override == INLINE_PARSER) m_InlineVariables = true;
   ...
   */
    public String getSQLQuery() {
        if (m_InlineVariables) return m_ParsedQuery.toString(); else return m_OrigQuery;
    }
   ...
   */
    protected void inlineParser() {
        ...
        for (int idx = 0; idx < m_OrigQuery.length(); idx++) {
            ...
            switch(state) {
                case 0:
                    if (ch == '\'') state = 1; else if (ch == '?') state = 4; else if (firstword && (Character.isLetterOrDigit(ch) || ch == '#')) {
                        tok.append(ch);
                        state = 3;
                    }
                    ...
                    break;
                case 1:
                    if (ch == '\'') state = 0; else if (ch == '\\') state = 2;
                    m_ParsedQuery.append(ch);
                    break;
                case 2:
                    state = 1;
                    ...
                    break;
                case 3:
                    if (Character.isLetterOrDigit(ch) || ch == '#' || ch == '_') tok.append(ch); else {
                        ...
                        if (ch == '\'') state = 1; else if (ch == '?') state = 4; else state = 0;
                    }
                    m_ParsedQuery.append(ch);
                    break;
                case 4:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    if (!Character.isWhitespace(ch) && ch != ']') tok.append(ch); else if (tok.length() > 0) {
