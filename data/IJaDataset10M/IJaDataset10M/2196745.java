...
public class DefaultWizardComponents implements WizardComponents {
    ...
    public void addWizardPanel(WizardPanel panel) {
        ...
        wizardPanelsContainer.add(panel, getWizardPanelList().size() - 1 + "");
    }
    ...
    public void updateComponents() {
        try {
            ...
            PropertyChangeEvent event = new PropertyChangeEvent(this, WizardComponents.CURRENT_PANEL_PROPERTY, null, getCurrentPanel());
