...
public class front_faceType extends com.jmex.xml.xml.Node {

    public front_faceType(front_faceType node) {
        super(node);
    }

    public front_faceType(org.w3c.dom.Node node) {
        super(node);
    }

    public front_faceType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public front_faceType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "front_face");
    }
    ...
    public gl_front_face_type newvalue2() {
        return new gl_front_face_type();
    }

    public gl_front_face_type getvalue2At(int index) throws Exception {
        return new gl_front_face_type(getDomNodeValue(getDomChildAt(Attribute, null, "value", index)));
    }
    ...
    public gl_front_face_type getvalue2ValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new com.jmex.xml.xml.XmlException("Out of range"); else return new gl_front_face_type(getDomNodeValue(curNode));
    }

    public gl_front_face_type getvalue2() throws Exception {
    ...
    public org.w3c.dom.Node addvalue2(gl_front_face_type value) {
    ...
    public org.w3c.dom.Node addvalue2(String value) throws Exception {
        return addvalue2(new gl_front_face_type(value));
    }

    public void insertvalue2At(gl_front_face_type value, int index) {
    ...
    public void insertvalue2At(String value, int index) throws Exception {
        insertvalue2At(new gl_front_face_type(value), index);
    }

    public void replacevalue2At(gl_front_face_type value, int index) {
    ...
    public void replacevalue2At(String value, int index) throws Exception {
        replacevalue2At(new gl_front_face_type(value), index);
    }
