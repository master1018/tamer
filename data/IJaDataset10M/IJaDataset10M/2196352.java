...
public abstract class GClientGeocoder extends AjaxEventBehavior {
    ...
    protected void onEvent(AjaxRequestTarget target) {
        ...
        onGeoCode(target, Integer.parseInt(request.getParameter("status")), request.getParameter("address"), GLatLng.parse(request.getParameter("point")));
    }
    ...
    protected CharSequence generateCallbackScript(CharSequence partialCall) {
        return "Wicket.geocoder.getLatLng('" + getCallbackUrl() + "', '" + addressField.getMarkupId() + "');" + "return false;";
    }
}
