 ...
 * @version $Revision: 156 $, $Date: 2006-01-02 16:13:26 -0500 (Mon, 02 Jan 2006) $
 * @since 1.5
 */
final class ExportToText extends LedgerSelectionAction {
    ...
    protected void actionPerformed(List selected) {
        ...
        if (JFileChooser.APPROVE_OPTION != chooser.showSaveDialog(RvSnooperGUI.getAppFrame())) return;
        ...
        try {
            ...
            for (int i = 0, imax = selected.size(); i < imax; ++i) bw.write(MarshalRvToString.marshal("", ((Record) selected.get(i)).getMessage()));
