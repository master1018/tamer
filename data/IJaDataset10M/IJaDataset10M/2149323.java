...
public class MainChatClient implements ChatClient, ObjSession {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RemoteChatServer server = ChatHelper.newServer(uri, null, new ChatHelper.ChatClientFactory() {

            public ChatClient newChatClient(RemoteChatServer server) throws Exception {
                return client;
            }
        });
    ...
    private static void do_who(MainChatClient client) {
        for (String name : client.getWhoIsOnline()) System.out.println("  " + name);
    }
