...
public class ZoieHtmlCreator {
    ...
    public static String getSimpleComparisonHeadingHtml(String[] expectedHeaders) {
        ...
        for (int i = 0; i < expectedHeaders.length; i++) {
            if (i == 0) {
                result = result + "<th title=\"" + expectedHeaders[i] + "\">" + expectedHeaders[i] + "</th> ";
            } else {
                result = result + "<th colspan=\"2\" title=\"" + "DIFFERENCE IN " + expectedHeaders[i] + "\">" + "DIFFERENCE IN " + expectedHeaders[i] + "</th> ";
            }
        }
        result = result + "\n</tr>\n";
        return result;
    ...
    public static String getSimpleNormalRowHtmlString(String key, String[] expectedHeaders, String[] values, String versionOne) {
        String verString = "";
        ...
        for (int i = 0; i < expectedHeaders.length; i++) {
            row = row + "<td title=\"Value of " + expectedHeaders[i] + verString + "\">" + values[i] + "  </td>\n";
        }
        row = row + "</tr>\n";
        return row;
    }

    public static String getSimpleNormalRowHtmlString(String key, GenericStatisticsUtil su, String versionOne) {
        String[] expectedHeaders = GenericStatisticsUtil.getHeaders();
        String[] values = new String[] { su.getCount() + "", su.getMin() + "", su.getMax() + "", PerformanceManager.truncateNumber(su.getMean(), 3) + "", su.getMedian() + "", PerformanceManager.truncateNumber(su.getStandardDeviation(), 3) + "", su.getNthPercentile(90) + "" };
        String verString = "";
        if ((versionOne != null) && (!"".equals(versionOne.trim()))) {
            verString = " in version " + versionOne;
        }
    ...
    public static String getSimpleTableHtmlString(String key, String[] scenarios, GenericStatisticsUtil[] su, String versionOne) {
        String table = "<table class=\"details\" border=\"0\" cellpadding=\"5\" cellspacing=\"2\" width=\"95%\">\n";
        table = table + getSimpleNormalHeadingHtml(key, GenericStatisticsUtil.getHeaders()) + "\n";
