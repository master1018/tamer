...
public class PasteAction extends SelectionAction {
    ...
    protected boolean calculateEnabled() {
        if (getClipboardContents() != null) return true;
        return false;
    }
    ...
    public void run() {
        ...
        for (Iterator iter = list.iterator(); iter.hasNext(); ) {
            ...
            if (!(next instanceof EditPart)) return;
            EditPart clipboardItem = (EditPart) next;
            StructuredSelection selection = (StructuredSelection) getSelection();
            Object selectedObj = selection.getFirstElement();
            if (!(selectedObj instanceof EditPart)) return;
            ...
            if (clipboardItem.getModel() instanceof PageElement) {
                ...
                if (target.getModel() instanceof PageElement) target = target.getParent();
                ...
                if (target.getModel() instanceof PageElement) target = target.getParent();
                while (target.getModel() instanceof IContext) target = target.getParent();
