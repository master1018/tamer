...
import org.eclipse.epsilon.fptc.system.diagram.edit.helpers.SystemBaseEditHelper;
import org.eclipse.epsilon.fptc.system.diagram.part.SystemVisualIDRegistry;
 ...
 * @generated
 */
public class SystemBaseItemSemanticEditPolicy extends SemanticEditPolicy {
    ...
    public Command getCommand(Request request) {
        if (request instanceof ReconnectRequest) {
            ...
            if (view instanceof View) {
                Integer id = new Integer(SystemVisualIDRegistry.getVisualID((View) view));
    ...
    protected Command getSemanticCommand(IEditCommandRequest request) {
        ...
        if (semanticCommand != null) {
            ...
            completedRequest.setParameter(SystemBaseEditHelper.EDIT_POLICY_COMMAND, command);
        }
        if (elementType != null) {
    ...
    public static class LinkConstraints {
		 ...
		 * @generated
		 */
        public static boolean canCreateConnection_4002(System container, Block source, Block target) {
            return canExistConnection_4002(container, source, target);
        }

        /**
		 * @generated
		 */
        public static boolean canExistConnection_4002(System container, Block source, Block target) {
            return true;
        }
    }
}
