...
public class Info extends MarshallableObject implements Element, IdentifiableElement {
    ...
    private IdentifiableElement _Idref;
    ...
    public IdentifiableElement getIdref() {
        return _Idref;
    }

    public void setIdref(IdentifiableElement _Idref) {
        this._Idref = _Idref;
        if (_Idref == null) {
            invalidate();
        }
    ...
    public void validate(Validator v) throws StructureValidationException {
        if (_Idref != null) v.reference(_Idref);
        if (_Attribute != null) {
    ...
    public void unmarshal(Unmarshaller u) throws UnmarshalException {
        ...
        while (xs.atAttribute()) {
            ...
            if (an.equals("idref")) {
                ...
                v.reference(xs.takeAttributeValue(), new IdrefVPatcher());
                continue;
            }
    ...
    public static Info unmarshal(InputStream in) throws UnmarshalException {
        return unmarshal(XMLScanner.open(in));
    }

    public static Info unmarshal(XMLScanner xs) throws UnmarshalException {
        return unmarshal(xs, newDispatcher());
    }

    public static Info unmarshal(XMLScanner xs, Dispatcher d) throws UnmarshalException {
        return ((Info) d.unmarshal(xs, (Info.class)));
    }
    ...
    public int hashCode() {
        ...
        h = ((179 * h) + ((_Idref != null) ? _Idref.id().hashCode() : 0));
    ...
    private class IdrefVPatcher extends Validator.Patcher {
