...
public class Plugin extends AbstractUIPlugin implements IStartup {
    ...
    static {
        try {
            resources = ResourceBundle.getBundle("core", Locale.getDefault(), Plugin.class.getClassLoader());
    ...
    public static void log(int iStatus, String msg, Throwable t) {
        getPlugin().getLog().log(new Status(iStatus, "ui", IStatus.OK, msg, t));
    }
