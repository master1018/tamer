...
public class JPanelSQL extends JPanel implements JPanelView {
    ...
    public JPanelSQL(AppView oApp) {
        ...
        try {
            BaseSentence sent = new MetaSentence(m_App.getSession(), "getTables", new SerializerWriteBasic(new Datas[] { Datas.STRING, Datas.STRING }), new SerializerReadBasic(new Datas[] { Datas.STRING, Datas.STRING, Datas.STRING, Datas.STRING, Datas.STRING }));
            ...
            rs.close();
            sent.closeExec();
            sent = new MetaSentence(m_App.getSession(), "getColumns", new SerializerWriteBasic(new Datas[] { Datas.STRING, Datas.STRING, Datas.STRING }), new SerializerReadBasic(new Datas[] { Datas.STRING, Datas.STRING, Datas.STRING, Datas.STRING, Datas.STRING }));
    ...
    private void m_jbegintransActionPerformed(java.awt.event.ActionEvent evt) {
        try {
    ...
    private void m_jrollbackActionPerformed(java.awt.event.ActionEvent evt) {
        try {
    ...
    private void m_jcommitActionPerformed(java.awt.event.ActionEvent evt) {
        try {
    ...
    private void m_jtabdeleteActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void m_jForwardActionPerformed(java.awt.event.ActionEvent evt) {
        m_iHistoryIndex++;
        m_jtxtSQL.setText((String) m_aHistory.get(m_iHistoryIndex));
        statusButtons();
    }

    private void m_jBackActionPerformed(java.awt.event.ActionEvent evt) {
        m_iHistoryIndex--;
        m_jtxtSQL.setText((String) m_aHistory.get(m_iHistoryIndex));
        statusButtons();
    }

    private void m_jTreeDBTreeExpanded(javax.swing.event.TreeExpansionEvent evt) {
    }
