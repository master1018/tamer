package de.uniwue.tm.textmarker.condition;
...
import de.uniwue.tm.textmarker.kernel.rule.EvaluatedCondition;
...
public class VoteCondition extends TerminalTextMarkerCondition {
    ...
    @Override
    public EvaluatedCondition eval(TextMarkerBasic basic, Type matchedType, TextMarkerRuleElement element, TextMarkerStream stream, InferenceCrowd crowd) {
        int count1 = 0;
        int count2 = 0;
        int totalCount = 0;
        if (matchedType == null) return new EvaluatedCondition(this, false);
