...
public class ClassChoosePanelDescriptor extends WizardPanelDescriptor implements OREManagerListener, ListSelectionListener, ChangeListener, ActionListener {
     ...
     */
    public static final String AUTO_LEARN_INFORMATION = "Adjust the parameters for automatic learning mode, " + "then press <Next>";

    public static final String MANUAL_LEARN_INFORMATION = "Above all atomic classes which have at least one individual are listed. " + "Select one of them for which you want to learn equivalent class or superclass expressions," + " then press <Next>";

    public static final String SKIP_LEARN_INFORMATION = "Choose one of the learning modes above, or press " + " <Next> to finish the wizard.";

    public static final String NO_LEARNING_SUPPORTED_INFORMATION = "LEarning is not supported because the currently loaded ontology contains no individuals. " + "Please choose another ontology or press <Next> to finish the wizard.";
    ...
    private void setNextButtonAccordingToConceptSelected() {
        ...
        if (classChoosePanel.getClassesTable().getSelectedRow() >= 0 || classChoosePanel.isAutoLearnMode() || man.getLearningMode() == LearningMode.OFF) {
