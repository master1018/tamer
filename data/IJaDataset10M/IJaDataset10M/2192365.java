...
public class XmlMerger {
    ...
    private void doUpdate() throws XMLStreamException, IOException {
        ...
        try {
            ...
            while (reader.hasNext()) {
                ...
                if (xmlEvent instanceof Comment) continue;
                if (xmlEvent.isCharacters()) if (xmlEvent.asCharacters().isWhiteSpace() || xmlEvent.asCharacters().isIgnorableWhiteSpace()) continue;
                writer.add(xmlEvent);
    ...
    private void processImportElement(StartElement element, XMLEventWriter writer, Properties metadata) throws XMLStreamException, IOException {
        ...
        if (!file.exists()) throw new FileNotFoundException("Missing file to import:" + file.getPath());
    ...
    private static class TimeCheckerHandler extends DefaultHandler {
        ...
        private boolean checkFile(File file) {
            ...
            try {
                ...
                if (!data.equals(hash)) return true;
            } catch (IOException e) {
