...
abstract class DecisionTree extends BinaryClassifier implements Serializable, Visible {
   ...
   */
    public static class InternalNode extends DecisionTree implements Visible {
        ...
        public double score(Instance instance) {
            if (instance.getWeight(test) >= threshold) return ifTrue.score(instance); else return ifFalse.score(instance);
        }
