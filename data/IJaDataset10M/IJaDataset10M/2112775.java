...
public class ImageTagTest {
    ...
    public void testFullImageTag() {
        ...
        Assert.assertEquals("<div class=\"image\"><img src=\"../resources/imagem.png\" alt=\"Imagem de alguma coisa\" />" + "<span class=\"image\">Imagem de alguma coisa</span></div>", result);
    }
    ...
    public void testImageTagWithoutDesc() {
        ...
        Assert.assertEquals("<div class=\"image\"><img src=\"../resources/imagem.png\" alt=\"imagem.png\" /></div>", result);
    }
