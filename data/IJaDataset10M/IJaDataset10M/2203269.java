...
public class IDirectInputDeviceA_Mouse extends IUnknown {
    ...
    public static int create(String name, int flags) {
        ...
        if (vtable == 0) vtable = createVTable();
        int address = allocate(vtable, DATA_SIZE, 0);
        setData(address, OFFSET_FLAGS, flags);
        return address;
    }

    private static Callback.Handler GetCapabilities = new HandlerBase() {
    ...
    private static Callback.Handler EnumObjects = new HandlerBase() {
    ...
    private static Callback.Handler GetProperty = new HandlerBase() {
    ...
    private static Callback.Handler SetProperty = new HandlerBase() {
    ...
    private static Callback.Handler Acquire = new HandlerBase() {
    ...
    private static Callback.Handler Unacquire = new HandlerBase() {
    ...
    private static Callback.Handler GetDeviceState = new HandlerBase() {
    ...
    private static Callback.Handler GetDeviceData = new HandlerBase() {
    ...
    private static Callback.Handler SetDataFormat = new HandlerBase() {
    ...
    private static Callback.Handler SetEventNotification = new HandlerBase() {
    ...
    private static Callback.Handler SetCooperativeLevel = new HandlerBase() {
    ...
    private static Callback.Handler GetObjectInfo = new HandlerBase() {
    ...
    private static Callback.Handler GetDeviceInfo = new HandlerBase() {
    ...
    private static Callback.Handler RunControlPanel = new HandlerBase() {
    ...
    private static Callback.Handler Initialize = new HandlerBase() {
