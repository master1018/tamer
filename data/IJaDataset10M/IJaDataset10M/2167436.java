 ...
 * @web.listener
 */
public class RollerSession implements HttpSessionListener, HttpSessionActivationListener {

    private static Log mLogger = LogFactory.getFactory().getInstance(RollerSession.class);
    ...
    public void sessionCreated(HttpSessionEvent se) {
        ...
        RollerContext rctx = RollerContext.getRollerContext(se.getSession().getServletContext());
     ...
     * @param useReferer If true try to return the "referer" header.
     */
    public static String getBreadCrumb(HttpServletRequest req, boolean useReferer) {
        String crumb = null;
        HttpSession ses = req.getSession(false);
        if (ses != null && ses.getAttribute(BREADCRUMB) != null) {
            ArrayStack stack = (ArrayStack) ses.getAttribute(BREADCRUMB);
