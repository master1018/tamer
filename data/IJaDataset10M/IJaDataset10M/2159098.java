...
public class Messager extends Log implements DocErrorReporter {
    ...
    public static Messager instance0(Context context) {
        ...
        if (instance == null || !(instance instanceof Messager)) throw new InternalError("no messager instance!");
    ...
    public void printNotice(SourcePosition pos, String msg) {
        if (pos == null) noticeWriter.println(msg); else noticeWriter.println(pos + ": " + msg);
        noticeWriter.flush();
    }
