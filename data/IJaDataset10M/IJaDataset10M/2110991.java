...
import bpmn.diagram.edit.policies.BpmnTextSelectionEditPolicy;
import bpmn.diagram.part.BpmnVisualIDRegistry;
import bpmn.diagram.providers.BpmnElementTypes;
 ...
 * @generated
 */
public class TimerEventNameEditPart extends BpmnExtNodeLabelEditPart implements ITextAwareEditPart {
	 ...
	 */
    static {
        registerSnapBackPosition(BpmnVisualIDRegistry.getType(TimerEventNameEditPart.VISUAL_ID), new Point(0, 0));
    }

    /**
	 * @generated
	 */
    public TimerEventNameEditPart(View view) {
        super(view);
    }
            ...
            ParserHintAdapter hintAdapter = new ParserHintAdapter(getParserElement(), parserHint) {
                ...
                public Object getAdapter(Class adapter) {
                    if (IElementType.class.equals(adapter)) {
                        return BpmnElementTypes.TimerEvent_2013;
                    }
    ...
    protected DirectEditManager getManager() {
        if (manager == null) {
            setManager(new TextDirectEditManager(this, TextDirectEditManager.getTextCellEditorClass(this), BpmnEditPartFactory.getTextCellEditorLocator(this)));
        }
        return manager;
    }
