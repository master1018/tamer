...
class ExportConfigDialog extends AbstractDoneDialog {
   ...
   */
    ...
    public ExportConfigDialog() {
        ...
        getDoneButton().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                prefs.putBoolean(EngineSpecificationExporter.VERIFICATION_WITH_EXPORT_PREFERENCE, verificationCheckBox.isSelected());
                prefs.putBoolean(EngineSpecificationExporter.ANALYSIS_WITH_EXPORT_PREFERENCE, analysisCheckBox.isSelected());
                prefs.putBoolean(EngineSpecificationExporter.AUTO_INCREMENT_VERSION_WITH_EXPORT_PREFERENCE, autoIncVersionCheckBox.isSelected());
                prefs.putBoolean(EngineSpecificationExporter.FILE_BACKUP_PREFERENCE, backupCheckBox.isSelected());
                prefs.putBoolean(EngineSpecificationExporter.FILE_VERSIONING_PREFERENCE, versionCopyCheckBox.isSelected());
                ...
                ArchivingThread.getInstance().engineFileExport(SpecificationModel.getInstance());
            }
        });
    }
    ...
    private JFormattedSelectField getVersionNumberField() {
        ...
        versionNumberField.setInputVerifier(new SpecificationVersionVerifier(SpecificationModel.getInstance().getVersionNumber()));
    ...
    private JCheckBox getAutoIncVersionCheckBox() {
        ...
        autoIncVersionCheckBox.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                if (!initialising) {
                    SpecificationVersionVerifier verifier = (SpecificationVersionVerifier) versionNumberField.getInputVerifier();
    ...
    public void showOrHideSpecIDField() {
        ...
        if (idLabel != null) idLabel.setVisible(showField);
        if (specificationIDField != null) specificationIDField.setVisible(showField);
    ...
    public void setVisible(boolean visible) {
        if (visible) {
            initialising = true;
            verificationCheckBox.setSelected(prefs.getBoolean(EngineSpecificationExporter.VERIFICATION_WITH_EXPORT_PREFERENCE, true));
            analysisCheckBox.setSelected(prefs.getBoolean(EngineSpecificationExporter.ANALYSIS_WITH_EXPORT_PREFERENCE, true));
            autoIncVersionCheckBox.setSelected(prefs.getBoolean(EngineSpecificationExporter.AUTO_INCREMENT_VERSION_WITH_EXPORT_PREFERENCE, true));
            backupCheckBox.setSelected(prefs.getBoolean(EngineSpecificationExporter.FILE_BACKUP_PREFERENCE, true));
            versionCopyCheckBox.setSelected(prefs.getBoolean(EngineSpecificationExporter.FILE_VERSIONING_PREFERENCE, true));
            ...
            SpecificationVersionVerifier svv = (SpecificationVersionVerifier) versionNumberField.getInputVerifier();
    ...
    class SpecificationIdFieldDocumentListener implements KeyListener {
        ...
        private boolean nameFieldValid() {
            return specificationIDField.getInputVerifier().verify(specificationIDField) && !specificationIDField.getText().equals("unnamed.ywl");
        }
    }
