...
public class TestMinguoDate {
    ...
    public void test_factory_of_3_invalidYear() throws Exception {
        try {
            MinguoDate.of(10000, testMonthOfYear, testDayOfMonth);
            fail();
    ...
    public void test_factory_of_3_invalidDay() throws Exception {
        try {
            MinguoDate.of(testYear, testMonthOfYear, 40);
            fail();
        } catch (IllegalCalendarFieldValueException ex) {
    ...
    private int[] getGregorianEraYearFromLocalEraYear(int localEra, int localYear) {
        int gregorianEraYear[] = new int[2];
        int gYear = 1 == localEra ? localYear + 1911 : (1 - localYear) + 1911;
        int gEra = 1;
        if (gYear < 0) {
            gYear = 1 - gYear;
            gEra = 0;
