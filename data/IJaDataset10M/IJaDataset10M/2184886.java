...
Sincronica o Asincronica */
    public void setReplication_Type(String Replication_Type) {
        if (Replication_Type == null || Replication_Type.equals("A") || Replication_Type.equals("S")) ; else throw new IllegalArgumentException("Replication_Type Invalid value - Reference = REPLICATION_TYPE_AD_Reference_ID - A - S");
