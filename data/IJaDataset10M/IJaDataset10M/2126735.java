...
public class SslListener extends SocketListener {
    ...
    protected ServerSocket newServerSocket(InetAddrPort p_address, int p_acceptQueueSize) throws IOException {
        ...
        try {
            ...
            if (_needClientAuth) socket.setNeedClientAuth(true); else if (_wantClientAuth) socket.setWantClientAuth(true);
    ...
    protected void customizeRequest(Socket socket, HttpRequest request) {
        ...
        if (!(socket instanceof javax.net.ssl.SSLSocket)) return;
        try {
            ...
            if (certs != null) request.setAttribute("javax.servlet.request.X509Certificate", certs); else if (_needClientAuth) throw new HttpException(HttpResponse.__403_Forbidden);
