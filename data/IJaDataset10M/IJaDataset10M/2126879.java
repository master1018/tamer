...
public class Reference implements Cloneable, Serializable {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Reference) {
            ...
            return new EqualsBuilder().append(localColumnName, other.localColumnName).append(foreignColumnName, other.foreignColumnName).isEquals();
        } else {
            return false;
        }
    }
    ...
    public boolean equalsIgnoreCase(Reference otherRef) {
        return (otherRef != null) && localColumnName.equalsIgnoreCase(otherRef.localColumnName) && foreignColumnName.equalsIgnoreCase(otherRef.foreignColumnName);
    }
