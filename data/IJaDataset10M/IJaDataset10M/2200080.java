...
public class ClasspathPreferences extends CayenneController {
    ...
    protected Domain getClassLoaderDomain() {
        return editor.editableInstance(getApplication().getPreferenceDomain()).getSubdomain(FileClassLoadingService.class);
    }
    ...
    class ClasspathTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            PreferenceDetail preference = (PreferenceDetail) classPathEntries.get(rowIndex);
