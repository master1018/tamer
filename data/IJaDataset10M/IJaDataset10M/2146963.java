...
public class MessagePopupShell implements AnimableShell {
    ...
    public MessagePopupShell(Display display, String icon, String title, String errorMessage, String details) {
        ...
        gcImage.dispose();
        if (!bItFit && details == null) details = errorMessage;
        if (details != null) textDetails.setText(details);
            ...
            public void run() {
                display.syncExec(new AERunnable() {
                    ...
                    public void runSupport() {
                        ...
                        if (notTopWindow || mouseOver || animationInProgress || detailsOpen) return;
                        hideShell();
                    }
                });
            }
