...
public class GraphMLIOTest {
    ...
    public static Graph<Integer> sample1() {
        if (SAMPLE1 == null) SAMPLE1 = (Graph<Integer>) GraphMLIO.getInstance().importGraph(new HashMap<Integer, double[]>(), GraphMLIO.class.getResource("data/simple.graphml"), GraphType.REGULAR);
        return SAMPLE1;
    }
