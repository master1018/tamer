...
public class MynaServer extends Thread {
    ...
    public static void runAsWatchdog() throws Exception {
        ...
        if (isJar) {
            cp = web_inf + "classes" + pathSep + web_inf + "lib" + fileSep + "*";
        }
        ...
        cmd.append(" -Dmyna.hasWatchdog=true " + " -cp " + cp + " info.emptybrain.myna.MynaServer " + " -c " + webctx + " -p " + new Integer(port).toString() + " -w " + webroot + " -l " + logFile);
        ;
        ...
        do {
            ...
            File propsFile = new File(new File(webroot).toURI().resolve("WEB-INF/classes/general.properties"));
