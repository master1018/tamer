...
public class CocoonServletRequest implements HttpServletRequest {
    ...
    public CocoonServletRequest(File path, String document, HttpServletRequest req) {
        if (path != null) this.path = path.toString();
    ...
    public String getPathInfo() {
        if (path != null) return "";
        if (req != null) return req.getPathInfo();
        return "";
    }
    ...
    public BufferedReader getReader() throws IOException {
        if (document != null) return new BufferedReader(new StringReader(document));
        if (req != null) return req.getReader();
        return null;
    }
    ...
    public Enumeration getParameterNames() {
        if ((req != null) && (params.size() > 0)) {
            ...
            while (reqNames.hasMoreElements()) names.addElement(reqNames.nextElement());
            reqNames = params.keys();
            while (reqNames.hasMoreElements()) names.addElement(reqNames.nextElement());
            return params.elements();
        }
        if (req != null) return req.getParameterNames();
        if (params.size() > 0) return params.keys();
        return null;
    }
    ...
    public void addParameter(String name, String value) {
        if (params.containsKey(name)) {
            ...
            for (int i = 0; i < old.length; i++) current[i] = old[i];
    ...
    public String[] getParameterValues(String name) {
        ...
        if (req != null) return req.getParameterValues(name);
        return null;
    }
    ...
    public String getParameter(String name) {
        if (params.containsKey(name)) return ((String[]) params.get(name))[0];
        if (req != null) {
            String value = req.getParameter(name);
            if (value != null) return value;
        }
        if ((document != null) && (name.equalsIgnoreCase("producer"))) return "org.apache.cocoon.producer.ProducerFromRequest";
        return null;
    }

    public String getAuthType() {
        if (req != null) return req.getAuthType();
        return null;
    }
    ...
    public Object getAttribute(String name) {
        if (req != null) return req.getAttribute(name);
        return null;
    }

    public Enumeration getAttributeNames() {
        if (req != null) return req.getAttributeNames();
        return null;
    }

    public void setAttribute(String name, Object value) {
        if (req != null) req.setAttribute(name, value);
    }

    public void removeAttribute(String name) {
        if (req != null) req.removeAttribute(name);
    }

    public String getContextPath() {
        if (req != null) return req.getContextPath();
        return null;
    }

    public Cookie[] getCookies() {
        if (req != null) return req.getCookies();
        return null;
    }

    public long getDateHeader(String name) {
        if (req != null) return req.getDateHeader(name);
        return -1;
    }

    public String getHeader(String name) {
        if (req != null) return req.getHeader(name);
        return null;
    }

    public Enumeration getHeaders(String name) {
        if (req != null) return req.getHeaders(name);
        return null;
    }

    public Enumeration getHeaderNames() {
        if (req != null) return req.getHeaderNames();
        return null;
    }

    public int getIntHeader(String name) {
        if (req != null) return req.getIntHeader(name);
        return -1;
    }

    public String getMethod() {
        if (req != null) return req.getMethod();
        return null;
    }

    public String getPathTranslated() {
        if (path != null) return path;
        if (req != null) if (req.getPathTranslated() != null) return req.getPathTranslated();
        return File.separator;
    }

    public String getQueryString() {
        if (req != null) return req.getQueryString();
        return null;
    }

    public String getRemoteUser() {
        if (req != null) return req.getRemoteUser();
        return null;
    }

    public String getRequestedSessionId() {
        if (req != null) return req.getRequestedSessionId();
        return null;
    }

    public String getRequestURI() {
        if (req != null) return req.getRequestURI();
        return null;
    }

    public String getServletPath() {
        if (req != null) return req.getServletPath();
        return null;
    }

    public HttpSession getSession() {
        if (req != null) return req.getSession();
        return null;
    }

    public HttpSession getSession(boolean create) {
        if (req != null) return req.getSession(create);
        return null;
    }

    public boolean isRequestedSessionIdFromCookie() {
        if (req != null) return req.isRequestedSessionIdFromCookie();
        return false;
    }

    public boolean isRequestedSessionIdFromURL() {
        if (req != null) return req.isRequestedSessionIdFromURL();
        return false;
    }

    public boolean isRequestedSessionIdValid() {
        if (req != null) return req.isRequestedSessionIdValid();
        return false;
    }
    ...
    public int getServerPort() {
        if (req != null) return req.getServerPort();
        return -1;
    }

    public String getServerName() {
        if (req != null) return req.getServerName();
        return null;
    }

    public String getContentType() {
        if (req != null) return req.getContentType();
        return null;
    }

    public ServletInputStream getInputStream() throws IOException {
        if (req != null) return req.getInputStream();
        return null;
    }

    public String getScheme() {
        if (req != null) return req.getScheme();
        return null;
    }

    /** @deprecated */
    public String getRealPath(String path) {
        if (req != null) return req.getRealPath(path);
        return null;
    }

    public boolean isSecure() {
        if (req != null) return req.isSecure();
        return false;
    }

    public Locale getLocale() {
        if (req != null) return req.getLocale();
        return null;
    }

    public Enumeration getLocales() {
        if (req != null) return req.getLocales();
        return null;
    }

    public boolean isUserInRole(String role) {
        if (req != null) return req.isUserInRole(role);
        return false;
    }

    public RequestDispatcher getRequestDispatcher(String path) {
        if (req != null) return req.getRequestDispatcher(path);
        return null;
    }

    public String getCharacterEncoding() {
        if (req != null) return req.getCharacterEncoding();
        return null;
    }

    public String getProtocol() {
        if (req != null) return req.getProtocol();
        return null;
    }
    ...
    public String getRemoteHost() {
        if (req != null) return req.getRemoteHost();
        return null;
    }

    public int getContentLength() {
        if (req != null) return req.getContentLength();
        return -1;
    }
}
