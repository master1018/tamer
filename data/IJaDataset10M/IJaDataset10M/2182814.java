...
public abstract class DeltaJTypeSystemRule extends RuntimeRule {
    ...
    public DeltaJTypeSystemRule(String ruleName, String typeJudgmentSymbol, String typeStatementRelation) {
        super(ruleName, typeJudgmentSymbol, typeStatementRelation);
    }

    public void applyTypeRule(TypingJudgmentEnvironment environment, Object left, Object right) throws RuleFailedException {
        addAppliedRuleToTrace(((DeltaJTypeSystemDefinition) runtimeTypeSystem).applyTypeRule(environment, left, right));
    }
}
