package org.systemsEngineering.workbench.core.ui.wizards;
...
public class SampleNewWizard extends Wizard implements INewWizard {
    ...
    /**
         ...
         * We will create an operation and run it using wizard as execution
         * context.
         */
    ...
    private void throwCoreException(String message) throws CoreException {
        IStatus status = new Status(IStatus.ERROR, "Wirksamkeitsanalyse", IStatus.OK, message, null);
