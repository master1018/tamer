...
public class ControllerTableViewer extends JPanel {
    ...
    class TableModel extends AbstractTableModel implements ControllerStateListener {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            if (columnIndex == 0) return ctrl.getState(); else if (columnIndex == 1) return ctrl; else if (columnIndex == 2) return ctrl.getType(); else if (columnIndex == 3) return ctrl.getCtrlClass().getModuleName(); else if (columnIndex == 4) return ctrl.getCtrlClass().getClassName(); else if (columnIndex == 5) return ctrl.getLanguage(); else if (columnIndex == 6) return ctrl.getCtrlClass().getFileName(); else return null;
        }
