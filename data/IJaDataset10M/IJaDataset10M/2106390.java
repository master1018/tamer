...
public abstract class APersistentVector extends AFn implements IPersistentVector, Iterable, List, RandomAccess, Comparable, Streamable {
    ...
    public int compareTo(Object o) {
        ...
        if (count() < v.count()) return -1; else if (count() > v.count()) return 1;
    ...
    static class Seq extends ASeq implements IndexedSeq, IReduce {
        ...
        public Object reduce(IFn f) throws Exception {
            Object ret = v.nth(i);
            for (int x = i + 1; x < v.count(); x++) ret = f.invoke(ret, v.nth(x));
            return ret;
        }
    ...
    static class SubVector extends APersistentVector {
        ...
        public IPersistentVector assocN(int i, Object val) {
            if (start + i > end) throw new IndexOutOfBoundsException(); else if (start + i == end) return cons(val);
