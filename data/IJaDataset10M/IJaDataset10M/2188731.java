package net.jadoth.sqlengine.retrospection;

import static net.jadoth.codegen.java.Java.Lang.$final;
import static net.jadoth.codegen.java.Java.Lang.$new;
import static net.jadoth.codegen.java.Java.Lang.$protected;
import static net.jadoth.codegen.java.Java.Lang.$public;
import static net.jadoth.codegen.java.Java.Lang.$static;
import static net.jadoth.codegen.java.Java.Lang.$super;
import static net.jadoth.codegen.java.JavaSyntax.callMethod;
import static net.jadoth.lang.reflection.JaReflect.getFullClassName;
import static net.jadoth.lang.reflection.JaReflect.getMemberByLabel;
import static net.jadoth.lang.reflection.JaReflect.getMembersByLabel;
import static net.jadoth.lang.reflection.JaReflect.isOfClassType;
import static net.jadoth.sqlengine.SQL.LANG.AS;
...
import static net.jadoth.sqlengine.SQL.Punctuation.is;
import static net.jadoth.sqlengine.SQL.Punctuation.par;
import static net.jadoth.sqlengine.SQL.Punctuation.rap;
import java.io.File;
...
import net.jadoth.codegen.java.JavaRuntimeCompiler;
import net.jadoth.codegen.java.JavaRuntimeCompiler.CompilerStatusCode;
import net.jadoth.codegen.java.JavaSourceCode;
import net.jadoth.codegen.java.JavaSyntax;
...
import net.jadoth.sqlengine.internal.tables.SqlIndex;
import net.jadoth.sqlengine.internal.tables.SqlPrimaryKey;
...
import net.jadoth.sqlengine.retrospection.definition.IndexDefinition;
import net.jadoth.sqlengine.retrospection.definition.TableDefinition;
import net.jadoth.sqlengine.util.SqlEngineLabels;

/**
 * The Class MappingGenerator.
 */
@License(name = SqlEngineLicense.LICENSE_NAME, licenseClass = SqlEngineLicense.class, declaringClass = MappingGenerator.class)
public class MappingGenerator extends SqlEngineLabels {
    ...
    /** The rc. */
    private final JavaRuntimeCompiler rc = new JavaRuntimeCompiler();
    ...
    public final String createSingletonIndexClassCode(final String packagePath, final String className) {
        ...
        code.addLine(JavaSourceCode.annotation(SuppressWarnings.class, "\"serial\""));
        code.modifier($public).class_(className, null);
        String tableClassName = null;
        for (int i = 0; i < tableClassNames.length; i++) {
            tableClassName = getCanonicalNameLastElement(tableClassNames[i]);
            code.modifier($public, $static, $final).append(tableClassName, tableNames[i], is, $new, tableClassName + "()").endLine();
        }
        code.blockEnd();
    ...
    protected void generateConstructor(final JavaSourceCode code, final Java.Visibility visibility, final boolean schema, final boolean name, final boolean alias) {
        ...
        code.indent();
        final String params = new StringBuilder(64).append(schema ? CONSTRUCTOR_PARAMETERNAME_SCHEMA : STATIC_SQLSCHEMA).append(comma_).append(name ? CONSTRUCTOR_PARAMETERNAME_NAME : STATIC_SQLNAME).append(comma_).append(alias ? CONSTRUCTOR_PARAMETERNAME_ALIAS : STATIC_DEFAULTALIAS).toString();
    ...
    protected void generateAS(final JavaSourceCode code) {
        code.modifier(Java.Visibility.public_.toString()).append(this.className).append(_).method(AS, "final String newAlias").blockNewLineStart().addLine(JavaSourceCode.return_(par + this.className + rap + $super + dot + AS + par + "newAlias" + rap)).blockEnd();
    }
	 ...
	 */
    @SuppressWarnings("unchecked")
    protected Class<? extends SqlTable.Implementation.Indices> getSuperClassIndexInnerClass() {
        final Class<?>[] allInnerClasses = this.config.superClass.getDeclaredClasses();
        for (final Class<?> c : allInnerClasses) {
            if (isOfClassType(c, SqlTable.Implementation.Indices.class)) {
                return (Class<? extends SqlTable.Implementation.Indices>) c;
            }
        }
        return null;
    }
    ...
    public final String createSqlTableDefinitionCode() {
        ...
        final Class<? extends SqlTable.Implementation> superClass = this.config.superClass;
    ...
    public static class Configuration {
        ...
        public static final String defaultSingletonIndexClassName = "SqlTable.Implementations";

        /** The super class. */
        private Class<? extends SqlTable.Implementation> superClass = SqlTable.Implementation.class;
        ...
        private String tableClassFileType = null;
		 ...
		 */
        public Configuration setConstructorConfiguration(final Java.Visibility nullary, final Java.Visibility alias, final Java.Visibility name, final Java.Visibility schema, final Java.Visibility schemaAlias, final Java.Visibility nameAlias, final Java.Visibility schemaName, final Java.Visibility schemaNameAlias) {
		 ...
		 */
        public Class<? extends SqlTableIdentifier.Implementation> getSuperClass() {
		 ...
		 * @return the configuration
		 */
        public Configuration setSuperClass(final Class<? extends SqlTable.Implementation> superClass) {
