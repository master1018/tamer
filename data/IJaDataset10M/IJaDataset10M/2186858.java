...
public class IntersectionMatrix implements Cloneable {
   ...
   */
    public boolean isTouches(int dimensionOfGeometryA, int dimensionOfGeometryB) {
        ...
        if ((dimensionOfGeometryA == Dimension.A && dimensionOfGeometryB == Dimension.A) || (dimensionOfGeometryA == Dimension.L && dimensionOfGeometryB == Dimension.L) || (dimensionOfGeometryA == Dimension.L && dimensionOfGeometryB == Dimension.A) || (dimensionOfGeometryA == Dimension.P && dimensionOfGeometryB == Dimension.A) || (dimensionOfGeometryA == Dimension.P && dimensionOfGeometryB == Dimension.L)) {
            return matrix[Location.INTERIOR][Location.INTERIOR] == Dimension.FALSE && (matches(matrix[Location.INTERIOR][Location.BOUNDARY], 'T') || matches(matrix[Location.BOUNDARY][Location.INTERIOR], 'T') || matches(matrix[Location.BOUNDARY][Location.BOUNDARY], 'T'));
        }
        return false;
    }
   ...
   */
    public boolean isCrosses(int dimensionOfGeometryA, int dimensionOfGeometryB) {
        if ((dimensionOfGeometryA == Dimension.P && dimensionOfGeometryB == Dimension.L) || (dimensionOfGeometryA == Dimension.P && dimensionOfGeometryB == Dimension.A) || (dimensionOfGeometryA == Dimension.L && dimensionOfGeometryB == Dimension.A)) {
            return matches(matrix[Location.INTERIOR][Location.INTERIOR], 'T') && matches(matrix[Location.INTERIOR][Location.EXTERIOR], 'T');
        }
        if ((dimensionOfGeometryA == Dimension.L && dimensionOfGeometryB == Dimension.P) || (dimensionOfGeometryA == Dimension.A && dimensionOfGeometryB == Dimension.P) || (dimensionOfGeometryA == Dimension.A && dimensionOfGeometryB == Dimension.L)) {
            return matches(matrix[Location.INTERIOR][Location.INTERIOR], 'T') && matches(matrix[Location.EXTERIOR][Location.INTERIOR], 'T');
        }
   ...
   */
    public boolean isWithin() {
        return matches(matrix[Location.INTERIOR][Location.INTERIOR], 'T') && matrix[Location.INTERIOR][Location.EXTERIOR] == Dimension.FALSE && matrix[Location.BOUNDARY][Location.EXTERIOR] == Dimension.FALSE;
    }
   ...
   */
    public boolean isContains() {
        return matches(matrix[Location.INTERIOR][Location.INTERIOR], 'T') && matrix[Location.EXTERIOR][Location.INTERIOR] == Dimension.FALSE && matrix[Location.EXTERIOR][Location.BOUNDARY] == Dimension.FALSE;
    }
   ...
   */
    public boolean isCovers() {
        boolean hasPointInCommon = matches(matrix[Location.INTERIOR][Location.INTERIOR], 'T') || matches(matrix[Location.INTERIOR][Location.BOUNDARY], 'T') || matches(matrix[Location.BOUNDARY][Location.INTERIOR], 'T') || matches(matrix[Location.BOUNDARY][Location.BOUNDARY], 'T');
   ...
   */
    public boolean isEquals(int dimensionOfGeometryA, int dimensionOfGeometryB) {
        ...
        return matches(matrix[Location.INTERIOR][Location.INTERIOR], 'T') && matrix[Location.EXTERIOR][Location.INTERIOR] == Dimension.FALSE && matrix[Location.INTERIOR][Location.EXTERIOR] == Dimension.FALSE && matrix[Location.EXTERIOR][Location.BOUNDARY] == Dimension.FALSE && matrix[Location.BOUNDARY][Location.EXTERIOR] == Dimension.FALSE;
    }
   ...
   */
    public boolean isOverlaps(int dimensionOfGeometryA, int dimensionOfGeometryB) {
        if ((dimensionOfGeometryA == Dimension.P && dimensionOfGeometryB == Dimension.P) || (dimensionOfGeometryA == Dimension.A && dimensionOfGeometryB == Dimension.A)) {
            return matches(matrix[Location.INTERIOR][Location.INTERIOR], 'T') && matches(matrix[Location.INTERIOR][Location.EXTERIOR], 'T') && matches(matrix[Location.EXTERIOR][Location.INTERIOR], 'T');
        }
        if (dimensionOfGeometryA == Dimension.L && dimensionOfGeometryB == Dimension.L) {
            return matrix[Location.INTERIOR][Location.INTERIOR] == 1 && matches(matrix[Location.INTERIOR][Location.EXTERIOR], 'T') && matches(matrix[Location.EXTERIOR][Location.INTERIOR], 'T');
        }
        return false;
    }
