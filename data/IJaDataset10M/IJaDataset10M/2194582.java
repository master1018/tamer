...
public class CMLAngleTest {
    ...
    String s1 = CMLConstants.S_EMPTY + "<cml " + CMLConstants.CML_XMLNS + ">" + " <molecule id='m1'>" + "  <atomArray>" + "   <atom id='a1' x3='1.0' y3='0.0' z3='0.0'/>" + "   <atom id='a2' x3='0.0' y3='0.0' z3='0.0'/>" + "   <atom id='a3' x3='0.0' y3='0.0' z3='2.0'/>" + "  </atomArray>" + "  <bondArray>" + "    <bond atomRefs2='a1 a2'/>" + "    <bond atomRefs2='a3 a2'/>" + "  </bondArray>" + " </molecule>" + " <angle id='aa0' atomRefs3='a1 a2 a3'/>" + " <angle id='aa1' atomRefs3='a2 a1 a3'/>" + " <angle id='aa2' atomRefs3='a1 a2 a4'/>" + "</cml>" + CMLConstants.S_EMPTY;
    ...
    public final void testCopy() {
        ...
        StringTestBase.assertEquals("atomRefs3", new String[] { "a1", "a2", "a3" }, angle00.getAtomRefs3());
    }
    ...
    public final void testGetCalculatedAngle() {
        ...
        Assert.assertEquals("angle1 ", 2.0, Math.tan(angle * Math.PI / 180.), EPS);
        try {
    ...
    public final void testAtomHash() {
        ...
        Assert.assertEquals("atom hash", s, CMLAngle.atomHash("a1", "a2", "a3"));
        Assert.assertEquals("atom hash", s, CMLAngle.atomHash("a3", "a2", "a1"));
    }
    ...
    public final void testGetIndexedAngles() {
        ...
        StringTestBase.assertEquals("atomRefs3 ", new String[] { "a1", "a2", "a3" }, angle.getAtomRefs3());
