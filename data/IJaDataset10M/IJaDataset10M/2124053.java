 ...
 * @version $Id: Constructor.java 1941 2004-09-30 03:37:06Z joewhaley $
 */
public class Constructor extends AccessibleObject {
    ...
    private Constructor(java.lang.Class clazz, java.lang.Class[] parameterTypes, java.lang.Class[] exceptionTypes, int modifiers, int slot) {
        this.clazz = clazz;
    ...
    public java.lang.Object newInstance(java.lang.Object[] initargs) throws java.lang.InstantiationException, java.lang.IllegalAccessException, java.lang.IllegalArgumentException, java.lang.reflect.InvocationTargetException {
        ...
        if (nargs != argtypes.length - 1) throw new java.lang.IllegalArgumentException("Constructor takes " + (argtypes.length - 1) + " arguments, but " + nargs + " arguments passed in");
