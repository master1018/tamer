...
public class DefaultSASFHelper implements SASFHelper {
    ...
    private static final String SESSION_KEY = "S_SASFHelper";

    private static final String SESSION_SOCIAL_AUTH_PROVIDER = "SESSION_SOCIAL_AUTH_PROVIDER";

    private static final String SESSION_SOCIAL_AUTH_MANAGER = "SESSION_SOCIAL_AUTH_MANAGER";

    private static final String SESSION_ERROR = "S_SASFError";

    private static final String SESSION_ERROR_CAUSE = "S_SASFErrorCause";
    ...
    public DefaultSASFHelper(final HttpServletRequest req, final SASFProperties props, final SASFSocialAuthManager sdbSocialAuthManager, final HttpSession session) throws SASFSecurityException {
        this.request = req;
        this.props = props;
    ...
    public void setProvider(final AuthProvider provider) {
        this.session.setAttribute(DefaultSASFHelper.SESSION_SOCIAL_AUTH_PROVIDER, provider);
    }

    @Override
    public AuthProvider getProvider() {
        return (AuthProvider) this.getSession().getAttribute(DefaultSASFHelper.SESSION_SOCIAL_AUTH_PROVIDER);
    }

    @Override
    public void setAuthManager(final SocialAuthManager socialAuthManager) {
        this.session.setAttribute(DefaultSASFHelper.SESSION_SOCIAL_AUTH_MANAGER, socialAuthManager);
    }

    @Override
    public SocialAuthManager getAuthManager() {
        return (SocialAuthManager) this.getSession().getAttribute(DefaultSASFHelper.SESSION_SOCIAL_AUTH_MANAGER);
    }
    ...
    public String getOpenidReturnUrl() {
        String returnUrl = getURLWithContextPath() + this.props.getOpenidReturnUrl();
        return returnUrl;
    }
