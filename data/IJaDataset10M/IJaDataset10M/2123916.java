...
public class ServletContextXMLApplicationContext extends AbstractXMLApplicationContext {
    ...
    public ServletContextXMLApplicationContext(ServletContext servletContext, String[] locations, AbstractApplicationContext parent) {
        super(parent);
        this.resources = new Resource[locations.length];
        this.servletContext = servletContext;
        for (int i = 0; i < locations.length; i++) resources[i] = new ServletContextResource(servletContext, locations[i]);
    }

    public ServletContextXMLApplicationContext(ServletContext servletContext, String[] locations) {
        this(servletContext, locations, null);
    }

    public ServletContextXMLApplicationContext(ServletContext servletContext, String location) {
