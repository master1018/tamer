...
public class Workflow implements Serializable, Comparable<Workflow>, PermissionsAware {
   ...
   */
    ...
    public int compareTo(Workflow that) {
        ...
        if (that.getSwAccession() == this.getSwAccession()) return 0;
        if (that.getSwAccession() == null) return -1;
    ...
    public boolean givesPermission(Registration registration) {
        ...
        if (!hasPermission) {
            ...
            throw new SecurityException("User " + registration.getEmailAddress() + " does not have permission to modify aspects of workflow " + this.getName());
        } else {
