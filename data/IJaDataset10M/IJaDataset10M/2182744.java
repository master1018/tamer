...
public class ProgressiveString {
    ...
    public ProgressiveString(String original, CharInterval... charIntervals) {
        if (charIntervals.length == 0) throw new RuntimeException("CharIntervals can't be null!");
    ...
    private char[] copyChars(int start, char[] old) {
        ...
        for (int i = 0; i < old.length; i++) str[start + i] = old[i];
        return str;
    }
    ...
    public void increase() {
        ...
        for (int i = str.length - 1; i >= 0; i--) {
            ...
            if (result.result == IncreaseResult.INCREASED) break;
    ...
    private IncreaseResult tryIncrease(char c) {
        ...
        } else return new IncreaseResult(nextChar(c), IncreaseResult.INCREASED);
    }
    ...
    public static void main(String[] args) {
        ProgressiveString str = new ProgressiveString(String.valueOf((char) 33), new CharInterval('a', 'm'), new CharInterval('n', 'z'));
        int loops = 2500000;
