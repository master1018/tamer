...
public class ArticleContainerUtil {
    ...
    public static String getArticleContainerID(ArticleContainerID articleContainerID) {
        if (articleContainerID == null) return null;
        ...
        return organisationID + articleContainerID.getArticleContainerIDPrefix() + ID_SEPARATOR + articleContainerID.getArticleContainerIDAsString();
    }
