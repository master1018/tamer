...
public class XImage {
    ...
    public static final int XYBITMAP_FORMAT = 0, XYPIXMAP_FORMAT = 1, ZPIXMAP_FORMAT = 2;

    public static final int LEAST_SIGNIFICANT_B_FIRST_ORDER = 0, MOST_SIGNIFICANT_B_FIRST_ORDER = 1;
    ...
    public XImage(Visual visual, int depth, int format, int xoffset, int width, int height, int bitmapPad, int bytesPerLine, int bitsPerPixel) {
        if (visual == null) throw new NullPointerException("a visual must be specified");
        init(visual, depth, format, xoffset, width, height, bitmapPad, bytesPerLine, bitsPerPixel);
    }

    public native void init(Visual visual, int depth, int format, int xoffset, int width, int height, int bitmapPad, int bytesPerLine, int bitsPerPixel);
   ...
   */
    public final native void setPixel(int x, int y, int pixel);
    ...
    public String toString() {
        ...
        return getClass().getName() + "[" + format + ", width=" + getWidth() + ", height=" + getHeight() + ", bytesPerLine=" + getBytesPerLine() + ", xoffset=" + getXOffset() + ", depth=" + getDepth() + ", bitsPerPixel=" + getBitsPerPixel() + ", bitmapUnit=" + getBitmapUnit() + ", bitmapPad=" + getBitmapPad() + ", byteOrder=" + imageByteOrder + ", bitOrder=" + bitmapBitOrder + "]";
    }
}
