 ...
 *
 */
public interface Level0ListOfListOperator<T, I> extends UniqOperator<List<List<T>>, I>, NavigableCollectionOperator<List<T>, I>, DistinguishableOperator<I>, SortableOperator<List<T>, I>, CastableToListOfListOperator<I>, FlattenableAsListOperator<T, I>, ModifiableCollectionOperator<List<T>, I>, GenerizableOperator<List<List<T>>, I>, ExecutableListOfListOperator<T, I>, SelectableOperator<List<List<T>>, I>, ReplaceableOperator<List<List<T>>, I>, ReplaceableIfNullOperator<List<List<T>>, I>, ConvertibleToArrayOfArrayOperator<T, I>, ConvertibleToArrayOfListOperator<T, I>, ConvertibleToArrayOfSetOperator<T, I>, ConvertibleToListOfArrayOperator<T, I>, ConvertibleToListOfSetOperator<T, I>, ConvertibleToSetOfArrayOperator<T, I>, ConvertibleToSetOfListOperator<T, I>, ConvertibleToSetOfSetOperator<T, I>, ConvertibleToArrayOfMapOperator<T, I>, ConvertibleToListOfMapOperator<T, I>, ConvertibleToSetOfMapOperator<T, I> {
