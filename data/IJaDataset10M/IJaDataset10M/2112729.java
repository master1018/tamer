...
final class GC extends Resource {
    ...
    private void init() {
        ...
        dash = null;
        dash_phase = 0.0f;
        attr = (LineSolid | CapButt | JoinMiter | FillSolid | EvenOddRule | ArcPieSlice | ClipByChildren | graphicsExposures);
        time = 0;
        tile = new Pix();
        stipple = null;
        ...
        while (mask != 0) {
            ...
            switch(index) {
                ...
                case GCLineStyle:
                    ...
                    if (foo != LineSolid && foo != LineOnOffDash && foo != LineDoubleDash) {
                ...
                case GCCapStyle:
                    ...
                    if (foo != CapNotLast && foo != CapButt && foo != CapRound && foo != CapProjecting) {
                ...
                case GCJoinStyle:
                    ...
                    if (foo != JoinMiter && foo != JoinRound && foo != JoinBevel) {
                ...
                case GCTile:
                    foo = io.readInt();
                    {
                        ...
                        if (o != null && (o instanceof Pixmap)) {
                            Pixmap tmp = (Pixmap) o;
                            if (tmp.depth != drawable.depth || tmp.screen != drawable.screen) {
                                c.errorValue = foo;
                                c.errorReason = 8;
                                break;
                            }
                ...
                case GCStipple:
                    foo = io.readInt();
                    {
                        ...
                        if (o != null && (o instanceof Pixmap)) {
                            Pixmap tmp = (Pixmap) o;
                            if (tmp.depth != 1 || tmp.screen != drawable.screen) {
                                c.errorValue = foo;
                                c.errorReason = 8;
                                break;
                            }
