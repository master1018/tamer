...
public class TSCXMLHelper {
     ...
     */
    protected static final BooleanAssignment decodeBooleanAssignment(String encodedBooleanAssignment, Logger logger) {
    ...
    protected static final Object decodeMetaData(String base64, Logger logger) {
        ...
        final ByteArrayInputStream dataStream = new ByteArrayInputStream(Base64.decode(base64));
        try {
     ...
     */
    protected static final String encodeBooleanAssignment(BooleanAssignment booleanAssignment, Logger logger) {
