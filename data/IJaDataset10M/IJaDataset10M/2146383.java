...
public class BlueZServiceRecordXMLTest extends TestCase {
    ...
    public static final String stringUTFData = "TODO";
    ...
    public static void assertEquals(String message, DataElement expected, DataElement actual) {
    ...
    public void testParserINT() throws IOException {
        assertParser(new DataElement(DataElement.U_INT_1, 0x4), 0, new String[] { "<record>", "<attribute id=\"0x0000\">", "<uint8 value=\"4\" />", "</attribute>", "</record>" });
        assertParser(new DataElement(DataElement.U_INT_2, 0x2794), 0, new String[] { "<record>", "<attribute id=\"0x0000\">", "<uint16 value=\"0x2794\" />", "</attribute>", "</record>" });
        assertParser(new DataElement(DataElement.U_INT_4, 0xabcdef40L), 0, new String[] { "<record>", "<attribute id=\"0x0000\">", "<uint32 value=\"0xabcdef40\" />", "</attribute>", "</record>" });
        assertParser(new DataElement(DataElement.INT_1, 0x4), 0, new String[] { "<record>", "<attribute id=\"0x0000\">", "<int8 value=\"0x4\" />", "</attribute>", "</record>" });
        assertParser(new DataElement(DataElement.INT_2, 0x584A), 0, new String[] { "<record>", "<attribute id=\"0x0000\">", "<int16 value=\"0x584A\" />", "</attribute>", "</record>" });
    }
    ...
    public void testIntTypes() throws Exception {
        ...
        validateConversion(new DataElement(DataElement.INT_16, new byte[] { 11, -22, 33, 44, -5, 6, 77, 88, 9, -10, 11, 12, -13, 14, 15, 16 }));
        validateConversion(new DataElement(DataElement.U_INT_16, new byte[] { 21, -32, 43, 54, -65, 76, 87, 98, 11, -110, 111, 112, -113, 114, 115, 16 }));
    }
