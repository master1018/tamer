    ...
    public void start() throws InvalidPluginArgumentException {
        ...
        if (ccNames != null && ccNames.length > 0) {
            for (String ccName : ccNames) {
                ...
                if (cc == null) ONDEXEventHandler.getEventHandlerForSID(graph.getSID()).fireEventOccurred(new ConceptClassMissingEvent(ccName, getCurrentMethodName())); else ccs.add(cc);
            }
        }
