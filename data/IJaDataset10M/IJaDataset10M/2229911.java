...
public class L2NpcBufferInstance extends L2Npc {
    ...
    public void showChatWindow(L2PcInstance playerInstance, int val) {
        ...
        if (val > 0) htmContent = HtmCache.getInstance().getHtm(playerInstance.getHtmlPrefix(), "data/html/mods/NpcBuffer-" + val + ".htm");
        if (htmContent != null) {
    ...
    public void onBypassFeedback(L2PcInstance player, String command) {
        if (player == null || player.getLastFolkNPC() == null || player.getLastFolkNPC().getObjectId() != this.getObjectId()) return;
        ...
        if (command.startsWith("Chat")) {
            ...
            for (String buffGroupList : buffGroupArray) {
                ...
                if (skill != null) skill.getEffects(player, target);
            }
