...
public abstract class SbbEventHandlersThrowsSbb extends SbbConstraintsOkSbb {
    ...
    public void onCustomEventTwo(XEvent event, ActivityContextInterface aci, EventContext ctx) {
    }

    public abstract void fireCustomEventThree(XEvent event, ActivityContextInterface aci, Address address);

    public abstract void fireCustomEventFour(XEvent event, ActivityContextInterface aci, Address address, ServiceID SID);

    public void onCustomEventFive(XEvent event, ActivityContextInterface aci, EventContext ctx) {
    }

    public abstract void fireCustomEventFive(XEvent event, ActivityContextInterface aci, Address address, ServiceID SID) throws Exception;
