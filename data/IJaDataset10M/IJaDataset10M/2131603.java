 ...
 * been rigorously tested and is not guaranteed to work.
 * <p>
 * Yes, this is platform-specific code, and yes, it may rely on
...
public class BrowserLauncher {
    ...
    /**
     * Actually an MRJOSType pointing to the System Folder on a
     * Macintosh
     */
     ...
     * would keep non-U.S. English systems from working properly.
     */
    ...
    /**
     * This class should be never be instantiated; this just ensures
     * so.
     */
     ...
     *         instead, it's the application that gets called to open
     *         the default web browser. In some cases, this will be a
     *         non-String object that provides the means of calling
     *         the default browser.
     */
     ...
     *            The URL to open
     * @throws IOException
     *             If the web browser could not be located or does not
     *             run
     */
