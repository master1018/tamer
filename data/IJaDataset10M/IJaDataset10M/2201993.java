...
public class XMLQuerySpecification2 implements IXMLQuerySpecification {
    ...
    public XMLQuerySpecification2(IResource container, IResource[] containers, IXMLSearchRequestor requestor, IXMLSearchDOMDocumentVisitor visitor, IStringQueryBuilder equalsStringQueryBuilder, IStringQueryBuilder startsWithStringQueryBuilder, String xpathEvaluatorId) {
    ...
    public static XMLQuerySpecification2 newDefaultQuerySpecification(IResource container) {
        return new XMLQuerySpecification2(container, null, AllXMLExtensionFilesXMLSearchRequestor.INSTANCE, XPathNodeSetSearchVisitor.INSTANCE, DefaultStringQueryBuilderProvider.INSTANCE.getEqualsStringQueryBuilder(), DefaultStringQueryBuilderProvider.INSTANCE.getStartsWithStringQueryBuilder(), null);
    }

    public static XMLQuerySpecification2 newDefaultQuerySpecification(IResource[] containers) {
        return new XMLQuerySpecification2(null, containers, AllXMLExtensionFilesXMLSearchRequestor.INSTANCE, XPathNodeSetSearchVisitor.INSTANCE, DefaultStringQueryBuilderProvider.INSTANCE.getEqualsStringQueryBuilder(), DefaultStringQueryBuilderProvider.INSTANCE.getStartsWithStringQueryBuilder(), null);
    }
    ...
    public void setEqualsStringQueryBuilder(IStringQueryBuilder equalsStringQueryBuilder) {
        this.equalsStringQueryBuilder = equalsStringQueryBuilder;
    }
    ...
    public void setStartsWithStringQueryBuilder(IStringQueryBuilder startsWithStringQueryBuilder) {
        this.startsWithStringQueryBuilder = startsWithStringQueryBuilder;
    }
