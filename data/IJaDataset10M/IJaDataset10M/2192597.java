...
public abstract class ExtAdvisor extends ExtJsComponent {
    ...
    protected static final String[] EXT_ATTRS = new String[] { "cls", "disableClass", "disabled", "fieldClass", "focusClass", "hideMode", "invalidClass", "invalidText", "msgDisplay", "readOnly", "validateOnBlur", "validationDelay", "validationEvent", "width" };
