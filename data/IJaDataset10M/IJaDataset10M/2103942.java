...
public interface FactoriaObjetosXML {
    ...
    /** Obtiene el encoding que se usar� para generar contenido XML
	 * @return Encoding con el que se genera contenido XML
	 */
    public String getEncoding();

    /** Establece la codificacion que se usar� para generar contenido XML
	 * @param encoding Codificacion que se usar� para generar contenido XML
	 */
