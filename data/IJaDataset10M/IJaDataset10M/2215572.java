...
public class NotEqualCheck extends AbstractAnnotationCheck<NotEqual> {
    ...
    private String getTestStringLowerCase() {
        if (testStringLowerCase == null && testString != null) testStringLowerCase = testString.toLowerCase(Locale.getDefault());
    ...
    public boolean isSatisfied(final Object validatedObject, final Object valueToValidate, final OValContext context, final Validator validator) {
        ...
        if (ignoreCase) return !valueToValidate.toString().toLowerCase(Locale.getDefault()).equals(getTestStringLowerCase());
