...
public class ObjectDumperObserver extends DefaultObserver {
    ...
    public enum Marker {
        ...
        SIMULATIONSTART, SIMULATIONEND, SIMULATIONSTATE
    }
    ...
    public void notifySimulationEnd() {
        log(LOGLEVEL_DEBUG);
        try {
            objectsink.writeObject(Marker.SIMULATIONEND);
        } catch (IOException e) {
            log(LOGLEVEL_ERROR, e.toString());
        }
    }
    ...
    public void notifySimulationStart() {
        log(LOGLEVEL_DEBUG);
        try {
            objectsink.writeObject(Marker.SIMULATIONSTART);
        } catch (IOException e) {
            log(LOGLEVEL_ERROR, e.toString());
        }
    }
