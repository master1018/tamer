package com.ssd.mdaworks.classdiagram.classDiagram.diagram.expressions;
 ...
 * @generated
 */
public abstract class ClassdiagramAbstractExpression {

    /**
	 * @generated
	 */
    private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean.valueOf(Platform.getDebugOption(com.ssd.mdaworks.classdiagram.classDiagram.diagram.part.ClassdiagramDiagramEditorPlugin.getInstance().getBundle().getSymbolicName() + "/debug/disableNoExprImplExceptionLog")).booleanValue();
	 ...
	 * @generated
	 */
    protected ClassdiagramAbstractExpression(EClassifier context) {
        this(null, context);
    }
	 ...
	 * @generated
	 */
    protected ClassdiagramAbstractExpression(String body, EClassifier context) {
        this.body = body;
    ...
    protected void setStatus(int severity, String message, Throwable throwable) {
        String pluginID = com.ssd.mdaworks.classdiagram.classDiagram.diagram.part.ClassdiagramDiagramEditorPlugin.ID;
        this.status = new Status(severity, pluginID, -1, (message != null) ? message : "", throwable);
        if (!this.status.isOK()) {
            com.ssd.mdaworks.classdiagram.classDiagram.diagram.part.ClassdiagramDiagramEditorPlugin.getInstance().logError("Expression problem: " + message + " body: " + body, throwable);
        }
    }
    ...
    public Object evaluate(Object context, Map env) {
        if (context().isInstance(context)) {
            try {
                ...
                com.ssd.mdaworks.classdiagram.classDiagram.diagram.part.ClassdiagramDiagramEditorPlugin.getInstance().logError("Expression evaluation failure: " + body, e);
            }
        }
        return null;
    }
	 ...
	 * @generated
	 */
    public static final ClassdiagramAbstractExpression createNullExpression(EClassifier context) {
        return new ClassdiagramAbstractExpression(context) {
