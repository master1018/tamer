package upm.fi.oeg.test.eswc2011queries;
...
import upm.fi.oeg.test.RDFActivity;

public class Query2Test {

    private static String mSPARQLquery = "SELECT ?pubmed ?gene1 ?mesh ?descriptor WHERE" + " { " + "  SERVICE <http://127.0.0.1:2020/sparql-geneid2pubmed>" + " { ?gene1 <http://bio2rdf.org/geneid_resource:pubmed_xref> ?pubmed .}   " + "  SERVICE <http://pubmed.bio2rdf.org/sparql> " + "     {?pubmed <http://bio2rdf.org/pubmed_resource:meshref> ?mesh . " + "  ?mesh <http://bio2rdf.org/pubmed_resource:descriptor> ?descriptor  } . " + "} ";
