...
public class SQLTypes {
   ...
   */
    public static int getType(Class klass) {
        if (klass.equals(java.lang.String.class)) return Types.VARCHAR; else if (klass.equals(java.lang.Long.class)) return Types.BIGINT; else if (klass.equals(java.lang.Integer.class)) return Types.INTEGER; else if (klass.equals(java.lang.Float.class)) return Types.FLOAT; else if (klass.equals(java.lang.Double.class)) return Types.DOUBLE; else if (klass.equals(java.lang.Boolean.class)) return Types.SMALLINT; else if (klass.equals(java.lang.Character.class)) return Types.CHAR; else if (klass.equals(java.lang.Short.class)) return Types.BIT; else if (klass.equals(java.lang.Byte.class)) return Types.TINYINT; else if (klass.equals(java.io.Reader.class)) return Types.CLOB; else throw new OntopiaRuntimeException("Cannot map value type " + klass + " to SQL type.");
    }
                        ...
                        if (direct) {
                            ...
                            if (lengthRead <= SQLTypes.SIZE_THRESHOLD && reader.read() == -1) {
                                if (lengthRead > 0) {
                                    ...
                                    return result;
                                } else if (lengthRead == 0) return new byte[] {}; else return null;
                            } else {
            ...
            case Types.CLOB:
                {
                    try {
                        if (direct) {
                            ...
                            if (lengthRead <= SQLTypes.SIZE_THRESHOLD && reader.read() == -1) {
                                if (lengthRead > 0) return new String(chars, 0, lengthRead); else if (lengthRead == 0) return ""; else return null;
                            } else {
                                return new OnDemandValue();
                            }
                        }
            ...
            switch(sql_type) {
                ...
                case Types.BLOB:
                    if (value instanceof byte[]) {
                        ...
                        if (blob != null) stmt.setBinaryStream(index, blob, (int) blob.getLength()); else stmt.setNull(index, sql_type);
                        odv.releaseValue();
                    }
                    break;
                case Types.CLOB:
                    if (value instanceof String) {
                        ...
                        if (clob != null) stmt.setCharacterStream(index, clob, (int) clob.getLength()); else stmt.setNull(index, sql_type);
                        odv.releaseValue();
                    } else {
