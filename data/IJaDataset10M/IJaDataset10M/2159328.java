...
public class ListenerManagerTest extends DatabaseTestCase {
    ...
    @After
    public void unregisterMocks() throws Exception {
    ...
    private XMLDocument createDocument(String path, String stamp) {
        ...
        return folder.documents().build(Name.overwrite(db, path.substring(k + 1))).elem("test").attrIf(stamp != null, "stamp", stamp).end("test").commit();
    }

    @Test
    public void listenDocumentsBeforeCreateDocument1() {
        ...
        context.checking(new Expectations() {
            ...
            {
                one(documentListener).handle(ev);
                will(checkDocumentExists(docPath, false));
            }
        });
    ...
    @Test
    public void listenDocumentsBeforeCreateDocument2() {
        final String docPath = "/top/test.xml";
        Folder top = db.createFolder("/top");
        context.checking(new Expectations() {
    ...
    @Test
    public void listenDocumentsAfterCreateDocument1() {
        final String docPath = "/top/test.xml";
        ...
        context.checking(new Expectations() {
            ...
            {
                one(documentListener).handle(with(eqDelayedDoc(ev)));
                will(checkDocumentExists(docPath, true));
            }
        });
    ...
    @Test
    public void listenDocumentsAfterCreateDocument2() {
        final String docPath = "/top/test.xml";
        Folder top = db.createFolder("/top");
        context.checking(new Expectations() {
    ...
    @Test
    public void listenFolderBeforeCreateDocument1() {
    ...
    @Test
    public void listenFolderBeforeCreateDocument2() {
        final String docPath = "/top/test2.xml";
        Folder top = db.createFolder("/top");
        context.checking(new Expectations() {
    ...
    @Test
    public void listenFolderAfterCreateDocument1() {
        final String docPath = "/top/test2.xml";
        XMLDocument doc = createDocument(docPath);
        final Document.Event ev = new Document.Event(Trigger.AFTER_CREATE, docPath, doc);
        doc.delete();
    ...
    @Test
    public void listenFolderAfterCreateDocument2() {
        final String docPath = "/top/test2.xml";
        Folder top = db.createFolder("/top");
        context.checking(new Expectations() {
    ...
    @Test
    public void listenDocumentsBeforeUpdateDocument1() {
        final String docPath = "/top/test.xml";
        ...
        context.checking(new Expectations() {
            ...
            {
                one(documentListener).handle(ev);
                will(checkDocumentStamp("before"));
            }
        });
    ...
    @Test
    public void listenDocumentsAfterUpdateDocument1() {
        final String docPath = "/top/test.xml";
        XMLDocument doc = createDocument(docPath, "before");
    ...
    @Test
    public void listenFolderBeforeUpdateDocument1() {
        final String docPath = "/top/test.xml";
        XMLDocument doc = createDocument(docPath, "before");
        final Document.Event ev = new Document.Event(Trigger.BEFORE_UPDATE, docPath, doc);
        Folder top = db.createFolder("/top");
    ...
    @Test
    public void listenFolderAfterUpdateDocument1() {
        final String docPath = "/top/test.xml";
        XMLDocument doc = createDocument(docPath, "before");
        final Document.Event ev = new Document.Event(Trigger.AFTER_UPDATE, docPath, doc);
        Folder top = db.createFolder("/top");
    ...
    @Test
    public void listenFolderDeepBeforeCreateDocument1() {
    ...
    @Test
    public void listenDocumentBeforeUpdateDocument1() {
        final String docPath = "/top/test.xml";
        XMLDocument doc = createDocument(docPath, "before");
        final Document.Event ev = new Document.Event(Trigger.BEFORE_UPDATE, docPath, doc);
        context.checking(new Expectations() {
    ...
    @Test
    public void listenDocumentAfterUpdateDocument1() {
        final String docPath = "/top/test.xml";
        XMLDocument doc = createDocument(docPath, "before");
        final Document.Event ev = new Document.Event(Trigger.AFTER_UPDATE, docPath, doc);
        context.checking(new Expectations() {
    ...
    @Test
    public void listenDocumentsBeforeDeleteDocument1() {
        final String docPath = "/top/test.xml";
        XMLDocument doc = createDocument(docPath);
    ...
    @Test
    public void listenDocumentsBeforeDeleteDocument2() {
        final String docPath = "/top/test.xml";
        XMLDocument doc = createDocument(docPath, "before");
        doc.delete();
        final Document.Event ev = new Document.Event(Trigger.BEFORE_REMOVE, docPath, doc);
    ...
    @Test
    public void listenDocumentsAfterDeleteDocument1() {
        final String docPath = "/top/test.xml";
    ...
    @Test
    public void listenFolderBeforeDeleteDocument1() {
        final String docPath = "/top/test.xml";
        XMLDocument doc = createDocument(docPath);
        final Document.Event ev = new Document.Event(Trigger.BEFORE_REMOVE, docPath, doc);
        context.checking(new Expectations() {
    ...
    @Test
    public void listenFolderBeforeDeleteDocument2() {
    ...
    @Test
    public void listenFolderAfterDeleteDocument1() {
        final String docPath = "/top/test.xml";
        XMLDocument doc = createDocument(docPath);
        final Document.Event ev = new Document.Event(Trigger.AFTER_REMOVE, docPath, null);
        context.checking(new Expectations() {
    ...
    @Test
    public void listenFolderAfterDeleteDocument2() {
        final String docPath = "/top/deeper/test.xml";
        XMLDocument doc = createDocument(docPath);
        final Document.Event ev = new Document.Event(Trigger.AFTER_REMOVE, docPath, null);
        context.checking(new Expectations() {
    ...
    @Test
    public void listenDocumentBeforeDeleteDocument1() {
        final String docPath = "/top/test.xml";
        XMLDocument doc = createDocument(docPath);
        final Document.Event ev = new Document.Event(Trigger.BEFORE_REMOVE, docPath, doc);
        context.checking(new Expectations() {
    ...
    @Test
    public void listenDocumentAfterDeleteDocument1() {
        final String docPath = "/top/test.xml";
        XMLDocument doc = createDocument(docPath);
        final Document.Event ev = new Document.Event(Trigger.AFTER_REMOVE, docPath, null);
        context.checking(new Expectations() {
    ...
    @Test
    public void listenBeforeCreateFolder2() {
