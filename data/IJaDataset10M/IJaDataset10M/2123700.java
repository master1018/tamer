...
public class AddPageTest extends BaseTestCase {
    ...
    public void testAddPage() throws Exception {
        ...
        selenium.typeKeys("new_page", RuntimeVariables.replace("Loan Calculator Test Page"));
        selenium.type("new_page", RuntimeVariables.replace("Loan Calculator Test Page"));
        ...
        selenium.click(RuntimeVariables.replace("link=Loan Calculator Test Page"));
        selenium.waitForPageToLoad("30000");
    }
}
