...
public class ActionMouseListener extends LTSMouseAdapter {
    ...
    public void doubleClick(Object source) {
        if (null != myDoubleClickAction) myDoubleClickAction.actionPerformed(null);
    }
    ...
    public void singleClick(Object source) {
        if (null != mySingleClickAction) mySingleClickAction.actionPerformed(null);
    }

    public void setRightClickAction(SimpleThreadedAction action) {
        if (null != myRightClickAction) myRightClickAction.actionPerformed(null);
    }
}
