...
public class CursorAdapterTest extends AndroidTestCase {
    ...
    private static final String[] NUMBER_PROJECTION = new String[] { "_id", "number" };
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test constructor(s) of {@link CursorAdapter}", method = "CursorAdapter", args = { android.content.Context.class, android.database.Cursor.class }), @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test constructor(s) of {@link CursorAdapter}", method = "CursorAdapter", args = { android.content.Context.class, android.database.Cursor.class, boolean.class }) })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test {@link CursorAdapter#init(Context, Cursor, boolean)}", method = "init", args = { android.content.Context.class, android.database.Cursor.class, boolean.class })
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test {@link CursorAdapter#changeCursor(Cursor)}", method = "changeCursor", args = { android.database.Cursor.class }), @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test {@link CursorAdapter#changeCursor(Cursor)}", method = "getCursor", args = {  }) })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test {@link CursorAdapter#convertToString(Cursor)}", method = "convertToString", args = { android.database.Cursor.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test {@link CursorAdapter#getView(int, View, ViewGroup)}", method = "getView", args = { int.class, android.view.View.class, android.view.ViewGroup.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test {@link CursorAdapter#newDropDownView(Context, Cursor, ViewGroup)}", method = "newDropDownView", args = { android.content.Context.class, android.database.Cursor.class, android.view.ViewGroup.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test {@link CursorAdapter#getDropDownView(int, View, ViewGroup)}", method = "getDropDownView", args = { int.class, android.view.View.class, android.view.ViewGroup.class })
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, method = "getFilterQueryProvider", args = {  }), @TestTargetNew(level = TestLevel.COMPLETE, method = "setFilterQueryProvider", args = { android.widget.FilterQueryProvider.class }) })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test {@link CursorAdapter#runQueryOnBackgroundThread(CharSequence)}", method = "runQueryOnBackgroundThread", args = { java.lang.CharSequence.class })
