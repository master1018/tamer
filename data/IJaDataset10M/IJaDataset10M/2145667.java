...
public class NestedExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Collection col = DatabaseManager.getCollection(URI + DBBroker.ROOT_COLLECTION, "admin", "");
        XMLResource res = (XMLResource) col.createResource("test.xml", "XMLResource");
        res.setContent(data);
        col.storeResource(res);
        XPathQueryServiceImpl service = (XPathQueryServiceImpl) col.getService("XPathQueryService", "1.0");
