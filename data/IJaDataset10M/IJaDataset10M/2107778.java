...
public class refType3 extends homura.hde.util.xml.xml.Node {

    public refType3(refType3 node) {
        super(node);
    }

    public refType3(org.w3c.dom.Node node) {
        super(node);
    }

    public refType3(org.w3c.dom.Document doc) {
        super(doc);
    }

    public refType3(homura.hde.util.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "ref");
    }
