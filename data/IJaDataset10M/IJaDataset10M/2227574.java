...
public class AttributeTest extends BaseTest {
    ...
    public void testCMLAttributeString() {
        ...
        Assert.assertEquals("string att", "setCMLValue", string.getJavaSetMethod());
        Assert.assertEquals("string att", "getCMLValue", string.getJavaGetMethod());
        Assert.assertEquals("string att", "CMLAttribute", string.getJavaShortClassName());
