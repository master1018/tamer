package de.icehorsetools.iceoffice.workflow.clazz;
...
import de.icehorsetools.dataAccess.objects.Clazz;

/**
 * @author tkr
 * @version $Id: ClazzDeleteWf.java 261 2008-08-20 22:30:05Z kruegertom $
 */
public class ClazzDeleteWf extends ADefaultMessageBoxWorkflow {

    private static final Logger LOG = Logger.getLogger(ClazzDeleteWf.class);
    ...
    public boolean areObjectsValidForWorkflow(List xObjects, UnitOfWork xCurrentUnitOfWork) {
        return xObjects != null && xObjects.size() == 1 && xObjects.get(0) instanceof Clazz;
    }
