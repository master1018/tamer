...
*/
public class ParsingSample extends Sample {
    ...
    private void printPageInfo(Page page, int index) {
    ...
    private int printContentObjects(List<ContentObject> objects, int index, int level) {
        ...
        for (ContentObject object : objects) {
            if (object instanceof Operation) {
                ...
                System.out.println("   " + indentation + object.getClass().getSimpleName() + "\n   " + indentation + "{");
    ...
    private String toString(org.w3c.dom.Document document) {
        try {
