...
public class ConstraintImpl extends NamedElementImpl implements Constraint {
    ...
    public void setKind(ConstraintKind newKind) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, PivotModelPackage.CONSTRAINT__KIND, oldKind, kind));
    }
    ...
    public Namespace getNamespace() {
        if (eContainerFeatureID() != PivotModelPackage.CONSTRAINT__NAMESPACE) return null;
    ...
    public NotificationChain basicSetNamespace(Namespace newNamespace, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newNamespace, PivotModelPackage.CONSTRAINT__NAMESPACE, msgs);
        return msgs;
    }
    ...
    public void setNamespace(Namespace newNamespace) {
        if (newNamespace != eInternalContainer() || (eContainerFeatureID() != PivotModelPackage.CONSTRAINT__NAMESPACE && newNamespace != null)) {
            ...
            if (newNamespace != null) msgs = ((InternalEObject) newNamespace).eInverseAdd(this, PivotModelPackage.NAMESPACE__OWNED_RULE, Namespace.class, msgs);
            msgs = basicSetNamespace(newNamespace, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, PivotModelPackage.CONSTRAINT__NAMESPACE, newNamespace, newNamespace));
    }
    ...
    public NotificationChain basicSetSpecification(Expression newSpecification, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PivotModelPackage.CONSTRAINT__SPECIFICATION, oldSpecification, newSpecification);
    ...
    public void setSpecification(Expression newSpecification) {
        if (newSpecification != specification) {
            NotificationChain msgs = null;
            if (specification != null) msgs = ((InternalEObject) specification).eInverseRemove(this, PivotModelPackage.EXPRESSION__CONSTRAINT, Expression.class, msgs);
            if (newSpecification != null) msgs = ((InternalEObject) newSpecification).eInverseAdd(this, PivotModelPackage.EXPRESSION__CONSTRAINT, Expression.class, msgs);
            msgs = basicSetSpecification(newSpecification, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, PivotModelPackage.CONSTRAINT__SPECIFICATION, newSpecification, newSpecification));
    }
    ...
    protected final List<ConstrainableElement> getConstrainedElementGen() {
        if (constrainedElement == null) {
            constrainedElement = new EObjectEList<ConstrainableElement>(ConstrainableElement.class, this, PivotModelPackage.CONSTRAINT__CONSTRAINED_ELEMENT);
        }
	 ...
	 * @generated
	 */
    public NotificationChain basicSetDefinedFeature(Feature newDefinedFeature, NotificationChain msgs) {
        Feature oldDefinedFeature = definedFeature;
        definedFeature = newDefinedFeature;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PivotModelPackage.CONSTRAINT__DEFINED_FEATURE, oldDefinedFeature, newDefinedFeature);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setDefinedFeature(Feature newDefinedFeature) {
        if (newDefinedFeature != definedFeature) {
            NotificationChain msgs = null;
            if (definedFeature != null) msgs = ((InternalEObject) definedFeature).eInverseRemove(this, PivotModelPackage.FEATURE__SEMANTICS, Feature.class, msgs);
            if (newDefinedFeature != null) msgs = ((InternalEObject) newDefinedFeature).eInverseAdd(this, PivotModelPackage.FEATURE__SEMANTICS, Feature.class, msgs);
            msgs = basicSetDefinedFeature(newDefinedFeature, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, PivotModelPackage.CONSTRAINT__DEFINED_FEATURE, newDefinedFeature, newDefinedFeature));
    }
    ...
    public Constraint addConstrainedElement(ConstrainableElement constrainedElement) {
        if (logger.isDebugEnabled()) {
            logger.debug("addConstrainedElement(constrainedElement=" + constrainedElement + ") - enter");
        }
        getConstrainedElementGen().add(constrainedElement);
        if (logger.isDebugEnabled()) {
            logger.debug("addConstrainedElement() - exit");
        }
        return this;
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch(featureID) {
            ...
            case PivotModelPackage.CONSTRAINT__SPECIFICATION:
                if (specification != null) msgs = ((InternalEObject) specification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PivotModelPackage.CONSTRAINT__SPECIFICATION, null, msgs);
    ...
    public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
        switch(eContainerFeatureID()) {
            case PivotModelPackage.CONSTRAINT__NAMESPACE:
                return eInternalContainer().eInverseRemove(this, PivotModelPackage.NAMESPACE__OWNED_RULE, Namespace.class, msgs);
        }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).appendToString(super.toString()).append("kind", getKind()).append("specification", getSpecification()).append("constrainedElement", getConstrainedElement()).append("definedFeature", getDefinedFeature()).toString();
    }
}
