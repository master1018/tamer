    ...
    public AsynchBeansWorkManagerExecutor(String workManagerJNDIName) {
        ...
        workListener = new WorkListener() {
            ...
            public void workCompleted(WorkEvent event) {
                ...
                if (e != null) {
                    if (Log.isDebug()) Log.getLogger(LogCategories.EXECUTOR).error("AsynchBeansWorkManager's WorkListener.workCompleted() callback invoked for failed execution.", e);
            ...
            public void workRejected(WorkEvent event) {
                WorkException e = event.getException();
                if (Log.isDebug()) Log.getLogger(LogCategories.EXECUTOR).error("AsynchBeansWorkManager's WorkListener.workRejected() callback invoked. WorkException? " + e);
                handleFailedExecution(((WorkCommandWrapper) event.getWork()).command, e);
            }
