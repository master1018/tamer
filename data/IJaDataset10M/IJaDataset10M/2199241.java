...
public class FreeformGraphicalRootEditPart extends SimpleRootEditPart implements LayerConstants, LayerManager {
    ...
    private PropertyChangeListener gridListener = new PropertyChangeListener() {
        ...
        public void propertyChange(PropertyChangeEvent evt) {
            ...
            if (property.equals(SnapToGrid.PROPERTY_GRID_ORIGIN) || property.equals(SnapToGrid.PROPERTY_GRID_SPACING) || property.equals(SnapToGrid.PROPERTY_GRID_VISIBLE)) refreshGridLayer();
        }
    };
 ...
 */
    public Object getAdapter(Class adapter) {
        if (adapter == AutoexposeHelper.class) return new ViewportAutoexposeHelper(this);
 ...
 */
    public IFigure getLayer(Object key) {
        if (innerLayers == null) return null;
        IFigure layer = innerLayers.getLayer(key);
        if (layer != null) return layer;
        if (printableLayers == null) return null;
 ...
 */
    protected LayeredPane getPrintableLayers() {
        if (printableLayers == null) printableLayers = createPrintableLayers();
 ...
 */
    protected void refreshGridLayer() {
        ...
        if (val != null) visible = val.booleanValue();
