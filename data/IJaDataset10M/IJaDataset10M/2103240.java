...
public class TypeDeclarationImpl extends DeclarationImpl implements TypeDeclaration {
   ...
   */
    public void setName(String newName) {
        String oldName = name;
        name = newName;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, MDDPackage.TYPE_DECLARATION__NAME, oldName, name));
    }
   ...
   */
    public void setFieldType(FieldType newFieldType) {
        if (newFieldType != fieldType) {
            ...
            if (fieldType != null) msgs = ((InternalEObject) fieldType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MDDPackage.TYPE_DECLARATION__FIELD_TYPE, null, msgs);
            if (newFieldType != null) msgs = ((InternalEObject) newFieldType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MDDPackage.TYPE_DECLARATION__FIELD_TYPE, null, msgs);
            msgs = basicSetFieldType(newFieldType, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, MDDPackage.TYPE_DECLARATION__FIELD_TYPE, newFieldType, newFieldType));
    }
