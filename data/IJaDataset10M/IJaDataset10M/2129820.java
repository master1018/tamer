...
public final class OutputDocument implements CharStreamSource {
    ...
    public void writeTo(final Writer writer, final int begin, final int end) throws IOException {
        try {
            ...
            for (final Iterator i = outputSegments.iterator(); i.hasNext(); ) {
                ...
                if (outputSegment.getEnd() < pos) continue;
                if (outputSegment.getEnd() == pos && outputSegment.getBegin() < pos) continue;
                if (outputSegment.getBegin() > end) break;
                if (outputSegment.getBegin() == end && outputSegment.getEnd() > end) break;
    ...
    public String getDebugInfo() {
        ...
        for (Iterator i = getRegisteredOutputSegments().iterator(); i.hasNext(); ) {
            ...
            if (outputSegment instanceof BlankOutputSegment) sb.append("Replace with Spaces: "); else if (outputSegment instanceof RemoveOutputSegment) sb.append("Remove: "); else sb.append("Replace: ");
