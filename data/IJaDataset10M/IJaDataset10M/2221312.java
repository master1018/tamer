...
public class QuickLaunch extends DesktopItem {
    ...
    public boolean isApproaching(long now, int x, int y, boolean ctrlKey) {
        return (!ctrlKey && y >= OS.getFixedBodyClientHeight() - 8 && isAround(x, y));
    }
    ...
    void toggleAutoHide() {
        ...
        handle.title = isAutoHide ? "Doubleclick to set quicklaunch always-visible" : "Doubleclick to set quicklaunch auto-hide";
