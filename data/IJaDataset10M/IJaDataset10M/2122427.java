...
public class Process {
     ...
     * {@hide}
     */
    public static final int start(String processClass, int uid, int gid, int[] gids, int debugFlags, String[] zygoteArgs) {
        return start(processClass, "", uid, gid, gids, debugFlags, zygoteArgs);
    }
    ...
    private static void invokeStaticMain(String className) {
        ...
        try {
            ...
            cl.getMethod("main", new Class[] { String[].class }).invoke(null, args);
        } catch (Exception ex) {
