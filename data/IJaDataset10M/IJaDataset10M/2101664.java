...
public class EgovLoginScrinImageController {
    ...
    public String selectLoginScrinImageList(@ModelAttribute("loginScrinImageVO") LoginScrinImageVO loginScrinImageVO, ModelMap model) throws Exception {
    ...
    public String selectLoginScrinImage(@RequestParam("imageId") String imageId, @ModelAttribute("loginScrinImageVO") LoginScrinImageVO loginScrinImageVO, ModelMap model) throws Exception {
    ...
    public String insertLoginScrinImage(final MultipartHttpServletRequest multiRequest, @ModelAttribute("loginScrinImage") LoginScrinImage loginScrinImage, @ModelAttribute("loginScrinImageVO") LoginScrinImageVO loginScrinImageVO, BindingResult bindingResult, SessionStatus status, ModelMap model) throws Exception {
        beanValidator.validate(loginScrinImage, bindingResult);
    ...
    public String updateLoginScrinImage(final MultipartHttpServletRequest multiRequest, @ModelAttribute("loginScrinImage") LoginScrinImage loginScrinImage, BindingResult bindingResult, SessionStatus status, ModelMap model) throws Exception {
        beanValidator.validate(loginScrinImage, bindingResult);
        if (bindingResult.hasErrors()) {
    ...
    public String deleteLoginScrinImage(@RequestParam("imageId") String imageId, @ModelAttribute("loginScrinImage") LoginScrinImage loginScrinImage, SessionStatus status, ModelMap model) throws Exception {
    ...
    public String deleteLoginScrinImageList(@RequestParam("imageIds") String imageIds, @ModelAttribute("loginScrinImage") LoginScrinImage loginScrinImage, SessionStatus status, ModelMap model) throws Exception {
    ...
    public String selectLoginScrinImageResult(@ModelAttribute("loginScrinImageVO") LoginScrinImageVO loginScrinImageVO, ModelMap model) throws Exception {
