...
public class HLPoissonDistributionGui extends HLDistributionGui {
    ...
    public HLPoissonDistributionGui(HLPoissonDistribution theParent) {
        super(theParent);
        myIntensity = new GUIPropertyDoubleTextField("Intensity value", ((HLPoissonDistribution) parent).getIntensity(), 0.00000000000000001, true, this);
    }
    ...
    public HLPoissonDistributionGui(HLGeneralDistribution theParent) {
        super(theParent);
        myIntensity = new GUIPropertyDoubleTextField("Intensity value", ((HLGeneralDistribution) parent).getIntensity(), 0.00000000000000001, true, this);
    }
