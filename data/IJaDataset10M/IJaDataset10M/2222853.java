 ...
 */
public class OdDs extends TwoButtonStomp {

    /** The background image */
    private static final Image BACKGROUND_IMAGE = new Image(Display.getCurrent(), OdDs.class.getResourceAsStream("images/odds.png"));
     ...
     */
    public OdDs(EditorHandler handler, Composite parent, int style, Image background) {
    ...
    protected Parameter getLeftParameter() {
        return mEditorHandler.getParameter("Drive");
    }
    ...
    protected Parameter getRightParameter() {
        return mEditorHandler.getParameter("Level");
    }
