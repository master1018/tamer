...
public abstract class AbstractFunction implements Function {
    ...
    public void checkParameters(List<Object> parameters) throws ParameterException {
        ...
        if (pCount < minParameters || (maxParameters != UNLIMITED_PARAMETERS && parameters.size() > maxParameters)) throw new ParameterException(String.format("Invalid number of parameters %d, expected %s", pCount, formatExpectedParameterString()));
    }
