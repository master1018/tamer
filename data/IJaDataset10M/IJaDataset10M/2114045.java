...
public class VSLineRaceMode extends DummyMode {
    ...
    public void renderSetting(GameEngine engine, int playerID) {
        if (engine.statc[4] == 0) {
            ...
            drawMenuCompact(engine, playerID, receiver, "LOAD", String.valueOf(presetNumber[playerID]), "SAVE", String.valueOf(presetNumber[playerID]));
            menuColor = EventReceiver.COLOR_CYAN;
            drawMenuCompact(engine, playerID, receiver, "GOAL", String.valueOf(goalLines[playerID]), "BIG", GeneralUtil.getONorOFF(big[playerID]), "SE", GeneralUtil.getONorOFF(enableSE[playerID]));
    ...
    public void renderLast(GameEngine engine, int playerID) {
        ...
        if (remainLines < enemyRemainLines) receiver.drawMenuFont(engine, playerID, -2, 22, "1ST", EventReceiver.COLOR_ORANGE); else if (remainLines > enemyRemainLines) receiver.drawMenuFont(engine, playerID, -2, 22, "2ND", EventReceiver.COLOR_WHITE);
        if (playerID == 0) {
    ...
    public void renderResult(GameEngine engine, int playerID) {
        ...
        drawResultStats(engine, playerID, receiver, 2, EventReceiver.COLOR_ORANGE, STAT_LINES, STAT_PIECE, STAT_LPM, STAT_PPS, STAT_TIME);
    }
