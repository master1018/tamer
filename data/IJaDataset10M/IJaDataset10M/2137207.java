...
final class DOMImpImp implements DOMImplementation {
    ...
    public boolean hasFeature(String feature, String version) {
        ...
        if ("Core".equalsIgnoreCase(name) || "XML".equalsIgnoreCase(name)) {
            ...
            if ("1.0".equals(ver) || "2.0".equals(ver)) return true;
        }
        return false;
    }
    ...
    public Document createDocument(String namespaceURI, String qualifiedName, DocumentType doctype) throws DOMException {
        ...
        if (qualifiedName != null) {
            Element elm = (qualifiedName.indexOf(':') < 0 && namespaceURI == null) ? doc.createElement(qualifiedName) : doc.createElementNS(namespaceURI, qualifiedName);
            doc.appendChild(elm);
        } else if (namespaceURI != null) throw new DOMException(DOMException.NAMESPACE_ERR, "");
        return doc;
    }
