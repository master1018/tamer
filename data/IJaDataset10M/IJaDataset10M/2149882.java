 ...
 *
 */
public class SystemTraySWT implements UIUpdatableAlways, MessageTextListener {
    ...
    private final void createUploadLimitMenu(final Menu parent) {
        ...
        final Menu uploadSpeedMenu = new Menu(uiFunctions.getMainShell(), SWT.DROP_DOWN);
    ...
    private final void createDownloadLimitMenu(final Menu parent) {
        ...
        final Menu downloadSpeedMenu = new Menu(uiFunctions.getMainShell(), SWT.DROP_DOWN);
    ...
    public void updateUI() {
        ...
        if (enableTooltip) {
            ...
            for (int i = 0; i < managers.size(); i++) {
                ...
                if (state == DownloadManager.STATE_DOWNLOADING) downloading++;
                if (state == DownloadManager.STATE_SEEDING) seeding++;
            }
