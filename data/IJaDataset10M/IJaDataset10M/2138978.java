...
public class FeatureCreatorTask extends Task {
    ...
    private static final String copyright = "http://www.example.com/copyright";

    private static final String licence = "http://www.example.com/license";

    private static final String description = "http://www.example.com/description";

    private static final String copyrightDescription = " [Enter Copyright Description here.]";

    private static final String licenceDescription = " [Enter License Description here.]";

    private static final String descriptionDescription = " [Enter Feature Description here.]";
    ...
    private void readPluginInfo() throws Exception {
        ...
        if (elements != null) {
            ...
            if (elements != null) {
                int i = 0;
                while (!elements.item(i).getNodeName().equals("requires")) i++;
                if (i < elements.getLength()) requires = elements.item(i);
            }
        }
    }
    ...
    public void execute() {
        try {
            ...
            rootNode.appendChild(childNode);
            if (this.requires != null) rootNode.appendChild(featureDoc.importNode(requires, true));
            ...
            featureLoc += File.separator + this.featureLoc + File.separator + this.pluginID + "_" + this.pluginVersion;
