...
public class OpenTypeTagBuilder {
    ...
    private static void dumpTags(String enumName, String[] tags) {
        ...
        for (int i = 0; i < tags.length; i += 1) {
            String tag = tags[i];
            System.out.println("    LE_" + tagLabel(tag) + "_" + enumName.toUpperCase() + "_TAG = " + TagUtilities.makeTag(tag) + "UL" + (i == tags.length - 1 ? " " : ",") + " /* '" + tag + "' */");
        }
        System.out.println("};");
    }
