package com.yxl.util.string.code;
...
public class MD5Code {
    ...
    protected static long[] state = new long[4];

    protected static long[] count = new long[2];

    protected static byte[] buffer = new byte[64];

    public static String digestHexStr;

    protected static byte[] digest = new byte[16];
    ...
    protected static long F(long x, long y, long z) {
        return (x & y) | ((~x) & z);
    }

    protected static long G(long x, long y, long z) {
        return (x & z) | (y & (~z));
    }

    protected static long H(long x, long y, long z) {
        return x ^ y ^ z;
    }

    protected static long I(long x, long y, long z) {
        return y ^ (x | (~z));
    }

    protected static long FF(long a, long b, long c, long d, long x, long s, long ac) {
        a += F(b, c, d) + x + ac;
    ...
    protected static long GG(long a, long b, long c, long d, long x, long s, long ac) {
        a += G(b, c, d) + x + ac;
        a = ((int) a << s) | ((int) a >>> (32 - s));
        a += b;
        return a;
    ...
    protected static long HH(long a, long b, long c, long d, long x, long s, long ac) {
        a += H(b, c, d) + x + ac;
        a = ((int) a << s) | ((int) a >>> (32 - s));
        a += b;
        return a;
    ...
    protected static long II(long a, long b, long c, long d, long x, long s, long ac) {
        a += I(b, c, d) + x + ac;
        a = ((int) a << s) | ((int) a >>> (32 - s));
        a += b;
        return a;
    ...
    protected static void md5Update(byte[] inbuf, int inputLen) {
        int i, index, partLen;
    ...
    protected static void md5Final() {
    ...
    protected static void md5Memcpy(byte[] output, byte[] input, int outpos, int inpos, int len) {
        int i;
        for (i = 0; i < len; i++) output[outpos + i] = input[inpos + i];
    }

    protected static void md5Transform(byte block[]) {
    ...
    protected static void Encode(byte[] output, long[] input, int len) {
        int i, j;
    ...
    protected static void DecodeMd5(long[] output, byte[] input, int len) {
        int i, j;
    ...
    public static void main(String[] args) throws IOException {
        ...
        String address = "";
        BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream(new File("C:/Documents and Settings/dreamsover/桌面/echo/test.txt"))));
        String line;
        ...
        String code = md5.getMD5ofStr(address.replaceAll(" ", ""));
        int strlen = md5.getMD5ofStr(address).length();
