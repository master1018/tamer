...
public class ExpEconGraphics extends javax.swing.JDialog {

    public ExpEconGraphics(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        setName("aboutBox");
        setResizable(false);
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(expecon.ExpEconApp.class).getContext().getActionMap(ExpEconGraphics.class, this);
        closeButton.setAction(actionMap.get("closeAboutBox"));
        closeButton.setName("closeButton");
        appTitleLabel.setFont(appTitleLabel.getFont().deriveFont(appTitleLabel.getFont().getStyle() | java.awt.Font.BOLD, appTitleLabel.getFont().getSize() + 4));
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(expecon.ExpEconApp.class).getContext().getResourceMap(ExpEconGraphics.class);
