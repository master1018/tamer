...
public class StudyProgrammeEntityFactory implements EntityFactory<StudyProgrammeEntity> {
    ...
    public StudyProgrammeEntity buildFromDomainObject(Object domainObject) {
        ...
        StudyProgrammeCategoryEntity categoryEntity = EntityFactoryVault.buildFromDomainObject(studyProgramme.getCategory());
        return new StudyProgrammeEntity(studyProgramme.getId(), studyProgramme.getName(), studyProgramme.getCode(), categoryEntity, studyProgramme.getArchived());
    }
}
