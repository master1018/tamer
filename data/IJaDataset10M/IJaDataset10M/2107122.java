...
public class _1002RequestoftheElim extends QuestHandler {
    ...
    private static final int[] npc_ids = { 203076, 730007, 730010, 730008, 205000, 203067 };
        ...
        if (qs.getStatus() == QuestStatus.START) {
            switch(env.getTargetId()) {
                ...
                case 730007:
                    switch(env.getDialogId()) {
                        case 26:
                            if (var == 1) return sendQuestDialog(env, 1352); else if (var == 5) return sendQuestDialog(env, 1693, 0, 0, 182200002, 1); else if (var == 6) return sendQuestDialog(env, 2034); else if (var == 12) return sendQuestDialog(env, 2120);
                        case 1353:
                    ...
                    switch(env.getDialogId()) {
                        ...
                        case 26:
                            if (defaultCloseDialog(env, 2, 4) || defaultCloseDialog(env, 4, 5)) {
                                ...
                                if (npc != null) npc.getController().onDie(player);
                                return true;
                            }
                    }
                    break;
                case 730008:
                    switch(env.getDialogId()) {
                        case 26:
                            if (var == 13) return sendQuestDialog(env, 2375); else if (var == 14) return sendQuestDialog(env, 2461);
                        case 10004:
