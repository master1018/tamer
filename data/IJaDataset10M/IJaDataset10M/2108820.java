...
public class VisualsForEventsFiring extends AbstractIssue {
    ...
    private static class CustomImage extends Image implements HasDoubleClickHandlers, HasContextMenuHandlers {
    ...
    private static class CustomScrollPanel extends ScrollPanel implements HasMouseWheelHandlers {
    ...
    private static class CustomTextBox extends TextBox implements HasChangeHandlers {
   ...
   */
    ...
    public String getInstructions() {
        return "Use the Widgets below to verify that all events fire in all " + "browsers.  To test an event, perform the action require to trigger " + "the event using the provided widget.";
    }
   ...
   */
    private int addTest(int eventType, String eventName, Widget trigger) {
        ...
        FlexCellFormatter formatter = layout.getFlexCellFormatter();
        formatter.setVerticalAlignment(numRows, 0, HasVerticalAlignment.ALIGN_MIDDLE);
        formatter.setHorizontalAlignment(numRows, 0, HasHorizontalAlignment.ALIGN_CENTER);
        return numRows;
    }
    ...
    private void prepMouseEvents() {
        ...
        button.addMouseOutHandler(new MouseOutHandler() {
            ...
            public void onMouseOut(MouseOutEvent event) {
                ...
                if (button.getElement().equals(nativeEvent.getEventTarget()) && button.getElement().getParentElement().equals(nativeEvent.getRelatedEventTarget())) {
