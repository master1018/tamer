...
public abstract class FunctionCall extends DebuggableExecutableReturnsValue {
    ...
    @Override
    public SetValueExecutable createSetValueInstruction(ReturnsValue r) throws UnassignableTypeException {
    ...
    ReturnsValue[] compileTimeExpressionFoldArguments(CompileTimeContext context) throws ParsingException {
    ...
    public static ReturnsValue generate_function_call(WordToken name, List<ReturnsValue> arguments, ExpressionContext f) throws ParsingException {
        ...
        if (result == null) {
            ...
            throw new AmbiguousFunctionCallException(name.lineInfo, chosen, ambigous);
        } else {
            return result;
        }
    }
