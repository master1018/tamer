...
public class LargeTrigramModelTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length == 0) {
            System.out.println("Usage: java LargeTrigramModelTest <config_file> " + "[<testFile>] " + "<output_file>");
        }
        configPath = args[0];
        if (args.length >= 2) {
            testFile = args[1];
    ...
    public static String getString(WordSequence ws) {
        ...
        for (int i = 0; i < ws.size(); i++) line.append(ws.getWord(i).getSpelling()).append(' ');
