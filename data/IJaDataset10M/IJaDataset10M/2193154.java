...
public class UnsolInd extends FIXMLField {

    public static final String TAG = "325";
	...
	public void setValue(String s) throws ModelException {
	    if ( s == null || s.indexOf('|') != -1 || ENUM.indexOf(s) == -1 )
	        throw new ModelException("Invalid value (" + s + ") for field UnsolInd.");
        _Value = s;	        
	}
	...
	public void initValue(Object s) throws ModelException {
	    if ( _Value != null ) 
	        throw new ModelException("Value has already been initialized for field UnsolInd.");
        setValue((String)s);	        
	}
	...
	public String toFIXML(String ident) {
	    ...
	    return ident + "<UnsolInd FIXTag=\"325\" DataType=\"Boolean\">"
	            + _Value + "</UnsolInd>";
