...
public class OpenBoardAlias extends RaptorAlias {
    ...
    public OpenBoardAlias() {
        super("openboard", "Brings up an a classic chess inactive board from the starting position. Optionally you can add a variant.", "openboard [variant] [FEN].\nVariants supported: " + WordUtils.wrap(RaptorStringUtils.toDelimitedString(Variant.values(), ", "), 70) + ".\n Examples: \"openboard\"\n \"openboard suicide\"\n " + "\"openboard rnbbkrqn/pppppppp/8/8/8/8/PPPPPPPP/RNBBKRQN w KQkq - 0 1\"\n " + "\"openboard suicide rnbbkrqn/pppppppp/8/8/8/8/PPPPPPPP/RNBBKRQN w KQkq - 0 1\"\b");
    }
    ...
    public RaptorAliasResult apply(ChatConsoleController controller, String command) {
        if (StringUtils.startsWithIgnoreCase(command, "openboard")) {
            ...
            try {
                ...
                ChessBoardUtils.openBoard(new InactiveController(game, "openboard " + variant + " Position", false));
