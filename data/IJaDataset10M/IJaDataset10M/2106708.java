...
public interface IBytestreamConnectionListener {
    ...
    public void addIncomingTransferObject(final IncomingTransferObject incomingTransferObject);

    public void connectionClosed(JID peer, IBytestreamConnection connection);

    public void connectionChanged(JID peer, IBytestreamConnection connection, boolean incomingRequest);
}
