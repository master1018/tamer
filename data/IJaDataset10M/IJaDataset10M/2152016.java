...
public class ONDEXPluginLoaderLegacy {
     ...
     */
    private Set<String> exporterNames, filterNames, mappingNames, parserNames, statisticNames, transformerNames, validatorNames;
    ...
    private enum Type {
        ...
        EXPORT("export", "Export"), FILTER("filter", "Filter"), MAPPING("mapping", "Mapping"), PARSER("parser", "Parser"), STATISTICS("statistics", "Statistics"), TRANSFORMER("transformer", "Transformer"), VALIDATOR("validator", "Validator");
