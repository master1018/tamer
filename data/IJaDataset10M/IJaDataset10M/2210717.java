...
public abstract class ConsumerAlgorithm<T> implements Algorithm {
    ...
    public ConsumerAlgorithm(Data[] data, Dictionary parameters, CIShellContext context) {
    ...
    public Data[] execute() throws AlgorithmExecutionException {
        ...
        while (!stream.isFinalEndpoint(nextToPrint)) {
            ...
            for (int ii = nextToPrint; ii < endpoint; ii++) {
                System.out.println("About to consume " + stream.getValueAtTimestep(ii) + " from timestep " + ii);
