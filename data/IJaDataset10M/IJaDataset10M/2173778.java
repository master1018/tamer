...
public class BulletSpanTest extends TestCase {
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test constructor(s) of BulletSpan.", method = "BulletSpan", args = {  }), @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test constructor(s) of BulletSpan.", method = "BulletSpan", args = { int.class }), @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test constructor(s) of BulletSpan.", method = "BulletSpan", args = { int.class, int.class }), @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test constructor(s) of BulletSpan.", method = "BulletSpan", args = { android.os.Parcel.class }) })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test getLeadingMargin(boolean first). And the parameter first is never read", method = "getLeadingMargin", args = { boolean.class })
    @ToBeFixed(bug = "1695243", explanation = "miss javadoc")
    ...
    @TestTargetNew(level = TestLevel.TODO, notes = "Test drawLeadingMargin(Canvas c, Paint p, int x, int dir, int top," + " int baseline, int bottom, CharSequence text, int start, int end," + " boolean first, Layout l). And the following parameters are never" + " used in this method: baseline, end, first, l.", method = "drawLeadingMargin", args = { android.graphics.Canvas.class, android.graphics.Paint.class, int.class, int.class, int.class, int.class, int.class, java.lang.CharSequence.class, int.class, int.class, boolean.class, android.text.Layout.class })
    @ToBeFixed(bug = "1400249", explanation = "have not found a reasonable way to test it" + " automatically.")
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test drawLeadingMargin(Canvas c, Paint p, int x, int dir, int top," + " int baseline, int bottom, CharSequence text, int start, int end," + " boolean first, Layout l).", method = "drawLeadingMargin", args = { android.graphics.Canvas.class, android.graphics.Paint.class, int.class, int.class, int.class, int.class, int.class, java.lang.CharSequence.class, int.class, int.class, boolean.class, android.text.Layout.class })
