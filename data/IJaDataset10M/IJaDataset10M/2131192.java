...
public class color_maskType2 extends homura.hde.util.xml.xml.Node {

    public color_maskType2(color_maskType2 node) {
        super(node);
    }

    public color_maskType2(org.w3c.dom.Node node) {
        super(node);
    }

    public color_maskType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public color_maskType2(homura.hde.util.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "color_mask");
    }
    ...
    public bool4 getvalue2ValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new homura.hde.util.xml.xml.XmlException("Out of range"); else return new bool4(getDomNodeValue(curNode));
    }
