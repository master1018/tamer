...
public class ProtocoloSincronizacion {
     ...
     */
    public ProtocoloSincronizacion(String hostLocal, int puertoLocal) throws BindException, UnknownHostException, SocketException {
     ...
     * @throws SocketException
     */
    public void conectarA(String servidorSinc, int puertoDestino) throws SocketException, UnknownHostException {
     ...
     * @throws SocketException
     */
    public void cambiarDireccionesLocales(String hostLocal, int puertoLocal) throws BindException, UnknownHostException, SocketException {
     ...
     */
    public long[] obtenerTimestampsSincronizacion() throws SocketTimeoutException, IOException {
        ...
        timestampsSincronizacion[0] = temporizador.timestamp();
        this.datagramSocket.receive(paqueteUDP);
        timestampsSincronizacion[3] = temporizador.timestamp();
        timestampsSincronizacion[1] = mensajeSinc.extraerLong(mensajeSinc.POSICION_T2);
        timestampsSincronizacion[2] = mensajeSinc.extraerLong(mensajeSinc.POSICION_T3);
     ...
     * @see ParametrosSincronizacion
     */
    public void esperarPeticionSincronizacion() throws SocketTimeoutException, IOException {
        long T2;
        Temporizador temporizador = new Temporizador();
        ...
        mensajeSinc.encapsularLong(mensajeSinc.POSICION_T3, temporizador.timestamp());
        this.datagramSocket.send(paqueteUDP);
    }
