...
public class polygon_offsetType2 extends com.jmex.xml.xml.Node {

    public polygon_offsetType2(polygon_offsetType2 node) {
        super(node);
    }

    public polygon_offsetType2(org.w3c.dom.Node node) {
        super(node);
    }

    public polygon_offsetType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public polygon_offsetType2(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "polygon_offset");
    }
    ...
    public float22 newvalue2() {
        return new float22();
    }

    public float22 getvalue2At(int index) throws Exception {
        return new float22(getDomNodeValue(getDomChildAt(Attribute, null, "value", index)));
    }
    ...
    public float22 getvalue2ValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new com.jmex.xml.xml.XmlException("Out of range"); else return new float22(getDomNodeValue(curNode));
    }

    public float22 getvalue2() throws Exception {
    ...
    public org.w3c.dom.Node addvalue2(float22 value) {
    ...
    public org.w3c.dom.Node addvalue2(String value) throws Exception {
        return addvalue2(new float22(value));
    }

    public void insertvalue2At(float22 value, int index) {
    ...
    public void insertvalue2At(String value, int index) throws Exception {
        insertvalue2At(new float22(value), index);
    }

    public void replacevalue2At(float22 value, int index) {
    ...
    public void replacevalue2At(String value, int index) throws Exception {
        replacevalue2At(new float22(value), index);
    }
