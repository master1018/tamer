 ...
 * @version 1.00
 */
public class CoursePortfolioModule extends lebah.portal.velocity.VTemplate implements lebah.portal.Attributable {
    ...
    public Template doTemplate() throws Exception {
        ...
        String template_name = "vtl/courseportfolio/portfolio.vm";
        ...
        if ("addPage".equals(submit)) {
            template_name = "vtl/courseportfolio/add.vm";
        ...
        int pageNum = !"".equals(getParam("pageNum")) ? Integer.parseInt(getParam("pageNum")) : 0;
        CoursePortfolio p = CoursePortfolioData.getPortfolio(subjectId);
    ...
    void addNew(HttpSession session, String subjectId) throws Exception {
        ...
        CoursePortfolioData.addNewPage(subjectId, text);
    }

    void movePage(HttpSession session, String subjectId) throws Exception {
        int toPage = Integer.parseInt(getParam("movePage")) + 1;
        int fromPage = Integer.parseInt(getParam("pageNum")) + 1;
        CoursePortfolioData.movePage(subjectId, fromPage, toPage);
    }

    void deletePage(HttpSession session, String subjectId) throws Exception {
        int page = Integer.parseInt(getParam("pageNum")) + 1;
        CoursePortfolioData.deletePage(subjectId, page);
    }

    void modifyPage(HttpSession session, String subjectId) throws Exception {
        int page = Integer.parseInt(getParam("pageNum")) + 1;
        Hashtable h = CoursePortfolioData.getPageContent(subjectId, page);
    ...
    void updatePage(HttpSession session) throws Exception {
        ...
        CoursePortfolioData.updatePage(pageId, text);
    }
}
