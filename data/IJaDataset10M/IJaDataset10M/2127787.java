...
public class CollectionRangeCSImpl extends CollectionLiteralPartsCSImpl implements CollectionRangeCS {
    ...
    public void setFrom(OclExpressionCS newFrom) {
        if (newFrom != from) {
            ...
            if (from != null) msgs = ((InternalEObject) from).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OclPackage.COLLECTION_RANGE_CS__FROM, null, msgs);
            if (newFrom != null) msgs = ((InternalEObject) newFrom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OclPackage.COLLECTION_RANGE_CS__FROM, null, msgs);
            msgs = basicSetFrom(newFrom, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.COLLECTION_RANGE_CS__FROM, newFrom, newFrom));
    }
    ...
    public void setTo(OclExpressionCS newTo) {
        if (newTo != to) {
            NotificationChain msgs = null;
            if (to != null) msgs = ((InternalEObject) to).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OclPackage.COLLECTION_RANGE_CS__TO, null, msgs);
            if (newTo != null) msgs = ((InternalEObject) newTo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OclPackage.COLLECTION_RANGE_CS__TO, null, msgs);
            msgs = basicSetTo(newTo, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.COLLECTION_RANGE_CS__TO, newTo, newTo));
    }
