...
public class MapIdTest extends AbstractFunctionalTest {
    ...
    public void testMapIdWithSubClasses() {
        ...
        assertNotNull("B property of dest should be instantiated if mapping by map-id works", dest.getBProperty());
    ...
    public void testMapIdWithHint() {
        ...
        assertEquals(((A) (aListContainer.getAList().get(0))).getSuperAField(), bContainer.getBField().getSuperBField());
        AListContainer newAListContainer = (AListContainer) mapper.map(bContainer, AListContainer.class);
