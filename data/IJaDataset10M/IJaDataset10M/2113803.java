...
class SshTunneledSocketFactory implements SocketFactory {
    ...
    public Socket createSocket(String host, int port, String sshHost) throws IOException {
        if (localPort == 0) {
            if (sshHost == null) {
    ...
    private void createTunnel(String host, int port, String sshHost) throws Exception {
        try {
            JSch jsch = new JSch();
   ...
   */
    ...
    public static class MyUserInfo implements UserInfo, UIKeyboardInteractive {
        ...
        public boolean promptYesNo(String str) {
            ...
            int foo = JOptionPane.showOptionDialog(null, str, "SSH: Warning", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[0]);
            return foo == 0;
        }
