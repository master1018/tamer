    ...
    static final class Max<T> extends Reductor<T, T, T> {
        ...
        protected T reduce(final T left, final T right, final ExecCtx ctx) {
            ...
            if (!(left instanceof Comparable)) {
                throw new ExecutionException("Cannot apply reduction: left side of reduction is not comparable (" + left.getClass().getName() + ")");
            }
            if (!(right instanceof Comparable)) {
                throw new ExecutionException("Cannot apply reduction: right side of reduction is not comparable (" + left.getClass().getName() + ")");
            }
