...
public class ConcurrentExampleConstants {
    ...
    public static final Color ERROR_MESSAGE_COLOR = Color.white;
    ...
    public static final Color REJECTED_COLOR = Color.white;

    public static final Color DEFAULT_BACKGROUND = new Color(0, 0, 0);

    public static final Color MUTEX_BACKGROUND = new Color(135, 134, 126).brighter();

    public static final Color MUTEX_FONT_COLOR = new Color(255, 255, 255);
