 ...
 * @generated
 */
public class PlwebParserProvider extends AbstractProvider implements IParserProvider {
    ...
    private IParser getAreaTitle_5001Parser() {
        if (areaTitle_5001Parser == null) {
            EAttribute[] features = new EAttribute[] { PlwebPackage.eINSTANCE.getElement_Title() };
