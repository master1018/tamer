...
/**
 * Java�����p�̃f�[�^�o�^�N���X�Q��K�؂Ƀr�W�^�[�ɓo�^���C�r�W�^�[�ɑ΂��鑀����s�����\�b�h��񋟂���D
 * 
 * @author kou-tngt
 *
 * @param <T> �Ǘ�����Visitor���K�₷��AST�̃m�[�h�̌^
 */
public class JavaAstVisitorManager<T> implements AstVisitorManager<T> {
    ...
    public JavaAstVisitorManager(final AstVisitor<T> visitor, final Settings settings) {
        ...
        this.builders.add(new InheritanceBuilder(this.buildDataManager, new JavaTypeBuilder(this.buildDataManager)));
        this.builders.add(new ThrowsBuilder(this.buildDataManager, new JavaTypeBuilder(this.buildDataManager)));
        ...
        this.builders.add(new ConstructorBuilder(this.buildDataManager, new ModifiersBuilder(), new JavaTypeBuilder(this.buildDataManager), new NameBuilder(), new MethodParameterBuilder(this.buildDataManager, new ModifiersBuilder(), new JavaTypeBuilder(this.buildDataManager), new NameBuilder())));
        this.builders.add(new MethodBuilder(this.buildDataManager, new ModifiersBuilder(), new JavaTypeBuilder(this.buildDataManager), new NameBuilder(), new MethodParameterBuilder(this.buildDataManager, new ModifiersBuilder(), new JavaTypeBuilder(this.buildDataManager), new NameBuilder())));
        this.builders.add(new MethodBuilderFromPropertyAST(this.buildDataManager, new ModifiersBuilder(), new JavaTypeBuilder(this.buildDataManager), new NameBuilder()));
        ...
        this.builders.add(new FieldBuilder(this.buildDataManager, this.expressionManager, new ModifiersBuilder(), new JavaTypeBuilder(this.buildDataManager), new NameBuilder()));
        final LocalVariableBuilder localVariableBuilder = new LocalVariableBuilder(this.buildDataManager, this.expressionManager, new ModifiersBuilder(), new JavaTypeBuilder(this.buildDataManager), new NameBuilder());
    ...
    private void addExpressionBuilder() {
        this.builders.add(new ExpressionDescriptionBuilder(this.expressionManager, this.buildDataManager));
        this.builders.add(new SingleIdentifierBuilder(this.expressionManager, this.buildDataManager));
        this.builders.add(new JavaCompoundIdentifierBuilder(this.expressionManager, this.buildDataManager));
        ...
        this.builders.add(new OperatorExpressionBuilder(this.expressionManager, this.buildDataManager));
        this.builders.add(new JavaConstructorCallBuilder(this.expressionManager, this.buildDataManager));
        this.builders.add(new JavaArrayInstantiationBuilder(this.expressionManager, this.buildDataManager));
        this.builders.add(new JavaExpressionElementBuilder(this.expressionManager, this.buildDataManager));
    ...
    private void addStatementBuilder(final LocalVariableBuilder localVariableBuilder) {
        final LocalVariableDeclarationStatementBuilder localVariableDeclarationBuilder = new LocalVariableDeclarationStatementBuilder(localVariableBuilder, this.buildDataManager);
        this.builders.add(localVariableDeclarationBuilder);
        this.builders.add(new ExpressionStatementBuilder(this.expressionManager, this.buildDataManager));
        this.builders.add(new ReturnStatementBuilder(this.expressionManager, this.buildDataManager));
        ...
        this.builders.add(new ContinueStatementBuilder(this.expressionManager, this.buildDataManager));
    ...
    private void addInnerBlockBuilder(final LocalVariableDeclarationStatementBuilder variableBuilder) {
        this.builders.add(new CatchBlockBuilder(this.buildDataManager, new LocalVariableBuilder(this.buildDataManager, this.expressionManager, new ModifiersBuilder(), new JavaTypeBuilder(this.buildDataManager), new NameBuilder())));
        this.builders.add(new DoBlockBuilder(this.buildDataManager, this.expressionManager, variableBuilder));
        ...
        this.builders.add(new ForBlockBuilder(this.buildDataManager, this.expressionManager, variableBuilder));
        this.builders.add(new ForeachBlockBuilder(this.buildDataManager, this.expressionManager, variableBuilder));
        this.builders.add(new IfBlockBuilder(this.buildDataManager, this.expressionManager, variableBuilder));
        this.builders.add(new SimpleBlockBuilder(this.buildDataManager));
        this.builders.add(new SwitchBlockBuilder(this.buildDataManager, this.expressionManager, variableBuilder));
        ...
        this.builders.add(new WhileBlockBuilder(this.buildDataManager, this.expressionManager, variableBuilder));
    }
