...
public class ImageView extends View {
    ...
    public void setImageDrawable(Drawable drawable) {
        ...
        if (drawable instanceof BitmapDrawable) {
            ((UIImageView) xmlvmGetViewHandler().getContentView()).setImage(((BitmapDrawable) drawable).xmlvmGetImage());
    ...
    private void refreshImageStateDrawable() {
        if (drawable instanceof StateListDrawable) {
            ...
            if (currentImg != newImg) {
                boolean relayout = currentImg != null && newImg != null && !currentImg.getSize().equals(newImg.getSize());
