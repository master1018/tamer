package fr.fous.ecore.edit.parts;
...
import fr.fous.ecore.edit.policies.EcoreTextSelectionEditPolicy;
import fr.fous.ecore.providers.EcoreElementTypes;
import fr.fous.ecore.providers.EcoreParserProvider;
...
public class EEnumNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    public IParser getParser() {
        if (parser == null) {
            ...
            IAdaptable hintAdapter = new EcoreParserProvider.HintAdapter(EcoreElementTypes.EEnum_1004, getParserElement(), parserHint);
