 ...
 */
public class SmileysSelectorBox extends SIPCommMenuBar implements ActionListener, MouseListener {

    private final ChatWritePanel chatWritePanel;

    private final Hashtable<JMenuItem, Smiley> smileysList = new Hashtable<JMenuItem, Smiley>();
     ...
     */
    public SmileysSelectorBox(Collection<Smiley> imageList, ChatWritePanel writePanel) {
     ...
     */
    private void addSmileyToGrid(Smiley smiley, int smileyIndex) {
    ...
    public void setText(String text) {
        ...
        this.selectorBox.setForeground(new Color(GuiActivator.getResources().getColor("service.gui.CHAT_MENU_FOREGROUND")));
    }
