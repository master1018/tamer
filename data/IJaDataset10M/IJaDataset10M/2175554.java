...
public abstract class StatisticDay extends YearStatistic implements IBarSelectionProvider, ITourProvider {
    ...
    private static final String DISTANCE_DATA = "distance";

    private static final String ALTITUDE_DATA = "altitude";

    private static final String DURATION_DATA = "duration";
    ...
    private ChartToolTipInfo createToolTipData(int valueIndex) {
        ...
        final String tourDescription = _tourDayData.tourDescription.get(valueIndex).replace(UI.SYSTEM_NEW_LINE, UI.NEW_LINE);
        ...
        toolTipFormat.append(Messages.TourTime_Info_DateDay);
        ...
        final String toolTipLabel = new Formatter().format(toolTipFormat.toString(), beginDate, _tourDayData.weekValues[valueIndex], distance / 1000, UI.UNIT_LABEL_DISTANCE, (int) _tourDayData.tourAltitudeValues[valueIndex], UI.UNIT_LABEL_ALTITUDE, startValue[valueIndex] / 3600, (startValue[valueIndex] % 3600) / 60, (endValue[valueIndex] / 3600) % 24, (endValue[valueIndex] % 3600) / 60, recordingTime / 3600, (recordingTime % 3600) / 60, (recordingTime % 3600) % 60, drivingTime / 3600, (drivingTime % 3600) / 60, (drivingTime % 3600) % 60, breakTime / 3600, (breakTime % 3600) / 60, (breakTime % 3600) % 60, speed, UI.UNIT_LABEL_SPEED, (int) (pace / 60), (int) (pace % 60), UI.UNIT_LABEL_PACE, tourTypeName, tourTags, tourDescription).toString();
    ...
    void createYDataAltitude(final ChartDataModel chartModel) {
        final ChartDataYSerie yData = new ChartDataYSerie(ChartDataModel.CHART_TYPE_BAR, _tourDayData.altitudeLow, _tourDayData.altitudeHigh);
    ...
    void createYDataDistance(final ChartDataModel chartModel) {
        final ChartDataYSerie yData = new ChartDataYSerie(ChartDataModel.CHART_TYPE_BAR, _tourDayData.distanceLow, _tourDayData.distanceHigh);
    ...
    void createYDataDuration(final ChartDataModel chartModel) {
        final ChartDataYSerie yData = new ChartDataYSerie(ChartDataModel.CHART_TYPE_BAR, _tourDayData.getTimeLowFloat(), _tourDayData.getTimeHighFloat());
    ...
    public void updateStatistic(final StatisticContext statContext) {
        ...
        _tourDayData = DataProviderTourDay.getInstance().getDayData(statContext.appPerson, statContext.appTourTypeFilter, statContext.statYoungestYear, statContext.statNumberOfYears, isDataDirtyWithReset() || statContext.isRefreshData);
