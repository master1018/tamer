...
public class StandardStorageFormat implements StorageFormat {
    ...
    public String storeString(Drawing saveDrawing) throws IOException {
        bout = new ByteArrayOutputStream();
        StorableOutput output = new StorableOutput(bout);
    ...
    public Drawing restoreString(String s) throws IOException {
