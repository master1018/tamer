...
public class StandardResearch implements Research, Serializable {
    ...
    public void addResearcher() throws Exception {
        if (getResearcherNum() == getLaboratorySize()) throw new Exception("Lab already full of researchers.");
    }
    ...
    public void removeResearcher() throws Exception {
        if (getResearcherNum() == 0) throw new Exception("Lab is already empty of researchers.");
    }
}
