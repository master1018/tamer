...
public class ERXJSVariables extends WOComponent {
    ...
    public NSDictionary arguments() {
        if (_arguments == null) {
            ...
            if (o != null) _arguments = ((NSDictionary) o).mutableClone(); else _arguments = new NSMutableDictionary();
            for (Enumeration e = bindingKeys().objectEnumerator(); e.hasMoreElements(); ) {
                String s = (String) e.nextElement();
                if (s.indexOf("?") == 0) {
                    Object obj = valueForBinding(s);
                    if (obj != null) ((NSMutableDictionary) _arguments).setObjectForKey(obj, s.substring(1));
                }
            }
        }
        return _arguments;
