...
public class DownloadStatusEventHandler implements DownloadStatusListener {
    ...
    private static interface i18n {
        ...
        String UPDATE_DOWNLOAD_FAILED_TITLE = s_stringMgr.getString("DownloadStatusEventHandler.updateDownloadFailedTitle");

        String UPDATE_DOWNLOAD_FAILED_MSG = s_stringMgr.getString("DownloadStatusEventHandler.updateDownloadFailedMsg");

        String FILE_LABEL = s_stringMgr.getString("DownloadStatusEventHandler.fileLabel");
    }
    ...
    private void handleDownloadStarted() {
        ...
        GUIUtils.processOnSwingEventThread(new Runnable() {
            ...
            public void run() {
                ...
                progressMonitor = new ProgressMonitor(frame, i18n.DOWNLOADING_UPDATES_MSG, i18n.DOWNLOADING_UPDATES_MSG, 0, totalFiles);
                setProgress(0);
            }
        });
    }
