...
public class TrackingFeatureManager implements FeatureManager {
     ...
     */
    public TrackingFeatureManager(FeatureNotifier notifier, FeatureExtractorFactory factory, int reference) {
    ...
    public boolean has(Features feature) {
        if (feature == Features.None || feature == Features.Event || feature == Features.Packet) return true;
