   ...
   */
    public void testTranslation() {
        LanguageUtils.loadTranslation(new Runnable() {
            ...
            public void run() {
                Translation.translate("hello world", Language.ENGLISH, Language.SPANISH, new TranslationCallback() {
   ...
   */
    public void testTranslationError() {
        LanguageUtils.loadTranslation(new Runnable() {
            ...
            public void run() {
                Translation.translate("hello world", "en", "zz", new TranslationCallback() {

                    @Override
                    protected void onCallback(TranslationResult result) {
                        assertEquals("invalid translation language pair", result.getError().getMessage());
    ...
    public void testTranslationWithHTMLOption() {
        ...
        LanguageUtils.loadTranslation(new Runnable() {
            ...
            public void run() {
                ...
                Option option = Option.newInstance("<bold>beans and rice</bold>", ContentType.HTML);
                assertNotNull(option);
                Translation.translate(option, Language.ENGLISH, Language.SPANISH, new TranslationCallback() {
   ...
   */
    public void testTranslationWithTextOption() {
        LanguageUtils.loadTranslation(new Runnable() {
            ...
            public void run() {
                Option option = Option.newInstance("Please bring me < bold > beans and rice. </ bold>", ContentType.TEXT);
                assertNotNull(option);
                Translation.translate(option, Language.ENGLISH, Language.SPANISH, new TranslationCallback() {
