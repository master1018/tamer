...
public class GhostedDragImage extends AbstractComponentDecorator {
    ...
    protected static final Logger logger = Logger.getLogger(GhostedDragImage.class);
    ...
    private List<GhostedDragImage> ghosts = new ArrayList<GhostedDragImage>();

    private Component dragSource;

    private float ghostAlpha = .8f;
    ...
    protected GhostedDragImage(JComponent dragSource, JLayeredPane root, Point screenLocation, Icon icon, Point imageOffset, boolean trackFrames) {
        ...
        setLocation(screenLocation.x - loc.x + imageOffset.x, screenLocation.y - loc.y + imageOffset.y);
        if (trackFrames) {
        ...
        timer.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (dx != 0 || dy != 0) {
                    ...
                    Point where = new Point(loc.x + location.x + dx - imageOffset.x, loc.y + location.y + dy - imageOffset.y);
                    move(where);
                } else {
                    timer.stop();
                    dispose();
