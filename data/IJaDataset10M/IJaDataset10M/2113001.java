...
public class RawTextContextUpdaterTest extends TestCase {
    ...
    public final void testPcdata() throws Exception {
        ...
        assertTransition("HTML_PCDATA", "<a onclick=\"</script>", "JS_REGEX NORMAL SCRIPT DOUBLE_QUOTE");
        ...
        assertTransition("HTML_PCDATA", "<script src=/search?q=", "URI SCRIPT URI SPACE_OR_TAG_END QUERY");
        assertTransition("HTML_PCDATA", "<script src=/foo#", "URI SCRIPT URI SPACE_OR_TAG_END FRAGMENT");
        assertTransition("HTML_PCDATA", "<img src=", "HTML_BEFORE_ATTRIBUTE_VALUE NORMAL URI");
        assertTransition("HTML_PCDATA", "<a href=mailto:", "URI NORMAL URI SPACE_OR_TAG_END PRE_QUERY");
        assertTransition("HTML_PCDATA", "<input type=button value= onclick=", "HTML_BEFORE_ATTRIBUTE_VALUE NORMAL SCRIPT");
    ...
    public final void testTagName() throws Exception {
        ...
        assertTransition("HTML_TAG_NAME", " stylez=\"", "HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT DOUBLE_QUOTE");
        assertTransition("HTML_TAG_NAME", " title=\"", "HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT DOUBLE_QUOTE");
    ...
    public final void testAttrName() throws Exception {
        ...
        assertTransition("HTML_ATTRIBUTE_NAME TEXTAREA PLAIN_TEXT", "=", "HTML_BEFORE_ATTRIBUTE_VALUE TEXTAREA PLAIN_TEXT");
        assertTransition("HTML_ATTRIBUTE_NAME NORMAL PLAIN_TEXT", " = ", "HTML_BEFORE_ATTRIBUTE_VALUE NORMAL PLAIN_TEXT");
    }

    public final void testBeforeAttrValue() throws Exception {
        assertTransition("HTML_BEFORE_ATTRIBUTE_VALUE NORMAL URI", "\"", "URI NORMAL URI DOUBLE_QUOTE START");
        assertTransition("HTML_BEFORE_ATTRIBUTE_VALUE NORMAL SCRIPT", "'", "JS NORMAL SCRIPT SINGLE_QUOTE REGEX");
        assertTransition("HTML_BEFORE_ATTRIBUTE_VALUE NORMAL STYLE", "\"", "CSS NORMAL STYLE DOUBLE_QUOTE");
        assertTransition("HTML_BEFORE_ATTRIBUTE_VALUE TEXTAREA STYLE", "color", "CSS TEXTAREA STYLE SPACE_OR_TAG_END");
        assertTransition("HTML_BEFORE_ATTRIBUTE_VALUE NORMAL URI", "/", "URI NORMAL URI SPACE_OR_TAG_END PRE_QUERY");
        assertTransition("HTML_BEFORE_ATTRIBUTE_VALUE TITLE PLAIN_TEXT", "\"", "HTML_NORMAL_ATTR_VALUE TITLE PLAIN_TEXT DOUBLE_QUOTE");
    ...
    public final void testAttr() throws Exception {
        assertTransition("HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT DOUBLE_QUOTE", "", "HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT DOUBLE_QUOTE");
        assertTransition("HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT SINGLE_QUOTE", "", "HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT SINGLE_QUOTE");
        assertTransition("HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT SPACE_OR_TAG_END", "", "HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT SPACE_OR_TAG_END");
        assertTransition("HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT DOUBLE_QUOTE", "foo", "HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT DOUBLE_QUOTE");
        assertTransition("HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT SINGLE_QUOTE", "foo", "HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT SINGLE_QUOTE");
        assertTransition("HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT SPACE_OR_TAG_END", "foo", "HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT SPACE_OR_TAG_END");
        assertTransition("HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT DOUBLE_QUOTE", "\"", "HTML_TAG NORMAL");
        assertTransition("HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT SINGLE_QUOTE", "'", "HTML_TAG NORMAL");
        assertTransition("HTML_NORMAL_ATTR_VALUE SCRIPT PLAIN_TEXT SINGLE_QUOTE", "'", "HTML_TAG SCRIPT");
        assertTransition("HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT SPACE_OR_TAG_END", " x='", "HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT SINGLE_QUOTE");
        assertTransition("HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT SPACE_OR_TAG_END", " x='y'", "HTML_TAG NORMAL");
        assertTransition("HTML_NORMAL_ATTR_VALUE NORMAL PLAIN_TEXT SPACE_OR_TAG_END", ">", "HTML_PCDATA");
    ...
    public final void testCssComment() throws Exception {
        ...
        assertTransition("CSS_COMMENT", "**/", "CSS");
        assertTransition("CSS_COMMENT", "\\*/", "CSS");
        assertTransition("CSS_COMMENT NORMAL STYLE SPACE_OR_TAG_END", "*/", "CSS NORMAL STYLE SPACE_OR_TAG_END");
    }
    ...
    public final void testCssDqString() throws Exception {
        ...
        assertTransition("CSS_DQ_STRING", "</style>", "HTML_PCDATA");
    }
    ...
    public final void testCssSqString() throws Exception {
        ...
        assertTransition("CSS_SQ_STRING", "</style>", "HTML_PCDATA");
        assertTransition("CSS_SQ_STRING NORMAL STYLE SPACE_OR_TAG_END", "'", "CSS NORMAL STYLE SPACE_OR_TAG_END");
    }
    ...
    public final void testCssUri() throws Exception {
        ...
        assertTransition("CSS_SQ_URI START", "(/don%27t+panic)", "CSS_SQ_URI PRE_QUERY");
        assertTransition("CSS_DQ_URI START", "Muhammed+%22The+Greatest!%22+Ali", "CSS_DQ_URI PRE_QUERY");
        assertTransition("CSS_DQ_URI START", "/don't+panic", "CSS_DQ_URI PRE_QUERY");
        assertTransition("CSS_SQ_URI START", "#foo'", "CSS");
        assertTransition("CSS_URI NORMAL STYLE SPACE_OR_TAG_END START", ")", "CSS NORMAL STYLE SPACE_OR_TAG_END");
        assertTransition("CSS_DQ_URI NORMAL STYLE SINGLE_QUOTE PRE_QUERY", "\"", "CSS NORMAL STYLE SINGLE_QUOTE");
        assertTransition("CSS_SQ_URI NORMAL STYLE DOUBLE_QUOTE FRAGMENT", "#x'", "CSS NORMAL STYLE DOUBLE_QUOTE");
    }
    ...
    public final void testJsBeforeRegex() throws Exception {
        ...
        assertTransition("JS NORMAL SCRIPT SPACE_OR_TAG_END REGEX", "/*", "JS_BLOCK_COMMENT NORMAL SCRIPT SPACE_OR_TAG_END REGEX");
        assertTransition("JS REGEX", "//", "JS_LINE_COMMENT REGEX");
        assertTransition("JS NORMAL SCRIPT SPACE_OR_TAG_END REGEX", "//", "JS_LINE_COMMENT NORMAL SCRIPT SPACE_OR_TAG_END REGEX");
        assertTransition("JS REGEX", "'", "JS_SQ_STRING");
        assertTransition("JS NORMAL SCRIPT SPACE_OR_TAG_END REGEX", "'", "JS_SQ_STRING NORMAL SCRIPT SPACE_OR_TAG_END");
        assertTransition("JS REGEX", "\"", "JS_DQ_STRING");
        assertTransition("JS NORMAL SCRIPT SPACE_OR_TAG_END REGEX", "\"", "JS_DQ_STRING NORMAL SCRIPT SPACE_OR_TAG_END");
        assertTransition("JS REGEX", "42", "JS DIV_OP");
        assertTransition("JS NORMAL SCRIPT SPACE_OR_TAG_END REGEX", "42", "JS NORMAL SCRIPT SPACE_OR_TAG_END DIV_OP");
        ...
        assertTransition("JS NORMAL SCRIPT SPACE_OR_TAG_END REGEX", "/", "JS_REGEX NORMAL SCRIPT SPACE_OR_TAG_END");
    ...
    public final void testJsBeforeDivOp() throws Exception {
        ...
        assertTransition("JS NORMAL SCRIPT SPACE_OR_TAG_END DIV_OP", "/*", "JS_BLOCK_COMMENT NORMAL SCRIPT SPACE_OR_TAG_END DIV_OP");
        assertTransition("JS DIV_OP", "//", "JS_LINE_COMMENT DIV_OP");
        assertTransition("JS NORMAL SCRIPT SPACE_OR_TAG_END DIV_OP", "//", "JS_LINE_COMMENT NORMAL SCRIPT SPACE_OR_TAG_END DIV_OP");
        assertTransition("JS DIV_OP", "'", "JS_SQ_STRING");
        assertTransition("JS NORMAL SCRIPT SPACE_OR_TAG_END DIV_OP", "'", "JS_SQ_STRING NORMAL SCRIPT SPACE_OR_TAG_END");
        assertTransition("JS DIV_OP", "\"", "JS_DQ_STRING");
        assertTransition("JS NORMAL SCRIPT SPACE_OR_TAG_END DIV_OP", "\"", "JS_DQ_STRING NORMAL SCRIPT SPACE_OR_TAG_END");
        assertTransition("JS DIV_OP", "42", "JS DIV_OP");
        assertTransition("JS NORMAL SCRIPT SPACE_OR_TAG_END DIV_OP", "42", "JS NORMAL SCRIPT SPACE_OR_TAG_END DIV_OP");
        ...
        assertTransition("JS DIV_OP", ")", "JS DIV_OP");
        assertTransition("JS DIV_OP", "/", "JS REGEX");
        assertTransition("JS NORMAL SCRIPT SPACE_OR_TAG_END DIV_OP", "/", "JS NORMAL SCRIPT SPACE_OR_TAG_END REGEX");
    ...
    public final void testJsLineComment() throws Exception {
        ...
        assertTransition("JS_LINE_COMMENT NORMAL SCRIPT DOUBLE_QUOTE DIV_OP", "\n", "JS NORMAL SCRIPT DOUBLE_QUOTE DIV_OP");
    ...
    public final void testJsBlockComment() throws Exception {
        ...
        assertTransition("JS_BLOCK_COMMENT NORMAL SCRIPT DOUBLE_QUOTE DIV_OP", "*/", "JS NORMAL SCRIPT DOUBLE_QUOTE DIV_OP");
    ...
    public final void testJsDqString() throws Exception {
        ...
        assertTransition("JS_DQ_STRING NORMAL SCRIPT SINGLE_QUOTE", "Hello, World!", "JS_DQ_STRING NORMAL SCRIPT SINGLE_QUOTE");
        assertTransition("JS_DQ_STRING NORMAL SCRIPT SINGLE_QUOTE", "\"", "JS NORMAL SCRIPT SINGLE_QUOTE DIV_OP");
        assertTransition("JS_DQ_STRING", "</script>", "HTML_PCDATA");
    ...
    public final void testJsSqString() throws Exception {
        ...
        assertTransition("JS_SQ_STRING NORMAL SCRIPT DOUBLE_QUOTE", "Hello, World!", "JS_SQ_STRING NORMAL SCRIPT DOUBLE_QUOTE");
        assertTransition("JS_SQ_STRING NORMAL SCRIPT DOUBLE_QUOTE", "'", "JS NORMAL SCRIPT DOUBLE_QUOTE DIV_OP");
        assertTransition("JS_SQ_STRING", "</script>", "HTML_PCDATA");
    ...
    public final void testJsRegex() throws Exception {
        ...
        assertTransition("JS_REGEX NORMAL SCRIPT DOUBLE_QUOTE", "Hello, World!", "JS_REGEX NORMAL SCRIPT DOUBLE_QUOTE");
        assertTransition("JS_REGEX NORMAL SCRIPT DOUBLE_QUOTE", "/", "JS NORMAL SCRIPT DOUBLE_QUOTE DIV_OP");
        assertTransition("JS_REGEX", "</script>", "HTML_PCDATA");
    }
    ...
    private static Context parseContext(String text) {
        ...
        assertTrue("Got [" + text + "] but didn't use [" + Joiner.on(' ').join(parts) + "]", parts.isEmpty());
