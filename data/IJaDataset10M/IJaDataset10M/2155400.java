...
abstract class FogRetained extends LeafRetained {
    ...
    static final int targetThreads = J3dThread.UPDATE_RENDERING_ENVIRONMENT | J3dThread.UPDATE_RENDER;
    ...
    void setInfluencingBounds(Bounds region) {
        ...
        sendMessage(BOUNDS_CHANGED, (region != null ? region.clone() : null));
    }
    ...
    void setInfluencingBoundingLeaf(BoundingLeaf region) {
        if (boundingLeaf != null) boundingLeaf.mirrorBoundingLeaf.removeUser(mirrorFog);
        if (region != null) {
            boundingLeaf = (BoundingLeafRetained) region.retained;
        ...
        sendMessage(BOUNDINGLEAF_CHANGED, (boundingLeaf != null ? boundingLeaf.mirrorBoundingLeaf : null));
    }
   ...
   */
    int indexOfScope(Group scope) {
        if (scope != null) return scopes.indexOf((GroupRetained) scope.retained); else return scopes.indexOf(null);
    }
   ...
   */
    void removeScope(Group scope) {
        ...
        if (i >= 0) removeScope(i);
    }

    void initRemoveScope(Group scope) {
        int i = indexOfScope(scope);
        if (i >= 0) initRemoveScope(i);
    }
   ...
   */
    ...
    void initRemoveAllScopes() {
        int n = scopes.size();
        for (int index = n - 1; index >= 0; index--) initRemoveScope(index);
    }
        ...
        if ((component & BOUNDS_CHANGED) != 0) {
            ...
            if (mirrorFog.boundingLeaf == null) {
                if (objs[2] != null) {
                    ...
                    mirrorFog.region.transform(mirrorFog.regionOfInfluence, getCurrentLocalToVworld());
                } else {
    ...
    void setLive(SetLiveState s) {
        ...
        s.notifyThreads |= J3dThread.UPDATE_RENDERING_ENVIRONMENT | J3dThread.UPDATE_RENDER;
        super.markAsLive();
    }
    ...
    void clearLive(SetLiveState s) {
        ...
        s.notifyThreads |= J3dThread.UPDATE_RENDERING_ENVIRONMENT | J3dThread.UPDATE_RENDER;
        if (mirrorFog.boundingLeaf != null) mirrorFog.boundingLeaf.removeUser(mirrorFog);
        if ((s.viewScopedNodeList != null) && (s.viewLists != null)) {
            s.viewScopedNodeList.add(mirrorFog);
            s.scopedNodesViewList.add(s.viewLists.get(0));
        } else {
    ...
    void updateImmediateTransformChange() {
        if (boundingLeaf == null) {
            if (regionOfInfluence != null) {
                region = regionOfInfluence.copy(region);
                region.transform(regionOfInfluence, sgFog.getCurrentLocalToVworld());
            }
        }
    }
