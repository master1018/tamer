...
public class CSQLStatus extends CJMapObject {
    ...
    private int m_nLastNbRecordUpdatedInsertedDeleted = 0;
    ...
    public void setSQLCode(String csMethod, SQLException e, String csQueryString, SQL sql) {
        doSetSQLCode(e.getErrorCode());
        m_csMethod = csMethod;
        m_csReason = "SQL Exception (" + m_nSQLCode + "):" + e.getMessage() + " SQLState=" + e.getSQLState();
        if (sql != null) {
    ...
    public void setSQLCode(String csMethod, int nCode, String csReason, String csQueryString) {
        m_csReasonParams = null;
        m_csReasonValues = null;
        doSetSQLCode(nCode);
        m_csMethod = csMethod;
    ...
    public int getSQLDiagnosticCode(int n) {
        if (n == 3) return m_nLastNbRecordUpdatedInsertedDeleted;
        return 0;
    }
