...
public class MainWindow extends javax.swing.JFrame implements DeviceListener {
    ...
    protected void refreshDevicesCombobox() {
        ...
        if (activeDevice == null) JOptionPane.showMessageDialog(this, "Application can not find any line 6 device. Plug in your device and restart application", "No Line6 devices", JOptionPane.WARNING_MESSAGE, null);
    }
    ...
    public void presetsSynchronized(Device dev) {
        presetNameTextbox.setText(dev.getActivePreset().getName());
        if (infoDialog != null) infoDialog.setVisible(false);
        setVisible(true);
