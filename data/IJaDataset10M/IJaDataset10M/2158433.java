...
import fitService.fitnesse.util.*;
import fitService.fitnesse.util.StreamReader;
...
public class FileSystemPage extends CachingPage {
    ...
    protected void loadChildren() throws Exception {
        ...
        if (thisDir.exists()) {
            ...
            for (int i = 0; i < subFiles.length; i++) {
                ...
                if (fileIsValid(subFile, thisDir) && !children.containsKey(subFile)) children.put(subFile, getChildPage(subFile));
            }
        }
    }
    ...
    public PageData getDataVersion(String versionName) throws Exception {
        ...
        if (!file.exists()) throw new NoSuchVersionException("There is no version '" + versionName + "'");
