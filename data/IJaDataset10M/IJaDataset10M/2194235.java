 ...
 *
 */
public interface Level2MapOfMapEntriesValueOperator<K1, K2, V, I> extends UniqOperator<Map<K1, Map<K2, V>>, I>, NavigableMapOperator<K2, V, I>, NavigatingMapEntryOperator<I>, CastableToMapOperator<I>, SortableOperator<Map.Entry<K2, V>, I>, ExecutableMapOperator<K2, V, I>, ModifiableMapOperator<K2, V, I>, SelectableOperator<Map<K2, V>, I>, ReplaceableOperator<Map<K2, V>, I>, ReplaceableIfNullOperator<Map<K2, V>, I>, ExtractableMapOperator<K2, V, I> {
