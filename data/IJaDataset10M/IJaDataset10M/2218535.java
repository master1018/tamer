    ...
    public boolean checkSubject(InterceptorChain chain, DN entryDN) {
        ...
        switch(this.subjectType) {
            case PUBLIC:
                ...
                break;
            case DN:
                subjectPassed = this.SubjectDN.equals(chain.getBindDN().getDN());
                break;
            case THIS:
                subjectPassed = entryDN.equals(chain.getBindDN().getDN());
                break;
            case SUBTREE:
                subjectPassed = isDescendantOf(this.SubjectDN, chain.getBindDN().getDN());
                break;
            case GROUP:
                subjectPassed = checkStaticGroup(chain);
                break;
            case DYNAMIC_GROUP:
                subjectPassed = checkDynamicGroup(chain);
                break;
        }
