...
public class AnnotationBubble extends JPanel {
     ...
     */
    public AnnotationBubble(final ChartPanel chartPanel, final AAnnotationContentComponent annotationContent, final boolean useDragListenerOnAnnotationContent, final boolean useTitleBar) {
        super();
