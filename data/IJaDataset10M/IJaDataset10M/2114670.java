...
public class Node_type implements java.io.Serializable {
     ...
     * Field _type.
     */
    private tree.jaxb.types.Node_type_string_type _type;
     ...
     */
    public tree.jaxb.types.Node_type_string_type getType() {
        return this._type;
    }
     ...
     */
    public void setType(final tree.jaxb.types.Node_type_string_type type) {
        this._type = type;
    }
}
