...
public class Persistent extends PersistentBase {
     ...
     */
    public Persistent(boolean shouldReset, boolean shouldClean, int aBatchWriteWindowSize, boolean noUseExpLog, int aMaxLogsBeforeSync, int aLogBufferSize) {
    ...
    public Persistent(boolean shouldReset, boolean shouldClean, long aBatchWindowSizeMs, int aBatchWindowSizeNs, boolean noUseExpLog, int aMaxLogsBeforeSync, int aLogBufferSize) {
        super(shouldReset, shouldClean, aLogBufferSize, aMaxLogsBeforeSync);
        dontUseExpLog = noUseExpLog;
