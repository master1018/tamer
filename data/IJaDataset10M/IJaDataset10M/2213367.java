 ...
 */
public final class BooleanVector implements ReallyCloneable, Serializable, Indexable, Sortable, Verifiable {
 ...
 * @since 2.0
 */
    public BooleanVector(boolean[] array) throws NullPointerException {
        int len;
        len = array.length;
        this.array = array;
    }
 ...
 * @since 2.0
 */
    public void setArray(boolean[] array) throws NullPointerException {
        int len;
        len = array.length;
        this.array = array;
    }
 ...
 * @see #ensureSize(int)
 */
    public final boolean getBooleanAt(int index) throws ArrayIndexOutOfBoundsException {
 ...
 * @see #fill(boolean[], int, int, boolean)
 */
    public void setAt(int index, boolean value) throws ArrayIndexOutOfBoundsException {
 ...
 * @see #ensureSize(int)
 */
    public void copyAt(int srcOffset, int destOffset, int len) throws ArrayIndexOutOfBoundsException {
        if (len > 0) {
 ...
 */
    public void resize(int size) {
        ...
        if ((len = array.length) != size) {
            ...
            if (size != 0) {
                if (len > size) if (size < 0) size = -1 >>> 1; else len = size;
                System.arraycopy(array, 0, newArray = new boolean[size], 0, len);
            }
            this.array = newArray;
        }
    }
 ...
 */
    public void ensureSize(int size) {
        ...
        if ((((len = array.length) - size) | size) < 0) {
            if (size < 0) size = -1 >>> 1;
            if ((len += len >> 1) >= size) size = len;
            System.arraycopy(array, 0, newArray = new boolean[size], 0, array.length);
            this.array = newArray;
        }
    }
 ...
 * @see #fill(boolean[], int, int, boolean)
 */
    public static final boolean[] resize(boolean[] array, int size) throws NullPointerException {
        int len;
        if ((len = array.length) != size) {
            boolean[] newArray = EMPTY;
            if (size != 0) {
 ...
 * @see #fill(boolean[], int, int, boolean)
 */
    public static final boolean[] ensureSize(boolean[] array, int size) throws NullPointerException {
        int len;
        if ((((len = array.length) - size) | size) < 0) {
            if (size < 0) size = -1 >>> 1;
            if ((len += len >> 1) >= size) size = len;
 ...
 * @since 2.0
 */
    public static final void fill(boolean[] array, int offset, int len, boolean value) throws NullPointerException, ArrayIndexOutOfBoundsException {
        int next = array.length, block;
        if (len > 0) {
            boolean temp;
            temp = array[(block = offset) + (--len)];
            if ((next = len) > 2) next = 3;
            do {
                array[block++] = value;
            } while (next-- > 0);
            len--;
 ...
 */
    public static final void reverse(boolean[] array) throws NullPointerException {
 ...
 * @see #countTrue(boolean[])
 */
    public static final void and(boolean[] arrayA, boolean[] arrayB) throws NullPointerException {
        int offset = arrayA.length, len;
        if (arrayA != arrayB) {
            if ((len = arrayB.length) <= offset) offset = len;
 ...
 * @see #countTrue(boolean[])
 */
    public static final void andNot(boolean[] arrayA, boolean[] arrayB) throws NullPointerException {
        int offset = arrayA.length, len;
        if (arrayA != arrayB) {
            if ((len = arrayB.length) <= offset) offset = len;
            while (offset-- > 0) if (arrayB[offset]) arrayA[offset] = false;
        }
        while (offset-- > 0) arrayA[offset] = false;
    }
 ...
 * @see #countTrue(boolean[])
 */
    public static final void or(boolean[] arrayA, boolean[] arrayB) throws NullPointerException {
        int offset = arrayA.length, len;
        if (arrayA != arrayB) {
            if ((len = arrayB.length) <= offset) offset = len;
            while (offset-- > 0) arrayA[offset] |= arrayB[offset];
 ...
 * @see #countTrue(boolean[])
 */
    public static final void orNot(boolean[] arrayA, boolean[] arrayB) throws NullPointerException {
        int offset = arrayA.length, len;
        if (arrayA != arrayB) {
            if ((len = arrayB.length) <= offset) offset = len;
            while (offset-- > 0) if (!arrayB[offset]) arrayA[offset] = true;
        }
        while (offset-- > 0) arrayA[offset] = true;
    }
 ...
 */
    public static final void xor(boolean[] arrayA, boolean[] arrayB) throws NullPointerException {
        int offset = arrayA.length, len;
        if (arrayA != arrayB) {
            if ((len = arrayB.length) <= offset) offset = len;
            while (offset-- > 0) arrayA[offset] ^= arrayB[offset];
 ...
 * @see #countTrue(boolean[])
 */
    public static final void invert(boolean[] array) throws NullPointerException {
        int offset = array.length;
        while (offset-- > 0) array[offset] ^= true;
    }
 ...
 * @since 2.0
 */
    public static final int countTrue(boolean[] array) throws NullPointerException {
        int offset = array.length, count = 0;
        while (offset-- > 0) if (array[offset]) count++;
        return count;
    }
 ...
 * @see #compare(boolean[], int, int, boolean[], int, int)
 */
    public static final int indexOf(boolean[] subArray, int offset, int len, int index, boolean[] array) throws NullPointerException, ArrayIndexOutOfBoundsException {
        ...
        if (len > 0) {
            ...
            index--;
            while (++index <= arrayLen) if (array[index] == value) {
                curOffset = offset;
                int curIndex = index;
                while (++curOffset <= len && array[++curIndex] == subArray[curOffset]) ;
                if (curOffset > len) break;
            }
        }
        if (index > arrayLen) index = -1;
        return index;
    }
 ...
 * @see #compare(boolean[], int, int, boolean[], int, int)
 */
    public static final int lastIndexOf(boolean[] subArray, int offset, int len, int index, boolean[] array) throws NullPointerException, ArrayIndexOutOfBoundsException {
        int curOffset = subArray.length, arrayLen;
        if (len <= 0) len = 0;
        if ((arrayLen = array.length - len) <= index) index = arrayLen;
        if (index < 0) index = -1;
        if (len > 0) {
            boolean value = subArray[offset], temp;
            temp = subArray[len += offset - 1];
            index++;
            while (index-- > 0) if (array[index] == value) {
                curOffset = offset;
                arrayLen = index;
                while (++curOffset <= len && array[++arrayLen] == subArray[curOffset]) ;
                if (curOffset > len) break;
            }
        }
        return index;
 ...
 * @see #invert(boolean[])
 */
    public static final String toString(boolean[] array, int offset, int len, char separator) throws NullPointerException, ArrayIndexOutOfBoundsException {
        int capacity = array.length;
        capacity = 0;
        if (len > 0) {
            boolean value = array[offset];
            value = array[offset + len - 1];
            if ((capacity = len << 2) <= 24) capacity = 24;
        }
 ...
 * @see #mismatches(boolean[], int, boolean[], int, int)
 */
    public static final int hashCode(boolean[] array) throws NullPointerException {
        int code = 0, offset = 0;
        for (int len = array.length; offset < len; code = (code << 5) - code) code ^= array[offset++] ? 1231 : 1237;
        return code ^ offset;
    }
 ...
 * @since 2.0
 */
    public static final boolean equals(boolean[] arrayA, boolean[] arrayB) throws NullPointerException {
        int offset = arrayA.length;
        if (arrayA != arrayB) if (arrayB.length != offset) return false; else while (offset-- > 0) if (arrayA[offset] != arrayB[offset]) return false;
        return true;
    }
 ...
 * @since 2.0
 */
    public static final int mismatches(boolean[] arrayA, int offsetA, boolean[] arrayB, int offsetB, int len) throws NullPointerException, ArrayIndexOutOfBoundsException {
        ...
        if (len > 0) {
            ...
            if (offsetA != offsetB || arrayA != arrayB) do {
                if (arrayA[offsetA++] != arrayB[offsetB++]) count++;
            } while (--len > 0);
        }
        return count;
    }
 ...
 * @see #mismatches(boolean[], int, boolean[], int, int)
 */
    public static final int compare(boolean[] arrayA, int offsetA, int lenA, boolean[] arrayB, int offsetB, int lenB) throws NullPointerException, ArrayIndexOutOfBoundsException {
        boolean value = false;
        if (arrayA.length == arrayB.length) value = true;
        if (lenA > 0) {
        ...
        if ((lenB = lenA - lenB) >= 0) lenA -= lenB;
        if (offsetA != offsetB || arrayA != arrayB) while (lenA > 0) {
 ...
 */
    public Object clone() {
        Object obj;
        try {
            if ((obj = super.clone()) instanceof BooleanVector && obj != this) {
 ...
 */
    public boolean equals(Object obj) {
        return obj == this || obj instanceof BooleanVector && equals(this.array, ((BooleanVector) obj).array);
    }
 ...
 */
    public boolean greaterThan(Object obj) {
        if (obj != this && obj instanceof BooleanVector) {
            ...
            if (compare(array, 0, array.length, otherArray, 0, otherArray.length) > 0) return true;
        }
        return false;
    }
 ...
 */
    public void integrityCheck() {
        if (this.array == null) throw new InternalError("array: null");
    }
