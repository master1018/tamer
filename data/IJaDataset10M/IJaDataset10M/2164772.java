...
public class LocalizedText implements Comparable<LocalizedText>, Serializable {
    ...
    private static PersistentFactory<LocalizedText> factory = new PersistentFactory<LocalizedText>(LocalizedText.class, "localizationCode");

    public static void addTranslation(String textGroup, String textCode, Locale forLocale, String translation) throws PersistenceException {
    ...
    public static Collection<LocalizedText> getTranslations(String textGroup, String textCode) throws PersistenceException {
