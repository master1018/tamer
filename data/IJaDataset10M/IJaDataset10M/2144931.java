...
public class Account implements Category, Serializable, Constants {
    ...
    private void cleanupEntry(Entry entry) {
        if (entry instanceof DoubleEntry) ((DoubleEntry) entry).removeOther(); else if (entry instanceof SplittedEntry) ((SplittedEntry) entry).removeAllEntries();
    }
    ...
    public void setName(String aName) {
        if (name != null && name.equals(aName)) return;
        name = aName;
    ...
    public void setCurrencyCode(String aCurrencyCode) {
        if (currencyCode != null && currencyCode.equals(aCurrencyCode)) return;
    ...
    public void setBank(String aBank) {
        if (bank != null && bank.equals(aBank)) return;
        bank = aBank;
    ...
    public void setAccountNumber(String anAccountNumber) {
        if (accountNumber != null && accountNumber.equals(anAccountNumber)) return;
    ...
    public void setAbbrevation(String anAbbrevation) {
        if (abbrevation != null && abbrevation.equals(anAbbrevation)) return;
    ...
    public void setComment(String aComment) {
        if (comment != null && comment.equals(aComment)) return;
        comment = aComment;
    ...
    public String getFullCategoryName() {
        return SerializedDatastorePlugin.getResourceString("TransferCategory.name") + ":" + getCategoryName();
    }
