...
public class EPerceivesEdge extends NAryEdge {
    ...
    public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
        ...
        if (nAryEdgesNum > 1 || edgesNum > 0 || !((selectedEdge == null) || (selectedEdge instanceof EPerceivesEdge))) return false;
        EPerceivesEdge edge = new EPerceivesEdge(null);
        if (nAryEdgesNum == 1 && selectedEdge instanceof EPerceivesEdge) edge = (EPerceivesEdge) selectedEdge;
