...
/**
 * This is a default implementation of the IFC object Ifc2DCompositeCurve<br><br>
 * 
 ...
 **/
public class Ifc2DCompositeCurve extends IfcCompositeCurve implements IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "LIST<IfcCompositeCurveSegment>", "LOGICAL" };
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("Segments")) stepString = stepString.concat("*,"); else {
            if (this.Segments != null) stepString = stepString.concat(((IfcRootInterface) this.Segments).getStepParameter(IfcCompositeCurveSegment.class.isInterface()) + ","); else stepString = stepString.concat("$,");
        }
    ...
    /**
	 * This method returns the value of the Segments attribute.
	 * 
    ...
    public Object clone() {
        ...
        if (this.Segments != null) ifc2DCompositeCurve.setSegments((LIST<IfcCompositeCurveSegment>) this.Segments.clone());
        if (this.SelfIntersect != null) ifc2DCompositeCurve.setSelfIntersect((LOGICAL) this.SelfIntersect.clone());
    ...
    public Object shallowCopy() {
        Ifc2DCompositeCurve ifc2DCompositeCurve = new Ifc2DCompositeCurve();
        if (this.Segments != null) ifc2DCompositeCurve.setSegments(this.Segments);
        if (this.SelfIntersect != null) ifc2DCompositeCurve.setSelfIntersect(this.SelfIntersect);
        return ifc2DCompositeCurve;
    }
