...
public abstract class PeriodicalImpl extends ItemImpl implements Periodical {
   ...
   */
    public void setTitle(String newTitle) {
        ...
        title = newTitle;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, EXTLibraryPackage.PERIODICAL__TITLE, oldTitle, title));
    }
   ...
   */
    public void setIssuesPerYear(int newIssuesPerYear) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, EXTLibraryPackage.PERIODICAL__ISSUES_PER_YEAR, oldIssuesPerYear, issuesPerYear));
    }
