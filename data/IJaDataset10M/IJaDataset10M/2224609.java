...
public class CExportCSVTest {
    ...
    private String[] columnNames = new String[] { "refnum", "sex", "crefnum", "question", "age", "weight" };

    private String[] PKs = new String[] { "refnum", "crefnum" };

    private CellReader<?>[] columnOptionalReaders = new CellReader<?>[] { CellReaders.OPTIONAL_INTEGER, CellReaders.CHARACTER, CellReaders.OPTIONAL_INTEGER, CellReaders.OPTIONAL_INTEGER, CellReaders.OPTIONAL_INTEGER, CellReaders.OPTIONAL_DOUBLE };

    private CellReader<?>[] columnReaders = new CellReader<?>[] { CellReaders.INTEGER, CellReaders.CHARACTER, CellReaders.INTEGER, CellReaders.INTEGER, CellReaders.INTEGER, CellReaders.DOUBLE };

    @Test
    public void testExportCSV() throws IOException, CDataGridException {
        CBuilder builder = new CBuildFromFile(patientsCSV, "patientsCSV", columnNames, columnOptionalReaders, PKs);
