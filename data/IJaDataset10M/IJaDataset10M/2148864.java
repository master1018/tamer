...
public abstract class PropertiesDialog extends JDialog {
    ...
    protected final JLabel lbloverridesmultipleValues = new JLabel(Messages.getString("PropertiesDialog.header_override"));
    ...
    private void jbInit() throws Exception {
        ...
        jLabelLineWidth.setText(Messages.getString("PropertiesDialog.line_width"));
        jLabelLineColor.setText(Messages.getString("PropertiesDialog.line_color"));
        ...
        jButtonColor.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Color newColor = JColorChooser.showDialog(PropertiesDialog.this, Messages.getString("MeasureTool.pick_color"), button.getBackground());
                if (newColor != null) {
        ...
        jPanelFooter.add(jButtonCancel, new GridBagConstraints(1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(30, 15, 15, 15), 0, 0));
        jPanelFooter.add(jButtonOk, new GridBagConstraints(0, 1, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(30, 15, 15, 15), 0, 0));
        ...
        jPanel1.add(jLabelLineColor, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(10, 25, 0, 0), 0, 0));
        jPanel1.add(jButtonColor, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(10, 2, 0, 0), 0, 0));
        ...
        jPanel1.add(jLabelLineWidth, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(10, 25, 0, 0), 0, 0));
        jPanel1.add(spinnerLineWidth, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(10, 2, 0, 0), 0, 0));
        ...
        jPanel1.add(jCheckBoxFilled, new GridBagConstraints(0, 3, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(10, 0, 0, 0), 0, 0));
