...
public final class COFINSQtdeImplTest {
    ...
    public void testCOFINSQtdeInterface() {
        COFINSTributadoPelaQuantidade cOFINSQtde = new COFINSTributadoPelaQuantidadeImpl().withCodigoSituacaoTributaria("abc").withQuantidadeVendida(new BigDecimal("1")).withAliquota(new BigDecimal("1")).withValor(new BigDecimal("1"));
