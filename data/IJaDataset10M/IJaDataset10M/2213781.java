...
public class AudioFileDataSource extends BaseDataProcessor {
    ...
    public void setAudioFile(URL audioFileURL, String streamName) {
        ...
        for (AudioFileProcessListener fileListener : fileListeners) fileListener.audioFileProcStarted(curAudioFile);
    ...
    public void setInputStream(AudioInputStream inputStream, String streamName) {
        ...
        if (encoding.equals(AudioFormat.Encoding.PCM_SIGNED)) signedData = true; else if (encoding.equals(AudioFormat.Encoding.PCM_UNSIGNED)) signedData = false; else throw new RuntimeException("used file encoding is not supported");
        totalValuesRead = 0;
    }
    ...
    private DataEndSignal createDataEndSignal() {
        if (!(this instanceof ConcatAudioFileDataSource)) for (AudioFileProcessListener fileListener : fileListeners) fileListener.audioFileProcFinished(curAudioFile);
