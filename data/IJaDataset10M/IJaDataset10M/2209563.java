...
public class Lint {
    ...
    public static Lint instance(Context context) {
        ...
        if (instance == null) instance = new Lint(context);
        return instance;
    }
    ...
    protected Lint(Context context) {
        ...
        for (Map.Entry<String, LintCategory> e : map.entrySet()) {
            if (options.lint(e.getKey())) values.add(e.getValue());
        }
    ...
    protected static class AugmentVisitor implements Attribute.Visitor {
        ...
        private void suppress(LintCategory lc) {
            if (lint == null) lint = new Lint(parent);
        ...
        public void visitCompound(Attribute.Compound compound) {
            if (compound.type.tsym == syms.suppressWarningsType.tsym) {
                for (List<Pair<MethodSymbol, Attribute>> v = compound.values; v.nonEmpty(); v = v.tail) {
                    Pair<MethodSymbol, Attribute> value = v.head;
                    if (value.fst.name.toString().equals("value")) value.snd.accept(this);
                }
            }
        }

        public void visitArray(Attribute.Array array) {
            for (Attribute value : array.values) value.accept(this);
        }
