package com.doculibre.intelligid.wicket.authentication;
...
public abstract class CustomAuthenticatedWebSession extends WebSession {

    /**
	 * @return Current authenticated web session
	 */
    public static CustomAuthenticatedWebSession get() {
        return (CustomAuthenticatedWebSession) Session.get();
    }
	 ...
	 *            The web application
	 */
    public CustomAuthenticatedWebSession(final CustomAuthenticatedWebApplication application) {
        super(application);
    }
