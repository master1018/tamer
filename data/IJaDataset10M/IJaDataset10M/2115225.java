...
public class Fuzzy10Bin {
    ...
    protected static double[] HueMembershipValues = { 0, 0, 5, 10, 5, 10, 35, 50, 35, 50, 70, 85, 70, 85, 150, 165, 150, 165, 195, 205, 195, 205, 265, 280, 265, 280, 315, 330, 315, 330, 360, 360 };

    protected static double[] SaturationMembershipValues = { 0, 0, 10, 75, 10, 75, 255, 255 };

    protected static double[] ValueMembershipValues = { 0, 0, 10, 75, 10, 75, 180, 220, 180, 220, 255, 255 };
