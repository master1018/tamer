...
public class SetDataPduDisplayPanel extends javax.swing.JPanel {
    ...
    public void setData(SetDataPdu pdu) {
        ...
        origEntityIDDisplayPanel.setData(pdu.getOriginatingEntityID());
        ...
        numFixedTF.setText("" + pdu.getNumberOfFixedDatumRecords());
        numVariableTF.setText("" + pdu.getNumberOfVariableDatumRecords());
        varDatumTA.setText(pdu.getVariableDatums().toString());
        fixedDataTA.setText(pdu.getFixedDatums().toString());
    }
   ...
   */
    ...
    private void initComponents() {
        ...
        numFixedLab.setText(NbBundle.getMessage(getClass(), "SetDataPduDisplayPanel.numFixedLab.text"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        ...
        numVariableLab.setText(NbBundle.getMessage(getClass(), "SetDataPduDisplayPanel.numVariableLab.text"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        requestIDLab.setText(NbBundle.getMessage(getClass(), "SetDataPduDisplayPanel.requestIDLab.text"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        paddingLab.setText(NbBundle.getMessage(getClass(), "SetDataPduDisplayPanel.paddingLab.text"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
