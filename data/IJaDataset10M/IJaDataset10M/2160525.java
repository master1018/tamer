...
public class light_enableType2 extends homura.hde.util.xml.xml.Node {

    public light_enableType2(light_enableType2 node) {
        super(node);
    }

    public light_enableType2(org.w3c.dom.Node node) {
        super(node);
    }

    public light_enableType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public light_enableType2(homura.hde.util.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "light_enable");
    }
