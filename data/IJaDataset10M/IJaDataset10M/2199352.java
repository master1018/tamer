...
public class KoPathwayMerger {
    ...
    public KoPathwayMerger(DPLPersistantSet<Pathway> pathways, Map<Concept, Set<String>> koConceptToGenes, HashMap<String, Concept> koNamesToKoConcept, HashMap<String, Concept> koAccessionToKoConcept, DPLPersistantSet<Relation> relationsCache) {
            ...
            while (itEntries.hasNext()) {
                ...
                if (entry.getType().equalsIgnoreCase("ortholog")) {
                    ...
                    for (String res : result) {
                        ...
                        if (entry.getLink() != null) concept_gene.setUrl(entry.getLink());
