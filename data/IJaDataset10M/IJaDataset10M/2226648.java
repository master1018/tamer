...
public class _2009ACeremonyinPandaemonium extends QuestHandler {
    ...
    public void register() {
        if (CustomConfig.ENABLE_SIMPLE_2NDCLASS) return;
                ...
                switch(env.getDialogId()) {
                    ...
                    case 10002:
                        if (var == 2) {
                            ...
                            if (playerClass == PlayerClass.WARRIOR) qs.setQuestVar(10); else if (playerClass == PlayerClass.SCOUT) qs.setQuestVar(20); else if (playerClass == PlayerClass.MAGE) qs.setQuestVar(30); else if (playerClass == PlayerClass.PRIEST) qs.setQuestVar(40);
                            updateQuestStatus(env);
