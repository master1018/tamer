...
/**
 * This is a default implementation of the IFC object IfcFillAreaStyle<br><br>
 * 
 ...
 **/
public class IfcFillAreaStyle extends IfcPresentationStyle implements IfcClass, IfcPresentationStyleSelect {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcLabel", "SET<IfcFillStyleSelect>" };
    ...
    public SET<IfcFillStyleSelect> FillStyles;
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("FillStyles")) stepString = stepString.concat("*);"); else {
            if (this.FillStyles != null) stepString = stepString.concat(((IfcRootInterface) this.FillStyles).getStepParameter(IfcFillStyleSelect.class.isInterface()) + ");"); else stepString = stepString.concat("$);");
        }
        return stepString;
    }
    ...
    /**
	 * This method returns the value of the FillStyles attribute.
	 * 
	 * @return the value of FillStyles
	 *         /
	 **/
    ...
    public Object clone() {
        ...
        if (this.Name != null) ifcFillAreaStyle.setName((IfcLabel) this.Name.clone());
        if (this.FillStyles != null) ifcFillAreaStyle.setFillStyles((SET<IfcFillStyleSelect>) this.FillStyles.clone());
    ...
    public Object shallowCopy() {
        IfcFillAreaStyle ifcFillAreaStyle = new IfcFillAreaStyle();
        if (this.Name != null) ifcFillAreaStyle.setName(this.Name);
        if (this.FillStyles != null) ifcFillAreaStyle.setFillStyles(this.FillStyles);
        return ifcFillAreaStyle;
    }
