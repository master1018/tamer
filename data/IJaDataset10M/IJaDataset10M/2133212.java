...
public class MqlHqlTest {
    ...
    public static void main(String[] args) {
        try {
            BufferedReader rd = new BufferedReader(new InputStreamReader((InputStream) ClassResource.get("org/makumba/providers/query/mql/mqlHqlCorpus.txt").getContent()));
            String query = null;
            int line = 0;
            ...
            while ((query = rd.readLine()) != null) {
                ...
                try {
                    ...
                    MqlParameterTransformer paramTransformer = MqlParameterTransformer.getSQLQueryGenerator(analyzer, new HashMap<String, Object>() {
