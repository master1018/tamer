package org.happy.collections.ver1x1.maps.decorators;
...
/**
 * tests the Unmodifiable map
 * @author Andreas Hollmann
 *
 */
public class UnmodifiableMap_1x0Test extends AbstractTestMap {

    public UnmodifiableMap_1x0Test(String testName) {
        super(testName);
    }

    @Override
    public Map<Object, Object> makeEmptyMap() {
        UnmodifiableMap_1x0<Object, Object> map = new UnmodifiableMap_1x0<Object, Object>(new HashMap<Object, Object>(), UnmodifiableStrategy_1x0.Modifiable);
        return map;
    }
