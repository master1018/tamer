...
/**
 * This is a default implementation of the IFC object IfcPreDefinedPointMarkerSymbol<br><br>
 * 
 ...
 **/
public class IfcPreDefinedPointMarkerSymbol extends IfcPreDefinedSymbol implements IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcLabel" };
    ...
    public Object clone() {
        ...
        if (this.Name != null) ifcPreDefinedPointMarkerSymbol.setName((IfcLabel) this.Name.clone());
    ...
    public Object shallowCopy() {
        IfcPreDefinedPointMarkerSymbol ifcPreDefinedPointMarkerSymbol = new IfcPreDefinedPointMarkerSymbol();
        if (this.Name != null) ifcPreDefinedPointMarkerSymbol.setName(this.Name);
        return ifcPreDefinedPointMarkerSymbol;
    }
