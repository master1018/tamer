...
public class EISBot extends BehavingEntity implements eisbot.abl.StarCraftConstants {
    ...
    private static final Object[] __$tempObjArray = new Object[1];

    private static final Class[] __$sensorFactoryArgArray = new Class[1];

    private static final Class[] __$behFactoryArgArray = new Class[5];

    private static final Class[] __$preconditionArgArray = new Class[4];

    private static final Class[] __$continuousConditionArgArray = new Class[3];

    private static final Class[] __$stepFactoryArgArray = new Class[3];

    private static final Class[] __$argumentStepExecuteArgArray = new Class[3];

    private static final Class[] __$mentalStepExecuteArgArray = new Class[4];

    private static final Class[] __$reinforcementSignalArgArray = new Class[3];

    private static final Class[] __$rlPolicyArgArray = new Class[6];

    private static final Class[] __$stateWMEArgArray = new Class[3];

    private static final Class[] __$successConditionArgArray = new Class[3];

    private static final Class __$EISBot_BehaviorFactories_rfield;

    static final Method __$behaviorFactory0_rfield;

    private static final Class __$EISBot_Preconditions_rfield;

    static final Method __$precondition0_rfield;

    private static final Class __$EISBot_PreconditionSensorFactories_rfield;

    static final Method __$preconditionSensorFactory0_rfield;

    private static final Class __$EISBot_ContextConditions_rfield;

    static final Method __$contextCondition0_rfield;

    private static final Class __$EISBot_ContextConditionSensorFactories_rfield;

    static final Method __$contextConditionSensorFactory0_rfield;

    private static final Class __$EISBot_StepFactories_rfield;

    static final Method __$stepFactory0_rfield;

    private static final Class __$EISBot_ArgumentStepExecute_rfield;

    static final Method __$argumentExecute0_rfield;

    private static final Class __$EISBot_MentalStepExecute_rfield;

    static final Method __$mentalExecute0_rfield;

    private static final Class __$EISBot_SuccessTests_rfield;

    static final Method __$successTest0_rfield;

    private static final Class __$EISBot_SuccessTestSensorFactories_rfield;

    static final Method __$successTestSensorFactory0_rfield;

    private static final Class __$EISBot_ReinforcementSignals_rfield;

    static final Method __$reinforcementSignal0_rfield;

    private static final Class __$EISBot_ReinforcementSignalSensorFactories_rfield;

    static final Method __$reinforcementSignalSensorFactory0_rfield;

    private static final Class __$EISBot_RLPolicy_rfield;

    static final Method __$rlPolicy0_rfield;

    private static final Class __$EISBot_StateWMEs_rfield;

    static final Method __$stateWME0_rfield;

    private static final Class __$EISBot_StateWMESensorFactories_rfield;

    static final Method __$stateWMESensorFactory0_rfield;

    private static final Class __$EISBot_SuccessConditions_rfield;

    static final Method __$successCondition0_rfield;

    private static final Class __$EISBot_SuccessConditionSensorFactories_rfield;

    static final Method __$successConditionSensorFactory0_rfield;
    ...
    static {
        try {
            ...
            throw new AblRuntimeError("Error in static initializer", e);
        }
    }
