...
public class SerialThrottle extends AbstractThrottle {
    ...
    public void setSpeedSetting(float speed) {
        ...
        SerialTrafficController.instance().sendSerialMessage(m, null);
        SerialTrafficController.instance().sendSerialMessage(m, null);
        if (oldSpeed != this.speedSetting) notifyPropertyChangeListener("SpeedSetting", oldSpeed, this.speedSetting);
    }
    ...
    public void setIsForward(boolean forward) {
        ...
        SerialTrafficController.instance().sendSerialMessage(m, null);
        SerialTrafficController.instance().sendSerialMessage(m, null);
        if (old != isForward) notifyPropertyChangeListener("IsForward", old, isForward);
    }
