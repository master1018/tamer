...
public class VisualizerAdaptor implements Visualizer {
     ...
     * @see ActionType
     */
    public void notifyListeners(int subjectId, ActionType actionType, boolean pause, LinkedList<ScheduleItem> itemList) {
    }
     ...
     * @see ActionType
     */
    public void notifyListeners(int subjectId, ActionType actionType, boolean pause, ScheduleItem item) {
    }
     ...
     * @see ActionType
     */
    public void notifyListeners(int subjectId, ActionType actionType, boolean pause) {
    }
