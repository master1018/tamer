...
/**
 * This is a default implementation of the IFC object IfcFaceBasedSurfaceModel<br><br>
 * 
 ...
 **/
public class IfcFaceBasedSurfaceModel extends IfcGeometricRepresentationItem implements IfcSurfaceOrFaceSurface, IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "SET<IfcConnectedFaceSet>" };
    ...
    public SET<IfcConnectedFaceSet> FbsmFaces;
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("FbsmFaces")) stepString = stepString.concat("*);"); else {
            if (this.FbsmFaces != null) stepString = stepString.concat(((IfcRootInterface) this.FbsmFaces).getStepParameter(IfcConnectedFaceSet.class.isInterface()) + ");"); else stepString = stepString.concat("$);");
        }
        return stepString;
    }
    ...
    /**
	 * This method returns the value of the FbsmFaces attribute.
	 * 
	 * @return the value of FbsmFaces
	 *         /
	 **/
    ...
    public Object clone() {
        ...
        if (this.FbsmFaces != null) ifcFaceBasedSurfaceModel.setFbsmFaces((SET<IfcConnectedFaceSet>) this.FbsmFaces.clone());
    ...
    public Object shallowCopy() {
        IfcFaceBasedSurfaceModel ifcFaceBasedSurfaceModel = new IfcFaceBasedSurfaceModel();
        if (this.FbsmFaces != null) ifcFaceBasedSurfaceModel.setFbsmFaces(this.FbsmFaces);
        return ifcFaceBasedSurfaceModel;
    }
