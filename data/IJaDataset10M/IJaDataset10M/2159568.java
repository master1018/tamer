...
public class CriteriaEntityFilter extends EntityFilter {
    ...
    public CriteriaEntityFilter(SecureObjectCache objectCache, MappingInformation mappingInformation, SecurityContext securityContext, CriteriaBuilder criteriaBuilder, ExceptionFactory exceptionFactory, Collection<AccessRule> accessRules, SubselectEvaluator... evaluators) {
    ...
    public <R> FilterResult<CriteriaQuery<R>> filterQuery(CriteriaQuery<R> query) {
        ...
        return new CriteriaFilterResult<CriteriaQuery<R>>(query, parameters.size() > 0 ? parameters : null, criteriaHolder.getParameters());
    }
