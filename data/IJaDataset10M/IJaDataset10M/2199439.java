 ...
 * @version $Id: PanRootStart.java 8 2009-02-15 08:54:54Z skulawik $
 */
public class PanRootStart extends JPanel implements WizardPanel, ActionListener {
    ...
    void jbInit() throws Exception {
        ...
        this.add(optDeployRoot, new GridBagConstraints(0, 2, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 50, 20, 50), 37, -6));
        this.add(optDeployAll, new GridBagConstraints(0, 4, 1, 1, 1.0, 1.0, GridBagConstraints.NORTH, GridBagConstraints.HORIZONTAL, new Insets(0, 50, 0, 50), 0, 0));
