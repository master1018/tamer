...
public class UsuarioHome {
    ...
    public Usuario findById(java.lang.String id) {
        ...
        try {
            Usuario instance = (Usuario) sessionFactory.getCurrentSession().get("negocio.basica.Usuario", id);
            if (instance == null) {
    ...
    public List findByExample(Usuario instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession().createCriteria("negocio.basica.Usuario").add(Example.create(instance)).list();
