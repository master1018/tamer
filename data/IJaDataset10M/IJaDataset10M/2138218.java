...
public class light_model_ambientType extends com.jmex.xml.xml.Node {

    public light_model_ambientType(light_model_ambientType node) {
        super(node);
    }

    public light_model_ambientType(org.w3c.dom.Node node) {
        super(node);
    }

    public light_model_ambientType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public light_model_ambientType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "light_model_ambient");
    }
    ...
    public float4 getvalue2ValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new com.jmex.xml.xml.XmlException("Out of range"); else return new float4(getDomNodeValue(curNode));
    }
