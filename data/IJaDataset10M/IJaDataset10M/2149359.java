...
public class TestWMethod {
    ...
    public final void computeStateCover1() {
        ...
        Set<List<Label>> expected = TestFSMAlgo.buildSet(new String[][] { new String[] {}, new String[] { "b" }, new String[] { "b", "a" } }, config), actual = new HashSet<List<Label>>();
    ...
    public final void computeStateCover2() {
        ...
        Collection<List<Label>> expected = TestFSMAlgo.buildSet(new String[][] { new String[] {}, new String[] { "b" }, new String[] { "b", "a" } }, config), actual = new HashSet<List<Label>>();
        actual.addAll(gr.pathroutines.computeStateCover(gr.getInit()));
        Assert.assertTrue(expected.equals(actual));
    }
    ...
    public final void computeStateCover3() {
        ...
        Collection<List<Label>> expected = TestFSMAlgo.buildSet(new String[][] { new String[] {}, new String[] { "b" }, new String[] { "d" }, new String[] { "b", "a" } }, config), actual = new HashSet<List<Label>>();
        actual.addAll(gr.pathroutines.computeStateCover(gr.getInit()));
        Assert.assertTrue(expected.equals(actual));
    }
    ...
    public final void computeStateCover3_ND() {
        ...
        Collection<List<Label>> expected = TestFSMAlgo.buildSet(new String[][] { new String[] {}, new String[] { "b" }, new String[] { "d" }, new String[] { "a" } }, config), actual = new HashSet<List<Label>>();
        actual.addAll(gr.pathroutines.computeStateCover(gr.getInit()));
        Assert.assertTrue(expected.equals(actual));
    }
    ...
    public final void computeStateCover4() {
        ...
        Collection<List<Label>> expected = TestFSMAlgo.buildSet(new String[][] { new String[] {}, new String[] { "a" }, new String[] { "b" }, new String[] { "d" }, new String[] { "b", "a" }, new String[] { "b", "a", "a" } }, config), actual = new HashSet<List<Label>>();
        actual.addAll(gr.pathroutines.computeStateCover(gr.getInit()));
        Assert.assertTrue(expected.equals(actual));
    }
    ...
    public final void testCross1a() {
        ...
        actual.addAll(cross(buildList(new String[][] { new String[] { "a", "b" }, new String[] { "z", "x" } }, config), buildList(new String[][] { new String[] { "c", "d" }, new String[] { "q", "w" } }, config)));
        Set<List<Label>> expected = buildSet(new String[][] { new String[] { "a", "b", "c", "d" }, new String[] { "a", "b", "q", "w" }, new String[] { "z", "x", "c", "d" }, new String[] { "z", "x", "q", "w" } }, config);
        Assert.assertTrue(expected.equals(actual));
    }
    ...
    public final void testCross1b() {
        Set<List<Label>> actual = new HashSet<List<Label>>();
        actual.addAll(cross(buildList(new String[][] { new String[] {}, new String[] { "a", "b" }, new String[] { "z", "x" } }, config), buildList(new String[][] { new String[] {}, new String[] { "c", "d" }, new String[] { "q", "w" } }, config)));
        Set<List<Label>> expected = buildSet(new String[][] { new String[] {}, new String[] { "a", "b" }, new String[] { "z", "x" }, new String[] { "c", "d" }, new String[] { "q", "w" }, new String[] { "a", "b", "c", "d" }, new String[] { "a", "b", "q", "w" }, new String[] { "z", "x", "c", "d" }, new String[] { "z", "x", "q", "w" } }, config);
        Assert.assertTrue(expected.equals(actual));
    }
    ...
    public final void testCross2() {
        Set<List<Label>> actual = new HashSet<List<Label>>();
        actual.addAll(cross(buildList(new String[][] { new String[] { "a", "b" } }, config), buildList(new String[][] { new String[] { "c", "d" }, new String[] { "q", "w" } }, config)));
        Set<List<Label>> expected = buildSet(new String[][] { new String[] { "a", "b", "c", "d" }, new String[] { "a", "b", "q", "w" } }, config);
        Assert.assertTrue(expected.equals(actual));
    }
    ...
    public final void testCross3() {
        Set<List<Label>> actual = new HashSet<List<Label>>();
        actual.addAll(cross(buildList(new String[][] { new String[] { "a", "b" }, new String[] { "z", "x" } }, config), buildList(new String[][] { new String[] { "c", "d" } }, config)));
        Set<List<Label>> expected = buildSet(new String[][] { new String[] { "a", "b", "c", "d" }, new String[] { "z", "x", "c", "d" } }, config);
        Assert.assertTrue(expected.equals(actual));
    }
    ...
    public final void testCross4() {
        Set<List<Label>> actual = new HashSet<List<Label>>();
        actual.addAll(cross(buildList(new String[][] {}, config), buildList(new String[][] { new String[] { "c", "d" }, new String[] { "q", "w" } }, config)));
    ...
    public final void testCross5() {
        Set<List<Label>> actual = new HashSet<List<Label>>();
        actual.addAll(cross(buildList(new String[][] { new String[] { "a", "b" }, new String[] { "z", "x" } }, config), buildList(new String[][] {}, config)));
        Assert.assertTrue(actual.isEmpty());
    }
    ...
    public final void testCrossWithSet1() {
        ...
        Set<List<Label>> expected = buildSet(new String[][] { new String[] { "a", "b", "p" }, new String[] { "z", "x", "p" }, new String[] { "a", "b", "q" }, new String[] { "z", "x", "q" } }, config);
    ...
    public final void testCrossWithSet4() {
        ...
        seq.clear();
        seq.addAll(labelList(new String[] { "a", "b" }));
        data.add((List<Label>) seq.clone());
        seq.clear();
        seq.addAll(labelList(new String[] { "z", "x" }));
        data.add((List<Label>) seq.clone());
        ...
        Set<List<Label>> expected = buildSet(new String[][] { new String[] { "a", "b", "p" }, new String[] { "z", "x", "p" } }, config);
        Assert.assertTrue("expected: " + expected + " actual: " + actualA, expected.equals(actualA));
        Assert.assertTrue("expected: " + expected + " actual: " + actualB, expected.equals(actualB));
    }
    ...
    public final void testGetStimuli2() {
        ...
        Assert.assertTrue(singleton.equals(buildSet(new String[][] { new String[] { "p" }, new String[] { "d" }, new String[] { "b" }, new String[] { "c" }, new String[] { "a" } }, config)));
    }
    ...
    public final void testAppendSequence0() {
        ...
        Set<List<Label>> expected = buildSet(new String[][] { new String[] {} }, config);
    ...
    public final void testAppendSequence1() {
        ...
        Set<List<Label>> expected = buildSet(new String[][] { new String[] { "p", "b" } }, config);
        fsm.wmethod.appendSequence(sequences, labelList(new String[] {}));
        Set<List<Label>> actual = new HashSet<List<Label>>();
        actual.addAll(sequences.getData());
        Assert.assertTrue("expected : " + expected + " got: " + actual, expected.equals(actual));
    ...
    public final void testAppendSequence3() {
        ...
        PrefixFreeCollection sequences = new SlowPrefixFreeCollection();
        sequences.addSequence(labelList(new String[] { "p", "b" }));
        Set<List<Label>> expected = buildSet(new String[][] { new String[] { "p", "b", "c" } }, config);
    ...
    public final void testAppendSequence4() {
        ...
        PrefixFreeCollection sequences = new SlowPrefixFreeCollection();
        sequences.addSequence(labelList(new String[] { "p", "b" }));
        Set<List<Label>> expected = buildSet(new String[][] { new String[] { "p", "b" }, new String[] { "p", "p" } }, config);
    ...
    public final void testAppendSequence5() {
        ...
        PrefixFreeCollection sequences = new SlowPrefixFreeCollection();
        sequences.addSequence(labelList(new String[] { "p", "b" }));
        Set<List<Label>> expected = buildSet(new String[][] { new String[] { "p", "b" }, new String[] { "p", "p", "p" } }, config);
    ...
    public final void testAppendAllSequences0() {
        ...
        PrefixFreeCollection sequences = new SlowPrefixFreeCollection();
        Set<List<Label>> expected = buildSet(new String[][] { new String[] { "p", "p", "p" }, new String[] { "g" } }, config);
        fsm.wmethod.appendAllSequences(sequences, buildList(new String[][] { new String[] { "p" }, new String[] { "p", "p" }, new String[] {}, new String[] { "g" }, new String[] { "p", "p", "p" } }, config));
        Set<List<Label>> actual = new HashSet<List<Label>>();
        actual.addAll(sequences.getData());
        Assert.assertTrue("expected : " + expected + " got: " + actual, expected.equals(actual));
    }
    ...
    public final void testAppendAllSequences0b() {
        ...
        PrefixFreeCollection sequences = new SlowPrefixFreeCollection();
        Set<List<Label>> expected = buildSet(new String[][] {}, config);
    ...
    public final void testAppendAllSequences1() {
        ...
        PrefixFreeCollection sequences = new SlowPrefixFreeCollection();
        sequences.addSequence(labelList(new String[] { "p", "b" }));
        Set<List<Label>> expected = buildSet(new String[][] { new String[] { "p", "b" }, new String[] { "g" }, new String[] { "p", "p", "p" } }, config);
        fsm.wmethod.appendAllSequences(sequences, buildList(new String[][] { new String[] { "p" }, new String[] { "p", "p" }, new String[] {}, new String[] { "g" }, new String[] { "p", "p", "p" } }, config));
        Set<List<Label>> actual = new HashSet<List<Label>>();
        actual.addAll(sequences.getData());
        Assert.assertTrue("expected : " + expected + " got: " + actual, expected.equals(actual));
    ...
    public static void checkEquivalentStatesException(EquivalentStatesException e, LearnerGraph fsm) {
        for (AMEquivalenceClass<CmpVertex, LearnerGraphCachedData> eqStatesGroup : e.getEquivalentStates()) {
            for (CmpVertex eA : eqStatesGroup.getStates()) for (CmpVertex eB : eqStatesGroup.getStates()) {
            ...
            for (AMEquivalenceClass<CmpVertex, LearnerGraphCachedData> eqStatesGroupAnother : e.getEquivalentStates()) if (eqStatesGroup != eqStatesGroupAnother) {
                for (CmpVertex eA : eqStatesGroup.getStates()) for (CmpVertex eB : eqStatesGroupAnother.getStates()) {
                    DifferentFSMException exception = WMethod.checkM(fsm, eA, fsm, eB, WMethod.VERTEX_COMPARISON_KIND.NONE);
                    if (exception == null) {
    ...
    public static void testWsetConstructionWithEquivalentStates(LearnerGraph fsm, boolean prefixClosed, Set<Pair<CmpVertex, CmpVertex>> equivalentVertices) {
        ...
        Set<List<Label>> wset = new HashSet<List<Label>>();
        wset.addAll(WMethod.computeWSet_reducedmemory(fsm));
        fsm.wmethod.checkW_is_corrent(wset, prefixClosed, equivalentVertices);
    }
    ...
    public static void testWsetconstruction(LearnerGraph fsm, boolean equivalentExpected, boolean reductionExpected, boolean prefixClosed) {
        fsm.config.setPrefixClosed(prefixClosed);
        Set<List<Label>> origWset = new HashSet<List<Label>>();
        try {
        ...
        try {
            Set<List<Label>> wset = new HashSet<List<Label>>();
            wset.addAll(WMethod.computeWSet_reducedw(fsm));
            Assert.assertEquals(false, equivalentExpected);
            fsm.wmethod.checkW_is_corrent(wset, prefixClosed, null);
    ...
    public final void testGenerateSink1() {
        ...
        CmpVertex sink = WMethod.generateSinkState(fsm);
        Assert.assertNotNull(sink);
        Assert.assertFalse(sink.isAccept());
    }
    ...
    private void testReduction(String fsm, String expected) {
        LearnerGraph fsmL = buildLearnerGraph(fsm, "testReductionA", config), expectedL = buildLearnerGraph(expected, "testReductionB", config);
    ...
    public final void testReduction1() {
        LearnerGraph fsmL = new LearnerGraph(config), expectedL = new LearnerGraph(config);
        WMethod.checkM(expectedL, fsmL.paths.reduce());
    }
    ...
    public final void testReduction6() {
        testReduction("A-a->B-a->B2-a->B-b->C-b->C-c->D / B2-b->C2-b->C3-b->C4-b->C2-c->D2 / C3-c->D2 / C4-c->D2", "A-a->B-a->B-b->C-b->C-c->D");
    }
    ...
    public final void testReduction9() {
        LearnerGraph fsmL = buildLearnerGraph("A-a->B-a->C-b->A", "testReduction9a", config), expectedL = buildLearnerGraph("A-a->A", "testReduction9b", config);
        ...
        expectedB.removeTransition(expectedL.transitionMatrix.get(expectedB.findVertex(VertexID.parseID("A"))), AbstractLearnerGraph.generateNewLabel("a", config), expectedB.findVertex(VertexID.parseID("A")));
    ...
    public final void testReduction10() {
        LearnerGraph fsmL = buildLearnerGraph("A-a->B-a->C-c->A / A-b->B2-a->C2-c->A", "testReduction10a", config), expectedL = buildLearnerGraph("A-a->B-a->C-c->A", "testReduction10b", config);
        WMethod.checkM(expectedL, fsmL.paths.reduce());
    }
    ...
    public final void testReduction11() {
        LearnerGraph fsmL = buildLearnerGraph("A-a->B-a->C-c->A / A-b->B2-a->C2-c->A", "testReduction11a", config), expectedL = buildLearnerGraph("A-a->B-a->C-c->A", "testReduction11b", config);
        fsmL.findVertex(VertexID.parseID("B")).setAccept(false);
        WMethod.checkM(expectedL, fsmL.paths.reduce());
    }
    ...
    public final void testReduction12() {
        LearnerGraph fsmL = buildLearnerGraph("A-a->B-a->C-c->A / A-b->B2-a->C2-c->A", "testReduction12a", config), expectedL = buildLearnerGraph("A-a->B-a->C-c->A", "testReduction12b", config);
        fsmL.findVertex(VertexID.parseID("B")).setAccept(false);
    ...
    private final void addDistLabels(Map<CmpVertex, Map<CmpVertex, Set<Label>>> distinguishingLabels, String stateA, String stateB, String[] labels) {
        Set<Label> distLabels = new HashSet<Label>();
        Map<CmpVertex, Set<Label>> stateToDist = new HashMap<CmpVertex, Set<Label>>();
        distLabels.clear();
        distLabels.addAll(labelList(labels));
    ...
    public final void testComputeTopLabe5() {
        ...
        addDistLabels(distinguishingLabels, "0", "1", new String[] { "b" });
        addDistLabels(distinguishingLabels, "3", "1", new String[] { "b" });
        addDistLabels(distinguishingLabels, "4", "1", new String[] {});
        Assert.assertEquals(AbstractLearnerGraph.generateNewLabel("b", config), WMethod.computeTopLabel(distinguishingLabels));
    }

    @Test
    public final void testCheckEquivalentStates1() {
    ...
    @Test
    public final void testCheckEquivalentStates2() {
    ...
    @Test
    public final void testCheckEquivalentStates3() {
    ...
    @Test
    public final void testCheckEquivalentStates4() {
        int[][] table = new int[][] { { 1, -1 }, { 1, -1 } };
        LearnerGraph fsm = LearnerGraph.convertTableToFSMStructure(table, new int[] { 0, 1 }, -1, config);
        Assert.assertEquals(true, WMethod.checkEquivalentStates(fsm));
    }
    ...
    private void checkTestGenerationResult(LearnerGraph fsm, int extraStates, String[][] expected) {
        Set<List<Label>> expectedSet = buildSet(expected, config), actualA = new HashSet<List<Label>>(), actualB = new HashSet<List<Label>>();
        actualA.addAll(fsm.wmethod.computeOldTestSet(extraStates));
        actualB.addAll(fsm.wmethod.computeNewTestSet(extraStates));
    ...
    public final void testTestGeneration1a() {
        ...
        g.addVertex(init);
        checkTestGenerationResult(new LearnerGraph(g, config), 0, new String[][] { new String[] {} });
    }
    ...
    public final void testTestGeneration1b() {
        ...
        init.addUserDatum(JUConstants.ACCEPTED, true, UserData.SHARED);
        g.addVertex(init);
        checkTestGenerationResult(new LearnerGraph(g, config), 2, new String[][] { new String[] {} });
    }

    @Test
    public final void testTestGeneration2() {
        LearnerGraph fsm = buildLearnerGraph("A-a->A", "testTestGeneration2", config);
        checkTestGenerationResult(fsm, 0, new String[][] { new String[] { "a" } });
    }

    @Test
    public final void testTestGeneration3() {
        LearnerGraph fsm = buildLearnerGraph("A-a->A", "testTestGeneration3", config);
        checkTestGenerationResult(fsm, 1, new String[][] { new String[] { "a", "a" } });
    }

    @Test
    public final void testTestGeneration4() {
        LearnerGraph fsm = buildLearnerGraph("A-a->A-b->B", "testTestGeneration4", config);
        checkTestGenerationResult(fsm, 0, new String[][] { new String[] { "a", "a" }, new String[] { "b", "a" }, new String[] { "b", "b" } });
    }

    @Test
    public final void testTestGeneration5() {
        LearnerGraph fsm = buildLearnerGraph("A-a->A-b->B", "testTestGeneration5", config);
        checkTestGenerationResult(fsm, 1, new String[][] { new String[] { "a", "a", "a" }, new String[] { "a", "b", "a" }, new String[] { "b", "a" }, new String[] { "b", "b" } });
    }

    @Test
    public final void testTestGeneration6() {
        LearnerGraph fsm = buildLearnerGraph("S-p->A-a->A1-a->A3\n" + "A-b->A2-b->A3\nA<-c-A2<-c-A3\n" + "A<-d-A5<-a-A3-b->A4-f->AA4-a->S\n" + "A-d->A\nA5-b->AA6", "testTestGeneration6", config);
        Set<List<Label>> actualA = new HashSet<List<Label>>(), actualB = new HashSet<List<Label>>();
        actualA.addAll(fsm.wmethod.computeOldTestSet(0));
        actualB.addAll(fsm.wmethod.computeNewTestSet(0));
        assertTrue("the two test generators return different values, old returns " + actualA + " and the new one - " + actualB, actualA.equals(actualB));
    }
    ...
    public final void testTestGeneration7() {
        ...
        Set<List<Label>> actualA = new HashSet<List<Label>>(), actualB = new HashSet<List<Label>>();
        actualA.addAll(fsm.wmethod.computeOldTestSet(2));
        actualB.addAll(fsm.wmethod.computeNewTestSet(2));
        assertTrue("the two test generators return different values, old returns " + actualA + " and the new one - " + actualB, actualA.equals(actualB));
    }
    ...
    public final void testTestGeneration8() {
        LearnerGraph fsmWW = buildLearnerGraph("WW-s->WW\nS-p->A-a->A1-a->A3\n" + "A-b->A2-b->A3\nA<-c-A2<-c-A3\n" + "A<-d-A5<-a-A3-b->A4-f->AA4-a->S\n" + "A-d->A\nA5-b->AA6", "testTestGeneration7", config);
        LearnerGraph fsmWOther = new LearnerGraph(fsmWW, fsmWW.config);
        fsmWOther.init = fsmWOther.findVertex(VertexID.parseID("S"));
        Set<List<Label>> actualA = new HashSet<List<Label>>(), actualB = new HashSet<List<Label>>();
    ...
    public final void testEquivalentStates1() {
        LearnerGraph fsmWW = buildLearnerGraph("A-a->B-b->C-b->B", "testEquivalentStates1", config);
    ...
    public final void testEquivalentStates2() {
        LearnerGraph fsmWW = buildLearnerGraph("A-a->B-b-#C / B-c->B / D-b-#E", "testEquivalentStates2", config);
        Set<Pair<CmpVertex, CmpVertex>> equiv = new TreeSet<Pair<CmpVertex, CmpVertex>>();
    ...
    public final void testEquivalentStates3() {
        LearnerGraph fsmWW = buildLearnerGraph("A-a->B-b-#C / D-b-#E", "testEquivalentStates3", config);
        Set<Pair<CmpVertex, CmpVertex>> equiv = new TreeSet<Pair<CmpVertex, CmpVertex>>();
        equiv.add(new Pair<CmpVertex, CmpVertex>(fsmWW.findVertex(VertexID.parseID("B")), fsmWW.findVertex(VertexID.parseID("D"))));
        equiv.add(new Pair<CmpVertex, CmpVertex>(fsmWW.findVertex(VertexID.parseID("B")), fsmWW.findVertex(VertexID.parseID("C"))));
        equiv.add(new Pair<CmpVertex, CmpVertex>(fsmWW.findVertex(VertexID.parseID("B")), fsmWW.findVertex(VertexID.parseID("E"))));
    ...
    public final void testCheckGraphNumeric3() {
        ...
        LearnerGraph numericGraph = new LearnerGraph(config);
        CmpVertex newInit = AbstractPathRoutines.addToGraph(numericGraph, textGraph, null);
    ...
    public final void testVertexToInt2() {
        ...
        CmpVertex A = numericGraph.paths.getVertex(labelList(new String[] {})), B = numericGraph.paths.getVertex(labelList(new String[] { "b" })), C = numericGraph.paths.getVertex(labelList(new String[] { "b", "c" }));
    ...
    public final void testVerifySameMergeResults1() {
        ...
        Configuration cloneConfig = graph.config.copy();
        cloneConfig.setLearnerCloneGraph(true);
        cloneConfig.setLearnerUseStrings(true);
    ...
    public final void testVerifySameMergeResults2() {
        LearnerGraph graph = buildLearnerGraph("A-a->A-b->B-c->C", "testCheckGraphNumeric", config);
        graph.findVertex("B").setColour(JUConstants.BLUE);
    ...
    public final void testVerifySameMergeResults3() {
        ...
        LearnerGraph g = new LearnerGraph(graph, cloneConfig);
        g.findVertex("B").setHighlight(true);
        g.findVertex("B").setColour(JUConstants.RED);
        Assert.assertNotNull(WMethod.checkM_and_colours(graph, g, WMethod.VERTEX_COMPARISON_KIND.DEEP));
        Assert.assertNotNull(WMethod.checkM_and_colours(g, graph, WMethod.VERTEX_COMPARISON_KIND.DEEP));
    }
    ...
    public final void testVerifySameMergeResults4() {
        ...
        LearnerGraph g = new LearnerGraph(graph, cloneConfig);
        g.findVertex("B").setHighlight(true);
        g.findVertex("D").setColour(JUConstants.RED);
        Assert.assertNotNull(WMethod.checkM_and_colours(graph, g, WMethod.VERTEX_COMPARISON_KIND.DEEP));
        Assert.assertNotNull(WMethod.checkM_and_colours(g, graph, WMethod.VERTEX_COMPARISON_KIND.DEEP));
    }
    ...
    @BeforeClass
    public static void initJungViewer() {
