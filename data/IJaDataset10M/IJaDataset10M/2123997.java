...
public class GoogleLoginServiceTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        getContext().bindService((new Intent()).setClassName("com.google.android.googleapps", "com.google.android.googleapps.GoogleLoginService"), mConnection, Context.BIND_AUTO_CREATE);
        mGlsLock.lock();
        try {
            while (mGls == null) {
                try {
    ...
    public void testSingleAccountScheme() throws Exception {
        ...
        mGls.saveUsernameAndPassword("vespa@gmail.com", "meow", GoogleLoginServiceConstants.FLAG_GOOGLE_ACCOUNT);
        Assert.assertEquals("vespa@gmail.com", mGls.getAccount(false));
        Assert.assertEquals("vespa@gmail.com", mGls.getAccount(true));
        mGls.saveUsernameAndPassword("mackerel@hosted.com", "purr", GoogleLoginServiceConstants.FLAG_HOSTED_ACCOUNT);
    ...
    public void testAuthTokens() throws Exception {
        ...
        mGls.saveUsernameAndPassword("vespa@example.com", "meow", GoogleLoginServiceConstants.FLAG_HOSTED_ACCOUNT);
        Assert.assertNull(mGls.peekCredentials("vespa@example.com", "mail"));
        ...
        mGls.saveUsernameAndPassword("mackerel@example.com", "purr", GoogleLoginServiceConstants.FLAG_GOOGLE_ACCOUNT);
        ...
        GoogleLoginCredentialsResult r = mGls.blockingGetCredentials("vespa@example.com", "mail", false);
