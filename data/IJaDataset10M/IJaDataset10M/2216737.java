...
public class ReqParamUtilsTest extends TestCase {
    ...
    public void testReversible() throws IOException {
        ...
        assertTrue("Parsed map is not like input map: " + parsed, parsed.equals(params));
    }

    public void testParseURLQuery() {
        Map parsed = ReqParamUtils.parseURLQuery("a=b&cde=fgh&d=h");
        assertTrue("result does not have three parameters", parsed.size() == 3);
        assertTrue("result does not have 'a' set to 'b'", parsed.get("a").equals("b"));
        assertTrue("result does not have 'cde' set to 'fgh'", parsed.get("cde").equals("fgh"));
        assertTrue("result does not have 'd' set to 'h'", parsed.get("d").equals("h"));
    }
    ...
    public void testParseURLQuerySingleParam() {
        ...
        assertTrue("result does not have one parameter", parsed.size() == 1);
        assertTrue("result does not have 'foo' set to 'bar'", parsed.get("foo").equals("bar"));
    }
    ...
    public void testParams2URLQueryUnrestricted() {
        ...
        assertTrue("Generated String is not like expected one (1): '" + queryURL + "'", queryURL.equals(""));
        ...
        assertTrue("Generated string is not like expected one (2).", queryURL.equals("add_something_42=langer+dumpf+backen+Garden"));
        keep.clear();
        ...
        fakeRequest = new FakeServletRequest(params);
        queryURL = params2URLQuery(fakeRequest, keep);
        assertTrue("Generated String is not like expected one (3): '" + queryURL + "'", queryURL.equals("topic_id=42&topicmap_id=opera.xtm") || queryURL.equals("topicmap_id=opera.xtm&topic_id=42"));
    }
    ...
    public void testParams2URLQueryRestricted() {
        ...
        fakeRequest = new FakeServletRequest(params);
        queryURL = params2URLQuery(fakeRequest, wantedParamNames);
        assertTrue("Generated String is not like expected one (2).", queryURL.equals("id=42"));
        ...
        fakeRequest = new FakeServletRequest(params);
        queryURL = params2URLQuery(fakeRequest, wantedParamNames);
        assertTrue("Generated String is not like expected one (3).", queryURL.equals("id=42&tm=opera.xtm") || queryURL.equals("tm=opera.xtm&id=42"));
    }
    ...
    public void testParams2URLQueryNonAscii() {
        ...
        fakeRequest = new FakeServletRequest(params);
        queryURL = params2URLQuery(fakeRequest, wantedParamNames);
        assertTrue("Generated string not like expected (1): '" + queryURL + "'", queryURL.equals(correct));
        ...
        fakeRequest = new FakeServletRequest(params);
        queryURL = params2URLQuery(fakeRequest, wantedParamNames);
        assertTrue("Generated String is not like expected one (2): '" + queryURL + "'", queryURL.equals("id=42"));
        wantedParamNames.put("tm", null);
        params.clear();
        params.put("id", "42");
        params.put("add_something_42", "langer dumpf backen Garden");
    ...
    public void testParams2URLQueryMap() throws IOException {
        ...
        assertTrue("Generated String is not like expected one.", queryURL.equals("topic_id=42&topicmap_id=opera.xtm") || queryURL.equals("topicmap_id=opera.xtm&topic_id=42"));
    }
}
