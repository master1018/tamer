...
public class DH {
    ...
    public static DHKeyPair generateKeyPair(int keysize) {
        ...
        try {
            keyPairGenerator.initialize(new DHParameterSpec(prime, generator, keysize));
    ...
    public static DHPublicKey bytesToPublicKey(DHParameterSpec parameterSpec, byte[] bytes) {
        KeySpec keySpec = new DHPublicKeySpec(bytesToBigInteger(bytes), parameterSpec.getP(), parameterSpec.getG());
        try {
    ...
    public static DHPrivateKey bytesToPrivateKey(DHParameterSpec parameterSpec, byte[] bytes) {
        KeySpec keySpec = new DHPrivateKeySpec(bytesToBigInteger(bytes), parameterSpec.getP(), parameterSpec.getG());
        try {
