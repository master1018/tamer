...
public class DirectoryRepository extends Repository {
    ...
    public DirectoryRepository(String name, String location) throws BadRepositoryException, IOException {
        ...
        if (!dir.isDirectory()) throw new BadRepositoryException("Repository " + dirString + " is not a directory");
        if (!dir.canRead()) throw new BadRepositoryException("Repository " + dirString + " is not readable");
    }
    ...
    public static void main(String[] args) throws BadRepositoryException, IOException {
        ...
        for (Enumeration en = dir.getEnumeration(); en.hasMoreElements(); ) System.out.println((String) en.nextElement());
