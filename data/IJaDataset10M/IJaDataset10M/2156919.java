...
public class EmbossConfiguration implements Serializable, PEFConfiguration {
    ...
    public String getEmbosserType() {
        return embosser.getType();
    }

    public String getCharSetType() {
        return charSet.getType();
    }

    public String getPaperType() {
        return paper.getType();
    }
    ...
    public boolean getMagazineMode() {
        return magazineMode.get();
    }

    public void setEmbosserType(String value) {
        embosser.setType(value);
    }

    public void setCharSetType(String value) {
        charSet.setType(value);
    }
    ...
    public void setPageWidth(Length value) {
        pageWidth.set(value);
    }

    public void setPageHeight(Length value) {
        pageHeight.set(value);
    }

    public void setPageOrientation(boolean value) {
        pageOrientation.set(value);
    }
    ...
    public void setEightDots(boolean value) {
        eightDots.set(value);
    }

    public void setZFolding(boolean value) {
        zFolding.set(value);
    }

    public void setMagazineMode(boolean value) {
        magazineMode.set(value);
    }
    ...
    public class EmbosserSetting extends OptionSetting<Embosser> {
        ...
        protected boolean update(Embosser value) {
            if (value.getIdentifier().equals(embosser.getIdentifier())) {
                return false;
            }
            embosser = value;
            return true;
    ...
    public class CharacterSetSetting extends DependentOptionSetting<Table> {
        ...
        public boolean accept(Table value) {
            ...
            try {
                ...
                if (getEightDots() ^ converter.supportsEightDot()) {
                    return false;
                }
    ...
    public class PaperSetting extends DependentOptionSetting<Paper> {
        ...
        protected boolean update(Paper value) {
            ...
            if (paper.getIdentifier().equals(value.getIdentifier())) {
                return false;
            }
            paper = value;
            return true;
        ...
        public boolean refresh() {
            ...
            if (getEmbosser().getIdentifier().equals(GENERIC_EMBOSSER)) {
                ...
                for (Paper.Type t : types) {
                    switch(t) {
                        case SHEET:
                            options.add(customSheetPaper);
                            break;
                        case TRACTOR:
                            options.add(customTractorPaper);
                            break;
                        case ROLL:
                            options.add(customRollPaper);
                            break;
                    }
                }
    ...
    public class PageOrientationSetting extends DependentYesNoSetting {
        ...
        public boolean accept(Boolean value) {
            ...
            return embosser.get().supportsPageFormat(new SheetPaperFormat((SheetPaper) paper.get(), value ? Orientation.REVERSED : Orientation.DEFAULT));
        }

        @Override
        public boolean refresh() {
            enabled = (paper.get().getType() == Paper.Type.SHEET && !(paper.get() instanceof CustomSheetPaper));
            if (accept(get())) {
                return false;
            }
    ...
    public abstract class PageDimensionSetting extends Setting<Length> implements Dependent {
        ...
        protected boolean update(Length value) {
            if (value.asMillimeter() == length.asMillimeter()) {
                return false;
            }
            length = value;
            return true;
    ...
    public class PageWidthSetting extends PageDimensionSetting {
        ...
        public boolean accept(Length value) {
            ...
            switch(paper.get().getType()) {
                case SHEET:
                    return e.supportsPageFormat(new SheetPaperFormat(value, pageHeight.get()));
                case TRACTOR:
                    return e.supportsPageFormat(new TractorPaperFormat(value, pageHeight.get()));
                case ROLL:
                    return e.supportsPageFormat(new RollPaperFormat(value, pageHeight.get()));
            }
            return false;
        }
        ...
        public boolean update(Length value) {
            ...
            switch(p.getType()) {
                case SHEET:
                    ((CustomSheetPaper) p).setPageWidth(value);
                    break;
                case TRACTOR:
                    ((CustomTractorPaper) p).setLengthAcrossFeed(value);
                    break;
                case ROLL:
                    ((CustomRollPaper) p).setLengthAcrossFeed(value);
                    break;
            }
        ...
        public boolean refresh() {
            Paper p = paper.get();
            enabled = p instanceof CustomSheetPaper || p instanceof CustomTractorPaper || p instanceof CustomRollPaper;
            PageFormat f = pageFormat.get();
            switch(f.getPageFormatType()) {
                case SHEET:
                    return super.update(f.asSheetPaperFormat().getPageWidth());
                case TRACTOR:
                    return super.update(f.asTractorPaperFormat().getLengthAcrossFeed());
                case ROLL:
                    return super.update(f.asRollPaperFormat().getLengthAcrossFeed());
            }
            return false;
        }
    }
    ...
    public class PageHeightSetting extends PageDimensionSetting {
        ...
        public boolean accept(Length value) {
            ...
            switch(paper.get().getType()) {
                case SHEET:
                    return e.supportsPageFormat(new SheetPaperFormat(pageWidth.get(), value));
                case TRACTOR:
                    return e.supportsPageFormat(new TractorPaperFormat(pageWidth.get(), value));
                case ROLL:
                    return e.supportsPageFormat(new RollPaperFormat(pageWidth.get(), value));
            }
            return false;
        }
        ...
        public boolean update(Length value) {
            ...
            switch(p.getType()) {
                case SHEET:
                    ((CustomSheetPaper) p).setPageHeight(value);
                    break;
                case TRACTOR:
                    ((CustomTractorPaper) p).setLengthAlongFeed(value);
                    break;
            }
            return super.update(value);
        }
        ...
        public boolean refresh() {
            Paper p = paper.get();
            enabled = p instanceof CustomSheetPaper || p instanceof CustomTractorPaper || p instanceof RollPaper;
            PageFormat f = pageFormat.get();
            switch(f.getPageFormatType()) {
                case SHEET:
                    return super.update(f.asSheetPaperFormat().getPageHeight());
                case TRACTOR:
                    return super.update(f.asTractorPaperFormat().getLengthAlongFeed());
                case ROLL:
                    return super.update(f.asRollPaperFormat().getLengthAlongFeed());
            }
            return false;
        }
    }

    public class PageFormatProperty extends Property<PageFormat> implements Dependent {
        ...
        public boolean refresh() {
            ...
            switch(p.getType()) {
                case SHEET:
                    format = new SheetPaperFormat((SheetPaper) p, pageOrientation.get() ? Orientation.REVERSED : Orientation.DEFAULT);
                    break;
                case TRACTOR:
                    format = new TractorPaperFormat((TractorPaper) p);
                    break;
                case ROLL:
                    format = new RollPaperFormat((RollPaper) p, pageHeight.get());
                    break;
            }
            return true;
        }
    ...
    private class SheetsPerQuireSetting extends DependentNumberSetting {
        ...
        public boolean enabled() {
            ...
            return (getMagazineMode() && getEmbosser().getFeature(EmbosserFeatures.PAGES_IN_QUIRE) != null);
        }
    }
    ...
    public class MarginSettings implements Dependent, Serializable {
        ...
        public void setOuter(int value) {
            outer.set(value);
        }
    ...
    public class ColumnsProperty extends Property<Integer> implements Dependent {
    ...
    public class RowsProperty extends Property<Integer> implements Dependent {
