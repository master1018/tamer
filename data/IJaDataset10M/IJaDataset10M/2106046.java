 ...
 * service as defined by the <tt>TxnMgrAdmin</tt> interface.
 * 
 * @author Sun Microsystems, Inc.
 * 
 * @since 1.1
 */
class TxnMgrAdminProxy implements DestroyAdmin, JoinAdmin, Serializable, ReferentUuid {
    ...
    /**
	 * Creates an administrable transaction manager proxy, returning an instance
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        s.defaultReadObject();
        if (server == null) {
            throw new InvalidObjectException("TxnMgrAdminProxy.readObject " + "failure - server " + "field is null");
        }
        if (proxyID == null) {
            throw new InvalidObjectException("TxnMgrAdminProxy.proxyID " + "failure - proxyID " + "field is null");
        }
    }
    ...
    static final class ConstrainableTxnMgrAdminProxy extends TxnMgrAdminProxy implements RemoteMethodControl {

        private static final long serialVersionUID = 2L;

        /**
		 * Constructs a new <code>ConstrainableTxnMgrAdminProxy</code> instance.
		 * <p>
		 ...
		 */
        private static TxnManager constrainServer(TxnManager server, MethodConstraints constraints) {
        ...
        public RemoteMethodControl setConstraints(MethodConstraints constraints) {
            return (new ConstrainableTxnMgrAdminProxy(server, proxyID, constraints));
        }

        /**
		 * Returns the client constraints placed on the current instance of this
		 * proxy class (<code>ConstrainableTxnMgrAdminProxy</code>). The value
        ...
        private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
            ...
            if (!(server instanceof RemoteMethodControl)) {
                throw new InvalidObjectException("TxnMgrAdminProxy.readObject failure - server " + "does not implement RemoteMethodControl");
            }
        }
    }
}
