    ...
    public List obtenerDiasFestivosMes(int anyo, int mes) throws Exception {
        ...
        if (props == null) {
            ...
            try {
                ...
                throw new Exception("No se ha especificado directorio para calendario dias festivos para a�o " + anyo, e);
            }
        }
        String festivosMes = props.getProperty("mes." + mes);
        if (festivosMes == null) {
            throw new Exception("No se ha especificado directorio para calendario dias festivos para a�o " + anyo + " mes " + mes);
        }
