...
public class ItalicSpecField extends AbstractRendererSpecField<Boolean> {
    ...
    protected static final Logger logger = Logger.getLogger(ItalicSpecField.class);
    ...
    public void renderHTML(FilteredRenderable fr, Boolean value, StringBuffer in, Object o) {
