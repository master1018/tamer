...
public class EnsoniqVFXSingleDriver extends Driver {
    ...
    /**
         ...
         */
    public EnsoniqVFXSingleDriver(final Device device) {
        super(device, "Single", "Denis Queffeulou");
        sysexID = "F00F0500**02";
