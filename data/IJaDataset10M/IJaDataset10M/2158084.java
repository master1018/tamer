...
@WebService(serviceName = "AlarmRetrieval", portName = "AlarmRetrieval", targetNamespace = "tmf854.v1.ws", endpointInterface = "ws.v1.tmf854.fault.http.AlarmRetrieval")
public class AlarmRetrievalImpl implements AlarmRetrieval {

    private static final Logger LOG = Logger.getLogger(AlarmRetrievalImpl.class.getPackage().getName());
    ...
    public Future<?> getActiveAlarmsCountAsync(Holder<HeaderT> mtosiHeader, GetActiveAlarmsCountT mtosiBody, AsyncHandler<GetActiveAlarmsCountResponseT> asyncHandler) {
    ...
    public Response<GetActiveAlarmsCountResponseT> getActiveAlarmsCountAsync(Holder<HeaderT> mtosiHeader, GetActiveAlarmsCountT mtosiBody) {
    ...
    public GetActiveAlarmsCountResponseT getActiveAlarmsCount(Holder<HeaderT> mtosiHeader, GetActiveAlarmsCountT mtosiBody) throws ProcessingFailureException {
    ...
    public Future<?> getActiveAlarmsAsync(Holder<HeaderT> mtosiHeader, GetActiveAlarmsT mtosiBody, AsyncHandler<GetActiveAlarmsResponseT> asyncHandler) {
    ...
    public Response<GetActiveAlarmsResponseT> getActiveAlarmsAsync(Holder<HeaderT> mtosiHeader, GetActiveAlarmsT mtosiBody) {
    ...
    public GetActiveAlarmsResponseT getActiveAlarms(Holder<HeaderT> mtosiHeader, GetActiveAlarmsT mtosiBody) throws ProcessingFailureException {
