 ...
 */
public class EdgeListPanel extends JPanel implements Observer {
    ...
    public EdgeListPanel(Controller controller) {
        ...
        setBorder(BorderFactory.createTitledBorder(new EtchedBorder(), Messages.getString("dijkstra", "EdgeListPanel.Edge_list")));
        ...
        JButton applyButton = new JButton(Messages.getString("dijkstra", "EdgeListPanel.Apply"));
