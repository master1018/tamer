...
public class GlopusMapFile extends TrekBuddy {
    ...
    public void createMap() throws MapCreationException, InterruptedException {
        try {
            ...
            if (parameters != null) createCustomTiles(); else createTiles();
    ...
    private class GlopusTileWriter implements MapTileWriter {
        ...
        public void finalizeMap() {
            ...
            try {
                ...
                int offset = 8 + count * (20 + (12 * 2) + (4 * 24));
                ...
                for (GlopusTile gt : tiles) {
                    ...
                    out.writeDouble(gt.calWLon);
                    out.writeDouble(gt.calSLat);
                    if (log.isTraceEnabled()) log.trace(String.format("Offset %f %f %f %f \"%s\": 0x%x", gt.calWLon, gt.calNLat, gt.calELon, gt.calELon, mapName, offset));
