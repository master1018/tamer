...
public class CollectionTest {
    ...
    public static byte[] contenthash1 = new byte[32];

    public static byte[] contenthash2 = new byte[32];

    public static byte[] publisherid1 = new byte[32];

    public static byte[] publisherid2 = new byte[32];
    ...
    public void testRemoveLink() {
        ...
        cd.remove(lrs[0]);
        Assert.assertEquals(cd.get(0), lrs[1]);
        LinkAuthenticator la2alt = new LinkAuthenticator(pubID2, null, null, SignedInfo.ContentType.DATA, contenthash1);
