...
public class ProxyPage extends CachingPage implements Serializable {
    ...
    public boolean hasChildPage(String pageName) throws Exception {
        if (children.containsKey(pageName)) return true; else {
            loadChildren();
    ...
    public PageData getMeat(String versionName) throws Exception {
        ...
        if (versionName != null) urlString.append("&version=").append(versionName);
        URL url = new URL(urlString.toString());
        PageData data = (PageData) getObjectFromUrl(url);
        if (data != null) data.setWikiPage(this);
        return data;
    }
    ...
    public PageData getDataVersion(String versionName) throws Exception {
        ...
        if (data == null) throw new NoSuchVersionException("There is no version '" + versionName + "'");
        return data;
    }
