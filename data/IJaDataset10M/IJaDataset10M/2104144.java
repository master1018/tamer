...
public interface DBaseDocument extends DBase {
     ...
     * @return DItem
     */
    DItem appendItemValue(String name);
     ...
     * @return DItem
     */
    DItem appendItemValue(String name, String value);
     ...
     * @return DItem
     */
    DItem appendItemValue(String name, int value);
     ...
     * @return DItem
     */
    DItem appendItemValue(String name, double value);
     ...
     * @return DItem
     */
    DItem appendItemValue(String name, Calendar value);
     ...
     * @return DItem
     */
    DItem appendItemValue(String name, List values);
     ...
     * @return DItem
     */
    DItem replaceItemValue(String name, String value);
     ...
     * @return DItem
     */
    DItem replaceItemValue(String name, int value);
     ...
     * @return DItem
     */
    DItem replaceItemValue(String name, Integer value);
     ...
     * @return DItem
     */
    DItem replaceItemValue(String name, double value);
     ...
     * @return DItem
     */
    DItem replaceItemValue(String name, Calendar value);
     ...
     * @return DItem
     */
    DItem replaceItemValue(String name, TimeZone value);
     ...
     * @return DItem
     */
    DItem replaceItemValue(String name, DDateRange value);
     ...
     * @return DItem
     */
    DItem replaceItemValue(String name, Calendar calendar1, Calendar calendar2);
     ...
     * @return DItem
     */
    DItem replaceItemValue(String name, List values);
     ...
     * @return DItem
     */
    DItem replaceItemValue(String name, String[] values);
     ...
     * </p>
     *
     * @return <code>true</code> if successfully saved, else <code>false</code>
     ...
     *
     * @param name The name of the item.
     * @return The value of the item as a Calendar or <tt>null</tt> if the
     ...
     * @return DItem
     */
    DItem replaceItemValueCustomData(String name, String type, Object obj);
     ...
     * @return DItem
     */
    DItem replaceItemValueCustomData(String name, Object obj);
     ...
     * @return DItem
     */
    DItem replaceItemValueCustomDataBytes(String name, String type, byte[] bytes);
