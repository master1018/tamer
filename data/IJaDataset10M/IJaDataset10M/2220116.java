...
public class TestQSMTool {
    ...
    public final void testLoad1() {
        ...
        tool.loadConfig(new StringReader(""));
    ...
    public final void testLoad2() {
        QSMTool tool = new QSMTool();
        tool.loadConfig(new StringReader("# sample file\n+ [[part_a, part_b,part_c]]\n- [[smth_a]]"));
        Assert.assertEquals(-1, tool.k);
        Assert.assertEquals(Configuration.getDefaultConfiguration(), tool.learnerInitConfiguration.config);
    ...
    public final void testLoad8() {
        ...
        Assert.assertEquals(TestFSMAlgo.buildSet(new String[][] { new String[] { "part_a", "part_b", "part_c" } }, tool.learnerInitConfiguration.config), tool.sPlus);
        Assert.assertEquals(TestFSMAlgo.buildSet(new String[][] { new String[] { "smth_a" } }, tool.learnerInitConfiguration.config), tool.sMinus);
        Set<String> expectedltl = new TreeSet<String>();
        expectedltl.addAll(Arrays.asList(new String[] { QSMTool.cmdLTL + " this is a test", QSMTool.cmdIFTHENAUTOMATON + " A-b->B == THEN = C-a->C", QSMTool.cmdIFTHENAUTOMATON + " A-a->B == THEN = C-b->C", QSMTool.cmdLTL + " more test" }));
    ...
    public final void testLoad9() {
        ...
        expectedConfig.setCompressLogs(true);
        expectedConfig.setLearnerIdMode(IDMode.NONE);
        expectedConfig.setGenerateDotOutput(true);
        expectedConfig.setGenerateTextOutput(true);
        Assert.assertEquals(expectedConfig, tool.learnerInitConfiguration.config);
        Assert.assertEquals(TestFSMAlgo.buildSet(new String[][] { new String[] { "part_a", "part_b", "part_c" } }, tool.learnerInitConfiguration.config), tool.sPlus);
        Assert.assertEquals(TestFSMAlgo.buildSet(new String[][] { new String[] { "smth_a" } }, tool.learnerInitConfiguration.config), tool.sMinus);
        Assert.assertNull(tool.learnerInitConfiguration.ifthenSequences);
    ...
    public static class TestInvalidTraces {
        ...
        public static Collection<Object[]> data() {
            ...
            return java.util.Arrays.asList(new Object[][] { new Object[] { "A# sample file", "invalid command" }, new Object[] { "+", errArgumentRequired }, new Object[] { "-", errArgumentRequired }, new Object[] { QSMTool.cmdLTL, errArgumentRequired }, new Object[] { "- +", "invalid token type" }, new Object[] { "- [a] +", "expected a sequence" }, new Object[] { "- [] +[] []", "a collection of traces should start" }, new Object[] { "- [a, aa", "unexpected end of list" }, new Object[] { "- [+ ]", "invalid token" }, new Object[] { "- aa", "expected a sequence" }, new Object[] { "- [aa, []]", "expected a sequence" }, new Object[] { "- [] P", "a collection of traces should start" } });
        }
        ...
        public final void testParseBadTrace() {
            checkForCorrectException(new whatToRun() {
                ...
                public void run() {
                    QSMTool tool = new QSMTool();
                    tool.loadConfig(new StringReader(text));
                }
    ...
    public final void testInsufficientArgsForProperty1() {
        checkForCorrectException(new whatToRun() {
            ...
            public void run() {
                QSMTool tool = new QSMTool();
                tool.loadConfig(new StringReader(QSMTool.cmdConfig));
            }
        }, IllegalArgumentException.class, "Argument required");
    }
    ...
    public final void testInsufficientArgsForProperty2() {
        checkForCorrectException(new whatToRun() {
            ...
            public void run() {
                QSMTool tool = new QSMTool();
                tool.loadConfig(new StringReader(QSMTool.cmdConfig + " a"));
            }
    ...
    public final void testWrongProperty() {
        checkForCorrectException(new whatToRun() {
            ...
            public void run() {
                QSMTool tool = new QSMTool();
                tool.loadConfig(new StringReader(QSMTool.cmdConfig + " junk test"));
            }
    ...
    public final void testWrongValueForProperty1() {
        checkForCorrectException(new whatToRun() {
            ...
            public void run() {
                QSMTool tool = new QSMTool();
                tool.loadConfig(new StringReader(QSMTool.cmdConfig + " learnerIdMode JUNK"));
            }
    ...
    public final void testWrongValueForProperty2() {
        checkForCorrectException(new whatToRun() {
            ...
            public void run() {
                QSMTool tool = new QSMTool();
                tool.loadConfig(new StringReader(QSMTool.cmdConfig + " klimit 2.0"));
            }
        }, IllegalArgumentException.class, "failed to load");
    }
    ...
    public final void testWrongValueForProperty3() {
        checkForCorrectException(new whatToRun() {
            ...
            public void run() {
                QSMTool tool = new QSMTool();
                tool.loadConfig(new StringReader(QSMTool.cmdConfig + " gdLowToHighRatio AAA34"));
            }
        }, IllegalArgumentException.class, "failed to load");
    }
    ...
    public final void testWrongValueForProperty4() {
        checkForCorrectException(new whatToRun() {
            ...
            public void run() {
                QSMTool tool = new QSMTool();
                tool.loadConfig(new StringReader(QSMTool.cmdConfig + " gdLowToHighRatio 34"));
            }
        }, IllegalArgumentException.class, "failed to load");
    }
    ...
    public final void testWrongValueForK() {
        checkForCorrectException(new whatToRun() {
            ...
            public void run() {
                QSMTool tool = new QSMTool();
                tool.loadConfig(new StringReader("k 2.0"));
            }
    ...
    public final void testLoadXMLabels2() {
        ...
        Assert.assertEquals(SmtLabelRepresentation.commentForNewSeq + "[]" + ENDL + "(and" + ENDL + SmtLabelRepresentation.commentForInit + ENDL + "constraint" + SmtLabelRepresentation.delimiterString + "2" + ENDL + ')' + ENDL, state.secondElem);
    }
    ...
    public final void testLoadXMLabels_Error() {
        checkForCorrectException(new whatToRun() {
            ...
            public void run() {
                QSMTool tool = new QSMTool();
                tool.loadConfig(new StringReader(QSMTool.cmdOperation + " " + SmtLabelRepresentation.INITMEM + " " + SmtLabelRepresentation.OP_DATA.PRE + " decl_N" + "\n" + QSMTool.cmdOperation + " " + SmtLabelRepresentation.INITMEM + " JUNK constraint_N" + "\n" + QSMTool.cmdOperation));
            }
