...
public class StandardDialog extends JDialog {
    ...
    public void performAction(Object src) {
        if (src == okButton) acceptChanges(); else if (src == cancelButton) rejectChanges();
    }

    public class StandardActionListener implements ActionListener {
    ...
    public ActionListener getActionListener() {
        if (null == myActionListener) myActionListener = createActionListener();
    ...
    public JPanel createBottomPanel(int config) {
        ...
        addOKButton(p);
        if (OK_CANCEL == config) addCancelButton(p);
        return p;
    }
    ...
    public void initialize() {
        ...
        if (null != menuBar) setJMenuBar(menuBar);
    ...
    public static Dimension toDimension(double widthPercent, int minWidth, double heightPercent, int minHeight) {
        Dimension d = Toolkit.getDefaultToolkit().getScreenSize();
    ...
    public void setVisible(boolean visible) {
        if (visible) setChangesAccepted(false);
