...
public class CaixaEconomica extends Banco {
    ...
    private final String CD_COBRANCA_SR = "14";

    private final String SG_COBRANCA_SR = "SR";

    private final String BC_COBRANCA_SR = "80";

    private final String CONSTANTE_CAMPO_LIVRE = "7";
    ...
    public CaixaEconomica(String codbanco, String codmoeda, String dvbanco, Long fatvenc, BigDecimal vlrtitulo, String convenio, String tpnossonumero, Long doc, Long seq, Long rec, Long nparc, String agencia, String conta, String carteira, String modalidade) {
    ...
    public String geraCodBar() {
        String parte1 = getNumero();
        String parte2 = String.valueOf(getMoeda());
        String parte3 = String.valueOf(getCampo4());
        String parte4 = String.valueOf(getFatvenc());
        String parte5 = getValorTitulo();
        String parte6 = getCampoLivre();
        String numero = parte1 + parte2 + parte3 + parte4 + parte5 + parte6;
        return numero;
    }

    public String geraCodBar(String codbanco, String codmoeda, String dvbanco, Long fatvenc, BigDecimal vlrtitulo, String convenio, String tpnossonumero, Long doc, Long seq, Long rec, Long nparc, String agencia, String conta, String carteira, String modalidade) {
        setMoeda(new Integer(codmoeda).intValue());
        setValorTitulo(vlrtitulo);
        setCodcli(convenio);
        setConvenio(convenio);
