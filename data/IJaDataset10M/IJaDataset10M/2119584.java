...
public abstract class BaseCmsAdvertisingSpace implements Serializable {
	 ...
	 */
    public BaseCmsAdvertisingSpace(java.lang.Integer id, com.jeecms.cms.entity.main.CmsSite site, java.lang.String name, java.lang.Boolean enabled) {
        this.setId(id);
        this.setSite(site);
        this.setName(name);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.jeecms.cms.entity.assist.CmsAdvertisingSpace)) return false; else {
            ...
            if (null == this.getId() || null == cmsAdvertisingSpace.getId()) return false; else return (this.getId().equals(cmsAdvertisingSpace.getId()));
        }
    }
