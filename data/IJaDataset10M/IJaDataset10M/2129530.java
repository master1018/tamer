 ...
 * @author Bruno
 */
public class verEstrenosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            List<JBPelicula> peliculas = i.verEstrenos();
            session.setAttribute("peliculas", peliculas);
            response.sendRedirect("verEstrenos.jsp");
        } catch (Exception exc) {
            session.setAttribute("error", "Ha ocurrido un error " + exc.toString());
            response.sendRedirect("verEstrenos.jsp");
        }
    }
