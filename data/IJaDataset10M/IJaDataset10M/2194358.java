...
public class LocalizationUtil {
    ...
    static final Logger logger = LoggerFactory.getLogger(LocalizationUtil.class);
    ...
    private static void generateIneFormSourceFromCsv() {
        ...
        try {
            ...
            I18nModuleConverter srvI18nConverter = new I18nModuleConverter(CMI18n.class, serverStore.getLocalizablesForModule(CMI18n.MODULE_NAME));
