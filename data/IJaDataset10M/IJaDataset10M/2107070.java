...
public class LayerControlList extends JPanel {
    ...
    public LayerControlList() {
        ...
        Object[][] items = new Object[][] { { new JRadioButton(), new JCheckBox(), "A" }, { new JRadioButton(), new JCheckBox(), "B" }, { new JRadioButton(), new JCheckBox(), "Result" } };
        ...
        table.getColumnModel().getColumn(1).setCellEditor(new CheckBoxEditor(new JCheckBox()));
