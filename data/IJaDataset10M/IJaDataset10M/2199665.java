...
public class CreateDecryption extends AbstractModernAlgorithm {
    ...
    public Document decrypt(final Decryption decryption, IProgressMonitor monitor) throws Exception {
        ...
        monitor.worked(1);
        NodeList encryptedElements = doc.getElementsByTagNameNS(EncryptionConstants.EncryptionSpecNS, EncryptionConstants._TAG_ENCRYPTEDDATA);
        int position = 0;
        monitor.worked(1);
        ...
        NodeList references = encryptedElement.getElementsByTagNameNS(EncryptionConstants.EncryptionSpecNS, EncryptionConstants._TAG_CIPHERREFERENCE);
