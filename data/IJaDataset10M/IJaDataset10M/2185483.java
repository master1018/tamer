package org.hmaciel.sisingr.otros.Usuarios;
...
@Stateless
public class ControllerLogica implements Ilogica {

    int ldapPort = LDAPConnection.DEFAULT_PORT;

    int ldapVersion = LDAPConnection.LDAP_V3;

    String ldapHost = "192.168.162.12";

    String loginDN = "cn=Manager,dc=usuariosSisIngr";

    String password = "opensih";

    public void persistirUsuario(User user) throws LDAPException {
        LDAPConnection lc = new LDAPConnection();
        String cedula = user.getCi().replaceAll("\\.", "").replaceAll("-", "").replaceAll(" ", "");
        ...
        attributeSet.add(new LDAPAttribute("roles", "'cn=" + user.getRol() + ",ou=Roles,dc=usuariosSisIngr'"));
        ...
        attributeSet.add(new LDAPAttribute("description", cedula));
        String dn = "uid=" + user.getUser() + ",ou=people,dc=usuariosSisIngr";
    ...
    public User obtenerUsuario(String nombre) {
        ...
        try {
            ...
            String baseBusqueda = "uid=" + nombre + ",ou=people,dc=usuariosSisIngr";
            String filtro = "";
            String[] atributos = { "*" };
    ...
    public void modificarPass(String nombre, String nuevopass) throws LDAPException {
        LDAPConnection lc = new LDAPConnection();
        String dn = "uid=" + nombre + ",ou=people,dc=usuariosSisIngr";
        try {
            lc.connect(ldapHost, ldapPort);
            lc.bind(ldapVersion, loginDN, password.getBytes("UTF8"));
