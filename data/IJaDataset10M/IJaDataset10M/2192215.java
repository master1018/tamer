...
public class Paarung implements plugins.IPaarung {
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof Paarung) {
            ...
            if ((spiel.getStringDate().equals(m_sDatum)) && (spiel.getGastId() == m_iGastId) && (spiel.getGastName().equals(m_sGastName)) && (spiel.getHeimId() == m_iHeimId) && (spiel.getHeimName().equals(m_sHeimName)) && (spiel.getMatchId() == m_iMatchId) && (spiel.getSpieltag() == m_iSpieltag) && (spiel.getToreGast() == m_iToreGast) && (spiel.getToreHeim() == m_iToreHeim)) {
                return true;
            }
        }
        return false;
