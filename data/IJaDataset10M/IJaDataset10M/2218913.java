...
public class LuceneSearchIndexer extends AbstractSearchIndexer {
   ...
   */
    public LuceneSearchIndexer(IndexWriter indexWriter, LuceneSearchEngineBuilder searchEngineBuilder, LuceneFieldManager fieldManager, SearchDependencies searchDependencies) {
        super();
   ...
   */
    ...
    protected void add(MutableSearchEntry entry, Long id) throws SearchException {
        ...
        try {
            ...
            NumericField idField = new NumericField(SearchEntry.FIELD_ID, NumericUtils.PRECISION_STEP_DEFAULT, Store.YES, true);
   ...
   */
    public SearchEngine getSearchEngine() {
        try {
            if (this.searchEngine == null) {
                this.searchEngine = this.searchEngineBuilder.createSearchEngine(this.indexWriter.getReader(), this.fieldManager.getConfigurationHolder(), null);
            }
