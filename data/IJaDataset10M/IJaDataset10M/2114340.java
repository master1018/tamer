...
public class BulkMutateJobPolicy implements java.io.Serializable {
     ...
     * size of this collection is 3.</span>
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = true && ((this.prerequisiteJobIds == null && other.getPrerequisiteJobIds() == null) || (this.prerequisiteJobIds != null && java.util.Arrays.equals(this.prerequisiteJobIds, other.getPrerequisiteJobIds())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPrerequisiteJobIds() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getPrerequisiteJobIds()); i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(BulkMutateJobPolicy.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v200909", "BulkMutateJobPolicy"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("prerequisiteJobIds");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v200909", "prerequisiteJobIds"));
