...
public class OntologyURIFilter extends LogFilter {
    ...
    protected String getHelpForThisLogFilter() {
        return "Renames ontology URIs in the log file. " + "This filter can be used to rename URIs pointing to (possibly non-existing) http URLs " + "to local files for example." + "For more information, please see <b>http://prom.win.tue.nl/research/wiki/online/semanticprocessmining</b>.";
    }
