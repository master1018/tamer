...
public class MenuGroup extends AbstractIdentifier implements TreeMenuItem, Cloneable, Serializable {
    ...
    public void copyFrom(au.org.emii.portal.config.MenuGroup configData, PortalSession portalSession) {
    ...
    public String dump(String indent) {
        StringBuffer dump = new StringBuffer("MG" + indent + dump() + " (parent=" + ((parent == null) ? "NULL_PARENT!" : parent.getId()) + ")\n");
        indent += "  ";
