...
public abstract class Logic extends Types {
    ...
    public static boolean equal(final Node lhs, final Node rhs) {
        if ((lhs != null) && (rhs != null)) return (equal(toToken(lhs), toToken(rhs)));
        return (false);
    }
    ...
    public static boolean notEqual(final Node lhs, final Node rhs) {
        if ((lhs != null) && (rhs != null)) return (notEqual(toToken(lhs), toToken(rhs)));
        return (false);
    }
    ...
    public static boolean less(final Node lhs, final Node rhs) {
        if ((lhs != null) && (rhs != null)) return (less(toToken(lhs), toToken(rhs)));
        return (false);
    }
    ...
    public static boolean greater(final Node lhs, final Node rhs) {
        if ((lhs != null) && (rhs != null)) return (greater(toToken(lhs), toToken(rhs)));
        return (false);
    }
    ...
    public static boolean lessOrEqual(final Node lhs, final Node rhs) {
        if ((lhs != null) && (rhs != null)) return (lessOrEqual(toToken(lhs), toToken(rhs)));
        return (false);
    }
    ...
    public static boolean greaterOrEqual(final Node lhs, final Node rhs) {
        if ((lhs != null) && (rhs != null)) return (greaterOrEqual(toToken(lhs), toToken(rhs)));
        return (false);
    }
