...
public class depth_funcType extends homura.hde.util.xml.xml.Node {

    public depth_funcType(depth_funcType node) {
        super(node);
    }

    public depth_funcType(org.w3c.dom.Node node) {
        super(node);
    }

    public depth_funcType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public depth_funcType(homura.hde.util.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "depth_func");
    }
    ...
    public gl_func_type newvalue2() {
        return new gl_func_type();
    }

    public gl_func_type getvalue2At(int index) throws Exception {
        return new gl_func_type(getDomNodeValue(getDomChildAt(Attribute, null, "value", index)));
    }
    ...
    public gl_func_type getvalue2ValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new homura.hde.util.xml.xml.XmlException("Out of range"); else return new gl_func_type(getDomNodeValue(curNode));
    }

    public gl_func_type getvalue2() throws Exception {
    ...
    public org.w3c.dom.Node addvalue2(gl_func_type value) {
    ...
    public org.w3c.dom.Node addvalue2(String value) throws Exception {
        return addvalue2(new gl_func_type(value));
    }

    public void insertvalue2At(gl_func_type value, int index) {
    ...
    public void insertvalue2At(String value, int index) throws Exception {
        insertvalue2At(new gl_func_type(value), index);
    }

    public void replacevalue2At(gl_func_type value, int index) {
    ...
    public void replacevalue2At(String value, int index) throws Exception {
        replacevalue2At(new gl_func_type(value), index);
    }
