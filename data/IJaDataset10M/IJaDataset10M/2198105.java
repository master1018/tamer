 ...
 */
public class HelpTOCAction extends RunnableAction {
	 ...
	 */
    public HelpTOCAction(XMLHammer parent) {
        super("Table of Contents");
        putValue(MNEMONIC_KEY, new Integer('T'));
        putValue(SHORT_DESCRIPTION, "Help Table of Contents");
        putValue(SMALL_ICON, new ImageIcon(getClass().getResource("/org/xmlhammer/gui/icons/etool16/alltopics_co.gif")));
        this.parent = parent;
    }
