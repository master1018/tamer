 ...
 * @author Apelon, Inc.
 */
public class SuperconceptHandler extends DTSSaxHandler {

    static final String HANDLER_NAME = "superconcept";

    public SuperconceptHandler() {
        super();
