...
public class RepositoryObjectCollectionImpl extends EObjectImpl implements RepositoryObjectCollection {
    ...
    public void setSourceConnection(JCoDestination newSourceConnection) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, ROMPackage.REPOSITORY_OBJECT_COLLECTION__SOURCE_CONNECTION, oldSourceConnection, sourceConnection));
    }
    ...
    public RepositoryObject loadObject(RepositoryObjectKey key) throws ObjectNotFoundException, ObjectLoadingException {
        ...
        throw new ObjectLoadingException(MessageFormat.format("Unable to load repository object {0} {1} {2}.", key.getProgramID(), key.getObjectTypeID(), key.getName()));
    }
    ...
    private RepositoryObject loadTABLObject(RepositoryObjectKey key) throws ObjectLoadingException, ObjectNotFoundException {
        try {
            ...
            if (type.equals("TRANSP")) {
                ...
                throw new ObjectLoadingException(MessageFormat.format("Unable to load structure {0}: unsupported structure type {1}", key.getName(), type));
            }
        } catch (JCoException e) {
            throw new ObjectLoadingException(MessageFormat.format("Unable to load repository object R3TR TABL {0}.", key.getName()), e);
        }
    }
    ...
    protected void loadRepositoryData(RepositoryObject object) throws ObjectLoadingException {
        try {
            ...
            if (result.isEmpty()) {
                throw new ObjectLoadingException(MessageFormat.format("Unable to read the repository data (TADIR) for object {0} {1} {2}", object.getProgramID(), object.getObjectTypeID(), object.getName()));
            }
            if (result.size() > 1) {
                throw new ObjectLoadingException(MessageFormat.format("Received multiple lines while reading the repository data (TADIR) for object {0} {1} {2}", object.getProgramID(), object.getObjectTypeID(), object.getName()));
            }
            try {
                ...
                throw new ObjectLoadingException(MessageFormat.format("Error converting the repository object data from TADIR for object {0} {1} {2}", object.getProgramID(), object.getObjectTypeID(), object.getName()), e);
            }
        } catch (JCoException e) {
            throw new ObjectLoadingException(MessageFormat.format("Error loading the repository object data from TADIR for object {0} {1} {2}", object.getProgramID(), object.getObjectTypeID(), object.getName()), e);
        }
    }
    ...
    private void loadPackage(RepositoryPackage pkg) throws ObjectNotFoundException, ObjectLoadingException {
        ...
        try {
            ...
            if (result.isEmpty()) {
                throw new ObjectNotFoundException(MessageFormat.format("Unable to read the package data (TDEVC) for package {0}", pkg.getName()));
            }
            if (result.size() > 1) {
                throw new ObjectLoadingException(MessageFormat.format("Received multiple lines while reading the package data (TDEVC) for package {0}", pkg.getName()));
            }
            try {
                final ITableLine line = result.getLine(0);
                ...
                if (packtype.equals("")) {
                    ...
                    switch(packtype.charAt(0)) {
                        ...
                        case 'O':
                            ...
                            break;
                        default:
                            throw new ObjectLoadingException(MessageFormat.format("Unexpected value {0} in field PACKTYPE of the package data (TDEVC) for package {1}", packtype, pkg.getName()));
                    }
                }
                ...
                if (mainpack.equals("")) {
                    ...
                    switch(mainpack.charAt(0)) {
                        ...
                        case 'S':
                            ...
                            break;
                        default:
                            throw new ObjectLoadingException(MessageFormat.format("Unexpected value {0} in field MAINPACK of the package data (TDEVC) for package {1}", packtype, pkg.getName()));
                    }
                }
            } catch (Exception e) {
                throw new ObjectLoadingException(MessageFormat.format("Error converting the package data from TDEVC for package {0}", pkg.getName()), e);
            }
            ...
            for (final ITableLine line : result) {
                try {
                    ...
                    throw new ObjectLoadingException(MessageFormat.format("Error reading the sub-packages of package {0}", pkg.getName()), e);
                }
            }
            ...
            for (final ITableLine line : result) {
                try {
                    ...
                    throw new ObjectLoadingException(MessageFormat.format("Error reading the contents of package {0}", pkg.getName()), e);
                }
            }
            getPackages().add(pkg);
        } catch (JCoException e) {
            throw new ObjectLoadingException(MessageFormat.format("Error loading the package data from TDEVC/TDEVCT for package {0}", pkg.getName()), e);
        }
    }
    ...
    private void loadStructure(Structure structure) throws ObjectNotFoundException, ObjectLoadingException {
        ...
        try {
            ...
            if (type.equals("INTTAB") || type.equals("APPEND")) {
                ...
                throw new ObjectLoadingException(MessageFormat.format("{0} is not a structure (INTTAB or APPEND), but a {1}.", structure.getName(), type));
            }
        } catch (JCoException e) {
    ...
    private void loadTable(Table table) throws ObjectNotFoundException, ObjectLoadingException {
        ...
        try {
            ...
            if (type.equals("TRANSP")) {
                ...
                throw new ObjectLoadingException(MessageFormat.format("{0} is not a transparent table (TRANSP), but a {1}.", table.getName(), type));
            }
        } catch (JCoException e) {
	 ...
	 * @generated no
	 */
    private void loadForwardDeclarations(final String objectTypeName, ForwardDeclarations forwardDeclarations) throws JCoException, FieldNotFoundException {
        TableReader reader;
        ITableContents result;
	 ...
	 */
    @SuppressWarnings("unchecked")
    private void loadAttributes(final String objectTypeName, Map attributeMap, EList attributes, EClass attributeType) throws JCoException, FieldNotFoundException, LocaleNotFoundException {
	 ...
	 */
    @SuppressWarnings("unchecked")
    private void loadMethods(final String objectTypeName, Map methodMap, EList methods, EClass methodType) throws JCoException, FieldNotFoundException, LocaleNotFoundException {
	 ...
	 * @generated no
	 */
    private void loadMethodParameters(final String objectTypeName, Map<String, ? extends InterfaceMethod> methods) throws JCoException, FieldNotFoundException, LocaleNotFoundException {
	 ...
	 * @generated no
	 */
    private void loadMethodExceptions(final String objectTypeName, Map<String, ? extends InterfaceMethod> methods) throws JCoException, FieldNotFoundException, LocaleNotFoundException {
	 ...
	 */
    @SuppressWarnings("unchecked")
    private void loadEvents(final String objectTypeName, Map eventMap, EList events, EClass eventType) throws JCoException, FieldNotFoundException, LocaleNotFoundException {
	 ...
	 * @generated no
	 */
    private void loadEventParameters(final String objectTypeName, Map<String, ? extends InterfaceEvent> events) throws JCoException, FieldNotFoundException, LocaleNotFoundException {
