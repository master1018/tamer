...
public class XMLElementTest extends TestCase {
    ...
    private static final W3cDomHelper docHelper = new W3cDomHelper(TreeLogger.NULL, new MockResourceOracle());
    ...
    public void setUp() throws Exception {
        super.setUp();
        CompilationState state = CompilationStateBuilder.buildFrom(createCompileLogger(), UiJavaResources.getUiResources());
    ...
    public void testAssertNoAttributes() throws SAXParseException {
        ...
        try {
            ...
            assertTrue("Expect extra attributes list", logger.died.contains("\"yes\""));
            assertTrue("Expect extra attributes list", logger.died.contains("\"no\""));
            assertTrue("Expect line number " + logger.died, logger.died.contains("Unknown:3"));
        }
    }
    ...
    public void testConsumeBoolean() throws SAXParseException, UnableToCompleteException {
    ...
    public void testConsumeBooleanConstant() throws SAXParseException, UnableToCompleteException {
        init("<doc>\n\n<elm yes='true' no='false' " + "fnord='fnord' ref='{foo.bar.baz}' empty=''/></doc>");
    ...
    public void testConsumeBooleanDefault() throws SAXParseException, UnableToCompleteException {
        init("<doc>\n\n<elm yes='true' no='false' " + "fnord='fnord' ref='{foo.bar.baz}'/></doc>");
   ...
   */
    public void testConsumeStringArray_designTime() throws Exception {
        ...
        assertEquals("new String[] {\"a\", \"b\", \"c\"}", attributes.get("0/0 attr"));
    }
    ...
    public void testConsumeInnerTextEscapedAsHtmlStringLiteral() throws UnableToCompleteException {
        ...
        assertEquals(UiBinderWriter.escapeTextForJavaStringLiteral(STRING_WITH_DOUBLEQUOTE), elm.consumeInnerTextEscapedAsHtmlStringLiteral(new NullInterpreter<String>()));
    }
    ...
    public void testConsumeRawAttributeWithDefault() {
        ...
        assertEquals("otherDefault", elm.consumeRawAttribute("unsetthing", "otherDefault"));
    }
    ...
    public void testConsumeRequired() throws UnableToCompleteException {
        assertEquals("\"attr1Value\"", elm.consumeRequiredAttribute("attr1", types.findType("java.lang.String")));
    }
   ...
   */
    ...
    public void testConsumeRequiredDouble() throws UnableToCompleteException, SAXParseException {
        init("<doc>\n\n<elm minus='-123.45' plus='123.45' minus-one='-1' " + "plus-one='1' fnord='fnord' ref='{foo.bar.baz}'/></doc>");
   ...
   */
    public void testConsumeRequiredInt() throws UnableToCompleteException, SAXParseException {
    ...
    public void testConsumeSingleChildElementEmpty() throws SAXParseException, UnableToCompleteException {
        assertNull(logger.died);
        try {
        ...
        assertEquals("Hi.", elm.consumeSingleChildElement().consumeUnescapedInnerText());
        logger.died = null;
   ...
   */
    private void init(DesignTimeUtils designTime, String domString) throws SAXParseException {
   ...
   */
    private void init(String domString) throws SAXParseException {
        ...
        item = (Element) doc.getDocumentElement().getElementsByTagName("elm").item(0);
