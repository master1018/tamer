...
public abstract class Syntax implements Printable, Named {
    ...
    public final String getName() {
        return name == null ? null : name instanceof Symbol ? ((Symbol) name).getName() : name.toString();
    }
   ...
   */
    ...
    public Expression rewriteForm(Object form, Translator tr) {
        if (form instanceof Pair) return rewriteForm((Pair) form, tr); else return tr.syntaxError("non-list form for " + this);
    }
    ...
    public void scanForm(Pair st, ScopeExp defs, Translator tr) {
        ...
        if (!ok) tr.formStack.add(new ErrorExp("syntax error expanding " + this));
    }
