...
public class ForceIndex extends Indicator {
    ...
    public void paint(Graphics2D g, ChartFrame cf, Rectangle bounds) {
        ...
        if (dataset1 != null && dataset2 != null) {
            if (maximized) {
                ...
                DefaultPainter.line(g, cf, range, bounds, Dataset.DIV(dataset1, factor), properties.getColor1(), properties.getStroke1());
                DefaultPainter.line(g, cf, range, bounds, Dataset.DIV(dataset2, factor), properties.getColor2(), properties.getStroke2());
            }
        }
    }
    ...
    public double[] getValues(ChartFrame cf) {
        ...
        Dataset dataset2 = visibleDataset(cf, FI2);
        double factor = getFactor(cf);
        if (dataset1 != null && dataset2 != null) return new double[] { dataset1.getLastClose() / factor, dataset2.getLastClose() / factor };
        return new double[] {};
    }
    ...
    public double[] getValues(ChartFrame cf, int i) {
        ...
        Dataset dataset2 = visibleDataset(cf, FI2);
        double factor = getFactor(cf);
        if (dataset1 != null && dataset2 != null) return new double[] { dataset1.getCloseAt(i) / factor, dataset2.getCloseAt(i) / factor };
        return new double[] {};
    }
