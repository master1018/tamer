...
public class AlfNature implements org.eclipse.core.resources.IProjectNature {

    public static final String NATURE_ID = "fr.inria.papyrus.uml4tst.emftext.alf.resource.alf.nature";
	 ...
	 */
    public static final String[] BUILDER_IDS = { fr.inria.papyrus.uml4tst.emftext.alf.resource.alf.mopp.AlfBuilderAdapter.BUILDER_ID };
    ...
    public void configure() throws org.eclipse.core.runtime.CoreException {
        ...
        for (int i = 0; i < commands.length; ++i) {
            if (commands[i].getBuilderName().equals(fr.inria.papyrus.uml4tst.emftext.alf.resource.alf.mopp.AlfBuilderAdapter.BUILDER_ID)) {
                return;
            }
        }
