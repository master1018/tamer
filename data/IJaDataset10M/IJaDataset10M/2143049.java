...
public abstract class DmcTypeUserGroupREF extends DmcTypeNamedObjectREF<UserGroupREF, StringName> {
    ...
    protected boolean isDMO(Object value) {
        if (value instanceof UserGroupDMO) return (true);
        return (false);
    }
    ...
    protected UserGroupREF typeCheck(Object value) throws DmcValueException {
        ...
        if (value instanceof UserGroupREF) rc = (UserGroupREF) value; else if (value instanceof UserGroupDMO) rc = new UserGroupREF((UserGroupDMO) value); else if (value instanceof StringName) rc = new UserGroupREF((StringName) value); else if (value instanceof String) rc = new UserGroupREF((String) value); else throw (new DmcValueException("Object of class: " + value.getClass().getName() + " passed where object compatible with UserGroupREF, UserGroupDMO or String expected."));
        return (rc);
    }
