...
public class FavoritesXmlHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attribs) {
        ...
        if (identifier == FAVORITES) {
            ...
            isInsideFolder = true;
        } else if (identifier == STOCK) stack.push(new StockAPI()); else if (identifier == NAME || identifier == COMPANY || identifier == SYMBOL || identifier == EXCHANGE || identifier == DATAPROVIDER) {
