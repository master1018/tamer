 ...
 */
public abstract class LogicEditPart extends org.eclipse.gef.editparts.AbstractGraphicalEditPart implements NodeEditPart, PropertyChangeListener {
 ...
 */
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (LogicSubpart.CHILDREN.equals(prop)) {
            if (evt.getOldValue() instanceof Integer) addChild(createChild(evt.getNewValue()), ((Integer) evt.getOldValue()).intValue()); else removeChild((EditPart) getViewer().getEditPartRegistry().get(evt.getOldValue()));
        } else if (LogicSubpart.INPUTS.equals(prop)) refreshTargetConnections(); else if (LogicSubpart.OUTPUTS.equals(prop)) refreshSourceConnections(); else if (prop.equals(LogicSubpart.ID_SIZE) || prop.equals(LogicSubpart.ID_LOCATION)) refreshVisuals();
    }
 ...
 */
    protected void refreshVisuals() {
        ...
        RectD2D r = new RectD2D(loc, size);
