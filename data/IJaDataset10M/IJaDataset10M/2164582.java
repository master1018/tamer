...
public class ReferenceProviderDescriptor {
    ...
    public boolean isPluginLoaded() {
        if (fBundle == null) fBundle = Platform.getBundle(fConfiguration.getContributor().getName());
    ...
    public boolean getDefault() {
        if (fDefault == null) {
            ...
            if ("true".equalsIgnoreCase(def)) fDefault = Boolean.TRUE; else fDefault = Boolean.FALSE;
        }
