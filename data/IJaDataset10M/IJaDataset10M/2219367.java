...
public class MapFilterModelEditor extends JPanel {
    ...
    public class DeleteButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (JOptionPane.showConfirmDialog(tufts.vue.VUE.getDialogParentAsFrame(), VueResources.getString("dialog.delcustommetdata.message"), VueResources.getString("dialog.delcustommetdata.title"), JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, tufts.vue.VueResources.getImageIcon("vueIcon32x32")) == JOptionPane.YES_OPTION) {
                ...
                if (r > 0) table.setRowSelectionInterval(r - 1, r - 1); else if (table.getRowCount() > 0) table.setRowSelectionInterval(0, 0);
            }
        }
    }
}
