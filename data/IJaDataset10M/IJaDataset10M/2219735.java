...
public class MigrateTask extends Task {
    ...
    public void execute() {
        try {
            ...
            emClass.getMethod("setNameConverter", Class.forName("net.java.ao.schema.PluggableNameConverter", true, classloader)).invoke(manager, loadNameConverter(classloader));
