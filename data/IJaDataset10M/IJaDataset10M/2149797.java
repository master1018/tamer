...
public class GradeCourseResourceDAO extends PyramusEntityDAO<GradeCourseResource> {
   ...
   */
    public GradeCourseResource create(Course course, Resource resource, Double hours, MonetaryAmount hourlyCost, MonetaryAmount unitCost) {
   ...
   * @param unitCost Resource unit cost
   */
    public void update(GradeCourseResource gradeCourseResource, Double hours, MonetaryAmount hourlyCost, MonetaryAmount unitCost) {
        EntityManager entityManager = getEntityManager();
        gradeCourseResource.setHours(hours);
        gradeCourseResource.setHourlyCost(hourlyCost);
        gradeCourseResource.setUnitCost(unitCost);
    ...
    public List<GradeCourseResource> listByCourse(Course course) {
        ...
        criteria.where(criteriaBuilder.equal(root.get(GradeCourseResource_.course), course));
   ...
   */
    ...
    public void delete(GradeCourseResource gradeCourseResource) {
        EntityManager entityManager = getEntityManager();
        if (gradeCourseResource.getCourse() != null) gradeCourseResource.getCourse().removeGradeCourseResource(gradeCourseResource);
