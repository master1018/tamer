...
public class ClassHierarchyTest extends TestCase {
    ...
    public class MC001 {
        ...
        @i
        public class MC001_01 {

            @i
            public class MC001_01_01 {

                @i
                public class MC001_01_01_01 {

                    @i
                    public class MC001_01_01_01_01 {

                        @i
                        public class MC001_01_01_01_01_01 {

                            @i
                            public class MC001_01_01_01_01_01_01 {
                            }
    ...
    @i
    public class MC002<X, Y, Z> {

        @i
        public class MC002_01<X1, Y1, Z1> {

            @i
            public class MC002_01_01<X2, Y2, Z2> {

                @i
                public class MC002_01_01_01<X3, Y3, Z3> {

                    @i
                    public class MC002_01_01_01_01<X4, Y4, Z4> {

                        @i
                        public class MC002_01_01_01_01_01<X5, Y5, Z5> {

                            @i
                            public class MC002_01_01_01_01_01_01<X6, Y6, Z6> {
                            }
    ...
    interface MI001 {
        ...
        interface MI001_01 {
            ...
            @i
            interface MI001_01_01 {

                @i
                interface MI001_01_01_01 {

                    @i
                    interface MI001_01_01_01_01 {

                        @i
                        interface MI001_01_01_01_01_01 {

                            @i
                            interface MI001_01_01_01_01_01_01 {
    ...
    @i
    interface MI002<X, Y, Z> {

        @i
        interface MI002_01<X1, Y1, Z1> {

            @i
            interface MI002_01_01<X2, Y2, Z2> {

                @i
                interface MI002_01_01_01<X3, Y3, Z3> {

                    @i
                    interface MI002_01_01_01_01<X4, Y4, Z4> {

                        @i
                        interface MI002_01_01_01_01_01<X5, Y5, Z5> {

                            @i
                            interface MI002_01_01_01_01_01_01<X6, Y6, Z6> {
    ...
    public void test_1_1() {
        ...
        try {
            MI001.class.asSubclass(ClassHierarchyTest.class);
            fail("test_1, case 011 FAILED: " + MI001.class.asSubclass(ClassHierarchyTest.class));
        } catch (Exception e) {
        }
    ...
    public void test_3() {
        ...
        try {
            LC001.class.asSubclass(ClassHierarchyTest.class);
            fail("test_3, case 011 FAILED: " + LC001.class.asSubclass(ClassHierarchyTest.class));
        } catch (Exception e) {
        }
    ...
    public void test_4() {
        ...
        try {
            cuCla.asSubclass(ClassHierarchyTest.class);
            fail("test_4, case 026 FAILED: " + cuCla.asSubclass(ClassHierarchyTest.class));
        } catch (Exception e) {
        }
        ...
        try {
            cuCla.asSubclass(ClassHierarchyTest.class);
            fail("test_4, case 038 FAILED: " + cuCla.asSubclass(ClassHierarchyTest.class));
        } catch (Exception e) {
        }
        ...
        try {
            cuCla = (Class) new $LC003().value().getDeclaredMethod("m1").invoke(ooo, (Object[]) null);
            ...
            try {
                cuCla.asSubclass(ClassHierarchyTest.class);
                fail("test_4, case 050 FAILED: " + cuCla.asSubclass(ClassHierarchyTest.class));
            } catch (Exception e) {
            }
        ...
        try {
            cuCla.asSubclass(ClassHierarchyTest.class);
            fail("test_4, case 062 FAILED: " + cuCla.asSubclass(ClassHierarchyTest.class));
        } catch (Exception e) {
        }
        ...
        try {
            cuCla = (Class) X.class.getDeclaredMethod("m2").invoke(new X(), (Object[]) null);
            ...
            try {
                cuCla.asSubclass(ClassHierarchyTest.class);
                fail("test_4, case 074 FAILED: " + cuCla.asSubclass(ClassHierarchyTest.class));
            } catch (Exception e) {
            }
    ...
    public void test_5() {
        ...
        Class cuCla = java.lang.reflect.Proxy.newProxyInstance(java.io.Serializable.class.getClassLoader(), new Class[] { java.io.Serializable.class }, new LIH()).getClass();
        ...
        try {
            cuCla.asSubclass(ClassHierarchyTest.class);
            fail("test_5, case 011 FAILED: " + cuCla.asSubclass(ClassHierarchyTest.class));
        } catch (Exception e) {
        }
    ...
    @MA001
    @MA001.MA001_01
    @MA001.MA001_01.MA001_01_01
    @MA001.MA001_01.MA001_01_01.MA001_01_01_01
    @MA001.MA001_01.MA001_01_01.MA001_01_01_01.MA001_01_01_01_01
    @MA001.MA001_01.MA001_01_01.MA001_01_01_01.MA001_01_01_01_01.MA001_01_01_01_01_01
    @MA001.MA001_01.MA001_01_01.MA001_01_01_01.MA001_01_01_01_01.MA001_01_01_01_01_01.MA001_01_01_01_01_01_01
    @MA001.MA001_01.MA001_01_01.MA001_01_01_01.MA001_01_01_01_01.MA001_01_01_01_01_01.MA001_01_01_01_01_01_01.iiii
    public void test_8() {
    ...
    public void test_9() {
        ...
        for (int i = 0; i < aa.length; i++) {
            ...
            while (cuCla != null) {
                ...
                try {
                    cuCla.asSubclass(cuCla.getEnclosingClass() != null ? cuCla.getEnclosingClass() : cuCla);
                    if (!cuCla.getCanonicalName().equals("java.lang.ClassHierarchyTest")) fail("test_9, case 011 FAILED: " + cuCla.asSubclass(cuCla.getEnclosingClass() != null ? cuCla.getEnclosingClass() : cuCla));
                } catch (Exception e) {
                }
    ...
    public static enum ME001 {
        ...
        public static enum ME001_01_ {

            G_A_T, P_T, V_T, W_T;

            public static enum ME001_01_1 {

                G_A_T, P_T, V_T, W_T;

                public static enum ME001_01_2 {

                    G_A_T, P_T, V_T, W_T;

                    public static enum ME001_01_3 {

                        G_A_T, P_T, V_T, W_T;

                        public static enum ME001_01_4 {

                            G_A_T, P_T, V_T, W_T;

                            public static enum ME001_01_5 {
    ...
    public void test_11() {
        ...
        class Xx extends Str implements java.io.Serializable {

            static final long serialVersionUID = 0;
        }
        class Yy extends Str implements java.io.Serializable {
        ...
        try {
            fo3 = (CCCc<Xx, Yy>) o;
            fo3.getClass().cast(new CCCc<Yy, Yy>());
        } catch (Exception e) {
        ...
        try {
            ...
            Object o3 = o1.getClass().cast(o2);
            obj = o3;
            Object o4 = o2.getClass().cast(o1);
            obj = o4;
            Object o5 = o2.getClass().cast(null);
            obj = o5;
            Class cuCla1 = o1.getClass();
            Class cuCla2 = o2.getClass();
            Class cuCla3 = cuCla1.asSubclass(cuCla2);
            obj = cuCla3;
        } catch (ClassCastException e) {
        ...
        class Xx2 extends Str implements java.io.Serializable {

            static final long serialVersionUID = 0;
        }
        class Yy2 extends Str implements java.io.Serializable {
    ...
    public void test_12() {
        ...
        Annotation aaa = null;
        try {
            aaa = ClassHierarchyTest.class.getMethod("test_12").getAnnotations()[0];
        } catch (NoSuchMethodException e) {
            fail("test_1, case 022 FAILED: Internal Error");
        }
        try {
    ...
    public <T0> void test_14() {
        @i
        class LC000<T1 extends T0> {
        }
        @i
        class LC001<T1 extends LC000 & java.io.Serializable & java.lang.reflect.Type & GenericDeclaration> {
    ...
    public <T0 extends MC002> void test_15() {
        @i
        ...
        class $LC003<T2 extends ClassHierarchyTest & java.lang.reflect.ParameterizedType> {
            ...
            public Class value() {
                class A<T3 extends T2> extends $LC003 {
                }
                ;
                Object o = new LC002<T0>() {

                    class A<T5, T6, T7, T8, T9> {
                    }
        ...
        if (!cuCla.getSimpleName().equals("AAA")) fail("test_4, case 046 FAILED: " + cuCla.getSimpleName());
        try {
            cuCla = (Class) new $LC003().value().getDeclaredMethod("m1").invoke(ooo2, (Object[]) null);
