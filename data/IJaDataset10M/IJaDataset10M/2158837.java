...
class AppletFrame extends JFrame {
    ...
    private class PropertiesAction extends AbstractAction {
        ...
        private void showSetPropDialog(final JFrame frame) {
            ...
            if (Main.properties.getProperty(Main.httpProxyHost).equals(Main.properties.getProperty(Main.httpsProxyHost)) && Main.properties.getProperty(Main.httpProxyHost).equals(Main.properties.getProperty(Main.ftpProxyHost)) && Main.properties.getProperty(Main.httpProxyPort).equals(Main.properties.getProperty(Main.httpsProxyPort)) && Main.properties.getProperty(Main.httpProxyPort).equals(Main.properties.getProperty(Main.ftpProxyPort))) {
            ...
            apply.addActionListener(new ActionListener() {
                ...
                private void showErrorMessage(String portName) {
                    JOptionPane.showMessageDialog(frame, portName + " must be a positive integer value", "Invalid entry", JOptionPane.ERROR_MESSAGE);
                }
            });
    ...
    private class CloseAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            AppletFrame.this.processWindowEvent(new WindowEvent(AppletFrame.this, WindowEvent.WINDOW_CLOSING));
        }
    }
    ...
    private static class ShutdownHandler implements WindowListener {
        ...
        public void windowClosing(WindowEvent e) {
            ...
            if (applet != null) {
                ViewerAppletContext ac = (ViewerAppletContext) applet.getAppletContext();
                ac.remove(applet);
            }
            if (frameList.isEmpty()) System.exit(0);
        }
