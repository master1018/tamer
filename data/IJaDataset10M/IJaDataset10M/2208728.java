...
public class InterfaceA_EnvironmentBasedClient extends Interface_Client {
    ...
    public String checkConnection(String sessionHandle) throws IOException {
        return executeGet(_backEndURIStr, prepareParamMap("checkConnection", sessionHandle));
    }
    ...
    public String uploadSpecification(String specification, String filename, String sessionHandle) throws IOException {
        return executeUpload(_backEndURIStr + "/upload", specification, filename, sessionHandle);
    }
