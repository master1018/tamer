...
public class IslamicTest extends CalendarTest {
    ...
    public void TestRoll() {
        int[][] tests = new int[][] { { 0001, QIDAH, 2, MONTH, 1, 0001, HIJJAH, 2 }, { 0001, QIDAH, 2, MONTH, 2, 0001, MUHARRAM, 2 }, { 0001, QIDAH, 2, MONTH, -1, 0001, SHAWWAL, 2 }, { 0001, MUHARRAM, 2, MONTH, 12, 0001, MUHARRAM, 2 }, { 0001, MUHARRAM, 2, MONTH, 13, 0001, SAFAR, 2 }, { 0001, HIJJAH, 1, DATE, 30, 0001, HIJJAH, 2 }, { 0002, HIJJAH, 1, DATE, 31, 0002, HIJJAH, 2 }, { 0001, MUHARRAM, 30, MONTH, 1, 0001, SAFAR, 29 }, { 0002, HIJJAH, 30, YEAR, -1, 0001, HIJJAH, 29 } };
    ...
    public void TestCoverage() {
        ...
        }
        {
            ...
            String[] calendarLocales = { "ar_AE", "ar_BH", "ar_DZ", "ar_EG", "ar_JO", "ar_KW", "ar_OM", "ar_QA", "ar_SA", "ar_SY", "ar_YE", "ms_MY" };
