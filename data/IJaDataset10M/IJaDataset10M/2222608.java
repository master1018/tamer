...
public class RenderingAttributes extends NodeComponent {
     ...
     */
    public static final int ALLOW_ALPHA_TEST_VALUE_READ = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_ALPHA_TEST_VALUE_READ;

    /**
     * Specifies that this RenderingAttributes object
     * allows writing its alpha test value component information.
     */
    public static final int ALLOW_ALPHA_TEST_VALUE_WRITE = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_ALPHA_TEST_VALUE_WRITE;

    /**
     * Specifies that this RenderingAttributes object
     * allows reading its alpha test function component information.
     */
    public static final int ALLOW_ALPHA_TEST_FUNCTION_READ = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_ALPHA_TEST_FUNCTION_READ;

    /**
     * Specifies that this RenderingAttributes object
     * allows writing its alpha test function component information.
     */
    public static final int ALLOW_ALPHA_TEST_FUNCTION_WRITE = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_ALPHA_TEST_FUNCTION_WRITE;
     ...
     * @since Java 3D 1.4
     */
    public static final int ALLOW_DEPTH_TEST_FUNCTION_READ = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_DEPTH_TEST_FUNCTION_READ;
     ...
     * @since Java 3D 1.4
     */
    public static final int ALLOW_DEPTH_TEST_FUNCTION_WRITE = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_DEPTH_TEST_FUNCTION_WRITE;
     ...
     */
    public static final int ALLOW_DEPTH_ENABLE_READ = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_DEPTH_ENABLE_READ;
     ...
     * @since Java 3D 1.3
     */
    public static final int ALLOW_DEPTH_ENABLE_WRITE = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_DEPTH_ENABLE_WRITE;
     ...
     * @since Java 3D 1.2
     */
    public static final int ALLOW_VISIBLE_READ = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_VISIBLE_READ;
     ...
     * @since Java 3D 1.2
     */
    public static final int ALLOW_VISIBLE_WRITE = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_VISIBLE_WRITE;
     ...
     * @since Java 3D 1.2
     */
    public static final int ALLOW_IGNORE_VERTEX_COLORS_READ = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_IGNORE_VERTEX_COLORS_READ;
     ...
     * @since Java 3D 1.2
     */
    public static final int ALLOW_IGNORE_VERTEX_COLORS_WRITE = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_IGNORE_VERTEX_COLORS_WRITE;
     ...
     * @since Java 3D 1.2
     */
    public static final int ALLOW_RASTER_OP_READ = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_RASTER_OP_READ;
     ...
     * @since Java 3D 1.2
     */
    public static final int ALLOW_RASTER_OP_WRITE = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_RASTER_OP_WRITE;
     ...
     * @since Java 3D 1.4
     */
    public static final int ALLOW_STENCIL_ATTRIBUTES_READ = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_STENCIL_ATTRIBUTES_READ;
     ...
     * @since Java 3D 1.4
     */
    public static final int ALLOW_STENCIL_ATTRIBUTES_WRITE = CapabilityBits.RENDERING_ATTRIBUTES_ALLOW_STENCIL_ATTRIBUTES_WRITE;
    ...
    private static final int[] readCapabilities = { ALLOW_ALPHA_TEST_FUNCTION_READ, ALLOW_ALPHA_TEST_VALUE_READ, ALLOW_DEPTH_ENABLE_READ, ALLOW_DEPTH_TEST_FUNCTION_READ, ALLOW_IGNORE_VERTEX_COLORS_READ, ALLOW_RASTER_OP_READ, ALLOW_STENCIL_ATTRIBUTES_READ, ALLOW_VISIBLE_READ };
    ...
    public RenderingAttributes(boolean depthBufferEnable, boolean depthBufferWriteEnable, float alphaTestValue, int alphaTestFunction) {
        this(depthBufferEnable, depthBufferWriteEnable, alphaTestValue, alphaTestFunction, true, false, false, ROP_COPY);
    }
    ...
    public void setDepthBufferEnable(boolean state) {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_DEPTH_ENABLE_WRITE)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes0"));
        if (isLive()) ((RenderingAttributesRetained) this.retained).setDepthBufferEnable(state); else ((RenderingAttributesRetained) this.retained).initDepthBufferEnable(state);
    }
    ...
    public boolean getDepthBufferEnable() {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_DEPTH_ENABLE_READ)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes1"));
    ...
    public void setDepthBufferWriteEnable(boolean state) {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_DEPTH_ENABLE_WRITE)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes2"));
        if (isLive()) ((RenderingAttributesRetained) this.retained).setDepthBufferWriteEnable(state); else ((RenderingAttributesRetained) this.retained).initDepthBufferWriteEnable(state);
    }
    ...
    public boolean getDepthBufferWriteEnable() {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_DEPTH_ENABLE_READ)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes3"));
    ...
    public void setAlphaTestValue(float value) {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_ALPHA_TEST_VALUE_WRITE)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes4"));
        if (isLive()) ((RenderingAttributesRetained) this.retained).setAlphaTestValue(value); else ((RenderingAttributesRetained) this.retained).initAlphaTestValue(value);
    }
    ...
    public float getAlphaTestValue() {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_ALPHA_TEST_VALUE_READ)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes5"));
    ...
    public void setAlphaTestFunction(int function) {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_ALPHA_TEST_FUNCTION_WRITE)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes6"));
        if (isLive()) ((RenderingAttributesRetained) this.retained).setAlphaTestFunction(function); else ((RenderingAttributesRetained) this.retained).initAlphaTestFunction(function);
    }
    ...
    public int getAlphaTestFunction() {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_ALPHA_TEST_FUNCTION_READ)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes7"));
    ...
    public void setVisible(boolean visible) {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_VISIBLE_WRITE)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes8"));
        if (isLive()) ((RenderingAttributesRetained) this.retained).setVisible(visible); else ((RenderingAttributesRetained) this.retained).initVisible(visible);
    }
    ...
    public boolean getVisible() {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_VISIBLE_READ)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes9"));
    ...
    public void setIgnoreVertexColors(boolean ignoreVertexColors) {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_IGNORE_VERTEX_COLORS_WRITE)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes12"));
        if (isLive()) ((RenderingAttributesRetained) this.retained).setIgnoreVertexColors(ignoreVertexColors); else ((RenderingAttributesRetained) this.retained).initIgnoreVertexColors(ignoreVertexColors);
    }
    ...
    public boolean getIgnoreVertexColors() {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_IGNORE_VERTEX_COLORS_READ)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes13"));
    ...
    public void setRasterOpEnable(boolean rasterOpEnable) {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_RASTER_OP_WRITE)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes10"));
        if (isLive()) ((RenderingAttributesRetained) this.retained).setRasterOpEnable(rasterOpEnable); else ((RenderingAttributesRetained) this.retained).initRasterOpEnable(rasterOpEnable);
    }
    ...
    public boolean getRasterOpEnable() {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_RASTER_OP_READ)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes11"));
    ...
    public void setRasterOp(int rasterOp) {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_RASTER_OP_WRITE)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes10"));
        if (isLive()) ((RenderingAttributesRetained) this.retained).setRasterOp(rasterOp); else ((RenderingAttributesRetained) this.retained).initRasterOp(rasterOp);
    }
    ...
    void duplicateAttributes(NodeComponent originalNodeComponent, boolean forceDuplicate) {
        ...
        RenderingAttributesRetained rt = (RenderingAttributesRetained) retained;
    ...
    public void setDepthTestFunction(int function) {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_DEPTH_TEST_FUNCTION_WRITE)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes14"));
        if (isLive()) ((RenderingAttributesRetained) this.retained).setDepthTestFunction(function); else ((RenderingAttributesRetained) this.retained).initDepthTestFunction(function);
    }
    ...
    public int getDepthTestFunction() {
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_DEPTH_TEST_FUNCTION_READ)) throw new CapabilityNotSetException(Ding3dI18N.getString("RenderingAttributes15"));
    ...
    public void setStencilEnable(boolean state) {
        ...
        if (isLive()) ((RenderingAttributesRetained) this.retained).setStencilEnable(state); else ((RenderingAttributesRetained) this.retained).initStencilEnable(state);
    }
    ...
    public void setStencilOp(int failOp, int zFailOp, int zPassOp) {
        ...
        if (isLive()) ((RenderingAttributesRetained) this.retained).setStencilOp(failOp, zFailOp, zPassOp); else ((RenderingAttributesRetained) this.retained).initStencilOp(failOp, zFailOp, zPassOp);
    }
    ...
    public void setStencilOp(int[] stencilOps) {
        ...
        if (isLive()) ((RenderingAttributesRetained) this.retained).setStencilOp(stencilOps[0], stencilOps[1], stencilOps[2]); else ((RenderingAttributesRetained) this.retained).initStencilOp(stencilOps[0], stencilOps[1], stencilOps[2]);
    }
    ...
    public void setStencilFunction(int function, int refValue, int compareMask) {
        ...
        if (isLive()) ((RenderingAttributesRetained) this.retained).setStencilFunction(function, refValue, compareMask); else ((RenderingAttributesRetained) this.retained).initStencilFunction(function, refValue, compareMask);
    }
    ...
    public void setStencilFunction(int[] params) {
        ...
        if (isLive()) ((RenderingAttributesRetained) this.retained).setStencilFunction(params[0], params[1], params[2]); else ((RenderingAttributesRetained) this.retained).initStencilFunction(params[0], params[1], params[2]);
    }
    ...
    public void setStencilWriteMask(int mask) {
        ...
        if (isLive()) ((RenderingAttributesRetained) this.retained).setStencilWriteMask(mask); else ((RenderingAttributesRetained) this.retained).initStencilWriteMask(mask);
    }
