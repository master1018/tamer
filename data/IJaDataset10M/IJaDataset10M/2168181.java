...
public final class ArrayUtils {
    ...
    public static <T> boolean contains(T[] array, T value) {
        ...
        for (int i = 0; i < array.length; i++) if (value == array[i]) return true;
        return false;
    }
    ...
    public static <T> int indexOf(T[] array, T value, int index) {
        if (index < 0 || array.length <= index) return INDEX_NOT_FOUND;
        for (int i = index; i < array.length; i++) if (value == array[i]) return i;
    ...
    public static <T> T[] remove(T[] array, T value) {
        ...
        if (index == INDEX_NOT_FOUND) return array;
    ...
    public static int[] toArray(Collection<Integer> collection) {
        ...
        int i = 0;
        for (Integer t : collection) ar[i++] = t;
        return ar;
    }
    ...
    public static int[] createAscendingArray(int min, int max) {
        ...
        int x = 0;
        for (int i = min; i <= max; i++, x++) array[x] = i;
        return array;
    }
}
