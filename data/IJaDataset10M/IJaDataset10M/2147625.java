...
public class TransferableUtilsTest {
    ...
    public void testResolveDtoToEntityBeforeExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityBeforeExact"), TestServiceImpl.class);
    ...
    public void testResolveDtoToEntityBefore() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityBefore"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityByFilterBeforeExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityByFilterBeforeExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityByFilterBefore() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityByFilterBefore"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveDtosToEntitiesBeforeExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtosToEntitiesBeforeExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveDtosToEntitiesBefore() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtosToEntitiesBefore"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveDtosToEntitiesByFilterBeforeExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtosToEntitiesByFilterBeforeExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveDtosToEntitiesByFilterBefore() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtosToEntitiesByFilterBefore"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityKeyAfterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityKeyAfterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
    ...
    public void testResolveDtoToEntityKeyAfter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityKeyAfter"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityKeyByFilterAfterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityKeyByFilterAfterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityKeyByFilterAfter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityKeyByFilterAfter"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityAfterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityAfterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityAfter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityAfter"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityByFilterAfterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityByFilterAfterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityByFilterAfter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityByFilterAfter"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveDtosToEntitiesByFilterAfterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtosToEntitiesByFilterAfterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveDtosToEntitiesByFilterAfter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtosToEntitiesByFilterAfter"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveDtosToEntitiesAfterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtosToEntitiesAfterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveDtosToEntitiesAfter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtosToEntitiesAfter"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoBeforeExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoBeforeExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoBefore() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoBefore"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoByFilterBeforeExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoByFilterBeforeExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoByFilterBefore() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoByFilterBefore"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntitiesToDtosByFilterBefore() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entitiesToDtosByFilterBefore"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntitiesToDtosByFilterBeforeExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entitiesToDtosByFilterBeforeExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntitiesToDtosBeforeExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entitiesToDtosBeforeExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntitiesToDtosBefore() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entitiesToDtosBefore"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoKeyAfterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoKeyAfterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoKeyAfter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoKeyAfter"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoKeyByFilterAfterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoKeyByFilterAfterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoKeyByFilterAfter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoKeyByFilterAfter"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoAfterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoAfterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoAfter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoAfter"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoByFilterAfterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoByFilterAfterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoByFilterAfter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoByFilterAfter"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveEntitiesToDtosByFilterAfterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entitiesToDtosByFilterAfterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveEntitiesToDtosByFilterAfter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entitiesToDtosByFilterAfter"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveEntitiesToDtosAfterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entitiesToDtosAfterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveEntitiesToDtosAfter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entitiesToDtosAfter"), TestServiceImpl.class);
        assertEquals(map.size(), 1);
        final AdviceConfig after = map.get(Occurrence.AFTER_METHOD_INVOCATION);
        assertEquals(after.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(after.getOccurrence(), Occurrence.AFTER_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityAndBackToDtoExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityAndBackToDtoExact"), TestServiceImpl.class);
    ...
    public void testResolveDtoToEntityAndBackToDto() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityAndBackToDto"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityAndBackToDtoByFilterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityAndBackToDtoByFilterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityAndBackToDtoByFilter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityAndBackToDtoByFilter"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityAndBackToDtoVoidExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityAndBackToDtoVoidExact"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityAndBackToDtoVoid() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityAndBackToDtoVoid"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityAndBackToDtoVoidByFilterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityAndBackToDtoVoidByFilterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveDtoToEntityAndBackToDtoVoidByFilter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "dtoToEntityAndBackToDtoVoidByFilter"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.DTO_TO_ENTITY);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoAndBackToEntityExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoAndBackToEntityExact"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoAndBackToEntity() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoAndBackToEntity"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoAndBackToEntityByFilterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoAndBackToEntityByFilterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoAndBackToEntityByFilter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoAndBackToEntityByFilter"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoAndBackToEntityVoidExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoAndBackToEntityVoidExact"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoAndBackToEntityVoid() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoAndBackToEntityVoid"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoAndBackToEntityVoidByFilterExact() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoAndBackToEntityVoidByFilterExact"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
    ...
    public void testResolveEntityToDtoAndBackToEntityVoidByFilter() throws Exception {
        final Map<Occurrence, AdviceConfig> map = TransferableUtils.resolveConfiguration(getMethod(TestServiceImpl.class, "entityToDtoAndBackToEntityVoidByFilter"), TestServiceImpl.class);
        assertEquals(map.size(), 2);
        final AdviceConfig before = map.get(Occurrence.BEFORE_METHOD_INVOCATION);
        assertEquals(before.getDirection(), Direction.ENTITY_TO_DTO);
        assertEquals(before.getOccurrence(), Occurrence.BEFORE_METHOD_INVOCATION);
