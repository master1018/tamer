...
public final class RelationshipTransformProvider extends Provider {
    ...
    public RelationshipTransformProvider() {
        ...
        map.put("TransformService." + RelationshipTransformProvider.RelationShipTransformAlgorithm, "org.openxml4j.signaturehelpers.RelationshipTransformService");
        map.put("TransformService." + RelationshipTransformProvider.RelationShipTransformAlgorithm + " MechanismType", "DOM");
