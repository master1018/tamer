...
public abstract class AbstractSVGTransform implements SVGTransform {
    ...
    public void setMatrix(SVGMatrix matrix) {
        ...
        affineTransform = new AffineTransform(matrix.getA(), matrix.getB(), matrix.getC(), matrix.getD(), matrix.getE(), matrix.getF());
    }
    ...
    public void setSkewX(float angle) {
        ...
        affineTransform = new AffineTransform(1.0, Math.tan(Math.toRadians(angle)), 0.0, 1.0, 0.0, 0.0);
        this.angle = angle;
    }
    ...
    public void setSkewY(float angle) {
        ...
        this.angle = angle;
        affineTransform = new AffineTransform(1.0, 0.0, Math.tan(Math.toRadians(angle)), 1.0, 0.0, 0.0);
    }
}
