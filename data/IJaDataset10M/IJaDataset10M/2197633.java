...
public abstract class NonModalDialog extends JDialog implements ActionListener {
    ...
    protected static Logger log = Logger.getLogger(NonModalDialog.class.getPackage().getName());

    public NonModalDialog(String key, DialogOwner owner, JFrame window, String title, String message) {
    ...
    protected GridBagConstraints constraints(int gridx, int gridy, int leftinset, int topinset, int rightinset, int bottominset) {
