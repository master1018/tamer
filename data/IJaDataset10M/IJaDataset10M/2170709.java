...
public class ComponentArrayPanel extends JPanel {
    ...
    private void createComponentTable() throws InterruptedException {
        ...
        for (int componentIndex = 0; componentIndex < componentList.size(); componentIndex++) {
            ...
            if (Thread.currentThread().isInterrupted()) throw new InterruptedException("createComponentTable() was interrupted.");
        }
    ...
    private class ComponentController {
        ...
        public void configureControls() {
            ...
            if (componentIndex == 0) componentPosition = FIRST_EVENT_POSITION;
            if (componentIndex == (componentList.size() - 1)) componentPosition = LAST_EVENT_POSITION;
            if ((componentIndex == 0) && (componentIndex == (componentList.size() - 1))) componentPosition = FIRST_AND_LAST_EVENT_POSITION;
            if (null != upButton) {
