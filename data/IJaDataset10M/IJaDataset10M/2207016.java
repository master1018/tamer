...
public class SequenceRulesPerfTest {
   ...
   */
    ...
    public Object[][] perfData() {
        return new Object[][] { new Object[] { new Rule[] { new AlphabeticalSequenceRule(), new NumericalSequenceRule(), new QwertySequenceRule() }, 5000 } };
    }
   ...
   */
    @Test(groups = { "seqperftest" }, dataProvider = "perf-data", timeOut = 60000)
    public void execute(final Rule[] rules, final int iterations) {
        ...
        System.out.println(String.format("%s:: execution completed in %s ms", getClass().getName(), System.currentTimeMillis() - t));
    }
}
