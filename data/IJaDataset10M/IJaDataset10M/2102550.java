...
public final class dns {
    ...
    public static void init(String defaultResolver) {
        Resolver.setDefaultResolver(defaultResolver);
    }

    public static Record[] getRecords(Resolver res, String name, short type, short dclass) {
        ...
        if (response.getHeader().getRcode() != Rcode.NOERROR) return null;
    ...
    public static Record[] getRecords(Resolver res, String name, short type) {
        return getRecords(res, name, type, DClass.IN);
    }

    public static Record[] getRecords(String name, short type, short dclass) {
    ...
    public static Record[] getRecordsByAddress(Resolver res, String addr, short type) {
        byte[] address;
        try {
