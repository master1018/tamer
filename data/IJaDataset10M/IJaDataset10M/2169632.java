...
public class WeblogEntryFormEx extends WeblogEntryForm {
    ...
    private static Log mLogger = LogFactory.getFactory().getInstance(WeblogEntryFormEx.class);
    ...
    public WeblogEntryFormEx(WeblogEntryData entryData, java.util.Locale locale) throws RollerException {
    ...
    public void initNew(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (rreq.getWebsite().getDefaultPlugins() != null) {
            setPluginsArray(StringUtils.split(rreq.getWebsite().getDefaultPlugins(), ","));
        }
     ...
     */
    public void copyTo(WeblogEntryData entry, Locale locale, Map paramMap) throws RollerException {
     ...
     */
    public void copyFrom(WeblogEntryData entry, Locale locale) throws RollerException {
    ...
    public void doReset(org.apache.struts.action.ActionMapping mapping, javax.servlet.ServletRequest request) {
