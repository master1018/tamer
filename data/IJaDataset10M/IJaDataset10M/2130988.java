 ...
 */
    ...
    protected JDialog createEditor() {
        return new FormulaWin(sectionWidget.designer, getField().getReport(), ((FormulaField) getField()).getFormula());
    }

    protected void updateEditor() {
        ((FormulaWin) editor).update(null, null);
    }
    ...
    public void setWidgetName(String newName) {
        if (newName.length() == 0) newName = I18N.get("FieldPickerWin.unnamed_formula");
