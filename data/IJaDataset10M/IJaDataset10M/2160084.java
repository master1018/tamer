...
public class FactorialDeUnNumero {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El factorial del n�mero " + Integer.toString(iNumero) + " es " + Integer.toString(iFactorial));
        ;
        System.out.println("El factorial del n�mero " + Integer.toString(iNumero) + " es " + Integer.toString(factorial(iNumero)));
    }
}
