...
public class SystemConsoleConfigPanel extends JPanel {
    ...
    private static final Integer fontSizes[] = { 8, 9, 10, 11, 12, 13, 14, 16, 18, 20, 24 };

    private static final Integer wrapStyles[] = { SystemConsole.WRAP_STYLE_NONE, SystemConsole.WRAP_STYLE_LINE, SystemConsole.WRAP_STYLE_WORD };

    private static final String wrapStyleNames[] = { rbc.getString("ConsoleWrapStyleNone"), rbc.getString("ConsoleWrapStyleLine"), rbc.getString("ConsoleWrapStyleWord") };
    ...
    private static void doFontStyle() {
        SystemConsole.getInstance().setFontStyle((fontStyleBold.isSelected() ? Font.BOLD : Font.PLAIN) | (fontStyleItalic.isSelected() ? Font.ITALIC : Font.PLAIN));
        scheme.repaint();
    }
}
