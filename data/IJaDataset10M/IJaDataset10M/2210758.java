...
public class CoordinationFileTrackingCountResource extends ServerResource {
    ...
    public CoordinationFileTrackingCountResource(CollectorFileTrackerMemory fileTrackerMemory) {
    ...
    public long getFileTrackingStatusCount() {
        ...
        return (query == null) ? fileTrackerMemory.getFileCount() : fileTrackerMemory.getFileCountByQuery(query);
    }
}
