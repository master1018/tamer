...
public class XMLScanner extends RuleBasedScanner {
    ...
    public XMLScanner(ColorManager manager) {
        IToken procInstr = new Token(new TextAttribute(manager.getColor(IColorConstants.PROC_INSTR)));
        IToken docType = new Token(new TextAttribute(manager.getColor(IColorConstants.DOCTYPE)));
