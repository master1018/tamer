...
/**
 * Adapter for server implementation of DispHTMLFormElement
 */
public class DispHTMLFormElementServer extends IDispatchServer implements DispHTMLFormElement {

    public DispHTMLFormElementServer(CoClassMetaInfo classImpl) {
        super(classImpl);
        registerMethods(DispHTMLFormElement.class);
    }
    ...
    public void setAction(BStr param1) {
    }

    public BStr getAction() {
        throw new ComException(HResult.E_NOTIMPL);
    }

    public void setEncoding(BStr param1) {
    }

    public BStr getEncoding() {
        throw new ComException(HResult.E_NOTIMPL);
    }

    public void setMethod(BStr param1) {
    }

    public BStr getMethod() {
        throw new ComException(HResult.E_NOTIMPL);
    }

    public IDispatch getElements() {
        throw new ComException(HResult.E_NOTIMPL);
    }
    ...
    public void setOnsubmit(Variant param1) {
    }

    public Variant getOnsubmit() {
        throw new ComException(HResult.E_NOTIMPL);
    }

    public void setOnreset(Variant param1) {
    }

    public Variant getOnreset() {
        throw new ComException(HResult.E_NOTIMPL);
    }
    ...
    public void invokeSetLength(Int32 param1) {
    }
    ...
    public void setAcceptCharset(BStr param1) {
    }

    public BStr getAcceptCharset() {
        throw new ComException(HResult.E_NOTIMPL);
    }
    ...
    public IDispatch namedItem(BStr name) {
        throw new ComException(HResult.E_NOTIMPL);
    }

    public void appendNameValuePair(BStr name, BStr value) {
    }

    public void appendNameFilePair(BStr name, BStr filename) {
    }
