...
public class CrrSection11B extends CrrSection {
    ...
    void defineIO() {
        ...
        inputs = new NamedBean[] { tu[13], tu[14], tu[15], tu[16], bo[1], bo[16], bo[17], bo[18], bo[19], si[9], si[12], si[24], si[61] };
    }
    ...
    void setOutput() {
        ...
        int value = GREEN;
        if (bo1 || !tu16) value = RED; else if (!tu14 && bo16) value = RED; else if (tu14 && !tu15 && bo18) value = RED; else if (tu14 && tu15 && bo19) value = RED;
        if (value == GREEN && !tu14 && si9) value = YELLOW; else if (value == GREEN && tu14 && !tu15 && si12) value = YELLOW; else if (value == GREEN && tu14 && tu15 && si132) value = YELLOW;
