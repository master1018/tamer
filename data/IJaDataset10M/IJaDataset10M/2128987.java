...
public class JUnitServletTest extends TestCase {
    ...
    public void testSomeFailuresXMLFormat() throws Exception {
        ...
        verifyElementWithNameHasFailureNode("testAddition", nl, "failure", true);
        verifyElementWithNameHasFailureNode("testSubtraction", nl, "failure", true);
        verifyElementWithNameHasFailureNode("testMultiplication", nl, "failure", false);
    }
    ...
    public void testSomeErrorsXMLFormat() throws Exception {
        ...
        NodeList nl = element.getElementsByTagName("testcase");
        verifyElementWithNameHasFailureNode("testAddition", nl, "error", true);
        verifyElementWithNameHasFailureNode("testMultiplication", nl, "error", false);
    }
