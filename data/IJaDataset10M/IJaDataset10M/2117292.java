...
public class FragmentsView {
    ...
    private static final double PIXEL_PER_SCALE = (double) (MAX_WIDTH_COLUMN - MIN_WIDTH_COLUMN) / MAX_SCALE_FOR_MULTICOL;
    ...
    public void setScale(int scale) {
        this.scale = scale;
        if (this.scale <= MAX_SCALE_FOR_MULTICOL) this.viewType = TYPE_MULTICOLUMN; else if (this.scale >= MIN_SCALE_FOR_DETAIL) this.viewType = TYPE_DETAIL; else this.viewType = TYPE_TREE;
    ...
    public int getPageSize() {
        if (this.viewType.equals(TYPE_MULTICOLUMN)) return this.compactColumn ? 200 : 100; else if (this.viewType.equals(TYPE_TREE)) return 50; else return 10;
    }
