...
public class NodeFactoryTest extends XOMTestCase {
    ...
    public void testSkippingComment() throws IOException, ParsingException {
        ...
        assertEquals("Skipped comment interrupted text node", 2, root.getChildCount());
    ...
    public void testCantAddOneElementMultipleTimes() throws IOException, ParsingException {
    ...
    public void testCantAddOneAttributeMultipleTimes() throws IOException, ParsingException {
    ...
    public void testChangingElementName() throws IOException, ParsingException {
    ...
    public void testSkippingProcessingInstruction() throws IOException, ParsingException {
        String data = "<a>1<?test some data?>8</a>";
        Builder builder = new Builder(new ProcessingInstructionFilter());
        Document doc = builder.build(data, "http://www.example.org/");
        Element root = doc.getRootElement();
        assertEquals("Skipped processing instruction interrupted text node", 2, root.getChildCount());
        assertEquals("18", doc.getValue());
        Node first = root.getChild(0);
        assertEquals(first.getValue(), "1");
        Node second = root.getChild(1);
    ...
    public void testMinimalizedDocument() throws IOException, ParsingException {
    ...
    public void testValidateWithFactory() throws ParsingException, IOException {
        Builder validator = new Builder(true, new MinimizingFactory());
        Document doc = validator.build("<!-- a comment --><!DOCTYPE root [" + "<!ELEMENT root EMPTY>" + "]>" + "<root/><?a processing instruction?>", "http://www.example.org/");
        assertEquals(1, doc.getChildCount());
    }
    ...
    public void testCDATASectionsCanBeOverridden() throws ValidityException, ParsingException, IOException {
    ...
    public void testNullRootNotAllowed() throws IOException, ParsingException {
        File input = new File(data, "entitytest.xml");
    ...
    public void testNullDocumentNotAllowed() throws IOException, ParsingException {
        File input = new File(data, "entitytest.xml");
    ...
    public void testDontReportCommentsAndProcessingInstructionsInExternalDTDSubset() throws IOException, ParsingException {
    ...
    public void testDontCoalesceTextNodes() throws IOException, ParsingException {
    ...
    public void testTriple() throws IOException, ParsingException {
    ...
    public void testUncomment() throws ParsingException, IOException {
    ...
    public void testCantAddDocument() throws ParsingException, IOException {
    ...
    public void testCantAddTwoDoctypes() throws ParsingException, IOException {
    ...
    public void testChangeAttributesToElements() throws ParsingException, IOException {
    ...
    public void testInsertElementsInInternalDTDSubsetViaProcessingInstruction() throws ParsingException, IOException {
    ...
    public void testInsertElementsInInternalDTDSubsetViaComment() throws ParsingException, IOException {
    ...
    public void testChangeElementsToAttributes() throws ParsingException, IOException {
    ...
    public void testChangeDefaultNamespaceFromEnd() throws ParsingException, IOException {
    ...
    public void testChangePrefixedNamespaceFromEnd() throws ParsingException, IOException {
    ...
    public void testChangeDefaultNamespaceFromBeginning() throws ParsingException, IOException {
        String data = "<a><b xmlns='http://www.a.com'/></a>";
        Builder builder = new Builder(new NodeFactory() {
    ...
    public void testChangePrefixedNamespaceFromBeginning() throws ParsingException, IOException {
        String data = "<a><pre:b xmlns:pre='http://www.a.com'/></a>";
        Builder builder = new Builder(new NodeFactory() {
    ...
    public void testChangeTextToAttributes() throws ParsingException, IOException {
        String data = "<a><b>data1</b><c>text</c></a>";
        Builder builder = new Builder(new NodeFactory() {
    ...
    public void testChangeRootElementsToAttribute() throws ParsingException, IOException {
        String data = "<a><b>data1</b><c>text</c></a>";
        Builder builder = new Builder(new NodeFactory() {
    ...
    public void testCantBypassMultipleParentChecks() throws ParsingException, IOException {
    ...
    public void testCantBypassMultipleParentChecksFromFinishMakingElement() throws ParsingException, IOException {
        String doc = "<root><a/><a/></root>";
        Builder builder = new Builder(new NodeFactory() {
            ...
            public Nodes finishMakingElement(Element element) {
                if (element.getLocalName().equals("a")) return new Nodes(a); else return new Nodes(element);
            }
        });
        try {
            builder.build(doc, "http://www.example.org/");
    ...
    public void testFinishMakingElementIsCalledForRootElement() throws ParsingException, IOException {
        String doc = "<root/>";
        Builder builder = new Builder(new NodeFactory() {
    ...
    public void testCanReplaceRootElementFromFinishMakingElement() throws ParsingException, IOException {
        String data = "<root/>";
        Builder builder = new Builder(new NodeFactory() {
    ...
    public void testCanAddAroundExistingRootElementFromFinishMakingElement() throws ParsingException, IOException {
        String data = "<root/>";
        Builder builder = new Builder(new NodeFactory() {
    ...
    public void testCantReplaceRootElementWithNoElement() throws ParsingException, IOException {
        String data = "<root/>";
        Builder builder = new Builder(new NodeFactory() {
    ...
    public void testCantReplaceRootElementWithNothing() throws ParsingException, IOException {
        String data = "<root/>";
        Builder builder = new Builder(new NodeFactory() {
    ...
    public void testReplaceCommentWithAttribute() throws ParsingException, IOException {
    ...
    public void testReplaceProcessingInstructionWithAttribute() throws ParsingException, IOException {
    ...
    public void testReplaceProcessingInstructionWithText() throws ParsingException, IOException {
        String data = "<root><?target data?></root>";
        Builder builder = new Builder(new NodeFactory() {
    ...
    public void testCantReplaceRootElementWithTwoElements() throws ParsingException, IOException {
        String data = "<root/>";
        Builder builder = new Builder(new NodeFactory() {
    ...
    public void testOrderOfCalls() throws ParsingException, IOException {
    ...
    public void testOrderOfCallsWithPI() throws ParsingException, IOException {
    ...
    public void testFinishMakingElementDetachesItsArgument() throws ParsingException, IOException {
