...
public class CloneableConverterTest {
    ...
    public void testIdentity() throws Exception {
        ...
        cloneableBean.setMyDates(new ArrayList<Date>(Arrays.asList(new Date(0), new Date(1))));
        cloneableBean.setMyString("Hello world");
        CloneableBean clone = converter.convert(cloneableBean, CloneableBean.class);
