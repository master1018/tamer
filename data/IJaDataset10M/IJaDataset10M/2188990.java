...
public class ModelMenuItem {
    ...
    public void setHideIfSelected(String val) {
        if (UtilValidate.isNotEmpty(val)) if (val.equalsIgnoreCase("true")) hideIfSelected = Boolean.TRUE; else hideIfSelected = Boolean.FALSE; else hideIfSelected = null;
    }
    ...
    public void mergeOverrideModelMenuItem(ModelMenuItem overrideModelMenuItem) {
        if (overrideModelMenuItem == null) return;
    }
    ...
    public void dump(StringBuffer buffer) {
        buffer.append("ModelMenuItem:" + "\n     title=").append(this.title).append("\n     name=").append(this.name).append("\n     entityName=").append(this.entityName).append("\n     titleStyle=").append(this.titleStyle).append("\n     widgetStyle=").append(this.widgetStyle).append("\n     tooltipStyle=").append(this.tooltipStyle).append("\n     selectedStyle=").append(this.selectedStyle).append("\n\n");
    }
    ...
    public static class Link {
        ...
        public void setUrlMode(String val) {
            if (UtilValidate.isNotEmpty(val)) this.urlMode = val;
        }
        ...
        public void setFullPath(String val) {
            ...
            if (sFullPath != null && sFullPath.equalsIgnoreCase("true")) this.fullPath = true; else this.fullPath = false;
        }

        public void setSecure(String val) {
            String sSecure = val;
            if (sSecure != null && sSecure.equalsIgnoreCase("true")) this.secure = true; else this.secure = false;
        }

        public void setEncode(String val) {
            String sEncode = val;
            if (sEncode != null && sEncode.equalsIgnoreCase("true")) this.encode = true; else this.encode = false;
        }
    ...
    public static class Image {
        ...
        public void setUrlMode(String val) {
            if (UtilValidate.isEmpty(val)) this.urlMode = "content"; else this.urlMode = val;
        }
    }
}
