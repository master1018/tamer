...
public class GribSummary {
            ...
            if (N > 0) {
                if (N > 1) {
                    if (mMinDelta == mMaxDelta) {
                        ...
                        str += " delta[" + ms2str(mMinDelta) + " - " + ms2str(mMaxDelta) + "]";
                    }
                }
                return str + ":\n       min " + mDmin + "\n       max " + mDmax;
            }
    ...
    private static class FldIter {
       ...
       */
        public FldIter(GribRecordLight[] lights) {
            mLights = lights;
            mFldCmp = new GribFldComparator(new int[] { GribRecHeader.F_GDS, GribRecHeader.F_LEV_TYP, GribRecHeader.F_PAR, GribRecHeader.F_DATE, GribRecHeader.F_LEV_Z });
    ...
    */
    private static void printGDS(GribRecordLight light) {
        ...
        System.out.println("    PDS cent sub tab proc: " + cenId + " " + subId + " " + tabId + " " + proId);
        System.out.println("     -> cent sub tab file: " + cen2 + " " + sub2 + " " + tab2 + " " + filn2);
    }
