package fr.inria.uml4tst.papyrus.ocl4tst.ocl.resource.ocl;
 ...
 * resolver
 */
public interface IOclReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends fr.inria.uml4tst.papyrus.ocl4tst.ocl.resource.ocl.IOclConfigurable {
	 ...
	 * operation.
	 */
    public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, fr.inria.uml4tst.papyrus.ocl4tst.ocl.resource.ocl.IOclReferenceResolveResult<ReferenceType> result);
