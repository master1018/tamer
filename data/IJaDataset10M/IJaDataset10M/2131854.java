   ...
   */
    ...
    public void extractDataFromSource(Object source) throws PersistenceException {
        if (!(source instanceof DirectoryCorpus)) {
            throw new UnsupportedOperationException(getClass().getName() + " can only be used for " + DirectoryCorpus.class.getName() + " objects!\n" + source.getClass().getName() + " is not a " + DirectoryCorpus.class.getName());
        }
