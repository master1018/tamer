...
public class StatusDetail {
    ...
    public static StatusDetail getInstance(Node root) throws ParsingException {
        if (!root.getNodeName().equals("StatusDetail")) throw new ParsingException("not a StatusDetail node");
    ...
    public String getEncoded() throws IllegalStateException {
        if (detailText == null) throw new IllegalStateException("no encoded form available");
        return detailText;
    }
}
