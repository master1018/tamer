 ...
 */
public class CreativeCommonsRDFStreamDisseminationCrosswalk implements StreamDisseminationCrosswalk {
    ...
    public boolean canDisseminate(Context context, DSpaceObject dso) {
        try {
            return dso.getType() == Constants.ITEM && CreativeCommons.getLicenseRdfBitstream((Item) dso) != null;
        } catch (Exception e) {
