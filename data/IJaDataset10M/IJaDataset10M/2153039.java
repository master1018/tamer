...
public class TestConfigurationServicePersistency extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        confFile = new File(System.getProperty("user.home") + File.separator + confDirName + File.separator + ourConfFileName);
        configurationService.purgeStoredConfiguration();
        originalConfFileName = System.getProperty("net.java.sip.communicator.CONFIGURATION_FILE_NAME");
    ...
    protected void tearDown() throws Exception {
        confFile.delete();
        configurationService.purgeStoredConfiguration();
        System.setProperty("net.java.sip.communicator.CONFIGURATION_FILE_NAME", originalConfFileName);
        super.tearDown();
    }
