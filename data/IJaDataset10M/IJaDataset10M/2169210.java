package edu.unibi.agbi.biodwh.entity.kegg.medicus.disease;

import javax.persistence.Column;
import javax.persistence.Embeddable;

/**
 * KeggDiseasePathwayId generated by hbm2java
 */
@Embeddable
public class KeggDiseasePathwayId implements java.io.Serializable {

    private static final long serialVersionUID = -8073070753517765694L;
    ...
    public KeggDiseasePathwayId() {
    }

    public KeggDiseasePathwayId(String entry, String org, String number) {
        this.entry = entry;
        this.org = org;
        this.number = number;
    }

    @Column(name = "entry", nullable = false, length = 6)
    ...
    @Column(name = "org", nullable = false, length = 4)
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof KeggDiseasePathwayId)) return false;
        KeggDiseasePathwayId castOther = (KeggDiseasePathwayId) other;
