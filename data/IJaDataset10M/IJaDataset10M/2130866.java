...
public class DbmsServerByChannel {
    ...
    private static class Handler implements Runnable {
        ...
        public void run() {
            ...
            while (getRequest()) executeRequest();
            close();
        }
        ...
        private void executeRequest() {
            ...
            try {
                ...
                if (!(e instanceof SuException)) e.printStackTrace();
                output = stringToBuffer("ERR " + escape(e.toString()) + "\r\n");
            }
            cmd = null;
            line = null;
            extra = null;
            if (output != null) outputQueue.add(output);
            outputQueue.write();
        }
        ...
        private static Command getCmd(ByteBuffer buf) {
            try {
                ...
                if (word.isEmpty()) return Command.NILCMD;
