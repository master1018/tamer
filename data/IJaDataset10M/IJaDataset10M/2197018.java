...
public abstract class Odt2BrailleTest {
    ...
    protected static boolean comparePEFs(File correctPEF, File testPEF) throws Exception {
        Diff myDiff = new Diff(new FileReader(correctPEF), new FileReader(testPEF));
    ...
    protected static ConversionResult convertODT2PEF(ODT odt, Configuration configuration, PEFConfiguration pefConfiguration) throws Exception {
