   ...
   */
    ...
    */
    public java.sql.Timestamp getEndDate() throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = mInternal.getProperty(ii_EndDate, jj_EndDate, com.intersys.objects.Database.RET_PRIM, "EndDate");
    ...
    */
    public com.intersys.classes.RelationshipObject getReports() throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = mInternal.getProperty(ii_Reports, jj_Reports, com.intersys.objects.Database.RET_OBJECT, "Reports");
        com.intersys.cache.CacheObject cobj = dh.getCacheObject();
        if (cobj == null) return null;
        return (com.intersys.classes.RelationshipObject) (cobj.newJavaInstance());
    }
    ...
    */
    public java.sql.Timestamp getStartDate() throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = mInternal.getProperty(ii_StartDate, jj_StartDate, com.intersys.objects.Database.RET_PRIM, "StartDate");
        return dh.getTimestamp();
    }
...
<LINK href=DocBook.UI.Page.cls?KEY=GOBJ_populate>The Cach&eacute; Populate Utility</LINK>.</p>
    ...
    */
    ...
    public static Object addToBatchInsert(Object batch, java.sql.Connection con, java.sql.Timestamp cos_EndDate, java.sql.Timestamp cos_StartDate) throws java.sql.SQLException {
        ...
        com.intersys.jdbc.SysListProxy.setInteger(qbatch.list, 3);
