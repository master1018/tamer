...
import org.geoforge.guillc.popupmenu.PmuCtlCtrFolderTopMainSelAbs;
 ...
 * @author bantchao
 */
public class PmuCtlCtrFolderTopMainSelDskS2ds extends PmuCtlCtrFolderTopMainSelAbs {

    private MimTrsAbs _mimNewEmpty_ = null;

    public PmuCtlCtrFolderTopMainSelDskS2ds(ActionListener alrController, TreAbs tree, ActionListener alrParentNode, ActionListener alrParentPanelMvc) throws Exception {
        super(tree, alrParentNode, alrParentPanelMvc);
