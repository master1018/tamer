...
public class FolderTreeModel extends DefaultTreeModel {
    ...
    public FolderTreeModel(FolderXmlConfig folderConfig) {
        ...
        tempFolder = new TempFolder(Config.getInstance().getConfigDirectory() + "/mail/");
        createDirectories(((IMailFolder) getRoot()).getConfiguration().getRoot(), (IMailFolder) getRoot());
    ...
    public void createDirectories(XmlElement parentTreeNode, IMailFolder parentFolder) {
    ...
    public IMailFolder add(XmlElement childNode, IMailFolder parentFolder) {
        ...
        try {
            handler = PluginManager.getInstance().getExtensionHandler(IExtensionHandlerKeys.ORG_COLUMBA_MAIL_FOLDER);
