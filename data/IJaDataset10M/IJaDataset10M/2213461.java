 ...
 *
 */
public interface Level1ListOfSetElementsOperator<T, I> extends UniqOperator<List<Set<T>>, I>, NavigableCollectionOperator<T, I>, NavigatingCollectionOperator<Set<T>, I>, SortableOperator<T, I>, CastableToSetOperator<I>, ExecutableSetOperator<T, I>, ModifiableCollectionOperator<T, I>, ConvertibleToArrayOperator<T, I>, ConvertibleToListOperator<I>, SelectableOperator<Set<T>, I>, ReplaceableOperator<Set<T>, I>, ReplaceableIfNullOperator<Set<T>, I>, ConvertibleToMapOperator<T, I> {
