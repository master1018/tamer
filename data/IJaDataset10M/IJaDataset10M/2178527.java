...
public class MemoryTest {
     ...
     */
    public MemoryTest(String context, String configPath, String testFile, String outFile) throws IOException {
    ...
    public void testUtterance() throws IOException {
        ...
        timer.start();
        lm.start();
        while ((input = reader.readLine()) != null && !input.equals("<END_UTT>")) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String outFile = null;
        if (args.length == 0) {
            System.out.println("Usage: java MemoryTest <config_file> " + "<testFile> <output_file>");
        }
        configPath = args[0];
        if (args.length >= 2) {
            testFile = args[1];
        ...
        try {
            MemoryTest test = new MemoryTest("test", configPath, testFile, outFile);
