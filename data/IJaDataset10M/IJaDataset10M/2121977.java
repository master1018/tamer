...
public class ServletUtils {
    ...
    public static void sendStream(InputStream in, OutputStream out) throws IOException {
        sendStream(in, out, 2048);
    }

    public static void sendStream(InputStream is, OutputStream os, int bufsize) throws IOException {
