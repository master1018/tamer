...
public class JavascriptFactory implements IScriptableFactory {
   ...
   * Logger definition
   */
    private static final transient Log LOGGER = LogFactory.getLog(JavascriptFactory.class);
    ...
    public boolean supports(String scriptName) {
        return scriptName.equalsIgnoreCase("javascript") || scriptName.equalsIgnoreCase("js");
    }
}
