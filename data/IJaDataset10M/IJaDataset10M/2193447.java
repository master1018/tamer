...
public class BoardTest extends TestCase {
    ...
    public void testGetNeighbors() {
        ...
        assertNeighbors(board.getField(0, 0), board, new int[][] { { 1, 0 }, { 0, 1 }, { 1, 1 } });
        assertNeighbors(board.getField(1, 0), board, new int[][] { { 0, 0 }, { 0, 1 }, { 1, 1 }, { 2, 1 }, { 2, 0 } });
        assertNeighbors(board.getField(1, 1), board, new int[][] { { 0, 0 }, { 0, 1 }, { 0, 2 }, { 1, 2 }, { 2, 2 }, { 2, 1 }, { 2, 0 }, { 1, 0 } });
    }
    ...
    public void testGestState() {
        ...
        for (int x = 0; x < dimension.x; x++) {
            for (int y = 0; y < dimension.y; y++) {
                assertEquals(((Field) itsBoard.getField(x, y)).getState(), state.getFieldState(x, y));
            }
        }
    }
