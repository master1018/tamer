...
public class ClassDef extends stmt {
    ...
    private static final PyString[] fields = new PyString[] { new PyString("name"), new PyString("bases"), new PyString("body"), new PyString("decorator_list") };
    ...
    public ClassDef(Token token, String name, java.util.List<expr> bases, java.util.List<stmt> body, java.util.List<expr> decorator_list) {
        super(token);
        this.name = name;
        this.bases = bases;
        if (bases == null) {
    ...
    public ClassDef(Integer ttype, Token token, String name, java.util.List<expr> bases, java.util.List<stmt> body, java.util.List<expr> decorator_list) {
        super(ttype, token);
        this.name = name;
        this.bases = bases;
        if (bases == null) {
    ...
    public ClassDef(PythonTree tree, String name, java.util.List<expr> bases, java.util.List<stmt> body, java.util.List<expr> decorator_list) {
        super(tree);
        this.name = name;
        this.bases = bases;
        if (bases == null) {
