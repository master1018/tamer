...
public class DataValueVectorProfile extends VectorProfile {
    ...
    protected DataValueVectorProfile(LogReader log) throws IndexOutOfBoundsException, IOException {
        super("Data value profile", "Profile for attribute values", log.getLogSummary().getNumberOfProcessInstances(), (String[]) scanDataValues(log).toArray());
    }
	 ...
	 */
    protected static Set<String> scanDataValues(LogReader log) throws IndexOutOfBoundsException, IOException {
