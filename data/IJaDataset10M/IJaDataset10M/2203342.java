...
public class WritePEPE extends AbstractBasicTranscriptionProcessor {
    ...
    public void processTranscription(BasicTranscription bt) {
        try {
            ...
            String listFilename = getCurrentDirectoryname() + System.getProperty("file.separator") + "presentation" + System.getProperty("file.separator") + getNakedFilenameWithoutSuffix() + "_ulist" + ".xml";
            lt.writeXMLToFile(listFilename, "none");
            String pepeXMLFilename = getCurrentDirectoryname() + System.getProperty("file.separator") + "export" + System.getProperty("file.separator") + getNakedFilenameWithoutSuffix() + suffix + ".xml";
            try {
                Document listXML = FileIO.readDocumentFromLocalFile(listFilename);
                listXML.getRootElement().getChild("head").getChild("meta-information").getChild("referenced-file").setAttribute("url", referencedFile);
