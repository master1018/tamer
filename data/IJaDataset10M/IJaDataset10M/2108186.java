...
public class Spell_Boomerang extends Spell {
    ...
    public void executeMsg(Environmental host, CMMsg msg) {
        ...
        if ((msg.targetMinor() == CMMsg.TYP_GET) && (msg.amITarget(affected)) && (text().length() == 0)) {
        ...
        if ((affected instanceof Item) && (text().length() > 0)) {
            ...
            if (owner == null) {
                if ((I.owner() != null) && (I.owner() instanceof MOB) && (I.owner().Name().equals(text()))) owner = (MOB) I.owner(); else owner = CMLib.players().getPlayer(text());
            }
    ...
    public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel) {
        ...
        } else beneficialWordsFizzle(mob, target, "<S-NAME> point(s) at <T-NAMESELF>, but fail(s) to cast a spell.");
        return success;
    }
}
