...
public class ExpEconAboutBox extends javax.swing.JDialog {

    public ExpEconAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(expecon.ExpEconApp.class).getContext().getResourceMap(ExpEconAboutBox.class);
        setTitle(resourceMap.getString("title"));
        setModal(true);
        setName("aboutBox");
        setResizable(false);
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(expecon.ExpEconApp.class).getContext().getActionMap(ExpEconAboutBox.class, this);
