...
public class ZDDTutorial extends TutorialHelper {
    ...
    public ZDDTutorial() {
        ...
        JDDConsole.out.println("There are several Z-BDD objects in JDD, they are however all created " + "in a similar fashion to the BDD object. Consult BDD tutorial for more info.");
        JDDConsole.out.println("<p>The basic Z-BDD class is <i>ZDD</i>. It uses BDD-style initialization");
        code("ZDD zdd = new ZDD(1000,100);");
        JDDConsole.out.println("<p>It contains all the basic operations, which are:<ul>" + "<li> base()" + "<li> empty()" + "<li> subset1()" + "<li> subset0()" + "<li> union()" + "<li> intersect()" + "<li> diff()" + "<li> change()" + "</ul>");
        ...
        int f = zdd.union(b, e);
        int g = zdd.diff(f, c);
        JDDConsole.out.println("<p>Note that in contrast to BDDs, Z-BDD variables (here v1 and v2) are just " + "number and no Z-BDD trees. You can't do stuff like <i>int a = zdd.union(v1,v2)</i>!!!");
        ...
        zdd.printCubes(g);
        JDDConsole.out.println("</pre>");
        JDDConsole.out.println("<p>But you will probably prefer the DOT printer <i>printDot()</i>. " + "It was used to produce the following images:");
        ...
        zdd.printDot(filename("a"), a);
        img("a");
        JDDConsole.out.println("</td><td>");
        zdd.printDot(filename("b"), b);
        img("b");
        JDDConsole.out.println("</td><td>");
        zdd.printDot(filename("c"), c);
        img("c");
        JDDConsole.out.println("</td><td>");
        zdd.printDot(filename("d"), d);
        img("d");
        JDDConsole.out.println("</td><td>");
        zdd.printDot(filename("e"), e);
        img("e");
        JDDConsole.out.println("</td><td>");
        zdd.printDot(filename("f"), f);
        img("f");
        JDDConsole.out.println("</td><td>");
        zdd.printDot(filename("g"), g);
        img("g");
        ...
        h3("The ZDD2 object");
        JDDConsole.out.println("<p><i>ZDD2</i> contains additional operations for unate cube set algebra. " + "These operations are shown below");
        showClass("jdd.zdd.ZDD2");
        h3("The ZDDCSP object");
        JDDConsole.out.println("<p><i>ZDDCSP</i> adds extra ZDD operations for CSP problems. " + "it is 	based on 'On the properties of combination set operations', " + "by Okuno, Minato and Isozaki.");
        JDDConsole.out.println("<p>The new operations are:");
        showClass("jdd.zdd.ZDDCSP");
        h3("The ZDDGraph object");
        JDDConsole.out.println("<p><i>ZDDGraph</i> is intended to [in near future] include common ZDD operations used in graph algorithms, " + "as explained in Coudert's paper.");
