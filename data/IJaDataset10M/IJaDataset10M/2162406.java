...
public class ImportImpl extends MinimalEObjectImpl.Container implements Import {
   ...
   */
    public void setImportedNamespace(String newImportedNamespace) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, ArithmeticsPackage.IMPORT__IMPORTED_NAMESPACE, oldImportedNamespace, importedNamespace));
    }
