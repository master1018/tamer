...
public class LeditorAboutBox extends javax.swing.JDialog {

    public LeditorAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(leditor.LeditorApp.class).getContext().getResourceMap(LeditorAboutBox.class);
        setTitle(resourceMap.getString("title"));
        setModal(true);
        setName("aboutBox");
        setResizable(false);
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(leditor.LeditorApp.class).getContext().getActionMap(LeditorAboutBox.class, this);
