...
public class InformationPacket extends AbstractLocalPacket {
     ...
     */
    public static InformationPacket createFromBuffer(int headerLength, int middleLength, int endLength, ChannelBuffer buf) throws OpenR66ProtocolPacketException {
        if (headerLength - 1 <= 0) {
