...
/**
 * This is the class for GE node of the IF-statement. Its functionality is
 ...
 * greater than or equal to the second Term.
 *
...
public class GeNode extends OperationNode {
    ...
    public static final String GE_NODE = "GE";
   ...
   */
    public static void register() {
        try {
            issrg.pba.rbac.xmlpolicy.XMLPolicyParser.registerXMLNode(GE_NODE, GeNode.class);
   ...
   * Term is greater or equal to the second Term in the array passed to the
   ...
   */
    public static void registerInterpreter(Interpreter i) {
        OperationNode.registerInterpreterForNode(GE_NODE, i);
    }
    ...
    /**
   * This constructor builds a GeNode given the XMLPolicyParser and the set of
   * attributes of this XML element. It expects that there are two and only two
   * child nodes.
   *
   * @param p - the XMLPolicyParser that builds this GeNode
   * @param attr - the attributes of this XML element
   */
    public GeNode(issrg.pba.rbac.xmlpolicy.XMLPolicyParser p, org.xml.sax.Attributes attrs) {
        super(GE_NODE, attrs, 2, 2);
    }
}
