...
public class VariableLengthScalarSerializerTest extends OpenFastTestCase {
    ...
    public void testSerializeString() {
        ...
        scalar.setId("5");
        String expected = "<string name=\"name\" ns=\"http://openfast.org\" id=\"5\" charset=\"unicode\">" + NL + "    <copy dictionary=\"template\" key=\"items\" ns=\"http://www.openfast.org\" value=\"abcd\"/>" + NL + "</string>" + NL;
    ...
    public void testSerializeByteVector() {
        ...
        scalar.addNode(node);
        String expected = "<byteVector name=\"bytes\" ns=\"http://openfast.org\" id=\"345\" presence=\"optional\">" + NL + "    <length name=\"bytesLength\" ns=\"http://www.openfast.org\" id=\"344\"/>" + NL + "    <tail dictionary=\"template\" key=\"items\" ns=\"http://www.openfast.org\"/>" + NL + "</byteVector>" + NL;
        serializer.serialize(writer, scalar, XMLMessageTemplateSerializer.createInitialContext());
        assertEquals(expected, byteOut.toString());
    }
}
