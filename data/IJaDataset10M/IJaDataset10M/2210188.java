...
public class NewEncryptionCommand extends AbstractAlgorithmAction {
    ...
    private void createEncryption() {
        try {
            ...
            Object activeEditor = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().getActiveEditor().getAdapter(ITextEditor.class);
            ...
            Job job = new Job(Messages.NewEncryptionCommand_0) {
                ...
                public IStatus run(final IProgressMonitor monitor) {
                    try {
                        ...
                        if (doc != null) {
                            IEditorInput output = AbstractEditorService.createOutputFile("encrypted", IConstants.XML_FILE_TYPE_EXTENSION, Utils.docToInputStram(doc));
