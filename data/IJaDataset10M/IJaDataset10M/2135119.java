...
public class ConceptNameImpl extends AbstractONDEXEntity implements ConceptName {
	 ...
	 *            Is the concept name preferred?
	 */
    protected ConceptNameImpl(long sid, int cid, String name, boolean isPreferred) {
        this.sid = sid;
        this.conceptId = cid;
        this.name = name;
	 ...
	 */
    @Override
    public void setPreferred(boolean isPreferred) throws UnsupportedOperationException {
        if (ONDEXGraphRegistry.graphs.get(getSID()).isReadOnly()) throw new UnsupportedOperationException();
        this.isPreferred = isPreferred;
    }
}
