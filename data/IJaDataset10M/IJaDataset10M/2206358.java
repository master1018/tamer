...
public class ExecutableBundleActivator implements BundleActivator {
    ...
    public void start(BundleContext bc) throws BundleException {
        ...
        try {
            ...
            if (startFile != null) {
                ...
                runProcess = runFile(startFile, args, false, isProcessExitMeansStopBundle());
            }
        } catch (IOException e) {
   ...
   */
    ...
    void initFiles() throws IOException {
        initFiles((String) bc.getBundle().getHeaders().get(BUNDLE_START_EXECUTABLE), (String) bc.getBundle().getHeaders().get(BUNDLE_STOP_EXECUTABLE), (String) bc.getBundle().getHeaders().get(BUNDLE_EXTRACT_FILES));
    }
   ...
   */
    ...
    private Collection getNativeCode(String bnc) {
        if (bnc != null) {
            ...
            fwprops.put(Constants.FRAMEWORK_PROCESSOR, bc.getProperty(Constants.FRAMEWORK_PROCESSOR));
            fwprops.put(Constants.FRAMEWORK_OS_NAME, bc.getProperty(Constants.FRAMEWORK_OS_NAME));
            fwprops.put(Constants.FRAMEWORK_OS_VERSION, bc.getProperty(Constants.FRAMEWORK_OS_VERSION));
            fwprops.put(Constants.FRAMEWORK_LANGUAGE, bc.getProperty(Constants.FRAMEWORK_LANGUAGE));
