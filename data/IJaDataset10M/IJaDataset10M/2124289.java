...
public class ParallelMultiplyingDiskBufferedDoubleMatrix extends DiskBufferedDoubleMatrix {
    ...
    public ParallelMultiplyingDiskBufferedDoubleMatrix(File diskDir, int pageSize, boolean isRowMatrix, int numThreads) {
   ...
   */
    ...
    public MapVector timesSquared(MapVector input) {
        if (!_isNumColsCalculated) for (Entry<Integer, MapVector> e : this) ;
