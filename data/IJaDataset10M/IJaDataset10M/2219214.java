 ...
 * <p>
 * <b>Syntax:</b> <code>LUSERS [ &lt;mask&gt; [ &lt;target&gt; ] ]</code>
 * <p>
 ...
 * a <code>mask</code> is specified, then the reply will only concern the part
 * of the network formed by the servers matching the mask. Finally, if the
 * <code>target</code> parameter is specified, the request is forwarded to that
 * server which will generate the reply.
 * <p>
 * Wildcards are allowed in the <code>target</code> parameter.
 *
 * @author Christoph Daniel Schulze
 * @version $Id: LusersMessage.java 3 2003-01-07 14:16:38Z captainnuss $
 */
