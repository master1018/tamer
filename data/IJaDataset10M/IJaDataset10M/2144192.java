...
public class ShipperPlanReader extends MatsimXmlParser {
    ...
    public void startTag(String name, Attributes atts, Stack<String> context) {
        ...
        if (name.equals("shipment")) {
            ShipperShipment shipment = ShipperUtils.createShipment(currentComFlow.getFrom(), currentComFlow.getTo(), getInt(atts.getValue("size")), getDouble(atts.getValue("startPickup")), getDouble(atts.getValue("endPickup")), getDouble(atts.getValue("startDelivery")), getDouble(atts.getValue("endDelivery")));
