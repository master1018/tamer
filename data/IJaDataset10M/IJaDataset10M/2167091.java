...
public abstract class SenseData implements Encodable {
    ...
    public SenseData(ResponseCode responseCode, KCQ kcq, byte[] information, byte[] commandSpecificInformation, SenseKeySpecificField senseKeySpecific) {
        super();
    ...
    */
    ...
    protected static SenseKeySpecificField decodeSenseKeySpecificField(SenseKey key, ByteBuffer input) throws IOException {
