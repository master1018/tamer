...
public class Thing extends org.ontoware.rdfreactor.schema.rdfs.Class {
     ...
     */
    @SuppressWarnings("hiding")
    public static final URI[] MANAGED_URIS = { new URIImpl("http://www.w3.org/2002/07/owl#maxCardinality", false), new URIImpl("http://www.w3.org/2002/07/owl#minCardinality", false), new URIImpl("urn:ex:rrr", false), new URIImpl("urn:ex:sss2", false), new URIImpl("urn:ex:ttt2", false) };
