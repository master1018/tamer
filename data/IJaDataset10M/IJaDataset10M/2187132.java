...
public class PageCursor implements Serializable, IPageCursor {
    ...
    protected IRecordsPerPageProvider _recordsPerPageProvider = new DefaultRecordsPerPageProvider();
 ...
 */
    public void setRecordsPerPageProvider(IRecordsPerPageProvider recordsPerPageProvider) {
        _recordsPerPageProvider = recordsPerPageProvider != null ? recordsPerPageProvider : new DefaultRecordsPerPageProvider();
    }
 ...
 */
    protected class DefaultRecordsPerPageProvider implements Serializable, IRecordsPerPageProvider {
 ...
 */
        public void setRecordsPerPage(int recordsPerPage) {
            _recordsPerPage = Math.max(IRecordsPerPageProvider.MIN_RECORDS_PER_PAGE, recordsPerPage);
        }
    }
}
