...
public class XOCLPackageImpl extends EPackageImpl implements XOCLPackage {
   ...
   */
    public static XOCLPackage init() {
        ...
        XOCLPackageImpl theXOCLPackage = (XOCLPackageImpl) (EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof XOCLPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new XOCLPackageImpl());
        isInited = true;
   ...
   */
    public EReference getTupleLiteralPartXS_VariableDeclaration() {
        return (EReference) tupleLiteralPartXSEClass.getEStructuralFeatures().get(0);
    }
   ...
   */
    public void createPackageContents() {
        ...
        createEAttribute(collectionOperationCallExpXSEClass, COLLECTION_OPERATION_CALL_EXP_XS__REFERRED_COLLECTION_OPERATION);
        ...
        createEAttribute(modelOperationCallExpXSEClass, MODEL_OPERATION_CALL_EXP_XS__REFERRED_OPERATION_NAME);
        ...
        createEReference(tupleLiteralPartXSEClass, TUPLE_LITERAL_PART_XS__VARIABLE_DECLARATION);
   ...
   */
    public void initializePackageContents() {
        ...
        initEClass(elementXSEClass, ElementXS.class, "ElementXS", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEClass(constraintXSEClass, ConstraintXS.class, "ConstraintXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getConstraintXS_Name(), ecorePackage.getEString(), "name", null, 0, 1, ConstraintXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getConstraintXS_Kind(), this.getConstraintKindXS(), "kind", null, 0, 1, ConstraintXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getConstraintXS_ConstrainedElement(), ecorePackage.getEString(), "constrainedElement", null, 0, 1, ConstraintXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getConstraintXS_DefinedFeature(), ecorePackage.getEString(), "definedFeature", null, 0, 1, ConstraintXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getConstraintXS_Specification(), this.getExpressionInOclXS(), this.getExpressionInOclXS_Constraint(), "specification", null, 0, 1, ConstraintXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(expressionInOclXSEClass, ExpressionInOclXS.class, "ExpressionInOclXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getExpressionInOclXS_Body(), ecorePackage.getEString(), "body", null, 0, 1, ExpressionInOclXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getExpressionInOclXS_Constraint(), this.getConstraintXS(), this.getConstraintXS_Specification(), "constraint", null, 0, 1, ExpressionInOclXS.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getExpressionInOclXS_BodyExpression(), this.getOclExpressionXS(), null, "bodyExpression", null, 1, 1, ExpressionInOclXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getExpressionInOclXS_Context(), this.getVariableXS(), null, "context", null, 0, 1, ExpressionInOclXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getExpressionInOclXS_Parameter(), this.getVariableXS(), null, "parameter", null, 0, -1, ExpressionInOclXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getExpressionInOclXS_Result(), this.getVariableXS(), null, "result", null, 0, 1, ExpressionInOclXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(oclExpressionXSEClass, OclExpressionXS.class, "OclExpressionXS", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEClass(variableXSEClass, VariableXS.class, "VariableXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getVariableXS_Name(), ecorePackage.getEString(), "name", null, 0, 1, VariableXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getVariableXS_Type(), ecorePackage.getEString(), "type", null, 0, 1, VariableXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getVariableXS_InitExpression(), this.getOclExpressionXS(), null, "initExpression", null, 0, 1, VariableXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(propertyCallExpXSEClass, PropertyCallExpXS.class, "PropertyCallExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getPropertyCallExpXS_ReferredPropertyName(), ecorePackage.getEString(), "referredPropertyName", null, 0, 1, PropertyCallExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getPropertyCallExpXS_Qualifier(), this.getOclExpressionXS(), null, "qualifier", null, 0, -1, PropertyCallExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(booleanLiteralExpXSEClass, BooleanLiteralExpXS.class, "BooleanLiteralExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getBooleanLiteralExpXS_BooleanSymbol(), ecorePackage.getEBoolean(), "booleanSymbol", null, 0, 1, BooleanLiteralExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(callExpXSEClass, CallExpXS.class, "CallExpXS", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getCallExpXS_Source(), this.getOclExpressionXS(), null, "source", null, 0, 1, CallExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(collectionItemXSEClass, CollectionItemXS.class, "CollectionItemXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getCollectionItemXS_Item(), this.getOclExpressionXS(), null, "item", null, 1, 1, CollectionItemXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(collectionLiteralExpXSEClass, CollectionLiteralExpXS.class, "CollectionLiteralExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getCollectionLiteralExpXS_Kind(), this.getCollectionKindXS(), "kind", null, 0, 1, CollectionLiteralExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getCollectionLiteralExpXS_Part(), this.getCollectionLiteralPartXS(), null, "part", null, 0, -1, CollectionLiteralExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(collectionLiteralPartXSEClass, CollectionLiteralPartXS.class, "CollectionLiteralPartXS", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEClass(collectionOperationCallExpXSEClass, CollectionOperationCallExpXS.class, "CollectionOperationCallExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getCollectionOperationCallExpXS_ReferredCollectionOperation(), this.getCollectionOperationXS(), "referredCollectionOperation", null, 0, 1, CollectionOperationCallExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(collectionRangeXSEClass, CollectionRangeXS.class, "CollectionRangeXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getCollectionRangeXS_Last(), this.getOclExpressionXS(), null, "last", null, 1, 1, CollectionRangeXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getCollectionRangeXS_First(), this.getOclExpressionXS(), null, "first", null, 1, 1, CollectionRangeXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(enumLiteralExpXSEClass, EnumLiteralExpXS.class, "EnumLiteralExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getEnumLiteralExpXS_ReferredEnumLiteralPathName(), ecorePackage.getEString(), "referredEnumLiteralPathName", null, 0, 1, EnumLiteralExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(featureCallExpXSEClass, FeatureCallExpXS.class, "FeatureCallExpXS", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEClass(ifExpXSEClass, IfExpXS.class, "IfExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getIfExpXS_ElseExpression(), this.getOclExpressionXS(), null, "elseExpression", null, 1, 1, IfExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getIfExpXS_Condition(), this.getOclExpressionXS(), null, "condition", null, 1, 1, IfExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getIfExpXS_ThenExpression(), this.getOclExpressionXS(), null, "thenExpression", null, 1, 1, IfExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(integerLiteralExpXSEClass, IntegerLiteralExpXS.class, "IntegerLiteralExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getIntegerLiteralExpXS_IntegerSymbol(), ecorePackage.getEInt(), "integerSymbol", null, 0, 1, IntegerLiteralExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(iterateExpXSEClass, IterateExpXS.class, "IterateExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getIterateExpXS_Result(), this.getVariableXS(), null, "result", null, 0, 1, IterateExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(invalidLiteralExpXSEClass, InvalidLiteralExpXS.class, "InvalidLiteralExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEClass(iteratorExpXSEClass, IteratorExpXS.class, "IteratorExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getIteratorExpXS_Name(), this.getIteratorExpressionXS(), "name", null, 0, 1, IteratorExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(letExpXSEClass, LetExpXS.class, "LetExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getLetExpXS_In(), this.getOclExpressionXS(), null, "in", null, 1, 1, LetExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getLetExpXS_Variable(), this.getVariableXS(), null, "variable", null, 1, 1, LetExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(literalExpXSEClass, LiteralExpXS.class, "LiteralExpXS", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEClass(loopExpXSEClass, LoopExpXS.class, "LoopExpXS", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getLoopExpXS_Iterator(), this.getVariableXS(), null, "iterator", null, 0, -1, LoopExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getLoopExpXS_Body(), this.getOclExpressionXS(), null, "body", null, 1, 1, LoopExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(modelOperationCallExpXSEClass, ModelOperationCallExpXS.class, "ModelOperationCallExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getModelOperationCallExpXS_ReferredOperationName(), ecorePackage.getEString(), "referredOperationName", null, 0, 1, ModelOperationCallExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(namespaceXSEClass, NamespaceXS.class, "NamespaceXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getNamespaceXS_PathName(), ecorePackage.getEString(), "pathName", null, 0, 1, NamespaceXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getNamespaceXS_OwnedRule(), this.getConstraintXS(), null, "ownedRule", null, 0, -1, NamespaceXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(numericLiteralExpXSEClass, NumericLiteralExpXS.class, "NumericLiteralExpXS", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEClass(operationCallExpXSEClass, OperationCallExpXS.class, "OperationCallExpXS", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getOperationCallExpXS_Argument(), this.getOclExpressionXS(), null, "argument", null, 0, -1, OperationCallExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(primitiveLiteralExpXSEClass, PrimitiveLiteralExpXS.class, "PrimitiveLiteralExpXS", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEClass(realLiteralExpXSEClass, RealLiteralExpXS.class, "RealLiteralExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getRealLiteralExpXS_RealSymbol(), ecorePackage.getEFloat(), "realSymbol", null, 0, 1, RealLiteralExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(staticOperationCallExpXSEClass, StaticOperationCallExpXS.class, "StaticOperationCallExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEClass(staticPropertyCallExpXSEClass, StaticPropertyCallExpXS.class, "StaticPropertyCallExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEClass(stringLiteralExpXSEClass, StringLiteralExpXS.class, "StringLiteralExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getStringLiteralExpXS_StringSymbol(), ecorePackage.getEString(), "stringSymbol", null, 0, 1, StringLiteralExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(tupleLiteralExpXSEClass, TupleLiteralExpXS.class, "TupleLiteralExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getTupleLiteralExpXS_Part(), this.getTupleLiteralPartXS(), null, "part", null, 0, -1, TupleLiteralExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(tupleLiteralPartXSEClass, TupleLiteralPartXS.class, "TupleLiteralPartXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getTupleLiteralPartXS_VariableDeclaration(), this.getVariableXS(), null, "variableDeclaration", null, 1, 1, TupleLiteralPartXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(typeLiteralExpXSEClass, TypeLiteralExpXS.class, "TypeLiteralExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getTypeLiteralExpXS_ReferredTypeName(), ecorePackage.getEString(), "referredTypeName", null, 0, 1, TypeLiteralExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(undefinedLiteralExpXSEClass, UndefinedLiteralExpXS.class, "UndefinedLiteralExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEClass(unlimitedNaturalExpXSEClass, UnlimitedNaturalExpXS.class, "UnlimitedNaturalExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getUnlimitedNaturalExpXS_Symbol(), ecorePackage.getEString(), "symbol", null, 0, 1, UnlimitedNaturalExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEClass(variableExpXSEClass, VariableExpXS.class, "VariableExpXS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getVariableExpXS_ReferredVariable(), this.getVariableXS(), null, "referredVariable", null, 0, 1, VariableExpXS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEEnum(constraintKindXSEEnum, ConstraintKindXS.class, "ConstraintKindXS");
        ...
        initEEnum(collectionKindXSEEnum, CollectionKindXS.class, "CollectionKindXS");
        ...
        initEEnum(collectionOperationXSEEnum, CollectionOperationXS.class, "CollectionOperationXS");
        ...
        initEEnum(iteratorExpressionXSEEnum, IteratorExpressionXS.class, "IteratorExpressionXS");
