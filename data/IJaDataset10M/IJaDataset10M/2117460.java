	...
	*/
    public int evaluateHand() {
        ...
        if (v[1] == v[0]) {
            if (v[2] == v[1]) {
                if (v[3] == v[2]) {
                    if (v[4] == v[3]) value = 6; else value = 5;
                } else if (v[4] == v[2]) value = 5; else if (v[4] == v[3]) value = 4; else value = 3;
            } else if (v[3] == v[2]) {
                if (v[4] == v[1]) value = 4; else if (v[4] == v[2]) value = 4; else value = 2;
            } else if (v[3] == v[1]) {
                if (v[4] == v[2]) value = 4; else if (v[4] == v[3]) value = 5; else value = 3;
            } else if (v[4] == v[1]) value = 3; else if (v[4] == v[2]) value = 2; else if (v[4] == v[3]) value = 2; else value = 1;
        } else if (v[2] == v[1]) {
            if (v[3] == v[0]) {
                if (v[4] == v[3]) value = 4; else if (v[4] == v[2]) value = 4; else value = 2;
            } else if (v[3] == v[2]) {
                if (v[4] == v[3]) value = 5; else if (v[4] == v[0]) value = 4; else value = 3;
            } else if (v[4] == v[0]) value = 2; else if (v[4] == v[2]) value = 3; else if (v[4] == v[3]) value = 2; else value = 1;
        } else if (v[2] == v[0]) {
            if (v[3] == v[2]) {
                if (v[4] == v[3]) value = 5; else if (v[4] == v[1]) value = 4; else value = 3;
            } else if (v[3] == v[1]) {
                if (v[4] == v[2]) value = 4; else if (v[4] == v[3]) value = 4; else value = 2;
            } else if (v[4] == v[2]) value = 3; else if (v[4] == v[1]) value = 2; else if (v[4] == v[3]) value = 2; else value = 1;
        } else if (v[3] == v[0]) {
            if (v[4] == v[3]) value = 3; else if (v[4] == v[1]) value = 2; else if (v[4] == v[2]) value = 2; else value = 1;
        } else if (v[3] == v[1]) {
            if (v[4] == v[3]) value = 3; else if (v[4] == v[0]) value = 2; else if (v[4] == v[2]) value = 2; else value = 1;
        } else if (v[3] == v[2]) {
            if (v[4] == v[0]) value = 2; else if (v[4] == v[1]) value = 2; else if (v[4] == v[3]) value = 3; else value = 1;
        } else if (v[4] == v[0]) value = 1; else if (v[4] == v[1]) value = 1; else if (v[4] == v[2]) value = 1; else if (v[4] == v[3]) value = 1; else value = 0;
        return value;
    }
