package org.gems.designer.model;
...
public class LocationPropertySource implements IPropertySource {
    ...
    static {
        PropertyDescriptor xProp = new TextPropertyDescriptor(ID_XPOS, LogicMessages.LocationPropertySource_Property_X_Label);
        xProp.setValidator(LogicNumberCellEditorValidator.instance());
        PropertyDescriptor yProp = new TextPropertyDescriptor(ID_YPOS, LogicMessages.LocationPropertySource_Property_Y_Label);
