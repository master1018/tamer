...
/**
 * This is a default implementation of the IFC object IfcWindow<br><br>
 * 
 ...
 **/
public class IfcWindow extends IfcBuildingElement implements IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcGloballyUniqueId", "IfcOwnerHistory", "IfcLabel", "IfcText", "IfcLabel", "IfcObjectPlacement", "IfcProductRepresentation", "IfcIdentifier", "IfcPositiveLengthMeasure", "IfcPositiveLengthMeasure" };
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("OverallHeight")) stepString = stepString.concat("*,"); else {
            if (this.OverallHeight != null) stepString = stepString.concat(((IfcRootInterface) this.OverallHeight).getStepParameter(IfcPositiveLengthMeasure.class.isInterface()) + ","); else stepString = stepString.concat("$,");
        }
	 ...
	 * 
	 * @param OverallHeight value to set
	 *            /
	 **/
    ...
    public Object clone() {
        ...
        if (this.GlobalId != null) ifcWindow.setGlobalId((IfcGloballyUniqueId) this.GlobalId.clone());
        if (this.OwnerHistory != null) ifcWindow.setOwnerHistory((IfcOwnerHistory) this.OwnerHistory.clone());
        if (this.Name != null) ifcWindow.setName((IfcLabel) this.Name.clone());
        if (this.Description != null) ifcWindow.setDescription((IfcText) this.Description.clone());
        if (this.ObjectType != null) ifcWindow.setObjectType((IfcLabel) this.ObjectType.clone());
        if (this.ObjectPlacement != null) ifcWindow.setObjectPlacement((IfcObjectPlacement) this.ObjectPlacement.clone());
        if (this.Representation != null) ifcWindow.setRepresentation((IfcProductRepresentation) this.Representation.clone());
        if (this.Tag != null) ifcWindow.setTag((IfcIdentifier) this.Tag.clone());
        if (this.OverallHeight != null) ifcWindow.setOverallHeight((IfcPositiveLengthMeasure) this.OverallHeight.clone());
        if (this.OverallWidth != null) ifcWindow.setOverallWidth((IfcPositiveLengthMeasure) this.OverallWidth.clone());
        return ifcWindow;
    }
    ...
    public Object shallowCopy() {
        IfcWindow ifcWindow = new IfcWindow();
        if (this.GlobalId != null) ifcWindow.setGlobalId(this.GlobalId);
        if (this.OwnerHistory != null) ifcWindow.setOwnerHistory(this.OwnerHistory);
        if (this.Name != null) ifcWindow.setName(this.Name);
        if (this.Description != null) ifcWindow.setDescription(this.Description);
        if (this.ObjectType != null) ifcWindow.setObjectType(this.ObjectType);
        if (this.ObjectPlacement != null) ifcWindow.setObjectPlacement(this.ObjectPlacement);
        if (this.Representation != null) ifcWindow.setRepresentation(this.Representation);
        if (this.Tag != null) ifcWindow.setTag(this.Tag);
        if (this.OverallHeight != null) ifcWindow.setOverallHeight(this.OverallHeight);
        if (this.OverallWidth != null) ifcWindow.setOverallWidth(this.OverallWidth);
        return ifcWindow;
    }
