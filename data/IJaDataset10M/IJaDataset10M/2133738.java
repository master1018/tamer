...
public class RubyOutlineInformationControl extends AbstractInformationControl {
    ...
    private class OutlineTreeViewer extends TreeViewer {
        ...
        protected Object[] getFilteredChildren(Object parent) {
            ...
            if (filters != null) {
                for (int i = 0; i < filters.length; i++) result = filters[i].filter(this, parent, result);
            }
    ...
    private class OutlineContentProvider extends StandardRubyElementContentProvider {
        ...
        public void toggleShowInheritedMembers() {
            ...
            if (selectedElement != null) getTreeViewer().reveal(selectedElement);
            tree.setRedraw(true);
        }
    ...
    private class ShowOnlyMainTypeAction extends Action {
        ...
        private ShowOnlyMainTypeAction(TreeViewer outlineViewer) {
            ...
            RubyPluginImages.setLocalImageDescriptors(this, "gointo_toplevel_type.gif");
        ...
        private void setTopLevelTypeOnly(boolean show) {
            ...
            if (!fShowOnlyMainType) fOutlineViewer.expandToLevel(2);
            Object selectedElement = getSelectedElement();
            if (selectedElement != null) fOutlineViewer.reveal(selectedElement);
            tree.setRedraw(true);
    ...
    private class LexicalSortingAction extends Action {
        ...
        private LexicalSortingAction(TreeViewer outlineViewer) {
            ...
            RubyPluginImages.setLocalImageDescriptors(this, "alphab_sort_co.gif");
            fOutlineViewer = outlineViewer;
        ...
        private void valueChanged(final boolean on, boolean store) {
            ...
            if (store) getDialogSettings().put(STORE_LEXICAL_SORTING_CHECKED, on);
        }
    }
    ...
    private class SortByDefiningTypeAction extends Action {
        ...
        private SortByDefiningTypeAction(TreeViewer outlineViewer) {
            ...
            RubyPluginImages.setLocalImageDescriptors(this, "definingtype_sort_co.gif");
            fOutlineViewer = outlineViewer;
    ...
    protected TreeViewer createTreeViewer(Composite parent, int style) {
        ...
        if (decoratorMgr.getEnabled("org.rubypeople.rdt.ui.override.decorator")) fInnerLabelProvider.addLabelDecorator(new OverrideIndicatorLabelDecorator(null));
    ...
    protected String getStatusFieldText() {
        ...
        if (fOutlineContentProvider.isShowingInheritedMembers()) return Messages.format(RubyUIMessages.RubyOutlineControl_statusFieldText_hideInheritedMembers, keySequence); else return Messages.format(RubyUIMessages.RubyOutlineControl_statusFieldText_showInheritedMembers, keySequence);
    }
    ...
    protected void setMatcherString(String pattern, boolean update) {
        ...
        if (update) stringMatcherUpdated();
    }
