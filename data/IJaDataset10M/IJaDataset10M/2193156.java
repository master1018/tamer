...
public class IdentityTriple<T1, T2, T3> extends Triple<T1, T2, T3> {
    ...
    public IdentityTriple(T1 first, T2 second, T3 third) {
   ...
   */
    public boolean equals(Object o) {
        if (this == o) {
            ...
            return _first == cast._first && _second == cast._second && _third == cast._third;
        }
    }

    protected int generateHashCode() {
        return System.identityHashCode(_first) ^ (System.identityHashCode(_second) << 1) ^ (System.identityHashCode(_third) << 2) ^ getClass().hashCode();
    }
