...
public class AndroidServerAboutBox extends JDialog {

    public AndroidServerAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = Application.getInstance(androidserver.AndroidServerApp.class).getContext().getResourceMap(AndroidServerAboutBox.class);
        setTitle(resourceMap.getString("title"));
        setModal(true);
        setName("aboutBox");
        setResizable(false);
        javax.swing.ActionMap actionMap = Application.getInstance(androidserver.AndroidServerApp.class).getContext().getActionMap(AndroidServerAboutBox.class, this);
