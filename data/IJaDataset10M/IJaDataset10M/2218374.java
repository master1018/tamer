...
public class IndicatorNode extends AbstractPropertiesNode {
    ...
    public IndicatorNode() {
        super("Rate of Change - Ratio Properties");
    }

    public IndicatorNode(IndicatorProperties indicatorProperties) {
        super("Rate of Change - Ratio Properties", indicatorProperties);
    }
    ...
    protected Sheet createSheet() {
        ...
        try {
            ...
            set.put(getProperty("Period", "Sets the Period Line", IndicatorProperties.class, int.class, null, "getPeriod", "setPeriod", IndicatorProperties.PERIOD));
            ...
            LOG.log(Level.SEVERE, "[Rate of Change - Ratio Node] : Method does not exist.", ex);
        }
        return sheet;
    }
}
