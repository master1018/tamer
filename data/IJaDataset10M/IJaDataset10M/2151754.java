 ...
 */
public class DurationDialog extends JDialog implements ActionListener {
    ...
    /** Creates a new instance of DurationDialog */
    public DurationDialog(JFrame owner, String dialogTitle, ResourceBundle rb) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand() == "EXIT") {
            ...
            if (dp.getDuration() == null) dp.setDuration("duration");
            this.dispose();
        }
    }
