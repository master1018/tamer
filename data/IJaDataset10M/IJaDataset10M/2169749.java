...
/**
 * Represents COM dispinterface DispHTMLAreaElement.
 */
public class DispHTMLAreaElementImpl extends IDispatchImpl implements DispHTMLAreaElement {

    public static final String INTERFACE_IDENTIFIER = "{3050F503-98B5-11CF-BB82-00AA00BDCE0B}";

    private static final IID _iid = IID.create(INTERFACE_IDENTIFIER);

    public DispHTMLAreaElementImpl() {
    }

    protected DispHTMLAreaElementImpl(IUnknownImpl that) throws ComException {
        super(that);
    }

    public DispHTMLAreaElementImpl(IUnknown that) throws ComException {
        super(that);
    }

    public DispHTMLAreaElementImpl(CLSID clsid, ClsCtx dwClsContext) throws ComException {
        super(clsid, dwClsContext);
    }

    public DispHTMLAreaElementImpl(CLSID clsid, IUnknownImpl pUnkOuter, ClsCtx dwClsContext) throws ComException {
    ...
    public void setShape(BStr param1) {
        Parameter[] parameters = new Parameter[] { param1 == null ? (Parameter) PTR_NULL : param1 };
        Automation.setDispatchProperty(this, "shape", parameters);
    }

    public BStr getShape() {
        Parameter[] parameters = new Parameter[0];
        return (BStr) Automation.getDispatchProperty(this, "shape", parameters, BStr.class);
    }

    public void setCoords(BStr param1) {
        Parameter[] parameters = new Parameter[] { param1 == null ? (Parameter) PTR_NULL : param1 };
        Automation.setDispatchProperty(this, "coords", parameters);
    }

    public BStr getCoords() {
        Parameter[] parameters = new Parameter[0];
        return (BStr) Automation.getDispatchProperty(this, "coords", parameters, BStr.class);
    }

    public void setHref(BStr param1) {
        Parameter[] parameters = new Parameter[] { param1 == null ? (Parameter) PTR_NULL : param1 };
        Automation.setDispatchProperty(this, "href", parameters);
    }

    public BStr getHref() {
        Parameter[] parameters = new Parameter[0];
        return (BStr) Automation.getDispatchProperty(this, "href", parameters, BStr.class);
    }

    public void setTarget(BStr param1) {
        Parameter[] parameters = new Parameter[] { param1 == null ? (Parameter) PTR_NULL : param1 };
        Automation.setDispatchProperty(this, "target", parameters);
    }

    public BStr getTarget() {
        Parameter[] parameters = new Parameter[0];
        return (BStr) Automation.getDispatchProperty(this, "target", parameters, BStr.class);
    }

    public void setAlt(BStr param1) {
        Parameter[] parameters = new Parameter[] { param1 == null ? (Parameter) PTR_NULL : param1 };
        Automation.setDispatchProperty(this, "alt", parameters);
    }

    public BStr getAlt() {
        Parameter[] parameters = new Parameter[0];
        return (BStr) Automation.getDispatchProperty(this, "alt", parameters, BStr.class);
    }

    public void setNoHref(VariantBool param1) {
        Parameter[] parameters = new Parameter[] { param1 };
        Automation.setDispatchProperty(this, "noHref", parameters);
    }

    public VariantBool getNoHref() {
        Parameter[] parameters = new Parameter[0];
        return (VariantBool) Automation.getDispatchProperty(this, "noHref", parameters, VariantBool.class);
    }

    public void setHost(BStr param1) {
        Parameter[] parameters = new Parameter[] { param1 == null ? (Parameter) PTR_NULL : param1 };
        Automation.setDispatchProperty(this, "host", parameters);
    }

    public BStr getHost() {
        Parameter[] parameters = new Parameter[0];
        return (BStr) Automation.getDispatchProperty(this, "host", parameters, BStr.class);
    }

    public void setHostname(BStr param1) {
        Parameter[] parameters = new Parameter[] { param1 == null ? (Parameter) PTR_NULL : param1 };
        Automation.setDispatchProperty(this, "hostname", parameters);
    }

    public BStr getHostname() {
        Parameter[] parameters = new Parameter[0];
        return (BStr) Automation.getDispatchProperty(this, "hostname", parameters, BStr.class);
    }

    public void setPathname(BStr param1) {
        Parameter[] parameters = new Parameter[] { param1 == null ? (Parameter) PTR_NULL : param1 };
        Automation.setDispatchProperty(this, "pathname", parameters);
    }

    public BStr getPathname() {
        Parameter[] parameters = new Parameter[0];
        return (BStr) Automation.getDispatchProperty(this, "pathname", parameters, BStr.class);
    }

    public void setPort(BStr param1) {
        Parameter[] parameters = new Parameter[] { param1 == null ? (Parameter) PTR_NULL : param1 };
        Automation.setDispatchProperty(this, "port", parameters);
    }

    public BStr getPort() {
        Parameter[] parameters = new Parameter[0];
        return (BStr) Automation.getDispatchProperty(this, "port", parameters, BStr.class);
    }

    public void setProtocol(BStr param1) {
        Parameter[] parameters = new Parameter[] { param1 == null ? (Parameter) PTR_NULL : param1 };
        Automation.setDispatchProperty(this, "protocol", parameters);
    }

    public BStr getProtocol() {
        Parameter[] parameters = new Parameter[0];
        return (BStr) Automation.getDispatchProperty(this, "protocol", parameters, BStr.class);
    }

    public void setSearch(BStr param1) {
        Parameter[] parameters = new Parameter[] { param1 == null ? (Parameter) PTR_NULL : param1 };
        Automation.setDispatchProperty(this, "search", parameters);
    }

    public BStr getSearch() {
        Parameter[] parameters = new Parameter[0];
        return (BStr) Automation.getDispatchProperty(this, "search", parameters, BStr.class);
    }

    public void setHash(BStr param1) {
        Parameter[] parameters = new Parameter[] { param1 == null ? (Parameter) PTR_NULL : param1 };
        Automation.setDispatchProperty(this, "hash", parameters);
    }

    public BStr getHash() {
        Parameter[] parameters = new Parameter[0];
        return (BStr) Automation.getDispatchProperty(this, "hash", parameters, BStr.class);
    }
    ...
    public Object clone() {
        return new DispHTMLAreaElementImpl(this);
    }
}
