...
public class ConsoleCategory extends JOrganCategory {
    ...
    private static Configuration config = Configuration.getRoot().get(ConsoleCategory.class);

    private Model<Integer> grid = getModel(new Property(ConsolePanel.class, "grid"));

    private Model<Integer> threshold = getModel(new Property(ConsolePanel.class, "threshold"));

    private Model<Color> background = getModel(new Property(ConsolePanel.class, "background"));

    private Model<Color> foreground = getModel(new Property(ConsolePanel.class, "foreground"));

    private Model<Color> popupBackground = getModel(new Property(ConsolePanel.class, "popupBackground"));

    private Model<Color> elementForeground = getModel(new Property(View.class, "defaultColor"));

    private Model<Font> elementFont = getModel(new Property(View.class, "defaultFont"));

    private Model<Boolean> showShortcut = getModel(new Property(View.class, "showShortcut"));

    private Model<Color> shortcutColor = getModel(new Property(View.class, "shortcutColor"));

    private Model<Font> shortcutFont = getModel(new Property(View.class, "shortcutFont"));

    private JSpinner gridSpinner = new JSpinner(new SpinnerNumberModel(1, 1, 256, 1));

    private JSpinner thresholdSpinner = new JSpinner(new SpinnerNumberModel(1, 1, 16, 1));
    ...
    protected void read() {
        ...
        elementForegroundSelector.setSelectedColor(elementForeground.getValue());
