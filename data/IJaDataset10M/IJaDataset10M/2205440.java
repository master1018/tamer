...
public class ListReferencesAPI {
   ...
   */
    public Reference copyToUserStorage(Reference rootRef, Context context, ClientInfo clientInfo) throws SitoolsException, IOException {
        ...
        String urlReturn = settings.getPublicHostDomain() + settings.getString(Consts.APP_URL) + refReturn.toString().replace(RIAPUtils.getRiapBase(), "");
   ...
   *           if there is an error while creating the file
   */
    public Reference copyToAdminStorage(Context context, String folderName, String fileName, ClientInfo clientInfo) throws SitoolsException, IOException {
   ...
   *           if there is an error while creating the file
   */
    private Reference createAndCopyIndexFile(List<Reference> references, Boolean removeRIAP, Context context, Reference destReference, ClientInfo clientInfo) throws SitoolsException, IOException {
