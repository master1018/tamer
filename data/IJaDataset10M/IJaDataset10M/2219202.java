...
public final class ArmaImplTest {
    ...
    public void testArmaInterface() {
        Armamento arma = new ArmamentoImpl().withTipo(TipoDeArmamento.USO_PERMITIDO).withNumeroDeSerie(new Integer(0)).withNumeroDeSerieDoCano(new Integer(0)).withDescricao("abc");
