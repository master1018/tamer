 ...
 *
 * @author Slava Pestov
 * @version $Id: JEditTextArea.java,v 1.6 2008/09/16 09:00:03 ferra4models Exp $
 */
public class JEditTextArea extends JComponent {
    ...
    public int _offsetToX(int line, int offset) {
        ...
        if (tokenMarker == null) {
            ...
            Token tokens;
            if (painter.currentLineIndex == line && painter.currentLineTokens != null) tokens = painter.currentLineTokens; else {
            ...
            for (; ; ) {
                ...
                if (id == Token.NULL) fm = painter.getFontMetrics(); else fm = styles[id].getFontMetrics(defaultFont);
    ...
    public int xToOffset(int line, int x) {
        ...
        if (tokenMarker == null) {
            for (int i = 0; i < segmentCount; i++) {
                ...
                int charWidth;
                if (c == '\t') charWidth = (int) painter.nextTabStop(width, i) - width; else charWidth = fm.charWidth(c);
            ...
            for (; ; ) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    int charWidth;
                    if (c == '\t') charWidth = (int) painter.nextTabStop(width, offset + i) - width; else charWidth = fm.charWidth(c);
                    if (painter.isBlockCaretEnabled()) {
    ...
    public int getLineStartOffset(int line) {
        ...
        if (lineElement == null) return -1; else return lineElement.getStartOffset();
    }
    ...
    public int getLineEndOffset(int line) {
        Element lineElement = document.getDefaultRootElement().getElement(line);
        if (lineElement == null) return -1; else return lineElement.getEndOffset();
    }
    ...
    public int getLineLength(int line) {
        Element lineElement = document.getDefaultRootElement().getElement(line);
        if (lineElement == null) return -1; else return lineElement.getEndOffset() - lineElement.getStartOffset() - 1;
    }
    ...
    public String getText() {
        try {
            ...
            log.warn("BadLocationException was thrown. Message is : " + ble.getMessage(), ble);
            return null;
        }
    }
    ...
    public int getSelectionStart(int line) {
        if (line == selectionStartLine) return selectionStart; else if (rectSelect) {
    ...
    public int getSelectionEnd(int line) {
        if (line == selectionEndLine) return selectionEnd; else if (rectSelect) {
            Element map = document.getDefaultRootElement();
    ...
    public final String getSelectedText() {
        ...
        if (rectSelect) {
            ...
            for (int i = selectionStartLine; i <= selectionEndLine; i++) {
                ...
                if (i != selectionEndLine) buf.append(System.getProperty(EOL));
            }
            return buf.toString();
        } else {
    ...
    public void setSelectedText(String selectedText) {
        ...
        try {
            ...
            String msg;
            log.error(msg = "Cannot replace selection. Message is : " + ble.getMessage(), ble);
    ...
    public void overwriteSetSelectedText(String str) {
        ...
        try {
            ...
            log.warn("BadLocationException thrown. Message is : " + ble.getMessage(), ble);
        } finally {
            document.endCompoundEdit();
        }
    }
    ...
    protected void updateBracketHighlight(int newCaretPosition) {
        ...
        try {
            ...
            String msg;
            log.error(msg = "BadLocationException thrown. Message is : " + ble.getMessage(), ble);
        }
        bracketLine = bracketPosition = -1;
    }
    ...
    protected void documentChanged(DocumentEvent evt) {
        ...
        int count;
        if (ch == null) count = 0; else count = ch.getChildrenAdded().length - ch.getChildrenRemoved().length;
    ...
    class ScrollLayout implements LayoutManager {
        ...
        public void addLayoutComponent(String name, Component comp) {
            if (name.equals(CENTER)) center = comp; else if (name.equals(RIGHT)) right = comp; else if (name.equals(BOTTOM)) bottom = comp; else if (name.equals(LEFT_OF_SCROLLBAR)) leftOfScrollBar.addElement(comp);
        }

        public void removeLayoutComponent(Component comp) {
            if (center == comp) center = null;
            if (right == comp) right = null;
            if (bottom == comp) bottom = null; else leftOfScrollBar.removeElement(comp);
        }
    ...
    class AdjustHandler implements AdjustmentListener {
        ...
        public void adjustmentValueChanged(final AdjustmentEvent evt) {
            ...
            SwingUtilities.invokeLater(new Runnable() {
                ...
                public void run() {
                    if (evt.getAdjustable() == vertical) setFirstLine(vertical.getValue()); else setHorizontalOffset(-horizontal.getValue());
                }
            });
        }
    }
    ...
    class DocumentHandler implements DocumentListener {
        ...
        public void insertUpdate(DocumentEvent evt) {
            ...
            int newStart;
            int newEnd;
            if (selectionStart > offset || (selectionStart == selectionEnd && selectionStart == offset)) newStart = selectionStart + length; else newStart = selectionStart;
            if (selectionEnd >= offset) newEnd = selectionEnd + length; else newEnd = selectionEnd;
        ...
        public void removeUpdate(DocumentEvent evt) {
            ...
            if (selectionStart > offset) {
                if (selectionStart > offset + length) newStart = selectionStart - length; else newStart = offset;
            } else newStart = selectionStart;
            if (selectionEnd > offset) {
                if (selectionEnd > offset + length) newEnd = selectionEnd - length; else newEnd = offset;
