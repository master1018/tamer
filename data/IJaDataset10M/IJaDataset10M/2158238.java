...
public class DiscardTrain extends PossibleORAction {
    ...
    private transient List<TrainI> ownedTrains = null;
    ...
    private transient TrainI discardedTrain = null;
    ...
    public DiscardTrain(PublicCompanyI company, List<TrainI> trains, boolean forced) {
        this(company, trains);
        this.forced = forced;
    }
