...
public class ExecutionService {
    ...
    public Runnable createStoredProcedureRunnable(Connection con, ILaunchConfiguration configuration, boolean closeCon, IConnectionTracker tracker, DatabaseIdentifier databaseIdentifier) {
        return createCallableSQLResultRunnable(con, configuration, closeCon, tracker, databaseIdentifier);
    }
    ...
    public Runnable createFunctionRunnable(Connection con, String sql, boolean closeCon, IConnectionTracker tracker, IProgressMonitor parentMonitor, DatabaseIdentifier databaseIdentifier, ILaunchConfiguration configuration, HashMap addInfo) {
        return createSimpleSQLResultRunnable(con, sql, closeCon, tracker, parentMonitor, databaseIdentifier, configuration, addInfo);
    }
     ...
     * @deprecated for backward compatibility. Use createAdHocScriptRunnable instead 
     */
    public Runnable createCallableSQLResultRunnable(Connection con, ILaunchConfiguration configuration, boolean closeCon, IConnectionTracker tracker, DatabaseIdentifier databaseIdentifier) {
        return null;
    }
	 ...
	 * @return
	 */
    public Runnable createExecuteParallelRunnable(String sql, DatabaseIdentifier databaseIdentifier) {
        return null;
    }
