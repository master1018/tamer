 ...
 * Time: 14:12:54
 */
public class DtoAvailabilityServiceImpl extends AbstractDtoServiceImpl<AvailabilityDTO, AvailabilityDTOImpl, Availability> implements DtoAvailabilityService {
     ...
     */
    public DtoAvailabilityServiceImpl(final DtoFactory dtoFactory, final GenericService<Availability> availabilityGenericService) {
     ...
     * {@inheritDoc}
     */
    public AvailabilityDTO create(final AvailabilityDTO instance) throws UnmappedInterfaceException, UnableToCreateInstanceException {
