...
abstract class AbstractCache implements AuditableEventListener {
    ...
    protected AbstractCache() {
        primeCacheEvent = RegistryProperties.getInstance().getProperty("omar.server.cache.primeCacheEvent", "onCacheInit");
        if (cacheMgr == null) {
            try {
    ...
    protected static ServerRequestContext getCacheContext(String contextId) throws RegistryException {
    ...
    protected RegistryObjectType getRegistryObjectInternal(ServerRequestContext context, String id, String typeName) throws RegistryException {
    ...
    protected List executeQueryInternal(ServerRequestContext context, String sqlQuery, List queryParams, String tableName) throws RegistryException {
        List results = null;
        ...
        try {
            ...
            results = pm.executeSQLQuery(context, sqlQuery, queryParams, responseOption, tableName, objectRefs);
