...
import rpr2_d18.fixedRecordRepresentations.EnvironmentRecStruct;
 ...
 */
public class EnvironmentRecordList implements HLAfixedArray {

    ArrayList<EnvironmentRecStruct> value = new ArrayList<EnvironmentRecStruct>();

    /**
   * Constructor
   */
    public EnvironmentRecordList() throws RTIinternalError {
        value = new ArrayList<EnvironmentRecStruct>();
        for (int i = 0; i < value.size(); i++) value.add(new EnvironmentRecStruct());
    }
   ...
   */
    public EnvironmentRecStruct get(int index) {
   ...
   */
    public void addElement(DataElement newElement) {
        value.add((EnvironmentRecStruct) newElement);
    }
   ...
   */
    public void resize(int newSize) {
        ArrayList<EnvironmentRecStruct> tempValue = value;
        value = new ArrayList<EnvironmentRecStruct>(newSize);
        try {
            for (int i = 0; i < value.size(); i++) value.add(new EnvironmentRecStruct());
   ...
   */
    public ArrayList<EnvironmentRecStruct> getValue() {
        return value;
    }
   ...
   */
    public void setValue(ArrayList<EnvironmentRecStruct> newValue) throws RTIinternalError {
        value = new ArrayList<EnvironmentRecStruct>(newValue.size());
