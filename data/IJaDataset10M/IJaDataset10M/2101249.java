...
public class HeaderAndTailUtil {
     ...
     * @throws Exception
     */
    public static String getBanner(boolean loggedIn, String centralServer, String casServer, String searchServer, String returnUrlPath, String returnLogoutUrlPath, String query, Boolean populateSearchBox) throws Exception {
