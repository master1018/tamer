...
public class IDEJRManFramebufferImpl extends JInternalFrame implements Framebuffer {
    ...
    private ImageViewerPanelSaveAction save = new ImageViewerPanelSaveAction(imagePanel, BufferedImage.TYPE_INT_ARGB);
    ...
    public IDEJRManFramebufferImpl(String name, BufferedImage image) {
        ...
        MainMenuEventHandlers.getInstance(null).getIdeInstance().getWorkspaceDesktop().addInternalFrame(this, true);
    }
    ...
    private static final ResourceBundle messagesBundle = ResourceBundle.getBundle(net.falappa.imageio.ImageViewerPanelSaveAction.class.getPackage().getName() + ".res.ImageViewerPanelActions");
    ...
    public class ImageViewerPanelSaveAction extends AbstractAction {
        ...
        public ImageViewerPanelSaveAction(JImageViewerPanel viewerPanel, int imageType) {
            super(messagesBundle.getString("ImageViewerPanelSaveAction.Save_1"));
            assert viewerPanel != null;
            this.imageType = imageType;
            this.viewerPanel = viewerPanel;
            putValue(SHORT_DESCRIPTION, messagesBundle.getString("ImageViewerPanelSaveAction.Save_image_to_file_2"));
            putValue(SMALL_ICON, UIManager.getIcon("FileView.floppyDriveIcon"));
        }
        ...
        public void actionPerformed(ActionEvent e) {
            if (fc == null) {
                ...
                fc.setDialogTitle(messagesBundle.getString("ImageViewerPanelSaveAction.Choose_filename_to_save_4"));
                ...
                while (it.hasNext()) {
                    ...
                    if ((imageType == BufferedImage.TYPE_INT_ARGB || imageType == BufferedImage.TYPE_INT_ARGB_PRE) && "JPEG".equals(writer.getFormatNames()[0].toUpperCase())) continue;
            ...
            if (fc.showSaveDialog(viewerPanel) == JFileChooser.APPROVE_OPTION) {
                ...
                if (selectedFile != null) {
                    ...
                    if (selectedFile.exists()) {
                        String message = MessageFormat.format(messagesBundle.getString("ImageViewerPanelSaveAction.Overwrite_question_5"), fileName);
                        if (JOptionPane.NO_OPTION == JOptionPane.showConfirmDialog(viewerPanel, message, messagesBundle.getString("ImageViewerPanelSaveAction.Warning_6"), JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE)) return;
                    }
        ...
        private void writeToFile(File selectedFile, ImageWriterSpiFileFilter ff) {
            try {
                ...
                if (viewerPanel.getImage() instanceof BufferedImage) bufferedImage = (BufferedImage) viewerPanel.getImage(); else {
                ...
                JOptionPane.showMessageDialog(viewerPanel, messagesBundle.getString("ImageViewerPanelSaveAction." + "Error_during_image_saving_message_7"), messagesBundle.getString("ImageViewerPanelSaveAction." + "Error_dialog_title_8"), JOptionPane.ERROR_MESSAGE);
                ioe.printStackTrace();
            }
        }
    }
