...
public abstract class AbstractUMLConnectionEditPart extends AbstractConnectionEditPart implements PropertyChangeListener {
    ...
    protected void createEditPolicies() {
        ...
        installEditPolicy(EditPolicy.CONNECTION_BENDPOINTS_ROLE, new UMLConnectionBendpointEditPolicy());
    }
    ...
    protected void refreshBendpoints() {
        ...
        List bendpoints = ((AbstractUMLConnectionModel) getModel()).getBendpoints();
    ...
    private class MoveBendpointCommand extends BendpointCommand {
        ...
        public void execute() {
            ConnectionBendpoint bp = new ConnectionBendpoint(getFirstRelativeDimension(), getSecondRelativeDimension());
