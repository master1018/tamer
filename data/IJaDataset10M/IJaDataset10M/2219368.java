package viewer.geometry.manage.filetree;
...
public class Node extends Entry {
    ...
    /**
	 * Get the index of the denoted child entry. Indices for leafs are biased by the number of
	 * child nodes.
	 * 
	 * @param child
	 *            the object to lookup.
	 * @return the index of the child or -1 if not contained or not a Node or Leaf instance.
	 */
