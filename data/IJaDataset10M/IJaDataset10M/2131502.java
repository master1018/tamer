...
public abstract class FTBuilder extends IndexBuilder {
   ...
   */
    public static FTBuilder get(final Data d, final boolean wild) throws IOException {
   ...
   * @throws IOException IOException
   */
    protected final void writeFTData(final DataOutput out, final byte[] vpre, final byte[] vpos) throws IOException {
