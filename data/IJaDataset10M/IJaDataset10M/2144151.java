...
public class NLPlot extends NLControl {
    ...
    public String toString() {
        return "Plot(" + boundingBox.x + ", " + boundingBox.y + ", " + boundingBox.width + ", " + boundingBox.height + ", title=" + title + ", x-caption=" + xTitle + ", y-caption=" + yTitle + ", x-min=" + xMin + ", x-max=" + xMax + ", y-min=" + yMin + ", y-max=" + yMax + ", x-varies=" + unknownBool + ", y-varies=" + multipen + ", pens=" + pens + ")";
    }
}
