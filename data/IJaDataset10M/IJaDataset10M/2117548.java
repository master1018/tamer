...
public class Theme {
	 ...
	 */
    private static final double TITLE_BAR_SECONDARY_COLOR_MAX = 0.60;

    /**
	 * The percentage of the way down the menu bar that the secondary color
	 * used in the gradient fill is at its max.
	 */
    private static final double MENU_BAR_SECONDARY_COLOR_MAX = 0.10;

    /**
	 * The percentage of the way across the scrollbar that the secondary color
	 * used in the gradient fill is at its max.
	 */
    private static final double SCROLLBAR_SECONDARY_COLOR_MAX = 0.80;
