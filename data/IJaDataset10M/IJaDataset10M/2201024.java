package com.inetmon.jn.decoder.tools;
...
public class TimeStamp implements java.io.Serializable, Comparable {
    ...
    private static void appendHexString(StringBuffer buf, long l) {
        ...
        for (int i = s.length(); i < 8; i++) buf.append('0');
        buf.append(s);
    }
    ...
    public String toUTCString() {
        DateFormat formatter = null;
        if (utcFormatter != null) formatter = (DateFormat) utcFormatter.get();
        if (formatter == null) {
