...
public class EconomicClimate implements FreerailsSerializable {
    ...
    public static final EconomicClimate PROSPERITY = new EconomicClimate(i++, "PROSPERITY");

    public static final EconomicClimate MODERATION = new EconomicClimate(i++, "MODERATION");

    public static final EconomicClimate RECESSION = new EconomicClimate(i++, "RECESSION");
    ...
    public boolean equals(Object o) {
        ...
        if (name != null ? !name.equals(economicClimate.name) : economicClimate.name != null) {
            return false;
        }
        return true;
    }
