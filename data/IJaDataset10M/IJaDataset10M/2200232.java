...
public class TableImpl extends NamedColumnSetImpl implements Table {
    ...
    public void setIsTemporary(boolean newIsTemporary) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TABLE__IS_TEMPORARY, oldIsTemporary, isTemporary));
    }
    ...
    public void setTemporaryScope(String newTemporaryScope) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TABLE__TEMPORARY_SCOPE, oldTemporaryScope, temporaryScope));
    }
    ...
    public void setIsSystem(boolean newIsSystem) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TABLE__IS_SYSTEM, oldIsSystem, isSystem));
    }
