...
public class KtiConfigGroupTest extends MatsimTestCase {
    ...
    public void testKtiConfigGroup() {
        ...
        assertEquals(Double.parseDouble(KtiConfigGroup.KtiConfigParameter.CONST_BIKE.getDefaultValue()), testee.getConstBike());
        assertEquals(Double.parseDouble(KtiConfigGroup.KtiConfigParameter.CONST_CAR.getDefaultValue()), testee.getConstCar());
        ...
        assertEquals(Boolean.parseBoolean(KtiConfigGroup.KtiConfigParameter.USE_PLANS_CALC_ROUTE_KTI.getDefaultValue()), testee.isUsePlansCalcRouteKti());
