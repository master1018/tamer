...
public class GetAllImpl extends ExpressionImpl implements GetAll {
   ...
   */
    public void setExpression(Expression newExpression) {
        if (newExpression != expression) {
            ...
            if (expression != null) msgs = ((InternalEObject) expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesystemPackage.GET_ALL__EXPRESSION, null, msgs);
            if (newExpression != null) msgs = ((InternalEObject) newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesystemPackage.GET_ALL__EXPRESSION, null, msgs);
            msgs = basicSetExpression(newExpression, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, TypesystemPackage.GET_ALL__EXPRESSION, newExpression, newExpression));
    }
    ...
    public EStructuralFeature getMainfeature() {
        if (mainfeature != null && mainfeature.eIsProxy()) {
            ...
            if (mainfeature != oldMainfeature) {
                if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypesystemPackage.GET_ALL__MAINFEATURE, oldMainfeature, mainfeature));
            }
        }
        return mainfeature;
    }
   ...
   */
    public void setMainfeature(EStructuralFeature newMainfeature) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, TypesystemPackage.GET_ALL__MAINFEATURE, oldMainfeature, mainfeature));
    }
    ...
    public EStructuralFeature getExtendfeature() {
        if (extendfeature != null && extendfeature.eIsProxy()) {
            ...
            if (extendfeature != oldExtendfeature) {
                if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypesystemPackage.GET_ALL__EXTENDFEATURE, oldExtendfeature, extendfeature));
            }
        }
   ...
   */
    public void setExtendfeature(EStructuralFeature newExtendfeature) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, TypesystemPackage.GET_ALL__EXTENDFEATURE, oldExtendfeature, extendfeature));
    }
