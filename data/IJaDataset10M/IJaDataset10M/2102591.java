 ...
 */
@RunWith(Suite.class)
@SuiteClasses({ ExamplePersonTest.class, ExampleProgramerTest.class })
public class AllTests extends TestSuite {
    ...
    public static void main(String[] args) {
        try {
            if (args == null || args.length != 2 || !(args[1].equals("methods") || args[1].equals("nomethods"))) {
                throw new IllegalArgumentException("Usage: " + AllTests.class.getName() + "TestRunnerShortName (methods|nomethods)");
            }
            ...
            System.setProperty(CoverageLogPath.PROPERTY_PATH_VARIABLE, "testtarget/coverage_log_" + testRunnerName + suffix + ".clf");
