...
public class ProjectResources {
   ...
   */
    public static String createWebXmlSource(String servletName, String servletPath, String servletQualifiedClassName) {
        StringBuilder sb = new StringBuilder();
        sb.append("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n");
        sb.append("<web-app xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"\n");
        sb.append("xmlns=\"http://java.sun.com/xml/ns/javaee\"\n");
   ...
   */
    public static void reformatJavaSource(File file) throws CoreException {
        try {
            ...
            throw new CoreException(new Status(Status.ERROR, CorePlugin.PLUGIN_ID, "IOException while trying to reformat source code in new project"));
        }
    }
   ...
   */
    public static String reformatJavaSourceAsString(String source) {
        TextEdit reformatTextEdit = CodeFormatterUtil.format2(CodeFormatter.K_COMPILATION_UNIT, source, 0, (String) null, JavaCore.getOptions());
