...
public class ModelElementSelectionPage extends WizardPage {
    ...
    public void createControl(Composite parent) {
        ...
        modelVewer.setContentProvider(new AdapterFactoryContentProvider(EJBTool.deployment.part.EJBToolDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory()));
        modelVewer.setLabelProvider(new AdapterFactoryLabelProvider(EJBTool.deployment.part.EJBToolDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory()));
        if (selectedModelElement != null) {
            modelVewer.setInput(selectedModelElement.eResource());
            modelVewer.setSelection(new StructuredSelection(selectedModelElement));
        }
    ...
    protected String getSelectionTitle() {
        return EJBTool.deployment.part.Messages.ModelElementSelectionPageMessage;
    }
