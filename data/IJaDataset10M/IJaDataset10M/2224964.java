...
/**
 * A Pl0LayoutInformationAdapter is used to store layout information that is found
 ...
 * Pl0LayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class Pl0LayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
    private java.util.List<org.emftext.language.pl0.resource.pl0.mopp.Pl0LayoutInformation> layoutInformations = new java.util.ArrayList<org.emftext.language.pl0.resource.pl0.mopp.Pl0LayoutInformation>();
    ...
    public java.util.List<org.emftext.language.pl0.resource.pl0.mopp.Pl0LayoutInformation> getLayoutInformations() {
        return layoutInformations;
    }

    public void addLayoutInformation(org.emftext.language.pl0.resource.pl0.mopp.Pl0LayoutInformation layoutInformation) {
    ...
    public void replaceProxy(org.eclipse.emf.ecore.EObject proxy, org.eclipse.emf.ecore.EObject target) {
        for (org.emftext.language.pl0.resource.pl0.mopp.Pl0LayoutInformation layoutInformation : layoutInformations) {
