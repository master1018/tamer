 ...
 * @generated
 */
public class DriveDriveContentsCompartment2ViewFactory extends BasicNodeViewFactory {
    ...
    protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
        if (semanticHint == null) {
            semanticHint = FilesystemVisualIDRegistry.getType(DriveDriveContentsCompartment2EditPart.VISUAL_ID);
