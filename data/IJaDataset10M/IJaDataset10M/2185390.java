 ...
 * @author Rudolf Mayer
 * @version $Id: DataTypeListerServlet.java 2659 2008-06-24 22:17:08Z rosso_nero $
 */
public class DataTypeListerServlet extends DataServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (dd == null) {
            ...
            try {
                ...
                for (int i = 3; i < fields.size(); i++) {
                    if (i > 3) what = what + ", ";
                    what = what + "obj." + fields.elementAt(i) + " AS " + fields.elementAt(i);
                }
                String query = "SELECT obj as ptr, obj." + titleField + " as title" + ", obj." + otherField + " as other" + " FROM " + type + " obj";
                ...
                for (int i = 0; i < results.size(); i++) {
                    ...
                    writer.println("<td>");
                    writer.println("<a href=\"" + contextPath + "/dataView/" + type + "?ptr=" + ((Pointer) (results.elementAt(i)).get("ptr")).toExternalForm() + "\">");
    ...
    private void doDirectoryListing(HttpServletRequest request, HttpServletResponse response, PrintWriter writer) throws IOException, FileNotFoundException {
        ...
        if (u == null) throw new FileNotFoundException(virtualPath);
