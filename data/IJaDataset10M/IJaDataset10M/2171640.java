...
public class NavigationHeader extends JComponent {
    ...
    public NavigationHeader(Workspace workSpace) {
        ...
        this.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getPoint().getX() > NavigationHeader.this.getWidth() - 150) if (TransitionManager.isToolBarDisplay()) TransitionManager.hideToolBar(); else TransitionManager.showToolBar();
            }
    ...
    public void clearLinks() {
        while (buttonStack.size() > 0) remove(buttonStack.pop());
        revalidate();
        repaint();
        LastBttn = null;
    }
    ...
    private void paintBackground(final Graphics2D g2) {
        ...
        g2.drawImage(backgroundGradient, (int) bounds.getX(), 0, (int) bounds.getWidth(), height, null);
    ...
    private class PathButton extends JButton {
        ...
        private void setHyperlinkCursor(boolean hyperlink) {
            if (hyperlink) {
                ...
                int x = 10;
                if (this != buttonStack.get(0)) x += pathSeparatorRight.getWidth();
        ...
        public Dimension getPreferredSize() {
            ...
            if (this != buttonStack.peek()) width += pathSeparatorLeft.getWidth();
            if (this != buttonStack.get(0)) width += pathSeparatorRight.getWidth();
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (ghostValue > 0.0f && this != buttonStack.peek()) {
                ...
                g2.drawImage(haloPicture, x, 0, textWidth + 20, getHeight(), null);
            }
            float offset = 10.0f;
            ...
            g2.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, pathShadowOpacity));
            g2.setColor(pathShadowColor);
            layout.draw(g2, shadowOffsetX + offset, layout.getAscent() + layout.getDescent() + shadowOffsetY);
            g2.setComposite(composite);
            g2.setColor(pathColor);
            layout.draw(g2, offset, layout.getAscent() + layout.getDescent());
            if (this != buttonStack.peek()) {
                g2.drawImage(pathSeparatorLeft, getWidth() - pathSeparatorLeft.getWidth(), 0, null);
            }
            if (this != buttonStack.get(0)) {
        ...
        private final class AnimateGhost implements TimingTarget {
            ...
            public void timingEvent(float fraction) {
                ...
                if (ghostValue > 1.0f) ghostValue = 1.0f; else if (ghostValue < 0.0f) ghostValue = 0.0f;
                repaint();
            }
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            switch(index) {
                ...
                case 1:
                    ...
                    break;
                default:
                    if (pathButton.getText().equals("Project")) TransitionManager.showMainPoject(); else if (pathButton.getText().equals("Editeur")) TransitionManager.showProjectEdit(); else {
