...
public final class PredicateConstant {
     ...
     */
    public PredicateConstant(final PredicateKey key, final ElementList completeFormula, final ModuleContext context) {
        this.key = key;
        ...
        for (int i = 0; i < predicate.size() - 1; i++) {
            subjectVariables.add(new SubjectVariable(predicate.getElement(i + 1).getList().getElement(0).getAtom().getString()));
        }
    }
    ...
    public boolean equals(final Object obj) {
        ...
        return EqualsUtility.equals(getKey(), other.getKey()) && EqualsUtility.equals(getCompleteFormula(), other.getCompleteFormula());
    }
