package dplayer.core;

import java.util.Locale;
import dplayer.About;
import dplayer.core.AbstractSettings.File;
import dplayer.core.AbstractSettings.LoggerSection;
import dplayer.core.AbstractSettings.Property;
import dplayer.core.AbstractSettings.Section;
...
public final class Settings extends AbstractSettings {
    ...
    static {
        sFile = new File("dplayer.properties", new String[] { "dplayer properties", About.COPYRIGHT_LINE1, About.COPYRIGHT_LINE2 });
    }
    ...
    private static final Section LASTFM = new Section("last.fm settings");
    ...
    public static final Property HISTORY_FOLDER_SELECTED = new Property(AUTO, "history.folder.selected", "");
