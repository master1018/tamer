...
public class Thief_Forgery extends ThiefSkill {
    ...
    public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel) {
        ...
        if ((!target.isGeneric()) || ((!(target instanceof Scroll)) && (!CMLib.flags().isReadable(target)))) {
        ...
        } else beneficialVisualFizzle(mob, target, "<S-NAME> attempt(s) to forge " + forgeWhat + ", but fail(s).");
        return success;
    }
}
