package kr.ac.ssu.imc.durubi.report.designer.components.maskings;
...
public class DRPercentMasking extends DRMaskingSet {
    ...
    public DRPercentMasking(String maskName, int selectedColumn) {
        super(maskName, selectedColumn);
    }

    public DRPercentMasking() {
        super();
    }
   ...
   */
    public static DRPercentMasking createRDPercentMasking(org.w3c.dom.Element oElement, int sColumn) {
        ...
        DRPercentMasking oNewPercentMasking = new DRPercentMasking("�����", sColumn);
