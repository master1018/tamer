...
public class ClassFactoryClassPool extends ClassPool {
    ...
    private static final Method defineClass = findMethod("defineClass", String.class, byte[].class, int.class, int.class);

    private static final Method defineClassWithProtectionDomain = findMethod("defineClass", String.class, byte[].class, int.class, int.class, ProtectionDomain.class);
    ...
    public Class toClass(CtClass ct, ClassLoader loader, ProtectionDomain domain) throws CannotCompileException {
        ...
        try {
            ...
            Object[] args = hasDomain ? new Object[] { ct.getName(), b, 0, b.length, domain } : new Object[] { ct.getName(), b, 0, b.length };
