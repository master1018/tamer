...
public class GUIUtil {
     ...
     */
    public static void addComponent(Container container, Component c, int x, int y, int w, int h, int fill, int anchor, int wx, int wy) throws AWTException {
    ...
    public static void addComponent(Container container, Component c, int x, int y, int w, int h) throws AWTException {
        GridBagConstraints gbc = new GridBagConstraints();
        gbc.insets = new Insets(5, 5, 2, 2);
        gbc.gridx = x;
        gbc.gridy = y;
    ...
    public static Frame getTopestParent(Component component) {
        ...
        if (c instanceof Frame) return (Frame) c; else return null;
    }
}
