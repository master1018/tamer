...
public class ProfileLockDM extends VSMCall {
     ...
     */
    public ProfileLockDM(String hostname, int port, String userid, String password, String target_identifier) {
        this();
    ...
    public static void main(String[] argv) throws IOException, VSMException {
        ProfileLockDM instance = null;
        if (argv.length != 5) {
            System.out.println("usage: args are:\ninetaddr port user pw target_id");
            System.exit(1);
        }
        System.out.println("Args are: " + argv[0] + " " + argv[1] + " " + argv[2] + " " + argv[3] + " " + argv[4]);
        instance = new ProfileLockDM(argv[0], Integer.valueOf(argv[1]).intValue(), argv[2], argv[3], argv[4]);
