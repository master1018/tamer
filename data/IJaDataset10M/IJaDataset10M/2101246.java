package org.jwos.plugin.mail.domain;
...
public class EmailSensitivity {
    ...
    public static short valueOf(String val) {
        ...
        if (value.equals("personal")) return PERSONAL; else if (value.equals("private")) return PRIVATE; else if (value.indexOf("confidential") > 0) return CONFIDENTIAL; else return NORMAL;
    }
}
