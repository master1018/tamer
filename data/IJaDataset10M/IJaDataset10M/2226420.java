...
public class MissionPlayer extends Player implements ToXML {
    ...
    public boolean equals(Object obj) {
        ...
        if (mission == null) {
            if (other.mission != null) return false;
        } else if (!mission.equals(other.mission)) return false;
        if (sch == null) {
            if (other.sch != null) return false;
        } else if (!sch.equals(other.sch)) return false;
        return true;
    }
}
