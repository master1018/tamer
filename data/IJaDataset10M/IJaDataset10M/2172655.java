...
public class JavaTokenizer implements Tokenizer {
    ...
    public void tokenize(SourceCode sourceCode, Tokens tokenEntries) {
        ...
        TokenManager tokenMgr = languageVersionHandler.getParser(languageVersionHandler.getDefaultParserOptions()).getTokenManager(fileName, new StringReader(buffer.toString()));
        ...
        while (currentToken.image.length() > 0) {
            ...
            if (currentToken.kind != JavaParserConstants.SEMICOLON) {
                ...
                if (ignoreLiterals && (currentToken.kind == JavaParserConstants.STRING_LITERAL || currentToken.kind == JavaParserConstants.CHARACTER_LITERAL || currentToken.kind == JavaParserConstants.DECIMAL_LITERAL || currentToken.kind == JavaParserConstants.FLOATING_POINT_LITERAL)) {
