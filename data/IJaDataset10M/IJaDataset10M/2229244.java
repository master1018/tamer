...
public class HomePieceOfFurniture implements PieceOfFurniture, Serializable, Selectable {
   ...
   */
    public enum Property {
        ...
        NAME, NAME_VISIBLE, NAME_X_OFFSET, NAME_Y_OFFSET, NAME_STYLE, DESCRIPTION, WIDTH, DEPTH, HEIGHT, COLOR, TEXTURE, VISIBLE, X, Y, ELEVATION, ANGLE, MODEL_MIRRORED
    }
   ...
   */
    private Shape getShape() {
        if (this.shapeCache == null) {
            Rectangle2D pieceRectangle = new Rectangle2D.Float(getX() - getWidth() / 2, getY() - getDepth() / 2, getWidth(), getDepth());
