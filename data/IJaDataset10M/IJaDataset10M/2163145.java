...
public class Codes implements NdRuleAgentEventCodes {
    ...
    private static final Map EVENT_CODE_NAMES = new HashMap();

    private static final Map TRACE_EVENT_NAMES = new HashMap();

    private static final Map ORIGIN_CODE_NAMES = new HashMap();
