...
public class Operation extends Base {
    ...
    public static enum Operator {
        ...
        ADDITION {
            ...
            @Override
            public void compare(Value v, Value v1, Value v2) throws CajuScriptException {
        ...
        , LESS {
            ...
            public void compare(Value v, Value v1, Value v2) throws CajuScriptException {
                if (v1.getType() == Value.Type.NUMBER && v2.getType() == Value.Type.NUMBER) {
                    ...
                    v.setValue(v1.getStringValue().compareTo(v2.getStringValue()) < 0);
                }
            }
        }
        , GREATER {
        ...
        public abstract void compare(Value v, Value v1, Value v2) throws CajuScriptException;
    }
}
