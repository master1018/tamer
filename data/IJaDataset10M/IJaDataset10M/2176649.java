package org.jcvi.vics.web.gwt.detail.client;

import com.google.gwt.user.client.History;
import com.google.gwt.user.client.ui.*;
import org.jcvi.vics.web.gwt.common.client.panel.TitledBox;
import org.jcvi.vics.web.gwt.common.client.panel.TitledBoxActionLinkUtils;
...
import org.jcvi.vics.web.gwt.common.client.ui.link.BackActionLink;
...
import org.jcvi.vics.web.gwt.detail.client.util.MessageUtil;
...
public abstract class DetailSubPanel extends VerticalPanel {
    ...
    private static Logger logger = Logger.getLogger("org.jcvi.vics.web.gwt.detail.client.DetailSubPanel");
     ...
     */
    public Widget getTargetAccessionWidget(final String currentAcc, final String currentPanelLabel, final String targetAcc) {
        Widget targetAccessWidget = new Link(targetAcc, new ClickListener() {
            ...
            BackActionLink backToCurrentDetailLink = new BackActionLink("back to " + currentPanelLabel, new ClickListener() {
     ...
     *
     * @see org.jcvi.vics.web.gwt.detail.client.bse.read.ReadPanel for example override
     */
