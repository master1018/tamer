...
public class CoreTestFixtureTests {
    ...
    public void tConstructor() throws Exception {
        ...
        Set<Field> expectedMocks = Sets.newHashSet(testClass.getDeclaredField("mock1"), testClass.getDeclaredField("mock2"));
        assertEquals(expectedMocks, fixture.getMockFields());
        Set<Field> expectedStubs = Sets.newHashSet(testClass.getDeclaredField("stub1"), testClass.getDeclaredField("stub2"));
