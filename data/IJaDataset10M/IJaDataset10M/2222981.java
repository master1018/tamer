...
public class TestOneLevelSubpackageExtendedREF extends DmcNamedObjectNontransportableREF<TestOneLevelSubpackageExtendedDMO> {
    ...
    public static final DmcAttributeInfo __name = new DmcAttributeInfo("name", 2, "StringName", ValueTypeEnum.SINGLE, DataTypeEnum.PERSISTENT);
    ...
    public void setObject(TestOneLevelSubpackageExtendedDMO o) {
        object = o;
        if (object != null) myName = (DmcTypeStringNameSV) o.getObjectNameAttribute();
    }
    ...
    public void setName(DmcObjectName n) throws DmcValueException {
        if (myName == null) myName = new DmcTypeStringNameSV(__name);
        myName.set(n);
    }
