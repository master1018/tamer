...
import co.edu.unal.ungrid.image.dicom.core.AttributeTag;
import co.edu.unal.ungrid.image.dicom.core.DateAttribute;
import co.edu.unal.ungrid.image.dicom.core.DicomException;
import co.edu.unal.ungrid.image.dicom.core.TagFromName;
import co.edu.unal.ungrid.image.dicom.core.TimeAttribute;
import co.edu.unal.ungrid.image.dicom.core.ValueRepresentation;
...
public class DateTimeRangeMatch {
    ...
    /**
	 * @uml.property name="useTimeStampRatherThanDicomAttribute"
	 */
    boolean useTimeStampRatherThanDicomAttribute;

    /**
	 * @uml.property name="rangeMatch"
	 * @uml.associationEnd multiplicity="(1 1)"
	 *                     inverse="this$0:co.edu.unal.ungrid.image.dicom.database.DateTimeRangeMatch$RangeMatch"
	 */
    RangeMatch rangeMatch;

    /**
	 * @uml.property name="matchColumnName"
	 */
    String matchColumnName;

    Set<AttributeTag> alreadyUsed;
    ...
    private DateTimeRangeMatch(AttributeTag tag, AttributeList requestIdentifier, String columnName) {
        ...
        alreadyUsed = new HashSet<AttributeTag>();
                ...
                if (timeValue != null) {
                    ...
                    if (a != null) {
                        ...
                        if (value != null && value.length() > 0) {
                            byte[] vr = a.getValueRepresentation();
    ...
    static boolean addToMatchClause(StringBuffer b, String tableName, String columnName, AttributeTag tag, AttributeList requestIdentifier, Set<AttributeTag> alreadyUsed) {
        boolean found = false;
    ...
    public static void main(String[] arg) {
        try {
            StringBuffer b = new StringBuffer();
            Set<AttributeTag> alreadyUsed = new HashSet<AttributeTag>();
        ...
        try {
            ...
            AttributeList list = new AttributeList();
            {
                AttributeTag t = TagFromName.StudyDate;
                Attribute a = new DateAttribute(t);
                a.addValue("20030701-20030728");
                list.put(t, a);
            }
            {
                AttributeTag t = TagFromName.StudyTime;
                Attribute a = new TimeAttribute(t);
                a.addValue("010101-173500");
                list.put(t, a);
            }
            addToMatchClause(b, "STUDY", "STUDYDATE", TagFromName.StudyDate, list, alreadyUsed);
            addToMatchClause(b, "STUDY", "STUDYTIME", TagFromName.StudyTime, list, alreadyUsed);
