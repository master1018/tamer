...
public class ArrowButton extends JComponent {
    ...
    public void setArrowType(ArrowType arrowType) {
        ...
        if (arrowType.equals(ArrowType.DOUBLE_LEFT)) {
            ...
            gp.lineTo(getArrowScale(), getArrowScale() / 2);
            gp.lineTo(0, 0);
            gp.moveTo(getArrowScale(), 0);
            gp.lineTo(getArrowScale() + getArrowScale() / 4, 0);
            gp.lineTo(getArrowScale() + getArrowScale() / 4, getArrowScale());
            gp.lineTo(getArrowScale(), getArrowScale());
            gp.lineTo(getArrowScale(), 0);
   ...
   */
    ...
    protected void fireActionPerformed() {
        ActionEvent event = new ActionEvent(ArrowButton.this, ActionEvent.ACTION_PERFORMED, "linkClicked", System.currentTimeMillis(), 0);
    ...
    public static enum ArrowType {
        ...
        DOUBLE_LEFT, LEFT, DOUBLE_RIGHT, RIGHT, UP, DOWN, DOUBLE_UP, DOUBLE_DOWN, FIRST, LAST
    }
}
