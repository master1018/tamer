...
public class DocObject {
    ...
    public DocObject accumulate(String key, Object value) {
        ...
        if (object == null) {
            put(key, value instanceof DocArray ? new DocArray().put(value) : value);
    ...
    public DocObject append(String key, Object value) {
        ...
        if (object == null) {
            ...
            throw new DocException("DocObject[" + key + "] is not a DocArray.");
        }
        return this;
    }
    ...
    public boolean getBoolean(String key) {
        ...
        throw new DocException("DocObject[" + quote(key) + "] is not a Boolean.");
    }
    ...
    public double getDouble(String key) {
        ...
        try {
            ...
            throw new DocException("DocObject[" + quote(key) + "] is not a number.");
        }
    }
    ...
    public int getInt(String key) {
        ...
        try {
            ...
            throw new DocException("DocObject[" + quote(key) + "] is not an int.");
        }
    }
    ...
    public long getLong(String key) {
        ...
        try {
            ...
            throw new DocException("DocObject[" + quote(key) + "] is not a long.");
        }
    }
        ...
        if (o != null) {
            if (o instanceof Double) {
                if (((Double) o).isInfinite() || ((Double) o).isNaN()) {
                    throw new DocException("Doc does not allow non-finite numbers.");
                }
    ...
    public DocObject merge(DocObject otherDoc) {
        ...
        while (it.hasNext()) {
            ...
            if (value != null && value instanceof DocObject && otherValue instanceof DocObject) {
    ...
    public static String valueToString(Object value) {
        ...
        if (value instanceof Boolean || value instanceof DocObject || value instanceof DocArray) {
