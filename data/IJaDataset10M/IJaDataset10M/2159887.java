...
public class HasParentFilterWrapper extends Filter implements ActionListener {
    ...
    public NodeFilter getNodeFilter() {
        ...
        if (null != filter) ret.setParentFilter(((Filter) filter).getNodeFilter());
        return (ret);
    }
    ...
    public NodeFilter[] getSubNodeFilters() {
        ...
        NodeFilter[] ret;
        filter = mFilter.getParentFilter();
        if (null != filter) ret = new NodeFilter[] { filter }; else ret = new NodeFilter[0];
        return (ret);
    }
    ...
    public void setSubNodeFilters(NodeFilter[] filters) {
        if (0 != filters.length) mFilter.setParentFilter(filters[0]); else mFilter.setParentFilter(null);
    }
    ...
    public String toJavaCode(StringBuffer out, int[] context) {
        String name;
        String ret;
        if (null != mFilter.getParentFilter()) name = ((Filter) mFilter.getParentFilter()).toJavaCode(out, context); else name = null;
