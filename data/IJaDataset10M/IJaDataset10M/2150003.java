...
public class IterableConverter extends TypeConverter {
    ...
    protected boolean isSupported(Class c, MappedField mf) {
        if (mf != null) return mf.isMultipleValues() && !mf.isMap(); else return c.isArray() || ReflectionUtils.implementsInterface(c, Iterable.class);
    }
    ...
    public Object encode(Object value, MappedField mf) {
        ...
        if (value.getClass().isArray()) {
            ...
            if (!(value instanceof Iterable)) throw new ConverterException("Cannot cast " + value.getClass() + " to Iterable for MappedField: " + mf);
