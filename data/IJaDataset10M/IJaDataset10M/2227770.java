...
public abstract class NodeAdapter implements Node {
    ...
    public Node getPreviousSibling() {
        ...
        if (this.ordinal <= 0) return null; else return this.parent.getChildNodes().item(this.ordinal - 1);
    }
    ...
    public Node getNextSibling() {
        ...
        if (this.ordinal >= (this.parent.getChildNodes().getLength() - 1)) return null; else return this.parent.getChildNodes().item(this.ordinal + 1);
    }
    ...
    public void setNodeValue(String nodeValue) throws DOMException {
        log.info("NodeAdapter: UnsupportedOperationException Thrown");
