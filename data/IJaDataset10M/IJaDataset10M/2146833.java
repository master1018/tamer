...
public class JolieDummyCreator {
    ...
    public static void main(String[] args) throws IOException {
        try {
            ...
            Program program = ParsingUtils.parseProgram(cmdParser.programStream(), URI.create("file:" + cmdParser.programFilepath()), cmdParser.includePaths(), JolieDummyCreator.class.getClassLoader(), cmdParser.definedConstants());
