 ...
 * @param <E>
 */
public abstract class SimplifiedList<E> implements List<E> {

    protected abstract boolean kernelCreate(int index, E element);

    protected abstract E kernelRead(int index);

    protected abstract E kernelUpdate(int index, E element);

    protected abstract boolean kernelDelete(int index);

    protected abstract void kernelClear();

    protected abstract int kernelIndexOf(Object e);

    protected abstract int kernelSize();

    protected abstract ListIterator<E> kernelIterator(int start);
