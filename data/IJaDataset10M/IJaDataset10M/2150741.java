...
public class NodeFormat {
    ...
    public static final NodeFormat KEEP_NUMBERS = new NodeFormat(new RegexFormatCallback("[^\\d]"));

    public static final NodeFormat PARSE_FLOAT = new NodeFormat(new RegexFormatCallback("^.*?(\\d+(?:\\.\\d+)?|\\.\\d+).*?$", 1));
