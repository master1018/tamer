...
public class ProjectTreeDialog extends JDialog implements TreeSelectionListener {
    ...
    private final JButton okButton = ModelerSession.getComponentFactoryService().createButton(ModelerSession.getCommonResourceBundle().getString("modeler.ok"), null);

    private final JButton cancelButton = ModelerSession.getComponentFactoryService().createButton(ModelerSession.getCommonResourceBundle().getString("modeler.cancel"), null);
        ...
        okButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if ((uuid != null) && (processVertex != null)) {
                    ...
                    ModelerSession.getProjectControlService().registerDiagramListener(projectDiagram, processVertex);
                }
                disposeDialog();
            }
        });
