...
public class XProperties {
    ...
    public void registerPersistenceDelegates() {
        ...
        encoder.setPersistenceDelegate(SortKeyState.class, new DefaultPersistenceDelegate(new String[] { "ascending", "modelIndex", "comparator" }));
        ...
        encoder.setPersistenceDelegate(XTableState.class, new DefaultPersistenceDelegate(new String[] { "columnStates", "sortKeyState", "horizontalScrollEnabled" }));
    }
    ...
    public static class XTableProperty implements Property {
        ...
        public void setSessionState(Component c, Object state) {
            ...
            if (tableState.getSortKey() != null) {
                table.getFilters().getSortController().setSortKeys(Collections.singletonList(tableState.getSortKey()));
            }
        }
    ...
    public static class SortKeyState {
         ...
         * @param comparator
         */
        public SortKeyState(boolean ascending, int modelIndex, Comparator comparator) {
