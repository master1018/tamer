...
/**
 * @author mog
 * @version $Id: PassiveConnection.java 411 2004-02-10 00:03:32Z mog $
 */
public class PassiveConnection extends Connection {
    ...
    public PassiveConnection(SSLContext ctx, PortRange portRange, InetSocketAddress bindAddr) throws IOException {
        if (ctx != null) {
            SSLServerSocket sslserver;
            sslserver = (SSLServerSocket) ctx.getServerSocketFactory().createServerSocket();
            _server = sslserver;
        } else {
