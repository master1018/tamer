...
public class Draw {
	 ...
	 */
    public static synchronized Draw getInstance() {
        return instance;
    }
    ...
    /**
	 * Returns true if shape AABBs should be drawn.
	 * @return boolean
	 * @since 3.0.0
	 */
    ...
    /**
	 * Sets whether AABBs should be drawn.
	 * @param flag true if shape AABBs should be drawn
	 * @since 3.0.0
	 */
    public synchronized void setDrawAABBs(boolean flag) {
        this.aabbs = flag;
    }
    ...
    /**
	 * Sets the color to use when drawing AABBs.
	 * @param color the color
	 * @since 3.0.0
	 */
    public synchronized void setAABBColor(float[] color) {
        if (color == null) throw new NullPointerException("The AABB color cannot be null.");
        if (color.length != 4) throw new IndexOutOfBoundsException("Colors must be arrays of 4 elements.");
        this.aabbColor = color;
    }

    /**
	 * Returns the color used when drawing AABBs.
	 * @return float[]
	 * @since 3.0.0
	 */
    public float[] getAABBColor() {
        return this.aabbColor;
    }
