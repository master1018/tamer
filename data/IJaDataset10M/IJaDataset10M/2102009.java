...
public class CUtil {
    ...
    public static File[] getPathFromEnvironment(String envVariable, String delim) {
        if (System.getProperty("os.name").equals("OS/400")) return new File[] {};
    ...
    public static String getRelativePath(final String base, final File targetFile) {
        try {
            ...
            if (System.getProperty("os.name").equals("OS/400")) canonicalTarget = targetFile.getPath(); else canonicalTarget = targetFile.getCanonicalPath();
    ...
    public static int runCommand(CCTask task, File workingDir, String[] cmdline, boolean newEnvironment, Environment env) throws BuildException {
        try {
            ...
            if (System.getProperty("os.name").equals("OS/390")) exe.setVMLauncher(false);
