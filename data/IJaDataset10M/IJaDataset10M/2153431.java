...
public class EgovServerResrceMntrngController {
    ...
    public String selectMntrngServerList(@ModelAttribute("serverResrceMntrngVO") ServerResrceMntrngVO serverResrceMntrngVO, ModelMap model) throws Exception {
    ...
    public String selectServerResrceMntrngListView(@ModelAttribute("pmServerResrceMntrng") ServerResrceMntrngVO pmServerResrceMntrng, ModelMap model) throws Exception {
    ...
    public String selectServerResrceMntrngList(@ModelAttribute("serverResrceMntrngVO") ServerResrceMntrngVO serverResrceMntrngVO, @ModelAttribute("pmServerResrceMntrng") ServerResrceMntrngVO pmServerResrceMntrng, ModelMap model) throws Exception {
        PaginationInfo paginationInfo = new PaginationInfo();
        paginationInfo.setCurrentPageNo(serverResrceMntrngVO.getPageIndex());
        paginationInfo.setRecordCountPerPage(serverResrceMntrngVO.getPageUnit());
        paginationInfo.setPageSize(serverResrceMntrngVO.getPageSize());
    ...
    public String selectServerResrceMntrng(@RequestParam("logId") String logId, @RequestParam("strStartDt") String strStartDt, @RequestParam("strEndDt") String strEndDt, @ModelAttribute("serverResrceMntrngVO") ServerResrceMntrngVO serverResrceMntrngVO, @ModelAttribute("pmServerResrceMntrng") ServerResrceMntrngVO pmServerResrceMntrng, ModelMap model) throws Exception {
