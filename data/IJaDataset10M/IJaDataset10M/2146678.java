...
Document sequence number of the document */
    ...
    public void setEDIStatus(String EDIStatus) {
        if (EDIStatus.equals("D") || EDIStatus.equals("S") || EDIStatus.equals("A") || EDIStatus.equals("C")) ; else throw new IllegalArgumentException("EDIStatus Invalid value - Reference_ID=202 - D - S - A - C");
...
Type of credit card transaction */
    public void setTrxType(String TrxType) {
        if (TrxType.equals("I") || TrxType.equals("O")) ; else throw new IllegalArgumentException("TrxType Invalid value - Reference_ID=203 - I - O");
