...
/**
* org/fudaa/dodico/corba/navigation/_IEtudeNavigationFluvialeStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from C:/devel/fudaa/fudaa_devel/dodico/idl/metier/navigation.idl
* mercredi 6 ao�t 2008 22 h 27 CEST
*/
public class _IEtudeNavigationFluvialeStub extends org.omg.CORBA.portable.ObjectImpl implements org.fudaa.dodico.corba.navigation.IEtudeNavigationFluviale {

    public void calculerAvec(org.fudaa.dodico.corba.navigation.ISimulateurNavigationFluviale simulateur) {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("calculerAvec", true);
            org.fudaa.dodico.corba.navigation.ISimulateurNavigationFluvialeHelper.write($out, simulateur);
            $in = _invoke($out);
            return;
            ...
            calculerAvec(simulateur);
        } finally {
            _releaseReply($in);
        }
    }

    public org.fudaa.dodico.corba.navigation.IReseauFluvial reseau() {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("_get_reseau", true);
            $in = _invoke($out);
            org.fudaa.dodico.corba.navigation.IReseauFluvial $result = org.fudaa.dodico.corba.navigation.IReseauFluvialHelper.read($in);
            return $result;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
            String _id = $ex.getId();
    ...
    public void reseau(org.fudaa.dodico.corba.navigation.IReseauFluvial newReseau) {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("_set_reseau", true);
            org.fudaa.dodico.corba.navigation.IReseauFluvialHelper.write($out, newReseau);
            $in = _invoke($out);
            return;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
    ...
    public String descriptionGraphiqueDja() {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("_get_descriptionGraphiqueDja", true);
            $in = _invoke($out);
            ...
            return descriptionGraphiqueDja();
        } finally {
            _releaseReply($in);
        }
    }

    public void descriptionGraphiqueDja(String newDescriptionGraphiqueDja) {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("_set_descriptionGraphiqueDja", true);
            org.fudaa.dodico.corba.base.ChaineHelper.write($out, newDescriptionGraphiqueDja);
            $in = _invoke($out);
            return;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
            ...
            descriptionGraphiqueDja(newDescriptionGraphiqueDja);
        } finally {
            _releaseReply($in);
        }
    }
    ...
    public byte[] toByteArray() {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("toByteArray", true);
            $in = _invoke($out);
            byte $result[] = org.fudaa.dodico.corba.base.BinaireHelper.read($in);
            return $result;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
            String _id = $ex.getId();
    ...
    private static String[] __ids = { "IDL:navigation/IEtudeNavigationFluviale:1.0", "IDL:navigation/IEtudeNavigation:1.0", "IDL:objet/IObjet:1.0" };
