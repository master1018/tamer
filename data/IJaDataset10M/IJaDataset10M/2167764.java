...
public class ContainerEntry extends JPanel {
    ...
    public ContainerEntry(MapController controller, ContainerManager cm, String containerURI, String fallbackLabel, Boolean required) {
        super();
        ...
        setSelected(controller.getConceptMap().getComponentManager().getContainerVisible(URI.create(containerURI)));
        add(cb);
        add(label);
        ...
        if (highlighted != b) {
            ...
            if (highlighted) {
                ...
                while (mapObjects.hasNext()) {
                    ...
                    if (c.getComponentManager().getLoadedRelevantContainers().contains(URI.create(containerURI)) || dl.getLoadContainer().equals(containerURI)) {
