...
public class Usb_Endpoint_Descriptor extends Usb_Descriptor {
	 ...
	 */
    public static final int USB_ENDPOINT_ADDRESS_MASK = 0x0f, USB_ENDPOINT_DIR_MASK = 0x80;
	 ...
	 */
    public static final int USB_ENDPOINT_TYPE_CONTROL = 0, USB_ENDPOINT_TYPE_ISOCHRONOUS = 1, USB_ENDPOINT_TYPE_BULK = 2, USB_ENDPOINT_TYPE_INTERRUPT = 3;
    ...
    private Usb_Endpoint_Descriptor extra;
    ...
    public String toString() {
        return "Usb_Endpoint_Descriptor bEndpointAddress: 0x" + Integer.toHexString(bEndpointAddress & 0xFF);
    }
}
