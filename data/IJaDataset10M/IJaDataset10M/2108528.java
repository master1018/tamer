...
public class PrettyLabeler {
    ...
    public static Data[] relabelWithFileName(Data[] data, File file) {
        ...
        for (Data datum : data) {
            Dictionary<String, Object> labeledDatumMetadata = DictionaryUtilities.copy(datum.getMetadata());
            Data labeledDatum = new BasicData(labeledDatumMetadata, datum.getData(), datum.getFormat());
