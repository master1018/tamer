...
public class DbxrefTableCellEditor extends AbstractCellEditor implements TableCellEditor {
    ...
    public DbxrefTableCellEditor() {
        ...
        editorPanel.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), "tabForward");
        editorPanel.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(KeyStroke.getKeyStroke(KeyEvent.VK_TAB, 0), "tabForward");
        editorPanel.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(KeyStroke.getKeyStroke(KeyEvent.VK_TAB, KeyEvent.SHIFT_DOWN_MASK), "tabBackward");
        editorPanel.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, KeyEvent.CTRL_DOWN_MASK), "commit");
    ...
    protected void tabToNext() {
        Component lastComponent = editorPanel.getFocusTraversalPolicy().getLastComponent(editorPanel);
    ...
    public boolean isCellEditable(EventObject e) {
        if (e == null || e instanceof MouseEvent && ((MouseEvent) e).getClickCount() == 2) return super.isCellEditable(e); else return false;
    }
    ...
    public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
        ...
        if (value instanceof Dbxref) {
            ...
            double[][] sizes = { { TableLayout.PREFERRED, 10, TableLayout.FILL }, { TableLayout.PREFERRED, TableLayout.PREFERRED, TableLayout.PREFERRED, TableLayout.PREFERRED } };
