...
public class XMLReferenceValidatorsManager extends AbstractRegistryManager {
        ...
        for (IConfigurationElement ce : cf) {
            if (FILTER_ELT.equals(ce.getName())) {
                ...
                try {
                    ...
                    Trace.trace(Trace.SEVERE, "  Could not load XML references validators for id: " + id, t);
                }
            }
        }
    }
    ...
    private synchronized void loadXMLReferenceValidators() {
        ...
        if (registry != null) {
            IConfigurationElement[] cf = registry.getConfigurationElementsFor(XMLSearchEditorPlugin.PLUGIN_ID, XML_REFERENCE_FILTERS_EXTENSION_POINT);
