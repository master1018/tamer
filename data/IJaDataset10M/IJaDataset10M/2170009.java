...
/**
 * Defines pull parameter.
 * 
 * @author Benjamin de Dardel <ant4hg[at]free.fr>
 * @since V0.5
 */
public class PullParameter extends Parameter {

    /**
     * Defines commands that use this parameter.
     */
    public static final String[] AUTHORIZED_COMMANDS = new String[] { "clone" };
     ...
     * 
     */
    public PullParameter() {
        super("pull", AUTHORIZED_COMMANDS, REQUIRED_VALUES);
    }
     ...
     *            , the parameter value.
     */
    public PullParameter(String value) {
        this();
        setValue(value);
    }
    ...
    public void initArgument(ArgumentFriender friend) {
        if (!isSet()) {
            Logger.error("PARAMETER pull NOT NULL, BUT NOT SET");
            return;
        }
        if (isTrue()) {
            friend.setArgument("--pull");
        }
    }
}
