 ...
 */
final class VerboseThreadFactory implements ThreadFactory, Thread.UncaughtExceptionHandler {
    ...
    public VerboseThreadFactory(Logger log, ThreadFactory factory) {
        this.log = log;
        this.factory = factory != null ? factory : Executors.defaultThreadFactory();
    }
