...
import lcd_api.messages.outbound.ScreenDelete;
import org.junit.After;
import org.junit.Before;

/**
 * A test of the ScreenDelete OutboundMessage. This message contains one single
 * attribute that is required.
 * 
 * @author Robert Derelanko
 */
public class ScreenDeleteTest extends TestCase {
    ...
    public void test_getMessage_Empty() {
        ...
        ScreenDelete theMessage = new ScreenDelete();
        assertNotNull(theMessage);
    ...
    public void test_setScreenID_Good() {
        ...
        assertEquals("screen_del Screen_1", messageString);
        System.out.println(PASSED);
    }
