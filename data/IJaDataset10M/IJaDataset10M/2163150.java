...
public class ActionBuilder {
    ...
    public ActionBuilder(MethodForm methodForm, Controller controller, ValidatorProvider validatorProvider, ControllerBuilder controllerBuilder) {
    ...
    public ParameterBuilder addParameter(String name, ScopeType scope, EnumerationType enumProperty, Class classType) {
        return addParameter(name, scope, enumProperty, null, null, null, null, false, classType);
    }
    ...
    public ParameterBuilder addNullParameter() {
        return addParameter(null, null, null, null, null, null, null, false, null);
    }
    ...
    public ParameterBuilder addParameter(String name, ScopeType scope, String temporalProperty, Class classType) {
        return addParameter(name, scope, EnumerationType.ORDINAL, temporalProperty, null, null, null, false, classType);
    }
    ...
    public ParameterBuilder addParameter(String name, ScopeType scope, Type type) {
        return addParameter(name, scope, EnumerationType.ORDINAL, "dd/MM/yyyy", null, type, null, false, type.getClassType());
    }
    ...
    public ParameterBuilder addParameter(String name, EnumerationType enumProperty, Class classType) {
        return addParameter(name, ScopeType.PARAM, enumProperty, null, null, null, null, false, classType);
    }
    ...
    public ParameterBuilder addParameter(String name, ScopeType scope, Class classType) {
        return addParameter(name, scope, EnumerationType.ORDINAL, "dd/MM/yyyy", null, null, null, false, classType);
    }
    ...
    public ParameterBuilder addParameter(String name, String temporalProperty, Class classType) {
        return addParameter(name, ScopeType.PARAM, EnumerationType.ORDINAL, temporalProperty, null, null, null, false, classType);
    }
    ...
    public ParameterBuilder addParameter(String name, Type type) {
        return addParameter(name, ScopeType.PARAM, EnumerationType.ORDINAL, "dd/MM/yyyy", null, type, null, false, type.getClassType());
    }
    ...
    public ParameterBuilder addParameterMapping(String mapping, Class classType) {
        return addParameter(null, ScopeType.PARAM, EnumerationType.ORDINAL, "dd/MM/yyyy", mapping, null, null, false, classType);
    }
    ...
    public ParameterBuilder addParameterMapping(String name, String mapping, Class classType) {
        return addParameter(name, ScopeType.PARAM, EnumerationType.ORDINAL, "dd/MM/yyyy", mapping, null, null, false, classType);
    }
    ...
    public ParameterBuilder addParameterMapping(String name, String mapping, ScopeType scope, Class classType) {
        return addParameter(name, scope, EnumerationType.ORDINAL, "dd/MM/yyyy", mapping, null, null, false, classType);
    }
    ...
    public ParameterBuilder addParameter(String name, Class classType) {
        return addParameter(name, ScopeType.PARAM, EnumerationType.ORDINAL, "dd/MM/yyyy", null, null, null, false, classType);
    }
    ...
    public BeanBuilder buildParameter(Class classType) {
        String beanName = this.methodForm.getName() + "#" + this.methodForm.getParamterSize();
        BeanBuilder bb = this.controllerBuilder.buildMappingBean(beanName, classType);
    ...
    public BeanBuilder buildParameter(Class classType, Class beanType) {
        String beanName = this.methodForm.getName() + "#" + this.methodForm.getParamterSize();
        BeanBuilder bb = this.controllerBuilder.buildMappingBean(beanName, beanType);
        this.addParameterMapping(beanName, classType);
        return bb;
    }
    ...
    public ParameterBuilder addStaticParameter(Class classType, Object value) {
        return addParameter(null, ScopeType.PARAM, EnumerationType.ORDINAL, "dd/MM/yyyy", null, null, value, false, classType);
    }
     ...
     * @return Contrutor do par�metro.
     */
    public ParameterBuilder addParameter(String name, ScopeType scope, EnumerationType enumProperty, String temporalProperty, String mapping, Type type, Object value, boolean nullable, Class classType) {
        ...
        if (mapping != null) {
            if (controller.getMappingBeans().containsKey(mapping)) useBean.setMapping(controller.getMappingBean(mapping)); else throw new BrutosException("mapping name " + mapping + " not found!");
        }
        if (type != null) {
            useBean.setType(type);
            if (classType != null && !classType.isAssignableFrom(useBean.getType().getClassType())) throw new BrutosException("expected " + classType.getName() + " found " + type.getClassType().getName());
        } else if (classType != null && mapping == null) {
            try {
                useBean.setType(Types.getType(classType));
            } catch (UnknownTypeException e) {
                throw new UnknownTypeException(String.format("%s.%s(...) index %d : %s", new Object[] { this.controller.getClassType().getName(), methodForm.getMethodName(), new Integer(methodForm.getParamterSize()), e.getMessage() }), e);
            }
            if (useBean.getType() == null) throw new UnknownTypeException(classType.getName());
        }
    ...
    public ActionBuilder addThrowable(Class target, String view, String id, DispatcherType dispatcher) {
        ...
        if (target == null) throw new BrutosException("target is required: " + controller.getClassType().getName());
        if (!Throwable.class.isAssignableFrom(target)) throw new BrutosException("target is not allowed: " + target.getName());
