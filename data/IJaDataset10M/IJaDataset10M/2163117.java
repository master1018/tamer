...
public class TextTreeTableTest {
    ...
    public void printTableWithThreeColumns() {
        ...
        String[][] data = { { "val10", "val20", "val30" }, { "val13", "val20", "val30" }, { "val12", "val21", "val31" }, { "val11", "val21", "val31" }, { "val12", "val25", "val31" }, { "val11", "val21", "val31" } };
    ...
    public void printTableWithTwoColumns() {
        ...
        String[][] data = { { "val10", "val20" }, { "val13", "val20" }, { "val12", "val21" }, { "val11", "val21" }, { "val12", "val25" }, { "val11", "val21" } };
    ...
    public void printTableWithOneColumn() {
        ...
        String[][] data = { { "val10" }, { "val13" }, { "val12" }, { "val11" }, { "val12" }, { "val11" } };
        TextTable tt = new TextTable(titles, data);
        tt.setSort(0);
        tt.printTable();
    }
