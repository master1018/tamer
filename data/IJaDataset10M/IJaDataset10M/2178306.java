...
public class ViewSwitcherTest extends AndroidTestCase {
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test constructor(s) of {@link ViewSwitcher}", method = "ViewSwitcher", args = { android.content.Context.class }), @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test constructor(s) of {@link ViewSwitcher}", method = "ViewSwitcher", args = { android.content.Context.class, android.util.AttributeSet.class }) })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test {@link ViewSwitcher#setFactory(ViewFactory)}", method = "setFactory", args = { android.widget.ViewSwitcher.ViewFactory.class })
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test {@link ViewSwitcher#getNextView()}", method = "getNextView", args = {  }), @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test {@link ViewSwitcher#getNextView()}", method = "addView", args = { android.view.View.class, int.class, android.view.ViewGroup.LayoutParams.class }) })
