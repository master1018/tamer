...
public class DrawableSequence extends Sequence {
   ...
   */
    ...
    public boolean colourText;

    public Vector textColour;
   ...
   */
    ...
    public void setPDBfile(PDBfile pdb) {
        ...
        for (int i = 0; i < pdb.chains.size(); i++) {
            ...
            as.traceAlignment();
            as.printAlignment();
            System.out.println("Score = " + as.getMaxScore());
            if (as.getMaxScore() > max) {
                System.out.println("New max score");
                max = as.getMaxScore();
                maxchain = i;
                pdbstart = as.getSeq2Start();
                pdbend = as.getSeq2End();
                seqstart = as.getSeq1Start() + start - 1;
                seqend = as.getSeq1End() + end - 1;
            }
