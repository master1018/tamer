 ...
 */
    public ImageField(Long id, Report report, Section section, Object value, boolean visible) {
 ...
 */
    public ImageIcon getImageIcon() {
        if (isVisible()) return getVisibleImageIcon(); else return getHiddenImageIcon();
    }
 ...
 */
    public ImageIcon getVisibleImageIcon() {
        if (imageIcon == null && value != null) imageIcon = new ImageIcon(getImageURL());
        return imageIcon;
    }
 ...
 */
    public ImageIcon getHiddenImageIcon() {
        if (hiddenImageIcon == null && value != null && canLoad()) {
            ...
            if (ii != null) {
                hiddenImageIcon = new ImageIcon(GrayFilter.createDisabledImage(ii.getImage()));
            }
        }
 ...
 */
    public void setValue(Object newValue) {
        ...
        if (str.indexOf(":/") == -1 && !str.startsWith("file:")) str = "file:" + str;
        try {
    ...
    public boolean canLoad() {
        return getVisibleImageIcon() != null && getVisibleImageIcon().getImageLoadStatus() == MediaTracker.COMPLETE;
    }
