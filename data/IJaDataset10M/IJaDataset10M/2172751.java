...
/**
 * Add validator support, that validate ResultSet, if is not valid, move to next
 * or previous result set. This implementation ensures that the validation method
 * is invoked only once per object.
 * 
