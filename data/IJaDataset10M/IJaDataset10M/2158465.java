 ...
 * @version $Rev: 1162 $ $Date: 2009-08-10 15:28:53 -0400 (Mon, 10 Aug 2009) $
 */
public interface AccountDAO extends UserDetailsService {
     ...
     * @throws DataAccessException
     */
    void storeActivationCode(String username, String code) throws DataAccessException;
     ...
     * @throws DataAccessException
     */
    boolean isValidActivationCode(String username, String code) throws DataAccessException;
     ...
     * @throws DataAccessException
     */
    public List<Account> getUsers(Long start, int amount) throws DataAccessException;
     ...
     * @throws DataAccessException
     */
    public List<Account> getUsersSinceTime(Date time, Long start, int amount) throws DataAccessException;
