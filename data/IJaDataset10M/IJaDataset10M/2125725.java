...
public abstract class ControlEdge extends Entity {
   ...
   */
    private boolean isSane() {
        return (okSourceSink(getSource(), getSink()) && (!sourceIsSecondary() | (getSource() != null)) && (!sinkIsSecondary() | (getSink() != null)));
    }
   ...
   */
    private static boolean okSourceSink(ControlNode source, ControlNode sink) {
        return (!(source == null ^ sink == null) && (source == null || source instanceof OneOutput || source instanceof TwoOutput) && (sink == null || sink instanceof OneInput || sink instanceof TwoInput));
    }
   ...
   */
    protected abstract void setSource(ControlNode source, boolean secondary) throws EdgeLinkageError;

    /** Set the sink of an edge.
   * (Used only in initialization by attach and friends.)
   */
    protected abstract void setSink(ControlNode sink, boolean secondary) throws EdgeLinkageError;
