 ...
 * @author Jerry Vos
 */
public class MethodMappingStep extends ModelAwarePanelStep<DataMappingWizardModel> implements PredicateFiltered<Method> {
    ...
    private void initComponents() {
        ...
        setLayout(new FormLayout(new ColumnSpec[] { FormFactory.DEFAULT_COLSPEC, FormFactory.LABEL_COMPONENT_GAP_COLSPEC, new ColumnSpec(ColumnSpec.FILL, Sizes.DEFAULT, FormSpec.DEFAULT_GROW) }, RowSpec.decodeSpecs("default")));
        ...
        methodBox.setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                if (value instanceof Method) {
                    super.getListCellRendererComponent(list, ((Method) value).getName(), index, isSelected, cellHasFocus);
                }
    ...
    public void prepare() {
        ...
        for (Method method : methods) {
            if (method.getParameterTypes().length == 0 && !method.getReturnType().equals(void.class) && !badMethods.contains(method.getName()) && (methodFilter == null || methodFilter.evaluate(method))) {
