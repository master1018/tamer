...
public class DummyPlugin implements IPlugin {
    ...
    public File getPluginAppSettingsFolder() throws IOException, IllegalStateException {
        String filename = System.getProperty(IJavaPropertyNames.USER_HOME) + File.separator + ".squirrel-sql" + File.separator + "plugins" + File.separator + "mssql" + File.separator;
