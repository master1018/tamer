package com.example.client.grid.gridform;
...
import com.example.client.data.ItemSupplyLocalDS;

public class GridRecordRemoveSample extends ShowcasePanel {

    private static final String DESCRIPTION = "<p>Click the \"Remove\" button to remove the selected item.</p>";
