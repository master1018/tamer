...
public class ObjectCacheManager extends CacheManager<ObjectCache> {
   ...
   */
    public ObjectCacheManager(final ConfigDirectory configDirectory, final int maxElementsInMemory, final boolean overflowToDisk, final boolean eternal, final int timeToLiveSeconds, final int timeToIdleSeconds, final boolean diskPersistent, final int diskExpiryThreadIntervalSeconds) {
   ...
   */
    ...
    protected ObjectCache createCache(final RepositoryName repositoryName) throws CacheException {
        ...
        final DefaultObjectCache objectCache = new DefaultObjectCache(cacheName, cachePath, maxElementsInMemory, overflowToDisk, eternal, timeToLiveSeconds, timeToIdleSeconds, diskPersistent, diskExpiryThreadIntervalSeconds);
        objectCache.flush();
