...
public class Facile {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            } else if (args[i].endsWith(".exe") || args[i].endsWith(".dll") || args[i].endsWith(".netmodule") || args[i].endsWith(".mcl")) {
        ...
        try {
            if (pdbPath == null) facileReflector = Facile.load(assemblyPath); else facileReflector = Facile.load(assemblyPath, pdbPath);
        } catch (Exception e) {
            e.printStackTrace();
            return;
        }
	 ...
	 * an {@link IOException}.
	 */
    public static Assembly loadAssembly(String pathToAssembly) throws CoffPeDataNotFoundException, DotNetContentNotFoundException, UnexpectedHeaderDataException, SizeMismatchException, IOException {
	 ...
	 * @throws IOException if the reading process of the specified file throws
	 */
    public static Assembly loadAssembly(String pathToAssembly, String pathToPdb) throws CoffPeDataNotFoundException, DotNetContentNotFoundException, UnexpectedHeaderDataException, SizeMismatchException, IOException {
	 ...
	 */
    public static Assembly loadAssembly(byte[] buffer) throws CoffPeDataNotFoundException, DotNetContentNotFoundException, UnexpectedHeaderDataException, SizeMismatchException {
	 ...
	 * an {@link IOException}.
	 */
    public static FacileReflector load(String pathToAssembly) throws CoffPeDataNotFoundException, DotNetContentNotFoundException, UnexpectedHeaderDataException, SizeMismatchException, IOException {
        FacileReflector reflector = new FacileReflector(pathToAssembly);
	 ...
	 * an {@link IOException}.
	 */
    public static FacileReflector load(String pathToAssembly, String pathToPdb) throws CoffPeDataNotFoundException, DotNetContentNotFoundException, UnexpectedHeaderDataException, SizeMismatchException, IOException {
        FacileReflector reflector = new FacileReflector(pathToAssembly, pathToPdb);
        reflector.loadAssembly();
        return reflector;
    }
	 ...
	 * data does not match the real size in the {@code buffer}.
	 */
    public static FacileReflector load(byte[] buffer) throws CoffPeDataNotFoundException, DotNetContentNotFoundException, UnexpectedHeaderDataException, SizeMismatchException {
        FacileReflector reflector = new FacileReflector(buffer);
        reflector.loadAssembly();
        return reflector;
    }
	 ...
	 * an {@link IOException}.
	 */
    public static FacileReflector reflect(String pathToAssembly) throws CoffPeDataNotFoundException, DotNetContentNotFoundException, UnexpectedHeaderDataException, SizeMismatchException, IOException {
	 ...
	 * an {@link IOException}.
	 */
    public static FacileReflector reflect(String pathToAssembly, String pathToPdb) throws CoffPeDataNotFoundException, DotNetContentNotFoundException, UnexpectedHeaderDataException, SizeMismatchException, IOException {
	 ...
	 * data does not match the real size in the {@code buffer}.
	 */
    public static FacileReflector reflect(byte[] buffer) throws CoffPeDataNotFoundException, DotNetContentNotFoundException, UnexpectedHeaderDataException, SizeMismatchException {
