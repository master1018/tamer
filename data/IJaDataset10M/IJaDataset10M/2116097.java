...
public class ConfirmacionForm extends ValidatorForm {
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if ((StringUtils.isNotEmpty(getFechaRegistro()) && (StringUtils.isEmpty(getNumeroRegistro()))) || (StringUtils.isNotEmpty(getNumeroRegistro()) && (StringUtils.isEmpty(getFechaRegistro())))) {
