...
public class ImageButtonOverlay extends MouseOverlay {
     ...
     */
    public ImageButtonOverlay(Canvas3D canvas, Dimension size, BufferedImage[] images) {
     ...
     * @param images The array of images to use (non-null)
     */
    public ImageButtonOverlay(Canvas3D canvas, Dimension size, boolean clipAlpha, boolean blendAlpha, BufferedImage[] images) {
        super(canvas, size, clipAlpha, blendAlpha, null, NUM_BUFFERS);
        ...
        for (int i = 0; i < images.length; i++) {
            ...
            if (hasImage[i]) updateBuffer(images[i], i);
        }
