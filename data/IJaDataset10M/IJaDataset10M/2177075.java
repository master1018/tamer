...
public class ConditionalExpression implements ExpressionCommand {
    ...
    */
    public void apply(StackOfDouble stack, Cases cases) {
        ...
        if (cases != null) cases.addCase((int) test);
        if (test != 0) stack.push(trueCase.getValueWithCases(cases)); else if (falseCase != null) stack.push(falseCase.getValueWithCases(cases)); else stack.push(Double.NaN);
    }
