...
public class ASTLiteralTest extends ParserTst {
    ...
    private static final String TEST4 = "public class Foo {" + PMD.EOL + "  int x = 42L;" + PMD.EOL + "}";

    private static final String TEST5 = "public class Foo {" + PMD.EOL + "  float x = 3.14159f;" + PMD.EOL + "}";

    private static final String TEST6 = "public class Foo {" + PMD.EOL + "  float x = 3.14159;" + PMD.EOL + "}";
