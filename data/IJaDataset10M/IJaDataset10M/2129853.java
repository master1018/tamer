...
public class Test_CrearCuenta {

    public Test_CrearCuenta() {
    }

    private static Equipomasfull sistema = Login.sistema;

    private static CrearCuenta cuenta = new CrearCuenta();

    private String continu = "Continue";

    private String Verificar_No_Esten_Vacios = "Por favor verifique que los campos con * no\nesten vacios";

    private String Operacion_Exitosa = "Operación Exitosa.";

    private String Usuario_Existe = "El usuario ya existe.";
    ...
    @Test
    public void Prueba1camposvacios() {
        ...
        u.setDireccion("");
        u.setEmail("");
        u.setIdentificacion(0L);
        u.setNombre("");
        u.setPuntos(0);
        u.setTelfijo(0L);
        u.setPlaca(placa);
        String b = cuenta.comprobacion1(u);
        assertEquals(b, Verificar_No_Esten_Vacios);
    }

    @Test
    public void Prueba2camposcorrectos() {
        Usuario u = new Usuario();
        ArrayList<String> placa = new ArrayList();
        placa.add("cri-778");
        ...
        u.setCelular(2763L);
        u.setCodigo(18273L);
        u.setDireccion("Cll 159 48b17");
        u.setEmail("jorto159@unal.edu.co");
        u.setIdentificacion(23435L);
        u.setNombre("Jorge");
        u.setPuntos(89);
        u.setTelfijo(7654373L);
        u.setPlaca(placa);
        String b = cuenta.comprobacion1(u);
    ...
    @Test
    public void Prueba3usuarioexistente() {
        Usuario u = new Usuario();
        Usuario x = new Usuario();
        x.setIdentificacion(1L);
        x.setCodigo(1L);
        ArrayList<String> placa = new ArrayList();
        placa.add("cri-778");
        u.setApellidos("Torres");
    ...
    public void Prueba4operacionexitosa() {
        ...
        u.setPlaca(placa);
        String b = cuenta.comprobacion2(u, x);
        assertEquals(b, Operacion_Exitosa);
    }
}
