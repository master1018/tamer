...
public class AD implements AttributeDefinition, Comparable, Cloneable {
   ...
   */
    public AD(String id, int type, int card, String name, String[] defValue) {
        this(id, type, card, name, "", defValue, null, null);
    }
   ...
   */
    public AD(String id, int type, int card, String name, String desc, String[] defValue, String[] optLabels, String[] optValues) {
    ...
    public AD(String id, int type, int card, String name, String desc, String[] defValue, String min, String max, boolean required) {
   ...
   */
    public void setDefaultValue(String[] value) {
        ...
        if (s != null && !"".equals(s)) {
            throw new IllegalArgumentException("Bad default value '" + toString(value) + "' " + ", id=" + id + ", class=" + getClass(type) + ", err=" + s);
        }
        defValue = value;
    }
   ...
   */
    ...
    static final Class[] PRIMITIVE_CLASSES = new Class[] { String.class, Long.TYPE, Integer.TYPE, Short.TYPE, Character.TYPE, Byte.TYPE, Double.TYPE, Float.TYPE, BIGINTEGER_PRIMITIVE, BIGDECIMAL_PRIMITIVE, Boolean.TYPE };

    static final Class[] OBJECT_CLASSES = new Class[] { String.class, Long.class, Integer.class, Short.class, Character.class, Byte.class, Double.class, Float.class, BIGINTEGER_OBJECT, BIGDECIMAL_OBJECT, Boolean.class };
    ...
    static {
        ...
        try {
            for (int i = STRING; i <= BOOLEAN; i++) {
                ARRAY_CLASSES[i - STRING] = (Array.newInstance(getPrimitiveClass(i), 0)).getClass();
            }
        } catch (Exception e) {
            e.printStackTrace();
            System.exit(0);
   ...
   */
    public static Object parse(String value, int card, int type) {
        if (card < 0) {
            ...
            Object array = Array.newInstance(getPrimitiveClass(type), v.size());
    ...
    static Vector parseMany(String value, int type) {
