...
public class ImportKey {
    ...
    public static void main(String args[]) {
        ...
        if (keystorename == null) keystorename = System.getProperty("user.home") + System.getProperty("file.separator") + "keystore.ImportKey";
        String keyfile = "";
        String certfile = "";
        if (args.length < 2 || args.length > 3) {
            ...
            keyfile = args[0];
            certfile = args[1];
            if (args.length > 2) defaultalias = args[2];
        }
        try {
