...
public class DomDoctype extends DomExtern implements DocumentType {
   ...
   */
    public DomDoctype(DomDocument doc, String name, String publicId, String systemId) {
   ...
   */
    public Entity declareEntity(String name, String publicId, String systemId, String notation) {
        ...
        getEntities();
        DomDocument.checkName(name, (owner != null) ? "1.1".equals(owner.getXmlVersion()) : false);
   ...
   */
    ...
    public void attributeDecl(String eName, String aName, String type, String mode, String value) {
        DTDAttributeTypeInfo info = new DTDAttributeTypeInfo(eName, aName, type, mode, value);
    ...
    DTDAttributeTypeInfo getAttributeTypeInfo(String elementName, String name) {
        DTDElementTypeInfo elementInfo = (DTDElementTypeInfo) elements.get(elementName);
        return (elementInfo == null) ? null : elementInfo.getAttributeTypeInfo(name);
    }
