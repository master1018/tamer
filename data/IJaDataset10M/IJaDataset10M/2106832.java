...
public class FileSelectionField extends JPanel {
    ...
    public FileSelectionField(Preferences prefs, String prefsKey, int fileSelectionMode, String buttonText) {
        this.prefs = prefs;
        ...
        if (!prefDirectories.isEmpty()) textField.setText(prefDirectories.get(0));
        add(textField);
    ...
    private void savePreferences(boolean updateFromSelection) {
        ...
        prefs.put(prefsKey, StringUtils.join(prefDirectories, File.pathSeparator));
    }
