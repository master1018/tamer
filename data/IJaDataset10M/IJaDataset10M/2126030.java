...
public final class BeanHelper {
   ...
   */
    ...
    public static BeanHelper createBeanHelper(Class<?> clazz, TreeLogger logger, GeneratorContext context) throws UnableToCompleteException {
    ...
    protected static BeanHelper createBeanHelper(JClassType jType, TreeLogger logger, GeneratorContext context) throws UnableToCompleteException {
   ...
   */
    static void writeInterface(GeneratorContext context, TreeLogger logger, BeanHelper bean) {
    ...
    private static BeanHelper createBeanHelper(Class<?> clazz, JClassType beanType, TreeLogger logger, GeneratorContext context) throws UnableToCompleteException {
    ...
    private static void createBeanHelper(PropertyDescriptor p, BeanHelper parent, TreeLogger logger, GeneratorContext context) throws UnableToCompleteException {
    ...
    private BeanHelper(JClassType jClass, Class<?> clazz, BeanDescriptor beanDescriptor) {
        super();
