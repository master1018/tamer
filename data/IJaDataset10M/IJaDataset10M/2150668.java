...
public class SearchSchoolsJSONRequestController extends JSONRequestController {
    ...
    public void process(JSONRequestContext requestContext) {
        ...
        if (searchResult.getTotalHitCount() > 0) {
            statusMessage = Messages.getInstance().getText(locale, "settings.searchSchools.searchStatus", new Object[] { searchResult.getFirstResult() + 1, searchResult.getLastResult() + 1, searchResult.getTotalHitCount() });
        } else {
