...
public class ListSelectionDialogBinder extends AbstractBinder {
    ...
    public ListSelectionDialogBinder() {
        super(null, new String[] { SELECTABLE_ITEMS_HOLDER_KEY, FILTER_PROPERTIES_KEY, FILTERED_KEY, RENDERER_KEY, LABEL_PROVIDER_KEY, COMPARATOR_KEY, DESCRIPTION_KEY_KEY, TITLE_KEY_KEY, NULLABLE_KEY });
    }
    ...
    protected Binding doBind(JComponent notUsed, FormModel formModel, String formPropertyPath, Map context) {
        ListSelectionDialogBinding binding = new ListSelectionDialogBinding(new SimpleSelectField(), formModel, formPropertyPath);
