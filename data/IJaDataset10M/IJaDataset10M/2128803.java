...
public class ForeignKey {
    ...
    public static String createName(String parentTableName, String childTableName, String[] parentColumnNames) {
        ...
        name.append("fky_").append(ConstraintHelper.nameFromTable(parentTableName, 5)).append("_").append(ConstraintHelper.nameFromColumns(parentColumnNames)).append("_").append(ConstraintHelper.nameFromTable(childTableName, 5));
