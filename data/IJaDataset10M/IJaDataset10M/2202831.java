...
public abstract class ElementPropertyProbe extends ElementProbe {
    ...
    public boolean isSatisfied() {
        return super.isSatisfied() && valueMatcher.matches(actualValue);
    }

    @Override
    public void describeTo(Description description) {
        super.describeTo(description);
        description.appendText(" with ").appendText(propertyName).appendText(" ").appendDescriptionOf(valueMatcher);
    }
    ...
    public void describeFailureTo(Description description) {
        ...
        if (super.isSatisfied()) {
            description.appendText(propertyName).appendText(" was ").appendValue(actualValue);
        }
    }
}
