        ...
        while (nodes.hasNext()) {
            ...
            if (node instanceof EPCSubstFunction) {
                ...
                if (sf.getSubstitutedEPC() != null && EPCs.indexOf(sf.getSubstitutedEPC()) > -1) {
                    definitionlist = definitionlist + "LinkedModels.IdRefs='" + AmlIdFormat((EPCs.indexOf(sf.getSubstitutedEPC()) + 1), MODEL) + "'\n ";
                }
            }
            if (cxnDefIdRefs.length() > 0) {
                definitionlist = definitionlist + "ToCxnDefs.IdRefs='" + cxnDefIdRefs + "'\n ";
            }
