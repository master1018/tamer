...
public class WhoImpl extends EObjectImpl implements Who {
    ...
    public void setActor(Actor newActor) {
        if (newActor != actor) {
            ...
            if (actor != null) msgs = ((InternalEObject) actor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Q7dslPackage.WHO__ACTOR, null, msgs);
            if (newActor != null) msgs = ((InternalEObject) newActor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Q7dslPackage.WHO__ACTOR, null, msgs);
            msgs = basicSetActor(newActor, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, Q7dslPackage.WHO__ACTOR, newActor, newActor));
    }
