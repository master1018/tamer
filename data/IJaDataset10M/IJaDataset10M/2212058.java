...
public class DoubleGene extends NumberGene implements IPersistentRepresentation {
   ...
   * @since 3.0
   */
    public DoubleGene(final Configuration a_config) throws InvalidConfigurationException {
        this(a_config, -(Double.MAX_VALUE / 2), Double.MAX_VALUE / 2);
    }
   ...
   * @since 2.0
   */
    public DoubleGene(final Configuration a_config, final double a_lowerBound, final double a_upperBound) throws InvalidConfigurationException {
        super(a_config);
   ...
   */
    protected Gene newGeneInternal() {
        try {
            DoubleGene result = new DoubleGene(getConfiguration(), m_lowerBound, m_upperBound);
            return result;
   ...
   */
    public String getPersistentRepresentation() {
        ...
        return s + PERSISTENT_FIELD_DELIMITER + m_lowerBound + PERSISTENT_FIELD_DELIMITER + m_upperBound;
    }
   ...
   */
    public void setValueFromPersistentRepresentation(String a_representation) throws UnsupportedRepresentationException {
        if (a_representation != null) {
            ...
            try {
                m_lowerBound = Double.parseDouble(lowerBoundRepresentation);
            } catch (NumberFormatException e) {
            ...
            try {
                m_upperBound = Double.parseDouble(upperBoundRepresentation);
            } catch (NumberFormatException e) {
   ...
   */
    public void setToRandomValue(RandomGenerator a_numberGenerator) {
        setAllele(new Double((m_upperBound - m_lowerBound) * a_numberGenerator.nextDouble() + m_lowerBound));
    }
   ...
   */
    protected void mapValueToWithinBounds() {
        if (getAllele() != null) {
            ...
            if (d_value.doubleValue() > m_upperBound || d_value.doubleValue() < m_lowerBound) {
                RandomGenerator rn;
                ...
                setAllele(new Double(rn.nextDouble() * (m_upperBound - m_lowerBound) + m_lowerBound));
            }
        }
    }
