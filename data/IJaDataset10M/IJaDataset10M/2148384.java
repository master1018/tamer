...
public class HttpMethodExecutor {
    ...
    void post(String content, String url, String contentType) throws IOException {
        ...
        postMethod.setRequestEntity(new StringRequestEntity(content, contentType, UTF_8));
    ...
    void put(String xml, String url, String contentType) throws IOException {
        ...
        putMethod.setRequestEntity(new StringRequestEntity(xml, contentType, UTF_8));
    ...
    private String execute(String url, HttpMethodBase method, int statusToCheck) throws IOException {
        ...
        try {
            ...
            if (statusCode != statusToCheck) {
                throw new RuntimeException(METHOD_FAILED + method.getStatusLine());
            }
