...
public class EdmondsKarpMaxFlow<V, E> extends IterativeProcess {
    ...
    public EdmondsKarpMaxFlow(DirectedGraph<V, E> directedGraph, V source, V sink, Transformer<E, Number> edgeCapacityTransformer, Map<E, Number> edgeFlowMap, Factory<E> edgeFactory) {
        if (directedGraph.getVertices().contains(source) == false || directedGraph.getVertices().contains(sink) == false) {
        ...
        try {
            ...
            for (E e : mOriginalGraph.getEdges()) {
                mFlowGraph.addEdge(e, mOriginalGraph.getSource(e), mOriginalGraph.getDest(e), EdgeType.DIRECTED);
            }
