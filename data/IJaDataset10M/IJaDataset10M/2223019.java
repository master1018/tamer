...
class ChangeTracksFrame extends OperationsFrame {
    ...
    public ChangeTracksFrame(LocationEditFrame lef) {
        ...
        pack();
        if (getWidth() < 250) setSize(getWidth() + 100, getHeight());
        setVisible(true);
    }
    ...
    private void changeTracks(String type) {
        ...
        if (type.equals(Track.STAGING)) _location.setLocationOps(Location.STAGING); else _location.setLocationOps(Location.NORMAL);
