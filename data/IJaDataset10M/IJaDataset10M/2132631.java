...
public class DOMUtil {
    ...
    /**
     * Get the first element with the given name as a child of the given element.
     * A RuntimeException will be thrown if the named element doesn't exist.
     *
    ...
    /**
     * Specialized form of getSimpleElementText that takes the name of an element
     * to get the text from.  Note that this will only take the first occurance
    ...
    /**
     * Returns the text contained in a simple node.  A "simple node", in this case,
     * means only the text elements with no extra tags inbetween.  Any tags like
