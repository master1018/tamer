package org.shestkoff.nimium.integration.tws.client;
...
public class OrderState {
    ...
    public String toString() {
        return "OrderState{" + "m_status='" + m_status + '\'' + ", m_initMargin='" + m_initMargin + '\'' + ", m_maintMargin='" + m_maintMargin + '\'' + ", m_equityWithLoan='" + m_equityWithLoan + '\'' + ", m_commission=" + m_commission + ", m_minCommission=" + m_minCommission + ", m_maxCommission=" + m_maxCommission + ", m_commissionCurrency='" + m_commissionCurrency + '\'' + ", m_warningText='" + m_warningText + '\'' + '}';
    }
}
