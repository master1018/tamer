package de.uniwue.dltk.textmarker.internal.debug.ui.launchConfigurations;
...
public class TextMarkerRemoteTab extends AbstractLaunchConfigurationTab {
    ...
    protected void createPathTemplate(Composite parent, Object data) {
        ...
        text.setText("${DEBUGGIN_ENGINE} -host-ide ${HOST} -port-ide ${PORT} -app-shell ${TM_INTERPRETER} -ide-key ${SESSION_ID} -app-file {TM_FILE}");
    }
    ...
    public void initializeFrom(ILaunchConfiguration configuration) {
        try {
            ...
            String sessionId = configuration.getAttribute(ScriptLaunchConfigurationConstants.ATTR_DLTK_DBGP_SESSION_ID, (String) null);
            setSessionId(sessionId != null ? sessionId : DEFAULT_SESSION_ID);
            int timeout = configuration.getAttribute(ScriptLaunchConfigurationConstants.ATTR_DLTK_DBGP_WAITING_TIMEOUT, -1);
    ...
    public void setDefaults(ILaunchConfigurationWorkingCopy configuration) {
        ...
        configuration.setAttribute(ScriptLaunchConfigurationConstants.ATTR_DLTK_DBGP_WAITING_TIMEOUT, DEFAULT_TIMEOUT);
    }
}
