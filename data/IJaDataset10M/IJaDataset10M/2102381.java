...
public class ForecastErrorFitnessFunction implements FitnessFunction {
    ...
    public double getFitness(Agent agent) {
        if (agent instanceof AbstractTradingAgent) {
            ...
            ReturnForecastValuationPolicy policy = (ReturnForecastValuationPolicy) tradingAgent.getValuationPolicy();
            ReturnForecasterWithTimeHorizon forecaster = (ReturnForecasterWithTimeHorizon) policy.getForecaster();
