...
public class Customer implements java.io.Serializable {
    ...
    public Customer(java.lang.String customerId, java.lang.String nickname, java.lang.String birthday, java.lang.String wishListId, com.amazon.ws.CustomerLocation location, com.amazon.ws.CustomerReviews[] customerReviews) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = true && ((this.customerId == null && other.getCustomerId() == null) || (this.customerId != null && this.customerId.equals(other.getCustomerId()))) && ((this.nickname == null && other.getNickname() == null) || (this.nickname != null && this.nickname.equals(other.getNickname()))) && ((this.birthday == null && other.getBirthday() == null) || (this.birthday != null && this.birthday.equals(other.getBirthday()))) && ((this.wishListId == null && other.getWishListId() == null) || (this.wishListId != null && this.wishListId.equals(other.getWishListId()))) && ((this.location == null && other.getLocation() == null) || (this.location != null && this.location.equals(other.getLocation()))) && ((this.customerReviews == null && other.getCustomerReviews() == null) || (this.customerReviews != null && java.util.Arrays.equals(this.customerReviews, other.getCustomerReviews())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCustomerReviews() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getCustomerReviews()); i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(Customer.class, true);
