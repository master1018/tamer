...
public interface FactoriaObjetosXMLDatosPropios extends FactoriaObjetosXML {
    ...
    /** Crea un objeto de datos propios vac�o
	 ...
	 */
    public DatosPropios crearDatosPropios(InputStream datosXMLDatosPropios) throws es.caib.xml.CargaObjetoXMLException;
	 ...
	 */
    public DatosPropios crearDatosPropios(File ficheroXMLDatosPropios) throws es.caib.xml.CargaObjetoXMLException;
	 ...
	 */
    public void guardarDatosPropios(DatosPropios datosPropios, OutputStream datosXMLdatosPropios) throws es.caib.xml.GuardaObjetoXMLException, EstablecerPropiedadException;
	 ...
	 * @throws EstablecerPropiedadException Los datos del objeto de datos propios no son correctos
	 */
    public void guardarDatosPropios(DatosPropios datosPropios, File ficheroXMLDatosPropios) throws es.caib.xml.GuardaObjetoXMLException, EstablecerPropiedadException;
	 ...
	 * @throws EstablecerPropiedadException Los datos del objeto de datos propios no son correctos
	 */
    public String guardarDatosPropios(DatosPropios datosPropios) throws es.caib.xml.GuardaObjetoXMLException, EstablecerPropiedadException;
