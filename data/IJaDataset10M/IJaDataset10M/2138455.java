...
public class LinkTagTest extends ParserTestCase {
    ...
    public void testLinkNodeBugNullPointerException() throws ParserException {
        createParser("<FORM action=http://search.yahoo.com/bin/search name=f><MAP name=m><AREA\n" + "coords=0,0,52,52 href=\"http://www.yahoo.com/r/c1\" shape=RECT><AREA" + "coords=53,0,121,52 href=\"http://www.yahoo.com/r/p1\" shape=RECT><AREA" + "coords=122,0,191,52 href=\"http://www.yahoo.com/r/m1\" shape=RECT><AREA" + "coords=441,0,510,52 href=\"http://www.yahoo.com/r/wn\" shape=RECT>", "http://www.cj.com/");
    ...
    public void testToHTML() throws ParserException {
        ...
        createParser(link1 + "\n" + "<LI><font color=\"FF0000\" size=-1><b>Tech Samachar:</b></font>" + link2 + " by Rajesh Jain", "http://www.cj.com/");
        parser.setNodeFactory(new PrototypicalNodeFactory(new LinkTag()));
    ...
    public void testErroneousLinkBugFromYahoo2() throws ParserException {
        String link = "<a href=s/8741>" + "<img src=\"http://us.i1.yimg.com/us.yimg.com/i/i16/mov_popc.gif\" height=16 width=16 border=0>";
        createParser("<td>" + link + "</td>" + "<td nowrap> &nbsp;\n" + "<a href=s/7509><b>Yahoo! Movies</b></a>" + "</td>", "http://www.yahoo.com");
    ...
    public void testErroneousLinkBugFromYahoo() throws ParserException {
        String link = "<a href=s/8741>" + "<img src=\"http://us.i1.yimg.com/us.yimg.com/i/i16/mov_popc.gif\" " + "height=16 " + "width=16 " + "border=0>" + "This is a test\n";
        createParser(link + "<a href=s/7509>" + "<b>Yahoo! Movies</b>" + "</a>", "http://www.yahoo.com");
    ...
    public void testCharacterReferenceInLink() throws Exception {
        String html = "<a href=\"http://www.someplace.com/somepage.html?&region=us\">Search By Region</a>" + "<a href=\"http://www.someplace.com/somepage.html?&region=&destination=184\">Search by Destination</a>";
        createParser(html);
        parseAndAssertNodeCount(2);
        assertType("node", LinkTag.class, node[0]);
        LinkTag linkTag = (LinkTag) node[0];
