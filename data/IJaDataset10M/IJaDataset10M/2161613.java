...
public class ResourcesTest {
    ...
    public void getLocalResources() throws Exception {
        ...
        internalGetLocalResources(c, "defaultFallback.txt", null, germanLocale, new String[] {});
        internalGetLocalResources(c, "defaultFallback", new String[] { ".txt", ".html" }, germanLocale, new String[] {});
        internalGetLocalResources(c, "................../underflow.txt", null, germanLocale, new String[] {});
        internalGetLocalResources(c, "test.txt", null, germanLocale, new String[] { "Foobar/test.txt" });
        internalGetLocalResources(c, "overloaded.txt", null, germanLocale, new String[] { "Foobar/overloaded.txt" });
        internalGetLocalResources(c, "overloaded.txt", null, null, new String[] { "Foobar/overloaded.txt" });
        internalGetLocalResources(c, "overloaded.txt", new String[] {}, null, new String[] { "Foobar/overloaded.txt" });
        internalGetLocalResources(c, "overloaded.txt", new String[] { "" }, null, new String[] { "Foobar/overloaded.txt" });
        internalGetLocalResources(c, "overloaded", new String[] { ".txt" }, null, new String[] { "Foobar/overloaded.txt" });
        internalGetLocalResources(c, "link.txt", null, germanLocale, new String[] { "Foobar/test.txt" });
        internalGetLocalResources(c, "cyclic1", null, germanLocale, new String[] {});
        internalGetLocalResources(c, "cyclicFallback1", null, germanLocale, new String[] { "Foobar/cyclicFallback1" });
        c = de.huxhorn.sulky.resources.junit.Foobar.Internal.class;
        internalGetLocalResources(c, "test.txt", null, germanLocale, new String[] { "Foobar/Internal/test.txt" });
        c = de.huxhorn.sulky.resources.junit.Foobar.StaticInternal.class;
        internalGetLocalResources(c, "test.txt", null, germanLocale, new String[] { "Foobar/StaticInternal/de/test.txt", "Foobar/StaticInternal/test.txt" });
    ...
    public void getLocalResource() throws Exception {
        Class c;
        c = de.huxhorn.sulky.resources.junit.Foobar.class;
        internalGetLocalResource(c, "defaultFallback.txt", null, germanLocale, null);
        internalGetLocalResource(c, "defaultFallback", new String[] { ".txt", ".html" }, germanLocale, null);
    ...
    public void getLocalResourceAsStream() throws Exception {
        Class c;
        c = de.huxhorn.sulky.resources.junit.Foobar.class;
        internalGetLocalResourceAsStream(c, "defaultFallback.txt", null, germanLocale, false);
        internalGetLocalResourceAsStream(c, "defaultFallback", new String[] { ".txt", ".html" }, germanLocale, false);
    ...
    public void getResources() throws Exception {
        Class c;
        c = de.huxhorn.sulky.resources.junit.Foobar.class;
        internalGetResources(c, "defaultFallback.txt", null, germanLocale, new String[] {});
        internalGetResources(c, "defaultFallback", new String[] { ".txt", ".html" }, germanLocale, new String[] {});
        internalGetResources(c, "................../underflow.txt", null, germanLocale, new String[] {});
        internalGetResources(c, "test.txt", null, germanLocale, new String[] { "Foobar/test.txt" });
        internalGetResources(c, "overloaded.txt", null, germanLocale, new String[] { "Foobar/overloaded.txt", "BaseClass/overloaded.txt" });
        internalGetResources(c, "overloaded.txt", null, null, new String[] { "Foobar/overloaded.txt", "BaseClass/overloaded.txt" });
        internalGetResources(c, "overloaded.txt", new String[] {}, null, new String[] { "Foobar/overloaded.txt", "BaseClass/overloaded.txt" });
        internalGetResources(c, "overloaded.txt", new String[] { "" }, null, new String[] { "Foobar/overloaded.txt", "BaseClass/overloaded.txt" });
        internalGetResources(c, "overloaded", new String[] { ".txt" }, null, new String[] { "Foobar/overloaded.txt", "BaseClass/overloaded.txt" });
        internalGetResources(c, "link.txt", null, germanLocale, new String[] { "Foobar/test.txt" });
        internalGetResources(c, "cyclic1", null, germanLocale, new String[] {});
        internalGetResources(c, "cyclicFallback1", null, germanLocale, new String[] { "Foobar/cyclicFallback1" });
        c = de.huxhorn.sulky.resources.junit.Foobar.Internal.class;
        internalGetResources(c, "test.txt", null, germanLocale, new String[] { "Foobar/Internal/test.txt", "Foobar/test.txt" });
        c = de.huxhorn.sulky.resources.junit.Foobar.StaticInternal.class;
        internalGetResources(c, "test.txt", null, germanLocale, new String[] { "Foobar/StaticInternal/de/test.txt", "Foobar/StaticInternal/test.txt", "Foobar/test.txt" });
        c = de.huxhorn.sulky.resources.junit.Foobar.StaticInternal.Foo.class;
        internalGetResources(c, "test.txt", null, germanLocale, new String[] { "Foobar/StaticInternal/de/test.txt", "Foobar/StaticInternal/test.txt", "Foobar/test.txt" });
    }
    ...
    public void getResource() throws Exception {
        Class c;
        c = de.huxhorn.sulky.resources.junit.Foobar.class;
        internalGetResource(c, "defaultFallback.txt", null, germanLocale, null);
        internalGetResource(c, "defaultFallback", new String[] { ".txt", ".html" }, germanLocale, null);
    ...
    public void getResourceAsStream() throws Exception {
        Class c;
        c = de.huxhorn.sulky.resources.junit.Foobar.class;
        internalGetResourceAsStream(c, "defaultFallback.txt", null, germanLocale, false);
        internalGetResourceAsStream(c, "defaultFallback", new String[] { ".txt", ".html" }, germanLocale, false);
    ...
    public void getLocaleSuffixArray() throws Exception {
        internalGetLocaleSuffixArray(germanLocale, new String[] { "de_DE", "de", "en_US", "en" });
        internalGetLocaleSuffixArray(hessianLocale, new String[] { "de_DE_hessisch", "de_DE", "de", "en_US", "en" });
        internalGetLocaleSuffixArray(new Locale("", "", "foo"), new String[] { "__foo", "en_US", "en" });
        internalGetLocaleSuffixArray(new Locale("foo", "", "bar"), new String[] { "foo__bar", "foo", "en_US", "en" });
        internalGetLocaleSuffixArray(empty, new String[] { "en_US", "en" });
        internalGetLocaleSuffixArray(null, new String[] { "en_US", "en" });
        internalGetLocaleSuffixArray(usLocale, new String[] { "en_US", "en" });
    ...
    public void getSingleLocaleSuffixArray() throws Exception {
        internalGetSingleLocaleSuffixArray(germanLocale, new String[] { "de_DE", "de" });
        internalGetSingleLocaleSuffixArray(hessianLocale, new String[] { "de_DE_hessisch", "de_DE", "de" });
        internalGetSingleLocaleSuffixArray(new Locale("", "", "foo"), new String[] { "__foo" });
        internalGetSingleLocaleSuffixArray(new Locale("foo", "", "bar"), new String[] { "foo__bar", "foo" });
