    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (value instanceof Object[]) {
            ...
            if ((Long) values[1] == 0 && (Long) values[2] == 0) {
                ...
                TextFormatter.appendFormattedCurrency(sb, (Long) values[1], InternalFormatter.isRed((BudgetCategory) values[0], (Long) values[1]), false);
                if (!((Long) values[2]).equals((Long) values[1]) && (Long) values[2] != 0) {
                    sb.append(" (");
                    TextFormatter.appendFormattedCurrency(sb, (Long) values[2], InternalFormatter.isRed((BudgetCategory) values[0], (Long) values[2]), false);
                    sb.append(")");
                }
            }
            if (PrefsModel.getInstance().isShowCurrentBudget()) {
                ...
                if (actualIncludingSubs != (long) actual) {
                    sb.append(" (");
                    TextFormatter.appendFormattedCurrency(sb, actualIncludingSubs, actualIncludingSubs < 0, actualIncludingSubs < 0);
                    sb.append(")");
                }
