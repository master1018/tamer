...
public class SpecifyTemplateStringPage extends WizardPage {
    ...
    public SpecifyTemplateStringPage(String pageName, InputParameterProvider inputParameterProvider, InputDataProvider inputDataProvider, CustomStringOption templateStringOption) {
        super(pageName);
    ...
    public void createControl(Composite parent) {
        this.specifyTemplateStringPanel = createSpecifyTemplateStringPanel(parent);
    ...
    private SpecifyTemplateStringPanel createSpecifyTemplateStringPanel(Composite parent) {
        SpecifyTemplateStringPanel specifyTemplateStringPanel = new SpecifyTemplateStringPanel(parent, SWT.NONE, this.templateStringOption);
    ...
    private void updatePlaceholderSet() {
        this.specifyTemplateStringPanel.updateControls(this.inputParameterProvider, this.inputDataProvider);
    }
}
