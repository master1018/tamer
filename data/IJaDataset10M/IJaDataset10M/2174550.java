...
public class NullableValueSecondaryStrategy extends TagStrategySupport implements QueryTagStrategy {
    ...
    NullableValueSecondaryStrategy(NullableValueStrategy main) {
        this.main = main;
    }

    public int doStart() throws JspException {
        int n = main.done;
        if (n != BodyTag.EVAL_BODY_TAG) return n;
    ...
    public ComposedQuery getQuery() {
        return main.getQuery();
    }
    ...
    public boolean foundMoreProjections() {
        return main.foundMoreProjections();
    }
