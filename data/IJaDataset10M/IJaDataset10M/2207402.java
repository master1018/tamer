...
public class ServiceRegistryImpl implements ServiceRegistry {
    ...
    private ConcurrentHashMap<Class<?>, Collection<Class<?>>> services = new ConcurrentHashMap<Class<?>, Collection<Class<?>>>();
    ...
    public <T> T getService(Class<T> contract) {
        return (T) ((InjectorImpl) injector).getUnscopedInstance(((ArrayList<Class<?>>) services.get(contract)).get(0));
    }
