...
public class UCharScalarHelper extends ANumberScalarHelper {
    ...
    void insert(double d) {
        ...
        if (dUnitFactor == 1.0) da.insert_uc((short) d); else {
    ...
    double getNumberScalarValue(DeviceAttribute devAtt) {
        ...
        if (uchar_arr == null) return Double.NaN;
        if (uchar_arr.length < 1) return Double.NaN;
        return uchar_arr[0];
    }
    ...
    double getNumberScalarSetPoint(DeviceAttribute devAtt) {
        ...
        if (uchar_arr == null) return Double.NaN;
        if (uchar_arr.length < 1) return Double.NaN;
        if (uchar_arr.length > 1) return uchar_arr[1]; else return uchar_arr[0];
    }
    ...
    double getNumberScalarDisplaySetPoint(DeviceAttribute devAtt) {
        ...
        if (uchar_arr == null) return Double.NaN;
        if (uchar_arr.length < 1) return Double.NaN;
        if (uchar_arr.length > 1) return (uchar_arr[1] * dUnitFactor); else return (uchar_arr[0] * dUnitFactor);
    }
    ...
    public String getVersion() {
        return "$Id: UCharScalarHelper.java 15105 2010-09-24 13:11:54Z poncet $";
    }
}
