...
public class AddPageTest extends BaseTestCase {
    ...
    public void testAddPage() throws Exception {
        ...
        selenium.typeKeys("new_page", RuntimeVariables.replace("Méssagé Boards Tést Pagé"));
        selenium.type("new_page", RuntimeVariables.replace("Méssagé Boards Tést Pagé"));
        ...
        selenium.click(RuntimeVariables.replace("link=Méssagé Boards Tést Pagé"));
        selenium.waitForPageToLoad("30000");
    }
}
