...
public class ValueSourceData {
	 ...
	 */
    private GroupCellSeriesData recursivelyGetSeriesDataForAllGroupCells(Vector<PlotDimension> dimensions, int dimensionIdx, GroupCellKey groupCellKey, GroupCellSeriesData dataForAllGroupCells) {
        if (groupCellKey == null) {
            groupCellKey = new GroupCellKey();
        }
