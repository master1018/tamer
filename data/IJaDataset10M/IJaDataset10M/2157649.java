...
/**
 * This is a default implementation of the IFC object IfcStyledItem<br><br>
 * 
 ...
 **/
public class IfcStyledItem extends IfcRepresentationItem implements IfcClass {
    ...
    public SET<IfcPresentationStyleAssignment> Styles;
    ...
    public Object clone() {
        ...
        if (this.Item != null) ifcStyledItem.setItem((IfcRepresentationItem) this.Item.clone());
        if (this.Styles != null) ifcStyledItem.setStyles((SET<IfcPresentationStyleAssignment>) this.Styles.clone());
        if (this.Name != null) ifcStyledItem.setName((IfcLabel) this.Name.clone());
    ...
    public Object shallowCopy() {
        IfcStyledItem ifcStyledItem = new IfcStyledItem();
        if (this.Item != null) ifcStyledItem.setItem(this.Item);
        if (this.Styles != null) ifcStyledItem.setStyles(this.Styles);
        if (this.Name != null) ifcStyledItem.setName(this.Name);
        return ifcStyledItem;
    }
