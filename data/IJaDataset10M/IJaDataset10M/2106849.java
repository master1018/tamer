...
public class BiomarkerDefinitions {
    ...
    */
    public synchronized void save() {
        if (dirty) {
            try {
                PrintStream ps = new PrintStream(new BufferedOutputStream(new FileOutputStream(getBiomarkersDefinitionsFile())));
                writeXML(ps);
                ps.close();
            } catch (IOException e) {
                e.printStackTrace();
    ...
    public synchronized void load() {
        ...
        try {
            InputStream in = new BufferedInputStream(new FileInputStream(getBiomarkersDefinitionsFile()));
            load(in);
            in.close();
