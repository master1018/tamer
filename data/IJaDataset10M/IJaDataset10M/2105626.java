...
public class ChromosomeViewExportJPGAction extends AbstractModelAction implements Observer {
    ...
    public ChromosomeViewExportJPGAction(ChromosomeView view, Model model) {
        super("Export as jpeg", new ImageIcon(model.getClass().getResource("/images/save.png")), model);
        this.view = view;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (outputFile != null) {
            ...
            GraphicsFileExport.exportJPG(view, outputFile.toString(), 800, prefHeight);
        }
    }
}
