 ...
 */
public class Ocl4tstHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
    public Ocl4tstHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
        this.region = region;
    ...
    public void open() {
        ...
        if (file != null) {
            ...
            try {
                ...
                fr.inria.uml4tst.papyrus.ocl4tst.ocl4tst.resource.ocl4tst.mopp.Ocl4tstPlugin.logError("Exception while opening hyperlink target.", e);
            }
        }
    }
