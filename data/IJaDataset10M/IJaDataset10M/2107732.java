...
public abstract class GFileDao extends ilarkesto.persistence.ADao<File> {
    ...
    private final Cache<scrum.server.project.Project, Set<File>> filesByProjectCache = new Cache<scrum.server.project.Project, Set<File>>(new Cache.Factory<scrum.server.project.Project, Set<File>>() {
    ...
    private final Cache<java.lang.String, Set<File>> filesByFilenameCache = new Cache<java.lang.String, Set<File>>(new Cache.Factory<java.lang.String, Set<File>>() {
    ...
    private final Cache<ilarkesto.base.time.DateAndTime, Set<File>> filesByUploadTimeCache = new Cache<ilarkesto.base.time.DateAndTime, Set<File>>(new Cache.Factory<ilarkesto.base.time.DateAndTime, Set<File>>() {
    ...
    private final Cache<java.lang.String, Set<File>> filesByLabelCache = new Cache<java.lang.String, Set<File>>(new Cache.Factory<java.lang.String, Set<File>>() {
    ...
    private final Cache<Integer, Set<File>> filesByNumberCache = new Cache<Integer, Set<File>>(new Cache.Factory<Integer, Set<File>>() {
    ...
    private final Cache<java.lang.String, Set<File>> filesByNoteCache = new Cache<java.lang.String, Set<File>>(new Cache.Factory<java.lang.String, Set<File>>() {
