...
public class USTMScheduler {
     ...
     */
    private List<Item> rescheduledItems = new ArrayList<Item>();

    /**
     * The map which contains all *running* delay-timers.
     */
    Map<Item, ItemReschedulerTask> itemTimers = new HashMap<Item, ItemReschedulerTask>();
