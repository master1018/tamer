    ...
    public double classifyInstance(Instance instance) throws Exception {
        ...
        if (m_ZeroR != null) {
            ...
            if (m_ActualClusterer != null) {
                ...
                if (result == -1) result = Instance.missingValue();
            } else {
    ...
    public String toString() {
        ...
        if (m_ActualClusterer != null) {
            ...
            for (i = 0; i < m_ClustersToClasses.length - 1; i++) {
                ...
                if (m_ClustersToClasses[i] < 0) result.append("no class"); else result.append(m_OriginalHeader.classAttribute().value((int) m_ClustersToClasses[i]) + " (" + ((int) m_ClustersToClasses[i] + 1) + ")");
                result.append("\n");
            }
            result.append("\n");
            ...
            for (i = 0; i < m_OriginalHeader.numClasses(); i++) {
                ...
                if (!found) result.append("no cluster");
                result.append("\n");
            }
            result.append("\n");
        } else {
