...
public class Config implements DOMable {
    ...
    private static final PropertyDescriptor<String> DECOMPILE_ON_NAVIGATION = new ImmutablePropertyDescriptor<String>("decompile-on-navigation", NavigationTriggeredDecompile.ALWAYS.getName());
    ...
    private static final PropertyDescriptor<String> REFORMAT_STYLE = new ImmutablePropertyDescriptor<String>("reformat-style", CodeStyle.PREFERRED_STYLE.getName());

    private static final PropertyDescriptor<Boolean> CLEANUP_SOURCE_ROOTS = new ImmutablePropertyDescriptor<Boolean>("cleanup-source-roots", Boolean.TRUE);
    ...
    public Config(RuleContext ruleContext) {
        ...
        dpc.put(EXCLUSION_TABLE_MODEL, new DOMableTableModel(EXCLUSION_TABLE_MODEL, new ExclusionTableModel()));
        this.domable = dpc;
     ...
     */
    private void registerBooleanProperty(PropertyDescriptor<Boolean> pd, DOMablePropertyContainer dpc) {
        dpc.put(pd, new DOMableGeneric<Boolean>(pd, ConverterFactory.getBooleanConverter(), DOMableCollectionContentType.BOOLEAN));
    }
     ...
     * @param dpc  the property container
     */
    private void registerBooleanProperty(CommandLinePropertyDescriptor<Boolean> clpd, DOMablePropertyContainer dpc) {
        dpc.put(clpd, new DOMableGeneric<Boolean>(clpd, ConverterFactory.getBooleanConverter(), DOMableCollectionContentType.BOOLEAN));
     ...
     * @param dpc the property container
     */
    private void registerIntegerProperty(PropertyDescriptor<Integer> pd, DOMablePropertyContainer dpc) {
        dpc.put(pd, new DOMableGeneric<Integer>(pd, ConverterFactory.getIntegerConverter(), DOMableCollectionContentType.INTEGER));
    }
     ...
     * @param dpc  the property container
     */
    private void registerIntegerProperty(CommandLinePropertyDescriptor<Integer> clpd, DOMablePropertyContainer dpc) {
        dpc.put(clpd, new DOMableGeneric<Integer>(clpd, ConverterFactory.getIntegerConverter(), DOMableCollectionContentType.INTEGER));
        ruleContext.addProperty(clpd);
        commandLinePropertyDescriptors.add(clpd);
    }
     ...
     * @param dpc the property container
     */
    private void registerStringProperty(PropertyDescriptor<String> pd, DOMablePropertyContainer dpc) {
        dpc.put(pd, new DOMableGeneric<String>(pd, ConverterFactory.getStringConverter(), DOMableCollectionContentType.STRING));
    }
     ...
     * @param dpc  the property container
     */
    private void registerStringProperty(CommandLinePropertyDescriptor<String> clpd, DOMablePropertyContainer dpc) {
        dpc.put(clpd, new DOMableGeneric<String>(clpd, ConverterFactory.getStringConverter(), DOMableCollectionContentType.STRING));
        ruleContext.addProperty(clpd);
        commandLinePropertyDescriptors.add(clpd);
    }
    ...
    public String renderCommandLinePropertyDescriptors() {
        ...
        for (CommandLinePropertyDescriptor pd : commandLinePropertyDescriptors) {
            sb.append(pd.getOption(ruleContext, propertyContainer.get(pd)));
        }
        return sb.toString();
    }
    ...
    public List<String> getArguments() {
        ...
        for (CommandLinePropertyDescriptor pd : commandLinePropertyDescriptors) {
            String option = pd.getOption(ruleContext, propertyContainer.get(pd));
            if (option != null) {
