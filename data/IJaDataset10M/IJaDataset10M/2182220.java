...
public final class AudioClipCache {
    ...
    public AudioClipCache(ClassLoader classLoader, String mediaDir, Map nameToAudioClipMap) {
        NullArgumentException.check(this.classLoader = classLoader);
        this.mediaDir = mediaDir;
        NullArgumentException.check(this.nameToAudioClipMap = nameToAudioClipMap);
    }

    public AudioClipCache(ClassLoader classLoader, String mediaDir) {
    ...
    public synchronized void play(String audioClipName) {
        ...
        if (audioClip == null) {
            URL audioClipURL = classLoader.getResource(mediaDir == null ? audioClipName : mediaDir + audioClipName);
