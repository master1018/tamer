...
public class OwlsAssignReorientCommand extends EditElementCommand {
    ...
    protected boolean canReorientSource() {
        ...
        return OwlsBaseItemSemanticEditPolicy.LinkConstraints.canExistOwlsAssign_3001(container, getNewSource(), target);
    }
    ...
    protected boolean canReorientTarget() {
        ...
        OwlsProcess container = (OwlsProcess) getLink().eContainer();
        return OwlsBaseItemSemanticEditPolicy.LinkConstraints.canExistOwlsAssign_3001(container, source, getNewTarget());
    }
