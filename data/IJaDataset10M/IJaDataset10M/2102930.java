...
public abstract class SimpleHorizontalASTViewComponent implements IOrientedComponent {

    /**
   * Logger definition
   */
    private static final transient Log LOGGER = LogFactory.getLog(SimpleHorizontalASTViewComponent.class);

    private static final String EDITOR = "table.Editor";

    private static final String TREEVIEW = "table.TreeView";

    private static final String COLUMN_INDEX = "table.columnIndex";
    ...
    private ITreeContentProvider _contentProvider = new AbstractACTRContentProvider() {
        ...
        public void inputChanged(Viewer viewer, Object oldInput, Object newInput) {
            if (newInput instanceof CommonTree) setRoot((CommonTree) newInput);
        }
    };
    ...
    protected abstract void getAST(ISession session, String modelName, double time, boolean isPostConflictResolution, Collection<CommonTree> container);

    public void setData(ISession session, String modelName, double time, boolean isPostConflictResolution) {
        ...
        Set<TableColumn> unprocessed = new HashSet<TableColumn>(_tableColumns.values());
