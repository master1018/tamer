...
public class AddPageTest extends BaseTestCase {
    ...
    public void testAddPage() throws Exception {
        ...
        selenium.typeKeys("new_page", RuntimeVariables.replace("Nested Portlets Test Page"));
        selenium.type("new_page", RuntimeVariables.replace("Nested Portlets Test Page"));
        ...
        selenium.click(RuntimeVariables.replace("link=Nested Portlets Test Page"));
        selenium.waitForPageToLoad("30000");
    }
}
