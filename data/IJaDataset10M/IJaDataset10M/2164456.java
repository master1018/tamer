...
public class RESConfig implements Cloneable {
    ...
    public final String versionString = " alpha1.9(06/03/2010) ";
    ...
    private byte procedureFormat;

    private byte dataNameFormat;
    ...
    public void loadDefaults() {
        ...
        tabSpaces = "";
        for (int i = 0; i < tabLength; ++i) tabSpaces += ' ';
    }
    ...
    private String applyNameValidation(String pkg) {
        ...
        while ((j = pkgBuff.indexOf(".", i)) > i) {
            pkgBuff.replace(i, j, NameUtil.convertCobolNameToJava(pkgBuff.substring(i, j), false).toLowerCase());
            i = j;
        }
    ...
    public void setPrintCobolStatementsAsComments(boolean printCobolStatementsAsComments) {
