...
public class PlayerTest extends FreeColTestCase {
    ...
    public void testUnits() {
        ...
        UnitType freeColonist = spec().getUnitType("model.unit.freeColonist");
        Unit unit1 = new ServerUnit(game, map.getTile(4, 7), dutch, freeColonist);
        Unit unit2 = new ServerUnit(game, map.getTile(4, 8), dutch, freeColonist);
        Unit unit3 = new ServerUnit(game, map.getTile(5, 7), dutch, freeColonist);
        Unit unit4 = new ServerUnit(game, map.getTile(5, 8), dutch, freeColonist);
        int count = 0;
    ...
    public void testFreecolPlayers() {
        ...
        for (Nation n : specification.getNations()) {
            Player p = new ServerPlayer(game, n.getRulerNameKey(), false, n, null, null);
    ...
    public void testAddAnotherPlayersUnit() {
        ...
        Unit colonist = new ServerUnit(game, map.getTile(6, 8), dutch, freeColonist);
