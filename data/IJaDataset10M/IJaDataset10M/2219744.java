...
public class PatientDAO {
    ...
    public boolean declareHCP(long pid, long hcpID) throws DBException, iTrustException {
        ...
        try {
            ...
            if (1062 == e.getErrorCode()) throw new iTrustException("HCP " + hcpID + " has already been declared for patient " + pid);
            e.printStackTrace();
            throw new DBException(e);
        } finally {
            DBUtil.closeConnection(conn, ps);
    ...
    public boolean addRepresentative(long representer, long representee) throws DBException, iTrustException {
        ...
        try {
            ...
            if (1062 == e.getErrorCode()) throw new iTrustException("Patient " + representer + " already represents patient " + representee);
            e.printStackTrace();
            throw new DBException(e);
        } finally {
            DBUtil.closeConnection(conn, ps);
