...
public class ReexportHTMLAction extends org.exmaralda.partitureditor.partiture.AbstractTableAction {
    ...
    private void reexportHTML() {
        org.exmaralda.partitureditor.interlinearText.InterlinearText it = ItConverter.BasicTranscriptionToInterlinearText(table.getModel().getTranscription(), table.getModel().getTierFormatTable());
        ...
        try {
            ...
            errorDialog.showMessageDialog(table, "File could not be written.\n" + "Error message was:\n" + ioe.getLocalizedMessage(), "IO error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
