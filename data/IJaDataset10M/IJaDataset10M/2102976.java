...
public class IgnitedLastKnownLocationAsyncTask extends AsyncTask<Void, Void, Location> {
     ...
     */
    public IgnitedLastKnownLocationAsyncTask(Context context, int locationUpdateDistanceDiff, long locationUpdateInterval) {
    ...
    protected Location getLastKnownLocation() {
        Location lastKnownLocation = lastLocationFinder.getLastBestLocation(locationUpdateDistanceDiff, System.currentTimeMillis() - locationUpdateInterval, false);
