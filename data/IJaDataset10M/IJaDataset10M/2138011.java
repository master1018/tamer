package com.google.code.head2head.gwtmodules.client.rating;
...
public class RateItWidget extends Composite implements SourcesChangeEvents {
    ...
    public RateItWidget(double rating, int maxRating, Image normalImage, Image ratedImage, Image normalZeroImage, Image ratedZeroImage, Image ratingImage) {
        this(rating, maxRating, normalImage, ratedImage, normalZeroImage, ratedZeroImage, new Image[] { ratingImage });
    }

    public RateItWidget(double rating, int maxRating, Image normalImage, Image ratedImage, Image normalZeroImage, Image ratedZeroImage, Image[] ratingImages) {
