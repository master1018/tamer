 ...
 */
    public void removeControlListener(ControlListener listener) {
        checkWidget();
        if (listener == null) error(SWT.ERROR_NULL_ARGUMENT);
        System.out.println("FIXME: TableColumn.removeControlListener");
    }
 ...
 */
    public void setAlignment(int alignment) {
        checkWidget();
        int index = getIndex();
        if ((alignment & (SWT.LEFT | SWT.RIGHT | SWT.CENTER)) != 0 && index != 0) {
            int style = getStyle();
 ...
 */
    public void setWidth(int width) {
        ...
        if (width != oldWidth) {
            ...
            parent.redraw(redrawX - 2, 0, 2, parent.getClientArea().height, false);
