...
public class CalendarTest extends junit.framework.TestCase {
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "setTime", args = { java.util.Date.class })
     ...
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "Verifies NullPointerException.", method = "compareTo", args = { java.util.Calendar.class })
     ...
     * @tests java.util.Calendar#compareTo(Calendar)
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "compareTo", args = { java.util.Calendar.class })
    ...
    public void test_clone() {
        ...
        assertNotSame("getTimeZone", cal.getTimeZone(), anotherCal.getTimeZone());
    }

    /**
     * @tests java.util.Calendar#getTimeInMillis()
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getTimeInMillis", args = {  })
     ...
     */
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getActualMinimum", args = { int.class }), @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "Calendar", args = {  }) })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "Calendar", args = { java.util.TimeZone.class, java.util.Locale.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test calls dummy implementation of abstract method.", method = "add", args = { int.class, int.class })
    public void test_addII() {
        MockCalendar mc = new MockCalendar();
        mc.add(Calendar.DAY_OF_YEAR, 7);
    }

    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "after", args = { java.lang.Object.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "before", args = { java.lang.Object.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "complete", args = {  })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "computeFields", args = {  })
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getFirstDayOfWeek", args = {  }), @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getInstance", args = {  }) })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getInstance", args = { java.util.Locale.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getInstance", args = { java.util.TimeZone.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getInstance", args = { java.util.TimeZone.class, java.util.Locale.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getTimeZone", args = {  })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "internalGet", args = { int.class })
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "isLenient", args = {  }), @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "setLenient", args = { boolean.class }) })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "isSet", args = { int.class })
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "set", args = { int.class, int.class, int.class }), @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "setTimeInMillis", args = { long.class }) })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "set", args = { int.class, int.class, int.class, int.class, int.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "set", args = { int.class, int.class, int.class, int.class, int.class, int.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "setTimeZone", args = { java.util.TimeZone.class })
    ...
    @TestTargetNew(level = TestLevel.ADDITIONAL, method = "get", args = { int.class })
