...
public class KubrickDvds {
    ...
    public byte[] createPdf() throws DocumentException, IOException, SQLException {
        ...
        for (Movie movie : movies) {
            annot = PdfAnnotation.createFileAttachment(writer, null, movie.getMovieTitle(false), null, String.format(RESOURCE, movie.getImdb()), String.format("%s.jpg", movie.getImdb()));
