...
public class FileUploadFilter extends AbstractFilter {
    ...
    public static List<FileItem> getFiles(HttpServletRequest request) throws FileUploadException {
        ...
        if (files == null) throw new IllegalStateException("Missing files, perhaps filter not configured or form enctype was wrong");
        return files;
    }
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public String getParameter(String name) {
            ...
            if (val == null) return null; else return val[0];
        }
