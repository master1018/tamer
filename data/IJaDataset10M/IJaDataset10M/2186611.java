...
public class RestrictNamingInvokerFilter extends NamingInvokerFilter {
    ...
    @Override
    protected Object lookup(HttpServletRequest request, HttpServletResponse response, String name, String method, String[] args) {
        Object impl = super.lookup(request, response, name, method, args);
        BlockingInvocationHandlerAdapter adapter = new BlockingInvocationHandlerAdapter(impl, domain);
