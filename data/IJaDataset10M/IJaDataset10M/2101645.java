...
public class MonitorResources {
     ...
     */
    public static final ModuleClassID monitorServiceClassID = (ModuleClassID) ID.create(URI.create(WK_ID_PREFIX + "0000011F05"));

    /**
     * Well known module class identifier: resolver service
     */
    public static final ModuleClassID resolverServiceMonitorClassID = (ModuleClassID) ID.create(URI.create(WK_ID_PREFIX + "0000010205"));

    /**
     * Well known module class identifier: discovery service
     */
    public static final ModuleClassID discoveryServiceMonitorClassID = (ModuleClassID) ID.create(URI.create(WK_ID_PREFIX + "0000010305"));

    /**
     * Well known module class identifier: pipe service
     */
    public static final ModuleClassID pipeServiceMonitorClassID = (ModuleClassID) ID.create(URI.create(WK_ID_PREFIX + "0000010405"));

    /**
     * Well known module class identifier: membership service
     */
    public static final ModuleClassID membershipServiceMonitorClassID = (ModuleClassID) ID.create(URI.create(WK_ID_PREFIX + "0000010505"));

    /**
     * Well known module class identifier: rendezvous service
     */
    public static final ModuleClassID rendezvousServiceMonitorClassID = (ModuleClassID) ID.create(URI.create(WK_ID_PREFIX + "0000010605"));

    /**
     * Well known module class identifier: peerinfo service
     */
    public static final ModuleClassID peerinfoServiceMonitorClassID = (ModuleClassID) ID.create(URI.create(WK_ID_PREFIX + "0000010705"));

    /**
     * Well known module class identifier: endpoint service
     */
    public static final ModuleClassID endpointServiceMonitorClassID = (ModuleClassID) ID.create(URI.create(WK_ID_PREFIX + "0000010805"));

    /**
     * Well known module class identifier: transport protocol
     */
    public static final ModuleClassID transportServiceMonitorClassID = (ModuleClassID) ID.create(URI.create(WK_ID_PREFIX + "0000010905"));

    /**
     * Well known module class identifier: router protocol
     */
    public static final ModuleClassID routerServiceMonitorClassID = (ModuleClassID) ID.create(URI.create(WK_ID_PREFIX + "0000010B05"));

    /**
     * Well known module class identifier: tlsProtocol
     */
    public static final ModuleClassID tlsProtoServiceMonitorClassID = (ModuleClassID) ID.create(URI.create(WK_ID_PREFIX + "00000105"));

    /**
     * Well known module class identifier: ProxyService
     */
    public static final ModuleClassID proxyServiceMonitorClassID = (ModuleClassID) ID.create(URI.create(WK_ID_PREFIX + "0000010E05"));

    /**
     * Well known module class identifier: RelayProtocol
     */
    public static final ModuleClassID relayServiceMonitorClassID = (ModuleClassID) ID.create(URI.create(WK_ID_PREFIX + "0000010F05"));

    /**
     * Well known service specification identifier: the standard monitor
     */
    public static final ModuleSpecID refMonitorServiceSpecID = (ModuleSpecID) ID.create(URI.create(WK_ID_PREFIX + "0000011F0106"));

    /**
     * Well known service specification identifier: the standard resolver
     */
    public static final ModuleSpecID refResolverServiceMonitorSpecID = (ModuleSpecID) ID.create(URI.create(WK_ID_PREFIX + "000001020106"));

    /**
     * Well known service specification identifier: the standard discovery
     */
    public static final ModuleSpecID refDiscoveryServiceMonitorSpecID = (ModuleSpecID) ID.create(URI.create(WK_ID_PREFIX + "000001030106"));

    /**
     * Well known service specification identifier: the standard pipe
     */
    public static final ModuleSpecID refPipeServiceMonitorSpecID = (ModuleSpecID) ID.create(URI.create(WK_ID_PREFIX + "000001040106"));

    /**
     * Well known service specification identifier: the standard membership
     */
    public static final ModuleSpecID refMembershipServiceMonitorSpecID = (ModuleSpecID) ID.create(URI.create(WK_ID_PREFIX + "000001050106"));

    /**
     * Well known service specification identifier: the standard rendezvous
     */
    public static final ModuleSpecID refRendezvousServiceMonitorSpecID = (ModuleSpecID) ID.create(URI.create(WK_ID_PREFIX + "000001060106"));

    /**
     * Well known service specification identifier: the standard peerinfo
     */
    public static final ModuleSpecID refPeerinfoServiceMonitorSpecID = (ModuleSpecID) ID.create(URI.create(WK_ID_PREFIX + "000001070106"));

    /**
     * Well known service specification identifier: the standard endpoint
     */
    public static final ModuleSpecID refEndpointServiceMonitorSpecID = (ModuleSpecID) ID.create(URI.create(WK_ID_PREFIX + "000001080106"));

    /**
     * Well known endpoint protocol specification identifier: the standard
     * transport Service Monitor
     */
    public static final ModuleSpecID refTransportServiceMonitorSpecID = (ModuleSpecID) ID.create(URI.create(WK_ID_PREFIX + "000001090106"));

    /**
     * Well known endpoint protocol specification identifier: the standard
     * router
     */
    public static final ModuleSpecID refRouterServiceMonitorSpecID = (ModuleSpecID) ID.create(URI.create(WK_ID_PREFIX + "0000010B0106"));

    /**
     * Well known endpoint protocol specification identifier: the standard
     * tls endpoint protocol
     */
    public static final ModuleSpecID refTlsServiceMonitorSpecID = (ModuleSpecID) ID.create(URI.create(WK_ID_PREFIX + "0000010D0106"));

    /**
     * Well known application: the Proxy
     */
    public static final ModuleSpecID refProxyServiceMonitorSpecID = (ModuleSpecID) ID.create(URI.create(WK_ID_PREFIX + "0000010E0106"));

    /**
     * Well known endpoint protocol specification identifier: the standard
     * relay endpoint protocol
     */
    public static final ModuleSpecID refRelayServiceMonitorSpecID = (ModuleSpecID) ID.create(URI.create(WK_ID_PREFIX + "0000010F0106"));
    ...
    public static ModuleImplAdvertisement getReferenceAllPurposeMonitorServiceImplAdvertisement(boolean includeTransports) {
        ...
        StructuredTextDocument param = (StructuredTextDocument) StructuredDocumentFactory.newStructuredDocument(MimeMediaType.XMLUTF8, "serviceMonitor");
        addServiceMonitorServiceAdvertisement(param, refResolverServiceMonitorSpecID, "Resolver", "net.jxta.impl.resolver.resolverMeter.ResolverServiceMonitor", "net.jxta.impl.resolver.resolverMeter.ResolverServiceMetric", "net.jxta.impl.resolver.resolverMeter.ResolverServiceMonitorFilter");
        addServiceMonitorServiceAdvertisement(param, refEndpointServiceMonitorSpecID, "Endpoint", "net.jxta.impl.endpoint.endpointMeter.EndpointServiceMonitor", "net.jxta.impl.endpoint.endpointMeter.EndpointServiceMetric", "net.jxta.impl.endpoint.endpointMeter.EndpointServiceMonitorFilter");
        addServiceMonitorServiceAdvertisement(param, refTransportServiceMonitorSpecID, "Transport", "net.jxta.impl.endpoint.transportMeter.TransportServiceMonitor", "net.jxta.impl.endpoint.transportMeter.TransportServiceMetric", "net.jxta.impl.endpoint.transportMeter.TransportServiceMonitorFilter");
        addServiceMonitorServiceAdvertisement(param, refRendezvousServiceMonitorSpecID, "Rendezvous", "net.jxta.impl.rendezvous.rendezvousMeter.RendezvousServiceMonitor", "net.jxta.impl.rendezvous.rendezvousMeter.RendezvousServiceMetric", "net.jxta.impl.rendezvous.rendezvousMeter.RendezvousServiceMonitorFilter");
    ...
    private static void addServiceMonitorServiceAdvertisement(Element root, ModuleSpecID moduleSpecID, String title, String implClassName, String metricClassName, String filterClassName) {
        ModuleImplAdvertisement moduleImplAdvertisement = createServiceMonitorModuleImplAdvertisement(moduleSpecID, title, implClassName, metricClassName, filterClassName);
        ...
        ServiceResource(ModuleImplAdvertisement moduleImplAdvertisement) throws JxtaException {
            try {
                ...
                if (!(ServiceMonitorFilter.class).isAssignableFrom(serviceMonitorFilterClass)) {
                    throw new JxtaException("Bad ServiceMonitorImplAdvertisment: " + serviceMonitorFilterClassName + " is not a ServiceMonitorFilter");
                }
                ...
                if (!(ServiceMetric.class).isAssignableFrom(serviceMetricClass)) {
                    throw new JxtaException("Bad ServiceMonitorImplAdvertisment: " + serviceMetricClassName + " is not a ServiceMetric");
                }
            } catch (Exception e) {
