...
public abstract class ObjectImpl implements org.omg.CORBA.Object {
   ...
   */
    ...
    */
    public Request _create_request(Context context, String operation, NVList parameters, NamedValue returns, ExceptionList exceptions, ContextList ctx_list) {
        return delegate.create_request(this, context, operation, parameters, returns, exceptions, ctx_list);
    }
   ...
   */
    public InputStream _invoke(OutputStream output) throws org.omg.CORBA.portable.ApplicationException, org.omg.CORBA.portable.RemarshalException {
   ...
   */
    public boolean _is_equivalent(org.omg.CORBA.Object other) {
        return (delegate == null) ? this == other : delegate.is_equivalent(this, other);
    }
  ...
  */
   ...
   */
    public void _releaseReply(InputStream stream) {
        if (delegate != null) delegate.releaseReply(this, stream);
    }
   ...
   */
    public boolean equals(java.lang.Object other) {
        if (delegate == null) return this == other; else return delegate.equals(this, other);
    }
