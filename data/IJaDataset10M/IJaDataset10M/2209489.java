...
public class DefaultTreeModelTest extends SwingTestCase {
    ...
    class ConcreteTreeModelListener extends FindableListener implements TreeModelListener {
        ...
        public void checkEvent(Object source, Object[] path, int[] childIndices, Object[] children) {
    ...
    public void testInsertNodeInto() {
        ...
        assertNotNull(listener.event);
        listener.checkEvent(model, new Object[] { node2 }, new int[] { 0 }, new Object[] { node1 });
        assertEquals(node1, node2.getChildAt(0));
        listener.reset();
        model.insertNodeInto(node3, node2, 0);
        listener.checkEvent(model, new Object[] { node2 }, new int[] { 0 }, new Object[] { node3 });
    ...
    public void testRemoveNodeFromParent() {
        ...
        assertNotNull(listener.event);
        listener.checkEvent(model, new Object[] { node1 }, new int[] { 1 }, new Object[] { node3 });
        assertEquals(1, node1.getChildCount());
        listener.reset();
        model.removeNodeFromParent(node2);
        assertNotNull(listener.event);
        listener.checkEvent(model, new Object[] { node1 }, new int[] { 0 }, new Object[] { node2 });
    ...
    public void testNodeChanged() {
        ...
        assertNotNull(listener.event);
        assertEquals("changed", listener.type);
        listener.checkEvent(model, new Object[] { node1, node2 }, new int[] { 0 }, new Object[] { node3 });
        listener.reset();
        model.nodeChanged(node4);
        assertNotNull(listener.event);
        assertEquals("changed", listener.type);
        listener.checkEvent(model, new Object[] { node1, node2 }, new int[] { 1 }, new Object[] { node4 });
        listener.reset();
    }
    ...
    public void testNodesWereInserted() {
        ...
        listener.checkEvent(model, new Object[] { node1 }, new int[] { 1, 0 }, new Object[] { node5, node2 });
        listener.reset();
        model.nodesWereInserted(node2, new int[] { 0, 1 });
        assertNotNull(listener.event);
        assertEquals("inserted", listener.type);
        listener.checkEvent(model, new Object[] { node1, node2 }, new int[] { 0, 1 }, new Object[] { node3, node4 });
        listener.reset();
    }
    ...
    public void testNodesWereRemoved() {
        ...
        listener.checkEvent(model, new Object[] { node1 }, new int[] { 1, 0 }, new Object[] { node3, node4 });
        listener.reset();
        model.nodesWereRemoved(node4, new int[] { 1 }, new Object[] { node3, node5 });
        assertNotNull(listener.event);
        assertEquals("removed", listener.type);
        listener.checkEvent(model, new Object[] { node1, node2, node4 }, new int[] { 1 }, new Object[] { node3, node5 });
        listener.reset();
    }
    ...
    public void testNodesChanged() {
        ...
        assertNotNull(listener.event);
        assertEquals("changed", listener.type);
        listener.checkEvent(model, new Object[] { root }, new int[] { 0 }, new Object[] { node6 });
        listener.reset();
        ...
        assertNotNull(listener.event);
        assertEquals("changed", listener.type);
        listener.checkEvent(model, new Object[] { node1 }, new int[] { 0, 1 }, new Object[] { node2, node5 });
        listener.reset();
    }
