        ...
        switch(pnts.length) {
            case 3:
                while (i < loopStopIndex) {
                    ...
                    if (intersectTriTri(points[0], points[1], points[2], pnts[0], pnts[1], pnts[2]) || intersectTriTri(points[0], points[2], points[3], pnts[0], pnts[1], pnts[2])) {
                        return true;
                    }
                }
                break;
            case 4:
                while (i < loopStopIndex) {
                    ...
                    getVertexData(indexCoord[i++], points[2]);
                    getVertexData(indexCoord[i++], points[3]);
                    if (intersectTriTri(points[0], points[1], points[2], pnts[0], pnts[1], pnts[2]) || intersectTriTri(points[0], points[1], points[2], pnts[0], pnts[2], pnts[3]) || intersectTriTri(points[0], points[2], points[3], pnts[0], pnts[1], pnts[2]) || intersectTriTri(points[0], points[2], points[3], pnts[0], pnts[2], pnts[3])) {
                        return true;
                    }
                }
                break;
            ...
            case 1:
                while (i < loopStopIndex) {
                    ...
                    getVertexData(indexCoord[i++], points[2]);
                    getVertexData(indexCoord[i++], points[3]);
                    if (intersectTriPnt(points[0], points[1], points[2], pnts[0]) || intersectTriPnt(points[0], points[2], points[3], pnts[0])) {
                        return true;
                    }
                }
                break;
