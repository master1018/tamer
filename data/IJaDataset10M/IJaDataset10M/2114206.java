...
public class AngleTracker extends AbstractTracker {
    ...
    public AngleTracker(ScreenAtom atom1, ScreenAtom atom2, ScreenAtom atom3) {
        ...
        this.atom2 = atom2;
        this.atom3 = atom3;
        double angle = MathUtil.toDegrees(MathUtil.findAngle(atom1.getAtom().getAtomCenter(), atom2.getAtom().getAtomCenter(), atom3.getAtom().getAtomCenter()));
        angleString = (new DecimalFormat("#.###").format(angle)) + " " + Utility.DEGREE_SYMBOL;
    ...
    public void draw(Graphics2D g2d) {
        Stroke drawingStroke = new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, new float[] { 1, 3 }, 0);
        ...
        if (!isolated) {
            ...
            theArc.setCurve(new Point2D.Double(midX12, midY12), new Point2D.Double(midX13, midY13), new Point2D.Double(midX23, midY23));
            g2d.draw(theArc);
