...
public class ViewingPanel extends JPanel {
    ...
    public ViewingPanel(String title) {
        ...
        desktop.setBorder(tb = new TitledBorder(new CompoundBorder(new EtchedBorder(), new EmptyBorder(4, 4, 4, 4)), title));
     ...
     */
    public void addScreen(String title, Player player, int displayFlags) {
