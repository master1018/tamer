...
public class LocateReplyPacket extends Packet {
    ...
    public void send() throws InvalidPacketException {
        if (target_name == null || located_mud_name == null || located_visible_name == null || status == null) {
            throw new InvalidPacketException();
        }
        super.send();
    }
    ...
    public String toString() {
        return "({\"locate-reply\",5,\"" + Server.getMudName() + "\",0,\"" + target_mud + "\",\"" + target_name + "\",\"" + located_mud_name + "\",\"" + located_visible_name + "\"," + idle_time + ",\"" + status + "\",})";
    }
}
