...
public class LuceneTest extends ATest {
    ...
    private String string = "Qu'est ce qui détermine la productivité, et comment est-il mesuré? " + "Was bestimmt die Produktivität, und wie wird sie gemessen? " + "Что определяет производительность труда, и как ее измерить? " + "Soleymān Khāţer Solţānābād";
