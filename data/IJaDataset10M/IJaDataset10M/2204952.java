...
public abstract class DataType implements java.io.Serializable {
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (obj instanceof DataType) {
            ...
            } else if (temp._mimeType != null) return false;
            ...
            } else if (temp._encoding != null) return false;
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        if (_mimeType != null && !org.castor.core.util.CycleBreaker.startingToCycle(_mimeType)) {
            result = 37 * result + _mimeType.hashCode();
            org.castor.core.util.CycleBreaker.releaseCycleHandle(_mimeType);
        }
        if (_encoding != null && !org.castor.core.util.CycleBreaker.startingToCycle(_encoding)) {
