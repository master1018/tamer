...
public class StatementMetaData {
    ...
    private static Pattern[] SELECT_PATTERNS = new Pattern[] { Pattern.compile("^\\s*SELECT\\s+", Pattern.CASE_INSENSITIVE), Pattern.compile("^\\s*SHOW\\s+", Pattern.CASE_INSENSITIVE), Pattern.compile("^\\s*DESC\\s+", Pattern.CASE_INSENSITIVE), Pattern.compile("^\\s*DESCRIBE\\s+", Pattern.CASE_INSENSITIVE) };
