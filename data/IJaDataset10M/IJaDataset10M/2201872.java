...
public class JTabbedPane extends JComponent implements Serializable, Accessible, SwingConstants {
   ...
   */
     ...
     */
        public void setTitle(String text) {
            title = text;
            if (title != null && title.length() <= underlinedChar) setDisplayedMnemonicIndex(title.length() - 1);
        }
     ...
     */
        public Icon getDisabledIcon() {
            if (disabledIcon == null && icon instanceof ImageIcon) setDisabledIcon(icon);
            return disabledIcon;
        }
     ...
     */
        public void setMnemonic(char aChar) {
            mnemonicKey = aChar;
            if (title != null) setDisplayedMnemonicIndex(title.indexOf(mnemonicKey));
        }
     ...
     */
        public void setDisplayedMnemonicIndex(int index) throws IllegalArgumentException {
            if (index < -1 || title != null && index >= title.length()) throw new IllegalArgumentException();
            if (title == null || mnemonicKey == 0 || (index > -1 && title.charAt(index) != mnemonicKey)) index = -1;
   ...
   */
    public JTabbedPane(int tabPlacement, int tabLayoutPolicy) {
        if (tabPlacement != TOP && tabPlacement != BOTTOM && tabPlacement != RIGHT && tabPlacement != LEFT) throw new IllegalArgumentException("tabPlacement is not valid.");
        if (tabLayoutPolicy != SCROLL_TAB_LAYOUT && tabLayoutPolicy != WRAP_TAB_LAYOUT) throw new IllegalArgumentException("tabLayoutPolicy is not valid.");
   ...
   */
    protected void fireStateChanged() {
        ...
        for (int i = changeListeners.length - 2; i >= 0; i -= 2) {
            if (changeListeners[i] == ChangeListener.class) ((ChangeListener) changeListeners[i + 1]).stateChanged(changeEvent);
        }
    }
   ...
   */
    private void checkIndex(int index, int start, int end) {
        if (index < start || index >= end) throw new IndexOutOfBoundsException("Index < " + start + " || Index >= " + end);
    }
   ...
   */
    public void setSelectedIndex(int index) {
        ...
        if (index != getSelectedIndex()) {
            if (getSelectedIndex() != -1 && getSelectedComponent() != null) getSelectedComponent().hide();
            if (index != -1 && getComponentAt(index) != null) getComponentAt(index).show();
   ...
   */
    public void setSelectedComponent(Component c) {
        if (c.getParent() == this) setSelectedIndex(indexOfComponent(c)); else setComponentAt(getSelectedIndex(), c);
    }
   ...
   */
    public Component add(Component component) {
        if (component instanceof UIResource) super.add(component); else insertTab(component.getName(), null, component, null, tabs.size());
        return component;
    }
   ...
   */
    public Component add(String title, Component component) {
        if (component instanceof UIResource) super.add(component); else insertTab(title, null, component, null, tabs.size());
        return component;
    }
   ...
   */
    public Component add(Component component, int index) {
        if (component instanceof UIResource) super.add(component); else insertTab(component.getName(), null, component, null, index);
        return component;
    }
   ...
   */
    public void add(Component component, Object constraints, int index) {
        if (component instanceof UIResource) super.add(component); else {
            if (constraints instanceof String) insertTab((String) constraints, null, component, null, index); else insertTab(component.getName(), (constraints instanceof Icon) ? (Icon) constraints : null, component, null, index);
        }
    }
   ...
   */
    public void removeAll() {
        for (int i = tabs.size() - 1; i >= 0; i--) removeTabAt(i);
    }
   ...
   */
    public AccessibleContext getAccessibleContext() {
        if (accessibleContext == null) accessibleContext = new AccessibleJTabbedPane();
