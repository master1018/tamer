...
public class PopupCellEditor extends BasicGraphUI implements java.io.Serializable {
            ...
            if (cellEditor.isCellEditable(event)) {
                new Thread() {
                    ...
                    public void run() {
                        ...
                        createIndependentEditDialog(cell, accept, cancel, main, ent, gep);
                    }
                }.start();
                return true;
            } else {
    ...
    private void createIndependentEditDialog(Object cell, JButton accept, JButton cancel, JPanel main, final Entity ent, final GeneralEditionPanel gep) {
        editingCell = cell;
        ...
        cancel.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (gep.isModified()) {
                    int result = JOptionPane.showConfirmDialog(owner, "You will loose current changes. Do you want to continue (y/n)?", "Warning", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
