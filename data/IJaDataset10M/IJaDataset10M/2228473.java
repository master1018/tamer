...
public class TestCertificateExpireTimedService extends BaseMailSignerTester {
    ...
    protected void setUp() throws Exception {
        ...
        TestUtils.assertSuccessfulExecution(new String[] { "module", "add", signserverhome + "/dist-server/simplemailsigner.mar", "" });
    ...
    protected void tearDown() throws Exception {
        ...
        TestUtils.assertSuccessfulExecution(new String[] { "removeworker", "" + getWorkerId() });
        TestUtils.assertSuccessfulExecution(new String[] { "removeworker", "" + SERVICEID });
