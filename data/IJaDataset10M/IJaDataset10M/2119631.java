...
public final class GetProcessLogsHandler extends AbstractHandler {
    ...
    protected JbpmActionListener getListener(final FaceletContext ctx) {
        return new GetProcessLogsActionListener(getValueExpression(processInstanceTagAttribute, ctx, ProcessInstance.class), getValueExpression(typeTagAttribute, ctx, Object.class), getValueExpression(targetTagAttribute, ctx, List.class));
    }
}
