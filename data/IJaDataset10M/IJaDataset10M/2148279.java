...
public class TimeSlotListWidget extends Composite implements ValueAwareEditor<List<TimeSlotProxy>> {
    ...
    private static TimeSlotListWidgetUiBinder uiBinder = GWT.create(TimeSlotListWidgetUiBinder.class);
