...
public class AddOutputDataPanel extends Composite {
    ...
    private void createHeader() {
        ...
        outputDataLabel.setFont(createOutputDataLabelFont(outputDataLabel.getDisplay(), outputDataLabel.getFont().getFontData()));
    }
    ...
    private Font createOutputDataLabelFont(Device device, FontData[] oldFontData) {
    ...
    private class GetOutputDataAction implements Runnable {
        ...
        public void run() {
            ...
            for (int ii = 0; ii < tableItems.length; ii++) {
                outputDataItems[ii] = (OutputDataItem) idToOutputDataItemMap.get(tableItems[ii].getText(0));
            }
        }
    }
}
