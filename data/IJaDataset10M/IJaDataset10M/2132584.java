...
public class AlertInstantMessaging extends JOptionPane {
    ...
    public AlertInstantMessaging(String text, int messageType, String initialInputValue) {
        ...
        if (messageType == JOptionPane.ERROR_MESSAGE) showMessageDialog(this, text, "Error", messageType); else if (messageType == JOptionPane.WARNING_MESSAGE) showMessageDialog(this, text, "Warning", messageType); else if (messageType == JOptionPane.INFORMATION_MESSAGE) {
