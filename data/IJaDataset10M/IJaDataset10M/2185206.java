...
public class MxlPrintAttributes {
    ...
    public static MxlPrintAttributes read(Element e) {
        ...
        if (newSystem != null || newPage != null) return new MxlPrintAttributes(newSystem, newPage); else return empty;
    }

    public void write(Element e) {
        if (this != empty) {
            if (newSystem != null) addAttribute(e, "new-system", MxlYesNo.write(newSystem));
            if (newPage != null) addAttribute(e, "new-page", MxlYesNo.write(newPage));
        }
    }
}
