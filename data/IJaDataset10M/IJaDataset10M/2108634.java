...
public class SimulateWindow extends JDialog implements ActionListener {
    ...
    private JButton synt = new JButton("Simular Sint�tico");
    ...
    public static SimulateWindow getInstance() {
        if (instance == null) instance = new SimulateWindow();
        return instance;
    }
            ...
            tbl.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
                ...
                public void valueChanged(ListSelectionEvent e) {
                    ...
                    if (!lsm.isSelectionEmpty()) {
                        ...
                        if (t.getId() != -1) ta.getCaret().moveDot(t.getPosition() + t.getLexeme().length());
                    }
                }
            });
        }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == lex) lexClick(); else if (e.getSource() == synt) syntClick(); else if (e.getSource() == close) closeClick();
    }
    ...
    private void lexClick() {
        ...
        try {
            ...
            tokensModel.add(dummy, "ERRO L�XICO");
            e.printStackTrace();
        }
    }
    ...
    private void syntClick() {
        ...
        DefaultMutableTreeNode root = new DefaultMutableTreeNode("Deriva��o");
