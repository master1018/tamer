...
public class Arithmetic extends Constants {
    ...
    public static double factorial(int k) {
        ...
        if (k < length1 + length2) return doubleFactorials[k - length1]; else return Double.POSITIVE_INFINITY;
    }
