 ...
 * @author Chris Wilper
 */
public class FedoraDSCompositeModel1_0Format extends XMLFormat {

    /** The only instance of this class. */
    private static final FedoraDSCompositeModel1_0Format ONLY_INSTANCE = new FedoraDSCompositeModel1_0Format();

    /**
     * Constructs the instance.
     */
    private FedoraDSCompositeModel1_0Format() {
        super("info:fedora/fedora-system:FedoraDSCompositeModel-1.0", FedoraDSCompositeModelNamespace.getInstance(), "http://www.fedora.info/definitions/1/0/dsCompositeModel.xsd");
    }
