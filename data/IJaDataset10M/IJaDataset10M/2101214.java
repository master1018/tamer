...
public class TileItemContainer extends FreeColGameObject {
    ...
    public TileImprovement addRiver(int magnitude, int style) {
        ...
        TileImprovement river = new TileImprovement(getGame(), tile, getSpecification().getTileImprovementType("model.improvement.river"));
    ...
    protected void toXMLImpl(XMLStreamWriter out, Player player, boolean showAll, boolean toSavedGame) throws XMLStreamException {
        PlayerExploredTile pet = (showAll || toSavedGame) ? null : tile.getPlayerExploredTile(player);
