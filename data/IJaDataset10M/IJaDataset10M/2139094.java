...
public class Real3Range implements EuclidConstants {
    ...
    public boolean isEqualTo(Real3Range r3, double eps) {
        return (xyzrange[0].isEqualTo(r3.xyzrange[0], eps) && xyzrange[1].isEqualTo(r3.xyzrange[1], eps) && xyzrange[2].isEqualTo(r3.xyzrange[2], eps));
    }
    ...
    public boolean isEqualTo(Real3Range r3) {
        return (xyzrange[0].isEqualTo(r3.xyzrange[0]) && xyzrange[1].isEqualTo(r3.xyzrange[1]) && xyzrange[2].isEqualTo(r3.xyzrange[2]));
    }
    ...
    public Real3Range plus(Real3Range r3) {
        return new Real3Range(xyzrange[0].plus(r3.xyzrange[0]), xyzrange[1].plus(r3.xyzrange[1]), xyzrange[2].plus(r3.xyzrange[2]));
    }
    ...
    public boolean includes(Point3 p) {
        ...
        return (xyzrange[0].includes(coords[0]) && xyzrange[1].includes(coords[1]) && xyzrange[2].includes(coords[2]));
    }
    ...
    public Point3 getMinPoint3() {
        return new Point3(xyzrange[0].getMin(), xyzrange[1].getMin(), xyzrange[2].getMin());
    }
    ...
    public Point3 getMaxPoint3() {
        return new Point3(xyzrange[0].getMax(), xyzrange[1].getMax(), xyzrange[2].getMax());
    }
    ...
    public String toString() {
        return EC.S_LBRAK + xyzrange[0] + EC.S_COMMA + xyzrange[1] + EC.S_COMMA + xyzrange[2] + EC.S_RBRAK;
    }
}
