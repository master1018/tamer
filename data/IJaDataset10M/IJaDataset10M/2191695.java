...
public class GrantPanel implements DataEntryPanel {
    ...
    public GrantPanel(@Nonnull WabitWorkspace workspace, @Nonnull WabitWorkspace systemWorkspace, @Nonnull String xobjectType, @Nullable String xobjectUuid, @Nonnull String label) {
        ...
        this.createCheckBox.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (oldGrant != null) {
                    Grant newGrant = new Grant(oldGrant.getSubject(), oldGrant.getType(), createCheckBox.isSelected(), oldGrant.isModifyPrivilege(), oldGrant.isDeletePrivilege(), oldGrant.isExecutePrivilege(), oldGrant.isGrantPrivilege());
                    grantsToDelete.add(oldGrant);
                    grants.put(uuid, newGrant);
                } else {
                    Grant newGrant = new Grant(objectUuid, objectType, createCheckBox.isSelected(), false, false, false, false);
                    grants.put(uuid, newGrant);
                }
                dirty = true;
            }
        ...
        this.modifyCheckBox.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Grant oldGrant = grants.get(uuid);
                if (oldGrant != null) {
                    Grant newGrant = new Grant(oldGrant.getSubject(), oldGrant.getType(), oldGrant.isCreatePrivilege(), modifyCheckBox.isSelected(), oldGrant.isDeletePrivilege(), oldGrant.isExecutePrivilege(), oldGrant.isGrantPrivilege());
                    grantsToDelete.add(oldGrant);
                    grants.put(uuid, newGrant);
                } else {
                    Grant newGrant = new Grant(objectUuid, objectType, false, modifyCheckBox.isSelected(), false, false, false);
                    grants.put(uuid, newGrant);
                }
                dirty = true;
            }
        ...
        this.deleteCheckBox.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Grant oldGrant = grants.get(uuid);
                if (oldGrant != null) {
                    Grant newGrant = new Grant(oldGrant.getSubject(), oldGrant.getType(), oldGrant.isExecutePrivilege(), oldGrant.isModifyPrivilege(), deleteCheckBox.isSelected(), oldGrant.isExecutePrivilege(), oldGrant.isGrantPrivilege());
                    grantsToDelete.add(oldGrant);
                    grants.put(uuid, newGrant);
                } else {
                    Grant newGrant = new Grant(objectUuid, objectType, false, false, deleteCheckBox.isSelected(), false, false);
                    grants.put(uuid, newGrant);
                }
                dirty = true;
            }
        ...
        this.executeCheckBox.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Grant oldGrant = grants.get(uuid);
                if (oldGrant != null) {
                    Grant newGrant = new Grant(oldGrant.getSubject(), oldGrant.getType(), oldGrant.isCreatePrivilege(), oldGrant.isModifyPrivilege(), oldGrant.isDeletePrivilege(), executeCheckBox.isSelected(), oldGrant.isGrantPrivilege());
                    grantsToDelete.add(oldGrant);
                    grants.put(uuid, newGrant);
                } else {
                    Grant newGrant = new Grant(objectUuid, objectType, false, false, false, executeCheckBox.isSelected(), false);
                    grants.put(uuid, newGrant);
                }
                dirty = true;
            }
        ...
        this.grantCheckBox.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Grant oldGrant = grants.get(uuid);
                if (oldGrant != null) {
                    Grant newGrant = new Grant(oldGrant.getSubject(), oldGrant.getType(), oldGrant.isCreatePrivilege(), oldGrant.isModifyPrivilege(), oldGrant.isDeletePrivilege(), oldGrant.isExecutePrivilege(), grantCheckBox.isSelected());
                    grantsToDelete.add(oldGrant);
                    grants.put(uuid, newGrant);
                } else {
                    Grant newGrant = new Grant(objectUuid, objectType, false, false, false, false, grantCheckBox.isSelected());
                    grants.put(uuid, newGrant);
                }
                dirty = true;
            }
        ...
        synchronized (systemWorkspace) {
            ...
            try {
                for (Entry<String, Grant> entry : this.grants.entrySet()) {
                    ...
                    if (!grant.isCreatePrivilege() && !grant.isDeletePrivilege() && !grant.isExecutePrivilege() && !grant.isGrantPrivilege() && !grant.isModifyPrivilege()) {
