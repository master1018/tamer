...
public class SamePropertyValuesAs<T> extends TypeSafeDiagnosingMatcher<T> {
    ...
    public boolean matchesSafely(T item, Description mismatchDescription) {
        return isCompatibleType(item, mismatchDescription) && hasNoExtraProperties(item, mismatchDescription) && hasMatchingValues(item, mismatchDescription);
    }
    ...
    public void describeTo(Description description) {
        description.appendText("same property values as " + expectedBean.getClass().getSimpleName()).appendList(" [", ", ", "]", propertyMatchers);
    }
