 ...
 * for the activator, the remote object handling object activation, if that
 * remote object is exported with {@link net.jini.jeri.BasicJeriExporter}. This
 * class can be passed to {@link net.jini.jeri.BasicInvocationDispatcher}, and
 * then used in security policy permission grants.
 * 
 * <p>
 * This permission class can be used for server-side access control of remote
 * object activation initiated by the client-side
 * {@link java.rmi.activation.ActivationID#activate ActivationID.activate}
 * method. The server-side method name for this operation is
 * <code>activate</code>.
 * 
 * <p>
 ...
 * <td>The caller can activate an object and obtain the proxy for it if it knows
 * the activation identifier.</td>
 * </tr>
 * <tr>
 * <td>net.jini.security.proxytrust.ProxyTrust.getProxyVerifier</td>
 * <td>invoking {@link net.jini.security.proxytrust.ProxyTrust#getProxyVerifier
