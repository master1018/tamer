...
public class FileSystemPageTest extends TestCase {
    ...
    public void testDefaultAttributes() throws Exception {
        ...
        assertTrue(page.getData().hasAttribute(WikiPage.ACTION_EDIT));
    }
    ...
    public void testPersistentAttributes() throws Exception {
        ...
        data.setAttribute(WikiPage.ACTION_TEST, "true");
        data.setAttribute(WikiPage.ACTION_SEARCH, "true");
        createdPage.commit(data);
        assertTrue(data.hasAttribute(WikiPage.ACTION_TEST));
        assertTrue(data.hasAttribute(WikiPage.ACTION_SEARCH));
        WikiPage page = root.getChildPage("FrontPage");
        assertTrue(page.getData().hasAttribute(WikiPage.ACTION_TEST));
        assertTrue(page.getData().hasAttribute(WikiPage.ACTION_SEARCH));
    }
    ...
    public void XtestUnicodeInVersions() throws Exception {
        WikiPage page = crawler.addPage(root, PathParser.parse("SomePage"), "몀몁몂몃");
        PageData data = page.getData();
    ...
    public void XtestVersionedPropertiedLoadedProperly() throws Exception {
        WikiPage page = crawler.addPage(root, PathParser.parse("TestPage"));
        PageData data = page.getData();
