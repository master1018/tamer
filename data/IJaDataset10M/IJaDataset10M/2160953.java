...
public class Response extends Message {
    ...
    public Set<Method> getAllowedMethods() {
        if (this.allowedMethods == null) this.allowedMethods = new HashSet<Method>();
    ...
    public Series<CookieSetting> getCookieSettings() {
        if (this.cookieSettings == null) this.cookieSettings = new CookieSettingSeries();
    ...
    public Set<Dimension> getDimensions() {
        if (this.dimensions == null) this.dimensions = EnumSet.noneOf(Dimension.class);
    ...
    public void setRedirectRef(String redirectUri) {
        Reference baseRef = (getRequest().getResourceRef() != null) ? getRequest().getResourceRef().getBaseRef() : null;
    ...
    private static class CookieSettingSeries extends Series<CookieSetting> {
        ...
        public Series<CookieSetting> createSeries(List<CookieSetting> delegate) {
            if (delegate != null) return new CookieSettingSeries(delegate); else return new CookieSettingSeries();
        }
    }
}
