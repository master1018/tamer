...
public class LoginPageTest extends WebTestCase {
    ...
    private void defineResouces() {
        server.setResource("/", "<html>" + "<head>" + "	<title>Login</title>" + "</head>" + "<body>" + "    <form action=\"login\" method=\"post\">" + "    	<table align=\"center\">" + "    		<tr>" + "    			<td>Username:</td>" + "    			<td><input type=\"text\" length=\"15\" name=\"username\"/></td>" + "    		</tr>" + "    		<tr>" + "    			<td>Password:</td>" + "    			<td><input type=\"password\" length=\"15\" name=\"password\"/></td>" + "    		</tr>" + "    		<tr>" + "    			<td colspan=\"10\" align=\"center\"><input type=\"submit\" value=\"Login\" name=\"login\"/></td>" + "    		</tr>" + "    </table>" + "    </form>" + "</body>" + "</html>");
