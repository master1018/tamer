...
public final class SequencerTest {
    ...
    @Test
    public void shouldWaitOnSequence() throws AlertException, InterruptedException {
    ...
    @Test
    public void shouldWaitOnSequenceShowingBatchingEffect() throws AlertException, InterruptedException {
        final SequenceBarrier barrier = sequencer.newBarrier();
    ...
    @Test
    public void shouldSignalWaitingProcessorWhenSequenceIsPublished() throws InterruptedException {
        final SequenceBarrier barrier = sequencer.newBarrier();
