 ...
 */
public class OMIllegalTypeIDException extends OMException {

    /**
    * @param errno
    * @param s
    * @roseuid 3C4ECBAE016C
    */
    public OMIllegalTypeIDException(int errno, String s) {
        super(errno, s);
    }

    /**
    * @roseuid 3C4ECBAE0162
    */
    public OMIllegalTypeIDException() {
        super();
    }
}
