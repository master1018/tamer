...
public class ColorEditor extends CDialog implements ActionListener, PropertyEditor {
    ...
    public static CompiereColor showDialog(Frame owner, CompiereColor color) {
        ...
        if (cce.isSaved()) return cce.getColor();
        return color;
    }
    ...
    private void init(CompiereColor color) {
        ...
        if (color == null) setColor(m_cc); else setColor(new CompiereColor(color));
    ...
    public void setColor(CompiereColor color) {
        if (color == null && m_cc != null) return;
        m_cc = color;
        if (m_cc == null) m_cc = CompiereColor.getDefaultBackground();
        updateFields();
    ...
    public void setValue(Object value) {
        if (value != null && value instanceof CompiereColor) setColor(new CompiereColor((CompiereColor) value)); else throw new IllegalArgumentException("AdempiereColorEditor.setValue requires AdempiereColor");
    }
