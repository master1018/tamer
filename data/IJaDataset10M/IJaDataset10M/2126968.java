...
class SWTNumberAxisEditor extends SWTAxisEditor implements FocusListener {
    ...
    public void focusLost(FocusEvent e) {
        if (e.getSource() == this.minimumRangeValue) {
            if (!validateMinimum(this.minimumRangeValue.getText())) this.minimumRangeValue.setText(String.valueOf(this.minimumValue)); else this.minimumValue = Double.parseDouble(this.minimumRangeValue.getText());
        } else if (e.getSource() == this.maximumRangeValue) {
            if (!validateMaximum(this.maximumRangeValue.getText())) this.maximumRangeValue.setText(String.valueOf(this.maximumValue)); else this.maximumValue = Double.parseDouble(this.maximumRangeValue.getText());
        }
    }
