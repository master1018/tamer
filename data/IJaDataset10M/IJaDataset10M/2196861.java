package com.metanology.mde.core.metaModel.commonbehavior;
...
/**
 *  A collection of CallAction objects.  CallActionCollection wraps a Vector
 *  to provide a typed collection, removing the casts required for 
 *  Vector operations.
 */
public class CallActionCollection implements java.io.Serializable, List {

    private java.util.Vector items = new java.util.Vector();

    /**
     *  Create an empty CallActionCollection.
     */
    public CallActionCollection() {
    }

    ;

    /**
     *  Create a CallActionCollection from 
     *  an existing Vector. All elements in theVector must be of type 
     *  CallAction. 
     */
    public CallActionCollection(java.util.Vector theItems) {
        this.items = theItems;
    }
     ...
     * CallActionCollection at the specified position.  Shifts the element currently at
     ...
     * @param c elements to be inserted into this CallActionCollection.
    ...
    /**
     *  The number of CallAction objects in this CallActionCollection.
     */
    public int size() {
    ...
    /**
     *  Return the nth CallAction object in this CallActionCollection.  Index
     *  must be between 0 and the number of CallAction - 1 in this collection.
     */
    public CallAction elementAt(int index) {
        return (CallAction) this.items.elementAt(index);
    }

    /**
     *  Add a CallAction to this CallActionCollection.
     */
    public void addElement(CallAction pVal) {
        items.addElement(pVal);
    }

    /**
     * Tests if the specified object is a component in this CallActionCollection.
     *
     * @param   o   an object.
     ...
     * be an CallAction, testing for equality using the equals method.
     */
    ...
    /**
     *  Remove the CallAction at the given location from this
    ...
    /**
     *  Remove the given CallAction from this CallActionCollection.
     */
    public void removeElement(CallAction pVal) {
        items.removeElement(pVal);
    }

    /**
     *  Remove all the elements from this CallActionCollection.
     */
    ...
    /**
     *  Return an enumeration of all the CallAction objects in this 
     *  CallActionCollection.
     */
