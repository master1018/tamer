    ...
    public GuessDatesDialog(final JFrame frame) {
        ...
        helpButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent actionEvent) {
                JScrollPane scrollPane = TextUtil.createHTMLScrollPane(DATE_FORMAT_HELP, new Dimension(560, 480));
                JOptionPane.showMessageDialog(frame, scrollPane, "Date format help", JOptionPane.PLAIN_MESSAGE);
            }
        });
