...
public class Action implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "Action", "ns1");

    /**
	 * field for Action
	 */
    protected de.vsis.coordination.stubs.addr.AttributedURIType localAction;

    /**
	 * Auto generated getter method
	 * 
	 * @return de.vsis.coordination.stubs.addr.AttributedURIType
	 */
    public de.vsis.coordination.stubs.addr.AttributedURIType getAction() {
        return localAction;
    }
	 ...
	 *            Action
	 */
    public void setAction(de.vsis.coordination.stubs.addr.AttributedURIType param) {
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.w3.org/2005/08/addressing", "Action").equals(reader.getName())) {
                            object.setAction(de.vsis.coordination.stubs.addr.AttributedURIType.Factory.parse(reader));
                        } else {
