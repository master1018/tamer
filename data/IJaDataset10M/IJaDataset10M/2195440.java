...
public class TdDialog extends JacinthDialog {
   ...
   * @return
   */
    public static TdDialog getNewTDDialog(Component component) {
        while (component != null && !(component instanceof Frame) && !(component instanceof Dialog)) component = component.getParent();
        TdDialog dialog;
        if (component == null) dialog = new TdDialog((Frame) null); else if (component instanceof Dialog) dialog = new TdDialog((Dialog) component); else dialog = new TdDialog((Frame) component);
