 ...
 *
 */
@TldTag(name = "deleteUser", description = "Delete a user from the database.", attributes = { @TldAttribute(name = "user", description = "The user to delete.", required = true, deferredType = User.class) })
public final class DeleteUserHandler extends AbstractHandler {
    ...
    protected JbpmActionListener getListener(final FaceletContext ctx) {
        return new DeleteUserActionListener(getValueExpression(userAttribute, ctx, User.class));
    }
}
