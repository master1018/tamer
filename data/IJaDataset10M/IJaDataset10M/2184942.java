...
public class AncestralStateTreeLikelihood extends TreeLikelihood implements TreeTraitProvider {
     ...
     */
    public AncestralStateTreeLikelihood(PatternList patternList, TreeModel treeModel, SiteModel siteModel, BranchRateModel branchRateModel, boolean useAmbiguities, boolean storePartials, final DataType dataType, final String tag, boolean forceRescaling, boolean useMAP, boolean returnML) {
    ...
    public AncestralStateTreeLikelihood(PatternList patternList, TreeModel treeModel, SiteModel siteModel, BranchRateModel branchRateModel, boolean useAmbiguities, boolean storePartials, DataType dataType, String tag, boolean forceRescaling) {
        this(patternList, treeModel, siteModel, branchRateModel, useAmbiguities, storePartials, dataType, tag, forceRescaling, false, true);
    }
    ...
    public void traverseSample(TreeModel tree, NodeRef node, int[] parentState) {
        ...
        if (!tree.isExternal(node)) {
            if (parent == null) {
                ...
                if (categoryCount > 1) throw new RuntimeException("Reconstruction not implemented for multiple categories yet.");
