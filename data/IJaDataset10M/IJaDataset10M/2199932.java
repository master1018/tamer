 ...
 */
public class JabberServerChooserDialog extends JDialog implements ListSelectionListener {
    ...
    private JTextArea chooseArea = new JTextArea(Resources.getString("chooseServerText"));
    ...
    private JButton cancelButton = new JButton(Resources.getString("cancelLabel"));

    private Vector servers = new Vector();

    private FileAccessService faService = null;

    private String[] columnNames = { Resources.getString("serverColumn"), Resources.getString("commentColumn") };
    ...
    private class ServerChooserTableModel extends AbstractTableModel {
        ...
        public ServerChooserTableModel() {
            try {
                DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
                serverComments = factory.newDocumentBuilder().parse(JabberServerChooserDialog.class.getClassLoader().getResourceAsStream(Resources.getString("commentsFile")));
