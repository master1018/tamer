...
public class InstanceTableSelectionListener implements ListSelectionListener {
    ...
    public void valueChanged(ListSelectionEvent e) {
        if (e.getSource() == table.getSelectionModel() && table.getRowSelectionAllowed() && table.getSelectedRowCount() != 0) controller.showInstanceButtons(true); else controller.showInstanceButtons(false);
    }
}
