...
public class rgbType2 extends com.jmex.model.collada.xml.Node {

    private static final long serialVersionUID = 1L;

    public rgbType2(rgbType2 node) {
        super(node);
    }

    public rgbType2(org.w3c.dom.Node node) {
        super(node);
    }

    public rgbType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public rgbType2(com.jmex.model.collada.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public gl_blend_equation_type getvalue2At(int index) throws Exception {
        return new gl_blend_equation_type(getDomNodeValue(dereference(getDomChildAt(Attribute, null, "value", index))));
    }
    ...
    public gl_blend_equation_type getvalue2ValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new com.jmex.model.collada.xml.XmlException("Out of range"); else return new gl_blend_equation_type(getDomNodeValue(dereference(curNode)));
    }
    ...
    public void addvalue2(gl_blend_equation_type value) {
    ...
    public void addvalue2(String value) throws Exception {
        addvalue2(new gl_blend_equation_type(value));
    }
