...
public class BookingServiceImpl implements BookingService {
    ...
    public Double calculateRoomSubtotalForBooking(Integer id_structure, Booking booking) {
        ...
        for (Date aBookingDate : bookingDates) {
            ...
            listinoCameraDelGiorno = this.getRoomPriceListService().findRoomPriceListByIdStructureAndIdSeasonAndIdRoomTypeAndIdConvention(id_structure, season.getId(), booking.getRoom().getRoomType().getId(), booking.getConvention().getId());
