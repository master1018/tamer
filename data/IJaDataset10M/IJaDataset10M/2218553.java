...
public class KamikazeTest extends TestCase {
    ...
    private DocIdSet createDocSet(ArrayList<Integer> nums) throws Exception {
        DocSet p4d = DocSetFactory.getDocSetInstance(0, 35000000, 200000, DocSetFactory.FOCUS.OPTIMAL);
        for (int num : nums) p4d.addDoc(num);
        return p4d;
    }
    ...
    public void testPartialEmptyAnd() throws IOException {
        try {
            ...
            @SuppressWarnings("unused") int docId = -1;
