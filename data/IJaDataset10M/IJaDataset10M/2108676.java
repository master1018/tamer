...
public class UsecaseModel extends AbstractUMLEntityModel implements EntityModel, ICloneableModel {
    ...
    public IPropertyDescriptor[] getPropertyDescriptors() {
        return new IPropertyDescriptor[] { new TextPropertyDescriptor(P_ENTITY_NAME, UMLPlugin.getDefault().getResourceString("property.name")), new ResourcePropertyDescriptor(P_RESOURCE, UMLPlugin.getDefault().getResourceString("property.resource")), new ColorPropertyDescriptor(P_BACKGROUND_COLOR, UMLPlugin.getDefault().getResourceString("property.background")), new ColorPropertyDescriptor(P_FOREGROUND_COLOR, UMLPlugin.getDefault().getResourceString("property.foreground")) };
    }
