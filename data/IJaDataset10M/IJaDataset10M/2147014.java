...
public abstract class SVGStylableElement extends SVGOMElement implements CSSStylableElement {
    ...
    public CSSStyleDeclaration getStyle() {
        CSSStyleDeclaration result = (CSSStyleDeclaration) getLiveAttributeValue(null, SVG_STYLE_ATTRIBUTE);
        if (result == null) {
     ...
     */
    public class PresentationAttributePaintValue extends CSSOMSVGPaint implements LiveAttributeValue, CSSOMSVGPaint.ValueProvider {
     ...
     */
    public class StyleDeclaration extends CSSOMSVGStyleDeclaration implements LiveAttributeValue, CSSOMSVGStyleDeclaration.ValueProvider, CSSOMSVGStyleDeclaration.ModificationHandler, CSSEngine.MainPropertyReceiver {
        ...
        public StyleDeclaration(CSSEngine eng) {
            ...
            declaration = cssEngine.parseStyleDeclaration(SVGStylableElement.this, getAttributeNS(null, SVG_STYLE_ATTRIBUTE));
        }
        ...
        public void setMainProperty(String name, Value v, boolean important) {
            ...
            for (; i < declaration.size(); i++) {
                if (idx == declaration.getIndex(i)) break;
            }
            if (i < declaration.size()) declaration.put(i, v, idx, important); else declaration.append(v, idx, important);
        }
