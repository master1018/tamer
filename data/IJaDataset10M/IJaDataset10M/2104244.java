...
public class SoundPlayer {
    ...
    private class PortionPlayerThread extends PlayerThread {
        ...
        public void play() {
            try {
                PortionPlayer player = new PortionPlayer(soundFileBuffer.getFileInputStream(fileName));
    ...
    private void playSFX(String fileName, double playSoundProportion, boolean playImmediately) {
        playSFX(new PortionPlayerThread(fileName, 1 - playSoundProportion, 1), playImmediately);
    }
    ...
    public void playSFXByConfigKey(String configKey) {
        playSFX(SoundConfig.get(configKey), SoundConfig.KEYS_SFX_IMMEDIATE_PLAYING.contains(configKey));
    }

    public void playSFXByConfigKey(String configKey, String parameter) {
        playSFX(SoundConfig.get(configKey, parameter), SoundConfig.KEYS_SFX_IMMEDIATE_PLAYING.contains(configKey));
    }
    ...
    public void playSFXByConfigKey(String configKey, double playSoundProportion) {
        playSFX(SoundConfig.get(configKey), playSoundProportion, SoundConfig.KEYS_SFX_IMMEDIATE_PLAYING.contains(configKey));
    }
