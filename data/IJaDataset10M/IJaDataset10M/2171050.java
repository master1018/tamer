...
public class GPHProject {
   ...
   * @param labels 
   */
    public GPHProject(GPHUser user, String projectName, String domain, String role, String scmType, String summary, String description, String htmlLink, String licenseType, List<String> repoUrls, List<String> labels) {
        if (user == null) {
