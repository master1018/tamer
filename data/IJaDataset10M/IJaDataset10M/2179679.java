package gov.sns.tools.plot.barchart;
...
public class BarChart {
   ...
   */
    public BarChart() {
        ...
        GP.addHorLimitsListener(new ActionListener() {
   ...
   */
    public void setBarColumns(Vector<BarColumn> clmns) {
        ...
        barColumns.clear();
        int nCv = 0;
        java.util.Iterator<BarColumn> itr = clmns.iterator();
        while (itr.hasNext()) {
            BarColumn bc = itr.next();
            barColumns.add(bc);
            nCv += bc.size();
   ...
   *
   *@param  title  The new title color
   */
   ...
   */
     ...
     */
        public MarkerFormat(Vector<BarColumn> barColumnsIn) {
