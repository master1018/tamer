...
public class Advertisement extends Message {
    ...
    public Advertisement(org.quickfix.field.AdvId aAdvId, org.quickfix.field.AdvTransType aAdvTransType, org.quickfix.field.Symbol aSymbol, org.quickfix.field.AdvSide aAdvSide, org.quickfix.field.Shares aShares) {
        getHeader().setField(new MsgType("7"));
        set(aAdvId);
        set(aAdvTransType);
        set(aSymbol);
