...
public class MockParticipationHelper implements ParticipationHelper {
   ...
   */
     ...
     */
        public Frame(ParticipantId result, ParticipantId editor, ParticipantId... candidates) {
            this.result = result;
            this.editor = editor;
   ...
   */
    ...
    public ParticipantId getAuthoriser(ParticipantId editor, Set<ParticipantId> candidates) {
        if (frames.isEmpty()) {
            throw new NoSuchElementException("No frames left to compare with getAuthoriser(" + editor + ", " + candidates + ")");
        } else {
