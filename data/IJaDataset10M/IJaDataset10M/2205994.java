...
public class GlobalDataEntry {
    ...
    @ElementList
    ArrayList<String> starterMoves = new ArrayList<String>();

    @ElementList
    ArrayList<String> eggMoves = new ArrayList<String>();

    @ElementList
    ArrayList<GlobalEvolution> evolutions = new ArrayList<GlobalEvolution>();
    ...
    public void setGenderRate(String genderRate) {
        if (genderRate.equals("Genderless")) femalePercentage = -1; else if (genderRate.equals("FemaleOneEighth")) ;
    }
    ...
    public ArrayList<GlobalEvolution> getEvolutions() {
        return evolutions;
    }

    public void setEvolutions(ArrayList<GlobalEvolution> evolutions) {
