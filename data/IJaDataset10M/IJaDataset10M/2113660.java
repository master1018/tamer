...
public class ExplicantoWebService_getRightsForProject_RequestStruct {

    protected de.bea.services.vidya.client.datasource.types.WSAuthentication WSAuthentication_1;

    protected long long_2;

    public ExplicantoWebService_getRightsForProject_RequestStruct() {
    }

    public ExplicantoWebService_getRightsForProject_RequestStruct(de.bea.services.vidya.client.datasource.types.WSAuthentication WSAuthentication_1, long long_2) {
