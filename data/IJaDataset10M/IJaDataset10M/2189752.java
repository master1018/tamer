...
public class ModLookup implements ArgModuleGeneral {
    ...
    protected final ArgDecl uriSearchDecl = new ArgDecl(ArgDecl.NoValue, "enable-urisearch", "urisearch");

    private boolean enableURISearch = false;

    public void registerWith(CmdGeneral cmdline) {
        cmdline.getUsage().startCategory("URI Lookup");
        cmdline.add(uriSearchDecl, "--enable-urisearch", "Enable URI search as part of the URI look-up process during query execution");
    }
