 ...
 */
public class ListOwnerYear extends JasperReport {
	 ...
	 * Constructor
	 */
    public ListOwnerYear() throws Exception {
        super();
    ...
    public String getResourceDescription() throws Exception {
        return Configuration.getLocaleString(uid, "s_res_listowneryear");
    }
    ...
    public String getNameFile(Connection conn) throws Exception {
        if (name == null) {
            Integer year = (Integer) resForm.getPValue("year");
            Integer ttid = Integer.valueOf((String) resForm.getPValue("ttid"));
            name = "ListTicketsByOwner-" + rid + "-" + ttid + "-" + year;
        }
        return name;
    }
    ...
    public String getJasperFile() {
        return "list_tickets_owner_year.jrxml";
    }
}
