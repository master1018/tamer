...
Access Level required */
    public void setAccessLevel(String AccessLevel) {
        if (AccessLevel.equals("1") || AccessLevel.equals("3") || AccessLevel.equals("4") || AccessLevel.equals("7") || AccessLevel.equals("2") || AccessLevel.equals("6")) ; else throw new IllegalArgumentException("AccessLevel Invalid value - Reference_ID=5 - 1 - 3 - 4 - 7 - 2 - 6");
...
Access Level required */
    ...
    public void setAD_ComponentVersion_ID(int AD_ComponentVersion_ID) {
        if (AD_ComponentVersion_ID <= 0) set_Value("AD_ComponentVersion_ID", null); else set_Value("AD_ComponentVersion_ID", new Integer(AD_ComponentVersion_ID));
    }
...
Table for the Fields */
    public void setAD_Table_ID(int AD_Table_ID) {
        if (AD_Table_ID <= 0) set_Value("AD_Table_ID", null); else set_Value("AD_Table_ID", new Integer(AD_Table_ID));
    }
...
Workflow Node (activity), step or process */
    public void setAD_WF_Node_ID(int AD_WF_Node_ID) {
        if (AD_WF_Node_ID <= 0) set_Value("AD_WF_Node_ID", null); else set_Value("AD_WF_Node_ID", new Integer(AD_WF_Node_ID));
    }
...
Responsible for Workflow Execution */
    public void setAD_WF_Responsible_ID(int AD_WF_Responsible_ID) {
        if (AD_WF_Responsible_ID <= 0) set_Value("AD_WF_Responsible_ID", null); else set_Value("AD_WF_Responsible_ID", new Integer(AD_WF_Responsible_ID));
    }
...
Workflow Processor Server */
    public void setAD_WorkflowProcessor_ID(int AD_WorkflowProcessor_ID) {
        if (AD_WorkflowProcessor_ID <= 0) set_Value("AD_WorkflowProcessor_ID", null); else set_Value("AD_WorkflowProcessor_ID", new Integer(AD_WorkflowProcessor_ID));
    }
...
Unit of Duration */
    public void setDurationUnit(String DurationUnit) {
        if (DurationUnit == null || DurationUnit.equals("Y") || DurationUnit.equals("M") || DurationUnit.equals("D") || DurationUnit.equals("h") || DurationUnit.equals("m") || DurationUnit.equals("s")) ; else throw new IllegalArgumentException("DurationUnit Invalid value - Reference_ID=299 - Y - M - D - h - m - s");
...
Dictionary Entity Type;
 Determines ownership and synchronization */
    public void setEntityType(String EntityType) {
        if (EntityType.equals("A") || EntityType.equals("C") || EntityType.equals("D") || EntityType.equals("U") || EntityType.equals("CUST")) ; else throw new IllegalArgumentException("EntityType Invalid value - Reference_ID=245 - A - C - D - U - CUST");
...
Indicates if this request is of a high, medium or low priority. */
    ...
    public void setProcessType(String ProcessType) {
        if (ProcessType == null || ProcessType.equals("PL") || ProcessType.equals("CF") || ProcessType.equals("DR") || ProcessType.equals("BF") || ProcessType.equals("MR") || ProcessType.equals("JS")) ; else throw new IllegalArgumentException("ProcessType Invalid value - Reference_ID=1000010 - PL - CF - DR - BF - MR - JS");
...
Status of Publication */
    public void setPublishStatus(String PublishStatus) {
        if (PublishStatus.equals("R") || PublishStatus.equals("T") || PublishStatus.equals("U") || PublishStatus.equals("V")) ; else throw new IllegalArgumentException("PublishStatus Invalid value - Reference_ID=310 - R - T - U - V");
...
Resource */
    public void setS_Resource_ID(int S_Resource_ID) {
        if (S_Resource_ID <= 0) set_Value("S_Resource_ID", null); else set_Value("S_Resource_ID", new Integer(S_Resource_ID));
    }
...
Type of Worflow */
    public void setWorkflowType(String WorkflowType) {
        if (WorkflowType.equals("G") || WorkflowType.equals("P") || WorkflowType.equals("V")) ; else throw new IllegalArgumentException("WorkflowType Invalid value - Reference_ID=328 - G - P - V");
