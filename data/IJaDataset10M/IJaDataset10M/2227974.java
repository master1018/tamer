...
class TestEventHandler extends ViewAdapter {
    ...
    public void Kpress(ViewPanel v, char c, int code, int mod, KeyEvent e) {
        if (c == 't') {
            ...
            application.toggleDynaSpot();
        } else if (code == KeyEvent.VK_1) {
            ((AgileViewPanel) v).setFontRenderingStrategy(agile2d.AgileGraphics2D.BEST_TEXT_RENDERING_STRATEGY);
        } else if (code == KeyEvent.VK_2) {
            ((AgileViewPanel) v).setFontRenderingStrategy(agile2d.AgileGraphics2D.ROUGH_TEXT_RENDERING_STRATEGY);
        }
    }
