 ...
 */
    ...
    private void initComponents() {
        ...
        AttrBasicLayout.setHorizontalGroup(AttrBasicLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(AttrBasicLayout.createSequentialGroup().addContainerGap().addGroup(AttrBasicLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(ACLDescripLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE).addComponent(TitleLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE).addComponent(IdLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(AttrBasicLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addComponent(TitleTextField).addComponent(IdField).addComponent(ACLComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 327, javax.swing.GroupLayout.PREFERRED_SIZE)).addContainerGap()));
        AttrBasicLayout.setVerticalGroup(AttrBasicLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(AttrBasicLayout.createSequentialGroup().addGap(24, 24, 24).addGroup(AttrBasicLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(IdField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(IdLabel)).addGap(18, 18, 18).addGroup(AttrBasicLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(ACLComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(ACLDescripLabel)).addGap(18, 18, 18).addGroup(AttrBasicLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(TitleTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(TitleLabel)).addContainerGap(155, Short.MAX_VALUE)));
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addContainerGap(288, Short.MAX_VALUE).addComponent(ButtonAcept).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(ButtonCancel).addContainerGap()).addComponent(Attributes, javax.swing.GroupLayout.DEFAULT_SIZE, 514, Short.MAX_VALUE).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addContainerGap().addComponent(LabelFoldType, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(FoldTypeCB, javax.swing.GroupLayout.PREFERRED_SIZE, 323, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap()).addGroup(layout.createSequentialGroup().addGap(21, 21, 21).addComponent(LabelOperation, javax.swing.GroupLayout.DEFAULT_SIZE, 481, Short.MAX_VALUE).addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addContainerGap().addComponent(LabelOperation).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 19, Short.MAX_VALUE).addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(LabelFoldType).addComponent(FoldTypeCB, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)).addGap(18, 18, 18).addComponent(Attributes, javax.swing.GroupLayout.PREFERRED_SIZE, 327, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(ButtonCancel).addComponent(ButtonAcept)).addContainerGap()));
        pack();
    }
    ...
    private void FoldTypeCBActionPerformed(java.awt.event.ActionEvent evt) {
        try {
...
*/
    public void setRecord(Record pFolder) {
        ...
        if (Attr.getValue() != null) FoldTypeCB.setSelectedItem((String) Attr.getValue());
        ...
        if (Attr.getValue() != null) IdField.setText((String) Attr.getValue());
        ...
        if (Attr.getValue() != null) ACLComboBox.setSelectedItem((String) Attr.getValue());
        ...
        if (Attr.getValue() != null) TitleTextField.setText((String) Attr.getValue());
...
*/
    ...
    private void ShowEditList(java.awt.event.InputEvent evt) {
        ...
        if (MultAttrDlg.isCancel()) return;
 ...
 */
    private JComponent genComponent(Attribute Attr, boolean Modif) {
        ...
        if (Attr.isMultivalued()) {
            ...
            if (Attr.getValue() != null) JTF = new JTextField((String) Attr.getValue()); else JTF = new JTextField();
        } else if (Attr.getType() == Attribute.tDATE) {
            JTF = new JFormattedTextField(MainWin.getFormatterDate());
            if (Attr.getValue() != null) ((JFormattedTextField) JTF).setValue((Date) Attr.getValue()); else ((JFormattedTextField) JTF).setValue(new Date());
        } else if (Attr.getType() == Attribute.tTIMESTAMP) {
            JTF = new JFormattedTextField(MainWin.getFormatterTS());
            if (Attr.getValue() != null) ((JFormattedTextField) JTF).setValue((Date) Attr.getValue());
            ...
            JTF = JCB;
        } else JTF = new JTextField("Error");
        if (Modif && !Attr.isModifAllowed()) JTF.setEnabled(false);
        if (Attr.getType() == Attribute.tDATE) JTF.setToolTipText(MainWin.DrvTT(Attr.getDescription()) + "( " + MainWin.getFormatDate() + " )"); else if (Attr.getType() == Attribute.tTIMESTAMP) JTF.setToolTipText(MainWin.DrvTT(Attr.getDescription()) + "( " + MainWin.getFormatTS() + " )"); else JTF.setToolTipText(MainWin.DrvTT(Attr.getDescription()));
 ...
 */
    private void FillAttr(Attribute Attr, JComponent JTF, boolean Modif) throws PDException {
        if (Modif && !Attr.isModifAllowed()) return;
        ...
        if (Attr.getType() == Attribute.tSTRING) {
            ...
            Boolean Act;
            if (((JCheckBox) JTF).isSelected()) Act = true; else Act = false;
            Attr.setValue(Act);
        } else Attr.setValue("Error");
    }
