...
public class SafTokenManager implements SafConstants {
    ...
    private int jjMoveStringLiteralDfa1_0(long active0) {
        ...
        switch(curChar) {
            ...
            case 114:
                if ((active0 & 0x100L) != 0L) return jjStartNfaWithStates_0(1, 8, 1);
                break;
            default:
                break;
        }
    ...
    private int jjMoveStringLiteralDfa2_0(long old0, long active0) {
        ...
        switch(curChar) {
            case 100:
                if ((active0 & 0x80L) != 0L) return jjStartNfaWithStates_0(2, 7, 1);
                break;
            case 111:
    ...
    private int jjMoveStringLiteralDfa5_0(long old0, long active0) {
        ...
        switch(curChar) {
            case 101:
                if ((active0 & 0x200L) != 0L) return jjStartNfaWithStates_0(5, 9, 1);
                break;
            default:
                break;
        }
    ...
    public static final String[] jjstrLiteralImages = { "", null, null, null, null, null, "\75", "\141\156\144", "\157\162", "\143\150\157\157\163\145", null, null, "\50", "\51", "\173", "\175", "\133", "\135", null };

    /** Lexer state names. */
    public static final String[] lexStateNames = { "DEFAULT" };

    static final long[] jjtoToken = { 0x7ffc1L };
