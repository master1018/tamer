...
public class ClassifierCustomGUI extends JPanel implements ActionListener, ChangeListener {
    ...
    protected static final Logger logger = Logger.getLogger(ClassifierCustomGUI.class.getName());
    ...
    ClassifierCustomGUI() {
        ...
        if (debugGUI) {
            classCountPanel.setBorder(BorderFactory.createLineBorder(Color.cyan));
        }
    ...
    void setNClasses(int nClasses) {
        ...
        classBoundaryFields.get(classBoundaryFields.size() - 1).setEditable(false);
    ...
    void setData(double[] data) {
        savedData = data;
        customClasser.breaks = equalClasser.getEqualBoundaries(data, classCountFields.size());
    ...
    private void doCustomClassification(double[] data) {
        ...
        int[] classes = customClasser.classify(data, customClasser.breaks.length - 1);
    ...
    public void stateChanged(ChangeEvent e) {
        if (e.getSource() != mSlider) {
            logger.severe("unexpected statechanged in " + this.getClass().getName());
        }
        ...
        if (savedData != null && customClasser.breaks != null) {
            ...
            int[] classes = customClasser.classify(savedData, customClasser.breaks.length - 1);
    ...
    private void makeConnectorStroke() {
        ...
        float dashPhase = 5f;
        connectorStroke = new BasicStroke(width, cap, join, miterLimit, dashPattern, dashPhase);
    }
    ...
    public ClassifierCustom showClassifierDialog(double[] data, Classifier currClassifier) {
    ...
    public static void main(String[] args) {
        ...
        logger.finest("java.version = " + System.getProperty("java.version") + ", Runtime.avaialableProcessors = " + Runtime.getRuntime().availableProcessors());
