package org.swing.datechooser.view.appearance.swing;

import org.swing.datechooser.view.appearance.*;
import org.swing.datechooser.view.appearance.CellRenderer;
import java.awt.*;
...
public class SwingCellAppearance extends CellAppearance implements SwingCellAttributes {
    ...
    public Object clone() {
        SwingCellAppearance newInst = new SwingCellAppearance(getFont(), getTextColor(), getCursorColor(), isPressed(), isEnabled(), (Painter) renderer.getPainter().clone());
    ...
    public boolean equals(Object obj) {
        ...
        return getTextColor().equals(value.getTextColor()) && getCursorColor().equals(value.getCursorColor()) && getFont().equals(value.getFont());
    }
