...
/**
 * Adapter for server implementation of HTMLMapEvents
 */
public class HTMLMapEventsServer extends IDispatchServer implements HTMLMapEvents {

    public HTMLMapEventsServer(CoClassMetaInfo classImpl) {
        super(classImpl);
        registerMethods(HTMLMapEvents.class);
    }
