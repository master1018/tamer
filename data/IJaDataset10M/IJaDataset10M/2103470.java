...
public class RCodeStylePreferenceBlock extends ManagedConfigurationBlock {
    ...
    protected String[] getChangedContexts() {
        return new String[] { RCodeStyleSettings.CONTEXT_ID };
    }
    ...
    public void createContents(final Composite pageComposite, final IWorkbenchPreferenceContainer container, final IPreferenceStore preferenceStore) {
        ...
        setupPreferenceManager(container, new Preference[] { RCodeStyleSettings.PREF_TAB_SIZE, RCodeStyleSettings.PREF_INDENT_DEFAULT_TYPE, RCodeStyleSettings.PREF_INDENT_SPACES_COUNT, RCodeStyleSettings.PREF_INDENT_BLOCK_DEPTH, RCodeStyleSettings.PREF_INDENT_GROUP_DEPTH, RCodeStyleSettings.PREF_INDENT_WRAPPED_COMMAND_DEPTH, RCodeStyleSettings.PREF_REPLACE_TABS_WITH_SPACES, RCodeStyleSettings.PREF_REPLACE_CONVERSATIVE });
    ...
    protected void addBindings(final DataBindingContext dbc, final Realm realm) {
        dbc.bindValue(SWTObservables.observeText(fTabSize, SWT.Modify), BeansObservables.observeValue(realm, fModel, RCodeStyleSettings.PROP_TAB_SIZE), new UpdateValueStrategy().setAfterGetValidator(new NumberValidator(1, 32, Messages.RCodeStyle_TabSize_error_message)), null);
        ...
        dbc.bindValue(indentObservable, BeansObservables.observeValue(realm, fModel, RCodeStyleSettings.PROP_INDENT_DEFAULT_TYPE), null, null);
        dbc.bindValue(SWTObservables.observeSelection(fConserveIndent), BeansObservables.observeValue(realm, fModel, RCodeStyleSettings.PROP_REPLACE_CONVERSATIVE), null, null);
        dbc.bindValue(SWTObservables.observeText(fIndentSpaceCount, SWT.Modify), BeansObservables.observeValue(realm, fModel, RCodeStyleSettings.PROP_INDENT_SPACES_COUNT), new UpdateValueStrategy().setAfterGetValidator(new NumberValidator(1, 32, Messages.RCodeStyle_Indent_NumOfSpaces_error_message)), null);
        dbc.bindValue(SWTObservables.observeText(fIndentBlockDepth, SWT.Modify), BeansObservables.observeValue(realm, fModel, RCodeStyleSettings.PROP_INDENT_BLOCK_DEPTH), new UpdateValueStrategy().setAfterGetValidator(new NumberValidator(1, 10, Messages.RCodeStyle_Indent_IndentInBlocks_error_message)), null);
        dbc.bindValue(SWTObservables.observeText(fIndentGroupDepth, SWT.Modify), BeansObservables.observeValue(realm, fModel, RCodeStyleSettings.PROP_INDENT_GROUP_DEPTH), new UpdateValueStrategy().setAfterGetValidator(new NumberValidator(1, 10, Messages.RCodeStyle_Indent_IndentInGroups_error_message)), null);
        dbc.bindValue(SWTObservables.observeText(fIndentWrappedCommandDepth, SWT.Modify), BeansObservables.observeValue(realm, fModel, RCodeStyleSettings.PROP_INDENT_WRAPPED_COMMAND_DEPTH), new UpdateValueStrategy().setAfterGetValidator(new NumberValidator(1, 10, Messages.RCodeStyle_Indent_IndentOfWrappedCommands_error_message)), null);
        dbc.bindValue(SWTObservables.observeSelection(fReplaceOtherTabs), BeansObservables.observeValue(realm, fModel, RCodeStyleSettings.PROP_REPLACE_TABS_WITH_SPACES), null, null);
    }
