...
public class TestPolicyParser {
    ...
    public static final String POLICY_QUESTIONABLE = "<Policy unexpectedAttribute='thisOne' PolicyId='foo' RuleCombi" + "ningAlgId='urn:oasis:names:tc:xacml:1.0:rule-combining-algorit" + "hm:first-applicable'/>";
