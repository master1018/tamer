...
public class PeakParkingDemandPerHub {
    ...
    private static void accumulateHubParkingOccupancyStatistics(LinkHubMapping linkHubMapping, HashMap<Id, ParkingOccupancyBins> hubIdParkingOccupancies, ParkingTimesPlugin parkingTimesPlugin) {
    ...
    private static void initParkingOccupancyHashMap(LinkHubMapping linkHubMapping, HashMap<Id, ParkingOccupancyBins> hubIdParkingOccupancies, ParkingIntervalInfo parkingIntervalInfo) {
