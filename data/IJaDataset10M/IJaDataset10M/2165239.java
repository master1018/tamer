...
public class ExtractMethodDialog extends JDialog {
    ...
    public static class ExtractMethodPanel extends JPanel implements KeyListener {
        ...
        ExtractMethodPanel(String invocation, String theHead, String theTail, int definitionLine) {
            ...
            JButton buttons[] = { new ButtonCancel(), new ButtonContinue() };
            ...
            y = 0;
            s.addGbcComponent(this, 0, y, 4, 1, 1, 1, GridBagConstraints.BOTH, new JPanel());
            y++;
            s.addGbcComponent(this, 0, y, 4, 1, 1, 1, GridBagConstraints.BOTH, new JLabel("Xrefactory Proposes Following New Definition:", SwingConstants.CENTER));
            y++;
            s.addGbcComponent(this, 0, y, 4, 1, 1, 1, GridBagConstraints.BOTH, new JPanel());
            y++;
            s.addGbcComponent(this, 0, y, 1, 1, 1, 1, GridBagConstraints.BOTH, new JPanel());
            s.addGbcComponent(this, 1, y, 2, 1, 100, 100, GridBagConstraints.BOTH, newMethodSc);
            s.addGbcComponent(this, 3, y, 1, 1, 1, 1, GridBagConstraints.BOTH, new JPanel());
            y++;
            s.addGbcComponent(this, 0, y, 4, 1, 1, 1, GridBagConstraints.BOTH, new JLabel("with Invocation:", SwingConstants.CENTER));
            y++;
            s.addGbcComponent(this, 0, y, 1, 1, 1, 1, GridBagConstraints.BOTH, new JPanel());
            s.addGbcComponent(this, 1, y, 2, 1, 100, 10, GridBagConstraints.BOTH, new JScrollPane(invoked));
            s.addGbcComponent(this, 3, y, 1, 1, 1, 1, GridBagConstraints.BOTH, new JPanel());
            y++;
            s.addGbcComponent(this, 0, y, 4, 1, 1, 1, GridBagConstraints.BOTH, new JPanel());
            y++;
            s.addGbcComponent(this, 0, y, 4, 1, 1, 1, GridBagConstraints.BOTH, new JSeparator());
            y++;
            s.addGbcComponent(this, 0, y, 4, 1, 1, 1, GridBagConstraints.BOTH, new JPanel());
            y++;
            s.addGbcComponent(this, 0, y, 4, 1, 1, 1, GridBagConstraints.BOTH, new JPanel());
            y++;
            s.addGbcComponent(this, 1, y, 1, 1, 1, 1, GridBagConstraints.BOTH, new JLabel("To be renamed to: ", SwingConstants.LEFT));
            s.addGbcComponent(this, 2, y, 1, 1, 1000, 1, GridBagConstraints.HORIZONTAL, name);
            y++;
            s.addGbcComponent(this, 0, y, 4, 1, 1, 1, GridBagConstraints.BOTH, new JPanel());
            y++;
