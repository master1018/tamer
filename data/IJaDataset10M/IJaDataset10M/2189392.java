...
/** 
 * Helper class for : optionalCodeSeq
 *  
 * @author OpenORB Compiler
 */
public class optionalCodeSeqHelper {
    ...
    /**
     * Insert optionalCodeSeq into an any
     * @param a an any
     * @param t optionalCodeSeq value
     */
    public static void insert(org.omg.CORBA.Any a, String[] t) {
        a.insert_Streamable(new org.omg.DsObservationTimeSeries.optionalCodeSeqHolder(t));
    }

    /**
     * Extract optionalCodeSeq from an any
     *
     * @param a an any
     * @return the extracted optionalCodeSeq value
     */
    public static String[] extract(org.omg.CORBA.Any a) {
        ...
        if (meth != null) {
            try {
                ...
                if (s instanceof org.omg.DsObservationTimeSeries.optionalCodeSeqHolder) {
                    return ((org.omg.DsObservationTimeSeries.optionalCodeSeqHolder) s).value;
                }
            ...
            org.omg.DsObservationTimeSeries.optionalCodeSeqHolder h = new org.omg.DsObservationTimeSeries.optionalCodeSeqHolder(read(a.create_input_stream()));
    ...
    /**
     * Return the optionalCodeSeq TypeCode
     * @return a TypeCode
     */
    public static org.omg.CORBA.TypeCode type() {
        if (_tc == null) {
            org.omg.CORBA.ORB orb = org.omg.CORBA.ORB.init();
            _tc = orb.create_alias_tc(id(), "optionalCodeSeq", orb.create_sequence_tc(1, org.omg.DsObservationTimeSeries.QualifiedCodeStrHelper.type()));
        }
        return _tc;
    }

    /**
     * Return the optionalCodeSeq IDL ID
     * @return an ID
     */
    ...
    private static final String _id = "IDL:omg.org/DsObservationTimeSeries/optionalCodeSeq:1.0";

    /**
     * Read optionalCodeSeq from a marshalled stream
     * @param istream the input stream
     * @return the readed optionalCodeSeq value
     */
    public static String[] read(org.omg.CORBA.portable.InputStream istream) {
        String[] new_one;
        {
            ...
            for (int i7 = 0; i7 < new_one.length; i7++) {
                new_one[i7] = org.omg.DsObservationTimeSeries.QualifiedCodeStrHelper.read(istream);
            }
        }
        return new_one;
    }
    ...
    /**
     * Write optionalCodeSeq into a marshalled stream
     * @param ostream the output stream
     * @param value optionalCodeSeq value
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, String[] value) {
        ostream.write_ulong(value.length);
        for (int i7 = 0; i7 < value.length; i7++) {
            org.omg.DsObservationTimeSeries.QualifiedCodeStrHelper.write(ostream, value[i7]);
        }
    }
}
