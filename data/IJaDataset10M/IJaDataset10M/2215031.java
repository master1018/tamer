...
public class SummaryIndex {
    ...
    public String toString() {
        return "SummaryIndex{" + "iSummaryLineIndex=" + iSummaryLineIndex + ", mass_index=" + mass_index + ", exp_index=" + exp_index + ", match_index=" + match_index + ", plughole_index=" + plughole_index + ", intensity_index=" + intensity_index + '}';
    }
}
