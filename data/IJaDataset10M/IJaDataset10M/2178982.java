...
public class FRCompras extends FRelatorio {
    ...
    public FRCompras() {
        ...
        adic(new JLabelPad("Descri��o do fornecedor"), 90, 100, 200, 20);
        adic(txtDescFor, 90, 120, 215, 20);
        adic(new JLabelPad("C�d.pl.pag."), 7, 140, 80, 20);
        adic(txtCodPlanoPag, 7, 160, 80, 20);
        adic(new JLabelPad("Descri��o do plano de pagamento"), 90, 140, 200, 20);
    ...
    public void imprimirDetalhado(boolean bVisualizar) {
        ...
        if ("E".equals(rgTipoRel.getVlrString())) {
            ...
            sCab.append(" (Ordenado por Data de Emiss�o)");
        } else {
        ...
        if ("T".equals(rgTipo.getVlrString())) {
            if ("D".equals(rgResDet.getVlrString())) {
                ...
                Funcoes.mensagemInforma(this, "Op��o n�o dispon�vel.\n Para relat�rio em modo texto, escolha a op��o 'Detalhado'.");
            }
        } else {
    ...
    private void imprimiGrafico(final ResultSet rs, final boolean bVisualizar, final String sCab) {
        ...
        if (rgResDet.getVlrString().equals("D")) {
            dlGr = new FPrinterJob("relatorios/FRCompras.jasper", "Relat�rio de Compras Geral", sCab, rs, hParam, this);
        } else {
            dlGr = new FPrinterJob("relatorios/FRComprasResumido.jasper", "Relat�rio de Compras Resumido", sCab, rs, hParam, this);
        }
        if (bVisualizar) {
            ...
            try {
                ...
                Funcoes.mensagemErro(this, "Erro na impress�o de relat�rio Compras Geral!" + err.getMessage(), true, con, err);
            }
        }
    }
}
