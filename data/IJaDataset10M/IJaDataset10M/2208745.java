...
/**
 * This is a default implementation of the IFC object IfcQuantityLength<br><br>
 * 
 ...
 **/
public class IfcQuantityLength extends IfcPhysicalSimpleQuantity implements IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcLabel", "IfcText", "IfcNamedUnit", "IfcLengthMeasure" };
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("Unit")) stepString = stepString.concat("*,"); else {
            if (this.Unit != null) stepString = stepString.concat(((IfcRootInterface) this.Unit).getStepParameter(IfcNamedUnit.class.isInterface()) + ","); else stepString = stepString.concat("$,");
        }
        if (getRedefinedDerivedAttributeTypes().contains("LengthValue")) stepString = stepString.concat("*);"); else {
            if (this.LengthValue != null) stepString = stepString.concat(((IfcRootInterface) this.LengthValue).getStepParameter(IfcLengthMeasure.class.isInterface()) + ");"); else stepString = stepString.concat("$);");
        }
        return stepString;
    }
	 ...
	 * 
	 * @param LengthValue value to set
	 *            /
	 **/
    ...
    public Object clone() {
        ...
        if (this.Name != null) ifcQuantityLength.setName((IfcLabel) this.Name.clone());
        if (this.Description != null) ifcQuantityLength.setDescription((IfcText) this.Description.clone());
        if (this.Unit != null) ifcQuantityLength.setUnit((IfcNamedUnit) this.Unit.clone());
        if (this.LengthValue != null) ifcQuantityLength.setLengthValue((IfcLengthMeasure) this.LengthValue.clone());
    ...
    public Object shallowCopy() {
        IfcQuantityLength ifcQuantityLength = new IfcQuantityLength();
        if (this.Name != null) ifcQuantityLength.setName(this.Name);
        if (this.Description != null) ifcQuantityLength.setDescription(this.Description);
        if (this.Unit != null) ifcQuantityLength.setUnit(this.Unit);
        if (this.LengthValue != null) ifcQuantityLength.setLengthValue(this.LengthValue);
        return ifcQuantityLength;
    }
