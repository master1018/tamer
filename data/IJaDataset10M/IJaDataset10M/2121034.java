...
public class Activator implements BundleActivator, ServiceListener {
    ...
    private static final String TOOLBAR_FILTER = String.format("(%s=%s)", Constants.OBJECTCLASS, Toolbar.class.getName());

    private static final String TOOL_FILTER = String.format("(%s=%s)", Constants.OBJECTCLASS, DockableTool.class.getName());
    ...
    public void start(final BundleContext context) throws Exception {
        ...
        GuiExecutor.instance().execute(new Runnable() {
            ...
            public void run() {
                ...
                dict.put(CommandProcessor.COMMAND_SCOPE, "dcmview2d");
        ...
        GuiExecutor.instance().execute(new Runnable() {
            ...
            public void run() {
                for (final ViewerPlugin viewerPlugin : pluginsToRemove) {
                    viewerPlugin.close();
                    Content content = UIManager.toolWindowManager.getContentManager().getContent(viewerPlugin.getDockableUID());
                    if (content != null) {
    ...
    private static void updateToolbarView() {
        ...
        if (view instanceof View2dContainer) {
            ...
            if (dicomView.getDataExplorerModel() instanceof DicomModel) {
                ...
                model.firePropertyChange(new ObservableEvent(ObservableEvent.BasicAction.UpdateToolbars, view, null, view));
            }
        }
    }
}
