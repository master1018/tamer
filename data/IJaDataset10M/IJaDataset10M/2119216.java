...
public class xorCode extends Code {
    ...
    public xorCode(int pc, int lineNumber, int target, int source1, int source2) {
    ...
    public void execute(Assembled assembled, Storage memory, SimulatorPack.RegisterStorage registers, SimulatorPack.fileStack raf) {
        registers.setRegister(target, registers.getRegister(source1) ^ registers.getRegister(source2));
    }
}
