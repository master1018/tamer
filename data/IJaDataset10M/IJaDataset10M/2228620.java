...
public class RemoteTestNG extends TestNG {
    ...
    public void configure(Map cmdLineArgs) {
        ...
        setConnectionParameters((String) cmdLineArgs.get(TestNGCommandLineArgs.HOST_COMMAND_OPT), Integer.parseInt((String) cmdLineArgs.get(TestNGCommandLineArgs.PORT_COMMAND_OPT)));
    }
   ...
   */
    ...
    private static class RemoteSuiteListener implements ISuiteListener {
        ...
        public void onFinish(ISuite suite) {
            m_messageSender.sendMessage(new SuiteMessage(suite, false));
        }

        public void onStart(ISuite suite) {
            m_messageSender.sendMessage(new SuiteMessage(suite, true));
        }
    }
