...
public class AttributeTest extends TestCase {
    ...
    private static final RelationName table1 = new RelationName(null, "table1");

    private static final RelationName table1b = new RelationName(null, "table1");

    private static final RelationName table2 = new RelationName(null, "table2");

    private static final RelationName xTable1 = new RelationName("x", "table1");

    private static final RelationName xTable2 = new RelationName("x", "table2");

    private static final RelationName yTable1 = new RelationName("y", "table1");

    private static final Attribute fooCol1 = new Attribute(null, "foo", "col1");

    private static final Attribute fooCol2 = new Attribute(null, "foo", "col2");

    private static final Attribute barCol1 = new Attribute(null, "bar", "col1");

    private static final Attribute barCol2 = new Attribute(null, "bar", "col2");
    ...
    public void testAttributeNames() {
        ...
        assertEquals(new RelationName(null, "table"), col.relationName());
    }
    ...
    public void testAttributeNameWithSchema() {
        ...
        assertEquals(new RelationName("schema", "table"), column.relationName());
    }
    ...
    public void testRelationNameToString() {
        assertEquals("table", new RelationName(null, "table").toString());
        assertEquals("schema.table", new RelationName("schema", "table").toString());
    }
