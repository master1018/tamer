...
/**
 * This is a default implementation of the IFC object IfcFurnitureType<br><br>
 * 
 ...
 **/
public class IfcFurnitureType extends IfcFurnishingElementType implements IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcGloballyUniqueId", "IfcOwnerHistory", "IfcLabel", "IfcText", "IfcLabel", "SET<IfcPropertySetDefinition>", "LIST<IfcRepresentationMap>", "IfcLabel", "IfcLabel", "IfcAssemblyPlaceEnum" };
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("AssemblyPlace")) stepString = stepString.concat("*);"); else {
            if (this.AssemblyPlace != null) stepString = stepString.concat(((IfcRootInterface) this.AssemblyPlace).getStepParameter(IfcAssemblyPlaceEnum.class.isInterface()) + ");"); else stepString = stepString.concat("$);");
        }
        return stepString;
    }
	 ...
	 * 
	 * @param AssemblyPlace value to set
	 *            /
	 **/
    ...
    public Object clone() {
        ...
        if (this.GlobalId != null) ifcFurnitureType.setGlobalId((IfcGloballyUniqueId) this.GlobalId.clone());
        if (this.OwnerHistory != null) ifcFurnitureType.setOwnerHistory((IfcOwnerHistory) this.OwnerHistory.clone());
        if (this.Name != null) ifcFurnitureType.setName((IfcLabel) this.Name.clone());
        if (this.Description != null) ifcFurnitureType.setDescription((IfcText) this.Description.clone());
        if (this.ApplicableOccurrence != null) ifcFurnitureType.setApplicableOccurrence((IfcLabel) this.ApplicableOccurrence.clone());
        if (this.HasPropertySets != null) ifcFurnitureType.setHasPropertySets((SET<IfcPropertySetDefinition>) this.HasPropertySets.clone());
        if (this.RepresentationMaps != null) ifcFurnitureType.setRepresentationMaps((LIST<IfcRepresentationMap>) this.RepresentationMaps.clone());
        if (this.Tag != null) ifcFurnitureType.setTag((IfcLabel) this.Tag.clone());
        if (this.ElementType != null) ifcFurnitureType.setElementType((IfcLabel) this.ElementType.clone());
        if (this.AssemblyPlace != null) ifcFurnitureType.setAssemblyPlace((IfcAssemblyPlaceEnum) this.AssemblyPlace.clone());
    ...
    public Object shallowCopy() {
        IfcFurnitureType ifcFurnitureType = new IfcFurnitureType();
        if (this.GlobalId != null) ifcFurnitureType.setGlobalId(this.GlobalId);
        if (this.OwnerHistory != null) ifcFurnitureType.setOwnerHistory(this.OwnerHistory);
        if (this.Name != null) ifcFurnitureType.setName(this.Name);
        if (this.Description != null) ifcFurnitureType.setDescription(this.Description);
        if (this.ApplicableOccurrence != null) ifcFurnitureType.setApplicableOccurrence(this.ApplicableOccurrence);
        if (this.HasPropertySets != null) ifcFurnitureType.setHasPropertySets(this.HasPropertySets);
        if (this.RepresentationMaps != null) ifcFurnitureType.setRepresentationMaps(this.RepresentationMaps);
        if (this.Tag != null) ifcFurnitureType.setTag(this.Tag);
        if (this.ElementType != null) ifcFurnitureType.setElementType(this.ElementType);
        if (this.AssemblyPlace != null) ifcFurnitureType.setAssemblyPlace(this.AssemblyPlace);
        return ifcFurnitureType;
    }
