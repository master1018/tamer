...
public class HTTPClient extends TimedEntry {
	 ...
	 * @param client the client to add.
	 */
    private static synchronized void addFreeClient(HTTPClient client) {
	 ...
	 */
    private static synchronized boolean removeFreeClient(HTTPClient client) {
	 ...
	 * </p>
	 */
    public static synchronized void exchange(HTTPClientDestination dest) {
        exchange(dest, "/");
    }
	 ...
	 */
    public static synchronized void exchange(HTTPClientDestination dest, String request) {
	 ...
	 */
    public static synchronized void exchange(HTTPClientDestination dest, HTTPRequest request) {
                    ...
                    synchronized (lockRequest) {
                        ...
                        try {
                            ...
                            if (!HTTPConstants.HTTP_HEADERVALUE_TRANSFERCODING_CHUNKED.equals(enc) && contentLength == -1) {
                                ...
                                request.serializeRequestBody(buffer, pd, context);
                                ...
                                request.serializeRequestBody(requestBody, pd, context);
                            }
