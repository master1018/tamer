...
public class LinkFactory {
    ...
    public Link createLink(Class<? extends BaseLink> linkClass, Object source, Object target, boolean directed, double weight) {
        ...
        if (!(linkClass == defaultDirectedLinkClass || linkClass == defaultUndirectedLinkClass || additionalDirectedLinkClasses.contains(linkClass) || additionalUndirectedLinkClasses.contains(linkClass))) {
        ...
        link.setBaseLinkProperties(observer, this, source, target, directed, weight);
        return link;
    }
    ...
    public void init(Observer observer) {
        ...
        nbD.setEdgeCreator(new ReLogoEdgeCreator(this, defaultDirectedLinkClass)).buildNetwork().addProjectionListener(observer);
        nbD = new NetworkBuilder("UndirectedLinks", context, false);
        nbD.setEdgeCreator(new ReLogoEdgeCreator(this, defaultUndirectedLinkClass)).buildNetwork().addProjectionListener(observer);
    ...
    private void createNetwork(Observer observer, Class<? extends BaseLink> linkClass, boolean directed) {
        ...
        nbD.setEdgeCreator(new ReLogoEdgeCreator(this, linkClass)).buildNetwork().addProjectionListener(observer);
    }
}
