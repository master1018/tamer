...
public class EnzymePathwayParser {
    ...
    public void parseAndWrite(DPLPersistantSet<Pathway> pathways, DPLPersistantSet<Relation> relationsCache) throws MetaDataMissingException {
                ...
                if (entry.getType().equalsIgnoreCase(MetaData.CC_ENZYME)) {
                    ...
                    for (String result : results) {
                        ...
                        for (String idpart : plus) {
                            ...
                            if (entry.getLink() != null) concept_enzyme.setUrl(entry.getLink());
                            ...
                            if (relationsCache.contains(cat_c.pk)) cat_c = relationsCache.get(cat_c.pk);
                            ...
                            if (relationsCache.contains(m_isp.pk)) m_isp = relationsCache.get(m_isp.pk);
