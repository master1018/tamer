package de.uniwue.dltk.textmarker.parser.ast.declarations;
...
import de.uniwue.dltk.textmarker.parser.ast.TMStatementConstants;
...
public class TextMarkerDeclarationsStatement extends Statement {
    ...
    public TextMarkerDeclarationsStatement(int stmtStart, int stmtEnd, List<TextMarkerAbstractDeclaration> declarations, Expression init, int typeTokenStart, int typeTokenEnd) {
        super(stmtStart, stmtEnd);
        this.declarations = declarations == null ? new ArrayList<TextMarkerAbstractDeclaration>() : declarations;
        this.initExpr = init;
