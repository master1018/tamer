...
public class CheckImpl extends EObjectImpl implements Check {
   ...
   */
    public void setName(String newName) {
        String oldName = name;
        name = newName;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, ParametercheckPackage.CHECK__NAME, oldName, name));
    }
   ...
   */
    public void setException(parametercheck.Exception newException) {
        if (newException != exception) {
            ...
            if (exception != null) msgs = ((InternalEObject) exception).eInverseRemove(this, ParametercheckPackage.EXCEPTION__PARENTCHECK, parametercheck.Exception.class, msgs);
            if (newException != null) msgs = ((InternalEObject) newException).eInverseAdd(this, ParametercheckPackage.EXCEPTION__PARENTCHECK, parametercheck.Exception.class, msgs);
            msgs = basicSetException(newException, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, ParametercheckPackage.CHECK__EXCEPTION, newException, newException));
    }
   ...
   */
    public void setExceptionIfTrue(boolean newExceptionIfTrue) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, ParametercheckPackage.CHECK__EXCEPTION_IF_TRUE, oldExceptionIfTrue, exceptionIfTrue));
    }
   ...
   */
    public void setParentmethod(Method newParentmethod) {
        if (newParentmethod != eInternalContainer() || (eContainerFeatureID() != ParametercheckPackage.CHECK__PARENTMETHOD && newParentmethod != null)) {
            if (EcoreUtil.isAncestor(this, newParentmethod)) throw new IllegalArgumentException("Recursive containment not allowed for " + toString());
            NotificationChain msgs = null;
            if (eInternalContainer() != null) msgs = eBasicRemoveFromContainer(msgs);
            if (newParentmethod != null) msgs = ((InternalEObject) newParentmethod).eInverseAdd(this, ParametercheckPackage.METHOD__CHECK, Method.class, msgs);
            msgs = basicSetParentmethod(newParentmethod, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, ParametercheckPackage.CHECK__PARENTMETHOD, newParentmethod, newParentmethod));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch(featureID) {
            case ParametercheckPackage.CHECK__EXCEPTION:
                if (exception != null) msgs = ((InternalEObject) exception).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ParametercheckPackage.CHECK__EXCEPTION, null, msgs);
