...
*/
    public static void o(double[] a, int w, int d) {
        ...
        while (jl < nc) {
            ...
            System.out.print("\n");
            for (int j = jl; j < ju; j++) System.out.print(DoubletoEstring(a[j], w, d));
            System.out.print("\n");
            jl = jl + ncp;
        }
    }
    ...
    public static void o(double[][] A, int w, int d) {
        ...
        while (jl < nc) {
            ...
            for (int i = 0; i < nr; i++) {
                ...
                for (int j = jl; j < ju; j++) System.out.print(DoubletoEstring(A[i][j], w, d));
                System.out.print("\n");
            }
            jl = jl + ncp;
        }
        ...
        while (jl < nc) {
            ...
            for (int i = 0; i < nr; i++) {
                ...
                for (int j = jl; j < ju; j++) {
                    ...
                    if (A[i][j].im < 0) snum = snum + " - " + DoubletoEstring(-A[i][j].im, d + 6, d) + "i"; else snum = snum + " + " + DoubletoEstring(A[i][j].im, d + 6, d) + "i";
            ...
            while (jl < nc) {
                ...
                for (int i = 0; i < nr; i++) {
                    ...
                    for (int j = jl; j < ju; j++) {
                        ...
                        if (A.im[i][j] < 0) snum = snum + " - " + DoubletoEstring(-A.im[i][j], d + 6, d) + "i"; else snum = snum + " + " + DoubletoEstring(A.im[i][j], d + 6, d) + "i";
                        System.out.print(snum);
                    }
                    System.out.print("\n");
                }
...
*/
    public static String ZtoEstring(Z num, int w, int d) {
        ...
        if (num.im < 0) snum = snum + " - " + DoubletoEstring(-num.im, d + 6, d) + "i"; else snum = snum + " + " + DoubletoEstring(num.im, d + 6, d) + "i";
        return snum;
    }
}
