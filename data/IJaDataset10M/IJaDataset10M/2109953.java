...
public class BasicGraphGUI extends JPanel implements ActionListener {
	 ...
	 */
    public static final String EVENT_NETWORKMODEL_CLEAR = "clear_graph";

    /**
	 * Event argument for notifying observers that Add new component button is
	 * clicked
	 */
    public static final String EVENT_ADD_COMPONENT_CLICKED = "add_component_clicked";

    /**
	 * Event argument for notifying observers that remove selected component
	 * button is clicked
	 */
    public static final String EVENT_REMOVE_COMPONENT_CLICKED = "remove_component_clicked";

    /**
	 * Event argument for notifying observers that merge two selected nodes
	 * button is clicked
	 */
    public static final String EVENT_MERGE_NODES_CLICKED = "merge_nodes_clicked";

    /**
	 * Event argument for notifying observers that split selected node button is
	 * clicked
	 */
    public static final String EVENT_SPLIT_NODE_CLICKED = "split_node_clicked";

    /**
	 * Event argument for notifying observers that edit vertex properties menu item is
	 * clicked
	 */
    public static final String EVENT_NODE_EDIT_PROPERTIES_CLICKED = "node_edit_properties_clicked";

    /**
	 * Event argument for notifying observers that edit edge properties menu item is
	 * clicked
	 */
    public static final String EVENT_EDGE_EDIT_PROPERTIES_CLICKED = "edge_edit_properties_clicked";

    /**
	 * Event argument for notifying observers that import graph from file button
	 * is clicked
	 */
    public static final String EVENT_IMPORT_GRAPH_CLICKED = "import_graph_clicked";

    public static final String EVENT_OBJECT_LEFT_CLICK = "object_left_click";

    public static final String EVENT_OBJECT_RIGHT_CLICK = "object_right_click";

    public static final String EVENT_OBJECT_DOUBLE_CLICK = "object_double_click";
	 ...
	 */
    private PluggableGraphMouse pgm = null;
	 ...
	 */
    private DefaultModalGraphMouse<GraphNode, GraphEdge> dgm = null;
    ...
    public void setGraph(Graph<GraphNode, GraphEdge> graph) {
        if (graph != null) {
                    ...
                    if (visView.getPickedVertexState().isPicked(arg0)) {
                        ...
                        try {
                            ...
                            if (colorString != null) {
                                ...
                                return color;
                            } else return BasicGraphGUI.DEFAULT_VERTEX_COLOR;
            ...
            visView.getRenderContext().setEdgeDrawPaintTransformer(new Transformer<GraphEdge, Paint>() {
                    ...
                    if (visView.getPickedEdgeState().isPicked(arg0)) {
                        ...
                        try {
                            ...
                            if (colorString != null) {
                                Color color = new Color(Integer.parseInt(colorString));
                                return color;
                            } else return BasicGraphGUI.DEFAULT_EDGE_COLOR;
                        } catch (NullPointerException ex) {
                            ex.printStackTrace();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == getJButtonZoomIn() && visView != null) {
            ...
            int n = JOptionPane.showConfirmDialog(this, Language.translate("Are you sure to clear the graph?", Language.EN), Language.translate("Confirmation", Language.EN), JOptionPane.YES_NO_OPTION);
    ...
    private JButton getJButtonZoomIn() {
        if (jButtonZoomIn == null) {
            ...
            jButtonZoomIn.setToolTipText(Language.translate("Vergr��ern"));
    ...
    private JButton getJButtonZoomReset() {
        if (jButtonZoomReset == null) {
            ...
            jButtonZoomReset.setToolTipText(Language.translate("Zur�cksetzen"));
