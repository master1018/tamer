    ...
    public Iterator<AlignedParallelPhrase> iterator() {
        ...
        return new Iterator<AlignedParallelPhrase>() {
            ...
            public AlignedParallelPhrase next() {
                AlignedParallelPhrase result = new AlignedParallelPhrase(sourceCorpus.getSentence(curr), targetCorpus.getSentence(curr), new Span(sourceCorpus.getSentencePosition(curr), sourceCorpus.getSentenceEndPosition(curr)), alignments);
                curr++;
                return result;
            }
