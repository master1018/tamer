...
public class Listitem extends XulElement implements org.zkoss.zul.api.Listitem {
    ...
    public Listgroup getListgroup() {
        ...
        if (lb != null) return lb.getListgroupAt(getIndex());
        return null;
    }
    ...
    public void setValue(Object value) {
        if (!Objects.equals(_value, value)) {
            _value = value;
            final Listbox listbox = getListbox();
            if (listbox != null) if (listbox.inSelectMold()) smartUpdate("value", Objects.toString(_value)); else if (listbox.getName() != null) smartUpdate("z.value", Objects.toString(_value));
        }
    }
    ...
    public void setDisabled(boolean disabled) {
        if (_disabled != disabled) {
            _disabled = disabled;
            if (inSelectMold()) smartUpdate("disabled", _disabled); else invalidate();
        }
    }
    ...
    final void setLoaded(boolean loaded) {
        if (loaded != _loaded) {
            _loaded = loaded;
            final Listbox listbox = getListbox();
            if (listbox != null && listbox.getModel() != null) if (_loaded && !listbox.inPagingMold()) invalidate(); else smartUpdate("z.loaded", _loaded);
        }
    }
    ...
    public boolean setVisible(boolean visible) {
        if (isVisible() != visible) {
            ...
            final Listbox listbox = (Listbox) getParent();
            if (listbox != null) {
                if (listbox.inSelectMold()) listbox.invalidate();
                final Listgroup g = listbox.getListgroupAt(getIndex());
                if (g == null || g.isOpen()) listbox.addVisibleItemCount(visible ? 1 : -1);
            }
        }
    ...
    public void smartUpdate(String attr, String value) {
        ...
        if (isVisible() || box == null || !box.inSelectMold()) super.smartUpdate(attr, value);
    }
    ...
    public void beforeParentChanged(Component parent) {
        if (parent != null && !(parent instanceof Listbox)) throw new UiException("Listitem's parent must be Listbox, not " + parent);
        super.beforeParentChanged(parent);
    }

    public void beforeChildAdded(Component child, Component refChild) {
        if (!(child instanceof Listcell)) throw new UiException("Unsupported child for listitem: " + child);
    ...
    public String getOuterAttrs() {
        ...
        if (inSelectMold()) {
            ...
            if (isSelected()) HTMLs.appendAttribute(sb, "selected", "selected");
        } else {
            final Listbox listbox = getListbox();
            if (listbox != null) {
                if (listbox.getName() != null) HTMLs.appendAttribute(sb, "z.value", Objects.toString(_value));
                if (listbox.getModel() != null) {
                    ...
                    if (_loaded && !listbox.inPagingMold()) {
                        ...
                        if (c instanceof Listitem && !((Listitem) c)._loaded) HTMLs.appendAttribute(sb, "z.skipsib", "true");
                    }
                }
            }
            if (isDisabled()) HTMLs.appendAttribute(sb, "z.disd", true);
            if (isSelected()) HTMLs.appendAttribute(sb, "z.sel", true);
