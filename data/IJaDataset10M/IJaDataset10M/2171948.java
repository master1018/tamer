...
public class MediaScannerConnectionTest extends AndroidTestCase {
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, method = "MediaScannerConnection", args = { Context.class, MediaScannerConnectionClient.class }), @TestTargetNew(level = TestLevel.COMPLETE, method = "connect", args = {  }), @TestTargetNew(level = TestLevel.COMPLETE, method = "disconnect", args = {  }), @TestTargetNew(level = TestLevel.COMPLETE, method = "isConnected", args = {  }), @TestTargetNew(level = TestLevel.COMPLETE, method = "onServiceConnected", args = { ComponentName.class, IBinder.class }), @TestTargetNew(level = TestLevel.NOT_FEASIBLE, method = "onServiceDisconnected", args = { ComponentName.class }), @TestTargetNew(level = TestLevel.COMPLETE, method = "scanFile", args = { String.class, String.class }) })
    ...
    public void testMediaScannerConnection() throws InterruptedException {
        ...
        mMediaScannerConnection = new MockMediaScannerConnection(getContext(), mMediaScannerConnectionClient);
