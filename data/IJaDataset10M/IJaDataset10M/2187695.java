package com.example.client.other;
...
public class SliderSample extends ShowcasePanel {
    ...
    private static final String DESCRIPTION = "Move either Slider to update the other. You can change the value by clicking and dragging the thumb, " + "clicking on the track, or using the keyboard (once you've focused on one of the sliders).";
