...
public class FeatureUtilTest extends TestCase {
    ...
    enum ExampleDerivedFeature implements Feature<ExampleDerivedInterface> {
        ...
        DERIVED_FEATURE_1, DERIVED_FEATURE_2(ExampleBaseFeature.BASE_FEATURE_1), DERIVED_FEATURE_3, COMPOUND_DERIVED_FEATURE(DERIVED_FEATURE_1, DERIVED_FEATURE_2, ExampleBaseFeature.BASE_FEATURE_2);
    ...
    private static class ExampleDerivedInterfaceTester_Conflict extends ExampleBaseInterfaceTester {
    }
    ...
    public void testAddImpliedFeatures_addsImpliedFeatures() throws Exception {
        ...
        assertContentsAnyOrder(FeatureUtil.addImpliedFeatures(features), ExampleDerivedFeature.DERIVED_FEATURE_1);
        features = Sets.<Feature<?>>newHashSet(ExampleDerivedFeature.DERIVED_FEATURE_2);
        assertContentsAnyOrder(FeatureUtil.addImpliedFeatures(features), ExampleDerivedFeature.DERIVED_FEATURE_2, ExampleBaseFeature.BASE_FEATURE_1);
        features = Sets.<Feature<?>>newHashSet(ExampleDerivedFeature.COMPOUND_DERIVED_FEATURE);
        assertContentsAnyOrder(FeatureUtil.addImpliedFeatures(features), ExampleDerivedFeature.COMPOUND_DERIVED_FEATURE, ExampleDerivedFeature.DERIVED_FEATURE_1, ExampleDerivedFeature.DERIVED_FEATURE_2, ExampleBaseFeature.BASE_FEATURE_1, ExampleBaseFeature.BASE_FEATURE_2);
    }
    ...
    public void testImpliedFeatures_returnsImpliedFeatures() throws Exception {
        ...
        features = Sets.<Feature<?>>newHashSet(ExampleDerivedFeature.DERIVED_FEATURE_2);
        assertContentsAnyOrder(FeatureUtil.impliedFeatures(features), ExampleBaseFeature.BASE_FEATURE_1);
        features = Sets.<Feature<?>>newHashSet(ExampleDerivedFeature.COMPOUND_DERIVED_FEATURE);
        assertContentsAnyOrder(FeatureUtil.impliedFeatures(features), ExampleDerivedFeature.DERIVED_FEATURE_1, ExampleDerivedFeature.DERIVED_FEATURE_2, ExampleBaseFeature.BASE_FEATURE_1, ExampleBaseFeature.BASE_FEATURE_2);
    }
    ...
    public void testBuildTesterRequirements_classClassConflict() throws Exception {
        try {
            ...
            assertContentsAnyOrder(e.getConflicts(), ExampleBaseFeature.BASE_FEATURE_1);
    ...
    public void testBuildTesterRequirements_methodClassConflict() throws Exception {
        Method method = ExampleDerivedInterfaceTester.class.getMethod("testRequiringConflictingFeatures");
        try {
