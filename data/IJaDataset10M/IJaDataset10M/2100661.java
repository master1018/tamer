...
/**
 * {@link AbstractAssociation} between a {@link Player} another.
 ...
 */
@Entity
@Table(name = "FS_PLAYER_FRIEND", uniqueConstraints = @UniqueConstraint(columnNames = { "PLAYER_ID", "FRIEND_ID" }))
public class PlayerFriend extends AbstractPlayerAssociation<Player> implements Serializable {

    /**
	 * 
	 */
    private static final long serialVersionUID = 3564510052782055143L;
