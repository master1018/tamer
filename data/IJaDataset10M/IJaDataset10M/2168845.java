...
public class TextPaintTest extends AndroidTestCase {
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, method = "TextPaint", args = {  }), @TestTargetNew(level = TestLevel.COMPLETE, method = "TextPaint", args = { int.class }), @TestTargetNew(level = TestLevel.COMPLETE, method = "TextPaint", args = { android.graphics.Paint.class }) })
    ...
    public void testConstructor() {
        ...
        assertEquals((TextPaint.DITHER_FLAG | DEFAULT_PAINT_FLAGS), textPaint.getFlags());
    }

    @TestTargetNew(level = TestLevel.COMPLETE, method = "set", args = { android.text.TextPaint.class })
