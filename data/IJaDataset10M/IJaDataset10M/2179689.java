...
public class TaskDetails extends Page {
   ...
   */
    public interface Resources extends ControlBar.Resources, LabelMatrix.Resources {
   ...
   */
    public static Controls createControls(final Controller controller, TaskDetails.Resources resources) {
    ...
    protected TaskDetails(PageTransitionPanel parent, Controls controls, Controller controller, TaskDetails.Resources resources) {
        ...
        contentElem.appendChild(createLabelledFieldGroup("*Label:", labelMatrix.getElement()));
   ...
   */
    ...
    private void hookEventListeners() {
        ...
        DomUtils.addEventListener("click", saveButton, new EventListener() {
            ...
            public void onBrowserEvent(Event event) {
                if (currentTask == null) {
                    currentTask = new Task("", titleField.getValue(), detailsField.getValue(), labelMatrix.getCurrentLabelPriority(), false);
    ...
    private boolean validateFields(Task potentialTask) {
        if (potentialTask.getTitle().equals("") || potentialTask.getLabelPriority() < 0) {
