...
public abstract class AbstractMethod {
    ...
    protected String postString(@Nonnull String authToken, @Nonnull String endpoint, @Nonnull String resource, @Nonnull String payload) throws CloudException, InternalException {
        ...
        try {
            ...
            if (code != HttpServletResponse.SC_OK && code != HttpServletResponse.SC_ACCEPTED && code != HttpServletResponse.SC_NO_CONTENT) {
                ...
                if (code == HttpServletResponse.SC_ACCEPTED || code == HttpServletResponse.SC_OK) {
                    String response;
                    try {
                        response = post.getResponseBodyAsString();
                    } catch (IOException e) {
    ...
    private int compareVersions(@Nullable String ver1, @Nullable String ver2) throws InternalException {
        ...
        try {
            ...
            if (result == 0) result = minor1 - minor2;
        } catch (Exception e) {
            throw new InternalException(e);
        } finally {
            if (logger.isTraceEnabled()) {
