...
public class AttributeAssignment extends AttributeValue {
    ...
    public boolean equals(Object o) {
        ...
        if (o.getClass() == this.getClass()) {
            return getDataType().equals(((AttributeAssignment) o).getDataType()) && compareObject(childExp, ((AttributeAssignment) o).childExp) && typedValue.equals(((AttributeAssignment) o).typedValue) && attributeId.equals(((AttributeAssignment) o).attributeId);
        }
        return false;
    }
}
