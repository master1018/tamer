...
public class ConnectionEvent {
    ...
    public Database[] getDatabases() {
        if (type != CONNECTION_EVENT_DATABASES_ADDED && type != CONNECTION_EVENT_DATABASES_REMOVED) return new Database[0];
    ...
    public Dimension[] getDimensions() {
        if (type != CONNECTION_EVENT_DIMENSIONS_ADDED && type != CONNECTION_EVENT_DIMENSIONS_REMOVED && type != CONNECTION_EVENT_DIMENSIONS_RENAMED) return new Dimension[0];
    ...
    public Element[] getElements() {
        if (type != CONNECTION_EVENT_ELEMENTS_ADDED && type != CONNECTION_EVENT_ELEMENTS_REMOVED && type != CONNECTION_EVENT_ELEMENTS_RENAMED && type != CONNECTION_EVENT_ELEMENTS_TYPE_CHANGED) return new Element[0];
    ...
    public Consolidation[] getConsolidation() {
        if (type != CONNECTION_EVENT_CONSOLIDATIONS_ADDED && type != CONNECTION_EVENT_CONSOLIDATIONS_REMOVED) return new Consolidation[0];
    ...
    public Cube[] getCubes() {
        if (type != CONNECTION_EVENT_CUBES_ADDED && type != CONNECTION_EVENT_CUBES_RENAMED && type != CONNECTION_EVENT_CUBES_REMOVED) return new Cube[0];
