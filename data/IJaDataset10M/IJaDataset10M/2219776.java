package com.example.client.sections;
...
public class ExpandCollapseSample extends ShowcasePanel {
    ...
    private static final String DESCRIPTION = "<p>Click on any section header showing an arrow to expand and collapse it (the \"Green Cube\" section is " + "marked not collapsible).</p><p>Click on the \"Expand Blue\" and \"Collapse Blue\" buttons to " + "expand and collapse the blue section externally.</p>";
