...
public class FadeAnim extends AnimatingControlsSurface {
    ...
    private static Font fonts[] = { new Font("Times New Roman", Font.PLAIN, 64), new Font("serif", Font.BOLD + Font.ITALIC, 24), new Font("Courier", Font.BOLD, 36), new Font("Arial", Font.BOLD + Font.ITALIC, 48), new Font("Helvetica", Font.PLAIN, 52) };

    private static String strings[] = { "Alpha", "Composite", "Src", "SrcOver", "SrcIn", "SrcOut", "Clear", "DstOver", "DstIn" };

    private static String imgs[] = { "jumptojavastrip.png", "duke.gif", "star7.gif" };

    private static Paint paints[] = { Color.red, Color.blue, Color.green, Color.magenta, Color.orange, Color.pink, Color.cyan, texture, Color.yellow, Color.lightGray, Color.white };
    ...
    public void render(int w, int h, Graphics2D g2) {
        for (int i = 0; i < vector.size(); i++) {
            ...
            AlphaComposite ac = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, od.alpha);
            g2.setComposite(ac);
