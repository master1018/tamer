...
public class JccConnectionLocal implements JccConnection {
    ...
    public JccConnectionLocal(JccConnection connection, JccProviderLocal provider, JccCallLocal call) {
    ...
    public boolean equals(Object other) {
        ...
        boolean res = other != null && other instanceof JccConnectionLocal && ((JccConnectionLocal) other).toString().equals(connection.toString());
