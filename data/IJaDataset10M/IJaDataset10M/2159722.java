...
public class XMLHelperImpl implements XMLHelper {
    ...
    public XMLHelperImpl() {
        ...
        prefixesToURIs = new BasicEMap<String, String>() {
    ...
    public void setOptions(Map<?, ?> options) {
        ...
        @SuppressWarnings("unchecked") List<? extends EObject> roots = (List<? extends EObject>) options.get(XMLResource.OPTION_ROOT_OBJECTS);
        if (roots != null) {
            this.roots = roots;
    ...
    public EPackage getNoNamespacePackage() {
        return noNamespacePackage != null ? noNamespacePackage : extendedMetaData != null ? extendedMetaData.getPackage(null) : null;
    }
    ...
    protected String getPrefix(EPackage ePackage, boolean mustHavePrefix) {
        ...
        if (nsPrefix == null || mustHavePrefix && nsPrefix.length() == 0) {
            String nsURI = xmlSchemaTypePackage == ePackage ? XMLResource.XML_SCHEMA_URI : extendedMetaData == null ? ePackage.getNsURI() : extendedMetaData.getNamespace(ePackage);
            boolean found = false;
    ...
    protected String getQName(String uri, String name) {
        ...
        EPackage ePackage = extendedMetaData == null ? EPackage.Registry.INSTANCE.getEPackage(uri) : extendedMetaData.getPackage(uri);
        if (ePackage == null) {
            if (extendedMetaData != null) {
    ...
    public String getName(ENamedElement obj) {
        if (extendedMetaData != null) {
            return obj instanceof EStructuralFeature ? extendedMetaData.getName((EStructuralFeature) obj) : extendedMetaData.getName((EClassifier) obj);
        }
        if (xmlMap != null) {
    ...
    protected URI handleDanglingHREF(EObject object) {
        if (!XMLResource.OPTION_PROCESS_DANGLING_HREF_DISCARD.equals(processDanglingHREF)) {
            DanglingHREFException exception = new DanglingHREFException("The object '" + object + "' is not contained in a resource.", resource == null || resource.getURI() == null ? "unknown" : resource.getURI().toString(), 0, 0);
   ...
   */
        ...
        if (feature == null) {
            if (xmlMap != null) {
                ...
                for (int i = 0, size = structuralFeatures.size(); i < size; ++i) {
                    ...
                    if (name.equals(extendedMetaData.getName(eStructuralFeature)) && (namespaceURI == null ? extendedMetaData.getNamespace(eStructuralFeature) == null : namespaceURI.equals(extendedMetaData.getNamespace(eStructuralFeature)))) {
    ...
    public EStructuralFeature getFeature(EClass eClass, String namespaceURI, String name, boolean isElement) {
        if (extendedMetaData != null) {
            ...
            EStructuralFeature eStructuralFeature = isElement ? extendedMetaData.getElement(eClass, namespaceURI, name) : extendedMetaData.getAttribute(eClass, namespaceURI == "" ? null : namespaceURI, name);
            if (eStructuralFeature != null) {
                computeFeatureKind(eStructuralFeature);
            } else {
                eStructuralFeature = getFeature(eClass, namespaceURI, name);
                if (!laxFeatureProcessing && eStructuralFeature != null && extendedMetaData.getFeatureKind(eStructuralFeature) != ExtendedMetaData.UNSPECIFIED_FEATURE) {
    ...
    protected EStructuralFeature getFeatureWithoutMap(EClass eClass, String name) {
        ...
        if (feature != null) computeFeatureKind(feature);
        return feature;
    }
    ...
    protected void computeFeatureKind(EStructuralFeature feature) {
        ...
        if (eClassifier instanceof EDataType) {
            ...
            if (feature.isMany()) {
                ...
                if (opposite == null || opposite.isTransient() || !opposite.isMany()) featuresToKinds.put(feature, INTEGER_IS_MANY_ADD); else featuresToKinds.put(feature, INTEGER_IS_MANY_MOVE);
            }
        }
    }
    ...
    public String getURI(String prefix) {
        return "xml".equals(prefix) ? "http://www.w3.org/XML/1998/namespace" : "xmlns".equals(prefix) ? ExtendedMetaData.XMLNS_URI : namespaceSupport.getURI(prefix);
    }
        ...
        public String getPrefix(String uri) {
            for (int i = namespaceSize; i > 0; i -= 2) {
                ...
                if ((knownURI != null) ? knownURI.equals(uri) : uri == knownURI) {
                    ...
                    if ((knownURI != null) ? knownURI.equals(uri) : uri == knownURI) return namespace[i - 2];
                }
            }
            return null;
        }
