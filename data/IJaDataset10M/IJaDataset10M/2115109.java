...
/**
 * Represents COM dispinterface DispHTMLParamElement.
 */
public class DispHTMLParamElementImpl extends IDispatchImpl implements DispHTMLParamElement {

    public static final String INTERFACE_IDENTIFIER = "{3050F590-98B5-11CF-BB82-00AA00BDCE0B}";

    private static final IID _iid = IID.create(INTERFACE_IDENTIFIER);

    public DispHTMLParamElementImpl() {
    }

    protected DispHTMLParamElementImpl(IUnknownImpl that) throws ComException {
        super(that);
    }

    public DispHTMLParamElementImpl(IUnknown that) throws ComException {
        super(that);
    }

    public DispHTMLParamElementImpl(CLSID clsid, ClsCtx dwClsContext) throws ComException {
        super(clsid, dwClsContext);
    }

    public DispHTMLParamElementImpl(CLSID clsid, IUnknownImpl pUnkOuter, ClsCtx dwClsContext) throws ComException {
    ...
    public void setValueType(BStr param1) {
        Parameter[] parameters = new Parameter[] { param1 == null ? (Parameter) PTR_NULL : param1 };
        Automation.setDispatchProperty(this, "valueType", parameters);
    }

    public BStr getValueType() {
        Parameter[] parameters = new Parameter[0];
        return (BStr) Automation.getDispatchProperty(this, "valueType", parameters, BStr.class);
    }
    ...
    public Object clone() {
        return new DispHTMLParamElementImpl(this);
    }
}
