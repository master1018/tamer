...
public class RawDataGeoCoder {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            try {
                ...
                if (lineCount % 20 == 0) logger.info(String.format("Parsed %1$s lines. %2$s addresses not found.", lineCount, invalid));
    ...
    private static double[] coordinates(String tokens[], TObjectIntHashMap<String> colNames, String prefix) {
        ...
        Coord c = null;
        if (query.isEmpty()) c = null; else {
            GeoCoordinate coord = googleLookup.requestCoordinate(builder.toString());
            if (coord != null) c = new CoordImpl(coord.getLongitude(), coord.getLatitude());
        }
        if (c == null) {
