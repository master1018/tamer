...
public class AHasMSEdge extends NAryEdge {
    ...
    public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
        ...
        if (nAryEdgesNum > 1 || edgesNum > 0 || !((selectedEdge == null) || (selectedEdge instanceof AHasMSEdge))) return false;
        AHasMSEdge edge = new AHasMSEdge(null);
        if (nAryEdgesNum == 1 && selectedEdge instanceof AHasMSEdge) edge = (AHasMSEdge) selectedEdge;
