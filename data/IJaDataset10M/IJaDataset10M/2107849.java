...
public class StatusDetailActivity extends Activity {
    ...
    private void showStatus() {
        ...
        String createdAt = getResources().getString(R.string.created_at_format, status.getCreatedAt().toGMTString());
        ...
        if (null != status.getGeoLocation()) {
            ...
            String geoLocation = getResources().getString(R.string.geo_location_format, location.getLatitude(), location.getLongitude());
