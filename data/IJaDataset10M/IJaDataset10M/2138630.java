...
public interface MultipleDocumentInterface {
    ...
    public MdiEntry createEntryFromSkinRef(String parentID, String id, String configID, String title, ViewTitleInfo titleInfo, Object datasource, boolean closeable, int index);
