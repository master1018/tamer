...
public class CommandConfigurationController {
    ...
    public CommandConfigurationController(JDialog owner) {
        ...
        commandConfigurationView.getJButtonInfo().addActionListener(new InfoActionListener("Tips for the command", false));
        commandConfigurationView.getJButtonOk().addActionListener(new JButtonOkAction());
        commandConfigurationView.getJButtonCancel().addActionListener(new JButtonCancelAction());
        commandConfigurationView.getJButtonBrowse().addActionListener(new JButtonBrowseAction());
        commandConfigurationView.getRootPane().registerKeyboardAction(commandConfigurationView.getJButtonCancel().getActionListeners()[0], KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE, 0), JComponent.WHEN_IN_FOCUSED_WINDOW);
