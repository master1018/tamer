...
public class TableComponent extends BaseRendererComponent {
    ...
    public void paint(Graphics g) {
        ...
        GradientPaint thePaint = new GradientPaint(0, 0, Color.blue, theSize.width - 35, theSize.height, Color.black, false);
        theGraphics.setPaint(thePaint);
        theGraphics.fillRect(11, 11, theSize.width - 10 - 1, 10 + theMetrics.getAscent() - 1);
        thePaint = new GradientPaint(0, 0, new Color(90, 90, 90), theSize.width - 35, theSize.height, Color.black, false);
        theGraphics.setPaint(thePaint);
        ...
        for (Attribute<Table> theAttriute : table.getAttributes()) {
            ...
            if (theInclude) {
                ...
                if (theAttriute.isPrimaryKey()) {
                    ...
                    as.addAttribute(TextAttribute.UNDERLINE, TextAttribute.UNDERLINE_ON, 0, theText.length());
