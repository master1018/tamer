...
public class SupergeneInternalParserTest extends JGAPTestCase {

    /** String containing the CVS revision. Read out via reflection!*/
    private static final String CVS_REVISION = "$Revision: 1.15 $";

    public static Test suite() {
        TestSuite suite = new TestSuite(SupergeneInternalParserTest.class);
        return suite;
    }

    public void testSupergeneInternalParser() throws Exception {
        TestClass m_test = new TestClass(conf);
        String expectedResponse = "----'0'" + "----'1'" + "----'2'" + "----''" + "--------'i1'" + "--------'ib'" + "--------'ic'" + "--------'k1'" + "--------'k2'" + "------------'hn1'" + "----------------''" + "----------------'a'" + "------------'hn2'" + "------------'hn3'";
        String s = "<0><1><2><><" + m_test.encode("<i1><ib><ic>") + "><" + m_test.encode("<k1><k2><" + m_test.encode("<hn1><" + m_test.encode("<><a>") + "><hn2><hn3>") + ">") + ">";
    ...
    class TestClass extends AbstractSupergene {
        ...
        public TestClass(final Configuration a_conf) throws InvalidConfigurationException {
            super(a_conf, new Gene[] {});
        }

        private void splitRecursive(String a_t, StringBuffer a_buffer, String a_ident, boolean a_print) throws UnsupportedRepresentationException {
