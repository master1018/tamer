...
public class AddPageTest extends BaseTestCase {
    ...
    public void testAddPage() throws Exception {
        ...
        selenium.typeKeys("new_page", RuntimeVariables.replace("Recent Bloggers Test Page"));
        selenium.type("new_page", RuntimeVariables.replace("Recent Bloggers Test Page"));
        ...
        selenium.click(RuntimeVariables.replace("link=Recent Bloggers Test Page"));
        selenium.waitForPageToLoad("30000");
    }
}
