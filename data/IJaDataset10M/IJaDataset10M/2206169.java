...
public class LeanDocument {
    ...
    public boolean equals(Object o) {
        if (o != null && o instanceof LeanDocument) return ((LeanDocument) o).uniqueId == uniqueId; else return false;
    }
 ...
 */
    public static LeanDocument readDocumentOld(String directory, int docID) throws IOException {
 ...
 */
    public void filterDoc(LeanDocument goldSt) {
        ...
        while (keyIterator.hasNext()) {
            ...
            if (!NPchains.containsKey(current)) throw new RuntimeException("Gold Standard np " + current + " not found in doc " + id);
 ...
 */
    public static LeanDocument readDocument(String fn, boolean delete_singletons) throws IOException {
 ...
 */
    ...
    private static int getClusterCorrespondance(Integer cl1, Integer cl2, HashMap<Integer, HashMap<Integer, Integer>> clusterCorresp, int nextId) {
