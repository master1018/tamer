...
public class RepoPerformanceTester extends CCNOutputStream {
    ...
    private class TestFlowControl extends CCNFlowControl {
        ...
        public TestFlowControl(String repoName, ContentName name, CCNHandle handle) throws RepositoryException, IOException {
            super(name, handle);
            if (repoName != null) {
    ...
    public RepoPerformanceTester(String repoName, ContentName name, CCNHandle handle) throws IOException, RepositoryException {
        super(name, null, null, null, null, _rpt.new TestFlowControl(repoName, name, handle));
    }

    public RepoPerformanceTester(ContentName name, CCNFlowControl cf) throws IOException, RepositoryException {
    ...
    private static void do_write(CCNOutputStream ostream, File file) throws IOException {
        ...
        do {
            ...
            if (size > fis.available()) size = fis.available();
            if (size > 0) {
