...
public class SQLDatabaseMetaDataTest extends BaseSQuirreLJUnit4TestCase {
    ...
    public void testPGGetTableTypes() throws SQLException {
        ResultSet mockTableTypeResultSet = buildVarcharResultSetAsRows("mockTableTypeResultSet", new String[] { "SYSTEM INDEX", "SYSTEM VIEW", "SYSTEM TABLE", "SYSTEM TOAST INDEX", "SYSTEM TOAST TABLE", "SYSTEM VIEW", "TABLE", "TEMPORARY INDEX", "TEMPORARY TABLE", "VIEW" });
        ...
        for (int i = 0; i < tableTypes.length; i++) {
            ...
            assertFalse("'SYSTEM INDEX' is a type returned from " + "SQLDatabaseMetaData.getTableTypes for PostgreSQL - " + "it should not be.", "SYSTEM INDEX".equals(type));
        }
        mockHelper.verifyAll();
    }
    ...
    public void testGetBestRowIdentifier() throws SQLException {
        ...
        expect(mockDatabaseMetaData.getBestRowIdentifier(TEST_CATALOG, TEST_SCHEMA, TEST_TABLE, DatabaseMetaData.bestRowTransaction, true));
