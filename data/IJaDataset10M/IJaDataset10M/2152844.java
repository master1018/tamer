...
public class ProxyHandler extends SimpleChannelUpstreamHandler {
    ...
    public ProxyHandler(ServerConfiguration config, ChannelFactory clientChannelFactory) {
        super();
        this.config = config;
    ...
    private class OutboundHandler extends SimpleChannelUpstreamHandler {
        ...
        public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) throws Exception {
            ...
            LOG.info("response : {} {}", ProxyHandler.this.inboundAddr, this.inboundChannel.getLocalAddress());
            newone.resetReaderIndex();
            LOG.info("readble bytes {} {} {}", new Object[] { newone.readableBytes(), msg.messageSize(), original.messageSize() });
            ProxyHandler.this.inboundChannel.write(newone, ProxyHandler.this.inboundAddr);
        }
