...
public class OclMarkerHelper {
	 ...
	 */
    public static final String MARKER_TYPE = fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.mopp.OclPlugin.PLUGIN_ID + ".problem";
    ...
    private static class MarkerCommandQueue {
        ...
        private java.util.List<fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclCommand<Object>> commands = new java.util.ArrayList<fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclCommand<Object>>();

        private final Object jobLock = new Object();

        public void addCommand(fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclCommand<Object> command) {
            ...
            new org.eclipse.core.runtime.jobs.Job("updating markers") {
                ...
                protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
                    synchronized (jobLock) {
                        java.util.List<fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclCommand<Object>> commandsToProcess = new java.util.ArrayList<fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclCommand<Object>>();
                        synchronized (commands) {
                            commandsToProcess.addAll(commands);
                            commands.clear();
                        }
                        for (fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclCommand<Object> command : commandsToProcess) {
	 ...
	 */
    public static void mark(org.eclipse.emf.ecore.resource.Resource resource, final fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclTextDiagnostic diagnostic) {
    ...
    private static void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclTextDiagnostic diagnostic) {
        final fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclProblem problem = diagnostic.getProblem();
        fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.OclEProblemType problemType = problem.getType();
        final String markerID = getMarkerID(problemType);
        COMMAND_QUEUE.addCommand(new fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclCommand<Object>() {
            ...
            public boolean execute(Object context) {
                try {
                    ...
                    if (problem.getSeverity() == fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.OclEProblemSeverity.ERROR) {
                    ...
                    fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclTextDiagnostic textDiagnostic = (fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclTextDiagnostic) diagnostic;
                    ...
                    if (diagnostic instanceof fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.mopp.OclResource.ElementBasedTextDiagnostic) {
                        org.eclipse.emf.ecore.EObject element = ((fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.mopp.OclResource.ElementBasedTextDiagnostic) diagnostic).getElement();
                    ...
                    java.util.Collection<fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
                    java.util.Collection<Object> sourceIDs = new java.util.ArrayList<Object>();
                    if (quickFixes != null) {
                        for (fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.IOclQuickFix quickFix : quickFixes) {
                            if (quickFix != null) {
                    ...
                    if (!sourceIDs.isEmpty()) {
                        marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.util.OclStringUtil.explode(sourceIDs, "|"));
                    }
    ...
    public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
        for (fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.OclEProblemType nextType : fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.OclEProblemType.values()) {
	 ...
	 */
    public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.OclEProblemType problemType) {
        final org.eclipse.core.resources.IFile file = getFile(resource);
        if (file == null) {
            return;
        }
    ...
    public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
        ...
        final String markerID = getMarkerID(fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.OclEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
    private static String getMarkerID(fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.OclEProblemType problemType) {
    ...
    private static void handleException(org.eclipse.core.runtime.CoreException ce) {
        if (ce.getMessage().matches("Marker.*not found.")) {
            ...
            fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.mopp.OclPlugin.logError("Error while removing markers from resource:", ce);
        }
    }
}
