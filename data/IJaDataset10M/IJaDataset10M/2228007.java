...
public final class Authority {
     ...
     */
    public Mapping createMapping(final Domain source, final Domain target) {
        if (source == null) {
     ...
     *    to <code>assignable</code>, supported by <code>evidence</code>
     */
    public Assignment createAssignment(final Concept concept, final Assignable assignable, final Set<Evidence> evidence) {
        if (concept == null) {
        ...
        final Assignment a = new Assignment(this, concept, assignable, evidenceCopy);
        addAssignment(a);
        return a;
    }
