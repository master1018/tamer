package reconcile.weka.gui.visualize;
...
public class PostscriptGraphics extends Graphics2D {
   ...
   */
    ...
    static {
        if (DEBUG) System.err.println(PostscriptGraphics.class.getName() + ": DEBUG ON");
   ...
   */
    private static String replacePSFont(String font) {
        ...
        if (m_PSFontReplacement.containsKey(font)) {
            ...
            if (DEBUG) System.out.println("switched font from '" + font + "' to '" + result + "'");
        }
        return result;
    }
   ...
   */
    public void setFont(Font font) {
        if (font != null) {
            ...
            if (font.getName().equals(m_psGraphicsState.getFont().getName()) && (m_psGraphicsState.getFont().getStyle() == font.getStyle()) && (m_psGraphicsState.getFont().getSize() == yScale(font.getSize()))) return;
   ...
   */
    public void translate(int x, int y) {
        if (DEBUG) System.out.println("translate with x = " + x + " and y = " + y);
    ...
    public void scale(double d1, double d2) {
        ...
        if (DEBUG) System.err.println("d1 = " + d1 + ", d2 = " + d2);
    }
