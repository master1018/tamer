...
public class ClientDateValidator extends ClientTextValidator {
    ...
    private static final String[] EXT_ATTRS_INTERNAL = new String[] { "altFormats", "disabledDates", "disabledDatesText", "disabledDays", "disabledDaysText", "format", "maxText", "maxValue", "minText", "minValue", "triggerClass" };
