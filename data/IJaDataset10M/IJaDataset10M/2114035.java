...
public class AudioProcessChain implements AudioProcess {
    ...
    protected void processMutations() {
        ...
        try {
            ...
            System.err.println("Exception for " + controlChain.getName() + ", Mutation: " + m);
    ...
    protected class ControlChainObserver implements Observer {
        ...
        public void update(Observable obs, Object obj) {
            if (obj instanceof AudioControlsChain.ChainMutation) mutationQueue.add((AudioControlsChain.ChainMutation) obj);
        }
    }
}
