...
/**
    The SimAction class is an abstract to a user-initiated
    action, like jumping or moving. SimActions can be mapped
...
public class SimAction {
    ...
    */
    ...
    /**
        Create a new SimAction with the NORMAL behavior.
    */
    public SimAction(String name) {
        this(name, NORMAL);
    }

    /**
        Create a new SimAction with the specified behavior.
    */
    public SimAction(String name, int behavior) {
        this.name = name;
    ...
    /**
        Gets the name of this SimAction.
    */
    ...
    /**
        Resets this SimAction so that it appears like it hasn't
        been pressed.
    */
    public void reset() {
    ...
    /**
        Taps this SimAction. Same as calling press() followed
        by release().
    */
