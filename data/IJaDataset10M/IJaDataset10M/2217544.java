...
public class TaskPanel extends JPanel {
    ...
    public TaskPanel() {
        ...
        progressPanel.add(Box.createVerticalGlue());
        queue.addStartupNotifier(new ProgressBarUpdateRunnable(queue, progressBar) {
    ...
    protected void setProgressVisible(final boolean visible) {
        ...
        } else layout.show(TaskPanel.this, CONTENT_KEY);
        repaint();
        validate();
    }
    ...
    public void setOpaque(boolean isOpaque) {
        ...
        if (contentPanel != null) contentPanel.setOpaque(isOpaque);
        if (progressPanel != null) progressPanel.setOpaque(isOpaque);
    }
    ...
    public void setLayout(LayoutManager mgr) {
        if (contentPanel != null) contentPanel.setLayout(mgr);
    }
