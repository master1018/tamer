...
public class EISBot_ContextConditionSensorFactories implements eisbot.abl.StarCraftConstants {
    ...
    public static SensorActivation[] contextConditionSensorFactory0(int __$behaviorID) {
        switch(__$behaviorID) {
            case 25:
                {
                    SensorActivation[] __$activationArray = { new SensorActivation(new PlayerUnitSensor(), null) };
            ...
            case 113:
                {
                    SensorActivation[] __$activationArray = { new SensorActivation(new MapSensor(), null) };
                    return __$activationArray;
                }
            default:
