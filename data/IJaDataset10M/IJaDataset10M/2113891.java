...
public class Legend {
    ...
    public static Composite createLegendComposite(Composite panel, Color[] blockColors, String[] keys) {
        ...
        if (layout instanceof GridLayout) layoutData = new GridData(GridData.FILL_HORIZONTAL);
    ...
    public static Composite createLegendComposite(final Composite panel, final Color[] blockColors, final String[] keys, Object layoutData) {
        ...
        if (blockColors.length != keys.length) return null;
        ...
        if (layoutData != null) legend.setLayoutData(layoutData);
            ...
            cColor.addMouseListener(new MouseAdapter() {
                ...
                public void mouseUp(MouseEvent e) {
                    ...
                    if (e.button == 1) {
                        ...
                        RGB rgb = cd.open();
                        if (rgb != null) config.setRGBParameter(keys[index], rgb.red, rgb.green, rgb.blue);
                    } else {
        ...
        legend.addDisposeListener(new DisposeListener() {
            ...
            public void widgetDisposed(DisposeEvent e) {
                for (int i = 0; i < blockColors.length; i++) blockColors[i] = defaultColors[i];
