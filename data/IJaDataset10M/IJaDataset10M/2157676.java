...
public class OTFScaleBarDrawer extends OTFGLDrawableImpl {
    ...
    public void onDraw(GL gl) {
        ...
        gl.glVertex3f(fl[4], fl[5], z);
        gl.glTexCoord2f(tx2, ty1);
        gl.glVertex3f(fl[4], fl[7], z);
        gl.glTexCoord2f(tx2, ty2);
        gl.glVertex3f(fl[2] + width2 + width2 / 3.f, fl[7], z);
        gl.glTexCoord2f(tx1, ty2);
        gl.glVertex3f(fl[2] + width2 + width2 / 3.f, fl[5], z);
        gl.glEnd();
        this.back.disable();
        ...
        gl.glBegin(GL_QUADS);
        gl.glTexCoord2f(tx1, ty1);
        gl.glVertex3f(fl[0], fl[1], z);
        gl.glTexCoord2f(tx2, ty1);
        gl.glVertex3f(fl[0], fl[3], z);
        gl.glTexCoord2f(tx2, ty2);
        gl.glVertex3f(fl[2], fl[3], z);
        gl.glTexCoord2f(tx1, ty2);
        gl.glVertex3f(fl[2], fl[1], z);
        gl.glEnd();
        this.sc.disable();
    ...
    private float[] getKoords() {
        ...
        ret[4] = ret[0] - 3 * xFactor;
        ret[5] = ret[1] - 0.99f * txHeight;
        ret[6] = ret[2] + 0.15f * scrWidth * xFactor;
        ret[7] = ret[3] - 3 * xFactor;
