...
public class ModelCommand extends AbstractCommand {
    ...
    public void run(CommandLine commandLine) {
        ...
        if (cls == null) {
            ...
            for (Alignment alignment : alignmentList) {
                sourceWidList.add(tokenizePutGet(alignment.getSourceSegmentList(), sourceVocabulary, splitAlgorithm));
                targetWidList.add(tokenizePutGet(alignment.getTargetSegmentList(), targetVocabulary, splitAlgorithm));
            }
        } else {
    ...
    private List<Integer> tokenizePutGet(List<String> segmentList, Vocabulary vocabulary, SplitAlgorithm splitAlgorithm) {
