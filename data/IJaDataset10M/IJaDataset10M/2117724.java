...
public class Quartile {
    ...
    public double getMin() {
        ...
        for (int i = 0; i < outliers.length; i++) min = Math.min(min, outliers[i]);
        return min;
    }
    ...
    public double getMax() {
        ...
        for (int i = 0; i < outliers.length; i++) max = Math.max(max, outliers[i]);
        return max;
    }
    ...
    public String toString() {
        return "Quartile (median: " + median + ", lower q: " + lowerQuartile + ", upper q: " + upperQuartile + "lower w: " + lowerWhisker + ", upper w: " + upperWhisker + ", mean: " + mean + ", sd: " + standardDeviation + ", number of outliers: " + outliers.length + ")";
    }
}
