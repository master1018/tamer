...
public class UMLSendsMessageEdge extends NAryEdge {
    ...
    public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
        ...
        if (nAryEdgesNum > 1 || edgesNum > 0 || !((selectedEdge == null) || (selectedEdge instanceof UMLSendsMessageEdge))) return false;
        UMLSendsMessageEdge edge = new UMLSendsMessageEdge(null);
        if (nAryEdgesNum == 1 && selectedEdge instanceof UMLSendsMessageEdge) edge = (UMLSendsMessageEdge) selectedEdge;
