...
public class QueryServiceSolrJImplTestCase extends BaseTestCase {
    ...
    private class QueryServiceSolrJSpy extends QueryServiceSolrJImpl {
        ...
        @Override
        protected SolrQuery createQuery(String q, String fq, String qt, boolean highlight, String facetFields, String sort, String sortOrder, Integer rows, Integer start, String otherParams) throws QueryException {
