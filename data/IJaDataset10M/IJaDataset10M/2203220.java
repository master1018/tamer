...
public class TestAttributeServiceImpl extends BaseCoreDBTestCase {
    ...
    public void testFindAttributesWithMultipleValues1() {
        assertEquals(5, attributeService.findAttributesWithMultipleValues(AttributeGroupNames.PRODUCT).size());
    }

    @Test
    public void testFindAvailableAttributes1() {
        List<Attribute> attrs = attributeService.findAvailableAttributes(AttributeGroupNames.PRODUCT, null);
    ...
    public void testMerge() {
        ...
        for (AttrValue attrVal : removedList) {
            ...
            assertTrue(val.equals("section_5_newval_0") || val.equals("section_5_value_1") || val.equals("section_5_value_2") || val.equals("section_5_value_3"));
        }
