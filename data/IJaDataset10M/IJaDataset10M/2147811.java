...
public class ItemBody extends BodyElement {
    ...
    public Interaction getInteraction(Identifier responseIdentifier) {
        for (Interaction interaction : getInteractions()) if (interaction.getResponseIdentifier() != null && interaction.getResponseIdentifier().equals(responseIdentifier)) return interaction;
        return null;
    }
    ...
    public List<TemplateElement> getTemplates(Identifier templateIdentifier) {
        ...
        for (TemplateElement template : getTemplates()) if (template.getTemplateIdentifier() != null && template.getTemplateIdentifier().equals(templateIdentifier)) templates.add(template);
