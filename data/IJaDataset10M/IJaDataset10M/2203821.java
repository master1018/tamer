...
public class BorderAndPainterDemo {
    ...
    public static void main(String[] args) {
        ...
        p.setBorder(new CompoundBorder(new EmptyBorder(12, 12, 12, 12), new RoundedBorder()));
        f.add(p);
        f.setSize(400, 300);
        f.setVisible(true);
    }
    ...
    private static final class RoundedBorder implements Border {
        ...
        private static final Insets INSETS = new Insets(SPACE_INSETS.top + 12, SPACE_INSETS.left + 12, SPACE_INSETS.bottom + 12, SPACE_INSETS.right + 12);
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
            ...
            Rectangle b = new Rectangle(x + SPACE_INSETS.left, y + SPACE_INSETS.top, width - (SPACE_INSETS.left + SPACE_INSETS.right + 1), height - (SPACE_INSETS.top + SPACE_INSETS.bottom + 1));
            g.drawImage(img, b.x, b.y, b.x + 10, b.y + 10, 0, 0, 10, 10, null);
            g.drawImage(img, b.x + 10, b.y, b.x + b.width - 10, b.y + 10, 11, 0, 12, 10, null);
            g.drawImage(img, b.x + b.width - 10, b.y, b.x + b.width, b.y + 10, 22, 0, 32, 10, null);
            ...
            g.drawImage(img, b.x + b.width - 10, b.y + b.height - 10, b.x + b.width, b.y + b.height, 22, 22, 32, 32, null);
            g.drawImage(img, b.x, b.y + 10, b.x + 10, b.y + b.height - 10, 0, 11, 10, 12, null);
            g.drawImage(img, b.x + b.width - 10, b.y + 10, b.x + b.width, b.y + b.height - 10, 22, 11, 32, 12, null);
