...
public class StringLengthValidationRule extends RangeValidationRule {
    ...
    private static final String rule = "(" + RegExpUtils.fieldName + ")" + RegExpUtils.LineWhitespaces + operator + RegExpUtils.minOneLineWhitespace + "" + rangeDef + "";
    ...
    public StringLengthValidationRule(FieldDefinition fd, String fieldName, String ruleName, String errorMessage, String lowerLimitString, String upperLimitString) {
        ...
        if (upperLimitString.equals("?")) {
            upperLimit = new Integer(Integer.MAX_VALUE);
        } else {
