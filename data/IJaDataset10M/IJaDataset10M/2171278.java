...
public class CertificateFactory1Test extends TestCase {
     ...
     * throws CertificateException when type is not available
     */
    public void testCertificateFactory04() throws CertificateException, NoSuchProviderException {
        if (!X509Support) {
            fail(NotSupportMsg);
            return;
        }
     ...
     */
    public void testCertificateFactory09() throws CertificateException, NoSuchProviderException {
        if (!X509Support) {
            fail(NotSupportMsg);
            return;
        }
     ...
     */
    public void testCertificateFactory10() throws CertificateException, NoSuchProviderException {
        if (!X509Support) {
            fail(NotSupportMsg);
            return;
        }
    ...
    public void testCertificateFactory11() throws CertificateException, NoSuchProviderException, IOException {
        if (!X509Support) {
            fail(NotSupportMsg);
            return;
        }
     ...
     */
    public void testCertificateFactory12() throws CertificateException, NoSuchProviderException {
        if (!X509Support) {
            fail(NotSupportMsg);
            return;
        }
     ...
     */
    public void testCertificateFactory13() throws IOException, CertificateException, NoSuchProviderException {
        if (!X509Support) {
            fail(NotSupportMsg);
            return;
        }
     ...
     */
    public void testCertificateFactory14() throws CertificateException, NoSuchProviderException {
        if (!X509Support) {
            fail(NotSupportMsg);
            return;
        }
     ...
     */
    public void testCertificateFactory15() throws CertificateException, NoSuchProviderException {
        if (!X509Support) {
            fail(NotSupportMsg);
            return;
        }
     ...
     */
    public void testCertificateFactory16() throws CertificateException, NoSuchProviderException {
        if (!X509Support) {
            fail(NotSupportMsg);
            return;
        }
     ...
     */
    public void testCertificateFactory17() throws CertificateException, NoSuchProviderException, NoSuchAlgorithmException, CRLException {
        if (!X509Support) {
            fail(NotSupportMsg);
            return;
        }
...
class myCertificateFactory extends CertificateFactory {
    ...
    public myCertificateFactory(CertificateFactorySpi spi, Provider prov, String type) {
        super(spi, prov, type);
    }
}
