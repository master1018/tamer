...
public class PropertyLocation extends Location {
    ...
    public static void setPropertyList(Object symbol, Object plist, Environment env) {
        synchronized (env) {
            ...
            if (symbol instanceof Symbol) {
                ...
                Object p = old;
                for (; ; ) {
                    if (!(p instanceof Pair)) break;
                    Pair pair = (Pair) p;
                    Object property = pair.getCar();
                    if (plistGet(plist, property, null) != null) env.remove(sym, property);
   ...
   */
    public static Object getProperty(Object symbol, Object property, Object defaultValue, Environment env) {
        if (!(symbol instanceof Symbol)) {
            if (symbol instanceof String) symbol = Namespace.getDefaultSymbol((String) symbol); else return plistGet(env.get(Symbol.PLIST, symbol, LList.Empty), property, defaultValue);
        }
   ...
   */
    ...
    public static void putProperty(Object symbol, Object property, Object newValue, Environment env) {
        if (!(symbol instanceof Symbol)) {
            if (symbol instanceof String) symbol = Namespace.getDefaultSymbol((String) symbol); else {
        ...
        if (loc != null && (loc = loc.getBase()) instanceof PropertyLocation) ((PropertyLocation) loc).set(newValue); else {
            Location lloc = env.getLocation(Symbol.PLIST, symbol);
   ...
   */
    public static boolean removeProperty(Object symbol, Object property, Environment env) {
        ...
        if (!(plist instanceof Pair)) return false;
        Pair pair = (Pair) plist;
        Pair prev = null;
        for (; ; ) {
            if (pair.getCar() == property) break;
            Object next = pair.getCdr();
            if (!(next instanceof Pair)) return false;
            prev = pair;
            pair = (Pair) next;
        }
        ...
        if (prev == null) {
            plist = tail;
            ploc.set(plist);
        } else prev.setCdr(tail);
        if (symbol instanceof Symbol) env.remove((Symbol) symbol, property);
        return true;
    }
   ...
   */
    public static Object plistGet(Object plist, Object prop, Object dfault) {
        while (plist instanceof Pair) {
            Pair pair = (Pair) plist;
            if (pair.getCar() == prop) return ((Pair) pair.getCdr()).getCar();
        }
        return dfault;
    }
