...
public class DocbookMojo extends AbstractMojo {
    ...
    private void describeClass(Class<?> catalogClass, PrintWriter writer) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (null != protocolStateAllowed) {
            writer.println("<para>");
            writer.println("This message is only accepted if the eID Applet Service protocol state is: " + protocolStateAllowed.value());
            writer.println("</para>");
        }
        ...
        writer.println("<tgroup cols=\"3\">");
        {
            ...
            writer.println("<tbody>");
            {
                ...
                for (Field field : fields) {
                    ...
                    writer.println("</entry>");
                    writer.println("<entry>");
                    writer.println((null != field.getAnnotation(NotNull.class)) || (0 != (field.getModifiers() & Modifier.FINAL)));
                    writer.println("</entry>");
                    writer.println("<entry>");
        ...
        if (null != stateTransition) {
            writer.println("<para>");
            writer.println("This message will perform an eID Applet protocol state transition to: " + stateTransition.value());
            writer.println("</para>");
        }
        writer.println("</section>");
    }
    ...
    private static void graphToFile(BasicVisualizationServer<String, String> visualization, File file) throws IOException {
    ...
    private static BasicVisualizationServer<String, String> createGraph() {
        ...
        for (Class<?> messageClass : catalogClasses) {
            ...
            ProtocolStateAllowed protocolStateAllowedAnnotation = messageClass.getAnnotation(ProtocolStateAllowed.class);
        ...
        for (Class<?> messageClass : catalogClasses) {
            ...
            if (null != responsesAllowedAnnotation) {
                ...
                for (Class<?> responseClass : responseClasses) {
                    ...
                    graph.addEdge(edgeName, messageClass.getSimpleName(), responseClass.getSimpleName(), EdgeType.DIRECTED);
                    edgeIdx++;
                }
            }
