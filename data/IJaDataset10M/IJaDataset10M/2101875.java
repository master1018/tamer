   ...
   */
    public void setExpression1(unaryExpression newExpression1) {
        if (newExpression1 != expression1) {
            ...
            if (expression1 != null) msgs = ((InternalEObject) expression1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmplePackage.MULTIPLICATIVE_EXPRESSION__EXPRESSION1, null, msgs);
            if (newExpression1 != null) msgs = ((InternalEObject) newExpression1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmplePackage.MULTIPLICATIVE_EXPRESSION__EXPRESSION1, null, msgs);
            msgs = basicSetExpression1(newExpression1, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, UmplePackage.MULTIPLICATIVE_EXPRESSION__EXPRESSION1, newExpression1, newExpression1));
    }
