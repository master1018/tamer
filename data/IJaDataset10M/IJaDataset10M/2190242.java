package mindmap.diagram.edit.commands;
...
public class MindmapReorientConnectionViewCommand extends AbstractTransactionalCommand {
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor progressMonitor, IAdaptable info) {
        assert null != edgeAdaptor : "Null child in MindmapReorientConnectionViewCommand";
        Edge edge = (Edge) getEdgeAdaptor().getAdapter(Edge.class);
        assert null != edge : "Null edge in MindmapReorientConnectionViewCommand";
