...
public class Cpp extends LanguageData {
    ...
    public Cpp() {
        ...
        ArrayList<String> SymStrList0 = new ArrayList<String>();
        SymStrList0.add("(");
        SymStrList0.add(")");
        SymStrList0.add("{");
        SymStrList0.add("}");
        SymStrList0.add("[");
        SymStrList0.add("]");
        Symbols.put(0, SymStrList0);
        ArrayList<String> SymStrList1 = new ArrayList<String>();
        SymStrList1.add("<");
        SymStrList1.add(">");
        SymStrList1.add("=");
        Symbols.put(1, SymStrList1);
        ArrayList<String> SymStrList2 = new ArrayList<String>();
        SymStrList2.add("+");
        SymStrList2.add("-");
        SymStrList2.add("*");
        SymStrList2.add("/");
        SymStrList2.add("%");
        Symbols.put(2, SymStrList2);
        ArrayList<String> SymStrList3 = new ArrayList<String>();
        SymStrList3.add("!");
        SymStrList3.add("^");
        SymStrList3.add("&");
        SymStrList3.add("|");
        Symbols.put(3, SymStrList3);
        ArrayList<String> SymStrList4 = new ArrayList<String>();
        SymStrList4.add(":");
        Symbols.put(4, SymStrList4);
        ...
        Styles.Comments.put(1, "color:#666666;");
        ...
        Styles.Brackets.put(0, "color:#008000;");
        ...
        Styles.Symbols.put(0, "color:#008000;");
        Styles.Symbols.put(1, "color:#000080;");
        Styles.Symbols.put(2, "color:#000040;");
        Styles.Symbols.put(3, "color:#000040;");
        Styles.Symbols.put(4, "color:#008080;");
