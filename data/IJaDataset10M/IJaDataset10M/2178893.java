...
public class BigIntegerOperateBitsTest extends TestCase {
     ...
     * bitCount() of zero.
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "This is a complete subset of tests for bitCount method.", method = "bitCount", args = {  })
     ...
     * bitLength() of zero.
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "This is a complete subset of tests for bitLength method.", method = "bitLength", args = {  })
     ...
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "This is a complete subset of tests for clearBit method.", method = "clearBit", args = { int.class })
     ...
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "This is a complete subset of tests for flipBit method.", method = "flipBit", args = { int.class })
     ...
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "This is a complete subset of tests for setBit method.", method = "setBit", args = { int.class })
     ...
     * shiftLeft(int n), n = 0
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "This is a complete subset of tests for shiftLeft method.", method = "shiftLeft", args = { int.class })
     ...
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "This is a complete subset of tests for shiftRight method.", method = "shiftRight", args = { int.class })
     ...
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "This is a complete subset of tests for shiftRight method.", method = "testBit", args = { int.class })
     ...
     *        negative BigInteger
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "This is a complete subset of tests for getLowestSetBit method.", method = "getLowestSetBit", args = {  })
