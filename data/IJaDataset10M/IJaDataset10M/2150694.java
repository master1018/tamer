...
public final class GenerateSoyUtilsEscapingDirectiveCode extends Task {
   ...
   */
    private Predicate<String> availableJavaScript = new Predicate<String>() {
        ...
        public boolean apply(String javaScriptFunctionName) {
            return javaScriptFunctionName.indexOf('.') < 0;
        }
    };
   ...
   */
    ...
    public void execute() {
        super.execute();
        if (output == null) {
            System.err.println("Please add an <output> for the <" + getTaskName() + "> at " + this.getLocation());
            return;
        }
   ...
   */
     ...
     */
        class DirectiveDigest {
            ...
            DirectiveDigest(String directiveName, int escapesVar, int matcherVar, int filterVar, @Nullable String nonAsciiPrefix) {
        ...
        escaperLoop: for (EscapingConventions.CrossLanguageStringXform escaper : EscapingConventions.getAllEscapers()) {
            ...
            if (!escaper.getEscapes().isEmpty()) {
                ...
                if (escapesVar == -1) {
                    ...
                    escapeMapNames.set(escapesVar, escapeMapNames.get(escapesVar) + "__AND__" + escapeDirectiveUIdent);
                }
            ...
            digests.add(new DirectiveDigest(escapeDirectiveIdent, escapesVar, matcherVar, filterVar, escaper.getNonAsciiPrefix()));
        }
        ...
        for (DirectiveDigest digest : digests) {
            ...
            if (digest.filterVar != -1) {
                ...
                outputJs.append("    return '").append(EscapingConventions.INNOCUOUS_OUTPUT).append("';\n").append("  }\n");
            }
