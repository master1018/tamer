...
public class ContentNetworkVuzeGeneric extends ContentNetworkImpl {
    ...
    static {
        COConfigurationManager.addAndFireParameterListeners(new String[] { "Send Version Info", "locale" }, new ParameterListener() {
            ...
            public void parameterChanged(String parameterName) {
                ...
                URL_SUFFIX = "azid=" + (send_info ? Base32.encode(VuzeCryptoManager.getSingleton().getPlatformAZID()) : "anonymous") + "&azv=" + Constants.AZUREUS_VERSION + "&locale=" + Locale.getDefault().toString() + "&os.name=" + UrlUtils.encode(System.getProperty("os.name")) + "&vzemb=1";
    ...
    public ContentNetworkVuzeGeneric(ContentNetworkManagerImpl _manager, long _content_network, long _version, String _name, Map<String, Object> _pprop_defaults, Set<Integer> _service_exclusions, String _site_host, String _url_prefix, String _url_icon, String _url_relay_rpc, String _url_authorised_rpc, String _url_faq, String _url_blog, String _url_forums, String _url_wiki) {
        this(_manager, _content_network, _version, _name, _pprop_defaults, _service_exclusions, _site_host, _url_prefix, _url_icon, _url_relay_rpc, _url_authorised_rpc, _url_faq, _url_blog, _url_forums, _url_wiki, null);
    }
    ...
    public String getServiceURL(int service_type, Object[] params) {
        ...
        switch(service_type) {
            ...
            case SERVICE_ABOUT:
                {
                    return base + "azv=" + Constants.AZUREUS_VERSION + "&locale=" + Locale.getDefault().toString();
                }
            default:
                {
