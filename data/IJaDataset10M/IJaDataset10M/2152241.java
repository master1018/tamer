 ...
 * @version $Id: UploadServlet.java 5313 2006-12-06 12:14:27Z cwilper $
 */
public class UploadServlet extends HttpServlet {
        ...
        try {
            ...
            if (part != null && part.isFile()) {
                if (part.getName().equals("file")) {
                    ...
                    sendResponse(HttpServletResponse.SC_BAD_REQUEST, "Content must be named \"file\"", response);
                }
            } else {
                if (part == null) {
            ...
            e.printStackTrace();
            sendResponse(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, e.getClass().getName() + ": " + e.getMessage(), response);
        }
    }
    ...
    private String saveAndGetId(Context context, FilePart filePart) throws ServerException, IOException {
