...
public class PlayListBorder extends AbstractBorder implements MouseListener, MouseMotionListener {
    ...
    private Image corner1, corner2, corner3, corner4;
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        if (wid > 0) {
            ...
            g.drawImage(top, sx, y, wid, top.getHeight(c), 0, 0, wid - sx, top.getHeight(c), c);
        }
        ...
        if (wid > 0) {
            ...
            g.drawImage(bottom, sx, height - bottom.getHeight(c), wid, height, 0, 0, wid - sx, bottom.getHeight(c), c);
        }
        ...
        if (he > 0) {
            ...
            g.drawImage(left, x, sy, left.getWidth(c), he + 1, 0, 0, left.getWidth(c), he - sy, c);
        }
        ...
        if (he > 0) {
            ...
            g.drawImage(right, width - right.getWidth(c), sy, width, he + 1, 0, 0, right.getWidth(c), he - sy, c);
        }
    }
