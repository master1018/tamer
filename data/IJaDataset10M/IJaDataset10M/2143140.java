...
/**
 	* A data access object (DAO) providing persistence and search support for Pedido entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see org.jw.web.rdc.integration.dto.Pedido
  * @author MyEclipse Persistence Tools 
 */
public class PedidoDAO extends HibernateDaoSupport {
    ...
    public void save(Pedido transientInstance) {
    ...
    public Pedido findById(java.lang.Integer id) {
        ...
        try {
            Pedido instance = (Pedido) getHibernateTemplate().get("org.jw.web.rdc.integration.dto.Pedido", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByProperty(String propertyName, Object value) {
        log.debug("finding Pedido instance with property: " + propertyName + ", value: " + value);
        try {
            String queryString = "from Pedido as model where model." + propertyName + "= ?";
    ...
    public Pedido merge(Pedido detachedInstance) {
        ...
        try {
            Pedido result = (Pedido) getHibernateTemplate().merge(detachedInstance);
    ...
    public static PedidoDAO getFromApplicationContext(ApplicationContext ctx) {
        return (PedidoDAO) ctx.getBean("PedidoDAO");
    }
}
