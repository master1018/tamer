 ...
 * @author Emil Ivov
 */
public class OperationSetPersistentPresenceGibberishImpl implements OperationSetPersistentPresence {

    private static final Logger logger = Logger.getLogger(OperationSetPersistentPresenceGibberishImpl.class);
     ...
     * changing it.
     */
    public void fireContactPresenceStatusChangeEvent(ContactGibberishImpl source, ContactGroup parentGroup, PresenceStatus oldValue) {
     ...
     */
    public void fireSubscriptionEvent(ContactGibberishImpl source, ContactGroup parentGroup, int eventID) {
     ...
     * @param eventID an identifier of the event to dispatch.
     */
    public void fireServerStoredGroupEvent(ContactGroupGibberishImpl source, int eventID) {
        ServerStoredGroupEvent evt = new ServerStoredGroupEvent(source, eventID, (ContactGroupGibberishImpl) source.getParentContactGroup(), this.parentProvider, this);
        Iterator listeners = null;
     ...
     * @param contactGroup the group to add
     */
    public void addGibberishGroupAndFireEvent(ContactGroupGibberishImpl parent, ContactGroupGibberishImpl contactGroup) {
     ...
     */
    private void changePresenceStatusForContact(ContactGibberishImpl contact, PresenceStatus newStatus) {
        PresenceStatus oldStatus = contact.getPresenceStatus();
     ...
     */
    public ContactGroupGibberishImpl findGroupParent(ContactGroupGibberishImpl gibberishGroup) {
     ...
     * belongs to or null if no parent was found.
     */
    public ContactGroupGibberishImpl findContactParent(ContactGibberishImpl gibberishContact) {
    ...
    public void renameServerStoredContactGroup(ContactGroup group, String newName) {
        ...
        this.fireServerStoredGroupEvent((ContactGroupGibberishImpl) group, ServerStoredGroupEvent.GROUP_RENAMED_EVENT);
    }
    ...
    public void subscribe(ContactGroup parent, String contactIdentifier) throws IllegalArgumentException, IllegalStateException, OperationFailedException {
        ...
        if (gibProvider != null) {
            OperationSetPersistentPresence opSetPresence = (OperationSetPersistentPresence) gibProvider.getOperationSet(OperationSetPersistentPresence.class);
            changePresenceStatusForContact(contact, (GibberishStatusEnum) opSetPresence.getPresenceStatus());
        } else {
     ...
     */
    private AuthorizationResponse deliverAuthorizationRequest(AuthorizationRequest request, Contact contact) {
    ...
    public void unsubscribe(Contact contact) throws IllegalArgumentException, IllegalStateException, OperationFailedException {
        ...
        fireSubscriptionEvent((ContactGibberishImpl) contact, ((ContactGibberishImpl) contact).getParentContactGroup(), SubscriptionEvent.SUBSCRIPTION_REMOVED);
    }
     ...
     */
    public ProtocolProviderServiceGibberishImpl findProviderForGibberishUserID(String gibberishUserID) {
    ...
    private class UnregistrationListener implements RegistrationStateChangeListener {
        ...
        public void registrationStateChanged(RegistrationStateChangeEvent evt) {
            ...
            while (groupsIter.hasNext()) {
                ContactGroupGibberishImpl group = (ContactGroupGibberishImpl) groupsIter.next();
    ...
    public ContactGibberishImpl createVolatileContact(String contactAddress) {
        ...
        if (theVolatileGroup == null) {
            ...
            theVolatileGroup = new ContactGroupGibberishImpl("NotInContactList", parentProvider);
