 ...
 * 
 */
public abstract class AbstractPostPageDirective implements TemplateDirectiveModel {
    ...
    protected Integer getPreGount(Map<String, TemplateModel> params) throws TemplateException {
        return DirectiveUtils.getInt(PARAM_PER_COUNT, params);
    }

    protected String getPostStyle(Map<String, TemplateModel> params) throws TemplateException {
        return DirectiveUtils.getString(PARAM_POST_STYLE, params);
    }

    protected Integer getCreaterId(Map<String, TemplateModel> params) throws TemplateException {
        return DirectiveUtils.getInt(PARAM_CREATER_ID, params);
    }

    protected Short getStatus(Map<String, TemplateModel> params) throws TemplateException {
