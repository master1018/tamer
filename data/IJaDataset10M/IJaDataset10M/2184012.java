...
public class ModuleExporter {
    ...
    private static String[] DEFAULT_EXCLUDES = { "**/*~", "**/#*#", "**/.#*", "**/%*%", "**/._*", "**/CVS", "**/CVS/**", "**/.cvsignore", "**/SCCS", "**/SCCS/**", "**/vssver.scc", "**/.svn", "**/.svn/**", "**/.DS_Store" };
    ...
    protected ConsoleParametersProcessor createParametersProcessor() {
        ...
        parametersProcessor.addSupportedParameter(parameter);
        parameter = new ConsoleParameter("scanAllowedPackages", "A list of packages (separated by commas) that will be scanned to find Controllers, Modules and Templates", false, true);
        parameter.addParameterOption(new ConsoleParameterOption("allowed", "Allowed packages"));
        parametersProcessor.addSupportedParameter(parameter);
        parameter = new ConsoleParameter("scanIgnoredPackages", "A list of packages (separated by commas) that will not be scanned to find Controllers, Modules and Templates", false, true);
    ...
    protected void initializeJarCreator() throws ModuleExporterException {
        ...
        try {
            jarCreator = new JarCreator(new File[] { exporterWorkDir, sourceDir }, new File(outputDir, outputModuleName + ".module.jar"), includes, excludes, metaInfAttributes, unpackaged);
        } catch (IOException e) {
