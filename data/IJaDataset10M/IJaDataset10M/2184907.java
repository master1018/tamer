package net.sf.echopm.navigation.event;
...
public class OpenPanelEvent extends NavigationEvent {
	 ...
	 */
    public OpenPanelEvent(Object source, PanelActionType panelActionType, Object targetObject, Class<?> targetType, String panelName) {
        this(source, panelActionType, targetObject, targetType, panelName, WorkflowDisposition.ContinueFlow);
    }
	 ...
	 */
    public OpenPanelEvent(Object source, PanelActionType panelActionType, Object targetObject, Class<?> targetType, String panelName, WorkflowDisposition disposition) {
    ...
    public OpenPanelEvent(Object source, PanelActionType panelActionType, String panelName, WorkflowDisposition disposition) {
        super(source, "OpenPanel:" + panelActionType.name());
        this.panel = null;
        this.panelActionType = (panelActionType == null ? PanelActionType.Unspecified : panelActionType);
        this.panelName = panelName;
