...
public class HLStudentDistributionGui extends HLDistributionGui {
    ...
    public HLStudentDistributionGui(HLStudentDistribution theParent) {
        super(theParent);
        myDegreesFreedom = new GUIPropertyIntegerTextField("Degrees of freedom value", ((HLStudentDistribution) parent).getDegreesFreedom(), 1, true, this);
    }
    ...
    public HLStudentDistributionGui(HLGeneralDistribution theParent) {
        super(theParent);
        myDegreesFreedom = new GUIPropertyIntegerTextField("Degrees of freedom value", ((HLGeneralDistribution) parent).getDegreesOfFreedom(), 1, true, this);
    }
