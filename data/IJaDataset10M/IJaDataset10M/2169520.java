...
/**
 * @(#)InputFactoryTypeEJB.java	1.350 01/12/03
 * @version 1.3.1
 * @see     org.j2eebuilder.view.ManagedComponentObjectFactory#getDataVO(
 *			java.lang.Object, java.lang.Class)
 * @since OEC1.2
 */
public abstract class InputFactoryTypeEJB extends org.j2eebuilder.model.ejb.SignatureAbstract implements EntityBean {
    ...
    public org.j2eebuilder.model.ManagedTransientObject getDataVO() throws org.j2eebuilder.model.ejb.ManagedTransientObjectHandlerException {
        return org.j2eebuilder.model.ejb.ManagedTransientObjectHandlerHelper.getDataVO(this.ctx.getPrimaryKey(), this, com.ohioedge.j2ee.api.org.proc.InputFactoryTypeBean.class);
    }
    ...
    public InputFactoryTypeEJB() {
    }

    public InputFactoryTypePK ejbCreate(Integer id, String name, String description, Integer createdBy) throws CreateException {
        setInputFactoryTypeID(id);
        setName(name);
        setDescription(description);
    ...
    public abstract Integer getInputFactoryTypeID();

    public abstract void setInputFactoryTypeID(Integer inputFactoryTypeID);
