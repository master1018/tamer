 ...
 * $Id: IndentFile.java 902 2002-07-03 22:04:48Z theoyaung $
 */
public class IndentFile {

    private static final int BUF_SIZE = 0x2800;
    ...
    private static String readFileAsString(String filename, char[] buf) throws IOException {
    ...
    private static void writeFileFromString(String filename, String value) throws IOException {
