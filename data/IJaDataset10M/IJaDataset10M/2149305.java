...
public class OntologyCleaner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        OWLOntology ontology = OWLManager.createOWLOntologyManager().loadOntologyFromOntologyDocument(OntologyCleaner.class.getClassLoader().getResourceAsStream("dbpedia_0.75.owl"));
