...
public class ImageEntry {
    ...
    /** file for the image */
    protected final File IMAGE_FILE;
    ...
    public static ImageEntryTransferable getTransferable(final List<File> imageFiles) {
    ...
    public static ImageEntryTransferable getTransferableForEntries(final List<ImageEntry> entries) {
        return new ImageEntryTransferable(entries);
    }
