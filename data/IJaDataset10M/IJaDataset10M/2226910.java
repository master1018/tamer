...
public class FunctionTag extends TagSupport {
    ...
    private static Logger log = LoggerFactory.getLogger(FunctionTag.class.getName());
   ...
   */
    public int doStartTag() throws JspTagException {
        ...
        try {
            ...
            String msg = "FunctionTag: error while reading in function file from " + fileName + ": " + ioe.getMessage();
            throw new NavigatorRuntimeException(msg, ioe);
        } catch (SAXException saxe) {
            String msg = "FunctionTag: error while parsing function file (" + fileName + "): " + saxe.getMessage();
   ...
   * function.
   */
    protected JSPTreeNodeIF readinFunction(String filename) throws IOException, SAXException {
