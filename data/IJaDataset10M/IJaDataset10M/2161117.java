...
public abstract class AbstractStaxWriterTest extends AbstractXMLWriterTest {
    ...
    protected void marshall(QNameMap qnameMap, boolean repairNamespaceMode) throws XMLStreamException {
        outputFactory.setProperty(XMLOutputFactory.IS_REPAIRING_NAMESPACES, repairNamespaceMode ? Boolean.TRUE : Boolean.FALSE);
