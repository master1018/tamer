...
public class ForeachBlockBuilder extends InnerBlockBuilder<ForeachBlockInfo, UnresolvedForeachBlockInfo> {
    ...
    public ForeachBlockBuilder(final BuildDataManager targetDataManager, final ExpressionElementManager expressionManager, final LocalVariableDeclarationStatementBuilder variableBuilder) {
    ...
    public void stateChanged(final StateChangeEvent<AstVisitEvent> event) {
        ...
        if (type.equals(FOREACH_BLOCK_STATE_CHANGE.ENTER_FOREACH_VARIABLE)) {
            ...
            this.getBuildingBlock().setIteratorVariable(this.iteratorVariableBuilder.getLastBuildData());
            ...
            final UnresolvedExpressionInfo<? extends ExpressionInfo> iteratorExpression = null == this.expressionManager.getPeekExpressionElement() ? null : this.expressionManager.getPeekExpressionElement().getUsage();
