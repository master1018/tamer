...
public class EPPDomainUpdate extends EPPDomainBase implements epp_DomainUpdate {
    ...
    public String toXML() throws epp_XMLException {
        ...
        Element add_element = getAddRemoveElement(doc, action_request_.m_add, "domain:add");
        if (add_element != null) {
            domain_update.appendChild(add_element);
        }
        Element remove_element = getAddRemoveElement(doc, action_request_.m_remove, "domain:rem");
