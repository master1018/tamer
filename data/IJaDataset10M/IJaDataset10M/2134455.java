...
public class Table implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Table) {
            ...
            return new EqualsBuilder().append(_name, other._name).append(_columns, other._columns).append(new HashSet(_foreignKeys), new HashSet(other._foreignKeys)).append(new HashSet(_indices), new HashSet(other._indices)).isEquals();
        } else {
            return false;
        }
    }
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(_name).append(_columns).append(new HashSet(_foreignKeys)).append(new HashSet(_indices)).toHashCode();
    }
