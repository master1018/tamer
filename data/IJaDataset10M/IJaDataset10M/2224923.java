...
public class ConsoleLogger extends Log {
    ...
    public void setLogLevel(String level) {
        if (level.equals("INFO")) ConsoleLogger.level = Level.INFO; else if (level.equals("FINE")) ConsoleLogger.level = Level.FINE; else if (level.equals("FINER")) ConsoleLogger.level = Level.FINER; else if (level.equals("FINEST")) ConsoleLogger.level = Level.FINEST; else if (level.equals("WARNING")) ConsoleLogger.level = Level.WARNING; else if (level.equals("SEVERE")) ConsoleLogger.level = Level.SEVERE;
    }

    public boolean isLoggable(Level level) {
        if (ConsoleLogger.level == level) return true; else return false;
    }
    ...
    public static synchronized ConsoleLogger getConsoleLoggerInstance() {
        if (consoleLogger == null) consoleLogger = new ConsoleLogger();
