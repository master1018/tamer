...
public class WaterPassEditor extends JPanel {
    ...
    private static final Logger logger = Logger.getLogger(WaterPassEditor.class.getName());
    ...
    private float origClipBias, origHeightFalloffSpeed, origHeightFalloffStart, origSpeedReflection;
