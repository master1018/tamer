...
public class GridEditAllRowsSample extends ShowcasePanel {
    ...
    private static final String DESCRIPTION = "<p>This is an example of editing with all editors active. This is done by simply " + "calling : <pre>listGrid.setAlwaysShowEditors(true)</b></pre>";
