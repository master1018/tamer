 ...
 * distance apart.
 */
public class WordCooccurrenceWritable implements WritableComparable<WordCooccurrenceWritable> {
    ...
    public static WordCooccurrenceWritable read(DataInput in) throws IOException {
    ...
    public int hashCode() {
        return w1.hashCode() ^ w2.hashCode() ^ distance;
    }

    public boolean equals(Object o) {
        if (o instanceof WordCooccurrenceWritable) {
            WordCooccurrenceWritable wow = (WordCooccurrenceWritable) o;
            return w1.equals(wow.w1) && w2.equals(wow.w2) && distance == wow.distance;
        }
        return false;
    }
