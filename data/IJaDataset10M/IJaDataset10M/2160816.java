...
public class RealPlot2dDisplay extends CoDa2dDisplay {
    ...
    public void drawLabels(Graphics2D g2) {
        ...
        g2.drawString(textLabel[0], (int) o.getX() - metric.stringWidth(textLabel[0]) / 2, (int) o.getY() - separation);
        o = defaultTransform.transform(new Point2D.Double(V[1][0], V[1][1]), o);
        g2.drawString(textLabel[1], (int) o.getX() - metric.stringWidth(textLabel[1]) / 2, (int) o.getY() - separation);
    }
