...
public class OGCServiceInformation extends AbstractXMLEventParser {
    ...
    public XMLEventParser allocate(XMLEventParserContext ctx, XMLEvent event) {
        ...
        if (ctx.isStartElement(event, ONLINE_RESOURCE)) defaultParser = new OGCOnlineResource(this.getNamespaceURI()); else if (ctx.isStartElement(event, CONTACT_INFORMATION)) defaultParser = new OGCContactInformation(this.getNamespaceURI()); else if (ctx.isStartElement(event, KEYWORD_LIST)) defaultParser = new StringSetXMLEventParser(this.getNamespaceURI(), KEYWORD);
    ...
    protected void doParseEventContent(XMLEventParserContext ctx, XMLEvent event, Object... args) throws XMLStreamException {
        if (ctx.isStartElement(event, NAME)) {
            ...
            if (parser != null) {
                ...
                if (o != null && o instanceof StringSetXMLEventParser) this.setKeywords(((StringSetXMLEventParser) o).getStrings());
            }
            ...
            if (parser != null) {
                Object o = parser.parse(ctx, event, args);
                if (o != null && o instanceof OGCContactInformation) this.setContactInformation((OGCContactInformation) o);
            }
        }
    }
    ...
    public Set<String> getKeywords() {
        if (keywords != null) return keywords; else return Collections.emptySet();
    }
    ...
    protected void keywordsToString(StringBuilder sb) {
        sb.append("Keywords: ");
        if (this.getKeywords().size() == 0) sb.append(" none"); else {
