...
public interface IConstants {
    ...
    /** Url response codes */
    Integer HTTP_200 = Integer.valueOf(200);

    Integer HTTP_301 = Integer.valueOf(301);

    Integer HTTP_400 = Integer.valueOf(400);

    Integer HTTP_401 = Integer.valueOf(401);

    Integer HTTP_403 = Integer.valueOf(403);

    Integer HTTP_404 = Integer.valueOf(404);

    Integer HTTP_418 = Integer.valueOf(418);

    Integer HTTP_500 = Integer.valueOf(500);

    Integer HTTP_503 = Integer.valueOf(503);
