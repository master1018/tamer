...
public class ServiceFactory {
    ...
    public static <T extends GoofsService> Object getService(Class<T> clazz) throws Exception {
        ...
        return Proxy.newProxyInstance(clazz.getClassLoader(), new Class[] { clazz }, new ServiceInvocationHandler(gs));
    }
}
