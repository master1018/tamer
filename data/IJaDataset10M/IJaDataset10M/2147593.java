 ...
 *
 */
public class D55_Test23_UserIntentDiscoveryLogParser {
	...
	*/
    public static void EntryPointForPERSISTEvaluators() {
        EvaluationFilter filter = new DelayEvaluationFilter("UserIntentModel.dataset.18", "UserIntentDiscovery", "UserIntentDiscovery.ResponseTime", 23);
        String filename = "C:\\PERSIST_SVN\\SOURCEFORGE_REPO\\open_source\\trunk\\PersistContainer\\PerformanceLog.log";
        int numHistoBins = 10;
        PerformanceStatistic statistic = new PerformanceStatistic(D55_Test23_UserIntentDiscoveryLogParser.ReturnResultsFromLogFile(filter, filename), numHistoBins);
    ...
    public static void main(String[] args) {
        D55_Test23_UserIntentDiscoveryLogParser.EntryPointForPERSISTEvaluators();
    }
