...
public class Home implements Serializable, Cloneable {
   ...
   */
    public enum Property {
        ...
        NAME, MODIFIED, FURNITURE_SORTED_PROPERTY, FURNITURE_DESCENDING_SORTED, FURNITURE_VISIBLE_PROPERTIES, BACKGROUND_IMAGE, CAMERA, PRINT, BASE_PLAN_LOCKED
    }
   ...
   */
    ...
    private Home(List<HomePieceOfFurniture> furniture, float wallHeight) {
        ...
        this.furnitureVisibleProperties = Arrays.asList(new HomePieceOfFurniture.SortableProperty[] { HomePieceOfFurniture.SortableProperty.NAME, HomePieceOfFurniture.SortableProperty.WIDTH, HomePieceOfFurniture.SortableProperty.DEPTH, HomePieceOfFurniture.SortableProperty.HEIGHT, HomePieceOfFurniture.SortableProperty.VISIBLE });
        init();
    }
   ...
   */
        ...
        if (KEEP_BACKWARD_COMPATIBLITY) {
            ...
            if (this.furnitureVisiblePropertyNames != null) {
                ...
                for (String furnitureVisiblePropertyName : this.furnitureVisiblePropertyNames) {
                    try {
                        this.furnitureVisibleProperties.add(HomePieceOfFurniture.SortableProperty.valueOf(furnitureVisiblePropertyName));
                    } catch (IllegalArgumentException ex) {
                    }
                }
    ...
    private void init() {
        ...
        this.topCamera = new Camera(500, 1500, 1000, (float) Math.PI, (float) Math.PI / 4, (float) Math.PI * 63 / 180);
        this.observerCamera = new ObserverCamera(50, 50, 170, 7 * (float) Math.PI / 4, (float) Math.PI / 16, (float) Math.PI * 63 / 180);
   ...
   */
    public void setFurnitureSortedProperty(HomePieceOfFurniture.SortableProperty furnitureSortedProperty) {
        if (furnitureSortedProperty != this.furnitureSortedProperty || (furnitureSortedProperty != null && !furnitureSortedProperty.equals(this.furnitureSortedProperty))) {
            ...
            this.propertyChangeSupport.firePropertyChange(Property.FURNITURE_SORTED_PROPERTY.name(), oldFurnitureSortedProperty, furnitureSortedProperty);
        }
    }
   ...
   */
    public void setFurnitureDescendingSorted(boolean furnitureDescendingSorted) {
        if (furnitureDescendingSorted != this.furnitureDescendingSorted) {
            ...
            this.propertyChangeSupport.firePropertyChange(Property.FURNITURE_DESCENDING_SORTED.name(), !furnitureDescendingSorted, furnitureDescendingSorted);
        }
    }
   ...
   */
    public void setFurnitureVisibleProperties(List<HomePieceOfFurniture.SortableProperty> furnitureVisibleProperties) {
        if (furnitureVisibleProperties != this.furnitureVisibleProperties || (furnitureVisibleProperties != null && !furnitureVisibleProperties.equals(this.furnitureVisibleProperties))) {
            ...
            this.propertyChangeSupport.firePropertyChange(Property.FURNITURE_VISIBLE_PROPERTIES.name(), Collections.unmodifiableList(oldFurnitureVisibleProperties), Collections.unmodifiableList(furnitureVisibleProperties));
        }
    }
   ...
   */
    public void setBasePlanLocked(boolean basePlanLocked) {
        if (basePlanLocked != this.basePlanLocked) {
            ...
            this.propertyChangeSupport.firePropertyChange(Property.BASE_PLAN_LOCKED.name(), !basePlanLocked, basePlanLocked);
        }
    }
   ...
   */
    ...
    public Home clone() {
        try {
            ...
            clone.furniture = cloneSelectableItems(this.furniture, this.selectedItems, clone.selectedItems);
            clone.rooms = cloneSelectableItems(this.rooms, this.selectedItems, clone.selectedItems);
            clone.dimensionLines = cloneSelectableItems(this.dimensionLines, this.selectedItems, clone.selectedItems);
            ...
            clone.furnitureVisibleProperties = new ArrayList<HomePieceOfFurniture.SortableProperty>(this.furnitureVisibleProperties);
   ...
   */
    ...
    private <T extends Selectable> List<T> cloneSelectableItems(List<T> source, List<Selectable> sourceSelectedItems, List<Selectable> destinationSelectedItems) {
   ...
   */
    public static List<Selectable> duplicate(List<? extends Selectable> items) {
        ...
        for (Selectable item : items) {
            if (!(item instanceof Wall) && !(item instanceof Camera)) {
                list.add(item.clone());
            }
        }
