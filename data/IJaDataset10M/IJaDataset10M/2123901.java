...
public class Spell_DistantVision extends Spell {
    ...
    public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel) {
        ...
        try {
            ...
            if (rooms.size() > 0) thisRoom = (Room) rooms.elementAt(CMLib.dice().roll(1, rooms.size(), -1));
        ...
        } else beneficialWordsFizzle(mob, null, "<S-NAME> close(s) <S-HIS-HER> eyes, incanting, but then open(s) them in frustration.");
        return success;
    }
}
