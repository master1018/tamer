...
public class VariableResolverTreeNode extends FeatureTreeNode implements EventListener {
    ...
    public void startExamplePanel() {
        ...
        itsNatDoc.addEventListener((EventTarget) linkToResolve, "click", this, false);
    ...
    public void endExamplePanel() {
        ItsNatDocument itsNatDoc = getItsNatDocument();
        this.label = null;
        itsNatDoc.removeEventListener((EventTarget) linkToResolve, "click", this, false);
        this.linkToResolve = null;
        itsNatDoc.removeEventListener((EventTarget) inputElem, "change", this, false);
        this.inputElem = null;
    }

    public void handleEvent(Event evt) {
        if (linkToResolve == evt.getCurrentTarget()) label.setLabelValue(inputElem.getValue());
    }
}
