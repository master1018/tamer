...
public class PacketFactoryTest {
    ...
    private final int[] allIds = new int[] { CommandId.ALERT_NOTIFICATION, CommandId.BIND_RECEIVER, CommandId.BIND_RECEIVER_RESP, CommandId.BIND_TRANSCEIVER, CommandId.BIND_TRANSCEIVER_RESP, CommandId.BIND_TRANSMITTER, CommandId.BIND_TRANSMITTER_RESP, CommandId.BROADCAST_SM, CommandId.BROADCAST_SM_RESP, CommandId.CANCEL_BROADCAST_SM, CommandId.CANCEL_BROADCAST_SM_RESP, CommandId.CANCEL_SM, CommandId.CANCEL_SM_RESP, CommandId.DATA_SM, CommandId.DATA_SM_RESP, CommandId.DELIVER_SM, CommandId.DELIVER_SM_RESP, CommandId.ENQUIRE_LINK, CommandId.ENQUIRE_LINK_RESP, CommandId.GENERIC_NACK, CommandId.OUTBIND, CommandId.PARAM_RETRIEVE, CommandId.PARAM_RETRIEVE_RESP, CommandId.QUERY_BROADCAST_SM, CommandId.QUERY_BROADCAST_SM_RESP, CommandId.QUERY_LAST_MSGS, CommandId.QUERY_LAST_MSGS_RESP, CommandId.QUERY_MSG_DETAILS, CommandId.QUERY_MSG_DETAILS_RESP, CommandId.QUERY_SM, CommandId.QUERY_SM_RESP, CommandId.REPLACE_SM, CommandId.REPLACE_SM_RESP, CommandId.SUBMIT_MULTI, CommandId.SUBMIT_MULTI_RESP, CommandId.SUBMIT_SM, CommandId.SUBMIT_SM_RESP, CommandId.UNBIND, CommandId.UNBIND_RESP };
    ...
    public void testCustomCommand() throws Exception {
        ...
        packetFactory.registerVendorPacket(VENDOR_ID, VendorRequest.class, VendorResponse.class);
