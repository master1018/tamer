...
public interface LPAClient extends Remote {
     ...
     * @throws IOException if there is a communication problem
     */
    Set<AffinityGroup> getAffinityGroups(long runNumber, boolean done) throws IOException;
     ...
     * @throws IOException if there is a communication problem
     */
    void notifyCrossNodeEdges(Collection<Object> objIds, long nodeId) throws IOException;
     ...
     * @throws IOException if there is a communication problem
     */
    Map<Object, Map<Integer, List<Long>>> getRemoteLabels(Collection<Object> objIds) throws IOException;
