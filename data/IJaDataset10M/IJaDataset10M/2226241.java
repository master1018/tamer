...
/**
 * {@link Java13Parser}���琶�������AST�m�[�h�� {@link AstToken}�ɕϊ�����N���X.
 * 
 * @author kou-tngt
 *
 */
public class Java13AntlrAstTranslator implements AstTokenTranslator<AST> {
    ...
    /**
     *  {@link Java14Parser}���琶�������AST�m�[�h�� {@link AstToken}�ɕϊ�����.
     *  
     *  @param node �ϊ��Ώۂ̃m�[�h
     *  @return �ϊ����ʂ�AstToken
     */
    public AstToken translate(AST node) {
        ...
        switch(type) {
            ...
            case Java13TokenTypes.STRING_LITERAL:
                final ClassInfo stringClass = DataManager.getInstance().getClassInfoManager().getClassInfo(new String[] { "java", "lang", "String" });
                if (null == stringClass) {
