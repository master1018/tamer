package pcgen.gui2.generator.ability;
...
import pcgen.gui2.filter.FilteredTreeViewPanel;
import pcgen.gui2.tools.ResourceManager;
import pcgen.gui2.tools.ResourceManager.Icons;
import pcgen.gui2.util.table.ListTableModel;
...
class AbilityBuildPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        add(new JLabel(ResourceManager.getText("abilityCatagory")), gridBagConstraints2);
        {
            categoryBox.addItemListener(model);
        }
        ...
        JPanel panel = new JPanel(new GridBagLayout());
        {
            ...
            initButton(panel, orderBox, "ordered", null, model, gridBagConstraints);
            initButton(panel, addButton, "add", null, model, gridBagConstraints);
            initButton(panel, removeButton, "remove", null, model, gridBagConstraints);
            gridBagConstraints2 = new GridBagConstraints();
            ...
            initButton(panel, upButton, "up", Icons.Up16, model, gridBagConstraints);
            initButton(panel, downButton, "down", Icons.Down16, model, gridBagConstraints);
        }
        JSplitPane splitPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT, true, panel, abilityPanel);
    ...
    private void initButton(JPanel panel, AbstractButton button, String prop, Icons icon, ActionListener listener, GridBagConstraints gridBagConstraints) {
        if (icon == null) {
    ...
    private class AbilityTableModel extends ListTableModel<AbilityFacade> implements ActionListener, ItemListener, ListSelectionListener {
