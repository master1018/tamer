...
public class TCActionHandlerManager {
    ...
    public void createActionHandlers() {
        ...
        _actionHandlers.put(TourChart.COMMAND_ID_CAN_MOVE_SLIDERS_WHEN_ZOOMED, new ActionHandlerCanMoveSlidersWhenZoomed());
        setupHandlers();
    }
    ...
    private void setupHandlers() {
        ...
        for (final TCActionHandler actionHandler : _actionHandlers.values()) {
            final IHandlerActivation handlerActivation = _handlerService.activateHandler(actionHandler.getCommandId(), actionHandler, partIdExpression);
