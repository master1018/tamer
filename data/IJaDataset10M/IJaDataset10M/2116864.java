...
/**
 * A JInternalFrame which responds to changes in client resources.
 ...
 *         1999.03.03  MB              Created
 */
public class CFJInternalFrame extends JInternalFrame implements CFJItem {

    private String resourceKey;

    /**
     * Construct a CFJInternalFrame   (Client Framework JInternalFrame)
     ...
     */
    public CFJInternalFrame(ClientResource resource, String resourceKey) {
        super(resourceKey);
    ...
    public void update(ClientResource clientResource) {
        ...
        final String text = clientResource.getText(resourceKey);
        if (text != null) {
            setTitle(text);
        } else {
