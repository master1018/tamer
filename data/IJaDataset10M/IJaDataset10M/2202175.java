...
public class OpenNLPTokenizer extends AbstractOpenNLPTool<NLPText> {
    ...
    static {
        try {
            ...
            String modelFile = resourceBundleHelper.getString(PROP_ENGLISH_TOKENIZER_MODEL_FILE, PROP_ENGLISH_TOKENIZER_MODEL_FILE_DEFAULT);
    ...
    public NLPText process(NLPText text) {
        if (text.is(GrammaticalStructureLevel.SENTENCE) || text.is(GrammaticalStructureLevel.UNKNOWN)) {
