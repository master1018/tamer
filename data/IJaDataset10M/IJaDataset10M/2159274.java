...
import de.uniwue.dltk.textmarker.internal.core.TextMarkerExtensionManager;
...
public class TextMarkerExternalFactory {
    ...
    public TextMarkerExternalFactory() {
        ...
        IIDEConditionExtension[] cextensions = TextMarkerExtensionManager.getDefault().getIDEConditionExtensions();
        ...
        IIDEActionExtension[] aextensions = TextMarkerExtensionManager.getDefault().getIDEActionExtensions();
        ...
        IIDENumberFunctionExtension[] nfextensions = TextMarkerExtensionManager.getDefault().getIDENumberFunctionExtensions();
        ...
        IIDEBooleanFunctionExtension[] bfextensions = TextMarkerExtensionManager.getDefault().getIDEBooleanFunctionExtensions();
        ...
        IIDEStringFunctionExtension[] sfextensions = TextMarkerExtensionManager.getDefault().getIDEStringFunctionExtensions();
        ...
        IIDETypeFunctionExtension[] tfextensions = TextMarkerExtensionManager.getDefault().getIDETypeFunctionExtensions();
    ...
    public TextMarkerCondition createExternalCondition(Token id, List<Expression> args) throws RecognitionException {
    ...
    public TextMarkerAction createExternalAction(Token id, List<Expression> args) throws RecognitionException {
        String name = id.getText();
        IIDEActionExtension extension = actionExtensions.get(name);
        if (extension != null) {
            return extension.createAction(id, args);
        }
        throw new NoViableAltException("Unknown action : " + name, id.getType(), id.getType(), id.getInputStream());
    }

    public TextMarkerExpression createExternalNumberFunction(Token id, List<Expression> args) throws RecognitionException {
        String name = id.getText();
        IIDENumberFunctionExtension extension = numberFunctionExtensions.get(name);
        if (extension != null) {
            return extension.createNumberFunction(id, args);
        }
        throw new NoViableAltException("Unknown number function : " + name, id.getType(), id.getType(), id.getInputStream());
    }

    public TextMarkerExpression createExternalBooleanFunction(Token id, List<Expression> args) throws RecognitionException {
        String name = id.getText();
    ...
    public TextMarkerExpression createExternalStringFunction(Token id, List<Expression> args) throws RecognitionException {
        String name = id.getText();
    ...
    public TextMarkerExpression createExternalTypeFunction(Token id, List<Expression> args) throws RecognitionException {
        String name = id.getText();
