...
public class SVG2CMLSpectConverter extends AbstractConverter {
    ...
    public static final String[] typicalArgsForConverterCommand = { "-sd", "src/test/resources/spectrum/svgin", "-odir", "../svgcml", "-is", "svg", "-os", "cml", "-converter", "org.xmlcml.cml.converters.graphics.svg.SVG2CMLConverter" };
