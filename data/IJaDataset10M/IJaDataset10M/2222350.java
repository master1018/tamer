...
public class TestQuery extends TestCase {
    ...
    public void testEqualsANDQuery() throws Exception {
        ...
        andChain.add(LogicExpression.createInstance("value", "parent://2", LogicExpression.OP_EQUALS)).add(LogicExpression.createInstance("child.value", "child://2", LogicExpression.OP_EQUALS));
    ...
    public void testEqualsORQuery() throws Exception {
        ...
        andChain.add(LogicExpression.createInstance("value", "parent://2", LogicExpression.OP_EQUALS)).add(LogicExpression.createInstance("strings[2]", "string://2", LogicExpression.OP_EQUALS));
        Query query = Query.createInstance(andChain);
        Vector result = query.executeQuery(all);
        assertTrue("Must Not be Empty", result != null && !result.isEmpty());
        int size = result.size();
