...
public class TraceVectorInstances {
    ...
    public TraceVector add(String category, int target, String description) throws Exception {
        Map<Integer, TraceVector> vectorsForCategory = vectorsByCategory.get(category);
        ...
        if (vector == null) {
            ...
            throw new Exception(String.format("attempt to add duplicate vector %s", vector));
        }
        return vector;
    }
    ...
    public Set<TraceVector> getVectorsInState(String category, boolean enableFlag) {
