...
public class BrowseHobbyBirra2 extends javax.swing.JInternalFrame {
    ...
    public BrowseHobbyBirra2() {
        ...
        @SuppressWarnings("unchecked") Iterator it = root.getChildren().iterator();
        while (it.hasNext()) {
            Element el = (Element) it.next();
            StyleTreeNode styleNode = new StyleTreeNode(el.getAttribute("nome").getValue(), "-1");
            @SuppressWarnings("unchecked") Iterator it2 = el.getChildren().iterator();
            ...
            while (it2.hasNext()) {
                ...
                SubStyleTreeNode subNode = new SubStyleTreeNode(el2.getAttribute("nome").getValue() + " (" + el2.getAttribute("count").getValue() + ")", el2.getAttribute("id_stile").getValue(), styleNode);
        ...
        while (it.hasNext()) {
            Element el = (Element) it.next();
            RecipeTreeNode newNode = new RecipeTreeNode("(" + el.getAttribute("id_ricetta_HB").getValue() + ") - " + el.getAttribute("nome").getValue(), el.getAttribute("id_ricetta_HB").getValue());
                ...
                public void actionPerformed(ActionEvent e) {
                    if (SubStyleTreeNode.this.nodes.isEmpty()) {
                        ...
                        while (it.hasNext()) {
                            ...
                            RecipeTreeNode newNode = new RecipeTreeNode("(" + el.getAttribute("id_ricetta_HB").getValue() + ") - " + el.getAttribute("nome").getValue() + concorso, el.getAttribute("id_ricetta_HB").getValue());
