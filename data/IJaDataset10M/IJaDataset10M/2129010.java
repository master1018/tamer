package filebot.ui.panel.rename;
...
import filebot.ui.FileFormat;
import filebot.ui.MessageManager;
import filebot.ui.panel.rename.entry.FileEntry;
import filebot.ui.panel.rename.entry.ListEntry;
...
public class RenameAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (errors > 0) MessageManager.showWarning((i - errors) + " of " + i + " files renamed."); else MessageManager.showInfo(i + " files renamed.");
        namesList.repaint();
        filesList.repaint();
    }
}
