...
@Scope("prototype")
public class EditVerbNetSelectionRestrictionCommandImpl extends AbstractDictionaryCommand implements EditVerbNetSelectionRestrictionCommand {
    ...
    public void execute() {
        try {
            ...
            VerbNetSelectionRestrictionType type = getDictionaryRepository().get(getVerbNetSelectionRestrictionType());
