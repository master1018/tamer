...
public class AuthorizationUserGroup implements AuthorizationPackageContainer {
    ...
    static final int RIGHT_PAGE_ASSIGN_KEYWORDS_BIT_INDEX = 6;

    static final int RIGHT_PAGE_EDIT_HEADLINE_BIT_INDEX = 0;

    static final int RIGHT_PAGE_LINKING_APPEARANCE_SCHEDULE_BIT_INDEX = 5;

    static final int RIGHT_PAGE_PUBLISH_PAGE_BIT_INDEX = 13;

    static final int RIGHT_LINKS_CONNECT_EXISTING_PAGE_BIT_INDEX = 2;
	 ...
	 * constructor comment.
	 */
    public AuthorizationUserGroup(AuthorizationPackage authorizationPackage, String userGroupGuid, String userGroupName, String right1, String right2, String right3, String right4, String right5, String right6, String right7, String right8, String deny1, String deny2, String deny3, String deny4, String deny5, String deny6, String deny7, String deny8) {
    ...
    private void save(String attributes) throws RQLException {
        String rqlRequest = "<IODATA loginguid='" + getLogonGuid() + "' sessionkey='" + getSessionKey() + "'>" + "<AUTHORIZATION>" + "<AUTHORIZATIONPACKET action='save' guid='" + getAuthorizationPackageGuid() + "'>" + "<GROUPS><GROUP guid='" + getUserGroupGuid() + "' " + attributes + "/>" + "</GROUPS></AUTHORIZATIONPACKET></AUTHORIZATION></IODATA>";
