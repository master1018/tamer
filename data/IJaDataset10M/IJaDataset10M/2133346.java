...
public class CallRetrofitter {
    ...
    private static class Retrofitter extends DefaultContext implements ErrorListener {
        ...
        private void applyChanges(File sourceFile, List errorEvents) throws IOException {
            ...
            while (it.hasNext()) {
                ...
                if (index > 0) {
                    ...
                    boolean templateExists = mCompiler.getCompilationUnit(templateName, sourceUnit) != null;
                    if (templateExists) {
                        mChangeCount++;
            ...
            reader.close();
            String newContents = replace(sourceContents.toString(), replacements);
