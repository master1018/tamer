 ...
 */
public class AudioPlayMessage extends LongMessage implements ChannelMessage, MidiConvertible, AudioDataSequencer {
    ...
    public String toString() {
        return "AudioPlay:" + " voice=" + voice + " index=" + index + " velocity=" + velocity;
    }
