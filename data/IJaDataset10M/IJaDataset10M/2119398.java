...
class LRU<E extends Chainable<E>> {
    ...
    public abstract static class AbstractChainable<E> implements LRU.Chainable<E> {
        ...
        public Chainable<E> getNewer() {
            return this.newer;
        }

        public Chainable<E> getOlder() {
            return this.older;
        }

        public void setNewer(Chainable<E> newer) {
            this.newer = newer;
        }

        public void setOlder(Chainable<E> older) {
            this.older = older;
        }
    }

    abstract static interface Chainable<E> {
