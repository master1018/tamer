...
public class DirectMessage implements Serializable {
   ...
   */
    ...
    protected static final DirectMessage[] newArrayFromJsonString(String jsonString) throws TwitterException {
        return newArrayFromJsonArray(JSONArray.fromObject(jsonString));
    }

    protected static final DirectMessage[] newArrayFromJsonArray(JSONArray jsonArray) throws TwitterException {
    ...
    protected static final DirectMessage newFromJsonString(String jsonString) throws TwitterException {
        return newFromJsonObject(JSONObject.fromObject(jsonString));
    }

    protected static final DirectMessage newFromJsonObject(JSONObject jsonObject) throws TwitterException {
        if (jsonObject == null) {
            return null;
        }
        ...
        if (jsonObject.has("sender")) {
            directMessage.setSender(User.newFromJsonObject(jsonObject.getJSONObject("sender")));
        }
        ...
        if (jsonObject.has("recipient")) {
            directMessage.setRecipient(User.newFromJsonObject(jsonObject.getJSONObject("recipient")));
        }
