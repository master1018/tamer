 ...
 * @version $Id: IssueNote.java 22 2010-04-03 17:16:12Z syllant $
 */
public class IssueNote extends AbstractRevuEntity<IssueNote> implements Comparable<IssueNote>, IRevuHistoryHolderEntity<IssueNote> {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("history", history).append("content", content).toString();
    }
}
