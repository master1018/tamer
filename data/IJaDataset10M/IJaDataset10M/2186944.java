...
public final class Main {
    ...
    private static final Logger logger = Logger.getLogger("org.metastatic.vwdiff");
    ...
    public static void main(String[] argv) throws Throwable {
        ...
        LongOpt[] longopts = { new LongOpt("config", LongOpt.REQUIRED_ARGUMENT, null, 'c'), new LongOpt("help", LongOpt.NO_ARGUMENT, null, 'h'), new LongOpt("version", LongOpt.NO_ARGUMENT, null, 'v') };
        ...
        try {
            ...
            System.err.println("Could not load config file " + conffile + ": " + ioe.getMessage());
            System.exit(1);
        }
        virgin = false;
        try {
            ...
            if (conf.debug) {
                ...
                logger.addAppender(new WriterAppender(layout, new FileWriter(conf.logfile)));
            }
        ...
        while (true) {
            try {
                ...
                try {
                    ...
                    if (elapsed < 300000) Thread.sleep(300000 - elapsed);
    ...
    static void loadConfig(Config conf) throws IOException {
        ...
        while (true) {
            try {
                ...
                if (virgin) {
                    System.err.println("WARNING: bad configuration file: " + pe.getMessage());
                }
            } catch (IllegalArgumentException iae) {
                if (virgin) {
                    System.err.println("WARNING: bad configuration file: " + iae.getMessage());
                }
            }
        }
        conf.current = null;
    ...
    private static void version() {
        System.out.println("vwdiff version " + version.VERSION + " (Jarsync " + org.metastatic.rsync.version.VERSION + ")");
        System.out.println();
