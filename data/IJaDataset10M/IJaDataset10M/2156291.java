...
public class ExecutionRandomSequence extends ExecutionComposite {
    ...
    public ExecutionRandomSequence(ModelTask modelTask, BTExecutor executor, ExecutionTask parent) {
        ...
        if (!(modelTask instanceof ModelRandomSequence)) {
            throw new IllegalArgumentException("The ModelTask must subclass " + ModelRandomSequence.class.getCanonicalName() + " but it inherits from " + modelTask.getClass().getCanonicalName());
        }
    }
    ...
    protected void internalSpawn() {
        ...
        this.activeChild = this.children.get(this.order.get(this.activeChildIndex)).createExecutor(this.getExecutor(), this);
