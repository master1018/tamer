...
public interface WebHookPayload {
     ...
     */
    String buildChangedStatus(SRunningBuild sRunningBuild, Status oldStatus, Status newStatus, SortedMap<String, String> extraParameters);
     ...
     */
    String responsibleChanged(@NotNull SBuildType sBuildType, @NotNull ResponsibilityInfo responsibilityInfoOld, @NotNull ResponsibilityInfo responsibilityInfoNew, boolean isUserAction, SortedMap<String, String> extraParameters);
