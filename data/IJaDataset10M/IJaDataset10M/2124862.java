...
public class ContactCTypeRelDao extends BaseDao<ContactCTypeRel> {
    ...
    @Inject
    public ContactCTypeRelDao(Provider<EntityManager> em, ManipulationObjectFactory objectFactory, AssistedObjectHandlerFactory handlerFactory, DescriptorStore descStore) {
