...
public class NoBidDesc extends FIXMLField {

    public static final String TAG = "398";
    ...
    public void initValue(Object s) throws ModelException {
        if (_Value != null) throw new ModelException("Value has already been initialized for field NoBidDesc.");
        setValue((String) s);
    }
    ...
    public String toFIXML(String ident) {
        ...
        StringBuffer sb = new StringBuffer(ident + "<NoBidDesc FIXTag=\"398\" DataType=\"int\"");
        sb.append(">" + _Value + "</NoBidDesc>");
        return sb.toString();
    }
}
