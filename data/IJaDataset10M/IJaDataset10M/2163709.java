...
public class GraphStats {
    ...
    public NodeStats getNodeStats(NodeMetric metric) {
        if (!nodeStats.containsKey(metric)) nodeStats.put(metric, new NodeStats(graph, metric));
    ...
    public Object getGlobalStats(GlobalMetric metric) {
        if (!globalStats.containsKey(metric)) globalStats.put(metric, metric.value(graph));
    ...
    public static class NodeStats {
        ...
        public NodeStats(List values) {
            ...
            for (Object v : values) if (v instanceof Number) stats.addValue(((Number) v).doubleValue());
        }
