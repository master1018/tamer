...
class MissionDataBean {
    ...
    void createMission() {
        ...
        if (TRAVEL_MISSION.equals(type)) {
            ...
            mission = new Trade(members, startingSettlement, destinationSettlement, rover, description, sellGoods, buyGoods);
            ...
            mission = new BuildingConstructionMission(members, constructionSettlement, constructionSite, constructionStageInfo, constructionSiteXLoc, constructionSiteYLoc, constructionSiteFacing, constructionVehicles);
        } else if (AREOLOGY_FIELD_MISSION.equals(type)) {
            mission = new AreologyStudyFieldMission(members, startingSettlement, leadResearcher, study, rover, fieldSite, description);
        } else if (BIOLOGY_FIELD_MISSION.equals(type)) {
            mission = new BiologyStudyFieldMission(members, startingSettlement, leadResearcher, study, rover, fieldSite, description);
        } else if (SALVAGE_MISSION.equals(type)) {
            mission = new BuildingSalvageMission(members, salvageSettlement, salvageBuilding, salvageSite, salvageVehicles);
    ...
    static String[] getMissionTypes() {
        String[] result = { TRAVEL_MISSION, EXPLORATION_MISSION, ICE_MISSION, REGOLITH_MISSION, AREOLOGY_FIELD_MISSION, BIOLOGY_FIELD_MISSION, RESCUE_MISSION, TRADE_MISSION, MINING_MISSION, CONSTRUCTION_MISSION, SALVAGE_MISSION };
        return result;
    }
    ...
    static String getMissionDescription(String missionType) {
        String result = "";
        if (missionType.equals(TRAVEL_MISSION)) result = TravelToSettlement.DEFAULT_DESCRIPTION; else if (missionType.equals(EXPLORATION_MISSION)) result = Exploration.DEFAULT_DESCRIPTION; else if (missionType.equals(ICE_MISSION)) result = CollectIce.DEFAULT_DESCRIPTION; else if (missionType.equals(REGOLITH_MISSION)) result = CollectRegolith.DEFAULT_DESCRIPTION; else if (missionType.equals(RESCUE_MISSION)) result = RescueSalvageVehicle.DEFAULT_DESCRIPTION; else if (missionType.equals(TRADE_MISSION)) result = Trade.DEFAULT_DESCRIPTION; else if (missionType.equals(MINING_MISSION)) result = Mining.DEFAULT_DESCRIPTION; else if (missionType.equals(CONSTRUCTION_MISSION)) result = BuildingConstructionMission.DEFAULT_DESCRIPTION; else if (missionType.equals(AREOLOGY_FIELD_MISSION)) result = AreologyStudyFieldMission.DEFAULT_DESCRIPTION; else if (missionType.equals(BIOLOGY_FIELD_MISSION)) result = BiologyStudyFieldMission.DEFAULT_DESCRIPTION; else if (missionType.equals(SALVAGE_MISSION)) result = BuildingSalvageMission.DEFAULT_DESCRIPTION;
        return result;
    }
