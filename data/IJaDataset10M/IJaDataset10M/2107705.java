...
public class AssociationModel extends AbstractUMLConnectionModel implements StereoTypeModel {
    ...
    public IPropertyDescriptor[] getPropertyDescriptors() {
        return new IPropertyDescriptor[] { new TextPropertyDescriptor(StereoTypeModel.P_STEREO_TYPE, UMLPlugin.getDefault().getResourceString("property.stereoType")), new TextPropertyDescriptor(P_FROM_MULTIPLICITY, UMLPlugin.getDefault().getResourceString("property.multiplicityA")), new TextPropertyDescriptor(P_TO_MULTIPLICITY, UMLPlugin.getDefault().getResourceString("property.multiplicityB")), new ColorPropertyDescriptor(P_FOREGROUND_COLOR, UMLPlugin.getDefault().getResourceString("property.foreground")) };
    }
