package net.sourceforge.dashbov.persistencia.webservice.bacen;
...
public class WSValorSerieVO implements java.io.Serializable {
    ...
    public WSValorSerieVO(int ano, int anoFim, boolean bloqueado, boolean bloqueioLiberado, int dia, int diaFim, int mes, int mesFim, long oid, long oidSerie, java.lang.String svalor, java.math.BigDecimal valor) {
        this.ano = ano;
        this.anoFim = anoFim;
