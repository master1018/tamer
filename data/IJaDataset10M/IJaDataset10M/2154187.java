...
public class AddMeasurementGroupDialog extends JDialog {
    ...
    private void fillComponents() {
        ...
        for (ExperimentChannel channel : devicePool.getExperimentChannels()) listModel.addElement(channel);
    ...
    protected void createPressed(ActionEvent e) {
        ...
        try {
            ...
            devicePool.getDevice().executeCommand(DevicePoolUtils.POOL_CMD_CREATE_MEASUREMENT_GROUP, args);
            JOptionPane.showMessageDialog(this, "Measurement group " + name + " sucessfully created", "Sucess!", JOptionPane.INFORMATION_MESSAGE);
        } catch (DevFailed devFailed) {
            StringBuffer channels = new StringBuffer();
            for (int i = 0; i < strParams.length; i++) channels.append(strParams[i] + ", ");
            ...
            JOptionPane.showMessageDialog(this, buff.toString(), "Error trying to create a new measurement group", JOptionPane.ERROR_MESSAGE);
        }
    }
}
