...
import org.apache.java.lang.UnsupportedOperationException;
...
public abstract class AbstractCollection implements Collection {
    ...
    public Object[] toArray(Object[] contents) {
        ...
        if (size > contents.length) {
            throw new UnsupportedOperationException("given array (size " + contents.length + ") too small for Collection size of " + size);
        }
        Iterator it = iterator();
