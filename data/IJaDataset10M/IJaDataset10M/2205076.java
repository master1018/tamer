...
public class PDFViewerBean extends JPanel {
    ...
    private final float[] zoomFactors = new float[] { 0.25f, 0.33f, 0.50f, 0.75f, 1.00f, 1.50f, 2.00f, 4.00f, 8.00f };
    ...
    public void rotateCClock() {
        rotationSelect.setSelectedIndex((rotationSelect.getSelectedIndex() + 3) % 4);
    }

    public void rotateClock() {
        rotationSelect.setSelectedIndex((rotationSelect.getSelectedIndex() + 1) % 4);
    }
