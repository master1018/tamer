...
public class QCandidate extends QCandidateBase implements ParentCandidate {
    ...
    private void readArrayCandidates(TypeHandler4 typeHandler, final ReadBuffer buffer, final TypeHandler4 arrayElementHandler, final QCandidates candidates) {
        ...
        if (classMetadata != null) {
            if (_member != null && _member.getClass().isArray()) {
                ...
                if (reflector.array().isNDimensional(memberClass())) {
                    MultidimensionalArrayHandler mah = new MultidimensionalArrayHandler(arrayElementTypehandler, false);
