...
public class PreferencePageEncryption extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    protected Control createContents(Composite parent) {
        ...
        int indent = 0;
        bDocument = addRadioButton(gResource, Messages.document, PreferenceConstants.ENCRYPT_RESOURCE, "document", indent);
        bDocument.addSelectionListener(selectionListener);
        bSelection = addRadioButton(gResource, Messages.selection, PreferenceConstants.ENCRYPT_RESOURCE, "selection", indent);
        bSelection.addSelectionListener(selectionListener);
        bXpath = addRadioButton(gResource, Messages.xpath, PreferenceConstants.ENCRYPT_RESOURCE, "xpath", indent);
        ...
        gd.horizontalSpan = PreferenceConstants.SMALL_GROUP;
        encryptionType = new RadioGroupFieldEditor(PreferenceConstants.ENCRYPT_TYPE, Messages.type, PreferenceConstants.SMALL_GROUP, IPreferenceValues.ENCRYPTION_TYPES, top, true);
        ...
        cEncryptionAlgorithm = addComboControl(gAlgorithms, lEncryptionAlgorithm, PreferenceConstants.ENCRYPT_ENCRYPTION, indent, IAlgorithms.ENCRYPTION_ALGORITHMS);
        ...
        cKeyWrapAlgorithm = addComboControl(gAlgorithms, lKeyWrapAlgorithm, PreferenceConstants.ENCRYPT_KEY_WRAP, indent, IAlgorithms.KEY_WRAP_ALGORITHMS);
        ...
        indent = 0;
        keystore = new FileFieldEditor(PreferenceConstants.ENCRYPT_KEY_STORE, Messages.keystore, gKeystore);
