...
public final class SimpleBookmark implements SimpleXMLDocHandler {
    ...
    public void endElement(String tag) {
        if (tag.equals("Bookmark")) {
            if (attr.isEmpty()) return; else throw new RuntimeException("Bookmark end tag out of place.");
        }
        if (!tag.equals("Title")) throw new RuntimeException("Invalid end tag - " + tag);
    ...
    public void startElement(String tag, HashMap h) {
        if (topList == null) {
            if (tag.equals("Bookmark")) {
                ...
                return;
            } else throw new RuntimeException("Root element is not Bookmark: " + tag);
        }
        if (!tag.equals("Title")) throw new RuntimeException("Tag " + tag + " not allowed.");
