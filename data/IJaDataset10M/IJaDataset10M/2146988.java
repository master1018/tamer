...
public class TLVTableImplTest {
    ...
    public void testTLVTableFailAddParams() {
        ...
        try {
            String longString = new String("111111111111111111111111111111111111111111111111111111111111111111111111111" + "222222222222222222222222222222222222222222222222222222222222222222222222222" + "333333333333333333333333333333333333333333333333333333333333333333333333333" + "444444444444444444444444444444444444444444444444444444444444444444444444444" + "555555555555555555555555555555555555555555555555555555555555555555555555555" + "666666666666666666666666666666666666666666666666666666666666666666666666666");
    ...
    public void testTLVTableDeSerializeUnknown() throws Exception {
        ...
        encoder.writeBytes(new byte[] { (byte) 0xca, (byte) 0xfe, (byte) 0x00, (byte) 0x02, (byte) 0xfe, (byte) 0xed });
        encoder.writeBytes(new byte[] { (byte) 0xbe, (byte) 0xef, (byte) 0x00, (byte) 0x05, (byte) 0xba, (byte) 0xbe, (byte) 0xde, (byte) 0xad, (byte) 0x99 });
        ...
        try {
            ...
            expectedValue = new byte[] { (byte) 0xba, (byte) 0xbe, (byte) 0xde, (byte) 0xad, (byte) 0x99 };
            assertEquals(b, expectedValue);
        } catch (Exception x) {
    ...
    private void doTableAssertions(TLVTableImpl origTable, TLVTableImpl newTable) {
        assertEquals(((Number) origTable.get(Tag.DEST_ADDR_SUBUNIT)).longValue(), ((Number) newTable.get(Tag.DEST_ADDR_SUBUNIT)).longValue());
        assertEquals(((Number) origTable.get(Tag.DEST_TELEMATICS_ID)).longValue(), ((Number) newTable.get(Tag.DEST_TELEMATICS_ID)).longValue());
        assertEquals(((Number) origTable.get(Tag.QOS_TIME_TO_LIVE)).longValue(), ((Number) newTable.get(Tag.QOS_TIME_TO_LIVE)).longValue());
        assertEquals(origTable.get(Tag.ADDITIONAL_STATUS_INFO_TEXT), newTable.get(Tag.ADDITIONAL_STATUS_INFO_TEXT));
        assertEquals((byte[]) newTable.get(Tag.CALLBACK_NUM_ATAG), (byte[]) origTable.get(Tag.CALLBACK_NUM_ATAG));
        assertEquals((BitSet) origTable.get(Tag.MS_MSG_WAIT_FACILITIES), (BitSet) newTable.get(Tag.MS_MSG_WAIT_FACILITIES));
    }
}
