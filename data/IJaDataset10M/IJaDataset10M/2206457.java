package com.gm.codegen.provider.java.model;
...
import com.gm.codegen.util.IOHelper;
import com.gm.codegen.util.StringHelper;
import com.gm.codegen.util.paranamer.AdaptiveParanamer;
import com.gm.codegen.util.paranamer.BytecodeReadingParanamer;
import com.gm.codegen.util.paranamer.CachingParanamer;
import com.gm.codegen.util.paranamer.DefaultParanamer;
import com.gm.codegen.util.paranamer.JavaSourceParanamer;
import com.gm.codegen.util.paranamer.Paranamer;
...
public class MethodParameter {
    ...
    public String getName() {
        ...
        if (parameterNames == null || parameterNames.length == 0) {
            if (StringHelper.isNotBlank(paramName)) return paramName;
