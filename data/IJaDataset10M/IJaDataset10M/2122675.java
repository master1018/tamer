...
public class TransientTest {
    ...
    public void testTransient() throws Exception {
        assertCanAdaptInstance(WithTransientFieldInterface.class, WithTransientField.class, WithoutTransientField.class);
    }

    @Test
    public void testTransientMethod() throws Exception {
        assertCanAdaptInstance(WithTransientFieldInterface.class, WithTransientField.class, WithMethodField.class);
    }
}
