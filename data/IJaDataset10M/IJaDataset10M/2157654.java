...
public class TinyMCEExample extends JPanel {
    ...
    public TinyMCEExample() {
        ...
        String configurationScript = "theme_advanced_buttons1: 'bold,italic,underline,strikethrough,sub,sup,|,charmap,|,justifyleft,justifycenter,justifyright,justifyfull,|,hr,removeformat'," + "theme_advanced_buttons2: 'undo,redo,|,cut,copy,paste,pastetext,pasteword,|,search,replace,|,forecolor,backcolor,bullist,numlist,|,outdent,indent,blockquote,|,table'," + "theme_advanced_buttons3: ''," + "theme_advanced_toolbar_location: 'top'," + "theme_advanced_toolbar_align: 'left'," + "plugins: 'table,paste'";
        final JHTMLEditor htmlEditor = new JHTMLEditor(JHTMLEditor.setEditorImplementation(JHTMLEditor.HTMLEditorImplementation.TinyMCE), JHTMLEditor.setCustomJavascriptConfiguration(configurationScript));
