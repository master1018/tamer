...
public class IntegrationTest extends TestCase {
    ...
    protected static String getAddress() {
        return "http://127.0.0.1:" + port + "/axis2/services/Echo";
    }
    ...
    protected void setUp() throws Exception {
        final AxisService service = Utils.createSimpleService(SERVICE_NAME, EchoService.class.getName(), OPERATION_NAME);
    ...
    public void testSendReceiveNonRefAttachment() throws Exception {
        ...
        while (attachIter.hasNext()) {
            ...
            if (content instanceof String) {
                ...
                byte[] b = new byte[15000];
                final int lengthRead = bais.read(b);
                FileOutputStream fos = new FileOutputStream(new File(System.getProperty("basedir", ".") + "/" + "target/target/test-resources/axis2.jpg"));
                fos.write(b, 0, lengthRead);
                fos.flush();
                fos.close();
                assertTrue(attachment.getContentType().equals("image/jpeg") || attachment.getContentType().equals("text/plain"));
    ...
    private void createSOAPPart(SOAPMessage message) throws SOAPException {
        ...
        final SOAPHeaderElement headerEle3 = soapHeader.addHeaderElement(env.createName("TestHeader3", "swa", "http://fakeNamespace.org"));
    ...
    private void createSimpleSOAPPart(SOAPMessage message) throws SOAPException {
        ...
        header.addHeaderElement(env.createName("Header1", "pref", "http://test.apach.org/test")).addTextNode("This is header1");
    ...
    public void testSendReceive_ISO88591_EncodedSOAPMessage() {
        try {
            ...
            FileInputStream fileInputStream = new FileInputStream(System.getProperty("basedir", ".") + "/test-resources" + File.separator + "soap-part-iso-8859-1.xml");
