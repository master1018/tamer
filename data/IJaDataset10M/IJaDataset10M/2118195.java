...
public class MsgUtils {
    ...
    public static MqRfh2 getRfh2Header(MQMessage message) throws EOFException, IOException {
        ...
        int c = readRfhCommon(message, ret);
        ret.nameValuesCharSetId = message.readInt4();
        c += 4;
        Map maps = new HashMap();
        do {
            ret.nameValuesLength = message.readInt4();
            c += 4;
            String strNameValues = message.readString((int) ret.nameValuesLength);
            c += ret.nameValuesLength;
    ...
    private static int readRfhCommon(MQMessage message, MqRfh ret) throws EOFException, IOException {
        int c = 0;
        ret.strucId = message.readString(4);
        c += 4;
        ret.version = message.readInt4();
        c += 4;
        ret.length = message.readInt4();
        c += 4;
        ret.encoding = message.readInt4();
        c += 4;
        ret.codedCharSetId = message.readInt4();
        c += 4;
        ret.format = message.readString(8);
        c += 8;
        ret.flags = message.readInt4();
        c += 4;
        return c;
    }
    ...
    private static Map getNameValues(String prefix, String s) {
        ...
        for (StringTokenizer t = new StringTokenizer(s, " "); t.hasMoreTokens(); ) {
            ...
            String value = null;
            if (t.hasMoreTokens()) value = t.nextToken();
