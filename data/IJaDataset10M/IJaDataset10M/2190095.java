 ...
 * @generated
 */
public class OdmStructuralFeatureParser extends OdmAbstractParser {
	 ...
	 * @generated
	 */
    public OdmStructuralFeatureParser(EStructuralFeature feature) {
    ...
    protected IParserEditStatus validateValues(Object[] values) {
        ...
        if (value instanceof InvalidValue) {
            return new ParserEditStatus(OdmDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE, value.toString());
        }
