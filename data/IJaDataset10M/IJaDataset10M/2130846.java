   ...
   */
    ...
    public void paint(Graphics g, int localX, int localY, int width, int height) {
        if (useAlternateBlending) {
            ...
            g.setColor(new Color(modulationColor.getRed() * modulationColor.getAlpha(), modulationColor.getGreen() * modulationColor.getAlpha(), modulationColor.getBlue() * modulationColor.getAlpha(), modulationColor.getAlpha()));
        } else {
            g.setColor(modulationColor);
        }
        g.drawScaledImage(tex[LEFT], localX, localY + getBottom(), getLeft(), height - getBottom() - getTop());
        g.drawScaledImage(tex[BOTTOM], localX + tex[BOTTOM_LEFT].getWidth(), localY, width - getLeft() - getRight(), getBottom());
        g.drawScaledImage(tex[TOP], localX + getLeft(), localY + height - getTop(), width - getLeft() - getRight(), getTop());
        g.drawScaledImage(tex[RIGHT], localX + width - getRight(), localY + getBottom(), getRight(), height - getBottom() - getTop());
