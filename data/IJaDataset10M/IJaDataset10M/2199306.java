...
public class InnerClass {
    ...
    public static enum InnerClassFlag {
        ...
        @Flag(0x0001)
        InnerClassIsPublic, @Flag(0x0002)
        InnerClassIsPrivate, @Flag(0x0004)
        InnerClassIsProtected, @Flag(0x0008)
        InnerClassIsStatic, @Flag(0x0010)
        InnerClassIsFinal, @Flag(0x0200)
        InnerClassIsInterface, @Flag(0x0400)
        InnerClassIsAbstract, @Flag(0x2000)
        InnerClassIsAnnotation, @Flag(0x4000)
        InnerClassIsEnum, @Flag(0x1000)
        InnerClassIsSynthetic;

        /**
         * Parser for the flags
         */
        public static final FlagParser<InnerClassFlag> parser = new FlagParser<InnerClassFlag>(InnerClassFlag.class);
    }
     ...
     */
    public InnerClass(String simpleName, ObjectType outerClass, ObjectType innerClass, Collection<InnerClassFlag> flags) {
