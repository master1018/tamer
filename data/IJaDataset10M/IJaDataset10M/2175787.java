 ...
 */
    ...
    public abstract Iterable<Document> iterable() throws IOException;
 ...
 * @throws IOException
 */
    public abstract void reformatCorpus(File originalDir) throws IOException;
 ...
 */
    public static void mkdir(File dir) throws IOException {
        ...
        if (!success) throw new IOException("could not make dir: " + dir.getAbsolutePath());
    }
 ...
 * @throws IOException
 */
    public void cleanTrain() throws IOException {
 ...
 * @throws IOException
 */
    public static int recursivelyDelete(File fileToDelete) throws IOException {
