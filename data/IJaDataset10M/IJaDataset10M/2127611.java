...
public class TipoExpedicao implements java.io.Serializable {
    ...
    public static final Constant TIPO_EXPEDICAO_PESAGEM = new Constant("Expedi��o com pesagem", "EP");

    public static final Constant TIPO_EXPEDICAO_SEM_PESAGEM = new Constant("Expedi��o sem pesagem", "SP");
