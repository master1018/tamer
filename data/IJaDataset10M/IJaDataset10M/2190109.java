...
public class ContinueStatementInfo extends JumpStatementInfo {
    ...
    public ContinueStatementInfo(LocalSpaceInfo ownerSpace, LabelInfo destinationLabel, int fromLine, int fromColumn, int toLine, int toColumn) {
    ...
    public ExecutableElementInfo copy() {
        ...
        final ContinueStatementInfo newStatement = new ContinueStatementInfo(outerUnit, label, fromLine, fromColumn, toLine, toColumn);
        return newStatement;
    }
}
