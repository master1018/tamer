...
public class EGMFormatReaderTest extends TestCase {
    ...
    public void testRead() throws OrekitException, IOException {
        InputStream in = EGMFormatReaderTest.class.getResourceAsStream("/potential/egm-format/egm96_to5.ascii.gz");
    ...
    public void testException() throws FileNotFoundException, IOException {
        ...
        int c = 0;
        try {
            InputStream in = EGMFormatReaderTest.class.getResourceAsStream("/potential/egm-format-corrupted/fakegm1");
            factory.getPotentialReader(in);
        } catch (OrekitException e) {
            c++;
        }
        try {
            InputStream in = EGMFormatReaderTest.class.getResourceAsStream("/potential/egm-format-corrupted/fakegm2");
            factory.getPotentialReader(in);
        } catch (OrekitException e) {
            c++;
        }
