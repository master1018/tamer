...
public class MCalculator_RK2 extends MCalculator_Diff {
    ...
    public MCalculator_RK2(MEquation initialDisplacementEqn, MEquation initialVelocityEqn, MEquation accelEquation) {
    ...
    void calculatePointAfterZero(MDataHistory vars, int atTick) throws UnknownVariableException, InvalidEquationException, UnknownTickException {
        int nTick = atTick;
