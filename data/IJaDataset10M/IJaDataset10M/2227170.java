...
public class clip_planeType2 extends com.jmex.xml.xml.Node {

    public clip_planeType2(clip_planeType2 node) {
        super(node);
    }

    public clip_planeType2(org.w3c.dom.Node node) {
        super(node);
    }

    public clip_planeType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public clip_planeType2(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "clip_plane");
    }
    ...
    public bool4 newvalue2() {
        return new bool4();
    }

    public bool4 getvalue2At(int index) throws Exception {
        return new bool4(getDomNodeValue(getDomChildAt(Attribute, null, "value", index)));
    }
    ...
    public bool4 getvalue2ValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new com.jmex.xml.xml.XmlException("Out of range"); else return new bool4(getDomNodeValue(curNode));
    }

    public bool4 getvalue2() throws Exception {
    ...
    public org.w3c.dom.Node addvalue2(bool4 value) {
    ...
    public org.w3c.dom.Node addvalue2(String value) throws Exception {
        return addvalue2(new bool4(value));
    }

    public void insertvalue2At(bool4 value, int index) {
    ...
    public void insertvalue2At(String value, int index) throws Exception {
        insertvalue2At(new bool4(value), index);
    }

    public void replacevalue2At(bool4 value, int index) {
    ...
    public void replacevalue2At(String value, int index) throws Exception {
        replacevalue2At(new bool4(value), index);
    }
    ...
    public GLES_MAX_CLIP_PLANES_index newindex() {
        return new GLES_MAX_CLIP_PLANES_index();
    }

    public GLES_MAX_CLIP_PLANES_index getindexAt(int index) throws Exception {
        return new GLES_MAX_CLIP_PLANES_index(getDomNodeValue(getDomChildAt(Attribute, null, "index", index)));
    }
    ...
    public GLES_MAX_CLIP_PLANES_index getindexValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new com.jmex.xml.xml.XmlException("Out of range"); else return new GLES_MAX_CLIP_PLANES_index(getDomNodeValue(curNode));
    }

    public GLES_MAX_CLIP_PLANES_index getindex() throws Exception {
        return getindexAt(0);
    }
    ...
    public org.w3c.dom.Node addindex(GLES_MAX_CLIP_PLANES_index value) {
        if (value.isNull()) return null;
        return appendDomChild(Attribute, null, "index", value.toString());
    }

    public org.w3c.dom.Node addindex(String value) throws Exception {
        return addindex(new GLES_MAX_CLIP_PLANES_index(value));
    }

    public void insertindexAt(GLES_MAX_CLIP_PLANES_index value, int index) {
    ...
    public void insertindexAt(String value, int index) throws Exception {
        insertindexAt(new GLES_MAX_CLIP_PLANES_index(value), index);
    }

    public void replaceindexAt(GLES_MAX_CLIP_PLANES_index value, int index) {
    ...
    public void replaceindexAt(String value, int index) throws Exception {
        replaceindexAt(new GLES_MAX_CLIP_PLANES_index(value), index);
    }
}
