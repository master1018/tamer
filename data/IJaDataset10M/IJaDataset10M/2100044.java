...
public class HostPropertiesMonitor {
    ...
    public String getMacAddressesCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getMacAddresses();
    ...
    public String getCpuUSRCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getCpuUSR();
        return getCpuUSR();
    }
    ...
    public String getCpuSYSCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getCpuSYS();
        return getCpuSYS();
    }
    ...
    public String getCpuNICECall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getCpuNICE();
        return getCpuNICE();
    }
    ...
    public String getCpuIDLECall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getCpuIDLE();
        return getCpuIDLE();
    }
    ...
    public String getPagesInCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getPagesIn();
        return getPagesIn();
    }
    ...
    public String getPagesOutCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getPagesOut();
        return getPagesOut();
    }
    ...
    public String getMemUsageCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getMemUsage();
        return getMemUsage();
    }
    ...
    public String getMemUsedCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getMemUsed();
        return getMemUsed();
    }
    ...
    public String getMemFreeCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getMemFree();
        return getMemFree();
    }
    ...
    public String getDiskIOCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getDiskIO();
        return getDiskIO();
    }
    ...
    public String getDiskTotalCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getDiskTotal();
        return getDiskTotal();
    }
    ...
    public String getDiskUsedCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getDiskUsed();
        return getDiskUsed();
    }
    ...
    public String getDiskFreeCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getDiskFree();
        return getDiskFree();
    }
    ...
    public String getNoProcessesCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getNoProcesses();
    ...
    public String getLoad1Call() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getLoad1();
        return getLoad1();
    }
    ...
    public String getLoad5Call() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getLoad5();
        return getLoad5();
    }
    ...
    public String getLoad15Call() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getLoad15();
        return getLoad15();
    }
    ...
    public String[] getNetInterfacesCall() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getNetInterfaces();
    ...
    public String getNetInCall(String ifName) {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getNetIn(ifName);
    ...
    public String getNetOutCall(String ifName) {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getNetOut(ifName);
    ...
    public Hashtable getPState() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getProcessesState();
    ...
    public Hashtable getSockets() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getNetSockets();
    ...
    public Hashtable getTCPDetails() {
        ...
        if (osName.indexOf("Mac") != -1) return macHostMonitor.getTcpDetails();
