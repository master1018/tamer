...
public abstract class VM_Type implements VM_ClassLoaderConstants, VM_SizeConstants {
   ...
   */
    ...
    public final boolean isJavaLangObjectType() throws VM_PragmaUninterruptible {
        return this == JavaLangObjectType;
    }

    public final boolean isJavaLangThrowableType() throws VM_PragmaUninterruptible {
        return this == JavaLangThrowableType;
    }

    public final boolean isJavaLangStringType() throws VM_PragmaUninterruptible {
        return this == JavaLangStringType;
    }

    public final boolean isWordType() throws VM_PragmaUninterruptible {
        return (this == WordType) || (this == AddressType) || (this == ExtentType) || (this == OffsetType);
    }

    final boolean isWordArrayType() throws VM_PragmaUninterruptible {
        return (this == WordArrayType) || (this == AddressArrayType) || (this == ExtentArrayType) || (this == OffsetArrayType);
    }

    public final boolean isMagicType() throws VM_PragmaUninterruptible {
        return isWordType() || isWordArrayType() || (this == MagicType);
    }

    public final boolean isUninterruptibleType() throws VM_PragmaUninterruptible {
        return this == UninterruptibleType;
    }

    public final boolean isSynchronizedObjectType() throws VM_PragmaUninterruptible {
        return this == SynchronizedObjectType;
    }

    public final boolean isDynamicBridgeType() throws VM_PragmaUninterruptible {
        return this == DynamicBridgeType;
    }

    public final boolean isSaveVolatileType() throws VM_PragmaUninterruptible {
        return this == SaveVolatileType;
    }

    public final boolean isNativeBridgeType() throws VM_PragmaUninterruptible {
   ...
   */
    ...
    static void init() throws ClassNotFoundException {
        ...
        UninterruptibleType = VM_TypeReference.findOrCreate(VM_SystemClassLoader.getVMClassLoader(), VM_Atom.findOrCreateAsciiAtom("Lcom/ibm/JikesRVM/VM_Uninterruptible;")).resolve();
        SynchronizedObjectType = VM_TypeReference.findOrCreate(VM_SystemClassLoader.getVMClassLoader(), VM_Atom.findOrCreateAsciiAtom("Lcom/ibm/JikesRVM/VM_SynchronizedObject;")).resolve();
        DynamicBridgeType = VM_TypeReference.findOrCreate(VM_SystemClassLoader.getVMClassLoader(), VM_Atom.findOrCreateAsciiAtom("Lcom/ibm/JikesRVM/VM_DynamicBridge;")).resolve();
        SaveVolatileType = VM_TypeReference.findOrCreate(VM_SystemClassLoader.getVMClassLoader(), VM_Atom.findOrCreateAsciiAtom("Lcom/ibm/JikesRVM/VM_SaveVolatile;")).resolve();
        NativeBridgeType = VM_TypeReference.findOrCreate(VM_SystemClassLoader.getVMClassLoader(), VM_Atom.findOrCreateAsciiAtom("Lcom/ibm/JikesRVM/VM_NativeBridge;")).resolve();
