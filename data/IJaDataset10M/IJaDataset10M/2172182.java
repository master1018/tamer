 ...
 *
 */
public interface ILevel0ListOfSetOperator<T> extends IUniqOperator<List<Set<T>>>, INavigableCollectionOperator<Set<T>>, IDistinguishableOperator, ISortableOperator<Set<T>>, ICastableToListOfSetOperator, IFlattenableAsListOperator<T>, IModifiableCollectionOperator<Set<T>>, IGenerizableOperator<List<Set<T>>>, IExecutableOperator<List<Set<T>>>, IConvertibleOperator<List<Set<T>>>, IEvaluableOperator<List<Set<T>>>, IConvertibleToArrayOfArrayOperator<T>, IConvertibleToArrayOfListOperator<T>, IConvertibleToArrayOfSetOperator<T>, IConvertibleToListOfArrayOperator<T>, IConvertibleToListOfListOperator<T>, IConvertibleToSetOfArrayOperator<T>, IConvertibleToSetOfListOperator<T>, IConvertibleToSetOfSetOperator<T>, IConvertibleToArrayOfMapOperator<T>, IConvertibleToListOfMapOperator<T>, IConvertibleToSetOfMapOperator<T> {
