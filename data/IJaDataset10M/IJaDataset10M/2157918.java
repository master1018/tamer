...
public class IncludeBlockTag extends BodyTagSupport implements ReplaceableTag, ParametrizableTag, ErrorManageableTag {
    ...
    public int doEndTag() throws JspException {
        if (parseAbsoluteUrl) {
            String baseUrl = DriverUtils.getBaseUrl(provider, HttpRequestImpl.wrap((HttpServletRequest) pageContext.getRequest()), HttpResponseImpl.wrap((HttpServletResponse) pageContext.getResponse()));
