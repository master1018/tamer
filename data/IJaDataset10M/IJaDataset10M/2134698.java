...
public class TestToken extends UtilTestCase {
    ...
    private static final String FOO_XML = "<!DOCTYPE titlepage " + "[<!ENTITY % active.links \"INCLUDE\">" + "  <!ENTITY   test \"This is test! Do NOT Panic!\" >" + "]>" + "<foo attrName='attrVal'>bar<!--comment\r\ntest-->" + "&test;&test;&lt;&#32;" + "&amp;&gt;&apos;&quot;&#x20;&#x3C;" + "<?pi ds\r\nda?><![CDATA[ vo<o ]]></foo>";
    ...
    public void testTokenEventEquivalency() throws Exception {
        ...
        xpp.next();
        checkParserStateNs(xpp, 1, XmlPullParser.TEXT, null, 0, null, null, "barThis is test! Do NOT Panic!This is test! Do NOT Panic!< &>'\" < vo<o ", false, -1);
        xpp.next();
    ...
    public void testTokenTypes(boolean checkPrologAndEpilog, boolean useRoundtrip) throws Exception {
        XmlPullParser xpp = factory.newPullParser();
        assertEquals(true, xpp.getFeature(XmlPullParser.FEATURE_PROCESS_NAMESPACES));
        ...
        if (!useRoundtrip && roundtripSupported != false) {
            throw new RuntimeException("disabling feature " + FEATURE_XML_ROUNDTRIP + " must be supported");
        }
        checkParserStateNs(xpp, 0, XmlPullParser.START_DOCUMENT, null, 0, null, null, null, false, -1);
        try {
            xpp.isWhitespace();
        ...
        String expectedDocdecl = " titlepage " + "[<!ENTITY % active.links \"INCLUDE\">" + "  <!ENTITY   test \"This is test! Do NOT Panic!\" >]";
        ...
        xpp.nextToken();
        if (!processDocdecl) {
            checkParserStateNs(xpp, 1, XmlPullParser.ENTITY_REF, null, 0, null, "test", null, false, -1);
        } else {
            checkParserStateNs(xpp, 1, XmlPullParser.ENTITY_REF, null, 0, null, "test", "This is test! Do NOT Panic!", false, -1);
        }
        if (!processDocdecl) {
            xpp.defineEntityReplacementText("test", "This is test! Do NOT Panic!");
        }
