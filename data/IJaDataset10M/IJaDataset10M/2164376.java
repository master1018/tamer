...
public class SAXFrequencyEntry implements Comparable<SAXFrequencyEntry> {
   ...
   */
    public ArrayList<Integer> getEntries() {
        @SuppressWarnings("unchecked") ArrayList<Integer> res = (ArrayList<Integer>) this.entries.clone();
   ...
   */
    ...
    public boolean equals(Object o) {
        if (o instanceof SAXFrequencyEntry) {
            ...
            if (other.getSubstring().equalsIgnoreCase(this.substring) && (other.getEntries().size() == this.entries.size())) {
