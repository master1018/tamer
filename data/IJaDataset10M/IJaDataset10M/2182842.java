...
public class BooleanParameterHandler extends ParameterHandler<Boolean> {
   ...
   */
    public Boolean coerce(String value) {
        ...
        if (value.equalsIgnoreCase("null") || value.equalsIgnoreCase("nil") || value.equalsIgnoreCase("f")) return Boolean.FALSE;
        if (value.equalsIgnoreCase("t")) return Boolean.TRUE;
