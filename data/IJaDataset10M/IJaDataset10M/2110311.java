package com.emental.mindraider.profile.color;
 ...
 */
public class ColorProfileSpidersBlack implements ColorProfileSpidersGraph {

    private static ColorProfileSpidersBlack singleton;

    public static ColorProfileSpidersGraph getInstance() {
        if (singleton == null) {
            singleton = new ColorProfileSpidersBlack();
        }
        return singleton;
    }

    private ColorProfileSpidersBlack() {
    }
