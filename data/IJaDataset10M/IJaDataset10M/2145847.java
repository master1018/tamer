...
public class TestXmlJAXBProviders extends BaseResourceTest {
    ...
    public void testUnmarshalOrder() throws Exception {
        InputStream in = Thread.currentThread().getContextClassLoader().getResourceAsStream("orders/order_123.xml");
    ...
    public void testUnmarshalOrdertype() throws Exception {
        InputStream in = Thread.currentThread().getContextClassLoader().getResourceAsStream("order_123.xml");
