...
class GUIPlanetListJFC extends UniverseJFrame {
    ...
    private DisplayPlanetFilter filter;

    GUIPlanetListJFC(CivID in_player) {
        this(in_player, new DisplayPlanetFilter(DisplayPlanetFilter.All, DisplayPlanetFilter.Alphabetical));
    }
    ...
    class TableMouseListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            if (e.getClickCount() == 2) {
                ...
                GUIFactoryJFC.spawnSubWindow(player, DR.getPlanet());
            }
        }
    }
    ...
    public void newFilter(DisplayPlanetFilter filter) {
        this.filter = filter;
        VDRtable = DisplayPlanet.get(player, filter);
        updatePanels();
    }
    ...
    class FilterButtonAction implements ActionListener {
        ...
        private GUIPlanetListJFC parent;

        FilterButtonAction(GUIPlanetListJFC parent) {
            this.parent = parent;
        }

        public void actionPerformed(ActionEvent e) {
            new GUIPlanetFilterJFC(parent);
        }
    }
}
