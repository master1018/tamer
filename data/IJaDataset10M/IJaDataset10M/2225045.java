...
public final class LabelEnumerator extends AbstractEnumerator {
	 ...
	 * @generated
	 */
    private static final LabelEnumerator[] VALUES_ARRAY = new LabelEnumerator[] { FULLY_SATISFIED_LITERAL, PARTIALLY_SATISFIED_LITERAL, FULLY_DENIED_LITERAL, PARTIALLY_DENIED_LITERAL, CONFLICT_LITERAL, UNKNOWN_LITERAL };
    ...
    public static LabelEnumerator get(int value) {
        switch(value) {
            case FULLY_SATISFIED:
                return FULLY_SATISFIED_LITERAL;
            case PARTIALLY_SATISFIED:
                return PARTIALLY_SATISFIED_LITERAL;
            case FULLY_DENIED:
                return FULLY_DENIED_LITERAL;
            case PARTIALLY_DENIED:
                return PARTIALLY_DENIED_LITERAL;
            case CONFLICT:
