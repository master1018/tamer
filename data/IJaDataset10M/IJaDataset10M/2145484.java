...
public class XStream {
    ...
    private Mapper buildMapper() {
        ...
        if (jvm.loadClass("net.sf.cglib.proxy.Enhancer") != null) {
            mapper = buildMapperDynamically("com.thoughtworks.xstream.mapper.CGLIBMapper", new Class[] { Mapper.class }, new Object[] { mapper });
        }
        ...
        if (JVM.is15()) {
            mapper = buildMapperDynamically("com.thoughtworks.xstream.mapper.EnumMapper", new Class[] { Mapper.class, ConverterLookup.class }, new Object[] { mapper, converterLookup });
        } else {
            mapper = new AttributeMapper(mapper, converterLookup);
        }
        mapper = new ImmutableTypesMapper(mapper);
        if (JVM.is15()) {
            mapper = buildMapperDynamically(ANNOTATION_MAPPER_TYPE, new Class[] { Mapper.class, ConverterRegistry.class, ClassLoader.class, ReflectionProvider.class, JVM.class }, new Object[] { mapper, converterLookup, classLoaderReference, reflectionProvider, jvm });
        }
    ...
    protected void setupConverters() {
        ...
        if (jvm.loadClass("net.sf.cglib.proxy.Enhancer") != null) {
            dynamicallyRegisterConverter("com.thoughtworks.xstream.converters.reflection.CGLIBEnhancedConverter", PRIORITY_NORMAL, new Class[] { Mapper.class, ReflectionProvider.class }, new Object[] { mapper, reflectionProvider });
        }
    ...
    public ClassMapper getClassMapper() {
        if (mapper instanceof ClassMapper) {
            ...
            return (ClassMapper) Proxy.newProxyInstance(getClassLoader(), new Class[] { ClassMapper.class }, new InvocationHandler() {
