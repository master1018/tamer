 ...
 */
    ...
    private void preprocessDoc(boolean overwrite, List<String> elNames, HashMap<String, String[]> elSetNames, Map<String, Annotator> elements, Document doc, int i) {
        ...
        if (verbose) {
            ...
            System.out.println("Finished: " + doc.getDocumentId() + " document #" + (i + 1) + " in " + Long.toString((docEnd - docStart) / 1000));
        }
    }
}
