...
public class TaskElementsMultipleFiltersFinder extends MultipleFiltersFinder {
    ...
    private void addCriterion(CriterionType type, Criterion criterion) {
        ...
        getListMatching().add(new FilterPair(TaskElementFilterEnum.Criterion, type.getResource().toLowerCase(), pattern, criterion));
    }

    private void addLabel(LabelType type, Label label) {
        String pattern = label.getName() + " ( " + type.getName() + " )";
        getListMatching().add(new FilterPair(TaskElementFilterEnum.Label, pattern, label));
    }
    ...
    private void addResource(Class className, Resource resource) {
        ...
        getListMatching().add(new FilterPair(TaskElementFilterEnum.Resource, className.getSimpleName(), pattern, resource));
    }
}
