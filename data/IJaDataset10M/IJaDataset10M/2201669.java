...
public interface XBag<E> extends XPutGetBag<E>, XProcessingBag<E>, XCollection<E> {
    ...
    @Override
    public XBag<E> execute(Procedure<? super E> procedure);

    @Override
    public XBag<E> execute(LoopProcedure<? super E> procedure);

    @Override
    public XBag<E> process(Procedure<? super E> procedure);
}
