 ...
 * (or disconnected).
 */
public class ConnectSpecificProfilesActivity extends PreferenceActivity implements CachedBluetoothDevice.Callback, Preference.OnPreferenceChangeListener {
    ...
    private void refreshOnlineModePreference() {
        ...
        mOnlineModePreference.setSummary(mOnlineMode ? mCachedDevice.getSummary() : R.string.bluetooth_device_advanced_online_mode_summary);
    }
    ...
    private void refreshProfilePreference(CheckBoxPreference profilePref, Profile profile) {
        ...
        profilePref.setSummary(getProfileSummary(profileManager, profile, device, connectionStatus, mOnlineMode));
    ...
    private static int getProfileSummary(LocalBluetoothProfileManager profileManager, Profile profile, BluetoothDevice device, int connectionStatus, boolean onlineMode) {
