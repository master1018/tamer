...
public class angularType extends homura.hde.util.xml.xml.Node {
    ...
    public angularType(homura.hde.util.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
