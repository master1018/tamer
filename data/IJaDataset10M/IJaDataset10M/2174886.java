...
public class LogMessageNotificationHandlerImpl implements LogMessageNotificationHandler {
    ...
    public void logMessage(String message) {
        if (logType.equals(LogMessageNotificationHandler.ERROR_LOG_TYPE)) logger.error(message); else if (logType.equals(LogMessageNotificationHandler.INFO_LOG_TYPE)) logger.info(message); else if (logType.equals(LogMessageNotificationHandler.TRACE_LOG_TYPE)) logger.trace(message);
    }
