        ...
        Runnable proc = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    setHTML("<html><body>" + "<h2 align=\"center\">Unknown Host Exception:</h2>" + "<h3 align=\"center\">'" + url.getHost() + "'</h3>" + "</body></html>");
                } catch (ConnectException ex) {
                    setHTML("<html><body>" + "<h2 align=\"center\">Connect Exception:" + ex.getLocalizedMessage() + "</h2>" + "<h3 align=\"center\">'" + url.getHost() + "'</h3>" + "</body></html>");
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
