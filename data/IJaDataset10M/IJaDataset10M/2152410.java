 ...
 */
class SynthSliderUI extends BasicSliderUI implements PropertyChangeListener, SynthUI {
    ...
    protected void layout() {
        ...
        if (slider.getOrientation() == JSlider.HORIZONTAL) {
            ...
            contentDim.height = valueRect.height + trackRect.height + trackInsets.top + trackInsets.bottom + tickRect.height + labelRect.height + 4;
