...
public class ParameterStore implements LiveParameterListener, DataListener {
    ...
    /** live parameters */
    protected final List<LiveParameter> _liveParameters;

    /** core parameters */
    protected final Map<String, CoreParameter> _coreParameterTable;

    protected final List<CoreParameter> _coreParameters;
	 ...
	 * @param name the name of the live parameter
    ...
    public void update(final DataAdaptor adaptor) {
        final Iterator coreAdaptorIter = adaptor.childAdaptorIterator(CoreParameter.DATA_LABEL);
        while (coreAdaptorIter.hasNext()) {
            final DataAdaptor coreAdaptor = (DataAdaptor) coreAdaptorIter.next();
    ...
    public void write(final DataAdaptor adaptor) {
        final Iterator paramIter = _coreParameters.iterator();
        while (paramIter.hasNext()) {
            final CoreParameter coreParameter = (CoreParameter) paramIter.next();
