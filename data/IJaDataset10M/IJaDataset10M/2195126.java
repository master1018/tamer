...
public class EPCSoundnessUI extends JPanel implements Provider {
    ...
    public ProvidedObject[] getProvidedObjects() {
        return new ProvidedObject[] { new ProvidedObject("EPC", new Object[] { epc }), new ProvidedObject("Pruned Transition System", new Object[] { transitionSystem }), new ProvidedObject("Soundness result", new Object[] { message }) };
    }
}
