...
public class WValidationException extends RuntimeException {
    ...
    /** The relevant pagelet, if any.  Set by catchers after exception is thrown.
     * (field may be null, but pagelets is still needed for onMaybeErroneous etc.) */
    WPagelet pagelet;
    ...
    public WPagelet getPagelet() {
        return pagelet;
    }

    public void setPagelet(WPagelet pagelet) {
