...
public class ExperimentStarterApplication extends JFrame implements ExperimentStarterGUI {
    ...
    private static final String TITLE = "DESMO-J " + Experiment.getDesmoJVersion() + " Experiment Starter";
    ...
    public ExperimentStarterApplication(Class modelClass, Class expRunnerClass) {
        ...
        experimentStarter = new ExperimentStarter(this, modelClass, expRunnerClass);
    ...
    public void jbInit() throws Exception {
        ...
        startButton.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (experimentStarter.runsBatch) experimentStarter.runBatch(experimentStarter.docNode); else experimentStarter.startExperiment();
            }
        });
        ...
        manualPanel.setPage(classLoader.getResource("desmoj/extensions/experimentation/ui/htmlFiles/manualApplication.html"));
	 ...
	 */
    public void clockAdvanced(String currentTime, double timePercent, long startTime) {
        progressBar.setValue((int) timePercent);
        timeLabel.setText("SimulatedTime: " + currentTime);
        runLabel.setText("RunTime: " + (System.currentTimeMillis() - startTime) / 1000.0);
    }
    ...
    public String loadDialog(String currentFilename) {
        ...
        jfc.setSize(500, 400);
        if (currentFilename != null) jfc.setSelectedFile(new File(currentFilename));
        int result = jfc.showOpenDialog(this);
        if (result == JFileChooser.CANCEL_OPTION) return currentFilename;
    ...
    public String saveDialog(String currentFilename) {
        ...
        if (result == JFileChooser.CANCEL_OPTION) filename = null;
	 ...
	 */
    public void resetGUI(String filename, boolean runsBatch, AccessPointTableModel modelAccessPoints, AccessPointTableModel expAccessPoints, String modelName) {
        ...
        if (!runsBatch) {
            ...
            resetButton.setEnabled(false);
            tabbedPane.setComponentAt(0, new JLabel("Batch run from file " + filename));
        }
        tabbedPane.repaint();
        ...
        if (filename != null) {
            text += " - " + filename;
            if (runsBatch) text += " (Batch)";
        } else if (modelName != null) text += " - " + modelName;
	 ...
	 */
    public void setStopped(String currentTime, long startTime, String experimentValues, String outputPath, List<List<String>> appendixes) {
        newButton.setEnabled(true);
        resetButton.setEnabled(true);
        stopButton.setEnabled(false);
        pauseButton.setEnabled(false);
        ...
        timeLabel.setText("SimulatedTime: " + currentTime);
        runLabel.setText("RunTime: " + (System.currentTimeMillis() - startTime) / 1000.0);
        reportsPanel.urlTreePanel.createNode(experimentValues, "file:" + outputPath, appendixes);
    }
