...
public class TestPCAPredictorTransposed {
    ...
    private static class LocalTimeMinutes implements CalUtils.InstantGenerator {
        ...
        public LocalTimeMinutes(final int minutes) {
    ...
    public void testPrediction1() throws Exception {
        ...
        final Calendar moments[] = new Calendar[] { Calendar.getInstance(), Calendar.getInstance(), Calendar.getInstance(), Calendar.getInstance(), Calendar.getInstance(), Calendar.getInstance() };
        ...
        final double[][] synthesizedDailyVols = new double[coreDailyVols.length][instantGenerator.maxInstantValue()];
        ...
        final Predictor predictor = new PCAPredictorTransposed(instantGenerator, 5);
        for (int i = 0; i < 5; i++) {
            predictor.learnVector(moments[i], synthesizedDailyVols[i]);
        }
        final double prediction[] = predictor.predictVector(moments[5]);
        final double coreExpectedPrediction[] = new double[] { 0.21383323, -0.08665493, -0.28527934, -0.45293966, -0.35525111, -0.49117788, -0.38114565, -0.60141152, -0.09029406, -0.44815719, -0.45152723, -0.58079146, -0.29110153, 1.54262599, -0.59900211, -0.48107804, -0.03280398, -0.59369964, -0.44886852, -0.43868587, 0.88745208, -0.10900099, -0.26251035, -0.71557572, -0.20051598, -0.57674404, 0.53793693, 0.15857465, -0.53212067, -0.13529962, -0.49171709, -0.32334222, 2.16101856, 0.46824882, 2.13337330, -0.48802957, -0.40084079, 1.62077396, 1.93080019, -0.59114756, -0.09429057, -0.68952951, -0.39819841, -0.63019599, -0.78762027, 0.12458423, 0.34847712, -0.52481068, 0.69730449, -0.74290105, -0.68866588, -0.45964670, -0.69174165, -0.64825389, -0.49908622, -0.30049621, 0.35726449, 0.47210113, -0.25058065, -0.72112704, 0.79345044, -0.73245678, -0.75581875, -0.40885896, -0.08033429, -0.56030291, -0.54967743, -0.63571829, -0.58889882, -0.71099478, -0.67055922, -0.03850658, -0.40339282, -0.43003588, -0.44813762, -0.14347007, -0.48441216, -0.48851502, -0.15427010, -0.39484463, 0.52701151, -0.61335693, 0.89776479, -0.18821502, -0.46457371, -0.39850394, -0.26234640, -0.21535441, 0.33669589, -0.48879971, 0.43892192, 0.52101182, -0.42851659, -0.51364225, 0.85831207, -0.24052028, -0.04192086, -0.02287821, 0.01522206, 0.24307671, 0.27369478, 0.11058009, -0.95575786, 14.90733910 };
    ...
    public static void main(final String args[]) throws Exception {
        try {
            new Engine();
            final TestPCAPredictorTransposed test = new TestPCAPredictorTransposed();
