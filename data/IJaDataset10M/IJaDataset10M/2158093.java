package net.taylor.uml2.classdiagram.edit.parts;

import java.util.Collections;
import java.util.List;
import net.taylor.uml2.classdiagram.edit.policies.OperationItemSemanticEditPolicy;
import net.taylor.uml2.classdiagram.edit.policies.UMLTextNonResizableEditPolicy;
import net.taylor.uml2.classdiagram.edit.policies.UMLTextSelectionEditPolicy;
import net.taylor.uml2.classdiagram.part.UMLDiagramEditorPlugin;
...
public class OperationEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    protected Image getLabelIcon() {
        ImageDescriptor descriptor = UMLDiagramEditorPlugin.getInstance().getItemImageDescriptor(getParserElement());
        if (descriptor == null) {
    ...
    protected String getLabelText() {
        Operation operation = (Operation) ((Node) getModel()).getElement();
        return ModelUtil.getSignature(operation);
    }
            ...
            ParserHintAdapter hintAdapter = new ParserHintAdapter(getParserElement(), parserHint) {
                ...
                public Object getAdapter(Class adapter) {
                    if (IElementType.class.equals(adapter)) {
                        return UMLElementTypes.Operation_2003;
                    }
