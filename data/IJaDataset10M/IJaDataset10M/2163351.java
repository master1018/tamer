...
public class Table extends ViewGroup {
    ...
    private static final OnHierarchyChangeListener hierarchyChangeListener = new OnHierarchyChangeListener() {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        layout.setLayoutSize(0, 0, widthUnspecified ? 0 : MeasureSpec.getSize(widthMeasureSpec), heightUnspecified ? 0 : MeasureSpec.getSize(heightMeasureSpec));
        ...
        for (int i = 0, n = cells.size(); i < n; i++) {
            ...
            if (((View) c.getWidget()).getVisibility() == GONE) {
                ((View) c.getWidget()).measure(MeasureSpec.makeMeasureSpec(0, MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(0, MeasureSpec.EXACTLY));
            }
        }
        layout.layout();
