...
import fr.inria.uml4tst.papyrus.ocl4tst.ocl.CollectionTypeIdentifierCS;
 ...
 * <ul>
 *   <li>{@link fr.inria.uml4tst.papyrus.ocl4tst.ocl.impl.CollectionTypeIdentifierCSImpl#getTypeName <em>Type Name</em>}</li>
 *   <li>{@link fr.inria.uml4tst.papyrus.ocl4tst.ocl.impl.CollectionTypeIdentifierCSImpl#getGenericType <em>Generic Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollectionTypeIdentifierCSImpl extends TypeCSImpl implements CollectionTypeIdentifierCS {
    ...
    public Type getTypeName() {
        if (typeName != null && typeName.eIsProxy()) {
            ...
            if (typeName != oldTypeName) {
                if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.RESOLVE, OclPackage.COLLECTION_TYPE_IDENTIFIER_CS__TYPE_NAME, oldTypeName, typeName));
            }
        }
        return typeName;
    }
    ...
    public void setTypeName(Type newTypeName) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.COLLECTION_TYPE_IDENTIFIER_CS__TYPE_NAME, oldTypeName, typeName));
    }
    ...
    public void setGenericType(TypeCS newGenericType) {
        if (newGenericType != genericType) {
            ...
            if (genericType != null) msgs = ((InternalEObject) genericType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OclPackage.COLLECTION_TYPE_IDENTIFIER_CS__GENERIC_TYPE, null, msgs);
            if (newGenericType != null) msgs = ((InternalEObject) newGenericType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OclPackage.COLLECTION_TYPE_IDENTIFIER_CS__GENERIC_TYPE, null, msgs);
            msgs = basicSetGenericType(newGenericType, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.COLLECTION_TYPE_IDENTIFIER_CS__GENERIC_TYPE, newGenericType, newGenericType));
    }
