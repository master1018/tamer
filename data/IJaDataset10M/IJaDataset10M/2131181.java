...
public final class Cryptographer {
    ...
    public String encrypt(byte[] data) {
        ...
        try {
            ...
            SystemException sys = new SystemException(Cryptographer.class.getName(), "encrypt", new String[] { "Throwable: " + t.toString(), "Message: " + t.getMessage() });
            throw sys;
        }
    }
    ...
    public String decrypt(String encoded) {
        ...
        try {
            ...
            SystemException sys = new SystemException(Cryptographer.class.getName(), "decrypt", new String[] { "Throwable: " + t.toString(), "Message: " + t.getMessage() });
            throw sys;
        }
    }
}
