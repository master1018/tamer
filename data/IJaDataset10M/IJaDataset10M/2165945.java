...
public class LibraryLoader extends ClassLoader {
    ...
    public SpecialValueMap load(final URL libraries, final URIMap uriMap, final ModelConnection mc) throws RippleException {
    ...
    public class Context {
        ...
        private final LinkedHashMap<Value, RippleValue> primaryMap, aliasMap;
