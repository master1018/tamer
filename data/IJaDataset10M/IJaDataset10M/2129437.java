...
public class View_ForwardUpdateRTest extends TestCase {
    ...
    private class ParentView extends WithChildrenView {
        ...
        public int getViewIndex(int pos, Bias bias) {
            ...
            logger.println("\t" + getInfo() + ".getViewIndex(" + pos + ", " + bias + ") = " + result);
            return result;
        }
        ...
        @Override
        protected void forwardUpdateToView(View view, DocumentEvent event, Shape shape, ViewFactory factory) {
    ...
    public void testForwardUpdate03() throws BadLocationException {
        ...
        assertEquals(view.getViewCount() - 1, view.getViewIndex(docEvent.getOffset() + docEvent.getLength(), Bias.Forward));
