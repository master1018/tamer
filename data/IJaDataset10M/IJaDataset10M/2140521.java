...
public class MobileNetworksAboutBox extends javax.swing.JDialog {

    public MobileNetworksAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(mobilenetworks.MobileNetworksApp.class).getContext().getResourceMap(MobileNetworksAboutBox.class);
        setTitle(resourceMap.getString("title"));
        setModal(true);
        setName("aboutBox");
        setResizable(false);
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(mobilenetworks.MobileNetworksApp.class).getContext().getActionMap(MobileNetworksAboutBox.class, this);
