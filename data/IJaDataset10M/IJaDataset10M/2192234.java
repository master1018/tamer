...
public final class ZoneResolvers {
    ...
    private static class Strict extends ZoneResolver {
        ...
        /** {@inheritDoc} */
        @Override
        protected OffsetDateTime handleGap(ZoneId zone, ZoneRules rules, ZoneOffsetTransition discontinuity, LocalDateTime newDateTime, OffsetDateTime oldDateTime) {
        ...
        /** {@inheritDoc} */
        @Override
        protected OffsetDateTime handleOverlap(ZoneId zone, ZoneRules rules, ZoneOffsetTransition discontinuity, LocalDateTime newDateTime, OffsetDateTime oldDateTime) {
