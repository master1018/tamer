...
public class TransitiveReduction implements ConvertingPlugin {
    ...
    public String getHtmlDescription() {
        return "This plugin calculates the transitive reduction of a graph. It only works if the graph is a " + "\"simple directed graph\", i.e. a graph that has at most one edge between two nodes and no loops.";
    }
