...
public class DSAKeyValueTypeSequence implements java.io.Serializable {
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (obj instanceof DSAKeyValueTypeSequence) {
            ...
            } else if (temp._p != null) return false;
            if (this._q != null) {
            ...
            } else if (temp._q != null) return false;
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = 17;
        long tmp;
        if (_p != null && !org.castor.core.util.CycleBreaker.startingToCycle(_p)) {
            result = 37 * result + _p.hashCode();
            org.castor.core.util.CycleBreaker.releaseCycleHandle(_p);
        }
        if (_q != null && !org.castor.core.util.CycleBreaker.startingToCycle(_q)) {
     ...
     */
    public static org.w3.www._2000._09.xmldsig.DSAKeyValueTypeSequence unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
