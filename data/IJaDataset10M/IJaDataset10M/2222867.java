...
public class OverlaysPanel extends BasePanel {
	 ...
	 */
    public OverlaysPanel(final GUI gui, final Composite parent, final int style) {
    ...
    private Image getIcon(final Overlay ov) {
        if (!iconsLoaded) {
            binaryOverlayIcon = new Image(Display.getCurrent(), getClass().getResourceAsStream("/res/misc/binaryOverlayIcon.png"));
            discreteOverlayIcon = new Image(Display.getCurrent(), getClass().getResourceAsStream("/res/misc/discreteOverlayIcon.png"));
            realOverlayIcon = new Image(Display.getCurrent(), getClass().getResourceAsStream("/res/misc/realOverlayIcon.png"));
            iconsLoaded = true;
        }
	 ...
	 */
    @Override
    protected BaseStatus createStatusItem(final Composite parent, final Object o) {
    ...
    protected void onSelectionMade(final String selection) {
        ...
        if (overlay == null) {
            throw new RuntimeException("You chose a non existing overlay. How did u mange??");
        }
