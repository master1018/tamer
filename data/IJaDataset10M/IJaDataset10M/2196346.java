...
/**
 * Adapter for server implementation of DispHTMLHeaderElement
 */
public class DispHTMLHeaderElementServer extends IDispatchServer implements DispHTMLHeaderElement {

    public DispHTMLHeaderElementServer(CoClassMetaInfo classImpl) {
        super(classImpl);
        registerMethods(DispHTMLHeaderElement.class);
    }
