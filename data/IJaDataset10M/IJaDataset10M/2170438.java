...
public final class InstructionResolver implements Instructions {
    ...
    private final Map<Integer, Statement> statementByOffset = new HashMap<Integer, Statement>();
    ...
    public void aastore() {
        statements.assign((Expression) null, null, null);
    }
    ...
    public void vreturn() {
        statements.voidReturn();
    }

    public void ret(int localVar) {
        throw new RuntimeException("ret instruction is not supported.");
    }
    ...
    public void dconst_0() {
        insert(constantDouble(0.0));
    }

    public void dconst_1() {
        insert(constantDouble(1.0));
    }

    public void fconst_0() {
        insert(constantFloat(0f));
    }

    public void fconst_1() {
        insert(constantFloat(1f));
    }

    public void fconst_2() {
        insert(constantFloat(2f));
    }

    public void iconst_0() {
        insert(constantInt(0));
    }

    public void iconst_1() {
        insert(constantInt(1));
    }

    public void iconst_2() {
        insert(constantInt(2));
    }

    public void iconst_3() {
        insert(constantInt(3));
    }

    public void iconst_4() {
        insert(constantInt(4));
    }

    public void iconst_5() {
        insert(constantInt(5));
    }
    ...
    public void lconst_0() {
        insert(constantLong(0L));
    }

    public void lconst_1() {
        insert(constantLong(1L));
    }
    ...
    public void athrow() {
        statements.throwException(null);
    }

    public void checkcast(int classIndex) {
        insert(cast(ObjectOrArrayType.fromName(cpool.getClassName(classIndex)), null));
    }

    public void instanceOf(int classIndex) {
        insert(ExpressionBuilder.instanceOf(ObjectOrArrayType.fromName(cpool.getClassName(classIndex)), null));
    }

    public void d2f() {
        conv(PrimitiveType.FLOAT);
    }

    public void d2i() {
        conv(PrimitiveType.INT);
    }

    public void d2l() {
        conv(PrimitiveType.LONG);
    }

    public void i2b() {
        conv(PrimitiveType.BYTE);
    }

    public void i2c() {
        conv(PrimitiveType.CHAR);
    }

    public void i2d() {
        conv(PrimitiveType.DOUBLE);
    }
    ...
    public void monitorenter() {
        statements.monitorEnter(null);
    }

    public void monitorexit() {
        statements.monitorExit(null);
    }
    ...
    public void jsr_w(int label) {
        throw new RuntimeException("JSR is unsupported - please recompile for >= Java 5");
    }
    ...
    public void if_acmpeq(int label) {
        condBranch(label, condition(IF_EQUAL, null, null));
    }

    public void if_acmpne(int label) {
        condBranch(label, condition(IF_NOT_EQUAL, null, null));
    }
    ...
    public void if_icmpge(int label) {
        condBranch(label, condition(IF_GREATER_OR_EQUAL, null, null));
    }

    public void if_icmpgt(int label) {
        condBranch(label, condition(IF_GREATER_THAN, null, null));
    }

    public void if_icmple(int label) {
        condBranch(label, condition(IF_LESS_OR_EQUAL, null, null));
    }

    public void if_icmplt(int label) {
        condBranch(label, condition(IF_LESS_THAN, null, null));
    }
    ...
    public void ifeq(int label) {
        condBranch(label, condition(IF_EQUAL, null, constantInt(0)));
    }

    public void ifge(int label) {
        condBranch(label, condition(IF_GREATER_OR_EQUAL, null, constantInt(0)));
    }

    public void ifgt(int label) {
        condBranch(label, condition(IF_GREATER_THAN, null, constantInt(0)));
    }

    public void ifle(int label) {
        condBranch(label, condition(IF_LESS_OR_EQUAL, null, constantInt(0)));
    }

    public void iflt(int label) {
        condBranch(label, condition(IF_LESS_THAN, null, constantInt(0)));
    }

    public void ifne(int label) {
        condBranch(label, condition(IF_NOT_EQUAL, null, constantInt(0)));
    }

    public void ifnonnull(int label) {
        condBranch(label, condition(IF_NOT_EQUAL, null, constantNull()));
    }

    public void ifnull(int label) {
        condBranch(label, condition(IF_EQUAL, null, constantNull()));
    }
    ...
    public void nop() {
        statements.expression(constantNull());
    }

    public void iinc(int localVar, int increment) {
        StaticSingleAssignmentStatement var = pushVar(localVar);
        new LocalVarAssignmentStatement(localVar, ExpressionBuilder.binaryOp(ADD, ExpressionBuilder.value(var), ExpressionBuilder.constantInt(increment)));
    }

    public void dup_x1() {
        new StackOperationStatement(1, 1).append(statements);
    }

    public void dup_x2() {
        new StackOperationStatement(1, 2).append(statements);
    }

    public void dup() {
        new StackOperationStatement(1, 0).append(statements);
    }

    public void dup2_x1() {
        new StackOperationStatement(2, 1).append(statements);
    }

    public void dup2_x2() {
        new StackOperationStatement(2, 2).append(statements);
    }

    public void dup2() {
        new StackOperationStatement(2, 0).append(statements);
    }

    public void swap() {
        new StackOperationStatement(0, 0).append(statements);
    }

    public void pop() {
        new PopStatement(1).append(statements);
    }
    ...
    public void ddiv() {
        insert(binaryOp(DIVIDE, null, null));
    }
    ...
    public void dmul() {
        insert(binaryOp(MULTIPLY, null, null));
    }
    ...
    public void drem() {
        insert(binaryOp(REMAINDER, null, null));
    }
    ...
    public void dsub() {
        insert(binaryOp(SUBTRACT, null, null));
    }
    ...
    public void dcmpg() {
        insert(binaryOp(COMPARE_G, null, null));
    }
    ...
    public void dcmpl() {
        insert(binaryOp(COMPARE_L, null, null));
    }
    ...
    public void ishl() {
        insert(binaryOp(SHIFT_LEFT, null, null));
    }
    ...
    public void ishr() {
        insert(binaryOp(SHIFT_RIGHT_SIGNED, null, null));
    }
    ...
    public void iushr() {
        insert(binaryOp(SHIFT_RIGHT_UNSIGNED, null, null));
    }
    ...
    public void lcmp() {
        insert(binaryOp(COMPARE, null, null));
    }
}
