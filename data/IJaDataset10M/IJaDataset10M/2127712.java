...
public class FileSpecification extends Dictionary {
    ...
    public String getFileSpecification() {
        if (library.getObject(entries, "F") instanceof StringObject) {
            return ((StringObject) library.getObject(entries, "F")).getDecryptedLiteralString(library.getSecurityManager());
        } else {
            return null;
        }
    }
    ...
    public String getDos() {
        if (library.getObject(entries, "DOS") instanceof StringObject) {
            return ((StringObject) library.getObject(entries, "DOS")).getDecryptedLiteralString(library.getSecurityManager());
        } else {
            return null;
        }
    }
    ...
    public String getMac() {
        if (library.getObject(entries, "Mac") instanceof StringObject) {
            return ((StringObject) library.getObject(entries, "Mac")).getDecryptedLiteralString(library.getSecurityManager());
        } else {
            return null;
        }
    }
    ...
    public String getUnix() {
        if (library.getObject(entries, "Unix") instanceof StringObject) {
            return ((StringObject) library.getObject(entries, "Unix")).getDecryptedLiteralString(library.getSecurityManager());
        } else {
            return null;
        }
    }
