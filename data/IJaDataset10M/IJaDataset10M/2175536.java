...
public class Html extends JHeader {
    ...
    public enum Tag {
        ...
        A, B, BODY, BUTTON, CAPTION, CENTER, DIV, EM, FORM, H1, H2, H3, H4, H5, H6, HEAD, HTML, I, IFRAME, IMG, INPUT, LABEL, LI, LINK("rel", "type", "href"), META, NOSCRIPT, OBJECT, OL, P, REL, SCRIPT, SPAN, TABLE, TBODY, TD, TEXT, TH, TITLE, TR, U, UL, UNKNOWN;
