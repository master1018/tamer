...
public class XokobanActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (useAccelerometer) {
            sensorManager.registerListener(inputController, sensorAccelerometer, SensorManager.SENSOR_ACCELEROMETER);
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_CODE_SETTINGS && resultCode == RESULT_OK) {
            boolean accelerometerEnabled = data.getBooleanExtra(SettingsActivity.KEY_ACCELEROMETER_ENABLED, false);
    ...
    private void enableAccelerometer() {
        if (!useAccelerometer) {
            ...
            sensorManager.registerListener(inputController, sensorAccelerometer, SensorManager.SENSOR_DELAY_FASTEST);
    ...
    private void switchToSettings() {
        ...
        startActivityForResult(new Intent(this, SettingsActivity.class).putExtra(SettingsActivity.KEY_ACCELEROMETER_ENABLED, isAccelerometerEnabled()), REQUEST_CODE_SETTINGS);
    }
