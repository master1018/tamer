...
public class DateTimeAnnotation_Type extends Annotation_Type {
    ...
    /** @generated */
    public static final int typeIndexID = DateTimeAnnotation.typeIndexID;

    /**
	 * @generated
	 * @modifiable
	 */
    public static final boolean featOkTst = JCasRegistry.getFeatOkTst("org.uimafit.examples.tutorial.type.DateTimeAnnotation");
    ...
    public String getShortDateString(int addr) {
        if (featOkTst && casFeat_shortDateString == null) jcas.throwFeatMissing("shortDateString", "org.uimafit.examples.tutorial.type.DateTimeAnnotation");
