...
public class LauncherActions {
    ...
    public static synchronized LauncherActions getInstance() {
        if (mInstance == null) mInstance = new LauncherActions();
        return mInstance;
    }
    ...
    private List<Action> getList() {
        ...
        for (int i = 0; i < menuBindingsValues.length; i++) {
            ...
            if (value != Launcher.BIND_NONE && value != Launcher.BIND_APP_LAUNCHER && value != Launcher.BIND_HOME_PREVIEWS && value != Launcher.BIND_HOME_NOTIFICATIONS) {
