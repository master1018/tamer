                ...
                if ((i != ci[0]) && (i != ci[1])) {
                    for (int j = i + 1; j < numCards - 1; j++) {
                        if ((j != ci[0]) && (j != ci[1])) {
                            for (int k = j + 1; k < numCards; k++) {
                                if ((k != ci[0]) && (k != ci[1])) {
                                    if (((c[i].getRank() == Card.ACE) || (c[i].getRank() >= Card.TEN)) && ((c[j].getRank() == Card.ACE) || (c[j].getRank() >= Card.TEN)) && ((c[k].getRank() == Card.ACE) || (c[k].getRank() >= Card.TEN))) {
                                        return 74.0f;
                                    }
                                    if ((Math.abs(c[i].getRank() - c[j].getRank()) <= 4.0) && (Math.abs(c[i].getRank() - c[k].getRank()) <= 4.0) && (Math.abs(c[j].getRank() - c[k].getRank()) <= 4.0)) {
                                        if ((c[i].getRank() <= c[j].getRank()) && (c[i].getRank() <= c[k].getRank())) {
