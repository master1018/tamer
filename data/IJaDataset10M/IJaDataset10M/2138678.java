...
public class OCLHTMLPrinter {
    ...
    private static final class HTML2TextReader extends java.io.Reader {
        ...
        protected String computeSubstitution(int c) throws java.io.IOException {
            if (c == '<') return processHTMLTag(); else if (fIgnore) return EMPTY_STRING; else if (c == '&') return processEntity(); else if (fIsPreformattedText) return processPreformattedText(c);
            return null;
        }
