...
public class ExecID extends FIXMLField {
    ...
    public void initValue(Object s) throws ModelException {
        if (_Value != null) throw new ModelException("Value has already been initialized for field ExecID.");
        setValue((String) s);
    }
    ...
    public String toFIXML(String ident) {
        ...
        StringBuffer sb = new StringBuffer(ident + "<ExecID FIXTag=\"17\" DataType=\"String\"");
        sb.append(">" + _Value + "</ExecID>");
        return sb.toString();
    }
}
