...
public class ScrollbarTest extends TestCase {
    ...
    private void checkScrollbar(int orientation, int value, int visible, int min, int max, int unitInc, int blockInc) {
    ...
    public final void testSetValues() {
        ...
        scrollbar.setValues(val = 20, vis = 200, min = Integer.MIN_VALUE, max = Integer.MAX_VALUE);
        checkScrollbar(-1 - vis, vis, min, -1);
        scrollbar.setValues(val = 200, vis = -200, min = 0, max = 100);
        checkScrollbar(99, 1, min, max);
        scrollbar.setValues(val = -5, vis = 200, min = 0, max = 100);
    ...
    public void testProcessAdjustmentEvent() {
        ...
        scrollbar.processEvent(new AdjustmentEvent(scrollbar, AdjustmentEvent.ADJUSTMENT_VALUE_CHANGED, AdjustmentEvent.UNIT_INCREMENT, 1));
