 ...
 */
    ...
    public void setButton(int flags) {
        ...
        if (flags != 0) put(PdfName.FF, new PdfNumber(flags));
    }
    ...
    public static PdfFormField createTextField(PdfWriter writer, boolean multiline, boolean password, int maxLen) {
        ...
        if (maxLen > 0) field.put(PdfName.MAXLEN, new PdfNumber(maxLen));
        return field;
    }
    ...
    protected static PdfFormField createChoice(PdfWriter writer, int flags, PdfArray options, int topIndex) {
        ...
        if (topIndex > 0) field.put(PdfName.TI, new PdfNumber(topIndex));
        return field;
    }
    ...
    public int setFieldFlags(int flags) {
        ...
        int old;
        if (obj == null) old = 0; else old = obj.intValue();
        int v = old | flags;
    ...
    public void setFieldName(String s) {
        if (s != null) put(PdfName.T, new PdfString(s, PdfObject.TEXT_UNICODE));
    }
