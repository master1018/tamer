...
public class TramiteNivelForm extends TramiteValidatorForm {
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        try {
            ...
            if (niveles.indexOf(TramiteNivel.AUTENTICACION_ANONIMO) != niveles.lastIndexOf(TramiteNivel.AUTENTICACION_ANONIMO) || niveles.indexOf(TramiteNivel.AUTENTICACION_CERTIFICADO) != niveles.lastIndexOf(TramiteNivel.AUTENTICACION_CERTIFICADO) || niveles.indexOf(TramiteNivel.AUTENTICACION_USUARIOPASSWORD) != niveles.lastIndexOf(TramiteNivel.AUTENTICACION_USUARIOPASSWORD)) {
    ...
    public void setNivelesAutenticacionSelected(String[] nivelesAutenticacionSelected) {
