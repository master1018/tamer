...
public class EgovCtsnnManageController {
    ...
    public String selectCtsnnManageListView(@ModelAttribute("ctsnnManageVO") CtsnnManageVO ctsnnManageVO, ModelMap model) throws Exception {
    ...
    public String selectCtsnnManageList(@ModelAttribute("ctsnnManageVO") CtsnnManageVO ctsnnManageVO, ModelMap model) throws Exception {
    ...
    public String selectCtsnnManage(@ModelAttribute("ctsnnManage") CtsnnManage ctsnnManage, @ModelAttribute("ctsnnManageVO") CtsnnManageVO ctsnnManageVO, Map commandMap, ModelMap model) throws Exception {
    ...
    public String insertViewCtsnnManage(@ModelAttribute("ctsnnManage") CtsnnManage ctsnnManage, @ModelAttribute("ctsnnManageVO") CtsnnManageVO ctsnnManageVO, ModelMap model) throws Exception {
        List ctsnnCdCodeList = null;
        List relateCodeList = null;
        ComDefaultCodeVO vo = new ComDefaultCodeVO();
        vo.setCodeId("COM054");
    ...
    public String insertCtsnnManage(@ModelAttribute("ctsnnManage") CtsnnManage ctsnnManage, @ModelAttribute("ctsnnManageVO") CtsnnManageVO ctsnnManageVO, BindingResult bindingResult, SessionStatus status, ModelMap model) throws Exception {
        beanValidator.validate(ctsnnManage, bindingResult);
    ...
    public String updtCtsnnManage(@ModelAttribute("ctsnnManage") CtsnnManage ctsnnManage, @ModelAttribute("ctsnnManageVO") CtsnnManageVO ctsnnManageVO, BindingResult bindingResult, SessionStatus status, ModelMap model) throws Exception {
        beanValidator.validate(ctsnnManage, bindingResult);
        if (bindingResult.hasErrors()) {
            model.addAttribute("ctsnnManageVO", ctsnnManageVO);
            return "egovframework/com/uss/ion/ctn/EgovCtsnnUpdt";
    ...
    public String deleteCtsnnManage(@ModelAttribute("ctsnnManage") CtsnnManage ctsnnManage, SessionStatus status, ModelMap model) throws Exception {
    ...
    public String selectCtsnnManageConfmList(@ModelAttribute("ctsnnManageVO") CtsnnManageVO ctsnnManageVO, ModelMap model) throws Exception {
        PaginationInfo paginationInfo = new PaginationInfo();
        paginationInfo.setCurrentPageNo(ctsnnManageVO.getPageIndex());
        paginationInfo.setRecordCountPerPage(ctsnnManageVO.getPageUnit());
        paginationInfo.setPageSize(ctsnnManageVO.getPageSize());
        ...
        ctsnnManageVO.setRecordCountPerPage(paginationInfo.getRecordCountPerPage());
        LoginVO user = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
        ctsnnManageVO.setSanctnerId(user.getUniqId());
    ...
    public String selectCtsnnConfm(@ModelAttribute("ctsnnManageVO") CtsnnManageVO ctsnnManageVO, @ModelAttribute("ctsnnManage") CtsnnManage ctsnnManage, ModelMap model) throws Exception {
        ctsnnManageVO.setReqstDe(EgovStringUtil.removeMinusChar(ctsnnManageVO.getReqstDe()));
        CtsnnManageVO ctsnnManageVOTemp = egovCtsnnManageService.selectCtsnnManage(ctsnnManageVO);
        CtsnnManage ctsnnManageTemp = new CtsnnManage();
        ctsnnManageTemp.setCtsnnId(ctsnnManageVOTemp.getCtsnnId());
    ...
    public String updateCtsnnManageConfm(@ModelAttribute("ctsnnManage") CtsnnManage ctsnnManage, BindingResult bindingResult, SessionStatus status, ModelMap model) throws Exception {
        beanValidator.validate(ctsnnManage, bindingResult);
        if (bindingResult.hasErrors()) {
    ...
    public String selectSanctnerListPopup(@ModelAttribute("ctsnnManage") CtsnnManage ctsnnManage, Map commandMap, ModelMap model) throws Exception {
