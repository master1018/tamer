...
import se.mdh.mrtc.saveccm.composite.diagram.part.SaveccmDiagramEditor;
 ...
 * @generated
 */
public class SaveccmNavigatorActionProvider extends CommonActionProvider {
    ...
    private class OpenDiagramAction extends Action {
        ...
        public final void selectionChanged(IStructuredSelection selection) {
            ...
            if (selection.size() == 1) {
                ...
                if (selectedElement instanceof SaveccmNavigatorItem) {
                    selectedElement = ((SaveccmNavigatorItem) selectedElement).getView();
                } else if (selectedElement instanceof IAdaptable) {
                    selectedElement = ((IAdaptable) selectedElement).getAdapter(View.class);
                }
                if (selectedElement instanceof Diagram) {
                    Diagram diagram = (Diagram) selectedElement;
                    if (CompositeEditPart.MODEL_ID.equals(SaveccmVisualIDRegistry.getModelID(diagram))) {
                        myDiagram = diagram;
                    }
                }
            }
        ...
        public void run() {
            ...
            try {
                page.openEditor(editorInput, SaveccmDiagramEditor.ID);
            } catch (PartInitException e) {
                SaveccmDiagramEditorPlugin.getInstance().logError("Exception while openning diagram", e);
            }
        }
