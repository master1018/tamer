...
public class PatientDao extends StorableItem {
    ...
    public String[] getColumnNames() {
        return new String[] { "surname", "forename", "dateofbirth", "sex", "address1", "address2", "address3", "postcode", "telephone1", "telephone2", "mobile", "centreCode", "diagnosis", "treatment", "transplantstatus", "hospitalnumber", "gpname", "gpaddress1", "gpaddress2", "gpaddress3", "gppostcode", "gptelephone" };
    }
