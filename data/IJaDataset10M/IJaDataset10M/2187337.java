package hu.aitia.qcg.statnetds.tools;
 ...
 *
 * @author Nick Collier
 * @version $Revision: 77 $ $Date: 2011-03-21 05:55:21 -0400 (Mon, 21 Mar 2011) $
 */
public class OpenSequenceGraphNoGUI extends OpenGraphNoGUI {
    ...
    static interface ExpandPolicy {
        ...
        public void expand(double val, OpenSequenceGraphNoGUI graph);
    }

    @Patch
    static class ShowAllPointsX implements ExpandPolicy {

        public void expand(double xVal, OpenSequenceGraphNoGUI graph) {
    ...
    static class ShowAllPointsY implements ExpandPolicy {
        ...
        public void expand(double yVal, OpenSequenceGraphNoGUI graph) {
   ...
   */
    @Patch
    public OpenSequenceGraphNoGUI(String title, SimModel model) {
        super(title);
        this.model = model;
   ...
   */
    @Patch
    public OpenSequenceGraphNoGUI(String title, SimModel model, String fileName, int fileFormat) {
        super(title);
        this.model = model;
   ...
   * @param markStyle the shape of the plotted points
   */
    public Sequence addSequence(String name, Sequence sequence, Color color, int markStyle) {
        Sequence s = stats.addSequence(name, sequence);
   ...
   */
    public void setXAutoExpand(boolean autoExpand) {
        if (autoExpand) setXViewPolicy(OpenSequenceGraphNoGUI.SHOW_ALL); else setXViewPolicy(SHOW_FIRST);
    }
   ...
   */
    ...
    public void setYAutoExpand(boolean autoExpand) {
        if (autoExpand) setYViewPolicy(OpenSequenceGraphNoGUI.SHOW_ALL); else setYViewPolicy(SHOW_FIRST);
    }
