...
public class ExplicantoWebService_storeChunk_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public ExplicantoWebService_storeChunk_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader, SOAPDeserializationContext context) throws Exception {
        de.bea.services.vidya.client.datasource.types.ExplicantoWebService_storeChunk_ResponseStruct instance = new de.bea.services.vidya.client.datasource.types.ExplicantoWebService_storeChunk_ResponseStruct();
        de.bea.services.vidya.client.datasource.types.ExplicantoWebService_storeChunk_ResponseStruct_SOAPBuilder builder = null;
        Object member;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_result_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new de.bea.services.vidya.client.datasource.types.ExplicantoWebService_storeChunk_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        de.bea.services.vidya.client.datasource.types.ExplicantoWebService_storeChunk_ResponseStruct instance = (de.bea.services.vidya.client.datasource.types.ExplicantoWebService_storeChunk_ResponseStruct) obj;
    }
