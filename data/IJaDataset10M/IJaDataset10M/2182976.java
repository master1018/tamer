...
public abstract class GraphicSupport implements Graphic {
    ...
    public GraphicMouseListener getMouseListener(Point p) {
        for (GraphicMouseListener handler : mouseHandlers) if (handler.interestedIn(p)) return handler;
        return null;
    }
