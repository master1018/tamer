...
public class BeanContextChildSupportTest extends TestCase {
    ...
    private static class MockBeanContextChildSupport extends BeanContextChildSupport {
    ...
    public void testAddPropertyChangeListener_NullParam() {
        ...
        support.firePropertyChange("property name", "old value", "new value");
    }
    ...
    public void testAddVetoableChangeListener_NullParam() throws PropertyVetoException {
        BeanContextChildSupport support = new MockBeanContextChildSupport();
        support.addVetoableChangeListener(null, new MockVetoableChangeListener());
    ...
    public void testFireVetoableChange_OldEqualsNew() throws PropertyVetoException {
        BeanContextChildSupport support = new MockBeanContextChildSupport();
        MockVetoableChangeListener l1 = new MockVetoableChangeListener();
        MockVetoableChangeListener l2 = new MockVetoableChangeListener();
        String propName = "property name";
    ...
    public void testFireVetoableChange_OldEqualsNew_IsNull() throws PropertyVetoException {
        BeanContextChildSupport support = new MockBeanContextChildSupport();
        MockVetoableChangeListener l1 = new MockVetoableChangeListener();
        MockVetoableChangeListener l2 = new MockVetoableChangeListener();
        String propName = "property name";
    ...
    public void testInitializeBeanContextResources() throws PropertyVetoException {
    ...
    public void testSetBeanContext() throws PropertyVetoException {
        ...
        MockBeanContextChildSupport support = new MockBeanContextChildSupport(peer);
        MockPropertyChangeListener l1 = new MockPropertyChangeListener();
        MockVetoableChangeListener l2 = new MockVetoableChangeListener();
    ...
    public void testSetBeanContext_VetoedByListener() throws PropertyVetoException {
        MockBeanContextChildSupport support = new MockBeanContextChildSupport();
    ...
    public void testSerialization_NoPeer() throws IOException, ClassNotFoundException {
        ...
        MockPropertyChangeListenerS pcl2 = new MockPropertyChangeListenerS("id of pcl2");
        MockVetoableChangeListener vcl1 = new MockVetoableChangeListener();
        MockVetoableChangeListenerS vcl2 = new MockVetoableChangeListenerS("id of vcl2");
        ...
        assertEqualsSerially(support, (BeanContextChildSupport) SerializationTester.getDeserilizedObject(support));
    }
    ...
    public void testSerialization_WithPeer() throws IOException, ClassNotFoundException {
        MockBeanContextChildDelegateS peer = new MockBeanContextChildDelegateS("id of peer");
    ...
    public static void assertEqualsSerially(BeanContextChildSupport orig, BeanContextChildSupport ser) {
        if (orig == orig.getBeanContextChildPeer()) {
            assertSame(ser, ser.getBeanContextChildPeer());
        } else {
            assertSame(orig.getBeanContextChildPeer().getClass(), ser.getBeanContextChildPeer().getClass());
            if (orig.getBeanContextChildPeer() instanceof MockBeanContextChildDelegateS) {
                MockBeanContextChildDelegateS origPeer = (MockBeanContextChildDelegateS) orig.getBeanContextChildPeer();
                MockBeanContextChildDelegateS serPeer = (MockBeanContextChildDelegateS) ser.getBeanContextChildPeer();
                assertEquals(origPeer.id, serPeer.id);
            }
        }
        PropertyChangeSupport origPCS = (PropertyChangeSupport) Utils.getField(orig, "pcSupport");
        PropertyChangeSupport serPCS = (PropertyChangeSupport) Utils.getField(ser, "pcSupport");
        PropertyChangeListener origPCL[] = origPCS.getPropertyChangeListeners("beanContext");
        PropertyChangeListener serPCL[] = serPCS.getPropertyChangeListeners("beanContext");
        int i = 0, j = 0;
        while (i < origPCL.length) {
            if (origPCL[i] instanceof Serializable) {
                ...
                if (origPCL[i] instanceof MockPropertyChangeListenerS) {
                    assertEquals(((MockPropertyChangeListenerS) origPCL[i]).id, ((MockPropertyChangeListenerS) serPCL[j]).id);
                }
                i++;
                j++;
            } else {
        ...
        VetoableChangeSupport origVCS = (VetoableChangeSupport) Utils.getField(orig, "vcSupport");
        VetoableChangeSupport serVCS = (VetoableChangeSupport) Utils.getField(ser, "vcSupport");
        VetoableChangeListener origVCL[] = origVCS.getVetoableChangeListeners("beanContext");
        VetoableChangeListener serVCL[] = serVCS.getVetoableChangeListeners("beanContext");
        i = 0;
        j = 0;
        while (i < origVCL.length) {
            if (origVCL[i] instanceof Serializable) {
                ...
                if (origVCL[i] instanceof MockVetoableChangeListenerS) {
                    assertEquals(((MockVetoableChangeListenerS) origVCL[i]).id, ((MockVetoableChangeListenerS) serVCL[j]).id);
                }
                i++;
                j++;
            } else {
    ...
    public void testSetBeanContextBeanContextWithPropertyVetoException() throws Exception {
        ...
        myBeanContextChildSupport.removeVetoableChangeListener("beanContext", vcl);
        myBeanContextChildSupport.setBeanContext(beanContext);
        assertTrue(myBeanContextChildSupport.getRejectedSetBCOnce());
