...
public abstract class AbstractLibraryProperty extends AbstractSimpleObject implements java.io.Serializable {
    ...
    public boolean equals(Object other) {
        ...
        return ((this.getType() == castOther.getType()) || (this.getType() != null && castOther.getType() != null && this.getType().equals(castOther.getType()))) && ((this.getLibrary() == castOther.getLibrary()) || (this.getLibrary() != null && castOther.getLibrary() != null && this.getLibrary().equals(castOther.getLibrary()))) && (this.getRank() == castOther.getRank());
    }
