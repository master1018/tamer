...
/**
 * <p>
 * The {@link co.edu.unal.ungrid.image.dicom.core.Attribute Attribute} class is
 * an abstract class that contains the core functionality for storing, accessing
...
public abstract class Attribute {
    ...
    /**
	 * @uml.property name="valueLength"
	 */
    protected long valueLength;

    /**
	 * @uml.property name="valueMultiplicity"
	 */
    ...
    public String getValueRepresentationAsString() {
        return ValueRepresentation.getAsString(getValueRepresentation());
    }
	 ...
	 */
    public long getPaddedValueLength() {
        return valueLength;
    }
	 ...
	 *                thrown if values are not available (such as not supported
	 *                for this concrete attribute class)
	 */
    public String[] getOriginalStringValues() throws DicomException {
        throw new DicomException("internal error - wrong value type for attribute " + tag);
    }
	 ...
	 *            value to add
	 * @exception DicomException
	 *                thrown if value of this type is not valid for this
	 *                concrete attribute class
	 */
	 ...
	 * @exception DicomException
	 *                thrown if values of this type are not valid for this
	 *                concrete attribute class
	 */
    ...
    public void removeValues() throws DicomException {
        throw new DicomException("internal error - removeValues() not implemented for attribute " + tag);
    }
	 ...
	 * 
	 * <p>
	 * Writes the tag, VR (if explicit in the output stream) and the value
	 * length in the appropriate form.
	 * </p>
	 * 
	 * <p>
    ...
    protected void writeBase(DicomOutputStream o) throws IOException {
        ...
        if (o.isExplicitVR()) {
            byte[] vr = getValueRepresentation();
            o.write(vr, 0, 2);
            if (ValueRepresentation.isShortValueLengthVR(vr)) {
                o.writeUnsigned16((int) getPaddedValueLength());
            } else {
                o.writeUnsigned16(0);
                o.writeUnsigned32(getPaddedValueLength());
            }
        } else {
            o.writeUnsigned32(getPaddedValueLength());
        }
	 ...
	 * @exception DicomException
	 */
    public abstract void write(DicomOutputStream os) throws DicomException, IOException;
	 ...
	 * 
	 * @param dictionary
	 *            the dictionary to use to look up the name
    ...
    public String toString(DicomDictionary dictionary) {
        ...
        str.append(" VR=<");
        str.append(getValueRepresentationAsString());
        str.append("> VL=<0x");
        str.append(Long.toHexString(getValueLength()));
        str.append(">");
        return str.toString();
    }
	 ...
	 * 
	 * <p>
	 * If there is an exception trying to fetch the value, the supplied default
	 * is returned.
	 * </p>
	 * 
	 * <p>
    ...
    public String getSingleStringValueOrEmptyString() {
        return getSingleStringValueOrDefault("");
    }
    ...
    public String getSingleStringValueOrEmptyString(NumberFormat format) {
        return getSingleStringValueOrDefault("", format);
    }
	 ...
	 * 
	 * <p>
	 * If there is an exception trying to fetch the value, <code>null</code>
	 * is returned.
	 * </p>
	 * 
	 * <p>
    ...
    public String getSingleStringValueOrNull(NumberFormat format) {
        return getSingleStringValueOrDefault(null, format);
    }
    ...
    public String getDelimitedStringValuesOrEmptyString() {
        return getDelimitedStringValuesOrDefault("");
    }
    ...
    public String getDelimitedStringValuesOrEmptyString(NumberFormat format) {
        return getDelimitedStringValuesOrDefault("", format);
    }
	 ...
	 * 
	 * <p>
	 * If there is an exception trying to fetch the values, <code>null</code>
	 * is returned.
	 * </p>
	 * 
	 * <p>
    ...
    public String getDelimitedStringValuesOrNull(NumberFormat format) {
        return getDelimitedStringValuesOrDefault(null, format);
    }
