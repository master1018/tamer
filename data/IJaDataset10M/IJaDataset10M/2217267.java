...
public class DjVuBean extends Panel implements PropertyChangeListener, DjVuInterface, java.io.Serializable, Runnable {
                ...
                synchronized (this) {
                    ...
                    if (retval == null) {
                        ...
                        try {
                            ...
                            retval = new DjVuImage(pageArray, stringToBoolean(properties.getProperty("zoomfast"), false), zoom, getViewportSize());
        ...
        if (mode != this.mode.intValue()) {
            synchronized (this) {
                if (mode != this.mode.intValue()) {
                    ...
                    this.mode = (mode != LAST_MODE) ? (new Integer(mode)) : getLastMode();
   ...
   */
    public void setPage(final int page) {
        if (page != getPage()) {
            ...
            if (image != null) {
                prevPage = stringToBoolean(properties.getProperty("cache"), DjVuObject.hasReferences) ? image.getDjVuPage(image.getIndexMax() - 1) : null;
            }
            int zoom = this.zoom;
            if (zoom == 0) {
                zoom = 100;
            ...
            defereRepaint = true;
            try {
                int xpage = Math.max(1, Math.min(page, getDocumentSize()));
   ...
   */
    public void setPageString(final String page) {
        if (FIRST_PAGE.equals(page)) {
            ...
            try {
                setPage(Integer.parseInt((space > 0) ? s.substring(0, space) : s));
   ...
   */
    public void setSearchMask(final int mask) {
        if (mask == -1) {
            change.firePropertyChange("searchMask", new Integer(-1), searchMask);
   ...
   */
    public void setSearchText(final String searchText) {
        if ((this.searchText != searchText) && ((searchText == null) || !searchText.equals(this.searchText))) {
   ...
   */
    public Runnable getTextSearchObject() {
        ...
        if (retval == null) {
            textSearchObject = retval = (Runnable) createAddOn("com.lizardtech.djvubean.text.TextSearch");
        }
        return retval;
    }
   ...
   */
    public void setURL(final URL url) throws IOException {
        ...
        if ((oldURL != url) && ((url == null) || !url.equals(oldURL))) {
            ...
            setPageString(this.properties.getProperty("page", page.toString()));
            this.zoom = 0;
            setZoom(this.properties.getProperty("zoom", ZOOM100));
            setPageLayout(this.properties.getProperty("pagelayout", PAGE_LAYOUT_LIST[SINGLE_PAGE_LAYOUT]));
   ...
   */
    public Component getOutline() {
        ...
        if (retval == null) {
            outline = retval = (Component) createAddOn("com.lizardtech.djvubean.outline.OutlineScrollPane");
        }
        return retval;
    }
   ...
   */
    public void setPropertyName(final String name) {
        ...
        if ("page".equalsIgnoreCase(name)) {
            setPageString(properties.getProperty("page", page.toString()));
        } else if ("zoom".equalsIgnoreCase(name)) {
            setZoom(properties.getProperty("zoom", getZoom()));
        } else if ("mousemode".equalsIgnoreCase(name)) {
            setMode(properties.getProperty("mousemode", Integer.toString(getMode())));
        } else if ("pagelayout".equalsIgnoreCase(name)) {
            setPageLayout(properties.getProperty("pagelayout", getPageLayout()));
        }
    }
   ...
   */
    public Component getToolbar() {
        ...
        if (retval == null) {
            toolBar = retval = (Component) createAddOn("com.lizardtech.djvubean.toolbar.Toolbar");
        }
        return retval;
    }
   ...
   */
    public Dimension getViewportSize() {
        ...
        return (retval == null) ? getSize() : retval;
    }
    ...
    public void setZoom(final String zoom) {
        if (!getZoom().equals(zoom)) {
            ...
            if (percent > 0) {
                ...
                final int scale = (this.zoom <= 0) ? Math.min(getXScale(), getYScale()) : this.zoom;
                int nscale;
                if (scale >= 1051) {
                    nscale = 1200;
                } else if (scale >= 370) {
                ...
                final int scale = (this.zoom <= 0) ? Math.max(getXScale(), getYScale()) : this.zoom;
                int nscale;
                if (scale < 60) {
                    nscale = 25;
                } else if (scale < 85) {
        ...
        try {
            ...
            if ("status".equalsIgnoreCase(name)) {
                ...
                if ((oldText != text) && ((oldText == null) || !oldText.equals(text))) {
                    textArea.setText((text != null) ? text : NILL);
                    textArea.repaint();
   ...
   */
    public static boolean stringToBoolean(final String value, final boolean retval) {
        try {
   ...
   */
    public Object createAddOn(final String name) {
        try {
            ...
            final Constructor addOnConstructor = addOnClass.getConstructor(properties);
   ...
   */
    public void paintComponent(Graphics g) {
        if (isShowing()) {
            ...
            try {
                final Rectangle scrollPaneBounds = new Rectangle(getScrollPosition(), getViewportSize());
                final DjVuImage image = getImage();
                if (image == null) {
                    try {
                        Thread.sleep(20L);
                ...
                if ((select.width > 1) && (select.height > 1)) {
                    if (useXOR) {
                        ...
                        if ((select.width > 3) && (select.height > 3)) {
                            g.drawRect(select.x + 1, select.y + 1, select.width - 2, select.height - 2);
                        }
                    }
                    g.setPaintMode();
   ...
   */
    public void recursiveRevalidate() {
        invalidate();
        try {
            for (Component component = this; (component != null) && (component.isShowing()); component = component.getParent()) {
                component.validate();
            }
        } catch (final Throwable ignored) {
        }
        ...
        if ((bounds != null) && (!bounds.isEmpty()) && isShowing()) {
            try {
                ...
                if (scrollPaneBounds.intersects(bounds)) {
                    repaint(20L, bounds.x - scrollPaneBounds.x, bounds.y - scrollPaneBounds.y, bounds.width, bounds.height);
                }
            } catch (final Throwable exp) {
                exp.printStackTrace(DjVuOptions.err);
                System.gc();
   ...
   */
    public void scaleScrollPosition(final int owidth, final int oheight, final int nwidth, final int nheight) {
        final Point scrollPosition = getScrollPosition();
        final Dimension viewportSize = getViewportSize();
        final long xmid2 = (2L * scrollPosition.x) + viewportSize.width;
        final long x2 = ((xmid2 * nwidth) / owidth) - viewportSize.width;
        final long ymid2 = (2L * scrollPosition.y) + viewportSize.height;
        final long y2 = ((ymid2 * nheight) / oheight) - viewportSize.height;
   ...
   */
    public void zoomSelect() {
        ...
        if ((select.width > 0) && (select.height > 0)) {
            ...
            setScrollPosition(borderNW.width + (((int) (((x0 + width) * s) - (double) scrollPaneSize.width)) / 2), borderNW.height + (((int) (((y0 + height) * s) - (double) scrollPaneSize.height)) / 2));
        }
        setSelect(null);
    }
   ...
   */
    protected Object invokeMethod(final Object component, final String[] methodName, final Class[] parms, final Object[] args) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        Object retval = null;
        for (int i = 0; i < methodName.length; ) {
            try {
                Method method = component.getClass().getMethod(methodName[i++], parms);
   ...
   */
    protected Object invokeParentsMethod(final String[] methodName, final Class[] parms, final Object[] args, int maxDepth) {
        Object retval = null;
        for (Component parent = getParent(); (parent != null) && (maxDepth-- > 0); parent = parent.getParent()) {
            try {
   ...
   */
    private void zoom(int zoom) {
        ...
        try {
            ...
            if (notRecursive) {
                change.firePropertyChange("zoom", oldZoom, getZoom());
                oldZoom = null;
                defereRepaint = false;
            }
        }
