...
/**
 * Records information needed to make a remote call. The information consists of
 * the endpoint, client subject, requirement for client authentication,
...
class CallContext extends Utilities implements OutboundRequestHandle {
    ...
    /**
	 * The principals in the client subject that may be used for authentication,
	 * or null if the client is anonymous.
	 */
    ...
    CallContext(Endpoint endpoint, SslEndpointImpl endpointImpl, Subject clientSubject, boolean clientAuthRequired, Set clientPrincipals, Set serverPrincipals, List cipherSuites, boolean integrityRequired, boolean integrityPreferred, long connectionTime) {
        ...
        this.cipherSuites = (String[]) cipherSuites.toArray(new String[cipherSuites.size()]);
    ...
    public String toString() {
        ...
        if (clientSubject == null) {
            ...
            buff.append("Subject@");
            buff.append(Integer.toHexString(System.identityHashCode(clientSubject)));
        }
