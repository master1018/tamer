...
public class FormUtils {
     ...
     *            The supported character encoding.
     */
    public static void getParameters(Logger logger, String query, Map<String, Object> parameters, CharacterSet characterSet) throws IOException {
    ...
    public static Parameter getFirstParameter(Logger logger, String query, String name, CharacterSet characterSet) throws IOException {
        return new FormReader(logger, query, characterSet).readFirstParameter(name);
    }
    ...
    public static Parameter create(CharSequence name, CharSequence value, CharacterSet characterSet) throws IOException {
        ...
        if (name != null) {
            if (value != null) {
                result = new Parameter(Reference.decode(name.toString(), characterSet), Reference.decode(value.toString(), characterSet));
            } else {
                result = new Parameter(Reference.decode(name.toString(), characterSet), null);
            }
        }
        return result;
    }
