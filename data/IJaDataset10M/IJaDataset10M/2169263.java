...
public class PersistenceInvariantDescriptor<I, G> implements Iterable<Entry<Integer, List<ObjectObjectPair<I, G>>>> {
    ...
    public boolean equals(Object obj) {
        ...
        if (generators == null) {
            if (other.generators != null) return false;
        } else if (!mapSetEquals(this.generators, other.generators)) return false;
        if (intervalGeneratorPairs == null) {
            if (other.intervalGeneratorPairs != null) return false;
        } else if (!mapSetEquals(this.intervalGeneratorPairs, other.intervalGeneratorPairs)) return false;
        if (intervals == null) {
            if (other.intervals != null) return false;
        } else if (!mapSetEquals(this.intervals, other.intervals)) return false;
        return true;
    }
