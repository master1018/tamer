...
public final class Arguments {
     ...
     */
    public Arguments(final Configuration configuration, final TemplateParser templateParser, final String templateName, final IContext context) {
        super();
     ...
     */
    public Arguments(final Configuration configuration, final TemplateParser templateParser, final String templateName, final IContext context, final Map<String, Object> localVariables, final SelectionTarget selectionTarget, final Map<String, Integer> idCounts, final ITextInliner textInliner) {
        super();
        this.configuration = configuration;
        this.templateParser = templateParser;
        this.templateName = templateName;
    ...
    public Arguments addLocalVariables(final Map<String, Object> newVariables) {
        ...
        final Arguments arguments = new Arguments(this.configuration, this.templateParser, this.templateName, this.context, Collections.unmodifiableMap(cloneLocalVariables), this.selectionTarget, this.idCounts, this.textInliner);
        return arguments;
    }
    ...
    public Arguments setSelectionTarget(final Object target) {
        final Arguments arguments = new Arguments(this.configuration, this.templateParser, this.templateName, this.context, this.localVariables, new SelectionTarget(target), this.idCounts, this.textInliner);
        return arguments;
    }
    ...
    public Arguments addLocalVariablesAndSetSelectionTarget(final Map<String, Object> newVariables, final Object target) {
        ...
        cloneLocalVariables.putAll(this.localVariables);
        cloneLocalVariables.putAll(newVariables);
        final Arguments arguments = new Arguments(this.configuration, this.templateParser, this.templateName, this.context, Collections.unmodifiableMap(cloneLocalVariables), new SelectionTarget(target), this.idCounts, this.textInliner);
        return arguments;
    }
    ...
    public Arguments setTextInliner(final ITextInliner newTextInliner) {
        final Arguments arguments = new Arguments(this.configuration, this.templateParser, this.templateName, this.context, this.localVariables, this.selectionTarget, this.idCounts, newTextInliner);
        return arguments;
    }
    ...
    public Arguments addLocalVariablesAndTextInliner(final Map<String, Object> newVariables, final ITextInliner newTextInliner) {
        ...
        cloneLocalVariables.putAll(this.localVariables);
        cloneLocalVariables.putAll(newVariables);
        final Arguments arguments = new Arguments(this.configuration, this.templateParser, this.templateName, this.context, Collections.unmodifiableMap(cloneLocalVariables), this.selectionTarget, this.idCounts, newTextInliner);
        return arguments;
    }
    ...
    public Arguments setTextInlinerAndSetSelectionTarget(final ITextInliner newTextInliner, final Object target) {
        final Arguments arguments = new Arguments(this.configuration, this.templateParser, this.templateName, this.context, this.localVariables, new SelectionTarget(target), this.idCounts, newTextInliner);
        return arguments;
    }
    ...
    public Arguments addLocalVariablesAndTextInlinerAndSetSelectionTarget(final Map<String, Object> newVariables, final ITextInliner newTextInliner, final Object target) {
        ...
        cloneLocalVariables.putAll(this.localVariables);
        cloneLocalVariables.putAll(newVariables);
        final Arguments arguments = new Arguments(this.configuration, this.templateParser, this.templateName, this.context, Collections.unmodifiableMap(cloneLocalVariables), new SelectionTarget(target), this.idCounts, newTextInliner);
        return arguments;
    }
