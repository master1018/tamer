...
public class ImageOverlay extends OverlayBase {
     ...
     */
    public ImageOverlay(Canvas3D canvas, Dimension size, BufferedImage image) {
     ...
     * @param image The image to display
     */
    public ImageOverlay(Canvas3D canvas, Dimension size, boolean clipAlpha, boolean blendAlpha, BufferedImage image) {
