...
public class SienaMainPanel extends JFrame implements MainPanel, EventBrokerListener {
    ...
    public SienaMainPanel(final boolean loadLastFile) {
        ...
        if (loadLastFile && this.mruList.size() > 0) {
            final File schemaFile = new File(this.mruList.get(this.mruList.size() - 1));
    ...
    protected void createDiagramEditingView() {
        ...
        this.temporalControls = new TemporalControlsPanel(this.diagramEditingView.getDiagramView(), this.diagramExportSettings, this.eventBroker);
        final boolean temporalControlsEnabled = preferences.getBoolean("temporalControlsEnabled", false);
        ...
        this.diagramEditingView.setExtraContextMenuActions(new DiagramEditingView.DiagramAction[] { new DiagramEditingView.DiagramAction() {

            public void actionPerformed(final ActionEvent e, final Diagram2D diagram) {
        ...
        this.diagramEditingView.getDiagramView().getController().getEventBroker().subscribe(this, DisplayedDiagramChangedEvent.class, Object.class);
        final DiagramView diagramView = this.diagramEditingView.getDiagramView();
        diagramView.getController().getEventBroker().subscribe(new ObjectEditingLabelViewPopupMenuHandler(diagramView), CanvasItemContextMenuRequestEvent.class, ObjectLabelView.getFactory().getLabelClass());
    ...
    private void insertDiagramIntoView(final Diagram2D<FCAElement, FCAElement> diagram, final boolean nestDiagram) {
        ...
        if (nestDiagram && oldDiagram != null) {
            final Iterator oldObjectSetIterator = oldDiagram.getTopConcept().getExtentIterator();
            ...
            for (final Iterator<FCAElement> iter = oldObjects.iterator(); iter.hasNext(); ) {
        ...
        final ConceptInterpretationContext context = new ConceptInterpretationContext(diagramHistory, new EventBroker());
        this.diagramEditingView.getDiagramView().setConceptInterpretationContext(context);
    }

    private Diagram2D extendDiagram(final Diagram2D oldDiagram, final Object newObject) {
        ...
        return NDimLayoutOperations.createDiagram(lgen.createLattice(context), oldDiagram.getTitle(), new DefaultDimensionStrategy());
    }
    ...
    private void editObject(final int row) {
        ...
        final WritableFCAElement object = (WritableFCAElement) objectList.get(row);
    ...
    private void editAttribute(final int column) {
        ...
        final Frame tFrame = JOptionPane.getFrameForComponent(this.tableView);
        final List<ManyValuedAttribute> manyValuedAttributeList = manyValuedContext.getAttributes();
        final WritableManyValuedAttribute attribute = (WritableManyValuedAttribute) manyValuedAttributeList.get(column);
    ...
    private JToolBar createContextToolbar() {
        ...
        addObjectButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                final WritableManyValuedContext manyValuedContext = SienaMainPanel.this.conceptualSchema.getManyValuedContext();
    ...
    public void createMenuBar() {
        ...
        final NewConceptualSchemaActivity newSchemaActivity = new NewConceptualSchemaActivity(this.eventBroker);
        ...
        final SimpleAction newAction = new SimpleAction(this, newSchemaActivity, "New", KeyEvent.VK_N, KeyStroke.getKeyStroke(KeyEvent.VK_N, ActionEvent.CTRL_MASK));
        final JMenuItem newMenuItem = new JMenuItem("New");
        newMenuItem.setMnemonic(KeyEvent.VK_N);
        newMenuItem.addActionListener(newAction);
        this.fileMenu.add(newMenuItem);
        final LoadConceptualSchemaActivity loadSchemaActivity = new LoadConceptualSchemaActivity(this.eventBroker);
        loadSchemaActivity.setTestOpenOkActivity(testSchemaSavedActivity);
        final OpenFileAction openFileAction = new OpenFileAction(this, loadSchemaActivity, this.currentFile, KeyEvent.VK_O, KeyStroke.getKeyStroke(KeyEvent.VK_O, ActionEvent.CTRL_MASK));
        ...
        if (this.saveAsFileAction == null) {
            this.saveAsFileAction = new SaveFileAction(this, this.saveActivity, KeyEvent.VK_S, KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.CTRL_MASK));
        }
        ...
        final JMenuItem importCernatoXMLItem = new JMenuItem("Import Cernato XML...");
        ...
        final JMenuItem importBurmeisterItem = new JMenuItem("Import Burmeister Format...");
        ...
        final JMenuItem importOALItem = new JMenuItem("Import Object Attribute List...");
        ...
        if (this.diagramExportSettings != null) {
            ...
            this.exportDiagramAction = new ExportDiagramAction(frame, this.diagramExportSettings, this.diagramEditingView.getDiagramView(), KeyEvent.VK_E, KeyStroke.getKeyStroke(KeyEvent.VK_E, ActionEvent.CTRL_MASK));
        ...
        exitMenuItem.addActionListener(new SimpleAction(this, new CloseMainPanelActivity(this), "Exit", KeyEvent.VK_X, KeyStroke.getKeyStroke(KeyEvent.VK_F4, ActionEvent.ALT_MASK)));
        ...
        this.showExactMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.CTRL_MASK));
        ...
        this.showAllMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.CTRL_MASK + ActionEvent.SHIFT_MASK));
        ...
        final Collection<DiagramSchema> colorSchemas = DiagramSchema.getSchemas();
        for (final DiagramSchema schema : colorSchemas) {
            final JRadioButtonMenuItem colorSchemaItem = new JRadioButtonMenuItem(schema.getName());
        ...
        viewMenu.addSeparator();
        final JCheckBoxMenuItem showTemporalControls = new JCheckBoxMenuItem("Show Temporal Controls");
        ...
        showTemporalControls.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                final boolean newState = !SienaMainPanel.this.temporalControls.isVisible();
    ...
    private void addQueryMenuItem(final Query query, final JMenu viewMenu, final ButtonGroup labelContentGroup, final int mnemonic) {
    ...
    private void importCernatoXML() throws IOException {
        ...
        openDialog.setFileFilter(new ExtensionFileFilter(new String[] { "xml" }, "Cernato XML Files"));
    ...
    private WritableManyValuedContext createManyValuedContext(final CernatoModel cernatoModel) {
        ...
        for (final Iterator it = types.iterator(); it.hasNext(); ) {
            ...
            final org.tockit.cernatoXML.model.Value[] valueRange = cernatoType.getValueRange();
            Datatype targetType;
            if (cernatoType instanceof NumericalType) {
                ...
                final DecimalType decType = DecimalType.createDecimalType(numType.getName(), min.getValue(), max.getValue(), numType.getNumberOfDecimals());
                targetType = decType;
            } else if (cernatoType instanceof TextualType) {
                final String[] stringValues = new String[valueRange.length];
                final TextualType textType = new TextualType(cernatoType.getName());
                ...
                targetType = StringType.createEnumerationRestrictedType(textType.getName(), stringValues);
            } else {
        ...
        for (final Iterator it = properties.iterator(); it.hasNext(); ) {
            ...
            final ManyValuedAttributeImplementation attribute = new ManyValuedAttributeImplementation(attributeType, property.getName());
        ...
        for (final Iterator it = objects.iterator(); it.hasNext(); ) {
            ...
            final FCAElementImplementation targetObject = new FCAElementImplementation(cernatoObject.getName());
        ...
        for (final Iterator objIt = objects.iterator(); objIt.hasNext(); ) {
            ...
            for (final Iterator propIt = properties.iterator(); propIt.hasNext(); ) {
                final Property property = (Property) propIt.next();
                final org.tockit.cernatoXML.model.Value value = cernatoContext.getRelationship(cernatoObject, property);
                final FCAElement targetObject = objectMap.get(cernatoObject);
                final ManyValuedAttribute attribute = attributeMap.get(property);
                if (value instanceof NumericalValue) {
                    ...
                    throw new RuntimeException("Unknown Cernato value for relationship between " + "object '" + cernatoObject.getName() + "' and " + "property '" + property.getName() + "'");
                }
            }
        }
        return result;
    ...
    private void importBurmeister() {
        ...
        final JRadioButton keepSchemaButton = new JRadioButton("Extend existing schema");
        keepSchemaButton.setSelected(true);
        final JRadioButton newSchemaButton = new JRadioButton("Create new schema");
        ...
        schemaOptionPanel.add(keepSchemaButton, new GridBagConstraints(0, 0, 1, 1, 1, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 2, 2));
        schemaOptionPanel.add(newSchemaButton, new GridBagConstraints(0, 1, 1, 1, 1, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 5, 5, 5), 2, 2));
        schemaOptionPanel.add(new JPanel(), new GridBagConstraints(0, 2, 1, 1, 1, 1, GridBagConstraints.NORTHWEST, GridBagConstraints.BOTH, new Insets(0, 5, 5, 5), 2, 2));
        openDialog.setAccessory(schemaOptionPanel);
        openDialog.setFileFilter(new ExtensionFileFilter(new String[] { "cxt" }, "Context Files"));
        openDialog.setApproveButtonText("Import");
        final int rv = openDialog.showOpenDialog(this);
        if (rv != JFileChooser.APPROVE_OPTION) {
            return;
    ...
    private void importBurmeister(final File file) {
        ...
        addDiagram(this.conceptualSchema, context, context.getName(), new DefaultDimensionStrategy());
    }
    ...
    private void importObjectAttributeList() {
        ...
        schemaOptionPanel.add(new JPanel(), new GridBagConstraints(0, 2, 1, 1, 1, 1, GridBagConstraints.NORTHWEST, GridBagConstraints.BOTH, new Insets(0, 5, 5, 5), 2, 2));
        openDialog.setAccessory(schemaOptionPanel);
        openDialog.setFileFilter(new ExtensionFileFilter(new String[] { "oal" }, "Object Attribute Lists"));
        openDialog.setApproveButtonText("Import");
        final int rv = openDialog.showOpenDialog(this);
        if (rv != JFileChooser.APPROVE_OPTION) {
            return;
    ...
    private void addDiagrams(final ConceptualSchema schema, final CernatoModel cernatoModel) {
        ...
        for (final Iterator iterator = views.iterator(); iterator.hasNext(); ) {
            ...
            final ViewContext viewContext = new ViewContext(cernatoModel.getContext(), view);
            final Context mappedContext = new ContextImplementation();
            final BinaryRelationImplementation mappedRelation = (BinaryRelationImplementation) mappedContext.getRelation();
            ...
            for (final Object element : viewContext.getObjects()) {
                ...
                final FCAElement newObject = new FCAElementImplementation(object.getName());
            ...
            for (final Object element : viewContext.getAttributes()) {
                ...
                final FCAElement newAttribute = new FCAElementImplementation(criterion);
            ...
            addDiagram(schema, mappedContext, view.getName(), new CernatoDimensionStrategy());
        }
    }

    private void addDiagram(final ConceptualSchema schema, final Context context, final String name, final DimensionCreationStrategy dimensionStrategy) {
        try {
            final LatticeGenerator lgen = new GantersAlgorithm();
            final Lattice lattice = lgen.createLattice(context);
            final Diagram2D diagram = NDimLayoutOperations.createDiagram(lattice, name, dimensionStrategy);
            schema.addDiagram(diagram);
        } catch (final Exception e) {
            ErrorDialog.showError(this, e, "Diagram creation failed", "Could not create diagram \"" + name + "\"");
        }
    }
    ...
    public void closeMainPanel() {
        ...
        if (this.lastCernatoFile != null) {
            preferences.put("lastCernatoImport", this.lastCernatoFile.getAbsolutePath());
        }
        if (this.lastBurmeisterFile != null) {
            preferences.put("lastBurmeisterImport", this.lastBurmeisterFile.getAbsolutePath());
        }
        if (this.lastOALFile != null) {
            preferences.put("lastOALImport", this.lastOALFile.getAbsolutePath());
        }
        if (this.lastCSCFile != null) {
            preferences.put("lastCSCImport", this.lastCSCFile.getAbsolutePath());
        }
        preferences.putBoolean("temporalControlsEnabled", this.temporalControls.isVisible());
    ...
    public void processEvent(final Event e) {
        ...
        this.exportDiagramAction.setEnabled((this.diagramEditingView.getDiagramView().getDiagram() != null) && (this.diagramExportSettings != null));
    ...
    private void updateWindowTitle() {
        if (this.currentFile != null) {
            final String filename = this.currentFile.getName().substring(0, this.currentFile.getName().length() - 4);
    ...
    private void recreateMruMenu() {
        ...
        if (this.mruList.size() > 0) {
            final ListIterator<String> it = this.mruList.listIterator(this.mruList.size());
            while (it.hasPrevious()) {
                final String cur = it.previous();
                if (this.currentFile != null && cur.equals(this.currentFile.getAbsolutePath())) {
                    continue;
                }
                empty = false;
    ...
    private WritableManyValuedContext createManyValuedContextFromDiagrams() {
        ...
        final StringType type = StringType.createEnumerationRestrictedType("single valued", new String[] { "X" });
        mvContext.add(type);
        for (final Iterator<Diagram2D> iter = this.conceptualSchema.getDiagramsIterator(); iter.hasNext(); ) {
            final Diagram2D diagram = iter.next();
            final Context svContext = DiagramToContextConverter.getContext(diagram);
            ...
            for (final Iterator<Object> attrIt = svContext.getAttributes().iterator(); attrIt.hasNext(); ) {
                final FCAElement attribute = (FCAElement) attrIt.next();
                final ManyValuedAttribute mvAttribute = new ManyValuedAttributeImplementation(type, attribute.getData().toString());
                mvContext.add(mvAttribute);
                attributeMap.put(attribute, mvAttribute);
            }
            for (final Iterator<Object> objIt = svContext.getObjects().iterator(); objIt.hasNext(); ) {
    ...
    private int showFileChangedDialog() {
        ...
        return JOptionPane.showOptionDialog(this, "The conceptual schema has been modified. Do you want to save the changes?", "Schema changed", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[2]);
    }
    ...
    private void ensureObjectSetConsistency() {
        ...
        for (final Iterator<Diagram2D> diagIt = this.conceptualSchema.getDiagramsIterator(); diagIt.hasNext(); ) {
            final Diagram2D diagram = diagIt.next();
            final Concept concept = diagram.getTopConcept();
            for (final Iterator concIt = concept.getExtentIterator(); concIt.hasNext(); ) {
        ...
        for (final Iterator<Diagram2D> diagIt = this.conceptualSchema.getDiagramsIterator(); diagIt.hasNext(); ) {
            ...
            for (final Iterator<FCAElement> extIt = concept.getExtentIterator(); extIt.hasNext(); ) {
            ...
            if (concept.getAttributeContingentSize() != 0) {
                ...
                final ConceptImplementation oldTopConcept = (ConceptImplementation) topNode.getConcept();
                ...
                final DiagramNode newTop = new NDimDiagramNode(diagram, "new top", new double[diagram.getBase().size()], concept, null, new LabelInfo(), null);
                for (final Iterator<DiagramNode> nodeIt = diagram.getNodes(); nodeIt.hasNext(); ) {
                    ...
                    final ConceptImplementation curConcept = (ConceptImplementation) node.getConcept();
    ...
    protected void showNumericInputDialog(final WritableManyValuedAttribute attribute, final WritableFCAElement obj) {
        ...
        final String value = (String) JOptionPane.showInputDialog(this, "Enter Value", "Edit Value", JOptionPane.PLAIN_MESSAGE, null, null, content);
        if (value != null) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Enter numbers only.", "Warning", JOptionPane.WARNING_MESSAGE);
