...
public class MenubarBuilder extends UIComposer<JMenuBar> {
    ...
    protected void composeDrawingMenu() {
        drawingMenu = new MMenu(LangTool.INSTANCE.getStringLaTeXDrawFrame("LaTeXDrawFrame.91"), true);
    ...
    protected void composeEditMenu() {
        editMenu = new MMenu(LangTool.INSTANCE.getStringLaTeXDrawFrame("LaTeXDrawFrame.89"), true);
    ...
    protected void composeHelpMenu() {
        helpMenu = new MMenu(LangTool.INSTANCE.getStringLaTeXDrawFrame("LaTeXDrawFrame.93"), true);
    ...
    protected void composeDisplayMenu() {
        displayMenu = new MMenu(LangTool.INSTANCE.getStringLaTeXDrawFrame("LaTeXDrawFrame.90"), true);
