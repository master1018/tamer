...
public class BasicXMLEventParserContext extends AVListImpl implements XMLEventParserContext {
        ...
        this.addPropertyChangeListener(new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent propEvent) {
                ...
                if (notification.getEvent() != null) {
                    msg = Logging.getMessage(notification.getMessage(), notification.getEvent().toString(), notification.getEvent().getLocation().getLineNumber(), notification.getEvent().getLocation().getColumnNumber(), notification.getEvent().getLocation().getCharacterOffset());
                } else {
                    msg = Logging.getMessage(notification.getMessage(), "", "");
                }
                if (notification.getPropertyName().equals(XMLParserNotification.EXCEPTION)) Logging.logger().log(Level.WARNING, msg); else if (notification.getPropertyName().equals(XMLParserNotification.UNRECOGNIZED)) Logging.logger().log(Level.WARNING, msg);
            }
        });
    }
    ...
    public static boolean isEndElementEvent(XMLEvent event, XMLEvent startElement) {
        ...
        return (event.isEndElement() && event.asEndElement().getName().equals(startElement.asStartElement().getName()));
    }
