...
public class InternalDiskIndexIterator extends DiskIndexIteratorBase implements ResultSet<ByteRange, ByteRange> {
     ...
     */
    public InternalDiskIndexIterator(DiskIndex index, BlockReader blockIndexReader, byte[] from, byte[] to, boolean ascending, ByteBuffer[] maps) {
     ...
     */
    public InternalDiskIndexIterator(DiskIndex index, BlockReader blockIndexReader, byte[] from, byte[] to, boolean ascending, FileChannel[] dbFileChannels) {
