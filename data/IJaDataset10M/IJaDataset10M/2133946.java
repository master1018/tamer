...
public class PlayPenLabel extends DraggablePlayPenComponent {
    ...
    public static final List<Class<? extends SPObject>> allowedChildTypes = Collections.<Class<? extends SPObject>>singletonList(SPLabel.class);
    ...
    @Constructor
    public PlayPenLabel(@ConstructorParameter(parameterType = ParameterType.CHILD, propertyName = "label") SPLabel label, @ConstructorParameter(propertyName = "name") String name) {
        super(name);
            ...
            if ((evt.getModifiers() & MouseEvent.BUTTON1_MASK) != 0) {
                if (evt.getClickCount() == 2) {
                    if (isSelected()) {
                        ...
                        af.getEditLabelAction().actionPerformed(new ActionEvent(this, ActionEvent.ACTION_PERFORMED, PlayPen.ACTION_COMMAND_SRC_PLAYPEN));
                    }
                } else {
