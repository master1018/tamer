 ...
 */
public class PluginManagerConfigForm extends JPanel implements ConfigurationForm {
    ...
    public PluginManagerConfigForm() {
        ...
        pluginListScrollPane.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
    ...
    private class PluginListSelectionListener implements ListSelectionListener {
        ...
        public void valueChanged(ListSelectionEvent e) {
            ...
            Object sysBundleProp = selectedBundle.getHeaders().get("System-Bundle");
            if (sysBundleProp != null && sysBundleProp.equals("yes")) buttonsPanel.enableUninstallButton(false); else buttonsPanel.enableUninstallButton(true);
            if (selectedBundle.getState() == Bundle.ACTIVE) {
                if (sysBundleProp != null && sysBundleProp.equals("yes")) buttonsPanel.enableDesactivateButton(false); else buttonsPanel.enableDesactivateButton(true);
