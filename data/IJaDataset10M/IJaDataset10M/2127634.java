...
final class ShortViewBufferImpl extends ShortBuffer {
   ...
   */
    ...
    public ShortBuffer slice() {
        return new ShortViewBufferImpl(bb, (position() >> 1) + offset, remaining(), remaining(), 0, -1, readOnly, endian);
    }
    ...
    ShortBuffer duplicate(boolean readOnly) {
        ...
        int mark = position();
        position(pos);
        return new ShortViewBufferImpl(bb, offset, capacity(), limit(), pos, mark, readOnly, endian);
    }
