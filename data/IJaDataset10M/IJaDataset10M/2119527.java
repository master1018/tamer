...
public class InstrumentationTestRunnerTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        mInstrumentationTestRunner = new StubInstrumentationTestRunner(new StubContext("com.google.foo.tests"), new StubContext(mTargetContextPackageName), mStubAndroidTestRunner);
    }
    ...
    public void testOverrideTestToRunWithClassArgument() throws Exception {
        ...
        mInstrumentationTestRunner.onCreate(createBundle(InstrumentationTestRunner.ARGUMENT_TEST_CLASS, expectedTestClassName));
    ...
    public void testOverrideTestToRunWithClassAndMethodArgument() throws Exception {
        ...
        mInstrumentationTestRunner.onCreate(createBundle(InstrumentationTestRunner.ARGUMENT_TEST_CLASS, classAndMethod));
        assertTestRunnerCalledWithExpectedParameters(expectedTestClassName, expectedTestMethodName);
    }
    ...
    private static class StubInstrumentationTestRunner extends InstrumentationTestRunner {
        ...
        public StubInstrumentationTestRunner(Context context, Context targetContext, AndroidTestRunner androidTestRunner) {
