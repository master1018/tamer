...
public class ResetBasicData {
    ...
    public void deleteAll() {
        Ebean.execute(new TxRunnable() {
            ...
            public void run() {
                Ebean.createUpdate(OrderShipment.class, "delete from orderShipment").execute();
                Ebean.createUpdate(OrderDetail.class, "delete from orderDetail").execute();
                Ebean.createUpdate(Order.class, "delete from order").execute();
                Ebean.createUpdate(Contact.class, "delete from contact").execute();
                Ebean.createUpdate(Customer.class, "delete from Customer").execute();
