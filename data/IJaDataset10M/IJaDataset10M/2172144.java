...
public class WidgetDemo extends Demo implements ActionListener, ItemListener, MouseListener, ClipboardOwner {
    ...
    private void add(Component component, int gridx, int gridy, int gridwidth, int gridheight, int fill, int ipadx, int ipady, Insets insets, int anchor, double weightx, double weighty) {
        gbc.gridx = gridx;
        gbc.gridy = gridy;
