...
public class LinearBiasTest extends TestCase {
    ...
    Instance test0 = new Instance() {
        ...
        public OnePhaseModel getSubModel() {
            return new AsymmetricQuadraticModel(new Microsatellite(1, 4), null, new Parameter.Default(5.0), new Parameter.Default(3.0), new Parameter.Default(0.0), new Parameter.Default(5.0), new Parameter.Default(3.0), new Parameter.Default(0.0), false);
        }
        ...
        public double[] getExpectedPi() {
            return new double[] { 0.605108055009823, 0.324165029469548, 0.070726915520629, 0 };
        }

        public double[] getExpectedResult() {
            return new double[] { 0.946658398354944, 0.052177678283089, 0.001163923361967, 0, 0.097398332795100, 0.863963320210341, 0.038638346994560, 0, 0.009958010985717, 0.177092423725065, 0.812949565289218, 0, 0.000867275762735, 0.023191450073206, 0.212503945856679, 0.763437328307380 };
        }
    ...
    Instance test1 = new Instance() {
        ...
        public OnePhaseModel getSubModel() {
            return new AsymmetricQuadraticModel(new Microsatellite(1, 4), null, new Parameter.Default(2.0), new Parameter.Default(5.0), new Parameter.Default(1.0), new Parameter.Default(2.0), new Parameter.Default(5.0), new Parameter.Default(1.0), false);
        }
