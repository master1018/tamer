    ...
    private void createContents() {
        ...
        if (mAvdInfo != null) {
            ...
            if (mAvdInfo.getStatus() != AvdStatus.OK) {
                ...
                displayValue(c, "Target:", String.format("%s (API level %s)", target.getName(), version.getApiString()));
                ...
                if (properties != null) {
                    ...
                    if (copy.size() > 0) {
                        ...
                        l.setLayoutData(new GridData(GridData.FILL, GridData.CENTER, false, false, 2, 1));
