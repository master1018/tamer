...
public class ImageOutputStreamImplTest extends TestCase {
    ...
    public void testWriteChars() throws IOException {
        ...
        final BasicImageOutputStreamImpl out = new BasicImageOutputStreamImpl(2 * buff.length);
        final ImageInputStream in = new BasicImageInputStreamImpl(out.buff);
        out.writeChars("test");
    ...
    public void testWriteShorts() throws IOException {
        ...
        final BasicImageOutputStreamImpl out = new BasicImageOutputStreamImpl(2 * dest.length);
        final ImageInputStream in = new BasicImageInputStreamImpl(out.buff);
    ...
    public void testWriteInts() throws IOException {
        ...
        final BasicImageOutputStreamImpl out = new BasicImageOutputStreamImpl(4 * dest.length);
        final ImageInputStream in = new BasicImageInputStreamImpl(out.buff);
    ...
    public void testWriteLongs() throws IOException {
        ...
        final BasicImageOutputStreamImpl out = new BasicImageOutputStreamImpl(8 * dest.length);
        final ImageInputStream in = new BasicImageInputStreamImpl(out.buff);
    ...
    public void testWriteUTF() throws IOException {
        final BasicImageOutputStreamImpl out = new BasicImageOutputStreamImpl(100);
        final ImageInputStream in = new BasicImageInputStreamImpl(out.buff);
        out.writeUTF("test");
    ...
    static class BasicImageOutputStreamImpl extends ImageOutputStreamImpl {
        ...
        public BasicImageOutputStreamImpl(final int capacity, final ByteOrder order) {
        ...
        public int read() throws IOException {
            bitOffset = 0;
            return (streamPos >= buff.length) ? -1 : (buff[(int) streamPos++] & 0xff);
        }
