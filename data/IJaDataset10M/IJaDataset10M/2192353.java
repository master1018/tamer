...
public class IntentFilter_AuthorityEntryTest extends AndroidTestCase {
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, method = "IntentFilter.AuthorityEntry", args = { java.lang.String.class, java.lang.String.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, method = "match", args = { android.net.Uri.class })
