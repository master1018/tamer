...
public class TimeSlotValue implements Cloneable {
    ...
    private static String format(Date date) {
        ...
        SimpleDateFormat dateFormat = TimeUtils.isCurrentDay(date) ? TimeSlotValue.HOURLY_FORMAT : TimeSlotValue.DAILY_FORMAT;
    ...
    public TimeSlotValue(Date start, Date stop, String description, Object timeSlotId, TaskValue taskValue) {
        this.start = start;
        this.stop = stop;
