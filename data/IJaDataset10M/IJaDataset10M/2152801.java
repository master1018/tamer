...
public class Radio extends Input {
    ...
    private static final IPropertyDescriptor[] pds = new IPropertyDescriptor[] { new StringPropertyDescriptor(PROMPT, "Prompt"), new BooleanPropertyDescriptor(SELECTION_STATE, "Selected"), new StringPropertyDescriptor(TEXT, "Text"), new IntegerPropertyDescriptor(WIDTH, "Width") };
    ...
    public Object getPropertyValue(Object propName) {
        if (SELECTION_STATE.equals(propName)) return isSelected(); else if (TEXT.equals(propName)) return getText();
        return super.getPropertyValue(propName);
    }

    @Override
    public void setPropertyValue(Object propName, Object val) {
        if (SELECTION_STATE.equals(propName)) setSelected((Boolean) val); else if (TEXT.equals(propName)) setText((String) val);
