package de.icehorsetools.iceoffice.workflow.timetable;
...
import de.icehorsetools.dataAccess.objects.Timetable;

public class TimetableDeleteWf extends ADefaultMessageBoxWorkflow {

    private static final Logger LOG = Logger.getLogger(TimetableDeleteWf.class);
    ...
    public boolean areObjectsValidForWorkflow(List xObjects, UnitOfWork xCurrentUnitOfWork) {
        return xObjects != null && xObjects.size() == 1 && xObjects.get(0) instanceof Timetable;
    }
