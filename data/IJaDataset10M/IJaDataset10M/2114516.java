...
public final class Wizard {
     ...
     */
    public static final int MODE_CAN_CONTINUE = WizardController.MODE_CAN_CONTINUE;
     ...
     */
    public static final int MODE_CAN_FINISH = WizardController.MODE_CAN_FINISH;
     ...
     */
    public static final int MODE_CAN_CONTINUE_OR_FINISH = WizardController.MODE_CAN_CONTINUE_OR_FINISH;
    ...
    private class ImplL implements WizardObserver {
        ...
        public void stepsChanged(Wizard wizard) {
            WizardObserver[] l = (WizardObserver[]) listeners.toArray(new WizardObserver[listeners.size()]);
