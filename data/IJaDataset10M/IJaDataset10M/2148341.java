...
public class LambertAzimuthalEqualArea extends CoordinateSystem {
    ...
    private static Unit[] default_reference_units = { CommonUnit.radian, CommonUnit.radian };
    ...
    public LambertAzimuthalEqualArea(RealTupleType reference, double R, double lon_center, double lat_center, double false_easting, double false_northing) throws VisADException {
        ...
        reference_units = reference.getDefaultUnits();
    ...
    public double[][] toReference(double[][] tuples) throws VisADException {
        ...
        return Unit.convertTuple(t_tuples, default_reference_units, reference_units);
    }
    ...
    public double[][] fromReference(double[][] tuples) throws VisADException {
        ...
        tuples = Unit.convertTuple(tuples, reference_units, default_reference_units);
        double t_tuples[][] = new double[2][n_tuples];
        ...
        for (int ii = 0; ii < n_tuples; ii++) {
            ...
            t_tuples[1][ii] = ksp * (cos_lat_o * sin_lat[ii] - sin_lat_o * cos_lat[ii] * cos_delta_lon[ii]) + false_northing;
        }
        delta_lon = null;
        sin_lat = null;
        cos_lat = null;
    ...
    public static void main(String args[]) throws VisADException {
        double[][] values_in = { { -90 * Data.DEGREES_TO_RADIANS, -85 * Data.DEGREES_TO_RADIANS, -80 * Data.DEGREES_TO_RADIANS, -75 * Data.DEGREES_TO_RADIANS }, { 42 * Data.DEGREES_TO_RADIANS, 42 * Data.DEGREES_TO_RADIANS, 42 * Data.DEGREES_TO_RADIANS, 42 * Data.DEGREES_TO_RADIANS } };
        ...
        CoordinateSystem lamaz_cs = new LambertAzimuthalEqualArea(Reference, earth_rad, lon_center, lat_center, false_easting, false_northing);
