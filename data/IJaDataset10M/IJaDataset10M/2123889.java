...
public abstract class ThreeEventOrderTest extends MultiStreamEventGenerator {
    ...
    protected String[] getResultColumnNames() {
        return new String[] { "stg1_id", "stg1_time", "stg2_id", "stg2_time", "stg3_id", "stg3_time" };
    }
    ...
    protected String getRQL() {
        ...
        String query = "select " + csv + "\n\n from" + "\n alert one_event.event_id as stg1_id, one_event.event_time as stg1_time," + " two_event.event_id as stg2_id, two_event.event_time as stg2_time," + " three_event.event_id as stg3_id, three_event.event_time as stg3_time" + "\n\n using stg1_event (partition store last 5 seconds) as one_event correlate on event_id," + " stg2_event (partition store last 5 seconds) as two_event correlate on event_id," + " stg3_event (partition store last 5 seconds) as three_event correlate on event_id" + "\n\n when present(one_event and two_event and three_event)" + "\n\n where stg1_time < stg2_time and stg1_time < stg3_time;";
    ...
    protected void verify(List<BatchResult> results) {
        ...
        for (BatchResult result : results) {
            ...
            for (Object[] objects : rows) {
                ...
                Assert.assertTrue((stg1TS.getTime() < stg2TS.getTime()), "Stage 2 arrived before/with Stage 1");
                Assert.assertTrue((stg1TS.getTime() < stg3TS.getTime()), "Stage 3 arrived before/with Stage 1");
                System.out.println();
            }
        }
