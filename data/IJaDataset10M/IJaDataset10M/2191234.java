...
public class ModulePrefs {
    ...
    public ModulePrefs(Element element, Uri base) throws SpecParserException {
        ...
        Set<ElementVisitor> visitors = ImmutableSet.of(new FeatureVisitor(), new PreloadVisitor(), new OAuthVisitor(), new IconVisitor(), new LocaleVisitor(), new LinkVisitor(), new ExtraElementsVisitor());
