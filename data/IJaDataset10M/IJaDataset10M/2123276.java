...
public class Anaconda extends PokerGame {
    ...
    private boolean passSelections[][];
    ...
    protected void mouseClick(String name, int x, int y) {
        ...
        if ((actionNum >= 2) && (actionNum <= 4)) {
            ...
            for (int cardNum = 0; cardNum < 7; cardNum++) {
                ...
                if ((x >= PokerApp.LOCATION[loc][0] + 30 * cardNum) && (x <= PokerApp.LOCATION[loc][0] + 30 * cardNum + width) && (y >= PokerApp.LOCATION[loc][1] + 15) && (y <= PokerApp.LOCATION[loc][1] + 23 + 96)) {
