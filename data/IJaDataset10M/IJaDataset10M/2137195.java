...
public class Fighter_Stonebody extends FighterSkill {
    ...
    public boolean okMessage(Environmental myHost, CMMsg msg) {
        ...
        if (msg.amITarget(mob) && (CMLib.flags().aliveAwakeMobile(mob, true)) && (msg.targetMinor() == CMMsg.TYP_DAMAGE) && ((msg.value()) > 0) && (msg.tool() != null) && (msg.tool() instanceof Weapon) && (mob.rangeToTarget() == 0) && ((mob.fetchAbility(ID()) == null) || proficiencyCheck(null, -85 + mob.charStats().getStat(CharStats.STAT_CONSTITUTION), false))) {
    ...
    public void executeMsg(Environmental myHost, CMMsg msg) {
        ...
        MOB mob = (MOB) affected;
        if ((msg.amITarget(mob)) && (msg.targetMinor() == CMMsg.TYP_DAMAGE) && (regain > 0)) {
            helpProficiency(mob);
            regain = -1;
        }
    }
