   ...
   */
    public void setS(UnionRule newS) {
        if (newS != s) {
            ...
            if (s != null) msgs = ((InternalEObject) s).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MDDPackage.QUANTIFIED_EXPRESSION__S, null, msgs);
            if (newS != null) msgs = ((InternalEObject) newS).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MDDPackage.QUANTIFIED_EXPRESSION__S, null, msgs);
            msgs = basicSetS(newS, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, MDDPackage.QUANTIFIED_EXPRESSION__S, newS, newS));
    }
