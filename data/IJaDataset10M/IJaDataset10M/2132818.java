...
public class FreeMarkerView extends AbstractTemplateView {
    ...
    protected Configuration autodetectConfiguration() throws BeansException {
        try {
            FreeMarkerConfig freemarkerConfig = (FreeMarkerConfig) BeanFactoryUtils.beanOfTypeIncludingAncestors(getApplicationContext(), FreeMarkerConfig.class, true, false);
