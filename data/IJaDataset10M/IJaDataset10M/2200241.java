...
public class ProxyUtil {
    ...
    public static Object newProxy(Class<?> clazz, InvocationHandler handler) {
        ...
        while (clazz != Object.class && (clazz.isSynthetic() || clazz.isAnonymousClass() || clazz.getName().startsWith("$Proxy") || Modifier.isFinal(clazz.getModifiers()) || Modifier.isNative(clazz.getModifiers()) || clazz == Proxy.class)) {
    ...
    public static boolean canMock(Class clazz) {
        ...
        if (clazz.isArray() || clazz.isEnum() || clazz.isAnonymousClass() || clazz.isSynthetic()) {
            return false;
        }
        if (USE_CGLIB) {
            return true;
