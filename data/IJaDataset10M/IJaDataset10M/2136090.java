...
public class floatType extends homura.hde.util.xml.xml.Node {

    public floatType(floatType node) {
        super(node);
    }

    public floatType(org.w3c.dom.Node node) {
        super(node);
    }

    public floatType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public floatType(homura.hde.util.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "float");
    }
