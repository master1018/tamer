...
public class RepositorySearchResultView extends AbstractTextSearchViewPage implements IAdaptable {
    ...
    private static final String KEY_SORTING = TasksUiPlugin.ID_PLUGIN + ".search.resultpage.sorting";
    ...
    protected void configureTableViewer(TableViewer viewer) {
        ...
        for (int i = 0; i < columnNames.length; i++) {
            columns[i] = new TableColumn(viewer.getTable(), 0, i);
        ...
        Color categoryBackground = themeManager.getCurrentTheme().getColorRegistry().get(TaskListColorsAndFonts.THEME_COLOR_TASKLIST_CATEGORY);
        SearchViewTableLabelProvider taskListTableLabelProvider = new SearchViewTableLabelProvider(new TaskElementLabelProvider(true), PlatformUI.getWorkbench().getDecoratorManager().getLabelDecorator(), categoryBackground);
