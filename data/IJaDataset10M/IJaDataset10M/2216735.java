...
final class CldcTransactionRecordImpl implements TransactionRecord {
     ...
     */
    CldcTransactionRecordImpl(int applicationID, String applicationName, Transaction transaction, long timestamp, boolean fake) {
     ...
     */
    static CldcTransactionRecordImpl createFakeRecord(int transactionID, int applicationID, String applicationName, int featureID, String featureTitle, double price, String currency, int state, long timestamp) {
     ...
     */
    static CldcTransactionRecordImpl read(DataInputStream is) throws IOException {
        CldcTransactionRecordImpl newRecord = new CldcTransactionRecordImpl();
    ...
    int add2list(Vector v) {
        ...
        if (count == 0) {
            ...
            do {
                if (((CldcTransactionRecordImpl) v.elementAt(count - 1)).getFinishedTimestamp() <= this.timestamp) {
