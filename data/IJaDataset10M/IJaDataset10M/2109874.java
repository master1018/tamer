...
public class FacWarTopStatsHandler extends AbstractContentHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attrs) throws SAXException {
        if (qName.equals("characters")) characters = true; else if (qName.equals("corporations")) corporations = true; else if (qName.equals("factions")) factions = true; else if (qName.equals("rowset")) {
            ...
            if (characters) {
                if (killsYesterday) response.addYesterday(getCharKill(attrs)); else if (killsLastWeek) response.addLastWeek(getCharKill(attrs)); else if (killsTotal) response.addTotal(getCharKill(attrs)); else if (victoryPointsYesterday) response.addYesterday(getCharVP(attrs)); else if (victoryPointsLastWeek) response.addLastWeek(getCharVP(attrs)); else if (victoryPointsTotal) response.addTotal(getCharVP(attrs));
            } else if (corporations) {
                if (killsYesterday) response.addYesterday(getCorpKill(attrs)); else if (killsLastWeek) response.addLastWeek(getCorpKill(attrs)); else if (killsTotal) response.addTotal(getCorpKill(attrs)); else if (victoryPointsYesterday) response.addYesterday(getCorpVP(attrs)); else if (victoryPointsLastWeek) response.addLastWeek(getCorpVP(attrs)); else if (victoryPointsTotal) response.addTotal(getCorpVP(attrs));
            } else if (factions) {
                if (killsYesterday) response.addYesterday(getFactionKill(attrs)); else if (killsLastWeek) response.addLastWeek(getFactionKill(attrs)); else if (killsTotal) response.addTotal(getFactionKill(attrs)); else if (victoryPointsYesterday) response.addYesterday(getFactionVP(attrs)); else if (victoryPointsLastWeek) response.addLastWeek(getFactionVP(attrs)); else if (victoryPointsTotal) response.addTotal(getFactionVP(attrs));
            }
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("characters")) characters = false; else if (qName.equals("corporations")) corporations = false; else if (qName.equals("factions")) corporations = false; else super.endElement(uri, localName, qName);
    }
