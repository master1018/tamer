...
public class EventPanel extends JPanel implements ActionListener {
    ...
    protected NavEvent[] events = { NavEvent.ADD_WAYPOINT, NavEvent.ARC, NavEvent.CALCULATE_PATH, NavEvent.CLEAR_PATH, NavEvent.EXIT, NavEvent.FOLLOW_PATH, NavEvent.GET_BATTERY, NavEvent.GET_ESTIMATED_POSE, NavEvent.GET_PARTICLES, NavEvent.GET_POSE, NavEvent.GET_READINGS, NavEvent.GOTO, NavEvent.LOCALIZE, NavEvent.RANDOM_MOVE, NavEvent.ROTATE, NavEvent.ROTATE_SPEED, NavEvent.ROTATE_TO, NavEvent.SET_POSE, NavEvent.SET_TARGET, NavEvent.SOUND, NavEvent.START_NAVIGATOR, NavEvent.STOP, NavEvent.TAKE_READINGS, NavEvent.TRAVEL, NavEvent.TRAVEL_SPEED };
    ...
    public EventPanel(PCNavigationModel model, NavigationPanel panel, NavEvent[] events) {
        ...
        actionPerformed(new ActionEvent(eventCombo, 0, null));
    }
                ...
                switch(event) {
                    ...
                    case GOTO:
                        if (param3.getText().length() > 0) {
                            model.goTo(new Waypoint(Float.parseFloat(param1.getText()), Float.parseFloat(param2.getText()), Float.parseFloat(param3.getText())));
                        } else {
                            model.goTo(new Waypoint(Float.parseFloat(param1.getText()), Float.parseFloat(param2.getText())));
                        }
                        break;
                    case ADD_WAYPOINT:
                        if (param3.getText().length() > 0) {
                            model.addWaypoint(new Waypoint(Float.parseFloat(param1.getText()), Float.parseFloat(param2.getText()), Float.parseFloat(param3.getText())));
                        } else {
                            model.addWaypoint(new Waypoint(Float.parseFloat(param1.getText()), Float.parseFloat(param2.getText())));
                        }
                        break;
                    case STOP:
                        model.stop();
                    ...
                    case CLEAR_PATH:
                        ...
                        break;
                    case SET_POSE:
                        model.setPose(new Pose(Float.parseFloat(param1.getText()), Float.parseFloat(param2.getText()), Float.parseFloat(param3.getText())));
                        panel.repaint();
                        break;
                    case SET_TARGET:
                        if (param3.getText().length() > 0) {
                            model.setTarget(new Waypoint(Float.parseFloat(param1.getText()), Float.parseFloat(param2.getText()), Float.parseFloat(param3.getText())));
                        } else {
                            model.setTarget(new Waypoint(Float.parseFloat(param1.getText()), Float.parseFloat(param2.getText())));
                        }
                        panel.repaint();
                        break;
                    case CALCULATE_PATH:
