...
public class LegendControl extends Composite {
     ...
     */
    public void setLegendContentProvider(ILegendContentProvider legendContentProvider) {
    ...
    public void refreshLegend() {
        ...
        if (!checkContentProviderData(colors, labels)) {
            throw new IllegalArgumentException("ILegendContentProvider data is not valid");
        }
        if (colors.size() == 0) {
            return;
        }
        ...
        for (int i = 0; i < colors.size(); i++) {
            ...
            gridObject.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false));
     ...
     *         labels
     */
    private boolean checkContentProviderData(List<Color> colors, List<String> labels) {
