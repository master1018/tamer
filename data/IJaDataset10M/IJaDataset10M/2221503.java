...
public class ApplicationProperties {
     ...
     */
    private static final String BUNDLE_NAME = "resources.application";

    /**
     * Bundle which handle access to localized resources.
     */
    private static final ResourceBundle PROPERTIES_BUNDLE = ResourceBundle.getBundle(BUNDLE_NAME);
