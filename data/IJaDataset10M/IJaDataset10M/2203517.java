 ...
 * <code>null</code>
 */
    public ScriptEditorWin(Designer designer, Report report, String initialText, String title, String errorSuffixKey, String errorTitleKey) {
 ...
 */
    ...
    protected JComponent northPanel(Report report) {
        ...
        languageMenu = efl.addComboBox(I18N.get("ScriptEditorWin.scripting_lang"), langs);
        return efl.getPanel();
    }
}
