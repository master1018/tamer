...
public class ProportionEstimateExperiment extends Experiment implements Serializable {
    ...
    public static final int INTERVAL = 0, LOWER_BOUND = 1, UPPER_BOUND = 2;

    private double p = 0.5, lowerCritical = -1.645, upperCritical = 1.645, level = 0.95, lowerEstimate, upperEstimate;
	...
	*/
    public void doExperiment() {
        ...
        if (lowerEstimate < p & p < upperEstimate) success.setValue(1); else success.setValue(0);
    }
	...
	*/
    public void update() {
        ...
        recordTable.addRecord(new double[] { getTime(), lowerEstimate, upperEstimate, criticalGraph.getValue(), success.getValue() });
        successTable.repaint();
    }
