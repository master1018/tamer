...
public interface INodeMatcher extends IConfigurable {
     ...
     */
    public char nodeMatch(IContextMapping<IAtomicConceptOfLabel> acolMapping, Map<INode, ArrayList<IAtomicConceptOfLabel>> nmtAcols, Map<String, IAtomicConceptOfLabel> sourceACoLs, Map<String, IAtomicConceptOfLabel> targetACoLs, INode sourceNode, INode targetNode) throws NodeMatcherException;
}
