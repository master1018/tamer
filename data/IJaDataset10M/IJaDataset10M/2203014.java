...
public class GenerateTestSuite {
    ...
    private Settings createSettings(Friend user) {
        ...
        if (Math.random() > 0.5) s.getMy().createChecksumAndSetInvitations((int) (4 * Math.random())); else s.getMy().setInvitations(0);
    ...
    private String[] usernames = { "Abacuss", "Abbe", "Abbis", "Abbo", "Abbot", "Abby", "Absa", "Absy", "Ace", "Acka", "Acke", "Actra", "Addie", "Adian", "Adelie", "Adina", "Adonis", "Affa", "Affe", "Affi", "Africa", "Afrodite", "Agazzi", "Agnes", "Aikie", "Ajax", "Ajja", "Akeem", "Akela", "Akilles", "Akita", "Akka", "Bilbo", "Bill", "Billow", "Billy", "Bimba", "Bimbo", "Bimma", "Bimmer", "Bina", "Bingo", "Birka", "Biscaya", "Bison", "Bisse", "Bistro", "Bita", "Bittan", "Bitte", "Bizzy", "Blaise", "Blaisy", "Blenda", "Blissi", "Blitz", "Blizzard", "Blixten", "Blondie", "Blues", "Bluey", "Blumchen", "Blunder", "Blura", "Bobby", "Bobo", "Bodmin", "Bodo", "Bombax", "Bombibitt", "Bonbon", "Bonita", "Bonker", "Bonnie", "Bonzo", "Bonzai", "Boomer", "Boris", "Bosco", "Boss", "Bosse", "Bossman", "Bosso", "Bossy", "Botjena", "Botvid", "Boy", "Brahe", "Branco", "Brando", "Brandy", "Braska", "Brasse", "Bravo", "Brick", "Bricko", "Bronco", "Bronson", "Bruno", "Brusko", "Brutus", "Bubba", "Bubben", "Buddy", "Buggoo", "Bull", "Bulldoozer", "Bullen", "Bullet", "Bulten", "Bumbi", "Bunni", "Busbus", "Busen", "Dirre", "Disa", "Ditte", "Diva", "Divo", "Dixie", "Dixon", "Diza", "Dizzie", "Django", "Djingis", "Dodge", "Dogge", "Dogglas", "Dojjan", "Dojje", "Dolares", "Dollar", "Dolle", "Dolly", "Dominga", "Domino", "Don", "Donald", "Don", "Juan", "de", "Marco", "Don-Qijote", "Donna", "Donny", "Doris", "Dozer", "Draco", "Drago", "Droopy", "Drulle", "Drutten", "Duchess", "Duff", "Dumbo", "Effie", "Ego", "Egon", "Eiro", "Eisy", "Eja", "Ekstra", "Elektra", "Elga", "Elin", "Eliza", "Elke", "Ella", "Elli", "Elliot", "Elroy", "Elsa", "Elton", "Elva", "Elvira", "Elvis", "Embla", "Emil", "Emilia", "Emelie", "Emma", "Empress", "Enigma", "Enok", "Enzo", "Enya", "Epsylon", "Ernie", "Eroll", "Eros", "Esco", "Eski", "Esset", "Esso", "Essy", "Ester", "Ettan", "Evelina", "Evita", "Ewert", "Exa", "Exigor", "Exxet", "Exxon", "Fancy", "Fandango", "Fang", "Fangera", "Fanny", "Fanta", "Farao", "Fargo", "Fando", "Farris", "Fatima", "Fattzi", "Fatzer", "Faust", "Faxe", "Fazeth", "Faxxa", "Fazita", "Fedor", "Felicia", "Femman", "Fender", "Fenix", "Fernando", "Ferossa", "Ferox", "Ferrari", "Ferro", "Ferus", "Fetzo", "Fia", "Fidde", "Fiddeli", "Fido", "Fidoman", "Fiffi", "Figaro", "Fighter", "Filippa", "Filur", "Fimla", "Fina", "Findus", "Fingal", "Fining", "Finn", "Fiona", "Fira", "Fisan", "Fisen", "Fizzy", "Fjodor", "Flagan", "Flash", "Flax", "Flaxa", "Flickan", "Flingan", "Flinta", "Flipp", "Flora", "Flex", "Flipper", "Florry", "Floyd", "Flubber", "Fluff", "Fluffy", "Flux", "Flying-Flip", "Focus", "Folke", "Fonda", "Fonz", "Fonzie", "Foppa", "Fotti", "Fox", "Foxy", "Fozzie", "Franzesco", "Frasse", "Fredde", "Freddy", "Frej", "Freja", "Frejser", "Freud", "Frida", "Fritiof", "Fritte", "Fritz", "Frodo", "Frost", "Froy", "Froyd", "Froding", "Fuling", "Fuska", "F", "Fabbe", "Fabian", "Fabiola", "Faija", "Fairy", "Fajjen", "Fajt", "Falco", "Falcon", "Falstaff", "Lambada", "Lamborghini", "Lana", "Lapp-lisa", "Lara", "Larionov", "Larizza", "Larry", "Lassemaja", "Lassie", "Lasso", "Lattjo", "Lavinia", "Lazio", "Lazy", "Layla", "Lea", "Lego", "Leia", "Lejki", "Lenita", "Lennox", "Lenny", "Lenzi", "Leo", "Leon", "Leonard", "Lera", "Lester", "Leva", "Lewis", "Li", "Lia", "Libro", "Lilja", "Lillan", "Lillen", "Lilleman", "Lillis", "Lilly", "Limbo", "Lime", "Limpan", "Lina", "Lingo", "Lingon", "Linn", "Linne" + "", "Linus", "Linux", "Lipton", "Lisa", "Lisen", "Lista", "LitoLiz", "Liza", "Lize", "Lizton", "Lizze", "Lizzy", "Lobo", "Loke", "Lola", "Lolla", "Lollipop", "Lolita", "Lona", "Loppan", "Loranga", "Lord", "Lorry", "Lottie", "Louie", "Lova", "Love", "Lovis", "Lovisa", "Lowe", "Lucia", "Lucifer", "Lucinda", "Lucky", "Ludde", "Ludors", "Ludwig", "Luffis-Dino", "Lufsen", "Lufsi", "Luke", "Lukas", "Luki", "Luna", "Luni", "Lurvas", "Lurven", "Lussan", "Lusse", "Lusta", "Lutzie", "Luzette", "Lydia", "Lyssa", "Läckra", "Zamba", "Zambexius", "Zambezi", "Zam-bo", "Zamira", "Zanderega", "Zandor", "Zane", "Zanja", "Zap", "Zappa", "Zaron", "Zarro", "Zax", "Zazza", "Zazzy", "Zeb", "Zefalus", "Zeina", "Zeke", "Zelda", "Zenta", "Zenthi", "Zephyr", "Zepp", "Zeppo", "Zera", "Zero", "Zesco", "Zeus", "Zhaan", "Ziara", "Zicki", "Zico", "Zilla", "Zimba", "Zingo", "Zinko", "Zinou", "Zip", "Zippa", "Zipper", "Ziri", "Zirro", "Zita", "Zockan", "Zombie", "Zombra", "Zoom", "Zorayah", "Zorba", "Zorina", "Zoritha", "Zorrie", "Zoy", "Zoya", "Zorro", "Zumo" };
}
