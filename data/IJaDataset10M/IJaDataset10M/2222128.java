...
class PileupTask extends Task {
    ...
    public void run() {
        try {
            ...
            log.severe("Scheduler exception: " + pw + "\t" + idx + "\tpw.get(" + idx * PileupSummary.CHUNK + ", " + (idx + 1) * PileupSummary.CHUNK + ")\n\t" + e);
        } catch (Error er) {
            log.severe("Scheduler error: " + pw + "\t" + idx + "\tpw.get(" + idx * PileupSummary.CHUNK + ", " + (idx + 1) * PileupSummary.CHUNK + ")\n\t" + er);
        }
    }
}
