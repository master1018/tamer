...
public class MainTypeProcessor implements ILaunchConfigurationProcessor {
   ...
   */
    public enum MainType {
        ...
        GWT_DEV_MODE("com.google.gwt.dev.DevMode"), GWT_HOSTED_MODE("com.google.gwt.dev.HostedMode"), GWT_SHELL("com.google.gwt.dev.GWTShell"), GAE_APP_SERVER("com.google.appengine.tools.development.DevAppServerMain");
   ...
   */
    ...
    private static String computeMainTypeName(ILaunchConfigurationWorkingCopy config, IJavaProject javaProject, ClassFinder classFinder) throws CoreException {
        IProject project = javaProject.getProject();
        ExtensionQuery<MainTypeProcessor.MainTypeFinder> extQuery = new ExtensionQuery<MainTypeProcessor.MainTypeFinder>(GdtPlugin.PLUGIN_ID, "mainTypeFinder", "class");
