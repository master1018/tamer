...
/**
 * Performs a >= operation on two operands.
 *
 * <pre>
 * Syntax:   opand-exp1 gteq opand-exp2
...
public class GtEqOperator extends Operator {
    ...
    /**
     * The operator body. Converts the two operands to doubles and performs an
     * >= operation.
     *
    ...
    protected Object doOperator(Object left, Object right) throws JatoException {
        return new Boolean(convertDouble(left) >= convertDouble(right));
    }
}
