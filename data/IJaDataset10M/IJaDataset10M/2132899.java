...
public class ImportCustomizationDialog extends JDialog {
    ...
    public Dimension getSize() {
        int width = GUIGlobals.IMPORT_DIALOG_COL_0_WIDTH + GUIGlobals.IMPORT_DIALOG_COL_1_WIDTH + GUIGlobals.IMPORT_DIALOG_COL_2_WIDTH + GUIGlobals.IMPORT_DIALOG_COL_3_WIDTH;
    ...
    public ImportCustomizationDialog(JabRefFrame frame_) throws HeadlessException {
        ...
        addFromFolderButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                importer.setBasePath(FileDialogs.getNewDir(frame, new File(prefs.get("workingDirectory")), "", Globals.lang("Select Classpath of New Importer"), JFileChooser.CUSTOM_DIALOG, false));
                String chosenFileStr = FileDialogs.getNewFile(frame, importer.getBasePath(), ".class", Globals.lang("Select new ImportFormat Subclass"), JFileChooser.CUSTOM_DIALOG, false);
        ...
        addFromJarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String basePath = FileDialogs.getNewFile(frame, new File(prefs.get("workingDirectory")), ".zip,.jar", Globals.lang("Select a Zip-archive"), JFileChooser.CUSTOM_DIALOG, false);
