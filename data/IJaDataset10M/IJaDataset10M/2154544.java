...
public class BindingsInfo extends BindingInfo {
    ...
    private static final String ADD_FIELD_BINDING = "com.extjs.gxt.ui.client.binding.Bindings.addFieldBinding(com.extjs.gxt.ui.client.binding.FieldBinding)";

    private static final String BIND = "com.extjs.gxt.ui.client.binding.Bindings.bind(com.extjs.gxt.ui.client.data.ModelData)";
    ...
    public void setFieldBindings(List<FieldBindingInfo> newBindings, DatabindingsProvider provider) throws Exception {
    ...
    public AstObjectInfo parseExpression(AstEditor editor, String signature, MethodInvocation invocation, Expression[] arguments, IModelResolver resolver, IDatabindingsProvider provider) throws Exception {
        if (ADD_FIELD_BINDING.equals(signature)) {
            ...
            if (binding == null) {
                AbstractParser.addError(editor, "FieldBinding '" + arguments[0] + "' not found", new Throwable());
                return null;
            }
    ...
    protected void finishBinding(Expression[] arguments, IDatabindingsProvider provider) throws Exception {
        ...
        for (FieldBindingInfo binding : m_fieldBindings) {
            binding.setModel(beanObserveObject, beanObserveObject.resolvePropertyReference(binding.getParsedProperty(), null));
        }
    ...
    protected final void super_createContentProviders(List<IUiContentProvider> providers, IPageListener listener, DatabindingsProvider provider) throws Exception {
        super.createContentProviders(providers, listener, provider);
    }
