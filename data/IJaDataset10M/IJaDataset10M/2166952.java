...
public class FriedmanGraph extends Graph {
    ...
    private void iniSettings() {
        ...
        marginRight = 4;
        calcAreas();
        descTopFontColor = new MColor("0095C9", 255);
        descBottomFontColor = new MColor("FFFFFF", 255);
        descTopBGColor = new MColor("306A90", 255);
        descBottomBGColor = new MColor("B60000", 255);
        descLeftBGColor = new MColor("B60000", 255);
        descRightBGColor = new MColor("B60000", 255);
        barAreaBGColor = new MColor("306A90", 255);
        overlayBarColor = new MColor("006AB0", 255);
    }
    ...
    protected final void paintDescBottomArea(final Rectangle thisArea, final MColor thisBGColor, final MColor thisFontColor) {
        Rectangle descDrawingRect = new Rectangle(barAreaRect.x + marginLeft, descBottomRect.y, barAreaRect.width - marginLeft - marginRight, descBottomRect.height);
        Rectangle textBox;
        thisBGColor.setColor(gc);
        thisBGColor.setBGColor(gc);
        gc.fillRectangle(thisArea);
