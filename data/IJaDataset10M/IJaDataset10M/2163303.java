...
public final class Py {
    ...
    public static void warning(PyObject category, String message) {
        ...
        if (mod != null) func = mod.__getattr__("warn");
        if (func == null) {
    ...
    public static void warning(PyObject category, String message, String filename, int lineno, String module, PyObject registry) {
        PyObject func = null;
        PyObject mod = importWarnings();
        if (mod != null) func = mod.__getattr__("warn_explicit");
        if (func == null) {
    ...
    **/
    ...
    public static PyObject newInteger(long i) {
        if (i < Integer.MIN_VALUE || i > Integer.MAX_VALUE) return new PyLong(i); else return newInteger((int) i);
    }
    ...
    public static Class relFindClass(Class home, String name) {
        try {
            ...
            if (loader != null) return loader.loadClass(name); else return Class.forName(name);
    ...
    private static synchronized void initProperties(String[] args, String[] packages, String[] props, String frozenPackage, String[] modules, ClassLoader classLoader) {
        ...
        if (modules != null) {
            if (frozenModules == null) frozenModules = new java.util.Hashtable();
    ...
    public static void initProxy(PyProxy proxy, String module, String pyclass, Object[] args, String[] packages, String[] props, String frozenPackage, String[] modules) {
        ...
        if (proxy._getPyInstance() != null) return;
        ThreadState ts = getThreadState();
        PyInstance instance = ts.getInitializingProxy();
        if (instance != null) {
            if (instance.javaProxy != null) throw Py.TypeError("Proxy instance reused");
    ...
    public static void runMain(PyRunnable main, String[] args) throws Exception {
        ...
        try {
            ...
            Py.getSystemState().callExitFunc();
            if (Py.matchException(e, Py.SystemExit)) return;
            throw e;
        }
        Py.getSystemState().callExitFunc();
    }
    ...
    private static String getStackTrace(Throwable javaError) {
        ...
        int index = -1;
        if (index == -1) index = str.indexOf("at org.python.core.PyReflectedConstructor.__call__");
        if (index == -1) index = str.indexOf("at org.python.core.PyReflectedFunction.__call__");
        if (index == -1) index = str.indexOf("at org/python/core/PyReflectedConstructor.__call__");
        if (index == -1) index = str.indexOf("at org/python/core/PyReflectedFunction.__call__");
        if (index != -1) index = str.lastIndexOf("\n", index);
        int index0 = str.indexOf("\n");
        if (index >= index0) str = str.substring(index0 + 1, index + 1);
        return str;
    }
    ...
    public static void displayException(PyObject type, PyObject value, PyObject tb, PyObject file) {
        ...
        if (tb instanceof PyTraceback) stderr.print(((PyTraceback) tb).dumpStack());
        if (__builtin__.isinstance(value, (PyClass) Py.SyntaxError)) {
            ...
            if (text != Py.None && text.__len__() != 0) {
                ...
                for (int j = 1; j < col; j++) space = space + " ";
    ...
    public static PyException makeException(PyObject type, PyObject value, PyObject traceback) {
        ...
        if (traceback == None) return new PyException(type, value);
        if (!(traceback instanceof PyTraceback)) throw TypeError("raise 3rd arg must be traceback or None");
    ...
    public static void exec(PyObject o, PyObject globals, PyObject locals) {
        ...
        if (o instanceof PyCode) {
            ...
            if (o instanceof PyString) contents = o.toString(); else if (o instanceof PyFile) {
                PyFile fp = (PyFile) o;
                if (fp.closed) return;
                contents = fp.read().toString();
            } else throw Py.TypeError("exec: argument 1 must be string, code or file object");
    ...
    public static final ThreadState getThreadState(PySystemState newSystemState) {
        if (threadStateMapping == null) {
            synchronized (Py.class) {
                if (threadStateMapping == null) threadStateMapping = ThreadStateMapping.makeMapping();
            }
        }
    ...
    public static void print(PyObject file, PyObject o) {
        if (file == None) print(o); else new FixedFileWrapper(file).print(o);
    }

    public static void printComma(PyObject file, PyObject o) {
        if (file == None) printComma(o); else new FixedFileWrapper(file).printComma(o);
    }

    public static void println(PyObject file, PyObject o) {
        if (file == None) println(o); else new FixedFileWrapper(file).println(o);
    }

    public static void printlnv(PyObject file) {
        if (file == None) println(); else new FixedFileWrapper(file).println();
    }
    ...
    public static byte py2byte(PyObject o) {
        ...
        if (i == null || i == Py.NoConversion) throw Py.TypeError("integer required");
    ...
    public static float py2float(PyObject o) {
        ...
        if (i == null || i == Py.NoConversion) throw Py.TypeError("float required");
    ...
    public static char py2char(PyObject o, String msg) {
        ...
        if (i == null || i == Py.NoConversion) throw Py.TypeError(msg);
    ...
    public static PyObject makeClass(String name, PyObject[] bases, PyCode code, PyObject doc, Class proxyClass, PyObject[] closure_cells) {
        ...
        if (metaclass == null) {
            if (bases.length != 0) {
                ...
                if (globals != null) metaclass = globals.__finditem__("__metaclass__");
            }
        }
        if (metaclass == null || metaclass == CLASS_TYPE || (metaclass instanceof PyJavaClass && ((PyJavaClass) metaclass).proxyClass == Class.class)) {
            ...
            if (!more_general) return new PyClass(name, new PyTuple(bases), dict, proxyClass);
        }
        if (proxyClass != null) {
    ...
    public static PyObject[] unpackSequence(PyObject o, int length) {
        if (o instanceof PyTuple) {
            ...
            if (tup.__len__() == length) return tup.getArray();
    ...
    public static PyObject iter(PyObject seq, String message) {
        try {
            ...
            if (Py.matchException(exc, Py.TypeError)) throw Py.TypeError(message);
            throw exc;
        }
    }
    ...
    private static boolean abstract_issubclass(PyObject derived, PyObject cls) {
        ...
        for (int i = 0; i < bases.__len__(); i++) {
            if (abstract_issubclass(bases.__getitem__(i), cls)) return true;
        }
        return false;
    }
    ...
    public static boolean isInstance(PyObject obj, PyObject cls) {
        if (cls instanceof PyType) {
            ...
            for (int i = 0; i < cls.__len__(); i++) {
                if (isInstance(obj, cls.__getitem__(i))) return true;
            }
            return false;
        } else {
            if (cls.__findattr__("__bases__") == null) throw Py.TypeError("isinstance() arg 2 must be a class, type," + " or tuple of classes and types");
            PyObject ocls = obj.__findattr__("__class__");
            if (ocls == null) return false;
    ...
    public static boolean isSubClass(PyObject derived, PyObject cls) {
        if (derived instanceof PyType && cls instanceof PyType) {
            ...
            for (int i = 0; i < cls.__len__(); i++) {
                if (isSubClass(derived, cls.__getitem__(i))) return true;
            }
            return false;
        } else {
            if (derived.__findattr__("__bases__") == null) throw Py.TypeError("issubclass() arg 1 must be a class");
            if (cls.__findattr__("__bases__") == null) throw Py.TypeError("issubclass() arg 2 must be a class, type," + " or tuple of classes and types");
            return abstract_issubclass(derived, cls);
        }
    }

    static PyObject[] make_array(PyObject o) {
        if (o instanceof PyTuple) return ((PyTuple) o).getArray();
        PyObject iter = o.__iter__();
        int n = 10;
        try {
            n = o.__len__();
...
class JavaCode extends PyCode {
    ...
    public JavaCode(PyObject func) {
        this.func = func;
        if (func instanceof PyReflectedFunction) this.co_name = ((PyReflectedFunction) func).__name__;
    }
