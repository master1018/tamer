...
public class Status extends PreferenceActivity {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_BATTERY_CHANGED.equals(action)) {
                ...
                if (status == BatteryManager.BATTERY_STATUS_CHARGING) {
                    ...
                    if (plugType > 0) {
                        statusString = statusString + " " + getString((plugType == BatteryManager.BATTERY_PLUGGED_AC) ? R.string.battery_info_status_charging_ac : R.string.battery_info_status_charging_usb);
                    }
    ...
    void updateSignalStrength() {
        if (mSignalStrength != null) {
            ...
            mSignalStrength.setSummary(String.valueOf(signalDbm) + " " + r.getString(R.string.radioInfo_display_dbm) + "   " + String.valueOf(signalAsu) + " " + r.getString(R.string.radioInfo_display_asu));
        }
    }
