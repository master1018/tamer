...
public class TimeAllocationMutatorModule extends AbstractMultithreadedModule {
    ...
    public PlanAlgorithm getPlanAlgoInstance() {
        TimeAllocationMutator mutator = new TimeAllocationMutator(blackList != null ? blackList : controler.getTripRouterFactory().createTripRouter().getStageActivityTypes(), this.mutationRange, MatsimRandom.getLocalInstance());
