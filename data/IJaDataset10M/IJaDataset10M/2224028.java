...
public class ValueMakerTest extends TestCase {
    ...
    private static final Attribute foo_col1 = new Attribute(null, "foo", "col1");

    private static final Attribute foo_col2 = new Attribute(null, "foo", "col2");
    ...
    public void testValueDecoratorWithoutTranslatorToString() {
        assertEquals("Column(foo.col1):maxLength=10", new ValueDecorator(new Column(foo_col1), Collections.singletonList(ValueDecorator.maxLengthConstraint(10))).toString());
    }
