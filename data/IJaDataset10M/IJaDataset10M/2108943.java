...
public interface IEditorAPI {
     ...
     */
    public void setSelection(IEditorPart editorPart, ITextSelection selection, User source, boolean follow);
     ...
     * for the given user.
     */
    public void setViewportAnnotation(IEditorPart editorPart, ILineRange viewport, User user);
     ...
     * 
     */
    public void addSharedEditorListener(EditorManager editorManager, IEditorPart editorPart);
     ...
     */
    public void removeSharedEditorListener(EditorManager editorManager, IEditorPart editorPart);
