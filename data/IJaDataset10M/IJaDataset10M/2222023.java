...
public class SearchPanel extends JPanel {
    ...
    public SearchPanel(final String emptyLabel, final JPopupMenu popup, final boolean searchAsYouType) {
        ...
        if (Utils.isMacOSX() && Utils.getMacOSXMajorVersionNumber() >= 5) {
            ...
            findButton.setPreferredSize(new Dimension(findButton.getIcon().getIconWidth(), findButton.getIcon().getIconHeight()));
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_DOWN) {
                    if (comboBox != null) {
                        ...
                        if (index < comboBox.getItemCount() - 1) index++;
    ...
    private void searchTextChanged() {
        if (searchText.isFocusOwner()) searchTextEmpty = searchText.getText().length() == 0;
