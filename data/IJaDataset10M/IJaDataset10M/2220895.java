...
public class ResupplyList implements java.io.Serializable {
     ...
     */
    public void addResupply(final org.mars_sim.msp.config.model.resupply.Resupply vResupply) throws java.lang.IndexOutOfBoundsException {
     ...
     * given is outside the bounds of the collection
     */
    public void addResupply(final int index, final org.mars_sim.msp.config.model.resupply.Resupply vResupply) throws java.lang.IndexOutOfBoundsException {
     ...
     * index
     */
    public org.mars_sim.msp.config.model.resupply.Resupply getResupply(final int index) throws java.lang.IndexOutOfBoundsException {
     ...
     */
    public boolean removeResupply(final org.mars_sim.msp.config.model.resupply.Resupply vResupply) {
     ...
     */
    public org.mars_sim.msp.config.model.resupply.Resupply removeResupplyAt(final int index) {
     ...
     * given is outside the bounds of the collection
     */
    public void setResupply(final int index, final org.mars_sim.msp.config.model.resupply.Resupply vResupply) throws java.lang.IndexOutOfBoundsException {
        if (index < 0 || index >= this._resupplyList.size()) {
     ...
     */
    public void setResupply(final org.mars_sim.msp.config.model.resupply.Resupply[] vResupplyArray) {
        _resupplyList.clear();
     ...
     */
    public static org.mars_sim.msp.config.model.resupply.ResupplyList unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
