...
import org.saosis.core.models.features.ThirtyFiveUpstreamSignalFeature;

/**
 * An interface for building and converting ThirtyFiveUpstreamSignalFeature
 * objects.
 * 
 * @author Daniel Allen Prust (danprust@yahoo.com)
 * 
 */
public class ThirtyFiveUpstreamSignalFeatureBuilder extends FeatureBuilder implements IFeatureBuilder {

    public Feature buildFeature(FeedbackController feedbackController, String name, ArrayList<FeatureQualifier> qualifiers) {
        ThirtyFiveUpstreamSignalFeature feature = new ThirtyFiveUpstreamSignalFeature();
    ...
    public ArrayList<FeatureQualifier> buildQualifiers(Entry entry, Feature generalFeature) {
        ThirtyFiveUpstreamSignalFeature feature = (ThirtyFiveUpstreamSignalFeature) generalFeature;
