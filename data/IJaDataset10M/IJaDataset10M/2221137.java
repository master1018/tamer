package net.sourceforge.ivi.ui.waveview.tree;
 ...
 */
    void calculateSelectionExtent() {
        ...
        if (trimmedText != null) {
            ...
            selectionExtent.x = Math.min(selectionExtent.x, column.getWidth() - getImageStopX(column.getIndex()) - gridLineWidth);
 ...
 */
    Point drawImage(GC gc, Point destinationPosition, int index) {
        ...
        if (((index == TableColumn.FIRST && parent.hasFirstColumnImage() == true) || (index != TableColumn.FIRST && image != null)) && destinationImageExtent != null) {
 ...
 */
    void drawText(String label, GC gc, Point position, int index) {
        ...
        if (label != null) {
            ...
            boolean drawSelection = (index == TableColumn.FIRST || (parent.getStyle() & SWT.FULL_SELECTION) != 0) && ((parent.getStyle() & SWT.HIDE_SELECTION) == 0 || parent.isFocusControl());
    ...
    int getAlignmentOffset(int columnIndex, int columnWidth, GC gc) {
        ...
        if (((columnIndex == TableColumn.FIRST && parent.hasFirstColumnImage() == true) || (columnIndex != TableColumn.FIRST && image != null)) && imageExtent != null) {
        ...
        if (itemIndex == -1 || index < 0 || index >= parent.internalGetColumnCount()) {
            ...
            if (index == TableColumn.FIRST) {
                if (isCheckable() == true) {
                    ...
                    itemBounds.x = checkboxBounds.x + checkboxBounds.width + CHECKBOX_PADDING;
 ...
 */
    int getImageStopX(int columnIndex) {
        ...
        if (((columnIndex == TableColumn.FIRST && parent.hasFirstColumnImage() == true) || (columnIndex != TableColumn.FIRST && getImage(columnIndex) != null)) && parent.getImageExtent() != null) {
