...
public class ActionsScraperTest {
    ...
    @Test
    public void empty() throws IOException, ScraperException {
    ...
    @Test
    public void noActions() throws IOException, ScraperException {
    ...
    @Test
    public void justName() throws IOException, ScraperException {
    ...
    @Test
    public void justNameAndSpace() throws IOException, ScraperException {
        Reader reader = getReader("{{test  }}");
        Map<String, List<Action>> ret = ActionsScraper.scrape(reader);
        assertNotNull(ret);
        List<Action> list = ret.get("test");
    ...
    @Test
    public void oneArg() throws IOException, ScraperException {
        Reader reader = getReader("{{test arg=\"value\"}}");
        Map<String, List<Action>> ret = ActionsScraper.scrape(reader);
        assertNotNull(ret);
        List<Action> list = ret.get("test");
    ...
    @Test
    public void twoArg() throws IOException, ScraperException {
        Reader reader = getReader("{{test \n  argOne=\"value1\"  \n argTwo=\"value2\"}}");
        Map<String, List<Action>> ret = ActionsScraper.scrape(reader);
        assertNotNull(ret);
        List<Action> list = ret.get("test");
    ...
    @Test
    public void twoArgNoSpace() throws IOException, ScraperException {
    ...
    @Test
    public void twoArgNoCloseQuote() throws IOException, ScraperException {
        Reader reader = getReader("{{test argOne=\"value1\" argTwo=\"value2}}");
        Map<String, List<Action>> ret = ActionsScraper.scrape(reader);
        assertNotNull(ret);
        List<Action> list = ret.get("test");
    ...
    @Test
    public void twoArgNoCloseQuoteWithSpace() throws IOException, ScraperException {
        Reader reader = getReader("{{test argOne=\"value1\" argTwo=\"value2   }}");
        Map<String, List<Action>> ret = ActionsScraper.scrape(reader);
        assertNotNull(ret);
        List<Action> list = ret.get("test");
    ...
    @Test
    public void htmlEntity() throws IOException, ScraperException {
        Reader reader = getReader("{{test arg=\"Pronounced 'L&#277;h-'N�rd 'Skin-'N�rd\"}}");
        Map<String, List<Action>> ret = ActionsScraper.scrape(reader);
        assertNotNull(ret);
        List<Action> list = ret.get("test");
        assertNotNull(list);
        ...
        String value = action.get("arg");
        assertNotNull(value);
        assertEquals("Pronounced 'Lĕh-'N�rd 'Skin-'N�rd", value);
    }

    @Test
    public void ampersand() throws IOException, ScraperException {
