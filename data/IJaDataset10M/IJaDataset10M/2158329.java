...
public class LogisticRegression extends AbstractLearner {
    ...
    public boolean supportsCapability(OperatorCapability lc) {
        ...
        if (lc == OperatorCapability.WEIGHTED_EXAMPLES) return true;
        return false;
    }
