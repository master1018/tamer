...
public final class EcActionBuildExtractor extends EcActionBuildBuilding implements Serializable {
    ...
    protected void postExecute(EcBuildOrder s, GameLog e) {
        if (s.extractorsBuilding == 0) throw new RuntimeException("wtf?");
    ...
    public boolean isInvalid(EcBuildOrder s) {
        if (s.getGasExtractors() + s.extractorsBuilding >= s.extractors()) return true;
        if (s.supplyUsed < s.settings.minimumExtractorSupply) return true;
