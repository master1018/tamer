 ...
 *
 */
public interface Level1SetOfMapElementsOperator<K, V, I> extends UniqOperator<Set<Map<K, V>>, I>, NavigableMapOperator<K, V, I>, NavigatingCollectionOperator<Map<K, V>, I>, SortableOperator<Map.Entry<K, V>, I>, CastableToMapOperator<I>, ExecutableMapOperator<K, V, I>, ModifiableMapOperator<K, V, I>, SelectableOperator<Map<K, V>, I>, ReplaceableOperator<Map<K, V>, I>, ReplaceableIfNullOperator<Map<K, V>, I>, ExtractableMapOperator<K, V, I> {
