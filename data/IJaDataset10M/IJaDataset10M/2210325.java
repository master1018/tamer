...
public class MatchModelImpl extends EObjectImpl implements MatchModel {
    ...
    public EList<MatchElement> getMatchedElements() {
        if (matchedElements == null) {
            matchedElements = new EObjectContainmentEList<MatchElement>(MatchElement.class, this, MatchPackage.MATCH_MODEL__MATCHED_ELEMENTS);
        }
    ...
    public EList<UnMatchElement> getUnMatchedElements() {
        if (unMatchedElements == null) {
            unMatchedElements = new EObjectContainmentEList<UnMatchElement>(UnMatchElement.class, this, MatchPackage.MATCH_MODEL__UN_MATCHED_ELEMENTS);
        }
    ...
    public void setLeftModel(String newLeftModel) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, MatchPackage.MATCH_MODEL__LEFT_MODEL, oldLeftModel, leftModel));
    }
    ...
    public void setOriginModel(String newOriginModel) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, MatchPackage.MATCH_MODEL__ORIGIN_MODEL, oldOriginModel, originModel));
    }
    ...
    public void setRightModel(String newRightModel) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, MatchPackage.MATCH_MODEL__RIGHT_MODEL, oldRightModel, rightModel));
    }
