...
public class JDOClassImplDynamic extends JDOMemberImpl implements JDOClass {
    ...
    /** I18N support */
    protected static final I18NHelper msg = I18NHelper.getInstance(JDOClassImplDynamic.class);
    ...
    public int getIdentityType() {
        ...
        int result = 0;
        if (pcRoot == this) {
            result = (pcRoot.getDeclaredObjectIdClassName() != null) ? JDOIdentityType.APPLICATION : JDOIdentityType.DATASTORE;
        } else {
    ...
    public JavaType getObjectIdClass() {
        ...
        if (name != null) {
            ...
            if (Modifier.isAbstract(type.getModifiers())) type = null;
        } else {
    ...
    public String getDeclaredObjectIdClassName() {
        if (declaredObjectIdClassName != null) {
            ...
            if (index == -1) {
                JavaType type = TypeSupport.resolveType(getDeclaringModel(), declaredObjectIdClassName, getPackagePrefix());
                if (type == null) {
                    throw new ModelFatalException(msg.msg("EXC_CannotResolveObjectIdClass", declaredObjectIdClassName, getName()));
                }
            ...
            if ((declaredPKFields != null) && (declaredPKFields.length == 1)) {
                ...
                if (fieldType != null) {
                    return TypeSupport.getSingleFieldObjectIdClassName(fieldType.getName());
                }
            }
        }
    ...
    public String getPersistenceCapableSuperclassName() {
        if (pcSuperclassName != null) {
            ...
            if (index == -1) {
                JavaType type = TypeSupport.resolveType(getDeclaringModel(), pcSuperclassName, getPackagePrefix());
                if (type == null) {
                    throw new ModelFatalException(msg.msg("EXC_CannotResolvePCSuperClass", pcSuperclassName, getName()));
                }
    ...
    public JDOField createJDOField(String name) throws ModelException {
        ...
        if (field == null) {
            ...
            throw new ModelException(msg.msg("EXC_ExistingJDOProperty", name));
        }
        return field;
    }
    ...
    public JDOProperty createJDOProperty(String name) throws ModelException {
        ...
        if (field == null) {
            ...
            throw new ModelException(msg.msg("EXC_ExistingJDOField", name));
        }
        return property;
    }
     ...
     * @exception ModelException if impossible
     */
    public JDOProperty createJDOProperty(String name, JDOField associatedJDOField) throws ModelException {
        ...
        if (property == null) {
            ...
            if (property.getAssociatedJDOField() != associatedJDOField) {
                throw new ModelException(msg.msg("EXC_ExistingJDOAssociatedProperty", name, associatedJDOField));
            }
        }
        return property;
    }
    ...
    public JDOClass[] getDeclaredClasses() {
        return (JDOClass[]) declaredClasses.values().toArray(new JDOClass[declaredClasses.size()]);
    }
    ...
    public JDOField[] getDeclaredManagedFields() {
        ...
        for (Iterator i = declaredFields.values().iterator(); i.hasNext(); ) {
            ...
            if (field.isManaged()) fieldList.add(field);
        }
    ...
    public JDOField[] getManagedFields() {
        ...
        if (superclass == null) {
            ...
            System.arraycopy(declared, 0, fields, inherited.length, declared.length);
        }
        return fields;
    }
    ...
    public JDOField getManagedField(String fieldName) {
        ...
        if ((field != null) && !field.isManaged()) return null;
        return field;
    }
    ...
    public JDOField getField(String fieldName) {
        ...
        if (index != -1) {
            ...
            for (JDOClassImplDynamic next = this; next != null; next = (JDOClassImplDynamic) next.getPersistenceCapableSuperclass()) {
    ...
    public JDOField getField(int fieldNumber) {
        JDOField field = null;
        JDOField[] fields = getManagedFields();
        if ((0 <= fieldNumber) && (fieldNumber < fields.length)) field = fields[fieldNumber];
        return field;
    }
    ...
    public int getInheritedManagedFieldCount() {
        ...
        JDOClass superclass = getPersistenceCapableSuperclass();
        if (superclass != null) {
            count = superclass.getInheritedManagedFieldCount() + superclass.getDeclaredManagedFieldCount();
        }
        return count;
    }
     ...
     * Returns a new instance of the JDOProperty implementation class.
     */
    protected JDOProperty newJDOPropertyInstance(String name, JDOField associatedJDOField) throws ModelException {
        return new JDOAssociatedPropertyImplDynamic(name, this, associatedJDOField);
    }
}
