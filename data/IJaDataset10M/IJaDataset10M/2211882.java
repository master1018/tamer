...
public class FloatingZoomPanel extends JPanel {
    ...
    public FloatingZoomPanel() {
        ...
        setOpaque(false);
        if (GUI.isMacBrushedMetal()) setBorder(new EmptyBorder(0, 3, 2, 10)); else setBorder(new EmptyBorder(0, 3, 0, 10));
    ...
    protected PaletteButton createPaletteButton(VueTool pTool) {
        ...
        button.setIcons(pTool.getIcon(), pTool.getDownIcon(), pTool.getSelectedIcon(), pTool.getDisabledIcon(), pTool.getRolloverIcon());
