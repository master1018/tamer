...
public class JmsMessageEventSerialiserEnvelopeImplTest {
     ...
     * System Under Test
     */
    private JmsMessageEventSerialiserEnvelopeImpl jmsMessageEventSerialiserEnvelopeImpl = new JmsMessageEventSerialiserEnvelopeImpl(envelopeFactory, jmsMessageFactory);
     ...
     */
    @Test
    public void testFromMapMessage() throws EventSerialisationException, UnknownMessageContentException, EnvelopeOperationException, PayloadOperationException, JMSException {
     ...
     */
    @Test
    public void testFromMapMessageThrowsEventSerialisationExceptionForJmsException() throws UnknownMessageContentException, EnvelopeOperationException, PayloadOperationException, JMSException {
        final MapMessage mapMessage = mockery.mock(MapMessage.class);
        mockery.checking(new Expectations() {
     ...
     */
    @Test
    public void testFromMapMessageThrowsEventSerialisationExceptionForPayloadOperationException() throws UnknownMessageContentException, EnvelopeOperationException, PayloadOperationException, JMSException {
        final MapMessage mapMessage = mockery.mock(MapMessage.class);
        mockery.checking(new Expectations() {
     ...
     */
    @Test
    public void testFromMapMessageThrowsEventSerialisationExceptionForEnvelopeOperationException() throws UnknownMessageContentException, EnvelopeOperationException, PayloadOperationException, JMSException {
        final MapMessage mapMessage = mockery.mock(MapMessage.class);
        mockery.checking(new Expectations() {
     ...
     */
    @Test
    public void testFromMapMessageThrowsEventSerialisationExceptionForUnknownMessageContentException() throws UnknownMessageContentException, EnvelopeOperationException, PayloadOperationException, JMSException {
        final MapMessage mapMessage = mockery.mock(MapMessage.class);
        mockery.checking(new Expectations() {
