...
public interface DNSLookupPerformer {
	 ...
	 */
    List<NAPTRRecord> performNAPTRLookup(String domain, boolean isSecure, Set<String> supportedTransports);
	 ...
	 */
    Queue<Hop> locateHopsForNonNumericAddressWithPort(String host, int port, String transport);
}
