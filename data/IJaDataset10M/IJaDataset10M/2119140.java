...
public abstract class ServerUtils {
    ...
    public static final String MACROSERVER_CLASS_NAME = "MacroServer", DOOR_CLASS_NAME = "Door", POOL_CLASS_NAME = "Pool";

    protected static Logger log = null;

    public String getFullServerNameForDevice(Machine machine, String serverType, String deviceName) throws DevFailed {
        ...
        for (String serverName : serverList) {
            ...
            for (int i = 0; i < serverDevices.length; i += 2) {
                ...
                if (deviceType.equals(serverType) && devName.equalsIgnoreCase(deviceName)) return serverName;
            }
        }
        return null;
    }
