...
public class NodeFactory {
    ...
    public Node getNode4Entity(IAttribute entity) {
        if (entity instanceof INumberScalar) return getNode4Entity((INumberScalar) entity);
        if (entity instanceof IStringScalar) return getNode4Entity((IStringScalar) entity);
        if (entity instanceof INumberSpectrum) return getNode4Entity((INumberSpectrum) entity);
        if (entity instanceof INumberImage) return getNode4Entity((INumberImage) entity);
