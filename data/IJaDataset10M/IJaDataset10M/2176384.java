...
public abstract class ComparisonWriter {
    ...
    protected abstract static class Visitor implements ComparisonVisitor {
        ...
        private void writeSummary(RunComparison run) {
            ...
            writeSummary(evolTypeVisitor.getCounter(EvolutionType.REGRESSION), evolTypeVisitor.getCounter(EvolutionType.PROGRESSION), evolTypeVisitor.getCounter(EvolutionType.STAGNATION));
