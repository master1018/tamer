...
public class HeatbugContextBuilder implements ContextBuilder<Heatbug> {
    ...
    public Context<Heatbug> build(Context<Heatbug> context) {
        GridFactoryFinder.createGridFactory(null).createGrid("Bug Grid", context, new GridBuilderParameters<Heatbug>(new WrapAroundBorders(), new RandomGridAdder<Heatbug>(), false, new int[] { 80, 80 }, new int[] { 5, 5 }));
