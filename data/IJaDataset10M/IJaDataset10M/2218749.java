...
abstract class ExampleTab {
    ...
    private static final String[] SWT_CURSORS = { "null", "CURSOR_ARROW", "CURSOR_WAIT", "CURSOR_CROSS", "CURSOR_HELP", "CURSOR_SIZEALL", "CURSOR_SIZENS", "CURSOR_SIZEWE", "CURSOR_SIZEN", "CURSOR_SIZES", "CURSOR_SIZEE", "CURSOR_SIZEW", "CURSOR_SIZENE", "CURSOR_SIZESE", "CURSOR_SIZESW", "CURSOR_SIZENW", "CURSOR_IBEAM", "CURSOR_HAND" };
    ...
    private void initColors() {
        bgColors = new Color[] { null, BG_COLOR_GREEN, BG_COLOR_BLUE, BG_COLOR_BROWN };
        fgColors = new Color[] { null, FG_COLOR_RED, FG_COLOR_BLUE, FG_COLOR_ORANGE };
    }
   ...
   */
    ...
    protected Button createStyleButton(final String fieldName, final int style) {
    ...
    protected Button createPropertyCheckbox(final String text, final String prop) {
        return createPropertyCheckbox(text, prop, false);
    }

    protected Button createPropertyCheckbox(final String text, final String prop, final boolean checked) {
