...
public class Monstre {
        ...
        public MobGroup(int Aid, int Aalign, ArrayList<MobGrade> possibles, Carte Map, int cell, int maxSize) {
            ...
            switch(maxSize) {
                ...
                case 4:
                    ...
                    if (rand < 22) nbr = 1; else if (rand < 48) nbr = 2; else if (rand < 74) nbr = 3; else nbr = 4;
                    break;
                case 5:
                    rand = Formulas.getRandomValue(0, 99);
                    if (rand < 15) nbr = 1; else if (rand < 35) nbr = 2; else if (rand < 60) nbr = 3; else if (rand < 85) nbr = 4; else nbr = 5;
                    break;
                case 6:
                    rand = Formulas.getRandomValue(0, 99);
                    if (rand < 10) nbr = 1; else if (rand < 25) nbr = 2; else if (rand < 45) nbr = 3; else if (rand < 65) nbr = 4; else if (rand < 85) nbr = 5; else nbr = 6;
                    break;
                case 7:
                    rand = Formulas.getRandomValue(0, 99);
                    if (rand < 9) nbr = 1; else if (rand < 20) nbr = 2; else if (rand < 35) nbr = 3; else if (rand < 55) nbr = 4; else if (rand < 75) nbr = 5; else if (rand < 91) nbr = 6; else nbr = 7;
                    break;
                default:
                    rand = Formulas.getRandomValue(0, 99);
                    if (rand < 9) nbr = 1; else if (rand < 20) nbr = 2; else if (rand < 33) nbr = 3; else if (rand < 50) nbr = 4; else if (rand < 67) nbr = 5; else if (rand < 80) nbr = 6; else if (rand < 91) nbr = 7; else nbr = 8;
                    break;
            }
    ...
    public Monstre(int Aid, int agfx, int Aalign, String Acolors, String Agrades, String Aspells, String Astats, String aPdvs, String aPoints, String aInit, int mK, int MK, String xpstr, int IAtype, boolean capturable) {
        ...
        for (int n = 0; n < 11; n++) {
            try {
                ...
                ;
                grades.put(G, new MobGrade(this, G, level, PA, PM, resists, stats, spells, pdvmax, init, xp));
                G++;
            } catch (Exception e) {
                continue;
            }
    ...
    public MobGrade getGradeByLevel(int lvl) {
        for (Entry<Integer, MobGrade> grade : grades.entrySet()) {
            if (grade.getValue().getLevel() == lvl) return grade.getValue();
        }
        return null;
    }
