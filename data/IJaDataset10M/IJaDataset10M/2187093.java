...
public class BulkMutateResult implements java.io.Serializable {
    ...
    private com.google.api.adwords.v201101.cm.OperationStreamResult[] operationStreamResults;

    public BulkMutateResult() {
    }

    public BulkMutateResult(java.lang.Integer partIndex, com.google.api.adwords.v201101.cm.OperationStreamResult[] operationStreamResults) {
     ...
     */
    public com.google.api.adwords.v201101.cm.OperationStreamResult[] getOperationStreamResults() {
     ...
     *                 {@code OperationStream} in the {@link BulkMutateRequest}.
     */
    public void setOperationStreamResults(com.google.api.adwords.v201101.cm.OperationStreamResult[] operationStreamResults) {
        this.operationStreamResults = operationStreamResults;
    }

    public com.google.api.adwords.v201101.cm.OperationStreamResult getOperationStreamResults(int i) {
        return this.operationStreamResults[i];
    }

    public void setOperationStreamResults(int i, com.google.api.adwords.v201101.cm.OperationStreamResult _value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = true && ((this.partIndex == null && other.getPartIndex() == null) || (this.partIndex != null && this.partIndex.equals(other.getPartIndex()))) && ((this.operationStreamResults == null && other.getOperationStreamResults() == null) || (this.operationStreamResults != null && java.util.Arrays.equals(this.operationStreamResults, other.getOperationStreamResults())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getOperationStreamResults() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getOperationStreamResults()); i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(BulkMutateResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201101", "BulkMutateResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("partIndex");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201101", "partIndex"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201101", "operationStreamResults"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201101", "OperationStreamResult"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
