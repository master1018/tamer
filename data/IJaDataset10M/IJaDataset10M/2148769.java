...
public class RMIServerImpl implements RMIServer {
    ...
    public RMIServerImpl(String replicantName, Class intf, Object handler) throws Exception {
        ...
        this.rmistub = (RemoteStub) UnicastRemoteObject.exportObject(this, 0, null, null);
        RMIServer.rmiServers.put(key, this);
    }

    public Object createStub() {
        RMIClient client = new RMIClient(handler, this, key);
        return Proxy.newProxyInstance(intf.getClassLoader(), new Class[] { intf, RMIProxy.class }, client);
    }
