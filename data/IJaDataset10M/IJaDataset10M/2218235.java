 ...
 */
public interface IAlfOptions {

    /**
	 * The key for the option to provide a stream pre-processor.
	 */
    public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new fr.inria.papyrus.uml4tst.emftext.alf.resource.alf.mopp.AlfMetaInformation().getInputStreamPreprocessorProviderOptionKey();

    /**
	 * The key for the option to provide a resource post-processor.
	 */
    public String RESOURCE_POSTPROCESSOR_PROVIDER = new fr.inria.papyrus.uml4tst.emftext.alf.resource.alf.mopp.AlfMetaInformation().getResourcePostProcessorProviderOptionKey();
