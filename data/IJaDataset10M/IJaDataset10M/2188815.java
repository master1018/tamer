...
public class InstanceClassTableSelectionListener implements ListSelectionListener {
    ...
    public void valueChanged(ListSelectionEvent e) {
        if (e.getSource() == table.getSelectionModel() && table.getRowSelectionAllowed() && table.getSelectedRowCount() != 0) controller.showInstanceClassButtons(true); else controller.showInstanceClassButtons(false);
    }
}
