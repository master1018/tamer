...
public class HasspellformulaToken implements CDOMPrimaryToken<PCClass> {
    ...
    public boolean parse(LoadContext context, PCClass obj, String value) throws PersistenceLayerException {
        Logging.deprecationPrint("Ignoring HASSPELLFORMULA: " + "No longer required in PCGen 5.15+ ");
        return true;
    }
}
