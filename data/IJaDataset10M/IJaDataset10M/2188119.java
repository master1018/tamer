...
public class EventREF extends DmcNamedObjectNontransportableREF<EventDMO> {
    ...
    public static final DmcAttributeInfo __eventName = new DmcAttributeInfo("eventName", 809, "CamelCaseName", ValueTypeEnum.SINGLE, DataTypeEnum.PERSISTENT);
    ...
    public void setName(DmcObjectName n) throws DmcValueException {
        if (myName == null) myName = new DmcTypeCamelCaseNameSV(__eventName);
        myName.set(n);
    }
