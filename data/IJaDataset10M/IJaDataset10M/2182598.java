...
public class OrangeColorTheme implements ColorTheme {
    ...
    private Color backgroundColor1 = new Color(212, 159, 104);

    private Color backgroundColor2 = new Color(251, 208, 160);

    public OrangeColorTheme() {
        this(new Dimension());
    }

    public OrangeColorTheme(Dimension dim) {
        update(dim);
    ...
    public Paint getBackgoundPaint() {
        return backgoundPaint;
    }

    public void setBackgoundPaint(Paint backgoundPaint) {
        this.backgoundPaint = backgoundPaint;
    }
}
