...
public class ASTVariable extends ACTRDebugElement implements IVariable, IValue {
   ...
   * Logger definition
   */
    private static final transient Log LOGGER = LogFactory.getLog(ASTVariable.class);
    ...
    private SoftReference<IVariable[]> _children = new SoftReference<IVariable[]>(null);
    ...
    public ASTVariable(CommonTree ast, ACTRDebugTarget target) {
        ...
        if (LOGGER.isDebugEnabled()) LOGGER.debug("Variable created " + _variableName + " ");
    }

    public ASTVariable(CommonTree ast, String variableValue, ACTRDebugTarget target) {
        this(ast, target);
    ...
    public IVariable[] getVariables() throws DebugException {
        ...
        if (children == null) {
            ...
            for (CommonTree child : Support.getVisibleChildren(_ast)) variables.add(new ASTVariable(child, _target));
   ...
   */
    protected void extractDisplayTexts() {
        ...
        String tokenType = "[" + JACTRBuilder.tokenNames[_ast.getType()].toLowerCase() + "]";
