            ...
            if (rs.next()) {
                ...
                if (sAprova != null) {
                    if (!sAprova.equals("ND")) {
                        if (sAprova.equals("TD")) bAprovaCab = true; else if ((codcc.trim().equals(rs.getString("CODCC").trim())) && (codemp == rs.getInt("CODEMPCC")) && (codfilial == rs.getInt("CODFILIALCC")) && (sAprova.equals("CC"))) {
                            bAprovaCab = true;
                        } else {
                            bAprovaCab = false;
                        }
