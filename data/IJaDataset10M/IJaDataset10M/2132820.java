...
public class DOMUtils {
    ...
    protected static Class[] getElementsByNSParameterTypes = { String.class, String.class };
    ...
    public static String getTextValue(Node node) {
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            if (nodeList.item(i).getNodeType() == Node.TEXT_NODE || nodeList.item(i).getNodeType() == Node.CDATA_SECTION_NODE) {
    ...
    protected static void getChildElementsByTagNameNS(Vector vector, Node node, String tagName, String namespace) {
        ...
        for (int i = 0; list != null && i < list.getLength(); i++) {
            try {
                ...
                if (tagName.equals(getElementLocalName(element)) && namespace.equals(getElementNamespaceURI(element))) {
