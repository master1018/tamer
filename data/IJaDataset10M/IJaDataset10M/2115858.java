...
public class light_quadratic_attenuationType2 extends com.jmex.xml.xml.Node {

    public light_quadratic_attenuationType2(light_quadratic_attenuationType2 node) {
        super(node);
    }

    public light_quadratic_attenuationType2(org.w3c.dom.Node node) {
        super(node);
    }

    public light_quadratic_attenuationType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public light_quadratic_attenuationType2(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "light_quadratic_attenuation");
    }
    ...
    public float2 getvalue2ValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new com.jmex.xml.xml.XmlException("Out of range"); else return new float2(getDomNodeValue(curNode));
    }
    ...
    public GLES_MAX_LIGHTS_index getindexValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new com.jmex.xml.xml.XmlException("Out of range"); else return new GLES_MAX_LIGHTS_index(getDomNodeValue(curNode));
    }
