    ...
    public void testGetLength() {
        loadApi(new Runnable() {
            ...
            public void run() {
                ...
                LatLng[] points = { LatLng.newInstance(45, 45), LatLng.newInstance(45, -45), LatLng.newInstance(0, 0) };
   ...
   */
    public void testPolylineFromEncoded() {
        loadApi(new Runnable() {
            ...
            public void run() {
                MapWidget map = new MapWidget(LatLng.newInstance(33.75951619957536, -84.39289301633835), 20);
                map.setSize("500px", "400px");
                map.addMapType(MapType.getHybridMap());
                map.setCurrentMapType(MapType.getHybridMap());
                EncodedPolyline[] polylines = new EncodedPolyline[2];
                polylines[0] = EncodedPolyline.newInstance("{t`mEt_bbO?eAx@??dAy@?", 2, "BBBBB", 1);
                polylines[0].setColor("#ff00ff");
                polylines[0].setWeight(2);
                polylines[0].setOpacity(0.7);
                polylines[1] = EncodedPolyline.newInstance("au`mEz_bbO?sAbA@?pAcA?", 2, "BBBBB", 1, "#0000ff", 2, 0.9);
    ...
    public void testPolylineOptions() {
        loadApi(new Runnable() {
            ...
            public void run() {
                MapWidget map = new MapWidget(LatLng.newInstance(0, 0), 3);
                map.setSize("500px", "400px");
                LatLng nycToZurich[] = { LatLng.newInstance(40.75, -73.90), LatLng.newInstance(47.3, 8.5) };
    ...
    public void testPolylineOptions2() {
        loadApi(new Runnable() {
            ...
            public void run() {
                ...
                LatLng nycToZurich[] = { LatLng.newInstance(40.75, -73.90), LatLng.newInstance(47.3, 8.5) };
                map.setCenter(LatLng.newInstance(40, -25), 2);
                Polyline pline = new Polyline(nycToZurich, "#FF0000", 1, .75, PolylineOptions.newInstance(false));
                map.addOverlay(pline);
                RootPanel.get().add(map);
            }
        });
