...
public final class NetworkTrain implements Comparable<NetworkTrain> {
    ...
    protected static Logger log = Logger.getLogger(NetworkTrain.class.getPackage().getName());
    ...
    private NetworkTrain(int majors, int minors, boolean ignoreMinors, int multiplyMajors, int multiplyMinors, boolean isHTrain, String trainName, TrainI train) {
        this.majors = majors;
        this.minors = minors;
    ...
    static NetworkTrain createFromRailsTrain(TrainI railsTrain) {
        ...
        return new NetworkTrain(majors, minors, ignoreMinors, multiplyMajors, multiplyMinors, isHTrain, trainName, railsTrain);
    }
    ...
    public static NetworkTrain createFromString(String trainString) {
        ...
        int cities = 0;
        int towns = 0;
        boolean ignoreTowns = false;
        int multiplyCities = 1;
        int multiplyTowns = 1;
        ...
        if (t.equals("D")) {
            ...
            cities = Integer.parseInt(t.split("\\+")[0]);
        ...
        NetworkTrain train = new NetworkTrain(cities, towns, ignoreTowns, multiplyCities, multiplyTowns, isHTrain, t, null);
        return train;
    }
