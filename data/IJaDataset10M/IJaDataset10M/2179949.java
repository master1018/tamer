...
public class Memer {
    ...
    long currFreeMem, currTotalMem, currMemUsed, deltaMemUsed, prevFreeMem, prevTotalMem, prevMemUsed;
   ...
   */
    public String toString() {
        calcMem();
        return " free: " + currFreeMem + "   total: " + currTotalMem + "   used: " + currMemUsed + "   delta: " + deltaMemUsed;
    }
}
