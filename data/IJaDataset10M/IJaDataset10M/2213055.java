...
public class JavaContentOutlinePage extends ContentOutlinePage {
    ...
    protected class ContentProvider implements ITreeContentProvider {
        ...
        protected void parse(IDocument document) {
            ...
            for (int line = 0; line < lines; line += increment) {
                ...
                if (line + increment > lines) length = lines - line;
                try {
                    ...
                    fContent.add(new Segment(MessageFormat.format(JavaEditorMessages.getString("OutlinePage.segment.title_pattern"), new Object[] { new Integer(offset) }), p));
        ...
        public Object getParent(Object element) {
            if (element instanceof Segment) return fInput;
            return null;
        }
    ...
    public void selectionChanged(SelectionChangedEvent event) {
        ...
        if (selection.isEmpty()) fTextEditor.resetHighlightRange(); else {
