...
public class OAConfiguration implements Configuration {
    ...
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(OAConfiguration.class.getName());
     ...
     */
    public void setConfiguration(Document aConfigXML) throws XPathExpressionException, SAXException, IOException, ParserConfigurationException {
    ...
    public boolean verify() throws XPathExpressionException {
        ...
        } else log.info("verifyConfiguration : hasProperties : check FAIL ");
        return false;
    }
}
