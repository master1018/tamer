...
public class Line {
    ...
    public String getLineData() {
        return String.format("indexed: start=(%s, %s) - end=(%s, %s)", this.startX, this.startY, this.endX, this.endY) + String.format("\t\tpixel: start=(%s, %s) - end=(%s, %s)", this.startX + 1, this.startY + 1, this.endX + 1, this.endY + 1);
    }
