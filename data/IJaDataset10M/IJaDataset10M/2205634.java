...
public class FunctionsTest extends TestCase {
    ...
    public void testForMapWithoutDefault() {
        ...
        new EqualsTester(function).addEqualObject(Functions.forMap(map)).addEqualObject(Functions.forMap(map)).addNotEqualObject(Functions.forMap(map, 42)).testEquals();
    ...
    public void testComposition() {
        ...
        new EqualsTester(japaneseToSpanish).addEqualObject(Functions.compose(integerToSpanish, japaneseToInteger)).addEqualObject(SerializableTester.reserialize(japaneseToSpanish)).addNotEqualObject(japaneseToInteger).addNotEqualObject(integerToSpanish).addNotEqualObject(Functions.compose(japaneseToInteger, integerToSpanish)).testEquals();
    }
    ...
    public void testForPredicate() {
        ...
        new EqualsTester(alwaysTrue).addEqualObject(Functions.forPredicate(Predicates.alwaysTrue())).addNotEqualObject(alwaysFalse).addNotEqualObject(Functions.identity()).testEquals();
    ...
    public void testConstant() {
        ...
        new EqualsTester(f).addEqualObject(Functions.constant("correct")).addNotEqualObject(Functions.constant("incorrect")).addNotEqualObject(Functions.toStringFunction()).addNotEqualObject(g).testEquals();
        new EqualsTester(g).addEqualObject(Functions.constant(null)).addNotEqualObject(Functions.constant("incorrect")).addNotEqualObject(Functions.toStringFunction()).addNotEqualObject(f).testEquals();
