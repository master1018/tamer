...
import javax.swing.*;
import jmetal.gui.utils.PrintClassInfo;
import jmetal.gui.utils.PrintOperatorInfo;
...
public class AddOperator implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    (new PrintOperatorInfo()).printAlgorithmInfo(algorithmName_.getText(), packageName_.getText());
