...
public class Macro extends Closure {
    ...
    public static Object expand(Pair x) {
        Object f = U.first(x);
        Object fval = (f instanceof Symbol) ? (((Symbol) f).isDefined() ? ((Symbol) f).getGlobalValue() : null) : null;
        if (fval instanceof Macro) return ((Macro) fval).apply(U.toList(x.rest)); else return x;
    }
