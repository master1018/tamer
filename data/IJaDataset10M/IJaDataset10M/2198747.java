...
public class FlowViewStateManager extends StateManager {
    ...
    public void writeState(FacesContext context, javax.faces.application.StateManager.SerializedView state) throws IOException {
        if (!JsfUtils.isFlowRequest()) {
    ...
    public Object saveView(FacesContext context) {
        ...
        SerializedView view = new SerializedView(context.getViewRoot().getViewId(), getTreeStructureToSave(context), getComponentStateToSave(context));
