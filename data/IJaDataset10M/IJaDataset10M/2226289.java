...
/** 
 * Helper class for : CodingScheme
 *  
 * @author OpenORB Compiler
 */
public class CodingSchemeHelper {
    ...
    /**
     * Insert CodingScheme into an any
     * @param a an any
     * @param t CodingScheme value
     */
    public static void insert(org.omg.CORBA.Any a, org.omg.NamingAuthority.AuthorityId t) {
        a.insert_Streamable(new org.omg.NamingAuthority.AuthorityIdHolder(t));
    }

    /**
     * Extract CodingScheme from an any
     *
     * @param a an any
     * @return the extracted CodingScheme value
     */
    public static org.omg.NamingAuthority.AuthorityId extract(org.omg.CORBA.Any a) {
        ...
        if (meth != null) {
            try {
                ...
                if (s instanceof org.omg.NamingAuthority.AuthorityIdHolder) return ((org.omg.NamingAuthority.AuthorityIdHolder) s).value;
            ...
            org.omg.NamingAuthority.AuthorityIdHolder h = new org.omg.NamingAuthority.AuthorityIdHolder(read(a.create_input_stream()));
    ...
    /**
     * Return the CodingScheme TypeCode
     * @return a TypeCode
     */
    public static org.omg.CORBA.TypeCode type() {
        if (_tc == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                ...
                _tc = orb.create_alias_tc(id(), "CodingScheme", org.omg.NamingAuthority.AuthorityIdHelper.type());
                _working = false;
            }
        }
        return _tc;
    ...
    /**
     * Return the CodingScheme IDL ID
     * @return an ID
     */
    ...
    private static final String _id = "IDL:omg.org/PersonIdService/CodingScheme:1.0";

    /**
     * Read CodingScheme from a marshalled stream
     * @param istream the input stream
     * @return the readed CodingScheme value
     */
    public static org.omg.NamingAuthority.AuthorityId read(org.omg.CORBA.portable.InputStream istream) {
        return org.omg.NamingAuthority.AuthorityIdHelper.read(istream);
    }

    /**
     * Write CodingScheme into a marshalled stream
     * @param ostream the output stream
     * @param value CodingScheme value
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, org.omg.NamingAuthority.AuthorityId value) {
        org.omg.NamingAuthority.AuthorityIdHelper.write(ostream, value);
    }
}
