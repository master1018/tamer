...
class PageResources {
        ...
        if (forbiddenNames != null) {
            ...
            if (translated == null) {
                while (true) {
                    ...
                    if (!forbiddenNames.containsKey(translated)) break;
                }
    ...
    void addDefaultColor(PdfName name, PdfObject obj) {
        if (obj == null || obj.isNull()) colorDictionary.remove(name); else colorDictionary.put(name, obj);
    }
    ...
    PdfDictionary getResources() {
        ...
        if (originalResources != null) resources.putAll(originalResources);
