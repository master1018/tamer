...
public class BeamExcursionOrbitAdaptor {
    ...
    protected void generateMap() {
        try {
            ...
            if (sequence != null) {
                ...
                if (probe instanceof BeamProbe) {
                    ((BeamProbe) probe).setBeamCharge(0.0);
                    ((BeamProbe) probe).setBeamCurrent(0.0);
                }
    ...
    protected static List<BeamMarker> mergeNodes(final AcceleratorSeq sequence, final List<BpmAgent> bpms, final List<AcceleratorNode> quadrupoles) {
        ...
        final List<BeamMarker> markers = new ArrayList<BeamMarker>();
        ...
        if (bpmCount > 1) {
            while (true) {
                ...
                if (bpm != null && quadrupole != null) {
                    ...
                    if (quadrupolePosition == bpmPosition) {
    ...
    private class BeamMarkerCluster {
        ...
        protected final BeamMarker BEAM_MARKER;
        ...
        public List<BpmAgent> getBPMAgentList() {
            final List<BpmAgent> list = new ArrayList(2);
