...
public class ReplicationManager implements LifeCycleListener {
    ...
    public Object getRuntimeState(String property) {
        ...
        if (RUNTIME_STATE_ADDRESS.equals(property)) return controlLayer.getThisAddress();
        return null;
    }
    ...
    public void crashPerformed(Throwable exc) {
        Logging.logMessage(Logging.LEVEL_CRIT, this, "An essential replication component has crashed, because %s.", exc.getMessage());
