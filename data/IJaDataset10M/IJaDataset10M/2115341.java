...
public class OpenCalaisAnalyzer implements LWComponentAnalyzer {
            ...
            if (c.getResource() != null) {
                ...
                if (map != null) {
                    ...
                    for (int p = 0; p < obj.length; p++) {
                        ...
                        if (key.startsWith("title") || key.startsWith("date") || key.startsWith("creator") || key.startsWith("description")) {
    ...
    public void visit(Node node, int level) {
        ...
        for (int i = 0, cnt = nl.getLength(); i < cnt; i++) {
            ...
            if (n.getFirstChild() == null) skip = true; else if (n.getFirstChild().getNodeValue() == null || (n.getFirstChild().getNodeValue() != null && n.getFirstChild().getNodeValue().trim().equals(""))) skip = true; else skip = false;
            if (!skip) {
