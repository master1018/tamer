...
public class AutonomousEntityQueryRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
    ...
    static {
        try {
            ...
            RenderComponentManager.loadRenderFile("AutonomousEntityQuery", index, "/ingenias/editor/rendererxml/AutonomousEntityQueryUMLPanel.xml");
            index = ViewPreferences.ViewType.INGENIAS;
            RenderComponentManager.loadRenderFile("AutonomousEntityQuery", index, "/ingenias/editor/rendererxml/AutonomousEntityQueryINGENIASPanel.xml");
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    public Component getRendererComponent(JGraph graph, CellView view, boolean sel, boolean focus, boolean preview) {
        return RenderComponentManager.retrievePanel("AutonomousEntityQuery", ((Entity) ((DefaultGraphCell) (view.getCell())).getUserObject()).getPrefs().getView());
    }
