...
public class XMLBIFv03TokenManager implements XMLBIFv03Constants {
    ...
    private final int jjMoveNfa_0(int startState, int curPos) {
        ...
        for (; ; ) {
                    ...
                    switch(jjstateSet[--i]) {
                        case 1:
                            if ((0xefffffffffffffffL & l) != 0L) {
                                if (kind > 28) kind = 28;
                            } else if (curChar == 60) jjAddStates(0, 1);
                            if ((0x3ff000000000000L & l) != 0L) {
                                ...
                                if (kind > 1) kind = 1;
                                jjCheckNAdd(0);
                            } else if (curChar == 34) jjCheckNAdd(12); else if (curChar == 36) {
                                if (kind > 25) kind = 25;
                                jjCheckNAdd(9);
                        ...
                        case 9:
                            ...
                            break;
                        case 10:
                            if ((0xefffffffffffffffL & l) != 0L && kind > 28) kind = 28;
                            break;
                        case 11:
                            if (curChar == 34) jjCheckNAdd(12);
                            break;
                        case 12:
                        ...
                        case 17:
                            ...
                            break;
                        case 19:
                            if ((0x280000000000L & l) != 0L) jjCheckNAdd(20);
                            break;
                        case 20:
                            if ((0x3ff000000000000L & l) == 0L) break;
                            if (kind > 23) kind = 23;
                        ...
                        case 21:
                            ...
                            break;
                        case 23:
                            if ((0x280000000000L & l) != 0L) jjCheckNAdd(24);
                            break;
                        case 24:
                            if ((0x3ff000000000000L & l) == 0L) break;
                            if (kind > 23) kind = 23;
                            ...
                            break;
                        case 25:
                            if (curChar == 60) jjAddStates(0, 1);
                            break;
                        case 26:
                            if (curChar == 33) jjCheckNAddTwoStates(27, 28);
                            break;
                        case 27:
                            if ((0xbfffffffffffffffL & l) != 0L) jjCheckNAddTwoStates(27, 28);
                            break;
                        case 28:
                            if (curChar == 62 && kind > 2) kind = 2;
                            break;
                        case 30:
                            if ((0xbfffffffffffffffL & l) != 0L) jjAddStates(6, 7);
                            break;
                        case 31:
                            if (curChar == 62 && kind > 6) kind = 6;
                            break;
                        case 34:
                            if (curChar == 63) jjstateSet[jjnewStateCnt++] = 33;
                            break;
                        default:
                            break;
                    }
                ...
                MatchLoop: do {
                    switch(jjstateSet[--i]) {
                        case 1:
                            ...
                            break;
                        case 5:
                            if ((0x2000000020L & l) != 0L) jjAddStates(8, 9);
                            break;
                        case 8:
                        case 9:
                        ...
                        case 27:
                            ...
                            break;
                        case 29:
                            if ((0x100000001000L & l) != 0L) jjCheckNAddTwoStates(30, 31);
                            break;
                        case 30:
                            jjCheckNAddTwoStates(30, 31);
                            break;
                        case 32:
                            if ((0x200000002000L & l) != 0L) jjstateSet[jjnewStateCnt++] = 29;
                            break;
                        case 33:
                            if ((0x100000001000000L & l) != 0L) jjstateSet[jjnewStateCnt++] = 32;
                            break;
                        default:
                            break;
                    }
                ...
                MatchLoop: do {
                    switch(jjstateSet[--i]) {
                        ...
                        case 9:
                            ...
                            break;
                        case 10:
                            if (jjCanMove_1(hiByte, i1, i2, l1, l2) && kind > 28) kind = 28;
                            break;
                        case 12:
                            if (jjCanMove_1(hiByte, i1, i2, l1, l2)) jjAddStates(10, 11);
                            break;
                        case 27:
                            if (jjCanMove_1(hiByte, i1, i2, l1, l2)) jjAddStates(16, 17);
                            break;
                        case 30:
                            if (jjCanMove_1(hiByte, i1, i2, l1, l2)) jjAddStates(6, 7);
                            break;
                        default:
                            break;
                    }
            ...
            ++curPos;
            if ((i = jjnewStateCnt) == (startsAt = 35 - (jjnewStateCnt = startsAt))) break;
            try {
                curChar = input_stream.readChar();
            } catch (java.io.IOException e) {
                break;
    ...
    public static final String[] jjstrLiteralImages = { "", null, null, "\74", "\74\57", "\76", null, "\75", null, null, null, null, null, null, null, null, null, null, null, null, "\42\156\141\164\165\162\145\42", "\42\144\145\143\151\163\151\157\156\42", "\42\165\164\151\154\151\164\171\42", null, null, null, null, null, null, null };
    ...
    private final void ReInitRounds() {
        int i;
        jjround = 0x80000001;
        for (i = 35; i-- > 0; ) jjrounds[i] = 0x80000000;
    }
