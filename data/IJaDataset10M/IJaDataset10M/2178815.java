 ...
 */
public class accanti extends GLSkeleton<GLJPanel> implements GLEventListener, KeyListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        for (jitter = 0; jitter < ACSIZE; jitter++) {
            ...
            gl.glPushMatrix();
            gl.glTranslatef(j8[jitter].x * 4.5f / viewport[2], j8[jitter].y * 4.5f / viewport[3], 0.0f);
            displayObjects(gl);
            gl.glPopMatrix();
    ...
    public void reshape(GLAutoDrawable drawable, int x, int y, int w, int h) {
        ...
        gl.glLoadIdentity();
        if (w <= h) gl.glOrtho(-2.25, 2.25, -2.25 * h / w, 2.25 * h / w, -10.0, 10.0); else gl.glOrtho(-2.25 * w / h, 2.25 * w / h, -2.25, 2.25, -10.0, 10.0);
