...
import purej.cache.web.filter.ResponseContent;
...
public class CacheEntry implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 1614277604965762519L;
     ...
     * @param policy
     *                Object that implements refresh policy logic. This
     ...
     *                parameter is optional.
     * @param groups
     *                The groups that this <code>CacheEntry</code> belongs to.
     ...
     * 
     * @param groups
     *                A string array containing all the group names
     */
     ...
     * 
     * @param groups
     *                A collection containing all the group names
     */
    ...
    /**
     * Gets the cache groups that this cache entry belongs to. These returned
     * groups should be treated as immuatable.
     * 
     * @return A set containing the names of all the groups that this cache
     *         entry belongs to.
     */
     ...
     * 
     * @param update
     *                The time (in milliseconds) this CacheEntry was last
     *                updated.
     */
     ...
     *                {@link #INDEFINITE_EXPIRY} will result in the content
     *                never becoming stale unless it is explicitly flushed, or
     *                expired by a custom {@link EntryRefreshPolicy}. Passing
     *                in 0 will always result in a refresh being required.
     * 
