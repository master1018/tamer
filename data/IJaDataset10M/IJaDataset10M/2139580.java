...
public class SampleGxtModel {
    ...
    public void restoreDefaultValues() {
        ...
        double newWage = employee.get(WAGE) + 10L;
    ...
    public void concatenateProperties() {
        ...
        city2 = employee.get(COMPANY.add(CITY));
    ...
    public void selectFromDatabase() {
        ...
        CQuery query = CQuery.newInstance(Employee.class, Employee.NAME, Employee.COMPANY.add(Company.NAME));
