...
public class MappingTest extends TestCase {
    ...
    private static final Resource database1 = ResourceFactory.createResource("http://test/db");

    private static final Resource database2 = ResourceFactory.createResource("http://test/db2");

    private static final Resource classMap1 = ResourceFactory.createResource("http://test/classMap1");
    ...
    public void testReturnAddedClassMaps() {
        ...
        ClassMap c = new ClassMap(classMap1);
        m.addClassMap(c);
        assertEquals(Collections.singleton(classMap1), new HashSet(m.classMapResources()));
