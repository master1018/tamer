...
import assfxmaker.lib.AssStyle;
import assfxmaker.lib.AssStylePreview;
...
public class AssStyleDialog extends javax.swing.JDialog {
    ...
    private SpinnerNumberModel snmColor1;

    private SpinnerNumberModel snmColor2;

    private SpinnerNumberModel snmColor3;

    private SpinnerNumberModel snmColor4;

    private SpinnerNumberModel snmBorder;

    private SpinnerNumberModel snmShadow;

    private SpinnerNumberModel snmFontsize;

    private DefaultComboBoxModel cbmFont;

    private DefaultComboBoxModel cbmEnco;

    private boolean refreshInfos = true;
    ...
    public AssStyleDialog(java.awt.Frame parent, boolean modal) {
        ...
        cbmEnco.addElement(Encoding.ANSI);
        cbmEnco.addElement(Encoding.DEFAULT);
        cbmEnco.addElement(Encoding.SYMBOL);
        cbmEnco.addElement(Encoding.MAC);
        cbmEnco.addElement(Encoding.SHIFT_JIS);
        cbmEnco.addElement(Encoding.HANGUL);
        cbmEnco.addElement(Encoding.JOHAB);
        cbmEnco.addElement(Encoding.GB2312);
        cbmEnco.addElement(Encoding.BIG5);
        cbmEnco.addElement(Encoding.GREEK);
        cbmEnco.addElement(Encoding.TURKISH);
        cbmEnco.addElement(Encoding.VIETNAMESE);
        cbmEnco.addElement(Encoding.HEBREW);
        cbmEnco.addElement(Encoding.ARABIC);
        cbmEnco.addElement(Encoding.BALTIC);
        cbmEnco.addElement(Encoding.RUSSIAN);
        cbmEnco.addElement(Encoding.THAI);
        cbmEnco.addElement(Encoding.EAST_EURO);
        cbmEnco.addElement(Encoding.OEM);
        cbmEnco.setSelectedItem(Encoding.DEFAULT);
        spiFontsize.setValue(40);
        spiBorderS.setValue(2);
        spiShadowS.setValue(2);
        spiMarginL.setValue(10);
        spiMarginR.setValue(10);
        spiMarginVT.setValue(10);
        spiMarginB.setValue(10);
        jPanel1.add(asp);
        setAlwaysOnTop(true);
    }
    ...
    private void lblColor1MouseClicked(java.awt.event.MouseEvent evt) {
    ...
    private void lblColor2MouseClicked(java.awt.event.MouseEvent evt) {
    ...
    private void lblColor3MouseClicked(java.awt.event.MouseEvent evt) {
    ...
    private void lblColor4MouseClicked(java.awt.event.MouseEvent evt) {
    ...
    private void cbFontnameActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    public AssStyle showDialog(AssStyle as) {
        setAssStyle(as);
        try {
            asp.setAssStyle(assStyle.getClone());
        } catch (Exception exc) {
        }
        int num = Integer.parseInt(spiText.getValue().toString());
        asp.setTextColor(lblColor1.getBackground(), num);
    ...
    private void updateStyle() {
        ...
        if (rb1.isSelected()) {
            assStyle.setAlignment(1);
        }
        if (rb2.isSelected()) {
            assStyle.setAlignment(2);
        }
        if (rb3.isSelected()) {
            assStyle.setAlignment(3);
        }
        if (rb4.isSelected()) {
            assStyle.setAlignment(4);
        }
        if (rb5.isSelected()) {
            assStyle.setAlignment(5);
        }
        if (rb6.isSelected()) {
            assStyle.setAlignment(6);
        }
        if (rb7.isSelected()) {
            assStyle.setAlignment(7);
        }
        if (rb8.isSelected()) {
            assStyle.setAlignment(8);
        }
        if (rb9.isSelected()) {
            assStyle.setAlignment(9);
        }
    ...
    private void updateControls() {
        ...
        if (assStyle.getAlignment() == 1) {
            rb1.setSelected(true);
        }
        if (assStyle.getAlignment() == 2) {
            rb2.setSelected(true);
        }
        if (assStyle.getAlignment() == 3) {
            rb3.setSelected(true);
        }
        if (assStyle.getAlignment() == 4) {
            rb4.setSelected(true);
        }
        if (assStyle.getAlignment() == 5) {
            rb5.setSelected(true);
        }
        if (assStyle.getAlignment() == 6) {
            rb6.setSelected(true);
        }
        if (assStyle.getAlignment() == 7) {
            rb7.setSelected(true);
        }
        if (assStyle.getAlignment() == 8) {
            rb8.setSelected(true);
        }
        if (assStyle.getAlignment() == 9) {
    ...
    public void setLanguageAndConfigure(Language lang) {
        localeLanguage = lang;
        if (lang.getValueOf("titleASD1") != null) {
            setTitle(lang.getValueOf("titleASD1"));
        }
        if (lang.getValueOf("buttonOk") != null) {
            OK_Button.setText(lang.getValueOf("buttonOk"));
        }
        if (lang.getValueOf("buttonCancel") != null) {
            Cancel_Button.setText(lang.getValueOf("buttonCancel"));
        }
        if (lang.getValueOf("labelName") != null) {
            jLabel17.setText(lang.getValueOf("labelName"));
        }
        if (lang.getValueOf("labelText") != null) {
            lblColorText4.setText(lang.getValueOf("labelText"));
        }
        if (lang.getValueOf("labelKaraoke") != null) {
            lblColorKaraoke.setText(lang.getValueOf("labelKaraoke"));
        }
        if (lang.getValueOf("labelBorder") != null) {
            lblColorBorder.setText(lang.getValueOf("labelBorder"));
        }
        if (lang.getValueOf("labelShadow") != null) {
            lblColorShadow.setText(lang.getValueOf("labelShadow"));
        }
        if (lang.getValueOf("labelFontName") != null) {
            jLabel18.setText(lang.getValueOf("labelFontName"));
        }
        if (lang.getValueOf("labelFontSize") != null) {
            jLabel16.setText(lang.getValueOf("labelFontSize"));
        }
        if (lang.getValueOf("labelAlignment") != null) {
            jLabel23.setText(lang.getValueOf("labelAlignment"));
        }
        if (lang.getValueOf("labelScaleX") != null) {
            jLabel26.setText(lang.getValueOf("labelScaleX"));
        }
        if (lang.getValueOf("labelScaleY") != null) {
            jLabel27.setText(lang.getValueOf("labelScaleY"));
        }
        if (lang.getValueOf("labelRotation") != null) {
            jLabel28.setText(lang.getValueOf("labelRotation"));
        }
        if (lang.getValueOf("labelSpacing") != null) {
            jLabel29.setText(lang.getValueOf("labelSpacing"));
        }
        if (lang.getValueOf("labelBorder") != null) {
            jLabel24.setText(lang.getValueOf("labelBorder"));
        }
        if (lang.getValueOf("labelShadow") != null) {
            jLabel25.setText(lang.getValueOf("labelShadow"));
        }
        if (lang.getValueOf("labelMarginL") != null) {
            jLabel20.setText(lang.getValueOf("labelMarginL"));
        }
        if (lang.getValueOf("labelMarginR") != null) {
            jLabel21.setText(lang.getValueOf("labelMarginR"));
        }
        if (lang.getValueOf("labelMarginTV") != null) {
            jLabel19.setText(lang.getValueOf("labelMarginTV"));
        }
        if (lang.getValueOf("labelMarginB") != null) {
            jLabel22.setText(lang.getValueOf("labelMarginB"));
        }
        if (lang.getValueOf("labelEncoding") != null) {
            jLabel30.setText(lang.getValueOf("labelEncoding"));
        }
        if (lang.getValueOf("checkboxBold") != null) {
            cboBold.setText(lang.getValueOf("checkboxBold"));
        }
        if (lang.getValueOf("checkboxItalic") != null) {
            cboItalic.setText(lang.getValueOf("checkboxItalic"));
        }
        if (lang.getValueOf("checkboxUnderline") != null) {
            cboUnderline.setText(lang.getValueOf("checkboxUnderline"));
        }
        if (lang.getValueOf("checkboxStrikeOut") != null) {
            cboStrikeOut.setText(lang.getValueOf("checkboxStrikeOut"));
        }
        if (lang.getValueOf("checkboxOpaqueBox") != null) {
            cboOpaqueBox.setText(lang.getValueOf("checkboxOpaqueBox"));
        }
    }
