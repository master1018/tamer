...
public class AccordionTestCase extends WiQueryTestCase {
    ...
    public void testActivateInt() {
        ...
        assertEquals(accordion.activate(5).render().toString(), "$('#anId').accordion('activate', 5);");
    }
    ...
    public void testGetHeader() {
        ...
        assertEquals(accordion.getHeader().getJavascriptOption(), "'> li> :first-child, > :not(li):even'");
    ...
    public void testGetIcons() {
        ...
        assertEquals(accordion.getIcons().getJavascriptOption().toString(), "{'header': 'ui-icon-triangle-1-e', 'headerSelected': 'ui-icon-triangle-1-s'}");
        accordion.setIcons(new AccordionIcon("ui-icon-triangle-1-s", "ui-icon-triangle-1-e"));
        assertEquals(accordion.getIcons().getJavascriptOption().toString(), "{'header': 'ui-icon-triangle-1-s', 'headerSelected': 'ui-icon-triangle-1-e'}");
    }
    ...
    public void testSetChangeEvent() {
        ...
        assertEquals(accordion.statement().render().toString(), "$('#anId').accordion({change: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testSetChangeStartEvent() {
        ...
        assertEquals(accordion.statement().render().toString(), "$('#anId').accordion({changestart: function(event, ui) {\n\talert('event');\n}});");
    }
