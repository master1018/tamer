 ...
 * @version $Id: RectilinearTreeLayout.java 1045 2010-01-13 03:09:14Z stevensh $
 */
    ...
    private Point2D constructNode(Node node, double xPosition) {
        ...
        if (!tree.isExternal(node)) {
            ...
            for (final Node child : children) {
                ...
                Line2D branchLabelPath = new Line2D.Double(zeroBramch ? x - dd : x, yChild, zeroBramch ? cx + dd : cx, yChild);
