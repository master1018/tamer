...
public final class SyncXMLGenerator {
    ...
    public String generateInitMessage(Session session, SyncMessage syncMessage) {
        ...
        if (credential != null) {
            ...
            buffer.append("<" + SyncXMLTags.Meta + "> xmlns='" + SyncXMLTags.sycml_metinf + "'>" + "<" + SyncXMLTags.Type + ">" + credential.getType() + "</" + SyncXMLTags.Type + ">" + "</" + SyncXMLTags.Meta + ">");
    ...
    private String generateItems(Vector items) {
        ...
        for (int i = 0, size = items.size(); i < size; i++) {
            ...
            if (item.getData() != null) {
                buffer.append("<" + SyncXMLTags.Data + ">" + XMLUtilities.addCData(item.getData()) + "</" + SyncXMLTags.Data + ">\n");
            }
