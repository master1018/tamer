package de.uniwue.tm.textmarker.kernel;

import java.util.List;
import org.apache.uima.cas.CAS;
import de.uniwue.tm.textmarker.kernel.rule.TextMarkerRule;
...
public abstract class TextMarkerBlock extends TextMarkerStatement {
    ...
    public TextMarkerBlock(String id, TextMarkerRule rule, List<TextMarkerStatement> elements, TextMarkerBlock parent, String defaultNamespace, CAS cas) {
        super(parent);
        this.id = id;
        this.rule = rule;
