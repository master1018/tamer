...
class SchedulerTableModel extends AbstractTableModel {
   ...
   */
    public int getColumnCount() {
        return (JUDGE_COLUMN + 1) + subjectiveColumns.size() + (schedule.getNumberOfRounds() * NUM_COLUMNS_PER_ROUND);
    }
   ...
   */
    ...
    public int getFirstPerformanceColumn() {
        return JUDGE_COLUMN + 1 + subjectiveColumns.size();
    }
   ...
   */
    public Object getValueAt(final int rowIndex, final int columnIndex) {
        ...
        if (columnIndex == TEAM_NUMBER_COLUMN) {
            ...
            final int perfColIdx = columnIndex - getFirstPerformanceColumn();
    ...
    public String getColumnName(final int columnIndex) {
        if (columnIndex == TEAM_NUMBER_COLUMN) {
            ...
            return subjectiveColumns.get(columnIndex - JUDGE_COLUMN - 1);
        } else {
            final int perfColIdx = columnIndex - getFirstPerformanceColumn();
            final int round = perfColIdx / NUM_COLUMNS_PER_ROUND;
            switch(perfColIdx % NUM_COLUMNS_PER_ROUND) {
