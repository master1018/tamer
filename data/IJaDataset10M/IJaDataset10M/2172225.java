...
public class DefaultInteractionType extends InteractionType {
	 ...
	 */
    public static Intent createViewContactIntent(Context context, String contactLookupKey) {
        ...
        Uri contactUri = Contacts.lookupContact(context.getContentResolver(), Uri.withAppendedPath(Contacts.CONTENT_LOOKUP_URI, contactLookupKey));
