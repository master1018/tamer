...
/**
 * This exception is thrown when an illegal
 * musical position is used.
 * 
...
public class IllegalMPException extends RuntimeException {
    ...
    public String getMessage() {
        ...
        if (superMessage == null) return "Invalid MP: " + pos; else return superMessage + " - Invalid MP: " + pos;
    }
}
