...
public class RentalCarAboutBox extends javax.swing.JDialog {

    public RentalCarAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(rentalcar.RentalCarApp.class).getContext().getResourceMap(RentalCarAboutBox.class);
        setTitle(resourceMap.getString("title"));
        setModal(true);
        setName("aboutBox");
        setResizable(false);
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(rentalcar.RentalCarApp.class).getContext().getActionMap(RentalCarAboutBox.class, this);
