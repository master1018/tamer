...
public abstract class ResizableAjaxBehavior extends WiQueryAbstractAjaxBehavior {
    ...
    private class InnerResizableBehavior extends ResizableBehavior {
        ...
        protected Options getOptions() {
            throw new UnsupportedOperationException("You can't call this method into the ResizableAjaxBehavior");
        }
    ...
    public final void onResize(AjaxRequestTarget target) {
        int height = (int) this.getComponent().getRequest().getQueryParameters().getParameterValue(RESIZED_HEIGHT).toDouble();
        int width = (int) this.getComponent().getRequest().getQueryParameters().getParameterValue(RESIZED_WIDTH).toDouble();
    ...
    protected CharSequence getCallbackScript() {
        return generateCallbackScript("wicketAjaxGet('" + getCallbackUrl() + "&" + RESIZED_HEIGHT + "='+" + ResizableBehavior.UI_SIZE + ".height+'" + "&" + RESIZED_WIDTH + "='+" + ResizableBehavior.UI_SIZE + ".width");
    }
