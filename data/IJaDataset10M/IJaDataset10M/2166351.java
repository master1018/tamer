...
public abstract class LoginPage extends BasePage {
        ...
        if (parameters != null) {
            ...
            if (artifactId != null) {
                ...
                if (claimsRequest != null) {
                    ...
                    if (logger.isDebugEnabled()) logger.info("Received claims request " + claimsRequest.getId() + " from " + claimsRequest.getIssuerChannel() + " at " + claimsRequest.getIssuerEndpoint());
                    if (claimsRequest.getLastErrorId() != null) {
                        if (logger.isDebugEnabled()) logger.info("Received last error ID : " + claimsRequest.getLastErrorId() + " (" + claimsRequest.getLastErrorMsg() + ")");
    ...
    protected abstract Panel prepareSignInPanel(final String id, ClaimsRequest claimsRequest, MessageQueueManager artifactQueueManager, final IdentityMediationUnitRegistry idsuRegistry);
}
