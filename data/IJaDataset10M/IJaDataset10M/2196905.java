package homura.hde.input;

/**
 * This interface is used to receive mouse events from {@link homura.hde.input.MouseInput#update()}.
 */
public interface MouseInputListener {

    /**
     * Called in {@link homura.hde.input.KeyInput#update()} whenever a mouse button is pressed or released.
    ...
    /**
     * Called in {@link homura.hde.input.KeyInput#update()} whenever the mouse wheel is rotated.
    ...
    /**
     * Called in {@link homura.hde.input.KeyInput#update()} whenever the mouse is moved.
