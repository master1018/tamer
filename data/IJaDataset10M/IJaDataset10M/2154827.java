...
public class CheckListPeer extends AbstractFixturePeer {
    ...
    public CheckListPeer(final AliasRegistry aliasesRegistry, String listAlias, final CheckMode checkMode, final CellBinding titleBinding, final CellBinding typeBinding) {
    ...
    private boolean typeMatches(final ObjectAdapter adapter) {
        ...
        final String simpleRequiredType = Strings.simpleName(requiredTypeName);
