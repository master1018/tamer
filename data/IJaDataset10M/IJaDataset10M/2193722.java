...
public interface MethodSignature {
    ...
    public static final int CALL_BITMASK = 0x60;

    public static final int CALL_HAS_THIS = 0x20;

    public static final int CALL_EXPLICIT_THIS = 0x40;

    public static final int CALL_CONV_BITMASK = 0x17;

    public static final int CALL_CONV_DEFAULT = 0x00;

    public static final int CALL_CONV_C = 0x01;

    public static final int CALL_CONV_STD = 0x02;

    public static final int CALL_CONV_THIS = 0x03;

    public static final int CALL_CONV_FAST = 0x04;

    public static final int CALL_CONV_VARARG = 0x05;

    public static final int CALL_CONV_GENERIC = 0x10;
