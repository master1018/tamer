...
public class ACSync {
    ...
    public static void main(String args[]) {
        ...
        for (int i = 0; i < args.length; i++) {
            try {
                Player p = Manager.createPlayer(Utility.appArgToMediaLocator(args[i]));
        ...
        for (int i = 0; i < players.length; i++) {
            ...
            Component vis = players[i].getVisualComponent();
            if (vis != null) {
            ...
            if (i == master) {
                ...
                Component cont = players[i].getControlPanelComponent();
                if (cont != null) {
