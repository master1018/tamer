...
public class YLogPredicate {
    ...
    public String toXML() {
        ...
        if (_startPredicate != null) xml.append(StringUtil.wrapEscaped(_startPredicate, "start"));
        if (_completionPredicate != null) xml.append(StringUtil.wrapEscaped(_completionPredicate, "completion"));
