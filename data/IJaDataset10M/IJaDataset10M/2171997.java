...
public class SimInit {
   ...
   */
    ...
    private void open(String modelClass, boolean isBatch, String fileName) throws IllegalAccessException {
        SimModel model = null;
        try {
        ...
        if (!isBatch) {
            ...
            if (fileName.length() == 0) {
                ...
                try {
                    ...
                    if (exitOnExit) System.exit(0); else throw new RuntimeException("Error reading parameter file");
                }
