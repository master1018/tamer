...
public class SimpleOperatorScheduleParser extends AbstractXMLObjectParser {
    ...
    private final XMLSyntaxRule[] rules = { AttributeRule.newBooleanRule(SEQUENTIAL, true), new ElementRule(MCMCOperator.class, 1, Integer.MAX_VALUE), AttributeRule.newStringRule(OPTIMIZATION_SCHEDULE, true) };
