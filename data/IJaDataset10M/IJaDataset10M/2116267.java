...
public class DensityBasedClustererAlgorithm extends WekaAlgorithm {
    ...
    public DensityBasedClustererAlgorithm() {
        super("Density Based Clustering", "Density Based Clustering allows the user to specify" + " the number of clusters. The algorithm will return" + " the number of clusters which users want.");
        clusters = null;
