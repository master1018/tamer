...
public class BuyPilotsFromHouseCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        if (command.hasMoreElements()) {
            ...
            int money = 0;
            if (unitType == Unit.MEK) money = h.getIntegerConfig("CostToBuyNewPilot"); else money = h.getIntegerConfig("CostToBuyNewProtoPilot");
            ...
            for (int pilotCount = 0; pilotCount < numberOfPilots; pilotCount++) {
                ...
                if (unitType == Unit.MEK) {
                    ...
                    if (skills == null || skills.equals("")) toUser += ") from your faction for " + CampaignMain.cm.moneyOrFluMessage(true, true, money) + "."; else toUser += " " + skills + ") from your faction for " + CampaignMain.cm.moneyOrFluMessage(true, true, money) + ".";
                } else {
