...
public class ArrayDeclaration extends JavaOperator implements ReferenceType {
    ...
    public static JavaNode createNode(IRNode base, int dims) {
        return createNode(tree, base, dims);
    }

    public static JavaNode createNode(SyntaxTreeInterface tree, IRNode base, int dims) {
    ...
    public boolean isEquivalentNode(IRNode n1, IRNode n2) {
        return super.isEquivalentNode(n1, n2) && (JavaNode.getConstantNode(n1) == JavaNode.getConstantNode(n2)) && (JavaNode.getConstantInt(n1) == JavaNode.getConstantInt(n2)) && true;
    }
    ...
    public Vector[] missingTokens(IRNode node) {
        ...
        for (int j = 0; j < numChildren + 1; j++) TokenList[j] = new Vector();
        return TokenList;
    }
}
