...
public class RecordingOptionsTab extends TabAdapter {
    ...
    protected void buildGUI() {
        ...
        for (Format f : Format.values()) {
            ...
            if (f == Format.AVI) opt.setSelected(true);
        }
        ...
        for (Compression f : Compression.values()) {
            ...
            opt.setValue(f);
            opt.setText(f.getName());
            if (f == Compression.JPG) opt.setSelected(true);
        }
        ...
        if (StateManager.SOUND_ENABLED) FengGUI.createLabel(recordContainer, "Note: Recordings do not currently include sound.");
        recordingButton.addButtonPressedListener(new IButtonPressedListener() {
            ...
            public void buttonPressed(ButtonPressedEvent e) {
                ...
                if (file.exists()) fileWindow.getFileChooser().setCurrentDirectory(file);
            ...
            public void buttonPressed(ButtonPressedEvent e) {
                ...
                try {
                    if (StateManager.getRecordingManager().isRecording()) {
                        ...
                        } else pauseResume.setText(StringConstants.get("MAIN_MENU.RECORDING.PAUSE", "Pause"));
                    }
                } finally {
                    StateManager.getRecordingManager().getRecordingLock().unlock();
                }
