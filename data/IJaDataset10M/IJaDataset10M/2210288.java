...
public class LabelServiceTest {
    ...
    private LabelType givenLabelTypeStored() {
        ...
        final LabelType labelType = LabelType.create("label-type-name" + UUID.randomUUID());
    ...
    public void exportLabelTypes2() {
        ...
        for (LabelTypeDTO typeDTO : labelTypes.labelTypes) {
            if ((typeDTO.code.equalsIgnoreCase(labelType.getCode())) && (typeDTO.labels.size() == 2)) {
                return;
            }
        }
        fail();
    ...
    public void importInvalidLabelWithoutAttributes() {
        ...
        List<InstanceConstraintViolationsDTO> instanceConstraintViolationsList = labelService.addLabelTypes(new LabelTypeListDTO(Arrays.asList(labelTypeDTO))).instanceConstraintViolationsList;
        assertThat(instanceConstraintViolationsList.size(), equalTo(1));
        List<ConstraintViolationDTO> constraintViolations = instanceConstraintViolationsList.get(0).constraintViolations;
    ...
    public void importValidLabelType() {
        ...
        LabelTypeDTO labelTypeDTO = new LabelTypeDTO("label-type-name" + UUID.randomUUID().toString(), new ArrayList<LabelDTO>());
        List<InstanceConstraintViolationsDTO> instanceConstraintViolationsList = labelService.addLabelTypes(new LabelTypeListDTO(Arrays.asList(labelTypeDTO))).instanceConstraintViolationsList;
        assertThat(instanceConstraintViolationsList.size(), equalTo(0));
        int current = transactionService.runOnTransaction(new IOnTransaction<Integer>() {
    ...
    public void importTwoValidLabelType() {
        ...
        LabelTypeDTO labelTypeDTO1 = new LabelTypeDTO(nameType1, new ArrayList<LabelDTO>());
        LabelTypeDTO labelTypeDTO2 = new LabelTypeDTO(nameType2, new ArrayList<LabelDTO>());
        LabelTypeListDTO labelTypeDTOs = createLabelTypeListDTO(labelTypeDTO1, labelTypeDTO2);
        List<InstanceConstraintViolationsDTO> instanceConstraintViolationsList = labelService.addLabelTypes(labelTypeDTOs).instanceConstraintViolationsList;
        assertThat(instanceConstraintViolationsList.size(), equalTo(0));
        List<LabelType> labelTypes = transactionService.runOnTransaction(new IOnTransaction<List<LabelType>>() {
    ...
    public void importTwoLabelTypeWithRepeatedName() {
        ...
        LabelTypeDTO labelTypeDTO1 = new LabelTypeDTO(labelTypeName, new ArrayList<LabelDTO>());
        LabelTypeDTO labelTypeDTO2 = new LabelTypeDTO(labelTypeName, new ArrayList<LabelDTO>());
        List<InstanceConstraintViolationsDTO> instanceConstraintViolationsList = labelService.addLabelTypes(new LabelTypeListDTO(Arrays.asList(labelTypeDTO1, labelTypeDTO2))).instanceConstraintViolationsList;
        assertThat(instanceConstraintViolationsList.size(), equalTo(1));
        assertThat(instanceConstraintViolationsList.get(0).numItem, equalTo(new Long(2)));
        int current = transactionService.runOnTransaction(new IOnTransaction<Integer>() {
    ...
    public void importValidLabelTypeWithTwoValidLabels() {
        ...
        LabelTypeDTO labelTypeDTO = new LabelTypeDTO("label-type-nameY", labelDTOs);
        List<InstanceConstraintViolationsDTO> instanceConstraintViolationsList = labelService.addLabelTypes(new LabelTypeListDTO(Arrays.asList(labelTypeDTO))).instanceConstraintViolationsList;
        assertThat(instanceConstraintViolationsList.size(), equalTo(0));
        List<LabelType> labelTypes = transactionService.runOnTransaction(new IOnTransaction<List<LabelType>>() {
        ...
        for (Label label : labelType.getLabels()) {
            assertThat(label.getName(), anyOf(equalTo(labelDTO1.name), equalTo(labelDTO2.name)));
        }
    }
    ...
    public void importLabelTypeWithNameAlreadyOnDatabase() {
        ...
        String name = transactionService.runOnAnotherTransaction(new IOnTransaction<String>() {
        ...
        assertThat(current, equalTo(previous + 1));
        LabelTypeDTO labelTypeDTO = new LabelTypeDTO(name, new ArrayList<LabelDTO>());
        List<InstanceConstraintViolationsDTO> instanceConstraintViolationsList = labelService.addLabelTypes(new LabelTypeListDTO(Arrays.asList(labelTypeDTO))).instanceConstraintViolationsList;
        assertThat(instanceConstraintViolationsList.size(), equalTo(1));
        current = transactionService.runOnTransaction(new IOnTransaction<Integer>() {
    ...
    public void importValidLabelTypeWithTwoLabelsWithTheSameName() {
        ...
        List<LabelDTO> labelDTOs = Arrays.asList(labelDTO1, labelDTO2);
        LabelTypeDTO labelTypeDTO = new LabelTypeDTO("label-type-name", labelDTOs);
        List<InstanceConstraintViolationsDTO> instanceConstraintViolationsList = labelService.addLabelTypes(new LabelTypeListDTO(Arrays.asList(labelTypeDTO))).instanceConstraintViolationsList;
        assertThat(instanceConstraintViolationsList.size(), equalTo(1));
        assertThat(labelTypeDAO.getAll().size(), equalTo(previous));
    }
