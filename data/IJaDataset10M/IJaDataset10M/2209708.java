...
public class AGOClientServerRelationshipGroupEdge extends NAryEdge {
    ...
    public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
        ...
        if (nAryEdgesNum > 1 || edgesNum > 0 || !((selectedEdge == null) || (selectedEdge instanceof AGOClientServerRelationshipGroupEdge))) return false;
        AGOClientServerRelationshipGroupEdge edge = new AGOClientServerRelationshipGroupEdge(null);
        if (nAryEdgesNum == 1 && selectedEdge instanceof AGOClientServerRelationshipGroupEdge) edge = (AGOClientServerRelationshipGroupEdge) selectedEdge;
