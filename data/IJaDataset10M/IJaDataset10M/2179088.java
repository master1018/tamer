...
public class CSSStyleDeclarationTest extends WebDriverTestCase {
    ...
    public void style_MultipleCssAttributes() throws Exception {
        ...
        final WebDriver driver = loadPageWithAlerts2(html);
        assertEquals("color: pink; background: blue; foo: bar;", driver.findElement(By.id("div1")).getAttribute("style"));
    }
     ...
     */
    @Test
    @Alerts(IE = { "", "hidden", "" }, FF = { "", "hidden", "undefined" })
     ...
     */
    @Test
    @Alerts(IE = "undefined 0.5 0.33333 -3 3 8  7  10px foo auto ", FF = " 0.5 0.33333 -3 3 8 7 7 7 7 ")
    ...
    public void borderXxxWidthConstants() throws Exception {
        final String html = "<html><head><title>First</title><script>\n" + "function doTest() {\n" + "    var oDiv = document.getElementById('div1');\n" + "    alert(oDiv.style.borderRightWidth);\n" + "    oDiv = document.getElementById('div2');\n" + "    alert(oDiv.style.borderLeftWidth);\n" + "    oDiv = document.getElementById('div3');\n" + "    alert(oDiv.style.borderBottomWidth);\n" + "    alert(oDiv.style.borderTopWidth);\n" + "}\n" + "</script></head>\n" + "<body onload='doTest()'>\n" + "<div id='div1' style='border: thin'>foo</div>" + "<div id='div2' style='border: medium'>foo</div>" + "<div id='div3' style='border: thick'>foo</div>" + "</body></html>";
        loadPageWithAlerts2(html);
    }
    ...
    public void properties() throws Exception {
        ...
        properties.put(BrowserVersion.INTERNET_EXPLORER_6, new String[] { "background", "backgroundAttachment", "backgroundColor", "backgroundImage", "backgroundPosition", "backgroundPositionX", "backgroundPositionY", "backgroundRepeat", "behavior", "border", "borderBottom", "borderBottomColor", "borderBottomStyle", "borderBottomWidth", "borderCollapse", "borderColor", "borderLeft", "borderLeftColor", "borderLeftStyle", "borderLeftWidth", "borderRight", "borderRightColor", "borderRightStyle", "borderRightWidth", "borderStyle", "borderTop", "borderTopColor", "borderTopStyle", "borderTopWidth", "borderWidth", "bottom", "clear", "clip", "color", "cssText", "cursor", "direction", "display", "filter", "font", "fontFamily", "fontSize", "fontStyle", "fontVariant", "fontWeight", "height", "imeMode", "layoutFlow", "layoutGrid", "layoutGridChar", "layoutGridLine", "layoutGridMode", "layoutGridType", "left", "letterSpacing", "lineBreak", "lineHeight", "listStyle", "listStyleImage", "listStylePosition", "listStyleType", "margin", "marginBottom", "marginLeft", "marginRight", "marginTop", "maxHeight", "maxWidth", "minHeight", "minWidth", "msInterpolationMode", "overflow", "overflowX", "overflowY", "padding", "paddingBottom", "paddingLeft", "paddingRight", "paddingTop", "pageBreakAfter", "pageBreakBefore", "pixelBottom", "pixelLeft", "pixelRight", "pixelTop", "position", "posBottom", "posHeight", "posLeft", "posRight", "posTop", "posWidth", "right", "rubyAlign", "rubyOverhang", "rubyPosition", "scrollbar3dLightColor", "scrollbarArrowColor", "scrollbarBaseColor", "scrollbarDarkShadowColor", "scrollbarFaceColor", "scrollbarHighlightColor", "scrollbarShadowColor", "scrollbarTrackColor", "styleFloat", "tableLayout", "textAlign", "textAlignLast", "textAutospace", "textDecoration", "textDecorationBlink", "textDecorationLineThrough", "textDecorationNone", "textDecorationOverline", "textDecorationUnderline", "textIndent", "textJustify", "textJustifyTrim", "textKashida", "textKashidaSpace", "textOverflow", "textTransform", "textUnderlinePosition", "top", "unicodeBidi", "verticalAlign", "visibility", "whiteSpace", "width", "wordBreak", "wordSpacing", "wordWrap", "writingMode", "zIndex", "zoom" });
    ...
    private void properties(final String[] expectedProperties) throws Exception {
        ...
        final List<String> collectedStyles = Arrays.asList(driver.findElement(By.id("myTextarea")).getText().split(" "));
    ...
    public void properties2() throws Exception {
        final Map<BrowserVersion, String[]> properties = new HashMap<BrowserVersion, String[]>();
        properties.put(BrowserVersion.INTERNET_EXPLORER_6, new String[] { "background", "backgroundAttachment", "backgroundColor", "backgroundImage", "backgroundPosition", "backgroundPositionX", "backgroundPositionY", "backgroundRepeat", "behavior", "border", "borderBottom", "borderBottomColor", "borderBottomStyle", "borderBottomWidth", "borderCollapse", "borderColor", "borderLeft", "borderLeftColor", "borderLeftStyle", "borderLeftWidth", "borderRight", "borderRightColor", "borderRightStyle", "borderRightWidth", "borderStyle", "borderTop", "borderTopColor", "borderTopStyle", "borderTopWidth", "borderWidth", "bottom", "clear", "clip", "color", "cssText", "cursor", "direction", "display", "filter", "font", "fontFamily", "fontSize", "fontStyle", "fontVariant", "fontWeight", "height", "imeMode", "layoutFlow", "layoutGrid", "layoutGridChar", "layoutGridLine", "layoutGridMode", "layoutGridType", "left", "letterSpacing", "lineBreak", "lineHeight", "listStyle", "listStyleImage", "listStylePosition", "listStyleType", "margin", "marginBottom", "marginLeft", "marginRight", "marginTop", "maxHeight", "maxWidth", "minHeight", "minWidth", "msInterpolationMode", "overflow", "overflowX", "overflowY", "padding", "paddingBottom", "paddingLeft", "paddingRight", "paddingTop", "pageBreakAfter", "pageBreakBefore", "position", "right", "rubyAlign", "rubyOverhang", "rubyPosition", "scrollbar3dLightColor", "scrollbarArrowColor", "scrollbarBaseColor", "scrollbarDarkShadowColor", "scrollbarFaceColor", "scrollbarHighlightColor", "scrollbarShadowColor", "scrollbarTrackColor", "styleFloat", "tableLayout", "textAlign", "textAlignLast", "textAutospace", "textDecoration", "textIndent", "textJustify", "textJustifyTrim", "textKashida", "textKashidaSpace", "textOverflow", "textTransform", "textUnderlinePosition", "top", "unicodeBidi", "verticalAlign", "visibility", "whiteSpace", "width", "wordBreak", "wordSpacing", "wordWrap", "writingMode", "zoom" });
        final String[] expectedProperties = properties.get(getBrowserVersion());
     ...
     */
    @Test
    @Alerts(IE6 = { "number", "0", "1", "2", "3", "4", "5", "5", "6", "7", "9" }, IE7 = { "number", "0", "1", "2", "3", "4", "5", "5", "6", "7", "9" }, IE8 = { "number", "0", "1", "2", "3", "4", "4", "5", "6", "7", "8" }, FF = { "string", "", "1", "2", "2", "2", "2", "5", "5", "5", "5" })
     ...
     */
    @Test
    @Alerts(IE = { "number", "0", "number", "0", "number", "4", "number", "4", "number", "4", "number", "0" }, FF = { "string", "", "string", "", "string", "4", "string", "", "string", "", "string", "" })
     ...
     */
    @Test
    @Alerts(IE6 = { "0", "0", "1", "0" }, IE7 = { "0", "0", "1", "0" }, IE8 = { "0", "error", "0", "1", "error", "1" }, FF = { "", "", "1", "1" })
     ...
     */
    @Test
    @Alerts(IE6 = { "0", "0", "1", "0" }, IE7 = { "0", "0", "1", "0" }, IE8 = { "0", "error", "0", "1", "error", "1" }, FF = { "", "", "1", "" })
     ...
     */
    @Test
    @Alerts(IE = { "0", "7", "8", "0", "error", "4", "error", "1" }, IE7 = { "0", "7", "8", "0", "error", "4", "error", "1" }, IE8 = { "0", "7", "7", "0", "error", "4", "error", "1" }, FF = { "", "7", "7", "", "4", "1" })
     ...
     */
    @Test
    @Alerts(IE = { "0", "error", "0", "1", "error", "1" }, FF = { "", "", "1", "1" })
     ...
     */
    @Test
    @Alerts({ "L:3px,R:3px,T:3px,B:3px", "L:5px,R:5px,T:5px,B:5px", "L:7px,R:2px,T:2px,B:2px", "L:3px,R:3px,T:3px,B:3px", "L:5px,R:5px,T:5px,B:5px", "L:7px,R:2px,T:2px,B:2px" })
    ...
    private void styleShorthand(final String style, final String attribute, final String expectedValue) throws Exception {
    ...
    private void getAttribute(final String params, final String... expected) throws Exception {
        final String html = "<html><body onload='alert(document.all[\"a\"].style.getAttribute(" + params + "))'>\n" + "<a id='a' href='#' style='color:green'>go</a></body></html>";
     ...
     */
    @Test
    @Alerts(IE = { "5px", "5", "1em", "16", "30px", "30" }, FF = { "5px", "undefined", "1em", "undefined" })
