...
import edu.nps.moves.disenum.ReceiverState;
...
public class ReceiverPduDisplayPanel extends javax.swing.JPanel {
    ...
    public void setData(ReceiverPdu pdu) {
        ...
        entityIDDisplayPanel.setData(pdu.getEntityId());
        radioIDTF.setText("" + pdu.getRadioId());
        paddingTF.setText("" + pdu.getPadding1());
        recvrStateTF.setText("" + ReceiverState.lookup[pdu.getReceiverState()].getDescription());
        recvPowerTF.setText("" + pdu.getReceivedPoser());
   ...
   */
    ...
    private void initComponents() {
        ...
        recvrStateLab.setText(NbBundle.getMessage(getClass(), "ReceiverPduDisplayPanel.recvrStateLab.text"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        ...
        recvPowerLab.setText(NbBundle.getMessage(getClass(), "ReceiverPduDisplayPanel.recvPowerLab.text"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        radioIDLab.setText(NbBundle.getMessage(getClass(), "ReceiverPduDisplayPanel.radioIDLab.text"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        paddingLab.setText(NbBundle.getMessage(getClass(), "ReceiverPduDisplayPanel.paddingLab.text"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jLabel2.setText(NbBundle.getMessage(getClass(), "ReceiverPduDisplayPanel.jLabel2.text"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jLabel1.setText(NbBundle.getMessage(getClass(), "ReceiverPduDisplayPanel.jLabel1.text"));
        gridBagConstraints = new java.awt.GridBagConstraints();
