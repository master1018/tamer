...
public class OLEDBAlertWindow {
    ...
    private static final String ERROR_MESSAGE = "A configuration problem is preventing this html page from " + "communicating with the dashboard.  For instructions on how " + "to solve this problem, point your web browser at " + "http://localhost:2468/help/trustlib.htm";
}
