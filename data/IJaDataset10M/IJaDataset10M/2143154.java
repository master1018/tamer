...
public class SecurityAuthorityImpl implements SecurityAuthority {
     ...
     */
    public SecurityAuthorityImpl(MainFrame mainFrame, ProtocolProviderService protocolProvider) {
    ...
    public UserCredentials obtainCredentials(String realm, UserCredentials userCredentials) {
        AuthenticationWindow loginWindow = new AuthenticationWindow(mainFrame, protocolProvider, realm, userCredentials);
