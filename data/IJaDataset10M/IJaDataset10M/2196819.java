...
public class ViewerServiceClient {
   ...
   */
    public void addLogBranch(int indexInParent, Type type, String msg, Throwable caught, HelpInfo helpInfo, int parentLogHandle, final Callback<Integer> callback) {
   ...
   */
    public void addLogEntry(int indexInParent, Type type, String msg, Throwable caught, HelpInfo helpInfo, int logHandle) {
        LogData.Builder logDataBuilder = generateLogData(type, msg, caught, helpInfo);
        ...
        transport.executeRequestAsync(requestMessage, new Callback<Response>() {
            ...
            public void onError(Throwable t) {
                unexpectedErrorLogger.log(TreeLogger.WARN, "An error occurred while attempting to add a log entry.", t);
            }
        });
    }
   ...
   */
    ...
    private Request.Builder buildRequestMessageFromViewerRequest(ViewerRequest.Builder viewerRequestBuilder) {
        return Request.newBuilder().setServiceType(Request.ServiceType.VIEWER).setViewerRequest(viewerRequestBuilder);
    }

    private void checkCapability(List<Capability> viewerCapabilityList, RequestType capabilityWeNeed) {
    ...
    private LogData.Builder generateLogData(Type type, String msg, Throwable caught, HelpInfo helpInfo) {
