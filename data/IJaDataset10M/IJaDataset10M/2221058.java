...
public class FileScope extends AbstractRevuEntity<FileScope> {
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(pathPattern, fs.pathPattern).append(vcsAfterRev, fs.vcsAfterRev).append(vcsBeforeRev, fs.vcsBeforeRev).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(pathPattern).append(vcsAfterRev).append(vcsBeforeRev).toHashCode();
    }
}
