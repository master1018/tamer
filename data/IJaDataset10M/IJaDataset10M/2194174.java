...
public class GiveWriteAccessAction extends Action implements Disposable {
    ...
    private static final Logger log = Logger.getLogger(GiveWriteAccessAction.class.getName());
    ...
    protected void updateEnablement() {
        try {
            List<User> participants = SelectionRetrieverFactory.getSelectionRetriever(User.class).getSelection();
            setEnabled(sessionManager.getSarosSession() != null && participants.size() == 1 && participants.get(0).hasReadOnlyAccess());
