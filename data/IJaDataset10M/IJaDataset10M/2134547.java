...
import rpr2_d18.simpleDataRepresentations.float32;
 ...
 */
public class float32Array implements HLAfixedArray {

    ArrayList<float32> value = new ArrayList<float32>();

    /**
   * Constructor
   */
    public float32Array() throws RTIinternalError {
        value = new ArrayList<float32>();
        for (int i = 0; i < value.size(); i++) value.add(new float32());
    }
   ...
   */
    public void resize(int newSize) {
        ArrayList<float32> tempValue = value;
        value = new ArrayList<float32>(newSize);
        try {
            for (int i = 0; i < value.size(); i++) value.add(new float32());
   ...
   */
    public ArrayList<float32> getValue() {
        return value;
    }
   ...
   */
    public void setValue(ArrayList<float32> newValue) throws RTIinternalError {
        value = new ArrayList<float32>(newValue.size());
