...
public class CookieJar {
    ...
    abstract class CookieRecipe {
        ...
        protected abstract boolean isCookieAttribute(String stringLowercase);

        protected abstract boolean isCookieReservedWord(String token);
    }
    ...
    class CookiePress {
        ...
        private int getDomainAttributeStatus(String domainAttribute, String sourceHost) {
            ...
            } else if (CookieProperties.isDomainMatchingStrict() && sourceHost.lastIndexOf(domainAttribute) > sourceHost.indexOf('.')) {
