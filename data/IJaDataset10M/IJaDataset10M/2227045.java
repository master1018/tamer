...
/**
 * Represents Java interface for COM interface IHTMLInputTextElement.
 */
public interface IHTMLInputTextElement extends IDispatch {

    public static final String INTERFACE_IDENTIFIER = "{3050F2A6-98B5-11CF-BB82-00AA00BDCE0B}";
    ...
    void setDefaultValue(BStr p) throws ComException;
    ...
    void setReadOnly(VariantBool p) throws ComException;
