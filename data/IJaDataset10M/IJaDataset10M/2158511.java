...
public final class AShrIdIdShiftExpression extends PShiftExpression {
    ...
    public AShrIdIdShiftExpression(@SuppressWarnings("hiding") TIdentifier _identifier1_, @SuppressWarnings("hiding") List<PAdditionalIdentifier> _additionalIdentifiers1_, @SuppressWarnings("hiding") TShr _shr_, @SuppressWarnings("hiding") TIdentifier _identifier2_, @SuppressWarnings("hiding") List<PAdditionalIdentifier> _additionalIdentifiers2_) {
    ...
    @Override
    public Object clone() {
        return new AShrIdIdShiftExpression(cloneNode(this._identifier1_), cloneList(this._additionalIdentifiers1_), cloneNode(this._shr_), cloneNode(this._identifier2_), cloneList(this._additionalIdentifiers2_));
    }
    ...
    public String toString() {
        return "" + toString(this._identifier1_) + toString(this._additionalIdentifiers1_) + toString(this._shr_) + toString(this._identifier2_) + toString(this._additionalIdentifiers2_);
    }
