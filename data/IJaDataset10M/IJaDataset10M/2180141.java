...
public class NValue implements Value {
   ...
   */
    public NValue(int type, Object val) throws NBenchException {
        ...
        switch(type) {
            case ValueType.INT:
                if (val instanceof java.lang.Integer) break;
                throw new NBenchException("Integer value expected");
            case ValueType.STRING:
                if (val instanceof java.lang.String) break;
                throw new NBenchException("String value expected");
            case ValueType.TIMESTAMP:
                if (val instanceof java.sql.Timestamp) break;
                throw new NBenchException("Timestamp value expected");
            case ValueType.NUMERIC:
                if (val instanceof java.math.BigDecimal) break;
   ...
   */
    public NValue(Object val) throws NBenchException {
        if (val instanceof java.lang.Integer) {
            ...
            this.val = val;
        } else throw new NBenchException("unsupported type object:" + val);
    }
   ...
   */
    ...
    public static Object parseAs(String str, int tt) throws NBenchException {
        try {
            switch(tt) {
                case ValueType.INT:
