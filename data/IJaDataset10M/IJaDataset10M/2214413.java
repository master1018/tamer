...
public class ArrayElementUsageEdgeBuilder extends EdgeBuilder<ArrayElementUsageInfo> {
    ...
    public void addInterproceduralEdge() {
        {
            final ExpressionInfo expression = this.statement.getIndexExpression();
            final EdgeBuilder<?> builder = EdgeBuilder.getBuilder(expression);
            builder.addInterproceduralEdge();
        }
        {
            final ExpressionInfo expression = this.statement.getQualifierExpression();
            final EdgeBuilder<?> builder = EdgeBuilder.getBuilder(expression);
            builder.addInterproceduralEdge();
        }
    }
