...
public class PropertiesReadOnlyResource extends AbstractPropertiesResource {
     ...
     */
    public PropertiesReadOnlyResource(Locale locale, PropertiesSerializer serializer, PropertiesDeserializer deserializer, String contents, String resourceLocationLabel) {
    ...
    public void setText(String text) {
        throw new UnsupportedOperationException(getResourceLocationLabel() + " resource is read-only");
    }
