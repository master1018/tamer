package org.apache.axis2.transport.http.turnup;
...
import org.apache.axis2.transport.http.turnup.server.SimpleHttpServer;
import org.apache.axis2.transport.http.turnup.server.SimpleHttpServerConnection;
...
public class SimpleHTTPServer implements TransportListener {
    ...
    public SimpleHTTPServer(String contextPath, ConfigurationContext systemContext, int port) throws AxisFault {
        this(contextPath, systemContext, port, null);
    }
     ...
     * @param pool
     */
    public SimpleHTTPServer(String contextPath, ConfigurationContext systemContext, int port, ThreadFactory pool) throws AxisFault {
        ...
        TransportInDescription trsIn = new TransportInDescription(new QName(Constants.TRANSPORT_HTTP));
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            SimpleHTTPServer receiver = new SimpleHTTPServer("/axis2", ConfigurationContextFactory.createConfigurationContextFromFileSystem(args[0], null), port, null);
    ...
    public EndpointReference getEPRForService(String serviceName, String ip) throws AxisFault {
        ...
        if (embedded != null) {
            return new EndpointReference("http://" + localAddress + ":" + (embedded.getLocalPort()) + "/axis2/services/" + serviceName);
        } else {
            throw new AxisFault("Unable to generate EPR for the transport : http");
        }
    }
