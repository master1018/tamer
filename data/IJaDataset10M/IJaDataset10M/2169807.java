...
public class ProcessTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        getContext().bindService(new Intent(ISecondary.class.getName()), mSecondaryConnection, Context.BIND_AUTO_CREATE);
        synchronized (mSync) {
            if (!mHasConnected) {
                try {
                    mSync.wait();
