...
public class CallParticipantState {
     ...
     * state.
     */
    public static final CallParticipantState UNKNOWN = new CallParticipantState(_UNKNOWN);
     ...
     * the remote side.
     */
    public static final CallParticipantState INITIATING_CALL = new CallParticipantState(_INITIATING_CALL);
     ...
     */
    public static final CallParticipantState CONNECTING = new CallParticipantState(_CONNECTING);
     ...
     */
    public static final CallParticipantState ALERTING_REMOTE_SIDE = new CallParticipantState(_ALERTING_REMOTE_SIDE);
     ...
     */
    public static final CallParticipantState INCOMING_CALL = new CallParticipantState(_INCOMING_CALL);
     ...
     * participant.
     */
    public static final CallParticipantState CONNECTED = new CallParticipantState(_CONNECTED);
     ...
     */
    public static final CallParticipantState DISCONNECTED = new CallParticipantState(_DISCONNECTED);
     ...
     */
    public static final CallParticipantState BUSY = new CallParticipantState(_BUSY);
     ...
     */
    public static final CallParticipantState FAILED = new CallParticipantState(_FAILED);
     ...
     * participant has failed for an unexpected reason.
     */
    public static final CallParticipantState ON_HOLD = new CallParticipantState(_ON_HOLD);
