...
import fr.inria.uml4tst.papyrus.ocl4tst.ocl.RealLiteralExpCS;
 ...
 * <ul>
 *   <li>{@link fr.inria.uml4tst.papyrus.ocl4tst.ocl.impl.RealLiteralExpCSImpl#getIntValue <em>Int Value</em>}</li>
 *   <li>{@link fr.inria.uml4tst.papyrus.ocl4tst.ocl.impl.RealLiteralExpCSImpl#getRealValue <em>Real Value</em>}</li>
 *   <li>{@link fr.inria.uml4tst.papyrus.ocl4tst.ocl.impl.RealLiteralExpCSImpl#getNavigationOperator <em>Navigation Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RealLiteralExpCSImpl extends PrimitiveLiteralExpCSImpl implements RealLiteralExpCS {
    ...
    public void setIntValue(int newIntValue) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.REAL_LITERAL_EXP_CS__INT_VALUE, oldIntValue, intValue));
    }
    ...
    public void setRealValue(String newRealValue) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.REAL_LITERAL_EXP_CS__REAL_VALUE, oldRealValue, realValue));
    }
    ...
    public void setNavigationOperator(String newNavigationOperator) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.REAL_LITERAL_EXP_CS__NAVIGATION_OPERATOR, oldNavigationOperator, navigationOperator));
    }
