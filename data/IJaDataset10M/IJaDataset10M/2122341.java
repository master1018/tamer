...
public class RGB implements SVGRGBColor, PaintDef, PaintServer {
     ...
     */
    public void setPaint(final PiscesRenderGraphics rg, final PiscesRenderer pr, final int paintOpacity) {
        pr.setColor(0xff & (rgb >> 16), 0xff & (rgb >> 8), 0xff & rgb, (paintOpacity * (0xff & (rgb >> 24))) / 255);
    }
     ...
     *        PaintServer.
     */
    public void setPaintTarget(final String paintType, final PaintTarget paintTarget) {
    }
