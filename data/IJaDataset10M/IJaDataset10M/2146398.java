...
public class SingleEmailMessage extends com.sforce.soap.partner.Email implements java.io.Serializable {
    ...
    public SingleEmailMessage(java.lang.Boolean bccSender, com.sforce.soap.partner.EmailPriority emailPriority, java.lang.String replyTo, java.lang.Boolean saveAsActivity, java.lang.String senderDisplayName, java.lang.String subject, java.lang.Boolean useSignature, java.lang.String[] bccAddresses, java.lang.String[] ccAddresses, java.lang.String charset, java.lang.String[] documentAttachments, java.lang.String htmlBody, com.sforce.soap.partner.EmailFileAttachment[] fileAttachments, java.lang.String plainTextBody, java.lang.String targetObjectId, java.lang.String templateId, java.lang.String[] toAddresses, java.lang.String whatId) {
        super(bccSender, emailPriority, replyTo, saveAsActivity, senderDisplayName, subject, useSignature);
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = super.equals(obj) && ((this.bccAddresses == null && other.getBccAddresses() == null) || (this.bccAddresses != null && java.util.Arrays.equals(this.bccAddresses, other.getBccAddresses()))) && ((this.ccAddresses == null && other.getCcAddresses() == null) || (this.ccAddresses != null && java.util.Arrays.equals(this.ccAddresses, other.getCcAddresses()))) && ((this.charset == null && other.getCharset() == null) || (this.charset != null && this.charset.equals(other.getCharset()))) && ((this.documentAttachments == null && other.getDocumentAttachments() == null) || (this.documentAttachments != null && java.util.Arrays.equals(this.documentAttachments, other.getDocumentAttachments()))) && ((this.htmlBody == null && other.getHtmlBody() == null) || (this.htmlBody != null && this.htmlBody.equals(other.getHtmlBody()))) && ((this.fileAttachments == null && other.getFileAttachments() == null) || (this.fileAttachments != null && java.util.Arrays.equals(this.fileAttachments, other.getFileAttachments()))) && ((this.plainTextBody == null && other.getPlainTextBody() == null) || (this.plainTextBody != null && this.plainTextBody.equals(other.getPlainTextBody()))) && ((this.targetObjectId == null && other.getTargetObjectId() == null) || (this.targetObjectId != null && this.targetObjectId.equals(other.getTargetObjectId()))) && ((this.templateId == null && other.getTemplateId() == null) || (this.templateId != null && this.templateId.equals(other.getTemplateId()))) && ((this.toAddresses == null && other.getToAddresses() == null) || (this.toAddresses != null && java.util.Arrays.equals(this.toAddresses, other.getToAddresses()))) && ((this.whatId == null && other.getWhatId() == null) || (this.whatId != null && this.whatId.equals(other.getWhatId())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getBccAddresses() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getBccAddresses()); i++) {
        ...
        if (getCcAddresses() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getCcAddresses()); i++) {
        ...
        if (getDocumentAttachments() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getDocumentAttachments()); i++) {
        ...
        if (getFileAttachments() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getFileAttachments()); i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(SingleEmailMessage.class, true);
