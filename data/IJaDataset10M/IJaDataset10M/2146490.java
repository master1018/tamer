...
public class ModelMap extends LinkedHashMap {
    ...
    public Errors getErrors() {
        if (errors == null) errors = new BindingResultImpl(null);
        return errors;
    }
    ...
    public void addErrors(ModelMap modelMap) {
        if (modelMap != null && modelMap.hasErrors()) this.getErrors().addAllErrors(modelMap.getErrors());
    }
    ...
    public void addErrors(Errors errors) {
        if (errors != null) this.getErrors().addAllErrors(errors);
    }
}
