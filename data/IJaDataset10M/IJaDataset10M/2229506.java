...
public class ReferenceChangeLeftTargetItemProvider extends ReferenceChangeItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    ...
    public String getText(Object object) {
        ...
        return getString("_UI_ReferenceChangeLeftTarget_type") + " " + referenceChangeLeftTarget.isConflicting();
    }
    ...
    protected void addRightRemovedTargetPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_ReferenceChangeLeftTarget_rightRemovedTarget_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ReferenceChangeLeftTarget_rightRemovedTarget_feature", "_UI_ReferenceChangeLeftTarget_type"), DiffPackage.Literals.REFERENCE_CHANGE_LEFT_TARGET__RIGHT_REMOVED_TARGET, true, false, true, null, null, null));
    }
