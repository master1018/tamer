...
public class SubMenuCommand extends Command {
    ...
    public synchronized void addSubCommand(Command cmd) {
        ...
        if (subCommands == null) {
            ...
            System.arraycopy(subCommands, 0, newCommands, 0, subCommands.length);
    ...
    public synchronized void addSubCommands(Command[] cmds) {
        ...
        if (subCommands == null) {
            ...
            Command[] newCommands = new Command[subCommands.length + cmds.length];
            System.arraycopy(subCommands, 0, newCommands, 0, subCommands.length);
            System.arraycopy(cmds, 0, newCommands, subCommands.length, cmds.length);
            subCommands = newCommands;
            newCommands = null;
        }
    }
