...
public class UserAgentTools {
    ...
    public static String[] getOS(String userAgent) {
        ...
        if ((pos = userAgent.indexOf("Windows-NT")) > -1) {
            ...
            if ((pos = userAgent.indexOf("Windows NT 5.1")) > -1) {
                ...
                res = getArray("Win", "WinNT", "WinNT");
            } else res = getArray("Win", "WinNT?", "WinNT?");
            ...
            if (userAgent.indexOf("PPC") > -1) res = getArray("Mac", "MacPPC", "Mac PPC"); else res = getArray("Mac?", "Mac?", "MacOS?");
    ...
    public static String[] getBrowser(String userAgent) {
        ...
        if ((pos = userAgent.indexOf("Lotus-Notes/")) > -1) {
            ...
            } else res = getArray("MSIE", "MSIE?", "MSIE?" + getVersionNumber(userAgent, userAgent.indexOf("MSIE") + 4) + "");
        ...
        } else if (userAgent.indexOf("Mozilla/4.") == 0 && userAgent.indexOf("Mozilla/4.0") < 0 && userAgent.indexOf("Mozilla/4.5 ") < 0) {
            res = getArray("Communicator", "Communicator", "Communicator" + getVersionNumber(userAgent, pos + 8));
        } else return getArray("?", "?", "?");
        return res;
    }

    public static String getUserPlatform(String agent) {
        int id_start = agent.indexOf('(');
        if (id_start < 0) return null;
        int id_end = agent.indexOf(')');
        if (id_end < id_start) return null;
        return agent.substring(id_start + 1, id_end);
    }
}
