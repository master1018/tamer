...
public class YamahaTG33BankDriver extends BankDriver {
    ...
    public YamahaTG33BankDriver(final Device device) {
        super(device, "Bank", "Brian Klock", 64, 4);
        sysexID = "F043**7E****4C4D2020303031325643";
        deviceIDoffset = 2;
        bankNumbers = new String[] { "0-Internal", "1-Card1", "2-Preset1", "3-Unused", "4-Card2", "5-Preset2" };
    ...
    public String getPatchName(Patch p, int patchNum) {
        ...
        nameStart += 12;
        try {
            return new String(p.sysex, nameStart, 8, "US-ASCII");
    ...
    public Patch getPatch(Patch bank, int patchNum) {
        try {
            ...
            Logger.reportError("Error", "Error in TG33 Bank Driver", e);
            return null;
        }
    }
