...
class SessionSchedule {
    ...
    protected static final Logger log = LoggerFactory.getLogger(SessionSchedule.class);
    ...
    private class TimeEndPoint {
        ...
        public String toString() {
            try {
                ...
                return (isSet(weekDay) ? DayConverter.toString(weekDay) + "," : "") + utc.format(calendar.getTime()) + "-" + utc.getTimeZone().getID();
            } catch (ConfigError e) {
                return "ERROR: " + e;
            }
        }
    ...
    public String toString() {
        ...
        if (startTime.getTimeZone() != SystemTime.UTC_TIMEZONE || endTime.getTimeZone() != SystemTime.UTC_TIMEZONE) {
            buf.append(" (");
    ...
    private int getDay(SessionSettings settings, SessionID sessionID, String key, int defaultValue) throws ConfigError, FieldConvertError {
        return settings.isSetting(sessionID, key) ? DayConverter.toInteger(settings.getString(sessionID, key)) : NOT_SET;
    }
