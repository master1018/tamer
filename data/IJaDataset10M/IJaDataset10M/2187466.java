 ...
 * 
 */
public class UsageNotificationManagerMBeanImpl extends StandardMBean implements UsageNotificationManagerMBean {
    ...
    public UsageNotificationManagerMBeanImpl(Class<?> interfaceName, NotificationSource notificationSource, SleeComponentWithUsageParametersInterface component) throws NotCompliantMBeanException, ClassNotFoundException {
        super(interfaceName);
