...
public class DARConfigurationServiceImpl extends RemoteServiceServlet implements DARConfigurationService {
    ...
    private ObjectName getApplicationDispatcher() {
        try {
            ...
            ObjectInstance dispatcherInstance = (ObjectInstance) mserver.queryMBeans(dispatcherQuery, null).iterator().next();
    ...
    public void configure(String config) {
        try {
            ...
            mserver.invoke(dispatcherName, "updateApplicationRouterConfiguration", new Object[] { props }, new String[] { Object.class.getName() });
        } catch (Throwable t) {
    ...
    public String[] getApplications() {
        try {
            ObjectName dispatcherName = getApplicationDispatcher();
            String[] applications = (String[]) mserver.invoke(dispatcherName, "findInstalledSipApplications", new Object[] {}, new String[] {});
            return applications;
        } catch (Throwable t) {
            throw new RuntimeException(t);
        }
    ...
    public DARRoute[] getConfiguration() {
        try {
            ObjectName dispatcherName = getApplicationDispatcher();
            Object configuration = (Object) mserver.invoke(dispatcherName, "retrieveApplicationRouterConfiguration", new Object[] {}, new String[] {});
