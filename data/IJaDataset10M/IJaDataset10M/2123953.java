...
public class CML2CMLIdConverter extends AbstractConverter implements Converter {
    ...
    public static final String[] typicalArgsForConverterCommand = { "-sd", "src/test/resources/cml", "-odir", "../temp", "-is", "cml", "-os", "cml", "-converter", "org.xmlcml.cml.converters.molecule.xyz.CML2CMLIdConverter" };
