...
public class CobarSqlMapClientTemplateWithNamespaceShardingRouterTest extends AbstractTestNGCobarClientTest {
    ...
    public CobarSqlMapClientTemplateWithNamespaceShardingRouterTest() {
        super(new String[] { "META-INF/spring/cobar-client-appctx.xml", "META-INF/spring/datasources-appctx.xml", "META-INF/spring/namespace-sharding-router-appctx.xml" });
    }
    ...
    public void testQueryForListOnCobarSqlMapClientTemplate() {
        ...
        @SuppressWarnings("unchecked") List<Follower> resultList = (List<Follower>) getSqlMapClientTemplate().queryForList("com.alibaba.cobar.client.entities.Follower.findAll");
        ...
        @SuppressWarnings("unchecked") List<Follower> followersWithNameStartsWithA = (List<Follower>) getSqlMapClientTemplate().queryForList("com.alibaba.cobar.client.entities.Follower.finaByNameAlike", "A");
        ...
        @SuppressWarnings("unchecked") List<Follower> followersWithNameStartsWithD = (List<Follower>) getSqlMapClientTemplate().queryForList("com.alibaba.cobar.client.entities.Follower.finaByNameAlike", "D");
