...
public class FindTextPanel extends JPanel {
    ...
    /** Creates an instance of FindTextPanel */
    public FindTextPanel(JComponent editorPane, boolean showNext, boolean showPrevious) {
        this(editorPane, showNext, showPrevious, "Next", "Previous");
    }

    /** Creates an instance of FindTextPanel */
    public FindTextPanel(JComponent editorPane, boolean showNext, boolean showPrevious, String nextButtonText, String prevButtonText) {
        if (editorPane instanceof JEditorPane) {
            ...
            throw new UnsupportedOperationException("FindTextPanel can only" + " be used with JEditTextArea or JEditorPane insatances.");
        }
        ...
        if (editorPane != null) {
            findString.addKeyListener(new KeyAdapter() {
                ...
                public void keyReleased(KeyEvent e) {
                    try {
                        int found = editorPane.getDocument().getText(0, editorPane.getDocument().getLength()).indexOf(findString.getText(), 0);
                        if (found >= 0) {
                            editorPane.setSelectionEnd(found);
                            editorPane.setSelectionStart(found);
                            editorPane.setSelectionEnd(found + findString.getText().length());
            ...
            findString.addKeyListener(new KeyAdapter() {
                ...
                public void keyReleased(KeyEvent e) {
                    try {
                        ...
                        int found = editorPaneTA.getDocument().getText(0, editorPaneTA.getText().length()).indexOf(findString.getText(), start);
                        if (found >= 0) {
                            editorPaneTA.setMagicCaretPosition(found);
                            editorPaneTA.setSelectionEnd(found);
                            editorPaneTA.setSelectionStart(found);
                            editorPaneTA.setSelectionEnd(found + findString.getText().length());
                            findString.setBackground(Color.white);
                        } else {
                            findString.setBackground(Color.red);
                        }
                ...
                findNext.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent ae) {
                        try {
                            ...
                            int found = editorPane.getDocument().getText(0, editorPane.getDocument().getLength()).indexOf(findString.getText(), start);
                            if (found >= 0) {
                                editorPane.setSelectionEnd(found);
                                editorPane.setSelectionStart(found);
                                editorPane.setSelectionEnd(found + findString.getText().length());
            ...
            if (editorPane != null) {
                findPrev.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent ae) {
                        try {
                            int start = editorPane.getCaretPosition();
                            int found = editorPane.getDocument().getText(0, start).lastIndexOf(findString.getText());
                            if (found >= 0) {
                                editorPane.setSelectionEnd(found);
                                editorPane.setSelectionStart(found + findString.getText().length());
                                editorPane.setSelectionEnd(found);
                            }
                        } catch (Exception ignored) {
                            System.err.println("Exception in find: " + ignored);
                ...
                findPrev.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent ae) {
                        try {
                            int start = editorPaneTA.getCaretPosition();
                            int found = editorPaneTA.getDocument().getText(0, start).lastIndexOf(findString.getText());
                            if (found >= 0) {
                                editorPaneTA.setSelectionEnd(found);
                                editorPaneTA.setSelectionStart(found + findString.getText().length());
                                editorPaneTA.setSelectionEnd(found);
                            }
                        } catch (Exception ignored) {
                            System.err.println("Exception in find: " + ignored);
