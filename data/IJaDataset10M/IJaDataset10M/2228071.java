...
public class BagaturEvaluator extends EvaluatorAdapter implements FeatureWeights {
    ...
    BagaturEvaluator(IBitBoard _bitboard, EvalCache _evalCache, IEvalConfig _evalConfig) {
        bitboard = _bitboard;
    ...
    public double fullEval(int depth, int alpha, int beta, int rootColour) {
        ...
        eval += interpolator.interpolateByFactor(evalInfo.eval_Material_o + evalInfo.eval_Standard_o + evalInfo.eval_PST_o + evalInfo.eval_PawnsPattern_o + evalInfo.eval_PawnsStandard_o + evalInfo.eval_PawnsPassed_o + evalInfo.eval_PawnsPassedKing_o + evalInfo.eval_PawnsUnstoppable_o + evalInfo.eval_NoQueen_o, evalInfo.eval_Material_e + evalInfo.eval_Standard_e + evalInfo.eval_PST_e + evalInfo.eval_PawnsStandard_e + evalInfo.eval_PawnsPassed_e + evalInfo.eval_PawnsPassedKing_e + evalInfo.eval_PawnsUnstoppable_e + evalInfo.eval_NoQueen_e);
        initEvalInfo1();
        ...
        eval += interpolator.interpolateByFactor(evalInfo.eval_PawnsPassedStoppers_o + evalInfo.eval_PawnsRooksQueens_o, evalInfo.eval_PawnsPassedStoppers_e + evalInfo.eval_PawnsRooksQueens_e);
        initEvalInfo2();
        eval_mobility();
        evalInfo.eval_Mobility_o *= evalConfig.get_WEIGHT_MOBILITY_O();
        evalInfo.eval_Mobility_e *= evalConfig.get_WEIGHT_MOBILITY_E();
        eval += interpolator.interpolateByFactor(evalInfo.eval_Mobility_o, evalInfo.eval_Mobility_e);
        initEvalInfo3();
        eval_king_safety();
        eval_space();
        eval_hunged();
        ...
        eval += interpolator.interpolateByFactor(evalInfo.eval_Kingsafety_o + evalInfo.eval_Space_o + evalInfo.eval_Hunged_o + evalInfo.eval_Trapped_o + evalInfo.eval_Mobility_Safe_o + evalInfo.eval_PawnsPassedStoppers_a_o, evalInfo.eval_Kingsafety_e + evalInfo.eval_Space_e + evalInfo.eval_Hunged_e + evalInfo.eval_Trapped_e + evalInfo.eval_Mobility_Safe_e + evalInfo.eval_PawnsPassedStoppers_a_e);
        if (USE_CACHE && evalCache != null) {
            evalCache.lock();
    ...
    public int lazyEval(int depth, int alpha, int beta, int rootColour) {
        ...
        evalInfo.eval_PST_e *= evalConfig.get_WEIGHT_PST_E();
        evalInfo.eval_PawnsPattern_o *= WEIGHT_PP_O;
        int eval1 = interpolator.interpolateByFactor(evalInfo.eval_Material_o + evalInfo.eval_Standard_o + evalInfo.eval_PST_o + evalInfo.eval_PawnsPattern_o + evalInfo.eval_NoQueen_o, evalInfo.eval_Material_e + evalInfo.eval_Standard_e + evalInfo.eval_PST_e + evalInfo.eval_NoQueen_e);
        eval += eval1;
        if (eval + INT1 <= alpha || eval - INT1 >= beta) {
            if (USE_LAZY) {
                return returnVal(eval);
            }
        }
        ...
        evalInfo.eval_PawnsPassedKing_o *= evalConfig.get_WEIGHT_PAWNS_PASSED_KING_O();
        evalInfo.eval_PawnsPassedKing_e *= evalConfig.get_WEIGHT_PAWNS_PASSED_KING_E();
        int eval2 = interpolator.interpolateByFactor(evalInfo.eval_PawnsStandard_o + evalInfo.eval_PawnsPassed_o + evalInfo.eval_PawnsPassedKing_o + evalInfo.eval_PawnsUnstoppable_o, evalInfo.eval_PawnsStandard_e + evalInfo.eval_PawnsPassed_e + evalInfo.eval_PawnsPassedKing_e + evalInfo.eval_PawnsUnstoppable_e);
        eval += eval2;
        if (eval + INT2 <= alpha || eval - INT2 >= beta) {
            if (USE_LAZY) {
                return returnVal(eval);
            }
        }
        ...
        evalInfo.eval_PawnsRooksQueens_o *= WEIGHT_PAWNS_ROOKQUEEN_O;
        evalInfo.eval_PawnsRooksQueens_e *= WEIGHT_PAWNS_ROOKQUEEN_E;
        int eval3 = interpolator.interpolateByFactor(evalInfo.eval_PawnsPassedStoppers_o + evalInfo.eval_PawnsRooksQueens_o, evalInfo.eval_PawnsPassedStoppers_e + evalInfo.eval_PawnsRooksQueens_e);
        eval += eval3;
        ...
        evalInfo.eval_Mobility_o *= evalConfig.get_WEIGHT_MOBILITY_O();
        evalInfo.eval_Mobility_e *= evalConfig.get_WEIGHT_MOBILITY_E();
        int eval4 = interpolator.interpolateByFactor(evalInfo.eval_Mobility_o, evalInfo.eval_Mobility_e);
        eval += eval4;
        if (eval + INT4 <= alpha || eval - INT4 >= beta) {
            if (USE_LAZY) {
                return returnVal(eval);
            }
        }
        ...
        evalInfo.eval_PawnsPassedStoppers_a_o *= evalConfig.get_WEIGHT_PAWNS_PSTOPPERS_A_O();
        evalInfo.eval_PawnsPassedStoppers_a_e *= evalConfig.get_WEIGHT_PAWNS_PSTOPPERS_A_E();
        eval5 = interpolator.interpolateByFactor(evalInfo.eval_Kingsafety_o + evalInfo.eval_Space_o + evalInfo.eval_Hunged_o + evalInfo.eval_Trapped_o + evalInfo.eval_Mobility_Safe_o + evalInfo.eval_PawnsPassedStoppers_a_o, evalInfo.eval_Kingsafety_e + evalInfo.eval_Space_e + evalInfo.eval_Hunged_e + evalInfo.eval_Trapped_e + evalInfo.eval_Mobility_Safe_e + evalInfo.eval_PawnsPassedStoppers_a_e);
        eval += eval5;
    ...
    private int drawProbability(int eval) {
        ...
        if (w_bishops.getDataSize() == 1 && b_bishops.getDataSize() == 1) {
            long w_colour = (evalInfo.bb_w_bishops & Fields.ALL_WHITE_FIELDS) != 0 ? Fields.ALL_WHITE_FIELDS : Fields.ALL_BLACK_FIELDS;
            long b_colour = (evalInfo.bb_b_bishops & Fields.ALL_WHITE_FIELDS) != 0 ? Fields.ALL_WHITE_FIELDS : Fields.ALL_BLACK_FIELDS;
    ...
    private void initEvalInfo1() {
        ...
        evalInfo.bb_all_w_pieces = evalInfo.bb_w_pawns | evalInfo.bb_w_bishops | evalInfo.bb_w_knights | evalInfo.bb_w_rooks | evalInfo.bb_w_queens | evalInfo.bb_w_king;
        evalInfo.bb_all_b_pieces = evalInfo.bb_b_pawns | evalInfo.bb_b_bishops | evalInfo.bb_b_knights | evalInfo.bb_b_rooks | evalInfo.bb_b_queens | evalInfo.bb_b_king;
    ...
    private void initEvalInfo2() {
        ...
        evalInfo.attackZone[Figures.COLOUR_WHITE] = evalInfo.attackedBy[Constants.PID_B_KING] | evalInfo.attackedBy[Constants.PID_B_KING] << 8;
        evalInfo.attackZone[Figures.COLOUR_BLACK] = evalInfo.attackedBy[Constants.PID_W_KING] | evalInfo.attackedBy[Constants.PID_W_KING] >> 8;
        ...
        evalInfo.attackCount[Figures.COLOUR_WHITE] += Utils.countBits_less1s(evalInfo.attackedBy[Constants.PID_W_PAWN] & evalInfo.attackedBy[Constants.PID_B_KING]) / 2;
        evalInfo.attackCount[Figures.COLOUR_BLACK] += Utils.countBits_less1s(evalInfo.attackedBy[Constants.PID_B_PAWN] & evalInfo.attackedBy[Constants.PID_W_KING]) / 2;
    }
        ...
        if (w_knights_count > 0) {
            ...
            for (int i = 0; i < w_knights_count; i++) {
                ...
                if ((SPACE_BLACK & bb_field) != 0) {
                    ...
                    if ((bb_neighbors & evalInfo.bb_b_pawns) == 0) {
                        int scores = 1;
                        if ((BlackPawnPlies.ALL_BLACK_PAWN_ATTACKS_MOVES[fieldID] & evalInfo.bb_w_pawns) != 0) {
                            scores += 1;
                            if (b_knights.getDataSize() == 0) {
                                long colouredFields = (bb_field & Fields.ALL_WHITE_FIELDS) != 0 ? Fields.ALL_WHITE_FIELDS : Fields.ALL_BLACK_FIELDS;
        ...
        if (b_knights_count > 0) {
            ...
            for (int i = 0; i < b_knights_count; i++) {
                ...
                if ((SPACE_WHITE & bb_field) != 0) {
                    ...
                    if ((bb_neighbors & evalInfo.bb_w_pawns) == 0) {
                        int scores = 1;
    ...
    private void initEvalInfo3() {
        evalInfo.attackedByWhite = evalInfo.attackedBy[Constants.PID_W_PAWN] | evalInfo.attackedBy[Constants.PID_W_KNIGHT] | evalInfo.attackedBy[Constants.PID_W_BISHOP] | evalInfo.attackedBy[Constants.PID_W_ROOK] | evalInfo.attackedBy[Constants.PID_W_QUEEN] | evalInfo.attackedBy[Constants.PID_W_KING];
        evalInfo.attackedByBlack = evalInfo.attackedBy[Constants.PID_B_PAWN] | evalInfo.attackedBy[Constants.PID_B_KNIGHT] | evalInfo.attackedBy[Constants.PID_B_BISHOP] | evalInfo.attackedBy[Constants.PID_B_ROOK] | evalInfo.attackedBy[Constants.PID_B_QUEEN] | evalInfo.attackedBy[Constants.PID_B_KING];
    ...
    private void eval_king_safety() {
        int kingSafety = 0;
        if (evalInfo.attacked[Figures.COLOUR_BLACK] > 0) {
            long undefended = evalInfo.attackedBy[Constants.PID_W_KING] & evalInfo.attackedByBlack & ~evalInfo.attackedBy[Constants.PID_W_PAWN] & ~evalInfo.attackedBy[Constants.PID_W_KNIGHT] & ~evalInfo.attackedBy[Constants.PID_W_BISHOP] & ~evalInfo.attackedBy[Constants.PID_W_ROOK] & ~evalInfo.attackedBy[Constants.PID_W_QUEEN];
            int attackUnits = Math.min((evalInfo.attackCount[Figures.COLOUR_BLACK] * evalInfo.attackWeight[Figures.COLOUR_BLACK]) / 2, 50) + (evalInfo.attacked[Figures.COLOUR_BLACK] + Utils.countBits_less1s(undefended)) * 3 - evalInfo.w_gards;
            if (attackUnits < 0) attackUnits = 0;
            if (attackUnits >= 100) attackUnits = 99;
            kingSafety += KING_SAFETY[attackUnits];
        }
        if (evalInfo.attacked[Figures.COLOUR_WHITE] > 0) {
            long undefended = evalInfo.attackedBy[Constants.PID_B_KING] & evalInfo.attackedByWhite & ~evalInfo.attackedBy[Constants.PID_B_PAWN] & ~evalInfo.attackedBy[Constants.PID_B_KNIGHT] & ~evalInfo.attackedBy[Constants.PID_B_BISHOP] & ~evalInfo.attackedBy[Constants.PID_B_ROOK] & ~evalInfo.attackedBy[Constants.PID_B_QUEEN];
            int attackUnits = Math.min((evalInfo.attackCount[Figures.COLOUR_WHITE] * evalInfo.attackWeight[Figures.COLOUR_WHITE]) / 2, 50) + (evalInfo.attacked[Figures.COLOUR_WHITE] + Utils.countBits_less1s(undefended)) * 3 - evalInfo.b_gards;
            if (attackUnits < 0) attackUnits = 0;
            if (attackUnits >= 100) attackUnits = 99;
            kingSafety -= KING_SAFETY[attackUnits];
        }
    ...
    private void eval_space() {
        ...
        if (w_spaceWeight > 0) {
            ...
            long w_safe = SPACE_WHITE & ~evalInfo.bb_w_pawns & ~evalInfo.attackedBy[Constants.PID_B_PAWN] & (evalInfo.attackedByWhite | ~evalInfo.attackedByBlack);
        ...
        if (b_spaceWeight > 0) {
            ...
            long b_safe = SPACE_BLACK & ~evalInfo.bb_b_pawns & ~evalInfo.attackedBy[Constants.PID_W_PAWN] & (evalInfo.attackedByBlack | ~evalInfo.attackedByWhite);
    ...
    private int fianchetto() {
        int fianchetto = 0;
        long w_pawns = evalInfo.bb_w_pawns;
        long b_pawns = evalInfo.bb_b_pawns;
        long w_bishops = evalInfo.bb_w_bishops;
        long b_bishops = evalInfo.bb_b_bishops;
        long w_king = evalInfo.bb_w_king;
        long b_king = evalInfo.bb_b_king;
    ...
    protected int eval_patterns() {
        ...
        long w_bishops = evalInfo.bb_w_bishops;
        long b_bishops = evalInfo.bb_b_bishops;
        long w_knights = evalInfo.bb_w_knights;
        long b_knights = evalInfo.bb_b_knights;
        long w_pawns = evalInfo.bb_w_pawns;
        long b_pawns = evalInfo.bb_b_pawns;
        if (w_bishops != 0) {
