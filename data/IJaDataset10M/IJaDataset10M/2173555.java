...
public final class OTSymbol implements Comparable<OTSymbol>, Serializable {
     ...
     */
    public OTSymbol(String code, String company, String currency, InstrumentEnum type) {
        this.code = code;
    ...
    @Override
    public int hashCode() {
        return safeHashCode(code) + 3 * safeHashCode(company) + 5 * safeHashCode(currency) + 7 * safeHashCode(type);
    }
