...
public abstract class CalorieCountPanel extends ApplicationContentPanel {
    ...
    protected Object[][] SPEC_WINDOW_MENU = { { "Window" }, { "Foods", winFoodList }, { "Daylist", winDayList }, { "Frequently Selected", winFrequentList }, { "Position/Size", winSize }, { "Other Main Frame", otherMainFrame }, { "Budget", winBudget }, { "Properties", propertiesEdit }, { "System Properties", systemPropertiesDisplay } };

    protected Object[][] SPEC_FILE_ACTION_MENU = { { "File" }, { "New", fileNew }, { "Open...", fileOpen }, {}, { "Save", fileSave }, { "Save As...", fileSaveAs }, {}, { "Export...", fileExport }, { "Import...", fileImport }, { "Exit", fileExit } };
    ...
    protected Object[][] SPEC_HELP_MENU = { { "Help" }, { "About", helpAbout } };

    protected Object[][][] SPEC_MENU_BAR = { SPEC_FILE_ACTION_MENU, SPEC_WINDOW_MENU, SPEC_HELP_MENU };
    ...
    protected void showExample() {
        try {
            @SuppressWarnings("unused") ExampleWindow win = ExampleWindow.showFrame();
    ...
    public void initialize(Container container) throws LTSException {
        ...
        if (definesWindowProperties()) listenForWindowComponentEvents();
    }

    public Dimension getWindowSize() {
        Dimension dim = getWindowSizeFromProperties();
        if (null == dim) dim = getDefaultWindowSize();
        return dim;
    }
