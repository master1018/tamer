 ...
 *
 */
public interface Level3MapOfSetSelectedEntriesValueSelectedElementsSelectedOperator<K, V> extends UniqOperator<Map<K, Set<V>>>, ExecutableSelectedOperator<V>, ReplaceableOperator<V>, SelectedOperator<V> {
