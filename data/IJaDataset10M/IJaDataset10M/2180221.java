...
public class ProfileConfigurationUI extends JPanel implements ChangeListener {
    ...
    public ProfileConfigurationUI(Profile aMetric) {
        ...
        this.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(new Color(60, 60, 60), 1), BorderFactory.createEmptyBorder(15, 15, 15, 15)));
        ...
        slider = new JSlider(JSlider.HORIZONTAL, 0, 1000, (int) (profile.getNormalizationMaximum() * 1000));
