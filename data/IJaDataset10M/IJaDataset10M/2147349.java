...
class PreferencesDialog extends JDialog implements ActionListener {
    ...
    public PreferencesDialog(Frame owner) {
        ...
        tabbedPane.addTab(Bundle.getString("Preferences.appearance.tab"), appearancePanel);
        colorsPanel = new SourceColorsPanel();
        tabbedPane.addTab(Bundle.getString("Preferences.colors.tab"), colorsPanel);
        miscPanel = new MiscPanel();
        tabbedPane.addTab(Bundle.getString("Preferences.misc.tab"), miscPanel);
        shortsPanel = new ShortcutsPanel();
        tabbedPane.addTab(Bundle.getString("Preferences.keys.tab"), shortsPanel);
        viewPanel = new ViewPanel();
        tabbedPane.addTab(Bundle.getString("Preferences.view.tab"), viewPanel);
        JButton button = new JButton(Bundle.getString("Preferences.saveButton"));
        ...
        allPanel.add(button);
        button = new JButton(Bundle.getString("Preferences.cancelButton"));
    ...
    protected class AppearancePanel extends JPanel implements ItemListener {
        ...
        public void commitChanges() {
            Preferences prefs = Preferences.userRoot().node("com/bluemarsh/jswat/ui/graphical");
            ...
            if (cmd.equals("tabbed")) {
                prefs.putInt("viewDesktopType", ViewDesktopFactory.MODE_TABBED);
            } else if (cmd.equals("frames")) {
                prefs.putInt("viewDesktopType", ViewDesktopFactory.MODE_IFRAMES);
            }
        ...
        protected JPanel createDesktopPanel() {
            ...
            Border border = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), Bundle.getString("Preferences.appearance.desktop"));
            panel.setBorder(border);
            GridBagConstraints gbc = new GridBagConstraints();
            gbc.insets = new Insets(3, 3, 3, 3);
            Preferences prefs = Preferences.userRoot().node("com/bluemarsh/jswat/ui/graphical");
            JLabel label = new JLabel(Bundle.getString("Preferences.appearance.desktopMode"));
            gbc.anchor = GridBagConstraints.WEST;
            gbc.gridwidth = GridBagConstraints.REMAINDER;
            gbc.weightx = 1.0;
            gbl.setConstraints(label, gbc);
            panel.add(label);
            int mode = prefs.getInt("viewDesktopType", Defaults.VIEW_DESKTOP_TYPE);
            desktopButtonGroup = new ButtonGroup();
            JRadioButton rbutton = new JRadioButton(Bundle.getString("Preferences.appearance.desktopTabbed"));
            ...
            rbutton = new JRadioButton(Bundle.getString("Preferences.appearance.desktopFrames"));
            desktopButtonGroup.add(rbutton);
            ...
            panel.add(rbutton);
            rbutton.addItemListener(this);
            maxViewCBox = new JCheckBox(Bundle.getString("Preferences.appearance.maximizeView"));
            maxViewCBox.setSelected(prefs.getBoolean("maximizeView", Defaults.VIEW_MAXIMIZE));
            maxViewCBox.setEnabled(mode == ViewDesktopFactory.MODE_IFRAMES);
            gbl.setConstraints(maxViewCBox, gbc);
            panel.add(maxViewCBox);
            oneRowTabsCBox = new JCheckBox(Bundle.getString("Preferences.appearance.oneRowTabs"));
            oneRowTabsCBox.setSelected(prefs.getBoolean("oneRowTabs", Defaults.VIEW_SINGLE_ROW_TABS));
        ...
        protected JPanel createOutputPanel() {
            GridBagLayout gbl = new GridBagLayout();
            JPanel panel = new JPanel(gbl);
            Border border = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), Bundle.getString("Preferences.appearance.scroll"));
            panel.setBorder(border);
            GridBagConstraints gbc = new GridBagConstraints();
            gbc.insets = new Insets(3, 3, 3, 3);
            Preferences prefs = Preferences.userRoot().node("com/bluemarsh/jswat/ui/graphical");
            JLabel label = new JLabel(Bundle.getString("Preferences.appearance.messageLines"));
            gbc.anchor = GridBagConstraints.EAST;
            gbc.gridwidth = GridBagConstraints.RELATIVE;
            gbl.setConstraints(label, gbc);
            panel.add(label);
            int lines = prefs.getInt("messageLines", Defaults.MESSAGE_LINES_SAVE);
            SpinnerNumberModel spinnerModel = new SpinnerNumberModel(lines, 100, 10000, 10);
            ...
            label = new JLabel(Bundle.getString("Preferences.appearance.outputLines"));
            gbc.anchor = GridBagConstraints.EAST;
            gbc.gridwidth = GridBagConstraints.RELATIVE;
            gbc.ipadx = 00;
            gbl.setConstraints(label, gbc);
    ...
    protected class MiscPanel extends JPanel {
        ...
        public void commitChanges() {
            ...
            prefs = Preferences.userRoot().node("com/bluemarsh/jswat/Session");
            prefs.put("defaultStratum", stratumField.getText());
            prefs = Preferences.userRoot().node("com/bluemarsh/jswat/ui/mro");
        ...
        protected JPanel createFileMenuPanel() {
            GridBagLayout gbl = new GridBagLayout();
            JPanel panel = new JPanel(gbl);
            Border border = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), Bundle.getString("Preferences.misc.fileMenu"));
            panel.setBorder(border);
            GridBagConstraints gbc = new GridBagConstraints();
            gbc.insets = new Insets(3, 3, 3, 3);
            JLabel label = new JLabel(Bundle.getString("Preferences.misc.mroListSize"));
            gbc.anchor = GridBagConstraints.EAST;
            gbc.gridwidth = GridBagConstraints.RELATIVE;
            gbl.setConstraints(label, gbc);
            panel.add(label);
            Preferences prefs = Preferences.userRoot().node("com/bluemarsh/jswat/ui/mro");
        ...
        protected JPanel createMapperPanel() {
            GridBagLayout gbl = new GridBagLayout();
            JPanel panel = new JPanel(gbl);
            Border border = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), Bundle.getString("Preferences.misc.mapper"));
            panel.setBorder(border);
            GridBagConstraints gbc = new GridBagConstraints();
            gbc.insets = new Insets(3, 3, 3, 3);
            JLabel label = new JLabel(Bundle.getString("Preferences.misc.fileExt"));
            gbc.anchor = GridBagConstraints.EAST;
            gbc.gridwidth = GridBagConstraints.RELATIVE;
            gbl.setConstraints(label, gbc);
            panel.add(label);
            Preferences prefs = Preferences.userRoot().node("com/bluemarsh/jswat");
            String val = prefs.get("defaultFileExtension", Defaults.FILE_EXTENSION);
            ...
            label = new JLabel(Bundle.getString("Preferences.misc.stratum"));
            gbc.anchor = GridBagConstraints.EAST;
            gbc.gridwidth = GridBagConstraints.RELATIVE;
            gbl.setConstraints(label, gbc);
            panel.add(label);
        ...
        protected JPanel createEvalPanel() {
            GridBagLayout gbl = new GridBagLayout();
            JPanel panel = new JPanel(gbl);
            Border border = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), Bundle.getString("Preferences.misc.evaluator"));
            panel.setBorder(border);
            GridBagConstraints gbc = new GridBagConstraints();
            gbc.insets = new Insets(3, 3, 3, 3);
            JLabel label = new JLabel(Bundle.getString("Preferences.misc.rmiTimeout"));
            gbc.anchor = GridBagConstraints.EAST;
            gbc.gridwidth = GridBagConstraints.RELATIVE;
            gbl.setConstraints(label, gbc);
            panel.add(label);
            ...
            SpinnerNumberModel smodel = new SpinnerNumberModel(timeout, 0, 60000, 1000);
    ...
    protected class ShortcutsPanel extends JPanel {
         ...
         */
        protected void buildElement(String name, GridBagLayout gbl, GridBagConstraints gbc, JPanel panel) {
            JLabel label = new JLabel(Bundle.getString("Preferences." + name));
            gbc.anchor = GridBagConstraints.EAST;
            gbc.gridwidth = GridBagConstraints.RELATIVE;
            gbc.weightx = 0.0;
            gbl.setConstraints(label, gbc);
            panel.add(label);
            Preferences prefs = Preferences.userRoot().node("com/bluemarsh/jswat/ui/graphical");
            String text = prefs.get(name, (String) Defaults.KEYBOARD_SHORTS.get(name));
        ...
        protected JPanel createShortcutsPanel() {
            GridBagLayout gbl = new GridBagLayout();
            JPanel panel = new JPanel(gbl);
            Border border = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), Bundle.getString("Preferences.keys.mappings"));
            panel.setBorder(border);
            GridBagConstraints gbc = new GridBagConstraints();
            gbc.insets = new Insets(3, 3, 3, 3);
    ...
    protected class SourceColorsPanel extends JPanel {
        ...
        protected void buildElement(String name, JPanel panel) {
            ...
            String color = prefs.get(name, (String) Defaults.VIEW_COLORS.get(name));
        ...
        protected JPanel createColorsPanel() {
            ...
            Border border = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), Bundle.getString("Preferences.colors.java"));
            panel.setBorder(border);
    ...
    public class ColorButton extends JButton implements ActionListener {
         ...
         */
        public void actionPerformed(ActionEvent e) {
            Color c = JColorChooser.showDialog(PreferencesDialog.this, "Choose Color", colorIcon.getColor());
            if (c != null) {
                colorIcon.setColor(c);
                repaint();
            }
     ...
     * @author  Nathan Fiedler
     */
    protected class ViewPanel extends JPanel implements ChangeListener, ListSelectionListener {
        ...
        public void commitChanges() {
            ...
            prefs.putBoolean("shortMethodDescInPopup", shortMethodDescCheckBox.isSelected());
        }
        ...
        protected JPanel createFontPanel() {
            GridBagLayout gbl = new GridBagLayout();
            JPanel panel = new JPanel(gbl);
            Border border = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), Bundle.getString("Preferences.view.font"));
            panel.setBorder(border);
            GridBagConstraints gbc = new GridBagConstraints();
            gbc.insets = new Insets(3, 3, 3, 3);
            Preferences prefs = Preferences.userRoot().node("com/bluemarsh/jswat/view");
            ...
            String family = prefs.get("fontFamily", Defaults.VIEW_FONT_FAMILY);
            ...
            panel.add(scroller);
            JLabel label = new JLabel(Bundle.getString("Preferences.view.fontSize"));
            gbc.anchor = GridBagConstraints.EAST;
            gbc.gridheight = 1;
            gbc.gridwidth = GridBagConstraints.RELATIVE;
            gbl.setConstraints(label, gbc);
            ...
            SpinnerNumberModel spinnerModel = new SpinnerNumberModel(fontSize, 4, 192, 1);
            ...
            fontSampleArea = new JTextArea("for (int i = 0; i < arr.length; i++) {\n" + "\twriteString(i);\n" + "} // for");
        ...
        protected JPanel createEditorPanel() {
            GridBagLayout gbl = new GridBagLayout();
            JPanel panel = new JPanel(gbl);
            Border border = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), Bundle.getString("Preferences.view.editor"));
            panel.setBorder(border);
            GridBagConstraints gbc = new GridBagConstraints();
            gbc.insets = new Insets(3, 3, 3, 3);
            JLabel label = new JLabel(Bundle.getString("Preferences.misc.sourceEditor"));
            gbc.anchor = GridBagConstraints.WEST;
            gbc.gridwidth = GridBagConstraints.REMAINDER;
        ...
        protected JPanel createPopupPanel() {
            GridBagLayout gbl = new GridBagLayout();
            JPanel panel = new JPanel(gbl);
            Border border = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), Bundle.getString("Preferences.view.popup"));
            panel.setBorder(border);
            GridBagConstraints gbc = new GridBagConstraints();
            gbc.insets = new Insets(3, 3, 3, 3);
            Preferences prefs = Preferences.userRoot().node("com/bluemarsh/jswat/view");
            boolean shortMethods = prefs.getBoolean("shortMethodDescInPopup", Defaults.VIEW_POPUP_SHORT_METHOD_DESC);
            shortMethodDescCheckBox = new JCheckBox(Bundle.getString("Preferences.view.viewPopupShortMethodDesc"), shortMethods);
            gbc.fill = GridBagConstraints.HORIZONTAL;
            gbc.weightx = 1.0;
