 ...
 * 
 * @author jwhaley
 * @version $Id: FindBestPermutation.java 2465 2006-06-07 23:03:17Z joewhaley $
 */
public class FindBestPermutation extends Thread {
     ...
     * @param filename
     */
    public FindBestPermutation(boolean reverse, String orderingToTry, String filename) {
        super();
    ...
    static String tweakInterleaving(String ordering) {
        ...
        if (s.equals("x")) sb.append("_"); else sb.append("x");
        while (st.hasMoreTokens()) {
            sb.append(st.nextToken());
        }
        return sb.toString();
