    ...
    public PhosphoTextWriter(File file, Pathway pw) {
        ...
        try {
            ...
            while (it2.hasNext()) {
                ...
                String from = ((BiologicalNodeAbstract) pw.getNodeByVertexID(edge.getEndpoints().getFirst().toString())).getLabel();
                String to = ((BiologicalNodeAbstract) pw.getNodeByVertexID(edge.getEndpoints().getSecond().toString())).getLabel();
                buff.append(from + ";" + to + " \n");
            }
            buff.append("\n");
