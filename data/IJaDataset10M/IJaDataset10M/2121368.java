...
public class GeneralConfigFrame extends JFrame implements ActionListener {
    ...
    /** Screen size table */
    protected static final int[][] SCREENSIZE_TABLE = { { 320, 240 }, { 400, 300 }, { 480, 360 }, { 512, 384 }, { 640, 480 }, { 800, 600 }, { 1024, 768 }, { 1152, 864 }, { 1280, 960 } };
    ...
    public void load() {
        ...
        comboboxScreenSize.setSelectedIndex(4);
        for (int i = 0; i < SCREENSIZE_TABLE.length; i++) {
