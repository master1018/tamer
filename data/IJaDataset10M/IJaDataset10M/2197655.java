...
public class LoadTestMasterOperationTest extends AbstractTest {
    ...
    public void testNodeCount() throws Exception {
        ...
        LoadTestMasterOperation operation = new LoadTestMasterOperation(nodeCount, 10, 20, 2, 20000, _queryExecutor, _temporaryFolder.newFolder("result"));
    ...
    public void testNodeOperation() throws Exception {
        ...
        int runTime = 20000;
        when(_protocol.getLiveNodes()).thenReturn(Arrays.asList("n1", "n2", "n3"));
        LoadTestMasterOperation operation = new LoadTestMasterOperation(nodeCount, startRate, endRate, step, runTime, _queryExecutor, _temporaryFolder.newFolder("result"));
        operation.execute(_context, Collections.EMPTY_LIST);
    ...
    public void testResultFiles() throws Exception {
        ...
        LoadTestMasterOperation operation = new LoadTestMasterOperation(nodeCount, startRate, endRate, step, runTime, _queryExecutor, resultFolder);
        operation.execute(_context, Collections.EMPTY_LIST);
