...
public class SortableBehaviorTestCase extends WiQueryTestCase {
    ...
    public void testCancel() {
        ...
        assertEquals(sortableBehavior.cancel().render().toString(), "$('#anId').sortable('cancel');");
    }
    ...
    public void testDestroy() {
        ...
        assertEquals(sortableBehavior.destroy().render().toString(), "$('#anId').sortable('destroy');");
    }
    ...
    public void testDisable() {
        ...
        assertEquals(sortableBehavior.disable().render().toString(), "$('#anId').sortable('disable');");
    }
    ...
    public void testEnable() {
        ...
        assertEquals(sortableBehavior.enable().render().toString(), "$('#anId').sortable('enable');");
    }
    ...
    public void testGetHelperComplex() {
        assertEquals(sortableBehavior.getHelperComplex().getJavascriptOption().toString(), "'original'");
        sortableBehavior.setHelper(new SortableHelper(HelperEnum.CLONE));
        assertEquals(sortableBehavior.getHelperComplex().getJavascriptOption().toString(), "'clone'");
    }
    ...
    public void testRefresh() {
        ...
        assertEquals(sortableBehavior.refresh().render().toString(), "$('#anId').sortable('refresh');");
    }
    ...
    public void testRefreshPositions() {
        ...
        assertEquals(sortableBehavior.refreshPositions().render().toString(), "$('#anId').sortable('refreshPositions');");
    }
    ...
    public void testSerialize() {
        ...
        assertEquals(sortableBehavior.serialize().render().toString(), "$('#anId').sortable('serialize');");
    }
    ...
    public void testSetActivateEvent() {
        ...
        assertEquals(sortableBehavior.statement().render().toString(), "$('#anId').sortable({activate: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testSetBeforeStopEvent() {
        ...
        assertEquals(sortableBehavior.statement().render().toString(), "$('#anId').sortable({beforeStop: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testSetChangeEvent() {
        ...
        assertEquals(sortableBehavior.statement().render().toString(), "$('#anId').sortable({change: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testSetDeactivateEvent() {
        ...
        assertEquals(sortableBehavior.statement().render().toString(), "$('#anId').sortable({deactivate: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testSetOutEvent() {
        ...
        assertEquals(sortableBehavior.statement().render().toString(), "$('#anId').sortable({out: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testSetOverEvent() {
        ...
        assertEquals(sortableBehavior.statement().render().toString(), "$('#anId').sortable({over: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testSetReceiveEvent() {
        ...
        assertEquals(sortableBehavior.statement().render().toString(), "$('#anId').sortable({receive: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testSetRemoveEvent() {
        ...
        assertEquals(sortableBehavior.statement().render().toString(), "$('#anId').sortable({remove: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testSetSortEvent() {
        ...
        assertEquals(sortableBehavior.statement().render().toString(), "$('#anId').sortable({sort: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testSetStartEvent() {
        ...
        assertEquals(sortableBehavior.statement().render().toString(), "$('#anId').sortable({start: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testSetStopEvent() {
        ...
        assertEquals(sortableBehavior.statement().render().toString(), "$('#anId').sortable({stop: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testSetUpdateEvent() {
        ...
        assertEquals(sortableBehavior.statement().render().toString(), "$('#anId').sortable({update: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testToArray() {
        ...
        assertEquals(sortableBehavior.toArray().render().toString(), "$('#anId').sortable('toArray');");
    }
    ...
    public void testWidget() {
        ...
        assertEquals(sortableBehavior.widget().render().toString(), "$('#anId').sortable('widget');");
    }
}
