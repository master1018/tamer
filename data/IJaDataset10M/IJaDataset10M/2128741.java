 ...
 *
 */
public class VirtualNetworkAdapterDelete extends FunctionProxy {
     ...
     */
    public VirtualNetworkAdapterDelete(Requestor requestor, Response response) throws org.json.JSONException {
     ...
     *   --  image_device_number instances {@code String}
     */
    public Response execute() throws org.json.JSONException {
        com.softwoehr.pigiron.functions.VirtualNetworkAdapterDelete pigfunc = new com.softwoehr.pigiron.functions.VirtualNetworkAdapterDelete(getHostSpecifier(), host.getPortNumber(), user.getUid(), user.getPassword(), getTargetIdentifier(), getInputArgumentString("image_device_number"));
