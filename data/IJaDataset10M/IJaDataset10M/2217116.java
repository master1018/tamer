...
public class DemoPanel extends JXPanel {
    ...
    public DemoPanel(Demo demo) {
        ...
        try {
            ...
            Animator fadeOutAnimator = new Animator(400, new FadeOut(DemoPanel.this, loadAnimationPanel, demoPanel));
    ...
    private static class LoadedDemoPanel extends RoundedPanel {
        ...
        public void doLayout() {
            if (demoPanel != null) {
                ...
                if (descriptionArea == null) {
                    demoPanel.setBounds(insets.left, insets.top, size.width - insets.left - insets.right, size.height - insets.top - insets.bottom);
                } else {
                    ...
                    descriptionArea.setBounds(insets.left, insets.top, size.width - margin - insets.right - bounds.width, size.height - insets.top - insets.bottom);
                }
            }
        }
        ...
        private void applyDefaults() {
            setBorder(new RoundedTitleBorder(demoName, UIManager.getColor(SwingSet3.TITLE_GRADIENT_COLOR1_KEY), UIManager.getColor(SwingSet3.TITLE_GRADIENT_COLOR2_KEY)));
