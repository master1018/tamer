...
public class OptionalFeaturesPage extends BannerPage implements IDynamicPage {
    ...
    class TreeContentProvider extends DefaultContentProvider implements ITreeContentProvider {
        ...
        public Object[] getElements(Object input) {
            if (jobRoots == null) return new Object[0];
            return jobRoots;
        }
    }
    ...
    class TreeLabelProvider extends LabelProvider {
        ...
        public String getText(Object obj) {
            if (obj instanceof JobRoot) {
                ...
                return feature.getLabel() + " " + feature.getVersionedIdentifier().getVersion().toString();
            }
    ...
    public Control createContents(Composite parent) {
        ...
        PlatformUI.getWorkbench().getHelpSystem().setHelp(client, "org.eclipse.update.ui.MultiOptionalFeaturesPage2");
    ...
    private void createCheckboxTreeViewer(Composite parent) {
        ...
        treeViewer = new CheckboxTreeViewer(parent, SWT.H_SCROLL | SWT.V_SCROLL | SWT.BORDER);
    ...
    private void initializeStates(boolean update, Object[] elements, ArrayList checked, ArrayList grayed, ArrayList editable) {
        for (int i = 0; i < elements.length; i++) {
            ...
            if (!element.isEditable()) grayed.add(element); else editable.add(element);
    ...
    private void handleChecked(Object element, boolean checked) {
        ...
        if (!fe.isEditable()) treeViewer.setChecked(element, !checked); else {
    ...
    public IFeatureReference[] getCheckedOptionalFeatures(IInstallFeatureOperation currentJob) {
        ...
        if (jobRoot == null) return new IFeatureReference[0];
