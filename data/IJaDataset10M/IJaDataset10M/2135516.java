...
import net.sourceforge.poi.cocoon.serialization.util.NumericConverter;
import net.sourceforge.poi.cocoon.serialization.util.NumericResult;
import net.sourceforge.poi.cocoon.serialization.util.Validator;
...
public class EPSheetObjectFilled extends BaseElementProcessor {
    ...
    public String getObjectBound() throws IOException {
        if (_object_bound == null) {
            ...
            if (_object_bound == null) {
                throw new IOException("missing " + _object_bound_attribute + " attribute");
            }
        }
    ...
    public Anchors getAnchors() throws IOException {
        if (_object_anchor_type == null) {
            _object_anchor_type = new Anchors(getValue(_object_anchor_type_attribute));
        }
    ...
    public int getDirection() throws IOException {
        if (_direction == null) {
            _direction = NumericConverter.extractInteger(getValue(_direction_attribute), _direction_validator);
        }
    ...
    public int getType() throws IOException {
        if (_type == null) {
            _type = NumericConverter.extractInteger(getValue(_type_attribute), _object_fill_validator);
        }
    ...
    public int getWidth() throws IOException {
        if (_width == null) {
            _width = NumericConverter.extractPositiveInteger(getValue(_width_attribute));
        }
    ...
    public double getArrowShapeA() throws IOException, NullPointerException {
        if (!_arrow_shape_a_fetched) {
            ...
            if (arrowShapeString != null) {
                _arrow_shape_a = NumericConverter.extractDouble(arrowShapeString);
            } else {
                throw new NullPointerException("attribute " + _arrow_shape_a_attribute + " is absent");
            }
        }
    ...
    public double getArrowShapeB() throws IOException, NullPointerException {
        if (!_arrow_shape_b_fetched) {
            ...
            if (arrowShapeString != null) {
                _arrow_shape_b = NumericConverter.extractDouble(arrowShapeString);
            } else {
                throw new NullPointerException("attribute " + _arrow_shape_b_attribute + " is absent");
            }
        }
    ...
    public double getArrowShapeC() throws IOException, NullPointerException {
        if (!_arrow_shape_c_fetched) {
            ...
            if (arrowShapeString != null) {
                _arrow_shape_c = NumericConverter.extractDouble(arrowShapeString);
            } else {
                throw new NullPointerException("attribute " + _arrow_shape_c_attribute + " is absent");
            }
        }
