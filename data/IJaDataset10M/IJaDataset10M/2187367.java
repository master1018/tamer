 ...
 * 
 * @author mcarbin
 * @version $Id: BDDInterpreter.java,v 1.5 2005/04/29 02:34:43 joewhaley Exp $
 */
public class BDDInterpreter extends Interpreter {
    ...
    public void interpret() {
        if (ir.DOMAIN_ASSIGNMENT) ((BDDOperationInterpreter) opInterpreter).needsDomainMatch = false;
