...
public class RollerRuntimeConfig {
    ...
    private static Log mLogger = LogFactory.getFactory().getInstance(RollerRuntimeConfig.class);
    ...
    public static RuntimeConfigDefs getRuntimeConfigDefs() {
        if (configDefs == null) {
            try {
                InputStream is = RollerRuntimeConfig.class.getResourceAsStream(runtime_config);
