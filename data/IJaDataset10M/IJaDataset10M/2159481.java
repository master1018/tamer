...
public class SiteLoc extends MarshallableObject implements Element, IdentifiableElement {
    ...
    private String _Sitepos;

    private String _Fuzzypos;

    private String _Complement;

    private boolean isDefaulted_Complement = true;

    private static final String DEFAULT_COMPLEMENT = String.valueOf("0");

    private String _StrandUnknown;

    private boolean isDefaulted_StrandUnknown = true;

    private static final String DEFAULT_STRANDUNKNOWN = String.valueOf("0");
    ...
    public void setSitepos(String _Sitepos) {
        this._Sitepos = _Sitepos;
        if (_Sitepos == null) {
            invalidate();
        }
    }

    public String getFuzzypos() {
        return _Fuzzypos;
    }

    public void setFuzzypos(String _Fuzzypos) {
        this._Fuzzypos = _Fuzzypos;
        if (_Fuzzypos == null) {
            invalidate();
        }
    }

    public boolean defaultedComplement() {
        return (_Complement != null);
    }
    ...
    public boolean defaultedStrandUnknown() {
        return (_StrandUnknown != null);
    }

    public String getStrandUnknown() {
        if (_StrandUnknown == null) {
            return DEFAULT_STRANDUNKNOWN;
        }
        return _StrandUnknown;
    }

    public void setStrandUnknown(String _StrandUnknown) {
        this._StrandUnknown = _StrandUnknown;
        if (_StrandUnknown == null) {
            invalidate();
        }
    }
    ...
    public void validateThis() throws LocalValidationException {
        if (_Sitepos == null) {
            throw new MissingAttributeException("sitepos");
        }
    }
    ...
    public void marshal(Marshaller m) throws IOException {
        ...
        w.attribute("sitepos", _Sitepos.toString());
        if (_Fuzzypos != null) {
            w.attribute("fuzzypos", _Fuzzypos.toString());
        }
        if (_Complement != null) {
            w.attribute("complement", _Complement.toString());
        }
        if (_StrandUnknown != null) {
            w.attribute("strand-unknown", _StrandUnknown.toString());
        }
        w.end("Site-loc");
    }
    ...
    public void unmarshal(Unmarshaller u) throws UnmarshalException {
        ...
        while (xs.atAttribute()) {
            ...
            if (an.equals("sitepos")) {
                if (_Sitepos != null) {
                    throw new DuplicateAttributeException(an);
                }
                _Sitepos = xs.takeAttributeValue();
                continue;
            }
            if (an.equals("fuzzypos")) {
                if (_Fuzzypos != null) {
                    throw new DuplicateAttributeException(an);
                }
                _Fuzzypos = xs.takeAttributeValue();
                continue;
            }
            if (an.equals("complement")) {
                if (_Complement != null) {
                    throw new DuplicateAttributeException(an);
                }
                _Complement = xs.takeAttributeValue();
                continue;
            }
            if (an.equals("strand-unknown")) {
                if (_StrandUnknown != null) {
                    throw new DuplicateAttributeException(an);
                }
                _StrandUnknown = xs.takeAttributeValue();
                continue;
            }
    ...
    public static SiteLoc unmarshal(InputStream in) throws UnmarshalException {
        return unmarshal(XMLScanner.open(in));
    }

    public static SiteLoc unmarshal(XMLScanner xs) throws UnmarshalException {
        return unmarshal(xs, newDispatcher());
    }

    public static SiteLoc unmarshal(XMLScanner xs, Dispatcher d) throws UnmarshalException {
        return ((SiteLoc) d.unmarshal(xs, (SiteLoc.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof SiteLoc)) {
            return false;
        }
        SiteLoc tob = ((SiteLoc) ob);
        if (_Id != null) {
            if (tob._Id == null) {
                return false;
            }
        ...
        if (_Sitepos != null) {
            if (tob._Sitepos == null) {
                return false;
            }
            if (!_Sitepos.equals(tob._Sitepos)) {
                return false;
            }
        } else {
            if (tob._Sitepos != null) {
        ...
        if (_Fuzzypos != null) {
            if (tob._Fuzzypos == null) {
                return false;
            }
            if (!_Fuzzypos.equals(tob._Fuzzypos)) {
                return false;
            }
        } else {
            if (tob._Fuzzypos != null) {
        ...
        if (_Complement != null) {
            if (tob._Complement == null) {
                return false;
            }
            if (!_Complement.equals(tob._Complement)) {
                return false;
            }
        } else {
            if (tob._Complement != null) {
        ...
        if (_StrandUnknown != null) {
            if (tob._StrandUnknown == null) {
                return false;
            }
            if (!_StrandUnknown.equals(tob._StrandUnknown)) {
                return false;
            }
        } else {
            if (tob._StrandUnknown != null) {
    ...
    public int hashCode() {
        ...
        h = ((127 * h) + ((_Sitepos != null) ? _Sitepos.hashCode() : 0));
        h = ((127 * h) + ((_Fuzzypos != null) ? _Fuzzypos.hashCode() : 0));
        h = ((127 * h) + ((_Complement != null) ? _Complement.hashCode() : 0));
        h = ((127 * h) + ((_StrandUnknown != null) ? _StrandUnknown.hashCode() : 0));
        return h;
    }

    public String toString() {
        StringBuffer sb = new StringBuffer("<<Site-loc");
        if (_Id != null) {
            sb.append(" id=");
        ...
        if (_Sitepos != null) {
            sb.append(" sitepos=");
            sb.append(_Sitepos.toString());
        }
        if (_Fuzzypos != null) {
            sb.append(" fuzzypos=");
            sb.append(_Fuzzypos.toString());
        }
        sb.append(" complement=");
        sb.append(getComplement().toString());
        sb.append(" strand-unknown=");
        sb.append(getStrandUnknown().toString());
        sb.append(">>");
        return sb.toString();
    }
