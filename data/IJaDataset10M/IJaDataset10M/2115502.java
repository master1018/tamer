 ...
 * @param <T>
 */
public abstract class Link<T> extends RepastEdge<T> implements Comparable<Link>, ReLogoAgent {
	 ...
	 */
    public abstract AgentSet minNOf(int number, Collection<? extends ReLogoAgent> a, Closure reporter);
	 ...
	 *         operated on by closure
	 */
    public abstract AgentSet maxNOf(int number, Collection<? extends ReLogoAgent> a, Closure reporter);
