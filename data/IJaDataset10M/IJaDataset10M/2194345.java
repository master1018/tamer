...
public class zipimporter extends importer<PyObject> {
    ...
    @ExposedGet
    public static final PyString __doc__ = new PyString("zipimporter(archivepath) -> zipimporter object\n" + "\n" + "Create a new zipimporter instance. 'archivepath' must be a path to\n" + "a zipfile. ZipImportError is raised if 'archivepath' doesn't point to\n" + "a valid Zip archive.");
    ...
    private long dosTimeToEpoch(int dosTime, int dosDate) {
        Date d = new Date(((dosDate >> 9) & 0x7f) + 80, ((dosDate >> 5) & 0x0f) - 1, dosDate & 0x1f, (dosTime >> 11) & 0x1f, (dosTime >> 5) & 0x3f, (dosTime & 0x1f) * 2);
        return d.getTime();
    }
    ...
    final String zipimporter_toString() {
        ...
        if (prefix != null && !"".equals(prefix)) {
            return String.format("<zipimporter object \"%.300s%c%.150s\">", displayArchive, File.separatorChar, prefix);
        }
