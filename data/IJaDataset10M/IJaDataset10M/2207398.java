 ...
 */
public class minmax extends GLSkeleton<GLJPanel> implements GLEventListener, KeyListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        if (gl.isExtensionAvailable("GL_ARB_imaging") && gl.isFunctionAvailable("glMinmax")) {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glDrawPixels(dim.width, dim.height, GL2.GL_RGB, GL.GL_UNSIGNED_BYTE, pixels);
        gl.glFlush();
        if (gl.isExtensionAvailable("GL_ARB_imaging") && gl.isFunctionAvailable("glGetMinmax")) {
            gl.glGetMinmax(GL2.GL_MINMAX, true, GL2.GL_RGB, GL.GL_UNSIGNED_BYTE, values);
            System.out.println(" Red   : min = %d " + values.get(0) + ", max = " + values.get(3));
            System.out.println(" Green : min = %d " + values.get(1) + ", max = " + values.get(4));
            System.out.println(" Blue  : min = %d " + values.get(2) + " max = " + values.get(5));
        }
    }
