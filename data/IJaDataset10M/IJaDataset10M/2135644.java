...
public class DraggableBehavior extends WiQueryAbstractBehavior {
    ...
    public enum CursorAtEnum {
        ...
        TOP, /** @deprecated will be removed in 1.2 */
        @Deprecated
        TOP_LEFT, /** @deprecated will be removed in 1.2 */
        @Deprecated
        TOP_RIGHT, LEFT, RIGHT, BOTTOM, /** @deprecated will be removed in 1.2 */
        @Deprecated
        BOTTOM_LEFT, /** @deprecated will be removed in 1.2 */
        @Deprecated
        BOTTOM_RIGHT;
