 ...
 */
public class NodeListPanel extends JPanel implements Observer {
    ...
    public NodeListPanel(Controller controller) {
        ...
        setBorder(BorderFactory.createTitledBorder(new EtchedBorder(), Messages.getString("dijkstra", "NodeListPanel.Node_list")));
