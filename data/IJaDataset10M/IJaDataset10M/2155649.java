...
public final class WayPointInfoControl extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int top = LineSep * 2;
        int iconWidth = 0;
        if (((int) waypoint.Type.ordinal()) < Global.CacheIconsBig.length) iconWidth = ActivityUtils.PutImageTargetHeight(canvas, Global.CacheIconsBig[(int) waypoint.Type.ordinal()], Sizes.getHalfCornerSize(), Sizes.getCornerSize(), imgSize);
        left += iconWidth;
