    ...
    public EObject create(EClass eClass) {
        switch(eClass.getClassifierID()) {
            case OclPackage.BRACKET_EXP_CS:
                return createBracketExpCS();
            case OclPackage.NAMED_LITERAL_EXP_CS:
                return createNamedLiteralExpCS();
