...
public class GraphOptions extends GraphOptionsView implements DockableFrameData {
    ...
    private void initBinding() {
        ...
        scaleSlider.setModel(new BoundedRangeAdapter(scaleModel, GraphOptionsModel.EXTENT, scaleSlider.getMinimum(), scaleSlider.getMaximum()));
        final SpinnerNumberModel scaleSpinnerModel = SpinnerAdapterFactory.createNumberAdapter(scaleModel, GraphOptionsModel.INIT_SCALE, GraphOptionsModel.MIN_SCALE, GraphOptionsModel.MAX_SCALE, GraphOptionsModel.INIT_SPINNER_STEP);
        scaleSpinner.setModel(scaleSpinnerModel);
        SpinnerNumberModel gridSpinnerModel = SpinnerAdapterFactory.createNumberAdapter(cellSizeModel, GraphOptionsModel.INIT_CELL_SIZE, GraphOptionsModel.MIN_CELL_SIZE, GraphOptionsModel.MAX_CELL_SIZE, GraphOptionsModel.INIT_SPINNER_STEP);
