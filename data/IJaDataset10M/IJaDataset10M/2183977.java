 ...
 * @since 0.1
 */
public class SchemaValidationReport implements ErrorHandler {
    ...
    public void fatalError(SAXParseException exception) {
        StringBuilder sb = new StringBuilder();
        sb.append("FATAL XML Parsing error detected on line ").append(((SAXParseException) exception).getLineNumber()).append("\n  Fatal Error message: ").append(exception.getMessage());
        errorMessages.add(new ValidatorMessage(sb.toString(), MessageLevel.FATAL));
    }

    public void fatalError(SAXException exception) {
        StringBuilder sb = new StringBuilder();
        sb.append("FATAL XML Parsing error: ").append(exception.getMessage());
        errorMessages.add(new ValidatorMessage(sb.toString(), MessageLevel.FATAL));
    }
    ...
    public void fatalError(ParserConfigurationException exception) {
        StringBuilder sb = new StringBuilder();
        sb.append("FATAL XML Parsing error: ").append(exception.getMessage());
        errorMessages.add(new ValidatorMessage(sb.toString(), MessageLevel.FATAL));
    }
