package com.fj.torkel.util;

import com.fj.engine.IDescription;
import com.fj.engine.Lib;
import com.fj.engine.Modifier;
import com.fj.engine.RPG;
import com.fj.engine.Thing;
import com.fj.torkel.Chest;
import com.fj.torkel.Poison;
import com.fj.torkel.Potion;
import com.fj.torkel.Effect;
import com.fj.torkel.Scripts;
import com.fj.torkel.Personality;
...
public class LibMetaDataHandler {
    ...
    private static void createLibraryItem(TreeMap itemData, MetaData metaData) {
        ...
        while (it.hasNext()) {
            ...
            if (value instanceof Integer) o = new Integer((String) o);
            if (value instanceof Double) o = new Double((String) o);
            ...
            if (o.getClass().getName().startsWith("mikera.tyrant")) {
                ...
                if (((String) o).indexOf("ChestCreate") >= 0) t.set(property, new Chest.ChestCreation());
                if (((String) o).indexOf("ChestOpen") >= 0) t.set(property, new Chest.ChestOpen());
                if (((String) o).indexOf("ChestClosed") >= 0) t.set(property, new Chest.ChestClosed());
                if (((String) o).indexOf("HealingScript") >= 0) t.set(property, new Potion.HealingScript());
                inserted = true;
            }
            if (!inserted) t.set(property, o);
        }
        Lib.add(t);
    }
    ...
    private static Object createLibraryItemFromMetaData(String property, TreeMap itemData) {
        ...
        if (property.equals("AddEffectScript")) {
            ...
            if (chance == null) return Scripts.addEffect((String) itemData.get("TargetProperty"), effect);
            ...
            if (multiplier == null) effect = Effect.temporary(Modifier.bonus((String) itemData.get("Stat"), ((Integer) itemData.get("Bonus")).intValue()), ((Integer) itemData.get("Time")).intValue()); else effect = Effect.temporary(Modifier.linear((String) itemData.get("Stat"), multiplier.intValue(), ((Integer) itemData.get("Bonus")).intValue()), ((Integer) itemData.get("Time")).intValue());
            if (chance == null) return Scripts.addEffect((String) itemData.get("TargetProperty"), effect);
            return Scripts.addEffect((String) itemData.get("TargetProperty"), effect, chance.intValue());
        } else if (property.equals("SimpleModifier")) {
            Integer multiplier = (Integer) itemData.get("Multiplier");
            if (multiplier == null) return Modifier.bonus((String) itemData.get("Stat"), ((Integer) itemData.get("Bonus")).intValue());
            ...
            if (state == null) return new Personality(((Integer) itemData.get("Type")).intValue());
    ...
    protected static LibMetaData createLibMetaData(LibMetaData lmd) {
        ...
        metaData.add("NameType", new Integer(IDescription.NAMETYPE_NORMAL), null, MetaDataEntry.FIX_VALUE, MetaDataEntry.MANDATORY_PROPERTY);
    ...
    private static LibMetaData createArmourMetaData(LibMetaData lmd) {
        ...
        metaData.add("NameType", new Integer(IDescription.NAMETYPE_QUANTITY), null, MetaDataEntry.FIX_VALUE, MetaDataEntry.MANDATORY_PROPERTY);
