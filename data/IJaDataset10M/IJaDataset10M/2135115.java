...
public class QueryParser implements QueryParserConstants {
    ...
    protected SrndQuery getDistanceQuery(List queries, boolean infix, Token dToken, boolean ordered) throws ParseException {
    ...
    public final ArrayList OptionalFields() throws ParseException {
        Token fieldName;
    ...
    public final List FieldsQueryList() throws ParseException {
        SrndQuery q;
