...
public class BorderFilter extends AbstractBufferedImageOp {
    ...
    public BufferedImage filter(BufferedImage src, BufferedImage dst) {
        ...
        if (dst == null) dst = new BufferedImage(width + leftBorder + rightBorder, height + topBorder + bottomBorder, src.getType());
        ...
        if (borderPaint != null) {
            ...
            if (bottomBorder > 0) g.fillRect(leftBorder, height - bottomBorder, width - leftBorder - rightBorder, bottomBorder);
        }
