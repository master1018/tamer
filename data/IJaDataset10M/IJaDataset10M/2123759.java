...
public class IppRequest {
    ...
    protected static void sortAttributes(Vector vaa) {
    ...
    public IppRequest(int version_major, int version_minor, short opid, String charset, String natural_language) {
        ...
        agroup.add(new IppAttribute(IppAttribute.TAG_CHARSET, "attributes-charset", charset));
        agroup.add(new IppAttribute(IppAttribute.TAG_NATURAL_LANGUAGE, "attributes-natural-language", natural_language));
    }
    ...
    public String toString() {
        ...
        try {
            ...
            ba.writeBytes("Operation id/Status code: 0x" + Integer.toHexString(operationid) + "\n");
