...
public class AxleStructure extends PhysicalStructure {
    ...
    public void refresh() {
        ...
        input.getModel().getLocalTranslation().set(leftFacade.getLocalTranslation());
        input.refresh();
        output.refresh();
    }
    ...
    public class ControllableImpl implements ControllableJoint {
        ...
        public ControllableImpl(CollidableAxle leftAxle, CylinderFacade leftFacade, CollidableAxle rightAxle, CylinderFacade rightFacade, WirePort wirePortModel, WirePort inputPortModel) {
            super();
        }
    ...
    public Action<?> getAction(Type type) throws ActionTypeException {
        if (type == Type.CONTROL) {
            return new Control();
        } else return super.getAction(type);
    }
