...
public class SecurityDefinition extends Message {
    ...
    public SecurityDefinition(quickfix.field.SecurityReqID aSecurityReqID, quickfix.field.SecurityResponseID aSecurityResponseID, quickfix.field.TotalNumSecurities aTotalNumSecurities) {
        getHeader().setField(new MsgType("d"));
        set(aSecurityReqID);
