...
public class RandomStringUtils {
    ...
    /**
     * <p>Crea una stringa random la cui lunghezza è nel range mincount : maxcount</p>
     *
     * <p>Characters will be chosen from the set of alpha-numeric
     * characters.</p>
     *
     * @param mincount  the min length of random string to create
     * @param maxcount  the max length of random string to create
     * @return the random string
     */
