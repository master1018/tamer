...
public class ConfigText {
    ...
    public ConfigText(Class accessorType, Field targetField, String field, boolean isCollection, Class converterType, Method getterMethod, String getterName, Method setterMethod, String setterName, Class targetType, String format, Class<? extends ValueConverter> converter) {
