...
public class InsertEdgesCommandTest extends TestCase {
    ...
    private TestDirectionalEdge<Integer> edge, edge2, edge3, edge4, innocentEdge;
    ...
    protected void setUp() throws Exception {
        ...
        factory3 = new InsertEdgesCommand("edit", graph, Arrays.asList(edge3, edge4));
    ...
    public void testExecute() {
        ...
        assertFalse(graph.containsEdge(innocentEdge));
        Edge hedge = new TestDirectionalHyperEdge(edge.getNodeAt(0), new Integer[] {});
        assertFalse(graph.containsEdge(hedge));
        assertFalse(graph.containsEdge(innocentEdge));
        Command fac = new InsertEdgesCommand("edit", graph, Arrays.asList(hedge));
        fac.execute();
    ...
    public void testGetPresentationName() {
        ...
        assertEquals("Insert Graph Edges", new InsertEdgesCommand(null, graph, Arrays.asList(edge)).getPresentationName());
    }
