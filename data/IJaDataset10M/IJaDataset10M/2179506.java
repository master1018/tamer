...
public class ConnectionVO implements Serializable {
    ...
    public ConnectionVO(StationVO start, StationVO destination, Date startTime, Date destinationTime) {
        this.start = start;
    ...
    public ConnectionVO(StationVO start, StationVO destination, Date startTime, Date destinationTime, Date date, Double price, String link) {
        this.start = start;
        this.destination = destination;
        this.startTime = startTime;
        this.destinationTime = destinationTime;
    ...
    public boolean equals(Object obj) {
        ...
        if (destinationTime == null) {
            if (other.destinationTime != null) return false;
        } else if (!destinationTime.equals(other.destinationTime)) return false;
        if (start == null) {
