 ...
 */
@DoNotInstrument
public class ThreadExitSyncPoint extends AThreadSyncPoint {

    /**
     * Constructor for this synchronization point.
     * @param thread thread whose exit method was called.
     */
    public ThreadExitSyncPoint(Thread thread) {
        super(thread);
    }
    ...
    public static class Translated extends AThreadSyncPoint.Translated {
        ...
        public <R, P> R execute(ISyncPointVisitor<R, P> visitor, P param) {
            return visitor.threadExitCase(this, param);
        }
    }
}
