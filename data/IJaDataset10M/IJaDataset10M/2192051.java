...
class ConsolePassword {
    ...
    public String getPasswordByStty(String prompt) throws MethodFailedException {
    ...
    public String getPasswordByJDialog(String prompt, Frame parent) throws MethodFailedException {
    ...
    public String getPasswordByBusyLoop(String prompt) throws MethodFailedException {
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
    ...
    public String getPassword(String prompt) {
        ...
        try {
            if (jbFrame != null) return jbFrame.getPasswordByJDialog(prompt, null);
        } catch (MethodFailedException e) {
        }
        try {
