...
public class SourceCodeUtil {
    ...
    public static File getWebHome(IObjectRegistry registry) {
        ...
        if (ue == null) throw new GeneralException("uncertain.exception.instance_not_found", new Object[] { UncertainEngine.class.getName(), null }, (Throwable) null, (CompositeMap) null);
        File configDirectory = ue.getConfigDirectory();
        if (configDirectory == null) throw new RuntimeException("Not defind configDirectory in UncertainEngine.");
