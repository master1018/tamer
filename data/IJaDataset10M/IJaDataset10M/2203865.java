 ...
 * @author Chris Wilper
 */
public class FedoraBatchModify1_1Format extends XMLFormat {

    /** The only instance of this class. */
    private static final FedoraBatchModify1_1Format ONLY_INSTANCE = new FedoraBatchModify1_1Format();

    /**
     * Constructs the instance.
     */
    private FedoraBatchModify1_1Format() {
        super("info:fedora/fedora-system:FedoraBatchModify-1.1", FedoraBatchModifyNamespace.getInstance(), "http://www.fedora.info/definitions/1/0/api/batchModify-1.1.xsd");
    }
