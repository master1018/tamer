 ...
 *  of <code>OutrasOrientacoesConcluidas</code>.
 ...
 *  <p>
 *  @author Generated with jNerd's XML2Java tool Version 1.2 Preview 2 on Tue Apr 14 16:30:43 BRT 2009
 *  @author <br>Please send BugReports to <a href="mailto:xml2java@jNerd.de">xml2java@jNerd.de</a>
 */
public class OutrasOrientacoesConcluidasList implements List, XMLContent {
    ...
    /**
	 * Constructs an empty <code>OutrasOrientacoesConcluidasList</code>.
	 */
    public OutrasOrientacoesConcluidasList() {
	 ...
	 */
    public OutrasOrientacoesConcluidasList(Collection col) {
        this();
        this.addAll(col);
    }
	 ...
	 * operation). <p>
	 *
	 * This list is solely cappable of adding instances of class <code>OutrasOrientacoesConcluidas</code>
	 *
	 * @param o instance of <code>OutrasOrientacoesConcluidas</code> to be appended to this list.
	 ...
	 *        of class <code>OutrasOrientacoesConcluidas</code>. 
	 * @throws IllegalArgumentException if some aspect of this element
	 *            prevents it from being added to this collection.
	 * @throws NullPointerException if the specified element is <code>null</code>.
	 */
    public boolean add(Object o) {
        if (!(o instanceof OutrasOrientacoesConcluidas)) {
            throw new ClassCastException("Cannot add a " + o.getClass() + " to a " + this.getClass() + ".");
        }
        return this.add((OutrasOrientacoesConcluidas) o);
    }

    /**
	 * Appends the specified <code>OutrasOrientacoesConcluidas</code> to the end of this list (optional
	 * operation). <p>
	 *
	 * @param o instance of <code>OutrasOrientacoesConcluidas</code> to be appended to this list.
	 * @return <code>true</code> (as per the general contract of the
	 ...
	 * @throws NullPointerException if the specified element is <code>null</code>.
	 */
    public boolean add(OutrasOrientacoesConcluidas o) {
    ...
    public boolean remove(Object o) {
        if (o instanceof OutrasOrientacoesConcluidas) {
            return this.remove((OutrasOrientacoesConcluidas) o);
        }
        return false;
    }
	 ...
	 *		  not supported by this lists implementing class (<code>java.util.LinkedList</code>).
	 */
    public boolean remove(OutrasOrientacoesConcluidas o) {
    ...
    public boolean equals(Object o) {
        return (o instanceof OutrasOrientacoesConcluidasList) && this.impl.equals(o);
    }
	 ...
	 * This element is an instance of <code>OutrasOrientacoesConcluidas</code>.
	 *
	 ...
	 * The specified element must be an instance of <code>OutrasOrientacoesConcluidas</code>.
	 *
    ...
    public Object set(int index, Object o) {
        ...
        return this.impl.set(index, (OutrasOrientacoesConcluidas) o);
    }
	 ...
	 * @throws NullPointerException if the specified element is <code>null</code>.
	 */
    public Object set(int index, OutrasOrientacoesConcluidas o) {
	 ...
	 * indices).
	 *  <br>
	 *  This list is only cappable of adding instances of class <code>OutrasOrientacoesConcluidas</code>
	 *
    ...
    public void add(int index, Object element) {
        if (!(element instanceof OutrasOrientacoesConcluidas)) {
            throw new ClassCastException("Cannot add a " + element.getClass() + " to a " + this.getClass() + ".");
        }
        this.impl.add(index, (OutrasOrientacoesConcluidas) element);
    }
	 ...
	 * @throws NullPointerException if the specified element is <code>null</code>.
	 */
    public void add(int index, OutrasOrientacoesConcluidas o) {
    ...
    public Object remove(int index) {
        OutrasOrientacoesConcluidas o = (OutrasOrientacoesConcluidas) this.impl.remove(index);
        return o;
    }
    ...
    public List subList(int fromIndex, int toIndex) {
        return new OutrasOrientacoesConcluidasList(this.impl.subList(fromIndex, toIndex), this);
    }

    /** A private constructor to wrap the Sublist returned by the <code>subList</code> method */
    private OutrasOrientacoesConcluidasList(List impl, OutrasOrientacoesConcluidasList backend) {
        this.impl = impl;
    }
}
