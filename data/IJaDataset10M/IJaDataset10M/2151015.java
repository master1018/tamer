...
public class QuoteSetID extends FIXMLField {

    public static final String TAG = "302";
    ...
    public void initValue(Object s) throws ModelException {
        if (_Value != null) throw new ModelException("Value has already been initialized for field QuoteSetID.");
        setValue((String) s);
    }
    ...
    public String toFIXML(String ident) {
        ...
        StringBuffer sb = new StringBuffer(ident + "<QuoteSetID FIXTag=\"302\" DataType=\"String\"");
        sb.append(">" + _Value + "</QuoteSetID>");
        return sb.toString();
    }
}
