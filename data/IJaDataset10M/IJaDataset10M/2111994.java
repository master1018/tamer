...
public class Unswons extends PrimitiveStackMapping {
    ...
    private static final String[] IDENTIFIERS = { StackLibrary.NS_2008_08 + "unswons", StackLibrary.NS_2007_08 + "unswons", StackLibrary.NS_2007_05 + "unswons" };

    public String[] getIdentifiers() {
        return IDENTIFIERS;
    }

    public Unswons() throws RippleException {
        super();
    }

    public Parameter[] getParameters() {
        return new Parameter[] { new Parameter("l", "a list", true) };
    }
    ...
    public void apply(final StackContext arg, final Sink<StackContext, RippleException> solutions) throws RippleException {
        ...
        Sink<RippleList, RippleException> listSink = new Sink<RippleList, RippleException>() {
            ...
            public void put(final RippleList list) throws RippleException {
                solutions.put(arg.with(rest.push(list.getRest()).push(list.getFirst())));
            }
        };
