...
public class JavaFormatterOptionsPane extends PropertySheetPanel implements OptionPane {
    ...
    public void init() {
        ...
        options = (JavaFormatterOptions) AppConfig.getInstance().getProperty(AppConfig.FORMATTER_OPTIONS, new JavaFormatterOptions());
    ...
    public void resetDefaults() {
        ...
        AppConfig.getInstance().setProperty(AppConfig.FORMATTER_OPTIONS, options);
    }
