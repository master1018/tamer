...
public class CipMultipleMessageRouterResponse {
    ...
    private static final int DEFAULT_OFFSET = EthernetIpEncapsulationHeader.SEGMENT_LENGTH + EthernetIpCommandSpecificData.SEGMENT_LENGTH + EthernetIpItemStruct.SEGMENT_LENGTH + CipPacketResponse.SEGMENT_LENGTH;
    ...
    private CipMultipleMessageRouterResponse(EthernetIpBufferUtil incomingBuffer) throws InvalidTypeException, InvalidEncapsulationPackageException {
