...
import net.sourceforge.poi.util.HexDump;
        ...
        try {
            ...
            do {
                ...
                if (rectype != 0) {
                    ...
                    offset += 4 + recsize;
                    if (dump) {
                        System.out.println("fixing to recordize the following");
                        System.out.println("rectype = " + Integer.toHexString(rectype));
                        System.out.println("recsize = " + Integer.toHexString(recsize));
                        System.out.println("--------------------------------------------");
                        if (data.length > 0) {
                    ...
                    Record[] recs = createRecord(rectype, recsize, data);
                    if (recs.length > 1) {
                        ...
                        if (record instanceof UnknownRecord && !dump) {
