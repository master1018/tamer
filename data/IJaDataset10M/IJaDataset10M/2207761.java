...
public class ComaXML {
	 ...
	 * @return
	 */
    public static Element createAndValidateElement(String text, Element commElmt) throws JDOMException {
        ...
        if (commElmt.getName().equals("Communication")) {
            ...
            text = text + outputter.outputString(commElmt.getParentElement().getChildren("Speaker"));
        }
        text = front + text + end;
        Document jdoc = null;
        ...
        if (url.toString().indexOf(".jar!") > 0) {
            builder.setProperty("http://apache.org/xml/properties/schema/external-noNamespaceSchemaLocation", "jar:" + url.getFile());
        } else {
            builder.setProperty("http://apache.org/xml/properties/schema/external-noNamespaceSchemaLocation", url.getFile());
        }
        ...
        elm = (Element) jdoc.getRootElement().getChild("CorpusData").getChildren().get(0);
        elm.detach();
        return elm;
    }
    ...
    public static boolean getContext(Element e) {
        if (e.getDocument() == null) {
            ...
            while ((pe.getName() != "Communication") && (pe.getName() != "Speaker") && (pe != null)) {
