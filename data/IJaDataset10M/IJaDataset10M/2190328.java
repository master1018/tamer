...
public final class OPT_ControlFlowGraph extends OPT_SpaceEffGraph {
   ...
   */
    public OPT_SortedGraphNode startNode(boolean forward) {
        if (forward) return entry(); else return exit();
    }
   ...
   */
    ...
    private static final class NodeEnumeration<T> implements Enumeration<T> {
        ...
        public T nextElement() {
            ...
            _node = n.getNext();
            if ((n != _end) && (_node == null)) _node = _end;
            return (T) n;
        }
    }

    public Enumeration<OPT_VCGNode> nodes() {
        return new NodeEnumeration<OPT_VCGNode>(this);
    }

    public Enumeration<OPT_GraphNode> graphNodes() {
        return new NodeEnumeration<OPT_GraphNode>(this);
    }

    public Enumeration<OPT_BasicBlock> basicBlocks() {
        return new NodeEnumeration<OPT_BasicBlock>(this);
    }
}
