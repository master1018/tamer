...
public class UiBinderProblemMarkerManager {
    ...
    public static final String MARKER_ID = GWTPlugin.PLUGIN_ID + ".uiBinderProblemMarker";
    ...
    public void setCssFileNotFoundError(IRegion position, String cssFileName) {
        placeValidationResult(UiBinderTemplateProblemType.CSS_FILE_NOT_FOUND, position, cssFileName);
    }

    public void setCssSelectorFragmentUndefinedError(IRegion position, String fieldValue) {
        placeValidationResult(UiBinderTemplateProblemType.CSS_SELECTOR_FRAGMENT_UNDEFINED, position, fieldValue);
    }

    public void setCssSelectorFragmentUnspecifiedError(IRegion fieldRefRegion) {
        placeValidationResult(UiBinderTemplateProblemType.CSS_SELECTOR_FRAGMENT_UNSPECIFIED, fieldRefRegion);
    }

    public void setDuplicateCssSelectorError(IRegion position, String errorMessage) {
        placeValidationResult(UiBinderTemplateProblemType.DUPLICATE_CSS_SELECTOR, position, errorMessage);
    }

    public void setDuplicateFieldError(IRegion position, String fragment) {
        placeValidationResult(UiBinderTemplateProblemType.DUPLICATE_FIELD, position, fragment);
    }

    public void setFieldNotStaticError(IRegion position, String fieldValue) {
        placeValidationResult(UiBinderTemplateProblemType.FIELD_NOT_STATIC, position, fieldValue);
    }

    public void setFieldNotVisibleError(IRegion position, String fieldValue) {
        placeValidationResult(UiBinderTemplateProblemType.FIELD_NOT_VISIBLE, position, fieldValue);
    }

    public void setFieldUndefinedError(IRegion position, String fieldValue) {
        placeValidationResult(UiBinderTemplateProblemType.FIELD_UNDEFINED, position, fieldValue);
    }

    public void setFirstFragmentUndefinedError(IRegion position, String fieldValue) {
        placeValidationResult(UiBinderTemplateProblemType.FIRST_FRAGMENT_UNDEFINED, position, fieldValue);
    }

    public void setImportMissingFieldAttr(IRegion position, String widget) {
        placeValidationResult(UiBinderTemplateProblemType.IMPORT_MISSING_FIELD_ATTR, position, widget);
    }

    public void setMethodFragmentUndefinedError(IRegion position, String fieldValue) {
        placeValidationResult(UiBinderTemplateProblemType.METHOD_FRAGMENT_UNDEFINED, position, fieldValue);
    }

    public void setNamespacePrefixUndefinedError(IRegion position, String prefix) {
        placeValidationResult(UiBinderTemplateProblemType.NAMESPACE_PREFIX_UNDEFINED, position, prefix);
    }

    public void setNotCssResourceSubtypeError(IRegion position, String fqType) {
        placeValidationResult(UiBinderTemplateProblemType.NOT_CSS_RESOURCE_SUBTYPE, position, fqType);
    }

    public void setPackageUndefinedError(IRegion position, String packageName) {
        placeValidationResult(UiBinderTemplateProblemType.PACKAGE_UNDEFINED, position, packageName);
    }

    public void setPrimitiveFragmentWithLeftoverFragmentsError(IRegion position, String primitiveFragment) {
        placeValidationResult(UiBinderTemplateProblemType.PRIMITIVE_FRAGMENT_WITH_LEFTOVER_FRAGMENTS, position, primitiveFragment);
    }

    public void setResourceNotFoundError(IRegion position, String imagePath) {
        placeValidationResult(UiBinderTemplateProblemType.RESOURCE_NOT_FOUND, position, imagePath);
    }

    public void setTypeNotVisibleError(IRegion position, String fieldValue) {
        placeValidationResult(UiBinderTemplateProblemType.TYPE_NOT_ACCESSIBLE, position, fieldValue);
    }

    public void setTypeUndefinedError(IRegion position, String type) {
        placeValidationResult(UiBinderTemplateProblemType.TYPE_UNDEFINED, position, type);
    }

    public void setWidgetUndefinedError(IRegion position, String widget) {
        placeValidationResult(UiBinderTemplateProblemType.WIDGET_UNDEFINED, position, widget);
    }

    private void placeValidationResult(UiBinderTemplateProblemType problemType, IRegion position, String... messageArgs) {
        GdtProblemSeverity severity = GdtProblemSeverities.getInstance().getSeverity(problemType);
        if (severity != GdtProblemSeverity.IGNORE) {
            String msg = MessageFormat.format(problemType.getMessage(), (Object[]) messageArgs);
            strategy.placeValidationResult(resource, document, position, msg, severity.getMarkerSeverity());
        }
    }
}
