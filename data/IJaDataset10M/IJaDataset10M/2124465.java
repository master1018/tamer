...
public class StaticPathFlow implements Iterable<Edge> {
    ...
    public StaticPathFlow(StaticPath path, int amount) {
        if (path == null) throw new NullPointerException(GraphLocalization.getSingleton().getString("ds.graph.PathIsNullException"));
        setPath(path);
        setAmount(amount);
    }
    ...
    public boolean equals(Object o) {
        if (o == null || !(o instanceof StaticPathFlow)) {
            ...
            return (staticPathFlow.getAmount() == this.amount && staticPathFlow.getPath().equals(this.path));
        }
    }
