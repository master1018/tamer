...
public class X10Sequence {
    ...
    Command[] cmds = new Command[MAXINDEX];
    ...
    static final int[] encoder = new int[] { -1, 0x6, 0xE, 0x2, 0xA, 0x1, 0x9, 0x5, 0xD, 0x7, 0xF, 0x3, 0xB, 0x0, 0x8, 0x4, 0xC };
    ...
    static final int[] decoder = new int[] { 13, 5, 3, 11, 15, 7, 1, 9, 14, 6, 4, 12, 16, 8, 2, 10 };

    /**
     * Pretty-print an address code
     */
    public static String formatAddressByte(int b) {
        return "House " + X10Sequence.houseValueToText(X10Sequence.decode((b >> 4) & 0x0F)) + " address device " + X10Sequence.decode(b & 0x0f);
    }
    ...
    public static String formatCommandByte(int b) {
        return "House " + X10Sequence.houseValueToText(X10Sequence.decode((b >> 4) & 0x0F)) + " function: " + X10Sequence.functionName(b & 0x0f);
    }
    ...
    static String[] houseValueDecoder = new String[] { "??", "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N", "O", "P" };
