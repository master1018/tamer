...
public class WFDecomposesRenderer extends VertexRenderer implements CellViewRenderer {
    ...
    static {
        try {
            ...
            RenderComponentManager.loadRenderFile("WFDecomposes", index, "/ingenias/editor/rendererxml/WFDecomposesNOICONPanel.xml");
            index = ViewPreferences.ViewType.INGENIAS;
            RenderComponentManager.loadRenderFile("WFDecomposes", index, "/ingenias/editor/rendererxml/WFDecomposesINGENIASPanel.xml");
            index = ViewPreferences.ViewType.LABEL;
            RenderComponentManager.loadRenderFile("WFDecomposes", index, "/ingenias/editor/rendererxml/WFDecomposesLABELPanel.xml");
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
