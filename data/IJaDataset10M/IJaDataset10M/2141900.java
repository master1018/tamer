...
public class WebClientFactory {
	 ...
	 * @return
	 */
    public static synchronized WebClient getWebClient(BrowserVersion browserVersion, boolean javaScriptEnabled, boolean cssEnabled, boolean throwExceptionOnScriptError) {
        if (WEB_CLIENT == null) {
    ...
    public static synchronized void closeWebClient() {
        ...
        LOGGER.info("Closed the web client : {}, before : {}, after : {}, released : {}", new Object[] { WEB_CLIENT, totalMemoryBefore, totalMemoryAfter, (totalMemoryBefore - totalMemoryAfter) });
    }
}
