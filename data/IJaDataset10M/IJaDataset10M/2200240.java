...
public class Relation {
    ...
    public Relation(String from_concept, String to_concept, String of_type) {
        if (from_concept == null) throw new NullPointerException("from_concept is null");
        if (to_concept == null) throw new NullPointerException("to_concept is null");
        if (of_type == null) throw new NullPointerException("of_type is null");
