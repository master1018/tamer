...
public class AboutDialog extends AbstractBudgetDialog {
    ...
    public AboutDialog() {
        ...
        sbTitle.append("<html><center><h1>").append(Translate.getInstance().get(TranslateKeys.BUDDI)).append("</h1>");
        StringBuffer sbVersion = new StringBuffer();
        sbVersion.append("<html><h5>").append(Translate.getInstance().get(TranslateKeys.VERSION)).append(" ").append(Const.VERSION).append("</h5></html");
