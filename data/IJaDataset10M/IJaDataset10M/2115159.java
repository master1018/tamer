 ...
 * 
 */
@ExtensionDescription.Default(nsAlias = ContactsNamespace.GCONTACT_ALIAS, nsUri = ContactsNamespace.GCONTACT, localName = Event.XML_NAME)
public class Event extends ExtensionPoint {
   ...
   */
    ...
    public void declareExtensions(ExtensionProfile extProfile) {
        ...
        extProfile.declare(Event.class, new ExtensionDescription(When.class, new XmlNamespace("gd", "http://schemas.google.com/g/2005"), "when", true, false, false));
   ...
   */
    public static ExtensionDescription getDefaultDescription(boolean required, boolean repeatable) {
        ExtensionDescription desc = ExtensionDescription.getDefaultDescription(Event.class);
