...
public class RealmChoiceCallbackTest extends TestCase {
    ...
    private static final String[] prompts = { "Prompts", "Another prompt", "Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt Long String for prompt" };
    ...
    private static final String[] choices = { "DefaultRealmInfo", "Another default realm info", "Long string for default realm info Long string for default realm info Long string for default realm info Long string for default realm info Long string for default realm info Long string for default realm info Long string for default realm info Long string for default realm info Long string for default realm info Long string for default realm info Long string for default realm info Long string for default realm info Long string for default realm info Long string for default realm info Long string for default realm info Long string for default realm info " };

    private static final int indexes[] = { Integer.MIN_VALUE, -1, 0, 100, 20000, Integer.MAX_VALUE };
    ...
    public void test03() {
        ...
        for (int i = 0; i < prompts.length; i++) {
            ...
            for (int j = 0; j < indexes.length; j++) {
                assertEquals("Incorrect index number: " + Integer.toString(j), ind[j], indexes[j]);
            }
