...
public class StatkartTopo2 extends AbstractHttpMapSource {
    ...
    public StatkartTopo2(String service, String name, int minZoom, int maxZoom, TileImageType tileType, HttpMapSource.TileUpdate tileUpdate) {
    ...
    public String getTileUrl(int zoom, int tilex, int tiley) {
        return "http://opencache.statkart.no/gatekeeper/gk/gk.open_gmaps?layers=" + service + "&zoom=" + zoom + "&x=" + tilex + "&y=" + tiley;
    }
}
