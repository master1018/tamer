...
public class DiscriminativeNgramModel extends DefaultStatefulFF {
    ...
    public DiscriminativeNgramModel(int ngramStateID, int featID, SymbolTable symbolTbl, int startNgramOrder, int endNgramOrder, String ngramModelFile, double weight, int baselineLMOrder) {
    ...
    private HashMap<String, Double> loadModel(String file) {
        try {
            ...
            while (reader.hasNext()) {
                ...
                double weight = new Double(fds[fds.length - 1]);
