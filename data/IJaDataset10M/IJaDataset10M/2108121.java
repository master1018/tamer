...
import org.seqtagutils.util.web.CWebHelper;
...
public class CEmailServiceImpl implements IEmailService {
    ...
    public void sendEmail(SimpleMailMessage message) {
        if (message.getTo().length == 0) throw new CException("No To: addresses specified in email with subject: " + message.getSubject());
        try {
