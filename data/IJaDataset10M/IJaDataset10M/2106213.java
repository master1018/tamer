package fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.ui;
...
public class OclBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
    ...
    private fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.ui.OclDocBrowserInformationControlInput fInput;
    ...
    public void setInput(Object input) {
        org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.ui.OclDocBrowserInformationControlInput);
        if (input instanceof String) {
            setInformation((String) input);
            return;
        }
        fInput = (fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.ui.OclDocBrowserInformationControlInput) input;
        String content = null;
        ...
        fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.ui.OclHTMLPrinter.insertStyles(buffer, styles);
    ...
    public org.eclipse.swt.graphics.Point computeSizeHint() {
        ...
        String text;
        try {
            text = fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.ui.OclHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
    public fr.inria.papyrus.uml4tst.emftext.ocl.resource.ocl.ui.OclDocBrowserInformationControlInput getInput() {
        return fInput;
    }
