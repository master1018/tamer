package net.jadoth.lang.concurrent;

import net.jadoth.lang.Instantiator;
...
public class ThreadedInstantiating<E> extends Threaded<E> {
    ...
    public static final <E> ThreadedInstantiating<E> threaded(final Instantiator<E> instantiator) {
        return new ThreadedInstantiating<E>(instantiator);
    }
	 ...
	 * @see net.jadoth.lang.concurrent.Threaded#lookupMissFallbackElement()
	 * @see net.jadoth.lang.concurrent.Threaded#get()
	 */
    @Override
