 ...
 * @version $Id: Journaller.java 5367 2006-12-08 08:51:00Z cwilper $
 */
public class Journaller extends Module implements Management, JournalConstants {

    /** Logger for this class. */
    private static final Logger LOG = Logger.getLogger(Journaller.class.getName());
    ...
    public Journaller(Map moduleParameters, Server server, String role) throws ModuleInitializationException {
    ...
    public void initModule() throws ModuleInitializationException {
        ...
        if (this.inRecoveryMode) {
            worker = new JournalConsumer(parameters, getRole(), this.serverInterface);
        } else {
            worker = new JournalCreator(parameters, getRole(), this.serverInterface);
        }
    ...
    private void copyPropertiesOverParameters(Map parameters) {
        ...
        for (Iterator keys = properties.keySet().iterator(); keys.hasNext(); ) {
            ...
            if (key.startsWith(SYSTEM_PROPERTY_PREFIX)) {
                parameters.put(key.substring(SYSTEM_PROPERTY_PREFIX.length()), properties.get(key));
            }
        }
    }
     ...
     */
    private void parseParameters(Map parameters) throws ModuleInitializationException {
        ...
        if (mode == null) {
            ...
            throw new ModuleInitializationException("'" + PARAMETER_JOURNAL_MODE + "' parameter must be '" + VALUE_JOURNAL_MODE_NORMAL + "'(default) or '" + VALUE_JOURNAL_MODE_RECOVER + "'", getRole());
        }
    }
    ...
    public String ingestObject(Context context, InputStream serialization, String logMessage, String format, String encoding, boolean newPid) throws ServerException {
        return worker.ingestObject(context, serialization, logMessage, format, encoding, newPid);
    }

    /**
     * Delegate to the JournalWorker.
     */
    public Date modifyObject(Context context, String pid, String state, String label, String ownerId, String logMessage) throws ServerException {
     ...
     * Delegate to the JournalWorker.
     */
    public Property[] getObjectProperties(Context context, String pid) throws ServerException {
     ...
     * Delegate to the JournalWorker.
     */
    public InputStream exportObject(Context context, String pid, String format, String exportContext, String encoding) throws ServerException {
        return worker.exportObject(context, pid, format, exportContext, encoding);
    }

    /**
     * Delegate to the JournalWorker.
     */
    public Date purgeObject(Context context, String pid, String logMessage, boolean force) throws ServerException {
    ...
    public String addDatastream(Context context, String pid, String dsID, String[] altIDs, String dsLabel, boolean versionable, String MIMEType, String formatURI, String location, String controlGroup, String dsState, String checksumType, String checksum, String logMessage) throws ServerException {
        return worker.addDatastream(context, pid, dsID, altIDs, dsLabel, versionable, MIMEType, formatURI, location, controlGroup, dsState, checksumType, checksum, logMessage);
    }

    /**
     * Delegate to the JournalWorker.
     */
    public Date modifyDatastreamByReference(Context context, String pid, String datastreamID, String[] altIDs, String dsLabel, String mimeType, String formatURI, String dsLocation, String checksumType, String checksum, String logMessage, boolean force) throws ServerException {
        return worker.modifyDatastreamByReference(context, pid, datastreamID, altIDs, dsLabel, mimeType, formatURI, dsLocation, checksumType, checksum, logMessage, force);
    }

    /**
     * Delegate to the JournalWorker.
     */
    public Date modifyDatastreamByValue(Context context, String pid, String datastreamID, String[] altIDs, String dsLabel, String mimeType, String formatURI, InputStream dsContent, String checksumType, String checksum, String logMessage, boolean force) throws ServerException {
        return worker.modifyDatastreamByValue(context, pid, datastreamID, altIDs, dsLabel, mimeType, formatURI, dsContent, checksumType, checksum, logMessage, force);
    }
    ...
    public Date[] purgeDatastream(Context context, String pid, String datastreamID, Date startDT, Date endDT, String logMessage, boolean force) throws ServerException {
        return worker.purgeDatastream(context, pid, datastreamID, startDT, endDT, logMessage, force);
    }
     ...
     * Delegate to the JournalWorker.
     */
    public String addDisseminator(Context context, String pid, String bDefPID, String bMechPid, String dissLabel, DSBindingMap bindingMap, String dissState, String logMessage) throws ServerException {
        return worker.addDisseminator(context, pid, bDefPID, bMechPid, dissLabel, bindingMap, dissState, logMessage);
    }

    /**
     * Delegate to the JournalWorker.
     */
    public Date modifyDisseminator(Context context, String pid, String disseminatorID, String bMechPid, String dissLabel, DSBindingMap bindingMap, String dissState, String logMessage, boolean force) throws ServerException {
        return worker.modifyDisseminator(context, pid, disseminatorID, bMechPid, dissLabel, bindingMap, dissState, logMessage, force);
    }

    /**
     * Delegate to the JournalWorker.
     */
    public Date[] purgeDisseminator(Context context, String pid, String disseminatorID, Date endDT, String logMessage) throws ServerException {
        return worker.purgeDisseminator(context, pid, disseminatorID, endDT, logMessage);
    }

    /**
     * Delegate to the JournalWorker.
     */
    public Disseminator getDisseminator(Context context, String pid, String disseminatorID, Date asOfDateTime) throws ServerException {
        return worker.getDisseminator(context, pid, disseminatorID, asOfDateTime);
    }

    /**
     * Delegate to the JournalWorker.
     */
    public Disseminator[] getDisseminators(Context context, String pid, Date asOfDateTime, String dissState) throws ServerException {
    ...
    public Date setDisseminatorState(Context context, String pid, String dsID, String dsState, String logMessage) throws ServerException {
        return worker.setDisseminatorState(context, pid, dsID, dsState, logMessage);
    }
