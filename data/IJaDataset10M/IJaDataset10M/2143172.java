...
public class ConstraintDataSet implements IDataSet {
    ...
    public ConstraintDataSet(ConstraintView constraintView, String fkTableName, String pkTableName) {
        ...
        _columnDisplayDefinitions = new ColumnDisplayDefinition[] { new ColumnDisplayDefinition(DISPLAY_WIDTH, s_stringMgr.getString("graph.ConstraintDataSet.LocalColumn", fkTableName)), new ColumnDisplayDefinition(DISPLAY_WIDTH, s_stringMgr.getString("graph.ConstraintDataSet.ReferencingColumn", pkTableName)) };
    }
