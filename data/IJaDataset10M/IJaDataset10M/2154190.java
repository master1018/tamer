...
public class MouseTrapsCreator implements ContextBuilder<MouseTrap> {
    ...
    public Context build(Context<MouseTrap> context) {
        ...
        Grid grid = GridFactoryFinder.createGridFactory(null).createGrid("Gym Floor", context, GridBuilderParameters.singleOccupancy2D(new MouseGridAdder(width - 1, height - 1), new StrictBorders(), width, height));
        GridValueLayer vl = new GridValueLayer("Trap Values", 1.0, true, width, height);
