...
public class DereferencingResult {
    ...
    public DereferencingResult(DereferencingTask task, int resultCode, NamedGraphSet resultData, Exception resultException, Map<String, List<String>> headerFields) {
        this.task = task;
    ...
    public boolean isSuccess() {
        return (this.resultCode == DereferencingResult.STATUS_OK) || (this.resultCode == DereferencingResult.STATUS_UNMODIFIED);
    }
