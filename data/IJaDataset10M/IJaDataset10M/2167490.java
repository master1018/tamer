 ...
 */
public class NewStatusMessageDialog extends JDialog implements ActionListener {
    ...
    private JLabel messageLabel = new JLabel(Resources.getString("newStatusMessage"));

    private JTextField messageTextField = new JTextField();

    private JPanel dataPanel = new JPanel(new BorderLayout(5, 5));

    private JTextArea infoLabel = new JTextArea(Resources.getString("statusMessageInfo"));

    private JLabel infoTitleLabel = new JLabel(Resources.getString("newStatusMessage"));
    ...
    private void init() {
        ...
        this.infoTitleLabel.setFont(infoTitleLabel.getFont().deriveFont(Font.BOLD, 18.0f));
    ...
    private class PublishStatusMessageThread extends Thread {
        ...
        public PublishStatusMessageThread(String message) {
            ...
            presenceOpSet = (OperationSetPersistentPresence) protocolProvider.getOperationSet(OperationSetPresence.class);
