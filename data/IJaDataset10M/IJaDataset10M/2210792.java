...
public class EnumIntTypeTest extends BaseTypeTest {
    ...
    public void testEnumInt() throws Exception {
        ...
        testType(dao, foo, clazz, val, sqlVal, sqlVal, valStr, DataType.ENUM_INTEGER, ENUM_COLUMN, false, true, false, false, false, false, true, false);
    }
    ...
    public void testEnumIntNull() throws Exception {
        ...
        LocalEnumInt foo = new LocalEnumInt();
        assertEquals(1, dao.create(foo));
        testType(dao, foo, clazz, null, null, null, null, DataType.ENUM_INTEGER, ENUM_COLUMN, false, true, false, false, false, false, true, false);
    }
    ...
    public void testEnumIntResultsNoFieldType() throws Exception {
        ...
        try {
            ...
            assertEquals(val.ordinal(), DataType.ENUM_INTEGER.getDataPersister().resultToJava(null, results, results.findColumn(ENUM_COLUMN)));
        } finally {
            if (stmt != null) {
                stmt.close();
            }
