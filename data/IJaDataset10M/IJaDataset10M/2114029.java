...
public class Model implements AcousticModel, Configurable {
    ...
    public SenoneSequence getCompositeSenoneSequence(Unit unit, HMMPosition position) {
        ...
        if (logger.isLoggable(Level.FINE)) {
            logger.fine("getCompositeSenoneSequence: " + unit.toString() + ((compositeSenoneSequence != null) ? "Cached" : ""));
        }
        ...
        if (logger.isLoggable(Level.FINE)) {
            logger.fine(unit.toString() + " consists of " + compositeSenones.size() + " composite senones");
    ...
    private Unit[] replaceNonSilenceFillerWithSilence(Unit[] context) {
        ...
        for (int i = 0; i < context.length; i++) {
            if (context[i].isFiller() && !context[i].equals(UnitManager.SILENCE)) {
