...
public class RandomPatternDialog extends JDialog {
    ...
    public RandomPatternDialog(PhaseOneScreenListener l1, PhaseTwoScreenListener l2) {
        listener1 = l1;
        listener2 = l2;
        if (listener1 == null) isphaseone = false; else isphaseone = true;
        setTitle(Messages.getString("kmp", "RPD.Title"));
        setFont(GUIConstants.SCREEN_FONT);
        setResizable(false);
        setLayout(new GridBagLayout());
        setSize(220, 120);
        if (isphaseone) addWindowFocusListener(listener1); else addWindowFocusListener(listener2);
        ...
        if (isphaseone) btapply.addActionListener(listener1); else btapply.addActionListener(listener2);
        ...
        if (isphaseone) btcancel.addActionListener(listener1); else btcancel.addActionListener(listener2);
