...
public class ConfigurableIPotGUIControl extends javax.swing.JPanel implements Observer, StateEditable {
    ...
    static final Preferences prefs = Preferences.userNodeForPackage(IPotSliderTextControl.class);
    ...
    public ConfigurableIPotGUIControl(ConfigurableIPotRev0 pot) {
        ...
        bufferBiasSlider.setMaximum(ConfigurableIPotRev0.maxBuffeBitValue - 1);
        updateAppearance();
    ...
    private void currentLevelComboBoxActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void sexComboBoxActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void biasSliderStateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    private void biasSliderMousePressed(java.awt.event.MouseEvent evt) {
        startEdit();
    }

    private void biasSliderMouseReleased(java.awt.event.MouseEvent evt) {
        endEdit();
    }

    private void biasTextFieldActionPerformed(java.awt.event.ActionEvent evt) {
        try {
    ...
    private void biasTextFieldFocusGained(java.awt.event.FocusEvent evt) {
        biasTextField.setFont(new java.awt.Font("Courier New", 1, 11));
    }

    private void biasTextFieldFocusLost(java.awt.event.FocusEvent evt) {
        biasTextField.setFont(new java.awt.Font("Courier New", 0, 11));
    }

    private void biasTextFieldKeyPressed(java.awt.event.KeyEvent evt) {
    ...
    private void biasTextFieldMouseWheelMoved(java.awt.event.MouseWheelEvent evt) {
    ...
    private void bufferBiasSliderStateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    private void bufferBiasSliderMousePressed(java.awt.event.MouseEvent evt) {
        startEdit();
    }

    private void bufferBiasSliderMouseReleased(java.awt.event.MouseEvent evt) {
        endEdit();
    }

    private void bufferBiasTextFieldActionPerformed(java.awt.event.ActionEvent evt) {
        try {
    ...
    private void bufferBiasTextFieldFocusGained(java.awt.event.FocusEvent evt) {
        bufferBiasTextField.setFont(new java.awt.Font("Courier New", 1, 11));
    }

    private void bufferBiasTextFieldFocusLost(java.awt.event.FocusEvent evt) {
        bufferBiasTextField.setFont(new java.awt.Font("Courier New", 0, 11));
    }

    private void bufferBiasTextFieldKeyPressed(java.awt.event.KeyEvent evt) {
        int code = evt.getKeyCode();
        boolean shifted = evt.isShiftDown();
        float byRatio = 1.02f;
        if (code == KeyEvent.VK_UP) {
    ...
    private void bufferBiasTextFieldMouseWheelMoved(java.awt.event.MouseWheelEvent evt) {
        int clicks = evt.getWheelRotation();
        pot.setBufferBitValue(pot.getBufferBitValue() - clicks);
    }

    private void bufferBiasPanelformMouseEntered(java.awt.event.MouseEvent evt) {
    }

    private void bufferBiasPanelformMouseExited(java.awt.event.MouseEvent evt) {
    }

    private void valueTextFieldKeyPressed(java.awt.event.KeyEvent evt) {
    }

    private void biasEnabledComboBoxActionPerformed(java.awt.event.ActionEvent evt) {
        startEdit();
    ...
    public void storeState(Hashtable<Object, Object> hashtable) {
        ...
        hashtable.put(KEY_SEX, pot.getSex());
    ...
    static String[] controlNames = { "Type", "Sex", "Slider" };
    ...
    static {
        ...
        for (int i = 0; i < controlNames.length; i++) {
            viewMenu.add(new VisibleSetter(controlNames[i]));
        }
    }
