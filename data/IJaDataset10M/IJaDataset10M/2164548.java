...
public class Image extends XulElement implements Viewable {
    ...
    public void setBorder(String border) {
        if (border != null && border.length() == 0) border = null;
    ...
    public void setHspace(String hspace) {
        if (hspace != null && hspace.length() == 0) hspace = null;
    ...
    public void setVspace(String vspace) {
        if (vspace != null && vspace.length() == 0) vspace = null;
    ...
    private String getEncodedSrc() {
        return _image != null ? getContentSrc() : getDesktop().getExecution().encodeURL(_src != null ? _src : "~./img/spacer.gif");
    }
    ...
    private String getContentSrc() {
        ...
        if (name != null || format != null) {
            ...
            if (bExtRequired && format != null) sb.append('.').append(format);
        }
        return getViewURI(sb.toString());
    }
