...
public class AncestralStateBeagleTreeLikelihoodTest extends TraceCorrelationAssert {
    ...
    public void testJointLikelihood() {
        ...
        BranchSubstitutionModel branchSubstitutionModel = new HomogenousBranchSubstitutionModel(siteRateModel.getSubstitutionModel(), siteRateModel.getSubstitutionModel().getFrequencyModel());
        BranchRateModel branchRateModel = null;
        AncestralStateBeagleTreeLikelihood treeLikelihood = new AncestralStateBeagleTreeLikelihood(alignment, treeModel, branchSubstitutionModel, siteRateModel, branchRateModel, null, false, PartialsRescalingScheme.DEFAULT, null, hky.getDataType(), "stateTag", hky, true, false);
        double logLike = treeLikelihood.getLogLikelihood();
        StringBuffer buffer = new StringBuffer();
        Tree.Utils.newick(treeModel, treeModel.getRoot(), false, Tree.BranchLengthType.LENGTHS_AS_TIME, null, null, new TreeTraitProvider[] { treeLikelihood }, null, buffer);
