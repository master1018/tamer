...
public class LinkParameterProbe extends AbstractParameterizedProbe<IAssociativeLink> {
   ...
   * Logger definition
   */
    private static final transient Log LOGGER = LogFactory.getLog(LinkParameterProbe.class);
    ...
    @Override
    protected AbstractParameterizedProbe<IAssociativeLink> newInstance(IAssociativeLink parameterized) {
