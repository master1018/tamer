...
public class AuthorizationProxy implements InvocationHandler {
    ...
    public static Object createProxy(Object obj, User user) {
        return Proxy.newProxyInstance(obj.getClass().getClassLoader(), obj.getClass().getInterfaces(), new AuthorizationProxy(user, obj));
    }
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        if (method.isAnnotationPresent(AuthorizedRoles.class)) {
            ...
            if (find < 0) throw new AuthorizationException("User not authorized");
        }
