...
public interface ArgumentNames {
    ...
    public static final String ONE_TO_ONE_MODE_DESC = "One to one mode. If ticked, one joined concept will be created per each relation" + "that joins the two instances of the specified concepts. If unticked the concpet of the type specified as" + "target of the collapse will get all of the attributes and relations of the valid source(s)";
}
