 ...
 */
public class ApproveSerialRequestsDialog extends javax.swing.JDialog {

    private static ApproveSerialRequestsDialog instance = null;

    private static ApproveSerialRequestsPanel panel = null;

    /** Creates new form ApproveSerialRequestsDialog */
    public static ApproveSerialRequestsDialog getInstance(int BUTTON_MODE) {
        if (instance == null) {
            instance = new ApproveSerialRequestsDialog();
        }
        return instance;
    }

    public ApproveSerialRequestsDialog() {
        initComponents();
        newgen.presentation.NewGenMain.getAppletInstance().applyOrientation(this);
        panel = new ApproveSerialRequestsPanel();
    ...
    public static void main(String args[]) {
        new ApproveSerialRequestsDialog().show();
    }
