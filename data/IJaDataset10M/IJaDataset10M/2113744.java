...
public class BwapiTestInformation {
    ...
    public BwapiTestInformation(String starcraftFolder, String chaosLauncherFolder, Class<? extends BridgeBot> bridgeBotClass, BroodwarMap map, BroodwarGameType gameType, BroodwarPlayer... players) {
        this(starcraftFolder, chaosLauncherFolder, bridgeBotClass, map, gameType, false, players);
    }

    public BwapiTestInformation(String starcraftFolder, String chaosLauncherFolder, Class<? extends BridgeBot> bridgeBotClass, BroodwarMap map, BroodwarGameType gameType, boolean consideredOverWhenUnitsGone, BroodwarPlayer... players) {
    ...
    public void setConsideredOverWhenUnitsGone(boolean consideredOverWhenUnitsGone) {
        this.consideredOverWhenUnitsGone = consideredOverWhenUnitsGone;
    }
