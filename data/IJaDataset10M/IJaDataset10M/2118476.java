...
public final class SanitizedContent extends SoyData {
   ...
   */
     ...
     */
        JS_STR_CHARS, /** A properly encoded portion of a URI. */
        URI, /** An attribute name and value, such as {@code dir="ltr"}. */
        HTML_ATTRIBUTE
    }
   ...
   */
    ...
    public boolean equals(@Nullable Object other) {
        return other instanceof SanitizedContent && this.contentKind == ((SanitizedContent) other).contentKind && this.content.equals(((SanitizedContent) other).content);
    }
