 ...
 */
public class SQLDTBigInt extends SQLDataType {

    private static final String _NAME = "bigint";

    private static final String _DEFAULT_JAVA_TYPE = "long";

    private static final boolean _IS_PRIMITIV = true;

    private static final String _PRIMITIV_TYPE = "int";

    private static final String _ALIASES[] = { "long" };

    /**
    * @roseuid 3CFCB3B803A7
    */
    public SQLDTBigInt() {
