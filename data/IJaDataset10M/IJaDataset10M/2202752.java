...
public class PKCS8Key implements PrivateKey {
    ...
    public static PrivateKey parseKey(DerValue in) throws IOException {
        ...
        if (!version.equals(parsedVersion)) {
            throw new IOException("version mismatch: (supported: " + Hex.encode(version) + ", parsed: " + Hex.encode(parsedVersion));
        }
    ...
    public void decode(InputStream in) throws InvalidKeyException {
        ...
        try {
            ...
            if (!version.equals(this.version)) {
                throw new IOException("version mismatch: (supported: " + Hex.encode(this.version) + ", parsed: " + Hex.encode(version));
            }
