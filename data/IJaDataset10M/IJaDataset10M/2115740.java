...
public class WFPursueRenderer extends VertexRenderer implements CellViewRenderer {
    ...
    static {
        try {
            ...
            RenderComponentManager.loadRenderFile("WFPursue", index, "/ingenias/editor/rendererxml/WFPursueNOICONPanel.xml");
            index = ViewPreferences.ViewType.INGENIAS;
            RenderComponentManager.loadRenderFile("WFPursue", index, "/ingenias/editor/rendererxml/WFPursueINGENIASPanel.xml");
            index = ViewPreferences.ViewType.LABEL;
            RenderComponentManager.loadRenderFile("WFPursue", index, "/ingenias/editor/rendererxml/WFPursueLABELPanel.xml");
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
