...
public class PerlinNoise {
    ...
    static {
        ...
        for (i = 0; i < TABLE_SIZE; i++) permute[i] = (short) i;
        ...
        for (i = 0; i < TABLE_SIZE; i++) grad[i] = (short) (permute[i] % 12);
    ...
    public static double value(double x, double y, double z) {
        ...
        return GRAD_SCALE * (getWavelet(i, j, k, u1, v1, w1) + getWavelet(i + 1, j, k, u2, v1, w1) + getWavelet(i, j + 1, k, u1, v2, w1) + getWavelet(i + 1, j + 1, k, u2, v2, w1) + getWavelet(i, j, k + 1, u1, v1, w2) + getWavelet(i + 1, j, k + 1, u2, v1, w2) + getWavelet(i, j + 1, k + 1, u1, v2, w2) + getWavelet(i + 1, j + 1, k + 1, u2, v2, w2));
    }
