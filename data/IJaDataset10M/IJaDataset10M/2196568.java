 ...
 *
 */
public class CAMERAAccessionSearchResultBuilderTest extends AbstractAccessionSearchResultBuilderTest {

    public CAMERAAccessionSearchResultBuilderTest(String name) {
        super(name);
    }

    protected AccessionSearchResultBuilder getCurrentAccessionResultBuilder() {
        return new CAMERAAccessionSearchResultBuilder();
    }
    ...
    private void testRetrieveExistingAccessionSearchResult(String testAcc) {
        try {
            AccessionSearchResultBuilder.AccessionSearchResult accResult = retrieveAccessionSearchResult(testAcc);
