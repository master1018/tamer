...
public class Hibernate3BeanReplicator extends HibernateBeanReplicator {
    ...
    public Hibernate3BeanReplicator(String applicationPackagePrefix) {
        super(new Hibernate3BeanTransformer().initPropertyFilter(new HibernatePropertyFilter(applicationPackagePrefix)));
    }
	 ...
	 */
    public Hibernate3BeanReplicator(Set<Class<?>> entityBeanClassSet, Set<? extends CollectionPropertyName<?>> collectionPropertyNameSet, PropertyFilter vetoer) {
        super(new Hibernate3BeanTransformer().initPropertyFilter(new HibernatePropertyFilter().withEntityBeanClassSet(entityBeanClassSet).withCollectionPropertyNameSet(collectionPropertyNameSet).withVetoer(vetoer)));
    }
     ...
     * @param vetoer used to veto the propagation of specific properties.
     */
    public Hibernate3BeanReplicator(String applicationPackagePrefix, Set<Class<?>> entityBeanClassSet, Set<? extends CollectionPropertyName<?>> collectionPropertyNameSet, PropertyFilter vetoer) {
        super(new Hibernate3BeanTransformer().initPropertyFilter(new HibernatePropertyFilter(applicationPackagePrefix).withEntityBeanClassSet(entityBeanClassSet).withCollectionPropertyNameSet(collectionPropertyNameSet).withVetoer(vetoer)));
    }
}
