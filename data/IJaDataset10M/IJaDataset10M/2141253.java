...
public class SelectionScriptLinkerUnitTest extends TestCase {
    ...
    private static class MockPermutationResult implements PermutationResult {
        ...
        public byte[][] getJs() {
            return new byte[][] { getBytes("code for fragment 0"), getBytes("code for fragment 1") };
        }

        public Permutation getPermutation() {
            return new Permutation(0, new StaticPropertyOracle(new BindingProperty[0], new String[0], new com.google.gwt.dev.cfg.ConfigurationProperty[0]));
        }
    ...
    private static class NonShardableSelectionScriptLinker extends SelectionScriptLinker {
        ...
        protected String getSelectionScriptTemplate(TreeLogger logger, LinkerContext context) {
            return SelectionScriptLinkerUnitTest.class.getPackage().getName().replace('.', '/') + "/MockTemplate.js";
        }
    }

    @Shardable
    private static class ShardableSelectionScriptLinker extends NonShardableSelectionScriptLinker {
    }
   ...
   */
    public void testNonShardableHasPermutations() throws UnableToCompleteException {
        ArtifactSet artifacts = new ArtifactSet();
        StandardCompilationResult result = createCompilationResult();
        artifacts.add(result);
        ArtifactSet updated = new NonShardableSelectionScriptLinker().link(TreeLogger.NULL, new MockLinkerContext(), artifacts);
   ...
   */
    ...
    private StandardCompilationResult createCompilationResult() {
        StandardCompilationResult result = new StandardCompilationResult(new MockPermutationResult());
    ...
    private EmittedArtifact findEmittedArtifact(ArtifactSet updated, String partialPath) {
