...
@NamedQueries({ @NamedQuery(name = NewswireItem.FIND_BY_EXTERNAL_ID, query = "SELECT n FROM NewswireItem AS n WHERE n.externalId=:externalId"), @NamedQuery(name = NewswireItem.FIND_BY_DATE, query = "SELECT n FROM NewswireItem AS n WHERE n.date BETWEEN :start AND :end OR n.updated BETWEEN :start AND :end"), @NamedQuery(name = NewswireItem.FIND_BY_USER, query = "SELECT DISTINCT n FROM NewswireItem n JOIN n.newswireService ns WHERE :user MEMBER OF ns.subscribers"), @NamedQuery(name = NewswireItem.FIND_BY_SERVICE, query = "SELECT n FROM NewswireItem AS n WHERE n.newswireService=:newswireService"), @NamedQuery(name = NewswireItem.SEARCH, query = "SELECT DISTINCT n FROM NewswireItem n JOIN n.newswireService ns WHERE :user MEMBER OF ns.subscribers AND (n.title LIKE :keyword OR n.summary LIKE :keyword)"), @NamedQuery(name = NewswireItem.DELETE_BY_SERVICE, query = "DELETE FROM NewswireItem n WHERE n.newswireService = :newswireService") })
public class NewswireItem implements Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "newswire_item_tag", joinColumns = { @JoinColumn(referencedColumnName = "id", name = "newswire_item_id", nullable = false) }, inverseJoinColumns = { @JoinColumn(referencedColumnName = "id", name = "content_tag_id", nullable = false) })
