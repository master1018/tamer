...
public abstract class ARunWithIndexReader<T> {
    ...
    protected IndexReader getFromQueryContextOrOpenIndexReader(ILogResource log) throws IOException {
        ...
        if (queryContext != null) {
            ...
            if (reader == null) {
                ...
                logger.info("Binding index reader to query context " + queryContext.toString());
    ...
    protected IndexReader openReader(ILogResource log) throws IOException {
        ...
        if (IndexReader.indexExists(dir)) {
            logger.info("Opening index reader for '" + log.getName() + "'...");
        ...
        try {
            ...
            try {
                ...
                if ((queryContext == null) && (reader != null)) {
                    logger.info("Closing index reader for '" + log.getName() + "'...");
                    reader.close();
                }
            }
            ...
            throw new CoreException(new Status(IStatus.ERROR, IndexPlugin.PLUGIN_ID, NLS.bind(Messages.LuceneIndexService_error_failedToReadIndex, new Object[] { log.getName(), e.getLocalizedMessage() }), e));
        }
    }
