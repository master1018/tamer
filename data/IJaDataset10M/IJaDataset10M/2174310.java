...
public interface IRNode {
   ...
   * </dl>
   */
    public void setSlotValue(SlotInfo si, Object newValue) throws SlotImmutableException;

    public int getIntSlotValue(SlotInfo si) throws SlotUndefinedException;

    public void setSlotValue(SlotInfo si, int newValue) throws SlotImmutableException;
