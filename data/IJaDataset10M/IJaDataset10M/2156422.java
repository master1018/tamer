...
public abstract class AbstractTupleSet implements TupleSet {
    ...
    public void addTupleSetListener(TupleSetListener tsl) {
        if (m_tupleListeners == null) m_tupleListeners = new CopyOnWriteArrayList();
        if (!m_tupleListeners.contains(tsl)) m_tupleListeners.add(tsl);
    }
    ...
    public void addPropertyChangeListener(PropertyChangeListener lstnr) {
        ...
        if (m_propSupport == null) m_propSupport = new SwingPropertyChangeSupport(this);
    ...
    public void putClientProperty(String key, Object value) {
        ...
        if (m_props == null && value == null) {
            ...
            if (m_props == null) m_props = new HashMap(2);
            prev = m_props.put(key, value);
        }
        if (m_propSupport != null) m_propSupport.firePropertyChange(key, prev, value);
    }
