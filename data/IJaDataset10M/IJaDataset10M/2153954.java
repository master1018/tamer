    ...
    public void run() {
        ...
        while (true) {
            if (m_localQueue.peek() != null) {
                ...
                if (m != null) m.sendChatMessage((String) o[0], Language.valueOf(((String) o[3])));
            }
            if (m_privateQueue.peek() != null) {
                o = m_privateQueue.poll();
                s = (IoSession) o[0];
                if (s.isConnected() && !s.isClosing()) TcpProtocolHandler.writeMessage(s, new ChatMessage(ChatMessageType.PRIVATE, ((String) o[1]) + "," + ((String) o[2])));
            }
            try {
                Thread.sleep(250);
            } catch (Exception e) {
