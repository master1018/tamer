...
public class Messages {
    ...
    private static Map defaultInstances = new HashMap();
    ...
    public String getMessage(String key) {
        ...
        if (mess == null && !(this == getDefaultInstance(world))) mess = getDefaultInstance(world).getMessage(key);
    ...
    public String getMessage(String key, Object[] argumentsForScriptCode) {
        ...
        String mess = getEntryForKey(key);
        if (mess == null && !(this == getDefaultInstance(world))) mess = getDefaultInstance(world).getMessage(key, argumentsForScriptCode);
        return (mess != null ? mess : "??" + key + "??");
    }
