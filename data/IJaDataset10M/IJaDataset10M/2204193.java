...
public class VirtualField extends VirtualData {
    ...
    public static VirtualField newVirtualField(SampledSet domainSet, VirtualTuple rangeTuple) throws VisADException {
        return newVirtualField(new FunctionType(((SetType) domainSet.getType()).getDomain(), rangeTuple.getType()), domainSet, rangeTuple);
    }
     ...
     */
    public Object clone() {
        return new VirtualField(functionType, domainSet, (VirtualTuple) rangeTuple.clone());
    }
