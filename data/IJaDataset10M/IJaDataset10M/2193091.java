...
/**
 * Test to see that when a probe fails it registers appropriate information in the database.
 * @see testBug116
 */
public class FailFileProbe extends FileProbe {

    public String getName() {
        return "FailFileProbe";
    }
