...
public interface ResourceLocks {
     ...
     */
    boolean lock(CalDAVTransaction transaction, String path, String owner, boolean exclusive, int depth, int timeout, boolean temporary) throws LockException;

    /**
     * Desbloquea el recursos "id" (y todos las subcarpetas si existen)
     ...
     * @return verdadero si el recurso en la ruta ha sido bloqueado, falso si
     *  si existe un bloqueo que lo previene
     * @throws LockException
     */
    boolean exclusiveLock(CalDAVTransaction transaction, String path, String owner, int depth, int timeout) throws LockException;
     ...
     * @throws LockException
     */
    boolean sharedLock(CalDAVTransaction transaction, String path, String owner, int depth, int timeout) throws LockException;
     ...
     * @return LockedObject o <code>null</code> si no existe un <code>LockedObject</code>
    ...
    /**
     * Obtiene el <code>LockedObject</code> temporal correspondiente a un identificador
     * 
     * @param transaction
     * @param id
     *      identificador para solicitar el recurso
