...
public class WinClass extends WinObject {
    ...
    public static WinClass create() {
        int id = nextObjectId();
        if (id > 0xFFFF) Win.panic("CLASS atom can not be greater than 0xFFFF");
    ...
    public static WinClass get(int handle) {
        ...
        if (object == null || !(object instanceof WinClass)) return null;
    ...
    public void write(int address) {
        ...
        address += 4;
        if (pClassName == 0) pClassName = StringUtil.allocateA(className);
