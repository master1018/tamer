...
public class CastOn implements BlockOperation {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((numberOfStitches == null) ? 0 : numberOfStitches.hashCode());
        result = prime * result + ((style == null) ? 0 : style.hashCode());
        result = prime * result + ((yarnIdRef == null) ? 0 : yarnIdRef.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (countAsRow != other.countAsRow) return false;
        if (numberOfStitches == null) {
            if (other.numberOfStitches != null) return false;
        } else if (!numberOfStitches.equals(other.numberOfStitches)) return false;
        if (style == null) {
            if (other.style != null) return false;
        } else if (!style.equals(other.style)) return false;
        if (yarnIdRef == null) {
            if (other.yarnIdRef != null) return false;
        } else if (!yarnIdRef.equals(other.yarnIdRef)) return false;
        return true;
    }

    @Override
    public String toString() {
        return "CastOn [numberOfStitches:" + numberOfStitches + ",yarnIdRef:" + yarnIdRef + ",style:" + style + ",countAsRow:" + countAsRow + "]";
    }
}
