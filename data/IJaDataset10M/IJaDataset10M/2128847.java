...
public class ElectromagneticEmission {
    ...
    public static void processPDU(DatagramPacket packet, int pduCounter) {
        ...
        @SuppressWarnings("unused") short padding1 = 0;
        byte systemDataLength = 0;
        byte numberOfBeams = 0;
        @SuppressWarnings("unused") short padding2 = 0;
        short emitterName = 0;
        ...
        @SuppressWarnings("unused") byte padding3 = 0;
        ...
        try {
            ...
            System.out.println("    stateUpdateIndicator : " + stateUpdateIndicator);
            ...
            for (int i = 0; i < numberOfSystems; i++) {
                ...
                System.out.println("        systemDataLength : " + systemDataLength);
                ...
                System.out.println("        emitterLocationX : " + emitterLocationX);
                System.out.println("        emitterLocationY : " + emitterLocationY);
                System.out.println("        emitterLocationZ : " + emitterLocationZ);
                for (int j = 0; j < numberOfBeams; j++) {
                    ...
                    System.out.println("             beamDataLength : " + beamDataLength);
                    System.out.println("               beamIDNumber : " + beamIDNumber);
                    System.out.println("             beamParamIndex : " + beamParamIndex);
                    System.out.println("                  frequency : " + frequency);
                    System.out.println("             frequencyRange : " + frequencyRange);
                    System.out.println("     effectiveRadiatedPower : " + effectiveRadiatedPower);
                    System.out.println("   pulseRepetitionFrequency : " + pulseRepetitionFrequency);
                    System.out.println("                 pulseWidth : " + pulseWidth);
                    System.out.println("          beamAzimuthCenter : " + beamAzimuthCenter);
                    System.out.println("           beamAzimuthSweep : " + beamAzimuthSweep);
                    System.out.println("        beamElevationCenter : " + beamElevationCenter);
                    System.out.println("         beamElevationSweep : " + beamElevationSweep);
                    System.out.println("              beamSweepSync : " + beamSweepSync);
                    System.out.println("               beamFunction : " + beamFunction);
                    System.out.println("    numberTargetsInTrackJam : " + numberTargetsInTrackJam);
                    System.out.println("        highDensityTrackJam : " + highDensityTrackJam);
                    for (int k = 0; k < numberTargetsInTrackJam; k++) {
                        ...
                        System.out.println("           jammingModeSequence : " + jammingModeSequence);
                        System.out.println("                  trackJamSite : " + trackJamSite);
                        System.out.println("                   trackJamApp : " + trackJamApp);
                        System.out.println("                trackJamEntity : " + trackJamEntity);
                        System.out.println("             trackJamEmitterID : " + trackJamEmitterID);
                        System.out.println("                trackJamBeamID : " + trackJamBeamID);
                    }
                }
            }
