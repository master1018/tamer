...
public abstract class TumblingWF1PartitionPauseTest extends OrderGeneratorTest {
    ...
    protected String getRQL() {
        ...
        return "select " + csv + " from test (partition store latest " + windowSize + ") as testStr where testStr.$row_status is new;";
    }
    ...
    protected void verify(List<BatchResult> results) {
        ...
        Assert.assertEquals(totalEvents, getMaxDataRows(), "Total events received don't match expected value.");
