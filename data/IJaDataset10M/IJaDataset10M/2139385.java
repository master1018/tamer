...
public class PaymentGatewayCaixa implements PaymentGateway {
    ...
    public PaymentGatewayCaixa(Properties props) {
        ...
        ENDPOINTADDRESS = (m_bTestMode) ? "https://sis-t.sermepa.es:25443/sis/operaciones" : "https://sis.sermepa.es/sis/realizarPago";
    }
    ...
    public PaymentConfiguration getConfiguration() {
        return new ConfigPaymentPanelCaixa();
    }
}
