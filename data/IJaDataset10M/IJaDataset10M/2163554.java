 ...
 */
@Purpose(htmlDescriptionKey = "com.ardor3d.example.effect.ParticleSwarmExample", thumbnailPath = "com/ardor3d/example/media/thumbnails/effect_ParticleSwarmExample.jpg", maxHeapMemory = 64)
public class ParticleSwarmExample extends ExampleBase {
    ...
    protected void updateExample(final ReadOnlyTimer timer) {
        if ((int) currentPos.getX() == (int) newPos.getX() && (int) currentPos.getY() == (int) newPos.getY() && (int) currentPos.getZ() == (int) newPos.getZ()) {
    ...
    protected void initExample() {
        ...
        ts.setTexture(TextureManager.load("images/flaresmall.jpg", Texture.MinificationFilter.Trilinear, TextureStoreFormat.GuessCompressedFormat, true));
        ts.setEnabled(true);
