...
public class FRCronograma extends FRelatorio implements CarregaListener {
    ...
    public void imprimir(boolean bVisualizar) {
        ...
        ResultSet rs = null;
        try {
            Constant[] filtroTipo = DAOGestaoProj.getFiltroTipo("N", cbTipoIC.getVlrString(), cbTipoSC.getVlrString(), cbTipoIS.getVlrString(), cbTipoTA.getVlrString(), cbTipoST.getVlrString());
            ...
            daogestao.setParamsQueryContr(ps, txtDataini.getVlrDate(), txtDatafim.getVlrDate(), Aplicativo.iCodEmp, ListaCampos.getMasterFilial("VDCONTRATO"), txtCodContr.getVlrInteger(), txtIndice.getVlrString(), filtroTipo);
            rs = ps.executeQuery();
        } catch (Exception err) {
