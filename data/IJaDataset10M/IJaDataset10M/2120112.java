...
public class CarcassonneAboutBox extends javax.swing.JDialog {

    public CarcassonneAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(carcassonne.gui.CarcassonneApp.class).getContext().getResourceMap(CarcassonneAboutBox.class);
        setTitle(resourceMap.getString("title"));
        setModal(true);
        setName("aboutBox");
        setResizable(false);
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(carcassonne.gui.CarcassonneApp.class).getContext().getActionMap(CarcassonneAboutBox.class, this);
