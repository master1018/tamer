...
public class ClassifierQuantiles implements DescribedClassifier, BoundaryClassifier {
    ...
    protected static final Logger logger = Logger.getLogger(ClassifierQuantiles.class.getName());
    ...
    public static void main(String[] args) {
        double[] someData = { Double.NaN, Double.NaN, 1, 1, 2, 45, 3, 45, 45, 600, 1, Double.NaN, Double.NaN };
