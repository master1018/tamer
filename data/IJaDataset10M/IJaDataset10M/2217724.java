...
public class AnalysisActivityTimings {
    ...
    public void readData(String path) {
        try {
            ...
            while (line != null) {
                ...
                if (token2 != "0") this.event2.add(token2); else this.event2.add("shopping");
                line = br.readLine();
                index++;
            }
        } catch (Exception ex) {
    ...
    public static void main(final String[] args) {
        ...
        for (int i = 0; i < msc.times.size(); i++) {
            if (msc.agent.get(i) == 1 && msc.event.get(i).startsWith("actstart")) stream1.println("Act start\t" + msc.times.get(i) + "\t" + java.lang.Math.floor(msc.times.get(i) / 3600) + "\t" + java.lang.Math.floor((msc.times.get(i) - (java.lang.Math.floor(msc.times.get(i) / 3600)) * 3600) / 60) + "\t" + (msc.times.get(i) - (java.lang.Math.floor(msc.times.get(i) / 3600) * 3600) - (java.lang.Math.floor((msc.times.get(i) - (java.lang.Math.floor(msc.times.get(i) / 3600)) * 3600) / 60) * 60)));
            if (msc.agent.get(i) == 1 && msc.event.get(i).startsWith("actend")) stream1.println("Act end\t" + msc.times.get(i) + "\t" + java.lang.Math.floor(msc.times.get(i) / 3600) + "\t" + java.lang.Math.floor((msc.times.get(i) - (java.lang.Math.floor(msc.times.get(i) / 3600)) * 3600) / 60) + "\t" + (msc.times.get(i) - (java.lang.Math.floor(msc.times.get(i) / 3600) * 3600) - (java.lang.Math.floor((msc.times.get(i) - (java.lang.Math.floor(msc.times.get(i) / 3600)) * 3600) / 60) * 60)));
        }
        double timeHome1 = 0;
        double timeHome1L = 0;
        double timeWork = 0;
            ...
            if (!hasLeisure) {
                for (int i = 0; i < msc.times.size(); i++) {
                    if (msc.agent.get(i) == j && msc.event.get(i).startsWith("actend")) {
                        if (actpos == 0) timeHome1 += msc.times.get(i); else if (actpos == 1) timeWork += msc.times.get(i) - prtime; else if (actpos == 2) timeShopping += msc.times.get(i) - prtime;
                        actpos++;
                    } else if (msc.agent.get(i) == j && msc.event.get(i).startsWith("actstart")) {
                        if (actpos != 3) prtime = msc.times.get(i); else timeHome2 += 86400 - msc.times.get(i);
                        ...
                        if (actpos == 1) timeftrip += msc.times.get(i) - prtime; else if (actpos == 2) timestrip += msc.times.get(i) - prtime; else if (actpos == 3) timettrip += msc.times.get(i) - prtime;
                    }
                }
            } else {
                for (int i = 0; i < msc.times.size(); i++) {
                    if (msc.agent.get(i) == j && msc.event.get(i).startsWith("actend")) {
                        if (actpos == 0) timeHome1L += msc.times.get(i); else if (actpos == 1) timeWorkL += msc.times.get(i) - prtime; else if (actpos == 2) timeLeisure += msc.times.get(i) - prtime;
                        actpos++;
                    } else if (msc.agent.get(i) == j && msc.event.get(i).startsWith("actstart")) {
                        if (actpos != 3) prtime = msc.times.get(i); else timeHome2L += 86400 - msc.times.get(i);
                    } else if (msc.agent.get(i) == j && msc.event.get(i).startsWith("departure")) {
                        prtime = msc.times.get(i);
                    } else if (msc.agent.get(i) == j && msc.event.get(i).startsWith("arrival")) {
                        if (actpos == 1) timeftripL += msc.times.get(i) - prtime; else if (actpos == 2) timestripL += msc.times.get(i) - prtime; else if (actpos == 3) timettripL += msc.times.get(i) - prtime;
                    }
                }
            }
        }
