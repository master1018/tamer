...
/**
 * This is a default implementation of the IFC object IfcSurfaceStyleShading<br><br>
 * 
 ...
 **/
public class IfcSurfaceStyleShading implements IfcClass, IfcSurfaceStyleElementSelect {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcColourRgb" };
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("SurfaceColour")) stepString = stepString.concat("*);"); else {
            if (this.SurfaceColour != null) stepString = stepString.concat(((IfcRootInterface) this.SurfaceColour).getStepParameter(IfcColourRgb.class.isInterface()) + ");"); else stepString = stepString.concat("$);");
        }
        return stepString;
    }
	 ...
	 * 
	 * @param SurfaceColour value to set
	 *            /
	 **/
    ...
    public Object clone() {
        ...
        if (this.SurfaceColour != null) ifcSurfaceStyleShading.setSurfaceColour((IfcColourRgb) this.SurfaceColour.clone());
    ...
    public Object shallowCopy() {
        IfcSurfaceStyleShading ifcSurfaceStyleShading = new IfcSurfaceStyleShading();
        if (this.SurfaceColour != null) ifcSurfaceStyleShading.setSurfaceColour(this.SurfaceColour);
        return ifcSurfaceStyleShading;
    }
