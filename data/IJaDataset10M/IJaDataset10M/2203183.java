...
public class X500PrincipalTest extends junit.framework.TestCase {
    ...
    public void test_ConstructorLjava_lang_String() {
        X500Principal principal = new X500Principal("CN=Hermione Granger, O=Apache Software Foundation, OU=Harmony, L=Hogwarts, ST=Hants, C=GB");
    ...
    public void test_getNameLjava_lang_String() {
        X500Principal principal = new X500Principal("CN=Dumbledore, OU=Administration, O=Hogwarts School, C=GB");
        ...
        assertEquals("CANONICAL output differs from expected result", expected, canonical);
    }
