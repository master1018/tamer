...
public class Annotation {
    ...
    Annotation(ClassReader cr) throws IOException, InvalidAnnotation {
        ...
        for (int i = 0; i < element_value_pairs.length; i++) element_value_pairs[i] = new element_value_pair(cr);
    }
    ...
    public int length() {
        int n = 2 + 2;
        for (element_value_pair pair : element_value_pairs) n += pair.length();
        return n;
    }
    ...
    public static class Array_element_value extends element_value {
        ...
        Array_element_value(ClassReader cr, int tag) throws IOException, InvalidAnnotation {
            ...
            for (int i = 0; i < values.length; i++) values[i] = element_value.read(cr);
        }

        @Override
        public int length() {
            int n = 2;
            for (int i = 0; i < values.length; i++) n += values[i].length();
            return n;
        }
