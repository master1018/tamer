...
/**
 * A basic implementation of an {@link InvocationLayerFactory}. This factory is
 * used to create a {@link Proxy} instance with a {@link BasicInvocationHandler}
 * and to create a {@link BasicInvocationDispatcher} for a remote object being
 * exported. This factory is used in conjunction with the
 * {@link BasicJeriExporter} class.
 * 
...
public class BasicILFactory extends AbstractILFactory {
	 ...
	 * implementing the specified interfaces, communicating with the specified
	 * remote object using the specified object endpoint.
	 * 
	 * <p>
	 * <code>BasicILFactory</code> implements this method to return a
	 * {@link BasicInvocationHandler} constructed with the specified object
	 ...
	 * 
	 * <p>
	 * <code>BasicILFactory</code> implements this method to return a new array
	 * containing the {@link RemoteMethodControl} and {@link TrustEquivalence}
    ...
    /**
	 * Returns an invocation dispatcher to receive incoming remote calls for the
	 * specified methods to the specified remote object, for a server and
	 * transport with the specified capabilities.
	 * 
	 * <p>
	 * <code>BasicILFactory</code> implements this method to return a
	 * {@link BasicInvocationDispatcher} instance constructed with the specified
	 * methods, server capabilities, and this factory's server constraints,
	 * permission class, and class loader specified at construction.
	 * 
	 * @throws NullPointerException
	 *             {@inheritDoc}
	 * @throws IllegalArgumentException
    ...
    protected InvocationDispatcher createInvocationDispatcher(Collection methods, Remote impl, ServerCapabilities caps) throws ExportException {
        ...
        return new BasicInvocationDispatcher(methods, caps, serverConstraints, permissionClass, getClassLoader());
    }
	 ...
	 * 
	 * <p>
	 * <code>BasicILFactory</code> implements this method to return
	 ...
	 * object, and the server constraints and permission class are equal to the
	 * ones in this object.
	 **/
    public boolean equals(Object obj) {
        ...
        return (permissionClass == ilf.permissionClass && (serverConstraints == ilf.serverConstraints || (serverConstraints != null && serverConstraints.equals(ilf.serverConstraints))));
    }
    ...
    public String toString() {
        return (super.toString() + "[" + serverConstraints + (permissionClass != null ? ", " + permissionClass.getName() : "") + "]");
    }
}
