...
*/
public class SelectedSparseSuperDoubleMatrix2D extends DoubleMatrix2D {
 ...
 * @param  offset   
 */
    protected SelectedSparseSuperDoubleMatrix2D(int rows, int columns, AbstractLongDoubleMap elements, int rowZero, int columnZero, int rowStride, int columnStride, int[] rowOffsets, int[] columnOffsets, int offset) {
 ...
 * @param  offset   
 */
    protected SelectedSparseSuperDoubleMatrix2D(AbstractLongDoubleMap elements, int[] rowOffsets, int[] columnOffsets, int offset) {
 ...
 */
    protected boolean haveSharedCellsRaw(DoubleMatrix2D other) {
        if (other instanceof SelectedSparseDoubleMatrix2D) {
            SelectedSparseSuperDoubleMatrix2D otherMatrix = (SelectedSparseSuperDoubleMatrix2D) other;
            return this.elements == otherMatrix.elements;
        } else if (other instanceof SparseSuperDoubleMatrix2D) {
            SparseSuperDoubleMatrix2D otherMatrix = (SparseSuperDoubleMatrix2D) other;
            return this.elements == otherMatrix.elements;
        }
        return false;
    }
...
*/
    public DoubleMatrix1D viewColumn(int column) {
        ...
        return new SelectedSparseSuperDoubleMatrix1D(viewSize, this.elements, viewZero, viewStride, viewOffsets, viewOffset);
    }
 ...
 */
    protected DoubleMatrix2D viewSelectionLike(int[] rowOffsets, int[] columnOffsets) {
        return new SelectedSparseSuperDoubleMatrix2D(this.elements, rowOffsets, columnOffsets, this.offset);
    }
}
