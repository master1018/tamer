package vademecum.visualizer.seriesplot.dialogs;
...
public class SetAxesDialog extends JDialog implements WindowFocusListener, WindowListener {
    ...
    public SetAxesDialog(PlotCanvas p) {
        plotCanvas = p;
        setPanel();
    ...
    public class ScalePanel extends JPanel implements StringPrintable {
        ...
        public void update() {
            title = plotCanvas.getGrid().getAxe(numAxe).getLegend();
        ...
        private void setTitle() {
            plotCanvas.setAxeLabel(numAxe, title_field.getText());
        }
