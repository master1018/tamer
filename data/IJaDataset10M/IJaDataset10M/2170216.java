...
public class FederationNode {
    ...
    public boolean equals(Object o) {
        ...
        return ((co.getIpAddress().equals(ipAddress)) && (co.getMetaVersion().equals(metaVersion)) && (co.getUserName().equals(userName)) && (co.getNumberOfProcessors() == numberOfProcessors));
    }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 47 * hash + (this.ipAddress != null ? this.ipAddress.hashCode() : 0);
        hash = 47 * hash + (this.metaVersion != null ? this.metaVersion.hashCode() : 0);
    ...
    public String toString() {
        return (ipAddress.getHostAddress() + ";" + metaVersion + ";" + userName + ";" + numberOfProcessors);
    }
}
