...
/**
* org/fudaa/dodico/corba/evenement/_IObjetEventSenderStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from C:/devel/fudaa/fudaa_devel/dodico/idl/general/evenement.idl
* mercredi 6 ao�t 2008 22 h 27 CEST
*/
public class _IObjetEventSenderStub extends org.omg.CORBA.portable.ObjectImpl implements org.fudaa.dodico.corba.evenement.IObjetEventSender {

    public void addObjetEventListener(org.fudaa.dodico.corba.evenement.IObjetEventListenerSupport l) {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("addObjetEventListener", true);
            org.fudaa.dodico.corba.evenement.IObjetEventListenerSupportHelper.write($out, l);
            $in = _invoke($out);
            return;
            ...
            addObjetEventListener(l);
        } finally {
            _releaseReply($in);
        }
    }

    public void removeObjetEventListener(org.fudaa.dodico.corba.evenement.IObjetEventListenerSupport l) {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("removeObjetEventListener", true);
            org.fudaa.dodico.corba.evenement.IObjetEventListenerSupportHelper.write($out, l);
            $in = _invoke($out);
            return;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            ...
            removeObjetEventListener(l);
        } finally {
            _releaseReply($in);
        }
    }

    public org.fudaa.dodico.corba.collection.ITableau getObjetEventListeners() {
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("getObjetEventListeners", true);
            $in = _invoke($out);
            org.fudaa.dodico.corba.collection.ITableau $result = org.fudaa.dodico.corba.collection.ITableauHelper.read($in);
            return $result;
        } catch (org.omg.CORBA.portable.ApplicationException $ex) {
            $in = $ex.getInputStream();
            String _id = $ex.getId();
    ...
    private static String[] __ids = { "IDL:evenement/IObjetEventSender:1.0", "IDL:objet/IObjet:1.0" };
