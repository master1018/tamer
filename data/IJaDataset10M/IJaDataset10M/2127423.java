...
public class ReportsUpdaterTest {
    ...
    public void setUp() {
        ...
        HandlingEvent handlingEvent = handlingEventFactory.createHandlingEvent(toDate("2009-10-02"), trackingId, null, HONGKONG.unLocode(), HandlingActivityType.RECEIVE, new OperatorCode("ABCDE"));
