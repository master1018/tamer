...
class ErrorNode extends AbstractCommandNode {
    ...
    void document(PrintWriter writer) {
        ...
        writer.println("<tr><td>" + "<a href=\"#" + NAME_OF_ERROR_TABLE + "_" + name + "\">" + name + "</a></td>" + "<td>" + com + "&nbsp;</td></tr>");
    }
    ...
    void genJavaDebugWrite(PrintWriter writer, int depth, String writeLabel) {
    }

    void genJavaDebugWrite(PrintWriter writer, int depth, String writeLabel, String displayValue) {
    }
