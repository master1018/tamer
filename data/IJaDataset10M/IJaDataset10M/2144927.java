...
public interface WftRegistryService {
     ...
     */
    @WebMethod(operationName = WftRegistryService.NAME + "_registerWorkflowTemplate", action = PlanetsServices.NS + "/" + WftRegistryService.NAME + "/registerWorkflowTemplate")
    public void registerWorkflowTemplate(@WebParam(name = "QWorkflowTemplateName", targetNamespace = PlanetsServices.NS + "/" + WftRegistryService.NAME, partName = "QWorkflowTemplateName") String qWorkflowTemplateName, @WebParam(name = "javaBinary", targetNamespace = PlanetsServices.NS + "/" + WftRegistryService.NAME, partName = "javaBinary") byte[] javaBinary) throws PlanetsException;

    /**
     * Returns a list of all fully QNames of registered WFTemplates
     * @return
     */
    @WebMethod(operationName = WftRegistryService.NAME + "_getAllSupportedQNames", action = PlanetsServices.NS + "/" + WftRegistryService.NAME + "/getAllSupportedQNames")
    @WebResult(name = WftRegistryService.NAME + "QNames", targetNamespace = PlanetsServices.NS + "/" + WftRegistryService.NAME, partName = WftRegistryService.NAME + "QNames")
     ...
     */
    @WebMethod(operationName = WftRegistryService.NAME + "_getWorkflowTemplate", action = PlanetsServices.NS + "/" + WftRegistryService.NAME + "/getWorkflowTemplate")
    @WebResult(name = WftRegistryService.NAME + "Template", targetNamespace = PlanetsServices.NS + "/" + WftRegistryService.NAME, partName = WftRegistryService.NAME + "Template")
    public byte[] getWFTemplate(@WebParam(name = "QWorkflowTemplateName", targetNamespace = PlanetsServices.NS + "/" + WftRegistryService.NAME, partName = "QWorkflowTemplateName") String qWorkflowTemplateName) throws PlanetsException;
}
