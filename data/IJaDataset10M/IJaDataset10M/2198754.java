...
public class DocumentExample extends SingleFrameApplication {
    ...
    private JDialog createAboutBox() {
        ...
        panel.setBorder(new EmptyBorder(0, 28, 16, 28));
    ...
    private JMenuBar createMenuBar() {
        ...
        String[] fileMenuActionNames = { "open", "save", "saveAs", "---", "quit" };
        String[] editMenuActionNames = { "cut", "copy", "paste", "delete" };
        String[] helpMenuActionNames = { "showAboutBox" };
    ...
    private JToolBar createToolBar() {
        String[] toolbarActionNames = { "open", "save", "cut", "copy", "paste" };
