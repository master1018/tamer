...
public class TestMailSignerCLI extends TestCase {
    ...
    public void testBasicSetup() {
        ...
        TestUtils.assertSuccessfulExecution(new String[] { "setproperty", "global", "WORKER" + TESTID + ".CLASSPATH", "org.signserver.server.signers.TimeStampSigner" });
        TestUtils.assertSuccessfulExecution(new String[] { "getconfig", "global" });
        assertTrue(TestUtils.grepTempOut("WORKER" + TESTID + ".CLASSPATH"));
        TestUtils.assertSuccessfulExecution(new String[] { "setproperty", TESTID, "TESTKEY", "TESTVALUE" });
        TestUtils.assertSuccessfulExecution(new String[] { "getconfig", TESTID });
        assertTrue(TestUtils.grepTempOut("TESTKEY"));
        TestUtils.assertSuccessfulExecution(new String[] { "removeproperty", TESTID, "TESTKEY" });
        TestUtils.assertSuccessfulExecution(new String[] { "removeproperty", "global", "WORKER" + TESTID + ".CLASSPATH" });
        TestUtils.assertSuccessfulExecution(new String[] { "getconfig", "global" });
        assertFalse(TestUtils.grepTempOut("WORKER" + TESTID + ".CLASSPATH"));
        TestUtils.assertSuccessfulExecution(new String[] { "getconfig", "" + TESTID });
        assertFalse(TestUtils.grepTempOut("TESTKEY"));
        TestUtils.assertSuccessfulExecution(new String[] { "getconfig", "-host", "localhost", "" + TESTID });
    }

    public void testSetupDummyMailSigner() {
        TestUtils.assertSuccessfulExecution(new String[] { "setproperties", signserverhome + "/src/test/test_add_dummymailsigner_configuration.properties" });
        assertTrue(TestUtils.grepTempOut("Setting the property NAME to dummyMailSigner1000 for worker 1000"));
        TestUtils.assertSuccessfulExecution(new String[] { "reload", TESTTSID });
        TestUtils.assertSuccessfulExecution(new String[] { "getstatus", "complete", TESTTSID });
        TestUtils.assertSuccessfulExecution(new String[] { "setproperty", TESTTSID, "TESTKEY", "TESTVALUE" });
        TestUtils.assertSuccessfulExecution(new String[] { "getstatus", "complete", TESTTSID });
        assertFalse(TestUtils.grepTempOut("TESTKEY"));
        TestUtils.assertSuccessfulExecution(new String[] { "reload", TESTTSID });
        ...
        assertTrue(TestUtils.grepTempOut("TESTKEY"));
        TestUtils.assertFailedExecution(new String[] { "activatesigntoken", TESTTSID, "9876" });
        TestUtils.assertSuccessfulExecution(new String[] { "activatesigntoken", TESTTSID, "1234" });
        assertTrue(TestUtils.grepTempOut("Activation of worker was successful"));
        TestUtils.assertSuccessfulExecution(new String[] { "deactivatesigntoken", TESTTSID });
        assertTrue(TestUtils.grepTempOut("Deactivation of worker was successful"));
        TestUtils.assertSuccessfulExecution(new String[] { "activatecryptotoken", "dummyMailSigner1000", "1234" });
        assertTrue(TestUtils.grepTempOut("Activation of worker was successful"));
        TestUtils.assertSuccessfulExecution(new String[] { "activatecryptotoken", "DUMMYMAILSIGNER1000", "1234" });
        TestUtils.assertFailedExecution(new String[] { "activatecryptotoken", "DUMMYMAILSIGNER2000", "1234" });
        TestUtils.assertSuccessfulExecution(new String[] { "addauthorizeduser", "test1", "pwd1" });
        TestUtils.assertSuccessfulExecution(new String[] { "listauthorizedusers" });
        assertTrue(TestUtils.grepTempOut("TEST1"));
        TestUtils.assertSuccessfulExecution(new String[] { "removeauthorizeduser", "test1" });
        TestUtils.assertSuccessfulExecution(new String[] { "listauthorizedusers" });
        assertFalse(TestUtils.grepTempOut("TEST1"));
        TestUtils.assertSuccessfulExecution(new String[] { "dumpproperties", "DUMMYMAILSIGNER1000", signserverhome + "/tmp/testdump.properties" });
    ...
    public void testRemoveDummyMailSigner() {
        TestUtils.assertSuccessfulExecution(new String[] { "removeworker", "1000" });
        assertTrue(TestUtils.grepTempOut("Property 'NAME' removed"));
        TestUtils.assertSuccessfulExecution(new String[] { "getconfig", TESTTSID });
        assertFalse(TestUtils.grepTempOut("NAME=dummyMailSigner1000"));
        TestUtils.assertSuccessfulExecution(new String[] { "removeproperty", TESTTSID, "TESTKEY" });
        TestUtils.assertSuccessfulExecution(new String[] { "reload", TESTTSID });
        assertTrue(TestUtils.grepTempOut("SignServer reloaded successfully"));
    }

    public void testSetupModules() throws Exception {
        TestUtils.assertSuccessfulExecution(new String[] { "module", "add", signserverhome + "/src/test/testmodule-withoutdescr.mar" });
        assertTrue(TestUtils.grepTempOut("Loading module TESTMODULE-WITHOUTDESCR with version 1"));
        assertTrue(TestUtils.grepTempOut("Module loaded successfully."));
        TestUtils.assertSuccessfulExecution(new String[] { "module", "add", signserverhome + "/src/test/testmodule-withdescr.mar" });
        ...
        TestUtils.assertSuccessfulExecution(new String[] { "module", "add", signserverhome + "/src/test/testmodule-withdescr.mar", "devel" });
    ...
    public void testModules() {
        TestUtils.assertSuccessfulExecution(new String[] { "module", "remove", "testmodule-withoutdescr", "1" });
        ...
        TestUtils.assertSuccessfulExecution(new String[] { "module", "remove", "testmodule-withdescr", "2" });
        assertTrue(TestUtils.grepTempOut("Removing module TESTMODULE-WITHDESCR version 2"));
        assertTrue(TestUtils.grepTempOut("Removal of module successful."));
        TestUtils.assertSuccessfulExecution(new String[] { "removeworker", "6543" });
        TestUtils.assertSuccessfulExecution(new String[] { "removeworker", "4321" });
        TestUtils.assertSuccessfulExecution(new String[] { "removeworker", "3433" });
        TestingSecurityManager.remove();
    }
}
