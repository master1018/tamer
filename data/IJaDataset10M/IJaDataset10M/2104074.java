...
public class Security implements Serializable {
    ...
    public void setIndustryGroupID(int id) {
        if (id != this.industryGroupID) {
            ...
            this.notifyListener("industryGroupID", new Integer(old), new Integer(this.industryGroupID));
        }
    }
    ...
    public void setIndustryID(int id) {
        if (id != this.industryID) {
            ...
            this.industryID = id;
            this.notifyListener("industryID", new Integer(old), new Integer(this.industryID));
        }
    }
    ...
    public void setSectorID(int id) {
        if (id != this.sectorID) {
            ...
            this.sectorID = id;
            this.notifyListener("sectorID", new Integer(old), new Integer(this.sectorID));
        }
    }
    ...
    public void setSubIndustryID(int id) {
        if (id != this.subIndustryID) {
            ...
            this.notifyListener("subIndustryID", new Integer(old), new Integer(this.subIndustryID));
        }
    }
