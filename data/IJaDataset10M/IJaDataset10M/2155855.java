...
@Purpose(htmlDescriptionKey = "com.ardor3d.example.terrain.ImageMapTerrainExample", thumbnailPath = "com/ardor3d/example/media/thumbnails/terrain_ImageMapTerrainExample.jpg", maxHeapMemory = 128)
public class ImageMapTerrainExample extends ExampleBase {
    ...
    protected void initExample() {
        ...
        _canvas.getCanvasRenderer().getCamera().setFrustumPerspective(70.0, (float) _canvas.getCanvasRenderer().getCamera().getWidth() / _canvas.getCanvasRenderer().getCamera().getHeight(), 1.0f, farPlane);
        ...
        try {
            ...
            final BufferedImage logo = ImageIO.read(ResourceLocatorTool.getClassPathResource(ImageMapTerrainExample.class, "com/ardor3d/example/media/images/water/dudvmap.png"));
            ...
            final TerrainDataProvider terrainDataProvider = new ArrayTerrainDataProvider(heightMap, SIZE, new Vector3(3, 50, 3));
        ...
        _logicalLayer.registerTrigger(new InputTrigger(new KeyPressedCondition(Key.NINE), new TriggerAction() {
            ...
            public void perform(final Canvas source, final TwoInputStates inputStates, final double tpf) {
                final Camera camera = _canvas.getCanvasRenderer().getCamera();
                camera.setLocation(camera.getLocation().getX(), camera.getLocation().getY(), camera.getLocation().getZ() + 1500.0);
            }
        }));
