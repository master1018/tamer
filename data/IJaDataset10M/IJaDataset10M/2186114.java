...
public class EgovBatchOpertController {
    ...
    public String insertBatchOpert(BatchOpert batchOpert, BindingResult bindingResult, ModelMap model) throws Exception {
        ...
        if (bindingResult.hasErrors()) {
            ...
            batchOpert.setLastUpdusrId((String) loginVO.getUniqId());
            batchOpert.setFrstRegisterId((String) loginVO.getUniqId());
    ...
    public String selectBatchOpertList(@ModelAttribute("searchVO") BatchOpert searchVO, ModelMap model, @RequestParam(value = "popupAt", required = false) String popupAt) throws Exception {
