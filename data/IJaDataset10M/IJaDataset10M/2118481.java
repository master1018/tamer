...
public class XmlError implements java.io.Serializable {
    ...
    protected XmlError(String message, String code, int severity, XmlCursor cursor) {
        ...
        if (cursor != null) {
            ...
            if (ln == null) ln = (XmlLineNumber) c.toPrevBookmark(XmlLineNumber.class);
            if (ln != null) {
                line = ln.getLine();
                column = ln.getColumn();
                offset = ln.getOffset();
    ...
    protected XmlError(String message, String code, int severity, Location loc) {
        ...
        if (loc != null) {
            ...
            if (source == null) source = loc.getSystemId();
        }
        _message = message;
        _code = code;
        _severity = severity;
    ...
    public static XmlError forLocation(String message, String sourceName, Location location) {
        return new XmlError(message, (String) null, SEVERITY_ERROR, sourceName, location.getLineNumber(), location.getColumnNumber(), -1, null);
    }
    ...
    public static XmlError forObject(String message, int severity, XmlObject xobj) {
        if (xobj == null) return forMessage(message, severity);
    ...
    public static XmlError forObject(String code, Object[] args, int severity, XmlObject xobj) {
        if (xobj == null) return forMessage(code, args, severity);
        XmlCursor cur = xobj.newCursor();
    ...
    protected static String formattedFileName(String rawString, URI base) {
        ...
        try {
            ...
            if (!uri.isAbsolute()) uri = null;
        } catch (URISyntaxException e) {
            uri = null;
        }
        if (uri == null) uri = new File(rawString).toURI();
        if (base != null) uri = base.relativize(uri);
    ...
    public static String formattedMessage(String code, Object[] args) {
        ...
        try {
            ...
            return MessageFormat.format(_bundle.getString("message.missing.resource"), new Object[] { e.getMessage() });
        } catch (IllegalArgumentException e) {
            return MessageFormat.format(_bundle.getString("message.pattern.invalid"), new Object[] { e.getMessage() });
        }
        return message;
    }
    ...
    public Object getLocation(Object type) {
        if (type == XmlCursor.class) return _cursor;
        if (type == XmlObject.class && _cursor != null) return _cursor.getObject();
        return null;
    }
