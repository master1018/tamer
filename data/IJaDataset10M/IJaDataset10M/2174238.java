...
public class AmpSelectModel extends JPanel implements ActionListener {
    ...
    AmpSelectModel(ComboBoxWidget ampSelectCB, JPanel parentPanel) {
        ...
        ampDesc = newJLabel("Based on: " + AMP_DESC_STRING[ampSelectCB.getValue()], parentPanel);
        suggestedCab = newJLabel("Suggested Cabinet: " + SUGG_CAB_STRING[ampSelectCB.getValue()], parentPanel);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        suggestedCab.setText("Suggested Cabinet: " + SUGG_CAB_STRING[selectedIndex]);
    }
}
