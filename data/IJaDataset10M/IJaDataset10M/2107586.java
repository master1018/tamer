...
public interface Action {
     ...
     * 
     * @param registry
     *            the ItemRegistry housing the VisualItems to process
     * @param frac
     *            a fraction indicating the current progress of this
     *            action if it persists over time. For actions that
     *            are only run once, a value of 0 is used.
     */
