    ...
    public List<ICompletionProposal> computeCompletionProposals(final ContentAssistInvocationContext context, final IProgressMonitor monitor) {
        ...
        if (context instanceof JavaContentAssistInvocationContext) {
            ...
            try {
                ...
                if (element != null) {
                    IJavaReference javaReference = JavaReferencesManager.getInstance().getXMLReference(element, null);
                    if (javaReference != null) {
                        IDocument document = jcontext.getDocument();
                        StringArgument stringArgument = DocumentHelper.findStringArgument(document, offset, false);
                        if (stringArgument != null) {
                            ...
                            IResource resource = jcontext.getCompilationUnit().getCorrespondingResource();
                            IFile file = (resource != null && resource.getType() == IResource.FILE) ? (IFile) resource : null;
