...
public class GetFileControllerTest {
    ...
    public void testCacheNotUsed() throws Exception {
        ...
        repositoryServiceMock.getFileContents((SVNConnection) EasyMock.isNull(), EasyMock.matches(command.getPath()), EasyMock.eq(-1L), (OutputStream) EasyMock.anyObject());
    ...
    public void testCacheUsed() throws Exception {
        final RepositoryService repositoryServiceMock = EasyMock.createMock(RepositoryService.class);
        final ObjectCacheManager objectCacheManager = new ObjectCacheManager(configDirectory, 0, false, false, 0, 0, false, 0) {
