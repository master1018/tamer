...
public abstract class FeatureCollectionRenderer implements Renderer {
    ...
    public FeatureCollectionRenderer(Object contentID, LayerViewPanel panel, ImageCachingFeatureCollectionRenderer imageCachingFeatureCollectionRenderer) {
        ...
        simpleFeatureCollectionRenderer = new SimpleFeatureCollectionRenderer(contentID, panel);
    ...
    public Runnable createRunnable() {
        ...
        currentFeatureCollectionRenderer = useImageCaching(layerToFeaturesMap) ? (Renderer) imageCachingFeatureCollectionRenderer : simpleFeatureCollectionRenderer;
