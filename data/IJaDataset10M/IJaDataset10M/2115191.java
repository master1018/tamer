...
public class AnnotationsAttribute extends AttributeInfo {
    ...
    static class Walker {
        ...
        void parameters(int numParam, int pos) throws Exception {
            for (int i = 0; i < numParam; ++i) pos = annotationArray(pos);
        }
        ...
        int annotationArray(int pos, int num) throws Exception {
            for (int i = 0; i < num; ++i) pos = annotation(pos);
            return pos;
        }
        ...
        int annotation(int pos, int type, int numPairs) throws Exception {
            for (int j = 0; j < numPairs; ++j) pos = memberValuePair(pos);
            return pos;
        }
        ...
        final int memberValue(int pos) throws Exception {
            ...
            if (tag == 'e') {
                ...
                return pos + 3;
            } else if (tag == '@') return annotationMemberValue(pos + 1); else if (tag == '[') {
