...
public class TestConfigData {
    ...
    public TestConfigData(NewGraphComparer comparer, ConverterPath testConverters, ConverterPath comparisonConverters, CIShellContext context, Data[][] testFileData) {
