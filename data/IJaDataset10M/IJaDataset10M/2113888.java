...
class AttributePattern extends Pattern {
    ...
    Pattern expand(SchemaPatternBuilder b) {
        ...
        if (ep != p) return b.makeAttribute(nameClass, ep, loc); else return this;
    }
    ...
    void checkRestrictions(int context, DuplicateAttributeDetector dad, Alphabet alpha) throws RestrictionViolationException {
        switch(context) {
            ...
            case ELEMENT_CONTEXT:
                if (nameClass.isOpen()) throw new RestrictionViolationException("open_name_class_not_repeated");
                break;
    ...
    boolean samePattern(Pattern other) {
        if (!(other instanceof AttributePattern)) return false;
