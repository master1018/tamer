...
/**
 * Represents Java interface for COM interface DispHTMLMetaElement.
 */
public interface DispHTMLMetaElement extends IDispatch {

    public static final String INTERFACE_IDENTIFIER = "{3050F517-98B5-11CF-BB82-00AA00BDCE0B}";
    ...
    static final int DISPID_setHttpEquiv = 1001;

    static final int DISPID_getHttpEquiv = 1001;

    static final int DISPID_setContent = 1002;

    static final int DISPID_getContent = 1002;

    static final int DISPID_setName = -2147418112;

    static final int DISPID_getName = -2147418112;

    static final int DISPID_setUrl = 1003;

    static final int DISPID_getUrl = 1003;

    static final int DISPID_setCharset = 1013;

    static final int DISPID_getCharset = 1013;

    static final int DISPID_setScheme = 1020;

    static final int DISPID_getScheme = 1020;
    ...
    void setHttpEquiv(BStr param1);

    BStr getHttpEquiv();

    void setContent(BStr param1);
    ...
    void setUrl(BStr param1);

    BStr getUrl();

    void setCharset(BStr param1);

    BStr getCharset();

    void setScheme(BStr param1);
