...
public class Location {
    ...
    public int deleteLocation(long id) {
        return mResolver.delete(ContentUris.withAppendedId(Locations.CONTENT_URI, id), null, null);
    }

    public GeoPoint getPoint(long id) {
        Cursor cursor = mResolver.query(ContentUris.withAppendedId(Locations.CONTENT_URI, id), new String[] { Locations._ID, Locations.LATITUDE, Locations.LONGITUDE }, null, null, Locations.DEFAULT_SORT_ORDER);
    ...
    public Cursor queryExtras(long locationId) {
        ...
        return mResolver.query(uri.build(), new String[] { Extras._ID, Extras.KEY, Extras.VALUE }, null, null, Extras.KEY + "," + Extras.VALUE);
    }
