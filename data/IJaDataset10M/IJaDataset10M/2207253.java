...
public class LatestActionDAOMysqlImpl extends AbstractTableCreatingDAOImpl implements LatestActionDAO {
    ...
    private static final RowMapper defaultPreviousRatingMapper = new RatingRowMapper(DEFAULT_PREVIOUS_RATING_VALUE_COLUMN_NAME, DEFAULT_PREVIOUS_ACTION_TIME_COLUMN_NAME);

    private static RowMapper defaultRatedTogetherMapper = new RatedTogetherRowMapper();

    private static final RowMapper defaultRatingMapper = new RatingRowMapper(DEFAULT_RATING_VALUE_COLUMN_NAME, DEFAULT_ACTION_TIME_COLUMN_NAME);
    ...
    public List<ItemVO<Integer, Integer>> getAvailableItemsForTenant(final Integer tenantId, final Integer itemTypeId) {
    ...
    public List<RatingVO<Integer, Integer>> getAverageRatingsForItem(final Integer tenantId, final Integer itemTypeId) {
        ...
        final RowMapper mapper = new RowMapper() {
            ...
            public Object mapRow(final ResultSet rs, final int rowNum) throws SQLException {
                ...
                final ItemVO<Integer, Integer> item = new ItemVO<Integer, Integer>(tenantId, itemId, itemTypeId);
                final RatingVO<Integer, Integer> rating = new RatingVO<Integer, Integer>(item, averageRatingValue, count, null);
                return rating;
            }
        };
        final List<RatingVO<Integer, Integer>> ratings = getJdbcTemplate().query(query, args, argt, mapper);
        return ratings;
    }
    ...
    public List<RatingVO<Integer, Integer>> getAverageRatingsForUser(final Integer tenantId, final Integer itemTypeId) {
        ...
        final RowMapper mapper = new RowMapper() {
            ...
            public Object mapRow(final ResultSet rs, final int rowNum) throws SQLException {
                ...
                final Double averageRatingValue = DaoUtils.getDouble(rs, DEFAULT_RATING_VALUE_COLUMN_NAME);
                final Integer count = DaoUtils.getInteger(rs, "count");
                final RatingVO<Integer, Integer> rating = new RatingVO<Integer, Integer>(null, averageRatingValue, count, null, userId);
                return rating;
            }
        };
        final List<RatingVO<Integer, Integer>> ratings = getJdbcTemplate().query(query.toString(), args, argt, mapper);
        return ratings;
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ItemVO<Integer, Integer>> getItemsNotRatedByUser(final Integer tenantId, final Integer userId, final Integer itemTypeId) {
        final StringBuilder query = new StringBuilder("SELECT DISTINCT ");
        ...
        final List<ItemVO<Integer, Integer>> items = getJdbcTemplate().query(query.toString(), args, argt, new ItemRowMapper(tenantId, itemTypeId));
        return items;
    }

    @SuppressWarnings("unchecked")
    public List<RatedTogether<Integer, Integer>> getItemsRatedTogether(final Integer tenantId, final Integer itemTypeId, final Integer item1Id, final Integer item2Id, final Integer actionTypeId) {
        ...
        final int[] argt = new int[] { Types.INTEGER, Types.INTEGER, Types.INTEGER, Types.INTEGER, Types.INTEGER };
        final List<RatedTogether<Integer, Integer>> ratedTogether = getJdbcTemplate().query(query.toString(), args, argt, defaultRatedTogetherMapper);
        return ratedTogether;
    }

    @SuppressWarnings("unchecked")
    public List<RatedTogether<Integer, Integer>> getItemsRatedTogetherByUsers(final Integer tenantId, final Integer itemTypeId, final Integer user1Id, final Integer user2Id, final Integer actionTypeId) {
    ...
    @SuppressWarnings("unchecked")
    public List<RatingVO<Integer, Integer>> getLatestRatingPage(int page, int tenantId, int itemTypeId, Date since) {
        ...
        return (List<RatingVO<Integer, Integer>>) getJdbcTemplate().query(query.toString(), args, argt, defaultRatingMapper);
    }
    ...
    @SuppressWarnings("unchecked")
    @ShortCacheable
    public List<RatingVO<Integer, Integer>> getLatestRatingsForTenant(final Integer tenantId, final Integer itemTypeId, final Integer itemId, final Integer userId, final Date since) {
        final StringBuilder query = new StringBuilder("SELECT ");
        appendAllColumns(query);
        query.append("\n");
        query.append("FROM ").append(DEFAULT_TABLE_NAME).append("\n");
    ...
    @SuppressWarnings("unchecked")
    public List<RatingVO<Integer, Integer>> getUpdatedRatingsForTenant(final Integer tenantId, final Integer itemTypeId, final Integer actionTypeId, final Date since) {
        final StringBuilder query = new StringBuilder("SELECT ");
    ...
    public boolean didUserRateItem(final Integer userId, final ItemVO<Integer, Integer> item, final Integer actionTypeId) {
    ...
    public int generateLatestActionForTenant(final Integer tenantId, final Date sinceLastAction) {
        ...
        if (sinceLastAction != null) query.append(" AND ").append(ActionDAO.DEFAULT_ACTION_TIME_COLUMN_NAME).append(" > ?");
        query.append("\n");
    ...
    private static final class RatedTogetherRowMapper implements RowMapper {
        ...
        public Object mapRow(final ResultSet rs, final int rowNum) throws SQLException {
            ...
            final ItemVO<Integer, Integer> item1 = new ItemVO<Integer, Integer>(tenantId, itemId1, itemTypeId1);
            final ItemVO<Integer, Integer> item2 = new ItemVO<Integer, Integer>(tenantId, itemId2, itemTypeId2);
            ...
            final RatingVO<Integer, Integer> rating1 = new RatingVO<Integer, Integer>(item1, ratingValue1, null, null, userId1);
            final RatingVO<Integer, Integer> rating2 = new RatingVO<Integer, Integer>(item2, ratingValue2, null, null, userId2);
            final RatedTogether<Integer, Integer> ratedTogether = new RatedTogether<Integer, Integer>(rating1, rating2);
            return ratedTogether;
        }
    }
    ...
    private static final class RatingRowMapper implements RowMapper {
        ...
        public Object mapRow(final ResultSet rs, final int rowNum) throws SQLException {
            ...
            final ItemVO<Integer, Integer> item = new ItemVO<Integer, Integer>(tenantId, itemId, itemTypeId);
            final RatingVO<Integer, Integer> rating = new RatingVO<Integer, Integer>(item, (double) ratingValue, null, actionTime, userId);
            return rating;
        }
    }
