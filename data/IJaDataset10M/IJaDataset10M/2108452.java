...
public class APIConfigFactoryTest {
    ...
    public void testLoadConfigLoadsSpecifiedConfigClass() throws Exception {
        try {
            System.setProperty(APIConfigFactory.CONFIG_CLASS_PROP, "org.mobicents.protocols.smpp.util.NullAPIConfig");
            APIConfigFactory.reset();
    ...
    public void testLoadConfigThrowsExceptionWhenConfigClassDoesNotExist() {
        try {
            System.setProperty(APIConfigFactory.CONFIG_CLASS_PROP, "org.mobicents.smpp.util.NonExistentAPIConfig");
            APIConfigFactory.reset();
