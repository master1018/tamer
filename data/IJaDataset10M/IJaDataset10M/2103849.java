...
public class RemoveAllSkuFromCartCommandImplTest extends BaseCoreDBTestCase {
    ...
    public void testExecute() {
        ...
        new ChangeCurrencyEventCommandImpl(ctx(), Collections.singletonMap(ChangeCurrencyEventCommandImpl.CMD_KEY, "EUR")).execute(shoppingCart);
        ...
        new RemoveAllSkuFromCartCommandImpl(ctx(), params).execute(shoppingCart);
        assertEquals(BigDecimal.ZERO.setScale(Constants.DEFAULT_SCALE), shoppingCart.getCartSubTotal());
