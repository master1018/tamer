    ...
    DirectoryConfigPanel(PrefsDialog parent) {
        ...
        b.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (tFile.getText() != null) fc.setSelectedFile(new File(tFile.getText()));
                String lext = LibraryFrame.FILE_EXTENSION;
                ExtensionFilter filter = new ExtensionFilter("JSynthLib Library Files (*" + lext + ")", new String[] { lext });
                fc.addChoosableFileFilter(filter);
                fc.setFileFilter(filter);
                fc.showDialog(PatchEdit.getInstance(), "Choose Default Library File");
        ...
        b.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (tLib.getText() != null) fc.setSelectedFile(new File(tLib.getText()));
                fc.showDialog(PatchEdit.getInstance(), "Choose Default Patch Library Directory");
                if (fc.getSelectedFile() != null) {
        ...
        b.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                CompatibleFileDialog fc = new CompatibleFileDialog();
                fc.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
                if (tSyx.getText() != null) fc.setSelectedFile(new File(tSyx.getText()));
                fc.showDialog(PatchEdit.getInstance(), "Choose Default Sysex File Directory");
                if (fc.getSelectedFile() != null) {
