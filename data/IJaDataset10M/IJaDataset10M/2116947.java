 ...
 *
 */
public class AndroidInput extends GLSurfaceView implements TouchInput, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener, ScaleGestureDetector.OnScaleGestureListener {
    ...
    private final RingBuffer<TouchEvent> eventQueue = new RingBuffer<TouchEvent>(MAX_EVENTS);

    private final RingBuffer<TouchEvent> eventPoolUnConsumed = new RingBuffer<TouchEvent>(MAX_EVENTS);

    private final RingBuffer<TouchEvent> eventPool = new RingBuffer<TouchEvent>(MAX_EVENTS);

    private final HashMap<Integer, Vector2f> lastPositions = new HashMap<Integer, Vector2f>();
    ...
    private static final int[] ANDROID_TO_JME = { 0x0, 0x0, 0x0, KeyInput.KEY_HOME, KeyInput.KEY_ESCAPE, 0x0, 0x0, KeyInput.KEY_0, KeyInput.KEY_1, KeyInput.KEY_2, KeyInput.KEY_3, KeyInput.KEY_4, KeyInput.KEY_5, KeyInput.KEY_6, KeyInput.KEY_7, KeyInput.KEY_8, KeyInput.KEY_9, KeyInput.KEY_MULTIPLY, 0x0, KeyInput.KEY_UP, KeyInput.KEY_DOWN, KeyInput.KEY_LEFT, KeyInput.KEY_RIGHT, KeyInput.KEY_RETURN, 0x0, 0x0, KeyInput.KEY_POWER, 0x0, 0x0, KeyInput.KEY_A, KeyInput.KEY_B, KeyInput.KEY_C, KeyInput.KEY_D, KeyInput.KEY_E, KeyInput.KEY_F, KeyInput.KEY_G, KeyInput.KEY_H, KeyInput.KEY_I, KeyInput.KEY_J, KeyInput.KEY_K, KeyInput.KEY_L, KeyInput.KEY_M, KeyInput.KEY_N, KeyInput.KEY_O, KeyInput.KEY_P, KeyInput.KEY_Q, KeyInput.KEY_R, KeyInput.KEY_S, KeyInput.KEY_T, KeyInput.KEY_U, KeyInput.KEY_V, KeyInput.KEY_W, KeyInput.KEY_X, KeyInput.KEY_Y, KeyInput.KEY_Z, KeyInput.KEY_COMMA, KeyInput.KEY_PERIOD, KeyInput.KEY_LMENU, KeyInput.KEY_RMENU, KeyInput.KEY_LSHIFT, KeyInput.KEY_RSHIFT, KeyInput.KEY_TAB, KeyInput.KEY_SPACE, 0x0, 0x0, 0x0, KeyInput.KEY_RETURN, KeyInput.KEY_DELETE, KeyInput.KEY_GRAVE, KeyInput.KEY_MINUS, KeyInput.KEY_EQUALS, KeyInput.KEY_LBRACKET, KeyInput.KEY_RBRACKET, KeyInput.KEY_BACKSLASH, KeyInput.KEY_SEMICOLON, KeyInput.KEY_APOSTROPHE, KeyInput.KEY_SLASH, KeyInput.KEY_AT, KeyInput.KEY_NUMLOCK, 0x0, 0x0, KeyInput.KEY_ADD, KeyInput.KEY_LMETA, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 };
