...
public class MM6NewLodEntry extends LodEntry {
    ...
    protected static final int MM6_DATA_HEADER_LENGTH_UNCOMPRESSED = 0x00;

    protected static final int MM6_DATA_HEADER_LENGTH_COMPRESSED = 0x08;
    ...
    public MM6NewLodEntry(LodFile lodFile, long headerOffset) throws IOException {
    ...
    protected int getDataHeaderLength() {
        if (isCompressed()) return MM6_DATA_HEADER_LENGTH_COMPRESSED; else return MM6_DATA_HEADER_LENGTH_UNCOMPRESSED;
    }

    protected long getOffsetInDataHeaderFortDataContentCompressedLength() {
        if (isCompressed()) return MM6_DATA_CONTENT_COMPRESSED_SIZE__DATA_HEADER_OFFSET; else return -1;
    }

    protected long getOffsetInDataHeaderFortDataContentUncompressedLength() {
        if (isCompressed()) return MM6_DATA_CONTENT_UNCOMPRESSED_SIZE__DATA_HEADER_OFFSET; else return -1;
    }
