...
public class XSLTProcessor extends SimpleScriptable {
    ...
    private Object transform(final Node source) {
        try {
            ...
            final org.w3c.dom.Document containerDocument = DocumentBuilderFactory.newInstance().newDocumentBuilder().newDocument();
    ...
    public void jsxFunction_transform() {
        ...
        for (final DomNode child : ((Node) output_).<DomNode>getDomNodeOrDie().getChildren()) {
            if (child instanceof DomText) {
                ...
                final String serializedString = serializer.jsxFunction_serializeToString((Node) child.getScriptObject());
