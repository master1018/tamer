 ...
 */
public class XMLStreamReaderImpl implements XMLStreamReader, NamespaceContext {
    ...
    public int next() throws XMLStreamException {
        if (events.isEmpty()) throw new XMLStreamException("EOF");
    ...
    public int nextTag() throws XMLStreamException {
        ...
        do {
            ret = next();
        } while (ret != XMLStreamConstants.START_ELEMENT && ret != XMLStreamConstants.END_ELEMENT);
        return ret;
    }
    ...
    public Iterator getPrefixes(String namespaceURI) {
        ...
        for (Enumeration e = namespaces.getPrefixes(namespaceURI); e.hasMoreElements(); ) acc.add(e.nextElement());
        return acc.iterator();
    }
    ...
    public String getAttributeValue(String namespaceURI, String localName) {
        ...
        for (Iterator i = se.getAttributes(); i.hasNext(); ) {
            ...
            if (namespaceURI != null && !namespaceURI.equals(name.getNamespaceURI())) continue;
    ...
    public QName getAttributeQName(int index) {
        ...
        for (Iterator i = se.getAttributes(); i.hasNext(); ) {
            Attribute attr = (Attribute) i.next();
            if (index == count) return attr.getName();
            count++;
        }
        return null;
    }
    ...
    public String getAttributeValue(int index) {
        ...
        for (Iterator i = se.getAttributes(); i.hasNext(); ) {
            Attribute attr = (Attribute) i.next();
            if (index == count) return attr.getValue();
            count++;
        }
        return null;
    }
    ...
    public boolean isAttributeSpecified(int index) {
        ...
        for (Iterator i = se.getAttributes(); i.hasNext(); ) {
            Attribute attr = (Attribute) i.next();
            if (index == count) return attr.isSpecified();
            count++;
        }
        return false;
    }
    ...
    public String getNamespacePrefix(int index) {
        ...
        while (i.hasNext()) {
            ...
            if (index == count) return ns.getPrefix();
            count++;
        }
        return null;
    }
    ...
    public String getNamespaceURI(int index) {
        ...
        while (i.hasNext()) {
            Namespace ns = (Namespace) i.next();
            if (index == count) return ns.getNamespaceURI();
            count++;
        }
        return null;
    }
    ...
    public boolean hasText() {
        return eventType == CHARACTERS || eventType == DTD || eventType == SPACE || eventType == ENTITY_REFERENCE || eventType == COMMENT || eventType == DTD;
    }
   ...
   */
    class CallbackHandler implements ContentHandler, DTDHandler, LexicalHandler, DeclHandler, EntityResolver, ErrorHandler {
        ...
        public void setDocumentLocator(Locator locator) {
            ...
            location = new LocationImpl(-1, locator.getColumnNumber(), locator.getLineNumber(), locator.getSystemId());
        }

        public void startDocument() throws SAXException {
            String version = (locator instanceof Locator2) ? ((Locator2) locator).getXMLVersion() : null;
            String encoding = (locator instanceof Locator2) ? ((Locator2) locator).getEncoding() : null;
            boolean standalone = reader.getFeature("http://xml.org/sax/features/is-standalone");
            boolean standaloneDeclared = standalone;
            boolean encodingDeclared = (encoding != null);
            events.add(new StartDocumentImpl(location, location.getLocationURI(), encoding, version, standalone, standaloneDeclared, encodingDeclared));
        }
        ...
        public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
            ...
            StartElementImpl se = new StartElementImpl(location, name, attrs, ns, null);
            events.add(se);
            ...
            for (int i = 0; i < len; i++) {
                ...
                boolean specified = (atts instanceof Attributes2) && ((Attributes2) atts).isSpecified(i);
                ci = attQName.indexOf(':');
                ...
                if ("xmlns".equals(attPrefix) || "xmlns".equals(attQName)) continue;
                QName attrName = new QName(attURI, attLocalName, attPrefix);
                AttributeImpl attr = new AttributeImpl(location, attrName, value, type, specified);
                attrs.add(attr);
            }
        }
        ...
        public void characters(char[] ch, int start, int length) throws SAXException {
            ...
            events.add(new CharactersImpl(location, new String(ch, start, length), whitespace, inCDATA, false));
        }

        public void ignorableWhitespace(char[] ch, int start, int length) throws SAXException {
            boolean whitespace = isWhitespace(ch, start, length);
            events.add(new CharactersImpl(location, new String(ch, start, length), whitespace, inCDATA, true));
        }
        ...
        public void notationDecl(String name, String publicId, String systemId) throws SAXException {
            Object n = new NotationDeclarationImpl(location, name, publicId, systemId);
            notations.add(n);
        }

        public void unparsedEntityDecl(String name, String publicId, String systemId, String notationName) throws SAXException {
            Object e = new EntityDeclarationImpl(location, publicId, systemId, name, notationName, null, null);
            entities.add(e);
        }
        ...
        public void internalEntityDecl(String name, String value) throws SAXException {
            Object e = new EntityDeclarationImpl(location, null, null, name, null, value, null);
            entities.add(e);
        }

        public void externalEntityDecl(String name, String publicId, String systemId) throws SAXException {
            Object e = new EntityDeclarationImpl(location, publicId, systemId, name, null, null, null);
            entities.add(e);
        }
