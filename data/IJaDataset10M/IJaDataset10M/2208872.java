...
public final class MethodModel extends Model {
	 ...
	 */
    public MethodModel(ClassModel owner, Signature sig, ValueType returnType, Collection<MethodFlag> flags) {
        this.flags = flags;
        this.signature = sig;
    ...
    MethodModel(ClassModel owner, DataInput in, ConstantPool pool) throws IOException {
        this.owner = owner;
    ...
    public boolean isOverride() {
        for (ClassModel superclass = owner.superclass(); superclass != null; superclass = superclass.superclass()) {
