...
public abstract class StreamingPlaybackController {
    ...
    private final StreamingPlaybackListener streamingPlaybackListener = new StreamingPlaybackListener.Stub() {
        ...
        @Override
        public void onVolumeChanged(final int volume) throws RemoteException {
            StreamingPlaybackController.this.onVolumeChanged(volume);
        }
    ...
    private final ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(final ComponentName name, final IBinder service) {
            ...
            try {
                ...
                if (oldPlaying != playing || oldPaused != paused) {
                    onPlayingChanged();
                }
                StreamingPlaybackController.this.onServiceConnected();
            } catch (final RemoteException e) {
                if (DEBUG) {
                    Log.e(TAG, "Cannot call playback service", e);
                }
            }
        }
    ...
    protected void setPreparing(final boolean preparing) {
    ...
    protected Intent createPlayIntent() {
        return new Intent(context, getServiceClass()).setAction(StreamingPlaybackService.ACTION_PLAY);
    }

    /** @return intent to call 'stop' on the steaming service */
    protected Intent createStopIntent() {
        return new Intent(context, getServiceClass()).setAction(StreamingPlaybackService.ACTION_STOP);
    }
   ...
   */
    ...
    protected void onVolumeChanged(final int value) {
    }
    ...
    protected void onBind(final boolean result) {
    }
}
