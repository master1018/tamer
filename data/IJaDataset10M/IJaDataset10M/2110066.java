package welo.osgi.service.authn;
 ...
 * @version 1.0
 */
public class DBPrincipal implements Principal, java.io.Serializable {
	 ...
	 * 
	 */
    public DBPrincipal(String newName) {
        name = newName;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof DBPrincipal) {
            if (((DBPrincipal) o).getName().equals(name)) return true; else return false;
        } else return false;
    }
