...
public final class FastSymmlet8 implements FWT {
    ...
    static final float[] scale = { 0.0322231006040782f, -0.0126039672622638f, -0.0992195435769564f, 0.297857795605605f, 0.803738751805386f, 0.497618667632563f, -0.0296355276459604f, -0.0757657147893567f };
    ...
    public void transform(float[] v) {
        ...
        if (last != 8) System.err.println("Careful! this should be a power of 2 : " + v.length);
    }
