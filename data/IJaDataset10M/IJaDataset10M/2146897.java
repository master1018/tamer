 ...
 */
public class CrashOfFirstRemoteResourceWithXADatabaseAfterPrepareTestCase extends JBossCrashRecoveryTestCase {

    public CrashOfFirstRemoteResourceWithXADatabaseAfterPrepareTestCase(String name) throws java.io.IOException {
        super(name);
    }
