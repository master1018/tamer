...
public final class IDAStarGOAP {
	 ...
	 */
    private static CutoffAction depthFirst(WorldModel worldModel, Goal goal, TranspositionTable transpositionTable, Func1<WorldModel, Double> heuristic, int maxDepth, double cutoff) {
