package org.sepp.stm.security;

import iaik.utils.Base64Exception;
import iaik.utils.Util;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.sepp.stm.exceptions.SeppSecurityException;
...
public class AuthenticationData {
    ...
    public AuthenticationData(byte[] data) throws SeppSecurityException {
        log = LogFactory.getLog(this.getClass());
        parseAuthenticationData(Util.toASCIIString(data));
    }

    public AuthenticationData(String identity, byte[] randomNumber) throws SeppSecurityException {
        log = LogFactory.getLog(this.getClass());
        this.identity = identity;
        randomNumber1 = randomNumber;
    }

    public AuthenticationData(String identity, byte[] randomNumber1, byte[] randomNumber2) throws SeppSecurityException {
        log = LogFactory.getLog(this.getClass());
        this.identity = identity;
    ...
    public AuthenticationData(byte[] sessionKey, byte[] randomNumber1, byte[] randomNumber2) throws SeppSecurityException {
        log = LogFactory.getLog(this.getClass());
    ...
    private void parseAuthenticationData(String message) throws SeppSecurityException {
        ...
        try {
            ...
            throw new SeppSecurityException("Couldn't obtain random number from authentication data.");
        }
