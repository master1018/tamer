...
public class StringList implements List<String> {
    ...
    public StringList(Storage storage, boolean verifyType) throws TraCIException {
        if (verifyType) {
            if (storage.readByte() != Constants.TYPE_STRINGLIST) throw new TraCIException("string list expected");
        }
    ...
    public void writeTo(Storage out, boolean writeTypeID) {
        if (writeTypeID) out.writeByte(Constants.TYPE_STRINGLIST);
        out.writeInt(list.size());
        for (String str : list) out.writeStringASCII(str);
    }
