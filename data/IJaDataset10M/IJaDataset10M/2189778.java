...
public class ConceptBodyModuleDec extends ModuleDec {
    ...
    public ConceptBodyModuleDec(PosSymbol name, PosSymbol profileName, List<ModuleParameter> parameters, PosSymbol conceptName, List<PosSymbol> enhancementNames, List<UsesItem> usesItems, Exp requires, List<Exp> conventions, List<Exp> corrs, InitItem facilityInit, FinalItem facilityFinal, List<Dec> decs) {
        this.name = name;
