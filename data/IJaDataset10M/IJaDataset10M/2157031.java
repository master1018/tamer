...
public interface IExceptionHandler {
    ...
    abstract void processException(ValidationError validationError, Pattern pattern);
    ...
    abstract void initialize(SAXParseException ex, ResourceBundle resourceBundle, DOMParser parser, String ODFSectionString);
}
