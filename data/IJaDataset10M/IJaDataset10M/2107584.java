...
public class ScreenLogTest extends TestCase {
    ...
    private void doScreenLogTest(boolean includeHeartBeats) {
        ...
        sessionSettings.setBool(sessionID, ScreenLogFactory.SETTING_LOG_HEARTBEATS, includeHeartBeats);
    ...
    private void assertLoggedMessage(ByteArrayOutputStream data, long systemTime, String type, String content) {
        String expectedLogEntry = "<" + UtcTimestampConverter.convert(new Date(systemTime), false) + ", FIX.4.2:SENDER->TARGET, " + type + "> (" + content + ")" + System.getProperty("line.separator");
