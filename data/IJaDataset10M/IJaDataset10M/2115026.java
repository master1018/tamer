...
public class rescale_normal_enableType extends com.jmex.xml.xml.Node {

    public rescale_normal_enableType(rescale_normal_enableType node) {
        super(node);
    }

    public rescale_normal_enableType(org.w3c.dom.Node node) {
        super(node);
    }

    public rescale_normal_enableType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public rescale_normal_enableType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "rescale_normal_enable");
    }
    ...
    public bool getvalue2ValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new com.jmex.xml.xml.XmlException("Out of range"); else return new bool(getDomNodeValue(curNode));
    }
