...
public class DOInputCheckBox extends DOStaticList {
    ...
    public String getHtmlCode(DOIModel iModel) {
        ...
        if (property.getInputConfig() != null && !"".equals(property.getInputConfig())) {
            String configValue = property.getInputConfig().substring(0, property.getInputConfig().indexOf(","));
        ...
        if (property.getInputConfig() != null && property.getInputConfig().indexOf("@") != -1) {
            String configValue = property.getInputConfig().substring(0, property.getInputConfig().indexOf(","));
            String defaultCheck = property.getInputConfig().substring(property.getInputConfig().indexOf("@") + 1);
        ...
        if (property.getDoClickJs() != null && !"".equals(property.getDoClickJs().trim())) {
            buffer.append(" onclick='").append(property.getEscapeDOClickJs()).append("'");
        }
        buffer.append("/>");
