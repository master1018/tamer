...
Performing or initiating organization */
    public void setAD_OrgTrx_ID(int AD_OrgTrx_ID) {
        if (AD_OrgTrx_ID <= 0) set_Value("AD_OrgTrx_ID", null); else set_Value("AD_OrgTrx_ID", new Integer(AD_OrgTrx_ID));
    }
...
Business Activity */
    public void setC_Activity_ID(int C_Activity_ID) {
        if (C_Activity_ID <= 0) set_Value("C_Activity_ID", null); else set_Value("C_Activity_ID", new Integer(C_Activity_ID));
    }
...
Bank Account of the Business Partner */
    public void setC_BP_BankAccount_ID(int C_BP_BankAccount_ID) {
        if (C_BP_BankAccount_ID <= 0) set_Value("C_BP_BankAccount_ID", null); else set_Value("C_BP_BankAccount_ID", new Integer(C_BP_BankAccount_ID));
    }
...
Marketing Campaign */
    public void setC_Campaign_ID(int C_Campaign_ID) {
        if (C_Campaign_ID <= 0) set_Value("C_Campaign_ID", null); else set_Value("C_Campaign_ID", new Integer(C_Campaign_ID));
    }
...
Additional document charges */
    public void setC_Charge_ID(int C_Charge_ID) {
        if (C_Charge_ID <= 0) set_Value("C_Charge_ID", null); else set_Value("C_Charge_ID", new Integer(C_Charge_ID));
    }
...
Invoice Identifier */
    public void setC_Invoice_ID(int C_Invoice_ID) {
        if (C_Invoice_ID <= 0) set_Value("C_Invoice_ID", null); else set_Value("C_Invoice_ID", new Integer(C_Invoice_ID));
    }
...
Order */
    public void setC_Order_ID(int C_Order_ID) {
        if (C_Order_ID <= 0) set_Value("C_Order_ID", null); else set_Value("C_Order_ID", new Integer(C_Order_ID));
    }
...
Payment batch for EFT */
    public void setC_PaymentBatch_ID(int C_PaymentBatch_ID) {
        if (C_PaymentBatch_ID <= 0) set_Value("C_PaymentBatch_ID", null); else set_Value("C_PaymentBatch_ID", new Integer(C_PaymentBatch_ID));
    }
...
POS Journal */
    public void setC_POSJournal_ID(int C_POSJournal_ID) {
        if (C_POSJournal_ID <= 0) set_Value("C_POSJournal_ID", null); else set_Value("C_POSJournal_ID", new Integer(C_POSJournal_ID));
    }
...
Financial Project */
    public void setC_Project_ID(int C_Project_ID) {
        if (C_Project_ID <= 0) set_Value("C_Project_ID", null); else set_Value("C_Project_ID", new Integer(C_Project_ID));
    }
...
Credit Card (Visa, MC, AmEx) */
    public void setCreditCardType(String CreditCardType) {
        if (CreditCardType == null || CreditCardType.equals("D") || CreditCardType.equals("C") || CreditCardType.equals("P") || CreditCardType.equals("M") || CreditCardType.equals("V") || CreditCardType.equals("A") || CreditCardType.equals("N")) ; else throw new IllegalArgumentException("CreditCardType Invalid value - Reference = CREDITCARDTYPE_AD_Reference_ID - D - C - P - M - V - A - N");
...
The current status of the document */
    public void setDocStatus(String DocStatus) {
        if (DocStatus.equals("VO") || DocStatus.equals("NA") || DocStatus.equals("IP") || DocStatus.equals("CO") || DocStatus.equals("AP") || DocStatus.equals("CL") || DocStatus.equals("WC") || DocStatus.equals("WP") || DocStatus.equals("??") || DocStatus.equals("DR") || DocStatus.equals("IN") || DocStatus.equals("RE")) ; else throw new IllegalArgumentException("DocStatus Invalid value - Reference = DOCSTATUS_AD_Reference_ID - VO - NA - IP - CO - AP - CL - WC - WP - ?? - DR - IN - RE");
...
This is a sales transaction (receipt) */
    public void setIsReceipt(String IsReceipt) {
        if (IsReceipt.equals("N") || IsReceipt.equals("Y")) ; else throw new IllegalArgumentException("IsReceipt Invalid value - Reference = ISRECEIPT_AD_Reference_ID - N - Y");
...
This is a Sales Transaction */
    ...
    public void setM_BoletaDeposito_ID(int M_BoletaDeposito_ID) {
        if (M_BoletaDeposito_ID <= 0) set_Value("M_BoletaDeposito_ID", null); else set_Value("M_BoletaDeposito_ID", new Integer(M_BoletaDeposito_ID));
    }
...
Plan de Entidad Financiera */
    public void setM_EntidadFinancieraPlan_ID(int M_EntidadFinancieraPlan_ID) {
        if (M_EntidadFinancieraPlan_ID <= 0) set_Value("M_EntidadFinancieraPlan_ID", null); else set_Value("M_EntidadFinancieraPlan_ID", new Integer(M_EntidadFinancieraPlan_ID));
    }
...
This address has been verified */
    public void setR_AvsAddr(String R_AvsAddr) {
        if (R_AvsAddr == null || R_AvsAddr.equals("N") || R_AvsAddr.equals("X") || R_AvsAddr.equals("Y")) ; else throw new IllegalArgumentException("R_AvsAddr Invalid value - Reference = R_AVSADDR_AD_Reference_ID - N - X - Y");
...
The Zip Code has been verified */
    public void setR_AvsZip(String R_AvsZip) {
        if (R_AvsZip == null || R_AvsZip.equals("N") || R_AvsZip.equals("X") || R_AvsZip.equals("Y")) ; else throw new IllegalArgumentException("R_AvsZip Invalid value - Reference = R_AVSZIP_AD_Reference_ID - N - X - Y");
...
Credit Card Verification Code Match */
    ...
    public void setRef_Payment_ID(int Ref_Payment_ID) {
        if (Ref_Payment_ID <= 0) set_ValueNoCheck("Ref_Payment_ID", null); else set_ValueNoCheck("Ref_Payment_ID", new Integer(Ref_Payment_ID));
    }
...
Method of Payment */
    public void setTenderType(String TenderType) {
        if (TenderType.equals("K") || TenderType.equals("D") || TenderType.equals("A") || TenderType.equals("C") || TenderType.equals("CA")) ; else throw new IllegalArgumentException("TenderType Invalid value - Reference = TENDERTYPE_AD_Reference_ID - K - D - A - C - CA");
...
Type of credit card transaction */
    public void setTrxType(String TrxType) {
        if (TrxType.equals("S") || TrxType.equals("D") || TrxType.equals("C") || TrxType.equals("F") || TrxType.equals("A") || TrxType.equals("V")) ; else throw new IllegalArgumentException("TrxType Invalid value - Reference = TRXTYPE_AD_Reference_ID - S - D - C - F - A - V");
...
User defined element #1 */
    public void setUser1_ID(int User1_ID) {
        if (User1_ID <= 0) set_Value("User1_ID", null); else set_Value("User1_ID", new Integer(User1_ID));
    }
...
User defined element #2 */
    public void setUser2_ID(int User2_ID) {
        if (User2_ID <= 0) set_Value("User2_ID", null); else set_Value("User2_ID", new Integer(User2_ID));
    }
