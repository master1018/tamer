...
/**
 * Adapter for server implementation of DispHTMLPhraseElement
 */
public class DispHTMLPhraseElementServer extends IDispatchServer implements DispHTMLPhraseElement {

    public DispHTMLPhraseElementServer(CoClassMetaInfo classImpl) {
        super(classImpl);
        registerMethods(DispHTMLPhraseElement.class);
    }
    ...
    public void setCite(BStr param1) {
    }
    ...
    public void setDateTime(BStr param1) {
    }

    public BStr getDateTime() {
        throw new ComException(HResult.E_NOTIMPL);
    }
}
