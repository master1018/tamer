...
public class HaplotypeDisplayController extends JPanel {
    ...
    public HaplotypeDisplayController(HaplotypeDisplay parent) {
        ...
        hapPercentPanel.add(minDisplayField = new NumberTextField(String.valueOf(this.parent.theData.getHaplotypeDisplayThreshold() * 100), 5, true));
        ...
        thinPanel.add(minThinField = new NumberTextField(String.valueOf(parent.getThinThresh() * 100), 5, true));
        ...
        thickPanel.add(minThickField = new NumberTextField(String.valueOf(parent.getThickThresh() * 100), 5, true));
    ...
    public void setDisplayThresh(double amount) {
        if (this.parent.theData.getHaplotypeDisplayThreshold() != amount) {
            this.parent.theData.setHaplotypeDisplayThreshold(amount / 100);
            parent.adjustDisplay();
        }
    }

    public void setThinThresh(double amount) {
        parent.setThinThresh(amount / 100);
    }

    public void setThickThresh(double amount) {
        parent.setThickThresh(amount / 100);
    }
    ...
    public Dimension getMaximumSize() {
        return new Dimension(super.getPreferredSize().width, fieldSize.height * 3 + BETWEEN * 2);
    }
}
