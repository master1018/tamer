...
import org.pcomeziantou.volleylife.model.universe.AspectRatio;

/**
 * The environment attributes of a home.
 * @author Emmanuel Puybaret
 */
public class VolleyLifeEnvironment implements Serializable, Cloneable {
   ...
   */
    public enum Property {
        ...
        SKY_COLOR, SKY_TEXTURE, GROUND_COLOR, GROUND_TEXTURE, LIGHT_COLOR, CEILING_LIGHT_COLOR, WALLS_ALPHA, DRAWING_MODE, PHOTO_WIDTH, PHOTO_HEIGHT, PHOTO_ASPECT_RATIO, PHOTO_QUALITY, VIDEO_WIDTH, VIDEO_ASPECT_RATIO, VIDEO_QUALITY, VIDEO_FRAME_RATE, VIDEO_CAMERA_PATH
    }
   ...
   */
    public VolleyLifeEnvironment() {
        this(0xE0E0E0, null, (204 << 16) + (228 << 8) + 252, 0xD0D0D0, 0);
    }

    /**
   * Creates home environment from parameters.
   */
    public VolleyLifeEnvironment(int groundColor, HomeTexture groundTexture, int skyColor, int lightColor, float wallsAlpha) {
   ...
   * @since 2.2
   */
    public VolleyLifeEnvironment(int groundColor, HomeTexture groundTexture, int skyColor, HomeTexture skyTexture, int lightColor, float wallsAlpha) {
   ...
   */
    public void setGroundTexture(HomeTexture groundTexture) {
        if (groundTexture != this.groundTexture) {
            ...
            this.groundTexture = groundTexture;
            this.propertyChangeSupport.firePropertyChange(Property.GROUND_TEXTURE.name(), oldGroundTexture, groundTexture);
        }
    }
   ...
   */
    public void setPhotoAspectRatio(AspectRatio photoAspectRatio) {
        if (this.photoAspectRatio != photoAspectRatio) {
            ...
            this.propertyChangeSupport.firePropertyChange(Property.PHOTO_ASPECT_RATIO.name(), oldPhotoAspectRatio, photoAspectRatio);
        }
    }
   ...
   */
    public void setVideoAspectRatio(AspectRatio videoAspectRatio) {
        if (this.videoAspectRatio != videoAspectRatio) {
            ...
            this.propertyChangeSupport.firePropertyChange(Property.VIDEO_ASPECT_RATIO.name(), oldVideoAspectRatio, videoAspectRatio);
        }
    }
   ...
   */
    public void setVideoFrameRate(int videoFrameRate) {
        if (this.videoFrameRate != videoFrameRate) {
            ...
            this.propertyChangeSupport.firePropertyChange(Property.VIDEO_FRAME_RATE.name(), oldVideoFrameRate, videoFrameRate);
        }
    }
   ...
   */
    @Override
    public VolleyLifeEnvironment clone() {
        try {
            VolleyLifeEnvironment clone = (VolleyLifeEnvironment) super.clone();
