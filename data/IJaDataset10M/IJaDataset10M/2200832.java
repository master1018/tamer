...
public class Report extends Layout {
    ...
    public enum SPObjectOrder {
        ...
        PAGE(Page.class), SELECTOR(Selector.class, ComboBoxSelector.class, DateSelector.class, TextBoxSelector.class);
        ...
        public static SPObjectOrder getOrderBySimpleClassName(String name) {
            ...
            throw new IllegalArgumentException("The " + SPObject.class.getSimpleName() + " class \"" + name + "\" does not exist or is not a child type " + "of " + Report.class.getSimpleName() + ".");
        }
    }
