...
public class ShellJobManager extends AbstractJobManager {
    ...
    private static final int STATUS_POLL_FREQUENCY = 5 * 1000;
    ...
    private void runScript(String scriptType, String arg) throws JobManagerException {
        if (_type == null) {
            throw new JobManagerException(JobManagerException.ERROR_OPENING_JOBMANAGER_SCRIPT, "JobManager type was not set");
        }
        if (_libExecDir == null) {
            throw new JobManagerException(JobManagerException.ERROR_OPENING_JOBMANAGER_SCRIPT, "JobManager libexec directory was not set");
        }
        if (scriptType == null) {
            throw new JobManagerException(JobManagerException.ERROR_OPENING_JOBMANAGER_SCRIPT, "JobManager script name was not set");
        }
    ...
    private void runScript(String[] cmd) throws JobManagerException {
        String line = null;
        try {
            Process process = Runtime.getRuntime().exec(cmd, getEnvArray(), _directory);
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (line.startsWith(SCRIPT_JOB_ID)) {
                } else if (line.startsWith(SCRIPT_SUCCESS)) {
                    ...
                    return;
                } else if (line.startsWith(SCRIPT_ERROR)) {
    ...
    public void request(JobRequest request) throws JobManagerException {
        ...
        runScript("submit");
        if (_status == GRAMConstants.STATUS_ACTIVE || _status == GRAMConstants.STATUS_PENDING) {
