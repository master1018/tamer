...
public class DebugScriptApply extends ProfiledAnnotation {
   ...
   */
    public String getElement() {
        if (DebugScriptApply_Type.featOkTst && ((DebugScriptApply_Type) jcasType).casFeat_element == null) jcasType.jcas.throwFeatMissing("element", "de.uniwue.tm.textmarker.kernel.type.DebugScriptApply");
