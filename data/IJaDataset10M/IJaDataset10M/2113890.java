...
public class AlParserTest {
    ...
    public static final String[][] SOURCE_SEGMENT_ARRAY = { new String[] { "First sentence. ", "Second sentence." }, new String[] {}, new String[] {} };

    public static final String[][] TARGET_SEGMENT_ARRAY = { new String[] { "Pierwsze zdanie." }, new String[] { "Drugie zdanie." }, new String[] {} };
