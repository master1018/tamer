...
public class YouTubeWriteClient {
   ...
   */
    private static void printVideoEntry(VideoEntry entry) throws IOException, ServiceException {
   ...
   * @throws ServiceException If the service is unable to handle the request.
   */
    private static void printPlaylistEntry(String prefix, PlaylistLinkEntry playlistLinkEntry, boolean showPlaylistContents) throws IOException, ServiceException {
   ...
   * @throws ServiceException If the service is unable to handle the request.
   */
    private static void printPlaylist(Service service, String playlistUrl) throws IOException, ServiceException {
   ...
   */
    private static String readVideoID() throws IOException {
        System.out.println("Input a valid video ID or a watch URL (default: " + DEFAULT_VIDEO_ID + "):");
        String input = readLine();
        if (input.equals("")) {
   ...
   */
    private static void printUsage() {
        System.out.println("Usage: java YouTubeWriteClient.jar " + " --username <user@gmail.com> " + " --password <pass> " + " --key <developer key>");
    }
   ...
   * @throws ServiceException If the service is unable to handle the request.
   */
    private static void showPlaylists(YouTubeService service) throws IOException, ServiceException {
   ...
   * @throws ServiceException If the service is unable to handle the request.
   */
    private static void showFavorites(YouTubeService service) throws IOException, ServiceException {
        printVideoFeed(service, USER_FEED_PREFIX + DEFAULT_USER + FRIENDS_ACTIVITY_FEED_SUFFIX);
    }
   ...
   * @throws ServiceException If the service is unable to handle the request.
   */
    private static void showActivity(YouTubeService service) throws IOException, ServiceException {
   ...
   * @throws ServiceException If the service is unable to handle the request.
   */
    private static void showFriendsActivity(YouTubeService service) throws IOException, ServiceException {
        printActivityFeed(service, USER_FEED_PREFIX + DEFAULT_USER + FRIENDS_ACTIVITY_FEED_SUFFIX);
    }
   ...
   */
    private static void addComment(YouTubeService service) throws IOException {
        ...
        URL entryUrl = new URL("http://gdata.youtube.com/feeds/api/videos/" + videoID);
   ...
   */
    private static void addFavorite(YouTubeService service) throws IOException {
        ...
        URL feedUrl = new URL(USER_FEED_PREFIX + DEFAULT_USER + FAVORITES_FEED_SUFFIX);
        try {
   ...
   */
    private static void addPlaylistVideo(YouTubeService service, PlaylistLinkEntry entry) throws IOException {
   ...
   * @throws ServiceException If the service is unable to handle the request.
   */
    private static void printUploads(YouTubeService service) throws IOException, ServiceException {
        printVideoFeed(service, USER_FEED_PREFIX + DEFAULT_USER + UPLOADS_FEED_SUFFIX);
    }
   ...
   * @throws ServiceException If the service is unable to handle the request.
   */
    private static void printActivityFeed(YouTubeService service, String feedUrl) throws IOException, ServiceException {
        ...
        for (UserEventEntry entry : activityFeed.getEntries()) {
            ...
            if (entry.getUserEventType() == UserEventEntry.Type.VIDEO_UPLOADED) {
                ...
                System.out.println(user + " rated a video " + entry.getVideoId() + " " + entry.getRating().getValue() + " stars");
   ...
   * @throws ServiceException If the service is unable to handle the request.
   */
    private static void doPlaylistFeedOperation(YouTubeService service, PlaylistOperation op) throws IOException, ServiceException {
        ...
        if (op == PlaylistOperation.CREATE) {
            ...
            newEntry.setSummary(TextConstruct.create(TextConstruct.Type.TEXT, description, null));
            service.insert(new URL(feedUrl), newEntry);
            return;
        }
        PlaylistLinkFeed playlistLinkFeed = service.getFeed(new URL(feedUrl), PlaylistLinkFeed.class);
