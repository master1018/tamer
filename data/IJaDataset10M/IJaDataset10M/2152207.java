...
class UnixNativeDispatcher {
     ...
     */
    static void utimes(byte[] path, long times0, long times1) throws UnixException {
        NativeBuffer buffer = NativeBuffers.asNativeBuffer(path);
        try {
     ...
     */
    static void statvfs(byte[] path, UnixFileStoreAttributes attrs) throws UnixException {
        NativeBuffer buffer = NativeBuffers.asNativeBuffer(path);
        try {
