...
public class CompilationID_attribute extends Attribute {
    ...
    public CompilationID_attribute(ConstantPool constant_pool, int compilationID_index) throws ConstantPoolException {
    ...
    String getCompilationID(ConstantPool constant_pool) throws ConstantPoolException {
