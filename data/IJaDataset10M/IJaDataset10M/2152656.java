...
public class YadisTestServlet extends HttpServlet {
    ...
    public YadisTestServlet() throws ServletException {
        ...
        if (_testDataPath == null) throw new ServletException("YADIS_TEST_DATA path not initialized");
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (getHeadersFile != null) setHeadersFromFile(getHeadersFile, response); else if (headersFile != null) setHeadersFromFile(headersFile, response);
        if (xrdsFile != null) {
            BufferedInputStream input = new BufferedInputStream(new FileInputStream(_testDataPath + "/xrds/" + xrdsFile));
    ...
    private void setHeadersFromFile(String filename, HttpServletResponse response) throws IOException {
        BufferedReader input = new BufferedReader(new FileReader(_testDataPath + "/headers/" + filename));
        String line;
        while ((line = input.readLine()) != null) {
            ...
            if (equalPos > -1) {
                ...
                if (headerName.equals("status")) response.setStatus(Integer.parseInt(headerValue)); else {
