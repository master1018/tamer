        ...
        BattleTable.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    String curName = (String) battleSorter.getValueAt(BattleTable.rowAtPoint(e.getPoint()), 0);
    ...
    class BattlePopupListener extends MouseAdapter implements ActionListener {
        ...
        private void maybeShowPopup(MouseEvent e) {
            ...
            if (e.isPopupTrigger()) {
                ...
                String curName = (String) battleSorter.getValueAt(currRow, 0);
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            ...
            if (s.startsWith("RESTART|")) {
                ...
                if (result == JOptionPane.YES_OPTION) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",restart");
                ...
                if (result == JOptionPane.YES_OPTION) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",reset");
                ...
                if (result == JOptionPane.YES_OPTION) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",die");
                ...
                if (result == JOptionPane.YES_OPTION) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",start");
                ...
                if (result == JOptionPane.YES_OPTION) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",stop");
                ...
                if (result == JOptionPane.YES_OPTION) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",clearowners");
                ...
                if (result != null && result.length() > 1) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",owner " + result);
                ...
                if (result != null && result.length() > 1) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",port " + result);
                ...
                if (result != null && result.length() >= 1) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",savegamepurge " + result);
                ...
                if (result != null) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",loadgame " + result);
                ...
                if (result == JOptionPane.YES_OPTION) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",loadautosave");
                ...
                if (result != null && result.length() > 1) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",comment " + result);
                ...
                if (result != null && result.length() > 0) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",players " + result);
                ...
                if (result != null && result.length() >= 1) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",restartcount " + result);
                ...
                if (result != null && result.length() >= 1) mwclient.sendChat(MWClient.CAMPAIGN_PREFIX + "mail " + currName + ",setupdateurl " + result);
            }
        }
    }
    ...
    class BattlesModel extends AbstractTableModel {
        ...
        class Renderer extends DefaultTableCellRenderer {
            ...
            public java.awt.Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                String gameName = (String) battleSorter.getValueAt(row, 0);
                MMGame game = mwclient.getServers().get(gameName);
                if (game.getCurrentPlayers().size() >= game.getMaxPlayers()) c.setBackground(Color.red); else if (game.getStatus().equals("Open")) c.setBackground(Color.green); else if (game.getStatus().equals("Running")) c.setBackground(Color.yellow); else c.setBackground(getBackground());
                return c;
            }
        }
    }
