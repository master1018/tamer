 ...
 * @see com.xtreme.cis.model.Department
...
public class DepartmentHome {
    ...
    public Department findById(java.lang.String id) {
        ...
        try {
            Department instance = (Department) sessionFactory.getCurrentSession().get("com.xtreme.cis.model.Department", id);
            if (instance == null) {
    ...
    public List<Department> findByExample(Department instance) {
        ...
        try {
            List<Department> results = (List<Department>) sessionFactory.getCurrentSession().createCriteria("com.xtreme.cis.model.Department").add(create(instance)).list();
