...
import odm.ReflexiveObjectProperty;
 ...
 * <ul>
 *   <li>{@link odm.impl.ReflexiveObjectPropertyImpl#getObjectpropertyexpression <em>Objectpropertyexpression</em>}</li>
 *   <li>{@link odm.impl.ReflexiveObjectPropertyImpl#getTag <em>Tag</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReflexiveObjectPropertyImpl extends ObjectPropertyAxiomImpl implements ReflexiveObjectProperty {
    ...
    protected EClass eStaticClass() {
        return OdmPackage.Literals.REFLEXIVE_OBJECT_PROPERTY;
    }
    ...
    public ObjectProperty getObjectpropertyexpression() {
        if (objectpropertyexpression != null && objectpropertyexpression.eIsProxy()) {
            ...
            if (objectpropertyexpression != oldObjectpropertyexpression) {
                if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.RESOLVE, OdmPackage.REFLEXIVE_OBJECT_PROPERTY__OBJECTPROPERTYEXPRESSION, oldObjectpropertyexpression, objectpropertyexpression));
            }
        }
    ...
    public void setObjectpropertyexpression(ObjectProperty newObjectpropertyexpression) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, OdmPackage.REFLEXIVE_OBJECT_PROPERTY__OBJECTPROPERTYEXPRESSION, oldObjectpropertyexpression, objectpropertyexpression));
    }
    ...
    public void setTag(String newTag) {
        String oldTag = tag;
        tag = newTag;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, OdmPackage.REFLEXIVE_OBJECT_PROPERTY__TAG, oldTag, tag));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch(featureID) {
            case OdmPackage.REFLEXIVE_OBJECT_PROPERTY__OBJECTPROPERTYEXPRESSION:
                if (resolve) return getObjectpropertyexpression();
                return basicGetObjectpropertyexpression();
            case OdmPackage.REFLEXIVE_OBJECT_PROPERTY__TAG:
                return getTag();
        }
