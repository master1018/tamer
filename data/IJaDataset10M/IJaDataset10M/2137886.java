...
public class ChatRoomMemberYahooImpl implements ChatRoomMember {
    ...
    */
    public ChatRoomMemberYahooImpl(ChatRoomYahooImpl chatRoom, String nickName, String userAddress, ChatRoomMemberRole role) {
        ...
        if (contact != null) this.avatar = contact.getImage();
    }
