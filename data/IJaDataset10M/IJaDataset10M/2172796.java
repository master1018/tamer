...
public final class WebKeys {
    ...
    public static final String PERMISSION_INODE_EDIT = "com.dotmarketing.permissions.edit_permissions";

    public static final String PERMISSION_SHOW_APPLY_TO_SUBFOLDERS = "com.dotmarketing.permissions.apply_to_subfolders";

    public static final String PERMISSION_NOT_CHANGED = "PERMISSION_NOT_CHANGED";

    public static final String PERMISSION_IS_NEW = "PERMISSION_IS_NEW";

    public static final String PERMISSION_APPLY_PARENT = "applyParentPermissions";
    ...
    public static final String WYSIWYG_HTML_FORMAT = "com.dotmarketing.portlets.wysiwyg.html.format";

    public static final String WYSIWYG_DEFAULT_FORMAT = "com.dotmarketing.portlets.wysiwyg.default.format";

    public static final String WYSIWYG_PLAIN_TEXT_FORMAT = "com.dotmarketing.portlets.wysiwyg.plain_text.format";

    public static final String WYSIWYG_CLASSIC_FORMAT = "com.dotmarketing.portlets.wysiwyg.classic.format";

    public static final String WYSIWYG_EDIT_TEXT = "com.dotmarketing.portlets.wysiwyg.edit.text";
    ...
    public static final String CLICKSTREAM_URI_OVERRIDE = "com.dotmarketing.clickstream.override";
