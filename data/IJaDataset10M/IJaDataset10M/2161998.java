package org.jaffa.applications.mylife.admin.components.usermaintenance.ui;
 ...
 */
public class UserMaintenanceAction extends ActionBase {
    ...
    public FormKey do_Save_Clicked() {
        UserMaintenanceForm myForm = (UserMaintenanceForm) form;
        UserMaintenanceComponent comp = (UserMaintenanceComponent) myForm.getComponent();
    ...
    public FormKey do_Cancel_Clicked() {
        return ((UserMaintenanceForm) form).getComponent().quitAndReturnToCallingScreen();
    }
}
