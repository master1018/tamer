...
public class MessageQuery {
    ...
    private static class ResultImpl implements Result {
        ...
        public ResultImpl(Message theMessage, String[] theLoopPoints, Map<String, Integer> theLoopPointNames, String[] theFieldPaths, Map<String, Integer> theFieldNames, String[] theWherePaths, String[] theWherePatterns, boolean[] theExactMatchFlags) {
            ...
            if (theLoopPoints.length == 0) {
                myNonLoopingQuery = true;
            } else {
                myIndices[myIndices.length - 1] = -1;
            }
        }
        ...
        private String[] composeLoopPoints() {
            ...
            for (int i = 0; i < myLoopPoints.length; i++) {
                ...
                if (ref >= i) {
                    throw new IllegalStateException("Loop point must be defined after the " + "one it references: " + myLoopPoints[i]);
                } else if (ref >= 0) {
        ...
        public String get(int theFieldNumber) {
            if (theFieldNumber < 0 || theFieldNumber >= myValues.length) {
                throw new IllegalArgumentException("Field number must be between 0 and " + (myValues.length - 1));
            }
