...
/**
 * Adapter for server implementation of HTMLMarqueeElementEvents
 */
public class HTMLMarqueeElementEventsServer extends IDispatchServer implements HTMLMarqueeElementEvents {

    public HTMLMarqueeElementEventsServer(CoClassMetaInfo classImpl) {
        super(classImpl);
        registerMethods(HTMLMarqueeElementEvents.class);
    }
