...
public class TestFileLog extends TestCase {
    ...
    public void testLog() throws Exception {
        ...
        SessionID sessionID = new SessionID("FIX.4.2", "SENDER" + System.currentTimeMillis(), "TARGET" + System.currentTimeMillis());
        ...
        String formattedTime = FieldValueConverter.UtcTimestampConverter.convert(new Date(systemTime), false);
