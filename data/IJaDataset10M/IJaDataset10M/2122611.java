...
public class TLSSocketSupport {
    ...
    public java.net.Socket getSecureClientSocket() throws Exception {
        ...
        KeyManager[] keyManagers = TLSSocketSupport.createKeyManagers(keyStoreFileName, keyStorePassword, null);
    ...
    private static KeyManager[] createKeyManagers(String keyStoreFileName, String keyStorePassword, String alias) throws CertificateException, IOException, KeyStoreException, NoSuchAlgorithmException, UnrecoverableKeyException {
        ...
        KeyManager[] managers;
        if (alias != null) {
            managers = new KeyManager[] { new TLSSocketSupport().new AliasKeyManager(keyStore, alias, keyStorePassword) };
        } else {
