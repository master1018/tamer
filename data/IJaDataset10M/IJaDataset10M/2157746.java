...
public class IrFactoryImpl extends EFactoryImpl implements IrFactory {
    ...
    public InstLoad createInstLoad(int lineNumber, Var target, Var source, List<Expression> indexes) {
        return createInstLoad(lineNumber, IrFactory.eINSTANCE.createDef(target), IrFactory.eINSTANCE.createUse(source), indexes);
    }
    ...
    @Override
    public InstStore createInstStore(int lineNumber, Def target, List<Expression> indexes, Expression value) {
        InstStoreImpl instStore = new InstStoreImpl();
    ...
    @Override
    public InstStore createInstStore(int lineNumber, Var target, List<Expression> indexes, Expression value) {
    ...
    @Override
    public Var createVar(int lineNumber, Type type, String name, boolean global, boolean assignable) {
        VarImpl var = new VarImpl();
