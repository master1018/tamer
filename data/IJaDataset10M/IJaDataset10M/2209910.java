...
public class point_smooth_enableType extends homura.hde.util.xml.xml.Node {

    public point_smooth_enableType(point_smooth_enableType node) {
        super(node);
    }

    public point_smooth_enableType(org.w3c.dom.Node node) {
        super(node);
    }

    public point_smooth_enableType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public point_smooth_enableType(homura.hde.util.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "point_smooth_enable");
    }
