...
public class ATNAAuditEventHelper {
    ...
    private static final Logger logger = Logger.getLogger(ATNAAuditEventHelper.class);
     ...
     * @return
     */
    public static ATNAAuditEventPatientIdentityFeed getATNAAuditEventPatientIdentityFeed(ATNAAuditEvent.ActorType actorType, HL7V3Message message, boolean updateMode, List<SubjectIdentifier> subjectIdentifiers) {
     ...
     * @return
     */
    public static ATNAAuditEventPatientRecord getATNAAuditEventPatientRecord(ATNAAuditEvent.ActorType actorType, Subject subject, String targetEndpoint, String messageId) {
     ...
     * @return
     */
    public static ATNAAuditEventQuery getATNAAuditEventPDQQueryProvider(ATNAAuditEvent.ActorType actorType, PRPA_IN201305UV02_Message request, SubjectSearchResponse subjectSearchResponse, String homeCommunityId) {
        ATNAAuditEventQuery auditEvent = ATNAAuditEventHelper.getAuditEventQueryProvider(actorType, request, subjectSearchResponse, homeCommunityId);
     ...
     * @return
     */
    public static ATNAAuditEventQuery getATNAAuditEventPDQQueryInitiator(ATNAAuditEvent.ActorType actorType, PRPA_IN201305UV02_Message request, String homeCommunityId, String targetEndpoint) {
        ATNAAuditEventQuery auditEvent = ATNAAuditEventHelper.getAuditEventQueryInitiator(actorType, request, homeCommunityId, targetEndpoint);
        auditEvent.setTransaction(IHETransaction.ITI47);
        return auditEvent;
    }
     ...
     * @return
     */
    public static ATNAAuditEventQuery getATNAAuditEventPIXQueryProvider(ATNAAuditEvent.ActorType actorType, PRPA_IN201309UV02_Message request, SubjectSearchResponse subjectSearchResponse, String homeCommunityId) {
        ATNAAuditEventQuery auditEvent = ATNAAuditEventHelper.getAuditEventQueryProvider(actorType, request, subjectSearchResponse, homeCommunityId);
     ...
     * @return
     */
    public static ATNAAuditEventQuery getATNAAuditEventPIXQueryInitiator(ATNAAuditEvent.ActorType actorType, PRPA_IN201309UV02_Message request, String homeCommunityId, String targetEndpoint) {
        ATNAAuditEventQuery auditEvent = ATNAAuditEventHelper.getAuditEventQueryInitiator(actorType, request, homeCommunityId, targetEndpoint);
        auditEvent.setTransaction(IHETransaction.ITI45);
        return auditEvent;
    }
     ...
     * @return
     */
    private static ATNAAuditEventQuery getAuditEventQueryProvider(ATNAAuditEvent.ActorType actorType, HL7V3Message request, SubjectSearchResponse subjectSearchResponse, String homeCommunityId) {
     ...
     * @return
     */
    private static ATNAAuditEventQuery getAuditEventQueryInitiator(ATNAAuditEvent.ActorType actorType, HL7V3Message request, String homeCommunityId, String targetEndpoint) {
        ATNAAuditEventQuery auditEvent = new ATNAAuditEventQuery();
     ...
     * @return
     */
    private static String getPatientId(List<SubjectIdentifier> subjectIdentifiers) {
