...
public class VectorTest extends junit.framework.TestCase {
    ...
    public void test_copyInto$Ljava_lang_Object() {
        ...
        tVector.copyInto(a);
        for (int i = 0; i < 100; i++) assertTrue("copyInto failed", a[i] == tVector.elementAt(i));
    }
    ...
    public void test_lastIndexOfLjava_lang_ObjectI() {
        ...
        tVector.setElementAt(null, 40);
        tVector.setElementAt(null, 60);
        assertTrue("Incorrect lastIndexOf returned for null: " + tVector.lastIndexOf(null, 15), tVector.lastIndexOf(null, 15) == -1);
        assertTrue("Incorrect lastIndexOf returned for null: " + tVector.lastIndexOf(null, 45), tVector.lastIndexOf(null, 45) == 40);
    ...
    public void test_subListII() {
        ...
        for (int i = 10; i < 25; i++) assertTrue("Returned incorrect sublist", sl.contains(tVector.get(i)));
