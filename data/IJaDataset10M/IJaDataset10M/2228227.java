    ...
    private void initComponents() {
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String elem = (String) JOptionPane.showInputDialog(addButton, "Type device name to be added", "Input", JOptionPane.INFORMATION_MESSAGE, SwingResource.bigIconMap.get(IImageResource.IMG_ADD), null, null);
                if (elem != null && elem.length() > 0) {
                    String[] parts = elem.split("/");
                    if (parts.length != 3) {
                        JOptionPane.showMessageDialog(addButton, "Device name has to fulfil the pattern x...x/x...x/x...x ");
                        return;
                    }
        ...
        editButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String elem = (String) JOptionPane.showInputDialog(null, "Type device name to be added", "Input", JOptionPane.INFORMATION_MESSAGE, SwingResource.bigIconMap.get(IImageResource.IMG_EDIT), null, selection);
                if (elem != null && elem.length() > 0) {
                    String[] parts = elem.split("/");
                    if (parts.length != 3) {
                        JOptionPane.showMessageDialog(addButton, "Device name has to fulfil the pattern x...x/x...x/x...x ");
