    ...
    */
    ...
    private JPanel getOutlinePanel() {
        if (outlinePanel == null) {
            ...
            outlinePanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEtchedBorder(), BorderFactory.createEmptyBorder(8, 8, 8, 8)));
    ...
    private JLabel getLogo() {
        if (logo == null) {
            logo = new JLabel("<html><div align=\"center\">" + getWrappedPanel().getInfoString() + "</div></html>", getWrappedPanel().getIcon(), JLabel.CENTER);
