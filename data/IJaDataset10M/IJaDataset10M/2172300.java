...
public class DemoToggleButtonPanel extends JPanel {
    ...
    public class FlatStyleButtonPanel extends JPanel {
    ...
    public class AlloyStyleButtonPanel extends JPanel {
    ...
    public class EclipseStyleButtonPanel extends JPanel {
    ...
    public class BorlandStyleButtonPanel extends JPanel {
    ...
    public class NimbusStyleButtonPanel extends JPanel {
    ...
    public class ColorStyleButtonPanel extends JPanel {
    ...
    public class StyleButtonPanel extends JPanel {
