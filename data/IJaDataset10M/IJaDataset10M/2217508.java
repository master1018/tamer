...
public class ClassImpl implements IClass {
    ...
    private transient List<Object> m_instances = new ArrayList<Object>();
    ...
    public ClassImpl(Class cls, Object instance, Map<Class, IClass> classes, XmlTest xmlTest, IAnnotationFinder annotationFinder, IObjectFactory objectFactory) {
        m_class = cls;
        m_classes = classes;
        m_xmlTest = xmlTest;
    ...
    private Object getDefaultInstance() {
        if (m_defaultInstance == null) {
            m_defaultInstance = m_instance != null ? m_instance : ClassHelper.createInstance(m_class, m_classes, m_xmlTest, m_annotationFinder, m_objectFactory);
        }
    ...
    public Object[] getInstances(boolean create) {
        ...
        if (m_xmlTest.isJUnit()) {
            if (create) {
                result = new Object[] { ClassHelper.createInstance(m_class, m_classes, m_xmlTest, m_annotationFinder, m_objectFactory) };
            }
        } else {
