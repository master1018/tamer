...
public class GenerationalTSP extends AbstractTSP {
    ...
    static {
        ...
        PARAMETERS.add(new PrimitiveParameter("Selection type", "Selection model - states whether individuals are chosen or eliminated for the next generation", ParameterTypes.STRING, sel_types));
        ...
        PARAMETERS.add(new PrimitiveParameter("Expected cost", "Expected permutation cost. Once a solution with a cost less than the specified is found, the algorithm " + "will stop. If no expected cost is known, this may be set to 0.0.", ParameterTypes.REAL, positiveReal));
    ...
    public String getDescription() {
        return "Implementation of the generational genetic algorithm for the Travelling salesman problem. " + "Given the list of cities and their mutual distances, finds the optimal round-trip in terms of total " + "distance. The algorithm can use elimination or generational selection. " + "It offers a wide choice of crossover and mutation operators.";
    }
    ...
    public Map<String, IValue> runAlgorithm(Map<String, IValue> values, IInfoListener listener) {
        ...
        try {
            ...
            retval.put(RETURN_VALUES.get(3).getName(), new Value((lowestcost <= expectedcost) ? 1.0 : 0.0, RETURN_VALUES.get(3)));
