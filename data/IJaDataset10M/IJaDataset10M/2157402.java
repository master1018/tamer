...
public final class Geometry {
	 ...
	 *         points on same side.
	 */
    private static int sameSide(final double x0, final double y0, final double x1, final double y1, final double px0, final double py0, final double px1, final double py1) {
        int sameSide = 0;
        final double dx = x1 - x0;
        final double dy = y1 - y0;
	 ...
	 */
    public static boolean isLineIntersectingLine(final int x0, final int y0, final int x1, final int y1, final int x2, final int y2, final int x3, final int y3) {
	 ...
	 */
    public static boolean isLineIntersectingRectangle(final int lx0, final int ly0, final int lx1, final int ly1, final int x0, final int y0, final int x1, final int y1) {
	 ...
	 */
    public static void findPolygonExtent(final double[] x, final double[] y, final double[] z, final double[] xExtent, final double[] yExtent, final double[] zExtent) {
	 ...
	 */
    public static void findPolygonExtent(final int[] x, final int[] y, final int[] xExtent, final int[] yExtent) {
	 ...
	 *         set)
	 */
    public static int findLineSegmentIntersection(final double x0, final double y0, final double x1, final double y1, final double x2, final double y2, final double x3, final double y3, final double[] intersection) {
	 ...
	 */
    public static double[] findLinePolygonIntersections(final double[] x, final double[] y, final double x0, final double y0, final double x1, final double y1) {
        double x2, y2, x3, y3;
        final int nPoints = x.length;
	 ...
	 */
    public static int[] createArrow(final int x0, final int y0, final int x1, final int y1, final double length, final double angle, final double inset) {
        final int[] x = { x0, x1 };
        final int[] y = { y0, y1 };
