...
public class TypePropertyTest extends AbstractPropertyDescriptorTester {
    ...
    protected PropertyDescriptor createProperty(boolean multiValue) {
        return multiValue ? new TypeMultiProperty("testType", "Test type property", javaLangClasses, new String[] { "java.lang" }, 1.0f) : new TypeProperty("testType", "Test type property", javaLangClasses[0], new String[] { "java.lang" }, 1.0f);
    }
    ...
    protected PropertyDescriptor createBadProperty(boolean multiValue) {
        return multiValue ? new TypeMultiProperty("testType", "Test type property", new Class[] { Set.class }, new String[] { "java.lang" }, 1.0f) : new TypeProperty("testType", "Test type property", javaLangClasses[0], new String[] { "java.util" }, 1.0f);
    }
