 ...
 */
public class PresenceStatusMenu extends StatusSelectorMenu {
            ...
            if (e.getSource() instanceof JMenuItem) {
                ...
                while (statusSet.hasNext()) {
                    ...
                    if (status.getStatusName().equals(menuItem.getText())) {
                        if (protocolProvider.getRegistrationState() == RegistrationState.REGISTERED && !presence.getPresenceStatus().equals(status)) {
                            if (status.isOnline()) {
        ...
        public void run() {
            try {
                ...
                if (e1.getErrorCode() == OperationFailedException.GENERAL_ERROR) {
                    String msgText = GuiActivator.getResources().getI18NString("service.gui.STATUS_CHANGE_GENERAL_ERROR");
                    ...
                    String msgText = GuiActivator.getResources().getI18NString("service.gui.STATUS_CHANGE_NETWORK_FAILURE");
