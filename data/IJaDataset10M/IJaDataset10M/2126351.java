...
public class MD_SpatialRepresentationTypeCode_PropertyType extends org.mitre.caasd.aixm.xml.TypeBase {

    public static org.mitre.caasd.aixm.xml.meta.ComplexType getStaticInfo() {
        return new org.mitre.caasd.aixm.xml.meta.ComplexType(org.mitre.caasd.aixm.FPP_SIAP_Data_TypeInfo.binder.getTypes()[org.mitre.caasd.aixm.FPP_SIAP_Data_TypeInfo._altova_ti_gmd_altova_MD_SpatialRepresentationTypeCode_PropertyType]);
    }

    public MD_SpatialRepresentationTypeCode_PropertyType(org.w3c.dom.Node init) {
        super(init);
        instantiateMembers();
    }

    private void instantiateMembers() {
        nilReason = new MemberAttribute_nilReason(this, org.mitre.caasd.aixm.FPP_SIAP_Data_TypeInfo.binder.getMembers()[org.mitre.caasd.aixm.FPP_SIAP_Data_TypeInfo._altova_mi_gmd_altova_MD_SpatialRepresentationTypeCode_PropertyType._nilReason]);
        MD_SpatialRepresentationTypeCode = new MemberElement_MD_SpatialRepresentationTypeCode(this, org.mitre.caasd.aixm.FPP_SIAP_Data_TypeInfo.binder.getMembers()[org.mitre.caasd.aixm.FPP_SIAP_Data_TypeInfo._altova_mi_gmd_altova_MD_SpatialRepresentationTypeCode_PropertyType._MD_SpatialRepresentationTypeCode]);
    }
    ...
    public MemberElement_MD_SpatialRepresentationTypeCode MD_SpatialRepresentationTypeCode;

    public static class MemberElement_MD_SpatialRepresentationTypeCode {

        public static class MemberElement_MD_SpatialRepresentationTypeCode_Iterator implements java.util.Iterator {

            private org.w3c.dom.Node nextNode;

            private MemberElement_MD_SpatialRepresentationTypeCode member;

            public MemberElement_MD_SpatialRepresentationTypeCode_Iterator(MemberElement_MD_SpatialRepresentationTypeCode member) {
                this.member = member;
        ...
        public MemberElement_MD_SpatialRepresentationTypeCode(org.mitre.caasd.aixm.xml.TypeBase owner, org.mitre.caasd.aixm.typeinfo.MemberInfo info) {
            this.owner = owner;
            this.info = info;
        }
        ...
        public java.util.Iterator iterator() {
            return new MemberElement_MD_SpatialRepresentationTypeCode_Iterator(this);
        }
    ...
    public void setXsiType() {
        org.mitre.caasd.aixm.xml.XmlTreeOperations.setAttribute(getNode(), "http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "http://www.isotc211.org/2005/gmd", "MD_SpatialRepresentationTypeCode_PropertyType");
    }
}
