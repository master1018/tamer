...
/**
 * Represents Java interface for COM interface DispHTMLHeaderElement.
 */
public interface DispHTMLHeaderElement extends IDispatch {

    public static final String INTERFACE_IDENTIFIER = "{3050F515-98B5-11CF-BB82-00AA00BDCE0B}";
    ...
    static final int DISPID_setClear = -2147413096;

    static final int DISPID_getClear = -2147413096;

    static final int DISPID_setAlign = -2147418040;

    static final int DISPID_getAlign = -2147418040;
    ...
    void setClear(BStr param1);

    BStr getClear();

    void setAlign(BStr param1);
