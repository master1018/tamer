 ...
 */
public abstract class XMLWriter1_0_Base extends XMLWriterBase implements XMLNames1_0 {
     ...
     * @throws SAXException
     */
    private void createMetaDataListEntryElement(String name, Object value) throws SAXException {
        if (name == null) {
     ...
     * @throws SAXException
     */
    private void createObjectMetaDataListEntryElement(String name, String id, Object value) throws SAXException {
        if (name == null) {
            throw new NullPointerException("name == null");
        }
        if (id == null) {
     ...
     * @throws SAXException
     */
    private void createCoverageElement(String coverableItemId, Long value) throws SAXException {
     ...
     * @throws SAXException
     */
    private void createTestSessionElement(TestSession testSession) throws SAXException {
        if (testSession == null) {
     ...
     * @throws SAXException
     */
    private void createHierarchyLevelElement(HierarchyLevel level) throws SAXException {
        if (level == null) {
        ...
        atts.put(HIERARCHY_LEVEL_TYPE_ID, this.hierarchyLevelTypeIdMap.get(level.getType()));
     ...
     * @throws SAXException
     */
    private void createLocationListElement(String name, LocationList locationList) throws SAXException {
        if (name == null) {
            throw new NullPointerException("name == null");
        }
     ...
     * @throws SAXException
     */
    private void createLocationElement(String name, Location location) throws SAXException {
        if (name == null) {
            throw new NullPointerException("name == null");
        }
        if (location == null) {
     ...
     * @throws SAXException
     */
    private void createHierarchyLevelTypeElement(HierarchyLevelType type, String id) throws SAXException {
        if (type == null) {
     ...
     * @throws SAXException
     */
    private void createStatementSequenceElement(StatementSequence statementSequence) throws SAXException {
        ...
        createLocationListElement(ELEMENT_LOCATION_LIST, statementSequence.getLocation());
     ...
     * @throws SAXException
     */
    private void createStatementElement(Statement statement) throws SAXException {
        if (statement == null) {
        ...
        atts.put(COVERABLE_ITEM_PREFIX, statement.getCoverableItem().getPrefix());
        String elementName = null;
        if (statement instanceof BasicStatement) {
            elementName = createBasicStatementElement((BasicStatement) statement, atts);
        } else if (statement instanceof ComplexStatement) {
            elementName = createComplexStatementElement((ComplexStatement) statement, atts);
        }
        createLocationListElement(ELEMENT_LOCATION_LIST, statement.getLocation());
     ...
     * @throws SAXException
     */
    private String createComplexStatementElement(ComplexStatement complexStatement, Map<String, String> atts) throws SAXException {
        ...
        if (complexStatement instanceof LoopingStatement) {
            elementName = createLoopingStatementElement((LoopingStatement) complexStatement, atts);
        } else if (complexStatement instanceof ConditionalStatement) {
            elementName = createConditionalStatementElement((ConditionalStatement) complexStatement, atts);
        } else if (complexStatement instanceof SynchronizedStatement) {
            elementName = createSynchronizedStatementElement((SynchronizedStatement) complexStatement, atts);
        }
     ...
     * @throws SAXException
     */
    private String createConditionalStatementElement(ConditionalStatement conditionalStatement, Map<String, String> atts) throws SAXException {
     ...
     * @throws SAXException
     */
    private String createSynchronizedStatementElement(SynchronizedStatement synchronizedStatement, Map<String, String> atts) throws SAXException {
     ...
     * @throws SAXException
     */
    private String createLoopingStatementElement(LoopingStatement loopingStatement, Map<String, String> atts) throws SAXException {
        if (loopingStatement == null) {
            throw new NullPointerException("loopingStatement == null");
        }
        atts.put(MULTIPLE_EXECUTED_ID, loopingStatement.getMultipleExecutedItem().getId());
        atts.put(MULTIPLE_EXECUTED_PREFIX, loopingStatement.getMultipleExecutedItem().getPrefix());
        atts.put(NEVER_EXECUTED_ID, loopingStatement.getNeverExecutedItem().getId());
        atts.put(NEVER_EXECUTED_PREFIX, loopingStatement.getNeverExecutedItem().getPrefix());
        atts.put(ONCE_EXECUTED_ID, loopingStatement.getOnceExecutedItem().getId());
        atts.put(ONCE_EXECUTED_PREFIX, loopingStatement.getOnceExecutedItem().getPrefix());
        atts.put(OPTIONAL_BODY_EXECUTION, Boolean.toString(loopingStatement.isOptionalBodyExecution()));
     ...
     * @throws SAXException
     */
    private String createBasicStatementElement(BasicStatement basicStatement, Map<String, String> atts) throws SAXException {
     ...
     * @throws SAXException
     */
    private void createBooleanTermElement(BooleanTerm booleanTerm) throws SAXException {
        if (booleanTerm == null) {
        ...
        if (booleanTerm instanceof BasicBooleanTerm) {
            elementName = createBasicBooleanTermElement((BasicBooleanTerm) booleanTerm, atts);
        } else if (booleanTerm instanceof OperatorTerm) {
            elementName = createOperatorTermElement((OperatorTerm) booleanTerm, atts);
        }
        createLocationListElement(ELEMENT_LOCATION_LIST, booleanTerm.getLocation());
        endElement(elementName);
    }
     ...
     * @throws SAXException
     */
    private String createOperatorTermElement(OperatorTerm operatorTerm, Map<String, String> atts) throws SAXException {
        if (operatorTerm == null) {
            throw new NullPointerException("operatorTerm == null");
        }
        atts.put(BOOLEAN_OPERATOR_ID, this.operatorIdMap.get(operatorTerm.getOperator()));
     ...
     * @throws SAXException
     */
    private void createBooleanOperatorElement(BooleanOperator booleanOperator, String id) throws SAXException {
        ...
        createBooleanAssignmentBooleanMapListElement(ELEMENT_BOOLEAN_ASSIGNMENT_BOOLEAN_MAP_LIST, booleanOperator.getPossibleAssignments().entrySet());
     ...
     * @throws SAXException
     */
    private void createBooleanAssignmentStringMapListEntryElement(BooleanAssignment booleanAssignment, String value) throws SAXException {
        ...
        final String encodedBooleanAssignment = TSCXMLHelper.encodeBooleanAssignment(booleanAssignment, getLogger());
        Map<String, String> atts = getNewAttributes();
     ...
     * @throws SAXException
     */
    private String createBasicBooleanTermElement(BasicBooleanTerm basicBooleanTerm, Map<String, String> atts) throws SAXException {
     ...
     * @throws SAXException
     */
    private void createQuestionMarkOperatorElement(QuestionMarkOperator qmo) throws SAXException {
        if (qmo == null) {
        ...
        atts.put(COVERABLE_ITEM_PREFIX, qmo.getCoverableItem().getPrefix());
        startElement(ELEMENT_QUESTIONMARKOPERATOR, atts);
        createLocationListElement(ELEMENT_LOCATION_LIST, qmo.getLocation());
     ...
     * @throws SAXException
     */
    private void createQuestionMarkOperatorExpression(QuestionMarkOperatorExpression qmoe) throws SAXException {
        if (qmoe == null) {
        ...
        atts.put(COVERABLE_ITEM_PREFIX, qmoe.getCoverableItem().getPrefix());
        startElement(ELEMENT_QUESTIONMARKOPERATOR_EXPRESSION, atts);
        createLocationListElement(ELEMENT_LOCATION_LIST, qmoe.getLocation());
     ...
     * @throws SAXException
     */
    protected void createTestSessionContainerElement(TestSessionContainer testSessionContainer) throws SAXException {
        ...
        tscAttributes.put(DATE, Long.toString(testSessionContainer.getDate().getTime()));
        tscAttributes.put(TEST_SESSION_CONTAINER_ID, testSessionContainer.getId());
        ...
        createBooleanOperatorListElement(getAllBooleanOperators(testSessionContainer.getCode()));
        createHierarchyLevelTypeListElement(getAllHierarchyLevelTypes(testSessionContainer.getCode()));
     ...
     * @throws SAXException
     */
    private void createCriteriaListEntryElement(Criterion criterion) throws SAXException {
        if (criterion == null) {
     ...
     * @throws SAXException
     */
    private void createSourceFileElement(SourceFile sourceFile, String id) throws SAXException {
        if (sourceFile == null) {
    ...
    protected abstract void startElement(String elementName, Map<String, String> attributes) throws SAXException;
