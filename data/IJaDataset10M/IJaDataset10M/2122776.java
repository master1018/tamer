package org.vrspace.log4j.chainsaw;
...
public class MyTableModel extends AbstractTableModel {
    ...
    public static final Comparator MY_COMP = new Comparator() {
    ...
    public static final String[] COL_NAMES = { "Time", "Priority", "Trace", "Category", "NDC", "Message" };

    /** definition of an empty list **/
    public static final EventDetails[] EMPTY_LIST = new EventDetails[] {};

    /** used to format dates **/
    public static final DateFormat DATE_FORMATTER = DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.MEDIUM);
    ...
    public EventDetails[] mFilteredEvents = EMPTY_LIST;
    ...
    public Priority mPriorityFilter = Priority.DEBUG;
