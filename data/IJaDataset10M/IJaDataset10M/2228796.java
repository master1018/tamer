 ...
 */
@Purpose(htmlDescriptionKey = "com.ardor3d.example.canvas.JoglSwtExample", thumbnailPath = "com/ardor3d/example/media/thumbnails/canvas_JoglSwtExample.jpg", maxHeapMemory = 64)
public class JoglSwtExample {
    ...
    public static void main(final String[] args) {
        ...
        try {
            final SimpleResourceLocator srl = new SimpleResourceLocator(ResourceLocatorTool.getClassPathResource(JoglSwtExample.class, "com/ardor3d/example/media/"));
    ...
    private static void addNewCanvas(final TabFolder tabFolder, final ExampleScene scene, final FrameHandler frameWork, final LogicalLayer logicalLayer) {
        i++;
        ...
        logicalLayer.registerTrigger(new InputTrigger(new KeyPressedCondition(Key.G), new TriggerAction() {
            ...
            public void perform(final Canvas source, final TwoInputStates inputStates, final double tpf) {
                ...
                mouseManager.setGrabbed(mouseManager.getGrabbed() == GrabbedState.NOT_GRABBED ? GrabbedState.GRABBED : GrabbedState.NOT_GRABBED);
            }
        }));
    ...
    private static MouseCursor createMouseCursor(final AWTImageLoader awtImageLoader, final String resourceName) throws IOException {
        final com.ardor3d.image.Image image = awtImageLoader.load(ResourceLocatorTool.getClassPathResourceAsStream(JoglSwtExample.class, resourceName), false);
