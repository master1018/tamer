...
public class SeriesFormat implements Cloneable {
    ...
    private static class ItemShapeFactory {
        ...
        public static Shape createCrosshairs() {
            ...
            int[] xPoints = new int[] { (int) Math.ceil(x - pointSize / 6.0d), (int) Math.ceil(x + pointSize / 6.0d), (int) Math.ceil(x + pointSize / 6.0d), (int) Math.ceil(x + pointSize / 2.0d), (int) Math.ceil(x + pointSize / 2.0d), (int) Math.ceil(x + pointSize / 6.0d), (int) Math.ceil(x + pointSize / 6.0d), (int) Math.ceil(x - pointSize / 6.0d), (int) Math.ceil(x - pointSize / 6.0d), (int) Math.ceil(x - pointSize / 2.0d), (int) Math.ceil(x - pointSize / 2.0d), (int) Math.ceil(x - pointSize / 6.0d) };
            int[] yPoints = new int[] { (int) Math.ceil(y - pointSize / 2.0d), (int) Math.ceil(y - pointSize / 2.0d), (int) Math.ceil(y - pointSize / 6.0d), (int) Math.ceil(y - pointSize / 6.0d), (int) Math.ceil(y + pointSize / 6.0d), (int) Math.ceil(y + pointSize / 6.0d), (int) Math.ceil(y + pointSize / 2.0d), (int) Math.ceil(y + pointSize / 2.0d), (int) Math.ceil(y + pointSize / 6.0d), (int) Math.ceil(y + pointSize / 6.0d), (int) Math.ceil(y - pointSize / 6.0d), (int) Math.ceil(y - pointSize / 6.0d) };
            return new Polygon(xPoints, yPoints, xPoints.length);
        }
    ...
    public enum ItemShape {
        ...
        NONE(null, I18N.getGUILabel("plotter.dotstyle.NONE.label")), CIRCLE(ItemShapeFactory.createCircle(), I18N.getGUILabel("plotter.dotstyle.CIRCLE.label")), SQUARE(ItemShapeFactory.createSquare(), I18N.getGUILabel("plotter.dotstyle.SQUARE.label")), DIAMOND(ItemShapeFactory.createDiamond(), I18N.getGUILabel("plotter.dotstyle.DIAMOND.label")), TRIANGLE(ItemShapeFactory.createTriangular(), I18N.getGUILabel("plotter.dotstyle.TRIANGLE.label")), TRIANGLE_UPSIDE_DOWN(ItemShapeFactory.createTurnedTriangular(), I18N.getGUILabel("plotter.dotstyle.TRIANGLE_UPSIDE_DOWN.label")), STAR(ItemShapeFactory.createStar(), I18N.getGUILabel("plotter.dotstyle.STAR.label")), HOURGLASS(ItemShapeFactory.createHourglass(), I18N.getGUILabel("plotter.dotstyle.HOURGLASS.label")), CROSSHAIRS(ItemShapeFactory.createCrosshairs(), I18N.getGUILabel("plotter.dotstyle.CROSSHAIRS.label"));
    ...
    public enum IndicatorType {
        ...
        NONE(I18N.getGUILabel("plotter.error_indicator.NONE.label")), BARS(I18N.getGUILabel("plotter.error_indicator.BARS.label")), BAND(I18N.getGUILabel("plotter.error_indicator.BAND.label")), DIFFERENCE(I18N.getGUILabel("plotter.error_indicator.DIFFERENCE.label"));
    ...
    public enum FillStyle {
        ...
        NONE(I18N.getGUILabel("plotter.fillstyle.NONE.label")), SOLID(I18N.getGUILabel("plotter.fillstyle.SOLID.label")), CROSS_HATCHED(I18N.getGUILabel("plotter.fillstyle.CROSS_HATCHED.label")), RISING_HATCHED(I18N.getGUILabel("plotter.fillstyle.RISING_HATCHED.label")), FALLING_HATCHED(I18N.getGUILabel("plotter.fillstyle.FALLING_HATCHED.label")), VERTICALLY_HATCHED(I18N.getGUILabel("plotter.fillstyle.VERTICALLY_HATCHED.label")), HORIZONTALLY_HATCHED(I18N.getGUILabel("plotter.fillstyle.HORIZONTALLY_HATCHED.label"));
    ...
    public enum VisualizationType {
        ...
        LINES_AND_SHAPES(I18N.getGUILabel("plotter.series_type.lines_and_shapes")), BARS(I18N.getGUILabel("plotter.series_type.bars")), AREA(I18N.getGUILabel("plotter.series_type.area"));
    ...
    public enum StackingMode {
        ...
        NONE(I18N.getGUILabel("plotter.stacking_mode.none")), ABSOLUTE(I18N.getGUILabel("plotter.stacking_mode.absolute")), RELATIVE(I18N.getGUILabel("plotter.stacking_mode.percentage"));
