...
public class ExternalProgramsPanel extends AbstractPanel {
    ...
    public void toXML(final StringBuilder builder, final ConfigVerification errors) {
        ...
        if (sevenzip) {
            ...
            if (sevenzip) {
                ...
                if (cmd.length() == 0) {
                    errors.add(new ConfigItem(ConfigItemTypes.ERROR, ConfigErrorKeys.PATH_NOT_SET, "The path to the 7Zip executable" + " is missing."));
                }
