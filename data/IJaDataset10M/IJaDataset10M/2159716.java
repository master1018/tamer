...
public class FontExtra implements Extra {
    ...
    void popupFontDialog() {
        ...
        sizes.setSelectedIndex(Integer.parseInt(ConfigurationManager.getConfiguration().getString(Settings.CONZILLA_FONT_SIZE, "10")) - 7);
        final JDialog d = new JDialog((Frame) null, ConzillaResourceManager.getDefaultManager().getString(FontExtra.class.getName(), "SELECT_FONT"), true);
        JPanel cp = new JPanel();
        cp.setBorder(new EmptyBorder(20, 20, 20, 20));
        cp.setLayout(new BorderLayout());
        JLabel fs = new JLabel(ConzillaResourceManager.getDefaultManager().getString(FontExtra.class.getName(), "FONT_SIZE") + ": ");
        JLabel ex1 = new JLabel(ConzillaResourceManager.getDefaultManager().getString(FontExtra.class.getName(), "EXAMPLE_BUTTON") + ": ");
        JLabel ex2 = new JLabel(ConzillaResourceManager.getDefaultManager().getString(FontExtra.class.getName(), "EXAMPLE_TEXT") + ": ");
        JLabel warning = new JLabel(ConzillaResourceManager.getDefaultManager().getString(FontExtra.class.getName(), "WARNING"));
