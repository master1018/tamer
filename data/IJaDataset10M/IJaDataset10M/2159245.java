...
public class ConfigurationFailure {
    ...
    public void beforeTestClassFails() {
        ...
        testng.setVerbose(0);
        testng.run();
        assertTrue(ClassWithFailedBeforeTestClassVerification.success(), "Not all the @Configuration methods of Run2 were run");
    }
    ...
    public void beforeTestSuiteFails() {
        ...
        testng.setVerbose(0);
        testng.run();
        assertTrue(ClassWithFailedBeforeSuiteVerification.success(), "No @Configuration methods should have run");
    }
