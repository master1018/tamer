...
public class ProxyPSSSyncPrimitiveInputReturn extends TestCase implements IONMtest {
    ...
    public ProxyPSSSyncPrimitiveInputReturn() {
    ...
    private void sendMessageToOtherPss(PSSAdvertisement pssAd) {
        ...
        ServiceMessage message = new ServiceMessage("Proxy Service", "org.personalsmartspace.rms050.onm.ISyncService", targetID, istargetOtherPSS, "sendMessageReturnPrimitiveInput", isAsync, new Object[] { new double[] { 456.65 } }, new String[] { "java.lang.Double" });
        logger.info("Message ready: " + message + " : " + double.class.getName());
        try {
