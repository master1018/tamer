...
public class DataTypes_004 extends LiveConnectTest {
     ...
     */
    public void getJSVarWithEval(String rightExpr, String className, String value) {
        ...
        try {
            ...
            System.err.println("setJSVarWithEval threw " + e.toString() + " with arguments ( " + rightExpr + ", " + expectedClass.getName() + ", " + value.toString());
            e.printStackTrace();
            exception = e.toString();
            result = new Object();
        }
        try {
            addTestCase("global.eval( \"var " + varName + " = " + rightExpr + "); " + "result = global.eval( " + varName + "); " + "(result == null)", "true", (result == null) + "", exception);
        } catch (Exception e) {
            file.exception = e.toString();
        }
    }

    public void getJSVarWithGetMember(String rightExpr, String className, String value) {
        String varName = "jsVar";
        Object result;
        Class expectedClass = null;
        try {
            ...
            System.err.println("setJSVarWithGetMember threw " + e.toString() + " with arguments ( " + rightExpr + ", " + expectedClass.getName() + ", " + value.toString());
            e.printStackTrace();
            exception = e.toString();
            result = new Object();
        }
        try {
            addTestCase("global.eval( \"var " + varName + " = " + rightExpr + "); " + "result = global.getMember( " + varName + "); " + "(result == null)", "true", (result == null) + "", exception);
        } catch (Exception e) {
            file.exception = e.toString();
        }
    }
