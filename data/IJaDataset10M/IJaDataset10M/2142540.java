...
public class NumberSpectrumJChartAdapter implements ISpectrumListener, ChartDataManageable, ChartDataModel, ChartDataManager {
    ...
    public void spectrumChange(NumberSpectrumEvent evt) {
        ...
        if (ad == null) {
            ...
            yaxis = ad;
            xaxis = ChartDataSourceUtil.generateSingleXSeries(yaxis.length)[0];
    ...
    public void setModel(INumberSpectrum inumberspectrum) {
        if (model != null) model.removeSpectrumListener(this);
