...
/**
 * This is a default implementation of the IFC object IfcElectricalCircuit<br><br>
 * 
 ...
 **/
public class IfcElectricalCircuit extends IfcSystem implements IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcGloballyUniqueId", "IfcOwnerHistory", "IfcLabel", "IfcText", "IfcLabel" };
    ...
    public Object clone() {
        ...
        if (this.GlobalId != null) ifcElectricalCircuit.setGlobalId((IfcGloballyUniqueId) this.GlobalId.clone());
        if (this.OwnerHistory != null) ifcElectricalCircuit.setOwnerHistory((IfcOwnerHistory) this.OwnerHistory.clone());
        if (this.Name != null) ifcElectricalCircuit.setName((IfcLabel) this.Name.clone());
        if (this.Description != null) ifcElectricalCircuit.setDescription((IfcText) this.Description.clone());
        if (this.ObjectType != null) ifcElectricalCircuit.setObjectType((IfcLabel) this.ObjectType.clone());
    ...
    public Object shallowCopy() {
        IfcElectricalCircuit ifcElectricalCircuit = new IfcElectricalCircuit();
        if (this.GlobalId != null) ifcElectricalCircuit.setGlobalId(this.GlobalId);
        if (this.OwnerHistory != null) ifcElectricalCircuit.setOwnerHistory(this.OwnerHistory);
        if (this.Name != null) ifcElectricalCircuit.setName(this.Name);
        if (this.Description != null) ifcElectricalCircuit.setDescription(this.Description);
        if (this.ObjectType != null) ifcElectricalCircuit.setObjectType(this.ObjectType);
        return ifcElectricalCircuit;
    }
