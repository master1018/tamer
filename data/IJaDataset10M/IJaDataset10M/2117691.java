...
public class ClassInfo {
   ...
   */
    public static void isAncestorOf(String ancestor, String child) {
        try {
            ...
            if (classAncestor.isAssignableFrom(classChild)) System.out.println(T); else System.out.println(NIL);
        } catch (Exception ex) {
   ...
   */
    public static void getClassInfo(String className) {
        try {
            ...
            System.out.println("(error \"Trying to load " + className + " caused a Java exception: " + e + "\")");
        } catch (UnsatisfiedLinkError e) {
            System.out.println("(error \"Trying to load " + className + " caused a Java UnsatisfiedLinkError: " + e + "\")");
        } catch (LinkageError e) {
            System.out.println("(error \"Trying to load " + className + " caused a Java LinkageError: " + e + "\")");
        }
    }
   ...
   */
    ...
    static String className(Class c) {
        if (c.isArray()) return c.getComponentType().getName() + "[]"; else return c.getName();
    }
