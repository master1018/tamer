...
public class Budget extends ApplicationDataElementAdaptor {
    ...
    public void postDeserialize() throws ApplicationException {
        if (null == myStartOfDay) myStartOfDay = new TimeOfDay();
        if (null == myEndOfDay) myEndOfDay = new TimeOfDay();
    ...
    public static final SimpleDateFormat ourFormat = new SimpleDateFormat("HH:mm:ss.SSS");
