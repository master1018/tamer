...
public class KeyManagerFactory2Test extends TestCase {
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getInstance", args = { java.lang.String.class })
     ...
     * returns KeyManagerFactory object
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getInstance", args = { java.lang.String.class, java.lang.String.class })
     ...
     * returns KeyManagerFactory object
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getInstance", args = { java.lang.String.class, java.security.Provider.class })
