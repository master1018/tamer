...
public class MeasurementGroup extends AquisitionElement {
    ...
    class IntegrationTimeListener implements INumberScalarListener {
        ...
        public void numberScalarChange(NumberScalarEvent evt) {
            ...
            if (v == 0.0) integrationCountSpinner.setForeground(Color.LIGHT_GRAY); else integrationCountSpinner.setForeground(Color.WHITE);
    ...
    private void initComponents() {
        ...
        for (int i = 0; i < user_elems.length; i++) chns.add(user_elems[i]);
        timerCombo = new JComboBox(chns);
        monitorCombo = new JComboBox(chns);
        elementPanel.setLayout(new GridBagLayout());
        GridBagConstraints gbc = new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL, new Insets(4, 2, 4, 2), 0, 0);
        JLabel nameLabel = new JLabel(name);
        nameLabel.setHorizontalAlignment(SwingConstants.RIGHT);
        elementPanel.add(nameLabel, gbc);
        gbc = new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL, new Insets(4, 2, 4, 2), 0, 0);
        JLabel stateTextLabel = new JLabel(" State: ");
        elementPanel.add(stateTextLabel, gbc);
        gbc = new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(4, 2, 4, 2), 0, 0);
        elementPanel.add(stateLabel, gbc);
        JPanel channelPanel = new JPanel(new GridBagLayout());
        for (int i = 0; i < user_elems.length; i++) {
            gbc = new GridBagConstraints(0, i, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(4, 2, 4, 2), 0, 0);
            channelPanel.add(new JLabel(user_elems[i]), gbc);
            gbc = new GridBagConstraints(1, i, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(4, 2, 4, 2), 0, 0);
            JLabel valueTextLabel = new JLabel("value: ");
            channelPanel.add(valueTextLabel, gbc);
            gbc = new GridBagConstraints(2, i, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(4, 2, 4, 2), 0, 0);
            channelPanel.add(valueLabel[i], gbc);
        }
        gbc = new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0);
        elementPanel.add(channelPanel, gbc);
        gbc = new GridBagConstraints(4, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 2, 4, 2), 0, 0);
        elementPanel.add(startCommand, gbc);
        gbc = new GridBagConstraints(5, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 2, 4, 2), 0, 0);
        elementPanel.add(abortCommand, gbc);
        JPanel ctrlPanel = new JPanel(new GridBagLayout());
        gbc = new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 2, 4, 2), 0, 0);
        ctrlPanel.add(new JLabel("Integration Time:"), gbc);
        gbc = new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 2, 4, 2), 0, 0);
        ctrlPanel.add(integrationTimeSpinner, gbc);
        gbc = new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, new Insets(4, 2, 4, 2), 0, 0);
        ctrlPanel.add(applyIntegrationTime, gbc);
        gbc = new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 12, 4, 2), 0, 0);
        ctrlPanel.add(timerCombo, gbc);
        gbc = new GridBagConstraints(4, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, new Insets(4, 2, 4, 2), 0, 0);
        ctrlPanel.add(applyTimer, gbc);
        gbc = new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 2, 4, 2), 0, 0);
        ctrlPanel.add(new JLabel("Integration Count:"), gbc);
        gbc = new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 2, 4, 2), 0, 0);
        ctrlPanel.add(integrationCountSpinner, gbc);
        gbc = new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, new Insets(4, 2, 4, 2), 0, 0);
        ctrlPanel.add(applyIntegrationCount, gbc);
        gbc = new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 12, 4, 2), 0, 0);
        ctrlPanel.add(monitorCombo, gbc);
        gbc = new GridBagConstraints(4, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, new Insets(4, 2, 4, 2), 0, 0);
        ctrlPanel.add(applyMonitor, gbc);
        gbc = new GridBagConstraints(6, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(4, 2, 4, 2), 0, 0);
