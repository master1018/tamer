...
public class TerminationController {
    ...
    public String terminate(@RequestParam(required = true, value = "targetView") String targetView, @RequestParam(required = true, value = "command") String command) throws Exception {
