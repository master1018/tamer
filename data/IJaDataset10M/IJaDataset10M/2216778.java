...
public abstract class GeneratorStrategy {
    ...
    public final void generate(WrapperSourceWriter s, Entry entry, List<JvmMethod> overloads) {
    ...
    protected abstract void generateMethods(Entry entry, WrapperSourceWriter s, List<JvmMethod> overloads);
}
