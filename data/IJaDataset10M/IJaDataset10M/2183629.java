...
public class RangeOfValues implements CaseCondition {
    ...
    public RangeOfValues(ReturnsValue value, Object lower, Object higher, LineInfo line) throws ParsingException {
        ConstantAccess low = new ConstantAccess(lower, line);
        ConstantAccess hi = new ConstantAccess(higher, line);
        BinaryOperatorEvaluation greater_than_lower = BinaryOperatorEvaluation.generateOp(null, value, low, OperatorTypes.GREATEREQ, line);
        BinaryOperatorEvaluation less_than_higher = BinaryOperatorEvaluation.generateOp(null, value, hi, OperatorTypes.LESSEQ, line);
        this.line = line;
    }
