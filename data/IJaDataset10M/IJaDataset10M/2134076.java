...
public class Attribute extends AbstractCategorized implements IReference {
    ...
    public IValidator[] getValidators() {
        if (mIsRef) return mRefAttribute.mValidators; else return mValidators;
    }
    ...
    public String toString() {
        if (mRefAttribute != null) return mRefAttribute.toString();
        if (mQname == null) return "attribute"; else return mQname.toString();
    }
    ...
    public void resolveReference(ISchemaManager manager) {
        ...
        if (mIsRef) {
            ...
            if (qname == null) throw new SchemaError("Can't resolve qualified name:" + mRef);
            this.mQname = qname;
            mRefAttribute = manager.getAttribute(qname);
            if (mRefAttribute == null) throw new SchemaError("Unresolvable attribute ref:" + mRef);
        }
    }
    ...
    public void resolveQName(IQualifiedNameResolver resolver) {
        ...
        if (mIsRef) {
            ...
            if (mQname == null) throw new SchemaError("Can't resolve ref qualified name:" + mRef);
        }
    }
    ...
    public IType getAttributeType() {
        ...
        if (mType != null) qname = schema.getQualifiedName(mType);
