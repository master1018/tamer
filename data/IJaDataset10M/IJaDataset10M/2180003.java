                    ...
                    try {
                        ...
                        if (param != null && !param.equals("")) {
                            if (type.equals("java.lang.String")) {
                                ...
                                Date date = null;
                                if (param.indexOf(':') != (-1)) date = DateUtil.parseDateTime(param); else date = DateUtil.parseDate(param);
                                if (date != null) ms[i].invoke(bean, new Object[] { date }); else System.err.println("WARNING: date is null: " + param);
                            }
                        }
                    } catch (Exception e) {
