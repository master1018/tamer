...
public class MPI {
   ...
   */
    ...
    public static Status EMPTY_STATUS = new Status(MPI.ANY_SOURCE, MPI.ANY_TAG, 0, 0);
   ...
   */
    ...
    public static Group GROUP_EMPTY = new mpi.Group(new mpjdev.Group(new xdev.ProcessID[0], null, -1));
