...
public class RepJEMonitor extends JEMonitor {
    ...
    private static final MBeanOperationInfo OP_DUMP_REPSTATS_INFO = new MBeanOperationInfo(OP_DUMP_REPSTATS, "Dump environment's replicated stats.", statParams, "java.lang.String", MBeanOperationInfo.INFO);

    private static final MBeanOperationInfo OP_DUMP_STATE_INFO = new MBeanOperationInfo(OP_DUMP_STATE, "Dump replicated environment state, including current position in " + "replication stream and replication group database.", new MBeanParameterInfo[0], "java.lang.String", MBeanOperationInfo.INFO);
    ...
    public Object invoke(String actionName, Object[] params, String[] signature) throws MBeanException {
        ...
        try {
            if (actionName.equals(OP_DUMP_REPSTATS)) {
                ...
                return ((ReplicatedEnvironment) env).getRepStats(getStatsConfig(new Object[] { false, true })).getTips();
            } else if (actionName.equals(OP_DUMP_STATE)) {
                return RepInternal.getRepImpl((ReplicatedEnvironment) env).dumpState();
            }
