...
public class DhGroup1Sha1 extends SshKeyExchange {
    ...
    protected void onInit() throws IOException {
        messageStore.registerMessage(SshMsgKexDhInit.SSH_MSG_KEXDH_INIT, SshMsgKexDhInit.class);
        messageStore.registerMessage(SshMsgKexDhReply.SSH_MSG_KEXDH_REPLY, SshMsgKexDhReply.class);
        try {
