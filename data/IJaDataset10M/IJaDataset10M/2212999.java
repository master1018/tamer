...
public abstract class OPT_StaticFieldReader implements VM_SizeConstants {
   ...
   * @return the current value of the field
   */
    public static final long getLongStaticFieldValue(VM_Field field) throws NoSuchFieldException {
        if (VM.runningVM) {
            int slot = field.getOffset() >>> LOG_BYTES_IN_INT;
   ...
   * @return the current value of the field
   */
    public static final double getDoubleStaticFieldValue(VM_Field field) throws NoSuchFieldException {
        if (VM.runningVM) {
            int slot = field.getOffset() >>> LOG_BYTES_IN_INT;
   ...
   * @return the current value of the field
   */
    public static final Object getObjectStaticFieldValue(VM_Field field) throws NoSuchFieldException {
        if (VM.runningVM) {
            int slot = field.getOffset() >>> LOG_BYTES_IN_INT;
   ...
   */
    public static final boolean isStaticFieldNull(VM_Field field) throws NoSuchFieldException {
   ...
   */
    public static final VM_TypeReference getTypeFromStaticField(VM_Field field) throws NoSuchFieldException {
