...
public class MailSendProcessor extends AbstractProcessor {
    ...
    private boolean isAuthenticated() {
        return this.password != null && this.password.trim().length() != 0 && this.user != null && this.user.trim().length() != 0;
    }
    ...
    public void sendMail(String subject, String content, PrintStream debugStream, ProcessContext context) throws ApplicationException {
    ...
    public boolean equals(Object obj) {
        if (obj == null || (!(obj instanceof MailSendProcessor))) {
            ...
            return super.equals(other) && EqualsHelper.equals(this.password, other.password) && EqualsHelper.equals(this.user, other.user) && EqualsHelper.equals(this.smtpServer, other.smtpServer) && EqualsHelper.equals(this.recipients, other.recipients) && EqualsHelper.equals(this.smtps, other.smtps) && EqualsHelper.equals(this.title, other.title) && EqualsHelper.equals(this.intro, other.intro) && EqualsHelper.equals(this.from, other.from);
        }
    }
