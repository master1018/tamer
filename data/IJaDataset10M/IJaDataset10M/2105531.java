...
public class ExchForPhys extends FIXMLField {

    public static final String TAG = "411";
    public static final int DATA_TYPE = FIXDataConverter.BOOLEAN;
    public static final String ENUM_Yes = "Y";
    public static final String ENUM_No = "N";

    public static final String ENUM = "|Y|N";
	...
	public void setValue(String s) throws ModelException {
	    if ( s == null || s.indexOf('|') != -1 || ENUM.indexOf(s) == -1 )
	        throw new ModelException("Invalid value (" + s + ") for field ExchForPhys.");
        _Value = s;	        
	}
	...
	public void initValue(Object s) throws ModelException {
	    if ( _Value != null ) 
	        throw new ModelException("Value has already been initialized for field ExchForPhys.");
        setValue((String)s);	        
	}
	...
	public String toFIXML(String ident) {
	    ...
	    return ident + "<ExchForPhys FIXTag=\"411\" DataType=\"Boolean\">"
	            + _Value + "</ExchForPhys>";
