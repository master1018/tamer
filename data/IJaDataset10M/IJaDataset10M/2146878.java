...
public class DTNode {
    ...
    public boolean isTree(Set<DTNode> set) {
        for (DTNode n : children.values()) if (!n.isTree(set)) return false;
    ...
    public void addTopologicalOrder(List<DTNode> list, Set<Integer> seen) {
        ...
        seen.add(number);
        for (DTNode n : children.values()) n.addTopologicalOrder(list, seen);
        list.add(this);
    }
    ...
    public void addTopologicalOrder(List<DTNode> list) {
        for (DTNode n : children.values()) n.addTopologicalOrder(list);
        list.add(this);
    }
