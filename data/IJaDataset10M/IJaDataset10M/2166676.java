...
public class CODOVocabulary {
    ...
    public static final String[] ONTOLOGY_ANNOTATION_PROPERTIES = { CODOVocabulary.CODD_hasLogicalLanguage, CODOVocabulary.CODD_hasVersion, CODOVocabulary.CODD_imports, CODOVocabulary.CODD_isImportedBy, CODOVocabulary.CODD_isVersionOf, CODOVocabulary.CODD_relatedToOntology, CODOVocabulary.CODK_isReusedBy, CODOVocabulary.CODP_isIntendedOutputOf, CODOVocabulary.CODT_isInputDataFor, CODOVocabulary.CODT_isOutputDataFor, CODOVocabulary.CODW_isInvolvedInDesignOperationsBy, CODOVocabulary.DESCASIT_isDescribedBy, CODOVocabulary.INTEXT_expresses, CODOVocabulary.INTEXT_isAbout, CODOVocabulary.REPRESENTATION_hasRepresentationLanguage };
}
