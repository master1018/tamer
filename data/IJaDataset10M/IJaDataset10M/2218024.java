...
public class ParameterUpdateDialog extends AbstractDoneDialog {
    ...
    public ParameterUpdateDialog(AbstractDoneDialog parent, int transitionType) {
        ...
        getDoneButton().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                parameter.setVariable(getVariableWithName((String) sinkVariableComboBox.getSelectedItem()));
    ...
    private void setTitle() {
        if (parameter.getVariable() == null || parameter.getVariable().equals("")) {
            super.setTitle("Update " + DataVariable.scopeToString(outputType) + " Parameter");
        } else {
            super.setTitle("Update " + DataVariable.scopeToString(outputType) + " Parameter" + " \"" + parameter.getVariable().getName() + "\"");
        }
    }
    ...
    private JPanel getVariablePanel() {
        ...
        JLabel sourceVariableLabel = new JLabel(DataVariable.scopeToString(inputType).toLowerCase() + " variable:");
        ...
        gbc.anchor = GridBagConstraints.EAST;
        gbc.insets = new Insets(0, 0, 5, 5);
        JLabel sinkVariableLabel = new JLabel("populates " + DataVariable.scopeToString(outputType).toLowerCase() + " variable:");
    ...
    private JButton getNewInputVariableQueryElementButton() {
        ...
        inputVariableQueryElementButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                try {
                    xQueryEditor.getDocument().insertString(xQueryEditor.getCaretPosition(), XMLUtilities.getTagEnclosedEntireVariableXQuery(sourceVariableComboBox.getSelectedVariable()), null);
                } catch (Exception e) {
                    xQueryEditor.setText(xQueryEditor.getText() + XMLUtilities.getTagEnclosedEntireVariableXQuery(sourceVariableComboBox.getSelectedVariable()));
                }
    ...
    private JButton getNewInputVariableQueryContentButton() {
        ...
        inputVariableQueryContentButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                try {
                    xQueryEditor.getDocument().insertString(xQueryEditor.getCaretPosition(), XMLUtilities.getTagEnclosedVariableContentXQuery(sourceVariableComboBox.getSelectedVariable()), null);
                } catch (Exception e) {
                    xQueryEditor.setText(xQueryEditor.getText() + XMLUtilities.getTagEnclosedVariableContentXQuery(sourceVariableComboBox.getSelectedVariable()));
                }
                enableDoneButtonIfAppropriate();
            }
        });
    ...
    private JComboBox getSourceVariableComboBox() {
        sourceVariableComboBox = new DataVariableComboBox(transitionType == NET_TO_TASK ? DataVariableSet.VALID_USAGE_INPUT_FROM_NET : DataVariableSet.VALID_USAGE_OUTPUT_FROM_TASK);
        return sourceVariableComboBox;
    }

    private JComboBox getSinkVariableComboBox() {
        sinkVariableComboBox = new VariableParameterComboBox(transitionType == NET_TO_TASK ? DataVariableSet.VALID_USAGE_INPUT_TO_TASK : DataVariableSet.VALID_USAGE_OUTPUT_TO_NET);
        sinkVariableComboBox.addActionListener(new ActionListener() {

            public void actionPerformed(ActionEvent e) {
                xQueryEditorPanel.setSinkVariableName((String) sinkVariableComboBox.getSelectedItem());
            }
        });
    ...
    private void populateOutputVariableComboBox() {
        ...
        sinkVariableComboBox.setDetail(parameter, outputVariableScope);
        if (sinkVariableComboBox.getItemCount() > 0) {
            ...
            xQueryEditor.setTargetVariableName((String) sinkVariableComboBox.getSelectedItem());
    ...
    private boolean shouldDoneButtonBeEnabled() {
        return (!xQueryEditor.getText().equals("") && sinkVariableComboBox.isEnabled());
    }
    ...
    class XQueryEditorPanel extends JPanel {
        ...
        private void setContent() {
            setBorder(new CompoundBorder(new TitledBorder("XQuery"), new EmptyBorder(0, 5, 5, 5)));
