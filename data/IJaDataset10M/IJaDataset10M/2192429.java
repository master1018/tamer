package com.ubu.psg.gui;

import org.jdesktop.application.Action;

public class ProgramStructureGraphAboutBox extends javax.swing.JDialog {

    public ProgramStructureGraphAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.ubu.psg.gui.ProgramStructureGraph.class).getContext().getResourceMap(ProgramStructureGraphAboutBox.class);
        setTitle(resourceMap.getString("title"));
        setModal(true);
        setName("aboutBox");
        setResizable(false);
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.ubu.psg.gui.ProgramStructureGraph.class).getContext().getActionMap(ProgramStructureGraphAboutBox.class, this);
