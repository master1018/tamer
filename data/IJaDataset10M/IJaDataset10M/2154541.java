...
public abstract class BaseTurbineRolePeer extends BasePeer {
    ...
    protected static final String CLASSNAME_DEFAULT = "org.campware.cream.om.TurbineRole";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TurbineRole row2Object(Record row, int offset, Class cls) throws TorqueException {
        try {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void populateObject(Record row, int offset, TurbineRole obj) throws TorqueException {
        try {
    ...
    public static List doSelectVillageRecords(Criteria criteria) throws TorqueException {
        return BaseTurbineRolePeer.doSelectVillageRecords(criteria, (Connection) null);
    }
    ...
    public static List populateObjects(List records) throws TorqueException {
        ...
        for (int i = 0; i < records.size(); i++) {
            ...
            results.add(TurbineRolePeer.row2Object(row, 1, TurbineRolePeer.getOMClass()));
        }
        return results;
    }
    ...
    public static void doDelete(Criteria criteria) throws TorqueException {
        TurbineRolePeer.doDelete(criteria, (Connection) null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TurbineRole obj, Connection con) throws TorqueException {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TurbineRole obj, Connection con) throws TorqueException {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TurbineRole obj, Connection con) throws TorqueException {
    ...
    public static Criteria buildCriteria(TurbineRole obj) {
        ...
        if (!obj.isNew()) criteria.add(ROLE_ID, obj.getRoleId());
     ...
     */
    public static TurbineRole retrieveByPK(int pk) throws TorqueException, NoRowsException, TooManyRowsException {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TurbineRole retrieveByPK(int pk, Connection con) throws TorqueException, NoRowsException, TooManyRowsException {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TurbineRole retrieveByPK(ObjectKey pk) throws TorqueException, NoRowsException, TooManyRowsException {
        Connection db = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TurbineRole retrieveByPK(ObjectKey pk, Connection con) throws TorqueException, NoRowsException, TooManyRowsException {
