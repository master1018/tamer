 ...
 * TODO: Document me!
 * 
 * @version $Id: ClusterClassLoaderTest.java 1836 2011-08-11 10:09:05Z netmackan $
 */
public class ClusterClassLoaderTest extends ModulesTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        SignServerWSService signServerWSService = new SignServerWSService(new URL("https://localhost:" + getPublicHTTPSPort() + "/signserver/signserverws/signserverws?wsdl"), qname);
        signServerWS = signServerWSService.getSignServerWSPort();
    }

    public void testClusterClassLoader() throws Exception {
        assertSuccessfulExecution(new String[] { "module", "add", signserverhome + "/src/test/testcodev1.mar" });
        assertTrue(TestUtils.grepTempOut("Loading module TESTCODE with version 1"));
        assertTrue(TestUtils.grepTempOut("Module loaded successfully."));
        assertSuccessfulExecution(new String[] { "module", "add", signserverhome + "/src/test/testcodev2.mar" });
        assertTrue(TestUtils.grepTempOut("Loading module TESTCODE with version 2"));
        assertTrue(TestUtils.grepTempOut("Module loaded successfully."));
        assertSuccessfulExecution(new String[] { "reload", "8888" });
        assertTrue(TestUtils.grepTempOut("SignServer reloaded successfully"));
        assertSuccessfulExecution(new String[] { "reload", "8889" });
        assertTrue(TestUtils.grepTempOut("SignServer reloaded successfully"));
        assertSuccessfulExecution(new String[] { "reload", "8890" });
        assertTrue(TestUtils.grepTempOut("SignServer reloaded successfully"));
    ...
    public void testRemoveConfiguration() throws Exception {
        assertSuccessfulExecution(new String[] { "module", "remove", "testcode", "1" });
        ...
        assertSuccessfulExecution(new String[] { "module", "remove", "testcode", "2" });
        assertTrue(TestUtils.grepTempOut("Removing module TESTCODE version 2"));
        assertTrue(TestUtils.grepTempOut("Removal of module successful."));
        assertSuccessfulExecution(new String[] { "removeworker", "8888" });
        assertSuccessfulExecution(new String[] { "removeworker", "8889" });
        assertSuccessfulExecution(new String[] { "removeworker", "8890" });
        assertSuccessfulExecution(new String[] { "reload", "8888" });
        assertTrue(TestUtils.grepTempOut("SignServer reloaded successfully"));
        assertSuccessfulExecution(new String[] { "reload", "8889" });
        assertTrue(TestUtils.grepTempOut("SignServer reloaded successfully"));
