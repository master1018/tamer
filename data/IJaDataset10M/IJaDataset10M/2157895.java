...
public class HsqlTimerTest extends BaseTestCase {
    ...
    static class WriteAndSyncTask extends java.util.TimerTask {
        ...
        public float getAveragePeriod() {
            return (this.runs < 2) ? Float.NaN : (this.total / (float) (this.runs - 1));
        }
        ...
        public String toString() {
            return this.name + "[" + "runs: " + runs + ", " + "actual avg. period: " + getAveragePeriod() + "]";
        }
    }
    ...
    static class Stats {
        ...
        double getVariance() {
            ...
            return sample ? (n == 1) ? Double.NaN : (vk / (double) (n - 1)) : (vk / (double) (n));
        }
        ...
        double getStdDev() {
            ...
            return sample ? (n == 1) ? Double.NaN : (Math.sqrt(vk / (double) (n - 1))) : (Math.sqrt(vk / (double) (n)));
        }
    }
     ...
     */
    public static void test(final int taskCount, final double periodMultiplier, final long duration) {
        System.out.println();
        System.out.println("****************************************");
     ...
     */
    @SuppressWarnings("CallToThreadDumpStack")
    public static void testJavaUtilTimer(final int taskCount, final long period, final long duration) {
        System.out.println();
        System.out.println("****************************************");
    ...
    public static void testHsqlTimer(final int taskCount, final long period, final long duration) {
        System.out.println();
        System.out.println("****************************************");
