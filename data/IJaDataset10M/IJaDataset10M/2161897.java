...
public class TopicPopupPresenter implements Presenter {
    ...
    public TopicPopupPresenter(PersistentServiceAsync persistentService, SimpleEventBus eventBus, Display display, Topic topic) {
    ...
    public void bind() {
        this.display.getEditButton().addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                display.hide();
                eventBus.fireEvent(new TopicEditEvent(topic.getId()));
            }
        });
    ...
    private void deleteTopic(final Topic topic) {
        new RPCCall<Void>() {
            ...
            protected void callService(AsyncCallback<Void> cb) {
                persistentService.deleteTopic(topic, cb);
            }

            @Override
            public void onSuccess(Void result) {
                eventBus.fireEvent(new TopicDeleteEvent());
            }
            ...
            public void onFailure(Throwable caught) {
                if (caught instanceof booksandfilms.shared.exception.NotLoggedInException) {
                    ...
                    Window.alert("Cannot delete a Topic that has Books or Films");
                } else {
