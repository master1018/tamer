...
public class GridSortSample extends ShowcasePanel {
    ...
    private static final String DESCRIPTION = "Click on any column header to sort by that column. To reverse the sort direction, click on the same " + "column header, or the top-right corner of the grid.";
