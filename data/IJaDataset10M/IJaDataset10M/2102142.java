...
public class CorpusWordListAction extends org.exmaralda.coma.root.ComaAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            XPath xpath = XPath.newInstance("//Transcription[Description/Key[@Name='segmented']/text()='true']/NSLink");
            ...
            for (int pos = 0; pos < transcriptionList.size(); pos++) {
                ...
                String fullTranscriptionName = coma.getData().getOpenFile().getParentFile().getAbsolutePath() + System.getProperty("file.separator", "/") + nslink.getText();
                Document st = IOUtilities.readDocumentFromLocalFile(fullTranscriptionName);
            ...
            pbd.setTitle("Reading word list from " + coma.getData().getSelectedCorpusName());
            ...
            Thread openThread = new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        try {
                            javax.swing.SwingUtilities.invokeAndWait(doDisplayWordList);
                        } catch (Exception ex) {
                            ex.printStackTrace();
                        }
                    } catch (Exception ex) {
