...
public class HandshakeCompletedEventTest extends TestCase {
     ...
     */
    @TestTargetNew(level = TestLevel.SUFFICIENT, notes = "Exceptions for null/incorrect parameters are not provided", method = "HandshakeCompletedEvent", args = { javax.net.ssl.SSLSocket.class, javax.net.ssl.SSLSession.class })
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getPeerCertificateChain", args = {  })
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getPeerCertificates", args = {  })
     ...
     */
    @TestTargetNew(level = TestLevel.SUFFICIENT, notes = "", method = "getPeerPrincipal", args = {  })
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getSession", args = {  })
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getSocket", args = {  })
     ...
     */
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, notes = "", clazz = SSLSocket.class, method = "addHandshakeCompletedListener", args = { HandshakeCompletedListener.class }), @TestTargetNew(level = TestLevel.COMPLETE, notes = "", clazz = HandshakeCompletedListener.class, method = "handshakeCompleted", args = { HandshakeCompletedEvent.class }) })
