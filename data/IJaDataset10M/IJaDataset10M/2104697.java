...
public final class MulticastLimeSentQueryRepliesBytes extends AbstractMessageGraphPaneItem {
    ...
    public MulticastLimeSentQueryRepliesBytes(final String key) {
        ...
        registerStatistic(SentMessageStatBytes.MULTICAST_QUERY_REPLIES, GUIMediator.getStringResource("STATS_ALL_CLIENTS"));
        registerStatistic(LimeSentMessageStatBytes.MULTICAST_QUERY_REPLIES, GUIMediator.getStringResource("STATS_LIMEWIRE"));
    }
}
