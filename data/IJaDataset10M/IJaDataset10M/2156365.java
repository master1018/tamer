...
public interface TypeParameter extends ClassType {
    ...
    public static class EqualsImplementor {
        ...
        private static boolean checkSameBounds(TypeParameter tp1, TypeParameter tp2) {
            ...
            if (tp2s - tp1s < -1 || tp1s - tp2s > 1) return false;
            if (tp1s != tp2s) return false;
            ...
            if (!l1.contains("java.lang.Object")) l1.add("java.lang.Object");
            if (!l2.contains("java.lang.Object")) l2.add("java.lang.Object");
