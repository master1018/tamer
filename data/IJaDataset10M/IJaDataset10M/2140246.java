...
/**
 * This is a default implementation of the IFC object IfcCableCarrierFittingType<br><br>
 * 
 ...
 **/
public class IfcCableCarrierFittingType extends IfcFlowFittingType implements IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcGloballyUniqueId", "IfcOwnerHistory", "IfcLabel", "IfcText", "IfcLabel", "SET<IfcPropertySetDefinition>", "LIST<IfcRepresentationMap>", "IfcLabel", "IfcLabel", "IfcCableCarrierFittingTypeEnum" };
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("PredefinedType")) stepString = stepString.concat("*);"); else {
            if (this.PredefinedType != null) stepString = stepString.concat(((IfcRootInterface) this.PredefinedType).getStepParameter(IfcCableCarrierFittingTypeEnum.class.isInterface()) + ");"); else stepString = stepString.concat("$);");
        }
        return stepString;
    }
	 ...
	 * 
	 * @param PredefinedType value to set
	 *            /
	 **/
    ...
    public Object clone() {
        ...
        if (this.GlobalId != null) ifcCableCarrierFittingType.setGlobalId((IfcGloballyUniqueId) this.GlobalId.clone());
        if (this.OwnerHistory != null) ifcCableCarrierFittingType.setOwnerHistory((IfcOwnerHistory) this.OwnerHistory.clone());
        if (this.Name != null) ifcCableCarrierFittingType.setName((IfcLabel) this.Name.clone());
        if (this.Description != null) ifcCableCarrierFittingType.setDescription((IfcText) this.Description.clone());
        if (this.ApplicableOccurrence != null) ifcCableCarrierFittingType.setApplicableOccurrence((IfcLabel) this.ApplicableOccurrence.clone());
        if (this.HasPropertySets != null) ifcCableCarrierFittingType.setHasPropertySets((SET<IfcPropertySetDefinition>) this.HasPropertySets.clone());
        if (this.RepresentationMaps != null) ifcCableCarrierFittingType.setRepresentationMaps((LIST<IfcRepresentationMap>) this.RepresentationMaps.clone());
        if (this.Tag != null) ifcCableCarrierFittingType.setTag((IfcLabel) this.Tag.clone());
        if (this.ElementType != null) ifcCableCarrierFittingType.setElementType((IfcLabel) this.ElementType.clone());
        if (this.PredefinedType != null) ifcCableCarrierFittingType.setPredefinedType((IfcCableCarrierFittingTypeEnum) this.PredefinedType.clone());
    ...
    public Object shallowCopy() {
        IfcCableCarrierFittingType ifcCableCarrierFittingType = new IfcCableCarrierFittingType();
        if (this.GlobalId != null) ifcCableCarrierFittingType.setGlobalId(this.GlobalId);
        if (this.OwnerHistory != null) ifcCableCarrierFittingType.setOwnerHistory(this.OwnerHistory);
        if (this.Name != null) ifcCableCarrierFittingType.setName(this.Name);
        if (this.Description != null) ifcCableCarrierFittingType.setDescription(this.Description);
        if (this.ApplicableOccurrence != null) ifcCableCarrierFittingType.setApplicableOccurrence(this.ApplicableOccurrence);
        if (this.HasPropertySets != null) ifcCableCarrierFittingType.setHasPropertySets(this.HasPropertySets);
        if (this.RepresentationMaps != null) ifcCableCarrierFittingType.setRepresentationMaps(this.RepresentationMaps);
        if (this.Tag != null) ifcCableCarrierFittingType.setTag(this.Tag);
        if (this.ElementType != null) ifcCableCarrierFittingType.setElementType(this.ElementType);
        if (this.PredefinedType != null) ifcCableCarrierFittingType.setPredefinedType(this.PredefinedType);
        return ifcCableCarrierFittingType;
    }
