...
public class OdaException extends Exception {
    ...
    public void setNextException(OdaException nextException) {
        ...
        while (ex.m_nextException != null) ex = ex.m_nextException;
    ...
    public Throwable initCause(Throwable cause) throws IllegalArgumentException, IllegalStateException {
        if (m_isCauseSet) throw new IllegalStateException("initCause() cannot be called multiple times.");
        if (this == cause) throw new IllegalArgumentException("This cannot be caused by itself.");
        m_cause = cause;
        m_isCauseSet = true;
        return this;
    }
    ...
    public String toString() {
        ...
        if (cause != null) {
            ...
            if (causeString != null && causeString.length() > 0) message += " ;\n    " + causeString;
        }
        return message;
    }
}
