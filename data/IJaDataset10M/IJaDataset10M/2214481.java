...
public class UnionStyleTest extends ValidationTestCase {
    ...
    private static final String CAMEL_CASE_SOURCE = "<UnionListExample>" + "  <IntegerField>" + "    <Number>777</Number>" + "  </IntegerField>" + "  <IntegerEntry>" + "    <Number>111</Number>" + "  </IntegerEntry>" + "  <DoubleEntry>" + "    <Number>222.00</Number>" + "  </DoubleEntry>" + "  <StringEntry>" + "    <Text>A</Text>" + "  </StringEntry>" + "  <StringEntry>" + "    <Text>B</Text>" + "  </StringEntry>" + "</UnionListExample>";

    private static final String HYPHEN_SOURCE = "<union-list-example>" + "  <integer-field>" + "    <number>777</number>" + "  </integer-field>" + "  <integer-entry>" + "    <number>111</number>" + "  </integer-entry>" + "  <double-entry>" + "    <number>222.00</number>" + "  </double-entry>" + "  <string-entry>" + "    <text>A</text>" + "  </string-entry>" + "  <string-entry>" + "    <text>B</text>" + "  </string-entry>" + "</union-list-example>";
    ...
    public static class UnionListExample {
        ...
        @ElementUnion({ @Element(name = "doubleField", type = DoubleEntry.class), @Element(name = "stringField", type = StringEntry.class), @Element(name = "integerField", type = IntegerEntry.class) })
        private Entry entry;

        @ElementListUnion({ @ElementList(entry = "doubleEntry", inline = true, type = DoubleEntry.class), @ElementList(entry = "stringEntry", inline = true, type = StringEntry.class), @ElementList(entry = "integerEntry", inline = true, type = IntegerEntry.class) })
