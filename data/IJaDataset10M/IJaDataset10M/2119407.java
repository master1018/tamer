...
public class TinyComboBoxUI extends BasicComboBoxUI {
    ...
    protected JButton createArrowButton() {
        JButton button = new TinyComboBoxButton(comboBox, null, comboBox.isEditable(), currentValuePane, listBox);
    ...
    public class TinyComboBoxLayoutManager implements LayoutManager {
        ...
        public void layoutContainer(Container parent) {
            ...
            if (comboBox.isEditable()) {
                if (arrowButton != null) {
                    arrowButton.setBounds(width - COMBO_BUTTON_WIDTH, 0, COMBO_BUTTON_WIDTH, height);
                }
                if (editor != null) {
