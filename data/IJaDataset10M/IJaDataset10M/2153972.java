...
public class TranscriptionSearchInternalFrame extends AbstractSearchInternalFrame {
    ...
    public void moreContext() {
        TranscriptionSearchResultTableModel tsrtm = ((TranscriptionSearchResultTableModel) ((TableSorter) (getSearchResultTable().getModel())).getTableModel());
    ...
    public AbstractSearchResultItem getSelectedSearchResultItem() {
        ...
        TranscriptionSearchResultItem tsri = (TranscriptionSearchResultItem) (((TranscriptionSearchResultTableModel) ((TableSorter) (getSearchResultTable().getModel())).getTableModel()).searchResult.elementAt(no));
        return tsri;
    }
    ...
    public AbstractSearchResult getSearchResult() {
        return ((TranscriptionSearchResultTableModel) ((TableSorter) (getSearchResultTable().getModel())).getTableModel()).searchResult;
    }
