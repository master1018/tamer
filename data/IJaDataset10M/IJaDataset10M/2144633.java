package games.midhedava.server.entity.area;

import games.midhedava.common.ConfigurableFactory;
import games.midhedava.common.ConfigurableFactoryContext;
...
public class CreatureProtectionAreaFactory implements ConfigurableFactory {
	 ...
	 */
    protected void defineCreatures(CreatureProtectionArea area, ConfigurableFactoryContext ctx) throws IllegalArgumentException {
        String s;
        String clazz;
        String subclazz;
        boolean blocked;
