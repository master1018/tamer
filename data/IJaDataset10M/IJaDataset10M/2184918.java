...
public class Item implements Cloneable {
     ...
     */
    private FlashCard parentCard;

    protected HashMap<String, Object> itemProps = new HashMap<String, Object>();
    ...
    public Object getProperty(String propName, Object defaultProperty) {
        if (getItemProps().containsKey(propName)) return getItemProps().get(propName); else return defaultProperty;
    }
    ...
    public HashMap<String, Object> getItemProps() {
        if (itemProps == null) itemProps = new HashMap<String, Object>();
        return itemProps;
    }
}
