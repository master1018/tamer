...
public class DelDbxrefHistoryItem extends HistoryItem {
    ...
    public DelDbxrefHistoryItem(String target, Dbxref newref, boolean isDef, String synonym) {
        this.newref = newref;
        this.isDef = isDef;
    ...
    public String toString() {
        return "Deleted " + (isDef ? "definition" : "general") + " dbxref " + newref + " from " + (synonym != null ? "synonym " + synonym + " of " : "") + target;
    }

    public boolean equals(Object o) {
        if (!(o instanceof DelDbxrefHistoryItem)) return false;
        DelDbxrefHistoryItem item = (DelDbxrefHistoryItem) o;
        return item.getTarget().equals(target) && item.getDbxref().equals(newref) && item.isDef() == isDef && ObjectUtil.equals(item.getSynonym(), synonym);
    }
