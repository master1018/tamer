...
public class TaskList implements RtmObject, Serializable {
    ...
    public TaskList(String id, String name, boolean archived, boolean deleted, boolean locked, int position, boolean smart, int sortOrder) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        if (o instanceof TaskList) return this.getId().equals(((TaskList) o).getId()); else return false;
    }

    @Override
    public String toString() {
        return "RtmList [id=" + id + ", name=" + name + ", archived=" + archived + ", deleted=" + deleted + ", locked=" + locked + ", position=" + position + ", smart=" + smart + ", sortOrder=" + sortOrder + "]";
    }
}
