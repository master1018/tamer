...
public class LslSimProcess extends LslProcess {
    ...
    private static final String SYSTEM_TESTER = "SystemTester";
    ...
    protected Interactor createInteractor(Process p) {
        return new LslSimInteractor(launch.getLaunchMode(), simDescription, p.getInputStream(), p.getOutputStream());
    }
