...
public class BrowserDownloadAdapter extends ResourceCursorAdapter {
    ...
    public BrowserDownloadAdapter(Context context, int layout, Cursor c) {
        ...
        mCurrentBytesColumnId = c.getColumnIndexOrThrow(Downloads.COLUMN_CURRENT_BYTES);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (Downloads.isStatusCompleted(status)) {
            ...
            if (Downloads.isStatusError(status)) {
                ...
                tv.setText(r.getString(R.string.download_success, Formatter.formatFileSize(mContext, totalBytes)));
            }
