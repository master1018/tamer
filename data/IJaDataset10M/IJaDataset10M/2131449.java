...
public class HelpPageContentDAO extends PyramusEntityDAO<HelpPageContent> {
    ...
    public HelpPageContent findByPageAndLocale(HelpPage page, Locale locale) {
        ...
        criteria.where(criteriaBuilder.and(criteriaBuilder.equal(root.get(HelpPageContent_.page), page), criteriaBuilder.equal(root.get(HelpPageContent_.locale), locale)));
