...
/**
 * A CrashOfFirstRemoteResourceBeforeItAnswersPrepareIIOPSOAPTestCase.
 * 
 * @author <a href="reverbel@ime.usp.br">Francisco Reverbel</a>
 * @author <a href="mailto:ivanneto@gmail.com">Ivan Neto</a>
 * @version $Revision: 37406 $
 */
public class CrashOfFirstRemoteResourceBeforeItAnswersPrepareIIOPSOAPTestCase extends JBossCrashRecoveryIIOPTestCase {

    private Logger log = Logger.getLogger(this.getClass());

    public CrashOfFirstRemoteResourceBeforeItAnswersPrepareIIOPSOAPTestCase(String name) throws Exception {
        super(name);
    }
    ...
    public void test() throws Exception {
        ...
        for (int i = 0; i < N; i++) xaResEnlisterCaller.callXAResourceEnlistersOverIIOPAndSOAP();
        ...
        try {
            ...
            xaResEnlisterCaller.callXAResourceEnlistersOverIIOPAndSOAP();
    ...
    public static Test suite() throws Exception {
        return suite(CrashOfFirstRemoteResourceBeforeItAnswersPrepareIIOPSOAPTestCase.class);
    }
}
