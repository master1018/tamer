 ...
 *       &lt;sequence>
 *         &lt;element name="Car" type="{http://soap.svc.test.serviceadapter.jawise.com}Car" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ArrayOfCar", propOrder = { "car" })
public class ArrayOfCar {

    @XmlElement(name = "Car", required = true, nillable = true)
