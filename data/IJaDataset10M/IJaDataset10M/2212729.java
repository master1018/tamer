...
public class TechnologyNodeFigureDelegate extends AbstractFigureDelegate {
    ...
    public void drawFigure(Graphics graphics) {
        ...
        if (isEnabled()) {
            ...
            int[] points = new int[] { bounds.x + SHADOW_OFFSET, bounds.y + FOLD_HEIGHT, bounds.x + FOLD_HEIGHT, bounds.y + SHADOW_OFFSET, bounds.x + bounds.width, bounds.y + SHADOW_OFFSET, bounds.x + bounds.width, bounds.y + bounds.height - FOLD_HEIGHT, bounds.x + bounds.width - FOLD_HEIGHT + SHADOW_OFFSET - 1, bounds.y + bounds.height, bounds.x + SHADOW_OFFSET, bounds.y + bounds.height };
