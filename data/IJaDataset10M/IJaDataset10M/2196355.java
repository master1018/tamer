...
public class LongObjectHashMap implements Cloneable, Iterable {
    ...
    private LongObjectHashMap(float loadFactor, int table_size, int size, int mask, int capacity, int threshold, Object keyNotFoundValue) {
        this.loadFactor = loadFactor;
    ...
    @Override
    public Object clone() {
        LongObjectHashMap n = new LongObjectHashMap(loadFactor, table.length, size, mask, capacity, threshold, keyNotFoundValue);
    ...
    public void putAll(LongObjectHashMap source) {
