...
class TimedMap {
    ...
    /**
	 * Returns value associated with given key, or null if no mapping for key is
	 * found. Resets timeout for key if it is present in map.
	 */
    ...
    /**
	 * Removes mapping for key from map, returning the value associated with the
	 * key (or null if no mapping present).
	 */
