...
public abstract class FragmentGoodnessProbe {
    ...
    public FragmentGoodnessProbe(FragmentationScheme fragmentationScheme, Molecule molecule) {
     ...
     */
    public abstract FragmentAtomGoodness getBestGoodnessIndex(int atomIndex1, int atomIndex2);
     ...
     */
    public abstract Iterator<FragmentAtomGoodness> getGoodnessIndices(int atomIndex1, int atomIndex2);
     ...
     */
    public void setOverallMinimumGoodnessIndex(FragmentAtomGoodness overallMinimumGoodnessIndex) {
     ...
     */
    public void setOverallMaximumGoodnessIndex(FragmentAtomGoodness overallMaximumGoodnessIndex) {
