...
public class TestGraph extends javax.swing.JFrame {
    ...
    public TestGraph() {
        ...
        rollupPanel1.add("Energy Layout", new PropertySheet(energyLayout = new SpringLayout(gm.getLocationMap())));
    ...
    private void randomLBActionPerformed(java.awt.event.ActionEvent evt) {
        updateEL = true;
        gm.applyLayout(StaticGraphLayout.RANDOM, 5.0);
    }

    private void circleLBActionPerformed(java.awt.event.ActionEvent evt) {
        updateEL = true;
        gm.applyLayout(StaticGraphLayout.CIRCLE, 5.0);
    }

    private void energyIBActionPerformed(java.awt.event.ActionEvent evt) {
        if (energyLayout == null) energyLayout = new SpringLayout(gm.getLocationMap());
        gm.setLayoutAlgorithm(energyLayout);
        gm.iterateLayout();
        updateEL = false;
    }

    private void energyABActionPerformed(java.awt.event.ActionEvent evt) {
        if (energyLayout == null) energyLayout = new SpringLayout(gm.getLocationMap());
        gm.setLayoutAlgorithm(energyLayout);
        gm.startLayoutTask(10, 2);
    }

    private void energySBActionPerformed(java.awt.event.ActionEvent evt) {
        gm.stopLayoutTask();
    }
