...
public abstract class ContainerRegistry<R extends ContainerRegistry<R, C>, C extends Container<R, C>> extends AbstractSet<C> implements Resource {
    ...
    @SuppressWarnings(value = { "unchecked" })
    private static <R extends ContainerRegistry<R, C>, C extends Container<R, C>> R load(R registry, Storage storage) throws IOException, QdbException {
        try {
    ...
    private static <R extends ContainerRegistry<R, C>, C extends Container<R, C>> void store(R registry, Storage storage) throws IOException, QdbException {
