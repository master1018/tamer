...
import net.sf.imca.androidsync.Constants;
...
import net.sf.imca.androidsync.R;
...
public class ContactOperations {
     ...
     */
    public static ContactOperations createNewContact(Context context, String userId, String accountName, BatchOperation batchOperation) {
     ...
     * @return instance of ContactOperations
     */
    public static ContactOperations updateExistingContact(Context context, String rawContactId, BatchOperation batchOperation) {
    ...
    public ContactOperations(Context context, String userId, String accountName, BatchOperation batchOperation) {
    ...
    public ContactOperations(Context context, String rawContactId, BatchOperation batchOperation) {
        this(context, batchOperation);
        mIsNewContact = false;
    ...
    public ContactOperations addClub(String club) {
        mValues.clear();
        if (!TextUtils.isEmpty(club)) {
            mValues.put(Organization.TITLE, club);
     ...
     * @return instance of ContactOperations
     */
    public ContactOperations updateName(Uri uri, String existingFirstName, String existingLastName, String firstName, String lastName) {
        Log.i("ContactOperations", "ef=" + existingFirstName + "el=" + existingLastName + "f=" + firstName + "l=" + lastName);
        mValues.clear();
