package org.aspencloud.simple9.builder.editor.partitions.java;
...
public class JavaAutoIndentStrategy extends DefaultIndentLineAutoEditStrategy {
    ...
    public void customizeDocumentCommand(IDocument d, DocumentCommand c) {
        if (c.length == 0 && c.text != null && endsWithDelimiter(d, c.text)) smartIndentAfterNewLine(d, c); else if ("}".equals(c.text)) {
    ...
    protected void smartIndentAfterNewLine(IDocument document, DocumentCommand command) {
        ...
        try {
            ...
            System.out.println(JavaEditorMessages.getString("AutoIndent.error.bad_location_1"));
        }
    }
    ...
    protected void smartInsertAfterBracket(IDocument document, DocumentCommand command) {
        ...
        try {
            ...
            System.out.println(JavaEditorMessages.getString("AutoIndent.error.bad_location_2"));
        }
    }
}
