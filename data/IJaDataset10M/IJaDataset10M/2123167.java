...
public class TMHMMMatch extends Match<TMHMMMatch.TMHMMLocation> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TMHMMMatch)) return false;
        return new EqualsBuilder().appendSuper(super.equals(o)).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(19, 63).appendSuper(super.hashCode()).toHashCode();
    }
    ...
    public static class TMHMMLocation extends Location {
        ...
        public boolean equals(Object o) {
            if (this == o) return true;
            if (!(o instanceof TMHMMLocation)) return false;
            return new EqualsBuilder().appendSuper(super.equals(o)).isEquals();
        }

        @Override
        public int hashCode() {
            return new HashCodeBuilder(19, 61).appendSuper(super.hashCode()).toHashCode();
        }
    }
}
