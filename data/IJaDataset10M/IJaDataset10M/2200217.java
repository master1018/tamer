...
public class CAPUserAbortPrimitiveImpl implements CAPAsnPrimitive {
    ...
    private void _decode(AsnInputStream ais, int length) throws CAPParsingComponentException, IOException, AsnException {
        ...
        if (this.reason == null) this.reason = CAPUserAbortReason.no_reason_given;
        if (ais.available() > 0) throw new AsnException("Too much source data");
    }
    ...
    public void encodeData(AsnOutputStream aos) throws CAPException {
        if (this.reason == null) throw new CAPException("reason field must not be empty");
        try {
