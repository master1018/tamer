 ...
 *
 */
public interface Level3ListOfMapElementsEntriesValueSelectedOperator<K, V, I> extends UniqOperator<List<Map<K, V>>, I>, ExecutableSelectedOperator<V, I>, ReplaceableOperator<V, I>, SelectedOperator<V, I> {
