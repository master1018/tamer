...
public class ProtocolParameter {
    ...
    public int hashCode() {
        if (mParameterName != null) return mParameterName.hashCode(); else return -1;
    }
    ...
    public String getParameterString() {
        ...
        if (mParameterValue != null) buf.append('=').append(mParameterValue);
        return buf.toString();
    }

    public String getParameterStringXml() {
        StringBuilder buf = new StringBuilder(mParameterName);
        if (mParameterValue != null) buf.append("=\"").append(mParameterValue).append('\"');
        return buf.toString();
    }
}
