...
public class ConfigurationTest extends TestCase {
    ...
    public void testNext() {
        int setSize = 9;
        int subSetSize = 4;
        IConfiguration configuration = ConfigurationFactory.create(setSize, subSetSize);
    ...
    private void testNumberOfSelectedElements(int setSize, int subSetSize, IConfiguration configuration) {
    ...
    private void testNumberOfConfigurations(int setSize, int subSetSize, IConfiguration configuration) {
        assertEquals(choose(setSize, subSetSize), countConfigurations(setSize, configuration));
    }

    private void testLengthOfEachConfiguration(int setSize, IConfiguration configuration) {
    ...
    private int countConfigurations(int setSize, IConfiguration startConfiguration) {
        int count = 0;
