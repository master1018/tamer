package net.openchrom.chromatogram.msd.integrator.ui;
...
public class Activator extends AbstractUIPlugin {
    ...
    public static final String PLUGIN_ID = "net.openchrom.chromatogram.msd.integrator.ui";

    private static ImageRegistry imageRegistry;

    public static final String IMAGE_PEAK = "IMAGE_PEAK";
    ...
    private void initializeImageRegistry() {
        if (PlatformUI.isWorkbenchRunning()) {
            ...
            imageDescriptor = createImageDescriptor(bundle, "icons/peak.gif");
            imageRegistry.put(IMAGE_PEAK, imageDescriptor);
        }
    }
