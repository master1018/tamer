...
public class GridAggregationHarvester extends PatternHarvester {
     ...
     */
    public GridAggregationHarvester(Repository repository, String id) throws Exception {
        super(repository, id);
    }
     ...
     * @throws Exception _more_
     */
    public GridAggregationHarvester(Repository repository, Element element) throws Exception {
    ...
    protected void init(Element element) throws Exception {
        super.init(element);
        aggregationCoordinate = XmlUtil.getAttribute(element, ATTR_AGGREGATIONCOORDINATE, aggregationCoordinate);
        aggregationType = XmlUtil.getAttribute(element, ATTR_AGGREGATIONTYPE, aggregationType);
    }
    ...
    public void createEditForm(Request request, StringBuffer sb) throws Exception {
        ...
        List<String> types = (List<String>) Misc.newList(NcmlUtil.AGG_JOINEXISTING, NcmlUtil.AGG_UNION);
        sb.append(HtmlUtil.formEntry(msgLabel("Time coordinate"), HtmlUtil.input(ATTR_AGGREGATIONCOORDINATE, aggregationCoordinate, HtmlUtil.SIZE_60)));
        sb.append(HtmlUtil.formEntry(msgLabel("Aggregation type"), HtmlUtil.select(ATTR_AGGREGATIONTYPE, types, aggregationType)));
    }
