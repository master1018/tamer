...
public class PrivilegedAccessor {
    ...
    public static Object getValue(Object instance, String fieldName) throws IllegalAccessException, NoSuchFieldException {
        Field field;
        if (instance instanceof Class) field = getFieldImpl((Class) instance, fieldName); else field = getFieldImpl(instance.getClass(), fieldName);
     ...
     * @see PrivilegedAccessor#invokeMethod(Object,String,Object)
     */
    public static Object invokeMethod(Object instance, String methodName, Object[] args, Class[] classTypes) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
     ...
     * @see PrivilegedAccessor#invokeMethod(Object,String,Object[])
     */
    public static List invokeAllStaticMethods(Class clazz, String methodName, Object arg) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
     ...
     */
    public static List invokeAllStaticMethods(Class clazz, String methodName, Object[] args) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
     ...
     * @see PrivilegedAccessor#invokeAllStaticMethods(Class,String,Object)
     */
    public static List<PairTuple> invokeAllStaticMethods(Class clazz, String methodName, Object[] args, Class[] classTypes) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
    ...
    public static Method getMethod(Object instance, String methodName, Class[] classTypes) throws NoSuchMethodException {
        Method accessMethod;
        if (instance instanceof Class) accessMethod = getMethodImpl((Class) instance, methodName, classTypes); else accessMethod = getMethodImpl(instance.getClass(), methodName, classTypes);
    ...
    public static List<Method> getAllStaticMethods(Class entryClass, String methodName, Class[] classTypes) throws NoSuchMethodException {
        ...
        if (methods.isEmpty()) throw new NoSuchMethodException("Invalid method: " + methodName);
        return methods;
    }
     ...
     */
    public static Class getClass(Class parent, String name) throws ClassNotFoundException {
     ...
     */
    public static Object invokeConstructor(Class clazz, Object[] args) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    private static Class[] getArgumentTypes(Object[] args) {
        ...
        if (args != null) {
            ...
            for (int i = 0; i < args.length; i++) {
                if (args[i] != null) classTypes[i] = args[i].getClass();
            }
        }
        return classTypes;
    }
     ...
     */
    public static Object invokeConstructor(Class clazz, Object[] args, Class[] classTypes) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    private static Field getFieldImpl(Class thisClass, String fieldName) throws NoSuchFieldException {
        if (thisClass == null) throw new NoSuchFieldException("Invalid field : " + fieldName);
        try {
     ...
     */
    @SuppressWarnings("unchecked")
    private static Method getMethodImpl(Class thisClass, String methodName, Class[] classTypes) throws NoSuchMethodException {
        if (thisClass == null) throw new NoSuchMethodException("Invalid method : " + methodName);
        try {
     ...
     */
    private static Constructor getConstructorImpl(Class clazz, Class[] classTypes) throws NoSuchMethodException {
        Constructor[] cs = clazz.getDeclaredConstructors();
        for (int i = 0; i < cs.length; i++) {
            if (Arrays.equals(classTypes, cs[i].getParameterTypes())) return cs[i];
            if (cs[i].getParameterTypes().length == 0 && classTypes == null) return cs[i];
        }
