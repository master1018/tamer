...
public class DirtyShutdownTest {
    ...
    private static final String query = "import module namespace t=\"http://exist-db.org/xquery/test\" " + "at \"java:org.exist.storage.util.TestUtilModule\";\n" + "t:pause(120)";
    ...
    public void storeRepeatedly() {
        ...
        try {
            ...
            for (int i = 0; i < 50; i++) {
                ...
                IndexInfo info = root.validateXMLResource(transaction, broker, XmldbURI.create("test.xml"), new InputSource(f.toURI().toASCIIString()));
                assertNotNull(info);
