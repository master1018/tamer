...
public final class CdmaInformationRecords {
    ...
    public CdmaInformationRecords(Parcel p) {
        ...
        switch(id) {
            ...
            case RIL_CDMA_CONNECTED_NUMBER_INFO_REC:
                record = new CdmaNumberInfoRec(id, p.readString(), p.readInt(), p.readInt(), p.readInt(), p.readInt());
                break;
            case RIL_CDMA_SIGNAL_INFO_REC:
                record = new CdmaSignalInfoRec(p.readInt(), p.readInt(), p.readInt(), p.readInt());
                break;
            case RIL_CDMA_REDIRECTING_NUMBER_INFO_REC:
                record = new CdmaRedirectingNumberInfoRec(p.readString(), p.readInt(), p.readInt(), p.readInt(), p.readInt(), p.readInt());
                break;
            case RIL_CDMA_LINE_CONTROL_INFO_REC:
                record = new CdmaLineControlInfoRec(p.readInt(), p.readInt(), p.readInt(), p.readInt());
                break;
    ...
    public static class CdmaSignalInfoRec {
        ...
        public String toString() {
            return "CdmaSignalInfo: {" + " isPresent: " + isPresent + ", signalType: " + signalType + ", alertPitch: " + alertPitch + ", signal: " + signal + " }";
        }
    }
    ...
    public static class CdmaDisplayInfoRec {
        ...
        @Override
        public String toString() {
            return "CdmaDisplayInfoRec: {" + " id: " + CdmaInformationRecords.idToString(id) + ", alpha: " + alpha + " }";
        }
    }
    ...
    public static class CdmaNumberInfoRec {
        ...
        @Override
        public String toString() {
            return "CdmaNumberInfoRec: {" + " id: " + CdmaInformationRecords.idToString(id) + ", number: " + number + ", numberType: " + numberType + ", numberPlan: " + numberPlan + ", pi: " + pi + ", si: " + si + " }";
        }
    }
    ...
    public static class CdmaRedirectingNumberInfoRec {
        ...
        public CdmaRedirectingNumberInfoRec(String number, int numberType, int numberPlan, int pi, int si, int reason) {
            numberInfoRec = new CdmaNumberInfoRec(RIL_CDMA_REDIRECTING_NUMBER_INFO_REC, number, numberType, numberPlan, pi, si);
            redirectingReason = reason;
        }

        @Override
        public String toString() {
            return "CdmaNumberInfoRec: {" + " numberInfoRec: " + numberInfoRec + ", redirectingReason: " + redirectingReason + " }";
        }
    }
    ...
    public static class CdmaLineControlInfoRec {
        ...
        @Override
        public String toString() {
            return "CdmaLineControlInfoRec: {" + " lineCtrlPolarityIncluded: " + lineCtrlPolarityIncluded + " lineCtrlToggle: " + lineCtrlToggle + " lineCtrlReverse: " + lineCtrlReverse + " lineCtrlPowerDenial: " + lineCtrlPowerDenial + " }";
        }
    }
    ...
    public static class CdmaT53ClirInfoRec {
        ...
        @Override
        public String toString() {
            return "CdmaT53ClirInfoRec: {" + " cause: " + cause + " }";
        }
    }
    ...
    public static class CdmaT53AudioControlInfoRec {
        ...
        @Override
        public String toString() {
            return "CdmaT53AudioControlInfoRec: {" + " uplink: " + uplink + " downlink: " + downlink + " }";
        }
    }
}
