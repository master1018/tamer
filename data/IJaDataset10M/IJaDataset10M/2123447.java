...
public class XhtmlValidator {
   ...
   */
    public static String validateAndClean(String content) throws ValidationException {
    ...
    private static void initializeParser(SAXParser parser) throws SAXException {
    ...
    private static String insertNamespaceAndRemoveCDataTags(String text) throws ValidationException {
        ...
        return "<FormattedContent xmlns=\"" + NS + "\">" + text.substring(text.indexOf(CDATA_HEADER) + CDATA_HEADER.length(), text.indexOf(CDATA_FOOTER)) + "</FormattedContent>";
    }
