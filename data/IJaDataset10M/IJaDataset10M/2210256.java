...
import net.sourceforge.poi.hssf.record.BoolErrRecord;
import net.sourceforge.poi.hssf.record.ExtendedFormatRecord;
...
public class HSSFCell {
     ...
     *
     * @see net.sourceforge.poi.hssf.usermodel.HSSFRow#createCell(short)
     */
     ...
     *                Type of cell
     * @see net.sourceforge.poi.hssf.usermodel.HSSFRow#createCell(short,int)
     * @deprecated As of 22-Jan-2002 use @see net.sourceforge.poi.hssf.usermodel.HSSFRow#createCell(short)
    ...
    private void setCellType(int cellType, boolean setValue) {
        ...
        switch(cellType) {
            case CELL_TYPE_FORMULA:
                ...
                if (setValue) frec.setValue(getNumericCellValue());
            ...
            case CELL_TYPE_NUMERIC:
                ...
                if (setValue) nrec.setValue(getNumericCellValue());
            ...
            case CELL_TYPE_BLANK:
                ...
                if (cellStyle != null) brec.setXFIndex((short) cellStyle.getIndex()); else brec.setXFIndex((short) 0);
                brec.setRow(row);
                record = brec;
                break;
            case CELL_TYPE_BOOLEAN:
                ...
                if (setValue) boolRec.setValue(getBooleanCellValue());
            ...
            case CELL_TYPE_ERROR:
                ...
                if (setValue) errRec.setValue(getErrorCellValue());
    ...
    public void setCellValue(double value) {
        if ((cellType != CELL_TYPE_NUMERIC) && (cellType != CELL_TYPE_FORMULA)) setCellType(CELL_TYPE_NUMERIC, false);
    ...
    public void setCellValue(String value) {
        if (value == null) setCellType(CELL_TYPE_BLANK, false); else {
            if ((cellType != CELL_TYPE_STRING) && (cellType != CELL_TYPE_FORMULA)) setCellType(CELL_TYPE_STRING, false);
            int index = 0;
            if (encoding == ENCODING_COMPRESSED_UNICODE) {
    ...
    public void setCellValue(boolean value) {
        if ((cellType != CELL_TYPE_BOOLEAN) && (cellType != CELL_TYPE_FORMULA)) setCellType(CELL_TYPE_BOOLEAN, false);
    ...
    public void setCellErrorValue(byte value) {
        if ((cellType != CELL_TYPE_ERROR) && (cellType != CELL_TYPE_FORMULA)) setCellType(CELL_TYPE_ERROR, false);
        ((BoolErrRecord) record).setValue(value);
        errorValue = value;
    }
     ...
     * @see net.sourceforge.poi.hssf.usermodel.HSSFWorkbook#createCellStyle()
     * @see net.sourceforge.poi.hssf.usermodel.HSSFWorkbook#getCellStyleAt(short)
     */
