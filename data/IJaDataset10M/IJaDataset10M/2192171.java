...
public class ReportRequestBean {
    ...
    public static final String Requested = Messages.getString("ReportRequestBean.requested");

    public static final String Viewed = Messages.getString("ReportRequestBean.viewed");
