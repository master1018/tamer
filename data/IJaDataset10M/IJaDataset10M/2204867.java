 ...
 * @author Slava Pestov
 * @version $Id: DefaultInputHandler.java,v 1.3 2008/09/16 09:00:03 ferra4models Exp $
 */
public class DefaultInputHandler extends InputHandler {
    ...
    public void addKeyBinding(String keyBinding, ActionListener action) {
        ...
        while (st.hasMoreTokens()) {
            ...
            if (st.hasMoreTokens()) {
                ...
                if (o instanceof Hashtable) current = (Hashtable) o; else {
                    o = new Hashtable();
    ...
    public void keyPressed(KeyEvent evt) {
        ...
        if (keyCode == KeyEvent.VK_CONTROL || keyCode == KeyEvent.VK_SHIFT || keyCode == KeyEvent.VK_ALT || keyCode == KeyEvent.VK_META) return;
    ...
    public static KeyStroke parseKeyStroke(String keyStroke) {
        ...
        if (key.length() == 1) {
            ...
            if (modifiers == 0) return KeyStroke.getKeyStroke(ch); else return KeyStroke.getKeyStroke(ch, modifiers);
