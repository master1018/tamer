    ...
    public static class RelationOrderComparator implements Comparator<Relation> {
        ...
        public int compare(Relation o1, Relation o2) {
            if (descStore.getOD(o1.getKvo().getDescriptorName()).containsKey(IFConsts.KEY_ORDERNUM)) {
                return objectHandlerFactory.createHandler(o1.getKvo()).getLong(IFConsts.KEY_ORDERNUM).compareTo(objectHandlerFactory.createHandler(o2.getKvo()).getLong(IFConsts.KEY_ORDERNUM));
