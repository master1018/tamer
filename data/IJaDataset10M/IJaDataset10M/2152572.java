...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (version) {
            System.out.println("ClassFileAnalyzer (Can), Version " + Version.majorVersion + "." + Version.minorVersion + "." + Version.updateVersion + " " + Version.addVersion);
            System.exit(0);
        }
        if (help || (sources.size() < 1) || (sources.size() > 2)) {
            String usage = "Usage:" + lt + lt + "java -jar classfileanalyzer.jar [options] [<jarfile>] <classfile>" + lt + lt + "java ClassFileAnalyzer [options] [<jarfile>] <classfile>" + lt + "java Can [options] [<jarfile>] <classfile>" + lt + lt + "classfile:" + lt + "  Java class file to be disassembled." + lt + lt + "jarfile:" + lt + "  Java Archive (JAR) file, which includes the Java class file to be" + lt + "  disassembled (optional)." + lt + lt + "options:" + lt + "  -version" + lt + "    Print version information." + lt + "  -file" + lt + "    Generate file in actual directory with assembler source text." + lt + "  -info" + lt + "    Print additional informations, e.g. hexdump of classfile." + lt + "  -nopc" + lt + "    Omit pc label before mnemonic." + lt + "  -help, -?" + lt + "    Print usage message." + lt;
        ...
        try {
            builder.buildHeader(minor_version, major_version, cp, access_flags, this_class, super_class, ifs, aes);
