...
public class DatabasePisteAerodrome extends PisteAerodrome implements DatabaseVidesoObject {
    ...
    public DatabasePisteAerodrome(int type, String name, String nomPiste, double lat1, double lon1, double lat2, double lon2, double largeur, Position ref, Type base, TextLayer tl) {
    ...
    public SurfacePolygon getInnerRectangle() {
        if (this.inner == null) this.setInnerRectangle(new DatabaseSurfacePolygonAnnotation());
        return inner;
    }

    @Override
    public SurfacePolygon getOuterRectangle() {
        if (this.outer == null) this.setOuterRectangle(new DatabaseSurfacePolygonAnnotation());
        return outer;
    }
