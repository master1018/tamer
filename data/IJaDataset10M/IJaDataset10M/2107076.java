...
public class ChangeEventView extends ListSelector implements ChangeHistoryListener {
    ...
    public static final SelectorList.ElementSelector ELEMENT_SELECTOR = new SelectorList.ElementSelector() {
    ...
    public static final ListCellRenderer TREE_CHANGE_RENDERER = new DefaultListCellRenderer() {
