...
public final class ASuperReferenceWildcardBoundsUshr extends PWildcardBoundsUshr {
    ...
    public ASuperReferenceWildcardBoundsUshr(@SuppressWarnings("hiding") TSuperToken _superToken_, @SuppressWarnings("hiding") TIdentifier _identifier_, @SuppressWarnings("hiding") List<PAdditionalIdentifier> _additionalIdentifiers_, @SuppressWarnings("hiding") List<PTypeComponent> _typeComponents_, @SuppressWarnings("hiding") PTypeArgumentsUshrNoGtGt _typeArgumentsUshrNoGtGt_) {
    ...
    @Override
    public Object clone() {
        return new ASuperReferenceWildcardBoundsUshr(cloneNode(this._superToken_), cloneNode(this._identifier_), cloneList(this._additionalIdentifiers_), cloneList(this._typeComponents_), cloneNode(this._typeArgumentsUshrNoGtGt_));
    }
    ...
    public String toString() {
        return "" + toString(this._superToken_) + toString(this._identifier_) + toString(this._additionalIdentifiers_) + toString(this._typeComponents_) + toString(this._typeArgumentsUshrNoGtGt_);
    }
