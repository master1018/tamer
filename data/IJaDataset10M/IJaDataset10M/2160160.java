...
public class UnionWithNonMatchingListEntriesTest extends ValidationTestCase {
    ...
    private static class NonMatchingUnionList {
        ...
        @ElementListUnion({ @ElementList(entry = "a", inline = true, type = A.class), @ElementList(entry = "b", inline = true, type = B.class), @ElementList(entry = "c", inline = true, type = C.class), @ElementList(entry = "d", inline = true, type = D.class) })
