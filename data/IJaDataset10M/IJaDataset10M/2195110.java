   ...
   */
    public void setIndex(ArrayIndex newIndex) {
        if (newIndex != index) {
            ...
            if (index != null) msgs = ((InternalEObject) index).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesystemPackage.INDEXED_VARIABLE__INDEX, null, msgs);
            if (newIndex != null) msgs = ((InternalEObject) newIndex).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesystemPackage.INDEXED_VARIABLE__INDEX, null, msgs);
            msgs = basicSetIndex(newIndex, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, TypesystemPackage.INDEXED_VARIABLE__INDEX, newIndex, newIndex));
    }
