...
public class Rfc822TokenTest extends AndroidTestCase {
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, method = "Rfc822Token", args = { java.lang.String.class, java.lang.String.class, java.lang.String.class })
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, method = "getName", args = {  }), @TestTargetNew(level = TestLevel.COMPLETE, method = "setName", args = { java.lang.String.class }) })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, method = "quoteComment", args = { java.lang.String.class })
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, method = "getComment", args = {  }), @TestTargetNew(level = TestLevel.COMPLETE, method = "setComment", args = { java.lang.String.class }) })
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, method = "getAddress", args = {  }), @TestTargetNew(level = TestLevel.COMPLETE, method = "setAddress", args = { java.lang.String.class }) })
    ...
    public void testToString() {
        ...
        Rfc822Token rfc822Token2 = new Rfc822Token("\"John Doe\"", "\\jdoe@example.net", "\\(work)");
        assertEquals("\"\\\"John Doe\\\"\" (\\\\\\(work\\)) <\\jdoe@example.net>", rfc822Token2.toString());
    ...
    @TestTargetNew(level = TestLevel.NOT_FEASIBLE, notes = "the phrase 'likely to cause trouble outside of a quoted string' is not testable", method = "quoteNameIfNecessary", args = { java.lang.String.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test {@link Rfc822Token#quoteName(String)}", method = "quoteName", args = { java.lang.String.class })
