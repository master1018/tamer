...
public class JSONTest extends InstrumentationTestCase {
    ...
    public void test_response() {
        ...
        assertEquals("http://www.rauminfo.ethz.ch/Rauminfo/grundrissplan.gif?region=Z&areal=Z&gebaeude=IFW&geschoss=A&", m.getMapURL());
    }

    private static final String setFingerprintResponse_str = "{\"status\":\"ok\",\"data\":{\"id\":1,\"location\":{\"id\":1,\"symbolicID\":\"IFW A44\",\"map\":{\"id\":50,\"mapName\":\"Test Map Name\",\"mapURL\":\"http://www.testmap.ch/map.gif\"},\"mapXcord\":150,\"mapYcord\":250,\"accuracy\":0},\"measurement\":{\"id\":1,\"timestamp\":1234567890,\"gsmReadings\":[],\"wifiReadings\":[{\"id\":1,\"bssid\":\"BSSID\",\"ssid\":\"SSID\",\"rssi\":100,\"wepEnabled\":true,\"isInfrastructure\":false},{\"id\":2,\"bssid\":\"BSSID 2\",\"ssid\":\"SSID 2\",\"rssi\":100,\"wepEnabled\":true,\"isInfrastructure\":false},{\"id\":3,\"bssid\":\"BSSID 3\",\"ssid\":\"SSID 3\",\"rssi\":100,\"wepEnabled\":true,\"isInfrastructure\":false}],\"bluetoothReadings\":[]}}}";

    public void test_setFingerprintResponse() {
        Type type = new TypeToken<Response<Fingerprint>>() {
        }.getType();
        Response<Fingerprint> res = gson.fromJson(setFingerprintResponse_str, type);
        assertEquals(Response.Status.ok, res.getStatus());
        ...
        assertEquals(m1.getBluetoothReadings().size(), m2.getBluetoothReadings().size());
