...
public class _18501ShugoIndemnity extends QuestHandler {
    ...
    private static final int questId = 18501;
    ...
    public boolean onDialogEvent(QuestCookie env) {
        ...
        if (qs == null) return false; else if (targetId == 799523) {
            if (qs.getStatus() == QuestStatus.START && qs.getQuestVarById(0) == 0) {
                if (env.getDialogId() == 26) return sendQuestDialog(env, 2375); else if (env.getDialogId() == 34) {
            ...
            } else if (qs.getStatus() == QuestStatus.REWARD) return defaultQuestEndDialog(env);
        } else if (targetId == 700833) {
            if (qs.getStatus() == QuestStatus.START && qs.getQuestVarById(0) == 0) return true;
