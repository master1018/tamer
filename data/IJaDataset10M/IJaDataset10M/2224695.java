    ...
    private class CosMultipartFile implements MultipartFile {
        ...
        public void transferTo(File dest) throws IOException, IllegalStateException {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("Multipart file '" + getName() + "' with original filename [" + getOriginalFilename() + "], stored " + (this.file != null ? "at [" + this.file.getAbsolutePath() + "]" : "in memory") + ": " + (moved ? "moved" : "copied") + " to [" + dest.getAbsolutePath() + "]");
            }
        }
    }
}
