...
public class ResourceBundleTest extends junit.framework.TestCase {
     ...
     *        java.util.Locale)
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getBundle", args = { java.lang.String.class, java.util.Locale.class })
    public void test_getBundleLjava_lang_StringLjava_util_Locale() {
        ...
        try {
            bundle = ResourceBundle.getBundle(name, new Locale("fr", "FR", "VAR"));
            assertEquals("Security: Wrong bundle fr_FR_VAR", "frFRVARValue4", bundle.getString("parent4"));
            bundle = ResourceBundle.getBundle(name, new Locale("fr", "FR", "v1"));
            assertEquals("Security: Wrong bundle fr_FR_v1", "frFRValue4", bundle.getString("parent4"));
            bundle = ResourceBundle.getBundle(name, new Locale("fr", "US", "VAR"));
            assertEquals("Security: Wrong bundle fr_US_var", "frValue4", bundle.getString("parent4"));
            bundle = ResourceBundle.getBundle(name, new Locale("de", "FR", "VAR"));
            assertTrue("Security: Wrong bundle de_FR_var: " + bundle.getString("parent4"), bundle.getString("parent4").equals("enUSValue4"));
        } finally {
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getBundle", args = { java.lang.String.class, java.util.Locale.class, java.lang.ClassLoader.class })
    ...
    public void test_getBundleLjava_lang_StringLjava_util_LocaleLjava_lang_ClassLoader() {
        ...
        try {
            while (tok.hasMoreTokens()) {
                ...
                String url;
                if (new File(path).isDirectory()) url = "file:" + path + resPackage + "subfolder/"; else url = "jar:file:" + path + "!" + resPackage + "subfolder/";
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getString", args = { java.lang.String.class })
    ...
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "Regression test. Doesn't verify NullPointerException.", method = "getBundle", args = { java.lang.String.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getObject", args = { java.lang.String.class })
    ...
    @TestTargets({ @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getStringArray", args = { java.lang.String.class }), @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "setParent", args = { java.util.ResourceBundle.class }) })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getBundle", args = { java.lang.String.class })
