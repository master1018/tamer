 ...
 * @see Configuration.
 */
public abstract class Component extends IRPersistent implements VersionedStructure {

    private static final int magic = 0x434F4D50;
    ...
    private void setDefaultNameValue() {
        nameSlot = VersionedSlotFactory.prototype.predefinedSlot("#component#", this);
    }
    ...
    public abstract void saveDelta(Era era, fluid.util.FileLocator floc) throws IOException;

    public abstract void loadDelta(Era era, fluid.util.FileLocator floc) throws IOException;

    public abstract void saveSnapshot(Version v, fluid.util.FileLocator floc) throws IOException;

    public abstract void loadSnapshot(Version v, fluid.util.FileLocator floc) throws IOException;
    ...
    public void writeContents(IROutput out) throws IOException {
        ...
        out.writeByte(flags);
        if ((flags & NAMEBIT) != 0) nameSlot.writeValue(IRStringType.prototype, out);
    }

    public void writeChangedContents(IROutput out) throws IOException {
        int flags = 0;
        if (nameSlot.isChanged()) flags |= NAMEBIT;
        out.writeByte(flags);
        if ((flags & NAMEBIT) != 0) nameSlot.writeValue(IRStringType.prototype, out);
    }
    ...
    public void readContents(IRInput in) throws IOException {
        ...
        if ((flags & NAMEBIT) != 0) nameSlot = nameSlot.readValue(IRStringType.prototype, in);
    }
    ...
    static {
        IRPersistent.registerPersistentKind(kind, 0x63);
    }
    ...
    public boolean isDefined(Era e) {
        if (e == Era.getInitialEra()) return isDefined();
        if (e.isNew() || e.isAssociated(this) < 0) {
            boolean result = isDefined(e.getRoot());
            return result;
        }
        Delta d = Delta.find(this, e);
        if (d != null && d.isDefined(e.getVersion(e.maxVersionOffset()))) return true;
        return false;
    }
    ...
    public static class Delta extends IRPersistent {
        ...
        static final int magic = 0x43504400;
        ...
        Delta(Component c, Era e) {
            super(magic, false);
            era = e;
            if (!e.isNew()) throw new FluidError("Creating new delta from old eras");
            comp = c;
        }
        ...
        public static Delta get(Component c, Era e) {
            ...
            if (d == null) {
                if (e.isNew()) d = new Delta(c, e); else d = new Delta(c, e, false);
                add(d);
            }
            return d;
        }
        ...
        public String getFileName() {
            return era.getID().toString() + File.separator + comp.getID() + ".cpd";
        }
        ...
        public String toString() {
            return "CPD(" + getComponent().getID() + "," + getEra() + ")";
        }
    ...
    public static class Snapshot extends IRPersistent {
        ...
        static final int magic = 0x43505300;
        ...
        public static Snapshot get(Component c, Version v) {
            ...
            if (s == null) {
                if (v.getEra() == null || v.getEra().isNew()) s = new Snapshot(c, v); else s = new Snapshot(c, v, false);
                add(s);
            }
            return s;
        }
        ...
        public String toString() {
            ...
            return "CPS(" + getComponent().getName() + "," + version.getEra() + "," + version.getEraOffset() + ")";
        }
