...
public class SmartSpaceGateway implements Gateway {
    ...
    public void init(AdaptabilityEngine adaptabilityEngine, UpDevice currentDevice, SecurityManager securityManager, ConnectivityManager connectivityManager, DeviceManager deviceManager, DriverManager driverManager, ApplicationDeployer applicationDeployer, Ontology ontology) {
    ...
    public ServiceResponse callService(UpDevice device, String serviceName, String driverName, String instanceId, String securityType, Map<String, String> parameters) throws ServiceCallException {
        return adaptabilityEngine.callService(device, serviceName, driverName, instanceId, securityType, parameters);
    }
    ...
    public void registerForEvent(UosEventListener listener, UpDevice device, String driver, String eventKey) throws NotifyException {
        adaptabilityEngine.registerForEvent(listener, device, driver, null, eventKey);
    }
    ...
    public void registerForEvent(UosEventListener listener, UpDevice device, String driver, String instanceId, String eventKey) throws NotifyException {
        adaptabilityEngine.registerForEvent(listener, device, driver, instanceId, eventKey);
    }
    ...
    public void unregisterForEvent(UosEventListener listener, UpDevice device, String driver, String instanceId, String eventKey) throws NotifyException {
        adaptabilityEngine.unregisterForEvent(listener, device, driver, instanceId, eventKey);
    }
