    ...
    public void select_jpanTree_node(String aInput) {
        ...
        if (lIsQuerynumber) {
            ...
            if (tpQuery == null) {
                ...
                treeDatfile.getTreeSelectionListeners()[0].valueChanged(new TreeSelectionEvent(treeDatfile, new TreePath[] { tpQuery, tpPeptideHit }, new boolean[] { true, false }, tpQuery, tpPeptideHit));
            }
        } else {
