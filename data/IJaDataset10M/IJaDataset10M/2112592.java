...
public final class ViewEntry extends Activity implements StringProvider {
   ...
   */
    private boolean hasContactAttributes(final Entry e) {
        ...
        return (e.hasAttribute(ATTR_PRIMARY_MAIL) || e.hasAttribute(ATTR_ALTERNATE_MAIL) || e.hasAttribute(ATTR_PRIMARY_PHONE) || e.hasAttribute(ATTR_HOME_PHONE) || e.hasAttribute(ATTR_MOBILE_PHONE) || e.hasAttribute(ATTR_PAGER) || e.hasAttribute(ATTR_FAX));
    }
   ...
   */
    private void displayUser() {
        ...
        if (showAddToContacts) {
            ...
            addToContactsButton.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
            addToContactsButton.setOnClickListener(new AddToContactsOnClickListener(this, entry));
   ...
   */
    private void addPhoneNumber(final String number, final String type, final LinearLayout layout) {
        logEnter(LOG_TAG, "addPhoneNumber", number, type, layout);
        final PhoneNumberClickListener onClickListener = new PhoneNumberClickListener(this, number);
        ...
        typeView.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.FILL_PARENT));
        ...
        numberView.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT));
   ...
   */
    private void addEMailAddress(final String address, final String type, final LinearLayout layout) {
        logEnter(LOG_TAG, "addEMailAddress", address, type, layout);
        final EMailClickListener onClickListener = new EMailClickListener(this, address);
        final LinearLayout line = new LinearLayout(this);
        line.setOrientation(LinearLayout.VERTICAL);
        line.setPadding(0, 5, 0, 5);
        final TextView typeView = new TextView(this);
        ...
        addressView.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT));
   ...
   */
    private void addPostalAddress(final String address, final String type, final LinearLayout layout) {
        ...
        final MapClickListener onClickListener = new MapClickListener(this, mapFriendly.toString());
        final LinearLayout line = new LinearLayout(this);
        line.setOrientation(LinearLayout.VERTICAL);
        line.setPadding(0, 5, 0, 5);
        final TextView typeView = new TextView(this);
   ...
   */
    private void addGenericAttribute(final Attribute attribute, final LinearLayout layout) {
        ...
        nameView.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.FILL_PARENT));
        l.addView(nameView);
        ...
        valueView.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT));
        valueView.setOnClickListener(new GenericAttributeClickListener(this, values[0]));
        l.addView(valueView);
        layout.addView(l);
        for (int i = 1; i < values.length; i++) {
            ...
            additionalValueView.setOnClickListener(new GenericAttributeClickListener(this, values[i]));
