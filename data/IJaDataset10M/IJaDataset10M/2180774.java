 ...
 *
 * @author Markus Kilås
 * @version $Id: SigningAndValidationWS.java 1934 2011-11-18 16:30:54Z netmackan $
 */
public class SigningAndValidationWS implements ISigningAndValidation {
     ...
     * @param password Password for authentication.
     */
    public SigningAndValidationWS(final String host, final int port, final boolean useHTTPS, final String username, final String password) {
        final String url = (useHTTPS ? "https://" : "http://") + host + ":" + port + "/signserver/signserverws/signserverws?wsdl";
