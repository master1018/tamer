...
public class AnyURI implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
        ...
        public static AnyURI fromString(java.lang.String value, java.lang.String namespaceURI) {
            AnyURI returnValue = new AnyURI();
            returnValue.setAnyURI(org.apache.axis2.databinding.utils.ConverterUtil.convertToAnyURI(value));
            return returnValue;
        }

        public static AnyURI fromString(javax.xml.stream.XMLStreamReader xmlStreamReader, java.lang.String content) {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"anyURI".equals(type)) {
                            ...
                            return (AnyURI) org.apache.axis2.databinding.types.soapencoding.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement() || reader.hasText()) {
                        if (reader.isStartElement() || reader.hasText()) {
                            ...
                            object.setAnyURI(org.apache.axis2.databinding.utils.ConverterUtil.convertToAnyURI(content));
                        } else {
