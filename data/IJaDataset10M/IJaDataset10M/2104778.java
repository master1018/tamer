...
final class DataResultSet {
    ...
    public DataResultSet(final ResultSet rows, final boolean showLobs) throws SchemaCrawlerException {
        try {
    ...
    private String convertColumnDataToString(final int i) throws SQLException {
