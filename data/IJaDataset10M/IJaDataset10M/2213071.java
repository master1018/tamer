...
public class OutputFactory {
    ...
    private static OutputStream compressWith7Zip(final String archivePath) throws ConfigurationException {
    ...
    private static OutputStream compressWithBZip2(final String archivePath) throws ConfigurationException {
    ...
    public static OutputStream getOutputStream(final String archivePath) throws ConfigurationException {
        switch(MODE_OUTPUT) {
            case SEVENZIP:
            ...
            default:
                throw ErrorFactory.createConfigurationException(ErrorKeys.DELTA_CONSUMERS_SQL_WRITER_OUTPUTFACTORY_ILLEGAL_OUTPUTMODE_VALUE);
        }
    }
}
