...
public class ReaderWithStepScopeTestUtilsTest {
    ...
    public StepExecution getStepExecution() {
        JobParameters jobParameters = new JobParametersBuilder().addString(PARAM_INPUT_RESOURCE, PRODUCTS_PATH).toJobParameters();
    ...
    public void testReader() throws Exception {
        int count = StepScopeTestUtils.doInStepScope(getStepExecution(), new Callable<Integer>() {
