...
public class CompoundX3 {
    ...
    protected String x3Task;

    protected CompoundX2 x2;
    ...
    public static class Id implements Serializable {
        ...
        public Id(String clave) throws Exception {
            ...
            if (partes.length != 5) throw new Exception("Error, illegal params");
        ...
        public boolean equals(Object o) {
            ...
            return ((this.x3Task == null ? objToCompare.x3Task == null : this.x3Task.equals(objToCompare.x3Task)) && (this.x2 == null ? objToCompare.x2 == null : this.x2.equals(objToCompare.x2)));
        }
    }
}
