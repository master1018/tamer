...
public class EStringToEObjectMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<String, EObject> {
    ...
    public void setTypedKey(String newKey) {
        String oldKey = key;
        key = newKey;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, CachePackage.ESTRING_TO_EOBJECT_MAP_ENTRY__KEY, oldKey, key));
    }
    ...
    public EObject getTypedValue() {
        if (value != null && value.eIsProxy()) {
            ...
            if (value != oldValue) {
                if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.RESOLVE, CachePackage.ESTRING_TO_EOBJECT_MAP_ENTRY__VALUE, oldValue, value));
            }
        }
        return value;
    }
    ...
    public void setTypedValue(EObject newValue) {
        ...
        value = newValue;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, CachePackage.ESTRING_TO_EOBJECT_MAP_ENTRY__VALUE, oldValue, value));
    }
