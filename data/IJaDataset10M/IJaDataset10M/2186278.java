...
/**
 * This is a default implementation of the IFC object IfcMomentOfInertiaMeasure<br><br>
 * 
 ...
 **/
public class IfcMomentOfInertiaMeasure extends DOUBLE implements IfcType, IfcDerivedMeasureValue {
    ...
    public String getStepParameter(boolean isSelectType) {
        if (isSelectType) return new String("IFCMOMENTOFINERTIAMEASURE(" + super.getStepParameter(false) + ")"); else return super.getStepParameter(false);
    }
}
