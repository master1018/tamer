...
public class VehicleFleetBuilder {
    ...
    private void buildLkwWalkers() {
        for (CompanyClass c : companyClasses) {
            Frequency conditionalFrequency = Classifier.makeConditionalFrequency(c.getFrequencyClass(), vehicleStats.getEmployees(), vehicleStats.getLkw());
    ...
    private void buildPkwWalkers() {
        for (CompanyClass c : companyClasses) {
            Frequency conditionalFrequency = Classifier.makeConditionalFrequency(c.getFrequencyClass(), vehicleStats.getEmployees(), vehicleStats.getPkw());
