 ...
 */
public class JDialogPerl extends JFrame {

    private static String FRAME_X = "dialog_regexp_help_perl_x";

    private static String FRAME_Y = "dialog_regexp_help_perl_y";

    private static String FRAME_HEIGHT = "dialog_regexp_help_perl_h";

    private static String FRAME_WITH = "dialog_regexp_help_perl_w";

    private static JDialogPerl instance;
    ...
    private JDialogPerl(JFrame parent, String url) {
        this.url = url;
        this.initGui();
        this.loadUserPrefs();
    ...
    private void initGui() {
        this.setTitle("Comparison to Perl 5");
    ...
    public static JDialogPerl getInstance(JFrame parent, String url) {
        if (JDialogPerl.instance != null) {
            return JDialogPerl.instance;
        } else {
            JDialogPerl.instance = new JDialogPerl(parent, url);
            return JDialogPerl.instance;
        }
    }
