...
public class IndicatorProperties extends AbstractPropertyListener {
    ...
    public void setSMAPeriod(int i) {
        smaPeriod = i;
    }
    ...
    public void setSMAColor(Color c) {
        smaColor = c;
    }
    ...
    public int getSMAStrokeIndex() {
        return smaStrokeIndex;
    }

    public void setSMAStrokeIndex(int i) {
        smaStrokeIndex = i;
    }

    public Stroke getSMAStroke() {
        return StrokeGenerator.getStroke(smaStrokeIndex);
    }

    public void setSMAStroke(Stroke s) {
        smaStrokeIndex = StrokeGenerator.getStrokeIndex(s);
    }
}
