...
public class SmsMessageTest extends AndroidTestCase {
    ...
    public void testCreateFromPdu() throws Exception {
        ...
        assertNotNull(sms);
        pdu = "07912160130310F2040B915121927786F300036060924180008A0DA" + "8695DAC2E8FE9296A794E07";
        ...
        assertEquals(SmsMessage.MAX_USER_DATA_SEPTETS - sms.getMessageBody().length(), result[2]);
        assertEquals(SmsMessage.ENCODING_7BIT, result[3]);
        pdu = "07912160130300F4040B914151245584" + "F600087010807121352B10212200A900AE00680065006C006C006F";
        sms = SmsMessage.createFromPdu(hexStringToByteArray(pdu));
    ...
    public void testGetSubmitPdu() throws Exception {
        ...
        SmsMessage.SubmitPdu smsPdu = SmsMessage.getSubmitPdu(scAddress, destinationAddress, message, statusReportRequested);
        assertNotNull(smsPdu);
        smsPdu = SmsMessage.getSubmitPdu(scAddress, destinationAddress, (short) 80, message.getBytes(), statusReportRequested);
        assertNotNull(smsPdu);
    }
