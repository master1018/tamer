...
public class UserStoryData extends com.technoetic.xplanner.soap.domain.DomainData implements java.io.Serializable {
    ...
    public UserStoryData(int id, java.util.Calendar lastUpdateTime, double actualHours, double adjustedEstimatedHours, boolean completed, int customerId, java.lang.String description, java.lang.String dispositionName, double estimatedHours, double estimatedOriginalHours, int iterationId, java.lang.String name, double postponedHours, int priority, double remainingHours, int trackerId) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = super.equals(obj) && this.actualHours == other.getActualHours() && this.adjustedEstimatedHours == other.getAdjustedEstimatedHours() && this.completed == other.isCompleted() && this.customerId == other.getCustomerId() && ((this.description == null && other.getDescription() == null) || (this.description != null && this.description.equals(other.getDescription()))) && ((this.dispositionName == null && other.getDispositionName() == null) || (this.dispositionName != null && this.dispositionName.equals(other.getDispositionName()))) && this.estimatedHours == other.getEstimatedHours() && this.estimatedOriginalHours == other.getEstimatedOriginalHours() && this.iterationId == other.getIterationId() && ((this.name == null && other.getName() == null) || (this.name != null && this.name.equals(other.getName()))) && this.postponedHours == other.getPostponedHours() && this.priority == other.getPriority() && this.remainingHours == other.getRemainingHours() && this.trackerId == other.getTrackerId();
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(UserStoryData.class, true);
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("estimatedOriginalHours");
        elemField.setXmlName(new javax.xml.namespace.QName("", "estimatedOriginalHours"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "double"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
