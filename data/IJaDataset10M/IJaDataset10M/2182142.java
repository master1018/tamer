...
public class TableAggregatorTest extends TestCase {
   ...
   */
    public void testNoSuchElement() {
        ...
        try {
            tableAggregator.getAggregationValue(generatePath(new String[] { "1995", "2" }), "Sales", AggregationType.COUNT);
            fail();
   ...
   */
    public void testNoSuchColumn() {
        TableAggregator tableAggregator = newTableAggregator(1);
        try {
            assertNull(tableAggregator.getAggregationValue(generatePath(new String[] { "1994", "2" }), "Saless", AggregationType.COUNT));
            fail();
        } catch (IllegalArgumentException e) {
        }
        try {
            assertNull(tableAggregator.getAggregationValue(generatePath(new String[] { "1994", "2" }), "Songs", AggregationType.COUNT));
            fail();
        } catch (IllegalArgumentException e) {
        }
    }
   ...
   */
    public void testShortPath() {
        TableAggregator tableAggregator = newTableAggregator(1);
        assertEquals("60.0", tableAggregator.getAggregationValue(generatePath(new String[] { "1994" }), "Sales", AggregationType.SUM).toString());
        Assert.assertEquals(new TextValue("Youthanasia"), tableAggregator.getAggregationValue(generatePath(new String[] {}), "Band", AggregationType.MAX));
    }
   ...
   */
    public void testlongPath() {
        TableAggregator tableAggregator = newTableAggregator(1);
        assertEquals("48.0", tableAggregator.getAggregationValue(generatePath(new String[] { "1994", "2" }), "Sales", AggregationType.SUM).toString());
    }
   ...
   */
    public void testNullValues() {
        ...
        assertEquals("4.0", tableAggregator.getAggregationValue(generatePath(new String[] { "1994" }), "Sales", AggregationType.SUM).toString());
        assertEquals("4.0", tableAggregator.getAggregationValue(generatePath(new String[] { "1994", "2" }), "Sales", AggregationType.SUM).toString());
        assertEquals("4.0", tableAggregator.getAggregationValue(generatePath(new String[] {}), "Sales", AggregationType.SUM).toString());
    }
   ...
   */
    public void testElementNull() {
        TableAggregator tableAggregator = newTableAggregator(2);
        assertEquals("0.0", tableAggregator.getAggregationValue(generatePath(new String[] { "1994", null }), "Sales", AggregationType.SUM).toString());
    }
   ...
   */
    public void testNoElementNull() {
        TableAggregator tableAggregator = newTableAggregator(2);
        try {
            tableAggregator.getAggregationValue(generatePath(new String[] { "2003", null }), "Sales", AggregationType.SUM);
            fail();
        } catch (NoSuchElementException e) {
        }
    }
   ...
   */
    private TableAggregator newTableAggregator(int tableNum) {
        return new TableAggregator(groupByColumns, AggregationNodeTest.columnsToAggregate, MockDataSource.getData(tableNum));
    }
