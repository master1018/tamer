...
public class ProcessHierarchyGraphModel extends DefaultGraphModel {
    ...
    private static final String TREE_ERROR_LABEL = Resources.getResources().getString("hierarchy.tree.structure.check.error");
    ...
    public boolean acceptsTarget(final Object edge, final Object targetPort) {
        ...
        try {
            ProcessHierarchyNotation notation = (ProcessHierarchyNotation) ModelerSession.getNotationService().getNotation(identifier);
