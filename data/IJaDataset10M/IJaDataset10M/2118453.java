...
import ufpr.br.tsi.dacjaime.academico.secretaria.form.EmitirHistoricoForm;

public class EmitirHistoricoAction extends BaseDispatchAction {
    ...
    public ActionForward editar(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        EmitirHistoricoForm frm = (EmitirHistoricoForm) form;
