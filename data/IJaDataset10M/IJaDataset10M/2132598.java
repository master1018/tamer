...
public class SelfContainedSVGOnLoadTestValidator extends DefaultTestSuite {
    ...
    static class ReportErrorAndEntries extends DefaultErrorTest {
        ...
        public ReportErrorAndEntries() {
            super(errorAndEntriesURL, "can.you.read.this.error.code", new String[] { "can.you.read.this.first.entry", "can.you.read.this.second.entry" });
        }
    }
    ...
    static class MissingOrEmptyErrorCode extends DefaultErrorTest {
        ...
        public MissingOrEmptyErrorCode() {
            super(missingOrEmptyErrorCodeURL, SelfContainedSVGOnLoadTest.ERROR_MISSING_OR_EMPTY_ERROR_CODE_ON_FAILED_TEST, null);
        }
    }
    ...
    static class UnexpectedResultValue extends DefaultErrorTest {
        ...
        public UnexpectedResultValue() {
            super(unexpectedResultValueURL, SelfContainedSVGOnLoadTest.ERROR_UNEXPECTED_RESULT_VALUE, new String[] { SelfContainedSVGOnLoadTest.ENTRY_KEY_RESULT_VALUE });
        }
    }
    ...
    static class InvalidTestResultElementsNumber extends DefaultErrorTest {
        ...
        public InvalidTestResultElementsNumber() {
            super(invalidTestResultElementsNumberURL, SelfContainedSVGOnLoadTest.ERROR_UNEXPECTED_NUMBER_OF_TEST_RESULT_ELEMENTS, new String[] { SelfContainedSVGOnLoadTest.ENTRY_KEY_NUMBER_OF_TEST_RESULT_ELEMENTS });
        }
    }
    ...
    static class ProcessingError extends DefaultErrorTest {
        ...
        public ProcessingError() {
            super(processingErrorURL, SelfContainedSVGOnLoadTest.ERROR_WHILE_PROCESSING_SVG_DOCUMENT, new String[] { SelfContainedSVGOnLoadTest.ENTRY_KEY_ERROR_DESCRIPTION });
        }
    }
    ...
    static class CannotLoadSVGDocument extends DefaultErrorTest {
        ...
        public CannotLoadSVGDocument() {
            super(invalidURL, SelfContainedSVGOnLoadTest.ERROR_CANNOT_LOAD_SVG_DOCUMENT, new String[] { SelfContainedSVGOnLoadTest.ENTRY_KEY_ERROR_DESCRIPTION });
        }
    }
