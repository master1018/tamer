...
public interface Property extends AttributableSymbol, Comparable<Property> {
    ...
    public static final int FLAGS_RT_SPECIAL_NAME = 0x0400;

    public static final int FLAGS_HAS_CONSTANT_VALUE = 0x1000;

    public static final int FLAGS_UNUSED = 0xe9ff;
