...
public class SQLTypeUtils {
    ...
    public static boolean isLongType(int jdbcType) {
        boolean result = false;
        result = !isDateType(jdbcType) && !isStringType(jdbcType) && !isNumberType(jdbcType) && jdbcType != Types.BOOLEAN;
        return result;
    }
    ...
    public static Object getSQLValueObject(int type, String value, String param) {
        ...
        switch(type) {
            ...
            case Types.TIME:
            case Types.TIMESTAMP:
                Date date = TextUtils.parseDate(value, param);
                if (type == Types.DATE) {
