...
public class LogarithmStatisticParser extends AbstractXMLObjectParser {
    ...
    private XMLSyntaxRule[] rules = new XMLSyntaxRule[] { AttributeRule.newDoubleRule(BASE, true, "An optional base for the logarithm (default is the natural logarithm, base e)"), new ElementRule(Statistic.class, 1, 1) };
}
