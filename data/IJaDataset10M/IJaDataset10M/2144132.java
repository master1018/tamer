...
public class Network2Kml {
    ...
    private void generateKmlData() throws MismatchedDimensionException, TransformException {
        ...
        String key = "link";
        Folder folder = new Folder(key, key, ("Contains all " + key), key, org.matsim.utils.vis.kml.Feature.DEFAULT_LOOK_AT, org.matsim.utils.vis.kml.Feature.DEFAULT_STYLE_URL, true, org.matsim.utils.vis.kml.Feature.DEFAULT_REGION, org.matsim.utils.vis.kml.Feature.DEFAULT_TIME_PRIMITIVE);
        ...
        while (it.hasNext()) {
            ...
            Placemark placemark = new Placemark(link.getId().toString(), "link" + link.getId().toString(), "link" + link.getId().toString(), styleUrl, org.matsim.utils.vis.kml.Feature.DEFAULT_LOOK_AT, styleUrl, true, org.matsim.utils.vis.kml.Feature.DEFAULT_REGION, org.matsim.utils.vis.kml.Feature.DEFAULT_TIME_PRIMITIVE);
