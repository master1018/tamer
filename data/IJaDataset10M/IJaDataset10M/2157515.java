 ...
 */
    ...
    public static final int Tango_DEFAULT_TIMEOUT = (Tango_DEFAULT_TIMEOUT_SEC * 1000);
 ...
 */
    public static final String[] Tango_DevStateName = { "ON", "OFF", "CLOSE", "OPEN", "INSERT", "EXTRACT", "MOVING", "STANDBY", "FAULT", "INIT", "RUNNING", "ALARM", "DISABLE", "UNKNOWN" };
    ...
    public static final String[] eventNames = { "change", "quality_change", "periodic", "archive", "user_event", "attr_conf", "data_ready" };
	 ...
	 */
    public static final String[] LOGGING_LEVELS = { "OFF", "FATAL", "ERROR", "WARN", "INFO", "DEBUG" };
