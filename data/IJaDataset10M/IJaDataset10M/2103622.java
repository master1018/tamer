...
/**
 * Abstract class providing garbage collection facilities for Action
 * instances that perform filtering (i.e. mapping from abstract graph
...
public abstract class Filter extends AbstractAction {
     ...
     * 
     * @param itemClass
     *            the item class associated with this filter
     * @param gc
     *            indicates whether garbage collection should be
     *            performed
     */
    ...
    /**
     * Creates a new filter associated with the given item classes
     * that optionally performs garbage collection.
     * 
     * @param itemClasses
     *            the item classes associated with this filter
     * @param gc
     *            indicates whether garbage collection should be
     *            performed
     */
    public Filter(String[] itemClasses, boolean gc) {
        ...
        for (int i = 0; i < itemClasses.length; i++) {
            if (itemClasses[i] != null) m_classes.add(itemClasses[i]);
        }
        m_gc = gc;
    }

    /**
     * Indicates whether or not this filter performs garbage
     * collection.
     * 
     ...
     * 
     * @param s
     *            the flag indicating if garbage collected is
     *            performed
     */
    ...
    /**
     * Gets the item classes associated with this Filter. Item classes
     * are repreesnted as String instances corresponding to entries in
     * an ItemRegistry.
     * 
    ...
    /**
     * Signals the ItemRegistry to perform garbage collection, if
     * enabled, on the item classes registered with this filter.
     */
