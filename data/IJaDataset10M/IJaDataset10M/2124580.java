...
public class CA implements JainMgcpExtendedListener {
    ...
    public void sendAuditConnection() {
        try {
            ...
            InfoCode[] infoCodeList = new InfoCode[] { InfoCode.CallIdentifier, InfoCode.NotifiedEntity, InfoCode.LocalConnectionOptions, InfoCode.ConnectionMode, InfoCode.ConnectionParameters, InfoCode.RemoteConnectionDescriptor, InfoCode.LocalConnectionDescriptor };
