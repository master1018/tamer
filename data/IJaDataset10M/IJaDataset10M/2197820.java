...
public class SimilarityTest {
    ...
    public void setUp() throws Exception {
        ...
        BufferedReader reader = new BufferedReader(new FileReader("src/test/resources/data/indexing_sample_data.txt"));
        String line = null;
    ...
    public void testJaccardSimilarityWithTfIdfVector() throws Exception {
        ...
        prettyPrintMatrix("Jaccard Similarity (TF/IDF)", similarity, vectorGenerator.getDocumentNames(), new PrintWriter(System.out, true));
    }
    ...
    public void testJaccardSimilarityWithLsiVector() throws Exception {
        ...
        JaccardSimilarity jaccardSimilarity = new JaccardSimilarity();
        RealMatrix similarity = jaccardSimilarity.transform(termDocMatrix);
        prettyPrintMatrix("Jaccard Similarity (LSI)", similarity, vectorGenerator.getDocumentNames(), new PrintWriter(System.out, true));
    }
