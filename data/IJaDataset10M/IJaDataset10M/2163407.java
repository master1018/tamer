...
public class Preset extends ServerSetting implements Comparable<Preset> {
    ...
    protected WarlockColor getColorFromString(String key, String color) {
        if (color == null || color.length() == 0) {
            if (KEY_FGCOLOR.equals(key)) return getDefaultForegroundColor(); else if (KEY_BGCOLOR.equals(key)) return getDefaultBackgroundColor();
            ...
            if (KEY_FGCOLOR.equals(key)) return serverSettings.getDefaultSkin().getSkinForegroundColor(getName()); else if (KEY_BGCOLOR.equals(key)) return serverSettings.getDefaultSkin().getSkinBackgroundColor(getName());
        }
    ...
    public Preset(ServerSettings serverSettings, Element presetElement, Palette palette) {
        ...
        this.fillEntireLine = presetElement.attribute("line") != null ? "y".equalsIgnoreCase(presetElement.attributeValue("line")) : false;
    }
    ...
    public void setForegroundColor(WarlockColor foregroundColor) {
        ...
        if (!stormfrontString.equals(this.foregroundColor)) needsUpdate = true;
    ...
    public void setDefaultBackgroundColor() {
        if (this.foregroundColor != null) needsUpdate = true;
        this.foregroundColor = null;
    }

    public void setSkinBackgroundColor() {
        if (!"skin".equals(this.backgroundColor)) needsUpdate = true;
    ...
    public void setBackgroundColor(WarlockColor backgroundColor) {
        ...
        if (!stormfrontString.equals(this.backgroundColor)) needsUpdate = true;
    ...
    public void setFillEntireLine(boolean fillEntireLine) {
        if (this.fillEntireLine != fillEntireLine) needsUpdate = true;
    ...
    public void setName(String name) {
        if (!name.equals(this.name)) needsUpdate = true;
        this.name = name;
    }
    ...
    protected void saveToDOM() {
        ...
        if (fillEntireLine) setAttribute(KEY_FILL_ENTIRE_LINE, "y");
    }

    protected String toStormfrontMarkup() {
        return "<p id=\"" + getName() + "\" " + KEY_FGCOLOR + "=\"" + foregroundColor + "\" " + KEY_BGCOLOR + "=\"" + backgroundColor + "\"" + (fillEntireLine ? (" " + KEY_FILL_ENTIRE_LINE + "=\"y\"/>") : "/>");
    }
    ...
    public void setNeedsUpdate(boolean needsUpdate) {
        ...
        if (!needsUpdate) this.originalPreset = null;
    }
