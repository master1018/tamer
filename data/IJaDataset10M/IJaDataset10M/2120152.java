 ...
 * @generated
 */
public class LinkEventNameEditPart extends BpmnExtNodeLabelEditPart implements ITextAwareEditPart {
	 ...
	 */
    static {
        registerSnapBackPosition(BpmnVisualIDRegistry.getType(LinkEventNameEditPart.VISUAL_ID), new Point(0, 0));
    }

    /**
	 * @generated
	 */
    public LinkEventNameEditPart(View view) {
        super(view);
    }
            ...
            ParserHintAdapter hintAdapter = new ParserHintAdapter(getParserElement(), parserHint) {
                ...
                public Object getAdapter(Class adapter) {
                    if (IElementType.class.equals(adapter)) {
                        return BpmnElementTypes.LinkEvent_2015;
                    }
