...
public class AboutDialog extends AbstractDialog {
    ...
    public AboutDialog() {
        ...
        sbTitle.append("<html><center><h1>").append(Translate.getInstance().get(TranslateKeys.BUDDI)).append("</h1></center></html>");
        StringBuffer sbVersion = new StringBuffer();
        sbVersion.append("<html><center><h5>").append(Translate.getInstance().get(TranslateKeys.VERSION)).append(" ").append(Const.VERSION).append("</h5></center></html");
        ...
        sbText.append("<html><center>").append(Translate.getInstance().get(TranslateKeys.ABOUT_TEXT)).append("<br><br>").append(Translate.getInstance().get(TranslateKeys.ABOUT_COPYRIGHT)).append("<br>&lt;").append(Translate.getInstance().get(TranslateKeys.ABOUT_EMAIL)).append("&gt;<br><a href='").append(Translate.getInstance().get(Const.PROJECT_URL)).append("'>").append(Translate.getInstance().get(Const.PROJECT_URL)).append("</a><br><br>").append(Translate.getInstance().get(TranslateKeys.ABOUT_GPL)).append("</center></html>");
