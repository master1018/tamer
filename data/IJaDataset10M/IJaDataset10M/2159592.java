 ...
 *
 * @version $Rev: 532678 $ $Date: 2007-04-26 11:13:49 +0200 (Thu, 26 Apr 2007) $
 * @since 2.0
 */
public class TilesContainerFactory {
    ...
    protected void storeContainerDependencies(Object context, Map<String, String> initParameters, Map<String, String> configuration, BasicTilesContainer container) throws TilesException {
        TilesContextFactory contextFactory = (TilesContextFactory) createFactory(configuration, CONTEXT_FACTORY_INIT_PARAM);
        DefinitionsFactory defsFactory = (DefinitionsFactory) createFactory(configuration, DEFINITIONS_FACTORY_INIT_PARAM);
        PreparerFactory prepFactory = (PreparerFactory) createFactory(configuration, PREPARER_FACTORY_INIT_PARAM);
    ...
    protected static Map<String, String> getInitParameterMap(Object context) throws TilesException {
        ...
        try {
            ...
            Enumeration<String> e = (Enumeration<String>) method.invoke(context);
