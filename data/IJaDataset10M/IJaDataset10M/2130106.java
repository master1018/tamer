...
public class PlayWave extends Thread {
    ...
    public void run() {
        ...
        if (auline.isControlSupported(FloatControl.Type.PAN)) {
            ...
            if (curPosition == Position.RIGHT) pan.setValue(1.0f); else if (curPosition == Position.LEFT) pan.setValue(-1.0f);
        }
        auline.start();
        int nBytesRead = 0;
	 ...
	 * @throws Exception
	 */
    public void playAudioFromByteStrean(ByteArrayOutputStream out, AudioFormat format) throws Exception {
	 ...
	 * @throws Exception
	 */
    public void playAudioFromByteArray(byte[] audio, AudioFormat format) throws Exception {
        ...
        Runnable runner = new Runnable() {
            ...
            int bufferSize = (int) _format.getSampleRate() * _format.getFrameSize();
