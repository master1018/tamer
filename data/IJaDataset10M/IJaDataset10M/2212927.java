...
public class EnableCollectionTest extends JDWPSyncTestCase {
    ...
    public void testEnableCollection001() {
        ...
        logWriter.println("=> Send ReferenceType::Fields command and get fieldID for field representing checked object...");
        long checkedFieldID = checkFields(refTypeID, new String[] { "checkedObject" })[0];
        logWriter.println("=> Send ReferenceType::GetValues command for received fieldID and get ObjectID to check...");
        ...
        CommandPacket disableCollectionCommand = new CommandPacket(JDWPCommands.ObjectReferenceCommandSet.CommandSetID, JDWPCommands.ObjectReferenceCommandSet.DisableCollectionCommand);
        ...
        CommandPacket checkedCommand = new CommandPacket(JDWPCommands.ObjectReferenceCommandSet.CommandSetID, JDWPCommands.ObjectReferenceCommandSet.EnableCollectionCommand);
        ...
        if (messageFromDebuggee.equals("Checked Object is NOT UNLOADed; Pattern Object is UNLOADed;")) {
            logWriter.println("## FAILURE: Checked Object is NOT UNLOADed after " + thisCommandName);
