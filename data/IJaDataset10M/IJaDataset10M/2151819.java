 ...
 */
public class CheckSegmentationErrorsAction extends org.exmaralda.coma.root.ComaAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            final SegmentationErrorsChecker checker = new SegmentationErrorsChecker(dialog.getSegmentationCode());
    ...
    private void displaySaveDialog(SegmentationErrorsChecker checker) {
        ...
        if (errorCount == 0) {
            ...
            String message = Integer.toString(errorCount) + Ui.getText("result.segErrorsFound");
            int choice = JOptionPane.showConfirmDialog(coma, message, Ui.getText("prompt.saveErrorList"), JOptionPane.YES_NO_OPTION);
                    ...
                    if (ret == JFileChooser.APPROVE_OPTION) {
                        try {
                            ...
                            if (new File(filename).exists()) {
                                int ret2 = JOptionPane.showConfirmDialog(coma, filename + "\n" + Ui.getText("msg.overwriteWarning"), "", JOptionPane.YES_NO_OPTION);
                                if (ret2 == JOptionPane.NO_OPTION) continue;
                            }
