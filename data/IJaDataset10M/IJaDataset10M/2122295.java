...
public final class Util {
   ...
   * {@link org.jostraca.comp.apache.oro.text.perl.Perl5Util#split}.
   * </ul>
   * <p>
   ...
   * @since 2.0
   */
    public static void split(Collection results, PatternMatcher matcher, Pattern pattern, String input) {
   ...
   */
    public static String substitute(PatternMatcher matcher, Pattern pattern, Substitution sub, String input, int numSubs) {
        ...
        if (substitute(buffer, matcher, pattern, sub, pinput, numSubs) != 0) return buffer.toString();
        return input;
    }
