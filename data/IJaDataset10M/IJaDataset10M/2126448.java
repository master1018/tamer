...
public class RngOutputFormat implements OutputFormat {
    ...
    public void output(SchemaCollection sc, OutputDirectory od, String[] params, String inputFormat, ErrorHandler eh) throws IOException, InvalidParamsException, SAXException {
    ...
    private static void outputPattern(SchemaDocument sd, String sourceUri, OutputDirectory od) throws IOException {
        ...
        Output.output(sd.getPattern(), sd.getEncoding(), sourceUri, od, analyzer.getDatatypeLibrary(), analyzer.getPrefixMap());
    }
}
