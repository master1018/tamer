...
public class VerletConstrainedSpring2D extends VerletSpring2D {
     ...
     * @param str
     */
    public VerletConstrainedSpring2D(VerletParticle2D a, VerletParticle2D b, float len, float str) {
        super(a, b, len, str);
    }
     ...
     * @param limit
     */
    public VerletConstrainedSpring2D(VerletParticle2D a, VerletParticle2D b, float len, float str, float limit) {
        super(a, b, len, str);
        this.limit = limit;
    }
