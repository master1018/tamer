...
public abstract class RelativisticParticle extends Particle {
    ...
    public boolean equals(Object p) {
        return (p != null) && (p instanceof RelativisticParticle) && (position.equals(((RelativisticParticle) p).position)) && (momentum.equals(((RelativisticParticle) p).momentum)) && (Math.abs(restMass() - ((RelativisticParticle) p).restMass()) <= GlobalSettings.ZERO_TOL);
    }
}
