...
public class TransitionNumericalRank extends NumericalRank {
     ...
     */
    public TransitionNumericalRank(int relativeRank, AttributeName att, Set<Transition> transitions, StateMachine sm, ONDEXGraph og, ComparisonMethod method, boolean invertedOrder, boolean modulusValues) {
        super(relativeRank, invertedOrder, modulusValues, att, og, method);
    ...
    public int compare(EvidencePathNode path1, EvidencePathNode path2) {
        ...
        if (containsRankableElements(path1)) {
            ...
            if (values != null) rv1 = getRelativeRank(values, method);
        }
        if (containsRankableElements(path2)) {
            ...
            if (values != null) rv2 = getRelativeRank(values, method);
        }
        if (invertedOrder) {
