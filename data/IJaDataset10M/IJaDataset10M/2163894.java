 ...
 * @version $Id: ExtendedHardCodedCryptoToken.java 1824 2011-08-10 08:34:42Z netmackan $
 */
public class ExtendedHardCodedCryptoToken extends HardCodedCryptoToken implements IExtendedCryptoToken {
    ...
    private static final byte[] RSA1024PRIVKEY = Base64.decode(("MIICdgIBADANBgkqhkiG9w0BAQEFAASCAmAwggJcAgEAAoGBAKIpzGrxOqOjquzj" + "ueBQIATX8cyU8Q7eCfkHI7heahyAf8B6du88DpbHl33UOD+1HEL78McOfqmzL/C5" + "2uszth/upCnFXruEudzBAjk7fZkul0Qf88qXeMBk1hC0jA3uLdZlwc3OnvJ+HG6s" + "s1vJG2njGPKtbjmXd8D6FRE+RafvAgMBAAECgYB5x2n75axjt0VlIJ82FPX2rTSo" + "rjFZOOXEXdg1XLHTNay6nz0x66gJE1pw5C5ZqWjP5OOsmPYF+srFvMzqVKsvlhwb" + "uZnKbyWvCeyMpSr4Ob+A+SvPKDK3IjL2wms3Csq9CWdqtFwGBcETTfGqjL/0PB2b" + "zsrNQ2Gi4tmaBwM6AQJBAP6rzYqoVemHpBtq493TfxMkttWg6q0AeTZJmvxlkcUE" + "CnKNk35ZWU+FoXsuV44n1w3Pu6Ri2iepyRHwLZIIdfMCQQCjAmvDQYcuwODYttdw" + "BH9zYEUW0v9v8/QuVGcggRFaFx0So8+kIKz68+IWh2LINns3u0ZzXx4dVZes5/wj" + "Q9kVAkEAzMmicwmCbFPipxmBOvPDj8VKMOdBTvS+g+UUeDnEykTBkfQ+0q9Onh+7" + "Bq7xQSLQUA7nuPy0qIhjY8VbH78l+QJAapzXvEGsV3DA3hxftRzL+rrZFP91H1SP" + "vIlpVYH0xlZdpmZLFM5mNE+z7AYqHkY7uoyanDR2rrrfU6/6YVorrQJAEI83lpYz" + "o4ywGKR1RpQ9EDctxRmV573kf80/QlYKuk/pchbRpPCIFXzlXuSLDYBS7jsc2mkW" + "J8+7q6Sl9X/rlA==").getBytes());

    private static final byte[] RSA1024PUBKEY = Base64.decode(("MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCiKcxq8Tqjo6rs47ngUCAE1/HM" + "lPEO3gn5ByO4XmocgH/AenbvPA6Wx5d91Dg/tRxC+/DHDn6psy/wudrrM7Yf7qQp" + "xV67hLncwQI5O32ZLpdEH/PKl3jAZNYQtIwN7i3WZcHNzp7yfhxurLNbyRtp4xjy" + "rW45l3fA+hURPkWn7wIDAQAB").getBytes());

    /**
     * @see org.signserver.server.cryptotokens.IExtendedCryptoToken#decryptData(java.lang.String, byte[])
     */
    public byte[] decryptData(String keyRef, byte[] data) throws CryptoTokenOfflineException {
        byte[] retval = null;
     ...
     */
    public byte[] encryptData(String keyRef, byte[] data) throws CryptoTokenOfflineException {
        byte[] retval = null;
        if (keyRef.startsWith(KEYREF_AES256KEY)) {
            try {
                SecretKey key = new SecretKeySpec(AES256KEY, "AES");
     ...
     */
    public Serializable genExportableKey(String keyAlg, String keySpec) throws IllegalRequestException, CryptoTokenOfflineException {
     ...
     */
    public String genNonExportableKey(String keyAlg, String keySpec) throws IllegalRequestException, CryptoTokenOfflineException {
