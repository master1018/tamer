...
public class NamedConfigurationDAOMysqlImplTest {
    ...
    public void setUp() {
        ...
        pluginRegistry.getGenerators().put(waitingGenerator.getId(), (Generator<GeneratorConfiguration, GeneratorStatistics>) (Generator<? extends GeneratorConfiguration, ? extends GeneratorStatistics>) waitingGenerator);
    }
    ...
    public void updateConfiguration_shouldIgnoreWhenNotFound() {
        NamedConfiguration config = new NamedConfiguration(1, 1, waitingGenerator.getId(), "Configuration 3", CONFIG_1_1_3, false);
    ...
    public void updateConfiguration_shouldThrowOnExistingName() {
        ...
        config_1_1_2.setAssociationType("1-1-2");
        config_1_1_2.setTimeout(2000);
        NamedConfiguration config = new NamedConfiguration(1, 1, waitingGenerator.getId(), "Configuration 1", config_1_1_2, false);
    ...
    public void updateConfiguration_shouldThrowOnNullPluginId() {
        NamedConfiguration config = new NamedConfiguration(1, 1, null, "Configuration 2", CONFIG_1_1_2, false);
        namedConfigurationDAO.updateConfiguration(config);
    }

    @Test(expected = NullPointerException.class)
    public void updateConfiguration_shouldThrowOnNullName() {
        NamedConfiguration config = new NamedConfiguration(1, 1, waitingGenerator.getId(), null, CONFIG_1_1_1, false);
        namedConfigurationDAO.updateConfiguration(config);
    }

    @Test(expected = NullPointerException.class)
    public void updateConfiguration_shouldThrowOnNullConfiguration() {
        NamedConfiguration config = new NamedConfiguration(1, 1, waitingGenerator.getId(), "Configuration 1", null, false);
        namedConfigurationDAO.updateConfiguration(config);
    }

    @Test(expected = NullPointerException.class)
    public void updateConfiguration_shouldThrowOnNullConfigurationName() {
        NamedConfiguration config = new NamedConfiguration(1, 1, waitingGenerator.getId(), "Configuration 1", CONFIG_NULL_NAME, false);
        namedConfigurationDAO.updateConfiguration(config);
    }
    ...
    public void createConfiguration_shouldSave() {
        NamedConfiguration namedConfiguration = new NamedConfiguration(1, 1, waitingGenerator.getId(), "Configuration 3", CONFIG_1_1_3, false);
    ...
    public void createConfiguration_shouldUpdateActive() {
        NamedConfiguration namedConfiguration = new NamedConfiguration(1, 1, waitingGenerator.getId(), "Configuration 3", CONFIG_1_1_3, true);
        int rowsAffected = namedConfigurationDAO.createConfiguration(namedConfiguration);
        assertThat(rowsAffected, is(1));
    }
    ...
    public void createConfiguration_shouldThrowOnNullPluginId() {
        NamedConfiguration namedConfiguration = new NamedConfiguration(1, 1, null, "Configuration 3", CONFIG_1_1_3, false);
        namedConfigurationDAO.createConfiguration(namedConfiguration);
    }

    @Test(expected = NullPointerException.class)
    public void createConfiguration_shouldThrowOnNullName() {
        NamedConfiguration namedConfiguration = new NamedConfiguration(1, 1, waitingGenerator.getId(), null, CONFIG_1_1_3, false);
        namedConfigurationDAO.createConfiguration(namedConfiguration);
    }

    @Test(expected = NullPointerException.class)
    public void createConfiguration_shouldThrowOnNullConfiguration() {
        NamedConfiguration namedConfiguration = new NamedConfiguration(1, 1, waitingGenerator.getId(), "Configuration 3", null, false);
        namedConfigurationDAO.createConfiguration(namedConfiguration);
    }

    @Test(expected = DuplicateKeyException.class)
    public void createConfiguration_shouldThrowOnDuplicateName() {
        NamedConfiguration namedConfiguration = new NamedConfiguration(1, 1, waitingGenerator.getId(), "Configuration 2", CONFIG_1_1_2, false);
        namedConfigurationDAO.createConfiguration(namedConfiguration);
    }
