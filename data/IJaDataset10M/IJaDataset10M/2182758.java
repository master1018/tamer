   ...
   */
    public void setCu(CU newCu) {
        if (newCu != cu) {
            ...
            if (cu != null) msgs = ((InternalEObject) cu).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - URefPackage.C3U__CU, null, msgs);
            if (newCu != null) msgs = ((InternalEObject) newCu).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - URefPackage.C3U__CU, null, msgs);
            msgs = basicSetCu(newCu, msgs);
            if (msgs != null) msgs.dispatch();
        } else {
            boolean oldCuESet = cuESet;
            cuESet = true;
            if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, URefPackage.C3U__CU, newCu, newCu, !oldCuESet));
        }
    }
   ...
   */
    public void unsetCu() {
        if (cu != null) {
            ...
            boolean oldCuESet = cuESet;
            cuESet = false;
            if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.UNSET, URefPackage.C3U__CU, null, null, oldCuESet));
        }
    }
