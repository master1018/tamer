...
public class Pitch implements Comparable<Pitch> {
    ...
    public void setPitchName(String pitchName) throws IllegalArgumentException {
        ...
        if (accidental.equals("n")) displacement = 0; else if (pn.getAccidentalChar() == 'f') displacement = -accidental.length();
        int morpheticOctave = asaOctaveNumber - 1;
        if (morph < 2) morpheticOctave++;
        chromaticModulus = 12;
        morpheticModulus = 7;
    ...
    public void setPitchNameClass(String pitchNameClass) {
        ...
        if (pn.getAccidental().equals("n")) morpheticLOFCycle = 0; else if (pn.getAccidentalChar().equals('f')) morpheticLOFCycle = -pn.getAccidental().length(); else morpheticLOFCycle = pn.getAccidental().length();
    ...
    public void setMIDINoteNumber(Integer midiNoteNumber) throws IllegalArgumentException {
        if (midiNoteNumber < 128 && midiNoteNumber > -1) throw new IllegalArgumentException("MIDI note number must be between 0 and 127, inclusive.");
    ...
    public void setBase40(Integer base40) {
        ...
        if (displacement == 0) accidental = "n"; else if (displacement > 0) {
            accidental = "";
    ...
    public String getPitchName() {
        ...
        if (l != null && a != null && o != null) return l + a + o;
        return null;
    }
    ...
    public String getPitchLetterName() {
        Integer m = getMorph();
        if (m != null) return "ABCDEFG".substring(m, m + 1);
        return null;
    }
    ...
    public String getAccidental() {
        ...
        if (displacement != null) {
            ...
            if (displacement != 0) {
                if (displacement < 0) accidentalChar = "f"; else accidentalChar = "s";
                for (int i = 0; i < Math.abs(displacement); i++) accidental += accidentalChar;
            } else accidental = "n";
            return accidental;
        }
        return null;
    ...
    public Integer getDisplacement() {
        ...
        if (lofPos != null) return Maths.floor(lofPos, getMorpheticModulus());
        return null;
    }
    ...
    public Integer getASAOctaveNumber() {
        ...
        Integer m = getMorph();
        if (o != null && m != null) if (m < 2) return o; else return o + 1;
        return null;
    }
    ...
    public Integer[] getChromamorpheticPitch() {
        ...
        if (cp != null && mp != null) return new Integer[] { cp, mp };
        return null;
    }
    ...
    public Integer getChromaticPitch() {
        if (chromaticPitch != null) return chromaticPitch;
        return null;
    }

    public Integer getContinuousPitchCode() {
        if (chromaticPitch != null) return chromaticPitch + 9;
        return null;
    }
    ...
    public Integer getMIDINoteNumber() {
        if (chromaticPitch != null) {
            ...
            if (m >= 0 && m < 128) return m;
        }
        return null;
    }

    public Integer getMorpheticPitch() {
        if (morpheticPitch != null) return morpheticPitch;
        return null;
    }

    public Integer getContinuousNameCode() {
        if (morpheticPitch != null) return morpheticPitch + 5;
        return null;
    }

    public Integer getDiatone() {
        if (morpheticPitch != null) return morpheticPitch - 17;
        return null;
    }

    public Integer getChroma() {
        if (chroma != null) return chroma;
        if (chromaticPitch != null) return Maths.mod(chromaticPitch, chromaticModulus);
        if (lofPos != null) return Maths.mod(8 + (7 * getLOFPosition()), getChromaticModulus());
        return null;
    }
    ...
    public Integer getMorph() {
        ...
        if (morpheticPitch != null) return Maths.mod(morpheticPitch, getMorpheticModulus());
        if (lofPos != null) return Maths.mod(5 + (4 * getLOFPosition()), getMorpheticModulus());
        return null;
    }
    ...
    public Integer getMorpheticLOFClass() {
        ...
        Integer m = getMorph();
        if (m != null) return Maths.mod(2 * (m - 5), getMorpheticModulus());
        return null;
    }
    ...
    public Integer getChromaticLOFClass() {
        ...
        Integer c = getChroma();
        if (c != null) return Maths.mod(7 * (c - 8), getChromaticModulus());
        return null;
    }
    ...
    public int compareTo(Pitch p) {
        ...
        if (getChromaticModulus() > p.getChromaticModulus()) return 1;
        if (getChromaticModulus() < p.getChromaticModulus()) return -1;
        if (getMorpheticModulus() > p.getMorpheticModulus()) return 1;
        if (getMorpheticModulus() < p.getMorpheticModulus()) return -1;
        if (getChromaticPitch() > p.getChromaticPitch()) return 1;
        if (getChromaticPitch() < p.getChromaticPitch()) return -1;
        if (getMorpheticPitch() > p.getMorpheticPitch()) return 1;
        if (getMorpheticPitch() < p.getMorpheticPitch()) return -1;
        if (getLOFPosition() > p.getLOFPosition()) return 1;
        if (getLOFPosition() < p.getLOFPosition()) return -1;
        if (getChroma() > p.getChroma()) return 1;
        if (getChroma() < p.getChroma()) return -1;
        if (getMorph() > p.getMorph()) return 1;
        if (getMorph() < p.getMorph()) return -1;
        return 0;
    }
    ...
    public boolean equals(Object obj) {
        ...
        Pitch p = (Pitch) obj;
        return (getChroma() == p.getChroma() && getMorph() == p.getMorph() && getChromaticPitch() == p.getChromaticPitch() && getMorpheticPitch() == p.getMorpheticPitch() && getLOFPosition() == p.getLOFPosition() && getChromaticModulus() == p.getChromaticModulus() && getMorpheticModulus() == p.getMorpheticModulus());
    }

    public String toString() {
        return "Pitch:" + (getPitchName() != null ? "\n Pitch name: " + getPitchName() : "") + (getPitchNameClass() != null ? "\n Pitch name class: " + getPitchNameClass() : "") + (getPitchLetterName() != null ? "\n Pitch letter name: " + getPitchLetterName() : "") + (getAccidental() != null ? "\n Accidental: " + getAccidental() : "") + (getDisplacement() != null ? "\n Displacement: " + getDisplacement() : "") + (getASAOctaveNumber() != null ? "\n Octave number: " + getASAOctaveNumber() : "") + (getChromamorpheticPitch() != null ? "\n Chromamorphetic pitch: " + getChromamorpheticPitch() : "") + (getContinuousBinomialRepresentation() != null ? "\n Continuous binomial representation (Brinkman): " + getContinuousBinomialRepresentation() : "") + (getChromaticPitch() != null ? "\n Chromatic pitch: " + getChromaticPitch() : "") + (getContinuousPitchCode() != null ? "\n Continuous pitch code (Brinkman): " + getContinuousPitchCode() : "") + (getMIDINoteNumber() != null ? "\n MIDI note number: " + getMIDINoteNumber() : "") + (getMorpheticPitch() != null ? "\n Morphetic pitch: " + getMorpheticPitch() : "") + (getContinuousNameCode() != null ? "\n Continuous name code (Brinkman): " + getContinuousNameCode() : "") + (getDiatone() != null ? "\n Diatone (Regener): " + getDiatone() : "") + (getChroma() != null ? "\n Chroma: " + getChroma() : "") + (getPitchClass() != null ? "\n Pitch class: " + getPitchClass() : "") + (getMorph() != null ? "\n Morph: " + getMorph() : "") + (getNameClass() != null ? "\n Name class (Brinkman): " + getNameClass() : "") + (getDiatonicNoteClass() != null ? "\n Diatonic note class (Regener): " + getDiatonicNoteClass() : "") + (getChromaticOctave() != null ? "\n Chromatic octave: " + getChromaticOctave() : "") + (getMorpheticOctave() != null ? "\n�Morphetic octave: " + getMorpheticOctave() : "") + (getLOFPosition() != null ? "\n Line-of-fifths position: " + getLOFPosition() : "") + (getQuint() != null ? "\n Quint (Regener): " + getQuint() : "") + (getSharpness() != null ? "\n Sharpness (Longuet-Higgins): " + getSharpness() : "") + (getTonalPitchClass() != null ? "\n Tonal pitch class (Temperley): " + getTonalPitchClass() : "") + (getMorpheticLOFClass() != null ? "\n Morphetic line-of-fifths class: " + getMorpheticLOFClass() : "") + (getMorpheticLOFCycle() != null ? "\n�Morphetic line-of-fifths cycle: " + getMorpheticLOFCycle() : "") + (getChromaticLOFClass() != null ? "\n�Chromatic line-of-fifths class: " + getChromaticLOFClass() : "") + (getChromaticLOFCycle() != null ? "\n�Chromatic line-of-fifths cycle: " + getChromaticLOFCycle() : "") + (getBase40() != null ? "\n�Base 40 (Hewlett): " + getBase40() : "");
    }
}
