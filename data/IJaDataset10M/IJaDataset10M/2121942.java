...
/**
 * Interface definition: CodingSchemeVersionAttributes.
 * 
 * @author OpenORB Compiler
 */
public class CodingSchemeVersionAttributesPOATie extends CodingSchemeVersionAttributesPOA {

    private CodingSchemeVersionAttributesOperations _tie;
     ...
     * Constructor
     */
    public CodingSchemeVersionAttributesPOATie(CodingSchemeVersionAttributesOperations tieObject) {
        _tie = tieObject;
    }
     ...
     * Constructor
     */
    public CodingSchemeVersionAttributesPOATie(CodingSchemeVersionAttributesOperations tieObject, org.omg.PortableServer.POA poa) {
        _tie = tieObject;
        _poa = poa;
    }
     ...
     * Get the delegate
     */
    public CodingSchemeVersionAttributesOperations _delegate() {
        return _tie;
    }
     ...
     * Set the delegate
     */
    public void _delegate(CodingSchemeVersionAttributesOperations delegate_) {
        _tie = delegate_;
    }
