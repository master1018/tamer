...
public class InsertCodeAdapter extends ClassAdapter {
    ...
    public InsertCodeAdapter(ClassVisitor delegate, String method_name, String method_desc, Map<Integer, byte[]> fragments, int max_locals, int max_stack) {
        super(delegate);
    ...
    static class MethodAdapter implements MethodVisitor {
        ...
        MethodAdapter(MethodVisitor delegate, Map<Integer, byte[]> fragments, int max_locals, int max_stack) {
            this.mv = delegate;
            this.fragments = fragments;
            this.max_locals = max_locals;
            this.max_stack = max_stack;
