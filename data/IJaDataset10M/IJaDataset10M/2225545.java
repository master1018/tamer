...
public class RPCliente extends FTabDados implements ActionListener {
    ...
    private final JButtonPad btCopiarEnt = new JButtonPad("copiar endere�o", Icone.novo("btReset.gif"));

    private final JButtonPad btCopiarCob = new JButtonPad("copiar endere�o", Icone.novo("btReset.gif"));
    ...
    private void montaListaCampos() {
        ...
        lcClienteCP.add(new GuardaCampo(txtCodCliCP, "CodCli", "C�d.cli.", ListaCampos.DB_PK, false));
        lcClienteCP.add(new GuardaCampo(txtRazCliCP, "RazCli", "Raz�o do cliente", ListaCampos.DB_SI, false));
    ...
    private void montaTela() {
        ...
        adicCampo(txtCodCli, 7, 30, 100, 20, "CodCli", "C�d.cli.", ListaCampos.DB_PK, true);
        adicCampo(txtRazCli, 110, 30, 300, 20, "RazCli", "Raz�o social do cliente", ListaCampos.DB_SI, true);
        ...
        adicCampo(txtInscCli, 210, 110, 200, 20, "InscCli", "Inscri��o", ListaCampos.DB_SI, false);
        adicCampo(txtEndCli, 7, 150, 403, 20, "EndCli", "Endere�o", ListaCampos.DB_SI, false);
        ...
        adicCampo(txtEndEnt, 7, 30, 403, 20, "EndEntCli", "Endere�o", ListaCampos.DB_SI, false);
        ...
        adicCampo(txtInscEnt, 210, 110, 200, 20, "InscEntCli", "Inscri��o", ListaCampos.DB_SI, false);
        adic(btCopiarEnt, 7, 150, 200, 30);
        adicTab("Cobran�a", panelCobranca);
        setPainel(panelCobranca);
        adicCampo(txtEndCob, 7, 30, 403, 20, "EndCobCli", "Endere�o", ListaCampos.DB_SI, false);
        ...
        adicCampo(txtCodTipoCli, 7, 20, 90, 20, "CodTipoCli", "C�d.tp.cli.", ListaCampos.DB_FK, txtDescTipoCli, true);
        adicDescFK(txtDescTipoCli, 100, 20, 290, 20, "DescTipoCli", "Descri��o do tipo de cliente");
        adicCampo(txtCodVend, 7, 60, 90, 20, "CodVend", "C�d.vend.", ListaCampos.DB_FK, txtNomeVend, true);
        adicDescFK(txtNomeVend, 100, 60, 290, 20, "NomeVend", "Nome do vendedor");
        adicCampo(txtCodPlanoPag, 7, 100, 90, 20, "CodPlanoPag", "C�d.p.pag.", ListaCampos.DB_FK, txtDescPlanoPag, false);
        adicDescFK(txtDescPlanoPag, 100, 100, 290, 20, "DescPlanoPag", "Descri��o do plano de pagamento");
        adicCampo(txtCodCliCP, 7, 140, 90, 20, "CodCliCP", "C�d.Cli.", ListaCampos.DB_FK, txtRazCliCP, false);
        adicDescFK(txtRazCliCP, 100, 140, 290, 20, "RazCli", "Raz�o do cliente principal");
        txtCodCliCP.setNomeCampo("codcli");
        setPainel(panelVenda);
    ...
    private void copiarEndereco(final String arg) {
        ...
        } else if ("cobran�a".equalsIgnoreCase(arg)) {
