...
public class SpeciesBindingsParser extends AbstractXMLObjectParser {
    ...
    ElementRule treeWithPloidy = new ElementRule(GTREE, new XMLSyntaxRule[] { AttributeRule.newDoubleRule(PLOIDY), new ElementRule(TreeModel.class) }, 0, Integer.MAX_VALUE);

    public XMLSyntaxRule[] getSyntaxRules() {
        return new XMLSyntaxRule[] { new ElementRule(SpeciesBindings.SPinfo.class, 2, Integer.MAX_VALUE), new ElementRule(GENE_TREES, new XMLSyntaxRule[] { new ElementRule(TreeModel.class, 0, Integer.MAX_VALUE), treeWithPloidy }) };
    }
