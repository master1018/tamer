 ...
 */
public class FederationServiceVoiceTalkConsumer extends FederationServiceConsumer {
    ...
    public void consume(FederationRequest service) throws FederationServiceConsumptionFailed {
        try {
            captureThread = SoundUtility.createCaptureThread(service.getFederationConnection().getOutputStream());
            soundOutputThread = SoundUtility.createSoundOutputThread(service.getFederationConnection().getInputStream());
        } catch (Exception e) {
