...
public final class IDirect3D9 {
     ...
     * @return
     */
    public final long checkDepthStencilMatch(int adapter, int deviceType, int adapterFormat, int renderTargetFormat, int depthStencilFormat) {
     ...
     * @return
     */
    public final long checkDeviceFormat(int adapter, int deviceType, int adapterFormat, int usage, int resoruceType, int checkFormat) {
     ...
     * @return
     */
    public final long checkDeviceMultiSampleType(int adapter, int deviceType, int surfaceFormat, boolean windowed, int multiSampleType, IntBuffer qualityLevels) {
     ...
     * @return
     */
    public final long checkDeviceType(int adapter, int deviceType, int displayFormat, int backBufferFormat, boolean windowed) {
     ...
     * @return
     */
    public final long createDevice(int adapter, int deviceType, long focusWindow, int behaviorFlags, D3DPresentParameters presentationParameters, IDirect3DDevice9 returnedDeviceInterface) {
     ...
     */
    public static final IDirect3D9 create() {
