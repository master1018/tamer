...
public class PerfStatistic {
    ...
    private Map<String, Map<String, int[]>> category_map = new HashMap<String, Map<String, int[]>>();
...
class StringFormatter implements Formatter {
    ...
    public void formatCountElement(StringBuffer sb, int[] cc, int count, Interval interval, int per) {
        sb.append("\t\t[" + interval.getFrom() + "-" + interval.getUntil() + "]" + "=>" + cc[count] + "|" + per).append("\n");
    }
...
class XMLFormatter implements Formatter {
    ...
    public void printHeader(StringBuffer sb) {
        ...
        sb.append("<enabled>").append(PerfLogging.getInstance().isPerfLogggingEnabled()).append("</enabled>").append("\n");
        sb.append("<active>").append(PerfLogging.getInstance().isPerfLoggingActive()).append("</active>").append("\n");
        sb.append("</status>").append("\n");
    }
    ...
    public void formatCountElement(StringBuffer sb, int[] cc, int count, Interval interval, int per) {
        sb.append("<count from=\"" + interval.getFrom() + "\" to=\"" + interval.getUntil() + "\" per=\"" + per + "\">" + cc[count++] + "</count>").append("\n");
    }
