...
final class SchemaTextFactory {
   ...
   */
    public static final CrawlHandler createSchemaTextCrawlHandler(final SchemaTextOptions options) throws SchemaCrawlerException {
        if (options == null) {
            throw new IllegalArgumentException("Options not provided");
        }
        final OutputFormat outputFormat = options.getOutputOptions().getOutputFormat();
