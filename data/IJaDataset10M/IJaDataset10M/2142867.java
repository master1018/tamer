...
/**
 * Adapter for server implementation of HTMLFormElementEvents
 */
public class HTMLFormElementEventsServer extends IDispatchServer implements HTMLFormElementEvents {

    public HTMLFormElementEventsServer(CoClassMetaInfo classImpl) {
        super(classImpl);
        registerMethods(HTMLFormElementEvents.class);
    }
    ...
    public VariantBool onsubmit() {
        throw new ComException(HResult.E_NOTIMPL);
    }

    public VariantBool onreset() {
        throw new ComException(HResult.E_NOTIMPL);
    }
}
