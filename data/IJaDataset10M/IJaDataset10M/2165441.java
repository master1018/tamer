...
public class LogEvent {
    ...
    public LogEvent(Downloader d) {
        ...
        if (d.getAmountRead() == d.getContentLength()) {
            this.message = "<html>Download Finished - <b>" + (f == null ? "Unknown" : f.getName()) + "</b> <i>(" + GUIUtils.toUnitbytes(d.getContentLength()) + ")</i></html>";
        } else {
            this.message = "<html>Download Cancelled - <b>" + (f == null ? "Unknown" : f.getName()) + "</b> <i>(" + GUIUtils.toUnitbytes(d.getAmountRead()) + " of " + GUIUtils.toUnitbytes(d.getContentLength()) + ")</i></html>";
        }
    }
