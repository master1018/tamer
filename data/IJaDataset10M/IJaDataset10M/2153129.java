                    ...
                    public void runSupport() {
                        ...
                        for (int i = 0; i < plugins.length; i++) {
                            ...
                            if (plugin.getAlreadyInstalledPlugin() == null) {
                                if (pluginList == null || pluginList.isDisposed()) return;
        ...
        AEThread detailsLoader = new AEThread("Detail Loader") {
            ...
            public void runSupport() {
                ...
                wizard.getDisplay().asyncExec(new AERunnable() {
                    ...
                    public void runSupport() {
                        if (pluginList == null || pluginList.isDisposed() || pluginList.getSelectionCount() == 0) return;
                        if (pluginList.getSelection()[0] != selected_item) return;
                        link_area.reset();
