   ...
   */
	 ...
	 */
        private void showHint() {
            ...
            Border in = BorderFactory.createEmptyBorder(margin.top, margin.left, margin.bottom, margin.right);
        ...
        public void mouseExited(MouseEvent e) {
            ...
            if (popup != null) {
                if (popup.isShowing()) {
                    ...
                    Rectangle2D hbBounds = new Rectangle2D.Double(los.getX(), los.getY(), dim.getWidth(), dim.getHeight());
                    los = popup.getLocationOnScreen();
                    dim = popup.getSize();
                    Rectangle2D popupBounds = new Rectangle2D.Double(los.getX(), los.getY(), dim.getWidth(), dim.getHeight());
    ...
    private static class Wrap extends JTextPane {
        ...
        public Dimension getPreferredSize() {
            ...
            float w = view.getPreferredSpan(View.X_AXIS) + insets.left + insets.right + margin.left + margin.right;
            float h = view.getPreferredSpan(View.Y_AXIS) + insets.bottom + insets.top + margin.bottom + margin.top;
