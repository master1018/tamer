...
class MidiConfigPanel extends ConfigPanel {
    ...
    MidiConfigPanel(PrefsDialog parent) {
        ...
        label.setToolTipText("MIDI message size." + " If zero, whole MIDI message is passed to lower MIDI driver." + " Normally set to zero.");
        p.add(label, c);
        c.gridx = 1;
    ...
    void init() {
        ...
        cbxEnMidi.setEnabled(MidiUtil.isOutputAvailable() || MidiUtil.isInputAvailable());
