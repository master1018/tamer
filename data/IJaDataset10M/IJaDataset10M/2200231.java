package org.activebpel.samples.script.schema;

public class AesProcessDetailType implements java.io.Serializable {

    private org.activebpel.samples.script.schema.AesProcessInstanceDetail response;

    public AesProcessDetailType() {
    }

    public AesProcessDetailType(org.activebpel.samples.script.schema.AesProcessInstanceDetail response) {
     ...
     * @return response
     */
    public org.activebpel.samples.script.schema.AesProcessInstanceDetail getResponse() {
        return response;
    }
     ...
     * @param response
     */
    public void setResponse(org.activebpel.samples.script.schema.AesProcessInstanceDetail response) {
        this.response = response;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = true && ((this.response == null && other.getResponse() == null) || (this.response != null && this.response.equals(other.getResponse())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(AesProcessDetailType.class, true);
