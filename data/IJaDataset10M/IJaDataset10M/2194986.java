...
import de.uniwue.tm.textmarker.kernel.expression.bool.BooleanExpression;
import de.uniwue.tm.textmarker.kernel.expression.list.ListExpression;
        ...
        if (union) {
            ...
            for (int i = 1; i < lists.size(); i++) {
                if (lastList != null) {
                    ...
                    lastList = ListUtils.intersection(lists.get(i - 1).getList(element.getParent()), lists.get(i).getList(element.getParent()));
                }
            }
            list = lastList;
        }
