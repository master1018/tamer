...
public class GoogleSpreadSheet implements Job {
            ...
            if (entry.getTitle().getPlainText().equalsIgnoreCase(documentName)) {
                ...
                for (int j = 0; j < worksheets.size(); j++) {
                    ...
                    if (listFeed.getEntries().size() > 0) {
                        ...
                        builderOut.append(header.toString().substring(0, header.lastIndexOf(",")));
                    }
                    for (ListEntry entrada : listFeed.getEntries()) {
                        StringBuilder row = new StringBuilder();
                        for (String tag : entrada.getCustomElements().getTags()) {
                            row.append(entrada.getCustomElements().getValue(tag) + ",");
                        }
                        builderOut.append(row.toString().substring(0, row.lastIndexOf(",")));
                    }
                }
            }
        }
    ...
    public GoogleSpreadSheet(String service, String username, String password, String feedurl, String documentName, String lastUpdate) {
    }

    public String load(String service, String username, String password, String feedurl, String documentName, String lastUpdate) throws Exception {
