...
public class MainWindow extends javax.swing.JPanel {
    ...
    public MainWindow(FieldManager fm, RemoteManagementWrapper wrapper) {
        ...
        for (int i = 0; i < numRootChildren; i++) {
            intervalMonitorFieldTree.expandPath(new TreePath(model.getPathToRoot(rootIntervalMonitors.getChildAt(i))));
        }
        numRootChildren = rootSnapShotMonitors.getChildCount();
        for (int i = 0; i < numRootChildren; i++) {
            snapShotMonitorTreeField.expandPath(new TreePath(model.getPathToRoot(rootSnapShotMonitors.getChildAt(i))));
        }
    }
    ...
    private void initComponents() {
        ...
        monitorTreeRefreshButton.setText(org.openide.util.NbBundle.getMessage(MainWindow.class, "MainWindow.monitorTreeRefreshButton.text"));
        ...
        jLabel3.setText(org.openide.util.NbBundle.getMessage(MainWindow.class, "MainWindow.jLabel3.text"));
        jLabel4.setText(org.openide.util.NbBundle.getMessage(MainWindow.class, "MainWindow.jLabel4.text"));
        jScrollPane2.setViewportView(snapShotMonitorTreeField);
        javax.swing.GroupLayout leftPanelLayout = new javax.swing.GroupLayout(leftPanel);
        leftPanel.setLayout(leftPanelLayout);
        leftPanelLayout.setHorizontalGroup(leftPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(leftPanelLayout.createSequentialGroup().addContainerGap().addComponent(jLabel3).addContainerGap(83, Short.MAX_VALUE)).addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE).addGroup(leftPanelLayout.createSequentialGroup().addContainerGap().addComponent(jLabel4).addContainerGap(80, Short.MAX_VALUE)).addComponent(monitorTreeScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, leftPanelLayout.createSequentialGroup().addContainerGap(98, Short.MAX_VALUE).addComponent(monitorTreeRefreshButton).addContainerGap()));
        leftPanelLayout.setVerticalGroup(leftPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, leftPanelLayout.createSequentialGroup().addContainerGap().addComponent(jLabel3).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(monitorTreeScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 216, Short.MAX_VALUE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(jLabel4).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(monitorTreeRefreshButton).addContainerGap()));
        ...
        bottomRightTabbedPanel.addTab(org.openide.util.NbBundle.getMessage(MainWindow.class, "MainWindow.detailsPanel.TabConstraints.tabTitle"), detailsPanel);
        textFieldsPanel.setLayout(new java.awt.BorderLayout());
        bottomRightTabbedPanel.addTab(org.openide.util.NbBundle.getMessage(MainWindow.class, "MainWindow.textFieldsPanel.TabConstraints.tabTitle"), textFieldsPanel);
        testFieldsPanel.setLayout(new java.awt.BorderLayout());
        bottomRightTabbedPanel.addTab(org.openide.util.NbBundle.getMessage(MainWindow.class, "MainWindow.testFieldsPanel.TabConstraints.tabTitle"), testFieldsPanel);
        jLabel1.setText(org.openide.util.NbBundle.getMessage(MainWindow.class, "MainWindow.jLabel1.text"));
        traceDetailTimeField.setEditable(false);
        traceDetailTimeField.setText(org.openide.util.NbBundle.getMessage(MainWindow.class, "MainWindow.traceDetailTimeField.text"));
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(MainWindow.class, "MainWindow.jLabel2.text"));
        traceDetailMonitorField.setEditable(false);
        traceDetailMonitorField.setText(org.openide.util.NbBundle.getMessage(MainWindow.class, "MainWindow.traceDetailMonitorField.text"));
        ...
        threadTraceDetailsPanelLayout.setHorizontalGroup(threadTraceDetailsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(threadTraceDetailsPanelLayout.createSequentialGroup().addContainerGap().addComponent(jLabel1).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(traceDetailTimeField, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(jLabel2).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(traceDetailMonitorField, javax.swing.GroupLayout.DEFAULT_SIZE, 214, Short.MAX_VALUE).addContainerGap()).addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 398, Short.MAX_VALUE));
        threadTraceDetailsPanelLayout.setVerticalGroup(threadTraceDetailsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(threadTraceDetailsPanelLayout.createSequentialGroup().addContainerGap().addGroup(threadTraceDetailsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel1).addComponent(traceDetailTimeField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel2).addComponent(traceDetailMonitorField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE)));
        bottomRightTabbedPanel.addTab(org.openide.util.NbBundle.getMessage(MainWindow.class, "MainWindow.threadTraceDetailsPanel.TabConstraints.tabTitle"), threadTraceDetailsPanel);
        rightSplitPane.setRightComponent(bottomRightTabbedPanel);
        baseSplitPane.setRightComponent(rightSplitPane);
        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(this);
        this.setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(baseSplitPane, javax.swing.GroupLayout.DEFAULT_SIZE, 591, Short.MAX_VALUE));
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(baseSplitPane, javax.swing.GroupLayout.DEFAULT_SIZE, 438, Short.MAX_VALUE));
    }

    private void monitorTreeRefreshButtonActionPerformed(java.awt.event.ActionEvent evt) {
        refreshMonitors();
    }

    private void intervalMonitorFieldTreeValueChanged(javax.swing.event.TreeSelectionEvent evt) {
    }

    private void intervalMonitorFieldTreeMouseClicked(java.awt.event.MouseEvent evt) {
    }

    private void traceDetailTimeFieldActionPerformed(java.awt.event.ActionEvent evt) {
    }
