...
public class CardMatch implements Recorder, Configurable {
    ...
    public void newProperties(PropertySheet ps) throws PropertyException {
        recognizer = (Recognizer) ps.getComponent(PROP_RECOGNIZER, Recognizer.class);
        grammar = (JSGFGrammar) ps.getComponent(PROP_GRAMMAR, JSGFGrammar.class);
        microphone = (Microphone) ps.getComponent(PROP_MICROPHONE, Microphone.class);
        doEndpointing = ps.getBoolean(PROP_DO_ENDPOINTING, PROP_DO_ENDPOINTING_DEFAULT);
