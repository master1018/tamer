package nakayo.gameserver.model.gameobjects;

import nakayo.gameserver.ai.AI;
import nakayo.gameserver.controllers.CreatureController;
import nakayo.gameserver.controllers.MoveController;
import nakayo.gameserver.controllers.ObserveController;
import nakayo.gameserver.controllers.attack.AggroList;
import nakayo.gameserver.controllers.effect.EffectController;
import nakayo.gameserver.model.gameobjects.player.Player;
import nakayo.gameserver.model.gameobjects.state.CreatureSeeState;
import nakayo.gameserver.model.gameobjects.state.CreatureState;
import nakayo.gameserver.model.gameobjects.state.CreatureVisualState;
import nakayo.gameserver.model.gameobjects.stats.CreatureGameStats;
import nakayo.gameserver.model.gameobjects.stats.CreatureLifeStats;
import nakayo.gameserver.model.templates.VisibleObjectTemplate;
import nakayo.gameserver.model.templates.spawn.SpawnTemplate;
import nakayo.gameserver.skillengine.effect.EffectId;
import nakayo.gameserver.skillengine.model.Skill;
import nakayo.gameserver.taskmanager.tasks.PacketBroadcaster;
import nakayo.gameserver.taskmanager.tasks.PacketBroadcaster.BroadcastMode;
import nakayo.gameserver.world.WorldPosition;
...
public abstract class Creature extends VisibleObject {
    ...
    public boolean isEnemy(VisibleObject visibleObject) {
        if (visibleObject instanceof Npc) return isEnemyNpc((Npc) visibleObject); else if (visibleObject instanceof Player) return isEnemyPlayer((Player) visibleObject); else if (visibleObject instanceof Summon) return isEnemySummon((Summon) visibleObject);
        return false;
    }
    ...
    public boolean canSee(VisibleObject visibleObject) {
        if (visibleObject instanceof Npc) return canSeeNpc((Npc) visibleObject); else if (visibleObject instanceof Player) return canSeePlayer((Player) visibleObject);
        return true;
    }
