...
public abstract class IDPListType implements java.io.Serializable {
     ...
     */
    public void addIDPEntry(final oasis.names.tc.SAML.v2_0.protocol.IDPEntry vIDPEntry) throws java.lang.IndexOutOfBoundsException {
     ...
     * given is outside the bounds of the collection
     */
    public void addIDPEntry(final int index, final oasis.names.tc.SAML.v2_0.protocol.IDPEntry vIDPEntry) throws java.lang.IndexOutOfBoundsException {
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (obj instanceof IDPListType) {
            ...
            } else if (temp._IDPEntryList != null) return false;
            ...
            } else if (temp._getComplete != null) return false;
            return true;
        }
        return false;
    }
     ...
     */
    public oasis.names.tc.SAML.v2_0.protocol.IDPEntry getIDPEntry(final int index) throws java.lang.IndexOutOfBoundsException {
    ...
    public int hashCode() {
        int result = 17;
        long tmp;
        if (_IDPEntryList != null && !org.castor.core.util.CycleBreaker.startingToCycle(_IDPEntryList)) {
            result = 37 * result + _IDPEntryList.hashCode();
            org.castor.core.util.CycleBreaker.releaseCycleHandle(_IDPEntryList);
        }
        if (_getComplete != null && !org.castor.core.util.CycleBreaker.startingToCycle(_getComplete)) {
     ...
     */
    public boolean removeIDPEntry(final oasis.names.tc.SAML.v2_0.protocol.IDPEntry vIDPEntry) {
     ...
     */
    public oasis.names.tc.SAML.v2_0.protocol.IDPEntry removeIDPEntryAt(final int index) {
     ...
     */
    public void setGetComplete(final java.lang.String getComplete) {
     ...
     * given is outside the bounds of the collection
     */
    public void setIDPEntry(final int index, final oasis.names.tc.SAML.v2_0.protocol.IDPEntry vIDPEntry) throws java.lang.IndexOutOfBoundsException {
        if (index < 0 || index >= this._IDPEntryList.size()) {
     ...
     */
    public void setIDPEntry(final oasis.names.tc.SAML.v2_0.protocol.IDPEntry[] vIDPEntryArray) {
        _IDPEntryList.clear();
