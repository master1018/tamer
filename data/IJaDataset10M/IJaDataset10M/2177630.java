...
public class DocumentTest extends WebTestCase {
     ...
     */
    @Test
    @Alerts(IE = { "0", "3", "3", "true", "id: firstLink" }, FF = { "0", "1", "1", "true", "name: end" })
     ...
     */
    @Test
    @Alerts(IE = { "DIV,DIV,undefined,undefined,undefined", "HI:DIV,HI:DIV,undefined,undefined,undefined" }, FF = { "DIV,DIV,null,null,DIV", "HI:DIV,HI:DIV,null,null,HI:DIV" })
    ...
    public void createElementNS() throws Exception {
        final String html = "<html><head><script>\n" + "function doTest() {\n" + "  var div = document.createElementNS('myNS', 'Some:Div');\n" + "  alert(div.nodeName + ',' + div.tagName + ',' + div.namespaceURI + ',' + " + "div.prefix + ',' + div.localName);\n" + "  var svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');\n" + "  alert(svg.nodeName + ',' + svg.tagName + ',' + svg.namespaceURI + ',' + " + "svg.prefix + ',' + svg.localName);\n" + "}\n" + "</script></head>\n" + "<body onload='doTest()'>\n" + "</body></html>";
        loadPageWithAlerts(html);
    }
     ...
     */
    @Test
    @Alerts(FF = { "<p>a & b</p> &amp; Ţ \" '", "<p>a & b</p> &amp; Ţ \" '", "undefined", "&lt;p&gt;a &amp; b&lt;/p&gt; &amp;amp; Ţ \" '", "undefined" }, IE = { "<p>a & b</p> &amp; Ţ \" '", "<p>a & b</p> &amp; Ţ \" '", "<DIV id=div>&lt;p&gt;a &amp; b&lt;/p&gt; &amp;amp; Ţ \" '</DIV>", "&lt;p&gt;a &amp; b&lt;/p&gt; &amp;amp; Ţ \" '", "<p>a & b</p> &amp; Ţ \" '" })
    ...
    public void getElementById_scriptId() throws Exception {
        final String html = "<html><head><title>First</title><script id='script1'>\n" + "function doTest() {\n" + "    alert(top.document.getElementById('script1').id);\n" + "}\n" + "</script></head><body onload='doTest()'>\n" + "</body></html>";
        loadPageWithAlerts(html);
    }
    ...
    public void referrer_NoneSpecified() throws Exception {
        final String html = "<html><head><title>First</title></head><body onload='alert(document.referrer);'>\n" + "</form></body></html>";
        loadPageWithAlerts(html);
    }
    ...
    public void url() throws Exception {
        final String html = "<html><head><title>First</title></head><body onload='alert(document.URL);'>\n" + "</form></body></html>";
        loadPageWithAlerts(html);
    }
    ...
    public void getElementsByTagName_Inline() throws Exception {
        final String html = "<html><body><script type=\"text/javascript\">\n" + "alert(document.getElementsByTagName('script').length);\n" + "</script></body></html>";
        loadPageWithAlerts(html);
    }
     ...
     */
    @Test
    @Alerts(FF = "exception", IE = { "a", "b", "a", "b", "0" })
     ...
     */
    @Test
    @Alerts(FF = { "false", "true" }, IE = { "true", "true" })
     ...
     */
    @Test
    @Alerts(FF3 = { "undefined", "undefined" }, FF3_6 = { "loading", "complete" }, IE = { "loading", "complete" })
     ...
     */
    @Test
    @Alerts(FF = { "null", "byId" }, IE = { "findMe", "byId" })
     ...
     */
    @Test
    @Alerts(FF = { "true", "false" }, IE = { "false", "true" })
     ...
     */
    @Test
    @Alerts(FF = "null", IE = { "[object]", "[object]", "true", "true", "true", "true", "true", "true" })
    @NotYetImplemented
     ...
     */
    @Test
    @Alerts(FF = { "[object StyleSheetList]", "0", "true" }, IE = { "[object]", "0", "true" })
     ...
     */
    @Test
    @Alerts(FF = { "off", "off", "on", "on", "on", "off", "off", "off", "off" }, IE = { "Off", "!", "Off", "Off", "Off", "!", "Off", "Off", "Off", "Off", "Off" })
     ...
     */
    @Test
    @Alerts(FF = { "off", "off", "on", "on", "on", "off", "off", "off", "off" }, IE = { "Inherit", "!", "Inherit", "On", "On", "!", "On", "Off", "Off", "Inherit", "Inherit" })
     ...
     */
    @Test
    @Alerts(FF = { "error", "error", "true", "true", "true" }, IE = { "true", "true", "true", "true", "true" })
     ...
     */
    @Test
    @Alerts(FF = { "true", "false" }, IE = { "true", "command foo not supported" })
     ...
     */
    @Test
    @Alerts(FF = { "1: null", "2: null", "3: [object HTMLBodyElement]" }, IE = { "1: null", "2: [object]", "3: [object]" })
     ...
     */
    @Test
    @Alerts(FF = { "1: [object HTMLBodyElement]", "2: [object HTMLBodyElement]" }, IE = { "1: null", "2: [object]" })
    ...
    public void getElementsByTagNameNS() throws Exception {
        ...
        final String xml = "<soap:Envelope xmlns:soap='http://schemas.xmlsoap.org/soap/envelope/'>\n" + "  <books xmlns='http://www.example.com/ns1'>\n" + "    <book>\n" + "      <title>Immortality</title>\n" + "      <author>John Smith</author>\n" + "    </book>\n" + "  </books>\n" + "</soap:Envelope>";
        final List<String> collectedAlerts = new ArrayList<String>();
        final WebClient client = getWebClient();
        client.setAlertHandler(new CollectingAlertHandler(collectedAlerts));
        final MockWebConnection conn = new MockWebConnection();
