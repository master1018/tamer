...
public class BpmnNewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
    public BpmnNewDiagramFileWizard(IFile selectedModelFile, IWorkbenchPage workbenchPage, IStructuredSelection selection, EObject diagramRoot, TransactionalEditingDomain editingDomain) {
        assert selectedModelFile != null : "Null selectedModelFile in BpmnNewDiagramFileWizard constructor";
        assert workbenchPage != null : "Null workbenchPage in BpmnNewDiagramFileWizard constructor";
        assert selection != null : "Null selection in BpmnNewDiagramFileWizard constructor";
        assert diagramRoot != null : "Null diagramRoot in BpmnNewDiagramFileWizard constructor";
        assert editingDomain != null : "Null editingDomain in BpmnNewDiagramFileWizard constructor";
    ...
    public void addPages() {
        myFileCreationPage = new WizardNewFileCreationPage("Initialize new Ecore diagram file", mySelection) {
            ...
            public void createControl(Composite parent) {
                ...
                String fileExtension = ".bpmn_diagram";
        ...
        myFileCreationPage.setDescription("Create new diagram based on " + BPMNDiagramEditPart.MODEL_ID + " model content");
    ...
    public boolean performFinish() {
        ...
        AbstractTransactionalCommand command = new AbstractTransactionalCommand(myEditingDomain, "Initializing diagram contents", affectedFiles) {
            ...
            protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
                int diagramVID = BpmnVisualIDRegistry.getDiagramVisualID(myDiagramRoot);
                ...
                Diagram diagram = ViewService.createDiagram(myDiagramRoot, BPMNDiagramEditPart.MODEL_ID, BpmnDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT);
        ...
        try {
            ...
            BpmnDiagramEditorPlugin.getInstance().logError("Save operation failed for: " + diagramFile.getFullPath().toString(), ex);
        } catch (PartInitException ex) {
            BpmnDiagramEditorPlugin.getInstance().logError("Unable to open editor", ex);
        }
        return true;
    }
    ...
    private class RootElementSelectorPage extends WizardPage implements ISelectionChangedListener {
        ...
        private void createModelBrowser(Composite parent) {
            ...
            treeViewer.setContentProvider(new AdapterFactoryContentProvider(BpmnDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory()));
            treeViewer.setLabelProvider(new AdapterFactoryLabelProvider(BpmnDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory()));
        ...
        private boolean validatePage() {
            ...
            boolean result = ViewService.getInstance().provides(new CreateDiagramViewOperation(new EObjectAdapter(myDiagramRoot), BPMNDiagramEditPart.MODEL_ID, BpmnDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT));
