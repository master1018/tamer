    ...
    public HelpView(final Controller controller, ViewManager viewManager) {
        ...
        AbstractAction generateAction = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (m >= k && m >= i) controller.readMKI(m, k, i);
            }
        };
        ...
        pane.add(headline);
        JLabel l = new JLabel("<HTML> <br> Bitte w&auml;hle die Gr&ouml;&szlig;e der Parameter, <br> um ein neues Programm zu schreiben! <br> &nbsp;</HTML>");
        ...
        ActionListener actionlistener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Integer k = ((Integer) boxK.getSelectedItem()).intValue();
                Integer i = ((Integer) boxI.getSelectedItem()).intValue();
                if (m >= k && m >= i) okButton.setEnabled(true); else okButton.setEnabled(false);
            }
        };
