...
public class DescribeVolumesSetItemResponseType implements org.apache.axis2.databinding.ADBBean {
    ...
    public DescribeVolumesSetItemResponseType() {
        localAttachmentSet = new AttachmentSetResponseType();
        localAvailabilityZone = "";
        localCreateTime = UtilSet.getDefaultCalendar();
        localSize = "";
        localSnapshotId = "";
        localStatus = "";
        localVolumeId = "";
    ...
    private static java.lang.String generatePrefix(java.lang.String namespace) {
        if (namespace.equals("http://vbs.cgl/")) {
            return "ns1";
        }
	 ...
	 */
    protected cgl.vbs.AttachmentSetResponseType localAttachmentSet;

    /**
	 * Auto generated getter method
	 * 
	 * @return cgl.vbs.AttachmentSetResponseType
	 */
    public cgl.vbs.AttachmentSetResponseType getAttachmentSet() {
	 ...
	 *            AttachmentSet
	 */
    public void setAttachmentSet(cgl.vbs.AttachmentSetResponseType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory, org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException {
        ...
        if (serializeType) {
            java.lang.String namespacePrefix = registerPrefix(xmlWriter, "http://vbs.cgl/");
        ...
        localAttachmentSet.serialize(new javax.xml.namespace.QName("http://vbs.cgl/", "attachmentSet"), factory, xmlWriter);
        xmlWriter.writeEndElement();
    }
    ...
    public static class Factory {
        ...
        public static DescribeVolumesSetItemResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeVolumesSetItemResponseType".equals(type)) {
                            ...
                            return (DescribeVolumesSetItemResponseType) cgl.vbs.ExtensionMapper.getTypeObject(nsUri, type, reader);
                        }
                    }
                }
                ...
                reader.next();
                while (!reader.isStartElement() && !reader.isEndElement()) reader.next();
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://vbs.cgl/", "volumeId").equals(reader.getName())) {
                ...
                while (!reader.isStartElement() && !reader.isEndElement()) reader.next();
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://vbs.cgl/", "size").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();
                ...
                while (!reader.isStartElement() && !reader.isEndElement()) reader.next();
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://vbs.cgl/", "snapshotId").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();
                ...
                while (!reader.isStartElement() && !reader.isEndElement()) reader.next();
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://vbs.cgl/", "availabilityZone").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();
                ...
                while (!reader.isStartElement() && !reader.isEndElement()) reader.next();
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://vbs.cgl/", "status").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();
                ...
                while (!reader.isStartElement() && !reader.isEndElement()) reader.next();
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://vbs.cgl/", "createTime").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();
                ...
                while (!reader.isStartElement() && !reader.isEndElement()) reader.next();
                if (reader.isStartElement() && new javax.xml.namespace.QName("http://vbs.cgl/", "attachmentSet").equals(reader.getName())) {
                    object.setAttachmentSet(cgl.vbs.AttachmentSetResponseType.Factory.parse(reader));
                    reader.next();
                } else {
                    throw new org.apache.axis2.databinding.ADBException("Unexpected subelement " + reader.getLocalName());
                }
