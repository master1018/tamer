...
public class ArrowButton extends JPanel {
        ...
        public void run() {
            while (!die) {
                try {
                    ...
                    int state;
                    synchronized (this) {
                        while ((target = this.target) == null) wait();
                        state = this.state;
                    }
                    sleep(DELAY_MS);
    ...
    public void setDirection(String d) {
        if (d.equals(LEFT)) direction = LEFT; else if (d.equals(RIGHT)) direction = RIGHT; else if (d.equals(UP)) direction = UP; else direction = DOWN;
        repaint();
    }
    ...
    protected void fireActionEvent() {
        if (listeners != null) {
            ActionEvent ev = new ActionEvent(this, ActionEvent.ACTION_PERFORMED, direction);
