...
public class DfFactoryImpl extends EFactoryImpl implements DfFactory {
    ...
    @Override
    public Action createAction(Tag tag, Pattern inputPattern, Pattern outputPattern, Pattern peekedPattern, Procedure scheduler, Procedure body) {
        ActionImpl action = new ActionImpl();
        action.setBody(body);
    ...
    @Override
    public Connection createConnection(Vertex source, Port sourcePort, Vertex target, Port targetPort, int size) {
    ...
    @Override
    public Connection createConnection(Vertex source, Port sourcePort, Vertex target, Port targetPort, Collection<Attribute> attributes) {
        Connection connection = createConnection(source, sourcePort, target, targetPort);
