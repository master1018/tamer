...
public class __builtin__ {
    ...
    public static PyString hex(PyObject o) {
        try {
            ...
            if (Py.matchException(e, Py.AttributeError)) throw Py.TypeError("hex() argument can't be converted to hex");
            throw e;
        }
    }
    ...
    public static PyObject vars(PyObject o) {
        try {
            ...
            if (Py.matchException(e, Py.AttributeError)) throw Py.TypeError("vars() argument must have __dict__ attribute");
            throw e;
        }
    }
