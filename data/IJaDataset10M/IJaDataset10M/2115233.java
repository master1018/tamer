...
public class CancelRequestEvent extends RequestEvent {
    ...
    public CancelRequestEvent(Object source, ServerTransaction serverTransaction, ServerTransaction matchingTransaction, Dialog dialog, Request request) {
    ...
    public String toString() {
        return new StringBuilder("CancelRequestEvent[ cancelST = ").append(getServerTransaction()).append(", inviteST = ").append(matchingTransaction).append(", inviteDialog = ").append(getDialog()).append(" ]").toString();
    }
}
