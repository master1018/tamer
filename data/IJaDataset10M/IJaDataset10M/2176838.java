...
public class XMLDBSource extends AbstractLogEnabled implements ModifiableTraversableSource, XMLizable {
    ...
    private void queryToSAX(ContentHandler handler, Collection collection, String resource) throws SAXException, XMLDBException {
        AttributesImpl attributes = new AttributesImpl();
        ...
        attributes.addAttribute("", RESULTS_COUNT_ATTR, RESULTS_COUNT_ATTR, "CDATA", Long.toString(resultSet.getSize()));
        handler.startDocument();
        handler.startPrefixMapping(PREFIX, URI);
    ...
    public SourceValidity getValidity() {
        try {
            ...
            if (resource != null && resource instanceof org.exist.xmldb.AbstractEXistResource) return new TimeStampValidity(((org.exist.xmldb.AbstractEXistResource) resource).getLastModificationTime().getTime());
        } catch (XMLDBException e) {
