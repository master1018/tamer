...
public class DumpHandler implements SampleHandler<SocialSparseVertex> {
    ...
    public SpatialGraph analyze(AdjacencyMatrix<SocialSparseVertex> y, long iteration) {
        ...
        logger.info(String.format("VarK(m)=%1$.4f, VarK(<k>)=%2$.4f, VarK(<c_local>)=%3$.4f, VarK(<d>)=%4$.4f", edges.coefficientOfVariance(), degree.coefficientOfVariance(), clustering.coefficientOfVariance(), distance.coefficientOfVariance()));
