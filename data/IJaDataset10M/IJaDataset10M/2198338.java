...
public class WeightDAOMysqlImpl extends AbstractTableCreatingDAOImpl implements WeightDAO {
    ...
    private static final class WeightMapper implements RowMapper {
    ...
    @SuppressWarnings("unchecked")
    public List<Weight> getWeightsForUser1AndItem(final Integer tenantId, final Integer user1Id, final Integer itemId, final Integer itemTypeId) {
        final StringBuilder query = new StringBuilder("SELECT ");
        query.append(DEFAULT_ID_COLUMN_NAME);
        query.append(", ");
        query.append(DEFAULT_TENANT_COLUMN_NAME);
    ...
    public void insertOrUpdateWeightSymmetric(final Weight weight) {
        ...
        query.append(DEFAULT_WEIGHT_COLUMN_NAME);
        query.append(" = ?");
        final Object[] args1 = new Object[] { weight.getUser1().getTenantId(), weight.getUser1().getUser(), weight.getUser2().getUser(), weight.getWeight(), weight.getWeight() };
        final Object[] args2 = new Object[] { weight.getUser1().getTenantId(), weight.getUser2().getUser(), weight.getUser1().getUser(), weight.getWeight(), weight.getWeight() };
