...
public class DataInputMapper extends ArrayList<DataInputElement> {
    ...
    public void buildMap(String schemaStr, String dataStr) {
        ...
        _formName = element.getAttributeValue("name");
        createDataInputElements(element, data, ns, -1);
    }

    private void createDataInputElements(Element schema, Element data, Namespace ns, int level) {
        ++level;
    ...
    private void createDataInputElement(Element field, Element data, Namespace ns, int level) {
