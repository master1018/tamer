...
public class ShipmentServices {
    ...
    private static boolean applyQuantityBreak(Map context, Map result, List storeAll, GenericDelegator delegator, GenericValue estimate, String prefix, String breakType, String breakTypeString) {
    ...
    public static Map updateShipmentsFromStaging(DispatchContext dctx, Map context) {
        ...
        try {
            ...
            while ((pkgInfo = (GenericValue) eli.next()) != null) {
                ...
                GenericValue shipmentPackage = delegator.findByPrimaryKey("ShipmentPackage", UtilMisc.toMap("shipmentId", shipmentId, "shipmentPackageSeqId", packageSeqId));
