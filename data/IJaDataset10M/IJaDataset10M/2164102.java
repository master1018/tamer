...
public class ClassPathDataDictionaryLoader implements DataDictionaryLoader {
    ...
    public DataDictionary loadDictionary(SessionID sessionId) {
        ...
        if (!(FixVersions.BEGINSTRING_FIX40.equals(beginString) || FixVersions.BEGINSTRING_FIX41.equals(beginString) || FixVersions.BEGINSTRING_FIX42.equals(beginString) || FixVersions.BEGINSTRING_FIX43.equals(beginString) || FixVersions.BEGINSTRING_FIX44.equals(beginString) || FixVersions.BEGINSTRING_FIXT11.equals(beginString))) {
