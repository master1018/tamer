...
public class TokenizerTest {
    ...
    public void testTokenize() {
        ...
        try {
            ...
            assertEquals("[+, -, 1, +, alphabet, " + "+, b, (, c, -, d, ), " + "*, _f, (, 5, !, ), " + "+, -, 1.033e-5, f, " + "/**, hi, */, " + "a, ||, b, &&, !, c]", tokens.toString());
            assertEquals("[PRE_UNARY_OPERATOR, PRE_UNARY_OPERATOR, NUMBER, MULTARY_OPERATOR, IDENTIFIER, " + "MULTARY_OPERATOR, IDENTIFIER, PARENTHETICAL_OPEN, IDENTIFIER, BINARY_OPERATOR, IDENTIFIER, PARENTHETICAL_CLOSE, " + "MULTARY_OPERATOR, IDENTIFIER, PARENTHETICAL_OPEN, NUMBER, POST_UNARY_OPERATOR, PARENTHETICAL_CLOSE, " + "MULTARY_OPERATOR, PRE_UNARY_OPERATOR, NUMBER, IDENTIFIER, " + "PARENTHETICAL_OPEN, IDENTIFIER, PARENTHETICAL_CLOSE, " + "IDENTIFIER, MULTARY_OPERATOR, IDENTIFIER, MULTARY_OPERATOR, PRE_UNARY_OPERATOR, IDENTIFIER]", types.toString());
