    ...
    public void testOffsetAndLimit() {
        ...
        for (int offset = 0; offset < 10; offset++) {
            for (int limit = 10; limit >= 0; limit--) {
                assertEquals("Failed with offset " + offset + " and limit " + limit, list.subList(offset, Math.min(offset + limit, list.size())), new SlicingIterable<Integer>(offset, limit, list));
            }
        }
    }
