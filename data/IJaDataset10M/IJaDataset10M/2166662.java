...
import fr.inria.papyrus.uml4tst.emftext.ocl.TupleLiteralExpCS;
import fr.inria.papyrus.uml4tst.emftext.ocl.VariableDeclarationWithInitListCS;
 ...
 * <ul>
 *   <li>{@link fr.inria.papyrus.uml4tst.emftext.ocl.impl.TupleLiteralExpCSImpl#getVariableDeclarations <em>Variable Declarations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TupleLiteralExpCSImpl extends LiteralExpCSImpl implements TupleLiteralExpCS {
    ...
    public void setVariableDeclarations(VariableDeclarationWithInitListCS newVariableDeclarations) {
        if (newVariableDeclarations != variableDeclarations) {
            ...
            if (variableDeclarations != null) msgs = ((InternalEObject) variableDeclarations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OclPackage.TUPLE_LITERAL_EXP_CS__VARIABLE_DECLARATIONS, null, msgs);
            if (newVariableDeclarations != null) msgs = ((InternalEObject) newVariableDeclarations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OclPackage.TUPLE_LITERAL_EXP_CS__VARIABLE_DECLARATIONS, null, msgs);
            msgs = basicSetVariableDeclarations(newVariableDeclarations, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, OclPackage.TUPLE_LITERAL_EXP_CS__VARIABLE_DECLARATIONS, newVariableDeclarations, newVariableDeclarations));
    }
