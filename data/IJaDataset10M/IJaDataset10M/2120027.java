...
public class DbTriggerBean extends DbBean {
    ...
    protected static String[] FIELDS = { "References" };
    ...
    public String getReference(String name) {
        ...
        try {
            String obj = null;
            if (ub.getDbglobal()) obj = "all_dependencies"; else obj = "user_dependencies";
            ...
            while (rs.next()) {
                ...
                if (CharSet.nullToEmpty(rs.getString(1)).equals(ub.getUsername().toUpperCase())) objectName = CharSet.nullToEmpty(rs.getString(2)); else objectName = CharSet.nullToEmpty(rs.getString(1)) + "." + CharSet.nullToEmpty(rs.getString(2));
