...
public class KeyLocator extends GenericXMLEncodable implements XMLEncodable, Serializable {
    ...
    */
    ...
    public KeyLocator clone() {
        return new KeyLocator(name(), key(), certificate());
    }
    ...
    public KeyLocatorType type() {
        if (null != certificate()) return KeyLocatorType.CERTIFICATE;
        if (null != key()) return KeyLocatorType.KEY;
    ...
    public boolean equals(Object obj) {
        ...
        } else if (!_keyName.equals(other.name())) return false;
        return true;
    }
