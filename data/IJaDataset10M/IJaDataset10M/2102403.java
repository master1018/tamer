...
public class epp_HostInfoRsp implements org.omg.CORBA.portable.IDLEntity {
   ...
   * @see #m_status
   */
    public void setStatus(org.openrtk.idl.epp0705.host.epp_HostStatus[] value) {
        m_status = value;
    }
   ...
   * @see #m_status
   */
    public org.openrtk.idl.epp0705.host.epp_HostStatus[] getStatus() {
        return m_status;
    }
   ...
   * @see #m_addresses
   */
    public void setAddresses(org.openrtk.idl.epp0705.host.epp_HostAddress[] value) {
        m_addresses = value;
    }
   ...
   * @see #m_addresses
   */
    public org.openrtk.idl.epp0705.host.epp_HostAddress[] getAddresses() {
        return m_addresses;
    }
   ...
   */
    public String toString() {
        return this.getClass().getName() + ": { m_rsp [" + m_rsp + "] m_name [" + m_name + "] m_roid [" + m_roid + "] m_status [" + (m_status != null ? java.util.Arrays.asList(m_status) : null) + "] m_addresses [" + (m_addresses != null ? java.util.Arrays.asList(m_addresses) : null) + "] m_client_id [" + m_client_id + "] m_created_by [" + m_created_by + "] m_created_date [" + m_created_date + "] m_updated_by [" + m_updated_by + "] m_updated_date [" + m_updated_date + "] m_transfer_date [" + m_transfer_date + "] }";
    }
}
