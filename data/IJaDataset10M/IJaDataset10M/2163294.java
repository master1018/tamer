...
public abstract class StreamUtil {
     ...
     */
    public static void base64Encode(InputStream inStream, OutputStream outStream) throws IOException {
     ...
     */
    public static void base64Decode(InputStream inStream, OutputStream outStream) throws IOException {
    ...
    public static void base64Decode(File inFile, File outFile) throws IOException {
        ...
        BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(baseOut));
