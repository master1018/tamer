 ...
 * @author Damien Roth
 */
public class AutoAwayConfigurationPanel extends TransparentPanel {
    ...
    private Component init() {
        ...
        JLabel autoStatusLabel = new JLabel(AutoAwayActivator.getResources().getI18NString("plugin.autoaway.AUTO_STATUS"));
        ...
        enable = new SIPCommCheckBox(AutoAwayActivator.getResources().getI18NString("plugin.autoaway.ENABLE_CHANGE_STATUS"));
        ...
        timerPanel.add(new JLabel(AutoAwayActivator.getResources().getI18NString("plugin.autoaway.AWAY_MINUTES")));
    ...
    private void initValues() {
        ConfigurationService configService = AutoAwayActivator.getConfigService();
    ...
    private void saveData() {
        ConfigurationService configService = AutoAwayActivator.getConfigService();
        configService.setProperty(Preferences.ENABLE, Boolean.toString(enable.isSelected()));
