...
public class RegistrationInstructionsResponse extends Message {
    ...
    public RegistrationInstructionsResponse(quickfix.field.RegistID aRegistID, quickfix.field.RegistTransType aRegistTransType, quickfix.field.RegistRefID aRegistRefID, quickfix.field.RegistStatus aRegistStatus) {
        getHeader().setField(new MsgType("p"));
        set(aRegistID);
