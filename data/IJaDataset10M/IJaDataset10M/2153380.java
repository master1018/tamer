...
public class JDBCCallableStatementTest extends BaseJdbcTestCase {
    ...
    public void testGetInt() throws Exception {
        ...
        int result = 0;
        try {
            stmt = prepRegAndExec("{?= call cast(1 as integer)}", 1, Types.INTEGER);
    ...
    public void testGetLong() throws Exception {
        ...
        long result = 0;
        try {
            stmt = prepRegAndExec("{?= call cast(1 as bigint)}", 1, Types.BIGINT);
    ...
    public void testGetBigDecimal() throws Exception {
        ...
        try {
            stmt = prepRegAndExec("{?= call cast(1.00 as decimal(3,2))}", 1, Types.DECIMAL);
    ...
    public void testGetDate() throws Exception {
        ...
        Date result = null;
        try {
            stmt = prepRegAndExec("{?= call cast('2005-12-13' as date)}", 1, Types.DATE);
    ...
    public void testGetTime() throws Exception {
        ...
        Time result = null;
        try {
            stmt = prepRegAndExec("{?= call cast('11:12:02' as time)}", 1, Types.TIME);
    ...
    public void testGetTimestamp() throws Exception {
        ...
        try {
            stmt = prepRegAndExec("{?= call cast('2005-12-13 11:23:02.1234' as timestamp(6))}", 1, Types.TIMESTAMP);
    ...
    public void testGetObject() throws Exception {
        ...
        Object temp = null;
        try {
            stmt = prepRegAndExec("{?= call cast(X'cafebabe' as object)}", 1, Types.OTHER);
    ...
    public void testGetBlob() throws Exception {
        ...
        Blob result = null;
        try {
            stmt = prepRegAndExec("{?= call cast(X'cafe' as binary(2))}", 1, Types.BINARY);
    ...
    public void testGetArray() throws Exception {
        ...
        Array array = null;
        try {
            stmt = prepRegAndExec("{?= call cast(ARRAY['one','two','three'] as VARCHAR(5) ARRAY[3])}", 1, Types.ARRAY);
    ...
    public void testSetObject_LONGVARBINARY() throws Exception {
        ...
        setObjectTest("longvarbinary(" + bytes.length + ")", bytes, Types.LONGVARBINARY);
    }
    ...
    public void testSetObject_LONGVARCHAR() throws Exception {
        setUpDualTable();
        setObjectTest("longvarchar", "setObject_longvarchar", Types.LONGVARCHAR);
    }
    ...
    public void testSetObject_VARBINARY() throws Exception {
        ...
        setObjectTest("varbinary(" + bytes.length + ")", bytes, Types.VARBINARY);
    }
    ...
    public void testSetCharacterStream() throws Exception {
        setUpDualTable();
        prepareCall("select cast(? as varchar(18)) from dual").setCharacterStream("@p1", new java.io.StringReader("setCharacterStream"), "setCharacterStream".length());
    }
    ...
    public void testSetNCharacterStream() throws Exception {
        setUpDualTable();
        prepareCall("select cast(? as varchar(18)) from dual").setNCharacterStream("@p1", new java.io.StringReader("setCharacterStream"), "setCharacterStream".length());
    }
    ...
    public void testGetNClob() throws Exception {
        ...
        NClob result = null;
        try {
            stmt = prepRegAndExec("{?= call cast('getString' as longvarchar)}", 1, Types.LONGVARCHAR);
    ...
    public void testGetNString() throws Exception {
        ...
        String result = null;
        try {
            stmt = prepRegAndExec("{?= call cast('getString' as varchar(9))}", 1, Types.VARCHAR);
