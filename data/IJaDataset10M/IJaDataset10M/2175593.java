...
public class OperationCallImpl extends OperationStepImpl implements OperationCall {
    ...
    public Operation getOperation() {
        if (operation != null && operation.eIsProxy()) {
            ...
            if (operation != oldOperation) {
                if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESyntaxPackage.OPERATION_CALL__OPERATION, oldOperation, operation));
            }
        }
        return operation;
    }
   ...
   */
    public void setOperation(Operation newOperation) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, ESyntaxPackage.OPERATION_CALL__OPERATION, oldOperation, operation));
    }
