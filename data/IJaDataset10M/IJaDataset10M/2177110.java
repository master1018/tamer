package com.sodad.weka.gui.sql;
...
import com.sodad.weka.gui.DatabaseConnectionDialog;
import com.sodad.weka.gui.ListSelectorDialog;
import com.sodad.weka.gui.sql.event.ConnectionEvent;
import com.sodad.weka.gui.sql.event.ConnectionListener;
import com.sodad.weka.gui.sql.event.HistoryChangedEvent;
import com.sodad.weka.gui.sql.event.HistoryChangedListener;
...
public class ConnectionPanel extends JPanel implements CaretListener {
   ...
   */
    public void setHistory(DefaultListModel history) {
        int i;
        m_History.clear();
        for (i = 0; i < history.size(); i++) m_History.addElement(history.get(i));
        setButtons();
    }
