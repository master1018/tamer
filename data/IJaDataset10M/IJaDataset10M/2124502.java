...
public class CLMem extends OpenCL {
    ...
    private native int _createImage3Dbyte(int cid, int memFlags, CLImageFormat imageFormat, int imageW, int imageH, int imageD, int imageRowPitch, int imageSlicePitch, byte[] buffer);
