...
public class DnaDnaAlignFeatureAdaptorTest extends ComparaBase {
    ...
    private static Logger logger = Logger.getLogger(GenomeDBAdaptorTest.class.getName());
    ...
    public void testFetch() {
        try {
            ...
            List theDnaAligns = comparaDriver.getDnaDnaAlignFeatureAdaptor().fetch("Homo sapiens", tmp, "Mus musculus", "BLASTZ_NET");
