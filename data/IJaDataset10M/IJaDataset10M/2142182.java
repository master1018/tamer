...
public class ContentUrisTest extends AndroidTestCase {
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test parseId(Uri contentUri).", method = "parseId", args = { android.net.Uri.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test withAppendedId(Uri contentUri, long id).", method = "withAppendedId", args = { android.net.Uri.class, long.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test appendId(Builder builder, long id).", method = "appendId", args = { android.net.Uri.Builder.class, long.class })
