    ...
    public abstract class Options extends ScriptableDelegate implements SelectionOptions {
        ...
        Options(Node selectionNode) {
            ...
            for (int i = 0; i < _options.length; i++) {
                ...
                _options[i] = new Option(displayedText, getOptionValue(nl.item(i), displayedText), nl.item(i).getAttributes().getNamedItem("selected") != null);
        ...
        public Object get(int index) {
            if (index < 0 || index >= _options.length) {
                ...
                for (int i = 0; i < _options.length; i++) {
                    ...
                    if (i < _options.length - 1) msg = msg + ",";
                }
