...
public class ModelColor {
    ...
    public void setHSV(double _h, double _s, double _v) {
        if (Math.abs(H - _h) > 0.499999) H = _h;
        if (Math.abs(S - _s) > 0.009999) S = _s;
        if (Math.abs(V - _v) > 0.009999) V = _v;
        if ((S > 1.0) || (S < 0.0)) S = (S < 0.0) ? 0.0 : 1.0;
        if ((V > 1.0) || (V < 0.0)) V = (V < 0.0) ? 0.0 : 1.0;
        calculateRGBfromHSV();
    }
    ...
    private void calculateHSVfromRGB() {
        ...
        if (!exactMatch) {
            ...
            S = (rgbMaxValue > 0) ? 1.0 * (rgbMaxValue - rgbMinValue) / rgbMaxValue : 0.0;
            V = rgbMaxValue / 255.0;
            if (h < 0.1666668f) h *= 2.0f; else if (h < 0.3333334f) h += 0.1666667f; else if (h < 0.6666668f) h = h + 0.1666667f * ((0.6666667f - h) / 0.3333334f);
            H = 360.0 * h;
        }
    }
    ...
    private void calculateRGBfromHSV() {
        double h = H / 360.0;
        if (h < 0.3333334) h /= 2.0; else if (h < 0.5000001) h -= 0.1666667; else if (h < 0.6666668) h = 2.0 * h - 0.6666667;
