...
public class point_distance_attenuationType2 extends homura.hde.util.xml.xml.Node {

    public point_distance_attenuationType2(point_distance_attenuationType2 node) {
        super(node);
    }

    public point_distance_attenuationType2(org.w3c.dom.Node node) {
        super(node);
    }

    public point_distance_attenuationType2(org.w3c.dom.Document doc) {
        super(doc);
    }

    public point_distance_attenuationType2(homura.hde.util.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "point_distance_attenuation");
    }
    ...
    public float3 newvalue2() {
        return new float3();
    }

    public float3 getvalue2At(int index) throws Exception {
        return new float3(getDomNodeValue(getDomChildAt(Attribute, null, "value", index)));
    }
    ...
    public float3 getvalue2ValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
    ...
    public float3 getvalue2() throws Exception {
    ...
    public org.w3c.dom.Node addvalue2(float3 value) {
    ...
    public org.w3c.dom.Node addvalue2(String value) throws Exception {
        return addvalue2(new float3(value));
    }

    public void insertvalue2At(float3 value, int index) {
    ...
    public void insertvalue2At(String value, int index) throws Exception {
        insertvalue2At(new float3(value), index);
    }

    public void replacevalue2At(float3 value, int index) {
    ...
    public void replacevalue2At(String value, int index) throws Exception {
        replacevalue2At(new float3(value), index);
    }
