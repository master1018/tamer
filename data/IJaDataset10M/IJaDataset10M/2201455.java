...
public class StringSelectionListBinder extends AbstractBinder {
    ...
    public void setAddNull(boolean addNull) {
        ...
        if (addNull && labels != null && keys == null) throw new IllegalStateException("Keys should be defined before labels!");
        if (addNull && keys != null) {
            keys.add(null);
            if (labels != null) labels.add(null);
        }
    }
    ...
    protected Binding doBind(JComponent component, FormModel formModel, String formPropertyPath, Map context) {
        StringSelectionListBinding stringSelectionListBinding = new StringSelectionListBinding((JComboBox) component, formModel, formPropertyPath, isReadOnly());
        stringSelectionListBinding.setId(getLabelId());
        stringSelectionListBinding.setDefaultKeyIndex(defaultKeyIndex);
        if (getKeys() != null) stringSelectionListBinding.setSelectionList(getKeys(), getLabels() == null ? getKeys() : getLabels());
