...
public class VisADApplet extends Applet implements ActionListener, MouseListener, MouseMotionListener, WidgetListener {
   ...
   */
    private void addComponent(Component c, GridBagLayout layout, int x, int y, int w, int h, double wx, double wy) {
                        ...
                        if (w == -1) {
                            ...
                            if (message.startsWith("visad.ScalarMap\n")) {
                                ...
                                if (displayScalar.equals("DisplayIsoContour")) {
                                    ...
                                    ContourWidget widget = (ContourWidget) hashtable.get(widgetHash);
                                ...
                                String widgetName = controlClass.substring(dotIndex + 1, ctrlIndex);
                                ...
                                if (widget == null) {
                                    try {
                                        ...
                                        if (DEBUG) {
                                            System.err.println("Warning: ignoring status of " + "unknown " + widgetName + " widget.");
                                        }
                                    } catch (InstantiationException exc) {
                                        if (DEBUG) {
                                            System.err.println("Warning: ignoring status of " + "invalid " + widgetName + "widget.");
                                        }
                                    } catch (IllegalAccessException exc) {
                                        if (DEBUG) {
                                            System.err.println("Warning: ignoring status of " + "restricted " + widgetName + "widget.");
                                        }
                                    }
