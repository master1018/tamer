...
public class AddressBookDemo extends JFrame {
    ...
    private final JList lstPeople = new JList(new String[] { "Bunny, Bugs", "Cat, Sylvester", "Coyote, Wile E.", "Devil, Tasmanian", "Duck, Daffy", "Fudd, Elmer", "Le Pew, Pepe", "Martian, Marvin" });
