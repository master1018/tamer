...
public class epp_Command implements org.omg.CORBA.portable.IDLEntity {
   ...
   * @see #m_creds
   */
    public void setCreds(org.openrtk.idl.epp0604.epp_Credentials value) {
        m_creds = value;
    }
   ...
   * @see #m_creds
   */
    public org.openrtk.idl.epp0604.epp_Credentials getCreds() {
        return m_creds;
    }
   ...
   * @deprecated
   */
    public org.openrtk.idl.epp0604.epp_Extension getExtension() {
        return m_extensions == null ? null : m_extensions[0];
    }
   ...
   * @see #m_extensions
   */
    public void setExtensions(org.openrtk.idl.epp0604.epp_Extension[] value) {
        m_extensions = value;
    }
   ...
   * @see #m_extensions
   */
    public org.openrtk.idl.epp0604.epp_Extension[] getExtensions() {
        return m_extensions;
    }
   ...
   */
    public void setUnspec(org.openrtk.idl.epp0604.epp_Unspec value) {
        setExtension(value);
    }
   ...
   */
    public org.openrtk.idl.epp0604.epp_Unspec getUnspec() {
   ...
   */
    public String toString() {
        return this.getClass().getName() + ": { m_creds [" + m_creds + "] m_extensions [" + (m_extensions != null ? java.util.Arrays.asList(m_extensions) : null) + "] m_client_trid [" + m_client_trid + "] }";
    }
}
