...
public abstract class BaseChatPanel extends JPanel implements ConnectionContext.ConnectionContextListener {
    ...
    public void setConnectionContext(ConnectionContext ctx) {
        if (this.connectionContext != null) this.connectionContext.removeConnectionListener(this);
