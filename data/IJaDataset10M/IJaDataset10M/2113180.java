 ...
 * @since 1.0
 * @version $Id: RangeLookupOpImage.java 1716 2011-06-16 08:06:09Z michael.bedward $
 */
public class RangeLookupOpImage extends PointOpImage {
    ...
    protected void computeRect(Raster[] sources, WritableRaster dest, Rectangle destRect) {
        ...
        RasterAccessor srcAcc = new RasterAccessor(source, srcRect, formatTags[0], getSourceImage(0).getColorModel());
