...
/**
 * Provides unit tests for the <code>ComplexSentenceAND</code> class.
 *
 * @author   Jeffrey M. Thompson
 * @version  v0.4
 * @since    v0.2
 */
public class ComplexSentenceANDTest extends AbstractComplexSentenceTest {
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(ComplexSentenceANDTest.class);
    }
    ...
    public void testEvaluate() {
        ...
        try {
            Object[][] truthTable = { { SentenceFactory.FALSE, SentenceFactory.FALSE, Boolean.FALSE }, { SentenceFactory.FALSE, SentenceFactory.TRUE, Boolean.FALSE }, { SentenceFactory.TRUE, SentenceFactory.FALSE, Boolean.FALSE }, { SentenceFactory.TRUE, SentenceFactory.TRUE, Boolean.TRUE } };
            for (int i = 0; i < truthTable.length; i++) {
                ...
                IComplexSentence sentence = new ComplexSentenceAND(left, right);
    ...
    public void testToDebugString() {
        String expected0 = "org.vizzini.ai.logic.ComplexSentenceAND [connective=AND,description=null,left=(org.vizzini.ai.logic.LiteralArgument [argument=Literal,value=true] null org.vizzini.ai.logic.LiteralArgument [argument=Literal,value=true]),right=(org.vizzini.ai.logic.LiteralArgument [argument=Literal,value=true] null org.vizzini.ai.logic.LiteralArgument [argument=Literal,value=true]),sentenceType=Complex]";
        System.out.println("expected = " + _sentence0.toDebugString());
        assertEquals(expected0, _sentence0.toDebugString());
        String expected1 = "org.vizzini.ai.logic.ComplexSentenceAND [connective=AND,description=null,left=(org.vizzini.ai.logic.LiteralArgument [argument=Literal,value=value0] is org.vizzini.ai.logic.LiteralArgument [argument=Literal,value=value0]),right=(org.vizzini.ai.logic.LiteralArgument [argument=Literal,value=value0] is org.vizzini.ai.logic.PropertyArgument [argument=Property,propertyName=someProperty]),sentenceType=Complex]";
    ...
    protected ISentence create() {
        return new ComplexSentenceAND(LEFT_S0, RIGHT_S0);
    }
    ...
    protected ISentence create1() {
        return new ComplexSentenceAND(LEFT_S1, RIGHT_S1);
    }
}
