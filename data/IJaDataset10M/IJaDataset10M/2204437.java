 ...
 */
public class Validate extends FieldValidator implements java.io.Serializable {
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (net.sf.dynxform.form.schema.Validate) Unmarshaller.unmarshal(net.sf.dynxform.form.schema.Validate.class, reader);
    }
