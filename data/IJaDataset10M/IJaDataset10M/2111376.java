...
public class DateTimeFormat_de_Test extends DateTimeFormatTestBase {
    ...
    public void test_EEEEMMMddyy() {
        ...
        assertEquals("Donnerstag,Juli 27, 2006", DateTimeFormat.getFormat("EEEE,MMMM dd, yyyy").format(date));
    }

    public void test_EEEMMMddyy() {
        Date date = new Date(2006 - 1900, 6, 27, 13, 10, 10);
        assertEquals("Do., Jul 27, 06", DateTimeFormat.getFormat("EEE, MMM d, yy").format(date));
    }
    ...
    public void test_hhmmssa() {
        Date date = new Date(2006 - 1900, 6, 27, 13, 10, 10);
        assertEquals("1:10:10 nachm.", DateTimeFormat.getFormat("h:mm:ss a").format(date));
    }
    ...
    public void test_yyyyyMMMMM() {
        Date date = new Date(2006 - 1900, 6, 27, 13, 10, 10);
        assertEquals("02006.J.27 n. Chr. 01:10 nachm.", DateTimeFormat.getFormat("yyyyy.MMMMM.dd GGG hh:mm aaa").format(date));
    }
