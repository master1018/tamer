...
public class SinglePropertyValueComponent extends JFormattedTextField implements IPropertyComponent, KeyListener, PropertyChangeListener {
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (o == null) label = null; else label = (JLabel) o;
        updateLabel();
    }
    ...
    protected void updateLabel() {
        ...
        String str = getText();
        if (str != null && str.length() > 0) label.setForeground(Color.black); else label.setForeground(Color.red);
    }

    protected void updateValue() {
        if (model == null) return;
        Object v = model.getValue();
        if (v == null) v = model.getDbValue();
        if (v == null) v = model.getDefaultValue();
        setValue(v);
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            c = new SinglePropertyValueComponent(p1);
        } catch (Exception e1) {
        }
        ...
        try {
            c = new SinglePropertyValueComponent(p2);
        } catch (Exception e1) {
        }
        ...
        try {
            c = new SinglePropertyValueComponent(p3);
        } catch (Exception e1) {
        }
        ...
        try {
            c = new SinglePropertyValueComponent(p4);
        } catch (Exception e1) {
        }
