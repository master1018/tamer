...
/**
 * This is a default implementation of the IFC object IfcTableRow<br><br>
 * 
 ...
 **/
public class IfcTableRow implements IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "LIST<IfcValue>", "BOOLEAN" };
    ...
    public IfcTable OfTable_Inverse;
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("RowCells")) stepString = stepString.concat("*,"); else {
            if (this.RowCells != null) stepString = stepString.concat(((IfcRootInterface) this.RowCells).getStepParameter(IfcValue.class.isInterface()) + ","); else stepString = stepString.concat("$,");
        }
        if (getRedefinedDerivedAttributeTypes().contains("IsHeading")) stepString = stepString.concat("*);"); else {
            if (this.IsHeading != null) stepString = stepString.concat(((IfcRootInterface) this.IsHeading).getStepParameter(BOOLEAN.class.isInterface()) + ");"); else stepString = stepString.concat("$);");
        }
        return stepString;
    }
    ...
    /**
	 * This method returns the value of the RowCells attribute.
	 * 
	 * @return the value of RowCells
	 *         /
	 **/
    ...
    /**
	 * This method sets the OfTable_Inverse attribute to the given value.
	 * 
	 * @param OfTable_Inverse value to set
	 *            /
	 **/
    public void setOfTable_Inverse(IfcTable OfTable_Inverse) {
        this.OfTable_Inverse = OfTable_Inverse;
        fireChangeEvent();
    }
    ...
    public Object clone() {
        ...
        if (this.RowCells != null) ifcTableRow.setRowCells((LIST<IfcValue>) this.RowCells.clone());
        if (this.IsHeading != null) ifcTableRow.setIsHeading((BOOLEAN) this.IsHeading.clone());
        return ifcTableRow;
    }
    ...
    public Object shallowCopy() {
        IfcTableRow ifcTableRow = new IfcTableRow();
        if (this.RowCells != null) ifcTableRow.setRowCells(this.RowCells);
        if (this.IsHeading != null) ifcTableRow.setIsHeading(this.IsHeading);
        return ifcTableRow;
    }
