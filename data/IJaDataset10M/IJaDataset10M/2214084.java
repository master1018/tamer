 ...
 * for the {@link java.rmi.activation.ActivationSystem} remote object exported
 * with {@link net.jini.jeri.BasicJeriExporter}. This class can be passed to
 ...
 * <td>The caller can inject itself as the instantiation of a group if the group
 * is currently being activated.</td>
 * </tr>
 * <tr>
 ...
 * <td>The caller can obtain the descriptor for an existing activation group if
 * it knows the activation group identifier.</td>
 * </tr>
 * <tr>
 ...
 * <td>The caller can replace the descriptor for an existing activatable object
 * if it knows the activation identifier.</td>
 * </tr>
 * <tr>
 ...
 * <td>The caller can replace the descriptor for an existing activation group if
 * it knows the activation group identifier.</td>
 * </tr>
 * <tr>
 ...
 * <td>The caller can unregister existing activatable objects if it knows their
 * activation identifiers.</td>
 * </tr>
 * <tr>
 ...
 * <td>The caller can unregister existing activation groups if it knows their
 * activation group identifiers.</td>
 * </tr>
 * <tr>
 ...
 * <td>The caller can obtain the activation group identifiers and descriptors
 * for all registered activation groups</td>
 * </tr>
 * <tr>
 ...
 * <td>The caller can obtain the activation identifiers and descriptors for all
 * registered activatable objects in an activation group if it knows the
 * activation group identifier</td>
 * </tr>
 * </table>
 * 
