...
public class GridSelectionColFigure extends GridColumnFigure {
    ...
    private static final Image img_check = ImagesUtils.getImage("palette/checkbox_01.png");

    private static final Image img_radio = ImagesUtils.getImage("palette/radio_01.png");
    ...
    protected void paintFigure(Graphics g) {
        if (ResultDataSet.SELECT_NONE.equals(model.getSelectionMode())) return;
