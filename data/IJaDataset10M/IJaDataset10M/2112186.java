...
public class KeyConverter {
    ...
    private static final Rule[] rules = new Rule[] { new ConcatenateAndInsertRule("DOWNLOAD_APPLY_NEW_THEME_START", "DOWNLOAD_APPLY_NEW_THEME_END", "{0}", "DOWNLOAD_APPLY_NEW_THEME"), new ConcatenateAndInsertRule("ERROR_BROWSE_HOST_FAILED_BEGIN_KEY", "ERROR_BROWSE_HOST_FAILED_END_KEY", " {0} ", "ERROR_BROWSE_HOST_FAILED"), new ConcatenateAndInsertRule("ERROR_CANT_RESUME_START", "ERROR_CANT_RESUME_END", " {0} ", "ERROR_CANT_RESUME"), new ConcatenateAndInsertRule("MESSAGE_UNABLE_TO_RENAME_FILE_START", "MESSAGE_UNABLE_TO_RENAME_FILE_END", " {0} ", "MESSAGE_UNABLE_TO_RENAME_FILE"), new ConcatenateAndInsertRule("MESSAGE_FILE_CORRUPT", "MESSAGE_CONTINUE_DOWNLOAD", " {0} ", "MESSAGE_FILE_CORRUPT"), new ConcatenateAndInsertRule("MESSAGE_SENSITIVE_SHARE_TOP", "MESSAGE_SENSITIVE_SHARE_BOTTOM", "\n\n{0}\n\n", "MESSAGE_SENSITIVE_SHARE"), new ConcatenateRule("SEARCH_VIRUS_MSG", "SEARCH_VIRUS_MSG_ONE", "SEARCH_VIRUS_MSG_TWO", "SEARCH_VIRUS_MSG_THREE") };

    @SuppressWarnings("unused")
    private static final Rule encodeMnemonics = new EncodeMnemonicAsAmpersAnd();

    @SuppressWarnings("unused")
    private static final Rule[] rules2 = new Rule[] { new ConcatenateAndInsertRule("STATISTICS_SHARING_TOOLTIP", "STATISTICS_FILES_TOOLTIP", " {0} ", "STATISTICS_SHARING_TOOLTIP_NEW"), new ConcatenateAndInsertRule("STATISTICS_SHARING_TOOLTIP", "STATISTICS_FILES_TOOLTIP_PENDING", " {0} ", "STATISTICS_SHARING_TOOLTIP_PENDING_NEW") };

    private static final Rule[] rules3 = new Rule[] { new ConcatenateAndInsertRule("DOWNLOAD_STATUS_WAITING_FOR_REQUERY_START", "DOWNLOAD_STATUS_WAITING_FOR_REQUERY_END", " {0}", "DOWNLOAD_STATUS_WAITING_FOR_REQUERY") };
