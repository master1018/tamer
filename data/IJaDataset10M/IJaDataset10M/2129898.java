        ...
        if (args.size() > 1) {
            ...
            while (it.hasNext()) {
                ...
                if (opname.equals("separator")) {
                    separator = StringUtil.normalizeLinebreaks(DataLoaderUtil.getStringOption(opname, opvalue));
                    ...
                    trim = DataLoaderUtil.getBooleanOption(opname, opvalue);
                } else if (opname.equals("dropEmptyLastItem")) {
                    dropEmptyLastItem = DataLoaderUtil.getBooleanOption(opname, opvalue);
                } else {
