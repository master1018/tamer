...
public class ControlSysexMsg extends SysexMsg {
    ...
    public static boolean isControl(byte[] data) {
        return (data[0] == (byte) SYSTEM_EXCLUSIVE) && (data[1] == ID_NON_COMMERCIAL) && data.length == LENGTH;
    }
