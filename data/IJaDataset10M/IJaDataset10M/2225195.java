...
class ScalarAnalysis {
    ...
    private static final String NULL_BL_T_LINEBR = "\0 \t\r\n";
    ...
    public static ScalarAnalysis analyze(String scalar, boolean escapeUnicode) {
        ...
        while (index < scalar.length()) {
            ...
            if (' ' == ceh || '\n' == ceh || '' == ceh) {
                ...
                if (leading) {
                    if (spaces && breaks) mixedBreaksSpaces = true; else if (spaces) leadingSpaces = true; else if (breaks) {
                        leadingBreaks = true;
                    }
                } else if (mixed) mixedBreaksSpaces = true; else if (spaces && breaks) inlineBreaksSpaces = true; else if (spaces) {
                } else if (breaks) {
                    inlineBreaks = true;
                }
