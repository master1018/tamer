...
public class ERDEditFile extends ERDCustomEditComponent {
    ...
    void extract(InputStream in, String[] files) throws IOException {
        ...
        while ((e = zis.getNextEntry()) != null) {
            if (files == null) extractFile(zis, e); else {
    ...
    public void takeValuesFromRequest(WORequest q, WOContext c) throws NSValidation.ValidationException {
        ...
        uploadFile();
        try {
            if (key().charAt(0) != '#') object().validateTakeValueForKeyPath(objectKeyPathValue(), key());
        } catch (Throwable e) {
    ...
    public void sleep() {
        if (!synchronizesVariablesWithBindings()) reset();
        super.sleep();
    }
    ...
    public void setObjectKeyPathValue(Object value) {
        if (key().charAt(0) != '#') super.setObjectKeyPathValue(value);
    }

    public Object objectKeyPathValue() {
        if (key().charAt(0) != '#') return super.objectKeyPathValue();
        return null;
    }
    ...
    public boolean fileExists() {
        if (uploadDirectory() != null && objectKeyPathValue() != null) return (new File(uploadDirectory() + File.separator + objectKeyPathValue())).exists();
        return false;
    }
