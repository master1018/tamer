package com.eclipsegeek.history.ui;
...
import com.eclipsegeek.history.internal.ui.HistoryPage;
...
public interface IHistoryPage {
     ...
     * @since 3.3
     */
    public static final String P_NAME = TeamUIPlugin.ID + ".name";
     ...
     * @since 3.3
     */
    public static final String P_DESCRIPTION = TeamUIPlugin.ID + ".description";
	 ...
	 * @since 3.2
	 */
    public boolean setInput(Object[] objects);
