    ...
    public void execute() {
        ...
        try {
            ...
            try {
                ...
                String boql = "{Ebo_Queue}SELECT BOUI from Ebo_Queue WHERE executed < 1 OR executed IS NULL AND (afterDate IS NULL OR afterDate < " + eboctx.getDataBaseDriver().getDriverUtils().fnSysDateTime() + ")";
