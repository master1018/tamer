...
public class FManutRec extends FFDialogo implements CarregaListener, TabelaSelListener {
    ...
    private void montaListaCampos() {
        lcRecBaixa.add(new GuardaCampo(txtCodRecBaixa, "CodRec", "C�d.rec.", ListaCampos.DB_PK, false));
        lcRecBaixa.add(new GuardaCampo(txtCodVendaBaixa, "CodVenda", "C�d.venda", ListaCampos.DB_FK, false));
        ...
        lcRecBaixa.add(new GuardaCampo(txtCodCliBaixa, "CodCli", "C�d.cli.", ListaCampos.DB_FK, false));
        lcRecBaixa.add(new GuardaCampo(txtDtEmisBaixa, "DataRec", "Data emiss�o", ListaCampos.DB_SI, false));
        lcRecBaixa.add(new GuardaCampo(txtCodBancoBaixa, "CodBanco", "C�d.banco", ListaCampos.DB_FK, false));
        ...
        lcCliBaixa.add(new GuardaCampo(txtCodCliBaixa, "CodCli", "C�d.cli", ListaCampos.DB_PK, false));
        lcCliBaixa.add(new GuardaCampo(txtRazCliBaixa, "RazCli", "Raz�o social do cliente", ListaCampos.DB_SI, false));
        ...
        lcVendaBaixa.add(new GuardaCampo(txtCodVendaBaixa, "CodVenda", "C�d.venda", ListaCampos.DB_PK, false));
        lcVendaBaixa.add(new GuardaCampo(txtSerie, "Serie", "S�rie", ListaCampos.DB_SI, false));
    ...
    private void montaTela() {
        ...
        pnLegenda.add(new JLabelPad("� vencer", imgNaoVencido, SwingConstants.CENTER));
        pnBtOk.add(btOK);
        ...
        pinBaixa.adic(new JLabelPad("C�d.cli."), 7, 40, 100, 20);
        pinBaixa.adic(txtCodCliBaixa, 7, 60, 100, 20);
        pinBaixa.adic(new JLabelPad("Descri��o do cliente"), 110, 40, 256, 20);
        pinBaixa.adic(txtRazCliBaixa, 110, 60, 256, 20);
        pinBaixa.adic(new JLabelPad("C�d.banco"), 369, 40, 100, 20);
        pinBaixa.adic(txtCodBancoBaixa, 369, 60, 100, 20);
        pinBaixa.adic(new JLabelPad("Descri��o do banco"), 471, 40, 256, 20);
    ...
    private void montaTabela() {
        ...
        tabBaixa.adicColuna("C�d.rec.");
        tabBaixa.adicColuna("Nro.parc.");
        tabBaixa.adicColuna("Doc.");
        tabBaixa.adicColuna("Pedido");
        tabBaixa.adicColuna("Valor parcela");
        tabBaixa.adicColuna("Data Pagamento");
        tabBaixa.adicColuna("Valor pago");
        tabBaixa.adicColuna("Valor desc.");
        tabBaixa.adicColuna("Valor juros");
        tabBaixa.adicColuna("Valor aberto");
        tabBaixa.adicColuna("Nro.Conta");
        tabBaixa.adicColuna("Descri��o conta");
        tabBaixa.adicColuna("C�d.planej.");
        tabBaixa.adicColuna("Descri��o planej.");
        tabBaixa.adicColuna("C�d.c.c.");
        tabBaixa.adicColuna("Descri��o c.c.");
        ...
        try {
            ...
            for (int i = 0; rs.next(); i++) {
                if (txtCodVendaBaixa.getVlrInteger() == 0 && !porCliente) {
                    Funcoes.mensagemInforma(this, "Este recebimento n�o � origin�rio de uma venda\n" + "e n�o poder� ser recebido por este modulo.");
                    limpaConsulta();
                    return false;
                }
            ...
            if (porCliente && tabBaixa.getNumLinhas() == 0) {
                Funcoes.mensagemInforma(this, "N�o h� pagamentos pendentes para este cliente!");
                limpaConsulta();
                return false;
                ...
                if (rs.next()) {
                    if ("RP".equals(rs.getString("STATUSITREC")) && 0.0f == (rs.getBigDecimal("VLRAPAGITREC") != null ? rs.getBigDecimal("VLRAPAGITREC").floatValue() : 1f)) {
                        Funcoes.mensagemInforma(this, "Parcela j� foi paga!");
                        limpaConsulta();
                        return false;
                    }
                }
    ...
    public void setVisible(boolean arg0) {
        if (FreedomPDV.bECFTerm) {
            ...
            FreedomPDV.killProg(1, "Esta esta��o de trabalho n�o � um PDV!\n" + "Verifique o cadastro desta esta��o de trabalho atrav�s do modulo Standard.");
        }
    }
