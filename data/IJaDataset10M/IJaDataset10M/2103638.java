...
public class WadoPrefView extends AbstractItemDialogPage {
    ...
    private void initGUI() {
        ...
        lblCompression = new JLabel(Messages.getString("WadoPrefView.compr"));
        add(panel);
        ...
        panel.setBorder(new TitledBorder(null, Messages.getString("WadoPrefView.compr2"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
        final JLabel lblTranscodingTo = new JLabel(Messages.getString("WadoPrefView.trans"));
