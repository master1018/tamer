...
public class MutableStringTokenizer {
    ...
    private static final class SharedCharSequence implements CharSequence {
        ...
        public char charAt(int index) {
            if (index < 0 || start_ + index > end_) throw new IndexOutOfBoundsException(String.valueOf(index));
            return buf_.charAt(start_ + index);
        }

        public boolean equals(Object obj) {
            CharSequence s;
            if (obj instanceof CharSequence) s = (CharSequence) obj; else s = String.valueOf(obj);
            if (s.length() != length()) return false;
            for (int i = 0; i < s.length(); i++) {
                if (s.charAt(i) != buf_.charAt(start_ + i)) return false;
            }
            return true;
        }
        ...
        public String toString() {
            ...
            for (int i = start_; i < end_; i++) b.append(buf_.charAt(i));
            return b.toString();
        }
    }
    ...
    public static void main(String[] args) {
        ...
        CharSequence s;
        while ((s = t.nextToken()) != null) System.out.println(s);
    }
}
