...
public class CPanel extends JPanel {
    ...
    public void setBackground(Color bg) {
        if (bg.equals(getBackground())) return;
    ...
    public void setBackgroundColor(CompiereColor bg) {
        if (bg == null) bg = new CompiereColor(AdempierePLAF.getFormBackground());
        setOpaque(true);
    ...
    public void setTabLevel(int level) {
        if (level == 0) putClientProperty(AdempiereLookAndFeel.TABLEVEL, null); else putClientProperty(AdempiereLookAndFeel.TABLEVEL, new Integer(level));
    }
    ...
    public String toString() {
        ...
        if (bg != null) sb.append(bg.toString());
        sb.append("]");
        return sb.toString();
    }
}
