...
public class PacketId {
    ...
    public static class IdPart {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof IdPart)) return false;
    ...
    public PacketId(PartType[] types, long[] values) {
        if (types.length != types.length) throw new IllegalArgumentException("Invalid arrays, both must be the same length");
    ...
    public boolean equals(Object obj) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (id1 == null || !id1.equals(other.getParts().get(i))) return false;
        }
        return true;
    }
