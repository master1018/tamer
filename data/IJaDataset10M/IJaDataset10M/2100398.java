...
public class WeakTermListControl extends DeclarationObject {

    public WeakTermListControl(Element element, MenuActionDelegate actionDelegate, GraphGenerator graphGenerator) {
    ...
    protected void initVertexMenu() {
        ...
        menu.setSelectionAdapter(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                actionDelegate.getAction(MenuActionString.weak_term_overview.toString()).run(returnElement());
            }
        });
        getMenuTemplate().insertMenuAtEndOfSpace(menu, MenuSpace.GENERAL_SPACE);
        menu = new ItemTemplate(UIText._new, abstract_menu_type.push);
        menu.setSelectionAdapter(new SelectionAdapter() {
    ...
    public String toString() {
        return "<html><center><b>Weak Term List</b></center></html>";
    }
}
