...
public class RemoveConsiderAction implements ClickMenuAction {
    ...
    protected static final Logger logger = Logger.getLogger(RemoveConsiderAction.class);
    ...
    public HistoryItem execute() {
        RemoveConsiderHistoryItem item = new RemoveConsiderHistoryItem(clearObject, considerObject);
        Selection out = SelectionManager.createSelectionFromTerms(null, Collections.singleton((LinkedObject) clearObject), null, false);
