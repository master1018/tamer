...
public class MediaSlider extends JSlider implements ThemeObserver, ChangeListener {
    ...
    public void setUI(SliderUI sliderUI) {
        if (sliderUI instanceof MediaSliderUI) super.setUI(sliderUI);
    }
    ...
    protected void setImages() {
        setLeftTrackImage(convertIconToImage(GUIMediator.getThemeImage(LEFT_TRACK)));
        setRightTrackImage(convertIconToImage(GUIMediator.getThemeImage(RIGHT_TRACK)));
        setCenterTrackImage(convertIconToImage(GUIMediator.getThemeImage(CENTER_TRACK)));
        setThumbImage(convertIconToImage(GUIMediator.getThemeImage(THUMB)));
        setThumbPressedImage(convertIconToImage(GUIMediator.getThemeImage(THUMB_PRESSED)));
    }
