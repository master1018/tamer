...
public class MemoryONDEXGraphMetaData extends AbstractONDEXGraphMetaData {
    ...
    protected DataSource storeDataSource(DataSource dataSource) {
        ...
        if (existingDataSource != null) {
            fireEventOccurred(new DuplicatedEntryEvent(Config.properties.getProperty("memory.ONDEXGraphMetaData.DuplicatedDataSource") + dataSource.getId(), "[ONDEXGraphMetaData - storeDataSource]"));
    ...
    protected ConceptClass storeConceptClass(ConceptClass cc) {
        ...
        if (existingCc != null) {
            fireEventOccurred(new DuplicatedEntryEvent(Config.properties.getProperty("memory.ONDEXGraphMetaData.DuplicatedConceptClass") + cc.getId(), "[ONDEXGraphMetaData - storeConceptClass]"));
            return existingCc;
        } else {
            ccs.put(cc.getId(), cc);
        }
    ...
    protected AttributeName storeAttributeName(AttributeName an) {
        ...
        if (existingAn != null) {
            fireEventOccurred(new DuplicatedEntryEvent(Config.properties.getProperty("memory.ONDEXGraphMetaData.DuplicatedAttributeName") + an.getId(), "[ONDEXGraphMetaData - storeAttributeName]"));
            return existingAn;
        } else {
    ...
    protected Unit storeUnit(Unit unit) {
        ...
        if (existingUnit != null) {
            fireEventOccurred(new DuplicatedEntryEvent(Config.properties.getProperty("memory.ONDEXGraphMetaData.DuplicatedUnit") + unit.getId(), "[ONDEXGraphMetaData - storeUnit"));
            return existingUnit;
        } else {
    ...
    protected EvidenceType storeEvidenceType(EvidenceType evitype) {
        ...
        if (existingEt != null) {
            fireEventOccurred(new DuplicatedEntryEvent(Config.properties.getProperty("memory.ONDEXGraphMetaData.DuplicatedEvidenceType") + evitype.getId(), "[ONDEXGraphMetaData - storeEvidenceType]"));
            return existingEt;
        } else {
    ...
    protected RelationType storeRelationType(RelationType rt) {
        ...
        if (existingRT != null) {
            fireEventOccurred(new DuplicatedEntryEvent(Config.properties.getProperty("memory.ONDEXGraphMetaData.DuplicatedRelationType") + rt.getId(), "[ONDEXGraphMetaData - storeRelationType]"));
            return existingRT;
        } else {
