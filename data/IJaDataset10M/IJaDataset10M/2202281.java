...
public class CMISResourceProvider implements ResourceProvider {
    ...
    public Resource getResource(URI uri) throws ResourceProviderException {
        if (uri.getScheme() == null) throw new ResourceProviderException("Missing URI scheme: " + uri);
        if (!uri.getScheme().equals(CMIS_SCHEME)) throw new ResourceProviderException("URI scheme not supported: " + uri);
