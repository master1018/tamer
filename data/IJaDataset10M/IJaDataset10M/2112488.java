...
public class point_sizeType extends com.jmex.xml.xml.Node {

    public point_sizeType(point_sizeType node) {
        super(node);
    }

    public point_sizeType(org.w3c.dom.Node node) {
        super(node);
    }

    public point_sizeType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public point_sizeType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "point_size");
    }
