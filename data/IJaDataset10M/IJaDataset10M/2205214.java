...
public class SrndTruncQuery extends SimpleTerm {
    ...
    protected void appendRegExpForChar(char c, StringBuffer re) {
        if (c == unlimited) re.append(".*"); else if (c == mask) re.append("."); else re.append(c);
    }
    ...
    public void visitMatchingTerms(IndexReader reader, String fieldName, MatchingTermVisitor mtv) throws IOException {
