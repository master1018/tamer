...
public class JShowToolTipsMenuItem extends JCheckBoxMenuItem implements ChangeListener {
    ...
    public JShowToolTipsMenuItem() {
        super(TSNavigationConfigSection.RESOURCE.getString("travelingsalesman.configsection.showAllTags.title"), Settings.getInstance().getBoolean("showAllTags", false));
