...
public class PatternMatcherTests extends TestCase {
    ...
    public void testCapturesMatchedGroups() throws Exception {
        PatternMatcher matcher = new PatternMatcher(sequence(group("xs", oneOrMore(text("x"))), group("ys", oneOrMore(text("y")))));
        Parse parse;
    ...
    public void testCanReferToContentOfMatchedGroups() throws Exception {
        PatternMatcher matcher = new PatternMatcher(sequence(group("first", oneOrMore(text("x"))), text("-"), valueOf("first")));
    ...
    PatternMatcher scopedMatcher = new PatternMatcher(sequence(group("xs", oneOrMore(text("x"))), group("inside", sequence(group("xs", oneOrMore(text("X"))), valueOf("xs"))), valueOf("xs")));
    ...
    public void testCanReferToValuesOfGroupsInInnerScopesUsingDottedPathNotation() {
        PatternMatcher matcher = new PatternMatcher(sequence(group("xs", oneOrMore(text("x"))), group("inside", sequence(group("xs", oneOrMore(text("X"))), valueOf("xs"))), valueOf("xs"), valueOf("inside.xs")));
    ...
    public void testCanDefinePatternsInTermsOfExistingPatterns() {
        PatternMatcher emailAddressMatcher = new PatternMatcher(sequence(group("user", oneOrMore(anyCharacter())), "@", group("host", oneOrMore(anyCharacter()))));
        PatternMatcher mailToURLMatcher = new PatternMatcher(sequence(group("scheme", text("mailto")), ":", group("email", emailAddressMatcher)));
