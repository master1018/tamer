...
public class MessageQueueTest extends AndroidTestCase {
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, method = "addIdleHandler", args = { android.os.MessageQueue.IdleHandler.class })
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, method = "removeIdleHandler", args = { android.os.MessageQueue.IdleHandler.class })
    @BrokenTest("needs investigation")
