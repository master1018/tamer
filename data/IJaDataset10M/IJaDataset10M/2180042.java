 ...
 */
public class PSSPolicyServiceContext implements PSSServiceContext {
     ...
     */
    public PSSServiceContext m_local;
     ...
     * {@link PSSPolicyServiceContext#GLOBAL}, else use the 
     * given policy.
     * @param global the global bundle context
     * @param local the parent (local) service context
     * @param policy the resolution policy
     */
    public PSSPolicyServiceContext(BundleContext global, PSSServiceContext local, int policy) {
        m_global = global;
        m_local = local;
        if (m_local == null) {
            m_policy = GLOBAL;
     ...
     * if the {@link PSSPolicyServiceContext#LOCAL_AND_GLOBAL} is used.
    ...
    public Object getService(ServiceReference ref) {
        switch(m_policy) {
            ...
            case LOCAL_AND_GLOBAL:
                if (ref instanceof org.personalsmartspace.ipojo.context.PSSServiceReferenceImpl) {
                    return m_local.getService(ref);
                } else {
                    return m_global.getService(ref);
                }
    ...
    public boolean ungetService(ServiceReference reference) {
        if (reference instanceof org.personalsmartspace.ipojo.context.PSSServiceReferenceImpl) {
