 ...
 * @version $Id: OnlineDebugger.java 1941 2004-09-30 03:37:06Z joewhaley $
 */
public class OnlineDebugger {
        ...
        uphere: for (; ; ) {
            ...
            if (s.equals("d")) {
                ...
                for (; ; ) {
                    ...
                    if (sw2.getFP().peek().difference(sw.getFP()) == 0) break;
                    sw2.gotoNext();
                }
                sw = sw2;
                --frameNum;
    ...
    public static void printStackFrame(StackCodeWalker sw) {
        ...
        while (ptr.difference(next_fp) <= framesize) {
            if (ptr.difference(my_fp) == 0) {
                ...
                int code_offset = 0;
                if (cc2 != null) code_offset = my_ip2.difference(cc2.getStart());
                ...
                int code_offset = 0;
                if (cc != null) code_offset = my_ip.difference(cc.getStart());
    ...
    public static class BytecodeLister extends BytecodeVisitor {
        ...
        public String toString() {
            return Strings.left(method.getName().toString(), 12);
        }
    }
}
