...
public class RPCMethodCall implements Externalizable {
    ...
    Method findMethod(Class target_class) throws Exception {
        ...
        for (int i = 0; i < methods.length; i++) {
            ...
            if (m.getName().equals(method_name)) {
                if (m.getParameterTypes().length == len) return m;
            }
        }
        return null;
    }
    ...
    public Object invoke(Object target) throws Throwable {
        ...
        try {
            switch(mode) {
                ...
                case SIGNATURE:
                    Class[] mytypes = null;
                    if (signature != null) mytypes = getTypesFromString(cl, signature);
    ...
    static Class[] getTypesFromString(Class cl, String[] signature) throws Exception {
        ...
        for (int i = 0; i < signature.length; i++) {
            name = signature[i];
            if ("long".equals(name)) parameter = long.class; else if ("int".equals(name)) parameter = int.class; else if ("short".equals(name)) parameter = short.class; else if ("char".equals(name)) parameter = char.class; else if ("byte".equals(name)) parameter = byte.class; else if ("float".equals(name)) parameter = float.class; else if ("double".equals(name)) parameter = double.class; else if ("boolean".equals(name)) parameter = boolean.class; else parameter = Class.forName(name, false, cl.getClassLoader());
            mytypes[i] = parameter;
        }
        return mytypes;
    }
    ...
    public String toString() {
        ...
        boolean first = true;
        if (method_name != null) ret.append(method_name); else ret.append(method_id);
        ret.append('(');
        if (args != null) {
            for (int i = 0; i < args.length; i++) {
    ...
    public String toStringDetails() {
        ...
        if (method_name != null) ret.append("name=").append(method_name); else ret.append("id=").append(method_id);
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        if (name_available) method_name = in.readUTF(); else method_id = in.readShort();
