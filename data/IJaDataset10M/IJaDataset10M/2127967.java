...
public class Fisheyebar extends XulElement implements org.zkoss.zkex.zul.api.Fisheyebar {
    ...
    private int _itemwd = 50, _itemhgh = 50, _itemmaxwd = 200, _itemmaxhgh = 200, _itemPadding = 10;

    private String _orient = "horizontal", _attachEdge = "center", _labelEdge = "bottom";
    ...
    public void setItemWidth(int itemwd) throws WrongValueException {
        if (itemwd <= 0) throw new WrongValueException("Positive is required: " + itemwd);
        if (_itemwd != itemwd) {
            _itemwd = itemwd;
    ...
    public void setItemHeight(int itemhgh) throws WrongValueException {
        if (itemhgh <= 0) throw new WrongValueException("Positive is required: " + itemhgh);
        if (_itemhgh != itemhgh) {
            _itemhgh = itemhgh;
    ...
    public void setItemMaxWidth(int itemmaxwd) throws WrongValueException {
        if (itemmaxwd <= 0) throw new WrongValueException("Positive is required: " + itemmaxwd);
    ...
    public void setItemMaxHeight(int itemmaxhgh) throws WrongValueException {
        if (itemmaxhgh <= 0) throw new WrongValueException("Positive is required: " + itemmaxhgh);
    ...
    public void setItemPadding(int itemPadding) throws WrongValueException {
        if (itemPadding <= 0) throw new WrongValueException("Positive is required: " + itemPadding);
    ...
    public void setAttachEdge(String attachEdge) throws WrongValueException {
        if (attachEdge == null || attachEdge.length() == 0) throw new WrongValueException("Empty attachEdge not allowed");
    ...
    public void setLabelEdge(String labelEdge) throws WrongValueException {
        if (labelEdge == null || labelEdge.length() == 0) throw new WrongValueException("Empty labelEdge not allowed");
    ...
    public String getOuterAttrs() {
        final StringBuffer sb = new StringBuffer(256).append(super.getOuterAttrs());
    ...
    public void beforeChildAdded(Component child, Component refChild) {
        if (!(child instanceof Fisheye)) throw new UiException("Unsupported child for fisheyebar: " + child);
	 ...
	 */
    protected class ExtraCtrl extends XulElement.ExtraCtrl implements ChildChangedAware {
