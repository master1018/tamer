...
public final class TCPLimeReceivedMessages extends AbstractMessageGraphPaneItem {
    ...
    public TCPLimeReceivedMessages(final String key) {
        super(key);
        registerStatistic(ReceivedMessageStat.TCP_ALL_MESSAGES, GUIMediator.getStringResource("STATS_ALL_CLIENTS"));
        registerStatistic(LimeReceivedMessageStat.TCP_ALL_MESSAGES, GUIMediator.getStringResource("STATS_LIMEWIRE"));
    }
}
