...
public class ElementHandlerTest extends TestCase {
    ...
    static final String BASE_XML_URI = TestUtil.getPluginDirectory(AllSuites.PLUGIN_ID) + "/data/xml/";
   ...
   */
    ...
    public void testSimpleDeducedRoot() throws Exception {
        ...
        resource.load(options);
        ByteArrayOutputStream outputstream = new ByteArrayOutputStream(2064);
        @SuppressWarnings("unchecked") ElementHandlerImpl elementHandler = new ElementHandlerImpl(false, (Collection<EPackage>) (Collection<?>) resourceSet.getPackageRegistry().values());
