...
public class IntegerSubObjectPropertyOfAxiom implements ComplexIntegerAxiom {
	 ...
	 */
    public IntegerSubObjectPropertyOfAxiom(IntegerObjectPropertyExpression subPropExpr, IntegerObjectPropertyExpression superPropExpr) {
        if (subPropExpr == null) {
        ...
        this.objectPropertiesInSignature.addAll(this.subObjectProperty.getObjectPropertiesInSignature());
        this.objectPropertiesInSignature.addAll(this.superObjectProperty.getObjectPropertiesInSignature());
    }
