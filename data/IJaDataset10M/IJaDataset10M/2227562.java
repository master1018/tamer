...
public final class Initiator {
   ...
   *           if any error occurs.
   */
    public final void createSession(final InetSocketAddress targetAddress, final String targetName) throws Exception {
   ...
   */
    public final Future<Void> multiThreadedRead(final Object caller, final String targetName, final ByteBuffer dst, final int logicalBlockAddress, final long transferLength) throws Exception {
        final Future<Void> returnVal = getSession(targetName).read(caller, dst, logicalBlockAddress, transferLength);
        return returnVal;
    }
   ...
   *           if any error occurs.
   */
    public final void read(final Object caller, final String targetName, final ByteBuffer dst, final int logicalBlockAddress, final long transferLength) throws Exception {
        multiThreadedRead(caller, targetName, dst, logicalBlockAddress, transferLength).get();
    }
   ...
   */
    public final Future<Void> multiThreadedWrite(final Object caller, final String targetName, final ByteBuffer src, final int logicalBlockAddress, final long transferLength) throws Exception {
        return getSession(targetName).write(caller, src, logicalBlockAddress, transferLength);
    }
   ...
   *           if any error occurs.
   */
    public final void write(final Object caller, final String targetName, final ByteBuffer src, final int logicalBlockAddress, final long transferLength) throws Exception {
        multiThreadedWrite(caller, targetName, src, logicalBlockAddress, transferLength).get();
    }
