...
@XmlType(name = "DatosRegistroSalida", namespace = "urn:es:caib:regtel:ws:v1:model:DatosRegistroSalida", propOrder = { "datosExpediente", "oficinaRegistral", "datosInteresado", "datosRepresentado", "datosNotificacion", "documentos" })
