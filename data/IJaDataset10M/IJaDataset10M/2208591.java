...
public class UserDAOTest extends DatabaseDependingTest {
    ...
    private static final String INTERNAL_AUTH_OLDUSER1 = "เก่า";

    private static final String INTERNAL_AUTH_NEWUSER1 = "ใหม่";

    private static final String INTERNAL_AUTH_OLDPASS1 = "รหัสผ่าน";

    private static final String INTERNAL_AUTH_OLDUSER2 = "ผู้ใช้";

    private static final String INTERNAL_AUTH_OLDPASS2 = "ลับ";

    private static final String INTERNAL_AUTH_NEWUSER2 = "ผู้ใช้ใหม่";

    private static final String INTERNAL_AUTH_NEWPASS2 = "เหลือร้ายลับ";
    ...
    public void testListUsers() {
        ...
        for (int i = 0; i < users.size(); i++) userDAO.deleteUser(userDAO.getUser(users.get(i).getId()));
        commit();
    }
