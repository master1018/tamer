...
public class SkatGameTest extends AbstractJSkatTest {
    ...
    public void testPassIn_NoBids() {
        ...
        SkatGame game = new SkatGame("Table 1", GameVariant.STANDARD, new NoBiddingTestPlayer(), new NoBiddingTestPlayer(), new NoBiddingTestPlayer());
    ...
    public void testRamsch_Forced() {
        SkatGame game = new SkatGame("Table 1", GameVariant.RAMSCH, new AIPlayerRND(), new AIPlayerRND(), new AIPlayerRND());
        game.setView(new UnitTestView());
        game.start();
        try {
            game.join();
    ...
    public void testRamsch_ForcedForeHandGrandHand() {
        ...
        SkatGame game = new SkatGame("Table 1", GameVariant.RAMSCH, grandHandPlayer, new AIPlayerRND(), new AIPlayerRND());
        game.setView(new UnitTestView());
        game.start();
        try {
            game.join();
    ...
    public void testRamsch_ForcedMiddleHandGrandHand() {
        RamschTestPlayer grandHandPlayer = new RamschTestPlayer();
        grandHandPlayer.setPlayGrandHand(true);
        SkatGame game = new SkatGame("Table 1", GameVariant.RAMSCH, new AIPlayerRND(), grandHandPlayer, new AIPlayerRND());
        game.setView(new UnitTestView());
        game.start();
        try {
            game.join();
    ...
    public void testRamsch_ForcedRearHandGrandHand() {
        RamschTestPlayer grandHandPlayer = new RamschTestPlayer();
        grandHandPlayer.setPlayGrandHand(true);
        SkatGame game = new SkatGame("Table 1", GameVariant.RAMSCH, new AIPlayerRND(), new AIPlayerRND(), grandHandPlayer);
        game.setView(new UnitTestView());
        game.start();
        try {
            game.join();
