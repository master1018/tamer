...
/**
 * This is a default implementation of the IFC object IfcAxis2Placement2D<br><br>
 * 
 ...
 **/
public class IfcAxis2Placement2D extends IfcPlacement implements IfcClass, IfcAxis2Placement {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcCartesianPoint", "IfcDirection" };
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("Location")) stepString = stepString.concat("*,"); else {
            if (this.Location != null) stepString = stepString.concat(((IfcRootInterface) this.Location).getStepParameter(IfcCartesianPoint.class.isInterface()) + ","); else stepString = stepString.concat("$,");
        }
    ...
    public Object clone() {
        ...
        if (this.Location != null) ifcAxis2Placement2D.setLocation((IfcCartesianPoint) this.Location.clone());
        if (this.RefDirection != null) ifcAxis2Placement2D.setRefDirection((IfcDirection) this.RefDirection.clone());
    ...
    public Object shallowCopy() {
        IfcAxis2Placement2D ifcAxis2Placement2D = new IfcAxis2Placement2D();
        if (this.Location != null) ifcAxis2Placement2D.setLocation(this.Location);
        if (this.RefDirection != null) ifcAxis2Placement2D.setRefDirection(this.RefDirection);
        return ifcAxis2Placement2D;
    }
