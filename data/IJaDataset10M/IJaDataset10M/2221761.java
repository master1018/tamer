...
public class Tools {
    ...
    public static void unzip(String sZipFileName, String sOutputFilePath) throws FileNotFoundException, IOException {
    ...
    public static void readCap(String sCapFileName) throws FileNotFoundException, IOException {
