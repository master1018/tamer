...
public class PanelSeleccionEnlace extends JPanel {
    ...
    public PanelSeleccionEnlace() {
        super();
        super.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Direction"), BorderFactory.createEmptyBorder(10, 10, 10, 10)));
