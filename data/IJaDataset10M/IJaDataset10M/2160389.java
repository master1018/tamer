...
public class ContactListDraggable extends JComponent {
     ...
     */
    private static Logger logger = Logger.getLogger(ContactListDraggable.class.getName());
    ...
    static {
        try {
            ...
            logger.debug("Cursor \"MoveDrop.32x32\" isn't available " + "will use Cursor.MOVE_CURSOR instead", ex);
        ...
        try {
            ...
            logger.debug("Cursor \"Invalid.32x32\" isn't available " + "will use Cursor.WAIT_CURSOR instead", ex);
     ...
     *        the drag operation.
     */
    public ContactListDraggable(ContactList contactList, MetaContact metaContact, Contact contact, Image image) {
        setOpaque(false);
    ...
    public void paintComponent(Graphics g) {
        ...
        g2.drawImage(image, (int) (location.getX() - image.getWidth(null) / 2), (int) (location.getY() - image.getHeight(null) / 2), null);
        g2.setColor(Color.GRAY);
        g2.drawRect((int) (location.getX() - image.getWidth(null) / 2), (int) (location.getY() - image.getHeight(null) / 2), image.getWidth(null), image.getHeight(null));
