...
public class SbbCMPPanel extends Composite {
    ...
    private static final int[] EDITORS = new int[] { EditableTableViewer.EDITOR_NONE, EditableTableViewer.EDITOR_NONE, EditableTableViewer.EDITOR_NONE, EditableTableViewer.EDITOR_BUTTON };
        ...
        EditableTablePanelAddListener listener = new EditableTablePanelAddListener() {
            ...
            public HashMap getInitialData() {
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    if (type.equals("javax.slee.SbbLocalObject")) data.put("Stored SBB", sbbLocalObject.toString()); else data.put("Stored SBB", "N/A");
                    return data;
                }
                return null;
            }
