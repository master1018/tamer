...
public class OsmAgentController extends AgentAppController {
    ...
    public void prepare(String changedSelector) {
        ...
        search = SearchFactory.getInstance().createSearch(state.getValue(MapAgentFrame.SEARCH_SEL), state.getValue(MapAgentFrame.SEARCH_MODE_SEL), heuristic);
    ...
    public void run(MessageLogger logger) {
        ...
        if (env.getAgents().isEmpty()) initAgents(logger);
        try {
    ...
    protected void initAgents(MessageLogger logger) {
        ...
        switch(state.getValue(MapAgentFrame.AGENT_SEL)) {
            ...
            case 1:
                ...
                OnlineSearchProblem osp = new OnlineSearchProblem(p.getActionsFunction(), p.getGoalTest(), p.getStepCostFunction());
    ...
    static class H2 extends AdaptableHeuristicFunction {
        ...
        public double h(Object state) {
            ...
            if (pt1 != null && pt2 != null) result = pt1.distance(pt2);
            return result;
        }
    }
}
