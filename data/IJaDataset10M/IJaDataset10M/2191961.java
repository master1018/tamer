...
public class CachedImage {
    ...
    public static class Contract implements BaseColumns {
        ...
        /** Columns. */
        public static final String URL = "url", PATH = "path", LOADED = "loaded", REMOVED = "removed", TIMESTAMP = "ts", USAGE_TIMESTAMP = "usage_ts", TYPE = "type";

        /** Column indexes. */
        public static final int INDEX_ID = 0, INDEX_URL = 1, INDEX_PATH = 2, INDEX_LOADED = 3, INDEX_TIMESTAMP = 4, INDEX_USAGE_TIMESTAMP = 5, INDEX_TYPE = 6;

        /** Column names. */
        public static final String[] COLUMNS = new String[] { _ID, URL, PATH, LOADED, TIMESTAMP, USAGE_TIMESTAMP, TYPE };
    ...
    public void setUsageTimestamp(final long usageTimestamp) {
