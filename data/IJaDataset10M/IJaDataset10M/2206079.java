...
public class Marshaller {
    ...
    public static String getOutputParamsInXML(YParametersSchema params, String dataSpaceRootElementNm) {
        ...
        if (params != null) {
            for (Iterator iter = params.getOutputParams().iterator(); iter.hasNext(); ) {
    ...
    public static TaskInformation unmarshalTaskInformation(String taskInfoAsXML) {
        ...
        TaskInformation taskInfo = new TaskInformation(paramsForTaskNCase, taskID, specificationID, taskName, taskDocumentation, decompositionID);
        ...
        try {
            ...
            for (int i = 0; i < specSummaryElements.size(); i++) {
                ...
                if (specID != null && specStatus != null) {
                    specData = new SpecificationData(specID, specName, specDodo, specStatus, version);
    ...
    public static WorkItemRecord unmarshalWorkItem(Element workItemElement) {
        ...
        if (caseID != null && taskID != null && specID != null && enablementTime != null && status != null) {
            WorkItemRecord workItem = new WorkItemRecord(caseID, taskID, specID, enablementTime, status);
    ...
    public static String filterDataAgainstOutputParams(String mergedOutputData, List outputParams) throws JDOMException, IOException {
        SAXBuilder builder = new SAXBuilder();
        ...
        for (Iterator iterator = outputParams.iterator(); iterator.hasNext(); ) {
            ...
            String varElementName = parameter.getName() != null ? parameter.getName() : parameter.getElementName();
