...
public class ProvaCacheStateImpl implements ProvaCacheState {
    ...
    public boolean addSolution(ProvaCacheAnswerKey key, ProvaList literalList) {
        ...
        if (oldAnswer != null) return false;
    ...
    public ProvaCacheAnswerKey getCacheAnswerKey(ProvaList literalList, List<ProvaVariable> variables) {
        if (literalList == ProvaListImpl.emptyRList) return new ProvaCacheAnswerKey(0, null);
        ...
        for (int i = 0, j = 0; i < arity; i++) {
            ProvaObject o = fixed[i];
            if (o instanceof ProvaConstant) data[j++] = ((ProvaConstant) o).getObject();
        }
    ...
    public class ProvaCacheAnswerKey {
        ...
        public int hashCode() {
            final int prime = 31;
            int result = 1;
            result = prime * result + ((groundKey == null) ? 0 : groundKey.hashCode());
        ...
        public boolean equals(Object obj) {
            ...
            if (groundKey == null) {
                if (other.groundKey != null) return false;
            } else if (!groundKey.equals(other.groundKey)) return false;
