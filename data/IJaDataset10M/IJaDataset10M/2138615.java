...
public class AttributeDetailPane extends AbstractDetailPane {
    ...
    private void buildSpecificInfoPane() {
        ...
        addScreen(new ConstantValueAttributeDetailPane(services), SCREEN_CONSTANT_VALUE);
        addScreen(new CodeAttributeDetailPane(services), SCREEN_CODE);
        addScreen(new ExceptionsAttributeDetailPane(services), SCREEN_EXCEPTIONS);
        addScreen(new InnerClassesAttributeDetailPane(services), SCREEN_INNER_CLASSES);
        addScreen(new SourceFileAttributeDetailPane(services), SCREEN_SOURCE_FILE);
        addScreen(new LineNumberTableAttributeDetailPane(services), SCREEN_LINE_NUMBER_TABLE);
        addScreen(new LocalVariableTableAttributeDetailPane(services), SCREEN_LOCAL_VARIABLE_TABLE);
        addScreen(new EnclosingMethodAttributeDetailPane(services), SCREEN_ENCLOSING_METHOD);
        addScreen(new SignatureAttributeDetailPane(services), SCREEN_SIGNATURE);
        addScreen(new LocalVariableTypeTableAttributeDetailPane(services), SCREEN_LOCAL_VARIABLE_TYPE_TABLE);
        addScreen(new RuntimeAnnotationsAttributeDetailPane(services), SCREEN_RUNTIME_ANNOTATIONS);
        addScreen(new AnnotationDefaultAttributeDetailPane(services), SCREEN_ANNOTATION_DEFAULT);
    }
