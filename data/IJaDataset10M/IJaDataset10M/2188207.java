 ...
 * as, for example, {@link org.go.calendar.WeeklyCalendar 
...
public class DailyCalendar extends BaseCalendar {
	 ...
	 *                              time for the time range
	 */
    public DailyCalendar(org.go.Calendar baseCalendar, Calendar rangeStartingCalendar, Calendar rangeEndingCalendar) {
        super(baseCalendar);
        setTimeRange(rangeStartingCalendar, rangeEndingCalendar);
    }
	 ...
	 *                               range
	 */
    public DailyCalendar(org.go.Calendar baseCalendar, int rangeStartingHourOfDay, int rangeStartingMinute, int rangeStartingSecond, int rangeStartingMillis, int rangeEndingHourOfDay, int rangeEndingMinute, int rangeEndingSecond, int rangeEndingMillis) {
        super(baseCalendar);
        setTimeRange(rangeStartingHourOfDay, rangeStartingMinute, rangeStartingSecond, rangeStartingMillis, rangeEndingHourOfDay, rangeEndingMinute, rangeEndingSecond, rangeEndingMillis);
    }
	 ...
	 *                                  the time range
	 */
    public DailyCalendar(org.go.Calendar baseCalendar, long rangeStartingTimeInMillis, long rangeEndingTimeInMillis) {
        super(baseCalendar);
        setTimeRange(rangeStartingTimeInMillis, rangeEndingTimeInMillis);
    }
	 ...
	 *                          time range
	 */
    public DailyCalendar(org.go.Calendar baseCalendar, String rangeStartingTime, String rangeEndingTime) {
        super(baseCalendar);
	 ...
	 *                                  the time range
	 */
    public DailyCalendar(org.go.Calendar baseCalendar, TimeZone timeZone, long rangeStartingTimeInMillis, long rangeEndingTimeInMillis) {
