...
public class TestSuiteResultWriter {
    ...
    public static final String ID = "id", USER_AGENT = "userAgent", TIME = "time", TEST_CASES = "testCases", JSUNIT_VERSION = "JsUnitVersion", TEST_COUNT = "tests", REMOTE_ADDRESS = "remoteAddress", PROPERTIES = "properties", PROPERTY = "property", PROPERTY_KEY = "name", PROPERTY_VALUE = "value", BASE_URL = "baseURL";
