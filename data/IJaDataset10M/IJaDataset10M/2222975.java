...
final class BuildAgentUI extends JFrame implements BuildAgent.AgentStatusListener, BuildAgent.LUSCountListener, PreferencesHelper.UIPreferences {
    ...
    private void doEditEntries() {
        try {
            ...
            final BuildAgentEntryOverrideUI ui = new BuildAgentEntryOverrideUI(this, agentService, agentService.getMachineName() + ": " + buildAgent.getServiceID());
            ...
            LOG.error(msg, e1);
            JOptionPane.showMessageDialog(BuildAgentUI.this, msg + e1.getMessage(), "Error Editing Entry Overrides", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void doUpdateAgentInfoUI(final BuildAgentService buildAgentService) {
        ...
        final String agentText = "Build Agent: " + buildAgent.getServiceID() + "\n" + agentInfo + MulticastDiscovery.toStringEntries(buildAgent.getEntries());
            ...
            SwingUtilities.invokeLater(new Runnable() {
                ...
                public void run() {
                    ...
                    if (txaL4JConsole.getLineCount() > CONSOLE_LINE_BUFFER_SIZE) {
                        try {
                            txaL4JConsole.replaceRange("", 0, txaL4JConsole.getLineEndOffset(txaL4JConsole.getLineCount() - CONSOLE_LINE_BUFFER_SIZE));
