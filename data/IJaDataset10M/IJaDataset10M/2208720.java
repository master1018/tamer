...
public class TemplateParser {
     ...
     */
    public void readTemplate(ConfigData configData, String templateFile) throws ConfigException, FileNotFoundException {
        InputStream xsdFile = TemplateParser.class.getResourceAsStream(TemplateConst.CONF_FILE_TEMPLATE_XSD);
        if (xsdFile == null) throw new FileNotFoundException(TemplateConst.CONF_FILE_TEMPLATE_XSD);
