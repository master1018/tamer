...
public class AES {
	 ...
	 */
    public static byte[] hmacSha1(final byte[] key, final byte[] in) throws GeneralSecurityException {
	 ...
	 * @throws GeneralSecurityException
	 */
    public static void hmacSha1Verify(final byte[] key, final byte[] in, final byte[] expected) throws GeneralSecurityException {
        Mac hmac = Mac.getInstance(HMAC_TYPE);
        Key hmacKey = new SecretKeySpec(key, HMAC_TYPE);
        hmac.init(hmacKey);
        hmac.update(in);
	 ...
	 * @throws GeneralSecurityException
	 */
    public static byte[] aes128cbcEncrypt(final byte[] key, final byte[] plain) throws GeneralSecurityException {
	 ...
	 * @throws GeneralSecurityException
	 */
    public static byte[] aes128cbcEncryptWithIV(final byte[] key, final byte[] iv, final byte[] plain) throws GeneralSecurityException {
        Cipher cipher = Cipher.getInstance(CIPHER_TYPE);
	 ...
	 * @throws GeneralSecurityException
	 */
    public static byte[] aes128cbcDecrypt(final byte[] key, final byte[] cipherText) throws GeneralSecurityException {
	 ...
	 * @throws GeneralSecurityException
	 */
    public static byte[] aes128cbcDecryptWithIv(final byte[] key, final byte[] iv, final byte[] cipherText, final int offset) throws GeneralSecurityException {
        Cipher cipher = Cipher.getInstance(CIPHER_TYPE);
        Key cipherKey = new SecretKeySpec(key, CIPHER_KEY_TYPE);
        IvParameterSpec ivSpec = new IvParameterSpec(iv);
