...
public class SimulationLogger {
    ...
    private static final Map<String, SimulationMessage> lastRow = new Hashtable<String, SimulationMessage>();

    private static class CsvRow {

        public CsvRow(SimulationMessage event, Collection<SimulationMessage> values) {
            this.trigger = event;
