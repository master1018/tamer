...
public class TrafficMessage {
    ...
    public enum TYPES {
        ...
        TRAFFICJAM, SLOWTRAFFIC, ROADBLOCK, IGNORED
    }
     ...
     */
    public TrafficMessage(final Entity aEntity, final String aMessage, final Date aValidUntil, final TYPES aType, final int aLength) {
        super();
        myEntity = aEntity;
        myMessage = aMessage;
