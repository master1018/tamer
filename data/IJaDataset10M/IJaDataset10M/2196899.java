...
public class MontyHallGame extends Game implements ItemListener {
    ...
    public static final int STANDARD = 0, BLIND = 1;
    ...
    public MontyHallGame() {
        ...
        try {
            ...
            jocker = applet.getImage(new URL(applet.getCodeBase(), "images/cards/joker.jpg"));
        ...
        for (int i = 0; i < 3; i++) addGraph(door[i]);
    ...
    public void reset() {
        ...
        winGraph.repaint();
        winTable.update();
        System.out.println("MontyHallGame::OpenDoor::Reset()::jockerImage=" + jocker);
        System.out.println("MontyHallGame::OpenDoor::Reset()::diamondImage=" + diamond);
    }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        System.out.println("MontyHallGame::OpenDoor::actionPerformed()::jockerImage=" + jocker);
        System.out.println("MontyHallGame::OpenDoor::actionPerformed()::diamondImage=" + diamond);
    }
    ...
    public void mouseClicked(MouseEvent event) {
        System.out.println("MontyHallGame::OpenDoor::mouseClicked()::jockerImage=" + jocker);
        System.out.println("MontyHallGame::OpenDoor::mouseClicked()::diamondImage=" + diamond);
        for (int i = 0; i < 3; i++) {
            if ((event.getSource() == door[i]) & (stage == 1)) {
                ...
                if ((hostStrategy == STANDARD) & (host1 != player1)) {
                    ...
                    if (Math.random() < 0.5) host2 = player1 - 1; else host2 = player1 + 1;
                    if (host2 == -1) host2 = 2;
                    if (host2 == 3) host2 = 0;
                }
                if (host2 != host1) {
                    ...
                    System.out.println("MontyHallGame::OpenDoor::jockerImage=" + jocker);
                } else {
                    g = 0;
                    door[host2].open(diamond, String.valueOf(host2 + 1) + " Host");
                    System.out.println("MontyHallGame::OpenDoor::diamondImage=" + diamond);
                }
                stage = 2;
                ...
                if (player2 != host1) {
                    w = 0;
                    door[player2].open(jocker, String.valueOf(player2 + 1) + " Player");
                    System.out.println("MontyHallGame::OpenDoor::jockerImage=" + jocker);
                    try {
                        play("sounds/1.au");
                    } catch (Exception e) {
                    ...
                    w = 1;
                    door[player2].open(diamond, String.valueOf(player2 + 1) + " Player");
                    try {
                        play("sounds/1.au");
                    } catch (Exception e) {
                        ;
