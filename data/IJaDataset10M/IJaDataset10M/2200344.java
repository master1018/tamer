...
public class PlaybackURLConnectionTest {
    ...
    @Before
    public void setUp() {
        System.setProperty("java.protocol.handler.pkgs", "org.jvoicexml.jsapi2.jse.protocols");
    }
    ...
    public void testGetInputStream() throws Exception {
        final URL url = new URL("capture://audio?rate=8000&channels=1&encoding=pcm");
    ...
    public void testGetOutputStream() throws Exception {
        ...
        final URL url = new URL("playback://audio?rate=44100&channels=2&encoding=pcm&bits=16");
        final PlaybackURLConnection connection = new PlaybackURLConnection(url);
        connection.connect();
