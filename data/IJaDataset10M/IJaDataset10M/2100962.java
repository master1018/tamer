...
public class GlossaryTermsTable extends AbstractRequelNavigatorTable {
    ...
    static {
        ComponentManipulators.setManipulator(GlossaryTermsTable.class, new GlossaryTermsTableManipulator());
    }
    ...
    private NavigatorTableConfig getTableConfig() {
        ...
        tableConfig.addColumnConfig(new NavigatorTableColumnConfig("", new NavigatorTableCellValueFactory() {
            ...
            public Object getValueAt(NavigatorTableModel model, int column, int row) {
                ...
                if (isReadOnlyMode()) {
                    buttonLabel = getResourceBundleHelper(getLocale()).getString(PROP_VIEW_GLOSSARY_TERM_BUTTON_LABEL, "View");
                } else {
                    buttonLabel = getResourceBundleHelper(getLocale()).getString(PROP_EDIT_GLOSSARY_TERM_BUTTON_LABEL, "Edit");
                }
                NavigationEvent openEditorEvent = new OpenPanelEvent(this, PanelActionType.Editor, glossaryTerm, glossaryTerm.getClass(), null, WorkflowDisposition.NewFlow);
                NavigatorButton openEditorButton = new NavigatorButton(buttonLabel, getEventDispatcher(), openEditorEvent);
        ...
        tableConfig.addColumnConfig(new NavigatorTableColumnConfig("Term", new NavigatorTableCellValueFactory() {
        ...
        tableConfig.addColumnConfig(new NavigatorTableColumnConfig("Definition", new NavigatorTableCellValueFactory() {
        ...
        tableConfig.addColumnConfig(new NavigatorTableColumnConfig("Created By", new NavigatorTableCellValueFactory() {
        ...
        tableConfig.addColumnConfig(new NavigatorTableColumnConfig("Date Created", new NavigatorTableCellValueFactory() {
