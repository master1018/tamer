...
public class texture_env_modeType extends com.jmex.xml.xml.Node {

    public texture_env_modeType(texture_env_modeType node) {
        super(node);
    }

    public texture_env_modeType(org.w3c.dom.Node node) {
        super(node);
    }

    public texture_env_modeType(org.w3c.dom.Document doc) {
        super(doc);
    }

    public texture_env_modeType(com.jmex.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public void setXsiType() {
        ...
        el.setAttributeNS("http://www.w3.org/2001/XMLSchema-instance", "xsi:type", "texture_env_mode");
    }
    ...
    public string getvalue2At(int index) throws Exception {
        return new string(getDomNodeValue(getDomChildAt(Attribute, null, "value", index)));
    }
    ...
    public string getvalue2ValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new com.jmex.xml.xml.XmlException("Out of range"); else return new string(getDomNodeValue(curNode));
    }
    ...
    public org.w3c.dom.Node addvalue2(string value) {
    ...
    public org.w3c.dom.Node addvalue2(String value) throws Exception {
        return addvalue2(new string(value));
    }
    ...
    public GL_MAX_TEXTURE_IMAGE_UNITS_index getindexValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new com.jmex.xml.xml.XmlException("Out of range"); else return new GL_MAX_TEXTURE_IMAGE_UNITS_index(getDomNodeValue(curNode));
    }
