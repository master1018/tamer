...
public class SubMenuREF extends DmcNamedObjectNontransportableREF<SubMenuDMO> {
    ...
    public static final DmcAttributeInfo __elementName = new DmcAttributeInfo("elementName", 868, "CamelCaseName", ValueTypeEnum.SINGLE, DataTypeEnum.PERSISTENT);
    ...
    public void setObject(SubMenuDMO o) {
        object = o;
        if (object != null) myName = (DmcTypeCamelCaseNameSV) o.getObjectNameAttribute();
    }
    ...
    public void setName(DmcObjectName n) throws DmcValueException {
        if (myName == null) myName = new DmcTypeCamelCaseNameSV(__elementName);
        myName.set(n);
    }
