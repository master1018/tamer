...
public class Asset implements org.osid.repository.Asset {
    ...
    protected Asset(String displayName, String description, String url, org.osid.shared.Id repositoryId) throws org.osid.repository.RepositoryException {
        try {
    ...
    public org.osid.repository.PartIterator getPartByPart(org.osid.shared.Id partStructureId) throws org.osid.repository.RepositoryException {
    ...
    public org.osid.shared.ObjectIterator getPartValueByPart(org.osid.shared.Id partStructureId) throws org.osid.repository.RepositoryException {
        java.util.Vector results = new java.util.Vector();
