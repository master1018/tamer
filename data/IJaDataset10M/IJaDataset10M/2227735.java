...
public class OfflineCachingStorageTest extends TestCase {
    ...
    public void testPutAndGet() throws Exception {
        ...
        RepositoryTaskData newData = new RepositoryTaskData(new MockAttributeFactory(), MockRepositoryConnector.REPOSITORY_KIND, MockRepositoryConnector.REPOSITORY_URL, MOCK_ID);
        ...
        RepositoryTaskData oldData = new RepositoryTaskData(new MockAttributeFactory(), MockRepositoryConnector.REPOSITORY_KIND, MockRepositoryConnector.REPOSITORY_URL, MOCK_ID);
