   ...
   */
    public void setArgs(FunctionArguments newArgs) {
        if (newArgs != args) {
            ...
            if (args != null) msgs = ((InternalEObject) args).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MDDPackage.UNIQUENESS_VALIDATION_RULE_DECLARATION__ARGS, null, msgs);
            if (newArgs != null) msgs = ((InternalEObject) newArgs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MDDPackage.UNIQUENESS_VALIDATION_RULE_DECLARATION__ARGS, null, msgs);
            msgs = basicSetArgs(newArgs, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, MDDPackage.UNIQUENESS_VALIDATION_RULE_DECLARATION__ARGS, newArgs, newArgs));
    }
