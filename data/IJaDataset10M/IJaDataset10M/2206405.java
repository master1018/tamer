...
public class DoubleBiOperatorEval extends BinaryOperatorEvaluation {
    ...
    public DoubleBiOperatorEval(ReturnsValue operon1, ReturnsValue operon2, OperatorTypes operator, LineInfo line) {
    ...
    @Override
    public Object operate(Object value1, Object value2) throws PascalArithmeticException, InternalInterpreterException {
    ...
    public ReturnsValue compileTimeExpressionFold(CompileTimeContext context) throws ParsingException {
        ...
        if (val != null) {
            ...
            return new DoubleBiOperatorEval(operon1.compileTimeExpressionFold(context), operon2.compileTimeExpressionFold(context), operator_type, line);
        }
    }
}
