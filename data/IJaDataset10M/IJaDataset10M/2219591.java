...
public class ContactAddresDetailDao extends BaseDao<ContactAddresDetail> {
    ...
    @Inject
    public ContactAddresDetailDao(Provider<EntityManager> em, ManipulationObjectFactory objectFactory, AssistedObjectHandlerFactory handlerFactory, DescriptorStore descStore) {
