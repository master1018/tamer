...
public class RequestTest extends TestCase {
    ...
    public void testContent() throws Exception {
        ...
        for (int l = 0; l < 1025; l++) {
            ...
            if (l > 0) assertEquals(l, _handler._content.length());
        }
    }
    ...
    class RequestHandler extends AbstractHandler {
        ...
        public void handle(String target, HttpServletRequest request, HttpServletResponse response, int dispatch) throws IOException, ServletException {
            ...
            if (request.getContentLength() > 0) _content = IO.toString(request.getInputStream());
            if (_checker != null && _checker.check(request, response)) response.setStatus(200); else response.sendError(500);
        }
    }
}
