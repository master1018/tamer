...
public class KnownFeatureExtractor<E> extends ModifiedFeatureExtractor<E> implements Serializable {
    ...
    public Number filter(String feature, Number value) {
        return mKnownFeatureSet.contains(feature) ? value : null;
    }
    ...
    static class Serializer<F> extends AbstractExternalizable {
        ...
        public void writeExternal(ObjectOutput out) throws IOException {
            ...
            for (String s : mExtractor.mKnownFeatureSet) out.writeUTF(s);
        ...
        public Object read(ObjectInput in) throws IOException, ClassNotFoundException {
            ...
            for (int i = 0; i < size; ++i) knownFeatureSet.add(in.readUTF());
            @SuppressWarnings("unchecked") FeatureExtractor<F> baseExtractor = (FeatureExtractor<F>) in.readObject();
