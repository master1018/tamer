package org.pcomeziantou.volleylife.model;
...
public class DimensionLine implements Serializable, Selectable {
	 ...
	 * <code>PropertyChangeListener</code>s added to a dimension line will be
	 * notified under a property name equal to the string value of one these
	 * properties.
	 */
    public enum Property {

        X_START, Y_START, X_END, Y_END, OFFSET, LENGTH_STYLE
    }
    ...
    /**
	 * Initializes new dimension line transient fields and reads its properties
	 * from <code>in</code> stream with default reading method.
	 */
    ...
    /**
	 * Sets the start point abscissa of this dimension line. Once this dimension
	 * line is updated, listeners added to this dimension line will receive a
	 * change notification.
	 */
    ...
    /**
	 * Sets the start point ordinate of this dimension line. Once this dimension
	 * line is updated, listeners added to this dimension line will receive a
	 * change notification.
	 */
    ...
    /**
	 * Sets the end point abscissa of this dimension line. Once this dimension
	 * line is updated, listeners added to this dimension line will receive a
	 * change notification.
	 */
    ...
    /**
	 * Sets the end point ordinate of this dimension line. Once this dimension
	 * line is updated, listeners added to this dimension line will receive a
	 * change notification.
	 */
    ...
    /**
	 * Sets the offset of this dimension line. Once this dimension line is
	 * updated, listeners added to this dimension line will receive a change
	 * notification.
	 */
    ...
    /**
	 * Sets the text style used to display dimension line length. Once this
	 * dimension line is updated, listeners added to it will receive a change
	 * notification.
	 */
    ...
    /**
	 * Returns the points of the rectangle surrounding this dimension line and
	 * its extension lines.
	 * 
    ...
    public float[][] getPoints() {
        ...
        return new float[][] { { this.xStart, this.yStart }, { this.xStart + dx, this.yStart + dy }, { this.xEnd + dx, this.yEnd + dy }, { this.xEnd, this.yEnd } };
    }

    /**
	 * Returns <code>true</code> if this dimension line intersects with the
	 * horizontal rectangle which opposite corners are at points (
    ...
    /**
	 * Returns <code>true</code> if this dimension line contains the point at (
    ...
    /**
	 * Returns <code>true</code> if the middle point of this dimension line is
	 * the point at (<code>x</code>, <code>y</code>) with a given
	 * <code>margin</code>.
	 */
    ...
    /**
	 * Returns <code>true</code> if the extension line at the start of this
	 * dimension line contains the point at (<code>x</code>, <code>y</code>)
    ...
    public boolean containsStartExtensionLinetAt(float x, float y, float margin) {
        double angle = Math.atan2(this.yEnd - this.yStart, this.xEnd - this.xStart);
        Line2D startExtensionLine = new Line2D.Float(this.xStart, this.yStart, this.xStart + (float) -Math.sin(angle) * this.offset, this.yStart + (float) Math.cos(angle) * this.offset);
        return containsShapeAtWithMargin(startExtensionLine, x, y, margin);
    }

    /**
	 * Returns <code>true</code> if the extension line at the end of this
	 * dimension line contains the point at (<code>x</code>, <code>y</code>)
	 * with a given <code>margin</code> around the extension line.
	 */
    public boolean containsEndExtensionLineAt(float x, float y, float margin) {
        double angle = Math.atan2(this.yEnd - this.yStart, this.xEnd - this.xStart);
        Line2D endExtensionLine = new Line2D.Float(this.xEnd, this.yEnd, this.xEnd + (float) -Math.sin(angle) * this.offset, this.yEnd + (float) Math.cos(angle) * this.offset);
        return containsShapeAtWithMargin(endExtensionLine, x, y, margin);
    }

    /**
	 * Returns <code>true</code> if <code>shape</code> contains the point at (
	 * <code>x</code>, <code>y</code>) with a given <code>margin</code>.
	 */
