...
/**
 * Clase que representa un fragmento de un archivo. Se enviarán objetos de esta
 * clase como respuestas asíncronas a la recepción de mensajes del tipo FileRequest
 * cuando el archivo no quepa en un único mensaje.
