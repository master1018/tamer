...
public class IndicatorProperties extends AbstractPropertyListener {
    ...
    public int getStrokeIndex1() {
        return strokeIndex1;
    }

    public void setStrokeIndex1(int i) {
        strokeIndex1 = i;
    }

    public Stroke getStroke1() {
        return StrokeGenerator.getStroke(strokeIndex1);
    }

    public void setStroke1(Stroke s) {
        strokeIndex1 = StrokeGenerator.getStrokeIndex(s);
    }

    public int getStrokeIndex2() {
        return strokeIndex2;
    }

    public void setStrokeIndex2(int i) {
        strokeIndex2 = i;
    }

    public Stroke getStroke2() {
        return StrokeGenerator.getStroke(strokeIndex2);
    }

    public void setStroke2(Stroke s) {
        strokeIndex2 = StrokeGenerator.getStrokeIndex(s);
    }
}
