...
public class MutilInputResourceSelector extends ResourceSelector {
    ...
    public void setInputs(IContainer[] iContainers) {
        ...
        if (dia != null) {
            ...
            if (dia.open() != IDialogConstants.OK_ID) this.setResult(null);
        }
        TreeViewer treeViewer = this.getTreeViewer();
        if (treeViewer != null && !treeViewer.getTree().isDisposed()) treeViewer.setInput(iContainers);
    }
    ...
    private class ResourceContentProvider extends ResourceSelector.ResourceContentProvider {
