...
public class ListFeedHelper {
   ...
   */
    public ListEntry addListEntry(ListEntry entry) throws IOException, ServiceException {
   ...
   * @throws ServiceException if there was an error processnig the request
   */
    public List<ListEntry> getAllListEntries() throws IOException, ServiceException {
   ...
   * @throws ServiceException if there was an error processnig the request
   */
    public List<ListEntry> getFullTextSearch(String search) throws IOException, ServiceException {
        ListQuery query = new ListQuery(feedUrl);
   ...
   * @throws ServiceException if there was an error processnig the request
   */
    public List<ListEntry> getStructuredQuery(String structuredQuery) throws IOException, ServiceException {
        ListQuery query = new ListQuery(feedUrl);
