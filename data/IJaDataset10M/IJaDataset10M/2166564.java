...
public class ImplMapEntry implements RenderableCilElement, NativeImplementation {
    ...
    public String toString() {
        return String.format("ImplMapEntry: %s Scope %s (Flags: 0x%04x) MemberForwarded: %s", importName, importScope, mappingFlags, memberForwarded.getName());
    }
    ...
    public int hashCode() {
        final int prime = 31;
        return prime * (prime + ((importName == null) ? 0 : importName.hashCode())) + mappingFlags;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (importScope == null) {
            if (other.importScope != null) return false;
        } else if (!importScope.getFullQualifiedName().equals(other.importScope.getFullQualifiedName())) return false;
        if (mappingFlags != other.mappingFlags) return false;
        if (memberForwarded == null) {
            if (other.memberForwarded != null) return false;
        } else if (!memberForwarded.getName().equals(other.memberForwarded.getName())) return false;
        return true;
    }
}
