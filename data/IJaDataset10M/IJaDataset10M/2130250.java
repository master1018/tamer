...
public class CategoryChangeHistoryItem extends HistoryItem {
    ...
    public CategoryChangeHistoryItem(String category, boolean isDel, String target) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof CategoryChangeHistoryItem)) return false;
        CategoryChangeHistoryItem edit = (CategoryChangeHistoryItem) o;
        return ObjectUtil.equals(target, edit.getTarget()) && ObjectUtil.equals(category, edit.getCategory()) && isDel == edit.isDel();
    }
    ...
    public String toString() {
        if (isDel) return "Removed " + target + " from category " + category; else return "Added " + target + " to category " + category;
    }
