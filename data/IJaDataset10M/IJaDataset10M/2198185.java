...
public class ServerConnectionMock implements ServerConnection {
   ...
   */
    public void triggerServerDelta(TransformedWaveletDelta delta) throws TransformException, OperationException {
   ...
   */
    public void triggerServerDeltas(List<TransformedWaveletDelta> deltas) throws TransformException, OperationException {
   ...
   * Pretend we got the deltas on the wire.
   */
    public void triggerServerDeltas(TransformedWaveletDelta[] deltas) throws TransformException, OperationException {
   ...
   */
    public void triggerServerSuccess(int numDeltasApplied, HashedVersion signature) throws TransformException, OperationException {
        if (listener != null) {
   ...
   * @throws OperationException
   */
    public void triggerServerCommit(long version) throws TransformException, OperationException {
        if (listener != null) {
   ...
   * @param endSignature
   */
    public void triggerOnOpen(HashedVersion startSignature, HashedVersion endSignature) throws ChannelException {
