...
public class IterationCardCreatedCommand extends Command {
    ...
    public IterationCardCreatedCommand(IterationCardModel newCard, TableModel parent, Rectangle bounds) {
