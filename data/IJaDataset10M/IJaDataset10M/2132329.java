...
public class HolidaysPageTest extends TestCase {
    ...
    public void testFillTableFromElement() throws Exception {
        ...
        market.setHolidays(new MarketHoliday[] { new MarketHoliday(getTime(2007, Calendar.DECEMBER, 25), "Holiday 1"), new MarketHoliday(getTime(2008, Calendar.JANUARY, 1), "Holiday 2") });
        page.setElement(new IAdaptable() {

            @SuppressWarnings("unchecked")
            public Object getAdapter(Class adapter) {
                if (adapter.isAssignableFrom(Market.class)) return market;
                return null;
            }
        });
        page.createContents(shell);
