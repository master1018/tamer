...
public final class ColourHelper {
	 ...
	 * @return
	 */
    private static BufferedImage colourAttributes(int xMax, int yMax, BufferedImage output, final BufferedImage original, ColourChoiceStrategy colourChoiceStrategy) {
    ...
    public static int getMonochromeColour(int red, int green, int blue, int ink, int paper) {
        if (isBlack(red, green, blue)) return ink;
        return paper;
    }
}
