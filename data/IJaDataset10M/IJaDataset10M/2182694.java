...
public class TableEditor extends javax.swing.JDialog {
    ...
    public TableEditor(java.awt.Dialog parent, Map<String, String> displayNames, Collection<Line> tables, List<Line> associations, List<String> excludeFromDeletionList, List<String> initialDataTablesList) {
        ...
        setSize(600, 400);
        setLocation(parent.getLocation().x + parent.getSize().width / 2 - getPreferredSize().width / 2, parent.getLocation().y + parent.getSize().height / 2 - getPreferredSize().height / 2);
    ...
    private void initComponents() {
        ...
        columnsTable.setModel(new javax.swing.table.DefaultTableModel(new Object[][] { { null, null, null, null }, { null, null, null, null }, { null, null, null, null }, { null, null, null, null } }, new String[] { "Titel 1", "Titel 2", "Titel 3", "Titel 4" }));
    ...
    private void columnKeyReleased(java.awt.event.KeyEvent evt) {
    }

    private void columnInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
    }

    private void columnKeyTyped(java.awt.event.KeyEvent evt) {
    }

    private void columnActionPerformed(java.awt.event.ActionEvent evt) {
    }

    private void excludeFromDeletionActionPerformed(java.awt.event.ActionEvent evt) {
    }
    ...
    public boolean edit(Line tableLine, Map<String, Line> columnLines) {
        ...
        if (isOk && !(origDisplayName.equals(displayName.getText()) && origName.equals(nameField.getText()) && !needsSave && origUpsert == upsertCheckbox.isSelected() && origExcludeSet == excludeSet && origExportAllSet == exportAllSet)) {
