...
public class LocationResponse extends XMPPBean {
        ...
        do {
            switch(parser.getEventType()) {
                ...
                case XmlPullParser.END_TAG:
                    if (parser.getName().equals(getChildElement())) done = true; else parser.next();
                    break;
    ...
    public String payloadToXML() {
        ...
        sb.append("<" + this.LocationInfo.getChildElement() + ">").append(this.LocationInfo.toXML()).append("</" + this.LocationInfo.getChildElement() + ">");
