...
/**
 * This program loads ionospheric data in {@link dbaccess.iono2.UrsiFormat URSI Format}
 * to the database.  Data is read from the input file using the
 * <i>UrsiFormat</i> class to read and parse the URSI format data.
 * <p>
 * <h3>Program Usage</h3>
 * <p>
 * <B>ursiLoad</B> [Release Properties] [JDBC Properties] [Load Properties] [Other Properties] [<I>inputFile</I>]
 * <UL>
 * <TABLE>
 ...
 * checks for errors.
 * <li>{@link dbaccess.iono2.Ursi Ursi} : Converts each URSI characteristic code into the URSI characteristic code.
 ...
 */
public class ursiLoad {

    public static void main(String[] args) {
        UrsiLoad u = new UrsiLoad();
