...
import net.sourceforge.poi.hssf.record.FontRecord;
 ...
 * @see net.sourceforge.poi.hssf.usermodel.HSSFWorkbook#createFont()
 * @see net.sourceforge.poi.hssf.usermodel.HSSFWorkbook#getFontAt(short)
 * @see net.sourceforge.poi.hssf.usermodel.HSSFCellStyle#setFont(HSSFFont)
 */
public class HSSFFont implements HSSFColorConstants {
     ...
     */
    public static final short BOLDWEIGHT_NORMAL = 190;
