...
public class StudentProjectModuleDAO extends PyramusEntityDAO<StudentProjectModule> {
    ...
    public StudentProjectModule create(StudentProject studentProject, Module module, AcademicTerm academicTerm, CourseOptionality optionality) {
    ...
    public void update(StudentProjectModule studentProjectModule, AcademicTerm academicTerm, CourseOptionality optionality) {
        EntityManager entityManager = getEntityManager();
        studentProjectModule.setAcademicTerm(academicTerm);
        studentProjectModule.setOptionality(optionality);
        entityManager.persist(studentProjectModule);
    ...
    public List<StudentProjectModule> listByStudentProject(StudentProject studentProject) {
        ...
        criteria.where(criteriaBuilder.equal(root.get(StudentProjectModule_.studentProject), studentProject));
