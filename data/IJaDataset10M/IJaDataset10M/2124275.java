...
public class PickPanel extends JPanel implements ListSelectionListener, ChangeListener {
    ...
    private JPanel makeAddToTablePanel() {
        ...
        _addPanel = new jmri.jmrit.beantable.AddNewDevicePanel(_sysNametext, _userNametext, "addToTable", listener);
    ...
    public void valueChanged(ListSelectionEvent e) {
        if (log.isDebugEnabled()) log.debug("ListSelectionEvent from " + e.getSource().getClass().getName() + " idx= " + e.getFirstIndex());
    }
