...
public class NetworkVisum2Matsim {
    ...
    private static final Collection<String> additionalIrrelevantIdsPeriphery = Arrays.asList();

    private static final Collection<String> innerCity30to40KmhIdsNeedingVmaxChange = Arrays.asList();

    private static final Collection<String> innerCity45to60KmhIdsNeedingVmaxChange = Arrays.asList();
    ...
    private void writeNetwork() throws IOException, FileNotFoundException {
