 ...
 * <p>
 * Interval: This class represents an interval on the real line.
 * <p>
 * This class allows to perform simple interval operations like point inclusion
 * tests and intersection operations.
 * </p>
 * <p>
 * There is no distinction between open and closed intervals because real
...
public class Interval {
    ...
    * <p>
    * The given bounds do not need to be ordered, they will be reordered by the
    * constructor.
    * </p>
    * 
    * @param a first bound
    ...
    * </p>
    * <p>
    * This operation is <strong>not</strong> a union operation. If the instance
    * and the interval are disjoints (i.e. if {@link #intersects intersects(i)}
