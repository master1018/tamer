...
public class CastlingPiecesMovementTracker {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CastlingPiecesMovementTracker)) return false;
        CastlingPiecesMovementTracker candidate = (CastlingPiecesMovementTracker) obj;
        return whiteLeftCastleHasMoved == candidate.getWhiteLeftCastleHasMoved() && whiteKingHasMoved == candidate.getWhiteKingHasMoved() && whiteRightCastleHasMoved == candidate.getWhiteRightCastleHasMoved() && blackLeftCastleHasMoved == candidate.getBlackLeftCastleHasMoved() && blackKingHasMoved == candidate.getBlackKingHasMoved() && blackRightKingHasMoved == candidate.getBlackRightKingHasMoved();
    }
