 ...
 * @generated
 */
public class IndividualURIEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
    public IndividualURIEditPart(View view) {
        super(view);
    }
    ...
    protected Image getLabelIcon() {
        return OdmDiagramEditorPlugin.findImageDescriptor("/de.uka.aifb.owl/icons/elements/field.gif").createImage();
    }
            ...
            ParserHintAdapter hintAdapter = new ParserHintAdapter(getParserElement(), parserHint) {
                ...
                public Object getAdapter(Class adapter) {
                    if (IElementType.class.equals(adapter)) {
                        return OdmElementTypes.Individual_2008;
                    }
