...
public class Matrix4f implements Serializable {
    ...
    public Matrix4f(float xx, float yx, float zx, float wx, float xy, float yy, float zy, float wy, float xz, float yz, float zz, float wz, float xw, float yw, float zw, float ww) {
        this.xx = xx;
        this.xy = xy;
        this.xz = xz;
        this.xw = xw;
    ...
    public void set(float xx, float yx, float zx, float wx, float xy, float yy, float zy, float wy, float xz, float yz, float zz, float wz, float xw, float yw, float zw, float ww) {
        this.xx = xx;
        this.xy = xy;
        this.xz = xz;
        this.xw = xw;
    ...
    public static void main(String[] args) {
        ...
        myTransMatrix.translation.set(2, 3, 4);
