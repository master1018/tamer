 ...
 * 
 */
class MethodDefinitionsDeserializer extends DefaultHandler {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (localName.equals("UserInputParm")) {
            ...
            if (m_parmRequired != null) {
                if (m_parmRequired.equalsIgnoreCase("true") || m_parmRequired.equalsIgnoreCase("yes") || m_parmRequired.equals("1")) {
                    parmRequired = true;
                }
            }
            m_methodParms.add(new ParameterDefinition(m_parmName, m_parmLabel, parmRequired, m_parmDefaultValue, m_parmValidValues));
            ...
            m_result.add(new MethodDefinition(m_methodName, m_methodLabel, m_methodParms));
        }
    }
}
