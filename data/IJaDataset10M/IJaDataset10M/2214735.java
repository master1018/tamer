...
public class ControllerPanel extends JPanel {
    ...
    protected void initComponents() {
        ...
        ctrlSplitter = new DefaultStringSplitter(DevicePoolUtils.CTRL_DESCRIPTION_PATTERN, DevicePoolUtils.CTRL_DESCRIPTION_ELEMS, new DefaultStringFilter(), 0);
        ...
        GridBagConstraints gbc = new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.NORTH, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0);
        add(ctrlPropertiesViewer, gbc);
        propertiesViewer = new PropertiesFormViewerPanel();
        gbc = new GridBagConstraints(0, 2, 1, 1, 1.0, 0.5, GridBagConstraints.NORTH, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0);
