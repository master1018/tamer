...
public class SimpleBean {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((strPropEmpty == null) ? 0 : strPropEmpty.hashCode());
        result = prime * result + ((strPropNull == null) ? 0 : strPropNull.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (boolProp != other.boolProp) return false;
        if (byteProp != other.byteProp) return false;
        if (charProp != other.charProp) return false;
        if (Double.doubleToLongBits(doubleProp) != Double.doubleToLongBits(other.doubleProp)) return false;
        if (Float.floatToIntBits(floatProp) != Float.floatToIntBits(other.floatProp)) return false;
        if (intProp != other.intProp) return false;
        if (longProp != other.longProp) return false;
        if (shortProp != other.shortProp) return false;
        if (strProp == null) {
            if (other.strProp != null) return false;
        } else if (!strProp.equals(other.strProp)) return false;
        if (strPropEmpty == null) {
            if (other.strPropEmpty != null) return false;
        } else if (!strPropEmpty.equals(other.strPropEmpty)) return false;
        if (strPropNull == null) {
            if (other.strPropNull != null) return false;
        } else if (!strPropNull.equals(other.strPropNull)) return false;
        return true;
    }
}
