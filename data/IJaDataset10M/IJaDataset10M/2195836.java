...
public abstract class IndexReader {
        ...
        synchronized (directory) {
            return (IndexReader) new Lock.With(directory.makeLock(IndexWriter.COMMIT_LOCK_NAME), IndexWriter.COMMIT_LOCK_TIMEOUT) {
                ...
                public Object doBody() throws IOException {
                    ...
                    for (int i = 0; i < infos.size(); i++) readers[i] = SegmentReader.get(infos.info(i));
   ...
   */
    public final synchronized void setNorm(int doc, String field, byte value) throws IOException {
        if (directoryOwner) aquireWriteLock();
   ...
   */
    public Collection getIndexedFieldNames(boolean storedTermVector) {
        if (storedTermVector) {
            ...
            return fieldSet;
        } else return getIndexedFieldNames(Field.TermVector.NO);
    }
