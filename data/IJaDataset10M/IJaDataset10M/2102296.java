...
public class ColorChooser implements TextListener, AdjustmentListener {
    ...
    public Color getColor() {
        ...
        for (int i = 0; i < colors.size(); i++) ((TextField) colors.elementAt(i)).addTextListener(this);
        sliders = gd.getSliders();
        for (int i = 0; i < sliders.size(); i++) ((Scrollbar) sliders.elementAt(i)).addAdjustmentListener(this);
        gd.showDialog();
