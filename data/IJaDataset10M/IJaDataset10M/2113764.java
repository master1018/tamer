...
public class GraphSimilarity implements ISimilarity {
    ...
    */
    ...
    public double getOverallSimilarity() {
        if (clCalculator == null) return ValueSimilarity * ContainmentSimilarity * SizeSimilarity; else return clCalculator.Calculate(this, this);
    }
    ...
    public double asDistance() {
        ...
        if (dS == 0) return Double.POSITIVE_INFINITY; else return 1.0 / dS;
    }
