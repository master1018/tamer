...
public interface ISarosSessionManager {
     ...
     */
    public void startSession(HashMap<IProject, List<IResource>> projectResources) throws XMPPException;
     ...
     */
    public ISarosSession joinSession(JID host, int myColorID, DateTime sessionStart);
     ...
     */
    public void invitationReceived(JID from, String sessionID, int colorID, VersionInfo versionInfo, DateTime sessionStart, SarosUI sarosUI, String invitationID, MUCSessionPreferences comPrefs, String description);
