...
public class SessionListener implements HttpSessionListener {
    ...
    public void sessionDestroyed(HttpSessionEvent se) {
        ...
        if (session.getAttribute(HttpCookies.SESSION_ID_KEY) != null) {
            ACCESS_LOGGER.info("LOG OUT: User " + session.getAttribute(HttpCookies.NAME_KEY) + " with openID " + session.getAttribute(HttpCookies.SESSION_ID_KEY) + " at " + FORMATTER.format(new Date()));
