...
public class TestFilter {
    ...
    public void testComparisonSynthetic() {
        ...
        System.out.println(su.score(0) + "\t" + relief.score(0) + "\t" + gr.score(0) + "\t" + kl.score(0) + "\t" + rfe.rank(0));
        System.out.println(su.score(1) + "\t" + relief.score(1) + "\t" + gr.score(1) + "\t" + kl.score(1) + "\t" + rfe.rank(1));
        System.out.println(su.score(2) + "\t" + relief.score(2) + "\t" + gr.score(2) + "\t" + kl.score(2) + "\t" + rfe.rank(2));
    }
    ...
    public void testComparisonReal() {
        try {
            ...
            System.out.println(su.score(1) + "\t" + relief.score(1) + "\t" + gr.score(1) + "\t" + kl.score(1) + "\t" + rfe.rank(1));
            System.out.println(su.score(2) + "\t" + relief.score(2) + "\t" + gr.score(2) + "\t" + kl.score(2) + "\t" + rfe.rank(2));
            System.out.println(su.score(3) + "\t" + relief.score(3) + "\t" + gr.score(3) + "\t" + kl.score(3) + "\t" + rfe.rank(3));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
