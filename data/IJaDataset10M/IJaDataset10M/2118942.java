...
public class Rdr {
    ...
    protected RdrCache _rdrCache = new RdrCache();
    ...
    public RdrConclusion evaluate(YSpecificationID specID, String taskID, Element data, RuleType rType) {
     ...
     */
    private RdrConclusion getConclusion(YSpecificationID specID, String taskID, Element data, RuleType rType) {
        if (specID != null) {
    ...
    private RdrConclusion getConclusion(String processName, String taskID, Element data, RuleType rType) {
        if (processName != null) {
    ...
    private RdrTree getTree(YSpecificationID specID, String taskID, RuleType rType) {
        return getTree(getRdrSet(specID), taskID, rType);
    }
    ...
    private RdrTree getTree(RdrSet ruleSet, String taskID, RuleType rType) {
        ...
        RdrTree tree = rType.isCaseLevelType() ? ruleSet.getTree(rType) : ruleSet.getTree(rType, taskID);
