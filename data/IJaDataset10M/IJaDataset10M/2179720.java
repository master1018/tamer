...
public class CalcBehaviour extends OneShotBehaviour {
    ...
    int WordNGramSize_Min, WordNGramSize_Max, Word_Dmax, CharacterNGramSize_Min, CharacterNGramSize_Max, Character_Dmax;
     ...
     */
    public CalcBehaviour(String sDoc1, String sDoc2, int iWordNGramSize_Min, int iWordNGramSize_Max, int iWord_Dmax, int iCharacterNGramSize_Min, int iCharacterNGramSize_Max, int iCharacter_Dmax, boolean bDoCharNGrams, boolean bDoWordNGrams, boolean bSilent, String sID) {
        Doc1 = sDoc1;
        Doc2 = sDoc2;
        ID = sID;
    ...
    public void action() {
        ...
        try {
            ...
            if (DoWordNGrams) ndDoc1.setDataString(Doc1);
            if (DoCharNGrams) ndNDoc1.setDataString(Doc1);
            ...
            if (DoCharNGrams) {
                ndNDoc2 = new NGramGaussNormDocument(CharacterNGramSize_Min, CharacterNGramSize_Max, Character_Dmax, CharacterNGramSize_Min, CharacterNGramSize_Max);
            ...
            if (!Silent) synchronized (System.err) {
