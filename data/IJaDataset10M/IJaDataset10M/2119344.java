...
public class EPPHostUpdate extends EPPHostBase implements epp_HostUpdate {
    ...
    public String toXML() throws epp_XMLException {
        ...
        if (action_request_ == null || action_request_.m_cmd == null || action_request_.m_name == null) {
        ...
        Element add_element = getAddRemoveElement(doc, action_request_.m_add, "host:add");
        if (add_element != null) {
            host_update.appendChild(add_element);
        }
        Element remove_element = getAddRemoveElement(doc, action_request_.m_remove, "host:rem");
        if (remove_element != null) {
            host_update.appendChild(remove_element);
        }
        if (action_request_.m_change != null && action_request_.m_change.m_name != null) {
