...
public class M17N {
	 ...
	 * @param title
	 */
    @Pointcut("call(void java.awt.Frame+.setTitle(String)) && args(title) " + "|| call(void java.awt.Dialog+.setTitle(String)) && args(title)")
	 ...
	 * @param text
	 */
    @Pointcut("(call(void (javax.swing.JLabel+ || java.awt.Label+ || javax.swing.AbstractButton+).setText(String)) " + "|| call (void javax.swing.JComponent.setToolTipText(String))) " + "&& args(text)")
