...
public final class CreatePixelMatrixDialog extends JDialog {
    ...
    private JPanel createButtonPanel() {
        ...
        Dimension d = new Dimension(Math.max(cancelButton.getPreferredSize().width, 70), cancelButton.getPreferredSize().height);
     ...
     */
    private static class PixelMatrixEditorsComboBoxModel extends AbstractListModel implements ComboBoxModel {
