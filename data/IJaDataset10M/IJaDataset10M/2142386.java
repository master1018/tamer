...
public class RepositoryFtplet extends DefaultFtplet {
     ...
     */
    public FtpletResult afterCommand(FtpSession session, FtpRequest ftpRequest, FtpReply reply) throws FtpException, IOException {
     ...
     * @throws IOException _more_
     */
    public FtpletResult beforeCommand(FtpSession session, FtpRequest ftpRequest) throws FtpException, IOException {
        try {
            if (!didit) {
            }
    ...
    private Request getRequest(FtpSession session) throws Exception {
        try {
            ...
            String name = ((user == null) ? org.ramadda.repository.auth.UserManager.USER_ANONYMOUS : user.getName());
            return new Request(getRepository(), getRepository().getUserManager().findUser(name));
        } catch (Exception exc) {
     ...
     * @throws Exception _more_
     */
    private Entry getGroup(Request request, FtpSession session) throws Exception {
     ...
     * @throws IOException _more_
     */
    public FtpletResult handleError(FtpSession session, FtpRequest ftpRequest, String message) throws FtpException, IOException {
     ...
     * @throws IOException _more_
     */
    public FtpletResult handleError(FtpSession session, FtpRequest ftpRequest, int reply, String message) throws FtpException, IOException {
     ...
     * @throws Exception _more_
     */
    public FtpletResult handlePwd(Request request, Entry group, FtpSession session, FtpRequest ftpRequest) throws Exception {
        ...
        session.write(new DefaultFtpReply(FtpReply.REPLY_257_PATHNAME_CREATED, result.toString()));
        return FtpletResult.SKIP;
    }
     ...
     * @throws Exception _more_
     */
    public FtpletResult handleSyst(Request request, Entry group, FtpSession session, FtpRequest ftpRequest) throws Exception {
        session.write(new DefaultFtpReply(FtpReply.REPLY_215_NAME_SYSTEM_TYPE, "UNIX Type: L8"));
        return FtpletResult.SKIP;
    }
     ...
     * @throws Exception _more_
     */
    public FtpletResult handleList(Request request, Entry group, FtpSession session, FtpRequest ftpRequest) throws Exception {
        ...
        session.write(new DefaultFtpReply(FtpReply.REPLY_150_FILE_STATUS_OKAY, " Here comes the directory listing.."));
        session.getDataConnection().openConnection().transferToClient(session, result.toString());
        session.write(new DefaultFtpReply(FtpReply.REPLY_226_CLOSING_DATA_CONNECTION, "Directory send OK."));
     ...
     * @throws Exception _more_
     */
    public FtpletResult handleMkd(Request request, Entry group, FtpSession session, FtpRequest ftpRequest) throws Exception {
     ...
     * @throws Exception _more_
     */
    public FtpletResult handleDele(Request request, Entry group, FtpSession session, FtpRequest ftpRequest) throws Exception {
     ...
     * @throws Exception _more_
     */
    public FtpletResult handleRmd(Request request, Entry group, FtpSession session, FtpRequest ftpRequest) throws Exception {
        Entry entry = findEntry(request, group, ftpRequest.getArgument());
        if (entry == null) {
            return handleError(session, ftpRequest, "Not a valid file:" + ftpRequest.getArgument());
        }
     ...
     * @throws Exception _more_
     */
    public FtpletResult handleRetr(Request request, Entry group, FtpSession session, FtpRequest ftpRequest) throws Exception {
        ...
        try {
            if (outputType != null) {
                ...
                inputStream = getRepository().getStorageManager().getFileInputStream(file);
            }
            session.write(new DefaultFtpReply(FtpReply.REPLY_150_FILE_STATUS_OKAY, "Opening binary mode connect."));
            session.getDataConnection().openConnection().transferToClient(session, inputStream);
     ...
     * @throws Exception _more_
     */
    public FtpletResult handleSize(Request request, Entry group, FtpSession session, FtpRequest ftpRequest) throws Exception {
        String entryName = ftpRequest.getArgument();
        Entry entry = findEntry(request, group, entryName);
        ...
        session.write(new DefaultFtpReply(FtpReply.REPLY_250_REQUESTED_FILE_ACTION_OKAY, "" + entry.getFile().length()));
        return FtpletResult.SKIP;
    }
     ...
     * @throws Exception _more_
     */
    private Entry findEntry(Request request, Entry parent, String name) throws Exception {
     ...
     * @throws Exception _more_
     */
    private List<Entry> findEntries(Request request, Entry parent, String name) throws Exception {
        if (name.endsWith("/")) {
        ...
        if (name.startsWith("/")) {
            ...
            result = getEntryManager().findDescendants(request, getEntryManager().getTopGroup(), name);
            return result;
        } else {
     ...
     * @throws Exception _more_
     */
    public FtpletResult handleCwd(Request request, Entry group, FtpSession session, FtpRequest ftpRequest) throws Exception {
        StringBuffer result = new StringBuffer();
        ...
        session.write(new DefaultFtpReply(FtpReply.REPLY_250_REQUESTED_FILE_ACTION_OKAY, result.toString()));
        return FtpletResult.SKIP;
    }
     ...
     * @throws IOException _more_
     */
    public FtpletResult onLogin(FtpSession session, FtpRequest ftpRequest) throws FtpException, IOException {
