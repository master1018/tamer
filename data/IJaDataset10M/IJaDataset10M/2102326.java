...
public class JainSleeServerComponent implements JainSleeServerUtils, MeasurementFacet, OperationFacet, CreateChildResourceFacet {
    ...
    private void doGetERSGlobal(MBeanServerConnection connection, PropertyList statistics) throws Exception {
        ...
        PropertyMap query = new PropertyMap("EventRouterStatistics", new PropertySimple("id", "JAIN SLEE Container"), new PropertySimple("activitiesMapped", activitiesMapped), new PropertySimple("averageEventRoutingTime", averageEventRoutingTime), new PropertySimple("executedTasks", executedTasks), new PropertySimple("miscTasksExecuted", miscTasksExecuted));
    ...
    private void doGetERSExecutors(MBeanServerConnection connection, PropertyList statistics) throws Exception {
        ...
        for (int executorId = 0; executorId < numExecutors; executorId++) {
            ...
            PropertyMap query = new PropertyMap("EventRouterStatistics", new PropertySimple("id", "Executor #" + executorId), new PropertySimple("activitiesMapped", activitiesMapped), new PropertySimple("averageEventRoutingTime", averageEventRoutingTime), new PropertySimple("executedTasks", executedTasks), new PropertySimple("executingTime", executingTime), new PropertySimple("idleTime", idleTime), new PropertySimple("miscTasksExecuted", miscTasksExecuted));
            statistics.add(query);
        }
    }
    ...
    private void doGetERSEventTypes(MBeanServerConnection connection, PropertyList statistics) throws Exception {
        ...
        DeploymentMBean deploymentMBean = (DeploymentMBean) MBeanServerInvocationHandler.newProxyInstance(connection, deploymentObjectName, DeploymentMBean.class, false);
        ...
        for (EventTypeID eventType : eventTypes) {
            ...
            PropertyMap query = new PropertyMap("EventRouterStatistics", new PropertySimple("id", eventType.toString()), new PropertySimple("averageEventRoutingTime", averageEventRoutingTime), new PropertySimple("eventsRouted", eventsRouted));
            statistics.add(query);
        }
    }
    ...
    private void doGetERSCombined(MBeanServerConnection connection, PropertyList statistics) throws Exception {
        ...
        for (EventTypeID eventType : eventTypes) {
            for (int executorId = 0; executorId < numExecutors; executorId++) {
                ...
                PropertyMap query = new PropertyMap("EventRouterStatistics", new PropertySimple("id", eventType.toString() + "@Executor #" + executorId), new PropertySimple("averageEventRoutingTime", averageEventRoutingTime), new PropertySimple("routingTime", routingTime), new PropertySimple("eventsRouted", eventsRouted));
                statistics.add(query);
            }
        }
    }
    ...
    public CreateResourceReport createResource(CreateResourceReport createResourceReport) {
        ...
        if (resourceType.getCreationDataType() == ResourceCreationDataType.CONTENT) createContentBasedResource(createResourceReport, resourceType);
    ...
    private void createContentBasedResource(CreateResourceReport createResourceReport, ResourceType resourceType) {
        ...
        try {
            ...
            MBeanServerConnection connection = this.mBeanServerUtils.getConnection();
            this.mBeanServerUtils.login();
            DeploymentMBean deploymentMBean = (DeploymentMBean) MBeanServerInvocationHandler.newProxyInstance(connection, deploymentObjName, javax.slee.management.DeploymentMBean.class, false);
            String depKey = null;
            if (!persistentDeploy) {
    ...
    private OperationResult doSleeState(Configuration parameters) throws Exception {
        try {
            ...
            MBeanServerConnection connection = this.mBeanServerUtils.getConnection();
            this.mBeanServerUtils.login();
            SleeManagementMBean sleeManagementMBean = (SleeManagementMBean) MBeanServerInvocationHandler.newProxyInstance(connection, sleemanagement, javax.slee.management.SleeManagementMBean.class, false);
    ...
    private OperationResult doQueryActivityContextLiveness(Configuration parameters) throws Exception {
        try {
            ...
            ActivityManagementMBeanImplMBean aciManagMBean = (ActivityManagementMBeanImplMBean) MBeanServerInvocationHandler.newProxyInstance(connection, actMana, org.mobicents.slee.container.management.jmx.ActivityManagementMBeanImplMBean.class, false);
    ...
    private OperationResult doSwitchLoggingConfiguration(Configuration parameters) throws Exception {
        try {
            ...
            MobicentsManagementMBean mobicentsManagementMBean = (MobicentsManagementMBean) MBeanServerInvocationHandler.newProxyInstance(connection, actMana, org.mobicents.slee.container.management.jmx.MobicentsManagementMBean.class, false);
    ...
    private EventRouterStatisticsMBean getEventRouterStatisticsMBean() throws Exception {
        try {
            ...
            EventRouterStatisticsMBean erStatsMBean = (EventRouterStatisticsMBean) MBeanServerInvocationHandler.newProxyInstance(connection, erStatsObjectName, EventRouterStatisticsMBean.class, false);
            return erStatsMBean;
        } finally {
            try {
                this.mBeanServerUtils.logout();
    ...
    private EventRouterConfigurationMBean getEventRouterConfigurationMBean() throws Exception {
        try {
            ...
            EventRouterConfigurationMBean erConfigMBean = (EventRouterConfigurationMBean) MBeanServerInvocationHandler.newProxyInstance(connection, erConfigObjectName, EventRouterConfigurationMBean.class, false);
