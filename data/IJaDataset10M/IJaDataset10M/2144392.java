...
public class GUI implements Runnable {
    ...
    public void run() {
        ...
        this.connectedImg = new Image(display, this.getClass().getResourceAsStream("/res/connected.png"));
        this.notConnectedImg = new Image(display, this.getClass().getResourceAsStream("/res/notConnected.png"));
        this.shell = new Shell();
        Image appIcon = new Image(display, this.getClass().getResourceAsStream("/res/appIcon.png"));
    ...
    private void createConnectionStatusPanel() {
        ...
        status.setLayoutData(new GridData(SWT.FILL, SWT.BEGINNING, true, false, 2, 0));
        ...
        connectionImgLabel.setLayoutData(new GridData(SWT.END, SWT.BEGINNING, true, false, 2, 1));
    }
    ...
    public void createFooter(final Image logo, final String[] resetCommands) {
        ...
        footer.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 2, 1));
        ...
        if (resetCommands != null) {
            Image reset = new Image(display, this.getClass().getResourceAsStream("/res/reset.png"));
            Button resetButton = new Button(footer, SWT.FLAT);
            resetButton.setLayoutData(new GridData(SWT.END, SWT.FILL, true, true));
    ...
    public synchronized Button addButton(final String[] commands, final String caption, final Composite parent) {
        return addButton(commands, null, caption, parent);
    }

    public synchronized Button addButton(final String[] commands, Image img, final String caption, final Composite parent) {
        if (img != null) {
    ...
    public void updateStatus() {
        ...
        if (connectedNow != lastConnectionStatus) {
            logger.debug("Was connected=" + lastConnectionStatus + " but now=" + connectedNow);
