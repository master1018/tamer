...
public class ProfileDbAdapter {
    ...
    public ProfileDbAdapter(Context ctx, String table) {
        ...
        DATABASE_CREATE = "create table " + getDatabaseTable() + " (_id integer primary key autoincrement, " + "fullname text not null, gizmoname text not null, city text, state text, " + "country text, homepage text, sip_uri text not null, language text, " + "sex text, birthday text, description text, md5 text not null);";
    }
     ...
     */
    public long createProfile(String fullname, String gizmoname, String city, String state, String country, String homepage, String sip_uri, String language, String sex, String birthday, String description, String md5) {
    ...
    public Cursor fetchProfile(long rowId) throws SQLException {
        Cursor result = mDb.query(true, DATABASE_TABLE, new String[] { KEY_ROWID, KEY_FULL, KEY_GIZMO, KEY_CITY, KEY_STATE, KEY_COUNTRY, KEY_HOME, KEY_SIP_URI, KEY_LANGUAGE, KEY_SEX, KEY_BIRTH, KEY_DESCRIPTION, KEY_MD5 }, KEY_ROWID + "=" + rowId, null, null, null, null, null);
     ...
     */
    public boolean updateProfile(long rowId, String fullname, String gizmoname, String city, String state, String country, String homepage, String sip_uri, String language, String sex, String birthday, String description, String md5) {
    ...
    public Cursor fetchName(String queryName) {
        Cursor result = mDb.query(false, DATABASE_TABLE, new String[] { KEY_ROWID, KEY_FULL, KEY_GIZMO, KEY_CITY, KEY_STATE, KEY_COUNTRY, KEY_HOME, KEY_SIP_URI, KEY_LANGUAGE, KEY_SEX, KEY_BIRTH, KEY_DESCRIPTION, KEY_MD5 }, KEY_GIZMO + " like '%" + queryName + "%'", null, null, null, KEY_GIZMO, null);
        return result;
    }
    ...
    public Cursor fetchMd5(String queryName) {
        Cursor result = mDb.query(false, DATABASE_TABLE, new String[] { KEY_ROWID, KEY_GIZMO, KEY_MD5 }, KEY_GIZMO + " like '%" + queryName + "%'", null, null, null, KEY_GIZMO, null);
        return result;
    }
