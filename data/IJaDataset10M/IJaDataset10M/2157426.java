...
public class CPathProperty<UJO extends Cujo, VALUE> implements CujoProperty<UJO, VALUE> {
    ...
    public final CujoProperty getProperty(final int index) {
     ...
     * @hidden 
     */
    public static final <UJO1 extends Cujo, UJO2 extends Cujo, UJO3 extends Cujo, VALUE> CPathProperty<UJO1, VALUE> newInstance(final CujoProperty<UJO1, UJO2> property1, final CujoProperty<UJO2, UJO3> property2, final CujoProperty<UJO3, VALUE> property3) {
     ...
     * @hidden 
     */
    public static final <UJO1 extends Cujo, UJO2 extends Cujo, UJO3 extends Cujo, UJO4 extends Cujo, VALUE> CPathProperty<UJO1, VALUE> newInstance(final CujoProperty<UJO1, UJO2> property1, final CujoProperty<UJO2, UJO3> property2, final CujoProperty<UJO3, UJO4> property3, final CujoProperty<UJO4, VALUE> property4) {
