...
public class ClusterJob {
    ...
    public int getRunTime() {
        ...
        if (log.exists()) {
            ...
            if (lines == null || lines.containsKey("Start:") == false || lines.containsKey("End:") == false) runTime = -2; else {
    ...
    public String fetchNovoAlignmentCommand(String dirName) {
        ...
        if (chpcAligner.getAlignerName().contains("novoalign")) {
            ...
            cmd = chpcAligner.getAlignerApp() + " " + chpcAligner.getAlignerParams() + " " + " -d /scratch/local/" + dirName + "/" + chpcAligner.getGenomeIndex().getName() + " " + " -f " + data;
            String stripHeaders = "";
    ...
    public String fetchPBSHeader() {
        ...
        String h = "#PBS -l nodes=1:ppn=" + chpcAligner.getNumberCPUs() + ",walltime=" + chpcAligner.getHrsWallTime() + ":00:00 \n" + "#PBS -m a \n" + "#PBS -M " + chpcAligner.getEmail() + "\n" + "#PBS -N " + name + "\n" + "#PBS -j oe \n" + account + "#PBS -o " + log + "\n";
        return h;
    }
