...
public class TreeHotSpot extends AbstractHotSpot {
    ...
    public void selected(SelectEvent event) {
        if (event == null || this.isConsumed(event)) return;
        if (this.parent != null) this.parent.selected(event);
    }
    ...
    public void mouseClicked(MouseEvent event) {
        ...
        if (this.parent != null) this.parent.mouseClicked(event);
    }
    ...
    public void mousePressed(MouseEvent event) {
        if (event == null || event.isConsumed()) return;
        if (this.parent != null) this.parent.mousePressed(event);
    }
    ...
    public void mouseReleased(MouseEvent event) {
        if (event == null || event.isConsumed()) return;
        if (this.parent != null) this.parent.mouseReleased(event);
    }
    ...
    public void mouseWheelMoved(MouseWheelEvent event) {
        if (event == null || event.isConsumed()) return;
        if (this.parent != null) this.parent.mouseWheelMoved(event);
    }
}
