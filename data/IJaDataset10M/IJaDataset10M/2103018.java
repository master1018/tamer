...
public class StructureDiagramGeneratorTest extends CDKTestCase {
    ...
    public void xtestBug1714794() throws Exception {
        ...
        IChemModel model = (IChemModel) r.read(NoNotificationChemObjectBuilder.getInstance().newChemModel());
   ...
   *
   * @cdk.author Andreas Schueller <a.schueller@chemie.uni-frankfurt.de>
   * @cdk.bug    1772609
   */
	 ...
	 *@cdk.bug 1930186
	 */
    public void testBug1930186() throws Exception {
        SmilesParser sp = new SmilesParser(DefaultChemObjectBuilder.getInstance());
        IMolecule mol = sp.parseSmiles("[H]O[C@]12OC3=C([H])C([H])=C([H])C([H])=C3C([H])=C1[N+]4([H])C([H])([H])C([H])([H])C2([H])C([H])([H])C4([H])[H]");
        IAtomContainer ac = generateCoordinates(mol);
