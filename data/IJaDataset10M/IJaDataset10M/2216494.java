...
public class PlayGroundPanel extends JPanel {
	 ...
	 *            User panel
	 */
    public PlayGroundPanel(GameInformationPanel gameInfoPanel, OpponentPanel leftOpponentPanel, OpponentPanel rightOpponentPanel, JPanel gameContextPanel, JSkatUserPanel userPanel) {
        super(LayoutFactory.getMigLayout("fill", "fill", "[shrink][shrink][grow][shrink][shrink]"));
        add(gameInfoPanel, "span 2, growx, shrinky, align center, wrap");
        add(leftOpponentPanel, "width 50%, growx, growy, hmin 20%, hmax 20%, align left");
        add(rightOpponentPanel, "width 50%, growx, growy, hmin 20%, hmax 20%, align right, wrap");
