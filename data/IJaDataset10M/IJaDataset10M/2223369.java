...
public class SWTStormFrontClientViewer extends SWTWarlockClientViewer implements IStormFrontClientViewer {
    ...
    private class ListenerWrapper implements Runnable {
        ...
        public void run() {
            switch(eventType) {
                case LoadServerSettings:
                    viewer.loadServerSettings(settings);
                    break;
                case StartDownloadingServerSettings:
                    viewer.startDownloadingServerSettings();
                    break;
                case ReceivedServerSetting:
                    viewer.receivedServerSetting(settingType);
                case FinishedDownloadingServerSettings:
