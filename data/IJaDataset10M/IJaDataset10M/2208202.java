...
/**
 * Esta clase es la clase central del paquete Servando.Models.Protocol. Corresponde a la
 * definición del protocolo de seguimiento de un paciente. Este protocolo simplemente consiste en un conjunto
 * de ejecuciones de actuaciones médicas organizadas en el tiempo sobre un paciente.
 * @see Patient
