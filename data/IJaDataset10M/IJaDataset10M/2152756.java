...
public class CoreTypes {
    ...
    static class NumberParts {
        ...
        public NumberParts(String input) {
            ...
            if (indexOfE < 0) indexOfE = input.indexOf('E');
            if (indexOfE < 0) {
                mantissa = input;
                exponent = "";
            } else {
            ...
            if (exponent.endsWith("+") || exponent.endsWith("-")) exponent = exponent + "0";
        }

        public String toString() {
            if (exponent.length() > 0) return sign + mantissa + "E" + exponent; else return sign + mantissa;
        }
        ...
        public long toLong() {
            ...
            if (dot >= 0) return Long.parseLong(sign + mantissa.substring(0, dot)); else return Long.parseLong(sign + mantissa);
        }
        ...
        public BigInteger toBigInteger() {
            int dot = mantissa.indexOf('.');
            if (dot >= 0) return new BigInteger(sign + mantissa.substring(0, dot)); else return new BigInteger(sign + mantissa);
        }
    }
    ...
    private static int prepareNumber(java.lang.StringBuffer buffer, java.lang.String input) {
        int[][] actions = new int[][] { { 0, 0, 1, 2, 2 }, { 2, 0, 1, 2, 2 }, { 2, 0, 0, 0, 2 }, { 2, 0, 2, 2, 2 }, { 2, 0, 2, 0, 2 }, { 2, 0, 2, 1, 2 }, { 0, 0, 2, 2, 2 }, { 2, 0, 2, 2, 2 }, { 2, 0, 2, 2, 2 } };
        int[][] follow = new int[][] { { 1, 2, 3, 9, 9 }, { 9, 2, 3, 9, 9 }, { 9, 2, 5, 6, 9 }, { 9, 4, 9, 9, 9 }, { 9, 4, 9, 6, 9 }, { 9, 4, 9, 6, 9 }, { 7, 8, 9, 9, 9 }, { 9, 8, 9, 9, 9 }, { 9, 8, 9, 9, 9 } };
        int state = 0;
        for (int i = 0; i != input.length(); ++i) {
            char c = input.charAt(i);
            int cls;
            if (isSchemaDigit(c)) cls = 1; else if (isSchemaSign(c)) cls = 0; else if (isSchemaRadix(c)) cls = 2; else if (isSchemaExponent(c)) cls = 3; else cls = 4;
    ...
    public static int castToInt(long i) {
        if (i < (long) Integer.MIN_VALUE || i > (long) Integer.MAX_VALUE) throw new ArithmeticException("Numeric value overflow");
        return (int) i;
    }
    ...
    public static int castToInt(double d) {
        if (d < (double) Integer.MIN_VALUE || d > (double) Integer.MAX_VALUE) throw new ArithmeticException("Numeric value overflow");
        return (int) d;
    }
    ...
    public static int castToInt(BigInteger n) {
        if (n.compareTo(BigInteger.valueOf(Integer.MAX_VALUE)) > 0) throw new ArithmeticException("Numeric value overflow");
        return n.intValue();
    }

    public static int castToInt(BigDecimal n) {
        if (n.compareTo(BigDecimal.valueOf(Integer.MAX_VALUE)) > 0) throw new ArithmeticException("Numeric value overflow");
        return n.intValue();
    }

    public static int castToInt(String s) {
        if (s == null) return 0;
        if (s.equals("INF") || s.equals("-INF") || s.equals("NaN")) throw new ArithmeticException("'" + s + "' is too large for int.");
        s = s.trim();
    ...
    public static long castToLong(double d) {
        if (d < (double) Long.MIN_VALUE || d > (double) Long.MAX_VALUE) throw new ArithmeticException("Numeric value overflow");
        return (long) d;
    }
    ...
    public static long castToLong(BigInteger n) {
        if (n.compareTo(BigInteger.valueOf(Long.MAX_VALUE)) > 0) throw new ArithmeticException("Numeric value overflow");
        return n.longValue();
    }

    public static long castToLong(BigDecimal n) {
        if (n.compareTo(BigDecimal.valueOf(Long.MAX_VALUE)) > 0) throw new ArithmeticException("Numeric value overflow");
        return n.longValue();
    }

    public static long castToLong(String s) {
        if (s == null) return 0;
        if (s.equals("INF") || s.equals("-INF") || s.equals("NaN")) throw new ArithmeticException("'" + s + "' is too large for long.");
        s = s.trim();
        java.lang.StringBuffer buf = new java.lang.StringBuffer();
        switch(prepareNumber(buf, s)) {
            case 1:
    ...
    public static BigInteger castToBigInteger(String s) {
        ...
        if (s.equals("INF") || s.equals("-INF") || s.equals("NaN")) throw new ArithmeticException("'" + s + "' is too large for integer.");
        s = s.trim();
        java.lang.StringBuffer buf = new java.lang.StringBuffer();
        switch(prepareNumber(buf, s)) {
            case 1:
    ...
    public static BigDecimal castToBigDecimal(String s) {
        if (s == null) return null;
        if (s.equals("INF") || s.equals("-INF") || s.equals("NaN")) throw new ArithmeticException("'" + s + "' is too large for decimal.");
        s = s.trim();
        java.lang.StringBuffer buf = new java.lang.StringBuffer();
        switch(prepareNumber(buf, s)) {
            case 1:
    ...
    public static double castToDouble(BigInteger n) {
        ...
        if (dec.compareTo(new BigDecimal(Double.MAX_VALUE)) > 0) throw new ArithmeticException("Numeric value overflow");
        return dec.doubleValue();
    }

    public static double castToDouble(BigDecimal n) {
        if (n.compareTo(new BigDecimal(Double.MAX_VALUE)) > 0) throw new ArithmeticException("Numeric value overflow");
        return n.doubleValue();
    }

    public static double castToDouble(String s) {
        if (s == null) return 0;
        if (s.equals("INF")) return Double.POSITIVE_INFINITY; else if (s.equals("-INF")) return Double.NEGATIVE_INFINITY; else if (s.equals("NaN")) return Double.NaN;
        s = s.trim();
        java.lang.StringBuffer buf = new java.lang.StringBuffer();
        switch(prepareNumber(buf, s)) {
            case 1:
    ...
    public static String castToString(double d) {
        DecimalFormatSymbols decfmtsymb = new DecimalFormatSymbols(java.util.Locale.US);
    ...
    public static String castToString(byte[] b) {
        if (b == null) return "";
        String sResult = org.mitre.caasd.aixm.Base64.encode(b);
    ...
    public static String castToString(DateTime dt, int format) {
        if (format == DateTimeFormat_W3_dateTime) {
            return dt.toString();
        }
        if (format == DateTimeFormat_W3_date) {
            return dt.toDateString(true);
        }
        if (format == DateTimeFormat_W3_time) {
            return dt.toTimeString();
        }
        if (format == DateTimeFormat_W3_gYear) {
            String result = "";
            int year = dt.getYear();
            if (year < 0) {
                result += '-';
            ...
            if (dt.hasTimezone() != CalendarBase.TZ_MISSING) result = formatTimezone(dt.getTimezoneOffset());
            return result;
        }
        if (format == DateTimeFormat_W3_gYearMonth) {
            String result = "";
            int year = dt.getYear();
        ...
        if (format == DateTimeFormat_W3_gMonth) {
            String result = "--";
            int month = dt.getMonth();
            result += formatNumber(month, 2);
        ...
        if (format == DateTimeFormat_W3_gMonthDay) {
            String result = "--";
            int month = dt.getMonth();
            int day = dt.getDay();
            result += formatNumber(month, 2);
        ...
        if (format == DateTimeFormat_W3_gDay) {
            String result = "---";
            int day = dt.getDay();
            result += formatNumber(day, 2);
            if (dt.hasTimezone() != CalendarBase.TZ_MISSING) result += formatTimezone(dt.getTimezoneOffset());
        ...
        if (format == DateTimeFormat_S_DateTime) {
        ...
        if (format == DateTimeFormat_S_Seconds) {
            String result = "";
        ...
        if (format == DateTimeFormat_S_Days) {
            String result = "";
            long milliseconds = dt.getTimeValue();
            if (milliseconds < 0) {
                result += '-';
    ...
    public static DateTime castToDateTime(String s) {
        ...
        if (s.length() == 0) throw new IllegalArgumentException("Cast to DateTime failed.");
        return DateTime.parse(s);
    }

    public static Duration castToDuration(String s) {
        if (s == null) throw new java.lang.NullPointerException();
        if (s.length() == 0) throw new IllegalArgumentException("Cast to Duration failed.");
    ...
    public static boolean castToBool(String s) {
        ...
        if (s.length() == 0 || s.equals("false") || s.equals("0")) return false;
        return true;
    }
    ...
    public static int castToInt(Object v) {
        if (!exists(v)) throw new java.lang.NullPointerException();
    ...
    public static String castToString(Object v) throws Exception {
        ...
        if (v instanceof java.math.BigDecimal) return castToString((java.math.BigDecimal) v);
        if (v instanceof Double) return castToString(((Double) v).doubleValue());
        if (v instanceof byte[]) return castToString((byte[]) v);
        return v.toString();
    }
    ...
    public static javax.xml.namespace.QName castToQName(String s) {
        int i = s.indexOf('{');
        int j = s.indexOf('}');
        if (i == 0 && j > i) return new javax.xml.namespace.QName(s.substring(1, j), s.substring(j + 1));
    ...
    public static String formatFraction(long value, long precision) {
        ...
        if (value != 0) {
            ...
            int i = result.length();
            while (result.charAt(i - 1) == '0') i -= 1;
            result = result.substring(0, i);
        }
        return result;
    }

    public static java.lang.Boolean box(boolean v) {
        return new java.lang.Boolean(v);
    }

    public static java.lang.Byte box(byte v) {
        return new java.lang.Byte(v);
    }

    public static java.lang.Short box(short v) {
        return new java.lang.Short(v);
    }

    public static java.lang.Integer box(int v) {
        return new java.lang.Integer(v);
    }

    public static java.lang.Long box(long v) {
        return new java.lang.Long(v);
    }

    public static java.lang.Float box(float v) {
        return new java.lang.Float(v);
    }

    public static java.lang.Double box(double v) {
    ...
    public static BigDecimal box(BigDecimal v) {
        return v;
    }

    public static BigInteger box(BigInteger v) {
        return v;
    }

    public static DateTime box(DateTime v) {
        return v;
    }

    public static Duration box(Duration v) {
        return v;
    }
}
