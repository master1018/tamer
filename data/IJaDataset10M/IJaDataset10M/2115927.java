...
import se.mdh.mrtc.saveccm.assembly.diagram.edit.parts.ComponentComponentBindPortsCompartmentEditPart;
import se.mdh.mrtc.saveccm.assembly.diagram.part.SaveccmVisualIDRegistry;

/**
 * @generated
 */
public class ComponentComponentBindPortsCompartmentViewFactory extends BasicNodeViewFactory {
    ...
    protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
        if (semanticHint == null) {
            semanticHint = SaveccmVisualIDRegistry.getType(ComponentComponentBindPortsCompartmentEditPart.VISUAL_ID);
