...
public class Thief_MarkerSpying extends ThiefSkill {
    ...
    public boolean tick(Tickable ticking, int tickID) {
        if (super.canBeUninvoked()) {
            ...
            if (mark != affected) {
                MOB invoker = invoker();
                unInvoke();
                if ((mark != null) && (mark.fetchEffect(ID()) == null) && (invoker != null)) beneficialAffect(invoker, mark, 0, Integer.MAX_VALUE - 1000);
            }
        }
    ...
    public void executeMsg(Environmental myHost, CMMsg msg) {
        ...
        if ((msg.targetMinor() == CMMsg.TYP_READ) && (msg.source() == affected) && (msg.target() != null) && (invoker() != null) && (CMLib.flags().isInTheGame(invoker(), true)) && (getMark(invoker()) == msg.source())) {
    ...
    public void unInvoke() {
        if (canBeUninvoked()) {
            if ((invoker != null) && (affected != null)) invoker.tell("You are no longer spying on " + affected.name() + ".");
        }
        super.unInvoke();
    }
