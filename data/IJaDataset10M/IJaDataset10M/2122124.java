...
public class SimUtil {
     ...
     */
    public static final void printGraphCommand(String title, String x, String y, int[][] plots, String[] graphNames) {
        ...
        System.out.print("\" | graph -W .003 -C -T $type -L \"" + title + "\" -X \"" + x + "\" -Y \"" + y + "\"");
    }
