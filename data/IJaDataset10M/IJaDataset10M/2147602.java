...
public abstract class AbstractID3v2Frame extends AbstractMP3Fragment {
    ...
    protected static AbstractID3v2FrameBody readBody(final String identifier, final RandomAccessFile file) throws IOException, InvalidTagException {
        ...
        if ("APIC".equals(frameIdentifier)) {
            ...
            newBody = new FrameBodyTDAT(file);
            ...
            newBody = new FrameBodyTIME(file);
            ...
            newBody = new FrameBodyTORY(file);
            ...
            newBody = new FrameBodyTRDA(file);
            ...
            newBody = new FrameBodyTSIZ(file);
            ...
            newBody = new FrameBodyTYER(file);
