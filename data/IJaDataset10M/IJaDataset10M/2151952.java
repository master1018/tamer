...
public class MeshRoot2D {
    ...
    public static GeneralPath findRoots(Function<EuclideanPoint2D, Double> function, double zValue, EuclideanPoint2D p1, EuclideanPoint2D p2, double refinement, double precision, int maxIterations) throws FunctionEvaluationException {
    ...
    public static GeneralPath findRoots(Function<EuclideanPoint2D, Double> function, double zValue, double x1, double y1, double x2, double y2, double refinement, double precision, int maxIterations) throws FunctionEvaluationException {
    ...
    public static GeneralPath addFlatTriangles(GeneralPath path, Function<EuclideanPoint2D, Double> function, double zValue, double x1, double y1, double x2, double y2) throws FunctionEvaluationException {
