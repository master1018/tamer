...
public class HttpConfig {
    ...
    public static final String BBS_URL1 = "http://" + BBS_HOST1;

    public static final String BBS_URL2 = "http://" + BBS_HOST2;

    public static final String BBS_URL3 = "http://" + BBS_HOST3;
    ...
    static {
        ...
        connPerRoute.setMaxForRoute(new HttpRoute(new HttpHost(BBS_HOST1, 80)), 5);
        connPerRoute.setMaxForRoute(new HttpRoute(new HttpHost(BBS_HOST2, 80)), 5);
        connPerRoute.setMaxForRoute(new HttpRoute(new HttpHost(BBS_HOST3, 80)), 5);
        connPerRoute.setMaxForRoute(new HttpRoute(new HttpHost(SjtuHttpConfig.BBS_HOST, 80)), 5);
        connPerRoute.setMaxForRoute(new HttpRoute(new HttpHost(SjtuHttpConfig.BBS_HOST, 443)), 5);
        connPerRoute.setMaxForRoute(new HttpRoute(new HttpHost(YanxiHttpConfig.BBS_HOST, 80)), 5);
