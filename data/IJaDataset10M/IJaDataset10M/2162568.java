...
public final class RStringElement extends StringElement implements RStringFreeElement {
    ...
    public ModuleElement difference(ModuleElement element) throws DomainException {
        if (element instanceof RStringElement) {
    ...
    public RingElement product(RingElement element) throws DomainException {
        if (element instanceof RStringElement) {
    ...
    public RingElement quotient(RingElement element) throws DomainException, DivisionException {
        if (element instanceof RStringElement) {
    ...
    private static final XMLInputOutput<ModuleElement> xmlIO = new RStringElement("");
