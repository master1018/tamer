...
public class TestRunner extends BaseTestRunner {
    ...
    protected TestResult start(String args[]) throws Exception {
        ...
        for (int i = 0; i < args.length; i++) {
            if (args[i].equals("-wait")) wait = true; else if (args[i].equals("-c")) testCase = extractClassName(args[++i]); else if (args[i].equals("-v")) System.err.println("JUnit  by Kent Beck and Erich Gamma"); else testCase = args[i];
        }
