...
public class DirectColorModel extends PackedColorModel {
    ...
    public DirectColorModel(int bits, int rmask, int gmask, int bmask, int amask) {
        super(ColorSpace.getInstance(ColorSpace.CS_sRGB), bits, rmask, gmask, bmask, amask, false, (amask == 0 ? Transparency.OPAQUE : Transparency.TRANSLUCENT), ColorModel.getTransferType(bits));
        initLUTs();
    }
    ...
    public String toString() {
        String str = "DirectColorModel:" + " rmask = " + Integer.toHexString(componentMasks[0]) + " gmask = " + Integer.toHexString(componentMasks[1]) + " bmask = " + Integer.toHexString(componentMasks[2]) + " amask = " + (!hasAlpha ? "0" : Integer.toHexString(componentMasks[3]));
        return str;
    }
    ...
    public final int[] getComponents(Object pixel, int components[], int offset) {
        ...
        switch(transferType) {
            ...
            case DataBuffer.TYPE_INT:
                ...
                break;
            default:
                throw new UnsupportedOperationException(Messages.getString("awt.22D", transferType));
        }
