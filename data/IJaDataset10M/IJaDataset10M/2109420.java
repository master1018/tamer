...
public final class Twofish extends BlockCipher {
    ...
    public synchronized void initializeKey(byte[] key) throws InvalidKeyException {
        if (key == null) throw new InvalidKeyException("Empty key");
