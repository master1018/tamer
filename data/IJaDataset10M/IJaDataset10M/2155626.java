...
public class AUKUserAuthModel extends AUserAuthModel {
    ...
    public MUser searchUser(UserAuthData userAuthData) {
        return MUser.get(Env.getCtx(), userAuthData.getUserName(), userAuthData.getPassword(), false);
    }

    @Override
    public CallResult preValidateAuthorization(UserAuthData userAuthData) {
        CallResult result = new CallResult();
        if (Util.isEmpty(userAuthData.getPassword(), true) && Util.isEmpty(userAuthData.getUserID(), true)) {
