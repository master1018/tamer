...
public class ByteTest extends TestCase {
    ...
    public void test_ConstructorLjava_lang_String2() {
        ...
        assertTrue("Incorrect Byte Object created", b.byteValue() == (byte) 127 && (nb.byteValue() == (byte) -128));
    }
    ...
    public void test_byteValue() {
        assertTrue("Returned incorrect byte value", new Byte((byte) 127).byteValue() == (byte) (127));
    }
    ...
    public void test_decodeLjava_lang_String2() {
        ...
        assertTrue("String decoded incorrectly, wanted: -1 got: " + Byte.decode("-1").toString(), Byte.decode("-1").equals(new Byte((byte) -1)));
        assertTrue("String decoded incorrectly, wanted: 127 got: " + Byte.decode("127").toString(), Byte.decode("127").equals(new Byte((byte) 127)));
        assertTrue("String decoded incorrectly, wanted: -128 got: " + Byte.decode("-128").toString(), Byte.decode("-128").equals(new Byte((byte) -128)));
        assertTrue("String decoded incorrectly, wanted: 127 got: " + Byte.decode("0x7f").toString(), Byte.decode("0x7f").equals(new Byte((byte) 127)));
        assertTrue("String decoded incorrectly, wanted: -128 got: " + Byte.decode("-0x80").toString(), Byte.decode("-0x80").equals(new Byte((byte) -128)));
    ...
    public void test_parseByteLjava_lang_StringI2() {
        ...
        assertTrue("Returned incorrect value for most negative value hex", Byte.parseByte("-80", 16) == (byte) 0x80);
        assertTrue("Returned incorrect value for most positive value hex", Byte.parseByte("7f", 16) == 0x7f);
        assertEquals("Returned incorrect value for 0 decimal", 0, Byte.parseByte("0", 10));
        assertTrue("Returned incorrect value for most negative value decimal", Byte.parseByte("-128", 10) == (byte) 0x80);
        assertTrue("Returned incorrect value for most positive value decimal", Byte.parseByte("127", 10) == 0x7f);
        try {
