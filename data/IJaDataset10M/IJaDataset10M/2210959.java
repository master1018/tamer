...
public class SecuritySettAgentCode extends FIXMLField {

    public static final String TAG = "177";
    ...
    public void initValue(Object s) throws ModelException {
        if (_Value != null) throw new ModelException("Value has already been initialized for field SecuritySettAgentCode.");
        setValue((String) s);
    }
    ...
    public String toFIXML(String ident) {
        ...
        StringBuffer sb = new StringBuffer(ident + "<SecuritySettAgentCode FIXTag=\"177\" DataType=\"String\"");
        sb.append(">" + _Value + "</SecuritySettAgentCode>");
        return sb.toString();
    }
}
