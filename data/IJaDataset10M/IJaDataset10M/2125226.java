...
public class FastFileHandler extends StreamHandler {
    ...
    private static final MessageFormat fileNamePattern = new MessageFormat("rvsnoop-{0,time,yyyyMMddHHmmss}.log");
    ...
    private void initMaxFileSize(final LogManager manager, final String cname) {
        ...
        try {
            ...
            final String s = manager.getProperty(propname).trim().toUpperCase(Locale.ENGLISH);
    ...
    private void open(File file) throws IOException {
        BufferedOutputStream stream = new BufferedOutputStream(new FileOutputStream(file.toString()));
    ...
    private synchronized void rotate() {
        ...
        try {
            ...
            reportError("Error opening new log file after file rotation", e, ErrorManager.OPEN_FAILURE);
        }
        setLevel(oldLevel);
    }
}
