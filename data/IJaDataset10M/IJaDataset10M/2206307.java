...
public class DeliveryList extends AbstractJFSScriptExecutorDelegate {
    ...
    public Object doExecute() throws ScriptException {
        ...
        jdoql.append("SELECT " + "  this, " + "  JDOHelper.getObjectId(this.createUser), " + "  this.createDT, " + "  JDOHelper.getObjectId(this.productType), " + "  JDOHelper.getObjectId(this.order.vendor), " + "  JDOHelper.getObjectId(this.order.customer), " + "  JDOHelper.getObjectId(this.order), " + "  JDOHelper.getObjectId(this.offer), " + "  JDOHelper.getObjectId(this.deliveryNote), " + "  JDOHelper.getObjectId(this.invoice), " + "  this.articleLocal.delivered, " + "  this.invoice.invoiceLocal.outstanding " + "FROM " + "  " + Article.class.getName() + " " + "WHERE (1 == 1) ");
