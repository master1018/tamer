...
public class OwlsWsdlGroundingImpl extends EObjectImpl implements OwlsWsdlGrounding {
    ...
    public void setID(String newID) {
        String oldID = iD;
        iD = newID;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, OwlsPackage.OWLS_WSDL_GROUNDING__ID, oldID, iD));
    }
    ...
    public void setSupportedBy(OwlsService newSupportedBy) {
        if (newSupportedBy != eInternalContainer() || (eContainerFeatureID != OwlsPackage.OWLS_WSDL_GROUNDING__SUPPORTED_BY && newSupportedBy != null)) {
            if (EcoreUtil.isAncestor(this, newSupportedBy)) throw new IllegalArgumentException("Recursive containment not allowed for " + toString());
            NotificationChain msgs = null;
            if (eInternalContainer() != null) msgs = eBasicRemoveFromContainer(msgs);
            if (newSupportedBy != null) msgs = ((InternalEObject) newSupportedBy).eInverseAdd(this, OwlsPackage.OWLS_SERVICE__SUPPORTS, OwlsService.class, msgs);
            msgs = basicSetSupportedBy(newSupportedBy, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, OwlsPackage.OWLS_WSDL_GROUNDING__SUPPORTED_BY, newSupportedBy, newSupportedBy));
    }
