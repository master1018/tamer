...
public class MetaWeblogAPIHandler extends BloggerAPIHandler {
    ...
    private static Log mLogger = LogFactory.getFactory().getInstance(MetaWeblogAPIHandler.class);
    ...
    public boolean editPost(String postid, String userid, String password, Hashtable struct, boolean publish) throws Exception {
        ...
        try {
            ...
            if (cat != null) {
                WeblogCategoryData cd = weblogMgr.getWeblogCategoryByPath(entry.getWebsite(), cat);
    ...
    public String newPost(String blogid, String userid, String password, Hashtable struct, boolean publish) throws Exception {
        ...
        try {
            ...
            entry.setPublishEntry(Boolean.valueOf(publish));
            if (cat != null) {
                WeblogCategoryData cd = weblogMgr.getWeblogCategoryByPath(website, cat);
                entry.setCategory(cd);
            } else {
     ...
     * @return
     */
    public Object getRecentPosts(String blogid, String userid, String password, int numposts) throws Exception {
        ...
        try {
            ...
            WeblogManager weblogMgr = roller.getWeblogManager();
            if (website != null) {
                if (numposts > 100) numposts = 100;
                Map entries = weblogMgr.getWeblogEntryObjectMap(website, null, new Date(), null, WeblogManager.ALL, new Integer(numposts));
