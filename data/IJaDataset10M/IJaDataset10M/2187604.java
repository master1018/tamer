 ...
 */
public class LivenessTransformation implements Transformation<CfgTransformer, Cfg> {
    ...
    public Cfg getNewSubgraph() {
        CfgNode<?> newNode = new CfgNopNode(writeToKill.getParent(), writeToKill.getJNode());
        return CfgUtil.createSingleNodeReplacementGraph(graph, writeToKill, newNode);
    }
}
