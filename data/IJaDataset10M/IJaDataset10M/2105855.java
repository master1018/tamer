 ...
 */
public class ContentMaintenanceAction extends ActionBase {

    private static final Logger log = Logger.getLogger(ContentMaintenanceAction.class);

    /** Clicked event handler for the field Save.
     * @return The FormKey.
     */
    public FormKey do_Save_Clicked() {
        ContentMaintenanceForm myForm = (ContentMaintenanceForm) form;
        ContentMaintenanceComponent comp = (ContentMaintenanceComponent) myForm.getComponent();
    ...
    public FormKey do_Cancel_Clicked() {
        return ((ContentMaintenanceForm) form).getComponent().quitAndReturnToCallingScreen();
    }
}
