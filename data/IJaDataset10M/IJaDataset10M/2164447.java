...
public class ParameterUtility {
   ...
   */
    public Hashtable getDefaultParameters(SimModel model) throws IntrospectionException, InvocationTargetException, IllegalAccessException {
   ...
   */
    public ParameterSetter createParameters(Object o, String[] properties) throws IntrospectionException, IllegalAccessException, InvocationTargetException {
   ...
   * @throws java.lang.reflect.InvocationTargetException
   */
    public Hashtable getModelProperties(SimModel model) throws IntrospectionException, IllegalAccessException, InvocationTargetException {
   ...
   */
    public void makeParameterFileFromCurVals(Object o, String[] props, String fileName) throws IntrospectionException, IllegalAccessException, InvocationTargetException, RepastException, IOException {
        ...
        for (Iterator iter = setter.parameterNames(); iter.hasNext(); ) {
            ...
            if (setVal == null) {
                ...
                String set = "set: ";
                if (clazz.equals(Boolean.class) || clazz.equals(boolean.class)) set = "set_boolean: "; else if (clazz.equals(String.class)) set = "set_string: ";
                setVal = set + setVal;
                b.append(name);
                b.append(" ");
                b.append("{");
