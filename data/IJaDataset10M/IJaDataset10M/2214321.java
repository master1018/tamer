...
import edu.uiuc.ncsa.security.core.configuration.CfgEvent;
 ...
 */
public abstract class TypedProvider<T> extends HierarchicalConfigProvider<T> implements Provider<T> {
