...
public class SkeinAction {
    ...
    public static void testThreefish(final int blockSize, final int rounds) {
        ...
        byte[] keyData = new byte[blockSize / Byte.SIZE];
        final long[] tweak;
        try {
    ...
    public static byte[] doSimpleSkein(final int blockSize, final byte[] message, final int outputSize) {
        ...
        SkeinAlgorithm.Tweak tweak = new SkeinAlgorithm.Tweak(true, true, SkeinAlgorithm.Tweak.T_CFG, false, 0, configSize);
        ...
        while (bytesProcessed < messageLength) {
            ...
            tweak = new SkeinAlgorithm.Tweak(bytesProcessed == messageLength, bytesProcessed <= blockSizeBytes, SkeinAlgorithm.Tweak.T_MSG, false, 0, bytesProcessed);
