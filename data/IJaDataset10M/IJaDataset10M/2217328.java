...
/** <b>RFileInputStream</b> is an {@link InputStream} to transfer files
    ...
    @version $Id: RFileInputStream.java,v 1.1 2006/07/19 23:21:48 mschmitt Exp $
*/
public class RFileInputStream extends InputStream {
    ...
    RFileInputStream(Rtalk rti, String fn) throws IOException {
        ...
        if (rp == null || !rp.isOk()) throw new IOException((rp == null) ? "Connection to Rserve failed" : ("Request return code: " + rp.getStat()));
        closed = false;
        eof = false;
    }
