 ...
 * @version $Id: LabeledEdgeImpl.java,v 1.4 2002/08/29 14:00:51 jmsalvo Exp $
 */
   ...
   */
    public String getLabel() {
        if (this.followVertexLabel) {
            ...
            tmpString.append("-");
            if (this.edgeBeingLabelled instanceof DirectedEdge) tmpString.append(">");
    ...
    public void setLabel(String label) {
        if (this.followVertexLabel) throw new IllegalStateException("edge label is dynamically derived from vertices' label"); else super.setLabel(label);
    }
}
