package com.gobynote.android.util;
...
import com.gobynote.android.data.GobyNoteDB;
...
public class WPHtml {
    ...
    public static interface TagHandler {
		 ...
		 */
        public void handleTag(boolean opening, String tag, Editable output, XMLReader xmlReader, String mysteryTagContent);
    }
	 ...
	 * found in the wild.
	 */
    public static Spanned fromHtml(String source, Context ctx) {
        return fromHtml(source, null, null, ctx);
    }
	 ...
	 * found in the wild.
	 */
    public static Spanned fromHtml(String source, ImageGetter imageGetter, TagHandler tagHandler, Context ctx) {
        ...
        HtmlToSpannedConverter converter = new HtmlToSpannedConverter(source, imageGetter, tagHandler, parser, ctx);
    ...
    private static void processWPImage(StringBuilder out, Spanned text, int start, int end) {
        int next;
        for (int i = start; i < end; i = next) {
...
class HtmlToSpannedConverter implements ContentHandler {
    ...
    public HtmlToSpannedConverter(String source, WPHtml.ImageGetter imageGetter, WPHtml.TagHandler tagHandler, Parser parser, Context context) {
        mSource = source;
    ...
    public void characters(char ch[], int start, int length) throws SAXException {
        ...
        if (mysteryTagFound) mysteryTagContent += sb.toString().substring(start, length); else mSpannableStringBuilder.append(sb);
    }
