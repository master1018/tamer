...
public class EdgeListGraphIOTest {
    ...
    public static Graph<Integer> sample1() {
        if (SAMPLE1 == null) SAMPLE1 = (Graph<Integer>) EdgeListGraphIO.getInstance().importGraph(new HashMap<Integer, double[]>(), EdgeListGraphIO.class.getResource("data/edgeList.txt"), GraphType.REGULAR);
        return SAMPLE1;
    }
