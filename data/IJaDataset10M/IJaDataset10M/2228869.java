...
public class SettingsFileOpenException extends BaseException {
    ...
    public SettingsFileOpenException(final Throwable cause, final String aFileName, final SettingsFileType aFileType) {
    ...
    protected SettingsFileOpenException(final String error, final String aFileName, final SettingsFileType aFileType) {
        super(ExceptionType.SOLUTION, error);
        fileName = aFileName;
        fileType = aFileType;
    }

    protected SettingsFileOpenException(final String error, final Throwable cause, final String aFileName, final SettingsFileType aFileType) {
