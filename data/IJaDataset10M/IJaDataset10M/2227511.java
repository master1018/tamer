...
public class Rect implements Comparable {
	 ...
	 */
    Rect(final String id, final int x, final int y, final int w, final int h, final boolean rotated, final boolean packed) {
        this.id = id;
        this.x = x;
        this.y = y;
        this.w = w;
    ...
    public final String toString() {
        return id + "/" + x + "/" + y + "/" + w + "/" + h + "/" + rotated + "/" + packed + " (ID/x/y/w/h/rotated/packed)";
    }
