...
public class AuxiliaryFunctionsRuntime {
    ...
    public static ExpressionType createLanguageExpressionType(String classifier, boolean multi) {
        if (multi) return createCollectionType(classifier);
    ...
    public static ExpressionType createCollectionType(ExpressionType expressionType) {
