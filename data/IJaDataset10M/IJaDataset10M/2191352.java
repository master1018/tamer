 ...
 */
public final class JavaEnum extends JavaRawAbstractClass implements JavaClassMember, JavaInterfaceMember {
     ...
     *      package
     */
    public JavaEnum(JavaSchema schema, String id, JavaPackage pkg, JavaStructuredType<?> outerType) {
     ...
     */
    public JavaEnum(JavaSchema schema, String id, JavaStructuredType<?> outerType) {
    ...
    public void addTypeVariable(JavaTypeVariable var) {
        throw new UnsupportedOperationException("Enums cannot have type variables");
    }

    protected JavaParameterizedType<JavaClassMember> createParameterization(Map<JavaTypeVariable, JavaReferenceType> typeVarMap, Map<JavaTypeVariable, JavaReferenceType> fullTypeVarMap) {
    ...
    public JavaMemberVariable newValue(String id, boolean wantAnonClass, JavaExpression... args) {
