...
public class BasicProgressBarUI extends ProgressBarUI {
   ...
   */
     ...
     */
        public void propertyChange(PropertyChangeEvent e) {
            if (e.getPropertyName().equals("indeterminate")) if (((Boolean) e.getNewValue()).booleanValue() && progressBar.isShowing()) startAnimationTimer(); else stopAnimationTimer();
        }
    }
   ...
   */
     ...
     */
        public void ancestorAdded(AncestorEvent event) {
            if (progressBar.isIndeterminate()) startAnimationTimer();
        }
   ...
   */
    protected int getAmountFull(Insets b, int width, int height) {
        ...
        if (progressBar.getOrientation() == JProgressBar.HORIZONTAL) return (int) (percentDone * (width - b.left - b.right)); else return (int) (percentDone * (height - b.top - b.bottom));
    }
   ...
   */
    protected Rectangle getBox(Rectangle r) {
        if (!progressBar.isIndeterminate()) return null;
        ...
        if (animationIndex > (numFrames) / 2) index = numFrames - getAnimationIndex();
        if (progressBar.getOrientation() == JProgressBar.HORIZONTAL) {
   ...
   */
    protected Dimension getPreferredInnerHorizontal() {
        ...
        if (str != null) stringWidth = fm.stringWidth(progressBar.getString());
        Insets i = progressBar.getInsets();
        int prefWidth = Math.max(200 - i.left - i.right, stringWidth);
        int stringHeight = 0;
        if (str != null) stringHeight = fm.getHeight();
   ...
   */
    public Dimension getPreferredSize(JComponent c) {
        ...
        Dimension ret;
        int orientation = progressBar.getOrientation();
        if (orientation == JProgressBar.VERTICAL) ret = getPreferredInnerVertical(); else ret = getPreferredInnerHorizontal();
        ret.width += insets.left + insets.right;
        ret.height += insets.top + insets.bottom;
        return ret;
    }
   ...
   */
    protected Point getStringPlacement(Graphics g, String progressString, int x, int y, int width, int height) {
        ...
        SwingUtilities.layoutCompoundLabel(progressBar, fm, progressString, null, SwingConstants.CENTER, SwingConstants.CENTER, SwingConstants.CENTER, SwingConstants.CENTER, vr, ir, tr, 0);
   ...
   */
    protected void incrementAnimationIndex() {
        animationIndex++;
        if (animationIndex >= numFrames) animationIndex = 0;
        progressBar.repaint();
    }
   ...
   */
    public void paint(Graphics g, JComponent c) {
        if (!progressBar.isIndeterminate()) paintDeterminate(g, c); else paintIndeterminate(g, c);
    }
   ...
   */
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        if (progressBar.isStringPainted() && !progressBar.getString().equals("")) paintString(g, 0, 0, or.width, or.height, amountFull, insets);
        g.setColor(saved);
    }
   ...
   */
    protected void paintIndeterminate(Graphics g, JComponent c) {
        ...
        if (progressBar.isStringPainted() && !progressBar.getString().equals("")) paintString(g, 0, 0, or.width, or.height, getAmountFull(insets, or.width, or.height), insets);
        g.setColor(saved);
    }
   ...
   */
    protected void paintString(Graphics g, int x, int y, int width, int height, int amountFull, Insets b) {
        if (progressBar.getOrientation() == JProgressBar.VERTICAL) return;
        Point placement = getStringPlacement(g, progressBar.getString(), x + b.left, y + b.top, width - b.left - b.right, height - b.top - b.bottom);
   ...
   */
    protected void uninstallListeners() {
        ...
        animation = null;
        if (ancestorListener != null) progressBar.removeAncestorListener(ancestorListener);
        ancestorListener = null;
        if (componentListener != null) progressBar.removeComponentListener(componentListener);
