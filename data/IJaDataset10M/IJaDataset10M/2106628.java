...
public class TdsResultSetMetaData implements java.sql.ResultSetMetaData {
    ...
    */
    public String getColumnTypeName(int column) throws SQLException {
        if (columnsInfo.isAutoIncrement(column).booleanValue()) return getCleanTypeName(column) + " identity";
    ...
    */
    private String getCleanTypeName(int column) throws SQLException {
        ...
        throw new SQLException("Unknown native type for column " + column + ": " + columnsInfo.getNativeType(column));
    }
