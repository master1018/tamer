...
public class SRPGData {
    ...
    public byte[] savePosition() throws Exception {
        ...
        try {
            ...
            throw new Exception("An exception when the save srpg game data : " + ex.getMessage());
        }
    ...
    public SRPGPosition[] loadPosition(byte[] res) throws Exception {
        ...
        try {
            ...
            throw new Exception("An exception when the loading srpg game data : " + ex.getMessage());
        }
        return positions;
    }
    ...
    public boolean loadStatus(byte[] res) throws Exception {
        ...
        try {
            ...
            throw new Exception("An exception when loading the srpg game data : " + ex.getMessage());
        }
        return true;
    }
    ...
    public void allDefaultStatus() {
        checkInitStatus();
        for (int i = 0; i < statusArray.length; i++) if (statusArray[i] != null) {
