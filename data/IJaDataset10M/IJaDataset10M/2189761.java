...
public class JadaEdorAboutBox extends javax.swing.JDialog {

    public JadaEdorAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(jadaedor.JadaEdorApp.class).getContext().getResourceMap(JadaEdorAboutBox.class);
        setTitle(resourceMap.getString("title"));
        setModal(true);
        setName("aboutBox");
        setResizable(false);
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(jadaedor.JadaEdorApp.class).getContext().getActionMap(JadaEdorAboutBox.class, this);
