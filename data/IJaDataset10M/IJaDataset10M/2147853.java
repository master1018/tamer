        ...
        return new LogFilterParameterDialog(summary, LastOnlyActivityFilter.this) {
            ...
            protected JPanel getPanel() {
                ...
                deSelectAllButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        for (int i = 0; i < checks.length; i++) {
                            if ((eventsToFilter != null) && eventsToFilter.contains(checks[i].getLogEvent())) eventsToFilter.remove(checks[i].getLogEvent());
                ...
                selectAllButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        for (int i = 0; i < checks.length; i++) {
                            if ((eventsToFilter != null) && (!eventsToFilter.contains(checks[i].getLogEvent()))) eventsToFilter.add(checks[i].getLogEvent());
