...
public abstract class BaseContentCheck implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.jeecms.cms.entity.main.ContentCheck)) return false; else {
            com.jeecms.cms.entity.main.ContentCheck contentCheck = (com.jeecms.cms.entity.main.ContentCheck) obj;
            if (null == this.getId() || null == contentCheck.getId()) return false; else return (this.getId().equals(contentCheck.getId()));
        }
    }
