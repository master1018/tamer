...
public class MyMonKey implements MonKey {
    ...
    public Object getValue(String key) {
        if (LABEL_HEADER.equalsIgnoreCase(key)) return getLabel(); else if (UNITS_HEADER.equalsIgnoreCase(key)) return getUnits(); else if ("param".equalsIgnoreCase(key)) return getParam(); else if ("details".equalsIgnoreCase(key)) return getDetails(); else return null;
    }
	...
	*/
    ...
    public boolean equals(Object compareKey) {
        return (compareKey instanceof MyMonKey && summaryLabel.equals(((MyMonKey) compareKey).summaryLabel) && units.equals(((MyMonKey) compareKey).units));
    }
