 ...
 */
public class ForwardChainingRDFSInferencerConnection extends InferencerConnectionWrapper implements SailConnectionListener {
	 ...
	 */
    protected boolean statementsRemoved;

    /**
	 * Contains the statements that have been reported by the base Sail as
	 */
    protected Graph newStatements;

    protected Graph newThisIteration;

    /**
	 * Flags indicating which rules should be evaluated.
	 */
    protected boolean[] checkRule = new boolean[RDFSRules.RULECOUNT];

    /**
	 * Flags indicating which rules should be evaluated next iteration.
	 */
    protected boolean[] checkRuleNextIter = new boolean[RDFSRules.RULECOUNT];

    protected int totalInferred = 0;

    /**
	 * The number of inferred statements per rule.
	 */
    protected int[] ruleCount = new int[RDFSRules.RULECOUNT];
