...
public class Thief_Autocaltrops extends ThiefSkill {
    ...
    public void executeMsg(Environmental myHost, CMMsg msg) {
        ...
        if ((affected instanceof MOB) && (!noRepeat) && (msg.targetMinor() == CMMsg.TYP_ENTER) && (msg.source() == affected) && (msg.target() instanceof Room) && (msg.tool() instanceof Exit) && (((MOB) affected).location() != null)) dropem(msg.source(), (Room) msg.target());
    }
    ...
    public void unInvoke() {
        if ((affected instanceof MOB) && (!((MOB) affected).amDead())) ((MOB) affected).tell("You stop throwing down caltrops.");
        super.unInvoke();
    }
    ...
    public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel) {
        ...
        } else beneficialVisualFizzle(mob, null, "<S-NAME> attempt(s) to prepare some caltrops for quick dropping, but mess(es) up.");
        return success;
    }
}
