...
public class JTableDriverTest extends AbstractComponentDriverTest<JTableDriver> {
    ...
    public static final JTable SMALL_TABLE = new JTable(new Object[][] { new Object[] { "1x1", "1x2", "1x3" }, new Object[] { "2x1", "2x2", "2x3" } }, new Object[] { "one", "two", "three" });
    ...
    @Test
    public void detectsHasCellMatching() {
        driver.hasCell(withLabelText(equalTo("1x1")));
    }

    @SuppressWarnings("unchecked")
    @Test
    public void detectsHasRowMatching() {
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void reportsWhenDoesNotHaveRowMatching() {
        ...
        try {
            ...
            assertThat(expected.getMessage(), containsString("row with cells with text \"2x1\", with text \"1x2\", with text \"2x3\""));
            return;
        }
    ...
    @Test
    public void matchesOnCellColour() {
    ...
    @Test
    public void selectingSingleCell() throws Exception {
    ...
    @Test
    @Ignore
    public void selectingMultipleNonContiguousCells() throws Exception {
    ...
    @Test
    public void blockSelectionWithMouse() throws Exception {
        table.getSelectionModel().setSelectionMode(ListSelectionModel.SINGLE_INTERVAL_SELECTION);
        table.setRowSelectionAllowed(true);
        table.setColumnSelectionAllowed(true);
        driver.dragMouseOver(cell(1, 1), cell(3, 3));
        driver.hasSelectedCells(cell(1, 1), cell(1, 2), cell(1, 3), cell(2, 1), cell(2, 2), cell(2, 3), cell(3, 1), cell(3, 2), cell(3, 3));
        driver.dragMouseOver(cell(4, 3), cell(1, 1));
        driver.hasSelectedCells(cell(1, 1), cell(2, 2), cell(3, 3), cell(4, 3));
    }

    @Test
    public void cellRenderedWithText() throws Exception {
    ...
    public void editingCells() throws Exception {
