...
public abstract class Waiting {
     ...
     *         if {@link #until()} throws an exception
     */
    public void waitUntil(int timeout, String timeoutMessage) throws TimedOut, Exception {
     ...
     *         if {@link #until()} throws an exception
     */
    public void waitUntil(int timeout, int sleep, String timeoutMessage) throws TimedOut, Exception {
        int waited = 0;
        while (true) {
            if (this.until()) break;
