...
public final class UDPLimeSentPongsBytes extends AbstractMessageGraphPaneItem {
    ...
    public UDPLimeSentPongsBytes(final String key) {
        ...
        registerStatistic(SentMessageStatBytes.UDP_PING_REPLIES, GUIMediator.getStringResource("STATS_ALL_CLIENTS"));
        registerStatistic(LimeSentMessageStatBytes.UDP_PING_REPLIES, GUIMediator.getStringResource("STATS_LIMEWIRE"));
    }
}
