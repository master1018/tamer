...
public class FBTpbMapper implements Serializable {
    ...
    public static TransactionParameterBuffer processMapping(GDS gds, String mapping) throws FBResourceException {
        ...
        while (st.hasMoreTokens()) {
            ...
            if (value == null) throw new FBResourceException("Keyword " + token + " unknown. Please check your mapping.");
    ...
    public TransactionParameterBuffer getMapping(int transactionIsolation) {
        switch(transactionIsolation) {
            ...
            case Connection.TRANSACTION_REPEATABLE_READ:
            case Connection.TRANSACTION_READ_COMMITTED:
                return ((TransactionParameterBuffer) mapping.get(new Integer(transactionIsolation))).deepCopy();
            case Connection.TRANSACTION_READ_UNCOMMITTED:
                return ((TransactionParameterBuffer) mapping.get(new Integer(Connection.TRANSACTION_READ_COMMITTED))).deepCopy();
            case Connection.TRANSACTION_NONE:
            default:
