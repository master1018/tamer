...
public class SoyMsgBundleHandler {
   ...
   */
    public void writeToFile(SoyMsgBundle msgBundle, File outputFile) throws IOException, SoyMsgException {
   ...
   * @throws SoyMsgException If there's an error while processing the messages.
   */
    public void writeToFile(SoyMsgBundle msgBundle, OutputFileOptions options, File outputFile) throws IOException, SoyMsgException {
