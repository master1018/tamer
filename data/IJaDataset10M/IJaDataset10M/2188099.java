...
public class MDCDisplayerAppli {
    ...
    public JMenuBar buildMenuBar() {
        ...
        MenuUtils.addWithShortCut(fileMenu, new NewTextAction("New", workflow), KeyEvent.VK_N);
        MenuUtils.addWithShortCut(fileMenu, new OpenTextAction("Open", workflow), KeyEvent.VK_O);
        MenuUtils.addWithShortCut(fileMenu, new WorkflowMethodAction(workflow, "Save", "saveText"), KeyEvent.VK_S);
        MenuUtils.addWithShortCut(fileMenu, new SaveTextAsAction("Save As", workflow), KeyEvent.VK_S, InputEvent.SHIFT_DOWN_MASK);
        JMenu importMenu = new JMenu("Import");
        importMenu.add(new WorkflowMethodAction(workflow, "Import from pasted PDF", "importPastedPDF"));
        importMenu.add(new WorkflowMethodAction(workflow, "Import from pasted RTF", "importPastedRTF"));
        fileMenu.add(importMenu);
        JMenu exportMenu = new JMenu("Export as");
        fileMenu.add(exportMenu);
        fileMenu.addSeparator();
        MenuUtils.addWithMnemonics(fileMenu, new ExitAction("Exit", workflow), new Integer('X'));
        menubar.add(fileMenu);
        MenuUtils.addWithShortCut(exportMenu, new WorkflowMethodAction(workflow, "Export as JPEG or PNG", "exportAsBitmap"), KeyEvent.VK_B, InputEvent.SHIFT_DOWN_MASK);
        exportMenu.add(new WorkflowMethodAction(workflow, "Export as Wmf", "exportAsWMF", true));
        exportMenu.add(new WorkflowMethodAction(workflow, "Export as Emf", "exportAsEMF", true));
        exportMenu.add(new WorkflowMethodAction(workflow, "Export as EPS", "exportAsEPS", true));
        exportMenu.add(new WorkflowMethodAction(workflow, "Export as Mac Pict", "exportAsMacPict", true));
        exportMenu.add(new WorkflowMethodAction(workflow, "Export as SVG", "exportAsSVG", true));
        exportMenu.add(new WorkflowMethodAction(workflow, "Export as Html", "exportAsHtml"));
        exportMenu.add(new WorkflowMethodAction(workflow, "Export as Pdf", "exportAsPdf"));
        exportMenu.add(new WorkflowMethodAction(workflow, "Export as Rtf", "exportAsRtf"));
        JMenu edit = new JMenu("Edit");
        edit.setMnemonic(KeyEvent.VK_E);
        ForwardedAction undoAction = new ForwardedAction(workflow, "Undo", MDCEditorKeyManager.UNDO);
        MenuUtils.addWithShortCut(edit, undoAction, KeyEvent.VK_Z);
        Action redoAction = new ForwardedAction(workflow, "Redo", MDCEditorKeyManager.REDO);
        if (PlatformDetection.getPlatform() == PlatformDetection.MACOSX) {
            MenuUtils.addWithShortCut(edit, redoAction, KeyEvent.VK_Z, InputEvent.SHIFT_DOWN_MASK);
        } else {
            MenuUtils.addWithShortCut(edit, redoAction, KeyEvent.VK_Y);
        }
        workflow.registerUndoRedoActions(undoAction, redoAction);
        edit.addSeparator();
        MenuUtils.addWithShortCut(edit, new ForwardedAction(workflow, "Cut", MDCEditorKeyManager.CUT, true), KeyEvent.VK_X);
        MenuUtils.addWithShortCut(edit, new ForwardedAction(workflow, "Copy", MDCEditorKeyManager.COPY, true), KeyEvent.VK_C);
        MenuUtils.addWithShortCut(edit, new ForwardedAction(workflow, "Paste", MDCEditorKeyManager.PASTE), KeyEvent.VK_V);
        ...
        copyAs.add(new ForwardedAction(workflow, "Copy as BITMAP (JPEG,PNG...)", "COPY_AS_BITMAP"));
        edit.add(copyAs);
        edit.addSeparator();
        MenuUtils.addWithShortCut(edit, workflow.getSelectAllAction(), KeyEvent.VK_A);
        edit.addSeparator();
        MenuUtils.addWithShortCut(edit, workflow.getSetHieroglyphicModeAction(), KeyEvent.VK_N);
        ...
        MenuUtils.addWithShortCut(edit, workflow.getSetTransliterationModeAction(), KeyEvent.VK_T);
        MenuUtils.addWithShortCut(edit, workflow.getSetLinePageNumberModeAction(), KeyEvent.VK_EXCLAMATION_MARK);
        edit.add(new WorkflowMethodAction(workflow, "Add Short Text", "addShortText"));
        edit.addSeparator();
        ButtonGroup group = new ButtonGroup();
        JRadioButtonMenuItem copyAndPaste1 = new JRadioButtonMenuItem(new SelectCopyPasteConfigurationAction("copy : large size", workflow, 0));
        JRadioButtonMenuItem copyAndPaste2 = new JRadioButtonMenuItem(new SelectCopyPasteConfigurationAction("copy : small size", workflow, 1));
        JRadioButtonMenuItem copyAndPaste3 = new JRadioButtonMenuItem(new SelectCopyPasteConfigurationAction("copy : wysiwyg", workflow, 2));
        ...
        if (PlatformDetection.getPlatform() == PlatformDetection.MACOSX) {
            MenuUtils.addWithShortCut(manipulate, workflow.getGroupHorizontallyAction(), KeyEvent.VK_J);
        } else {
            MenuUtils.addWithShortCut(manipulate, workflow.getGroupHorizontallyAction(), KeyEvent.VK_H);
        }
        MenuUtils.addWithShortCut(manipulate, workflow.getGroupVerticallyAction(), KeyEvent.VK_G);
        MenuUtils.addWithShortCut(manipulate, workflow.getLigatureAction(), KeyEvent.VK_L);
        MenuUtils.addWithShortCut(manipulate, workflow.getLigatureBeforeAction(), KeyEvent.VK_K);
        MenuUtils.addWithShortCut(manipulate, workflow.getLigatureAfterAction(), KeyEvent.VK_M);
        MenuUtils.addWithShortCut(manipulate, workflow.getExplodeGroupAction(), KeyEvent.VK_E);
        manipulate.addSeparator();
        MenuUtils.addWithShortCut(manipulate, workflow.getInsertSpaceAction(), KeyEvent.VK_P);
        MenuUtils.addWithShortCut(manipulate, workflow.getInsertHalfSpaceAction(), KeyEvent.VK_P, InputEvent.SHIFT_DOWN_MASK);
        MenuUtils.addWithShortCut(manipulate, workflow.getInsertPageBreakAction(), KeyEvent.VK_ENTER, InputEvent.SHIFT_DOWN_MASK);
        ...
        shadingSymbols.setToolTipText("Shading shapes used as symbols (not combined with signs)");
        ...
        MenuUtils.addWithShortCut(manipulate, workflow.getPaintBlackAction(), KeyEvent.VK_R, InputEvent.SHIFT_DOWN_MASK);
        MenuUtils.addWithShortCut(manipulate, workflow.getEditGroupAction(), KeyEvent.VK_G, InputEvent.SHIFT_DOWN_MASK);
        manipulate.addSeparator();
        ...
        for (int i = 0; i < workflow.getRotations().length; i++) rotation.add(workflow.getRotations()[i]);
        sign.add(rotation);
        ...
        JRadioButtonMenuItem horizontalButton = new JRadioButtonMenuItem(new ForwardedAction(workflow, "Horizontal", MDCEditorKeyManager.SELECT_HORIZONTAL_ORIENTATION));
        JRadioButtonMenuItem verticalButton = new JRadioButtonMenuItem(new ForwardedAction(workflow, "Vertical", MDCEditorKeyManager.SELECT_VERTICAL_ORIENTATION));
        ...
        JRadioButtonMenuItem leftToRightButton = new JRadioButtonMenuItem(new ForwardedAction(workflow, "Left to Right", MDCEditorKeyManager.SELECT_L2R_DIRECTION));
        JRadioButtonMenuItem rightToLeftButton = new JRadioButtonMenuItem(new ForwardedAction(workflow, "Right to Left", MDCEditorKeyManager.SELECT_R2L_DIRECTION));
        ...
        help.add(new DisplayJavaPropertiesAction("Display java properties", frame));
    ...
    private void buildToolsMenus(JMenuBar menubar2) {
        ...
        tools.add(new WorkflowMethodAction(workflow, "Hide/Show hieroglyph palette", "toggleHieroglyphPalette"));
    ...
    private void buildPhilologicalMenu(JMenu menubar) {
        ...
        String tips[] = { "Editor addition", "Erased text", "Previously readable signs", "Scribe addition", "Superfluous signs", "Explanatory addition", "Dubious reading" };
        for (int i = 0; i < workflow.getPhilologyActions().length; i++) {
            JMenuItem sub = new JMenuItem(workflow.getPhilologyActions()[i]);
            if (i < tips.length) sub.setToolTipText(tips[i]);
            philology.add(sub);
        }
    ...
    private void buildHieroglyphicMenus(JMenuBar menubar) {
        ...
        for (int i = 0; i < families.size(); i++) {
            ...
            HieroglyphicMenu fmenu = new HieroglyphicMenu(family.getCode() + ". " + family.getDescription(), family.getCode(), 6);
            fmenu.setHieroglyphicMenuListener(new HieroglyphicMenuMediator());
            if (i < 25) fmenu.setMnemonic(family.getCode().toUpperCase().charAt(0)); else if (i == 25) {
                fmenu.setMnemonic(KeyEvent.VK_J);
            } else if (i == 26) fmenu.setMnemonic(KeyEvent.VK_AMPERSAND);
            hieroglyphs.add(fmenu);
        }
        hieroglyphs.add(new HieroglyphicMenu("Tall Narrow Signs", HieroglyphicMenu.TALL_NARROW, 6));
        hieroglyphs.add(new HieroglyphicMenu("Low Broad Signs", HieroglyphicMenu.LOW_BROAD, 6));
        hieroglyphs.add(new HieroglyphicMenu("Low Narrow Signs", HieroglyphicMenu.LOW_NARROW, 6));
    ...
    public static MDCDisplayerAppli startAppli(String args[]) {
        ...
        if (!CompositeHieroglyphsManager.getInstance().isUserFileCorrect()) {
            JOptionPane.showMessageDialog(a.frame, "I had difficulties reading the signs definitions\n" + "Maybe it's because of the file " + CompositeHieroglyphsManager.getUserSignDefinitionFile() + "\n" + "Error message was : \"" + CompositeHieroglyphsManager.getInstance().getUserFileMessage() + "\"", "Error loading signs definition", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private static void displayErrorMessage(Exception e) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                JOptionPane.showMessageDialog(null, pane, "Problem", JOptionPane.ERROR_MESSAGE);
            }
        });
    }
