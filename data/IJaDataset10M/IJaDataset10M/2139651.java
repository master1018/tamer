...
public class Match implements Comparable<Match> {
	 ...
	 * @param queryEnd
	 */
    public Match(DNASequence target, long targetStart, long targetEnd, DNASequence query, long queryStart, long queryEnd) {
        this.target = target;
    ...
    public long size() {
        return queryEnd - queryStart >= 0 ? queryEnd - queryStart : queryStart - queryEnd;
    }
    ...
    public boolean includedInOtherMatch(Match other) {
        ...
        if ((other.getQuerySmallerIndex() - slack) < this.getQuerySmallerIndex() && (other.getQueryLargerIndex() + slack) > this.getQueryLargerIndex()) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.target == other.target && this.queryStart == other.queryStart && this.queryEnd == other.queryEnd && this.targetStart == other.targetStart && this.targetEnd == other.targetEnd) {
            return true;
        } else {
            return false;
        }
