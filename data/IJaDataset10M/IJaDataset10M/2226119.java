package com.example.client.dataintegration.json;
...
public class JsonSimpleSample extends ShowcasePanel {
    ...
    private static final String DESCRIPTION = "<p>DataSources can bind directly to JSON data where records appear as an Array of JavaScript Objects with field values as properties.</p>" + "<p>This approach of loading simple JSON data over HTTP can be used with PHP and other server technologies.</p>";
