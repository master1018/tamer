 ...
 * @since 1.1
 */
public class IntegerGeneTest extends JGAPTestCase {
   ...
   */
    public void testPersistentRepresentation_2() throws Exception {
        ...
        gene1.setAllele(new Integer(45));
        gene1.setValueFromPersistentRepresentation("2" + IntegerGene.PERSISTENT_FIELD_DELIMITER + "3" + IntegerGene.PERSISTENT_FIELD_DELIMITER + "4");
   ...
   */
    public void testPersistentRepresentation_3() throws Exception {
        IntegerGene gene1 = new IntegerGene(conf, 2, 753);
        gene1.setAllele(new Integer(45));
        gene1.setValueFromPersistentRepresentation("null" + IntegerGene.PERSISTENT_FIELD_DELIMITER + "-3" + IntegerGene.PERSISTENT_FIELD_DELIMITER + "4");
   ...
   */
    public void testPersistentRepresentation_4() throws Exception {
        ...
        gene1.setAllele(new Integer(45));
        try {
            gene1.setValueFromPersistentRepresentation("null" + IntegerGene.PERSISTENT_FIELD_DELIMITER + "3.5" + IntegerGene.PERSISTENT_FIELD_DELIMITER + "4");
            fail();
   ...
   */
    public void testPersistentRepresentation_5() throws Exception {
        ...
        gene1.setAllele(new Integer(45));
        try {
            gene1.setValueFromPersistentRepresentation("null" + IntegerGene.PERSISTENT_FIELD_DELIMITER + "3" + IntegerGene.PERSISTENT_FIELD_DELIMITER + "a");
            fail();
        } catch (UnsupportedRepresentationException uex) {
            ;
        }
   ...
   * @since 2.6
   */
    public void testPersistentRepresentation_6() throws Exception {
        IntegerGene gene1 = new IntegerGene(conf);
        assertEquals("null" + IntegerGene.PERSISTENT_FIELD_DELIMITER + Integer.MIN_VALUE + IntegerGene.PERSISTENT_FIELD_DELIMITER + Integer.MAX_VALUE, gene1.getPersistentRepresentation());
    }
   ...
   */
    public void testCompareToNative_0() throws Exception {
        ...
        assertEquals(((Integer) gene1.getAllele()).compareTo((Integer) gene2.getAllele()), gene1.compareTo(gene2));
    }
   ...
   */
    public void testSetToRandomValue_3() throws Exception {
        ...
        if (gene.intValue() < 0 || gene.intValue() > 8) {
            fail();
        }
    }
   ...
   */
    public void testSetToRandomValue_4() throws Exception {
        ...
        if (gene.intValue() < 1 || gene.intValue() > 6) {
            fail();
        }
    }
   ...
   * @since 2.4
   */
    class IntegerGene2 extends IntegerGene {
    ...
    class GeneConstraintChecker implements IGeneConstraintChecker {
        ...
        public boolean verify(Gene a_gene, Object a_alleleValue, IChromosome a_chrom, int a_index) {
            return true;
        }
    }
