...
public class QuickViewerFactoryImpl implements QuickViewerFactory {
    ...
    public QuickViewer getViewer(String mime) {
        try {
            return ((QuickViewer) Class.forName(resources.getString(mime)).newInstance());
        } catch (Exception e) {
            throw new UnsupportedOperationException("Unable to find a proper " + "class for handling type : " + mime + "." + " Exception is : " + e.toString());
        }
    }
}
