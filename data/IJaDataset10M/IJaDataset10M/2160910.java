...
public class ThrottleSettings {
    ...
    public enum Policy {
        ...
        NONE, ERROR, IGNORE, BUFFER, CONFLATE
    }
    ...
    public static Policy parsePolicy(String policy) {
        if (Policy.NONE.toString().equalsIgnoreCase(policy)) return Policy.NONE; else if (Policy.IGNORE.toString().equalsIgnoreCase(policy)) return Policy.IGNORE; else if (Policy.ERROR.toString().equalsIgnoreCase(policy)) return Policy.ERROR; else if (Policy.BUFFER.toString().equalsIgnoreCase(policy)) return Policy.BUFFER; else if (Policy.CONFLATE.toString().equalsIgnoreCase(policy)) return Policy.CONFLATE;
    ...
    public void setIncomingClientFrequency(int n) {
        ...
        if (inDestinationMessagesPerSec > 0 && n > inDestinationMessagesPerSec) {
            ConfigurationException ex = new ConfigurationException();
            ex.setMessage(ERR_MSG_INVALID_INCOMING_CLENT_FREQ, new Object[] { name, destinationName, Integer.valueOf(n), Integer.valueOf(inDestinationMessagesPerSec) });
            throw ex;
        }
    ...
    public void setIncomingDestinationFrequency(int n) {
        ...
        if (inClientMessagesPerSec > 0 && n < inClientMessagesPerSec) {
            ConfigurationException ex = new ConfigurationException();
            ex.setMessage(ERR_MSG_INVALID_INCOMING_DEST_FREQ, new Object[] { name, destinationName, Integer.valueOf(n), Integer.valueOf(inClientMessagesPerSec) });
            throw ex;
        }
    ...
    public void setOutgoingClientFrequency(int n) {
        ...
        if (outDestinationMessagesPerSec > 0 && n > outDestinationMessagesPerSec) {
            ConfigurationException ex = new ConfigurationException();
            ex.setMessage(ERR_MSG_INVALID_OUTGOING_CLIENT_FREQ, new Object[] { name, destinationName, Integer.valueOf(n), Integer.valueOf(outDestinationMessagesPerSec) });
            throw ex;
        }
    ...
    public void setOutgoingDestinationFrequency(int n) {
        ...
        if (outClientMessagesPerSec > 0 && n < outClientMessagesPerSec) {
            ConfigurationException ex = new ConfigurationException();
            ex.setMessage(ERR_MSG_INVALID_OUTGOING_DEST_FREQ, new Object[] { name, destinationName, Integer.valueOf(n), Integer.valueOf(outClientMessagesPerSec) });
            throw ex;
        }
