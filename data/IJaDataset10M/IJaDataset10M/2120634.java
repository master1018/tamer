 ...
 * 
 */
@ExtensionDescription.Default(nsAlias = GttNamespace.GTT_ALIAS, nsUri = GttNamespace.GTT, localName = DocumentSource.XML_NAME)
public class DocumentSource extends ExtensionPoint {
    ...
    public enum Type {
        ...
        /** Aea document source. */
        AEA("aea"), /** Aes document source. */
        AES("aes"), /** Doc document source. */
        DOC("doc"), /** Html document source. */
        HTML("html"), /** Knol document source. */
        KNOL("knol"), /** Odt document source. */
        ODT("odt"), /** PlainText document source. */
        PLAINTEXT("plainText"), /** Rtf document source. */
        RTF("rtf"), /** Srt document source. */
        SRT("srt"), /** Sub document source. */
        SUB("sub"), /** Wiki document source. */
        WIKI("wiki");
   ...
   */
    public static ExtensionDescription getDefaultDescription(boolean required, boolean repeatable) {
        ExtensionDescription desc = ExtensionDescription.getDefaultDescription(DocumentSource.class);
    ...
    protected void consumeAttributes(AttributeHelper helper) throws ParseException {
        type = helper.consumeEnum(TYPE, false, Type.class, null, TYPE_ENUM_TO_ATTRIBUTE_VALUE);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(type, other.type) && eq(url, other.url);
    }
