package fr.inria.uml4tst.papyrus.ocl4tst.ocl4tst.resource.ocl4tst.util;
 ...
 */
public class Ocl4tstResourceUtil {
    ...
    public static fr.inria.uml4tst.papyrus.ocl4tst.ocl4tst.resource.ocl4tst.mopp.Ocl4tstResource getResource(org.eclipse.core.resources.IFile file) {
        ...
        return (fr.inria.uml4tst.papyrus.ocl4tst.ocl4tst.resource.ocl4tst.mopp.Ocl4tstResource) csResource;
    }

    public static fr.inria.uml4tst.papyrus.ocl4tst.ocl4tst.resource.ocl4tst.mopp.Ocl4tstResource getResource(java.io.File file) {
        return getResource(file, null);
    }

    public static fr.inria.uml4tst.papyrus.ocl4tst.ocl4tst.resource.ocl4tst.mopp.Ocl4tstResource getResource(java.io.File file, java.util.Map<?, ?> options) {
        return getResource(org.eclipse.emf.common.util.URI.createFileURI(file.getAbsolutePath()), options);
    }

    public static fr.inria.uml4tst.papyrus.ocl4tst.ocl4tst.resource.ocl4tst.mopp.Ocl4tstResource getResource(org.eclipse.emf.common.util.URI uri) {
        return getResource(uri, null);
    }

    public static fr.inria.uml4tst.papyrus.ocl4tst.ocl4tst.resource.ocl4tst.mopp.Ocl4tstResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?, ?> options) {
        new fr.inria.uml4tst.papyrus.ocl4tst.ocl4tst.resource.ocl4tst.mopp.Ocl4tstMetaInformation().registerResourceFactory();
        org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
        if (options != null) {
            rs.getLoadOptions().putAll(options);
        }
        org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
        return (fr.inria.uml4tst.papyrus.ocl4tst.ocl4tst.resource.ocl4tst.mopp.Ocl4tstResource) resource;
    }

    /**
	 * Returns the root element of the resource with the given URI.
	 */
    public static fr.inria.uml4tst.papyrus.ocl4tst.ocl4tst.OclDeclaration getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
    public static fr.inria.uml4tst.papyrus.ocl4tst.ocl4tst.OclDeclaration getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?, ?> options) {
        ...
        return (fr.inria.uml4tst.papyrus.ocl4tst.ocl4tst.OclDeclaration) root;
    }
