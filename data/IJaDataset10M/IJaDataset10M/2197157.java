...
public class DaoFinder {
    ...
    public Object lookupObject(String objectName) {
        ...
        if (objectClass == null) throw new RuntimeException("Can not be found class definition for: " + objectName + ", you may forgot adding package name of class!");
    ...
    private void checkInitialized() throws RuntimeException {
        if (packageNamePrefixes.size() == 0) {
            throw new RuntimeException("DaoInstancefinder not initialized." + " Please call for your dao packages the following: daoInstanceFinder.addPackageByName(\"com.inepex.example.daopackage\")");
        }
    }
}
