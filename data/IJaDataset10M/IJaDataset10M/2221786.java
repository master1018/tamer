...
public final class TCPLimeReceivedPongsBytes extends AbstractMessageGraphPaneItem {
    ...
    public TCPLimeReceivedPongsBytes(final String key) {
        ...
        registerStatistic(ReceivedMessageStatBytes.TCP_PING_REPLIES, GUIMediator.getStringResource("STATS_ALL_CLIENTS"));
        registerStatistic(LimeReceivedMessageStatBytes.TCP_PING_REPLIES, GUIMediator.getStringResource("STATS_LIMEWIRE"));
    }
}
