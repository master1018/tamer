...
public class ControlPanelFactory {
	 ...
	 */
    public static JPanel getMainControlPanel(final JFrame mainFrame, final JTabbedPane mainTabbedPane, final MyMainTabPreviewPainter mainTabPreviewPainter, final JToolBar toolbar) {
        ...
        markAsModified.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                mainFrame.getRootPane().putClientProperty(SubstanceLookAndFeel.WINDOW_MODIFIED, (markAsModified.isSelected() ? Boolean.TRUE : false));
            }
        });
        ...
        heapPanel.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                SubstanceLookAndFeel.setWidgetVisible(mainFrame.getRootPane(), heapPanel.isSelected(), SubstanceWidgetType.TITLE_PANE_HEAP_STATUS);
            }
        });
        ...
        useThemedDefaultIconsCheckBox.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        UIManager.put(SubstanceLookAndFeel.USE_THEMED_DEFAULT_ICONS, useThemedDefaultIconsCheckBox.isSelected() ? Boolean.TRUE : null);
                        mainFrame.repaint();
                    }
                });
            }
        ...
        try {
            final JComboBox overviewKindCombo = new FlexiComboBox<TabOverviewKind>(TabOverviewKind.GRID, TabOverviewKind.MENU_CAROUSEL, TabOverviewKind.ROUND_CAROUSEL) {
            ...
            overviewKindCombo.setSelectedItem(LafWidgetUtilities2.getTabPreviewPainter(mainTabbedPane).getOverviewKind(mainTabbedPane));
            overviewKindCombo.addActionListener(new ActionListener() {

                public void actionPerformed(ActionEvent e) {
                    mainTabPreviewPainter.setTabOverviewKind((TabOverviewKind) overviewKindCombo.getSelectedItem());
                }
            });
            builder.append("Overview kind", overviewKindCombo);
        } catch (NoClassDefFoundError ncdfe) {
        }
        final JComboBox menuGutterFillCombo = new FlexiComboBox<MenuGutterFillKind>(MenuGutterFillKind.NONE, MenuGutterFillKind.SOFT, MenuGutterFillKind.HARD, MenuGutterFillKind.SOFT_FILL, MenuGutterFillKind.HARD_FILL) {
        ...
        menuGutterFillCombo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                UIManager.put(SubstanceLookAndFeel.MENU_GUTTER_FILL_KIND, menuGutterFillCombo.getSelectedItem());
            }
        });
        ...
        isToolbarFlat.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                toolbar.putClientProperty(SubstanceLookAndFeel.FLAT_PROPERTY, Boolean.valueOf(isToolbarFlat.isSelected()));
                toolbar.repaint();
            }
        });
        ...
        menuSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                SubstanceLookAndFeel.setWidgetVisible(mainFrame.getRootPane(), menuSearch.isSelected(), SubstanceWidgetType.MENU_SEARCH);
            }
        });
        ...
        menuLocale.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (menuLocale.isSelected()) {
                    ...
                    mainFrame.getJMenuBar().putClientProperty(LafWidget.IGNORE_GLOBAL_LOCALE, Boolean.TRUE);
                } else {
        ...
        bopi.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        JOptionPane.showMessageDialog(mainFrame, "Sample info message", "Sample title", JOptionPane.INFORMATION_MESSAGE);
                    }
                });
            }
        ...
        bope.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        JOptionPane.showMessageDialog(mainFrame, "Sample error message", "Sample title", JOptionPane.ERROR_MESSAGE);
                    }
                });
            }
        ...
        bopw.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        JOptionPane.showMessageDialog(mainFrame, "Sample warning message", "Sample title", JOptionPane.WARNING_MESSAGE);
                    }
                });
            }
        ...
        bopq.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        JOptionPane.showMessageDialog(mainFrame, "Sample question message", "Sample title", JOptionPane.QUESTION_MESSAGE);
                    }
                });
            }
        ...
        bopc.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        JOptionPane.showOptionDialog(mainFrame, new JPanel(), "Option", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE, null, null, null);
                    }
                });
            }
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        JOptionPane.showInputDialog(panel, "Sample Question Message?", "Title Goes Here", JOptionPane.QUESTION_MESSAGE, null, optionChoices, "entry1");
                        dialog.dispose();
                    }
                });
            }
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        JDesktopPane panel = new JDesktopPane();
                        dialog.add(panel, BorderLayout.CENTER);
                        JOptionPane.showInternalInputDialog(panel, "Sample info message", "Sample title", JOptionPane.INFORMATION_MESSAGE);
                        dialog.dispose();
                    }
                });
            }
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        jsp.putClientProperty(LafWidget.COMPONENT_PREVIEW_PAINTER, new DefaultPreviewPainter());
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        tab1TextField.putClientProperty(LafWidget.TEXT_FLIP_SELECT_ON_ESCAPE, Boolean.TRUE);
                        ...
                        myContentPane.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_ESCAPE, 0), actionName);
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        testFrame.getRootPane().putClientProperty(SubstanceLookAndFeel.SKIN_PROPERTY, new NebulaBrickWallSkin());
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String contents = "";
                        for (int i = 0; i < 100; i++) contents += "This is sample line " + i + " and a lot of other irrelevant text\n";
