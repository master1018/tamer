...
public class ProcessUtils {
     ...
     */
    public static ProcessUtils.ProcessResult exec(String[] args) throws IOException {
        ...
        try {
            ...
            throw new IOException("Wait on process " + args + " interrupted: " + e.getMessage());
        }
        ProcessUtils.ProcessResult result = pu.new ProcessResult(args, exitVal, out.getSink(), err.getSink());
        if (exitVal != 0) {
