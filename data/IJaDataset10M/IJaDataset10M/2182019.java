...
public abstract class VM_AnnotatedElement implements AnnotatedElement {
   ...
   */
    protected VM_AnnotatedElement(VM_Annotation runtimeVisibleAnnotations[], VM_Annotation runtimeInvisibleAnnotations[]) {
   ...
   */
    protected static VM_Annotation[] readAnnotations(int constantPool[], DataInputStream input, int numAnnotationBytes, ClassLoader classLoader) throws IOException {
