        ...
        if (event.widget == templateContainerField) {
            ...
            if (jetNature != null) {
                try {
                    ...
                    setErrorMessage(CodeGenUIPlugin.getPlugin().getString("_UI_CannotSetTemplateContainer_message", new String[] { exception.getLocalizedMessage() }));
                }
            }
        }
        if (event.widget == javaSourceField) {
            ...
            if (jetNature != null) {
                ...
                if (newJavaSourceContainer.exists()) {
                    ...
                    setErrorMessage(CodeGenUIPlugin.getPlugin().getString("_UI_ContainerDoesNotExist_message", new String[] { newJavaSourceContainer.toString() }));
                }
            }
        }
    }
    ...
    protected void performApply() {
        ...
        if (jetNature != null) {
            if (newTemplateContainers != null) {
                jetNature.setTemplateContainers(newTemplateContainers, newTemplateSourceContainers == null ? newTemplateContainers : newTemplateSourceContainers);
            }
