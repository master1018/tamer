...
public class DasTimeRangeSelector extends JPanel implements TimeRangeSelectionListener {
    ...
    private void parseRange() {
        ...
        if (updateRangeString != updateRangeString0) Preferences.userNodeForPackage(getClass()).putBoolean("updateRangeString", updateRangeString);
        return;
    }
    ...
    protected void fireTimeRangeSelected() {
        ...
        if (favoritesEnabled) {
            ...
            if (favoritesList.contains(store)) favoritesList.remove(store);
