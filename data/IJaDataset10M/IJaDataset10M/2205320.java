...
public class SSLContext1Test extends TestCase {
    ...
    protected SSLContext[] createSSLCon() {
        ...
        try {
            ...
            sslC[2] = SSLContext.getInstance(defaultProtocol, defaultProviderName);
            return sslC;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
     ...
     * SSLContext object
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "SSLContext", args = { javax.net.ssl.SSLContextSpi.class, java.security.Provider.class, java.lang.String.class })
     ...
     */
    @TestTargetNew(level = TestLevel.SUFFICIENT, notes = "UnsupportedOperationException checking missed", method = "createSSLEngine", args = {  })
     ...
     */
    @TestTargetNew(level = TestLevel.SUFFICIENT, notes = "UnsupportedOperationException checking missed", method = "createSSLEngine", args = { java.lang.String.class, int.class })
     ...
     * @throws KeyManagementException 
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getClientSessionContext", args = {  })
    public void test_getClientSessionContext() throws NoSuchAlgorithmException, KeyManagementException {
        ...
        for (int i = 0; i < sslC.length; i++) {
            ...
            assertNotNull("Client session is incorrectly instantiated: " + i, sslC[i].getClientSessionContext());
            assertNotNull("Server session is incorrectly instantiated: " + i, sslC[i].getServerSessionContext());
        }
    }
     ...
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "", method = "getInstance", args = { java.lang.String.class })
     ...
     * or empty
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "", method = "getInstance", args = { java.lang.String.class, java.lang.String.class })
    ...
    public void test_getInstanceLjava_lang_StringLjava_lang_String04() throws NoSuchAlgorithmException, NoSuchProviderException {
        ...
        SSLContext sslContext;
        for (int i = 0; i < validValues.length; i++) {
            sslContext = SSLContext.getInstance(validValues[i], defaultProviderName);
     ...
     * method Assertion: throws IllegalArgumentException when provider is null
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "", method = "getInstance", args = { java.lang.String.class, java.security.Provider.class })
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getProtocol", args = {  })
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getProvider", args = {  })
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getServerSessionContext", args = {  })
    public void test_getServerSessionContext() throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException {
        ...
        for (SSLContext sslCi : sslC) {
            ...
            assertNotNull("Server context is incorrectly instantiated", sslCi.getServerSessionContext());
        }
    }
     ...
     * 
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getServerSocketFactory", args = {  })
    ...
    /**
      ...
      */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "getSocketFactory", args = {  })
    public void test_getSocketFactory() throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException {
        ...
        for (SSLContext sslCi : sslC) {
            sslCi.init(kmf.getKeyManagers(), tms, new SecureRandom());
            assertNotNull("Socket factory is incorrectly instantiated", sslCi.getSocketFactory());
        }
    }
     ...
     * @tests javax.net.ssl.SSLContext#
      ...
      */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "init", args = { javax.net.ssl.KeyManager[].class, javax.net.ssl.TrustManager[].class, java.security.SecureRandom.class })
