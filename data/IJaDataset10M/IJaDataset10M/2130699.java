...
public class FieldDeclaration extends BodyDeclaration {
	 ...
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor TYPE_PROPERTY = new ChildPropertyDescriptor(FieldDeclaration.class, "type", Type.class, MANDATORY, NO_CYCLE_RISK);

    /**
	 * The "fragments" structural property of this node type).
	 * @since 3.0
	 */
    public static final ChildListPropertyDescriptor FRAGMENTS_PROPERTY = new ChildListPropertyDescriptor(FieldDeclaration.class, "fragments", VariableDeclarationFragment.class, CYCLE_RISK);
