...
@XmlType(name = "variable", namespace = "http://www.nexusworkflow.com/", propOrder = { "value" })
public class Variable implements Cloneable {
    ...
    public void setInteger(Integer i) {
        ...
        if (i != null) setValue(i.toString()); else setValue(null);
    }
    ...
    public void setDouble(Double d) {
        ...
        if (d != null) setValue(d.toString()); else setValue(null);
    }
    ...
    private static String encodePlain(String str) {
        if (str == null) {
            ...
            return str.replaceAll("%", "%p").replaceAll("<", "%l").replaceAll(">", "%r").replaceAll("&", "%a");
        }
    }
    ...
    private static String encodeBase64(String value) {
        if (value == null) {
            ...
            return Base64Coder.encode(value).replaceAll("\\+", "_").replaceAll("/", "-").replaceAll("=", ".");
        }
    }
    ...
    private static String encodeBinary(byte[] value) {
        if (value == null) {
            ...
            return new String(Base64Coder.encode(value)).replaceAll("\\+", "_").replaceAll("/", "-").replaceAll("=", ".");
        }
    }
    ...
    private static String decodePlain(String str) {
        if (str == null) {
            ...
            return str.replaceAll("%a", "&").replaceAll("%r", ">").replaceAll("%l", "<").replaceAll("%p", "%");
        }
    }
    ...
    private static String decodeBase64(String str) {
        if (str == null) {
            ...
            return Base64Coder.decode(str.replaceAll("\\.", "=").replaceAll("-", "/").replaceAll("_", "+"));
        }
    }
    ...
    private static byte[] decodeBinary(String str) {
        if (str == null) {
            ...
            return Base64Coder.decode(str.replaceAll("\\.", "=").replaceAll("-", "/").replaceAll("_", "+").toCharArray());
        }
    }
