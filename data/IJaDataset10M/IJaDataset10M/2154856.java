...
public class NBoolSet {
    ...
    public boolean sameSet(NBoolSet other) {
        return !(xor(containsTrue, other.containsTrue) || xor(containsFalse, other.containsFalse));
    }
    ...
    public boolean subsetOf(NBoolSet other) {
        return !((containsTrue && !other.containsTrue) || (containsFalse && !other.containsFalse));
    }

    public boolean supersetOf(NBoolSet other) {
        return !((other.containsTrue && !containsTrue) || (other.containsFalse && !containsFalse));
    }
    ...
    public NBoolSet formUnion(NBoolSet other) {
        return new NBoolSet(containsTrue || other.containsTrue, containsFalse || other.containsFalse);
    }
    ...
    public NBoolSet formSymmDiff(NBoolSet other) {
        return new NBoolSet(xor(containsTrue, other.containsTrue), xor(containsFalse, other.containsFalse));
    }
