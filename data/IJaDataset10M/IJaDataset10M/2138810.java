 ...
 * @author jonb
 */
public class XXXAppGui extends DisposableImpl.IdentityEquality {

    /**
	 * Creates a new instance.
	 */
    public XXXAppGui(BomberApp app, FrameClock frameClock) {
        ...
        BomberView pilotView = null;
        boolean isPilotView = true;
        if (isPilotView) {
            new BomberView(world, bomber, bomber.getPilotViewSpec());
        ...
        BomberView sightView = null;
        boolean isSightView = true;
        if (isSightView) {
            new NordenSightView(world, bomber, bomber.getSightViewSpec());
        ...
        appInput.setAppControl(app.getControl());
