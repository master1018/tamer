 ...
 */
public class FirstWizardPage extends JPanel implements WizardPage, DocumentListener, ItemListener {
    ...
    private JLabel existingAccountLabel = new JLabel(Resources.getString("existingAccount"));
    ...
    private JCheckBox enableAdvOpButton = new JCheckBox(Resources.getString("ovverideServerOps"), false);
    ...
    private JLabel transportLabel = new JLabel(Resources.getString("preferredTransport"));
    ...
    private JComboBox transportCombo = new JComboBox(new Object[] { "UDP", "TLS", "TCP" });

    private JPanel presenceOpPanel = new JPanel(new BorderLayout(10, 10));

    private JPanel buttonsPresOpPanel = new JPanel(new GridLayout(0, 1, 10, 10));
    ...
    private JCheckBox enablePresOpButton = new JCheckBox(Resources.getString("enablePresence"), true);

    private JCheckBox forceP2PPresOpButton = new JCheckBox(Resources.getString("forceP2PPresence"), true);

    private JLabel pollPeriodLabel = new JLabel(Resources.getString("offlineContactPollingPeriod"));

    private JLabel subscribeExpiresLabel = new JLabel(Resources.getString("subscriptionExpiration"));

    private JTextField pollPeriodField = new JTextField(DEFAULT_POLL_PERIOD);

    private JTextField subscribeExpiresField = new JTextField(DEFAULT_SUBSCRIBE_EXPIRES);
    ...
    public void loadAccount(ProtocolProviderService protocolProvider) {
        ...
        if (!(serverPort.equals(DEFAULT_PORT) || serverPort.equals(DEFAULT_TLS_PORT)) || !(proxyPort.equals(DEFAULT_PORT) || proxyPort.equals(DEFAULT_TLS_PORT)) || !transportCombo.getSelectedItem().equals(DEFAULT_TRANSPORT)) {
    ...
    public void itemStateChanged(ItemEvent e) {
        if (e.getStateChange() == ItemEvent.SELECTED && e.getItem().equals("TLS")) {
