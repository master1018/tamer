...
public class TemplateIfType {
    ...
    @XmlElements({ @XmlElement(name = "templateCondition", type = TemplateConditionType.class), @XmlElement(name = "setCorrectResponse", type = SetCorrectResponseType.class), @XmlElement(name = "setDefaultValue", type = SetDefaultValueType.class), @XmlElement(name = "setTemplateValue", type = SetTemplateValueType.class), @XmlElement(name = "exitTemplate", type = ExitTemplateType.class) })
