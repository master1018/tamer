...
*/
public class DragDropImage extends BufferedImage {
    ...
    public DragDropImage(int nArrowDirection) {
        this(15, 9, nArrowDirection);
    }

    public DragDropImage(int nWidth, int nHeight, int nArrowDirection) {
        ...
        switch(nArrowDirection) {
            ...
            case ARROW_LEFT:
                ...
                _pathArrow.closePath();
                g2.setPaint(new GradientPaint(0, 0, Color.white, 0, h, SystemColor.controlShadow));
                g2.fill(_pathArrow);
                _pathArrow.reset();
