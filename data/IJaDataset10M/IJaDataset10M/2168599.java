 ...
 * @author slips
 */
public class TextfieldLocator extends AbstractLocator {

    private static final Log log = LogFactory.getLog(TextfieldLocator.class);

    public TextfieldLocator() {
        super.setElementTag(Constants.Tag.INPUT);
        super.setElementType(Constants.Type.TEXT);
    }
