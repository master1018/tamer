...
public class SavitzkyGolayFilter implements Filter {
    ...
    public SavitzkyGolayFilterParameters askParameters(MainWindow _mainWin, SavitzkyGolayFilterParameters currentValues) {
        ...
        String s = (String) JOptionPane.showInputDialog(mainWin, "Select number of data points used for smoothing:", "Savitzky-Golay filter", JOptionPane.PLAIN_MESSAGE, null, possibilities, new Integer(tmpParameters.numberOfDataPoints).toString());
        if (s == null) {
            return null;
        }
        try {
