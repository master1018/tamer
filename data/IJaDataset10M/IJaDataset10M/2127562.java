...
public class FFTMath implements PlugIn {
    ...
    public void run(String arg) {
        if (showDialog()) doMath(imp1, imp2);
    }
    ...
    public boolean showDialog() {
        ...
        for (int i = 0; i < wList.length; i++) {
            ...
            if (imp != null) titles[i] = imp.getTitle(); else titles[i] = "";
        }
    ...
    public void doMath(ImagePlus imp1, ImagePlus imp2) {
        ...
        if (fht1 != null) h1 = new FHT(fht1); else {
            IJ.showStatus("Converting to float");
            ImageProcessor ip1 = imp1.getProcessor();
            h1 = new FHT(ip1);
        }
        fht2 = (ImageProcessor) imp2.getProperty("FHT");
        if (fht2 != null) h2 = new FHT(fht2); else {
            ImageProcessor ip2 = imp2.getProcessor();
            if (imp2 != imp1) h2 = new FHT(ip2);
        }
        if (!h1.powerOf2Size()) {
        ...
        if (fht2 == null) {
            if (h2 == null) h2 = new FHT(h1.duplicate()); else {
