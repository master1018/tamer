...
public class DiagonalizerFactory {
    ...
    public static DiagonalizerFactory getInstance() {
        if (_diagonalizerFactory == null) {
            _diagonalizerFactory = new WeakReference<DiagonalizerFactory>(new DiagonalizerFactory());
        }
        ...
        if (diagonalizerFactory == null) {
            ...
            _diagonalizerFactory = new WeakReference<DiagonalizerFactory>(diagonalizerFactory);
        }
    ...
    public Diagonalizer getDiagonalizer(DiagonalizerType dt) {
        if (dt.equals(DiagonalizerType.JACOBI)) {
            ...
            throw new UnsupportedOperationException("Diagonalizer not " + "supported : " + dt.toString());
        }
    }
