...
public class IndexedQuadArray extends IndexedGeometryArray {
    ...
    */
    ...
    public IndexedQuadArray(int vertexCount, int vertexFormat, int indexCount) {
        ...
        if (vertexCount < 1) throw new IllegalArgumentException(Ding3dI18N.getString("IndexedQuadArray0"));
        if (indexCount < 4 || ((indexCount % 4) != 0)) throw new IllegalArgumentException(Ding3dI18N.getString("IndexedQuadArray1"));
    }
