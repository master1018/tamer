...
public class epp_ContactTrnData extends org.omg.CORBA.portable.ObjectImpl implements org.omg.CORBA.portable.IDLEntity, org.openrtk.idl.epp0705.epp_PollResData {
   ...
   */
    public void setTransferStatus(org.openrtk.idl.epp0705.epp_TransferStatusType value) {
        m_transfer_status = value;
    }
   ...
   * @see #m_transfer_status
   */
    public org.openrtk.idl.epp0705.epp_TransferStatusType getTransferStatus() {
   ...
   */
    public String toString() {
        return this.getClass().getName() + ": { m_id [" + m_id + "] m_transfer_status [" + m_transfer_status + "] m_request_client_id [" + m_request_client_id + "] m_action_client_id [" + m_action_client_id + "] m_request_date [" + m_request_date + "] m_action_date [" + m_action_date + "] }";
    }
}
