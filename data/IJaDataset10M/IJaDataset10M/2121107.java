...
public class SquareOperatorTest<RE extends IRingElement<RE>> extends OperatorTestBase<RE> {
    ...
    public void testOnFractions() {
        ...
        IRingElementFactory<RE> f = getFactory();
        testSqrSum(getLinAlgFactory().ones(5).multiply(f.get("1/2")), f.get("5/4"));
        testSqrSum(getLinAlgFactory().ones(7).multiply(f.get("1/3")), f.get("7/9"));
    }
