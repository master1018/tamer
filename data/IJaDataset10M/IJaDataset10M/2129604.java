...
public class RenameParameterOptions {
    ...
    public static final Option OPT_PROJECT_DIR = new Option("p", "projectDir", true, "List of directories and files that need to be processed.");

    public static final Option OPT_TEST_FULL_NAME = new Option("t", "test", true, "The full qualified name for a test including <package>.<className>.<methodName>");

    public static final Option OPT_OLD_PARAM = new Option("op", "oldParam", true, "The current parameter name that should be renamed");
    ...
    public static final Option OPT_BEAN_FULL_NAME = new Option("b", "bean", true, "The full name for a bean including <package>.<className>");
    ...
    static {
        ...
        OPT_PROJECT_DIR.setArgName("JSystem Project Directory or the full path of multiple scenario suite execution XML file");
        String projectOptionDescription = new StringBuilder().append("The root directory for JSystem project(Not the 'classes' directory ).\n").toString();
