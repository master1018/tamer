...
public class RealPlot3dDisplay extends CoDa3dDisplay {
    ...
    public void paintComponent(Graphics2D g2, double width, double height) {
        ...
        defaultTransform = new AffineTransform(factor, 0, 0, -factor, width / 2, height / 2);
    ...
    public void drawAxis(Graphics2D g2) {
        ...
        g2.setStroke(new BasicStroke(CoDaDisplayConfiguration.getSize("axisX"), BasicStroke.JOIN_MITER, BasicStroke.CAP_ROUND));
        ...
        g2.setStroke(new BasicStroke(CoDaDisplayConfiguration.getSize("axisY"), BasicStroke.JOIN_MITER, BasicStroke.CAP_ROUND));
        ...
        g2.setStroke(new BasicStroke(CoDaDisplayConfiguration.getSize("axisZ"), BasicStroke.JOIN_MITER, BasicStroke.CAP_ROUND));
    ...
    public void drawLabels(Graphics2D g2) {
        ...
        if (v_x[0] != 0 || v_x[1] != 0) {
            ...
            g2.drawString(textLabel[0], (int) o.getX() - metric.stringWidth(textLabel[0]) / 2, (int) o.getY() + metric.getHeight() / 2);
        }
        if (v_y[0] != 0 || v_y[1] != 0) {
            ...
            g2.drawString(textLabel[1], (int) o.getX() - metric.stringWidth(textLabel[1]) / 2, (int) o.getY() + metric.getHeight() / 2);
        }
        if (v_z[0] != 0 || v_z[1] != 0) {
            ...
            g2.drawString(textLabel[2], (int) o.getX() - metric.stringWidth(textLabel[2]) / 2, (int) o.getY() + metric.getHeight() / 2);
        }
    }
