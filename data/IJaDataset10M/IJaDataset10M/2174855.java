...
public abstract class GBlogEntryDao extends ilarkesto.persistence.ADao<BlogEntry> {
    ...
    private final Cache<scrum.server.project.Project, Set<BlogEntry>> blogEntrysByProjectCache = new Cache<scrum.server.project.Project, Set<BlogEntry>>(new Cache.Factory<scrum.server.project.Project, Set<BlogEntry>>() {
    ...
    private final Cache<Integer, Set<BlogEntry>> blogEntrysByNumberCache = new Cache<Integer, Set<BlogEntry>>(new Cache.Factory<Integer, Set<BlogEntry>>() {
    ...
    private final Cache<scrum.server.admin.User, Set<BlogEntry>> blogEntrysByAuthorCache = new Cache<scrum.server.admin.User, Set<BlogEntry>>(new Cache.Factory<scrum.server.admin.User, Set<BlogEntry>>() {
    ...
    private final Cache<java.lang.String, Set<BlogEntry>> blogEntrysByTitleCache = new Cache<java.lang.String, Set<BlogEntry>>(new Cache.Factory<java.lang.String, Set<BlogEntry>>() {
    ...
    private final Cache<java.lang.String, Set<BlogEntry>> blogEntrysByTextCache = new Cache<java.lang.String, Set<BlogEntry>>(new Cache.Factory<java.lang.String, Set<BlogEntry>>() {
    ...
    private final Cache<ilarkesto.base.time.DateAndTime, Set<BlogEntry>> blogEntrysByDateAndTimeCache = new Cache<ilarkesto.base.time.DateAndTime, Set<BlogEntry>>(new Cache.Factory<ilarkesto.base.time.DateAndTime, Set<BlogEntry>>() {
    ...
    private final Cache<scrum.server.release.Release, Set<BlogEntry>> blogEntrysByReleaseCache = new Cache<scrum.server.release.Release, Set<BlogEntry>>(new Cache.Factory<scrum.server.release.Release, Set<BlogEntry>>() {
    ...
    private final Cache<Boolean, Set<BlogEntry>> blogEntrysByPublishedCache = new Cache<Boolean, Set<BlogEntry>>(new Cache.Factory<Boolean, Set<BlogEntry>>() {
