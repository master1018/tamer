...
public class PolygonsSet extends AbstractRegion<Euclidean2D, Euclidean1D> {
        ...
        if (vertices == null) {
            if (getTree(false).getCut() == null) {
                ...
                while (!sorted.isEmpty()) {
                    final AVLTree<ComparableSegment>.Node<ComparableSegment> node = sorted.getSmallest();
     ...
     * {@code node}
     */
    private List<ComparableSegment> followLoop(final AVLTree<ComparableSegment>.Node<ComparableSegment> node, final AVLTree<ComparableSegment> sorted) {
        ...
        while ((end != null) && (open || (globalStart.distance(end) > 1.0e-10))) {
            AVLTree<ComparableSegment>.Node<ComparableSegment> selectedNode = null;
            ...
            for (AVLTree<ComparableSegment>.Node<ComparableSegment> n = sorted.getNotSmaller(lowerLeft); (n != null) && (n.getElement().compareTo(upperRight) <= 0); n = n.getNext()) {
