...
public final class GtpUtilTest extends junit.framework.TestCase {
    ...
    public void getTimeSettingsCommand() {
        ...
        assertEquals(GtpUtil.getTimeSettingsCommand(settings), "time_settings 60 0 0");
        settings = new TimeSettings(0, 60000, 10);
        assertEquals(GtpUtil.getTimeSettingsCommand(settings), "time_settings 0 60 10");
        settings = new TimeSettings(30000, 60000, 10);
        assertEquals(GtpUtil.getTimeSettingsCommand(settings), "time_settings 30 60 10");
        assertEquals(GtpUtil.getTimeSettingsCommand(null), "time_settings 0 1 0");
    }
}
