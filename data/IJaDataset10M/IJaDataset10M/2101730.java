...
public class SellerListings implements java.io.Serializable {
    ...
    public SellerListings(com.amazon.ws.Request request, org.apache.axis.types.NonNegativeInteger totalResults, org.apache.axis.types.NonNegativeInteger totalPages, com.amazon.ws.SellerListing[] sellerListing) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = true && ((this.request == null && other.getRequest() == null) || (this.request != null && this.request.equals(other.getRequest()))) && ((this.totalResults == null && other.getTotalResults() == null) || (this.totalResults != null && this.totalResults.equals(other.getTotalResults()))) && ((this.totalPages == null && other.getTotalPages() == null) || (this.totalPages != null && this.totalPages.equals(other.getTotalPages()))) && ((this.sellerListing == null && other.getSellerListing() == null) || (this.sellerListing != null && java.util.Arrays.equals(this.sellerListing, other.getSellerListing())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSellerListing() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getSellerListing()); i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(SellerListings.class, true);
