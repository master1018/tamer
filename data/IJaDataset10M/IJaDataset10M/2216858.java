...
public abstract class AbstractUsernamePasswordAllTestCase extends AbstractUsernamePasswordGroupTestCase implements AttributeSupportTestInterface {

    public AbstractUsernamePasswordAllTestCase(String name) {
        super(name);
    }
