...
public class Rectangle implements Cloneable {
   ...
   */
    public boolean intersect(Rectangle rect) {
        if (getIntersection(rect) == null) return false; else return true;
    }
    ...
    public Rectangle getIntersection(Rectangle rect) {
        ...
        int h = Math.min(rect.getY() + rect.getHeight(), this.getY() + this.getHeight()) - Math.max(rect.getY(), this.getY());
