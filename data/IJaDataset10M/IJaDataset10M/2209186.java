...
public class TestIOOperations {
    ...
    private static final String PROJECT_1_PATH = "." + SEP + "test" + SEP + "cz" + SEP + "cvut" + SEP + "promod" + SEP + "services" + SEP + "projectService" + SEP + "files" + SEP + "project1";

    private static final String PROJECT_2_PATH = "." + SEP + "test" + SEP + "cz" + SEP + "cvut" + SEP + "promod" + SEP + "services" + SEP + "projectService" + SEP + "files" + SEP + "project2";

    private static final File PROJECT_1_FILE = new File(PROJECT_1_PATH);

    private static final File PROJECT_2_FILE = new File(PROJECT_2_PATH);

    private static final File PROJECT_FILE_1_FILE = new File(PROJECT_1_PATH + "/" + PROJECT_NAME_1 + ProjectService.PROJECT_FILE_EXTENSION);

    private static final File PROJECT_FILE_2_FILE = new File(PROJECT_2_PATH + "/" + PROJECT_NAME_2 + ProjectService.PROJECT_FILE_EXTENSION);
    ...
    public void setUp() {
        ...
        projectDiagram1 = new ProjectDiagram("Diag1", epcNotation.getIdentifier(), UUID.randomUUID(), epcNotation.getDiagramModelFactory().createEmptyDiagramModel());
        final ProjectDiagram projectDiagram2 = new ProjectDiagram(DIAG_NAME_2, epcNotation.getIdentifier(), UUID.randomUUID(), epcNotation.getDiagramModelFactory().createEmptyDiagramModel());
        final ProjectDiagram projectDiagram3 = new ProjectDiagram("Diag3", hierarchyNotation.getIdentifier(), UUID.randomUUID(), hierarchyNotation.getDiagramModelFactory().createEmptyDiagramModel());
        final ProjectDiagram projectDiagram4 = new ProjectDiagram("Diag4", epcNotation.getIdentifier(), UUID.randomUUID(), epcNotation.getDiagramModelFactory().createEmptyDiagramModel());
        final ProjectDiagram projectDiagram5 = new ProjectDiagram("Diag5", hierarchyNotation.getIdentifier(), UUID.randomUUID(), hierarchyNotation.getDiagramModelFactory().createEmptyDiagramModel());
        ...
        final ProjectDiagram projectDiagram6 = new ProjectDiagram("Diag6", epcNotation.getIdentifier(), UUID.randomUUID(), epcNotation.getDiagramModelFactory().createEmptyDiagramModel());
        final ProjectDiagram projectDiagram7 = new ProjectDiagram("Diag7", epcNotation.getIdentifier(), UUID.randomUUID(), epcNotation.getDiagramModelFactory().createEmptyDiagramModel());
        final ProjectDiagram projectDiagram8 = new ProjectDiagram(DIAG_NAME_8, hierarchyNotation.getIdentifier(), UUID.randomUUID(), hierarchyNotation.getDiagramModelFactory().createEmptyDiagramModel());
        final ProjectDiagram projectDiagram9 = new ProjectDiagram("Diag9", epcNotation.getIdentifier(), UUID.randomUUID(), epcNotation.getDiagramModelFactory().createEmptyDiagramModel());
        final ProjectDiagram projectDiagram10 = new ProjectDiagram("Diag10", hierarchyNotation.getIdentifier(), UUID.randomUUID(), hierarchyNotation.getDiagramModelFactory().createEmptyDiagramModel());
    ...
    public void testSaveProject3() {
        assertFalse(PROJECT_1_FILE.exists());
        assertFalse(PROJECT_2_FILE.exists());
        TreePath diagramTreePath = projectRoot1TreePath.pathByAddingChild(((DefaultMutableTreeNode) projectRoot1TreePath.getLastPathComponent()).getFirstChild());
    ...
    public void testSaveProject4() {
        assertFalse(PROJECT_1_FILE.exists());
        assertFalse(PROJECT_2_FILE.exists());
        TreePath subfolderTreePath = projectRoot2TreePath.pathByAddingChild(((DefaultMutableTreeNode) projectRoot2TreePath.getLastPathComponent()).getFirstChild());
    ...
    public void testSaveProject5() {
        assertFalse(PROJECT_1_FILE.exists());
        assertFalse(PROJECT_2_FILE.exists());
        ProjectRoot projectRoot = new ProjectRoot(PROJECT_NAME_1, PROJECT_1_PATH);
        SaveProjectResult result = projectService.saveProject(new TreePath(new DefaultMutableTreeNode[] { new DefaultMutableTreeNode("node"), new DefaultMutableTreeNode(projectRoot) }));
        assertEquals(result, SaveProjectResult.INVALID_TREE_PATH);
        assertFalse(PROJECT_1_FILE.exists());
        assertFalse(PROJECT_2_FILE.exists());
    }
