...
public class Standalones {
	 ...
	 */
    public static final void output(ServletContext ctx, HttpServletRequest request, HttpServletResponse response, Component comp, String path, Writer out) throws ServletException, IOException {
        ...
        if (webman == null) {
            ...
            if (updateURI == null) updateURI = "/zkau"; else updateURI = DHtmlLayoutServlet.fixUpdateURI(updateURI, ATTR);
        ...
        try {
            ...
            final RequestInfo ri = new RequestInfoImpl(wapp, sess, desktop, request, PageDefinitions.getLocator(wapp, path));
