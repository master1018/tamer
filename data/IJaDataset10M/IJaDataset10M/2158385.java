...
public class PlanState implements Serializable {
     ...
     */
    public static String[] stateNames = new String[] { "Created", "Initialised", "Basis Defined", "Records Chosen", "Tree Defined", "Alternatives Defined", "Go Decision Taken", "Experiments Defined", "Experiments Performed", "Results Captured", "Transformations Defined", "Weights Set", "Analyzed", "Executable Plan Created", "Plan Defined", "Plan Validated", "Define Requirements (Fast-track evaluation)", "Evaluate Alternatives (Fast-track evaluation)", "Analyse Results (Fast-track evaluation)", "Completed fast-track evaluation" };
