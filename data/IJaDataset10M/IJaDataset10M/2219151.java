 ...
 *
 */
public interface PrimaryAspectBuilder<T extends Aspect> extends AspectBuilder<T> {
	 ...
	 */
    public abstract WrapperTemplate spawnTemplate(String shadowName, Class<?> source, boolean autoProcess);
}
