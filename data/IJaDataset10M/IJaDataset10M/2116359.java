...
public class CDataFileDefLoaderTest {
    ...
    public static final CDataFileDef adultsDef = new CDataFileDef("Adults", "updated,sex,weight,age,name,height,children", new CellReader<?>[] { CellReaders.BOOLEAN, CellReaders.CHARACTER, CellReaders.DOUBLE, CellReaders.INTEGER, CellReaders.STRING, CellReaders.OPTIONAL_DOUBLE, CellReaders.OPTIONAL_INTEGER }, "integer");

    public static final CDataFileDef nonDefaultCellReader = new CDataFileDef("Contains non default cell reader", "bool,char", new CellReader<?>[] { CellReaders.BOOLEAN, new CharacterReader() }, "bool");
