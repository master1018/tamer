...
public class ConfigureServiceBean extends XMPPBean {
    ...
    public ConfigureServiceBean(AgentConfigInfo agentConfig, String serviceNamespace, int serviceversion) {
        super();
    ...
    public ConfigureServiceBean clone() {
        ConfigureServiceBean clone = null != this.AgentConfig ? new ConfigureServiceBean(this.AgentConfig.clone(), this.ServiceNamespace, this.ServiceVersion) : new ConfigureServiceBean();
        ...
        do {
            switch(parser.getEventType()) {
                ...
                case XmlPullParser.END_TAG:
                    if (parser.getName().equals(CHILD_ELEMENT)) done = true; else parser.next();
                    break;
    ...
    public String payloadToXML() {
        ...
        if (null != this.AgentConfig) sb.append("<" + _xmlTag_AgentConfig + ">").append(this.AgentConfig.toXML()).append("</" + _xmlTag_AgentConfig + ">");
        if (null != this.ServiceNamespace) {
            sb.append("<" + _xmlTag_ServiceNamespace + ">").append(this.ServiceNamespace).append("</" + _xmlTag_ServiceNamespace + ">");
            sb.append("<" + _xmlTag_ServiceVersion + ">").append(this.ServiceVersion).append("</" + _xmlTag_ServiceVersion + ">");
        }
