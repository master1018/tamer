...
public class ObjectGraphNavigatorRegistry {
    ...
    private ObjectGraphNavigator _initializeDefaultOGN(final String id) {
        if ("jxpath".equals(id) && ReflectionUtils.isClassPresent("org.apache.commons.jxpath.JXPathContext")) return registerObjectGraphNavigator("jxpath", new ObjectGraphNavigatorJXPathImpl());
