 ...
 */
public class ScriptDocVersionNode extends ScriptDocParseNode {

    /**
	 * A node for the @version tag.
	 * @param typeIndex
	 * @param parseState
	 * @param startLexeme
	 */
    public ScriptDocVersionNode(int typeIndex, IParseState parseState, Lexeme startLexeme) {
    ...
    public void getSource(SourceWriter writer) {
        ...
        writer.print(this.getAttribute("version-number"));
    }
}
