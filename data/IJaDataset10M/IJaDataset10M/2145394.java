...
public class GLMaterial {
    ...
    public static final float colorNone[] = { 0f, 0f, 0f, 1f };
    ...
    public static final float colorDefaultDiffuse[] = { .8f, .8f, .8f, 1f };

    public static final float colorDefaultAmbient[] = { .2f, .2f, .2f, 1f };
    ...
    private static FloatBuffer defaultShine = allocFloats(new float[] { minShine, 0, 0, 0 });
    ...
    public void setReflection(float intensity, float highlight) {
        float[] color = { intensity, intensity, intensity, 1 };
        setSpecular(color);
