    ...
    public static enum Type {
        ...
        PRE_CURSOR {
            ...
            void dumb(EditorAdaptor vim, LineInformation line, String indent) {
                ...
                vim.getCursorService().setPosition(vim.getCursorService().newPositionForModelOffset(line.getBeginOffset() + indent.length()), true);
            }
            ...
            void smart(EditorAdaptor vim, LineInformation line) {
                ...
                if (line.getNumber() != 0) {
                    ...
                    cs.setPosition(cs.newPositionForModelOffset(p.getLineInformation(line.getNumber()).getEndOffset()), true);
                } else {
        ...
        , POST_CURSOR {
            ...
            void dumb(EditorAdaptor vim, LineInformation line, String indent) {
                ...
                cursorService.setPosition(cursorService.newPositionForModelOffset(begin + indent.length() + newline.length()), true);
            }
            ...
            void smart(EditorAdaptor vim, LineInformation line) {
                ...
                cs.setPosition(cs.newPositionForModelOffset(p.getLineInformation(line.getNumber() + 1).getEndOffset()), true);
            }
        }
        ;
