...
public class zfailType3 extends homura.hde.util.xml.xml.Node {

    public zfailType3(zfailType3 node) {
        super(node);
    }

    public zfailType3(org.w3c.dom.Node node) {
        super(node);
    }

    public zfailType3(org.w3c.dom.Document doc) {
        super(doc);
    }

    public zfailType3(homura.hde.util.xml.xml.Document doc, String namespaceURI, String prefix, String name) {
    ...
    public gles_stencil_op_type getvalue2ValueAtCursor(org.w3c.dom.Node curNode) throws Exception {
        if (curNode == null) throw new homura.hde.util.xml.xml.XmlException("Out of range"); else return new gles_stencil_op_type(getDomNodeValue(curNode));
    }
