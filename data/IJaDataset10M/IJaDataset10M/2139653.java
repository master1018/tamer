...
public abstract class AbstractLobType implements UserType {
	 ...
	 */
    public static final int LOB_CREATOR_SYNCHRONIZATION_ORDER = SessionFactoryUtils.SESSION_SYNCHRONIZATION_ORDER - 100;
    ...
    public final void nullSafeSet(PreparedStatement st, Object value, int index) throws HibernateException, SQLException {
        ...
        if (TransactionSynchronizationManager.isSynchronizationActive()) {
            ...
            if (this.jtaTransactionManager != null) {
                try {
                    ...
                    if (jtaStatus == Status.STATUS_ACTIVE || jtaStatus == Status.STATUS_MARKED_ROLLBACK) {
                        ...
                        this.jtaTransactionManager.getTransaction().registerSynchronization(new JtaLobCreatorSynchronization(lobCreator));
                        return;
                    }
                } catch (Exception ex) {
            ...
            throw new IllegalStateException("Active Spring transaction synchronization or active " + "JTA transaction with 'jtaTransactionManager' on LocalSessionFactoryBean required");
        }
    }
