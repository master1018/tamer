...
public class TUIGame extends Game {
    ...
    protected boolean handleCommand(String moveStr) {
        if (super.handleCommand(moveStr)) return true;
    ...
    private boolean handleTestSuite(String cmd) {
        ...
        try {
            ...
            while ((line = fr.readLine()) != null) {
                ...
                numTotal++;
                System.out.printf("%3d : %6s %6d %d %03d/%03d %s : %s\n", fr.getLineNumber(), TextIO.moveToString(testPos, sm, false), sm.score, correct ? 1 : 0, numRight, numTotal, bm, PV);
            }
            fr.close();
    ...
    public void play() throws IOException {
        ...
        while (true) {
            if (currentMove > 0) {
                ...
                String msg = String.format("Last move: %d%s %s", prevPos.fullMoveCounter, prevPos.whiteMove ? "." : "...", moveStr);
