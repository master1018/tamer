...
public class RegistroSeleccionado implements Comparable {
    ...
    public String anoEntrada, numeroEntrada, oficina, descripcionOficina, fechaES, data, descripcionRemitente, descripcionOrganismoDestinatario, descripcionDocumento, descripcionIdiomaDocumento, registroAnulado, extracto, descripcionGeografico, oficio, oficinaFisica, descripcionOficinaFisica;
