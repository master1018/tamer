...
public final class TableColumnOneToOneAssociationClear extends TableColumnNakedObjectAssociationModifyAbstract<OneToOneAssociation> {

    public TableColumnOneToOneAssociationClear(final AuthenticationSession session, final ObjectAdapter nakedObject, final ResourceContext resourceContext) {
