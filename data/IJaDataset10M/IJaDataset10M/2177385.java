...
public class SVGChemLine extends SVGLine implements SVGChemElement, Comparable<SVGChemLine>, HasStereoBondType {
    ...
    public boolean isShort(double averageLength) {
        getLength();
        return !Double.isNaN(averageLength) && length < SHORT_BOND_LENGTH_RATIO * averageLength;
    }
    ...
    public void closeShortGapsBetweenLineEndAndGroups(List<SVGChemText> groups, int serial, List<CMLAtom> atomList, SVG2CMLTool svg2CmlTool) {
    ...
    private boolean joinAnchor(int serial, Real2 xy, SVGChemText group, Real2 anchorXY, List<CMLAtom> atomList, SVG2CMLTool svg2CmlTool) {
