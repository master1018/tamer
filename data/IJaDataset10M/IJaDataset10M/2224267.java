...
/**
 * This is a default implementation of the IFC object IfcDistributionChamberElement<br><br>
 * 
 ...
 **/
public class IfcDistributionChamberElement extends IfcDistributionFlowElement implements IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcGloballyUniqueId", "IfcOwnerHistory", "IfcLabel", "IfcText", "IfcLabel", "IfcObjectPlacement", "IfcProductRepresentation", "IfcIdentifier" };
    ...
    public Object clone() {
        ...
        if (this.GlobalId != null) ifcDistributionChamberElement.setGlobalId((IfcGloballyUniqueId) this.GlobalId.clone());
        if (this.OwnerHistory != null) ifcDistributionChamberElement.setOwnerHistory((IfcOwnerHistory) this.OwnerHistory.clone());
        if (this.Name != null) ifcDistributionChamberElement.setName((IfcLabel) this.Name.clone());
        if (this.Description != null) ifcDistributionChamberElement.setDescription((IfcText) this.Description.clone());
        if (this.ObjectType != null) ifcDistributionChamberElement.setObjectType((IfcLabel) this.ObjectType.clone());
        if (this.ObjectPlacement != null) ifcDistributionChamberElement.setObjectPlacement((IfcObjectPlacement) this.ObjectPlacement.clone());
        if (this.Representation != null) ifcDistributionChamberElement.setRepresentation((IfcProductRepresentation) this.Representation.clone());
        if (this.Tag != null) ifcDistributionChamberElement.setTag((IfcIdentifier) this.Tag.clone());
    ...
    public Object shallowCopy() {
        IfcDistributionChamberElement ifcDistributionChamberElement = new IfcDistributionChamberElement();
        if (this.GlobalId != null) ifcDistributionChamberElement.setGlobalId(this.GlobalId);
        if (this.OwnerHistory != null) ifcDistributionChamberElement.setOwnerHistory(this.OwnerHistory);
        if (this.Name != null) ifcDistributionChamberElement.setName(this.Name);
        if (this.Description != null) ifcDistributionChamberElement.setDescription(this.Description);
        if (this.ObjectType != null) ifcDistributionChamberElement.setObjectType(this.ObjectType);
        if (this.ObjectPlacement != null) ifcDistributionChamberElement.setObjectPlacement(this.ObjectPlacement);
        if (this.Representation != null) ifcDistributionChamberElement.setRepresentation(this.Representation);
        if (this.Tag != null) ifcDistributionChamberElement.setTag(this.Tag);
        return ifcDistributionChamberElement;
    }
