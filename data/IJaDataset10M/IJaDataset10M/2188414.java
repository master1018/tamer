...
import de.hpi.eworld.importer.osm.jmapviewer.interfaces.TileSource.TileUpdate;
...
public class OsmFileCacheTileLoader extends OsmTileLoader {
    ...
    public OsmFileCacheTileLoader(TileLoaderListener map, File cacheDir) throws SecurityException {
        ...
        try {
            if (cacheDir == null) {
                if (tempDir == null) throw new IOException("No temp directory set");
                String subDirName = "JMapViewerTiles";
                if (userName != null && userName.length() > 0) subDirName += "_" + userName;
