...
public class ResourceAdaptorEntityStatePropertyEditorTest {
    ...
    private void testGetAsText(ResourceAdaptorEntityState state) throws Exception {
        propertyEditor.setValue(state);
        Assert.assertEquals(state.toString(), propertyEditor.getAsText());
    }

    private void testGetValue(ResourceAdaptorEntityState state) throws Exception {
