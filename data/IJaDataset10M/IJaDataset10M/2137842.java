...
public class CircuitGroupQueryMessageImpl extends ISUPMessageImpl implements CircuitGroupQueryMessage {
    ...
    CircuitGroupQueryMessageImpl(Set<Integer> mandatoryCodes, Set<Integer> mandatoryVariableCodes, Set<Integer> optionalCodes, Map<Integer, Integer> mandatoryCode2Index, Map<Integer, Integer> mandatoryVariableCode2Index, Map<Integer, Integer> optionalCode2Index) {
