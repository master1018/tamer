...
public class ResourceImplFactory extends Object {
    ...
    */
    public static LockManager createLockManager(ResourceImpl resource, NamespaceManager namespaceManager, PropertiesManager propertiesManager) throws WebDAVException {
        ...
        if (theClass == null) {
            String classname = ResourceImpl.webdavProperties.getProperty(repositoryManager + ".LockManager");
            if (classname == null) {
                if (!usingDefault) {
                    System.err.println("No LockManager for Repository Manager: " + repositoryManager);
            ...
            try {
                ...
                System.err.println("Cannot create lock manager: " + classname);
        ...
        try {
            ...
            lockManager.initialize(resource, namespaceManager, propertiesManager);
        } catch (Exception exc) {
            System.err.println("Cannot create lock manager: " + theClass.getName());
            System.err.println(exc);
        }
        return lockManager;
    }
    ...
    * @exception com.ibm.webdav.WebDAVException
    */
    public static NamespaceManager createNamespaceManager(ResourceImpl resource) throws WebDAVException {
        String repositoryManager = getRepositoryManagerFor(resource);
        boolean usingDefault = false;
        if (repositoryManager == null) {
            repositoryManager = defaultRepository;
        ...
        if (theClass == null) {
            String classname = ResourceImpl.webdavProperties.getProperty(repositoryManager + ".NamespaceManager");
            if (classname == null) {
                if (!usingDefault) {
                    System.err.println("No NamespaceManager for Repository Manager: " + repositoryManager);
                    System.err.println("Using the fileSystem by default");
                }
            ...
            try {
                ...
                System.err.println("Cannot create namespace manager: " + classname);
                System.err.println(exc);
            }
        ...
        try {
            ...
            System.err.println("Cannot create namespace manager: " + theClass.getName());
            System.err.println(exc);
        }
    ...
    * @exception com.ibm.webdav.WebDAVException
    */
    public static SearchManager createSearchManager(ResourceImpl resource) throws WebDAVException {
        String repositoryManager = getRepositoryManagerFor(resource);
        boolean usingDefault = false;
        if (repositoryManager == null) {
            repositoryManager = defaultRepository;
        ...
        if (theClass == null) {
            String classname = ResourceImpl.webdavProperties.getProperty(repositoryManager + ".SearchManager");
            if (classname == null) {
                if (!usingDefault) {
                    System.err.println("No SearchManager for Repository Manager: " + repositoryManager);
                }
            ...
            try {
                ...
                System.err.println("Cannot create search manager: " + classname);
                System.err.println(exc);
            }
    ...
    * @exception com.ibm.webdav.WebDAVException
    */
    public static PropertiesManager createPropertiesManager(ResourceImpl resource, NamespaceManager namespaceManager) throws WebDAVException {
        String repositoryManager = getRepositoryManagerFor(resource);
        boolean usingDefault = false;
        if (repositoryManager == null) {
            repositoryManager = defaultRepository;
        ...
        if (theClass == null) {
            String classname = ResourceImpl.webdavProperties.getProperty(repositoryManager + ".PropertiesManager");
            if (classname == null) {
                if (!usingDefault) {
                    System.err.println("No PropertiesManager for Repository Manager: " + repositoryManager);
                    System.err.println("Using the fileSystem by default");
                }
            ...
            try {
                ...
                System.err.println("Cannot create properties manager: " + classname);
                System.err.println(exc);
            }
        ...
        try {
            ...
            System.err.println("Cannot create properties manager: " + theClass.getName());
            System.err.println(exc);
        }
        return propertiesManager;
    }

    public static UserAuthenticator getAuthenticator(ResourceImpl resource) throws WebDAVException {
        String repositoryManager = getRepositoryManagerFor(resource);
        boolean usingDefault = false;
        if (repositoryManager == null) {
            repositoryManager = defaultRepository;
        ...
        if (theClass == null) {
            String classname = ResourceImpl.webdavProperties.getProperty(repositoryManager + ".Authenticator");
            if (classname == null) {
                if (!usingDefault) {
                    System.err.println("No Authenticator for Repository Manager: " + repositoryManager);
                }
            ...
            try {
                ...
                System.err.println("Cannot create authenticator: " + classname);
                System.err.println(exc);
            }
        ...
        try {
            ...
            System.err.println("Cannot create authenticator: " + theClass.getName());
            System.err.println(exc);
        }
    ...
    */
    private static String getRepositoryManagerFor(ResourceImpl resource) throws WebDAVException {
        String file = null;
        ...
        while (propertyNames.hasMoreElements()) {
            ...
            if (file.startsWith(propertyName) && (propertyName.length() > matchingPrefix.length())) {
                matchingPrefix = propertyName;
            }
        }
        String repositoryManager = ResourceImpl.webdavProperties.getProperty(matchingPrefix);
