...
Identifies a Business Partner */
    public void setC_BPartner_ID(int C_BPartner_ID) {
        if (C_BPartner_ID <= 0) set_Value("C_BPartner_ID", null); else set_Value("C_BPartner_ID", new Integer(C_BPartner_ID));
    }
...
Unit of Measure */
    public void setC_UOM_ID(int C_UOM_ID) {
        if (C_UOM_ID <= 0) set_Value("C_UOM_ID", null); else set_Value("C_UOM_ID", new Integer(C_UOM_ID));
    }
...
Line Extended Amount (Quantity * Actual Price) without Freight and Charges */
    ...
    public void setMPC_Product_BOM_ID(int MPC_Product_BOM_ID) {
        if (MPC_Product_BOM_ID <= 0) set_Value("MPC_Product_BOM_ID", null); else set_Value("MPC_Product_BOM_ID", new Integer(MPC_Product_BOM_ID));
    }
...
Product Attribute Set Instance */
    public void setM_AttributeSetInstance_ID(int M_AttributeSetInstance_ID) {
        if (M_AttributeSetInstance_ID <= 0) set_Value("M_AttributeSetInstance_ID", null); else set_Value("M_AttributeSetInstance_ID", new Integer(M_AttributeSetInstance_ID));
    }
...
Product, Service, Item */
    public void setM_Product_ID(int M_Product_ID) {
        if (M_Product_ID <= 0) set_Value("M_Product_ID", null); else set_Value("M_Product_ID", new Integer(M_Product_ID));
    }
...
Quantity */
    ...
    public void setSpecie(String Specie) {
        if (Specie.equals("Q") || Specie.equals("A") || Specie.equals("C") || Specie.equals("R") || Specie.equals("M") || Specie.equals("O") || Specie.equals("P") || Specie.equals("G") || Specie.equals("S") || Specie.equals("B") || Specie.equals("X")) ; else throw new IllegalArgumentException("Specie Invalid value - Reference_ID=1000003 - Q - A - C - R - M - O - P - G - S - B - X");
