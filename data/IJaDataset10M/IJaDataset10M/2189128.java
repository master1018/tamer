...
public class SVGImage {
     ...
     */
    public static final String ERROR_NON_INVERTIBLE_SVG_TRANSFORM = "The viewport to user space transform " + "cannot be computed. Check that the viewBox is not zero width and/or height";
     ...
     */
    public void setViewportSize(int width, int height) throws IllegalArgumentException {
