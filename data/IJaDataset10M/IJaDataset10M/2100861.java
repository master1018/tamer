...
/**
 * This is a default implementation of the IFC object IfcRailingType<br><br>
 * 
 ...
 **/
public class IfcRailingType extends IfcBuildingElementType implements IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcGloballyUniqueId", "IfcOwnerHistory", "IfcLabel", "IfcText", "IfcLabel", "SET<IfcPropertySetDefinition>", "LIST<IfcRepresentationMap>", "IfcLabel", "IfcLabel", "IfcRailingTypeEnum" };
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("PredefinedType")) stepString = stepString.concat("*);"); else {
            if (this.PredefinedType != null) stepString = stepString.concat(((IfcRootInterface) this.PredefinedType).getStepParameter(IfcRailingTypeEnum.class.isInterface()) + ");"); else stepString = stepString.concat("$);");
        }
        return stepString;
    }
    ...
    public Object clone() {
        ...
        if (this.GlobalId != null) ifcRailingType.setGlobalId((IfcGloballyUniqueId) this.GlobalId.clone());
        if (this.OwnerHistory != null) ifcRailingType.setOwnerHistory((IfcOwnerHistory) this.OwnerHistory.clone());
        if (this.Name != null) ifcRailingType.setName((IfcLabel) this.Name.clone());
        if (this.Description != null) ifcRailingType.setDescription((IfcText) this.Description.clone());
        if (this.ApplicableOccurrence != null) ifcRailingType.setApplicableOccurrence((IfcLabel) this.ApplicableOccurrence.clone());
        if (this.HasPropertySets != null) ifcRailingType.setHasPropertySets((SET<IfcPropertySetDefinition>) this.HasPropertySets.clone());
        if (this.RepresentationMaps != null) ifcRailingType.setRepresentationMaps((LIST<IfcRepresentationMap>) this.RepresentationMaps.clone());
        if (this.Tag != null) ifcRailingType.setTag((IfcLabel) this.Tag.clone());
        if (this.ElementType != null) ifcRailingType.setElementType((IfcLabel) this.ElementType.clone());
        if (this.PredefinedType != null) ifcRailingType.setPredefinedType((IfcRailingTypeEnum) this.PredefinedType.clone());
    ...
    public Object shallowCopy() {
        IfcRailingType ifcRailingType = new IfcRailingType();
        if (this.GlobalId != null) ifcRailingType.setGlobalId(this.GlobalId);
        if (this.OwnerHistory != null) ifcRailingType.setOwnerHistory(this.OwnerHistory);
        if (this.Name != null) ifcRailingType.setName(this.Name);
        if (this.Description != null) ifcRailingType.setDescription(this.Description);
        if (this.ApplicableOccurrence != null) ifcRailingType.setApplicableOccurrence(this.ApplicableOccurrence);
        if (this.HasPropertySets != null) ifcRailingType.setHasPropertySets(this.HasPropertySets);
        if (this.RepresentationMaps != null) ifcRailingType.setRepresentationMaps(this.RepresentationMaps);
        if (this.Tag != null) ifcRailingType.setTag(this.Tag);
        if (this.ElementType != null) ifcRailingType.setElementType(this.ElementType);
        if (this.PredefinedType != null) ifcRailingType.setPredefinedType(this.PredefinedType);
        return ifcRailingType;
    }
