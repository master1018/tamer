 ...
 * @version $Id: PickListPanel.java 8 2009-02-15 08:54:54Z skulawik $
 */
public class PickListPanel extends JPanel implements ActionListener {
    ...
    private JButton getBtnUp() {
        if (this.btnUp == null) {
            ...
            this.btnUp.setIcon(new ImageIcon(getClass().getResource("/images/content_up.gif")));
            ...
            this.btnUp.setToolTipText(Messages.getString("tooltip.moveitem.up"));
    ...
    private JButton getBtnDown() {
        if (this.btnDown == null) {
            ...
            this.btnDown.setIcon(new ImageIcon(getClass().getResource("/images/content_down.gif")));
            ...
            this.btnDown.setToolTipText(Messages.getString("tooltip.moveitem.down"));
