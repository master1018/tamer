...
public class TestDPersonIUD extends TestCase {
    ...
    public void test() {
        ...
        DPerson p2 = Ebean.find(DPerson.class).setAutofetch(false).where().idEq(id).findUnique();
        ...
        Query<DPerson> query = Ebean.find(DPerson.class).setAutofetch(false).where().gt("cmoney.amount", 1).query();
