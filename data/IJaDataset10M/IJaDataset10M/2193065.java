...
public class DropTargetTest extends TestCase {
    ...
    public void testCreateDropTargetAutoScroller() {
        ...
        DropTarget dt = new DropTarget(comp, new DTL()) {
            ...
            protected DropTargetAutoScroller createDropTargetAutoScroller(Component c, Point p) {
                assertSame(comp, c);
                assertSame(start, p);
                DropTargetAutoScroller ret = super.createDropTargetAutoScroller(c, p);
                assertNotNull(ret);
                return ret;
            }
        };
    ...
    public void testRemoveDropTargetListener() throws TooManyListenersException {
        DropTarget dt = new DropTarget();
        DropTargetListener dtl = new DTL();
    ...
    public void testDragExit() {
        DropTarget dt = new DropTarget();
        DropTargetEvent dte = new DropTargetEvent(dt.getDropTargetContext());
        dt.dragExit(dte);
        DTL dtl = new DTL();
        try {
            dt.addDropTargetListener(dtl);
    ...
    public void testDrop() {
        DropTarget dt = new DropTarget();
        DropTargetDropEvent dtde = new DropTargetDropEvent(dt.getDropTargetContext(), new Point(0, 0), DnDConstants.ACTION_COPY, DnDConstants.ACTION_COPY);
        dt.drop(dtde);
        DTL dtl = new DTL();
        try {
            dt.addDropTargetListener(dtl);
    ...
    public void testDropActionChanged() {
        DropTarget dt = new DropTarget();
        DropTargetDragEvent dtde = new DropTargetDragEvent(dt.getDropTargetContext(), new Point(0, 0), DnDConstants.ACTION_COPY, DnDConstants.ACTION_COPY);
    ...
    public void testSetDefaultActions() {
        ...
        testCheckDefaultAction(dt, DnDConstants.ACTION_LINK | DnDConstants.ACTION_COPY_OR_MOVE);
        testCheckDefaultAction(dt, DnDConstants.ACTION_LINK | ~DnDConstants.ACTION_COPY_OR_MOVE, DnDConstants.ACTION_LINK);
        testCheckDefaultAction(dt, DnDConstants.ACTION_COPY_OR_MOVE | ~DnDConstants.ACTION_LINK, DnDConstants.ACTION_COPY_OR_MOVE);
    }
