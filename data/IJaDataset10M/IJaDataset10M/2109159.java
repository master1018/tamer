...
public class BasicClassLoader extends ClassLoader {
    ...
    public List getRepositories() {
        if (null == myRepositories) myRepositories = new ArrayList();
    ...
    protected Enumeration findResources(String name) throws IOException {
        ...
        while (i.hasNext()) {
            ...
            try {
                ...
                IOException ioe = new IOException("Error trying to find resource " + name + " in repository " + repos);
                ioe.initCause(e);
                throw ioe;
            }
        }
    ...
    protected URL findResource(String name) {
        ...
        while (null == u && i.hasNext()) {
            ...
            try {
                ...
                throw new RuntimeException("Error trying to find resource " + name + ", in respository " + repos, e);
            }
        }
        return u;
    }
