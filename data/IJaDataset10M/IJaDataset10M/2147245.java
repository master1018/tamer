 ...
 * @author Dirk Kuch
 */
public class DrawHandlerForestDevelopment extends AbstractDrawHandler implements IDrawHandler {

    public DrawHandlerForestDevelopment(final IMeasureBuilder builder, final IMapPanel mapPanel, final PoolProject pool, final Feature feature, final Runnable doneListener) {
   ...
   */
    public IGeometryBuilder getGeometryBuilder() {
        ...
        final Object geometry = getFeature().getProperty(IMeasureForestDevelopment.QN_GEOMETRY);
        getFeature().setProperty(IMeasureForestDevelopment.QN_GEOMETRY, null);
   ...
   */
    public String[] getTooltip() {
        if (getLastEvent() == null) return new String[] {}; else if (MyEvent.Init.equals(getLastEvent().event)) return new String[] { Messages.DrawHandlerForestDevelopment_1, Messages.DrawHandlerForestDevelopment_2 }; else if (MyEvent.Left == (getLastEvent().event & MyEvent.Left)) return new String[] { Messages.DrawHandlerForestDevelopment_3, Messages.DrawHandlerForestDevelopment_4 };
        return new String[] {};
    }
   ...
   */
    public void resetGeometry() {
        MethodWidgetHelper.resetGeometry(getFeature(), IMeasureForestDevelopment.QN_GEOMETRY);
    }
   ...
   */
    public boolean setGeometry(final GM_Object gmo) throws Exception {
        FeatureUtils.updateProperty(getPool().getWorkspace(), getFeature(), IMeasureForestDevelopment.QN_GEOMETRY, gmo);
