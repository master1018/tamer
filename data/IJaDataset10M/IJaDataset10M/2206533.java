    ...
    public static final class SupportsScreens {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof SupportsScreens) {
                ...
                return mResizeable == support.mResizeable && mAnyDensity == support.mAnyDensity && mSmallScreens == support.mSmallScreens && mNormalScreens == support.mNormalScreens && mLargeScreens == support.mLargeScreens;
            }
            return false;
        }
        ...
        public boolean hasStrictlyDifferentScreenSupportAs(SupportsScreens support) {
            return (mSmallScreens != Boolean.TRUE || support.mSmallScreens != Boolean.TRUE) && (mNormalScreens != Boolean.TRUE || support.mNormalScreens != Boolean.TRUE) && (mLargeScreens != Boolean.TRUE || support.mLargeScreens != Boolean.TRUE);
        }
        ...
        public boolean overlapWith(SupportsScreens otherSS) {
            if (mSmallScreens == null || mNormalScreens == null || mLargeScreens == null || otherSS.mSmallScreens == null || otherSS.mNormalScreens == null || otherSS.mLargeScreens == null) {
