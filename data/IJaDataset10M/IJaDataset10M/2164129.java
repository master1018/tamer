...
public class DraggedIngredient extends JPanel implements ActionListener, MouseListener, MouseWheelListener {
    ...
    public static DraggedIngredient getInstance() {
        if (instance == null) instance = new DraggedIngredient();
        return instance;
    }
    ...
    public void mouseWheelMoved(MouseWheelEvent mwe) {
        if (mwe.getWheelRotation() == -1) amount += ingredient.getAmounts(); else if (amount > ingredient.getAmounts()) amount -= ingredient.getAmounts();
    }
}
