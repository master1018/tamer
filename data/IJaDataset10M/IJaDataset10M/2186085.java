...
public class Choice extends PrimitiveStackMapping {
    ...
    private static final String[] IDENTIFIERS = { LogicLibrary.NS_2008_08 + "choice", StackLibrary.NS_2007_08 + "choice", StackLibrary.NS_2007_05 + "choice" };

    public String[] getIdentifiers() {
        return IDENTIFIERS;
    }

    public Choice() throws RippleException {
        super();
    }

    public Parameter[] getParameters() {
        return new Parameter[] { new Parameter("b", "a boolean condition", true), new Parameter("t", "the value chosen if b is true", true), new Parameter("f", "the value chosen if b is not true", true) };
    }
