...
import iec61970.meas.Control;
import iec61970.meas.ControlType;
 ...
 * <ul>
 *   <li>{@link iec61970.meas.impl.ControlTypeImpl#getControls <em>Controls</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ControlTypeImpl extends IdentifiedObjectImpl implements ControlType {
    ...
    public EList<Control> getControls() {
        if (controls == null) {
            controls = new EObjectWithInverseResolvingEList<Control>(Control.class, this, MeasPackage.CONTROL_TYPE__CONTROLS, MeasPackage.CONTROL__CONTROL_TYPE);
        }
        return controls;
    }
