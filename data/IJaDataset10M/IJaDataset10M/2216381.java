...
public class LegacyRankerTest extends LimeTestCase {
    ...
    private RemoteFileDesc newRFD(String host, int speed) {
        return remoteFileDescFactory.createRemoteFileDesc(host, 1, 0, "asdf", TestFile.length(), new byte[16], speed, false, 4, false, null, null, false, false, "", null, -1, false);
    }
    ...
    private RemoteFileDesc newRFDWithURN(String host, int speed) {
        ...
        return remoteFileDescFactory.createRemoteFileDesc(host, 1, 0, "asdf", TestFile.length(), new byte[16], speed, false, 4, false, null, set, false, false, "", null, -1, false);
    }
}
