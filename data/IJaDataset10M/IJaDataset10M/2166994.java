...
public class LSInputImpl implements LSInput {
    ...
    public String toString() {
        return getClass().getSimpleName() + "(baseURI=" + baseURI + ",publicId=" + publicId + ",systemId=" + systemId + ",encoding=" + encoding + ",certifiedText=" + certifiedText + ",byteStream=" + byteStream + ",characterStream=" + characterStream + ",stringData=" + stringData + ")";
    }
}
