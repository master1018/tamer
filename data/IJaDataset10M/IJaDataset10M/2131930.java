...
public class DelimitedReader extends DataReader {
    ...
    public boolean hasNext() {
        return (!isClosed && nextLine != null && lastLine >= lineNo + 1);
    }
    ...
    public String[] readLine() {
        ...
        if (firstLine > 0 && lineNo < firstLine) setLine(firstLine);
        if (br == null) throw new IllegalStateException("You have read past the end of this file!");
        try {
            if (lastLine < lineNo + 1) throw new IllegalStateException("You have read past the line limit restriction!");
            thisLine = nextLine;
            if (br != null) {
                nextLine = br.readLine();
                if (nextLine != null) {
    ...
    public void setLine(int lineNumber) {
        if (lastLine < lineNo) lineNumber = lastLine;
