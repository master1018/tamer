...
public class CoverageLogParserTest extends TestCase {
    ...
    public void testCoverageLogParserMain() throws IOException {
        ...
        try {
            ...
            coverageLogParser.CompilationUnit(coverageResultLogSystem, expectedTestSessionContainerUID);
    ...
    class CoverageResultLogOracle implements CoverageResultLog {
        ...
        public void startTestCase(String testSessionContainerUID, String testCaseName, long timestamp) {
            fail("This method call was not expected.");
        }

        public void startTestCase(String testSessionContainerUID, String testCaseName, String comment) {
            fail("This method call was not expected.");
        }

        public void startTestCase(String testSessionContainerUID, String testCaseName, long timestamp, String comment) {
