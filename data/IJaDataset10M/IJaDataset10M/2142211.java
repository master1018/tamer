...
public class UTF8Char {
    ...
    public static byte[] charToUTF8(char c) throws IOException {
        ...
        if (e == null) throw new UTFDataFormatException("character has no UTF-8 representation");
    ...
    public static int UTF8Len(byte o) throws IOException {
        ...
        if (e == null) throw new UTFDataFormatException("this is no UTF-8 character");
        return e.len();
    }
    ...
    private static UTF8ToCharRV UTF8ToChar(byte[] array, int start) throws IOException {
        ...
        for (int i = 0; i < e.template.length; i++) {
            ...
            if (fixed != e.template[i].octet) throw new UTFDataFormatException("Invalid UTF-8 character");
    ...
    public UTF8Char(byte[] a) throws IOException {
        this(a, 0);
    }
