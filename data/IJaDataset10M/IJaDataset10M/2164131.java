...
public class SpecHelper extends JSpecSupport {
    ...
    public void atStart() {
        ...
        Context.setTLs(null, new MockHttpServletResponse(), new MockFilterConfig(), new ControllerRegistry(new MockFilterConfig()), new AppContext(), new RequestContext());
    }
    ...
    protected Object flash(String name) {
        if (session().get("flasher") == null) return null;
