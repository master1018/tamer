...
public class SampleComplexExpressionCompiledTemplate extends AbstractCompiledTemplate {
    ...
    protected String transformCompiled(TemplateContext context) {
        ...
        buffer.append(new StringToken("address", "address", "NIX", "<h1>", "</h1>", "long", "full").evaluate(context));
