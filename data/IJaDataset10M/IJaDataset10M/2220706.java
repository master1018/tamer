 ...
 *
 */
public interface Level0MapOfSetOperator<K, V> extends UniqOperator<Map<K, Set<V>>>, NavigableMapOperator<K, Set<V>>, SortableOperator<Map.Entry<K, Set<V>>>, CastableToMapOfSetOperator, ModifiableMapOperator<K, Set<V>>, ExtractableMapOperator<K, Set<V>>, GenerizableOperator<Map<K, Set<V>>>, ExecutableMapOfSetOperator<K, V>, SelectableOperator<Map<K, Set<V>>>, ReplaceableOperator<Map<K, Set<V>>>, ReplaceableIfNullOperator<Map<K, Set<V>>>, ConvertibleToMapOfArrayOperator<K, V>, ConvertibleToMapOfListOperator<K, V> {
