...
class PersonDisplayInfoBean implements UnitDisplayInfo {
    ...
    public String getSound(Unit unit) {
        ...
        if (person.getPhysicalCondition().isDead()) result = SoundConstants.SND_PERSON_DEAD; else {
            if (male) {
                if (randomSoundNum == 1) result = SoundConstants.SND_PERSON_MALE1; else if (randomSoundNum == 2) result = SoundConstants.SND_PERSON_MALE2;
            } else {
                if (randomSoundNum == 1) result = SoundConstants.SND_PERSON_FEMALE1; else if (randomSoundNum == 2) result = SoundConstants.SND_PERSON_FEMALE2;
            }
        }
        return result;
    }
