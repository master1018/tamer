    ...
    public IndicatorPluginPreferencePage createPreferencePage() {
        IndicatorPluginPreferencePage page = new TALibIndicatorPreferencePage() {
            ...
            public void createControl(Composite parent) {
                ...
                setControl(content);
                addColorSelector(content, "color", Messages.AROONOSC_Color, DEFAULT_COLOR);
                addLabelField(content, "label", Messages.AROONOSC_Label, DEFAULT_LABEL);
                addLineTypeSelector(content, "lineType", Messages.AROONOSC_LineType, DEFAULT_LINETYPE);
                addIntegerValueSelector(content, "period", Messages.AROONOSC_Period, 1, 9999, DEFAULT_PERIOD);
            }
        };
        return page;
    }
