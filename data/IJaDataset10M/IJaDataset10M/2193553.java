...
import org.nexopenframework.ide.eclipse.jee.model.IWebServiceRef;
 ...
 * @since 1.0
 */
public class WebServiceRefViewer extends TableViewer {

    /***/
    private final String columnHeaders[] = { "Field Name", "Type" };

    private final ColumnLayoutData columnLayouts[] = { new ColumnPixelData(100, true, true), new ColumnWeightData(100) };

    public WebServiceRefViewer(Composite parent, IStructuredContentProvider contentProvider) {
    ...
    class ProcessDefinitionProvider extends LabelProvider implements ITableLabelProvider {
        ...
        public String getColumnText(Object element, int columnIndex) {
            if (element instanceof IWebServiceRef && columnIndex == 0) {
                return ((IWebServiceRef) element).getFieldName();
            } else if (element instanceof IWebServiceRef && columnIndex == 1) {
                return ((IWebServiceRef) element).getType();
            }
