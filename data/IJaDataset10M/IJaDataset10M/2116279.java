 ...
 */
public final class GraphEditMonitor<N, ET extends Edge<N>> implements GraphChangeListener<N, ET> {

    private static final String GRAPH_DOES_NOT_MATCH = "Graph does not match EditMonitor Graph";
    ...
    private UndoableEdit getEditFor(Object key, String presentationName) {
        ...
        switch(changes.get(key).intValue()) {
            ...
            case RN:
                ...
                break;
            case AE:
                edit = new InsertGraphEdge<N, ET>(graph, (ET) key, presentationName);
                break;
            case RE:
                edit = new DeleteGraphEdge<N, ET>(graph, (ET) key, presentationName);
                break;
            default:
	 ...
	 *         changes
	 */
    public static <GT, ETN extends Edge<GT>> GraphEditMonitor<GT, ETN> getGraphEditMonitor(Graph<GT, ETN> g) {
