...
public final class CSystem {
    ...
    public static String getOS() {
        ...
        if (OS.indexOf("linux") != -1) {
            ...
            OS = "solaris";
        } else if (((OS.indexOf("mac") != -1) && (OS.indexOf("os") != -1) && (OS.indexOf("x") != -1)) || (OS.indexOf("rhapsody") != -1) || (OS.indexOf("darwin") != -1)) {
            OS = "macosx";
    ...
    public static String getArchitecture() {
        ...
        if (((arch.indexOf("ia") != -1) && (arch.indexOf("64") != -1)) || (arch.indexOf("ia64") != -1)) {
            ...
            arch = "x86_64";
        } else if ((arch.indexOf("86") != -1) || (arch.indexOf("ia32") != -1) || ((arch.indexOf("ia") != -1) && (arch.indexOf("32") != -1))) {
            arch = "x86";
