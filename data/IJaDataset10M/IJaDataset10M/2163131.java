...
public class LinkedHashMapTest extends junit.framework.TestCase {
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Need to improve code.", method = "LinkedHashMap", args = { int.class })
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Need to improve code.", method = "LinkedHashMap", args = { int.class, float.class })
     ...
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "Doesn't verify IllegalArgumentException.", method = "LinkedHashMap", args = { java.util.Map.class })
    public void test_ConstructorLjava_util_Map() {
        ...
        for (int counter = 0; counter < hmSize; counter++) assertTrue("Failed to construct correct LinkedHashMap", hm.get(objArray2[counter]) == hm2.get(objArray2[counter]));
    }

    /**
     * @tests java.util.LinkedHashMap#get(java.lang.Object)
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "Doesn't verify ClassCastException, NullPointerException.", method = "get", args = { java.lang.Object.class })
     ...
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "Doesn't verify that put returns null if there was no mapping for key, or associated null with the specified key.", method = "put", args = { java.lang.Object.class, java.lang.Object.class })
    ...
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "test that put on an already present key causes entry to move to tail.", method = "put", args = { java.lang.Object.class, java.lang.Object.class })
     ...
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "", method = "putAll", args = { java.util.Map.class })
     ...
     * @tests java.util.LinkedHashMap#putAll(java.util.Map)
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "Verifies NullPointerException.", method = "putAll", args = { java.util.Map.class })
    ...
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "Test that remove removes the entry from the linked list", method = "entrySet", args = {  })
    ...
    public void test_keySet() {
        ...
        for (int i = 0; i < objArray.length; i++) assertTrue("Returned set does not contain all keys", s.contains(objArray[i].toString()));
        LinkedHashMap m = new LinkedHashMap();
        m.put(null, "test");
    ...
    public void test_clear() {
        ...
        for (int i = 0; i < hmSize; i++) assertNull("Failed to clear all elements", hm.get(objArray2[i]));
    }
     ...
     * @tests java.util.LinkedHashMap#clone()
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "", method = "clone", args = {  })
    ...
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "Regression test.", method = "clone", args = {  })
     ...
     * returns true.
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "Regression for bug Google Bug 2121546", method = "get", args = { java.lang.Object.class })
     ...
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "Doesn't verify ClassCastException, NullPointerException.", method = "containsKey", args = { java.lang.Object.class })
     ...
     */
    @TestTargetNew(level = TestLevel.PARTIAL_COMPLETE, notes = "Doesn't verify ClassCastException, NullPointerException.", method = "containsValue", args = { java.lang.Object.class })
     ...
     */
    @TestTargetNew(level = TestLevel.COMPLETE, notes = "", method = "removeEldestEntry", args = { java.util.Map.Entry.class })
