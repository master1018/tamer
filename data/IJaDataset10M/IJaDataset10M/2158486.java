...
public class WidgetRoot extends Widget {
    ...
    public void invokeEvent(Event e) {
        ...
        if (in.getMouseTarget() != in.getPrevMouseTarget()) {
            if (in.getPrevMouseTarget() != null) in.getPrevMouseTarget().onMouseLeave.fire(new MouseEvent(MouseEventType.Leave, in));
            if (in.getMouseTarget() != null) in.getMouseTarget().onMouseEnter.fire(new MouseEvent(MouseEventType.Enter, in));
        }
    }
}
