...
public class RestClient {
    ...
    public void save(Resource resource) throws RestClientException {
        try {
            httpMethodExecutor.post(formatHandler.serialize(resource), resourceUrl.getURL(), formatHandler.getContentType());
        } catch (Exception e) {
    ...
    public void update(Resource resource) throws RestClientException {
        try {
            httpMethodExecutor.put(formatHandler.serialize(resource), resourceUrl.getResourceSpecificURL(resource.getId()), formatHandler.getContentType());
        } catch (Exception e) {
    ...
    public Resource getById(int id, Class<?> type) throws RestClientException {
        Resource resource;
        try {
            resource = formatHandler.deserialize(httpMethodExecutor.get(resourceUrl.getResourceSpecificURL(id)), type);
        } catch (Exception e) {
