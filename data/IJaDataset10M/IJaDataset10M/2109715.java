...
public class SyncCalendarTest extends CalendarSyncTestingBase {
    ...
    private EventInfo normalEvent = new EventInfo("normal0", "2008-12-01T00:00:00", "2008-12-02T00:00:00", false);

    private EventInfo dailyRecurringEvent = new EventInfo("dailyEvent", "daily from 5/1/2008 12am to 1am", "2008-10-01T00:00:00", "2008-10-01T01:00:00", "FREQ=DAILY;WKST=SU", false);
    ...
    public void testCreateAndDeleteNewRecurringEvent() throws Exception {
        ...
        assertTrue("A daily recurring event should have been created.", getEventsCount() > countBeforeNewEvent);
        deleteEvent(insertUri);
        assertEquals("Daily recurring event should have been deleted.", countBeforeNewEvent, getEventsCount());
    }
    ...
    public void testCreateAllDayEvent() throws Exception {
        ...
        assertTrue("An all-day event should have been created.", getEventsCount() > countBeforeNewEvent);
    }
