...
abstract class BXQAbstract {
   ...
   */
    protected static final Object valid(final Object obj, final Class<?> type) throws BXQException {
   ...
   */
    protected Type check(final Type e, final XQItemType tar) throws XQException {
        ...
        switch(e) {
            ...
            case DEC:
            case ITR:
                valid = t.num && t != Type.DBL && t != Type.FLT;
                break;
            case STR:
                valid = t.str;
                break;
   ...
   * @throws XQException exception
   */
    protected final Item create(final Object v, final XQItemType t) throws XQException {
   ...
   * @throws XQException exception
   */
    protected final DBNode createDB(final Source s, final XQItemType it) throws XQException {
   ...
   */
    protected final DBNode createDB(final InputStream is) throws XQException {
        ...
        valid(is, InputStream.class);
        try {
            return checkDB(CreateDB.xml(new SAXSource(new InputSource(is)), ctx.context.prop));
        } catch (final IOException ex) {
            throw new BXQException(ex);
        }
    }
   ...
   */
    protected final DBNode createDB(final Reader r) throws XQException {
        ...
        try {
            return checkDB(CreateDB.xml(new SAXSource(new InputSource(r)), ctx.context.prop));
        } catch (final IOException ex) {
            throw new BXQException(ex);
        }
    }
   ...
   * @throws XQException exception
   */
    protected void serialize(final Item it, final QueryContext qctx, final Serializer ser) throws XQException {
        opened();
        try {
