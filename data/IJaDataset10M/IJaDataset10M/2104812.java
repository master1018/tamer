...
public class WatermarkExample extends PdfPageEventHelper {
    ...
    public void onOpenDocument(PdfWriter writer, Document document) {
        ...
        try {
            ...
            image = Image.getInstance("resources/in_action/chapter10/iTextLogo.gif");
        } catch (Exception e) {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        try {
            ...
            contentunder.addImage(image, image.getWidth() * 4, 0, 0, image.getHeight() * 4, 120, 650);
            contentunder.setColorFill(color);
            contentunder.beginText();
            contentunder.setFontAndSize(helv, 48);
            contentunder.showTextAligned(Element.ALIGN_CENTER, "My Watermark Under " + writer.getPageNumber(), document.getPageSize().getWidth() / 2, document.getPageSize().getHeight() / 2, 45);
    ...
    public static void main(String[] args) {
        ...
        try {
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("results/in_action/chapter14/watermarks.pdf"));
