 ...
 *            .equals(..))
 */
public class MyScrollPane<NodeType, EdgeType> extends JScrollPane implements ListSelectionListener, PropertyChangeListener {
    ...
    @Override
    public void addPropertyChangeListener(final String str, final PropertyChangeListener l) {
    ...
    public void setNewFragmentData(final MyListModel<NodeType, EdgeType> listModel, final GraphPanel fragment) {
        ...
        if (fragment != null) {
            ...
            fragment.getComponent().setBackground(VisualisationConstants.selectedFragmentColor);
            fragment.getComponent().setPreferredSize(VisualisationConstants.cellElementDimension);
            currentSelection.setBorder(VisualisationConstants.selectedFragmentBorder);
    ...
    public void valueChanged(final ListSelectionEvent e) {
        ...
        if ((e.getValueIsAdjusting() == false) && (index >= 0)) {
            switch(tabIndex) {
                case 0:
                    this.spListeners.firePropertyChange("fragment selected", -1, index);
                    break;
                case 1:
                    this.spListeners.firePropertyChange("graph selected", -1, index);
                    break;
            }
        }
    }
