...
public final class FactorObject {
     ...
     */
    public FactorObject(byte position, float torwart, float spielaufbau, float passpiel, float fluegel, float abwehr, float torschuss, float standards) {
    ...
    public final float getSum() {
        return (m_fTorwart + m_fStandards + m_fTorschuss + m_fVerteidigung + m_fFluegelspiel + m_fPasspiel + m_fSpielaufbau);
    }
