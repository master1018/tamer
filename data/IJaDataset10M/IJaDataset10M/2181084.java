...
public class DefaultColorProvider<N> implements IColorProvider<N, Color>, Serializable {
    ...
    static {
        COLORS = new Color[] { new Color(0x9669FE), new Color(0xA27AFE), new Color(0xAD8BFE), new Color(0xB89AFE), new Color(0xC4ABFE), new Color(0xD0BCFE), new Color(0xDDCEFF), new Color(0xE6DBFF) };
    }
