...
public class CsvFlowMapGraphReader {
    ...
    protected CsvFlowMapGraphReader(FlowMapAttrSpec attrSpec, String nodesLocation, String flowsLocation, char separator, String charset) {
   ...
   */
    public static Iterable<String> readAttrNames(String csvLocation, char separator, String charset) throws IOException {
        ...
        try {
            ...
            throw new IOException("Error reading from location '" + csvLocation + "': " + ioe.getMessage(), ioe);
        } finally {
            try {
    ...
    public static FlowMapGraphBuilder readFlowMapGraph(String nodesLocation, String flowsLocation, FlowMapAttrSpec attrSpec, char separator, String charset) throws IOException {
        return new CsvFlowMapGraphReader(attrSpec, nodesLocation, flowsLocation, separator, charset).read();
    }
    ...
    private void parseCsv(String csvLocation, LineParser lp) throws IOException {
        ...
        try {
            ...
            throw new IOException("Error loading '" + csvLocation + "' (line " + lineNum + "): " + ioe.getMessage(), ioe);
        } finally {
            try {
                if (csv != null) csv.close();
            } catch (IOException ioe) {
    ...
    public static CSVReader createReader(String csvLocation, char separator, String charset) throws IOException {
        return new CSVReader(new InputStreamReader(IOUtils.asInputStream(csvLocation), charset), separator);
    }

    private Map<String, String> asAttrValuesMap(final String[] csvLine, Map<String, Integer> colsByName) {
