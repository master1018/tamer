...
public abstract class InlineValue<T> {
    ...
    public static InlineValue<Boolean> BOOLEAN_VALUE = new InlineValue<Boolean>() {
        ...
        public Boolean readFrom(JsonParser parser) throws IOException {
            ...
            if (jt == JsonToken.VALUE_FALSE) return false;
            if (jt == JsonToken.VALUE_TRUE) return true;
    ...
    public static class EnumValue<E extends EnumLite> extends InlineValue<E> {
        ...
        public static final <E extends EnumLite> EnumValue<E> create(Class<?> enumClass) {
            if (!enumClass.isEnum()) throw new RuntimeException("Not an enum class: " + enumClass);
            if (!EnumLite.class.isAssignableFrom(enumClass)) throw new RuntimeException("Enum not generated by protoc: " + enumClass);
