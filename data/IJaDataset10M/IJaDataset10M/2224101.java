...
public class MutableClassToInstanceMapTest extends TestCase {
    ...
    public static Test suite() {
        ...
        }).named("MutableClassToInstanceMap").withFeatures(MapFeature.GENERAL_PURPOSE, MapFeature.RESTRICTS_KEYS, MapFeature.ALLOWS_NULL_VALUES, CollectionSize.ANY).suppressing(remapTest).createTestSuite());
        return suite;
    }
