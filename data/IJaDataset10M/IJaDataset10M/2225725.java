...
public class HandShakeB implements BittorrentMessage {
    ...
    public HandShakeB(Hash peer_id) {
        ...
        Validator.isTrue(peer_id.getType() == Hash.Type.ID, "Expected peer id to be of type ID, but is " + peer_id.getType());
        Validator.isTrue(peer_id.getHashLength() == 20, "Expected hash length 20, but got " + peer_id.getHashLength());
