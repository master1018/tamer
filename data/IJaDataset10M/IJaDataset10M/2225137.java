...
public class SupportAndResistenceGraph extends AbstractGraph {
    ...
    public void render(Graphics g, Color c, int xoffset, int yoffset, double horizontalScale, double verticalScale, double topLineValue, double bottomLineValue, List xRange, boolean vertOrientation) {
        g.setColor(Color.green.darker());
        GraphTools.renderLine(g, support, xoffset, yoffset, horizontalScale, verticalScale, topLineValue, bottomLineValue, xRange, vertOrientation);
        g.setColor(Color.red.darker());
        GraphTools.renderLine(g, resistence, xoffset, yoffset, horizontalScale, verticalScale, topLineValue, bottomLineValue, xRange, vertOrientation);
    }
