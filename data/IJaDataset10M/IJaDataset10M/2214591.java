 ...
 * @author Antonio
 */
public class PanelSeleccionCodec extends JPanel implements ListSelectionListener, ActionListener {
    ...
    public PanelSeleccionCodec(GestorCodecsAudio gca) {
        ...
        for (int i = 0; i < codecsDisponibles.size(); i++) {
            ...
            subPanelTabla.add(new TablaPropiedadesCodec((FormatoCodecGst) this.gestorCodecsAudio.getFormatoCodec(codecsDisponibles.get(i))), gbc);
            this.panelesTablas.add(i, new JScrollPane(subPanelTabla));
        }
    ...
    public void valueChanged(ListSelectionEvent listEvent) {
        this.splitPaneCodecs.setRightComponent(this.panelesTablas.get(this.listaCodecs.getSelectedIndex()));
    }
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                try {
                    ...
                    if (duracion_us < 2000000) {
                        JOptionPane.showMessageDialog(this, "The audio file duration must be bigger than 2 seconds", "audio event", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                    ...
                    JOptionPane.showMessageDialog(this, ae.getMessage() + '\n' + ae.getCause().getMessage(), "audio event", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    }
    ...
    public FormatoCodec getFormatoCodecSeleccionado() {
        return this.gestorCodecsAudio.getFormatoCodec((String) this.listaCodecs.getSelectedValue());
    }
}
