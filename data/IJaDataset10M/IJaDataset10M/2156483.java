...
public class VIEXPopup {
    ...
    public static VIEXPopup getPopup() {
        if (viexPopup != null) return viexPopup;
        viexPopup = new VIEXPopup();
        return viexPopup;
    }

    public void setEditorComponent(JTextComponent component) {
        if (null == component) throw new NullPointerException("component can't be null");
    ...
    private Rectangle getScreenBounds() {
        if (screenBounds == null) {
            ...
            screenBounds = configuration != null ? configuration.getBounds() : new Rectangle();
        }
        return screenBounds;
    }
    ...
    private Point getOffset() {
        JTextComponent component = editorReferenceRef.get();
        if (component == null) return new Point();
    ...
    public void hide() {
        if (popup != null) {
            ...
            if (dpopup.isVisible()) dpopup.hide();
        }
    }
