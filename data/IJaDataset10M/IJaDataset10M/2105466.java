...
public class Decode {
    ...
    <T> int synth_1to1_mono(mpstr_tag mp, float[] bandPtr, int bandPos, T[] out, ProcessedBytes pnt, Factory<T> tFactory) {
        @SuppressWarnings("unchecked") T[] samples_tmp = (T[]) (new Object[64]);
        int tmp1 = 0;
        int i, ret;
    ...
    <T> int synth_1to1_mono_unclipped(mpstr_tag mp, float[] bandPtr, int bandPos, T[] out, ProcessedBytes pnt, Factory<T> tFactory) {
        @SuppressWarnings("unchecked") T[] samples_tmp = (T[]) (new Object[64]);
        int tmp1 = 0;
        int i, ret;
        ProcessedBytes pnt1 = new ProcessedBytes();
    ...
    <T> int synth_1to1(mpstr_tag mp, float[] bandPtr, int bandPos, int channel, T[] out, ProcessedBytes pnt, Factory<T> tFactory) {
        int bo;
        int samples = pnt.pb;
        float[] b0;
        int b0Pos;
    ...
    <T> int synth_1to1_unclipped(mpstr_tag mp, float[] bandPtr, int bandPos, int channel, T[] out, ProcessedBytes pnt, Factory<T> tFactory) {
        int bo;
        int samples = pnt.pb;
        float[] b0;
        int b0Pos;
