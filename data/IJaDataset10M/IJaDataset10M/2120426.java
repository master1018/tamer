...
public class DatePickerTestCase extends WiQueryTestCase {
    ...
    public void testGetDayNames() {
        ...
        assertEquals(datePicker.getDayNames().getJavascriptOption().toString(), "['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday']");
        datePicker.setDayNames(new ArrayOfDayNames("Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"));
        assertEquals(datePicker.getDayNames().getJavascriptOption().toString(), "['Su','Mo','Tu','We','Th','Fr','Sa']");
    }
    ...
    public void testGetDayNamesMin() {
        ...
        assertEquals(datePicker.getDayNamesMin().getJavascriptOption().toString(), "['Su','Mo','Tu','We','Th','Fr','Sa']");
        datePicker.setDayNamesMin(new ArrayOfDayNames("Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"));
        assertEquals(datePicker.getDayNamesMin().getJavascriptOption().toString(), "['Sun','Mon','Tue','Wed','Thu','Fri','Sat']");
    }
    ...
    public void testGetDayNamesShort() {
        ...
        assertEquals(datePicker.getDayNamesShort().getJavascriptOption().toString(), "['Sun','Mon','Tue','Wed','Thu','Fri','Sat']");
        datePicker.setDayNamesShort(new ArrayOfDayNames("Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"));
        assertEquals(datePicker.getDayNamesShort().getJavascriptOption().toString(), "['Su','Mo','Tu','We','Th','Fr','Sa']");
    }
    ...
    public void testGetDefaultDate() {
        ...
        assertEquals(datePicker.getDefaultDate().getJavascriptOption().toString(), "new Date(2009,11,1,0,0,0,0)");
    }
    ...
    public void testGetMaxDate() {
        ...
        assertEquals(datePicker.getMaxDate().getJavascriptOption().toString(), "new Date(2009,11,1,0,0,0,0)");
    }
    ...
    public void testGetMinDate() {
        ...
        assertEquals(datePicker.getMinDate().getJavascriptOption().toString(), "new Date(2009,11,1,0,0,0,0)");
    }
    ...
    public void testGetMonthNames() {
        ...
        assertEquals(datePicker.getMonthNames().getJavascriptOption().toString(), "['January','February','March','April','May','June','July','August','September','October','November','December']");
        datePicker.setMonthNames(new ArrayOfMonthNames("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"));
        assertEquals(datePicker.getMonthNames().getJavascriptOption().toString(), "['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec']");
    }
    ...
    public void testGetMonthNamesShort() {
        ...
        assertEquals(datePicker.getMonthNamesShort().getJavascriptOption().toString(), "['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec']");
        datePicker.setMonthNamesShort(new ArrayOfMonthNames("Ja", "Fe", "Ma", "Ap", "Ma", "Ju", "Ju", "Au", "Se", "Oc", "No", "De"));
        assertEquals(datePicker.getMonthNamesShort().getJavascriptOption().toString(), "['Ja','Fe','Ma','Ap','Ma','Ju','Ju','Au','Se','Oc','No','De']");
    }
    ...
    public void testGetOptions() {
        ...
        assertEquals(datePicker.getOptions().getJavaScriptOptions().toString(), "{altField: 'alt label'}");
    }
    ...
    public void testHideShort() {
        ...
        assertEquals(datePicker.hide(new Short("5")).render().toString(), "$('#anId').datepicker('hide', 5);");
    }
    ...
    public void testSetBeforeShowDayEvent() {
        ...
        assertEquals(datePicker.statement().render().toString(), "$('#anId').datepicker({beforeShowDay: function(date) {\n\talert('event');\n}});");
    }
    ...
    public void testSetBeforeShowEvent() {
        ...
        assertEquals(datePicker.statement().render().toString(), "$('#anId').datepicker({beforeShow: function(event, ui) {\n\talert('event');\n}});");
    }
    ...
    public void testSetDateDateOption() {
        assertNotNull(datePicker.setDate(new DateOption(new GregorianCalendar(2009, 11, 1).getTime())));
        assertEquals(datePicker.setDate(new DateOption(new GregorianCalendar(2009, 11, 1).getTime())).render().toString(), "$('#anId').datepicker('setDate', new Date(2009,11,1,0,0,0,0));");
    }
    ...
    public void testSetOnChangeMonthYearEvent() {
        ...
        assertEquals(datePicker.statement().render().toString(), "$('#anId').datepicker({onChangeMonthYear: function(year, month, inst) {\n\talert('event');\n}});");
    }
    ...
    public void testSetOnCloseEvent() {
        ...
        assertEquals(datePicker.statement().render().toString(), "$('#anId').datepicker({onClose: function(dateText, inst) {\n\talert('event');\n}});");
    }
    ...
    public void testSetOnSelectEvent() {
        ...
        assertEquals(datePicker.statement().render().toString(), "$('#anId').datepicker({onSelect: function(dateText, inst) {\n\talert('event');\n}});");
    }
