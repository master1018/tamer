...
public class TimeoutManager {
    ...
    public TimeoutManager(ScheduledThreadPoolExecutor executor, long commandTimeout) {
    ...
    public void addCommand(Command command) {
        ...
        synchronized (timeoutFutureMap) {
            ScheduledFuture<TimeoutTask> future = (ScheduledFuture<TimeoutTask>) executor.schedule(timeoutTask, commandTimeout, TimeUnit.MILLISECONDS);
