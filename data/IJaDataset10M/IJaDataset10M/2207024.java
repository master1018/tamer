...
public class ParameterComposite extends Composite {
    ...
    class ParameterContentProvider implements IStructuredContentProvider {
        ...
        public Object[] getElements(Object inputElement) {
            if (inputElement instanceof List) {
                return ((List) inputElement).toArray(new Parameter[((List) inputElement).size()]);
            }
            return null;
        }
    }

    class ParameterLabelProvider extends BaseLabelProvider implements ITableLabelProvider, ITableColorProvider {
        ...
        public Color getForeground(Object element, int columnIndex) {
            if (columnIndex == columnNumIndx) return new Color(null, 128, 128, 128);
            return null;
        }
    ...
    private void createControl() {
        ...
        paraViewer = new TableViewer(this, SWT.BORDER | SWT.FULL_SELECTION | SWT.SINGLE);
        ...
        add.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ParameterDialog pd = new ParameterDialog(getShell(), getContainers(), null, context);
                int open = pd.open();
        ...
        edit.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ParameterDialog pd = new ParameterDialog(getShell(), getContainers(), c_parameter, context);
                int open = pd.open();
                if (open == ParameterDialog.OK) {
                    Parameter parameter = pd.getParameter();
        ...
        paraViewer.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                ...
                if (s instanceof IStructuredSelection) {
                    ...
                    @SuppressWarnings("unchecked") List<Parameter> list = ss.toList();
