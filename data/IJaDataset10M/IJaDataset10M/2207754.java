...
import openjmx.log.Logger;
import openjmx.log.Log;
...
public class SMTP implements SMTPMBean, NotificationListener, MBeanRegistration {
    ...
    private Logger log = Log.getLogger("openjmx.tools.mail.SMTP");
    ...
    private String fromName = "OpenJMX default";
    ...
    public void handleNotification(Notification notification, Object handback) {
        if (notificationName != null && !notification.getType().equals(notificationName)) {
            return;
        }
    ...
    public ObjectName preRegister(MBeanServer server, ObjectName name) throws java.lang.Exception {
        this.server = server;
        log = Log.getLogger(name.toString());
