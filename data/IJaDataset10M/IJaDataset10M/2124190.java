 ...
 * @version $Id: ServerController.java 5313 2006-12-06 12:14:27Z cwilper $
 */
public class ServerController extends HttpServlet {
    ...
    private File getFedoraHomeDir() throws ServletException {
        ...
        if (fedoraHome == null) {
            failStartup("Neither the FEDORA_HOME environment variable, " + "nor the fedora.home system property was set", null);
        }
        File fedoraHomeDir = new File(fedoraHome);
        if (!fedoraHomeDir.isDirectory()) {
            failStartup("The FEDORA_HOME directory, " + fedoraHomeDir.getPath() + " does not exist", null);
        }
