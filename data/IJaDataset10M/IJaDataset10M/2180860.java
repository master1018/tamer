...
public class SslConfig extends AbstractConfig {
   ...
   */
    public boolean isEmpty() {
        return credentialConfig == null && trustManagers == null && enabledCipherSuites == null && enabledProtocols == null && handshakeCompletedListeners == null;
    }
   ...
   */
    ...
    public String toString() {
        return String.format("[%s@%d::credentialConfig=%s, trustManagers=%s, " + "enabledCipherSuites=%s, enabledProtocols=%s, " + "handshakeCompletedListeners=%s]", getClass().getName(), hashCode(), credentialConfig, Arrays.toString(trustManagers), Arrays.toString(enabledCipherSuites), Arrays.toString(enabledProtocols), Arrays.toString(handshakeCompletedListeners));
    }
}
