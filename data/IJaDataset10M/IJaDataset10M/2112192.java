...
public class DbExport {
    ...
    public enum Compatible {
        ...
        DB2, DERBY, FIREBIRD, H2, HSQLDB, HSQLDB2, INFORMIX, INTERBASE, MSSQL, MYSQL, ORACLE, POSTGRESQL, SYBASE
    }
    ...
    public void exportTables(OutputStream output, String[] tableNames) throws IOException {
        ...
        for (String tableName : tableNames) {
            ...
            if (table != null) {
                ...
                throw new RuntimeException("Cannot find table " + tableName + " in catalog " + catalog + " and schema " + schema);
            }
        }
