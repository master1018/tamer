...
public interface ICompositeCurve extends IComposite, IOrientableCurve {
   ...
   * cas de problème.
   */
    public abstract void addGenerator(IOrientableCurve value, double tolerance) throws Exception;
   ...
   */
    public abstract void addGeneratorTry(IOrientableCurve value, double tolerance) throws Exception;
