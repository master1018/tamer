...
public abstract class FeatureImpl extends ModelElementImpl implements Feature {
    ...
    public void setOwnerScope(ScopeKind newOwnerScope) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.FEATURE__OWNER_SCOPE, oldOwnerScope, ownerScope));
    }
    ...
    public void setOwner(Classifier newOwner) {
        if (newOwner != eInternalContainer() || (eContainerFeatureID() != CorePackage.FEATURE__OWNER && newOwner != null)) {
            ...
            if (newOwner != null) msgs = ((InternalEObject) newOwner).eInverseAdd(this, CorePackage.CLASSIFIER__FEATURE, Classifier.class, msgs);
            msgs = basicSetOwner(newOwner, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.FEATURE__OWNER, newOwner, newOwner));
    }
