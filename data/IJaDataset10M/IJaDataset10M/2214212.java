...
public final class AnnotationTextEdit extends UndoableEdit {
    ...
    public AnnotationTextEdit(AnnotationNote _annotationNote, String _oldText, String _newText) {
    ...
    public String toString() {
        return super.toString() + " " + annotationNote.getClass().getSimpleName() + "oldText: " + oldText + "newText: " + newText;
    }
}
