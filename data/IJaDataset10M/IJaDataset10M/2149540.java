 ...
 * @since 1.0
 * @version $Id: Integer64Gene.java 1431 2012-04-18 19:43:17Z fwilhelm $
 */
public final class Integer64Gene extends NumberGene<Integer64, Integer64Gene> {
	 ...
	 */
    public static final Function<Integer64Gene, Integer64> Allele = new Function<Integer64Gene, Integer64>() {

        @Override
        public Integer64 apply(final Integer64Gene value) {
            return value._value;
        }
    };
	 ...
	 */
    public static final Function<Integer64Gene, Integer64> Min = new Function<Integer64Gene, Integer64>() {
	 ...
	 * Converter for accessing the allowed minimum from a given number gene.
	 */
    public static final Function<Integer64Gene, Integer64> Max = new Function<Integer64Gene, Integer64>() {
    ...
    private static final ObjectFactory<Integer64Gene> FACTORY = new ObjectFactory<Integer64Gene>() {

        @Override
        protected Integer64Gene create() {
	 ...
	 */
    public static Integer64Gene valueOf(final long value, final long min, final long max) {
        return valueOf(Integer64.valueOf(value), Integer64.valueOf(min), Integer64.valueOf(max));
    }
	 ...
	 */
    public static Integer64Gene valueOf(final Integer64 value, final Integer64 min, final Integer64 max) {
    ...
    public static Integer64Gene valueOf(final Integer64 min, final Integer64 max) {
        ...
        final Integer64 value = Integer64.valueOf(nextLong(random, min.longValue(), max.longValue()));
        return valueOf(value, min, max);
    }

    static final XMLFormat<Integer64Gene> XML = new XMLFormat<Integer64Gene>(Integer64Gene.class) {
        ...
        @Override
        public Integer64Gene newInstance(final Class<Integer64Gene> cls, final InputElement element) throws XMLStreamException {
        ...
        @Override
        public void write(final Integer64Gene gene, final OutputElement element) throws XMLStreamException {
        ...
        @Override
        public void read(final InputElement element, final Integer64Gene gene) throws XMLStreamException {
        }
    };
    ...
    private void readObject(final ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        set(Integer64.valueOf(in.readLong()), Integer64.valueOf(in.readLong()), Integer64.valueOf(in.readLong()));
    }
}
