...
public class UserRatingType extends AbstractType {
    ...
    private static final String[] SOL_EVALUATIONS_VALUES = { SOL_STATE_CONFIRMED, SOL_STATE_CONFIRMED_GER, SOL_STATE_REJECTED, SOL_STATE_REJECTED_GER };
    ...
    public static UserEvaluation getUserEvaluationType(Section<UserRatingType> s) {
        ...
        if (trim.equalsIgnoreCase(SOL_STATE_CONFIRMED) || trim.equalsIgnoreCase(SOL_STATE_CONFIRMED_GER)) {
            return UserEvaluation.CONFIRMED;
        } else if (trim.equalsIgnoreCase(SOL_STATE_REJECTED) || trim.equalsIgnoreCase(SOL_STATE_REJECTED_GER)) {
