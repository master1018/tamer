 ...
 * @generated
 */
public class SystemCreateShortcutDecorationsCommand extends AbstractTransactionalCommand {
	 ...
	 * @generated
	 */
    public SystemCreateShortcutDecorationsCommand(TransactionalEditingDomain editingDomain, View parentView, List viewDescriptors) {
	 ...
	 * @generated
	 */
    public SystemCreateShortcutDecorationsCommand(TransactionalEditingDomain editingDomain, View parentView, CreateViewRequest.ViewDescriptor viewDescriptor) {
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
        for (Iterator it = myDescriptors.iterator(); it.hasNext(); ) {
            ...
            if (view != null && view.getEAnnotation("Shortcut") == null) {
                ...
                shortcutAnnotation.getDetails().put("modelID", SystemEditPart.MODEL_ID);
