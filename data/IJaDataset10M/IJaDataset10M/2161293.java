...
public class JEMonitor extends JEMBean implements DynamicMBean {
    ...
    private static final MBeanAttributeInfo[] COMMON_ATTR = { new MBeanAttributeInfo(ATT_ENV_HOME, "java.lang.String", "Environment home directory.", true, false, false) };
    ...
    private static final MBeanOperationInfo OP_CLEAN_INFO = new MBeanOperationInfo(OP_CLEAN, "Remove obsolete environment log files. Zero or more log files " + "will be cleaned as necessary to bring the disk space utilization " + "of the environment above the configured minimum utilization " + "threshold as determined by the setting je.cleaner.minUtilization. " + "Returns the number of files cleaned. These will be deleted at the " + "next qualifying checkpoint.", new MBeanParameterInfo[0], "java.lang.Integer", MBeanOperationInfo.UNKNOWN);

    private static final MBeanOperationInfo OP_EVICT_INFO = new MBeanOperationInfo(OP_EVICT, "Reduce cache usage to the threshold determined by the setting " + "je.evictor.useMemoryFloor. ", new MBeanParameterInfo[0], "void", MBeanOperationInfo.UNKNOWN);
    ...
    private static final MBeanOperationInfo OP_CHECKPOINT_INFO = new MBeanOperationInfo(OP_CHECKPOINT, "Checkpoint the environment.", checkpointParams, "void", MBeanOperationInfo.UNKNOWN);

    private static final MBeanOperationInfo OP_SYNC_INFO = new MBeanOperationInfo(OP_SYNC, "Flush the environment to stable storage.", new MBeanParameterInfo[0], "void", MBeanOperationInfo.UNKNOWN);

    private static final MBeanOperationInfo OP_ENV_STAT_INFO = new MBeanOperationInfo(OP_ENV_STAT, "Get environment statistics.", statParams, "java.lang.String", MBeanOperationInfo.INFO);

    private static final MBeanOperationInfo OP_TXN_STAT_INFO = new MBeanOperationInfo(OP_TXN_STAT, "Get transactional statistics.", statParams, "java.lang.String", MBeanOperationInfo.INFO);

    private static final MBeanOperationInfo OP_DB_NAMES_INFO = new MBeanOperationInfo(OP_DB_NAMES, "Get the names of databases in the environment.", new MBeanParameterInfo[0], "java.util.ArrayList", MBeanOperationInfo.INFO);
    ...
    private static final MBeanOperationInfo OP_DB_STAT_INFO = new MBeanOperationInfo(OP_DB_STAT, "Get database statistics.", dbStatParams, "java.lang.String", MBeanOperationInfo.INFO);

    private static final MBeanOperationInfo OP_ENV_CONFIG_INFO = new MBeanOperationInfo(OP_ENV_CONFIG, "Get environment configuration.", new MBeanParameterInfo[0], "java.lang.String", MBeanOperationInfo.INFO);
