...
public class BooleanExprFactory extends QueryModelVisitorBase<UnsupportedRdbmsOperatorException> {
    ...
    public SqlExpr createBooleanExpr(ValueExpr expr) throws UnsupportedRdbmsOperatorException {
        result = null;
        if (expr == null) return new SqlNull();
        expr.visit(this);
        if (result == null) return new SqlNull();
        return result;
    }
    ...
    protected SqlExpr point(ValueExpr arg) throws UnsupportedRdbmsOperatorException {
    ...
    private SqlExpr boxContains(FunctionCall functionCall) throws UnsupportedRdbmsOperatorException {
        ...
        if (!(args.size() >= 3 && args.get(0) instanceof ValueConstant && args.get(1) instanceof ValueConstant && args.get(2) instanceof Var)) throw unsupported(functionCall);
