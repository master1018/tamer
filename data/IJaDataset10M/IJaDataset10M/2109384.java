...
public class ShaderAttributeSet extends NodeComponent {
     ...
     * its attributes.
     */
    public static final int ALLOW_ATTRIBUTES_READ = CapabilityBits.SHADER_ATTRIBUTE_SET_ALLOW_ATTRIBUTES_READ;

    /**
     * Specifies that this ShaderAttributeSet object allows writing
     * its attributes.
     */
    public static final int ALLOW_ATTRIBUTES_WRITE = CapabilityBits.SHADER_ATTRIBUTE_SET_ALLOW_ATTRIBUTES_WRITE;

    private static final int[] readCapabilities = { ALLOW_ATTRIBUTES_READ };
    ...
    public void put(ShaderAttribute attr) {
        ...
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_ATTRIBUTES_WRITE)) throw new CapabilityNotSetException(J3dI18N.getString("ShaderAttributeSet1"));
    ...
    public ShaderAttribute get(String attrName) {
        ...
        if (isLiveOrCompiled()) if (!this.getCapability(ALLOW_ATTRIBUTES_READ)) throw new CapabilityNotSetException(J3dI18N.getString("ShaderAttributeSet0"));
