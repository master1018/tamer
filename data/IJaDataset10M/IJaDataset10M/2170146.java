...
public class LocalAnnotationSetImpl implements MutableAnnotationSet.Local {
   ...
   */
    ...
    @Override
    @Deprecated
    public void resetAnnotationsInRange(int rangeStart, int rangeEnd, String key, List<RangedValue<Object>> values) {
    ...
    @Override
    public Iterable<AnnotationInterval<Object>> annotationIntervals(int start, int end, ReadableStringSet keys) {
        return fullAnnotationSet.annotationIntervals(start, end, keys);
    }

    @Override
    public Iterable<RangedAnnotation<Object>> rangedAnnotations(int start, int end, ReadableStringSet keys) {
