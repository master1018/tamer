...
public class IndoorFace {
    ...
    private static final int FACET_NORMAL_X_FIXED_POINT_OFFSET_MM6 = 0;

    private static final int FACET_NORMAL_Y_FIXED_POINT_OFFSET_MM6 = 4;

    private static final int FACET_NORMAL_Z_FIXED_POINT_OFFSET_MM6 = 8;

    private static final int FACET_NORMAL_DISTANCE_FIXED_POINT_OFFSET_MM6 = 12;

    private static final int Z_CALC_1_OFFSET_MM6 = 16;

    private static final int Z_CALC_2_OFFSET_MM6 = 20;

    private static final int Z_CALC_3_OFFSET_MM6 = 24;

    private static final int ATTRIBUTES_OFFSET_MM6 = 28;

    private static final int VERTEX_INDEX_OFFSET_OFFSET_MM6 = 32;

    private static final int X_DISPLACEMENT_OFFSET_OFFSET_MM6 = 36;

    private static final int Y_DISPLACEMENT_OFFSET_OFFSET_MM6 = 40;

    private static final int Z_DISPLACEMENT_OFFSET_OFFSET_MM6 = 44;

    private static final int U_TEXTURE_OFFSET_OFFSET_MM6 = 48;

    private static final int V_TEXTURE_OFFSET_OFFSET_MM6 = 52;

    private static final int DATA_INDEX_OFFSET_MM6 = 56;

    private static final int BITMAP_INDEX_OFFSET_MM6 = 58;

    private static final int ROOM_NUMBER_OFFSET_MM6 = 60;

    private static final int ROOM_NUMBER_BEHIND_FACET_OFFSET_MM6 = 62;

    private static final int BOUNDING_BOX_MIN_X_OFFSET_MM6 = 64;

    private static final int BOUNDING_BOX_MAX_X_OFFSET_MM6 = 66;

    private static final int BOUNDING_BOX_MIN_Y_OFFSET_MM6 = 68;

    private static final int BOUNDING_BOX_MAX_Y_OFFSET_MM6 = 70;

    private static final int BOUNDING_BOX_MIN_Z_OFFSET_MM6 = 72;

    private static final int BOUNDING_BOX_MAX_Z_OFFSET_MM6 = 74;

    private static final int FACET_TYPE_OFFSET_MM6 = 76;

    private static final int NUMBER_OF_VERTEXES_OFFSET_MM6 = 77;

    private static final int PADDING_OFFSET_MM6 = 78;

    private static final int FACET_NORMAL_X_FLOAT_OFFSET_MM7 = 0;

    private static final int FACET_NORMAL_Y_FLOAT_OFFSET_MM7 = 4;

    private static final int FACET_NORMAL_Z_FLOAT_OFFSET_MM7 = 8;

    private static final int FACET_NORMAL_DISTANCE_FLOAT_OFFSET_MM7 = 12;

    private static final int FACET_NORMAL_X_FIXED_POINT_OFFSET_MM7 = 16;

    private static final int FACET_NORMAL_Y_FIXED_POINT_OFFSET_MM7 = 20;

    private static final int FACET_NORMAL_Z_FIXED_POINT_OFFSET_MM7 = 24;

    private static final int FACET_NORMAL_DISTANCE_FIXED_POINT_OFFSET_MM7 = 28;

    private static final int Z_CALC_1_OFFSET_MM7 = 32;

    private static final int Z_CALC_2_OFFSET_MM7 = 36;

    private static final int Z_CALC_3_OFFSET_MM7 = 40;

    private static final int ATTRIBUTES_OFFSET_MM7 = 44;

    private static final int VERTEX_INDEX_OFFSET_OFFSET_MM7 = 48;

    private static final int X_DISPLACEMENT_OFFSET_OFFSET_MM7 = 52;

    private static final int Y_DISPLACEMENT_OFFSET_OFFSET_MM7 = 56;

    private static final int Z_DISPLACEMENT_OFFSET_OFFSET_MM7 = 60;

    private static final int U_TEXTURE_OFFSET_OFFSET_MM7 = 64;

    private static final int V_TEXTURE_OFFSET_OFFSET_MM7 = 68;

    private static final int DATA_INDEX_OFFSET_MM7 = 72;

    private static final int BITMAP_INDEX_OFFSET_MM7 = 74;

    private static final int ROOM_NUMBER_OFFSET_MM7 = 76;

    private static final int ROOM_NUMBER_BEHIND_FACET_OFFSET_MM7 = 78;

    private static final int BOUNDING_BOX_MIN_X_OFFSET_MM7 = 80;

    private static final int BOUNDING_BOX_MAX_X_OFFSET_MM7 = 82;

    private static final int BOUNDING_BOX_MIN_Y_OFFSET_MM7 = 84;

    private static final int BOUNDING_BOX_MAX_Y_OFFSET_MM7 = 86;

    private static final int BOUNDING_BOX_MIN_Z_OFFSET_MM7 = 88;

    private static final int BOUNDING_BOX_MAX_Z_OFFSET_MM7 = 90;

    private static final int FACET_TYPE_OFFSET_MM7 = 92;

    private static final int NUMBER_OF_VERTEXES_OFFSET_MM7 = 93;

    private static final int PADDING_OFFSET_MM7 = 94;
    ...
    public IndoorFace(int gameVersion) {
        ...
        if (GameVersion.MM6 == gameVersion) this.facetData = new byte[FACE_RECORD_LENGTH_MM6]; else this.facetData = new byte[FACE_RECORD_LENGTH_MM7];
    }
    ...
    public int getVertexCount() {
        if (GameVersion.MM6 == gameVersion) return ByteConversions.convertByteToInt(this.facetData[NUMBER_OF_VERTEXES_OFFSET_MM6]); else return ByteConversions.convertByteToInt(this.facetData[NUMBER_OF_VERTEXES_OFFSET_MM7]);
    }
    ...
    public static int computeDataSize(int gameVersion, byte[] data, int offset, int variableFacetDataSize) {
        int faceCount = ByteConversions.getIntegerInByteArrayAtPosition(data, offset);
        offset += 4;
        if (GameVersion.MM6 == gameVersion) offset += faceCount * FACE_RECORD_LENGTH_MM6; else offset += faceCount * FACE_RECORD_LENGTH_MM7;
        offset += variableFacetDataSize;
    ...
    public int getRecordSize() {
        return facetData.length + vertexIndexArray.length + xDisplacementArray.length + yDisplacementArray.length + zDisplacementArray.length + uTextureArray.length + vTextureArray.length + FACES_BITMAP_NAME_LENGTH;
    }
