...
public class KeyrefPaserTest {
    ...
    private static final File resourceDir = new File("test-stub", KeyrefPaserTest.class.getSimpleName());
    ...
    private static final Content content = new ContentImpl();
    ...
    public void testTopicWrite() throws Exception {
        ...
        assertXMLEqual(new InputSource(new File(expDir, "a.xml").toURI().toString()), new InputSource(new File(tempDir, "a.xml").toURI().toString()));
    }
    ...
    public void testMapWrite() throws Exception {
        ...
        assertXMLEqual(new InputSource(new File(expDir, "b.ditamap").toURI().toString()), new InputSource(new File(tempDir, "b.ditamap").toURI().toString()));
    }
