package com.kenmccrary.jtella.subnet;
...
public class SubNetGNUTellaConnection extends GNUTellaConnection {
	 ...
	 */
    public SearchSession createSubNetSearchSession(String query, int queryType, String subNetId, int maxResults, int minSpeed, MessageReceiver receiver) {
        return new SubNetSearchSession(query, queryType, subNetId, maxResults, minSpeed, this, getRouter(), receiver);
    }
}
