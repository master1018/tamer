...
public class AvoidDuplicateLiteralsRule extends AbstractJavaRule {
    ...
    public static final CharacterProperty SEPARATOR_DESCRIPTOR = new CharacterProperty("separator", "Ignore list separator", ',', 4.0f);
    ...
    private void processResults(Object data) {
        ...
        for (Map.Entry<String, List<ASTLiteral>> entry : literals.entrySet()) {
            ...
            if (occurrences.size() >= threshold) {
                Object[] args = new Object[] { entry.getKey(), Integer.valueOf(occurrences.size()), Integer.valueOf(occurrences.get(0).getBeginLine()) };
