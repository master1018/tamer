...
/**
 * This is a default implementation of the IFC object IfcElectricApplianceType<br><br>
 * 
 ...
 **/
public class IfcElectricApplianceType extends IfcFlowTerminalType implements IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcGloballyUniqueId", "IfcOwnerHistory", "IfcLabel", "IfcText", "IfcLabel", "SET<IfcPropertySetDefinition>", "LIST<IfcRepresentationMap>", "IfcLabel", "IfcLabel", "IfcElectricApplianceTypeEnum" };
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("PredefinedType")) stepString = stepString.concat("*);"); else {
            if (this.PredefinedType != null) stepString = stepString.concat(((IfcRootInterface) this.PredefinedType).getStepParameter(IfcElectricApplianceTypeEnum.class.isInterface()) + ");"); else stepString = stepString.concat("$);");
        }
        return stepString;
    }
    ...
    public Object clone() {
        ...
        if (this.GlobalId != null) ifcElectricApplianceType.setGlobalId((IfcGloballyUniqueId) this.GlobalId.clone());
        if (this.OwnerHistory != null) ifcElectricApplianceType.setOwnerHistory((IfcOwnerHistory) this.OwnerHistory.clone());
        if (this.Name != null) ifcElectricApplianceType.setName((IfcLabel) this.Name.clone());
        if (this.Description != null) ifcElectricApplianceType.setDescription((IfcText) this.Description.clone());
        if (this.ApplicableOccurrence != null) ifcElectricApplianceType.setApplicableOccurrence((IfcLabel) this.ApplicableOccurrence.clone());
        if (this.HasPropertySets != null) ifcElectricApplianceType.setHasPropertySets((SET<IfcPropertySetDefinition>) this.HasPropertySets.clone());
        if (this.RepresentationMaps != null) ifcElectricApplianceType.setRepresentationMaps((LIST<IfcRepresentationMap>) this.RepresentationMaps.clone());
        if (this.Tag != null) ifcElectricApplianceType.setTag((IfcLabel) this.Tag.clone());
        if (this.ElementType != null) ifcElectricApplianceType.setElementType((IfcLabel) this.ElementType.clone());
        if (this.PredefinedType != null) ifcElectricApplianceType.setPredefinedType((IfcElectricApplianceTypeEnum) this.PredefinedType.clone());
    ...
    public Object shallowCopy() {
        IfcElectricApplianceType ifcElectricApplianceType = new IfcElectricApplianceType();
        if (this.GlobalId != null) ifcElectricApplianceType.setGlobalId(this.GlobalId);
        if (this.OwnerHistory != null) ifcElectricApplianceType.setOwnerHistory(this.OwnerHistory);
        if (this.Name != null) ifcElectricApplianceType.setName(this.Name);
        if (this.Description != null) ifcElectricApplianceType.setDescription(this.Description);
        if (this.ApplicableOccurrence != null) ifcElectricApplianceType.setApplicableOccurrence(this.ApplicableOccurrence);
        if (this.HasPropertySets != null) ifcElectricApplianceType.setHasPropertySets(this.HasPropertySets);
        if (this.RepresentationMaps != null) ifcElectricApplianceType.setRepresentationMaps(this.RepresentationMaps);
        if (this.Tag != null) ifcElectricApplianceType.setTag(this.Tag);
        if (this.ElementType != null) ifcElectricApplianceType.setElementType(this.ElementType);
        if (this.PredefinedType != null) ifcElectricApplianceType.setPredefinedType(this.PredefinedType);
        return ifcElectricApplianceType;
    }
