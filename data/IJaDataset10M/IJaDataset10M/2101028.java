...
public class JsoDevirtualizerTest extends OptimizerTestBase {
   ...
   */
    public void testDualJsoImpl() throws UnableToCompleteException {
        ...
        addSnippetClassDecl("interface Iface1 { int a(); }", "static class J1 implements Iface1 {", "  public int a() { return 1; }", "}", "static class Jso1 extends JavaScriptObject implements Iface1 {", "  protected Jso1() { }", "  public final int a() { return 2; }", "  public static native Jso1 create() /*-{ return {} }-*/;", "}", "static interface Iface2 { int a(); }", "static class J2 implements Iface2 {", "  public int a() { return 3; }", "}", "static class Jso2 extends JavaScriptObject implements Iface2 {", "  protected Jso2() { }", "  public final int a() { return 4; }", "  public static native Jso2 create() /*-{ return {} }-*/;", "}", "static Iface1 val1 = new J1();", "static Iface1 val2 = Jso1.create();", "static Iface2 val3 = new J2();", "static Iface2 val4 = Jso2.create();");
