...
public abstract class BaseIvyTestCase extends BaseTestCase {
   ...
   */
    private int getAntMessageOutputLevel() {
        String logLevelString = TestProperties.getInstance().getProperty(TestProperties.PROPERTY_ANT_MESSAGE_OUTPUT_LEVEL, MSG_DEBUG).trim();
        ...
        if (MSG_DEBUG.equals(logLevelString)) {
            ...
            System.err.println("Undefined value for " + TestProperties.PROPERTY_ANT_MESSAGE_OUTPUT_LEVEL + " '" + logLevelString + "' " + MSG_DEBUG + " will be used.");
        }
        return logLevel;
    }
   ...
   * @throws IOException If an error occurs writing the file contents to a File to be published.
   */
    protected void publish(File ivySettingsFile, String artifactFileContents, String revision, Boolean overwrite) throws IOException {
