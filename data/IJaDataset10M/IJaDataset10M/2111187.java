...
public class ObjectFactory {
    ...
    private static final QName _DocumentoRDSIdioma_QNAME = new QName("", "idioma");

    private static final QName _DocumentoRDSUsuarioSeycon_QNAME = new QName("", "usuarioSeycon");

    private static final QName _DocumentoRDSUrlVerificacion_QNAME = new QName("", "urlVerificacion");

    private static final QName _DocumentoRDSNif_QNAME = new QName("", "nif");

    private static final QName _DocumentoRDSReferenciaRDS_QNAME = new QName("", "referenciaRDS");

    private static final QName _DocumentoRDSFechaRDS_QNAME = new QName("", "fechaRDS");

    private static final QName _DocumentoRDSHashFichero_QNAME = new QName("", "hashFichero");

    private static final QName _DocumentoRDSReferenciaGestorDocumental_QNAME = new QName("", "referenciaGestorDocumental");

    private static final QName _DocumentoRDSFirmas_QNAME = new QName("", "firmas");

    private static final QName _DocumentoRDSEstructurado_QNAME = new QName("", "estructurado");

    private static final QName _DocumentoRDSCodigoDocumentoCustodia_QNAME = new QName("", "codigoDocumentoCustodia");

    private static final QName _DocumentoRDSPlantilla_QNAME = new QName("", "plantilla");

    private static final QName _FirmaWSFormato_QNAME = new QName("", "formato");

    private static final QName _Fault_QNAME = new QName("urn:es:caib:redose:ws:v2:model:BackofficeFacade", "fault");
