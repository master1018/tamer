...
public class ShelterShapeGenerator {
    ...
    private static final Logger log = Logger.getLogger(ShelterShapeGenerator.class);
    ...
    public ShelterShapeGenerator(String popBase, String quakeProof, String livingSpace, String out) {
