...
public class DistributionsTest extends EvalTestCase {
    ...
    public void norm() throws MathException {
        assertThat(Distributions.dnorm(0, 0, 1, false), closeTo(0.3989423, ERROR));
        assertThat(Distributions.dnorm(0, 0, 1, true), closeTo(-0.9189385, ERROR));
        assertThat(Distributions.pnorm(0.25, 0, 1, true, false), closeTo(0.5987063, ERROR));
        assertThat(Distributions.pnorm(0.25, 0, 1, false, false), closeTo(0.4012937, ERROR));
        assertThat(Distributions.pnorm(0.25, 0, 1, true, true), closeTo(-0.5129841, ERROR));
        assertThat(Distributions.pnorm(0.25, 0, 1, false, true), closeTo(-0.9130618, ERROR));
        assertThat(Distributions.qnorm(0.25, 0, 1, true, false), closeTo(-0.6744898, ERROR));
        assertThat(Distributions.qnorm(0.25, 0, 1, false, false), closeTo(0.6744898, ERROR));
        assertThat(Distributions.qnorm(0.99, 0, 1, false, false), closeTo(-2.326348, ERROR));
        assertThat(Distributions.qnorm(0.99, 0, 1, false, true), equalTo(Double.NaN));
        assertThat(Distributions.qnorm(0, 0, 1, true, false), equalTo(Double.NEGATIVE_INFINITY));
    }
    ...
    public void QLogNormal() {
        assertThat(Distributions.qlnorm(0.95, 0, 1, true, false), closeTo(5.180252, ERROR));
        assertThat(Distributions.qlnorm(0.68, 0, 1, false, false), closeTo(0.6264422, ERROR));
    }

    @Test
    public void PLogNormal() {
        assertThat(Distributions.plnorm(1.96, 0, 1, true, false), closeTo(0.7495087, ERROR));
        assertThat(Distributions.plnorm(2.55, 0, 1, false, false), closeTo(0.1746126, ERROR));
    }

    @Test
    public void DLogNormal() {
        assertThat(Distributions.dlnorm(1.96, 0, 1, false), closeTo(0.1622998, ERROR));
        assertThat(Distributions.dlnorm(2.55, 0, 1, true), closeTo(-2.293167, ERROR));
    }
