 ...
 */
public interface NetBroker extends Runnable {
    ...
    public static enum EventType {
		 ...
		 */
        DATA_DONE, /**
		 * Fired when an old connection's input stream terminates abnormally.
		 * Only assured to fire if the stream is done but the connection is not.
		 */
        DATA_INPUT_FAILED, /**
		 * Fired when an old connection's input stream terminates, for whatever
		 * reason. Only assured to fire if the stream is done but the connection
		 * is not.
		 */
        DATA_INPUT_DONE, /**
		 * Fired when an old connection's output stream terminates abnormally.
		 * Only assured to fire if the stream is done but the connection is not.
		 */
        DATA_OUTPUT_FAILED, /**
		 * Fired when an old connection's output stream terminates, for whatever
		 * reason. Only assured to fire if the stream is done but the connection
		 * is not.
		 */
        DATA_OUTPUT_DONE, /**
