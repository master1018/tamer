...
public interface ReportLayoutRenderer {
	 ...
	 */
    public RenderedReportLayout renderReport(PersistenceManager pm, RenderReportRequest renderRequest, IRunAndRenderTask task, String fileName, File layoutRoot, boolean prepareResultForTransfer) throws EngineException;
}
