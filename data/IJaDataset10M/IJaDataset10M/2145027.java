package org.kwantu.zakwantu.suckerfish;
...
public class SuckerfishMenuPanel extends Panel {
    ...
    public static class MenuItem implements Serializable {
        ...
        private final AjaxSubmitLink link;

        private final Label label;

        private final List<MenuItem> subMenuItems = new ArrayList<MenuItem>();

        public MenuItem(final AjaxSubmitLink link, final String strLabel) {
    ...
    private final class LinkFragment extends Fragment {
        ...
        public LinkFragment(final AjaxSubmitLink link) {
