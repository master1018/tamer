...
public final class ICMSInterImplTest {
    ...
    public void testICMSInterInterface() {
        ICMSSobreOperacoesInterestaduais iCMSInter = new ICMSSobreOperacoesInterestaduaisImpl().withValorDaBaseDeCalculoDoICMSSubstituicaoTributariaDoDestino(new BigDecimal("1")).withValorDoICMSSubstituicaoTributariaDoDestino(new BigDecimal("1"));
