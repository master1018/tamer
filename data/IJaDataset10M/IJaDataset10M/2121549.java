...
public class Types {
    ...
    public static boolean canWiden(String desiredType, Class actualType) {
        ...
        boolean actualFloat = actualType.equals(Float.class) || actualType.equals(Double.class);
    ...
    public static boolean canWiden(String desiredType, Type actualType) {
        ...
        boolean desiredInt = dc == 'B' || dc == 'S' || dc == 'I' || dc == 'J';
        boolean actualFloat = actualType instanceof FloatType || actualType instanceof DoubleType;
     ...
     *          desired type.
     */
    public static boolean isCompatible(String desiredSig, ReferenceType actualType) {
        Stack stack = new Stack();
        stack.push(actualType);
        while (!stack.empty()) {
