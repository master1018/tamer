...
public class SipCommunicatorOSGIBootstrap {
    ...
    public void setUp(Hashtable props) {
        ...
        try {
            sipProviderRefs = context.getServiceReferences(ProtocolProviderService.class.getName(), "(&" + "(" + ProtocolProviderFactory.PROTOCOL + "=" + ProtocolNames.SIP + ")" + "(" + ProtocolProviderFactory.USER_ID + "=" + "test" + ")" + ")");
    ...
    public static Hashtable createSipAccountProperties(String userId, String displayName, String password, String serverAddress, String serverPort, String proxyAddress, String proxyPort) {
    ...
    public static AudioNotifierService getAudioNotifier() {
        if (audioNotifierService == null) {
            ServiceReference serviceReference = SipPhoneActivator.getDefault().getBundle().getBundleContext().getServiceReference(AudioNotifierService.class.getName());
            audioNotifierService = (AudioNotifierService) SipPhoneActivator.getDefault().getBundle().getBundleContext().getService(serviceReference);
        }
