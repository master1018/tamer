...
public class WizardPageTest {
    ...
    */
    ...
    public void testUpdateSettings_keysExist() {
        ...
        Assert.assertTrue("Key set did not contain needed key.", settings.keySet().contains("test box"));
        Assert.assertTrue("Key set did not contain needed key.", settings.keySet().contains("test field"));
        Assert.assertTrue("Key set did not contain needed key.", settings.keySet().contains("custom comp"));
    }
