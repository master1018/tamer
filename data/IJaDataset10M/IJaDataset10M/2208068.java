...
/**
 * This is a default implementation of the IFC object IfcTransformerType<br><br>
 * 
 ...
 **/
public class IfcTransformerType extends IfcEnergyConversionDeviceType implements IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcGloballyUniqueId", "IfcOwnerHistory", "IfcLabel", "IfcText", "IfcLabel", "SET<IfcPropertySetDefinition>", "LIST<IfcRepresentationMap>", "IfcLabel", "IfcLabel", "IfcTransformerTypeEnum" };
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("PredefinedType")) stepString = stepString.concat("*);"); else {
            if (this.PredefinedType != null) stepString = stepString.concat(((IfcRootInterface) this.PredefinedType).getStepParameter(IfcTransformerTypeEnum.class.isInterface()) + ");"); else stepString = stepString.concat("$);");
        }
        return stepString;
    }
    ...
    public Object clone() {
        ...
        if (this.GlobalId != null) ifcTransformerType.setGlobalId((IfcGloballyUniqueId) this.GlobalId.clone());
        if (this.OwnerHistory != null) ifcTransformerType.setOwnerHistory((IfcOwnerHistory) this.OwnerHistory.clone());
        if (this.Name != null) ifcTransformerType.setName((IfcLabel) this.Name.clone());
        if (this.Description != null) ifcTransformerType.setDescription((IfcText) this.Description.clone());
        if (this.ApplicableOccurrence != null) ifcTransformerType.setApplicableOccurrence((IfcLabel) this.ApplicableOccurrence.clone());
        if (this.HasPropertySets != null) ifcTransformerType.setHasPropertySets((SET<IfcPropertySetDefinition>) this.HasPropertySets.clone());
        if (this.RepresentationMaps != null) ifcTransformerType.setRepresentationMaps((LIST<IfcRepresentationMap>) this.RepresentationMaps.clone());
        if (this.Tag != null) ifcTransformerType.setTag((IfcLabel) this.Tag.clone());
        if (this.ElementType != null) ifcTransformerType.setElementType((IfcLabel) this.ElementType.clone());
        if (this.PredefinedType != null) ifcTransformerType.setPredefinedType((IfcTransformerTypeEnum) this.PredefinedType.clone());
    ...
    public Object shallowCopy() {
        IfcTransformerType ifcTransformerType = new IfcTransformerType();
        if (this.GlobalId != null) ifcTransformerType.setGlobalId(this.GlobalId);
        if (this.OwnerHistory != null) ifcTransformerType.setOwnerHistory(this.OwnerHistory);
        if (this.Name != null) ifcTransformerType.setName(this.Name);
        if (this.Description != null) ifcTransformerType.setDescription(this.Description);
        if (this.ApplicableOccurrence != null) ifcTransformerType.setApplicableOccurrence(this.ApplicableOccurrence);
        if (this.HasPropertySets != null) ifcTransformerType.setHasPropertySets(this.HasPropertySets);
        if (this.RepresentationMaps != null) ifcTransformerType.setRepresentationMaps(this.RepresentationMaps);
        if (this.Tag != null) ifcTransformerType.setTag(this.Tag);
        if (this.ElementType != null) ifcTransformerType.setElementType(this.ElementType);
        if (this.PredefinedType != null) ifcTransformerType.setPredefinedType(this.PredefinedType);
        return ifcTransformerType;
    }
