...
public class SuperEllipsoid extends Surface {
	 ...
	 */
    public SuperEllipsoid(final PGraphics i_g, final int i_phiSteps, final int i_thetaSteps, final float i_N1, final float i_N2, final int[][] i_colors) {
        super(i_g, i_phiSteps, i_thetaSteps, -HALF_PI, HALF_PI, -PI, PI, new float[] { i_N1, i_N2 }, i_colors);
    }

    public SuperEllipsoid(final PGraphics i_g, final int i_phiSteps, final int i_thetaSteps, final float i_N1, final float i_N2) {
        super(i_g, i_phiSteps, i_thetaSteps, -HALF_PI, HALF_PI, -PI, PI, new float[] { i_N1, i_N2 }, null);
    }

    public SuperEllipsoid(final PGraphics i_g, final int i_phiSteps, final int i_thetaSteps, final int[][] i_colors) {
        this(i_g, i_phiSteps, i_thetaSteps, 0.2f, 1f, i_colors);
    }

    public SuperEllipsoid(final PGraphics i_g, final int i_phiSteps, final int i_thetaSteps) {
        this(i_g, i_phiSteps, i_thetaSteps, 0.2f, 1f);
    }
