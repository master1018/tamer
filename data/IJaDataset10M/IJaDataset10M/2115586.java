...
public class Application implements InitializingBean, ApplicationContextAware {
    ...
    public static Application instance() {
        Assert.state(isLoaded(), "The global rich client application instance has not yet been initialized; it must be created and loaded first.");
    ...
    public void afterPropertiesSet() throws Exception {
        Assert.notNull(this.lifecycleAdvisor, "The application advisor is required, for processing of application lifecycle events");
    ...
    public String getName() {
        if (descriptor != null && StringUtils.hasText(descriptor.getDisplayName())) return descriptor.getDisplayName();
        return "Spring Rich Client Application";
    }

    public Image getImage() {
        if (descriptor != null && descriptor.getImage() != null) return descriptor.getImage();
        try {
    ...
    public void openWindow(String pageDescriptorId) {
        ...
        if (pageDescriptorId == null) {
            ApplicationPageFactory pageFactory = (ApplicationPageFactory) services().getService(ApplicationPageFactory.class);
    ...
    protected ApplicationWindow createNewWindow() {
        ApplicationWindowFactory windowFactory = (ApplicationWindowFactory) services().getService(ApplicationWindowFactory.class);
