...
public class CharacterProvider extends CommandGene implements ICloneable {
   ...
   */
    ...
    public CharacterProvider(final GPConfiguration a_conf, Class a_returnType, String a_alphabet) throws InvalidConfigurationException {
        this(a_conf, a_returnType, a_alphabet, 0);
    }

    public CharacterProvider(final GPConfiguration a_conf, Class a_returnType, String a_alphabet, int a_subReturnType) throws InvalidConfigurationException {
   ...
   */
    public boolean equals(Object a_other) {
        try {
            CharacterProvider other = (CharacterProvider) a_other;
            return super.equals(a_other) && new EqualsBuilder().append(m_alphabet, other.m_alphabet).isEquals();
   ...
   */
    public Object clone() {
        try {
            CharacterProvider result = new CharacterProvider(getGPConfiguration(), getReturnType(), m_alphabet, getSubReturnType());
            return result;
        } catch (Exception ex) {
