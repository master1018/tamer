...
public class Version implements Comparable {
    ...
    static {
        try {
            InputStream inR = ClassLoader.getSystemResourceAsStream("reconcile/weka/core/version.txt");
        ...
        try {
            ...
            if (tmpStr.indexOf(".") > -1) {
                ...
                if (tmpStr.indexOf(".") > -1) {
                    ...
                    tmpStr = tmpStr.substring(tmpStr.indexOf(".") + 1);
                    if (!tmpStr.equals("")) revision = Integer.parseInt(tmpStr); else revision = 0;
                } else {
                    if (!tmpStr.equals("")) minor = Integer.parseInt(tmpStr); else minor = 0;
                }
            } else {
                if (!tmpStr.equals("")) major = Integer.parseInt(tmpStr); else major = 0;
            }
        } catch (Exception e) {
            e.printStackTrace();
            major = -1;
