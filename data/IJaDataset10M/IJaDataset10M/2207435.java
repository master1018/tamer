...
public class BenchmarkInvertSymPosDef {
    ...
    private static void runAlgorithms(DenseMatrix64F mat, int numTrials) {
        ...
        System.out.println("invert Cholesky Inner       = " + invertCholesky(new LinearSolverChol(new CholeskyDecompositionInner(true)), mat, numTrials));
        System.out.println("invert Cholesky Block Dense = " + invertCholesky(new LinearSolverChol(new CholeskyDecompositionBlock(EjmlParameters.BLOCK_WIDTH_CHOL)), mat, numTrials));
        System.out.println("invert CholeskyBlock64      = " + invertCholesky(new LinearSolverCholBlock64(), mat, numTrials));
    }
