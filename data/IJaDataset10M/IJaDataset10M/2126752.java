...
public class JosmMapFeatures implements IMapFeaturesSet {
     ...
     */
    private static final Logger LOG = Logger.getLogger(JosmMapFeatures.class.getName());
    ...
    */
    ...
    public void paintShop(final Point centerPoint, final String shopKind, final Graphics2D graphicsContext) {
        ...
        if (shopKind.equals("supermarket")) img = this.getImage("shopping/supermarket.png"); else if (shopKind.equals("convenience")) img = this.getImage("shopping/supermarket.png"); else if (shopKind.equals("department_store")) img = this.getImage("shopping/mall.png"); else if (shopKind.equals("mall")) img = this.getImage("shopping/mall.png"); else if (shopKind.equals("shop_center")) img = this.getImage("shopping/mall.png"); else if (shopKind.equals("jewelry")) img = this.getImage("shopping/jewelry.png"); else if (shopKind.equals("kiosk")) img = this.getImage("shopping/kiosk.png"); else if (shopKind.equals("butcher")) img = this.getImage("shopping/groceries/butcher.png"); else if (shopKind.equals("bakery")) img = this.getImage("shopping/groceries/bakery.png"); else if (shopKind.equals("bicycle")) img = this.getImage("sports/bicycle.png"); else if (shopKind.equals("cycle_repair")) img = this.getImage("sports/bicycle.png"); else if (shopKind.equals("florist")) img = this.getImage("shopping/florist.png"); else if (shopKind.equals("groceries")) img = this.getImage("shopping/groceries/fruits.png"); else if (shopKind.equals("organic")) img = this.getImage("shopping/groceries/fruits.png"); else if (shopKind.equals("beverages")) img = this.getImage("shopping/beverages.png"); else if (shopKind.equals("books")) img = this.getImage("shopping/rental/library.png"); else if (shopKind.equals("car")) img = this.getImage("transport/car.png"); else if (shopKind.equals("car_dealer")) img = this.getImage("transport/car.png"); else if (shopKind.equals("car_repair")) img = this.getImage("transport/car.png"); else if (shopKind.equals("chemist")) img = this.getImage("shopping/chemist.png"); else if (shopKind.equals("clothes")) img = this.getImage("shopping/clothes.png"); else if (shopKind.equals("computer")) img = this.getImage("shopping/computer.png"); else if (shopKind.equals("electronics")) img = this.getImage("shopping/electronics.png"); else if (shopKind.equals("hifi")) img = this.getImage("shopping/hifi.png"); else if (shopKind.equals("furniture")) img = this.getImage("shopping/furniture.png"); else if (shopKind.equals("garden_centre")) img = this.getImage("shopping/garden_centre.png"); else if (shopKind.equals("hardware")) img = this.getImage("shopping/diy_store.png"); else if (shopKind.equals("doityourself")) img = this.getImage("shopping/diy_store.png"); else if (shopKind.equals("hairdresser")) img = this.getImage("shopping/hairdresser.png"); else if (shopKind.equals("shoes")) img = this.getImage("shopping/shoes.png"); else if (shopKind.equals("toys")) img = this.getImage("shopping/toys.png"); else if (shopKind.equals("video")) img = this.getImage("shopping/video.png"); else if (shopKind.equals("dry_cleaning")) img = this.getImage("shopping/clothes.png"); else if (shopKind.equals("laundry")) img = this.getImage("shopping/laundry.png"); else if (shopKind.equals("outdoor")) img = this.getImage("shopping/sports/outdoor.png"); else if (shopKind.equals("optician")) img = this.getImage("shopping/optician.png"); else if (shopKind.equals("motorcycle")) img = this.getImage("vehicle/motorbike.png"); else if (shopKind.equals("newsagent")) img = this.getImage("shopping/kiosk.png"); else if (shopKind.equals("tailor")) img = this.getImage("shopping/tailor.png"); else if (shopKind.equals("travel_agency")) img = this.getImage("places/island.png");
        if (img != null) {
            graphicsContext.drawImage(img, null, centerPoint.x - img.getWidth() / 2, centerPoint.y - img.getHeight() / 2);
        }
    }
    ...
    public void paintAmenity(final Point centerPoint, final String amenityType, final Graphics2D graphicsContext) {
        ...
        if (amenityType.equals("pub")) img = this.getImage("food/pub.png"); else if (amenityType.equals("biergarten")) img = this.getImage("food/biergarten.png"); else if (amenityType.equals("nightclub")) img = this.getImage("recreation/nightclub.png"); else if (amenityType.equals("cafe")) img = this.getImage("food/cafe.png"); else if (amenityType.equals("restaurant")) img = this.getImage("food/restaurant.png"); else if (amenityType.equals("fast_food")) img = this.getImage("food/fastfood.png"); else if (amenityType.equals("bar")) img = this.getImage("food/bar.png"); else if (amenityType.equals("icecream")) img = this.getImage("food/icecream.png"); else if (amenityType.equals("drinking_water")) img = this.getImage("food/drinking_water.png"); else if (amenityType.equals("fountain")) img = this.getImage("misc/landmark/spring.png"); else if (amenityType.equals("telephone")) img = this.getImage("public/telephone.png"); else if (amenityType.equals("emergency_phone")) img = this.getImage("vehicle/emergency_phone.png"); else if (amenityType.equals("theatre")) img = this.getImage("recreation/theater.png"); else if (amenityType.equals("cinema")) img = this.getImage("recreation/cinema.png"); else if (amenityType.equals("recycling")) img = this.getImage("public/recycling.png"); else if (amenityType.equals("public_building") || amenityType.equals("embassy") || amenityType.equals("town_hall") || amenityType.equals("community_cenre")) img = this.getImage("service.png"); else if (amenityType.equals("gave_yard")) img = this.getImage("religion/cemetery.png"); else if (amenityType.equals("library")) img = this.getImage("shopping/rental/library.png");
        if (img != null) {
            graphicsContext.drawImage(img, null, centerPoint.x - img.getWidth() / 2, centerPoint.y - img.getHeight() / 2);
        }
    }
    ...
    public void paintTourism(final Point centerPoint, final String tourismNodeType, final Graphics2D graphicsContext) {
        BufferedImage img = null;
        if (tourismNodeType.equals("museum")) img = this.getImage("sightseeing/museum.png"); else if (tourismNodeType.equals("hotel")) img = this.getImage("accommodation/hotel.png"); else if (tourismNodeType.equals("motel")) img = this.getImage("accommodation/motel.png"); else if (tourismNodeType.equals("guest_house")) img = this.getImage("accommodation/guest_house.png"); else if (tourismNodeType.equals("hostel")) img = this.getImage("accommodation/hostel.png"); else if (tourismNodeType.equals("chalet")) img = this.getImage("accommodation/chalet.png"); else if (tourismNodeType.equals("camp_site")) img = this.getImage("accommodation/camping.png"); else if (tourismNodeType.equals("caravan_site")) img = this.getImage("accommodation/camping/caravan.png"); else if (tourismNodeType.equals("picnic_site")) img = this.getImage("recreation/picnic.png"); else if (tourismNodeType.equals("viewpoint")) img = this.getImage("sightseeing/viewpoint.png"); else if (tourismNodeType.equals("theme_park")) img = this.getImage("recreation/theme_park.png"); else if (tourismNodeType.equals("attraction")) img = this.getImage("sightseeing.png"); else if (tourismNodeType.equals("zoo")) img = this.getImage("recreation/zoo.png"); else if (tourismNodeType.equals("art_work")) img = this.getImage("public/arts_centre.png");
        if (img != null) {
            graphicsContext.drawImage(img, null, centerPoint.x - img.getWidth() / 2, centerPoint.y - img.getHeight() / 2);
        }
    }
