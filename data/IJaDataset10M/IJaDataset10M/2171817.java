...
public class BatchTagger {
   ...
   * */
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        if (args[3].indexOf("/") < 0) args[3] = "./" + args[3];
        ...
        Tagger tagger = null;
        try {
            if (args[0].toLowerCase().equals("var")) tagger = new VariationTagger(args[1]); else if (args[0].toLowerCase().equals("gene")) tagger = new GeneTagger(args[1]); else if (args[0].toLowerCase().equals("mal")) tagger = new MalignancyTagger(args[1]); else {
                System.out.println(usageHelp + '\n' + taggerHelp);
                return;
            }
