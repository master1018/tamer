...
public class VersionedChunk extends IRChunk {
    ...
    private static final int magic = 0x56430a00;

    /**
   * Log4j logger for this class
   */
    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger("IR");
   ...
   */
    protected class Structure extends VersionedStructureProxy {
        ...
        protected VersionedStructure computeReplacement() {
            if (version.getEra() == null) return null;
   ...
   */
    public static VersionedChunk getVersionedChunk(VersionedRegion vr, Bundle b) {
        return get(vr, b);
    }
   ...
   */
    ...
    public boolean isDefined(Version v) {
        ...
        while (v.getEra() == null) v = v.parent();
        if (e0.getRoot().comesFrom(v)) return true;
        for (Era e = v.getEra(); ; e = e.getParentEra()) {
            ...
            if (!vs.isDefined(v)) return false;
            if (e == e0) return true;
        }
    }
    ...
    static {
        IRPersistent.registerPersistentKind(kind, 0x76);
    }
   ...
   */
    protected static class Delta extends VersionedDelta {
        ...
        static final int magic = 0x56434400;
        ...
        public static Delta get(VersionedChunk ch, Era e) {
            ...
            if (d == null) {
                if (e.isNew()) d = new Delta(ch, e); else d = new Delta(ch, e, false);
                add(d);
            }
            return d;
        }
        ...
        static {
            IRPersistent.registerPersistentKind(kind, 0x03);
        }
     ...
     */
        ...
        public String toString() {
            return "VCD(" + getVersionedRegion() + "," + getChunk().getBundle() + "," + getEra() + ")";
        }
   ...
   */
    protected static class Snapshot extends VersionedSnapshot {
        ...
        private static final int magic = 0x56435300;
        ...
        public static Snapshot get(VersionedChunk vc, Version v) {
            ...
            if (vcs == null) {
                if (v.getEra() == null || v.getEra().isNew()) vcs = new Snapshot(vc, v); else vcs = new Snapshot(vc, v, false);
                add(vcs);
            }
            return vcs;
        }
        ...
        static {
            IRPersistent.registerPersistentKind(kind, 0x13);
        }
     ...
     */
        ...
        public String toString() {
            Version version = getVersion();
            return "VCS(" + getVersionedRegion() + "," + getBundle() + "," + version.getEra() + "," + version.getEraOffset() + ")";
        }
