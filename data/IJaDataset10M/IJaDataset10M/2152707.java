...
/**
 * <p>
 * A class that extends {@link java.io.FilterInputStream FilterInputStream} by
 * adding the concept of little and big endian binary value encoding, and
 * supplies functions for reading various sized integer and floating point
 * words.
 * </p>
 * 
 * @see co.edu.unal.ungrid.image.dicom.core.BinaryOutputStream
 * 
 * 
 */
public class BinaryInputStream extends FilterInputStream {
    ...
    final int extractUnsigned16() {
        ...
        return bigEndian ? (v1 << 8) | v2 : (v2 << 8) | v1;
    }
    ...
    final long extractUnsigned64() {
        ...
        return bigEndian ? (((((((((((((v1 << 8) | v2) << 8) | v3) << 8) | v4) << 8) | v5) << 8) | v6) << 8) | v7) << 8) | v8 : (((((((((((((v8 << 8) | v7) << 8) | v6) << 8) | v5) << 8) | v4) << 8) | v3) << 8) | v2) << 8) | v1;
    }
    ...
    public final void readUnsigned16(short[] w, int offset, int len) throws IOException {
        ...
        if (bigEndian) {
            ...
            for (; wcount < len; ++wcount) {
                w[offset + wcount] = (short) ((b[bcount++] & 0xff) + (b[bcount++] << 8));
            }
        }
    }
