...
public class ProcessVolumeInfo {
    ...
    public static void runCmd() {
        try {
            ...
            if (root.getAttribute("status").equals("failed")) System.out.println(root.getAttribute("msg")); else {
                Element dse = (Element) root.getElementsByTagName("volume").item(0);
                long capacitySz = Long.parseLong(dse.getAttribute("capacity"));
                double maxPFull = Double.parseDouble(dse.getAttribute("maximum-percentage-full"));
                ...
                if (maxPFull < 0) System.out.printf("Volume Max Percentage Full : %s\n", "Unlimited"); else System.out.printf("Volume Max Percentage Full : %s%%\n", maxPFull * 100);
