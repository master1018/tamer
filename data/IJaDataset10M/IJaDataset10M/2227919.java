...
public class DNABindingTreeResult extends TreeResult {
    ...
    public void addRuleResult(IDecisionRule rule, boolean value, IAtomContainer molecule) throws DecisionResultException {
        ...
        if (rule instanceof RuleDNABindingAlerts) setSilent(true); else setSilent((rule instanceof DecisionNode) && ((((DecisionNode) rule).getRule() instanceof RuleDNABindingAlerts)));
    }
