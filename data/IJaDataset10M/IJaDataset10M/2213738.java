package com.eric.simms.common.util;
    ...
    public synchronized void load(InputStream inStream) throws IOException {
        ...
        while (true) {
            ...
            if (line.length() > 0) {
                int len = line.length();
                int keyStart;
                for (keyStart = 0; keyStart < len; keyStart++) if (whiteSpaceChars.indexOf(line.charAt(keyStart)) == -1) break;
                ...
                if ((firstChar != '#') && (firstChar != '!')) {
                    ...
                    int valueIndex;
                    for (valueIndex = separatorIndex; valueIndex < len; valueIndex++) if (whiteSpaceChars.indexOf(line.charAt(valueIndex)) == -1) break;
        ...
        for (int x = 0; x < len; ) {
            ...
            if (aChar == '\\') {
                ...
                if (aChar == 'u') {
                    ...
                    if (aChar == 't') outBuffer.append('\t'); else if (aChar == 'r') outBuffer.append('\r'); else if (aChar == 'n') {
                        outBuffer.append('\n');
                    } else if (aChar == 'f') outBuffer.append('\f'); else outBuffer.append(aChar);
                }
