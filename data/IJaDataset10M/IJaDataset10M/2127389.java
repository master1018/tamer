...
public class PasswordSafeMacOSX extends PasswordSafeJFace {
   ...
   */
    protected void setupMacAppMenus(Display display) {
        ...
        int ret = OS.InstallEventHandler(OS.GetApplicationEventTarget(), commandProc, mask.length / 2, mask, 0, null);
        int[] outMenu = new int[1];
        short[] outIndex = new short[1];
        ret = OS.GetIndMenuItemWithCommandID(0, kHICommandPreferences, 1, outMenu, outIndex);
