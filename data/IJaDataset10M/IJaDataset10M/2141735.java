...
public final class AnimatedLabel extends JPanel {
     ...
     */
    public AnimatedLabel(Color baseColor, int fontExtraSize, String text, int orientation, int duration, int frames_per_second) {
        super(null);
    ...
    private void initComponents(int fontExtraSize) {
        labels = new JLabel[2];
        labels[foreground] = createBoldLabel(fontExtraSize, getTranslucentColor(255));
        labels[background] = createBoldLabel(fontExtraSize, getTranslucentColor(255));
    }
    ...
    private static final class AntiAliasedLabel extends JLabel {
        ...
        public void updateUI() {
            ...
            Font font = getFont();
            if (0 == fontExtraSize) {
                if (font.getStyle() != fontStyle) setFont(new FontUIResource(font.deriveFont(fontStyle)));
            } else setFont(new FontUIResource(new Font(font.getName(), fontStyle, font.getSize() + fontExtraSize)));
        }
    }
}
