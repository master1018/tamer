...
public class ProtocolProviderFactoryGibberishImpl extends ProtocolProviderFactory {
    ...
    private static final Logger logger = Logger.getLogger(ProtocolProviderFactoryGibberishImpl.class);
    ...
    public AccountID loadAccount(Map accountProperties) {
        ...
        ProtocolProviderServiceGibberishImpl gibberishProtocolProvider = new ProtocolProviderServiceGibberishImpl();
        gibberishProtocolProvider.initialize(userIDStr, accountID);
        ServiceRegistration registration = context.registerService(ProtocolProviderService.class.getName(), gibberishProtocolProvider, properties);
    ...
    public boolean uninstallAccount(AccountID accountID) {
        ...
        ProtocolProviderService protocolProvider = (ProtocolProviderService) GibberishActivator.getBundleContext().getService(serRef);
        try {
        ...
        return removeStoredAccount(GibberishActivator.getBundleContext(), accountID);
    }
    ...
    public void storePassword(AccountID accountID, String passwd) throws IllegalArgumentException {
        super.storePassword(GibberishActivator.getBundleContext(), accountID, passwd);
    }
    ...
    public String loadPassword(AccountID accountID) throws IllegalArgumentException {
        return super.loadPassword(GibberishActivator.getBundleContext(), accountID);
    }
