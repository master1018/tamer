...
public class GridEnterNewRowSample extends ShowcasePanel {
    ...
    private static final String DESCRIPTION = "<p><b>Click</b> on any cell to start editing, then <b>Tab</b> or <b>Down Arrow</b> past the" + " last row in the grid to create a new row.</p><p>Alternatively, click the <b>Edit New</b> button" + " to create a new data-entry row at the end of the grid.</p>";
