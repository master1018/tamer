...
public class AnnotationKeywordFactoryTest extends MockObjectTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        keywordExtractor.expects(once()).method("extractKeywords").with(eq(someKeywordBean)).will(returnValue(new HashMap() {
        ...
        keywordExtractor.expects(once()).method("extractKeywords").with(eq(anotherKeywordBean)).will(returnValue(new HashMap() {
