 ...
 */
public class MultiTemplateFormat extends TemplateFormat implements ResultFormat, ResultFormatGenerator {
    ...
    public String format(Object obj, Permission permission) throws ConfigurationException {
        if (this.needPermission != null && permission != null) {
            if (!permission.hasPermission(this.needPermission)) {
                return obj == null ? "" : this.htmlFilter ? Utils.dealString2HTML(obj.toString(), true) : obj.toString();
            }
        }
        ...
        while (strI != -1) {
            values[index++] = this.htmlFilter ? Utils.dealString2HTML(temp.substring(0, strI), true) : temp.substring(0, strI);
    ...
    protected void parseTemplate() {
        ...
        this.valueSplit = this.valueSplit == null || this.valueSplit.length() == 0 ? DEFAULT_VALUE_SPLIT : this.valueSplit;
