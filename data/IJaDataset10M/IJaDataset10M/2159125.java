...
public class NomenclatureImpl extends PackageImpl implements Nomenclature {
    ...
    public void setParent(Nomenclature newParent) {
        if (newParent != eInternalContainer() || (eContainerFeatureID() != BusinessnomenclaturePackage.NOMENCLATURE__PARENT && newParent != null)) {
            ...
            if (newParent != null) msgs = ((InternalEObject) newParent).eInverseAdd(this, BusinessnomenclaturePackage.NOMENCLATURE__CHILD, Nomenclature.class, msgs);
            msgs = basicSetParent(newParent, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, BusinessnomenclaturePackage.NOMENCLATURE__PARENT, newParent, newParent));
    }
