 ...
 * @see TreeUtil
 */
public class XvsYTreeSelector extends JPanel implements ActionListener {
   ...
   * buttons can be inserted by sub-classes if required. */
    ...
    public XvsYTreeSelector(String bordertitle) {
        ...
        itsTree.getSelectionModel().setSelectionMode(TreeSelectionModel.DISCONTIGUOUS_TREE_SELECTION);
   ...
   * @return Vector containing String names of selected X items. */
    public synchronized Vector getXSelections() {
   ...
   * @return Vector containing String names of selected Y items. */
    public synchronized Vector getYSelections() {
   ...
   * @param v Vector containing String names of items to be selected. */
    public synchronized void setXSelections(Vector v) {
        if (v == null || v.size() == 0) {
            itsXSelected.clear();
        } else {
   ...
   * @param v Vector containing String names of items to be selected. */
    public synchronized void setYSelections(Vector v) {
        if (v == null || v.size() == 0) {
            itsYSelected.clear();
        } else {
