 ...
 */
public class OperationSetBasicInstantMessagingMsnImpl implements OperationSetBasicInstantMessaging {

    private static final Logger logger = Logger.getLogger(OperationSetBasicInstantMessagingMsnImpl.class);
    ...
    public boolean isContentTypeSupported(String contentType) {
        if (contentType.equals(DEFAULT_MIME_TYPE)) return true; else return false;
    }
    ...
    public Message createMessage(byte[] content, String contentType, String contentEncoding, String subject) {
        return new MessageMsnImpl(new String(content), contentType, contentEncoding, subject);
    }
    ...
    public Message createMessage(String messageText) {
        return new MessageMsnImpl(messageText, DEFAULT_MIME_TYPE, DEFAULT_MIME_ENCODING, null);
    }
    ...
    private void assertConnected() throws IllegalStateException {
        if (msnProvider == null) throw new IllegalStateException("The provider must be non-null and signed on the " + "service before being able to communicate.");
        if (!msnProvider.isRegistered()) throw new IllegalStateException("The provider must be signed on the service before " + "being able to communicate.");
    }
    ...
    private class RegistrationStateListener implements RegistrationStateChangeListener {
        ...
        public void registrationStateChanged(RegistrationStateChangeEvent evt) {
            ...
            if (evt.getNewState() == RegistrationState.REGISTERED) {
                opSetPersPresence = (OperationSetPersistentPresenceMsnImpl) msnProvider.getSupportedOperationSets().get(OperationSetPersistentPresence.class.getName());
    ...
    private class MsnMessageListener extends MsnMessageAdapter implements MsnEmailListener {
        ...
        public void instantMessageReceived(MsnSwitchboard switchboard, MsnInstantMessage message, MsnContact contact) {
            ...
            if (sourceContact == null) {
                ...
                sourceContact = opSetPersPresence.createVolatileContact(contact.getEmail().getEmailAddress());
            }
        ...
        public void newEmailNotificationReceived(MsnSwitchboard switchboard, MsnEmailNotifyMessage message, MsnContact contact) {
            ...
            Message newMailMessage = new MessageMsnImpl(MessageFormat.format(Resources.getString("newMail"), new Object[] { message.getFrom(), message.getFromAddr(), subject }), DEFAULT_MIME_TYPE, DEFAULT_MIME_ENCODING, subject);
            ...
            if (sourceContact == null) {
                ...
                sourceContact = opSetPersPresence.createVolatileContact(message.getFromAddr());
            }
