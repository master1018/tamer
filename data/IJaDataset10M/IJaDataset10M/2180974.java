...
public abstract class ListScenario extends Activity {
    ...
    public static class Params {
         ...
         */
        public Params setPositionScreenSizeFactorOverride(int position, double itemScreenSizeFactor) {
    ...
    public final String getValueAtPosition(int position) {
        return isItemAtPositionSelectable(position) ? "position " + position : "------- " + position;
    }
