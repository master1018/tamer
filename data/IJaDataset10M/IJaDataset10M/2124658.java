...
public abstract class AuthenticationHeader extends ParametersHeader {
    ...
    public String getParameter(String name) {
        ...
        if ((returnValue != null) && isQuoted(name)) {
    ...
    private boolean isQuoted(String name) {
        if (equalsIgnoreCase(name, QOP) || equalsIgnoreCase(name, REALM) || equalsIgnoreCase(name, URI) || equalsIgnoreCase(name, CNONCE) || equalsIgnoreCase(name, NONCE) || equalsIgnoreCase(name, USERNAME) || equalsIgnoreCase(name, DOMAIN) || equalsIgnoreCase(name, OPAQUE) || equalsIgnoreCase(name, NEXT_NONCE) || equalsIgnoreCase(name, RESPONSE)) {
            return true;
        }
        return false;
    }
    ...
    public void setAlgorithm(String algorithm) throws ParseException {
        if (algorithm == null) throw new NullPointerException("null arg");
    ...
    public void setQop(String qop) throws ParseException {
        if (qop == null) throw new NullPointerException("null arg");
    ...
    public void setOpaque(String opaque) throws ParseException {
        if (opaque == null) throw new NullPointerException("null arg");
    ...
    public void setDomain(String domain) throws ParseException {
        if (domain == null) throw new NullPointerException("null arg");
    ...
    public void setResponse(String response) throws ParseException {
        if (response == null) throw new NullPointerException("Null parameter");
    ...
    public boolean equals(Object that) {
        if (!that.getClass().equals(this.getClass())) {
            ...
            return (equalsIgnoreCase(this.scheme, other.scheme) && this.parameters.equals(other.parameters));
        }
    }
