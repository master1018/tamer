...
public final class GroupedSequence extends AbstractSequence {
                ...
                for (int i = 0; i < len; i++) {
                    ...
                    if (atomizedItor.hasNext()) {
                        ...
                        if (atomizedItor.hasNext()) {
                            ...
                            throw new DynamicError("err:XQDY0095", "Illegal resulting value for a grouping variable: " + atomized);
                        }
    ...
    private static final class GroupEntry implements Externalizable {
        ...
        final transient DynamicContext dynEnv;
    ...
    private static final class GroupKeys implements Comparable<GroupKeys>, Externalizable {
        ...
        transient GroupingSpec[] _specs;

        transient Item[] _keys;

        transient Sequence[] _rawKeys;

        final transient DynamicContext _dynEnv;
