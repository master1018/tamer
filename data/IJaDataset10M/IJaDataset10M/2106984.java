...
public abstract class BaseSynthesizer extends BaseEngine implements Synthesizer {
    ...
    public BaseSynthesizer(final SynthesizerMode engineMode) {
        ...
        final SynthesizerProperties props = new BaseSynthesizerProperties(this);
    ...
    public void fireEvent(final EngineEvent event) {
        synchronized (engineListeners) {
            ...
            while (enumeration.hasMoreElements()) {
                final SynthesizerListener listener = (SynthesizerListener) enumeration.nextElement();
    ...
    protected void postSynthesizerEvent(long oldState, long newState, int eventType, boolean changedTopOfQueue) {
        switch(eventType) {
        ...
        final SynthesizerEvent event = new SynthesizerEvent(this, eventType, oldState, newState, null, changedTopOfQueue);
     ...
     */
    public void fireSpeakableEvent(final SpeakableEvent event, final SpeakableListener extraSpeakableListener) {
        ...
        if (speakableListeners != null) {
            ...
            while (e.hasMoreElements()) {
                final SpeakableListener sl = (SpeakableListener) e.nextElement();
     ...
     * {@inheritDoc}
     */
    public final void removeSpeakableListener(final SpeakableListener listener) {
     ...
     * {@inheritDoc}
     */
    public final void addSynthesizerListener(final SynthesizerListener listener) {
     ...
     * {@inheritDoc}
     */
    public final void removeSynthesizerListener(final SynthesizerListener listener) {
     ...
     * {@inheritDoc}
     */
    public boolean cancel(int id) throws IllegalArgumentException, EngineStateException {
        checkEngineState(DEALLOCATED | DEALLOCATING_RESOURCES);
    ...
    public void setSynthesizerProperties(SynthesizerProperties props) {
    }
    ...
    public int speak(AudioSegment audio, SpeakableListener listener) throws EngineStateException, IllegalArgumentException {
        return queueManager.appendItem(audio, listener);
    }

    public int speak(Speakable speakable, SpeakableListener listener) throws EngineStateException, SpeakableException, IllegalArgumentException {
        while (testEngineState(ALLOCATING_RESOURCES)) {
            try {
                waitEngineState(ALLOCATED);
            } catch (InterruptedException ex) {
     ...
     * {@inheritDoc}
     */
    public int speakMarkup(final String synthesisMarkup, final SpeakableListener listener) throws EngineStateException, SpeakableException, IllegalArgumentException {
        while (testEngineState(ALLOCATING_RESOURCES)) {
            try {
                waitEngineState(ALLOCATED);
            } catch (InterruptedException ex) {
     ...
     */
    protected abstract AudioSegment handleSpeak(final int id, final String item);
     ...
     * @return the audio segment that can be used to play back the audio
     */
    protected abstract AudioSegment handleSpeak(final int id, final Speakable item);
     ...
     *            if the engine was in an invalid state
     */
    protected abstract boolean handleCancel(final int id) throws EngineStateException;
     ...
     */
    protected void setAudioSegment(final int id, final AudioSegment audioSegment) {
