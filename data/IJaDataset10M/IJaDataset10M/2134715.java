...
public final class RemoteEval extends BuiltInFunction implements Evaluable {
    ...
    protected FunctionSignature[] signatures() {
        ...
        s[1] = new FunctionSignature(getName(), new Type[] { StringType.STRING, StringType.STRING, SequenceType.ANY_ITEMS });
        return s;
    }
    ...
    private void prepareVariablesToShip(QueryRequest request, ValueSequence contextSeq, DynamicContext dynEnv) throws XQueryException {
        if (thirdParam != null) {
    ...
    private static ShippedVariable wrapVariableToShip(QueryRequest request, VarRef ref, ValueSequence contextSeq, DynamicContext dynEnv) throws XQueryException {
