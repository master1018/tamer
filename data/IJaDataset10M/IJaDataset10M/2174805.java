...
public class HTMLTableWriterTest extends TestCase {
    ...
    private static final String EXPECTED_DEFAULT_RENDERING = "<table>" + CRLF + "<tr>" + CRLF + "<th " + HEADER_STYLE + ">A</th>" + CRLF + "<th " + HEADER_STYLE + ">B</th>" + CRLF + "<th " + HEADER_STYLE + ">C</th>" + CRLF + "</tr>" + CRLF + "<tr>" + CRLF + "<td>0&lt;0</td>" + CRLF + "<td>0&lt;1</td>" + CRLF + "<td>0&lt;2</td>" + CRLF + "</tr>" + CRLF + "<tr>" + CRLF + "<td>1&lt;0</td>" + CRLF + "<td>1&lt;1</td>" + CRLF + "<td>1&lt;2</td>" + CRLF + "</tr>" + CRLF + "</table>" + CRLF;
    ...
    private static final String EXPECTED_FANCY_RENDERING = "<table name='this&amp;that' border=1>" + CRLF + "<tr>" + "<th " + HEADER_STYLE + ">A</th>" + "<th " + HEADER_STYLE + " title='bb'>B</th>" + "<th " + HEADER_STYLE + ">C</th>" + "</tr>" + CRLF + "<tr>" + "<td>0&lt;0</td>" + "<td " + CLASS_ODD + ">0&lt;1</td>" + "<td>0&lt;2</td>" + "</tr>" + CRLF + "<tr>" + "<td " + CLASS_ODD + ">1&lt;0</td>" + "<td>1&lt;1</td>" + "<td " + CLASS_ODD + ">1&lt;2</td>" + "</tr>" + CRLF + "</table>" + CRLF;
}
