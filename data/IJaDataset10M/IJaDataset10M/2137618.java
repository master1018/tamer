...
Identifies a Business Partner */
    ...
    public void setD_Entity_ID(int D_Entity_ID) {
        if (D_Entity_ID <= 0) set_Value("D_Entity_ID", null); else set_Value("D_Entity_ID", new Integer(D_Entity_ID));
    }
...
Optional short description of the record */
    ...
    public void setFileStatus(String FileStatus) {
        if (FileStatus == null || FileStatus.equals("AP") || FileStatus.equals("DR")) ; else throw new IllegalArgumentException("FileStatus Invalid value - Reference_ID=1000067 - AP - DR");
