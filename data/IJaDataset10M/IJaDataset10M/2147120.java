...
public class FenetreListeServices extends FrameParcheminSimple {

    private static final long serialVersionUID = 1L;

    public FenetreListeServices() {
        super(Env.bdd.getParcheminSimple("Rouleau vertical 600x600"), "Services", false, true, false, true);
        this.setFrameIcon(Env.getIconeEquipement("icone_service"));
    ...
    private void afficheInfos() {
        ...
        int x = debut_x;
        int y = debut_y;
        JLabelTitre lbTitre = new JLabelTitre("SERVICES");
        panelHautPage.add(lbTitre);
        String[] nomColonnes = { "Type", "Service" };
        int[] tailleColonnes = { 120, 350 };
        ...
        x = 5;
        y = y + 20;
        for (final Service a : Env.bdd.getServices()) {
            final JLabelDonnee[] valeurs = new JLabelDonnee[nomColonnes.length];
            int col = 0;
            valeurs[col++] = new JLabelDonnee(a.getType());
