...
public class UnitTypeServices {
    ...
    public GxtComponentControllerMetaModel createDynamicWindowController() {
        String controllerMetaModelId = "unitTypeServices";
        Map<String, Object> gridMap2 = new HashMap<String, Object>();
        String formId = "unitTypeService";
        gridMap2 = createGridMap2(controllerMetaModelId, formId, gridMap2);
        GxtComponentControllerMetaModel gxtComponentControllerMetaModel = WindowApplicationBuildTemplate.createSimpleWindowApplication_model1(controllerMetaModelId, "单位类型设置", formId, gridMap2);
    ...
    private GxtComponentMetaModel createDynamicWindowController2() {
        ...
        codes1.add("0007");
        codes1.add("0008");
        windowController.put("id", "1_1_windowController_UnitType");
        ...
        contentPanelController.put("id", "2_1_contentPanelController_UnitType");
        ...
        menuBarController.put("id", "3_1_menuBarController_UnitType");
        ...
        toolBarController.put("id", "3_2_toolBarController_UnitType");
        ...
        sumFormPanelController.put("id", "3_3_sumFormPanelController_UnitType");
        ...
        gridController.put("id", "4_1_gridController_UnitType");
        ...
        codes12222.add("0201");
        codes12222.add("0401");
        dataLoadController.put("id", "5_1_dataLoadController_UnitType");
    ...
    private GxtComponentMetaNodeModel getWindowGxtComponentMetaNodeModel() {
        ...
        map2.put("title", "单位类型设置");
        map2.put("width", 800);
        map2.put("hight", 445);
        map2.put("id", "01_01_window_UnitType");
    ...
    private GxtComponentMetaNodeModel getContentPanelGxtComponentMetaNodeModel() {
        ...
        map2.put("id", "02_01_contentPanel_UnitType");
    ...
    private GxtComponentMetaNodeModel getToolBarGxtComponentMetaNodeModel2() {
        ...
        toolbar.put("id", "03_02_toolBar_UnitType");
    ...
    private GxtComponentMetaNodeModel getSumFormPanelGxtComponentMetaNodeModel() {
        ...
        MaxPanel.put("id", "03_03_sumFormPanel_UnitType");
    ...
    private GxtComponentMetaNodeModel getGridSetModuleGxtComponentMetaNodeModel() {
        ...
        subEventStructureMetaModel.setControllerId("5_1_dataLoadController_UnitType");
        subEventStructureMetaModel.setRootControllerId("1_1_windowController_UnitType");
        ...
        columnConfigs.add(new GridColumnConfigModel("NAME", "名称", 300));
        columnConfigs.add(new GridColumnConfigModel("DESCRIPTION", "描述", 400));
        map3.put("columnconfigload", columnConfigs);
        map3.put("id", "unitType");
        HandlerData.data(map3, "unitTypeService", "getAllUnitType", "addUnitType", "modifyUnitType", "loadEditorableGrid");
    ...
    private GxtComponentMetaNodeModel getShortcutGxtComponentMetaNodeModel() {
        ...
        Map<String, Object> oneDispacherEventTypeData = new HashMap<String, Object>();
        EventStructureMetaModel subEventStructureMetaModel = new EventStructureMetaModel();
        subEventStructureMetaModel.setControllerId("1_1_windowController_UnitType");
        subEventStructureMetaModel.setRootControllerId("1_1_windowController_UnitType");
        oneDispacherEventTypeData.put("eventstructuremetamodel", subEventStructureMetaModel);
    ...
    private GxtComponentMetaNodeModel getMenuBarGxtComponentMetaNodeModel() {
        ...
        menubar.put("id", "03_01_menuBar_UnitType");
