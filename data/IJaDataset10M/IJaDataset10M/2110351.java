...
public class Perfil implements Entidade {
	 ...
	 * @uml.associationEnd multiplicity="(0 -1)" inverse="perfil:br.com.vendaweb.integracao.entidade.Permissao"
	 * 
	 * joinColumns = @JoinColumn(name = "equipe_id"), inverseJoinColumns = @JoinColumn(name = "operador_id")
	 */
    @ManyToMany
