...
public class NameGrabberTest extends TestCase {
    ...
    public void testNameGrabber5A() {
        ...
        assertTrue("wrong base name grabbed", ((TopicNameIF) grabber.grab(topic5)).equals(basename5A));
    }

    public void testNameGrabber5B() {
        GrabberIF grabber = new NameGrabber(Collections.EMPTY_LIST);
        assertTrue("wrong base name grabbed", ((TopicNameIF) grabber.grab(topic5)).equals(basename5B));
    }
