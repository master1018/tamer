...
public class BibDocumentMapperTest extends TestCase {
    ...
    final String hasSimilarSpecies = "The Chinstrap Penguin, P. antarctica , has a longer bill, and a white face crossed " + "by a thin black line. The Gentoo Penguin, P. papua , is larger (80 cm long) with a black and yellow or orange " + "bill, and a white patch over the top of the head.";

    final String hasReproductionText = "Adelie Penguins breed in summer, mainly on the rocky platforms of islands of " + "southern oceans. The nests are made out of small stones, and males and females share incubation and care " + "of the young almost equally.";

    final String hasDietText = "Adelie Penguins feed mainly on fish, crustaceans, amphipods and cephalopods. They can " + "dive to about 175 m but usually feed up to 70 m below the water's surface.";

    final String hasDistributionText = "Adelie Penguins are found mainly at sea in southern oceans " + "around the coasts and islands of Antarctica, and only very rarely appear on the Australian coast, in winter.";
    ...
    public void testHarmonica() throws Exception {
        BibDocumentMapper dm = new BibDocumentMapper();
        String uri = "http://www.birdsinbackyards.net/species/Colluricincla-harmonica";
