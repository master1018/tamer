...
public class ImageProcessor {
	 ...
	 */
    public void crop(String src, String target, int width, int height) throws IOException, InterruptedException, IM4JavaException {
	 ...
	 * @throws IM4JavaException
	 */
    public void crop(String src, String target, int width, int height, int canvasWidth, int canvasHeight, String gravity) throws IOException, InterruptedException, IM4JavaException {
        IMOperation op = createOperation();
	 ...
	 * @throws IM4JavaException
	 */
    public void resize(String src, String target, int width, int height) throws IOException, InterruptedException, IM4JavaException {
        IMOperation op = createOperation();
        op.addImage(src);
	 ...
	 * @throws IOException 
	 */
    public void convert(String src, String target, Map<String, String> rawArgs) throws IOException, InterruptedException, IM4JavaException {
        IMOperation op = new IMOperation();
        op.addImage(src);
        if (rawArgs != null) {
            for (String rawArg : rawArgs.keySet()) op.addRawArgs(rawArg, rawArgs.get(rawArg));
        }
        op.addImage(target);
        new ConvertCmd(processingSystem == ImageProcessingSystem.GRAPHICSMAGICK).run(op);
    }
	 ...
	 * @throws IM4JavaException
	 */
    public void merge(List<String> srcs, String definition, String compression) throws IOException, InterruptedException, IM4JavaException {
        IMOperation op = createOperation();
        op.adjoin();
	 ...
	 * @throws IOException 
	 */
    public void scale(String src, String target, int width, int height) throws IOException, InterruptedException, IM4JavaException {
        IMOperation op = createOperation();
	 ...
	 * @throws IOException
	 */
    public void montage(List<String> srcs, String target, int xTiles, int yTiles, Map<String, String> rawArgs) throws IOException, InterruptedException, IM4JavaException {
        IMOperation op = createOperation();
	 ...
	 * @throws IOException
	 */
    public void montage(List<String> srcs, String target, int xTiles, int yTiles, int width, int height, String backgroundColor, String gravity) throws IOException, InterruptedException, IM4JavaException {
        IMOperation op = createOperation();
        op.tile(xTiles, yTiles);
        op.gravity(gravity);
        op.background(backgroundColor);
