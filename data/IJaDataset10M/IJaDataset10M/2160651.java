...
public class DayOfWeekSlot extends CalendarSlot implements MouseListener {
    ...
    private Border buildBorder() {
        ...
        int b = margin.bottom;
        int r = margin.right;
        Border ini = BorderFactory.createMatteBorder(1, 0, 0, 0, pp.getTopDayOfWeekSeparatorColor());
        Border outi = BorderFactory.createMatteBorder(0, 0, 1, 0, pp.getBottomDayOfWeekSeparatorColor());
