...
public class IntegerObjectTypeTest extends BaseTypeTest {
    ...
    public void testIntObj() throws Exception {
        ...
        testType(dao, foo, clazz, val, val, val, valStr, DataType.INTEGER_OBJ, INT_COLUMN, true, true, false, false, false, false, true, true);
    }
    ...
    public void testIntObjNull() throws Exception {
        ...
        LocalIntObj foo = new LocalIntObj();
        assertEquals(1, dao.create(foo));
        testType(dao, foo, clazz, null, null, null, null, DataType.INTEGER_OBJ, INT_COLUMN, true, true, false, false, false, false, true, true);
    }
