...
public class StatusOS implements java.io.Serializable {
    ...
    public static final Constant OS_ORCAMENTO = new Constant("Em or�amento", "EO");
    ...
    public static final Constant IT_OS_NAO_SALVO = new Constant("N�o Salvo", "");
    ...
    public static final Constant IT_OS_CONCLUIDO = new Constant("Conclu�do", "CO");
