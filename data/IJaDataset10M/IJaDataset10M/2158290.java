...
public class RunningQuery implements EventBucketClient, Serializable {
     ...
     */
    public RunningQuery(String queryName, String thePreparedStatementSQL, FilteredTable[] filteredTables, Object processingSpec, EnumMap<RowStatus, ? extends List<Integer>> statusAndPositions, TableFQN resultTableFQN, Map<String, TableSpec> tableFQNAndSpecMap, String lastRowIdInResultTableSQL, Set<String> cachedSubQueries) {
        this.name = queryName;
        ...
        this.correlationSpec = processingSpec instanceof CorrelationSpec ? (CorrelationSpec) processingSpec : null;
