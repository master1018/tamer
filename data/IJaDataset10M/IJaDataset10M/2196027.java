...
public class FilePersistenceManagerTest extends TestCase {
    ...
    public void testPidPlain() {
        ...
        assertEquals("encode" + File.separatorChar + "%1234" + File.separatorChar + "path", FilePersistenceManager.encodePid("encode/ሴ/path"));
        assertEquals("encode" + File.separatorChar + " %0025 " + File.separatorChar + "path", FilePersistenceManager.encodePid("encode/ % /path"));
    }
    ...
    public void testQuoting() throws IOException {
        ...
        check("QuotingControl", new String(new char[] { 5, 10, 32, 64 }));
    }

    public void testArray() throws IOException {
        check("StringArray", new String[] { "one", "two", "three" });
        check("IntArray", new int[] { 0, 1, 2 });
        check("IntegerArray", new Integer[] { new Integer(0), new Integer(1), new Integer(2) });
    }

    public void testVector() throws IOException {
        check("StringVector", new Vector(Arrays.asList(new String[] { "one", "two", "three" })));
        check("IntegerVector", new Vector(Arrays.asList(new Integer[] { new Integer(0), new Integer(1), new Integer(2) })));
    }

    public void testList() throws IOException {
        check("StringList", Arrays.asList(new String[] { "one", "two", "three" }));
        check("IntegerList", Arrays.asList(new Integer[] { new Integer(0), new Integer(1), new Integer(2) }));
    }
    ...
    public void testMultiValue() throws IOException {
        ...
        props.put("Array", new boolean[] { true, false });
