...
public class DasComponentFeature extends DasFeature implements Serializable {
    ...
    private DasComponentFeature(String featureId, String featureLabel, String targetSegmentId, String componentTargetLabel, int startCoordinateOnComponent, int endCoordinateOnComponent, String typeId, String category, String typeLabel, String methodId, String methodLabel, int startCoodinateOnSegment, int endCoordinateOnSegment, Double score, DasFeatureOrientation orientation, DasPhase phase, Collection<String> notes, Map<URL, String> links) throws DataSourceException {
        super(featureId, featureLabel, typeId, category, typeLabel, methodId, methodLabel, startCoodinateOnSegment, endCoordinateOnSegment, score, orientation, phase, notes, links, new ArrayList<DasTarget>(1), null);
    ...
    DasComponentFeature(DasAnnotatedSegment segment) throws DataSourceException {
        super(segment.getSegmentId(), null, "ThisSegment", "component", null, "assembly", null, segment.getStartCoordinate(), segment.getStopCoordinate(), 0.00, DasFeatureOrientation.ORIENTATION_NOT_APPLICABLE, DasPhase.PHASE_NOT_APPLICABLE, null, null, new ArrayList<DasTarget>(1), null);
     ...
     */
    public DasComponentFeature addSubComponent(String componentFeatureId, int startCoordinateOnSegment, int stopCoordinateOnSegment, int startCoordinateOnComponent, int stopCoordinateOnComponent, String componentFeatureLabel, String componentTypeId, String componentTypeLabel, String targetSegmentId, String componentTargetLabel, String componentMethodId, String componentMethodLabel, Double componentScore, DasFeatureOrientation componentOrientation, DasPhase componentPhase, Collection<String> componentNotes, Map<URL, String> componentLinks) throws DataSourceException {
        if (subComponents == null) {
            subComponents = new ArrayList<DasComponentFeature>();
        }
        DasComponentFeature newSubComponent = new DasComponentFeature(componentFeatureId, componentFeatureLabel, targetSegmentId, componentTargetLabel, startCoordinateOnComponent, stopCoordinateOnComponent, componentTypeId, "component", componentTypeLabel, componentMethodId, componentMethodLabel, startCoordinateOnSegment, stopCoordinateOnSegment, componentScore, componentOrientation, componentPhase, componentNotes, componentLinks);
     ...
     * @throws DataSourceException
     */
    public DasComponentFeature addSuperComponent(String componentFeatureId, int startCoordinateOnSegment, int stopCoordinateOnSegment, int startCoordinateOnComponent, int stopCoordinateOnComponent, String componentFeatureLabel, String componentTypeId, String componentTypeLabel, String targetSegmentId, String componentTargetLabel, String componentMethodId, String componentMethodLabel, Double componentScore, DasFeatureOrientation componentOrientation, DasPhase componentPhase, Collection<String> componentNotes, Map<URL, String> componentLinks) throws DataSourceException {
        if (superComponents == null) {
            superComponents = new ArrayList<DasComponentFeature>();
        }
        DasComponentFeature newSuperComponent = new DasComponentFeature(componentFeatureId, componentFeatureLabel, targetSegmentId, componentTargetLabel, startCoordinateOnComponent, stopCoordinateOnComponent, componentTypeId, "supercomponent", componentTypeLabel, componentMethodId, componentMethodLabel, startCoordinateOnSegment, stopCoordinateOnSegment, componentScore, componentOrientation, componentPhase, componentNotes, componentLinks);
