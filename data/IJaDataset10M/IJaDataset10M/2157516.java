...
public class CreateCommandAdapter implements IUpdateCommand {
    ...
    @Override
    public ICommand builder(IAlbianObject object, IRoutingsAttribute routings, IAlbianObjectAttribute albianObject, Map<String, Object> mapValue, IRoutingAttribute routing) {
        ...
        if (null != routings && null != routings.getHashMapping()) {
            tableName = routings.getHashMapping().mappingWriterTable(routing, object);
        }
        ...
        sqlText.append(" (").append(cols).append(") ").append("VALUES (").append(paras).append(") ");
