...
public final class AOneReferenceReferenceTypeListUshr extends PReferenceTypeListUshr {
    ...
    @Override
    public Object clone() {
        return new AOneReferenceReferenceTypeListUshr(cloneNode(this._identifier_), cloneList(this._additionalIdentifiers_), cloneList(this._typeComponents_), cloneNode(this._typeArgumentsUshrNoGtGt_));
    }
    ...
    public String toString() {
        return "" + toString(this._identifier_) + toString(this._additionalIdentifiers_) + toString(this._typeComponents_) + toString(this._typeArgumentsUshrNoGtGt_);
    }
