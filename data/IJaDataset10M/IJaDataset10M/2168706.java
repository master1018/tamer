...
public class Phenotype extends MarshallableObject implements Element, IdentifiableElement {
    ...
    public void marshal(Marshaller m) throws IOException {
        ...
        if (_Frequency != null) {
            w.attribute("frequency", _Frequency.toString());
        }
    ...
    public void unmarshal(Unmarshaller u) throws UnmarshalException {
        ...
        while (xs.atAttribute()) {
            ...
            if (an.equals("frequency")) {
                if (_Frequency != null) {
                    throw new DuplicateAttributeException(an);
                }
                _Frequency = xs.takeAttributeValue();
                continue;
            }
        ...
        xs.takeEnd("Phenotype");
    }

    public static Phenotype unmarshal(InputStream in) throws UnmarshalException {
        return unmarshal(XMLScanner.open(in));
    }

    public static Phenotype unmarshal(XMLScanner xs) throws UnmarshalException {
        return unmarshal(xs, newDispatcher());
    }

    public static Phenotype unmarshal(XMLScanner xs, Dispatcher d) throws UnmarshalException {
        return ((Phenotype) d.unmarshal(xs, (Phenotype.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof Phenotype)) {
            return false;
        }
        Phenotype tob = ((Phenotype) ob);
        if (_Id != null) {
            if (tob._Id == null) {
                return false;
            }
        ...
        if (_Frequency != null) {
            if (tob._Frequency == null) {
                return false;
            }
            if (!_Frequency.equals(tob._Frequency)) {
                return false;
            }
        } else {
            if (tob._Frequency != null) {
    ...
    public int hashCode() {
        ...
        h = ((127 * h) + ((_Frequency != null) ? _Frequency.hashCode() : 0));
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<Phenotype");
        if (_Id != null) {
            sb.append(" id=");
