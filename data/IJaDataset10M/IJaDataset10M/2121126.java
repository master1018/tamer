...
public class SceneLinkSearchHelper extends AEObjectSearchHelper {
    ...
    public List<EStructuralFeature> getSearchableFeatures() {
        ...
        features.add(ExhibitionPackage.Literals.LINK__TITLE);
        features.add(ExhibitionPackage.Literals.LINK__DESCRIPTION);
        return features;
    }
