package org.amadeus.audiocustominfo.mp3.id3;

import org.amadeus.audiocustominfo.mp3.AbstractMP3Tag;
import org.amadeus.audiocustominfo.mp3.InvalidTagException;
import org.amadeus.audiocustominfo.mp3.MP3File;
import org.amadeus.audiocustominfo.mp3.TagConstant;
import org.amadeus.audiocustominfo.mp3.TagException;
import org.amadeus.audiocustominfo.mp3.TagNotFoundException;
import org.amadeus.audiocustominfo.mp3.filename.FilenameTag;
import org.amadeus.audiocustominfo.mp3.lyrics3.AbstractLyrics3;
import org.amadeus.audiocustominfo.mp3.lyrics3.Lyrics3v2;
import org.amadeus.audiocustominfo.mp3.lyrics3.Lyrics3v2Field;
    ...
    public ID3v2_4(final AbstractMP3Tag mp3tag) {
        if (mp3tag != null) {
            if (mp3tag instanceof AbstractID3v2) {
                ...
                if (id3tag.genre >= 0) {
                    final String genre = "(" + Byte.toString(id3tag.genre) + ") " + TagConstant.genreIdToString.get(new Long(id3tag.genre));
    ...
    public void read(final RandomAccessFile file) throws TagException, IOException {
        ...
        if (this.extended) {
            ...
            if (this.tagRestriction) {
                ...
                this.textEncodingRestriction = (byte) ((buffer[0] & TagConstant.MASK_V24_TEXT_ENCODING_RESTRICTIONS) >> 5);
                this.textFieldSizeRestriction = (byte) ((buffer[0] & TagConstant.MASK_V24_TEXT_FIELD_SIZE_RESTRICTIONS) >> 3);
