...
public class WordListTest {
    ...
    public void skipHighCharacters() throws Exception {
        ...
        Assert.assertEquals("first word", "AB", word1);
        Assert.assertEquals("second word", "BC", word2);
        Assert.assertEquals("hasNext at start", true, hasNextAtStart);
        Assert.assertEquals("hasNext at end", false, hasNextAtEnd);
    }
    ...
    public void comeBackForHigherCharacters() throws Exception {
        ...
        Assert.assertEquals("first word", "BC", word1);
        Assert.assertEquals("second word", "AD", word2);
    }
    ...
    public void nextPastEnd() throws Exception {
        ...
        Assert.assertEquals("message", null, msg);
    }

    private RankFinder createRankFinder() {
        MockRankReader characterReader = new MockRankReader("A", "B", "C", "D", "E", "F");
