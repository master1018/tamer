...
import gov.sns.tools.swing.KeyValueFilteredTableModel;
...
public class RunController {
    ...
    /** file watcher */
    private final FileWatcher FILE_WATCHER;

    /** table of applications that can be run */
    private final JTable APP_TABLE;

    /** table model for displaying the applications */
    private final KeyValueFilteredTableModel<App> APP_TABLE_MODEL;

    /** filter field */
    private final JTextField FILTER_FIELD;
    ...
    public RunController(final LaunchModel model, final WindowReference windowReference) {
        ...
        APP_TABLE.getColumnModel().getColumn(2).setPreferredWidth(300);
        refreshView();
    }
