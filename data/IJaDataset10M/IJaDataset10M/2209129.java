...
public class RemoveConsiderHistoryItem extends HistoryItem {
    ...
    protected static final Logger logger = Logger.getLogger(RemoveConsiderHistoryItem.class);
    ...
    public RemoveConsiderHistoryItem(ObsoletableObject target, ObsoletableObject consider) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof RemoveConsiderHistoryItem)) return false;
        RemoveConsiderHistoryItem item = (RemoveConsiderHistoryItem) o;
        return ObjectUtil.equals(item.getConsider(), consider) && ObjectUtil.equals(item.getTarget(), target);
    }
