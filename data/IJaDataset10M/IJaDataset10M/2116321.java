...
public class HelpPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        btnPanel.add(new HelpLinkButton("Syntax Help", "http://www.stockscanpro.com/help"));
        btnPanel.add(new HelpLinkButton("Video Tutorial", "http://www.chartsy.org/support/tutorial/3"));
        btnPanel.add(new HelpLinkButton("Support", "http://www.stockscanpro.com/support"));
        ...
        SpringUtilities.makeCompactGrid(listPanel, listPanel.getComponentCount(), 1, 5, 5, 5, 5);
    ...
    class HelpList extends JList {
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (rowHeight > 0) nRows = height / rowHeight; else {
        ...
        class HelpListRenderer extends JLabel implements ListCellRenderer {
            ...
            public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                if (!isSelected && drawStripes) setBackground(rowColors[index & 1]);
                if (isSelected) {
        ...
        public ListCellRenderer getCellRenderer() {
            ...
            if (wrapper == null) wrapper = new HelpListRenderer();
            wrapper.ren = ren;
            return wrapper;
        }
    ...
    class HelpListModel extends AbstractListModel {
        ...
        public HelpListModel() {
            ...
            String[] indicators = NbBundle.getMessage(HelpList.class, "LST_Indicators").split(":");
            for (String indicator : indicators) {
                String usage = NbBundle.getMessage(HelpList.class, "FCT_" + indicator);
                String url = NbBundle.getMessage(HelpList.class, "URL_" + indicator);
