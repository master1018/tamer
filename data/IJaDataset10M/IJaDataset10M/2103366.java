...
public class ImprimeOrc extends ImprimeLayout {
    ...
    private void montaRel() {
        ...
        try {
            ...
            Funcoes.mensagemErro(this, "Erro ao montar o relat�rio!!!\n" + err.getMessage(), true, con, err);
        }
    }
    ...
    private void montaCab(ResultSet rs) {
        ...
        try {
            ...
            setFonte(fnCabCli);
            if (rs.getString("PRAZOENTORC") == null) drawTexto("� Combinar.", 470, 120); else drawTexto(rs.getString("PRAZOENTORC") + " dias.", 470, 120);
            iY += 5;
