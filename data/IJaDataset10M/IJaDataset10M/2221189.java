...
public final class HGAtomAttrib {
    ...
    static class Converter implements ByteArrayConverter<HGAtomAttrib> {
        ...
        static long getLong(byte[] src, int offset) {
            return (((long) src[offset] << 56) + ((long) (src[offset + 1] & 255) << 48) + ((long) (src[offset + 2] & 255) << 40) + ((long) (src[offset + 3] & 255) << 32) + ((long) (src[offset + 4] & 255) << 24) + ((src[offset + 5] & 255) << 16) + ((src[offset + 6] & 255) << 8) + ((src[offset + 7] & 255) << 0));
        }
