...
public class LocalizablesTest extends TestCase {
    ...
    private static final String[] STRINGS_ARRAY = new String[] { "Ändern", "Andere", "Aber", "Baden", "Auf", "ändern", "andere", "aber", "baden", "auf" };

    private static final String[] EXPECTED_STRINGS_ARRAY_DEFAULT = new String[] { "aber", "Aber", "andere", "Andere", "ändern", "Ändern", "auf", "Auf", "baden", "Baden" };

    private static final String[] EXPECTED_STRINGS_ARRAY_SECONDARY = new String[] { "Aber", "aber", "Andere", "andere", "Ändern", "ändern", "Auf", "auf", "Baden", "baden" };

    private static final List<String> STRINGS_LIST = Arrays.asList(STRINGS_ARRAY);

    private static final List<String> EXPECTED_STRINGS_LIST_DEFAULT = Arrays.asList(EXPECTED_STRINGS_ARRAY_DEFAULT);

    private static final List<String> EXPECTED_STRINGS_LIST_SECONDARY = Arrays.asList(EXPECTED_STRINGS_ARRAY_SECONDARY);

    private static final LocalizedString[] LOCALIZED_STRINGS_ARRAY = getLocalizedStringArray(STRINGS_ARRAY);

    private static final LocalizedString[] EXPECTED_LOCALIZED_STRINGS_ARRAY_DEFAULT = getLocalizedStringArray(EXPECTED_STRINGS_ARRAY_DEFAULT);

    private static final LocalizedString[] EXPECTED_LOCALIZED_STRINGS_ARRAY_SECONDARY = getLocalizedStringArray(EXPECTED_STRINGS_ARRAY_SECONDARY);

    private static final List<LocalizedString> LOCALIZED_STRINGS_LIST = Arrays.asList(LOCALIZED_STRINGS_ARRAY);

    private static final List<LocalizedString> EXPECTED_LOCALIZED_STRINGS_LIST_DEFAULT = Arrays.asList(EXPECTED_LOCALIZED_STRINGS_ARRAY_DEFAULT);

    private static final List<LocalizedString> EXPECTED_LOCALIZED_STRINGS_LIST_SECONDARY = Arrays.asList(EXPECTED_LOCALIZED_STRINGS_ARRAY_SECONDARY);
    ...
    public void testSort_Locale_LocalizableArr() {
        ...
        assertTrue(Arrays.equals(EXPECTED_LOCALIZED_STRINGS_ARRAY_DEFAULT, localizables));
    }
    ...
    public void testSort_LocalizableCollator_LocalizableArr() {
        ...
        Localizables.sort(collator, localizables);
        assertTrue(Arrays.equals(EXPECTED_LOCALIZED_STRINGS_ARRAY_SECONDARY, localizables));
    }
    ...
    public void testSort_3args_1() {
        ...
        assertTrue(Arrays.equals(EXPECTED_STRINGS_ARRAY_DEFAULT, strings));
    }
    ...
    public void testSort_3args_2() {
        ...
        collator.getCollator().setStrength(Collator.SECONDARY);
        Localizables.sort(new StringLocalizer(), collator, strings);
        assertTrue(Arrays.equals(EXPECTED_STRINGS_ARRAY_SECONDARY, strings));
    }
    ...
    private static LocalizedString[] getLocalizedStringArray(String... localizedStrings) {
        LocalizedString[] localizedStringArray = new LocalizedString[localizedStrings.length];
    ...
    private static LocalizedString[] getLocalizedTestStringArray() {
        return Arrays.copyOf(LOCALIZED_STRINGS_ARRAY, LOCALIZED_STRINGS_ARRAY.length);
    }
    ...
    private static class LocalizedString implements Localizable, Comparable<String> {
        ...
        public boolean equals(Object obj) {
            ...
            return (localizedString == other.localizedString || (localizedString != null && localizedString.equals(other.localizedString)));
        }
