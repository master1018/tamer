...
public class FTarefa extends FTabDados implements RadioGroupListener, InsertListener, CarregaListener, FocusListener {
    ...
    private JCheckBoxPad cbLanctoTarefa = new JCheckBoxPad("Lan�amentos na tarefa?", "S", "N");
    ...
    private void montaListaCampos() {
        ...
        lcMarc.add(new GuardaCampo(txtCodMarcor, "CodMarcor", "C�d.Marcador", ListaCampos.DB_PK, false));
        lcMarc.add(new GuardaCampo(txtDescMarcor, "DescMarcor", "Descri��o do Marcador", ListaCampos.DB_SI, false));
        ...
        lcSuperTarefa.add(new GuardaCampo(txtCodTarefaPrinc, "CodTarefa", "C�d.Tarefa", ListaCampos.DB_PK, txtDescTarefaPrinc, false));
        lcSuperTarefa.add(new GuardaCampo(txtDescTarefaPrinc, "DescTarefa", "Descri��o da tarefa", ListaCampos.DB_SI, false));
        ...
        lcTarefaPrev.add(new GuardaCampo(txtCodTarefaPrev, "CodTarefa", "C�d.Tarefa.", ListaCampos.DB_PK, txtDescTarefaPrev, false));
        lcTarefaPrev.add(new GuardaCampo(txtDescTarefaPrev, "DescTarefa", "Descri��o da tarefa", ListaCampos.DB_SI, false));
        lcTarefaPrev.add(new GuardaCampo(txtIndexTarefaPrev, "IndexTarefa", "�ndice da tarefa", ListaCampos.DB_SI, false));
    ...
    private void montaTela() {
        ...
        adicCampo(txtCodTarefa, 7, 20, 80, 20, "CodTarefa", "C�d.tarefa.", ListaCampos.DB_PK, true);
        adicCampo(txtDescTarefa, 90, 20, 520, 20, "DescTarefa", "Descri��o da Tarefa", ListaCampos.DB_SI, true);
        adicDB(rgTipoTarefa, 7, 63, 200, 25, "TipoTarefa", "Tipo de tarefa", true);
        adicCampo(txtCodTarefaPrinc, 210, 63, 80, 20, "CodTarefata", "C�d.tarefa.Princ", ListaCampos.DB_FK, txtDescTarefaPrinc, false);
        adicDescFK(txtDescTarefaPrinc, 293, 63, 317, 20, "DescTarefa", "Descri��o do projeto principal");
        adicCampo(txtCodContr, 7, 110, 80, 20, "CodContr", "C�d.Contrato", ListaCampos.DB_FK, true);
        adicDescFK(txtDescContr, 90, 110, 520, 20, "DescContr", "Descri�o do contrato");
        adicCampo(txtCodItContr, 7, 150, 80, 20, "CodItContr", "C�d.It.Contr.", ListaCampos.DB_FK, txtDescItContr, true);
        adicDescFK(txtDescItContr, 90, 150, 467, 20, "DescItContr", "Descri��o do item de contrato");
        adicCampo(txtIndexTarefa, 560, 150, 50, 20, "IndexTarefa", "�ndice", ListaCampos.DB_SI, true);
        adicCampo(txtCodChamado, 7, 190, 80, 20, "Codchamado", "C�d.Chamado", ListaCampos.DB_FK, txtDescChamado, false);
        adicDescFK(txtDescChamado, 90, 190, 520, 20, "Descchamado", "Descri��o do chamado");
        adicCampo(txtCodMarcor, 7, 230, 80, 20, "CodMarcor", "C�d.Marcador", ListaCampos.DB_FK, txtDescMarcor, false);
        adicDescFK(txtDescMarcor, 90, 230, 310, 20, "Descmarcor", "Descri��o do marcador");
        ...
        adicDB(txaDescDetTarefa, 7, 300, 603, 80, "DescDetTarefa", "Descri��o Detalhada da tarefa", true);
        ...
        adicCampo(txtMesTPer, 7, 20, 80, 20, "MesTPer", "M�s", ListaCampos.DB_PK, true);
        ...
        adicDescFK(txtCodTarefaPrev, 7, 20, 80, 20, "CodTarefa", "C�d.tarefa");
        adicDescFK(txtDescTarefaPrev, 90, 20, 520, 20, "DescTarefa", "Descri��o da tarefa");
    ...
    private void setContratos() {
        try {
            ...
            Funcoes.mensagemErro(this, "Erro ao buscar C�digo do Contrato!\n" + e.getMessage());
            e.printStackTrace();
        }
    }
