...
public class Info extends Command {
    ...
    protected void validateAttributes() throws Exception {
        if (this.path == null) throw new Exception("path cannot be null");
        if (this.revisionProperty == null) this.revisionProperty = SVN_INFO_REVISION;
        if (this.urlProperty == null) this.urlProperty = SVN_INFO_URL;
        if (this.repositoryRootUrlProperty == null) this.repositoryRootUrlProperty = SVN_INFO_REPOSITORY_ROOT_URL;
        if (this.authorProperty == null) this.authorProperty = SVN_INFO_AUTHOR;
        if (this.committedDateProperty == null) this.committedDateProperty = SVN_INFO_COMMITTED_DATE;
        if (this.committedRevisionProperty == null) this.committedRevisionProperty = SVN_INFO_COMMITTED_REVISION;
    }
