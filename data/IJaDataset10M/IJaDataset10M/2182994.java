...
public class UserDAOTest {
    ...
    public void testExistsByLoginNameAnotherTransaction() {
        ...
        assertTrue(userDAO.existsByLoginNameAnotherTransaction(loginName.toUpperCase()));
        assertTrue(userDAO.existsByLoginNameAnotherTransaction(loginName.toLowerCase()));
    }
    ...
    private UserRole getSecondUserRole() {
        return UserRole.values().length == 1 ? UserRole.values()[0] : UserRole.values()[1];
    }
