...
public interface JFlexHighlighterColors {
    ...
    TextAttributesKey COMMENT = TextAttributesKey.createTextAttributesKey("JFLEX.COMMENT", SyntaxHighlighterColors.JAVA_BLOCK_COMMENT.getDefaultAttributes());

    TextAttributesKey STRING = TextAttributesKey.createTextAttributesKey("JFLEX.STRING", SyntaxHighlighterColors.STRING.getDefaultAttributes());

    TextAttributesKey COMMA = TextAttributesKey.createTextAttributesKey("JFLEX_COMMA", SyntaxHighlighterColors.COMMA.getDefaultAttributes());

    TextAttributesKey OPERATION_SIGN = TextAttributesKey.createTextAttributesKey("JFLEX_OPERATION_SIGN", SyntaxHighlighterColors.OPERATION_SIGN.getDefaultAttributes());

    TextAttributesKey BRACES = TextAttributesKey.createTextAttributesKey("JFLEX_BRACES", SyntaxHighlighterColors.BRACES.getDefaultAttributes());

    TextAttributesKey BRACKETS = TextAttributesKey.createTextAttributesKey("JFLEX_BRACES", SyntaxHighlighterColors.BRACKETS.getDefaultAttributes());

    TextAttributesKey ANGLE_BRACKETS = TextAttributesKey.createTextAttributesKey("JFLEX_ANGLE_BRACKETS", SyntaxHighlighterColors.BRACKETS.getDefaultAttributes());

    TextAttributesKey PARENTHS = TextAttributesKey.createTextAttributesKey("JFLEX_PARENTHS", SyntaxHighlighterColors.PARENTHS.getDefaultAttributes());
    ...
    TextAttributesKey OPTION_KEYWORD = TextAttributesKey.createTextAttributesKey("JFLEX.OPTION_KEYWORD", new TextAttributes(new Color(0, 0, 0xff), null, null, null, Font.BOLD));
