...
public class CCPaymentServices {
    ...
    public static Map ccAuth(DispatchContext dctx, Map context) {
        ...
        Document authRequestDoc = buildPrimaryTxRequest(context, ccAction, (Double) context.get("processAmount"), (String) context.get("orderId"));
    ...
    public static Map ccCapture(DispatchContext dctx, Map context) {
        ...
        Document captureRequestDoc = buildSecondaryTxRequest(context, authTransaction.getString("referenceNum"), "PostAuth", (Double) context.get("captureAmount"));
    ...
    public static Map ccReAuth(DispatchContext dctx, Map context) {
        ...
        Document reauthRequestDoc = buildSecondaryTxRequest(context, authTransaction.getString("referenceNum"), "RePreAuth", (Double) context.get("reauthAmount"));
