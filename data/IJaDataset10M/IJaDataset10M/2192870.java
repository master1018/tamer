...
public class NetworkDescriptor implements Descriptor {
    ...
    public void removeRelationships(AgentDescriptor descriptor) {
        for (RelationshipDescriptor relationship : new ArrayList<RelationshipDescriptor>(relationships)) {
            if (relationship.getSource().equals(descriptor) || relationship.getTarget().equals(descriptor)) {
