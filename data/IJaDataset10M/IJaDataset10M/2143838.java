...
public class ExtendedJTableSorterModel extends AbstractTableModel {
    ...
    public int modelIndex(int viewIndex) {
        if ((viewIndex >= 0) && (viewIndex < getViewToModel().length)) return getViewToModel()[viewIndex].modelIndex; else return viewIndex;
    }
    ...
    private class TableModelHandler implements TableModelListener {
        ...
        public void tableChanged(TableModelEvent e) {
            ...
            if (e.getFirstRow() == e.getLastRow() && column != TableModelEvent.ALL_COLUMNS && getSortingStatus(column) == NOT_SORTED && modelToView != null) {
                ...
                fireTableChanged(new TableModelEvent(ExtendedJTableSorterModel.this, viewIndex, viewIndex, column, e.getType()));
                return;
            }
            clearSortingState();
            fireTableDataChanged();
