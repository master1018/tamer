...
public final class TCPLimeReceivedPongs extends AbstractMessageGraphPaneItem {
    ...
    public TCPLimeReceivedPongs(final String key) {
        super(key);
        registerStatistic(ReceivedMessageStat.TCP_PING_REPLIES, GUIMediator.getStringResource("STATS_ALL_CLIENTS"));
        registerStatistic(LimeReceivedMessageStat.TCP_PING_REPLIES, GUIMediator.getStringResource("STATS_LIMEWIRE"));
    }
}
