...
public class JTableProUI extends BasicTableUI {
    ...
    private void paintRow(Graphics g, int row) {
        ...
        boolean drawn = false;
        JTableProModel tableModel = (JTableProModel) table.getModel();
    ...
    private void paintCell(Graphics g, Rectangle cellRect, int row, int column) {
        ...
        g.drawRect(cellRect.x, cellRect.y, cellRect.width - 1, 1);
        g.setColor(c);
