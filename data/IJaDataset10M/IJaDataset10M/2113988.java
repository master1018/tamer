...
public class SenseEvalDependencyCorpusReader implements CorpusReader<Document> {
    ...
    public Iterator<Document> read(Reader docReader) {
        try {
            ...
            org.w3c.dom.Document currentXmlDoc = db.parse(new InputSource(docReader));
            return new SenseEvalIterator(currentXmlDoc.getElementsByTagName("instance"));
    ...
    public class SenseEvalIterator implements Iterator<Document> {
        ...
        protected String advance() {
            if (currentNodeIndex >= instances.getLength()) return null;
