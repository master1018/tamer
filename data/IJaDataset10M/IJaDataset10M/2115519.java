...
public class NSDate extends Date implements NSCoding {
    ...
    public NSDate laterDate(NSDate date) {
        ...
        if (before(date)) return date;
        return this;
    }

    public int compare(NSDate date) {
        if (before(date)) return NSOrderedAscending;
        if (after(date)) return NSOrderedDescending;
    ...
    public boolean equals(Object paramObject) {
        if (paramObject instanceof NSDate) return isEqualToDate((NSDate) paramObject);
