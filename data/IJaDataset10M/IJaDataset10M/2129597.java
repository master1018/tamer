...
public class CargoUpdaterTest {
    ...
    public void updateCargo() throws CannotCreateHandlingEventException {
        ...
        HandlingEvent handlingEvent = handlingEventFactory.createHandlingEvent(toDate("2009-10-01", "14:30"), cargo.trackingId(), HONGKONG_TO_NEW_YORK.voyageNumber(), HONGKONG.unLocode(), LOAD, new OperatorCode("ABCDE"));
