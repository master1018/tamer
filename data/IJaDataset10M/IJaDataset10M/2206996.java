...
public interface ModifiableGraph extends InspectableGraph, PositionalContainer {
   ...
   * to this graph
   */
    public Vertex splitEdge(Edge e, Object vertElement) throws InvalidAccessorException;
   ...
   * @return the new edge
   */
    public Edge unsplitEdge(Vertex v, Object edgeElement) throws InvalidAccessorException, InvalidVertexException;
   ...
   */
    public void setDirectionFrom(Edge e, Vertex v) throws InvalidAccessorException, InvalidVertexException;
   ...
   * <code>v</code> does not belong to this graph
   */
    public void setDirectionTo(Edge e, Vertex v) throws InvalidAccessorException, InvalidVertexException;
   ...
   * to this graph
   */
    public void reverseDirection(Edge e) throws InvalidEdgeException, InvalidAccessorException;
}
