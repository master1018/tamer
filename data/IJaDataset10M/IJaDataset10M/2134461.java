...
public class DSAKeyValueTypeSequence2 implements java.io.Serializable {
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (obj instanceof DSAKeyValueTypeSequence2) {
            ...
            } else if (temp._seed != null) return false;
            ...
            } else if (temp._pgenCounter != null) return false;
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int result = 17;
        long tmp;
        if (_seed != null && !org.castor.core.util.CycleBreaker.startingToCycle(_seed)) {
            result = 37 * result + _seed.hashCode();
            org.castor.core.util.CycleBreaker.releaseCycleHandle(_seed);
        }
        if (_pgenCounter != null && !org.castor.core.util.CycleBreaker.startingToCycle(_pgenCounter)) {
     ...
     */
    public static org.w3.www._2000._09.xmldsig.DSAKeyValueTypeSequence2 unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
