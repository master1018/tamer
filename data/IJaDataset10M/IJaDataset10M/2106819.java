...
public class DataTable {
    ...
    public static final DataTable GH_TOP_SCORES = new DataTable(3, 2, 8, "-|text~link=songid|text=int|img=rating~text=float|text=int|text=int|text|span"), GH_MANAGE_SCORES = new DataTable(3, 4, 11, "-|text=int|link=songid~text|-|-|text=int~link=picvid,picvid|img=rating~text=float|text=int|text=int|text|span"), GH_MANAGE_SCORES_SINGLE_PLAT = new DataTable(3, 3, 10, "-|text=int|link=songid~text|-|text=int~link=picvid,picvid|img=rating~text=float|text=int|text=int|text|span"), GH_STAR_CUTOFFS = new DataTable(3, 2, 7, "link=songid|-|text|text=int,-,int|text=int|text=int|text"), GH_TOTAL_NOTES = new DataTable(3, 2, 6, "link=songid|-|text|text=int|-|-"), GH_ALL_CUTOFFS = new DataTable(3, 2, 8, "text|text=int|text=int|text=int|text=int|text=int|text=int|text=int"), GH_DELETE_SCORES = new DataTable(-1, -1, 6, "input|text=int|img=rating~text=float|text=int|text=int|text") {
        ...
        public NodeFilter[] getFilters() {
            if (null == filters) {
                ...
                NodeFilter[] array0 = new NodeFilter[] { filter0, filter1, filter2 };
                AndFilter filter3 = new AndFilter();
                filter3.setPredicates(array0);
                HasParentFilter filter4 = new HasParentFilter();
                filter4.setRecursive(false);
    ...
    public static final TableRowFormat TIER_ROW_FORMAT = TableRowFormat.factory("text|-");
    ...
    public DataTable(final int tierColspan, final int tierChildNodeCount, final int rowChildNodeCount, final String rowFormat) {
        this(null, tierColspan, tierChildNodeCount, rowChildNodeCount, rowFormat);
    }

    public DataTable(final String headerCssClass, final int tierColspan, final int tierChildNodeCount, final int rowChildNodeCount, final String rowFormat) {
