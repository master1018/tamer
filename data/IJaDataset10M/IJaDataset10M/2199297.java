...
public class RepaintManager {
   ...
   */
    protected class RepaintWorker implements Runnable {
   ...
   */
     ...
     */
        public int compare(Object o1, Object o2) {
            ...
            } else throw new ClassCastException("This comparator can only be used with " + "JComponents");
        }
   ...
   */
    public static RepaintManager currentManager(Component component) {
        if (currentRepaintManagers == null) currentRepaintManagers = new WeakHashMap();
        ThreadGroup threadGroup = Thread.currentThread().getThreadGroup();
   ...
   */
    public synchronized void addInvalidComponent(JComponent component) {
        ...
        while (ancestor != null && (!(ancestor instanceof JComponent) || !((JComponent) ancestor).isValidateRoot())) ancestor = ancestor.getParent();
        if (ancestor != null && ancestor instanceof JComponent && ((JComponent) ancestor).isValidateRoot()) component = (JComponent) ancestor;
        if (invalidComponents.contains(component)) return;
   ...
   */
    public synchronized void addDirtyRegion(JComponent component, int x, int y, int w, int h) {
        if (w == 0 || h == 0 || !component.isShowing()) return;
        Rectangle r = new Rectangle(x, y, w, h);
        if (dirtyComponents.containsKey(component)) r = r.union((Rectangle) dirtyComponents.get(component)); else insertInRepaintOrder(component);
   ...
   */
    public Rectangle getDirtyRegion(JComponent component) {
        ...
        if (dirty == null) dirty = new Rectangle();
        return dirty;
    }
   ...
   */
    public boolean isCompletelyDirty(JComponent component) {
        if (!dirtyComponents.containsKey(component)) return false;
   ...
   */
    public void validateInvalidComponents() {
        ...
        for (Iterator i = workInvalidComponents.iterator(); i.hasNext(); ) {
            ...
            while ((!(comp instanceof JComponent) || !((JComponent) comp).isValidateRoot()) && comp.getParent() != null) comp = comp.getParent();
   ...
   */
    public Image getOffscreenBuffer(Component component, int proposedWidth, int proposedHeight) {
        if (doubleBuffer == null || (((doubleBuffer.getWidth(null) < proposedWidth) || (doubleBuffer.getHeight(null) < proposedHeight)) && (proposedWidth < doubleBufferMaximumSize.width) && (proposedHeight < doubleBufferMaximumSize.height))) {
