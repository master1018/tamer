...
public class NormalFontSDL {
    ...
    /** 文字色の定count */
    public static final int COLOR_WHITE = 0, COLOR_BLUE = 1, COLOR_RED = 2, COLOR_PINK = 3, COLOR_GREEN = 4, COLOR_YELLOW = 5, COLOR_CYAN = 6, COLOR_ORANGE = 7, COLOR_PURPLE = 8, COLOR_DARKBLUE = 9;
    ...
    public static SDLColor getFontColorAsSDLColor(int fontColor) {
        switch(fontColor) {
            ...
            case COLOR_RED:
                return new SDLColor(255, 0, 0);
            case COLOR_PINK:
                return new SDLColor(255, 128, 128);
            case COLOR_GREEN:
                return new SDLColor(0, 255, 0);
            case COLOR_YELLOW:
                return new SDLColor(255, 255, 0);
            case COLOR_CYAN:
                return new SDLColor(0, 255, 255);
            case COLOR_ORANGE:
                return new SDLColor(255, 128, 0);
            case COLOR_PURPLE:
                return new SDLColor(255, 0, 255);
            case COLOR_DARKBLUE:
                return new SDLColor(0, 0, 128);
        }
    ...
    public static void printFont(int fontX, int fontY, String fontStr, boolean flag, int fontColorFalse, int fontColorTrue) throws SDLException {
        if (!flag) printFont(fontX, fontY, fontStr, fontColorFalse); else printFont(fontX, fontY, fontStr, fontColorTrue);
    }
    ...
    public static void printFont(int fontX, int fontY, String fontStr, boolean flag, int fontColorFalse, int fontColorTrue, float scale) throws SDLException {
        if (!flag) printFont(fontX, fontY, fontStr, fontColorFalse, scale); else printFont(fontX, fontY, fontStr, fontColorTrue, scale);
    }
