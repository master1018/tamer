...
public class xBplusTree extends BplusTree {
    ...
    public static BplusTree Initialize(String treefileName, String blockfileName, int PrefixLength, int CultureId, int nodesize, int buffersize) throws Exception {
    ...
    public static BplusTree Initialize(String treefileName, String blockfileName, int PrefixLength, int CultureId) throws Exception {
    ...
    public static BplusTree Initialize(java.io.RandomAccessFile treefile, java.io.RandomAccessFile blockfile, int PrefixLength, int CultureId, int nodesize, int buffersize) throws Exception {
        xBplusTreeBytes tree = xBplusTreeBytes.Initialize(treefile, blockfile, PrefixLength, CultureId, nodesize, buffersize);
        return new xBplusTree(tree);
    }

    public static BplusTree Initialize(java.io.RandomAccessFile treefile, java.io.RandomAccessFile blockfile, int PrefixLength, int CultureId) throws Exception {
        xBplusTreeBytes tree = xBplusTreeBytes.Initialize(treefile, blockfile, PrefixLength, CultureId);
        return new xBplusTree(tree);
    }

    public static BplusTree Initialize(java.io.RandomAccessFile treefile, java.io.RandomAccessFile blockfile, int KeyLength) throws Exception {
