...
public class CompositeKeywordFactoryIntegrationTest extends MockObjectTestCase {
    ...
    private KeywordFactory createMockKeywordFactoryWithOneKeyword(String keywordName, Keyword keyword) {
        ...
        mockKeywordFactory.stubs().method("getKeywordNames").will(returnValue(new String[] { keywordName }));
        mockKeywordFactory.stubs().method("createKeyword").with(eq(keywordName)).will(returnValue(keyword));
