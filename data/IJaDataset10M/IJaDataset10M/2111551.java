...
public class ChargingLog {
    ...
    public void addChargingLog(String linkId, String agentId, double startChargingTime, double endChargingTime, double startSOC, double endSOC) {
...
class ChargingLogRow {
    ...
    public ChargingLogRow(String linkId, String agentId, double startChargingTime, double endChargingTime, double startSOCInJoule, double endSOCInJoule) {
        this.linkId = linkId;
