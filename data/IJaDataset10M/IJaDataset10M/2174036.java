...
public class Trainer {
     ...
     */
    public static final String PROP_PREFIX = "edu.cmu.sphinx.trainer.Trainer.";

    /**
     * The SphinxProperty name for the initial trainer stage to be processed.
     */
    public static final String PROP_INITIAL_STAGE = PROP_PREFIX + "initialStage";

    /**
     * Default initial stage.
     */
    public static final String PROP_INITIAL_STAGE_DEFAULT = "_00_INITIALIZATION";

    /**
     * The SphinxProperty name for the final trainer stage to be processed.
     */
    public static final String PROP_FINAL_STAGE = PROP_PREFIX + "finalStage";

    /**
     * Default final stage.
     */
    public static final String PROP_FINAL_STAGE_DEFAULT = "_40_TIED_CD_TRAIN";
    ...
    private void init(SphinxProperties props) {
        ...
        initialStage = props.getString(PROP_INITIAL_STAGE, PROP_INITIAL_STAGE_DEFAULT);
        finalStage = props.getString(PROP_FINAL_STAGE, PROP_FINAL_STAGE_DEFAULT);
    ...
    private void processStages(String context) {
        if (!(StageNames.contains(initialStage) && StageNames.contains(finalStage))) {
            return;
        }
    ...
    public static void main(String[] argv) {
        if (argv.length < 1) {
            System.out.println("Usage: Trainer propertiesFile");
            System.exit(1);
        }
