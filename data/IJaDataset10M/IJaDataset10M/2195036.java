...
public class PVehicle extends Vehicle {
    ...
    public void sendMessage(Message m, SimUnit targetUnit, double messageArrivalTime, int zoneId, boolean ownsZone) {
    ...
    public void _scheduleEnterRoadMessage(double scheduleTime, Road road) {
        sendMessage(MessageFactory.getEnterRoadMessage(scheduler, this), road, scheduleTime, currentZoneId, ownsCurrentZone);
    }

    public void scheduleEndRoadMessage(double scheduleTime, Road road) {
        sendMessage(MessageFactory.getEndRoadMessage(scheduler, this), road, scheduleTime, currentZoneId, ownsCurrentZone);
    }

    public void scheduleLeaveRoadMessage(double scheduleTime, Road road) {
        sendMessage(MessageFactory.getLeaveRoadMessage(scheduler, this), road, scheduleTime, currentZoneId, ownsCurrentZone);
    }

    public void scheduleEndLegMessage(double scheduleTime, Road road) {
        sendMessage(MessageFactory.getEndLegMessage(scheduler, this), road, scheduleTime, currentZoneId, ownsCurrentZone);
    }

    public void scheduleStartingLegMessage(double scheduleTime, Road road) {
        sendMessage(MessageFactory.getStartingLegMessage(scheduler, this), road, scheduleTime, currentZoneId, ownsCurrentZone);
    }

    public DeadlockPreventionMessage scheduleDeadlockPreventionMessage(double scheduleTime, Road road) {
        DeadlockPreventionMessage dpMessage = MessageFactory.getDeadlockPreventionMessage(scheduler, this);
        sendMessage(dpMessage, road, scheduleTime, currentZoneId, ownsCurrentZone);
        return dpMessage;
    }
