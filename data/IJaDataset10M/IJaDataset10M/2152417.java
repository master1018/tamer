...
public class TinySegmenterTest {
    ...
    public void testTokenize() throws Exception {
        ...
        String[] terms = { "本日", "は", "晴天", "なり", "。" };
        int[][] offsets = { { 0, 2 }, { 2, 3 }, { 3, 5 }, { 5, 7 }, { 7, 8 } };
    ...
    public void testMinimalBufferSize() throws Exception {
        ...
        TinySegmenter segmenter = new TinySegmenter(cpreader, 7, TinySegmenter.DEFAULT_MAX_TOKEN_SIZE);
        TinySegmenter segmenter2 = new TinySegmenter(cpreader2, 1024, TinySegmenter.DEFAULT_MAX_TOKEN_SIZE);
        TinySegmenter.Token token;
    ...
    public void testMaxTokenSize() throws Exception {
        ...
        String[] terms = { "一日", "作", "さざ", "れ", "ば", "、", "一", "日", "食わ", "ず", "。" };
        int[][] offsets = { { 0, 2 }, { 2, 3 }, { 3, 5 }, { 5, 6 }, { 6, 7 }, { 7, 8 }, { 8, 9 }, { 9, 10 }, { 10, 12 }, { 12, 13 }, { 13, 14 } };
        TinySegmenter.Token token;
        int i = 0;
        while ((token = segmenter.next()) != null) {
            assertEquals(terms[i], token.str);
