...
public class SidewikiEntry extends BaseEntry<SidewikiEntry> {
   ...
   */
    ...
    public void declareExtensions(ExtensionProfile extProfile) {
        ...
        extProfile.declare(SidewikiEntry.class, SidewikiAuthor.getDefaultDescription(false, true));
        new SidewikiAuthor().declareExtensions(extProfile);
        extProfile.declare(SidewikiEntry.class, Source.class);
        extProfile.declare(SidewikiEntry.class, new ExtensionDescription(Rating.class, new XmlNamespace("gd", "http://schemas.google.com/g/2005"), "rating", false, false, false));
        extProfile.declare(SidewikiEntry.class, ResourceId.getDefaultDescription(true, false));
