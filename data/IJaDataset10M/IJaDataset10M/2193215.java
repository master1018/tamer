...
public class DataSourceConfig {
    ...
    public void onInitialize() throws Exception {
        ...
        if (mPool) mDataSource = DataSources.pooledDataSource(unpooled); else mDataSource = unpooled;
        mLogger.log(Level.CONFIG, "Setting up pooled DataSource:{0}, database user:{1}", new Object[] { mUrl, mUserName });
