...
public class OperationsEnginesTest extends TestCase {
    ...
    public void testXMLRead() throws JDOMException, IOException {
        ...
        Engine e1 = manager.getByRoadAndNumber("CP", "Test Number 1");
        Engine e2 = manager.getByRoadAndNumber("ACL", "Test Number 2");
        Engine e3 = manager.getByRoadAndNumber("CP", "Test Number 3");
        Engine e4 = manager.getByRoadAndNumber("PC", "Test Number 4");
        Engine e5 = manager.getByRoadAndNumber("BM", "Test Number 5");
        Engine e6 = manager.getByRoadAndNumber("SP", "Test Number 6");
