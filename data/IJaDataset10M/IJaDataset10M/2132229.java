...
@RunWith(Suite.class)
@Suite.SuiteClasses({ CommandLineTests.class, InsertModeTests.class, KeyMapTests.class, MotionTests.class, NormalModeTests.class, SimpleKeyStrokeTests.class, SnapshotTests.class, StateAndTransitionTests.class, VisualModeTests.class })
