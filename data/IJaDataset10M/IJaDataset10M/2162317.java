...
public class XBeePin {
    ...
    public enum Capability {
        ...
        DISABLED(0), RTS_FLOW_CTRL(1), CTS_FLOW_CTRL(1), RSSI_PWM(1), ASSOC_LED(1), ANALOG_INPUT(2), PWM_OUTPUT(2), DIGITAL_INPUT(3), DIGITAL_OUTPUT_LOW(4), DIGITAL_OUTPUT_HIGH(5), UNMONITORED_INPUT(0), NODE_ID_ENABLED(1), RS485_TX_LOW(6), RS485_TX_HIGH(7);
    ...
    private static final List<XBeePin> wpanPins = new ArrayList<XBeePin>();
