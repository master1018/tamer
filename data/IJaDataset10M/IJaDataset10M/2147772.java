...
public class Style {
    ...
    protected Collection<String> createAdditionalCssFiles() {
        return Arrays.asList("/xava/editors/calendar/skins/aqua/theme.css", "/xava/style/yahoo-treeview/treeview.css", getJQueryCss());
    }
	 ...
	 */
    public final Collection<String> getAdditionalCssFiles() {
