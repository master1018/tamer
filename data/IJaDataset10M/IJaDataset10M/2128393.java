...
public class GLCgFXEffect implements GLConstants {
   ...
   */
    public void setTexParameter(String param, GLTexture tex) {
        ...
        if (p != null) CgGL.cgGLSetTextureParameter(p, id); else System.err.println("GLCgFXEffect:  Cant find texture parameter");
   ...
   */
    public void setIntParameter(String param, int x) {
        CGparameter p = CgGL.cgGetNamedEffectParameter(effect, param);
        if (p != null) CgGL.cgSetParameter1i(p, x); else System.err.println("GLCgFXEffect:  param1f is null");
    }
   ...
   */
    public void setFloatParameter(String param, float x) {
        CGparameter p = CgGL.cgGetNamedEffectParameter(effect, param);
        if (p != null) CgGL.cgSetParameter1f(p, x); else System.err.println("GLCgFXEffect:  param1f is null");
    }
   ...
   */
    public void setVecParameter(String param, float x, float y) {
        CGparameter p = CgGL.cgGetNamedEffectParameter(effect, param);
        if (p != null) CgGL.cgSetParameter2f(p, x, y); else System.err.println("GLCgFXEffect:  param2f is null");
    }
   ...
   */
    public void setVecParameter(String param, float x, float y, float z) {
        CGparameter p = CgGL.cgGetNamedEffectParameter(effect, param);
        if (p != null) CgGL.cgSetParameter3f(p, x, y, z); else System.err.println("GLCgFXEffect:  param3f is null");
    }
   ...
   */
    public void setVecParameter(String param, float x, float y, float z, float w) {
        CGparameter p = CgGL.cgGetNamedEffectParameter(effect, param);
        if (p != null) CgGL.cgSetParameter4f(p, x, y, z, w); else System.err.println("GLCgFXEffect:  param4f is null");
    }
   ...
   *        ...
   */
    public void setMatParameter(String param, float m00, float m01, float m10, float m11) {
        CGparameter p = CgGL.cgGetNamedEffectParameter(effect, param);
        if (p != null) {
        ...
        } else System.err.println("GLCgFXEffect:  matrix2x2f param is null");
    }
   ...
   *        ...
   */
    public void setMatParameter(String param, float m00, float m01, float m02, float m10, float m11, float m12, float m20, float m21, float m22) {
        CGparameter p = CgGL.cgGetNamedEffectParameter(effect, param);
        if (p != null) {
            ...
            mat[10] = m22;
            CgGL.cgGLSetMatrixParameterfr(p, mat, 0);
        } else System.err.println("GLCgFXEffect:  matrix3x3f param is null");
    }
   ...
   *        ...
   */
    public void setMatParameter(String param, float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float m20, float m21, float m22, float m23, float m30, float m31, float m32, float m33) {
        CGparameter p = CgGL.cgGetNamedEffectParameter(effect, param);
        if (p != null) {
            ...
            mat[15] = m33;
            CgGL.cgGLSetMatrixParameterfr(p, mat, 0);
        } else System.err.println("GLCgFXEffect:  matrix4x4f param is null");
    }
   ...
   */
    public void setModelviewMatrix(String param) {
        CGparameter p = CgGL.cgGetNamedEffectParameter(effect, param);
        if (p != null) CgGL.cgGLSetStateMatrixParameter(p, CgGL.CG_GL_MODELVIEW_MATRIX, CgGL.CG_GL_MATRIX_IDENTITY); else System.err.println("GLCgFXEffect:  cgGLSetStateMatrixParameter semantic param is null");
    }
   ...
   */
    public void setProjectionMatrix(String param) {
        CGparameter p = CgGL.cgGetNamedEffectParameter(effect, param);
        if (p != null) CgGL.cgGLSetStateMatrixParameter(p, CgGL.CG_GL_PROJECTION_MATRIX, CgGL.CG_GL_MATRIX_IDENTITY); else System.err.println("GLCgFXEffect:  cgGLSetStateMatrixParameter semantic param is null");
    }
   ...
   */
    public void setModelviewProjectionMatrix(String param) {
        CGparameter p = CgGL.cgGetNamedEffectParameter(effect, param);
        if (p != null) CgGL.cgGLSetStateMatrixParameter(p, CgGL.CG_GL_MODELVIEW_PROJECTION_MATRIX, CgGL.CG_GL_MATRIX_IDENTITY); else System.err.println("GLCgFXEffect:  cgGLSetStateMatrixParameter semantic param is null");
    }
   ...
   */
    public void setTexMatrix(String param) {
        CGparameter p = CgGL.cgGetNamedEffectParameter(effect, param);
        if (p != null) CgGL.cgGLSetStateMatrixParameter(p, CgGL.CG_GL_TEXTURE_MATRIX, CgGL.CG_GL_MATRIX_IDENTITY); else System.err.println("GLCgFXEffect:  cgGLSetStateMatrixParameter semantic param is null");
    }
   ...
   */
    public void setMatrixParameterBySemantic(String semantic, int matrix, int gltransform) {
        ...
        if (p != null) CgGL.cgGLSetStateMatrixParameter(p, matrix, getCgMatrixTransform(gltransform)); else System.err.println("GLCgFXEffect:  cgGLSetStateMatrixParameter(mat, type) is null");
    }
   ...
   */
    public void setModelviewMatrixBySemantic(String semantic, int gltransform) {
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) CgGL.cgGLSetStateMatrixParameter(p, CgGL.CG_GL_MODELVIEW_MATRIX, getCgMatrixTransform(gltransform)); else System.err.println("GLCgFXEffect:  cgGLSetStateMatrixParameter(mat, type) is null");
    }
   ...
   */
    public void setProjectionMatrixBySemantic(String semantic, int gltransform) {
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) CgGL.cgGLSetStateMatrixParameter(p, CgGL.CG_GL_PROJECTION_MATRIX, getCgMatrixTransform(gltransform)); else System.err.println("GLCgFXEffect:  cgGLSetStateMatrixParameter(mat, type) is null");
    }
   ...
   */
    public void setModelviewProjectionMatrixBySemantic(String semantic, int gltransform) {
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) CgGL.cgGLSetStateMatrixParameter(p, CgGL.CG_GL_MODELVIEW_PROJECTION_MATRIX, getCgMatrixTransform(gltransform)); else System.err.println("GLCgFXEffect:  cgGLSetStateMatrixParameter(mat, type) is null");
    }
   ...
   */
    public void setTextureMatrixBySemantic(String semantic, int gltransform) {
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) CgGL.cgGLSetStateMatrixParameter(p, CgGL.CG_GL_TEXTURE_MATRIX, getCgMatrixTransform(gltransform)); else System.err.println("GLCgFXEffect:  cgGLSetStateMatrixParameter(mat, type) is null");
    }
   ...
   */
    public void setTexParameterBySemantic(String semantic, GLTexture tex) {
        int id = tex.getTextureID();
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) CgGL.cgGLSetTextureParameter(p, id); else System.err.println("GLCgFXEffect:  Cant find texture semantic");
        CgGL.cgSetSamplerState(p);
    }
   ...
   */
    public void setIntParameterBySemantic(String semantic, int x) {
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) CgGL.cgSetParameter1i(p, x); else System.err.println("GLCgFXEffect:  1f semantic is null");
    }
   ...
   */
    public void setFloatParameterBySemantic(String semantic, float x) {
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) CgGL.cgSetParameter1f(p, x); else System.err.println("GLCgFXEffect: 1f  semantic is null");
    }
   ...
   */
    public void setVecParameterBySemantic(String semantic, float x, float y) {
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) CgGL.cgSetParameter2f(p, x, y); else System.err.println("GLCgFXEffect:  2f semantic is null");
    }
   ...
   */
    public void setVecParameterBySemantic(String semantic, float x, float y, float z) {
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) CgGL.cgSetParameter3f(p, x, y, z); else System.err.println("GLCgFXEffect:  3f semantic is null");
    }
   ...
   */
    public void setVecParameterBySemantic(String semantic, float x, float y, float z, float w) {
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) CgGL.cgSetParameter4f(p, x, y, z, w); else System.err.println("GLCgFXEffect:  4f semantic is null");
    }
   ...
   *        ...                                        
   */
    public void setMatParameterBySemantic(String semantic, float m00, float m01, float m10, float m11) {
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) {
            float[] mat = new float[4];
            mat[0] = m00;
            ...
            mat[5] = m11;
            CgGL.cgGLSetMatrixParameterfr(p, mat, 0);
        } else System.err.println("GLCgFXEffect:  matrix2x2f semantic is null");
    }
   ...
   *        ...                                        
   */
    public void setMatParameterBySemantic(String semantic, float m00, float m01, float m02, float m10, float m11, float m12, float m20, float m21, float m22) {
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) {
            float[] mat = new float[9];
            mat[0] = m00;
            ...
            mat[10] = m22;
            CgGL.cgGLSetMatrixParameterfr(p, mat, 0);
        } else System.err.println("GLCgFXEffect:  matrix3x3f semantic is null");
    }
   ...
   *        ...                                        
   */
    public void setMatParameterBySemantic(String semantic, float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float m20, float m21, float m22, float m23, float m30, float m31, float m32, float m33) {
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) {
            float[] mat = new float[16];
            mat[0] = m00;
            ...
            mat[15] = m33;
            CgGL.cgGLSetMatrixParameterfr(p, mat, 0);
        } else System.err.println("GLCgFXEffect:  matrix4x4f semantic is null");
    }
   ...
   */
    public void setMatrixParameterBySemantic(String semantic, float[] mat) {
        CGparameter p = CgGL.cgGetEffectParameterBySemantic(effect, semantic);
        if (p != null) CgGL.cgGLSetMatrixParameterfr(p, mat, 0); else System.err.println("GLCgFXEffect:  cgGLSetMatrixParameterfr(v[]) is null");
    }

    public int getCgMatrixTransform(int glcode) {
        if (glcode == IDENTITY_MATRIX) return CgGL.CG_GL_MATRIX_IDENTITY;
        if (glcode == INVERSE_TRANSPOSE_MATRIX) return CgGL.CG_GL_MATRIX_INVERSE_TRANSPOSE;
        if (glcode == INVERSE_MATRIX) return CgGL.CG_GL_MATRIX_INVERSE;
        if (glcode == TRANSPOSE_MATRIX) return CgGL.CG_GL_MATRIX_TRANSPOSE;
        return -1;
    }
    ...
    protected void load(String file) {
        ...
        if (effect == null) {
            System.err.println("GLCgFXEffect:  Effect file '" + file + "' not loaded correctly");
            error = CgGL.cgGetError();
            System.err.println("GLCgFXEffect:  Error String: " + CgGL.cgGetErrorString(error));
            System.err.println("GLCgFXEffect:  Last Listing: " + CgGL.cgGetLastListing(context));
        }
    }
