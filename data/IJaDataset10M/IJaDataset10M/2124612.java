...
public class MultipleVerticalPositionViewer extends JPanel implements PropertyChangeListener {
    ...
    private void refreshComponents(INumberSpectrum m, AttributeInfoEx positionGroupInfo, AttributeInfoEx[] positionsInfo) {
        ...
        GridBagConstraints gbc = new GridBagConstraints(0, 0, positionsInfo.length, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0);
        ...
        for (int index = 0; index < positionsInfo.length; index++) {
            ...
            gbc = new GridBagConstraints(index, 1, 1, 1, 0.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, new Insets(2, 2, 2, 2), 0, 0);
            add(barViewer, gbc);
            gbc = new GridBagConstraints(index, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, new Insets(2, 2, 2, 2), 0, 0);
            add(posViewer, gbc);
        }
    }
