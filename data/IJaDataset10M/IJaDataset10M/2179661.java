 ...
 * @since	TFP 1.1
 */
public final class DateTime extends TemporalDate implements ImmutableDate, ImmutableTime, Comparable<DateTime>, Serializable {

    /**
	 * The earliest possible date that can be correctly represented,
	 * @since	TFP 1.1
	 */
    public static final DateTime MIN_VALUE = new DateTime(DateValue.MIN_VALUE, TimeValue.START_OF_DAY, null);

    /**
	 * The latest possible date that can be correctly represented.
	 * @since	TFP 1.1
	 */
    public static final DateTime MAX_VALUE = new DateTime(DateValue.MAX_VALUE, TimeValue.END_OF_DAY, null);
	 ...
	 * @since	TFP 1.0
	 */
    public DateTime(final int day, final int month, final int year, final int hours, final int minutes, final int seconds) {
        this(new DateValue(day, month, year), new TimeValue(hours, minutes, seconds), null);
    }
	 ...
	 * @since	TFP 1.0
	 */
    public DateTime(final int day, final int month, final int year, final int hours, final int minutes, final int seconds, final boolean utc) {
        this(new DateValue(day, month, year), new TimeValue(hours, minutes, seconds), utc ? TimeZone.UTC : null);
    }
	 ...
	 * @since	TFP 1.0
	 */
    public DateTime(final int day, final int month, final int year, final int hours, final int minutes, final int seconds, final int offset) {
        this(new DateValue(day, month, year), new TimeValue(hours, minutes, seconds), new TimeZone(offset));
    }
	 ...
	 * @since	TFP 1.0
	 */
    public DateTime(final int day, final int month, final int year, final int hours, final int minutes, final BigDecimal seconds, final boolean utc) {
        this(new DateValue(day, month, year), new TimeValue(hours, minutes, seconds), utc ? TimeZone.UTC : null);
    }
	 ...
	 * @since	TFP 1.0
	 */
    public DateTime(final int day, final int month, final int year, final int hours, final int minutes, final BigDecimal seconds, final int offset) {
        this(new DateValue(day, month, year), new TimeValue(hours, minutes, seconds), new TimeZone(offset));
    }
	 ...
	 */
    public int hashCode() {
        if (timeZone != null) return (dateValue.hashCode() ^ timeValue.hashCode() ^ timeZone.hashCode()); else return (dateValue.hashCode() ^ timeValue.hashCode());
    }
    ...
    public String toString() {
        if (timeZone != null) return (dateValue.toString() + "T" + timeValue.toString() + timeZone.toString()); else return (dateValue.toString() + "T" + timeValue.toString());
    }
