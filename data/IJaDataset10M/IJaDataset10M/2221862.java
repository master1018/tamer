...
public interface IITFileOrCDTrack extends wayic.itunes.api.IITTrack {
     ...
     */
    @VTID(77)
    void rememberBookmark(boolean rememberBookmark);
     ...
     */
    @VTID(79)
    void excludeFromShuffle(boolean excludeFromShuffle);
     ...
     */
    @VTID(81)
    void lyrics(java.lang.String lyrics);
     ...
     */
    @VTID(83)
    void category(java.lang.String category);
     ...
     */
    @VTID(87)
    void longDescription(java.lang.String longDescription);
     ...
     */
    @VTID(89)
    void bookmarkTime(int bookmarkTime);

    /**
     * The video track kind.
     */
    @VTID(90)
    wayic.itunes.api.ITVideoKind videoKind();

    /**
     * The video track kind.
     */
    @VTID(91)
    void videoKind(wayic.itunes.api.ITVideoKind videoKind);
     ...
     */
    @VTID(93)
    void skippedCount(int skippedCount);
     ...
     */
    @VTID(95)
    void skippedDate(java.util.Date skippedDate);
     ...
     */
    @VTID(97)
    void partOfGaplessAlbum(boolean partOfGaplessAlbum);
     ...
     */
    @VTID(99)
    void albumArtist(java.lang.String albumArtist);
     ...
     */
    @VTID(101)
    void show(java.lang.String showName);
     ...
     */
    @VTID(103)
    void seasonNumber(int seasonNumber);
     ...
     */
    @VTID(105)
    void episodeID(java.lang.String episodeID);
     ...
     */
    @VTID(107)
    void episodeNumber(int episodeNumber);
     ...
     */
    @VTID(111)
    void unplayed(boolean isUnplayed);
     ...
     */
    @VTID(113)
    void sortAlbum(java.lang.String album);
     ...
     */
    @VTID(115)
    void sortAlbumArtist(java.lang.String albumArtist);
     ...
     */
    @VTID(117)
    void sortArtist(java.lang.String artist);
     ...
     */
    @VTID(119)
    void sortComposer(java.lang.String composer);
     ...
     */
    @VTID(121)
    void sortName(java.lang.String name);
     ...
     */
    @VTID(123)
    void sortShow(java.lang.String showName);
     ...
     */
    @VTID(126)
    void albumRating(int rating);

    /**
     * The album rating kind.
     */
    @VTID(127)
    wayic.itunes.api.ITRatingKind albumRatingKind();

    /**
     * The track rating kind.
     */
    @VTID(128)
    wayic.itunes.api.ITRatingKind ratingKind();

    /**
     * Returns a collection of playlists that contain the song that this track represents.
     */
    @VTID(129)
    wayic.itunes.api.IITPlaylistCollection playlists();

    @VTID(129)
    @ReturnValue(defaultPropertyThrough = { wayic.itunes.api.IITPlaylistCollection.class })
    wayic.itunes.api.IITPlaylist playlists(int index);
}
