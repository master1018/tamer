...
public class ActionstepTestNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
   ...
   */
    public IParser getParser() {
        if (parser == null) {
            ...
            IAdaptable hintAdapter = new SafiWorkshopParserProvider.HintAdapter(ElementTypes.elementType_ActionstepTest_10000, getParserElement(), parserHint);
   ...
   */
    protected DirectEditManager getManager() {
        if (manager == null) {
            setManager(new TextDirectEditManager(this, TextDirectEditManager.getTextCellEditorClass(this), SafiWorkshopEditPartFactory.getTextCellEditorLocator(this)));
        }
        return manager;
    }
