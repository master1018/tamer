...
public class PokemonEvolution {
    ...
    public enum EvolutionTypes {
        ...
        Level, LevelFemale, LevelMale, HasMove, Item, Happiness, HappinessDay, HappinessNight, DayHoldItem, TradeItem, Trade, DefenseGreater, AttackGreater, AtkDefEqual, Silcoon, Cascoon, Ninjask, Shedinja, Beauty, HasInParty
    }
