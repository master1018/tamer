...
/**
 * This is a default implementation of the IFC object IfcExternallyDefinedHatchStyle<br><br>
 * 
 ...
 **/
public class IfcExternallyDefinedHatchStyle extends IfcExternalReference implements IfcFillStyleSelect, IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcLabel", "IfcIdentifier", "IfcLabel" };
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("Location")) stepString = stepString.concat("*,"); else {
            if (this.Location != null) stepString = stepString.concat(((IfcRootInterface) this.Location).getStepParameter(IfcLabel.class.isInterface()) + ","); else stepString = stepString.concat("$,");
        }
        if (getRedefinedDerivedAttributeTypes().contains("ItemReference")) stepString = stepString.concat("*,"); else {
            if (this.ItemReference != null) stepString = stepString.concat(((IfcRootInterface) this.ItemReference).getStepParameter(IfcIdentifier.class.isInterface()) + ","); else stepString = stepString.concat("$,");
        }
	 ...
	 * 
	 * @param ItemReference value to set
	 *            /
	 **/
    ...
    public Object clone() {
        ...
        if (this.Location != null) ifcExternallyDefinedHatchStyle.setLocation((IfcLabel) this.Location.clone());
        if (this.ItemReference != null) ifcExternallyDefinedHatchStyle.setItemReference((IfcIdentifier) this.ItemReference.clone());
        if (this.Name != null) ifcExternallyDefinedHatchStyle.setName((IfcLabel) this.Name.clone());
    ...
    public Object shallowCopy() {
        IfcExternallyDefinedHatchStyle ifcExternallyDefinedHatchStyle = new IfcExternallyDefinedHatchStyle();
        if (this.Location != null) ifcExternallyDefinedHatchStyle.setLocation(this.Location);
        if (this.ItemReference != null) ifcExternallyDefinedHatchStyle.setItemReference(this.ItemReference);
        if (this.Name != null) ifcExternallyDefinedHatchStyle.setName(this.Name);
        return ifcExternallyDefinedHatchStyle;
    }
