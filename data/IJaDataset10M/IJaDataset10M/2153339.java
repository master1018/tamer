...
class ConfigCommand {
    ...
    ConfigCommand(Collection elements, String fileName, int lineNumber) {
        ...
        if (!(argc > 0 && (argv[0] instanceof String))) throw new IllegalArgumentException("malformed command");
        ...
        if (baseName != null && baseName.equals("Window")) baseName = "Screen";
    }
    ...
    private final String checkName(Object o) {
        if (!(o instanceof String)) throw new IllegalArgumentException("second argument to \"" + commandName + "\" must be a name");
        return (String) o;
    }
