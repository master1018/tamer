package gov.cdc.ncphi.phgrid.amds.biosense.service.globus;
 ...
 * 
 */
public class AMDS_BIOSENSEAuthorization implements PDP {

    public static final String SERVICE_NAMESPACE = "http://biosense.amds.phgrid.ncphi.cdc.gov/AMDS_BIOSENSE";

    public AMDS_BIOSENSEAuthorization() {
    }
    ...
    public static void authorizeMetaDataQuery() throws RemoteException {
    }

    public static void authorizeAmdsQuery() throws RemoteException {
    }
    ...
    public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
        ...
        } else if (operation.getLocalPart().equals("metaDataQuery")) {
            try {
                authorizeMetaDataQuery();
                return true;
            } catch (Exception e) {
                e.printStackTrace();
                return false;
            }
        } else if (operation.getLocalPart().equals("amdsQuery")) {
            try {
                authorizeAmdsQuery();
                return true;
            } catch (Exception e) {
