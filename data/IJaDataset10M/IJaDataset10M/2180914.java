...
public class ExternalRoutingService implements RoutingService {
    ...
    public List<Itinerary> fetchRoutesForSpecification(RouteSpecification routeSpecification) {
        ...
        final List<TransitPath> transitPaths = graphTraversalService.findShortestPath(origin.unLocode().idString(), destination.unLocode().idString());
    ...
    private Leg toLeg(TransitEdge edge) {
        return new Leg(carrierMovementRepository.find(new CarrierMovementId(edge.getCarrierMovementId())), locationRepository.find(new UnLocode(edge.getFromUnLocode())), locationRepository.find(new UnLocode(edge.getToUnLocode())));
    }
