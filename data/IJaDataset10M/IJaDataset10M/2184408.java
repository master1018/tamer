...
public class IORegisterClass extends ControllerClass {
    ...
    public boolean match(Object obj) {
        if (!(obj instanceof IORegisterClass)) return false;
        if (!super.match(obj)) return false;
        IORegisterClass pcc = (IORegisterClass) obj;
        return predefinedValues.equals(pcc.predefinedValues) && predefinedValuesDesc.equals(pcc.predefinedValuesDesc);
    }
}
