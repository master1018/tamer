...
public class LtiDigitalFilter extends AbstractDigitalFilter {
    ...
    public void setInputCoefficients(double[] arrCoeffs) throws IllegalArgumentException {
        ...
        for (int iDelay = 0; iDelay < arrCoeffs.length; iDelay++) this.setInputCoefficient(iDelay, arrCoeffs[iDelay]);
    }
    ...
    public void setOutputCoefficients(double[] arrCoeffs) throws IllegalArgumentException {
        this.checkIndex(arrCoeffs.length);
        for (int iDelay = 0; iDelay < arrCoeffs.length; iDelay++) this.setOutputCoefficient(iDelay, arrCoeffs[iDelay]);
    }
    ...
    private void checkIndex(int index) throws IndexOutOfBoundsException {
        if ((index < 0) || (index > this.getOrder())) throw new IllegalArgumentException("DigitalFiler#checkIndex(): " + "index outside domain [0," + this.getOrder() + "]");
    }
}
