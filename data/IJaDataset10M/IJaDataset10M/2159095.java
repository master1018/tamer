...
public class MultiUserChatActivity extends Activity implements MXAListener {
    ...
    private Handler guiHandler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            if (msg.what == 1) {
                if (mJoinRoom) createJoinRoomDialog(); else createGUI();
            }
        }
    };
    ...
    private void createJoinRoomDialog() {
        ...
        builder.setMessage(mDescriber.inviter + " invites you to the room \"" + mDescriber.room + "\", the reason is: " + mDescriber.reason).setCancelable(false).setPositiveButton("Accept", new DialogInterface.OnClickListener() {
