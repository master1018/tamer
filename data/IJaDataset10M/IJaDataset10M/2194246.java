...
public abstract class AbstractRMIBean implements RMIBean {
    ...
    public abstract void serialize(XMLStreamWriter writer, JavaObjectSerializer serializer, QName parentQName, NamespacePrefix namespacePrefix) throws XMLStreamException, XmlSerializingException;

    protected void writeStartElement(XMLStreamWriter writer, String namespace, String localPart, NamespacePrefix namespacePrefix) throws XMLStreamException {
        if (!namespace.equals("")) {
    ...
    protected void writeTypeAttribute(XMLStreamWriter writer, QName typeQname, NamespacePrefix namespacePrefix) throws XMLStreamException {
    ...
    protected void writeNullAttribute(XMLStreamWriter writer, NamespacePrefix namespacePrefix) throws XMLStreamException {
     ...
     */
    protected void writeAttribute(XMLStreamWriter writer, String attributeValue, QName attributeQName, NamespacePrefix namespacePrefix) throws XMLStreamException {
        if ((attributeQName.getNamespaceURI() != null) && !attributeQName.getNamespaceURI().trim().equals("")) {
            ...
            writer.writeAttribute(attributeQName.getNamespaceURI(), attributeQName.getLocalPart(), attributeValue);
        } else {
            writer.writeAttribute(attributeQName.getLocalPart(), attributeValue);
        }
    }

    protected void writeAttribute(XMLStreamWriter writer, QName attributeValue, QName attributeQName, NamespacePrefix namespacePrefix) throws XMLStreamException {
        ...
        if ((attributeQName.getNamespaceURI() != null) && !attributeQName.getNamespaceURI().trim().equals("")) {
            ...
            writer.writeAttribute(attributeQName.getNamespaceURI(), attributeQName.getLocalPart(), attributeStringVaule);
        } else {
