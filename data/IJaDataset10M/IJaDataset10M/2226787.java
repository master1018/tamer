...
public class CrossProductMatrixEditorFactory extends AbstractComponentFactory<CrossProductMatrixEditorComponent> {

    protected static final Logger logger = Logger.getLogger(CrossProductMatrixEditorFactory.class);
