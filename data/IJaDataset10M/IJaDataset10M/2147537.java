...
public class NotificationTest extends TestCase {
    ...
    public void testMergeRemoveNotifications() throws Exception {
        ...
        resource.getContents().add(EcoreFactory.eINSTANCE.createEAnnotation());
        resource.getContents().add(EcoreFactory.eINSTANCE.createEAttribute());
        resource.getContents().add(EcoreFactory.eINSTANCE.createEClass());
        resource.getContents().add(EcoreFactory.eINSTANCE.createEDataType());
        resource.getContents().add(EcoreFactory.eINSTANCE.createEEnum());
        resource.getContents().add(EcoreFactory.eINSTANCE.createEEnumLiteral());
        resource.getContents().add(EcoreFactory.eINSTANCE.createEFactory());
        resource.getContents().add(EcoreFactory.eINSTANCE.createEObject());
        resource.getContents().add(EcoreFactory.eINSTANCE.createEOperation());
        resource.getContents().add(EcoreFactory.eINSTANCE.createEPackage());
        resource.getContents().add(EcoreFactory.eINSTANCE.createEParameter());
   ...
   */
    public void testNotify() {
        ...
        NotificationResult[] expected = new NotificationResult[] { new NotificationResult(c, Notification.ADD, EClass.class, eStructuralFeaturesInt, eStructuralFeatures, null, a1, false, false, false, 0), new NotificationResult(c, Notification.ADD_MANY, EClass.class, eStructuralFeaturesInt, eStructuralFeatures, null, Arrays.asList(a2, a3, a4, a5), true, false, false, 1), new NotificationResult(c, Notification.REMOVE, EClass.class, eStructuralFeaturesInt, eStructuralFeatures, a2, null, true, false, false, 1), new NotificationResult(c, Notification.REMOVE_MANY, EClass.class, eStructuralFeaturesInt, eStructuralFeatures, Arrays.asList(a3, a4), new int[] { 1, 2 }, true, false, false, 1), new NotificationResult(c, Notification.MOVE, EClass.class, eStructuralFeaturesInt, eStructuralFeatures, 1, a5, true, false, false, 0), new NotificationResult(c, Notification.MOVE, EClass.class, eStructuralFeaturesInt, eStructuralFeatures, 0, a5, true, true, false, 0), new NotificationResult(c, Notification.SET, EClass.class, eStructuralFeaturesInt, eStructuralFeatures, a5, a2, true, false, false, 0), new NotificationResult(c, Notification.SET, EClass.class, eStructuralFeaturesInt, eStructuralFeatures, a2, a2, true, true, false, 0), new NotificationResult(a1, Notification.SET, EAttribute.class, nameInt, name, "a1", "a1", true, true, false, -1), new NotificationResult(a1, Notification.SET, EAttribute.class, nameInt, name, "a1", null, true, false, true, -1), new NotificationResult(a1, Notification.SET, EAttribute.class, nameInt, name, null, null, false, true, true, -1), new NotificationResult(a1, Notification.SET, EAttribute.class, upperBoundInt, upperBound, 1, 1, false, true, true, -1), new NotificationResult(a1, Notification.SET, EAttribute.class, upperBoundInt, upperBound, 1, -1, false, false, false, -1), new NotificationResult(a1, Notification.SET, EAttribute.class, upperBoundInt, upperBound, -1, -1, true, true, false, -1) };
        ...
        c.getEStructuralFeatures().addAll(Collections.<EStructuralFeature>emptyList());
        c.getEStructuralFeatures().remove(1);
        c.getEStructuralFeatures().remove(a6);
        c.getEStructuralFeatures().removeAll(Arrays.asList(a3, a4));
        c.getEStructuralFeatures().removeAll(Arrays.asList(a6));
