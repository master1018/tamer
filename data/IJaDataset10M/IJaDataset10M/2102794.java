...
public class ChemModelManipulatorTest extends CDKTestCase {
    ...
    private static final LoggingTool logger = new LoggingTool(ChemModelManipulatorTest.class);
    ...
    public void testGetAllChemObjects_IChemModel() {
        ...
        for (Iterator iter = list.iterator(); iter.hasNext(); ) {
            Object o = iter.next();
            if (o instanceof IMolecule) ++molCount; else if (o instanceof IMoleculeSet) ++molSetCount; else if (o instanceof IReaction) ++reactionCount; else if (o instanceof IReactionSet) ++reactionSetCount; else fail("Unexpected Object of type " + o.getClass());
        }
