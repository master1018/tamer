...
public class TmpFormatHandler implements FormatHandler {
     ...
     */
    public static final MIMEType TMP = new MIMEType("text/unknown", true);
    ...
    public TreeTagNodeResource loadTree(URI uri, URI origuri) throws ComponentException {
    ...
    public Resource loadComponent(Container container, URI origuri) throws ComponentException {
        throw new ComponentException("Loading of temporary components not supported.");
    }

    public Resource loadComponent(URI uri, URI origuri) throws ComponentException {
        throw new ComponentException("Loading of temporary components not supported.");
    }
    ...
    public Resource createComponent(URI uri, URI realURI, int type, Object extras) throws ComponentException {
        switch(type) {
            case CONCEPT:
        ...
        throw new ComponentException("Cannot create a component of the type " + type + ", doesn't know how!");
    }

    public void saveComponent(URI uri, Resource comp) throws ComponentException {
