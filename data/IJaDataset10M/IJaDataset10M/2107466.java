   ...
   */
    public void setFailureError(FailureError newFailureError) {
        if (newFailureError != failureError) {
            ...
            if (failureError != null) msgs = ((InternalEObject) failureError).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesystemPackage.ERROR_SPECIFICATION__FAILURE_ERROR, null, msgs);
            if (newFailureError != null) msgs = ((InternalEObject) newFailureError).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesystemPackage.ERROR_SPECIFICATION__FAILURE_ERROR, null, msgs);
            msgs = basicSetFailureError(newFailureError, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, TypesystemPackage.ERROR_SPECIFICATION__FAILURE_ERROR, newFailureError, newFailureError));
    }
