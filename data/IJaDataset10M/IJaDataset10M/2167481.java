...
public class FeatureObjectFiller {
        ...
        for (Entry<AttributeType, Field> entry : fieldMap.entrySet()) {
            try {
                if (Number.class.isAssignableFrom(entry.getKey().getType())) {
                    setNumber(o, entry.getValue(), (Number) feature.getAttribute(entry.getKey().getName()));
                    continue;
                }
                if (Boolean.class.equals(entry.getKey().getType())) {
                    entry.getValue().setBoolean(o, ((Boolean) feature.getAttribute(entry.getKey().getName())).booleanValue());
                }
                entry.getValue().set(o, feature.getAttribute(entry.getKey().getName()));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private boolean areEquivelent(Class class1, Class class2) {
        ...
        if (Number.class.isAssignableFrom(class2) && class1.equals(Long.TYPE) || (Number.class.isAssignableFrom(class1) && class2.equals(Long.TYPE))) {
            return true;
        }
        if (Number.class.isAssignableFrom(class2) && class1.equals(Integer.TYPE) || (Number.class.isAssignableFrom(class1) && class2.equals(Integer.TYPE))) {
            return true;
        }
        if (Number.class.isAssignableFrom(class2) && class1.equals(Short.TYPE) || (Number.class.isAssignableFrom(class1) && class2.equals(Short.TYPE))) {
            return true;
        }
        if (Number.class.isAssignableFrom(class2) && class1.equals(Double.TYPE) || (Number.class.isAssignableFrom(class1) && class2.equals(Double.TYPE))) {
            return true;
        }
        if (Number.class.isAssignableFrom(class2) && class1.equals(Float.TYPE) || (Number.class.isAssignableFrom(class1) && class2.equals(Float.TYPE))) {
            return true;
        }
        if (Number.class.isAssignableFrom(class2) && class1.equals(Byte.TYPE) || (Number.class.isAssignableFrom(class1) && class2.equals(Byte.TYPE))) {
            return true;
        }
