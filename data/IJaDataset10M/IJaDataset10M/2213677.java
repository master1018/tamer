...
public class ActionBar {
    ...
    private static class MoreMenuBuilder {
        ...
        public MenuModel build(final Context context, final MoreMenuFunction inactiveFunction) {
            return new MenuModel(context).setGravity(Gravity.RIGHT).add(R.string.moremenu_myfavorites, new OnClickListener() {
    ...
    private void addTitleAndSpacing() {
        LinearLayout.LayoutParams spacing = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.FILL_PARENT);
        spacing.weight = 1;
