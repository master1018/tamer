...
/**
 * This is a default implementation of the IFC object IfcDuctSilencerType<br><br>
 * 
 ...
 **/
public class IfcDuctSilencerType extends IfcFlowTreatmentDeviceType implements IfcClass {

    private static final long serialVersionUID = 8;

    public static final String[] nonInverseAttributes = new String[] { "IfcGloballyUniqueId", "IfcOwnerHistory", "IfcLabel", "IfcText", "IfcLabel", "SET<IfcPropertySetDefinition>", "LIST<IfcRepresentationMap>", "IfcLabel", "IfcLabel", "IfcDuctSilencerTypeEnum" };
    ...
    public String getStepLine() {
        ...
        if (getRedefinedDerivedAttributeTypes().contains("PredefinedType")) stepString = stepString.concat("*);"); else {
            if (this.PredefinedType != null) stepString = stepString.concat(((IfcRootInterface) this.PredefinedType).getStepParameter(IfcDuctSilencerTypeEnum.class.isInterface()) + ");"); else stepString = stepString.concat("$);");
        }
        return stepString;
    }
    ...
    public Object clone() {
        ...
        if (this.GlobalId != null) ifcDuctSilencerType.setGlobalId((IfcGloballyUniqueId) this.GlobalId.clone());
        if (this.OwnerHistory != null) ifcDuctSilencerType.setOwnerHistory((IfcOwnerHistory) this.OwnerHistory.clone());
        if (this.Name != null) ifcDuctSilencerType.setName((IfcLabel) this.Name.clone());
        if (this.Description != null) ifcDuctSilencerType.setDescription((IfcText) this.Description.clone());
        if (this.ApplicableOccurrence != null) ifcDuctSilencerType.setApplicableOccurrence((IfcLabel) this.ApplicableOccurrence.clone());
        if (this.HasPropertySets != null) ifcDuctSilencerType.setHasPropertySets((SET<IfcPropertySetDefinition>) this.HasPropertySets.clone());
        if (this.RepresentationMaps != null) ifcDuctSilencerType.setRepresentationMaps((LIST<IfcRepresentationMap>) this.RepresentationMaps.clone());
        if (this.Tag != null) ifcDuctSilencerType.setTag((IfcLabel) this.Tag.clone());
        if (this.ElementType != null) ifcDuctSilencerType.setElementType((IfcLabel) this.ElementType.clone());
        if (this.PredefinedType != null) ifcDuctSilencerType.setPredefinedType((IfcDuctSilencerTypeEnum) this.PredefinedType.clone());
    ...
    public Object shallowCopy() {
        IfcDuctSilencerType ifcDuctSilencerType = new IfcDuctSilencerType();
        if (this.GlobalId != null) ifcDuctSilencerType.setGlobalId(this.GlobalId);
        if (this.OwnerHistory != null) ifcDuctSilencerType.setOwnerHistory(this.OwnerHistory);
        if (this.Name != null) ifcDuctSilencerType.setName(this.Name);
        if (this.Description != null) ifcDuctSilencerType.setDescription(this.Description);
        if (this.ApplicableOccurrence != null) ifcDuctSilencerType.setApplicableOccurrence(this.ApplicableOccurrence);
        if (this.HasPropertySets != null) ifcDuctSilencerType.setHasPropertySets(this.HasPropertySets);
        if (this.RepresentationMaps != null) ifcDuctSilencerType.setRepresentationMaps(this.RepresentationMaps);
        if (this.Tag != null) ifcDuctSilencerType.setTag(this.Tag);
        if (this.ElementType != null) ifcDuctSilencerType.setElementType(this.ElementType);
        if (this.PredefinedType != null) ifcDuctSilencerType.setPredefinedType(this.PredefinedType);
        return ifcDuctSilencerType;
    }
