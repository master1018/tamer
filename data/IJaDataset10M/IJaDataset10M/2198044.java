 ...
 * @author Ken Swartz
 */
final class DeleteHistogram extends AbstractCommand implements Observer, Predicate<Nameable> {

    private final transient JFrame frame;

    private final transient Broadcaster broadcaster;

    private final transient Observer selectionObserver = new SelectionObserver(this, this);
    ...
    protected void execute(final Object[] cmdParams) {
        ...
        if (type == Group.Type.SORT) {
            ...
            if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(frame, "Delete " + name + "?", "Delete histogram", JOptionPane.YES_NO_OPTION)) {
                hist.delete();
