...
public abstract class Feature extends Object {
	 ...
	 */
    public Feature(final String id, final String name, final String description, final String address, final LookAt lookAt, final String styleUrl, final boolean visibility, final Region region, final TimePrimitive timePrimitive) {
        super(id);
        this.name = name;
