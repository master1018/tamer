...
public class PyList extends PySequenceList {
    ...
    public static void typeSetup(PyObject dict, PyType.Newstyle marker) {
        class exposed___ne__ extends PyBuiltinMethodNarrow {
            ...
            public PyObject __call__(PyObject arg0) {
                ...
                if (ret == null) return Py.NotImplemented;
                return ret;
            }
        }
        ...
        dict.__setitem__("__new__", new PyNewWrapper(PyList.class, "__new__", -1, -1) {
            ...
            public PyObject new_impl(boolean init, PyType subtype, PyObject[] args, String[] keywords) {
                ...
                if (for_type == subtype) {
                    newobj = new PyList();
                    if (init) newobj.list_init(args, keywords);
                } else {
    ...
    final PyObject list___imul__(PyObject o) {
        if (!(o instanceof PyInteger || o instanceof PyLong)) return null;
        int l = size();
    ...
    private int _index(PyObject o, String message, int start, int stop) {
        ...
        if (i == validStop) throw Py.ValueError(message);
        return i;
    }
    ...
    final PyObject list_pop(int n) {
        ...
        if (n < 0) n += length;
        if (n < 0 || n >= length) throw Py.IndexError("pop index out of range");
        PyObject v = pyget(n);
