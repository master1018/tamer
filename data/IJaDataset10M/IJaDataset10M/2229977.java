...
public class VariableTranslator {
    ...
    public static CpnVarAndType getCpnVarForDataAttributes() {
        return new CpnVarAndType(HLToCPNTranslator.cpnVarNameForDataAttributes, HLToCPNTranslator.cpnColorSetNameForDataAttributes);
    }
    ...
    public static CpnVarAndType getCpnVarForModifiedDataAttributes() {
        return new CpnVarAndType(HLToCPNTranslator.cpnVarNameForModifiedDataAttributes, HLToCPNTranslator.cpnColorSetNameForDataAttributes);
    }
    ...
    public static CpnVarAndType getCpnVarForCaseId() {
        return new CpnVarAndType(HLToCPNTranslator.cpnVarNameForCaseId, HLToCPNTranslator.cpnColorSetNameForCaseId);
    }
    ...
    public static CpnVarAndType getCpnVarForStartCase() {
        return new CpnVarAndType(HLToCPNTranslator.cpnVarNameForStartCase, HLToCPNTranslator.cpnColorSetNameForStartCase);
    }
    ...
    public static CpnVarAndType getCpnVarForGroupAllResources() {
        return new CpnVarAndType(HLToCPNTranslator.cpnVarNameForGroupAllResources, HLToCPNTranslator.cpnColorSetNameForGroupAllResources);
    }
