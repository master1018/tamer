    ...
    private static class HsmHandler extends Handler {
        ...
        private class StateInfo {
            ...
            public String toString() {
                return "state=" + state.getName() + ",active=" + active + ",parent=" + ((parentStateInfo == null) ? "null" : parentStateInfo.state.getName());
            }
        }
        ...
        private final int moveTempStateStackToStateStack() {
            ...
            if (mDbg) {
                Log.d(TAG, "moveTempStackToStateStack: X mStateStackTop=" + mStateStackTopIndex + ",startingIndex=" + startingIndex + ",Top=" + mStateStack[mStateStackTopIndex].state.getName());
            }
        ...
        private final StateInfo setupTempStateStackWithStatesToEnter(HierarchicalState destState) {
            ...
            if (mDbg) {
                Log.d(TAG, "setupTempStateStackWithStatesToEnter: X mTempStateStackCount=" + mTempStateStackCount + ",curStateInfo: " + curStateInfo);
            }
            return curStateInfo;
        }
