...
public class FindTrainDialog extends JDialog implements ActionListener {
    ...
    private void jbInit() throws Exception {
        ...
        jPanel3.add(lbTrainName, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 87, 7));
        jPanel3.add(tfTrainName, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 75, 0));
   ...
   */
    private void doFind() {
        ...
        if (trainName.trim().equalsIgnoreCase("")) return;
        if (mainFrame.chartView.findAndMoveToTrain(trainName)) this.statusBar.setText(trainName); else {
