 ...
 */
    public void addDirtyRegion(IFigure figure, RectD2D rect) {
 ...
 */
    protected void firePainting(RectD2D damage, Map dirtyRegions) {
        UpdateListener localListeners[] = listeners;
        for (int i = 0; i < localListeners.length; i++) localListeners[i].notifyPainting(damage, dirtyRegions);
    }
 ...
 */
    protected void fireValidating() {
        UpdateListener localListeners[] = listeners;
        for (int i = 0; i < localListeners.length; i++) localListeners[i].notifyValidating();
    }
 ...
 */
    ...
    void paint(GC gc) {
        performUpdate(new RectD2D(gc.getClipping()));
    }
 ...
 */
    public abstract void performUpdate(RectD2D exposed);
 ...
 */
    public void removeUpdateListener(UpdateListener listener) {
        if (listener == null) throw new IllegalArgumentException();
        for (int index = 0; index < listeners.length; index++) if (listeners[index] == listener) {
