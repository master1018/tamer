...
public class CollectionUtil {
    ...
    public static <T> List<T> filter(Collection<T> c, Filter<T> filter) {
        if (c.size() == 0) return Collections.emptyList();
        List<T> filteredList = new ArrayList<T>(c.size());
        for (T element : c) {
            if (filter.select(element)) filteredList.add(element);
        }
        return filteredList;
    }
    ...
    public static <K, V> K getKey(Map<K, V> map, V value) {
        for (Map.Entry<K, V> entry : map.entrySet()) {
            if (Util.equals(entry.getValue(), value)) return entry.getKey();
        }
        return null;
    }
    ...
    public static int[] toIntArray(Collection<? extends Number> c) {
        ...
        int i = 0;
        for (Number item : c) arr[i++] = item.intValue();
        return arr;
    }
    ...
    public static long[] toLongArray(Collection<? extends Number> c) {
        ...
        int i = 0;
        for (Number item : c) arr[i++] = item.longValue();
        return arr;
    }
    ...
    public static float[] toFloatArray(Collection<? extends Number> c) {
        ...
        int i = 0;
        for (Number item : c) arr[i++] = item.floatValue();
        return arr;
    }
    ...
    public static double[] toDoubleArray(Collection<? extends Number> c) {
        ...
        int i = 0;
        for (Number item : c) arr[i++] = item.doubleValue();
        return arr;
    }
    ...
    public static byte[] toByteArray(Collection<? extends Number> c) {
        ...
        int i = 0;
        for (Number item : c) arr[i++] = item.byteValue();
        return arr;
    }
    ...
    public static short[] toShortArray(Collection<? extends Number> c) {
        ...
        int i = 0;
        for (Number item : c) arr[i++] = item.shortValue();
        return arr;
    }
}
