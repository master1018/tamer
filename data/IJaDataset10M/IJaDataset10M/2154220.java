            ...
            public void run() {
                for (Button b : mNumberButtons.values()) {
                    ...
                    if (b.getTag().equals(mSelectedNumber)) {
                        ...
                        LightingColorFilter selBkgColorFilter = new LightingColorFilter(mContext.getResources().getColor(R.color.im_number_button_selected_background), 0);
                ...
                if (mHighlightCompletedValues || mShowNumberTotals) valuesUseCount = mGame.getCells().getValuesUseCount();
                ...
                if (mShowNumberTotals) {
                    for (Map.Entry<Integer, Integer> entry : valuesUseCount.entrySet()) {
                        Button b = mNumberButtons.get(entry.getKey());
                        if (!b.getTag().equals(mSelectedNumber)) b.setText(entry.getKey() + " (" + entry.getValue() + ")"); else b.setText("" + entry.getKey());
                    }
                }
            }
        }, 100);
