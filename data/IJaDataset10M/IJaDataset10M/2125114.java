...
import com.sodad.weka.core.converters.ConverterUtils.DataSource;
    ...
    public static String SelectAttributes(ASEvaluation ASEvaluator, String[] options) throws Exception {
        ...
        try {
            ...
            if (helpRequested || (trainFileName.length() == 0)) {
                ...
                if (helpRequested) throw new Exception("Help requested."); else throw new Exception("No training file given.");
            }
        } catch (Exception e) {
