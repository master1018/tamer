 ...
 * on the status.
 */
public abstract class SelectionStatusDialog extends SelectionDialog implements JDTOriginally {
    ...
    protected void configureShell(Shell shell) {
        ...
        if (fImage != null) shell.setImage(fImage);
    }
    ...
    protected void updateButtonsEnableState(IStatus status) {
        ...
        if (okButton != null && !okButton.isDisposed()) okButton.setEnabled(!status.matches(IStatus.ERROR));
    }
    ...
    public void create() {
        super.create();
        if (fLastStatus != null) updateStatus(fLastStatus);
    }
