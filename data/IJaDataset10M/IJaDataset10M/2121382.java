...
public class TestMisc extends UtilTestCase {
    ...
    public void testXmlDecl() throws Exception {
        ...
        pp.next();
        pp.require(XmlPullParser.END_DOCUMENT, null, null);
        pp.setInput(new StringReader("<?xml  version=\"1.0\" \t encoding='UTF-8' \nstandalone='yes' ?><foo/>"));
        pp.require(XmlPullParser.START_DOCUMENT, null, null);
        pp.next();
        pp.require(XmlPullParser.START_TAG, null, "foo");
        pp.setInput(new StringReader("<?xml  version=\"1.0\" \t encoding='UTF-8' \nstandalone='yes' ?><foo/>"));
        ...
        pp.setInput(new StringReader("<?xml version=\"1.0\" standalone='yes' encoding=\"UTF-8\" ?>\n<foo/>"));
        pp.require(XmlPullParser.START_DOCUMENT, null, null);
        try {
            pp.next();
    ...
    public void testContentMerging(final XmlPullParser pp, final String xml, final String expected) throws Exception {
    ...
    public void testReportNamespaceAttributes() throws Exception {
        ...
        PackageTests.addNote("* optional feature  " + XmlPullParser.FEATURE_REPORT_NAMESPACE_ATTRIBUTES + " is supported\n");
        final String XML_MISC_ATTR = "<test xmlns='Some-Namespace-URI' xmlns:n='Some-Other-URI'" + " a='a' b='b' xmlns:m='Another-URI' m:a='c' n:b='d' n:x='e' xml:lang='en'" + "/>\n" + "";
    ...
    public void testRoundtripNext() throws Exception {
        final String SAMPLE_XML = "<foo attEol='a\r\nv\n\ra\n\r\r\nio\rn\nica' attr=\"baz &amp; bar\"/>";
        XmlPullParser pp = factory.newPullParser();
        assertEquals(true, pp.getFeature(XmlPullParser.FEATURE_PROCESS_NAMESPACES));
