...
public class MoneyTransferList extends AbstractJFSScriptExecutorDelegate {
    ...
    public Object doExecute() throws ScriptException {
        ...
        if (accountIDs == null || accountIDs.size() < 1) throw new IllegalArgumentException("The parameter 'accountIDs' has to be set and contain at least one entry.");
        ...
        for (Iterator<AnchorID> iterator = accountIDs.iterator(); iterator.hasNext(); ) {
            ...
            jdoql.append("SELECT " + "  this " + "FROM " + "  " + MoneyTransfer.class.getName() + " " + "WHERE (1 == 1) ");
