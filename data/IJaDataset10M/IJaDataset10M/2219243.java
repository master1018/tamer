...
public class MailAccount {
    ...
    public MailAccount(User user, String emailAddress) {
        ...
        if (Validator.isNotNull(jsonObj)) {
            ...
            _password = MailPasswordUtil.decrypt(jsonObj.getString("password"));
            _username = jsonObj.getString("username");
        }
    }

    public MailAccount(User user, String emailAddress, boolean initialized, String mailInHostName, String mailInPort, boolean mailInSecure, String mailOutHostName, String mailOutPort, boolean mailOutSecure, String password, String username) {
        _user = user;
