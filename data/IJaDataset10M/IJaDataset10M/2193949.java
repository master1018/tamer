...
public class Movie extends EOGenericRecord {
    ...
    public demo.eo.PlotSummary plotSummary() {
        return (demo.eo.PlotSummary) storedValueForKey("plotSummary");
    }

    public void setPlotSummary(demo.eo.PlotSummary value) {
        takeStoredValueForKey(value, "plotSummary");
    }

    public demo.eo.Studio studio() {
        return (demo.eo.Studio) storedValueForKey("studio");
    }

    public void setStudio(demo.eo.Studio value) {
        takeStoredValueForKey(value, "studio");
    }

    public demo.eo.Voting voting() {
        return (demo.eo.Voting) storedValueForKey("voting");
    }

    public void setVoting(demo.eo.Voting value) {
    ...
    public void setDirectors(NSMutableArray value) {
    ...
    public void setRoles(NSMutableArray value) {
    ...
    public void setReviews(NSMutableArray value) {
