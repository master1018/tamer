package org.xmlcml.cml.legacy2cml.cif;
...
public class CIFEntry extends CMLEntry implements CIFConstants {
    ...
    private void addDictionaryFields(CMLEntry entry) {
        List<Node> categoryNodes = CMLUtil.getQueryNodes(entry, ".//" + CMLScalar.NS + "[@dictRef='" + IUCR_CATEGORY + "']", CML_XPATH);
        this.categoryName = (categoryNodes.size() == 0) ? null : categoryNodes.get(0).getValue();
    }
}
