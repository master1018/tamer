...
public abstract class AbstractMultisetTest extends AbstractCollectionTest {
    ...
    @Override
    protected abstract <E> Multiset<E> create();
   ...
   */
    ...
    public void testAddAllMultiset() {
        c = ms = createSample();
        Multiset<String> more = HashMultiset.create(asList("c", "c", "d", "d", "e"));
        assertTrue(ms.addAll(more));
    ...
    @Override
    protected Multiset<String> createSample() {
        @SuppressWarnings("hiding") Multiset<String> ms = create();
        ms.add("a", 1);
        ms.add("b", 2);
        ms.add("c", 1);
        ms.add("d", 3);
