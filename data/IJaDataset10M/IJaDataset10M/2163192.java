...
public class TSContainerInfo implements TSContainerHandle {
    ...
    void setFile(IFile file) {
        ...
        synchronized (this.lockFile) {
            if (!file.getFullPath().equals(this.file.getFullPath())) {
                throw new IllegalArgumentException("file must have the same path");
            }
            this.file = file;
        }
    }
   ...
   */
    ...
    void setActiveTestCases(List<TestCaseInfo> testCaseInfos) {
        if (testCaseInfos == null) {
            throw new NullPointerException("testCaseInfos mustn't be null");
        }
   ...
   */
    ...
    public String toString() {
        return String.format("%s (%2$td.%2$tm.%2$tY %2$tH:%2$tM:%2$tS)", this.getId(), this.getDate());
    }
   ...
   */
    ...
    public boolean equals(Object o) {
        if (o != null && o instanceof TSContainerHandle && ((TSContainerHandle) o).getPath().equals(this.getPath())) {
            return true;
        } else {
            return false;
        }
