...
public abstract class ExpensesEntityTypesProcessor<T> {
   ...
   */
    ...
    private static void process(ExpensesEntityTypesProcessor<?> processor, Class<?> clazz) {
    ...
    private static void process(ExpensesEntityTypesProcessor<?> processor, Object proxy) {
