...
public final class ActionEvent extends EventObject {
    ...
    public String toString() {
        if (stringValue == null) stringValue = "ActionEvent{action:" + action + ",sourceComponent:" + sourceComponent.getClass().getName() + "@" + System.identityHashCode(sourceComponent) + ",source:" + source + "@" + System.identityHashCode(source) + ",sourceComponentX:" + sourceComponentX + ",sourceComponentY:" + sourceComponentY + ",sourceX:" + sourceX + ",sourceY:" + sourceY + "}";
        return stringValue;
    }
}
