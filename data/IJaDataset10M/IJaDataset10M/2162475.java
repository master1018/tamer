package net.sourceforge.keytool;
...
public class KeytoolLog {
    ...
    */
    public static IStatus createStatus(int severity, int code, String message, Throwable exception) {
        return new Status(severity, KeytoolActivator.PLUGIN_ID, code, message, exception);
    }
    ...
    */
    public static void log(IStatus status) {
        KeytoolActivator.getDefault().getLog().log(status);
    }
}
