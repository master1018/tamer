package de.icehorsetools.iceoffice.state.combinationsection;
...
public class CombinationsectionSt extends AUnState {

    private Object data = null;

    public void initialize() {
        this.setContainerComponentByPluginName("combinationsection");
    }
    ...
    public void setData(Object xData) {
        this.data = xData;
        if (this.data instanceof Combinationsection) {
