...
public class JavaClass {
   ...
   */
    ...
    private void fillProperties() {
        ...
        for (int i = 0, n = methods.length; i < n; i++) {
            ...
            } else if (name.startsWith("is") && m.getParameterTypes().length == 0 && m.getReturnType().equals(boolean.class)) {
   ...
   */
    public Class getStaticFieldType(String fieldName) {
        ...
        if (f == null) throw new NoSuchElementException("Class " + clazz.getName() + " does not contain field " + fieldName);
        return f.getType();
    }
