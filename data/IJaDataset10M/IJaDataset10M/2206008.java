...
public interface UICCConstants {
	 ...
	 */
    public static final short FID_EF_ARR = (short) 0x2F06;

    /**
	 * File identifier : Preferred Languages  EF_PL = 0x2F05
	 */
    public static final short FID_EF_PL = (short) 0x2F05;
	 ...
	 */
    public static final byte SIMPLE_SEARCH_START_FORWARD = (byte) 0x04;

    /**
	 * Search mode backward beginning at the given record number
	 */
    public static final byte SIMPLE_SEARCH_START_BACKWARD = (byte) 0x05;

    /**
	 * Enhanced search
	 */
    public static final byte ENHANCED_SEARCH = (byte) 0x06;

    /**
	 * Search mode indication forward starting at given record number
	 */
    public static final short SEARCH_INDICATION_START_FORWARD_FROM_NEXT_GR = (short) 0x0400;

    /**
	 * Search mode indication backward starting at given record number
	 */
    public static final short SEARCH_INDICATION_START_BACKWARD_FROM_PREVIOUS_GR = (short) 0x0500;

    /**
	 * Search mode indication forward starting at next record
	 */
    public static final short SEARCH_INDICATION_START_FORWARD_FROM_NEXT = (short) 0x0600;

    /**
	 * Search mode indication backward starting from previous record
	 */
    public static final short SEARCH_INDICATION_START_BACKWARD_FROM_PREVIOUS = (short) 0x0700;

    /**
	 * Record access mode: CURRENT = 0x04
	 */
    public static final byte REC_ACC_MODE_CURRENT = (byte) 0x04;

    /**
	 * Record access mode: ABSOLUTE = 0x04
	 */
    public static final byte REC_ACC_MODE_ABSOLUTE = (byte) 0x04;
	 ...
	 * First Block = 0x80
	 */
    public static final byte BER_TLV_ACC_MODE_FIRST = (byte) 0x80;

    /**
	 * Next Block = 0x00
	 */
    public static final byte BER_TLV_ACC_MODE_NEXT = (byte) 0x00;

    /**
	 * TAG in FCP TLV structure: File Descriptor = 0x82
	 */
    public static final byte TAG_FCP_FILE_DESCRIPTOR = (byte) 0x82;

    /**
	 * TAG in FCP TLV structure: File Identifier = 0x83
	 */
    public static final byte TAG_FCP_FILE_IDENTIFIER = (byte) 0x83;

    /**
	 * Tag in FCP TLV structure: DF name (AID) = 0x84
	 */
    public static final byte TAG_FCP_FILE_AID = (byte) 0x84;

    /**
	 * Tag in FCP TLV structure: Proprietary information = 0xA5
	 */
    public static final byte TAG_FCP_FILE_PROPRIETARY_INFO = (byte) 0xA5;

    /**
	 * Tag in FCP TLV structure: Life Cycle Status Information = 0x8A
	 */
    public static final byte TAG_FCP_LCS_INTEGER = (byte) 0x8A;

    /**
	 * Tag in FCP TLV structure: PIN Status Template DO = 0xC6
	 */
    public static final byte TAG_FCP_PIN_STATUS_TEMPLATE_DO = (byte) 0xC6;

    /**
	 * Tag in FCP TLV structure: File Size = 0x80
	 */
    public static final byte TAG_FCP_FILE_SIZE = (byte) 0x80;

    /**
	 * Tag in FCP TLV structure: Total File Size = 0x81
	 */
    public static final byte TAG_FCP_TOTAL_FILE_SIZE = (byte) 0x81;

    /**
	 * TAG in FCP TLV structure: Short File Identifier = 0x88
	 */
    public static final byte TAG_FCP_SHORT_FILE_IDENTIFIER = (byte) 0x88;

    /**
	 * TAG in FCP TLV structure: Security attributes Compact Format = 0x8C
	 */
    public static final byte TAG_FCP_SECURITY_ATTRIBUTE_CF = (byte) 0x8C;

    /**
	 * TAG in FCP TLV structure: Security attributes Expanded Format = 0xAB
	 */
    public static final byte TAG_FCP_SECURITY_ATTRIBUTE_EF = (byte) 0xAB;
	 ...
	 */
    public static final byte TAG_FCP_SECURITY_ATTRIBUTE_REF_EF = (byte) 0xAB;

    /**
 	 * TAG in FCP TLV structure: Security attributes Referenced to Expanded Format = 0x8B
	 */
    public static final byte TAG_FCP_SECURITY_ATTRIBUTE_REFERENCED_EF = (byte) 0x8B;
}
