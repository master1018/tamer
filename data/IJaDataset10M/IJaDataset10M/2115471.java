...
public abstract class BoxHandlesStruct {
    ...
    protected void initStruct(ContextMap.BoundingBox bb, GridModel gridModel) {
        ul = new BoxHandle(bb.pos, gridModel);
        ur = new BoxHandle(new ContextMap.Position(bb.pos.x + bb.dim.width, bb.pos.y), gridModel);
        lr = new BoxHandle(new ContextMap.Position(bb.pos.x + bb.dim.width, bb.pos.y + bb.dim.height), gridModel);
        ll = new BoxHandle(new ContextMap.Position(bb.pos.x, bb.pos.y + bb.dim.height), gridModel);
    ...
    public void set() {
        ...
        ContextMap.BoundingBox bb = new ContextMap.BoundingBox(pos.x, pos.y, ur.rectangle.x - ul.rectangle.x, ll.rectangle.y - ul.rectangle.y);
        setImpl(bb);
    }
    ...
    public void paint(Graphics2D g) {
        ...
        if (tot.getParent() != null) tot.paint(g);
    }
}
