...
public final class EnvironmentToken extends FlowToken {
    ...
    public EnvironmentToken(final FrozenSlice slice, final LaTeXMode latexMode, final BuiltinEnvironment environment, final ArgumentContainerToken content) {
        this(slice, latexMode, environment, null, ArgumentContainerToken.EMPTY_ARRAY, content);
    }

    public EnvironmentToken(final FrozenSlice slice, final LaTeXMode latexMode, final BuiltinEnvironment environment, final ArgumentContainerToken optionalArgument, final ArgumentContainerToken[] arguments, final ArgumentContainerToken content) {
