...
public class HieroMain {
    ...
    public static void main(String[] argv) {
        ...
        try {
            ...
            Alignments al = SuffixArrayFactory.createAlignments(argv[2], SuffixArrayFactory.createSuffixArray(src, CACHE_SIZE), SuffixArrayFactory.createSuffixArray(tgt, CACHE_SIZE));
            ...
            for (Rule r : rules) {
                System.out.println(r.toString(src.getVocabulary()));
            }
        } catch (IOException e) {
