...
public class ColumnElements {
    ...
    public static final Font FONT9 = FontFactory.getFont(FontFactory.TIMES_ROMAN, 9);

    public static final Font FONT11 = FontFactory.getFont(FontFactory.TIMES_ROMAN, 11);

    public static final Font FONT11B = FontFactory.getFont(FontFactory.TIMES_ROMAN, 11, Font.BOLD);

    public static final Font FONT14B = FontFactory.getFont(FontFactory.TIMES_ROMAN, 14, Font.BOLD);

    public static final Font FONT14BC = FontFactory.getFont(FontFactory.TIMES_ROMAN, 14, Font.BOLD, new Color(255, 0, 0));
    ...
    public static void main(String[] args) {
        ...
        try {
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("results/in_action/chapter07/column_elements.pdf"));
            document.open();
            float gutter = 20;
            int numColumns = 2;
            ...
            ct.setYLine(currentY);
            ct.setSimpleColumn(allColumns[0], document.bottom(), allColumns[0] + columnWidth, currentY);
            ...
            ct.addText(new Phrase("In the past, developers built enterprise Java applications using EJB technologies that are excessively complex and difficult to use. Often EJB introduced more problems than it solved. There is a major trend in the industry towards using simpler and easier technologies such as Hibernate, Spring, JDO, iBATIS and others, all of which allow the developer to work directly with the simpler Plain Old Java Objects or POJOs. Now EJB version 3 solves the problems that gave EJB 2 a black eye--it too works with POJOs.\n\n", FONT11));
            Phrase p = new Phrase();
