package org.jcvi.vics.compute.service.tools;
...
import org.jcvi.vics.compute.service.common.file.SimpleMultiFastaSplitterService;
...
import org.jcvi.vics.model.tasks.tools.MuscleTask;
import org.jcvi.vics.model.tasks.tools.TmhmmTask;
...
import org.jcvi.vics.model.user_data.tools.MuscleResultFileNode;
import org.jcvi.vics.model.user_data.tools.TmhmmResultNode;
...
public class MuscleService extends SubmitDrmaaJobService {
    ...
    private void createShellScript(MuscleTask muscleTask, FileWriter writer) throws IOException, ParameterException {
        try {
    ...
    public void init(IProcessData processData) throws Exception {
        ...
        inputFiles = SimpleMultiFastaSplitterService.splitInputFileToList(processData, new File(inputFastaNode.getFastaFilePath()), DEFAULT_ENTRIES_PER_EXEC, logger);
    ...
    private MuscleResultFileNode createResultFileNode() throws Exception {
        ...
        resultFileNode = new MuscleResultFileNode(task.getOwner(), task, "MuscleResultFileNode", "MuscleResultFileNode for task " + task.getObjectId(), Node.VISIBILITY_PRIVATE, sessionName);
