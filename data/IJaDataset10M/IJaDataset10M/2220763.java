...
public class ObjectFields implements java.io.Serializable {
    ...
    public ObjectFields(java.lang.String pid, java.lang.String label, java.lang.String fType, java.lang.String cModel, java.lang.String state, java.lang.String ownerId, java.lang.String cDate, java.lang.String mDate, java.lang.String dcmDate, java.lang.String[] bDef, java.lang.String[] bMech, java.lang.String[] title, java.lang.String[] creator, java.lang.String[] subject, java.lang.String[] description, java.lang.String[] publisher, java.lang.String[] contributor, java.lang.String[] date, java.lang.String[] type, java.lang.String[] format, java.lang.String[] identifier, java.lang.String[] source, java.lang.String[] language, java.lang.String[] relation, java.lang.String[] coverage, java.lang.String[] rights) {
        this.pid = pid;
        this.label = label;
        this.fType = fType;
        this.cModel = cModel;
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = true && ((this.pid == null && other.getPid() == null) || (this.pid != null && this.pid.equals(other.getPid()))) && ((this.label == null && other.getLabel() == null) || (this.label != null && this.label.equals(other.getLabel()))) && ((this.fType == null && other.getFType() == null) || (this.fType != null && this.fType.equals(other.getFType()))) && ((this.cModel == null && other.getCModel() == null) || (this.cModel != null && this.cModel.equals(other.getCModel()))) && ((this.state == null && other.getState() == null) || (this.state != null && this.state.equals(other.getState()))) && ((this.ownerId == null && other.getOwnerId() == null) || (this.ownerId != null && this.ownerId.equals(other.getOwnerId()))) && ((this.cDate == null && other.getCDate() == null) || (this.cDate != null && this.cDate.equals(other.getCDate()))) && ((this.mDate == null && other.getMDate() == null) || (this.mDate != null && this.mDate.equals(other.getMDate()))) && ((this.dcmDate == null && other.getDcmDate() == null) || (this.dcmDate != null && this.dcmDate.equals(other.getDcmDate()))) && ((this.bDef == null && other.getBDef() == null) || (this.bDef != null && java.util.Arrays.equals(this.bDef, other.getBDef()))) && ((this.bMech == null && other.getBMech() == null) || (this.bMech != null && java.util.Arrays.equals(this.bMech, other.getBMech()))) && ((this.title == null && other.getTitle() == null) || (this.title != null && java.util.Arrays.equals(this.title, other.getTitle()))) && ((this.creator == null && other.getCreator() == null) || (this.creator != null && java.util.Arrays.equals(this.creator, other.getCreator()))) && ((this.subject == null && other.getSubject() == null) || (this.subject != null && java.util.Arrays.equals(this.subject, other.getSubject()))) && ((this.description == null && other.getDescription() == null) || (this.description != null && java.util.Arrays.equals(this.description, other.getDescription()))) && ((this.publisher == null && other.getPublisher() == null) || (this.publisher != null && java.util.Arrays.equals(this.publisher, other.getPublisher()))) && ((this.contributor == null && other.getContributor() == null) || (this.contributor != null && java.util.Arrays.equals(this.contributor, other.getContributor()))) && ((this.date == null && other.getDate() == null) || (this.date != null && java.util.Arrays.equals(this.date, other.getDate()))) && ((this.type == null && other.getType() == null) || (this.type != null && java.util.Arrays.equals(this.type, other.getType()))) && ((this.format == null && other.getFormat() == null) || (this.format != null && java.util.Arrays.equals(this.format, other.getFormat()))) && ((this.identifier == null && other.getIdentifier() == null) || (this.identifier != null && java.util.Arrays.equals(this.identifier, other.getIdentifier()))) && ((this.source == null && other.getSource() == null) || (this.source != null && java.util.Arrays.equals(this.source, other.getSource()))) && ((this.language == null && other.getLanguage() == null) || (this.language != null && java.util.Arrays.equals(this.language, other.getLanguage()))) && ((this.relation == null && other.getRelation() == null) || (this.relation != null && java.util.Arrays.equals(this.relation, other.getRelation()))) && ((this.coverage == null && other.getCoverage() == null) || (this.coverage != null && java.util.Arrays.equals(this.coverage, other.getCoverage()))) && ((this.rights == null && other.getRights() == null) || (this.rights != null && java.util.Arrays.equals(this.rights, other.getRights())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getBDef() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getBDef()); i++) {
        ...
        if (getBMech() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getBMech()); i++) {
        ...
        if (getTitle() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getTitle()); i++) {
        ...
        if (getCreator() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getCreator()); i++) {
        ...
        if (getSubject() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getSubject()); i++) {
        ...
        if (getDescription() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getDescription()); i++) {
        ...
        if (getPublisher() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getPublisher()); i++) {
        ...
        if (getContributor() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getContributor()); i++) {
        ...
        if (getIdentifier() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getIdentifier()); i++) {
        ...
        if (getSource() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getSource()); i++) {
        ...
        if (getLanguage() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getLanguage()); i++) {
        ...
        if (getRelation() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getRelation()); i++) {
        ...
        if (getCoverage() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getCoverage()); i++) {
        ...
        if (getRights() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getRights()); i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(ObjectFields.class, true);
