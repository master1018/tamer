 ...
 *
 */
public class SelectorParametro extends JPanel implements ChangeListener, ActionListener {
    ...
    public SelectorParametro(NombreParametro nombreParametro, ControladorParametro controladorParametro, Unit unidad) {
        super();
        super.setLayout(new BoxLayout(this, BoxLayout.X_AXIS));
        super.setAlignmentY(JPanel.CENTER_ALIGNMENT);
        super.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder(nombreParametro.toString()), BorderFactory.createEmptyBorder(5, 5, 5, 5)));
    ...
    public void setTextLabelDuracion(double duracionEnMS) {
        this.labelDuracion.setText(String.valueOf(this.numberFormat.format(duracionEnMS) + " ms"));
    }
