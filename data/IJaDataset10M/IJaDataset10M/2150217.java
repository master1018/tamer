 ...
 * @since 1.1
 */
public class BooleanGeneTest extends JGAPTestCase {
   ...
   * @since 3.1
   */
    public void testCompareTo_6() throws Exception {
        Gene gene1 = new BooleanGene(conf);
        Gene gene2 = new BooleanGene(conf);
   ...
   * @since 3.1
   */
    public void testCompareTo_6_2() throws Exception {
        Gene gene1 = new BooleanGene(conf);
   ...
   * @since 3.1
   */
    public void testCompareTo_6_3() throws Exception {
        Gene gene1 = new BooleanGene(conf);
   ...
   * @since 3.1
   */
    public void testCompareTo_7() throws Exception {
        Gene gene1 = new BooleanGene(conf);
        Gene gene2 = new BooleanGene(conf);
   ...
   * @author Klaus Meffert
   */
    public void testApplyMutation_8() throws Exception {
        BooleanGene gene = new BooleanGene(conf);
        gene.setAllele(Boolean.valueOf(false));
        gene.applyMutation(22, -0.5d);
        assertEquals(false, gene.booleanValue());
    }
   ...
   * @author Klaus Meffert
   */
    public void testApplyMutation_9() throws Exception {
        BooleanGene gene = new BooleanGene(conf);
        gene.setAllele(Boolean.valueOf(false));
        gene.applyMutation(22, 0.5d);
        assertEquals(true, gene.booleanValue());
   ...
   * @since 2.2
   */
    public void testApplyMutation_10() throws Exception {
        BooleanGene gene = new BooleanGene(conf);
        gene.applyMutation(0, 0.0d);
        assertEquals(false, gene.booleanValue());
    }
   ...
   * @since 2.0
   */
    public void testSetValueFromPersistentRepresentation_0() throws Exception {
        BooleanGene gene = new BooleanGene(conf);
        try {
   ...
   * @since 2.0
   */
    public void testSetValueFromPersistentRepresentation_1() throws Exception {
        BooleanGene gene = new BooleanGene(conf);
        gene.setValueFromPersistentRepresentation("null");
   ...
   * @since 2.0
   */
    public void testSetValueFromPersistentRepresentation_2() throws Exception {
        BooleanGene gene = new BooleanGene(conf);
   ...
   * @since 2.0
   */
    public void testSetValueFromPersistentRepresentation_3() throws Exception {
        BooleanGene gene = new BooleanGene(conf);
   ...
   * @since 2.0
   */
    public void testSetValueFromPersistentRepresentation_4() throws Exception {
        BooleanGene gene = new BooleanGene(conf);
        try {
            gene.setValueFromPersistentRepresentation("True");
            fail();
   ...
   * @since 2.0
   */
    public void testSetValueFromPersistentRepresentation_5() throws Exception {
        BooleanGene gene = new BooleanGene(conf);
        try {
            gene.setValueFromPersistentRepresentation("False");
            fail();
   ...
   * @since 2.0
   */
    public void testSetValueFromPersistentRepresentation_6() throws Exception {
        BooleanGene gene = new BooleanGene(conf);
        try {
   ...
   * @author Klaus Meffert
   */
    public void testGetPersistentRepresentation_0() throws Exception {
        BooleanGene gene = new BooleanGene(conf);
        gene.setAllele(Boolean.valueOf(true));
   ...
   * @author Klaus Meffert
   */
    public void testGetPersistentRepresentation_1() throws Exception {
        BooleanGene gene = new BooleanGene(conf);
        gene.setAllele(Boolean.valueOf(false));
        String s = gene.getPersistentRepresentation();
   ...
   * @author Klaus Meffert
   */
    public void testGetPersistentRepresentation_2() throws Exception {
        BooleanGene gene = new BooleanGene(conf);
        String s = gene.getPersistentRepresentation();
        assertEquals("null", s);
    }
