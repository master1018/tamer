...
public class FilePathEditController extends CommonController {
    ...
    private class DeleteAlert extends AlertController {
        ...
        protected DeleteAlert(FilePathItem deleteFilePath) throws InterruptedException {
            super("Please, confirm that you want to delete the location: " + deleteFilePath.toString(), Messagebox.YES | Messagebox.NO, Messagebox.QUESTION);
    ...
    @Override
    public void eventFilePathEdit(FilePathItem filePathItem) throws SearchLibException {
        if (filePathItem == null) return;
    ...
    public String getCurrentEditMode() throws SearchLibException {
        return selectedFilePath == null ? "Add a new location" : "Edit the selected location";
    }
    ...
    public void onSave() throws InterruptedException, SearchLibException, URISyntaxException {
        ...
        if (selectedFilePath == null) {
            ...
            if (checkFilePath != null) if (checkFilePath.hashCode() != selectedFilePath.hashCode()) {
                new AlertController("The location already exists");
                return;
            }
    ...
    public File[] getCurrentFileList() throws SearchLibException, IOException {
        synchronized (this) {
            ...
            if (isIgnoreHidden()) return currentFolder.listFiles((FileFilter) HiddenFileFilter.VISIBLE); else return currentFolder.listFiles();
        }
    }
    ...
    public File getCurrentFolder() throws SearchLibException, IOException {
        synchronized (this) {
            Client client = getClient();
            if (client == null) return null;
            if (currentFolder == null && ClientFactory.INSTANCE.properties.isChroot()) setCurrentFolder(StartStopListener.OPENSEARCHSERVER_DATA_FILE);
    ...
    public void setCurrentFolder(File file) throws IOException {
        if (!ClientFactory.INSTANCE.properties.checkChrootQuietly(file)) return;
        currentFolder = file;
        ...
        if (currentFolder != null) {
            ...
            for (; ; ) {
                ...
                f = f.getParentFile();
                if (f == null) break;
                if (!ClientFactory.INSTANCE.properties.checkChrootQuietly(f)) break;
            }
        }
        currentFile = null;
        reloadBrowser();
    ...
    public void onOpenFile(Component component) throws IOException {
        ...
        if (file.isDirectory()) setCurrentFolder(file);
    }
    ...
    public void onParentFolder() throws IOException {
        if (currentFolder != null) setCurrentFolder(currentFolder.getParentFile());
    }
}
