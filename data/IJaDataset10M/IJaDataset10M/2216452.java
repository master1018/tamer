...
public class PrepQCgenomes extends Module {
   ...
   */
    ...
    public ReturnValue init() {
        ...
        try {
            ...
            ret.setStdout(ret.getStdout() + "Output: " + (String) options.valueOf("outputDIR") + "/QCgenomes." + (String) thisdate + ".log\nOutput: " + (String) options.valueOf("outputDIR") + "/QCgenomes." + (String) thisdate + ".fa\nOutput: " + (String) options.valueOf("outputDIR") + "/QCgenomes." + (String) thisdate + ".key\n");
   ...
   */
    ...
    public ReturnValue do_verify_parameters() {
        ReturnValue ret = new ReturnValue();
        ret.setExitStatus(ReturnValue.SUCCESS);
        for (String option : new String[] { "outputDIR", "perl", "script" }) {
   ...
   */
    ...
    public ReturnValue do_verify_output() {
        ...
        if ((FileTools.fileExistsAndNotEmpty(outputL).getExitStatus() != ReturnValue.SUCCESS) || (FileTools.fileExistsAndNotEmpty(outputF).getExitStatus() != ReturnValue.SUCCESS) || (FileTools.fileExistsAndNotEmpty(outputK).getExitStatus() != ReturnValue.SUCCESS)) {
            ret.setExitStatus(ReturnValue.FILENOTREADABLE);
