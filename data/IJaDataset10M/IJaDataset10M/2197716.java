...
public class IBM01149 extends Charset {
    ...
    private static final class Encoder extends CharsetEncoder {
        ...
        protected CoderResult encodeLoop(CharBuffer cb, ByteBuffer bb) {
            ...
            if (CharsetProviderImpl.hasLoadedNatives() && bb.isDirect() && cb.hasRemaining() && cb.hasArray()) {
                ...
                if (res[0] <= 0) {
                    ...
                    if (res[1] != 0) {
                        if (res[1] < 0) return CoderResult.malformedForLength(-res[1]); else return CoderResult.unmappableForLength(res[1]);
                    }
                } else {
                    bb.position(bbPos + res[0]);
                    cb.position(cbPos + res[0]);
        ...
        static final char arr[] = {  };
