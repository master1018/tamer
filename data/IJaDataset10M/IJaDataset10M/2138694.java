...
public class Project implements Serializable, ZFormatObject {
    ...
    public void addEvacuationPlan(EvacuationPlan val) throws IllegalArgumentException {
        if (evacuationPlans.contains(val)) throw new IllegalArgumentException(ZLocalization.getSingleton().getString("ds.PlanAlreadyExistsException"));
        if (currentEvacuationPlan == null) currentEvacuationPlan = val;
    ...
    public void deleteEvacuationPlan(EvacuationPlan val) throws IllegalArgumentException {
        if (!evacuationPlans.remove(val)) throw new IllegalArgumentException(ZLocalization.getSingleton().getString("ds.PlanNotRegisteredException"));
        val.delete();
        if (val == currentEvacuationPlan) currentEvacuationPlan = evacuationPlans.size() > 0 ? evacuationPlans.get(0) : null;
    }
    ...
    public void setCurrentEvacuationPlan(EvacuationPlan val) throws IllegalArgumentException {
        if (!evacuationPlans.contains(val)) throw new IllegalArgumentException(ZLocalization.getSingleton().getString("ds.PlanNotInProjectException"));
    ...
    public void addAssignment(Assignment val) throws IllegalArgumentException {
        if (assignments.contains(val)) throw new IllegalArgumentException(ZLocalization.getSingleton().getString("ds.AssignmentAlreadyRegisteredException"));
        if (currentAssignment == null) currentAssignment = val;
        assignments.add(val);
    }
    ...
    public void deleteAssignment(Assignment val) throws IllegalArgumentException {
        if (!assignments.remove(val)) throw new IllegalArgumentException(ZLocalization.getSingleton().getString("ds.AssignmentNotRegisteredException"));
        if (val == null) return;
        val.delete();
        if (val == currentAssignment) if (assignments.size() > 0) currentAssignment = assignments.get(0); else currentAssignment = null;
    }
    ...
    public Assignment getCurrentAssignment() {
        if (currentAssignment == null) if (assignments.size() > 0) currentAssignment = assignments.get(0);
    ...
    public void setCurrentAssignment(Assignment val) throws IllegalArgumentException {
        if (!assignments.contains(val)) throw new IllegalArgumentException(ZLocalization.getSingleton().getString("ds.AssignmentNotInProjectException"));
    ...
    public boolean equals(Object o) {
        if (o instanceof Project) {
            Project p = (Project) o;
            if (assignments.size() != p.assignments.size() || evacuationPlans.size() != p.evacuationPlans.size()) return false;
