...
public class UserAgentProfile extends Configure {
    ...
    private static String config_file = "jjsip.cfg";
    ...
    public void initContactAddress(SipProvider sip_provider) {
        if (contact_url == null) {
            ...
            if (!sip_provider.getDefaultTransport().equals(SipProvider.Protocol.UDP.informalName)) contact_url += ";transport=" + sip_provider.getDefaultTransport();
        }
