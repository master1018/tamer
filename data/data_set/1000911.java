...
public class UTBDP10StrongKEMEngineTest extends AbstractJPBCCryptoTest {
    ...
    public void testUTBDP10StrongKEMEngine() {
        ...
        assertEquals(true, Arrays.equals(ct[0], decaps(keyPair.getPrivate(), randomize(parameters.getPublicParameters(), parameters.getRPublicParameters(), ct[1]))));
    }
    ...
    protected byte[] randomize(UTBDP10StrongPublicParameters publicParameters, UTBDP10StrongRPublicParameters rPublicParameters, byte[] ciphertext) {
        try {
            KeyEncapsulationMechanism engine = new UTBDP10StrongKEMEngine();
