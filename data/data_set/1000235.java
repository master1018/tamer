...
public class Parser extends ONDEXParser implements MetaData {
    ...
    public ArgumentDefinition<?>[] getArgumentDefinitions() {
        return new ArgumentDefinition<?>[] { new FileArgumentDefinition(FileArgumentDefinition.INPUT_FILE, FileArgumentDefinition.INPUT_FILE_DESC, true, true, false, false) };
    }
        ...
        try {
            ...
            while (reader.ready()) {
                ...
                if (to == null) {
                    ...
                    if (!line[3].trim().equalsIgnoreCase("No")) to.createAttribute(isTf, line[3], false);
                }
