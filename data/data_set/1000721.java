...
final class ReplayPhase extends Phase {
    ...
    ReplayPhase(RecordAndReplayExecution recordAndReplay) {
        ...
        initialStrictExpectationIndexForCurrentBlock = Math.max(recordAndReplay.lastExpectationIndexInPreviousReplayPhase, 0);
    ...
    private void positionOnFirstStrictInvocation() {
        ...
        if (expectations.isEmpty()) {
            ...
            currentExpectation = currentStrictExpectationIndex < expectations.size() ? expectations.get(currentStrictExpectationIndex) : null;
        }
    }
    ...
    @Override
    Object handleInvocation(Object mock, int mockAccess, String mockClsDesc, String mockDesc, String genericSignature, String exceptions, boolean withRealImpl, Object[] args) throws Throwable {
        ...
        if (nonStrictExpectation == null) {
            createExpectationIfNonStrictInvocation(mock, mockAccess, mockClsDesc, mockDesc, genericSignature, exceptions, args);
        }
        if (nonStrictExpectation != null) {
    ...
    private void createExpectationIfNonStrictInvocation(Object mock, int mockAccess, String mockClassDesc, String mockNameAndDesc, String genericSignature, String exceptions, Object[] args) {
        if (!TestRun.getExecutingTest().isStrictInvocation(mock, mockClassDesc, mockNameAndDesc)) {
            ExpectedInvocation invocation = new ExpectedInvocation(mock, mockAccess, mockClassDesc, mockNameAndDesc, false, genericSignature, exceptions, args);
    ...
    private Object handleStrictInvocation(Object mock, String mockClassDesc, String mockNameAndDesc, boolean withRealImpl, Object[] replayArgs) throws Throwable {
        ...
        while (true) {
            ...
            if (invocation.isMatch(mock, mockClassDesc, mockNameAndDesc, instanceMap)) {
                ...
                recordAndReplay.setErrorThrown(invocation.errorForUnexpectedInvocation(mock, mockClassDesc, mockNameAndDesc));
                return null;
            }
        }
    }
    ...
    private Object handleUnexpectedInvocation(Object mock, String mockClassDesc, String mockNameAndDesc, boolean withRealImpl, Object[] replayArgs) {
        ...
        recordAndReplay.setErrorThrown(new ExpectedInvocation(mock, mockClassDesc, mockNameAndDesc, replayArgs).errorForUnexpectedInvocation());
        return null;
    }
