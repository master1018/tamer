 ...
 * @version $Id: AbstractListUpdatableForm.java 64 2010-12-18 15:19:19Z syllant $
 */
public abstract class AbstractListUpdatableForm<E extends IRevuUniqueNameHolderEntity<E>, F extends AbstractUpdatableForm<E>> implements Configurable, Disposable {
    ...
    protected void configureUI() {
        list.setCellRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                AbstractListUpdatableForm.this.customizeListCellRendererComponent((JLabel) result, list, entity, index, isSelected, cellHasFocus);
                return result;
            }
        });
   ...
   */
    public final void apply() throws ConfigurationException {
        if (!updateFormData()) {
            throw new ConfigurationException(RevuBundle.message("general.form.hasErrors.text"), RevuBundle.message("general.plugin.title"));
        }
        int itemCount = list.getModel().getSize();
   ...
   */
    ...
    protected void customizeListCellRendererComponent(JLabel renderer, JList list, E entity, int index, boolean selected, boolean cellHasFocus) {
    }
