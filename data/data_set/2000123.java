 ...
 * image files:
 * 
 * JFileChooser chooser = new JFileChooser(); GenomeFileFilter filter = new
 * GenomeFileFilter( new String{"gif", "jpg"}, "JPEG & GIF Images")
...
public class MyFileFilter extends FileFilter {
	 ...
	 * Example: new GenomeFileFilter("jpg");
	 * 
	 * @see #addExtension
	 */
	 ...
	 * GenomeFileFilter("jpg", "JPEG Image Images");
	 * 
	 ...
	 * GenomeFileFilter(String {"gif", "jpg"});
	 * 
	 ...
	 * Example: new GenomeFileFilter(String {"gif", "jpg"},
	 * "Gif and JPG Images");
	 * 
	 ...
	 * 
	 * GenomeFileFilter filter = new GenomeFileFilter();
