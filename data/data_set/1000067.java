...
public class UserInputData {
    ...
    private ArrayList<Integer> columnVisibility;
    ...
    private String isAutoSaveEnabled = "";
    ...
    public void setSelectedUserlevel(Userlevel level) {
        switch(level) {
            case BEGINNER:
                selectedUserlevel = Userlevel.BEGINNER.toString();
                break;
            case EXPERT:
                selectedUserlevel = Userlevel.EXPERT.toString();
                break;
            case CUSTOM:
                selectedUserlevel = Userlevel.CUSTOM.toString();
                break;
            default:
                selectedUserlevel = Userlevel.UNDEFINED.toString();
                break;
        }
    }
