...
public class ConfigTest {
    ...
    private static final String BASIC_CONFIG = "supportfiles/config/basic.cfg";

    private static final String INCLUDE_CONFIG = "supportfiles/config/include.cfg";

    private static final String INCLUDE_CONFIG_2 = "supportfiles/config/include2.cfg";

    private static final String MORE_CONFIG = "supportfiles/config/more.cfg";

    private static final String WHITESPACE_CONFIG = "supportfiles/config/whitespace.cfg";

    private static final String CONFIG_DIR = "supportfiles/config/configdir";

    private static final String CONFIG_TREE = "supportfiles/config/configtree";

    private static final String CONFIG_INCLUDE_SUBDIR_FILE = "supportfiles/config/include_subdir_file.cfg";

    private static final String CONFIG_INCLUDE_SUBDIR = "supportfiles/config/include_subdir.cfg";

    private static final String NONEXISTANT_INCLUDE = "supportfiles/config/nonexistant_include.cfg";

    private static final String EMPTY_INCLUDE = "supportfiles/config/empty_include.cfg";

    private static final String MALFORMED_1 = "supportfiles/config/malformed1.cfg";

    private static final String MALFORMED_2 = "supportfiles/config/malformed2.cfg";

    private static final String MALFORMED_3 = "supportfiles/config/malformed3.cfg";

    private static final String MALFORMED_4 = "supportfiles/config/malformed4.cfg";

    private static final String MALFORMED_5 = "supportfiles/config/malformed5.cfg";

    private static final String MALFORMED_6 = "supportfiles/config/malformed6.cfg";

    private static final String BOOLEAN_CONFIG = "supportfiles/config/boolean.cfg";

    private static final String ARRAY_CONFIG = "supportfiles/config/array.cfg";

    private static final String RESOURCE_CONFIG = "rescuecore2/config/resource.cfg";

    private static final String DOLLAR_CONFIG = "supportfiles/config/dollar.cfg";

    private static final String DOLLAR_CONFIG_2 = "supportfiles/config/dollar2.cfg";

    private static final String DOLLAR_CONFIG_BAD = "supportfiles/config/dollar-bad.cfg";

    private static final String DOLLAR_CONFIG_DEFAULT = "supportfiles/config/dollar-default.cfg";
