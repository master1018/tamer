...
public class JAutoTextField extends JTextField {
    ...
    class AutoDocument extends PlainDocument {
        ...
        public void remove(int i, int j) throws BadLocationException {
            ...
            if (autoComboBox != null && s != null) autoComboBox.setSelectedValue(s);
            try {
                setSelectionStart(k);
                setSelectionEnd(getLength());
    ...
    private void init() {
        ...
        if (isStrict && dataList.size() > 0) setText(dataList.get(0).toString());
    }
    ...
    private String getMatch(String s) {
        for (int i = 0; i < dataList.size(); i++) {
            ...
            if (s1 != null) {
                if (!isCaseSensitive && s1.toLowerCase().startsWith(s.toLowerCase())) return s1;
                if (isCaseSensitive && s1.startsWith(s)) return s1;
            }
        }
        return null;
    }
