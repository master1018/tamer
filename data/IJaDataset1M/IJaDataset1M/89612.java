...
public class MolgenisUserGroup extends org.molgenis.util.AbstractEntity {
    ...
    public void setMembers(java.util.List _members) {
        if (_members != null && _members.size() > 0 && _members instanceof MolgenisUser) {
            ...
            if (this._members != null) this._members = _members; else this._members = new java.util.ArrayList<Integer>();
        }
    }
    ...
    public void setCanRead(java.util.List _canRead) {
        if (_canRead != null && _canRead.size() > 0 && _canRead instanceof MolgenisEntityMetaData) {
            ...
            if (this._canRead != null) this._canRead = _canRead; else this._canRead = new java.util.ArrayList<Integer>();
        }
    }
    ...
    public void setCanWrite(java.util.List _canWrite) {
        if (_canWrite != null && _canWrite.size() > 0 && _canWrite instanceof MolgenisEntityMetaData) {
            ...
            if (this._canWrite != null) this._canWrite = _canWrite; else this._canWrite = new java.util.ArrayList<Integer>();
        }
    }
    ...
    public Object get(String name) {
        ...
        if (name.toLowerCase().equals("id")) return getId();
        if (name.toLowerCase().equals("name")) return getName();
        if (name.toLowerCase().equals("superuser")) return getSuperuser();
        if (name.toLowerCase().equals("members")) return getMembers();
        if (name.toLowerCase().equals("members_name")) return getMembersLabels();
        if (name.toLowerCase().equals("canread")) return getCanRead();
        if (name.toLowerCase().equals("canread_name")) return getCanReadLabels();
        if (name.toLowerCase().equals("canwrite")) return getCanWrite();
        if (name.toLowerCase().equals("canwrite_name")) return getCanWriteLabels();
        return "";
    }
        ...
        if (tuple instanceof ResultSetTuple) {
            ...
            if (tuple.getObject("members") != null) {
                ...
                if (mrefs != null) for (Object ref : mrefs) {
                    if (ref instanceof String) values.add(Integer.parseInt((String) ref)); else values.add((Integer) ref);
                }
    ...
    public boolean equals(Object other) {
        if (!MolgenisUserGroup.class.equals(other.getClass())) return false;
        MolgenisUserGroup e = (MolgenisUserGroup) other;
        if (getId() == null ? e.getId() != null : !getId().equals(e.getId())) return false;
        if (getName() == null ? e.getName() != null : !getName().equals(e.getName())) return false;
        if (getSuperuser() == null ? e.getSuperuser() != null : !getSuperuser().equals(e.getSuperuser())) return false;
        if (getMembers() == null ? e.getMembers() != null : !getMembers().equals(e.getMembers())) return false;
        if (getCanRead() == null ? e.getCanRead() != null : !getCanRead().equals(e.getCanRead())) return false;
        if (getCanWrite() == null ? e.getCanWrite() != null : !getCanWrite().equals(e.getCanWrite())) return false;
        return true;
    }
    ...
    public String getFields(String sep) {
        return ("" + "id" + sep + "name" + sep + "superuser" + sep + "members" + sep + "canRead" + sep + "canWrite");
    }
    ...
    public String getValues(String sep) {
        StringWriter out = new StringWriter();
        {
            Object valueO = getId();
            String valueS;
            if (valueO != null) valueS = valueO.toString(); else valueS = "";
