...
public class SimulationConfig implements Serializable {
    ...
    public double getSimulationTimeRatio() {
        ...
        if (ratio < 0D) throw new IllegalStateException("Simulation time ratio must be positive number."); else if (ratio == 0D) throw new IllegalStateException("Simulation time ratio cannot be zero.");
        return ratio;
    }
    ...
    public String getEarthStartDateTime() {
        ...
        if ((startDate == null) || startDate.trim().length() == 0) throw new IllegalStateException("Earth start date time must not be blank.");
        return startDate;
    }
    ...
    public String getMarsStartDateTime() {
        ...
        if ((startDate == null) || startDate.trim().length() == 0) throw new IllegalStateException("Mars start date time must not be blank.");
        return startDate;
    }
