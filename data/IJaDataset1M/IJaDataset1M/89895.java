...
import net.sourceforge.poi.hssf.util.Region;
...
public class HSSFSheet {
     ...
     * @see net.sourceforge.poi.hssf.usermodel.HSSFWorkbook#createSheet()
     */
     ...
     * @see net.sourceforge.poi.hssf.usermodel.HSSFRow
    ...
    public int addMergedRegion(Region region) {
        return sheet.addMergedRegion((short) region.getRowFrom(), region.getColumnFrom(), (short) region.getRowTo(), region.getColumnTo());
    }
