 ...
 *
 */
public class DirectoryManagerSearchDM extends FunctionProxy {
     ...
     */
    public DirectoryManagerSearchDM(Requestor requestor, Response response) throws org.json.JSONException {
     ...
     *   --  tag_name instances {@code String}
     */
    public Response execute() throws org.json.JSONException {
        com.softwoehr.pigiron.functions.DirectoryManagerSearchDM pigfunc = new com.softwoehr.pigiron.functions.DirectoryManagerSearchDM(getHostSpecifier(), host.getPortNumber(), user.getUid(), user.getPassword(), getTargetIdentifier(), getInputArgumentString("tag_name"));
