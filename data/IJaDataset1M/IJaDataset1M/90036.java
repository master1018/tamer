...
public class Expediente implements Serializable {
    ...
    public static final String ESTADO_SOLICITUD_ENVIADA = "SE";

    public static final String ESTADO_SOLICITUD_ENVIADA_PENDIENTE_DOCUMENTACION_PRESENCIAL = "SP";

    public static final String ESTADO_AVISO_PENDIENTE = "AP";

    public static final String ESTADO_AVISO_RECIBIDO = "AR";

    public static final String ESTADO_NOTIFICACION_PENDIENTE = "NP";

    public static final String ESTADO_NOTIFICACION_RECIBIDA = "NR";
