...
public class AnnotationTreePerformanceTester {
    ...
    void testPerformance1(Random random) {
        ...
        RawAnnotationSet<Object> b = new AnnotationTree<Object>(new Object(), new Object(), null);
    ...
    void applyRandomOperation(RawAnnotationSet<Object> a, RawAnnotationSet<Object> b, String[] keys, String[] values, Random random) {
        if (a != null) {
    ...
    void setAnnotation(RawAnnotationSet<Object> a, int start, int end, String key, Object value) throws OperationException {
        a.begin();
        if (start > 0) {
            a.skip(start);
        }
    ...
    void insert(RawAnnotationSet<Object> a, int firstShiftedIndex, int length) throws OperationException {
        a.begin();
    ...
    void applyRandomDelete(RawAnnotationSet<Object> a, RawAnnotationSet<Object> b, Random random) throws OperationException {
    ...
    void applyRandomInsert(RawAnnotationSet<Object> a, RawAnnotationSet<Object> b, Random random) throws OperationException {
    ...
    void applyRandomSet(RawAnnotationSet<Object> a, RawAnnotationSet<Object> b, String[] keys, String[] values, Random random) throws OperationException {
