...
public class TestPropertiesWrapper extends Assert {
    ...
    public void testGetLongSuccess() {
        assertEquals(1234567890123456L, wrapper.getLongProperty("p", 1234567890123456L));
        assertEquals(1234567890123456L, wrapper.getLongProperty("p", 1234567890123456L, 0, 1234567890123456L));
        ...
        assertEquals(2345678901234567L, wrapper.getLongProperty("p", 10, 0, 2345678901234567L));
        props.setProperty("p", "100");
    ...
    public void testGetEnumSuccess() {
        assertSame(Fruit.APPLE, wrapper.getEnumProperty("fruit", Fruit.class, Fruit.APPLE));
        props.setProperty("fruit", "ORANGE");
        assertSame(Fruit.ORANGE, wrapper.getEnumProperty("fruit", Fruit.class, Fruit.APPLE));
    }
    ...
    public void testGetListPropertyNoProperty() {
        List<String> list = wrapper.getListProperty("values", String.class, null);
    ...
    public void testGetListPropertySingleValue() {
        ...
        List<Integer> list = wrapper.getListProperty("values", Integer.class, null);
    ...
    public void testGetListPropertyDefaultValue() {
        props.setProperty("values", "1::2");
        List<Integer> list = wrapper.getListProperty("values", Integer.class, 3);
    ...
    public void testGetEnumListPropertyNoProperty() {
        List<Fruit> list = wrapper.getEnumListProperty("values", Fruit.class, Fruit.APPLE);
        assertEquals(0, list.size());
    }
    ...
    public void testGetEnumListPropertySingleValue() {
        ...
        List<Fruit> list = wrapper.getEnumListProperty("values", Fruit.class, Fruit.PEAR);
        assertEquals(1, list.size());
    ...
    public void testGetEnumListPropertyNullDefaultValue() {
        props.setProperty("values", "APPLE::ORANGE");
        List<Fruit> list = wrapper.getEnumListProperty("values", Fruit.class, null);
        assertEquals(3, list.size());
        assertEquals(Fruit.APPLE, list.get(0));
        assertNull(list.get(1));
        assertEquals(Fruit.ORANGE, list.get(2));
    ...
    public void testGetClassListPropertySingleValue() {
        props.setProperty("values", "com.sun.sgs.test.impl.sharedutil.TestPropertiesWrapper$One");
        List<Class<?>> list = wrapper.getClassListProperty("values");
        assertEquals(1, list.size());
    ...
    public void testGetClassListPropertyMultipleValues() {
        props.setProperty("values", "com.sun.sgs.test.impl.sharedutil.TestPropertiesWrapper$One:" + "com.sun.sgs.test.impl.sharedutil.TestPropertiesWrapper$Two");
        List<Class<?>> list = wrapper.getClassListProperty("values");
        assertEquals(2, list.size());
        assertEquals(One.class, list.get(0));
    ...
    public void testGetClassListPropertyInvalidValue() {
        props.setProperty("values", "com.sun.sgs.test.impl.sharedutil.TestPropertiesWrapper$One:" + "com.sun.sgs.test.impl.sharedutil.TestPropertiesWrapper$Two:" + "this.is.not.a.class");
        wrapper.getClassListProperty("values");
    }

    @Test
    public void testGetClassListPropertyPrivateClass() {
        props.setProperty("values", "com.sun.sgs.test.impl.sharedutil.TestPropertiesWrapper$One:" + "com.sun.sgs.test.impl.sharedutil.TestPropertiesWrapper$Two:" + "com.sun.sgs.test.impl.sharedutil.TestPropertiesWrapper$" + "PrivateClass");
        List<Class<?>> list = wrapper.getClassListProperty("values");
        assertEquals(One.class, list.get(0));
        assertEquals(Two.class, list.get(1));
