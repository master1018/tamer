...
public class ThreadHistory implements Serializable {
    ...
    ThreadHistory(long timestampInMillis, Long threadId, String taskName, String status, String note, Boolean threadInUse, int sequenceId) {
        this(timestampInMillis, threadId, taskName, status, note, threadInUse, 0L, sequenceId);
    }

    ThreadHistory(long timestampInMillis, Long threadId, String taskName, String status, String note, Boolean threadInUse, long sequentialTime, int sequenceId) {
    ...
    public String toString() {
        ...
        sb.append(timestampInMillis).append(":").append(threadId).append(taskName).append(status);
        return sb.toString();
    }
