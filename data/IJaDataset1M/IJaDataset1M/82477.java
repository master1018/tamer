...
public class TargetEditorTableModel extends PrettyTableModel {
    ...
    */
    private boolean promptForSparseData(NutrientInfo ni) {
        ...
        int rc = JOptionPane.showConfirmDialog(CRONOMETER.mainFrame, ni.getName() + data + " in the USDA food database.\n" + "Are you sure you want to track it?", "Track " + ni.getName() + "?", JOptionPane.YES_NO_OPTION);
