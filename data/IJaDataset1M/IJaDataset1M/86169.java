...
public class PayloadBasedSftpConsumerTest {
     ...
     */
    @Test
    public void test_successful_invocation_withDirectoryURLFactory_no_discovered_file() throws ResourceException {
        ...
        this.mockery.checking(new Expectations() {

            {
                ...
                one(sftpConfiguration).getSourceDirectory();
                will(returnValue("sourceDirectory"));
                one(sourceDirectoryURLFactory).getDirectoriesURLs("sourceDirectory");
                will(returnValue(sourceDirectories));
                one(sftpConfiguration).getFilenamePattern();
                will(returnValue("filenamePattern"));
                one(sftpConfiguration).getRenameOnSuccess();
                will(returnValue(Boolean.TRUE));
                one(sftpConfiguration).getRenameOnSuccessExtension();
                will(returnValue("renameExtention"));
                one(sftpConfiguration).getMoveOnSuccess();
                will(returnValue(Boolean.FALSE));
                one(sftpConfiguration).getMoveOnSuccessNewPath();
                will(returnValue("moveOnSuccessNewPath"));
                one(sftpConfiguration).getChunking();
                will(returnValue(Boolean.FALSE));
                one(sftpConfiguration).getChunkSize();
                will(returnValue(Integer.valueOf(-1)));
                one(sftpConfiguration).getChecksum();
                will(returnValue(Boolean.FALSE));
                one(sftpConfiguration).getMinAge();
                will(returnValue(Long.valueOf(1)));
                one(sftpConfiguration).getDestructive();
                will(returnValue(Boolean.TRUE));
                one(sftpConfiguration).getFilterDuplicates();
                will(returnValue(Boolean.TRUE));
                one(sftpConfiguration).getFilterOnFilename();
                will(returnValue(Boolean.TRUE));
                one(sftpConfiguration).getFilterOnLastModifiedDate();
                will(returnValue(Boolean.TRUE));
                one(sftpConfiguration).getChronological();
                will(returnValue(Boolean.TRUE));
                one(fileTransferConnectionTemplate).getDiscoveredFile("sourceDirectory", "filenamePattern", true, "renameExtention", false, "moveOnSuccessNewPath", false, -1, false, 1, true, true, true, true, true);
                will(returnValue(null));
                one(sftpConfiguration).getMaxRows();
                will(returnValue(Integer.valueOf(1)));
                one(sftpConfiguration).getAgeOfFiles();
                will(returnValue(Integer.valueOf(1)));
     ...
     */
    @Test
    public void test_successful_invocation_no_discovered_file() throws ResourceException {
        final ByteArrayInputStream content = new ByteArrayInputStream("content".getBytes());
        final Map<String, InputStream> filenameContentPairsMap = new HashMap<String, InputStream>();
        filenameContentPairsMap.put("filename", content);
        this.mockery.checking(new Expectations() {
            ...
            {
                one(sftpConfiguration).getSourceDirectoryURLFactory();
                will(returnValue(null));
                one(sftpConfiguration).getSourceDirectory();
                will(returnValue("sourceDirectory"));
                one(sftpConfiguration).getFilenamePattern();
     ...
     */
    @Test
    public void consumer_must_not_perform_housekeeping_if_maxRows_not_configured() throws ResourceException {
        final ByteArrayInputStream content = new ByteArrayInputStream("content".getBytes());
        final Map<String, InputStream> filenameContentPairsMap = new HashMap<String, InputStream>();
        filenameContentPairsMap.put("filename", content);
        this.mockery.checking(new Expectations() {
     ...
     */
    @Test
    public void consumer_must_not_perform_housekeeping_if_ageOfFiles_not_configured() throws ResourceException {
        final ByteArrayInputStream content = new ByteArrayInputStream("content".getBytes());
        final Map<String, InputStream> filenameContentPairsMap = new HashMap<String, InputStream>();
        filenameContentPairsMap.put("filename", content);
        this.mockery.checking(new Expectations() {
     ...
     */
    @Test
    public void consumer_must_not_perform_housekeeping_if_either_maxRows_or_ageOfFiles_not_configured() throws ResourceException {
        final ByteArrayInputStream content = new ByteArrayInputStream("content".getBytes());
        final Map<String, InputStream> filenameContentPairsMap = new HashMap<String, InputStream>();
        filenameContentPairsMap.put("filename", content);
        this.mockery.checking(new Expectations() {
     ...
     */
    @Test
    public void test_successful_invocation_discovering_a_file() throws ResourceException {
        final ByteArrayInputStream content = new ByteArrayInputStream("content".getBytes());
        final Map<String, InputStream> filenameContentPairsMap = new HashMap<String, InputStream>();
        filenameContentPairsMap.put("filename", content);
        this.mockery.checking(new Expectations() {
     ...
     */
    @Test
    public void test_successful_invocation_with_DirectoryURLFactory_discovering_a_file() throws ResourceException {
        final ByteArrayInputStream content = new ByteArrayInputStream("content".getBytes());
        final List<String> sourceDirectories = new ArrayList<String>();
        sourceDirectories.add("sourceDirectory");
        final Map<String, InputStream> filenameContentPairsMap = new HashMap<String, InputStream>();
    ...
    public void consumer_fails_changes_to_original_connection_template() throws ResourceException {
        ...
        this.mockery.checking(new Expectations() {

            {
                exactly(2).of(sftpConfiguration).getSourceDirectoryURLFactory();
                will(returnValue(null));
                exactly(2).of(sftpConfiguration).getSourceDirectory();
                will(returnValue("sourceDirectory"));
                exactly(2).of(sftpConfiguration).getFilenamePattern();
                will(returnValue("filenamePattern"));
                exactly(2).of(sftpConfiguration).getRenameOnSuccess();
                will(returnValue(Boolean.TRUE));
                exactly(2).of(sftpConfiguration).getRenameOnSuccessExtension();
                will(returnValue("renameExtention"));
                exactly(2).of(sftpConfiguration).getMoveOnSuccess();
                will(returnValue(Boolean.FALSE));
                exactly(2).of(sftpConfiguration).getMoveOnSuccessNewPath();
                will(returnValue("moveOnSuccessNewPath"));
                exactly(2).of(sftpConfiguration).getChunking();
                will(returnValue(Boolean.FALSE));
                exactly(2).of(sftpConfiguration).getChunkSize();
                will(returnValue(Integer.valueOf(-1)));
                exactly(2).of(sftpConfiguration).getChecksum();
                will(returnValue(Boolean.FALSE));
                exactly(2).of(sftpConfiguration).getMinAge();
                will(returnValue(Long.valueOf(1)));
                exactly(2).of(sftpConfiguration).getDestructive();
                will(returnValue(Boolean.TRUE));
                exactly(2).of(sftpConfiguration).getFilterDuplicates();
                will(returnValue(Boolean.TRUE));
                exactly(2).of(sftpConfiguration).getFilterOnFilename();
                will(returnValue(Boolean.TRUE));
                exactly(2).of(sftpConfiguration).getFilterOnLastModifiedDate();
                will(returnValue(Boolean.TRUE));
                exactly(2).of(sftpConfiguration).getChronological();
                will(returnValue(Boolean.TRUE));
                one(fileTransferConnectionTemplate).getDiscoveredFile("sourceDirectory", "filenamePattern", true, "renameExtention", false, "moveOnSuccessNewPath", false, -1, false, 1, true, true, true, true, true);
                will(throwException(exception));
                one(mockAlternateConnectionTemplate).getDiscoveredFile("sourceDirectory", "filenamePattern", true, "renameExtention", false, "moveOnSuccessNewPath", false, -1, false, 1, true, true, true, true, true);
                will(throwException(exception));
            }
        });
        ((PayloadBasedSftpConsumer) this.payloadBasedSftpConsumer).setAlternateFileTransferConnectionTemplate(mockAlternateConnectionTemplate);
