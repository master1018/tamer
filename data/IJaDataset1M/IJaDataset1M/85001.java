...
public class Base64 {
    ...
    private static final Logger logger = Logger.getLogger("net.face2face.util");
    ...
    private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset) {
        if (source[srcOffset + 2] == EQUALS_SIGN) {
            ...
            try {
                ...
                logger.finest("" + source[srcOffset] + ": " + (DECODABET[source[srcOffset]]));
                logger.finest("" + source[srcOffset + 1] + ": " + (DECODABET[source[srcOffset + 1]]));
                logger.finest("" + source[srcOffset + 2] + ": " + (DECODABET[source[srcOffset + 2]]));
                logger.finest("" + source[srcOffset + 3] + ": " + (DECODABET[source[srcOffset + 3]]));
                return -1;
            }
        }
    }
