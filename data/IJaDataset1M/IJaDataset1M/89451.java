...
public class CommandGroup extends AbstractCommand {
	 ...
	 */
    private static CommandGroup createCommandGroup(final String groupId, final Object[] members, final boolean exclusive, final CommandConfigurer configurer) {
        final CommandConfigurer theConfigurer = (configurer != null) ? configurer : (CommandConfigurer) ApplicationServicesLocator.services().getService(CommandConfigurer.class);
