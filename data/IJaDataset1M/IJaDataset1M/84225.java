 ...
 */
public class OAuthPARequest extends PARequest {

    public OAuthPARequest(PARequest paRequest) {
    ...
    public OAuthPARequest(HttpServletRequest servletRequest, Client client) {
