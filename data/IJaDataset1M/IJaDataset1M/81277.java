...
public class WSPolicy {
    ...
    public static Reader transformPolicyFile(URI uri) {
        ...
        try {
            ...
            javax.xml.transform.Source xmlSource = new javax.xml.transform.stream.StreamSource(uri.toString());
            javax.xml.transform.Source xsltSource = new javax.xml.transform.stream.StreamSource(WSPOLICY_XSLT_URI);
