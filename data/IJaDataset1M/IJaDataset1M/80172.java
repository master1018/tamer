...
public class SourceFileException extends QedeqException {
     ...
     */
    public SourceFileException(final Plugin plugin, final int errorCode, final String errorText, final Throwable exception, final SourceArea errorArea, final SourceArea referenceArea) {
     ...
     * @param   referenceArea   Error reference location.
     */
    public SourceFileException(final Plugin plugin, final QedeqException exception, final SourceArea errorArea, final SourceArea referenceArea) {
    ...
    public String getDescription() {
        ...
        if (errorArea != null && errorArea.getStartPosition() != null) {
            ...
            buffer.append(errorArea.getAddress() + ":" + start.getRow() + ":" + start.getColumn());
            buffer.append("\n");
        }
    ...
    public final int hashCode() {
        return getErrorCode() ^ (errorArea != null ? errorArea.hashCode() : 13) ^ (getPlugin() != null ? getPlugin().hashCode() : 131) ^ (getMessage() != null ? getMessage().hashCode() : 499);
    }
    ...
    public final boolean equals(final Object obj) {
        ...
        return (getErrorCode() == other.getErrorCode()) && EqualsUtility.equals(getPlugin(), other.getPlugin()) && EqualsUtility.equals(getMessage(), other.getMessage()) && EqualsUtility.equals(errorArea, other.errorArea);
    }
