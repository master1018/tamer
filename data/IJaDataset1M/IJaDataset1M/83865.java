...
public class FeatTest extends TestCase {
    ...
    public void testAlertness() throws Exception {
        ...
        CampaignSourceEntry source = new CampaignSourceEntry(new Campaign(), FeatTest.class.getName() + ".java");
        featLoader.setCurrentSource(source);
        alertnessFeat = new Ability();
        featLoader.parseLine(alertnessFeat, "Alertness	TYPE:General	DESC:+2 on Listen and Spot checks	BONUS:SKILL|Listen,Spot|2", source);
    ...
    public void testAmbidexterity() throws Exception {
        ...
        featLoader.parseLine(ambidexterityFeat, "Ambidexterity	PRESTAT:1,DEX=15	PREHANDSEQ:2	TYPE:General.Fighter	DESC:You ignore all penalties for using your off-hand	BONUS:COMBAT|TOHIT-SECONDARY|4", source);
    ...
    public void testSimpleWeapon() throws Exception {
        ...
        featLoader.parseLine(simpleWeaponFeat, "Simple Weapon Proficiency	TYPE:General	DESC:You are proficient with all simple weapons. Non-proficiency suffers -4 to hit.	ADD:WEAPONPROFS|Simple", source);
