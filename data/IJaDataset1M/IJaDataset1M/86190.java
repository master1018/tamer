...
public final class FinanzenTable extends AbstractTable {
    ...
    /** tablename **/
    public static final String TABLENAME = "FINANZEN";
    ...
    protected String[] getCreateIndizeStatements() {
        return new String[] { "CREATE INDEX IFINANZEN_1 ON " + getTableName() + "(" + columns[0].getColumnName() + "," + columns[1].getColumnName() + ")", "CREATE INDEX IFINANZEN_2 ON " + getTableName() + "(" + columns[0].getColumnName() + ")" };
    }
    ...
    void saveFinanzen(int hrfId, Finanzen finanzen, Timestamp date) {
        ...
        if (finanzen != null) {
            ...
            statement = "INSERT INTO " + getTableName() + " ( HRF_ID, Supporter , Sponsoren , Finanzen , EinSponsoren , EinZuschauer , EinZinsen , EinSonstiges , EinGesamt , KostSpieler , KostTrainer , KostStadion, KostJugend , KostZinsen , KostSonstiges , KostGesamt , GewinnVerlust , LetzteEinSponsoren , LetzteEinZuschauer , LetzteEinZinsen , LetzteEinSonstiges , LetzteEinGesamt , LetzteKostSpieler , LetzteKostTrainer , LetzteKostStadion, LetzteKostJugend , LetzteKostZinsen , LetzteKostSonstiges , LetzteKostGesamt , LetzteGewinnVerlust, Datum ) VALUES(";
            statement += ("" + hrfId + "," + finanzen.getSupporter() + "," + finanzen.getSponsoren() + "," + finanzen.getFinanzen() + "," + finanzen.getEinnahmenSponsoren() + "," + finanzen.getEinnahmenZuschauer() + "," + finanzen.getEinnahmenZinsen() + "," + finanzen.getEinnahmenSonstige() + "," + finanzen.getEinnahmenGesamt() + "," + finanzen.getKostenSpieler() + "," + finanzen.getKostenTrainerstab() + "," + finanzen.getKostenStadion() + "," + finanzen.getKostenJugend() + "," + finanzen.getKostenZinsen() + "," + finanzen.getKostenSonstige() + "," + finanzen.getKostenGesamt() + "," + finanzen.getGewinnVerlust() + "," + finanzen.getLetzteEinnahmenSponsoren() + "," + finanzen.getLetzteEinnahmenZuschauer() + "," + finanzen.getLetzteEinnahmenZinsen() + "," + finanzen.getLetzteEinnahmenSonstige() + "," + finanzen.getLetzteEinnahmenGesamt() + "," + finanzen.getLetzteKostenSpieler() + "," + finanzen.getLetzteKostenTrainerstab() + "," + finanzen.getLetzteKostenStadion() + "," + finanzen.getLetzteKostenJugend() + "," + finanzen.getLetzteKostenZinsen() + "," + finanzen.getLetzteKostenSonstige() + "," + finanzen.getLetzteKostenGesamt() + "," + finanzen.getLetzteGewinnVerlust() + ",'" + date.toString() + "' )");
