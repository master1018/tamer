...
import se.mdh.mrtc.saveccm.composite.diagram.edit.policies.DataOut5ItemSemanticEditPolicy;
import se.mdh.mrtc.saveccm.composite.diagram.part.SaveccmVisualIDRegistry;

/**
 * @generated
 */
public class DataOut5EditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
    public DataOut5EditPart(View view) {
        super(view);
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataOut5ItemSemanticEditPolicy());
    ...
    protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
        if (borderItemEditPart instanceof DataOutName5EditPart) {
    ...
    public EditPart getPrimaryChildEditPart() {
        return getChildBySemanticHint(SaveccmVisualIDRegistry.getType(DataOutName5EditPart.VISUAL_ID));
    }
