...
public class HashPathIdMapperTest {
    ...
    public void testGetInternalPrefixNoPattern() {
        assertEquals("file:urn%3Atest", new HashPathIdMapper("").getInternalPrefix("urn:test"));
    }
    ...
    private static void assertBadPattern(String pattern) {
        try {
            ...
            if (!(th instanceof IllegalArgumentException)) {
                fail("Bad pattern '" + pattern + "' should have thrown " + "IllegalArgumentException, but threw " + th.getClass().getName());
            }
        }
    }
