package bova.desenv.lista.cotacao.jfreechart;
...
public class PriceVolumeDemo extends ApplicationFrame {
    ...
    private JFreeChart createChart() {
        ...
        final JFreeChart chart = ChartFactory.createTimeSeriesChart(title, "Date", "Price", priceData, true, true, false);
        ...
        renderer1.setToolTipGenerator(new StandardXYToolTipGenerator(StandardXYToolTipGenerator.DEFAULT_TOOL_TIP_FORMAT, new SimpleDateFormat("dd/MMM/yyyy"), new DecimalFormat("0.00")));
