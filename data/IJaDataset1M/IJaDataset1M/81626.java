...
public class CodeBlockJdomTest {
    ...
    private static final String CLASS_EXAMPLE = "package org.langera.examples;\n" + " \n" + "public class SimpleClass \n" + "{ \n" + " \n" + "  public String toString()\n" + "  {\n" + "       int a1 = 1;\n" + "       int a2 = 1;\n" + "       int a3 = 1;\n" + " //      int a4 = 1;\n" + "       int a5 = 1;\n" + " //      int a6 = 1;\n" + "       int a7 = 1;\n" + "       int a8 = 1;\n" + "       int a9 = 1;\n" + "  }" + "\n" + "}";
    ...
    public void setUp() throws Exception {
        ...
        Iterator iterator = javaSourceJdom.getDocument().getDescendants(new ElementFilter(JavaSourceTokenType.BLOCK_SCOPE.getName()));
