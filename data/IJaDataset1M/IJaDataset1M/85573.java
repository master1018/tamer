...
import com.sodad.weka.gui.AttributeVisualizationPanel;
...
public class AttributeSummarizer extends DataVisualizer {
   ...
   */
    ...
    protected void appearanceDesign() {
        removeAll();
        m_visual = new BeanVisual("AttributeSummarizer", BeanVisual.ICON_PATH + "AttributeSummarizer.gif", BeanVisual.ICON_PATH + "AttributeSummarizer_animated.gif");
