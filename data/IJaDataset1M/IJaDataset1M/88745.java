...
public class ObjCSelector {
     ...
     */
    public ObjCSelector(boolean staticSelector, Variable returnType, String leadingName, List<Parameter> parameters) {
    ...
    public static class Parameter {
        ...
        public String toObjCFormat() {
            boolean hasSelectorParamName = (selectorParamName == null || selectorParamName.trim().equals(""));
            return (hasSelectorParamName ? "" : selectorParamName) + ":(" + type.toObjCFormat() + ")" + trivialName;
        }
