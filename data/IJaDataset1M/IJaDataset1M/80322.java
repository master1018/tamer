...
public class SimpleAutoCorrelationExtractor extends AbstractAutoCorrelationExtractor {
     ...
     */
    public SimpleAutoCorrelationExtractor(ParameterManager parameters, FeatureManager features, AEChip chip) {
    ...
    public void update(int timestamp) {
        ...
        if (this.compare.getSize() >= this.nObservations * 2) {
            ...
            for (int t = 0; t < this.nObservations; t++) {
                ...
                items[t] = new CorrelationItem(this.compare.getTransition(t).time, c.correlation(c.getItem(this.compare, 0, this.nObservations), c.getItem(this.compare, t, this.nObservations + t)));
            }
