package com.sodad.weka.classifiers.meta;
...
import com.sodad.weka.classifiers.RandomizableIteratedSingleClassifierEnhancer;
import com.sodad.weka.classifiers.RandomizableParallelIteratedSingleClassifierEnhancer;
import com.sodad.weka.core.Instance;
import com.sodad.weka.core.Instances;
import com.sodad.weka.core.Option;
import com.sodad.weka.core.Randomizable;
...
public class RandomSubSpace extends RandomizableParallelIteratedSingleClassifierEnhancer implements WeightedInstancesHandler, TechnicalInformationHandler {
   ...
   */
    public RandomSubSpace() {
        super();
        m_Classifier = new com.sodad.weka.classifiers.trees.REPTree();
    }
   ...
   */
    public void setOptions(String[] options) throws Exception {
        ...
        if (tmpStr.length() != 0) setSubSpaceSize(Double.parseDouble(tmpStr)); else setSubSpaceSize(0.5);
   ...
   */
    public void buildClassifier(Instances data) throws Exception {
        ...
        if (m_data.numAttributes() == 1) {
            ...
            m_ZeroR = new com.sodad.weka.classifiers.rules.ZeroR();
