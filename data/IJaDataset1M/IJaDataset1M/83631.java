...
public class CommConnectionImpl extends ConnectionImpl implements CommConnection {
    ...
    public void open(String url, int mode, boolean timeouts) throws IOException {
        ...
        if (useCommPortsString != null) {
            ...
            while (keys.hasMoreElements()) {
                ...
                if (!key.equals("baudrate") && !key.equals("bitsperchar") && !key.equals("stopbits") && !key.equals("parity") && !key.equals("blocking") && !key.equals("autocts") && !key.equals("autorts")) {
            ...
            if (ht.containsKey("baudrate")) {
                ...
                if (baud.equals("57600")) {
                    ...
                    baudrate = 300;
                } else throw new IOException("Specified baudrate not supported " + baud);
            }
            if (ht.containsKey("bitsperchar")) {
                ...
                } else throw new IOException("Specified bitnumber not supported " + bits);
            }
            if (ht.containsKey("parity")) {
                ...
                } else throw new IllegalArgumentException("Specified parity not supported " + pari);
            }
            if (ht.containsKey("stopbits")) {
                ...
                } else throw new IllegalArgumentException("Specified amount of stopbits not supported '" + stop + "'");
            }
            if (ht.containsKey("blocking")) {
                ...
                if (block.equals("on")) {
                    ...
                    blocking = false;
                } else throw new IllegalArgumentException("Specified blocking mode not supported " + block);
            }
            if (ht.containsKey("autocts")) {
                ...
                if (acts.equals("on")) {
                    ...
                    autocts = false;
                } else throw new IllegalArgumentException("Specified mode for autocts not supported " + acts);
            }
            if (ht.containsKey("autorts")) {
                ...
                if (arts.equals("on")) {
                    ...
                    autorts = false;
                } else throw new IllegalArgumentException("Specified mode for autorts not supported " + arts);
            }
    ...
    public int setBaudRate(int baudrate) {
        ...
        try {
            ...
            System.out.println("Parameters for javax.comm.SerialPort: Baudrate=" + baudrate + ", Databits=" + databits + ", Stopbits=" + stopbits + ", Parity=" + parityStr);
            serialPort.setSerialPortParams(baudrate, databits, stopbits, parity);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public DataInputStream openDataInputStream() throws IOException {
        if (serialPort != null) return new DataInputStream(serialPort.getInputStream());
    ...
    public InputStream openInputStream() throws IOException {
        if (serialPort != null) return serialPort.getInputStream();
        throw new IOException("CommPort is not open!");
    }
    ...
    public DataOutputStream openDataOutputStream() throws IOException {
        if (serialPort != null) return new DataOutputStream(serialPort.getOutputStream());
        throw new IOException("CommPort is not open!");
    }
    ...
    public OutputStream openOutputStream() throws IOException {
        if (serialPort != null) return serialPort.getOutputStream();
        throw new IOException("CommPort is not open!");
    }
}
