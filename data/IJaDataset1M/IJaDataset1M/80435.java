...
public class Modification {
    ...
    public static final int PHONATION = 3;
	 ...
	 *            phonation).
	 */
    public Modification(String name, boolean contourType, boolean effortType, int defaultRate, int defaultContour, String defaultEffort, int type) {
        super();
        this.name = name;
    ...
    public boolean isDefault(String dr) {
        if (isVowelTargetType()) {
            if (defaultVowelTarget.compareTo(dr) == 0) return true;
        } else if (isEffortType()) {
            if (defaultEffort.compareTo(dr) == 0) return true;
        } else {
            String r = String.valueOf(defaultRate);
            if (r.compareTo(dr) == 0) return true;
        }
        return false;
    }
    ...
    public boolean isDefault(String dr1, String dr2) {
        ...
        if (r1.compareTo(dr1) == 0 && r2.compareTo(dr2) == 0) return true;
        return false;
    }
    ...
    public boolean isDefault(int dr, int dr2) {
        if (defaultRate == dr && defaultRate2 == dr2) return true;
        return false;
    }
