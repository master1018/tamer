...
public class DbObjects {
    ...
    FastMap<String, DbL2ItemBase> dbL2ItemCache = new FastMap<String, DbL2ItemBase>();

    FastMap<String, DbL2Npc> dbL2NpcCache = new FastMap<String, DbL2Npc>();

    FastMap<String, DbL2Skill> dbL2SkillCache = new FastMap<String, DbL2Skill>();
    ...
    public DbL2ItemBase getDbL2Item(final int item_id) {
        ...
        DbL2ItemBase dbL2Item = dbL2ItemCache.get(item_id_str);
        if (dbL2Item != null) {
            return dbL2Item;
        }
        {
            ...
            if (listResult.size() > 0) {
                ...
                dbL2ItemCache.put(item_id_str, dbL2Item);
                return dbL2Item;
            }
        }
        {
    ...
    public DbL2Npc getDbL2Npc(final int idTemplate) {
        ...
        DbL2Npc dbL2Npc = dbL2NpcCache.get(idTemplate_str);
        if (dbL2Npc != null) {
            return dbL2Npc;
        }
        ...
        if (listNpcs.size() > 0) {
            ...
            dbL2NpcCache.put(idTemplate_str, dbL2Npc);
            return dbL2Npc;
        }
        dbL2Npc = new DbL2Npc();
    ...
    public DbL2Skill getDbL2Skill(final int skill_id) {
        ...
        DbL2Skill dbL2Skill = dbL2SkillCache.get(skill_id_str);
        if (dbL2Skill != null) {
            return dbL2Skill;
        }
        ...
        if (listSkills.size() > 0) {
            ...
            dbL2SkillCache.put(skill_id_str, dbL2Skill);
            return dbL2Skill;
        }
