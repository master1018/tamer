...
public class CalorieCount extends Pest {
    ...
    public static CalorieCountProperties getProps() {
    ...
    public CalorieCountProperties getInstanceProperties() {
        if (null == myInstanceProperties) initializeInstanceProperties();
        return myInstanceProperties;
    }

    protected synchronized void initializeInstanceProperties() {
        if (null != myInstanceProperties) return;
    ...
    public ApplicationData createApplicationData() throws ApplicationException {
        ...
        try {
            ...
            if (null != list) data.setFoods(list);
        } catch (ApplicationException e) {
            String msg = "Error loading initial food database.\n" + "An empty list will be used instead.";
            showException(msg, e);
        }
        return data;
    }
    ...
    protected void copyInitialDatabase(File tempFile) throws ApplicationException {
        ...
        try {
            ...
            String msg = "Error trying to create initial datafile.  Source: " + file + " destination: " + tempFile;
    ...
    private void normalProcessing() throws ApplicationException {
        try {
            ...
            if (wasRecording()) startGathering();
    ...
    public Meal createMeal(FrequentFood freq, long time) {
        Food food = freq.getFood();
        if (null == food) food = getData().getFoods().getFood(freq.getFoodId());
