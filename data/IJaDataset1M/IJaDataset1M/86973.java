...
public class ServletConnector {
    ...
    private static ServletConnector thisInstance;

    private static ServletConnector thisInstanceWithURL;

    /** Creates a new instance of ServletConnector */
    private ServletConnector() {
    }

    public ServletConnector(String serverURLX) {
        this.serverURL = serverURLX;
    }

    public static ServletConnector getInstance() {
        if (thisInstance == null) thisInstance = new ServletConnector();
        return thisInstance;
    }

    public static ServletConnector getInstance(String serverURLX) {
        if (thisInstanceWithURL == null) thisInstanceWithURL = new ServletConnector(serverURLX);
        return thisInstanceWithURL;
    }

    public String sendRequest(String servletName, String request) {
        String reqxml = "";
