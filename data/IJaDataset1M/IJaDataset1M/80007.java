...
public class DefaultViewSerializer implements ViewSerializer {
    ...
    public static class GarbageView extends View {
        ...
        public GarbageView() {
            super("Garbage" + idgen, null, new ComponentConfigCard(new AbstractGUIComponent("dummy:" + idgen) {
            }));
            idgen++;
        }
    }
    ...
    public View readView(ObjectInputStream in) throws IOException {
        ...
        if (v == null) {
            ...
            if (factory != null && (!initialLoad || factory.isRestoreOnStartup())) {
                v = driver.createView(factory, id, null);
            } else v = new GarbageView();
            if (v != null) driver.addView(v);
        } else driver.fireCreatedView(v, IDWDriver.getComponent(v));
        return v;
    }
