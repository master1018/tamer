package org.emftext.language.parametercheck.resource.pcheck.util;

public class PcheckMinimalModelHelper {

    private static final org.emftext.language.parametercheck.resource.pcheck.util.PcheckEClassUtil eClassUtil = new org.emftext.language.parametercheck.resource.pcheck.util.PcheckEClassUtil();
            ...
            if (feature instanceof org.eclipse.emf.ecore.EReference) {
                ...
                if (type instanceof org.eclipse.emf.ecore.EClass) {
                    ...
                    for (int i = 0; i < lowerBound; i++) {
                        ...
                        if (reference.isContainment()) {
                            ...
                            String initialValue = "#some" + org.emftext.language.parametercheck.resource.pcheck.util.PcheckStringUtil.capitalize(typeClass.getName());
                        ...
                        if (value instanceof java.util.List<?>) {
                            java.util.List<org.eclipse.emf.ecore.EObject> list = org.emftext.language.parametercheck.resource.pcheck.util.PcheckListUtil.castListUnchecked(value);
                            list.add(subModel);
                        } else {
                ...
                if ("EString".equals(attribute.getEType().getName())) {
                    ...
                    if (attribute.getName().equals("name") && name != null) {
                        ...
                        initialValue = "some" + org.emftext.language.parametercheck.resource.pcheck.util.PcheckStringUtil.capitalize(attribute.getName());
                    }
                    java.lang.Object value = root.eGet(attribute);
                    if (value instanceof java.util.List<?>) {
                        java.util.List<String> list = org.emftext.language.parametercheck.resource.pcheck.util.PcheckListUtil.castListUnchecked(value);
