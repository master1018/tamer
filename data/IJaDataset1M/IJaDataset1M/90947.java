...
public class Lvq2_1 extends LvqAlgorithmAncestor {
	 ...
	 */
    private static final String PARAM_WINDOW_SIZE = "W";

    /**
	 * Window size argument description
	 */
    private static final String PARAM_WINDOW_SIZE_DESC = Constants.DESCRIPTION_WINDOW_SIZE;
    ...
    protected void setArguments(String[] options) throws Exception {
