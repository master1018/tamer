...
public class CoreDescriptor {
    ...
    public void setConfigName(String name) {
        if (name == null || name.length() == 0) throw new IllegalArgumentException("name can not be null or empty");
   ...
   */
    public void setCoreProperties(Properties coreProperties) {
        if (this.coreProperties == null) {
            ...
            if (coreProperties != null) this.coreProperties.putAll(coreProperties);
        }
    }
}
