...
public class OperatorsPanel extends JPanel implements Exportable {
    ...
    public OperatorsPanel(BeautiFrame parent) {
        ...
        operatorTable.getTableHeader().setDefaultRenderer(new HeaderRenderer(SwingConstants.LEFT, new Insets(0, 4, 0, 4)));
        operatorTable.getColumnModel().getColumn(0).setPreferredWidth(50);
        operatorTable.getColumnModel().getColumn(1).setCellRenderer(new OperatorTableCellRenderer(SwingConstants.LEFT, new Insets(0, 4, 0, 4)));
        operatorTable.getColumnModel().getColumn(1).setPreferredWidth(180);
        operatorTable.getColumnModel().getColumn(2).setCellRenderer(new OperatorTableCellRenderer(SwingConstants.LEFT, new Insets(0, 4, 0, 4)));
        operatorTable.getColumnModel().getColumn(2).setPreferredWidth(140);
        operatorTable.getColumnModel().getColumn(3).setCellRenderer(new OperatorTableCellRenderer(SwingConstants.LEFT, new Insets(0, 4, 0, 4)));
        operatorTable.getColumnModel().getColumn(3).setCellEditor(new RealNumberCellEditor(0, Double.POSITIVE_INFINITY));
        operatorTable.getColumnModel().getColumn(3).setPreferredWidth(50);
        operatorTable.getColumnModel().getColumn(4).setCellRenderer(new OperatorTableCellRenderer(SwingConstants.LEFT, new Insets(0, 4, 0, 4)));
        operatorTable.getColumnModel().getColumn(4).setCellEditor(new RealNumberCellEditor(0, Double.MAX_VALUE));
        operatorTable.getColumnModel().getColumn(4).setPreferredWidth(50);
        operatorTable.getColumnModel().getColumn(5).setCellRenderer(new OperatorTableCellRenderer(SwingConstants.LEFT, new Insets(0, 4, 0, 4)));
        operatorTable.getColumnModel().getColumn(5).setPreferredWidth(400);
        scrollPane = new JScrollPane(operatorTable, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
    ...
    class OperatorTableCellRenderer extends TableRenderer {
        ...
        public Component getTableCellRendererComponent(JTable aTable, Object value, boolean aIsSelected, boolean aHasFocus, int aRow, int aColumn) {
            ...
            if (!op.inUse && aColumn > 0) renderer.setForeground(Color.gray); else renderer.setForeground(Color.black);
            return this;
        }
    }
}
