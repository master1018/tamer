...
public class DHCPCoreServer implements Runnable {
    ...
    protected void init() throws DHCPServerInitException {
        ...
        try {
            ...
            this.threadPool = new ThreadPoolExecutor(numThreads, maxThreads, keepaliveThreads, TimeUnit.MILLISECONDS, new ArrayBlockingQueue<Runnable>(BOUNDED_QUEUE_SIZE), new ServerThreadFactory());
