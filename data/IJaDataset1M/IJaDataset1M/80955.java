...
public class HolidayDETest extends AbstractCountryTestBase {
    ...
    public void testManagerDEinterval() {
        try {
            ...
            List<LocalDate> expected = Arrays.asList(CalendarUtil.create(2010, 12, 25), CalendarUtil.create(2010, 12, 26), CalendarUtil.create(2010, 10, 3), CalendarUtil.create(2011, 1, 1));
