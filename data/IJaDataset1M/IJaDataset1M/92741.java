 ...
 */
public abstract class ExampleAppViewMVC extends View {
     ...
     */
    protected abstract void handleCommonInitEvent(AppEvent event);
    ...
    public Viewport getExappViewViewport() {
        if (exappViewViewport == null) exappViewViewport = (Viewport) Registry.get("exapp.view.viewport");
    ...
    public ContentPanel getExappViewWestpanel() {
        if (exappViewWestpanel == null) exappViewWestpanel = (ContentPanel) Registry.get("exapp.view.westpanel");
    ...
    public LayoutContainer getExappViewCenter() {
        if (exappViewCenter == null) exappViewCenter = (LayoutContainer) Registry.get("exapp.view.center");
