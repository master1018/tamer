...
public class TransformerCallback {
    ...
    public static int checkAuthorization(RequestContextImpl requestContext, String pageName) throws Exception {
        try {
            ...
            if (config != null) {
                ...
                if (authConst != null) {
                    if (authConst.isAuthorized(context)) result = 1; else if (authConst.getAuthPage(context) != null) result = 2; else result = 3;
                }
            }
            return result;
        } catch (Exception x) {
    ...
    public static String omitPage(RequestContextImpl requestContext, TargetGenerator gen, String pageName, String lang, String altKey) throws Exception {
        try {
            ...
            if ((tenant != null && !lang.equals(tenant.getDefaultLanguage())) || (tenant == null && projectInfo.getSupportedLanguages().size() > 1 && !lang.equals(projectInfo.getDefaultLanguage()))) {
