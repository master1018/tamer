package de.javagimmicks.xml.util;
...
public class NameUtils {
    ...
    public static void main(String[] args) {
        List<String> strings = Arrays.asList(new String[] { "hello123-world", "_hello123-world", "?hello123-world", "2hello123-world", "tns:hello123-world", "_tns:hello123-world", "1tns:hello123-world", "-tns:hello123-world", "?tns:hello123-world" });
        for (String s : strings) {
            System.out.println(isNCName(s));
            System.out.println(isQualifiedName(s));
            System.out.println("===========");
        }
        String[] split = splitQualifiedName("xs:schema");
        System.out.printf("Prefix: '%1$s', Local name: '%2$s'%n", split[0], split[1]);
    }
