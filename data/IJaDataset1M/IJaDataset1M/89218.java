 ...
 */
public class WorkReportTypeCRUDController extends BaseCRUDController<WorkReportType> implements IWorkReportTypeCRUDControllerEntryPoints {
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        final EntryPointsHandler<IWorkReportTypeCRUDControllerEntryPoints> handler = URLHandlerRegistry.getRedirectorFor(IWorkReportTypeCRUDControllerEntryPoints.class);
    ...
    private void loadComponents(Window window) {
        if (!window.equals(listWindow)) {
            ...
            listWorkReportLabelTypeAssigments = (NewDataSortableGrid) window.getFellow("listWorkReportLabelTypeAssigments");
    ...
    private void appendListboxPositionDescriptionField(final Row row) {
        final DescriptionField descriptionField = (DescriptionField) row.getValue();
    ...
    private void changePositionDescriptionField(Listitem selectedItem, DescriptionField descriptionField) {
        PositionInWorkReportEnum newPosition = (PositionInWorkReportEnum) selectedItem.getValue();
    ...
    private void appendLabelPosition(Row row) {
        org.zkoss.zul.Label labelPosition = new org.zkoss.zul.Label();
        labelPosition.setParent(row);
        labelPosition.setValue(_(workReportTypeModel.getLabelAssigmentPosition((WorkReportLabelTypeAssigment) row.getValue()).toString()));
    }
    ...
    private void appendComboboxLabelTypes(final Row row) {
        final WorkReportLabelTypeAssigment workReportLabelTypeAssigment = (WorkReportLabelTypeAssigment) row.getValue();
    ...
    private Autocomplete createComboboxLabelTypes(WorkReportLabelTypeAssigment workReportLabelTypeAssigment) {
        ...
        for (LabelType labelType : listLabelType) {
            ...
            if ((workReportLabelTypeAssigment.getLabelType() != null) && (workReportLabelTypeAssigment.getLabelType().equals(labelType))) {
    ...
    private Autocomplete createComboboxLabels(LabelType labelType, WorkReportLabelTypeAssigment workReportLabelTypeAssigment) {
        ...
        if (labelType != null) {
            ...
            for (Label label : listLabel) {
                ...
                if ((workReportLabelTypeAssigment.getDefaultLabel() != null) && (workReportLabelTypeAssigment.getDefaultLabel().equals(label))) {
    ...
    public void validateIfExistTheSameLabelType(final Combobox comboLabelTypes, final WorkReportLabelTypeAssigment workReportLabelTypeAssigment) throws WrongValueException {
        if ((getWorkReportType() != null) && (getWorkReportType().existRepeatedLabelType(workReportLabelTypeAssigment))) {
            ...
            throw new WrongValueException(comboLabelTypes, _("This label type already is assigned to the work report type."));
        }
    }
        ...
        return new Constraint() {
            ...
            public void validate(Component comp, Object value) throws WrongValueException {
                ...
                if ((getWorkReportType() != null) && (getWorkReportType().existSameFieldName(descriptionField))) {
                    ...
                    throw new WrongValueException(comp, _("A description field of the same name already exists."));
                }
            }
        };
    }
    ...
    private void showInvalidDescriptionFieldName(DescriptionField field) {
        ...
        throw new WrongValueException(fieldName, _("The field name must be unique, not null and not empty"));
    }

    private void showInvalidDescriptionFieldLength(DescriptionField field) {
        Row row = findRowByValue(listDescriptionFields.getRows(), field);
        Intbox fieldName = (Intbox) row.getChildren().get(1);
        throw new WrongValueException(fieldName, _("The length must be greater than 0, and not null."));
    }

    private void showInvalidWorkReportLabelTypeAssigment(int combo, String message, WorkReportLabelTypeAssigment labelType) {
    ...
    public class OrderedFieldsAndLabelsRowRenderer implements RowRenderer {
        ...
        public void render(Row row, Object data) {
            ...
            if (data instanceof DescriptionField) {
                if ((((DescriptionField) data).getFieldName() != null) || (!((DescriptionField) data).getFieldName().isEmpty())) {
                    name = ((DescriptionField) data).getFieldName();
                }
                type = _("Text field");
            } else {
                if ((((WorkReportLabelTypeAssigment) data).getLabelType() != null) && (((WorkReportLabelTypeAssigment) data).getDefaultLabel() != null)) {
    ...
    private void showMessageSortedLabelsAndFields() {
        ...
        if (messagesForUserSortedLabelsAndFields != null) {
            messagesForUserSortedLabelsAndFields.showMessage(Level.ERROR, _("The index fields and labels must be uniques and consecutives"));
        }
    }
    ...
    protected boolean beforeDeleting(WorkReportType workReportType) {
        if (thereAreWorkReportsFor(workReportType)) {
            try {
                Messagebox.show(_("Cannot delete work report type. There are some work reports bound to it."), _("Warning"), Messagebox.OK, Messagebox.EXCLAMATION);
            } catch (InterruptedException e) {
                LOG.error(_("Error on showing warning message removing workReportType: ", workReportType.getHumanId()), e);
            }
            return false;
        }
        return true;
