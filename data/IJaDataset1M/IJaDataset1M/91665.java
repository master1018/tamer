...
public class MonocaffeAboutBox extends javax.swing.JDialog {

    public MonocaffeAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(monocaffe.MonocaffeApp.class).getContext().getResourceMap(MonocaffeAboutBox.class);
        setTitle(resourceMap.getString("title"));
        setModal(true);
        setName("aboutBox");
        setResizable(false);
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(monocaffe.MonocaffeApp.class).getContext().getActionMap(MonocaffeAboutBox.class, this);
