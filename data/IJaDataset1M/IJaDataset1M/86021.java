...
public class BookImpl extends CirculatingItemImpl implements Book {
   ...
   */
    public void setTitle(String newTitle) {
        ...
        title = newTitle;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, EXTLibraryPackage.BOOK__TITLE, oldTitle, title));
    }
   ...
   */
    public void setPages(int newPages) {
        int oldPages = pages;
        pages = newPages;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, EXTLibraryPackage.BOOK__PAGES, oldPages, pages));
    }
   ...
   */
    public void setCategory(BookCategory newCategory) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, EXTLibraryPackage.BOOK__CATEGORY, oldCategory, category, !oldCategoryESet));
    }
   ...
   */
    public void unsetCategory() {
        ...
        eFlags &= ~CATEGORY_ESETFLAG;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.UNSET, EXTLibraryPackage.BOOK__CATEGORY, oldCategory, CATEGORY_EDEFAULT, oldCategoryESet));
    }
   ...
   */
    public Writer getAuthor() {
        if (author != null && author.eIsProxy()) {
            ...
            if (author != oldAuthor) {
                if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.RESOLVE, EXTLibraryPackage.BOOK__AUTHOR, oldAuthor, author));
            }
        }
        return author;
    }
   ...
   */
    public void setAuthor(Writer newAuthor) {
        if (newAuthor != author) {
            ...
            if (author != null) msgs = ((InternalEObject) author).eInverseRemove(this, EXTLibraryPackage.WRITER__BOOKS, Writer.class, msgs);
            if (newAuthor != null) msgs = ((InternalEObject) newAuthor).eInverseAdd(this, EXTLibraryPackage.WRITER__BOOKS, Writer.class, msgs);
            msgs = basicSetAuthor(newAuthor, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, EXTLibraryPackage.BOOK__AUTHOR, newAuthor, newAuthor));
    }
   ...
   */
    ...
    public String toString() {
        ...
        if ((eFlags & CATEGORY_ESETFLAG) != 0) result.append(category); else result.append("<unset>");
        result.append(')');
