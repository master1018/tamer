...
public class Rx extends JFrame implements ActionListener, KeyListener, MouseListener, WindowListener {
    ...
    public synchronized void addTargetToList(String localPort, String ip, String port) {
        ListUpdater listUpdater = new ListUpdater(localPort, ip, port, listModel, targets, removeTarget);
...
class ListUpdater implements Runnable {
    ...
    public ListUpdater(String localPort, String ip, String port, TargetListModel listModel, Vector targets, JButton removeTarget) {
