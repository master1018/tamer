        ...
        if (!newPlaylistName.equals(oldPlaylistName)) {
            try {
                ...
                if (message != null && message.indexOf("Duplicate Playlist") != -1) {
                    JOptionPane.showMessageDialog(rootContainer, ResourceManager.getLabel("rename.playlist.duplicate.error.message", context.getConfig().getLocale()), ResourceManager.getLabel("rename.playlist.duplicate.error.title", context.getConfig().getLocale()), JOptionPane.WARNING_MESSAGE);
                    startEditingTimer();
                } else {
                    ErrorDialog.showDialog(rootContainer, ResourceManager.getLabel("rename.playlist.unexpected.error.message", context.getConfig().getLocale()), ResourceManager.getLabel("rename.playlist.unexpected.error.title", context.getConfig().getLocale()), e, context.getConfig().getLocale());
                }
                return false;
            }
        } else {
            ...
            if (event.getSource() instanceof JTree) {
                ...
                if (event instanceof MouseEvent) {
                    ...
                    if (path != null) {
                        ...
                        if (node != null) {
                            if (node.getUserObject() instanceof StaticPlaylist || node.getUserObject() instanceof SmartPlaylist) {
                                editableNode = true;
                            }
                        }
                    }
