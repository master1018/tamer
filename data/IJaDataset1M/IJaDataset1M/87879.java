...
public class TableColumnExt extends TableColumn implements Cloneable {
    ...
    public void setEditable(boolean editable) {
        ...
        firePropertyChange("editable", Boolean.valueOf(oldEditable), Boolean.valueOf(editable));
    }
    ...
    @Override
    public Object clone() {
        final TableColumnExt copy = new TableColumnExt(this.getModelIndex(), this.getWidth(), this.getCellRenderer(), this.getCellEditor());
