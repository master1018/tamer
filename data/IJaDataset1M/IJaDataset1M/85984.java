...
public class ArithmeticSignedTypeRule extends DeltaJTypeSystemRule {
    ...
    protected Variable<org.deltaj.deltaj.IntType> var_subExpType = new Variable<org.deltaj.deltaj.IntType>(createEClassifierType(basicPackage.getIntType()));

    protected Variable<org.deltaj.deltaj.ArithmeticSigned> var_exp = new Variable<org.deltaj.deltaj.ArithmeticSigned>(createEClassifierType(basicPackage.getArithmeticSigned()));

    protected Variable<org.deltaj.deltaj.Type> var_t = new Variable<org.deltaj.deltaj.Type>(createEClassifierType(basicPackage.getType()));
    ...
    public ArithmeticSignedTypeRule(String ruleName, String typeJudgmentSymbol, String typeStatementRelation) {
    ...
    public void applyImpl() throws RuleFailedException {
        var_subExpType = new Variable<org.deltaj.deltaj.IntType>(createEClassifierType(basicPackage.getIntType()), factory.createIntType());
