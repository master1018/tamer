...
public abstract class Zone {
    ...
    /**
         ...
         * 
         */
    public Zone(Visualization vis, ForceSimulator fsim, ZoneShape zoneShape, ZoneColors zoneColors, ZoneAttributes zoneAttributes) {
    ...
    /**
         ...
         *                the moment always 1)
         */
    public Zone(Visualization vis, ForceSimulator fsim, ZoneShape zoneShape, ZoneColors zoneColors, ZoneAttributes zoneAttributes, int numberOfForces) {
        m_vis = vis;
        ...
        m_fsim = fsim;
        if (m_vis.getGroup(zoneAttributes.getZoneName()) != null) {
            m_vis.removeGroup(zoneAttributes.getZoneName());
        }
    ...
    /**
         ...
         */
    public abstract void catchItem(NodeItem aItem, boolean onlyIfOutside);

    public abstract void positionZoneAggregate(AggregateItem aAItem);

    public abstract void animateZoneAggregate(AggregateItem aAItem, double frac);
    ...
    /**
         ...
         * @param x
         */
    protected void setX(VisualItem item, VisualItem referrer, double x) {
        double sx = item.getX();
        if (Double.isNaN(sx)) {
    ...
    /**
         ...
         * @param y
         */
    protected void setY(VisualItem item, VisualItem referrer, double y) {
        double sy = item.getY();
        if (Double.isNaN(sy)) {
