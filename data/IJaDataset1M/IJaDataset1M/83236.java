...
@FullTextFilterDefs(@FullTextFilterDef(name = "ArchivedModule", impl = ArchivedEntityFilterFactory.class))
public class Module extends CourseBase implements ArchivableEntity {
    ...
    public void addModuleComponent(ModuleComponent moduleComponent) {
        if (moduleComponent.getModule() != null) moduleComponent.getModule().getModuleComponents().remove(moduleComponent);
