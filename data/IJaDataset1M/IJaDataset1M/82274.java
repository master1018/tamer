...
public class CategoriesPopularity implements Service {
    ...
    public Element exec(Element params, ServiceContext context) throws Exception {
        ...
        this.imageMap = org.fao.geonet.services.statistics.ChartFactory.writeChartImage(chart, f, this.chartWidth, this.chartHeight, this.createTooltips, "graphPopularityByCategoryImageMap");
        Element elResp = new Element(Jeeves.Elem.RESPONSE);
        Element elchartUrl = new Element("popularityByCategoryUrl").setText(context.getBaseUrl() + "/images/statTmp/" + chartFilename);
