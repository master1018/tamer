...
public class PlanRouter {
    ...
    private boolean useMoyoRouter = true;
    ...
    public PlanRouter(ScenarioImpl scenario) {
        ...
        new PopulationWriter(scenario.getPopulation()).write(routedPlansFile);
        scenario.getConfig().plans().setInputFile(routedPlansFile);
