...
public class LocalizationPanel extends PreferencePanel {
    ...
    private HashMap<String, String> displayCountrytoCode;
    ...
    private JPanel getCountryPanel() {
        if (countryPanel == null) {
            ...
            countryPanel.setBorder(BorderFactory.createTitledBorder(null, LocalizationData.get("PreferencesDialog.Localization.country"), TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
    ...
    private JPanel getLanguagePanel() {
        if (languagePanel == null) {
            ...
            languagePanel.setBorder(BorderFactory.createTitledBorder(null, LocalizationData.get("PreferencesDialog.Localization.language"), TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
    ...
    private JRadioButton getDefaultCButton() {
        if (defaultCButton == null) {
            ...
            String tip = MessageFormat.format(LocalizationData.get("PreferencesDialog.Localization.defaultCountry.toolTip"), defaultDisplayCountry);
            defaultCButton.setToolTipText(tip);
            defaultCButton.setText(MessageFormat.format(LocalizationData.get("PreferencesDialog.Localization.defaultCountry"), defaultDisplayCountry));
    ...
    private JRadioButton getCustomButton() {
        if (customButton == null) {
            ...
            customButton.setText(LocalizationData.get("PreferencesDialog.Localization.customCountry"));
            customButton.setToolTipText(LocalizationData.get("PreferencesDialog.Localization.customCountry.tooTip"));
    ...
    private JList getJList() {
        if (jList == null) {
            ...
            jList.setToolTipText(LocalizationData.get("PreferencesDialog.Localization.countryList.tooltip"));
    ...
    public boolean isChanged() {
        ...
        boolean change = !(loc.equals(getBuiltLocale()) && (Preferences.INSTANCE.isDefaultCountry() == isDefaultCountry()) && (Preferences.INSTANCE.isDefaultLanguage() == isDefaultLanguage()) && (Preferences.INSTANCE.isTranslatorMode() == isTranslatorMode()));
        return change;
    }
    ...
    private JRadioButton getDefaultLButton() {
        if (defaultLButton == null) {
            ...
            defaultLButton.setText(LocalizationData.get("PreferencesDialog.Localization.defaultLanguage"));
            defaultLButton.setToolTipText(LocalizationData.get("PreferencesDialog.Localization.defaultLanguage.toolTip"));
    ...
    private JButton getRevertButton() {
        if (revertButton == null) {
            ...
            revertButton.setText(LocalizationData.get("PreferencesDialog.Localization.revert"));
            revertButton.setToolTipText(LocalizationData.get("PreferencesDialog.Localization.revert.toolTip"));
    ...
    private JCheckBox getTranslatorButton() {
        if (translatorButton == null) {
            ...
            if (Preferences.INSTANCE.isExpertMode()) {
                translatorButton.setText(LocalizationData.get("PreferencesDialog.translatorMode"));
                translatorButton.setToolTipText(LocalizationData.get("PreferencesDialog.translatorMode.tooltip"));
