...
public class RegistrationForm extends ActionForm {
    ...
    private long organizationInodeAux;
    ...
    public long getOrganizationInodeAux() {
        return organizationInodeAux;
    }

    public void setOrganizationInodeAux(long organizationInodeAux) {
    ...
    public long getExtUserInode() {
        return extUserInode;
    }

    public void setExtUserInode(long extUserInode) {
    ...
    public long getUserProxyInode() {
        return userProxyInode;
    }

    public void setUserProxyInode(long userProxyInode) {
