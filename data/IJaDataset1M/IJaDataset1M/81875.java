...
public class UtilTest extends TestCase {
    ...
    public void testEqualsIgnoreCaseByteArrayByteArray() {
        assertTrue(Util.asciiEqualsIgnoreCase(ASCII_ALPHABET_LC_BYTES, ASCII_ALPHABET_LC_BYTES));
        assertTrue(Util.asciiEqualsIgnoreCase(ASCII_ALPHABET_LC_BYTES, ASCII_ALPHABET_UC_BYTES));
        assertTrue(Util.asciiEqualsIgnoreCase(ASCII_ALPHABET_UC_BYTES, ASCII_ALPHABET_UC_BYTES));
    }
}
