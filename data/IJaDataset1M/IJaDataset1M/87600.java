...
public class DatabaseSpellDictionary extends SpellDictionaryASpell {
	 ...
	 * @throws IOException
	 */
    public DatabaseSpellDictionary(DictionaryRepository dictionaryRepository, File phonetic, String encoding) throws IOException {
	 ...
	 * @throws IOException
	 */
    public DatabaseSpellDictionary(DictionaryRepository dictionaryRepository, File phonetic) throws IOException {
        super(phonetic);
        this.dictionaryRepository = dictionaryRepository;
    }
	 ...
	 * @throws IOException
	 */
    public DatabaseSpellDictionary(DictionaryRepository dictionaryRepository, Reader phonetic) throws IOException {
        super(phonetic);
        this.dictionaryRepository = dictionaryRepository;
    }
    ...
    protected List<String> getWords(String phoneticCode) {
        ...
        for (edu.harvard.fas.rregan.nlp.dictionary.Word word : dictionaryRepository.findWordsByPhoneticCode(phoneticCode)) {
    ...
    public void addWord(String text) {
        edu.harvard.fas.rregan.nlp.dictionary.Word word = new edu.harvard.fas.rregan.nlp.dictionary.Word(text, getCode(text));
