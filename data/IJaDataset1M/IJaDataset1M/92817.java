...
public class ListExplanationComposite extends ExplanationComposite {
    ...
    protected static class ListExplanationContentComposite extends Composite {
        ...
        public ListExplanationContentComposite(Composite parent, int style, ListExplanation listExplanation) {
            super(parent, style);
    ...
    public void setExplanation(ListExplanation listExplanation) {
        ...
        if (this.contentComposite != null && !this.contentComposite.isDisposed()) this.contentComposite.dispose();
