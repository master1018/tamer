...
class NamespaceSupport {
   ...
   * @see java.lang.String#intern */
    public String[] processName(String qName, String parts[], boolean isAttribute) {
        ...
        if (colonIndex < 0) {
            if (isAttribute) parts[0] = ""; else parts[0] = _currentContext.getURI("");
            qName = qName.intern();
            parts[1] = qName;
            parts[2] = qName;
            return parts;
   ...
   */
    private static final Iterator<String> _EMPTY_ITERATOR = new ArrayList<String>().iterator();
   ...
   */
     ...
     */
        String[] processName(String qName, boolean isAttribute) {
            ...
            if (isAttribute) {
                ...
                if (table == null) {
                    table = new HashMap<String, String[]>(37);
                    _elementNameTable = table;
                }
            }
     ...
     */
        ...
        private void copyTables() {
            if (_prefixTable != null) {
                _prefixTable = (HashMap<String, String>) _prefixTable.clone();
            } else {
                _prefixTable = new HashMap<String, String>(5);
            }
            if (_uriTable != null) {
                _uriTable = (HashMap<String, String>) _uriTable.clone();
            } else {
                _uriTable = new HashMap<String, String>(5);
            }
        ...
        private HashMap<String, String> _prefixTable;

        private HashMap<String, String> _uriTable;

        private HashMap<String, String[]> _elementNameTable;

        private HashMap<String, String[]> _attributeNameTable;
