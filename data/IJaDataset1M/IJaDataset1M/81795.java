...
public class LinkedBlockingQueueTest extends JSR166TestCase {
    ...
    public void testPeek() {
        ...
        for (int i = 0; i < SIZE; ++i) {
            ...
            q.poll();
            assertTrue(q.peek() == null || i != ((Integer) q.peek()).intValue());
        }
        assertNull(q.peek());
    }
    ...
    public void testRetainAll() {
        ...
        for (int i = 0; i < SIZE; ++i) {
            ...
            if (i == 0) assertFalse(changed); else assertTrue(changed);
            assertTrue(q.containsAll(p));
            assertEquals(SIZE - i, q.size());
            p.remove();
        }
    ...
    public void testToArray() {
        ...
        Object[] o = q.toArray();
        try {
            for (int i = 0; i < o.length; i++) assertEquals(o[i], q.take());
        } catch (InterruptedException e) {
            unexpectedException();
        }
    }
    ...
    public void testToArray2() {
        ...
        try {
            for (int i = 0; i < ints.length; i++) assertEquals(ints[i], q.take());
        } catch (InterruptedException e) {
            unexpectedException();
        }
    }
