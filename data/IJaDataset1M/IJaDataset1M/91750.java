...
public class ExpandSelectionControl extends JPanel implements ExpandSelectionListener {
    ...
    protected static Icon iconFirstOff = VueResources.getImageIcon("expandselection.first.off"), iconFirstOn = VueResources.getImageIcon("expandselection.first.on"), iconFirstOver = VueResources.getImageIcon("expandselection.first.over"), iconRestOff = VueResources.getImageIcon("expandselection.rest.off"), iconRestOn = VueResources.getImageIcon("expandselection.rest.on"), iconRestOver = VueResources.getImageIcon("expandselection.rest.over");

    protected int currentDepth = 0;

    protected JLabel labels[] = { new JLabel(iconFirstOff), new JLabel(iconRestOff), new JLabel(iconRestOff), new JLabel(iconRestOff), new JLabel(iconRestOff), new JLabel(iconRestOff) };
    ...
    public ExpandSelectionListener[] getExpandSelectionListeners() {
        return (ExpandSelectionListener[]) listenerList.getListeners(ExpandSelectionListener.class);
    }
