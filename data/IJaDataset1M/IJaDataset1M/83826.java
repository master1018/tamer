...
public class DependencyCycles extends GraphTask {
    ...
    private boolean hasStartRegularExpressionSwitches() {
        return !getStartincludes().equals("//") || !getStartexcludes().equals("") || !getPackagestartincludes().equals("") || !getPackagestartexcludes().equals("") || !getClassstartincludes().equals("") || !getClassstartexcludes().equals("") || !getFeaturestartincludes().equals("") || !getFeaturestartexcludes().equals("");
    }

    private boolean hasStartListSwitches() {
        return getStartincludeslist() != null || getStartexcludeslist() != null;
    }
