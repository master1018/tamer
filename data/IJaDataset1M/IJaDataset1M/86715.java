...
public class DAOGestaoProj extends AbstractDAO {
    ...
    public void setParamsQueryAcao(PreparedStatement ps, Integer codempct, Integer codfilialct, Integer codcontr, Date dataini, Date datafim, Integer codsubcontr, Integer codtarefa, Integer codatend) throws SQLException {
        int param = 1;
    ...
    public static Constant[] getFiltroTipo(final String tipoct, final String tipoic, final String tiposc, final String tipois, final String tipota, final String tipost) {
        Constant[] result = null;
    ...
    public void setParamsQueryContr(PreparedStatement ps, Date dataini, Date datafim, Integer codempct, Integer codfilialct, Integer codcontr, String indice, final Constant[] filtroTipo) throws SQLException {
        int param = 1;
        ps.setDate(param++, Funcoes.dateToSQLDate(dataini));
        ps.setDate(param++, Funcoes.dateToSQLDate(datafim));
        ps.setInt(param++, codempct);
    ...
    public Vector<Vector<Object>> loadContr(Date dataini, Date datafim, Integer codempct, Integer codfilialct, Integer codcontr, String conthsubcontr, final String indice, final Constant[] filtroTipo) throws SQLException {
