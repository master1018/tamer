...
@ResourceAdaptorType(name = "ExampleAnnotatedResourceAdaptorType", vendor = "javax.slee", version = "1.0", activities = { ExampleActivity.class }, events = { @EventTypeRef(name = ExampleEvent.EVENT_TYPE_NAME, vendor = ExampleEvent.EVENT_TYPE_VENDOR, version = ExampleEvent.EVENT_TYPE_VERSION) }, aciFactory = ExampleActivityContextInterfaceFactory.class, sbbInterface = ExampleResourceAdaptorSbbInterface.class, libraryRefs = { @LibraryRef(name = "ExampleLibrary", vendor = "javax.slee", version = "1.0") })
@ResourceAdaptor(name = "ExampleAnnotatedResourceAdaptor", vendor = "javax.slee", version = "1.0", raTypeRefs = { @ResourceAdaptorTypeRef(name = "ExampleAnnotatedResourceAdaptorType", vendor = "javax.slee", version = "1.0") }, properties = { @ConfigProperty(name = "X", type = String.class) }, usageParametersInterface = ExampleUsageParametersInterface.class, profileSpecRefs = { @ProfileSpecRef(name = "ExampleProfileSpec", vendor = "javax.slee", version = "1.0", alias = "profileSpec") }, securityPermissions = "...")
