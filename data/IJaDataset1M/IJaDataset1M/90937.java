...
public interface BlogMapper {
     ...
     * @mbggenerated Wed Nov 30 10:19:04 CET 2011
     */
    @Delete({ "delete from T_BLOG", "where ID = #{id,jdbcType=BIGINT}" })
     ...
     * @mbggenerated Wed Nov 30 10:19:04 CET 2011
     */
    @Insert({ "insert into T_BLOG (NAME, URL, ", "DESCRIPTION, OWNER_ID)", "values (#{name,jdbcType=VARCHAR}, #{url,jdbcType=VARCHAR}, ", "#{description,jdbcType=VARCHAR}, #{ownerId,jdbcType=BIGINT})" })
    ...
    @Results({ @Result(column = "ID", property = "id", jdbcType = JdbcType.BIGINT, id = true), @Result(column = "NAME", property = "name", jdbcType = JdbcType.VARCHAR), @Result(column = "URL", property = "url", jdbcType = JdbcType.VARCHAR), @Result(column = "DESCRIPTION", property = "description", jdbcType = JdbcType.VARCHAR), @Result(column = "OWNER_ID", property = "ownerId", jdbcType = JdbcType.BIGINT) })
     ...
     * @mbggenerated Wed Nov 30 10:19:04 CET 2011
     */
    @Update({ "update T_BLOG", "set NAME = #{name,jdbcType=VARCHAR},", "URL = #{url,jdbcType=VARCHAR},", "DESCRIPTION = #{description,jdbcType=VARCHAR},", "OWNER_ID = #{ownerId,jdbcType=BIGINT}", "where ID = #{id,jdbcType=BIGINT}" })
