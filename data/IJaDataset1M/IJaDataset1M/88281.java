...
public class SPARQL_Triple implements Serializable {
    ...
    public SPARQL_Triple(SPARQL_Term variable, SPARQL_Property property, SPARQL_Value value) {
        super();
        this.variable = variable;
        this.property = property;
        this.value = value;
    ...
    public SPARQL_Triple(SPARQL_Term variable, SPARQL_Property property, SPARQL_Value value, boolean optional) {
        super();
        this.variable = variable;
        this.property = property;
        this.value = value;
