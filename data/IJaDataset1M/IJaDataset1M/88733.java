...
public class VariableType {
   ...
   */
    public VariableType(String name) {
        if (name == null) throw new NullPointerException("A variable type must have a name, but was null");
        if (!isValidName(name)) throw new IllegalArgumentException("The variable name is not valid: " + name);
        this._name = name;
    }
