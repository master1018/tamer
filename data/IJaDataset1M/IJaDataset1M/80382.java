...
public class KSubsetsList<T extends INestedListElement, L extends List<T> & INestedListElement> implements Iterator<L>, Iterable<L> {
    ...
    public KSubsetsList(final Iterator<int[]> iterable, final L list, final int k, L resultList, INestedList<T, L> copier, final int offset) {
        fIterable = iterable;
        fList = list;
        fK = k;
    ...
    public static <T extends INestedListElement, L extends List<T> & INestedListElement> KSubsetsList<T, L> createKSubsets(final L list, final int k, L resultList, INestedList<T, L> copier, final int offset) {
