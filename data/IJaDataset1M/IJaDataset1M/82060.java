...
public class HITDataCSVWriter extends AbstractHITDataOutput {
    ...
    private final Collection<String> IGNORED_FIELDS = new HashSet<String>(Arrays.asList(HITProperties.AssignmentField.Answers.getFieldName()));
    ...
    protected synchronized CSVWriter getWriter() throws IOException {
        if (this.csvWriter == null) {
            FileOutputStream fos = new FileOutputStream(this.fileName, appendToFile);
            OutputStreamWriter writer = new OutputStreamWriter(fos, "UTF-8");
            this.csvWriter = new CSVWriter(writer, separator, useQuotes ? CSVWriter.DEFAULT_QUOTE_CHARACTER : CSVWriter.NO_QUOTE_CHARACTER, System.getProperty("line.separator"));
        }
