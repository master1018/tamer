...
public final class XmlReader {
    ...
    public XmlReader(InputStream in, ProgressShow progressShow, long streamSize) throws ErrorMessage {
        ...
        try {
            ...
            int size;
            if (m_isBoardSizeKnown) size = m_boardSize; else size = Math.max(DEFAULT_BOARDSIZE, m_boardSize);
            m_tree = new GameTree(size, m_root);
            m_tree.getGameInfo(m_root).copyFrom(m_info);
            if (m_gameName != null) m_root.addSgfProperty("GN", m_gameName);
        } catch (SAXException e) {
    ...
    public String getWarnings() {
        if (m_warnings.isEmpty()) return null;
    ...
    private class Handler extends DefaultHandler {
        ...
        public void startElement(String namespaceURI, String name, String qualifiedName, Attributes atts) throws SAXException {
            if (m_progressShow != null) showProgress();
            checkNoCharacters();
            m_element = name;
            m_atts = atts;
            if (m_isFirstElement) {
                if (!m_element.equals("Go")) throw new SAXException("Not a Go game");
                m_isFirstElement = false;
            }
            if (name.equals("Annotation")) startInfoElemWithoutFormat(); else if (name.equals("Application")) startInfoElemWithFormat(); else if (name.equals("AddBlack")) startSetup(BLACK); else if (name.equals("AddWhite")) startSetup(WHITE); else if (name.equals("Arg")) checkParent("SGF"); else if (name.equals("at")) checkParent("Black", "White", "AddBlack", "AddWhite", "Delete", "Mark"); else if (name.equals("Black")) startMove(BLACK); else if (name.equals("BlackPlayer")) startInfoElemWithFormat(); else if (name.equals("BlackRank")) startInfoElemWithFormat(); else if (name.equals("BlackTeam")) startInfoElemWithoutFormat(); else if (name.equals("BlackToPlay")) startToPlay(BLACK); else if (name.equals("BoardSize")) startInfoElemWithFormat(); else if (name.equals("Comment")) startComment(); else if (name.equals("Copyright")) startCopyright(); else if (name.equals("Date")) startInfoElemWithFormat(); else if (name.equals("Delete")) startSetup(EMPTY); else if (name.equals("Go")) startGo(); else if (name.equals("GoGame")) startGoGame(); else if (name.equals("Handicap")) startInfoElemWithFormat(); else if (name.equals("Information")) startInformation(); else if (name.equals("Line")) startLine(); else if (name.equals("Komi")) startInfoElemWithFormat(); else if (name.equals("Mark")) startMark(); else if (name.equals("Node")) startNode(); else if (name.equals("Nodes")) startNodes(); else if (name.equals("P")) startP(); else if (name.equals("Result")) startInfoElemWithFormat(); else if (name.equals("Round")) startInfoElemWithoutFormat(); else if (name.equals("Rules")) startInfoElemWithFormat(); else if (name.equals("Source")) startInfoElemWithFormat(); else if (name.equals("SGF")) startSGF(); else if (name.equals("Time")) startInfoElemWithFormat(); else if (name.equals("User")) startInfoElemWithoutFormat(); else if (name.equals("Variation")) startVariation(); else if (name.equals("White")) startMove(WHITE); else if (name.equals("WhitePlayer")) startInfoElemWithFormat(); else if (name.equals("WhiteRank")) startInfoElemWithFormat(); else if (name.equals("WhiteTeam")) startInfoElemWithoutFormat(); else if (name.equals("WhiteToPlay")) startToPlay(WHITE); else setWarning("Ignoring unknown element: " + name);
        ...
        public void endElement(String namespaceURI, String name, String qualifiedName) throws SAXException {
            ...
            if (name.equals("AddBlack")) endSetup(BLACK); else if (name.equals("AddWhite")) endSetup(WHITE); else if (name.equals("Annotation")) m_info.set(StringInfo.ANNOTATION, getCharacters()); else if (name.equals("Arg")) m_sgfArgs.add(getCharacters()); else if (name.equals("at")) endAt(); else if (name.equals("Black")) endMove(BLACK); else if (name.equals("BlackPlayer")) m_info.set(StringInfoColor.NAME, BLACK, getCharacters()); else if (name.equals("BlackRank")) m_info.set(StringInfoColor.RANK, BLACK, getCharacters()); else if (name.equals("BlackTeam")) m_info.set(StringInfoColor.TEAM, BLACK, getCharacters()); else if (name.equals("BlackToPlay")) endToPlay(); else if (name.equals("BoardSize")) endBoardSize(); else if (name.equals("Comment")) endComment(); else if (name.equals("Copyright")) endCopyright(); else if (name.equals("Date")) m_info.set(StringInfo.DATE, getCharacters()); else if (name.equals("Delete")) endSetup(EMPTY); else if (name.equals("Go")) checkNoCharacters(); else if (name.equals("GoGame")) checkNoCharacters(); else if (name.equals("Handicap")) endHandicap(); else if (name.equals("Information")) checkNoCharacters(); else if (name.equals("Komi")) endKomi(); else if (name.equals("Mark")) endMark(); else if (name.equals("Node")) endNode(); else if (name.equals("Nodes")) checkNoCharacters(); else if (name.equals("P")) endP(); else if (name.equals("Result")) m_info.set(StringInfo.RESULT, getCharacters()); else if (name.equals("Round")) m_info.set(StringInfo.ROUND, getCharacters()); else if (name.equals("Rules")) m_info.set(StringInfo.RULES, getCharacters()); else if (name.equals("SGF")) endSgf(); else if (name.equals("Source")) m_info.set(StringInfo.SOURCE, getCharacters()); else if (name.equals("Time")) endTime(); else if (name.equals("User")) m_info.set(StringInfo.USER, getCharacters()); else if (name.equals("White")) endMove(WHITE); else if (name.equals("WhitePlayer")) m_info.set(StringInfoColor.NAME, WHITE, getCharacters()); else if (name.equals("WhiteRank")) m_info.set(StringInfoColor.RANK, WHITE, getCharacters()); else if (name.equals("WhiteTeam")) m_info.set(StringInfoColor.TEAM, WHITE, getCharacters()); else if (name.equals("WhiteToPlay")) endToPlay(); else if (name.equals("Variation")) endVariation();
            m_characters.setLength(0);
        }
        ...
        public InputSource resolveEntity(String publicId, String systemId) {
            ...
            if (file.exists() || !"go.dtd".equals(file.getName())) return null;
    ...
    private void checkAttributes(String... atts) throws SAXException {
        ...
        for (int i = 0; i < m_atts.getLength(); ++i) {
            ...
            if (!list.contains(name)) setWarning("Unknown attribute \"" + name + "\" for element \"" + m_element + "\"");
        }
    }

    private void checkNoCharacters() throws SAXException {
        if (!getCharacters().trim().equals("")) setWarning("Cannot handle text content in element \"" + m_element + "\"");
    }

    private void checkRoot() throws SAXException {
        String parent = parentElement();
        if (parent != null) throwError("Element \"" + m_element + "\" cannot be child of \"" + parent + "\"");
    }

    private void checkParent(String... parents) throws SAXException {
        String parent = parentElement();
        if (!Arrays.asList(parents).contains(parent)) throwError("Element \"" + m_element + "\" cannot be child of \"" + parent + "\"");
    }

    private void createNode() {
        Node node = new Node();
        if (m_node != null) m_node.append(node); else if (!m_variation.isEmpty()) m_variation.peek().getFather().append(node);
        m_node = node;
    }
    ...
    private void endAt() throws SAXException {
        ...
        String parent = parentElement();
        if (parent.equals("Black")) m_node.setMove(Move.get(BLACK, p)); else if (parent.equals("White")) m_node.setMove(Move.get(WHITE, p)); else if (parent.equals("AddBlack")) m_node.addStone(BLACK, p); else if (parent.equals("AddWhite")) m_node.addStone(WHITE, p); else if (parent.equals("Delete")) m_node.addStone(EMPTY, p); else if (parent.equals("Mark")) {
            if (m_markType != null) m_node.addMarked(p, m_markType);
            if (m_label != null) m_node.setLabel(p, m_label);
        }
    }

    private void endBoardSize() throws SAXException {
        int boardSize = parseInt();
        if (boardSize < 1 || boardSize > GoPoint.MAX_SIZE) throw new SAXException("Unsupported board size");
    ...
    private void endHandicap() throws SAXException {
        ...
        if (handicap == 1 || handicap < 0) setWarning("Ignoring invalid handicap: " + handicap); else m_info.setHandicap(handicap);
    }
    ...
    private void endMove(GoColor c) throws SAXException {
        String value = getCharacters();
        if (!value.trim().equals("")) m_node.setMove(Move.get(c, getPoint(value)));
    }
    ...
    private void endP() throws SAXException {
        m_paragraphElementText = m_paragraphElementText + getMergedLines() + "\n";
    }

    private void endSetup(GoColor c) throws SAXException {
        String value = getCharacters();
        if (!value.trim().equals("")) m_node.addStone(c, getPoint(value));
    }

    private void endSgf() throws SAXException {
        checkNoCharacters();
        if (m_sgfType == null) return;
        if (m_sgfType.equals("AN")) endSgfInfo(StringInfo.ANNOTATION); else if (m_sgfType.equals("BL")) endSgfTimeLeft(BLACK); else if (m_sgfType.equals("BR")) endSgfInfo(StringInfoColor.RANK, BLACK); else if (m_sgfType.equals("BT")) endSgfInfo(StringInfoColor.TEAM, BLACK); else if (m_sgfType.equals("CP")) endSgfInfo(StringInfo.COPYRIGHT); else if (m_sgfType.equals("DT")) endSgfInfo(StringInfo.DATE); else if (m_sgfType.equals("HA")) endSgfHandicap(); else if (m_sgfType.equals("OB")) endSgfMovesLeft(BLACK); else if (m_sgfType.equals("OM")) endSgfOvertimeMoves(); else if (m_sgfType.equals("OP")) endSgfOvertimePeriod(); else if (m_sgfType.equals("OT")) endSgfOvertime(); else if (m_sgfType.equals("OW")) endSgfMovesLeft(WHITE); else if (m_sgfType.equals("KM")) endSgfKomi(); else if (m_sgfType.equals("PB")) endSgfInfo(StringInfoColor.NAME, BLACK); else if (m_sgfType.equals("PW")) endSgfInfo(StringInfoColor.NAME, WHITE); else if (m_sgfType.equals("PL")) endSgfPlayer(); else if (m_sgfType.equals("RE")) endSgfInfo(StringInfo.RESULT); else if (m_sgfType.equals("RO")) endSgfInfo(StringInfo.ROUND); else if (m_sgfType.equals("RU")) endSgfInfo(StringInfo.RULES); else if (m_sgfType.equals("SL")) endSgfSelect(); else if (m_sgfType.equals("WL")) endSgfTimeLeft(WHITE); else if (m_sgfType.equals("TM")) endSgfTime(); else if (m_sgfType.equals("WR")) endSgfInfo(StringInfoColor.RANK, WHITE); else if (m_sgfType.equals("WT")) endSgfInfo(StringInfoColor.TEAM, WHITE); else if (m_sgfType.equals("US")) endSgfInfo(StringInfo.USER); else m_node.addSgfProperty(m_sgfType, m_sgfArgs);
    }

    /** Handle non-root handicap info from SGF properties. */
    private void endSgfHandicap() {
        if (m_sgfArgs.size() == 0) return;
        try {
    ...
    private void endSgfMovesLeft(GoColor c) {
        ...
        try {
            ...
            if (movesLeft >= 0) m_node.setMovesLeft(c, movesLeft);
        } catch (NumberFormatException e) {
        }
    }
    ...
    private void endSgfPlayer() {
        ...
        GoColor c;
        if (value.equals("b") || value.equals("black")) c = BLACK; else if (value.equals("w") || value.equals("white")) c = WHITE; else return;
        m_node.setPlayer(c);
    }

    private void endSgfSelect() throws SAXException {
        for (int i = 0; i < m_sgfArgs.size(); ++i) m_node.addMarked(getSgfPoint(m_sgfArgs.get(i)), MarkType.SELECT);
    }
    ...
    private void endSgfTime() {
        ...
        if (preByoyomi < 0) {
            ...
            m_node.addSgfProperty("TM", value);
        } else m_preByoyomi = preByoyomi;
    }
    ...
    private void endToPlay() throws SAXException {
        if (!getCharacters().trim().equals("")) setWarning("Ignoring text content in element \"" + m_element + "\"");
    }
    ...
    private String getParagraphElementText() {
        ...
        if (!mergedLines.equals("")) text = text + mergedLines + "\n";
    ...
    private GoPoint getPoint(String value) throws SAXException {
        ...
        GoPoint p;
        try {
            if (m_isBoardSizeKnown) p = GoPoint.parsePoint(value, m_boardSize); else {
    ...
    private GoPoint getSgfPoint(String s) throws SAXException {
        ...
        if (s.length() > 2 || (s.length() == 2 && s.charAt(1) < 'a' || s.charAt(1) > 'z')) return getPoint(s); else if (s.length() != 2) throwError("Invalid SGF coordinates: " + s);
        if (!m_isBoardSizeKnown) {
            m_boardSize = DEFAULT_BOARDSIZE;
            m_isBoardSizeKnown = true;
        }
        if (s.equals("tt") && m_boardSize <= 19) return null;
        int x = s.charAt(0) - 'a';
        int y = m_boardSize - (s.charAt(1) - 'a') - 1;
        if (x < 0 || x >= m_boardSize || y < 0 || y >= m_boardSize) {
            if (x == m_boardSize && y == -1) return null;
            throwError("Coordinates \"" + s + "\" outside board size " + m_boardSize);
        }
    ...
    private void setSgfTimeSettings() {
        ...
        if (m_node == m_root && preByoyomi < 0) preByoyomi = m_gameInfoPreByoyomi;
        TimeSettings s = null;
        if (preByoyomi > 0 && (m_ignoreOvertime || m_byoyomi <= 0 || m_byoyomiMoves <= 0)) s = new TimeSettings(preByoyomi); else if (preByoyomi <= 0 && !m_ignoreOvertime && m_byoyomi > 0 && m_byoyomiMoves > 0) s = new TimeSettings(0, m_byoyomi, m_byoyomiMoves); else if (preByoyomi > 0 && !m_ignoreOvertime && m_byoyomi > 0 && m_byoyomiMoves > 0) s = new TimeSettings(preByoyomi, m_byoyomi, m_byoyomiMoves);
        if (s != null) {
            if (m_node == m_root) m_info.setTimeSettings(s); else m_node.createGameInfo().setTimeSettings(s);
        }
    }
    ...
    private void showProgress() {
        ...
        if (percent != m_lastPercent) m_progressShow.showProgress(percent);
    ...
    private void startGoGame() throws SAXException {
        ...
        if (name != null) m_gameName = name;
        if (++m_numberGames > 1) throwError("Multiple games per file not supported");
    }
    ...
    private void startInfoElemWithFormat() throws SAXException {
        ...
        if (!format.equals("sgf")) setWarning("Unknown format attribute \"" + format + "\" for element \"" + m_element + "\"");
    }
    ...
    private void startLine() throws SAXException {
        setWarning("Element \"Line\" cannot be child of element \"" + parentElement() + "\"");
    }
    ...
    private void startMark() throws SAXException {
        ...
        if (type != null) {
            if (type.equals("triangle")) m_markType = MarkType.TRIANGLE; else if (type.equals("circle")) m_markType = MarkType.CIRCLE; else if (type.equals("square")) m_markType = MarkType.SQUARE; else setWarning("Unknown mark type " + type);
        }
        if (territory != null) {
            if (territory.equals("black")) m_markType = MarkType.TERRITORY_BLACK; else if (territory.equals("white")) m_markType = MarkType.TERRITORY_WHITE; else setWarning("Unknown territory type " + territory);
        }
        if (type == null && territory == null && m_label == null) m_markType = MarkType.MARK;
    ...
    private void startMove(GoColor c) throws SAXException {
        ...
        if (!parentElement().equals("Node")) createNode();
        checkAttributes("annotate", "at", "timeleft", "name", "number");
        String name = m_atts.getValue("name");
        if (name != null) m_node.addSgfProperty("N", name);
        if (m_atts.getValue("annotate") != null) setWarning("Attribute \"annotate\" in element \"" + m_element + "\" not supported");
        String value = m_atts.getValue("at");
        if (value != null) m_node.setMove(Move.get(c, getPoint(value)));
    ...
    private void startNode() throws SAXException {
        ...
        if (!m_isFirstNode || !m_node.isEmpty()) createNode();
        m_isFirstNode = false;
        String name = m_atts.getValue("name");
        if (name != null) m_node.addSgfProperty("N", name);
    ...
    private void startNodes() throws SAXException {
        checkParent("GoGame");
        checkAttributes();
        if (++m_numberTrees > 1) throwError("More than one Nodes element in element GoGame");
    }
    ...
    private void startSetup(GoColor c) throws SAXException {
        ...
        checkAttributes("at");
        String value = m_atts.getValue("at");
        if (value != null) m_node.addStone(c, getPoint(value));
    }
    ...
    private void startVariation() throws SAXException {
        checkParent("Nodes", "Variation");
        checkAttributes();
        if (m_node == null) throwError("Variation without main node");
    ...
    private String parentElement() {
        if (m_elementStack.isEmpty()) return null;
    ...
    private void throwError(String message) throws SAXException {
        if (m_locator != null) message = "Line " + m_locator.getLineNumber() + ":" + m_locator.getColumnNumber() + ": " + message;
