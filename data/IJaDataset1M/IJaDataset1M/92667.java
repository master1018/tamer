...
public interface Message {
   ...
   */
    public static enum Field {
        ...
        APP_URL("appUrl"), /** the field name for body. */
        BODY("body"), /** the field name for body id. */
        BODY_ID("bodyId"), /** the field name for the collection IDs */
        COLLECTION_IDS("collectionIds"), /** the field name for the unique ID of this message. */
        ID("id"), /** the field name for the Parent Message Id for this message. */
        IN_REPLY_TO("inReplyTo"), /** the field name for replies to this message */
        REPLIES("replies"), /** the field name for recipient list. */
        RECIPIENTS("recipients"), /** the field name for the ID of the person who sent this message. */
        SENDER_ID("senderId"), /** the field name for the time this message was sent. */
        TIME_SENT("timeSent"), /** the field name for title. */
        TITLE("title"), /** the field name for title id. */
        TITLE_ID("titleId"), /** the field name for type. */
        TYPE("type"), /** the field name for status. */
        STATUS("status"), /** the field name for updated time stamp. */
        UPDATED("updated"), /** the field name for urls. */
        URLS("urls");
   ...
   */
    public enum Type {
        ...
        /** An email. */
        EMAIL("email"), /** A short private message. */
        NOTIFICATION("notification"), /** A message to a specific user that can be seen only by that user. */
        PRIVATE_MESSAGE("privateMessage"), /** A message to a specific user that can be seen by more than that user. */
