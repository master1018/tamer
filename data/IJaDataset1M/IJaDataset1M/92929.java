...
public class NewPopulationDialog extends EncogPropertiesDialog implements PopupListener {
    ...
    public NewPopulationDialog() {
        ...
        addProperty(this.outputActivationField = new PopupField("output activation", "Output Activation Function", true));
        addProperty(this.neatActivationField = new PopupField("NEAT activation", "NEAT Activation Function", true));
        render();
    ...
    public String popup(PopupField field) {
        if (field == this.outputActivationField) {
            ...
            if (!dialog.process()) return null; else {
    ...
    public void setOutputActivationFunction(ActivationFunction activationFunction) {
        ...
        this.outputActivationField.setValue(activationFunction.getClass().getSimpleName());
    }
