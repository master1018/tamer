...
public class TextEditActivity extends AbstractActivity {
    ...
    public String toString() {
        return "TextEditActivity(" + this.offset + ",new:'" + Utils.escapeForLogging(StringUtils.abbreviate(this.text, 150)) + "',old:'" + Utils.escapeForLogging(StringUtils.abbreviate(this.replacedText, 150)) + "',path:" + this.path.toString() + ",src:" + this.source + ")";
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((replacedText == null) ? 0 : replacedText.hashCode());
    ...
    public boolean sameLike(Object obj) {
        if (obj instanceof TextEditActivity) {
            TextEditActivity other = (TextEditActivity) obj;
            return (this.offset == other.offset) && (this.path != null) && (other.path != null) && this.path.equals(other.path) && this.text.equals(other.text) && (this.replacedText.equals(other.replacedText));
        }
        return false;
    }
    ...
    public IActivityDataObject getActivityDataObject(ISarosSession sarosSession) {
        return new TextEditActivityDataObject(source.getJID(), offset, text, replacedText, path.toSPathDataObject(sarosSession));
    }
}
