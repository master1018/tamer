    ...
    private void buildUI(final VCard vcard) {
        avatarImage.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent mouseEvent) {
                if (mouseEvent.getClickCount() == 2) ChatsyManager.getVCardManager().viewProfile(vcard.getJabberId(), avatarImage);
            }
        });
        ...
        if (ModelUtil.hasLength(firstName) && ModelUtil.hasLength(lastName)) usernameLabel.setText(firstName + " " + lastName); else {
        ...
        if (icon != null) usernameLabel.setIcon(icon);
        ...
        if (ModelUtil.hasLength(vcard.getEmailHome())) emailAddress = vcard.getEmailHome();
        ...
        if (!ModelUtil.hasLength(homeNumber)) homeNumber = "n/a";
        ...
        if (!ModelUtil.hasLength(workNumber)) workNumber = "n/a";
        ...
        if (!ModelUtil.hasLength(cellNumber)) cellNumber = "n/a";
