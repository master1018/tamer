 ...
 */
public interface FeatureList<E extends Property, C extends Collection<E>, M extends FeatureType, T extends FeatureCollectionType<E, C, M>, F extends Feature> extends FeatureCollection<E, C, M, T, F>, List<F> {
