...
/**
 *  A convenience class for the construction of various types of <code>WritableRaster</code>
 *  and <code>SampleModel</code> objects. <p>
 *
 *  This class provides the capability of creating <code>Raster</code>s with the
 *  enumerated data types in the java.awt.image.DataBuffer. <p>
 *
 *  In some cases, instances of <code>ComponentSampleModelJAI</code>, a subclass
 *  of <code>java.awt.image.ComponentSampleModel</code> are instantiated instead
 *  of <code>java.awt.image.BandedSampleModel</code> in order to work around
 *  bugs in the current release of the Java 2 SDK.
 *
 */
public class RasterFactory {

    /**
   *  Creates a <code>WritableRaster</code> based on a <code>PixelInterleavedSampleModel</code>
   *  with the specified data type, width, height, and number of bands. <p>
   *
   *  The upper left corner of the <code>WritableRaster</code> is given by the
   *  <code>location</code> argument. If <code>location</code> is <code>null</code>
   *  , (0, 0) will be used. The <code>dataType</code> parameter should be one
   *  of the enumerated values defined in the <code>DataBuffer</code> class.
   *
   * @param  dataType                   The data type of the <code>SampleModel</code>
   *      , one of <code>DataBuffer.TYPE_BYTE</code>, <code>TYPE_USHORT</code>,
   *      <code>TYPE_SHORT</code>, <code>TYPE_INT</code>, <code>TYPE_FLOAT</code>
   ...
   *      starting coordinates of the <code>WritableRaster</code>.
   ...
   */
    ...
    /**
   *  Creates a <code>WritableRaster</code> based on a <code>PixelInterleavedSampleModel</code>
   *  with the specified data type, width, height, scanline stride, pixel
   *  stride, and band offsets. The number of bands is inferred from
   *  bandOffsets.length. <p>
   *
   *  The upper left corner of the <code>WritableRaster</code> is given by the
   *  <code>location</code> argument. If <code>location</code> is <code>null</code>
   *  , (0, 0) will be used. The <code>dataType</code> parameter should be one
   ...
   *      , one of the enumerated dataType values in java.awt.image.DataBuffer.
   * @param  width                      The desired width of the <code>WritableRaster</code>
   *      .
   * @param  height                     The desired height of the <code>WritableRaster</code>
   *      .
   ...
   * @param  bandOffsets                An array of <code>int</code>s indicating
   *      the relative offsets of the bands within a pixel.
   * @param  location                   A <code>Point</code> indicating the
   *      starting coordinates of the <code>WritableRaster</code>.
   * @return                            Description of the Returned Value
   * @throws  IllegalArgumentException  if <code>bandOffsets</code> is <code>null</code>
   *      , <code>dataType</code> is not one of the enumerated dataType value of
   *      java.awt.image.DataBuffer.
   * @throws  IllegalArgumentException  if the number of array elements required
   *      by the returned <code>WritableRaster</code> would exceed <code>Integer.MAX_VALUE</code>
   *      .
   */
    ...
    /**
   *  Creates a <code>WritableRaster</code> based on a <code>ComponentSampleModel</code>
   *  with the specified data type, width, height, and number of bands. <p>
   *
   *  Note that the <code>Raster</code>'s <code>SampleModel</code> will be of
   *  type <code>ComponentSampleModel</code>, not <code>BandedSampleModel</code>
   ...
   */
    ...
    /**
   *  Creates a <code>WritableRaster</code> based on a <code>ComponentSampleModel</code>
   *  with the specified data type, width, height, scanline stride, bank indices
   *  and band offsets. The number of bands is inferred from <code>bankIndices.length</code>
   *  and <code>bandOffsets.length</code>, which must be the same. <p>
   *
   *  Note that the <code>Raster</code>'s <code>SampleModel</code> will be of
   *  type <code>ComponentSampleModel</code>, not <code>BandedSampleModel</code>
   *  as might be expected. <p>
   *
   *  The upper left corner of the <code>WritableRaster</code> is given by the
   *  <code>location</code> argument. The <code>dataType</code> parameter should
   *  be one of the enumerated values defined in the <code>DataBuffer</code>
   *  class.
   *
   * @param  dataType                   The data type of the <code>WritableRaster</code>
   *      , one of the enumerated dataType values in java.awt.image.DataBuffer.
   ...
   *      .
   * @param  scanlineStride             The desired scanline stride.
   * @param  bankIndices                An array of <code>int</code>s indicating
   ...
   *      , <code>bandOffsets</code> is <code>null</code>, if <code>bandOffsets.length</code>
   *      is <code>!=</code> <code>bankIndices.length</code>, if <code>dataType</code>
   *      is not one of the enumerated datatypes of java.awt.image.DataBuffer.
   */
    ...
    /**
   *  Creates a <code>WritableRaster</code> based on a <code>SinglePixelPackedSampleModel</code>
   *  with the specified data type, width, height, and band masks. The number of
   *  bands is inferred from <code>bandMasks.length</code>. <p>
   *
   *  The upper left corner of the <code>WritableRaster</code> is given by the
   *  <code>location</code> argument. If <code>location</code> is <code>null</code>
   *  , (0, 0) will be used. The <code>dataType</code> parameter should be one
   ...
   * @param  location                   A <code>Point</code> indicating the
   *      starting coordinates of the <code>WritableRaster</code>.
   * @param  bandMasks                  Description of Parameter
   * @return                            Description of the Returned Value
   * @throws  IllegalArgumentException  is thrown if the <code>dataType</code>
   ...
   */
    ...
    /**
   *  Creates a <code>WritableRaster</code> based on a packed <code>SampleModel</code>
   *  with the specified data type, width, height, number of bands, and bits per
   *  band. If the number of bands is one, the <code>SampleModel</code> will be
   *  a <code>MultiPixelPackedSampleModel</code>. <p>
   *
   *  If the number of bands is more than one, the <code>SampleModel</code> will
   *  be a <code>SinglePixelPackedSampleModel</code>, with each band having
   *  <code>bitsPerBand</code> bits. In either case, the requirements on <code>dataType</code>
   *  and <code>bitsPerBand</code> imposed by the corresponding <code>SampleModel</code>
   *  must be met. <p>
   *
   *  The upper left corner of the <code>WritableRaster</code> is given by the
   *  <code>location</code> argument. If <code>location</code> is <code>null</code>
   ...
   * @throws  IllegalArgumentException  is thrown if the <code>dataType</code>
   *      is not of either TYPE_BYTE or TYPE_USHORT or TYPE_INT.
   * @throws  IllegalArgumentException  is thrown if bitsPerBand is negative or
   *      zero.
   */
    ...
    /**
   *  Creates a <code>WritableRaster</code> based on a <code>PixelInterleavedSampleModel</code>
   *  with the specified <code>DataBuffer</code>, width, height, scanline
   *  stride, pixel stride, and band offsets. The number of bands is inferred
   *  from <code>bandOffsets.length</code>. The upper left corner of the <code>WritableRaster</code>
   *  is given by the <code>location</code> argument. If <code>location</code>
   *  is <code>null</code>, (0, 0) will be used.
   *
   ...
   * @return                            Description of the Returned Value
   * @throws  IllegalArgumentException  if <code>bandOffsets</code> is <code>null</code>
   *      , if <code>pixelStride*width</code> is <code>></code> <code>scanlineStride</code>
   *      , if <code>dataType</code>of the DataBuffer is not one the enumerated
   *      dataType value of java.awt.image.DataBuffer.
   */
   ...
   *  Creates a <code>WritableRaster</code> based on a <code>ComponentSampleModel</code>
   *  with the specified <code>DataBuffer</code>, width, height, scanline
   *  stride, bank indices, and band offsets. The number of bands is inferred
   *  from <code>bankIndices.length</code> and <code>bandOffsets.length</code>,
   *  which must be the same. The upper left corner of the <code>WritableRaster</code>
   *  is given by the <code>location</code> argument. If <code>location</code>
   *  is <code>null</code>, (0, 0) will be used. <p>
   *
   *  Note that the <code>Raster</code>'s <code>SampleModel</code> will be of
   *  type <code>ComponentSampleModel</code>, not <code>BandedSampleModel</code>
   ...
   * @return                            Description of the Returned Value
   * @throws  IllegalArgumentException  if <code>bankIndices</code> is <code>null</code>
   *      , if <code>bandOffsets</code> is <code>null</code>, if <code>bandOffsets.length</code>
   *      is <code>!=</code> <code>bankIndices.length</code>, if <code>dataType</code>
   *      is not one of the enumerated datatypes of java.awt.image.DataBuffer.
   */
   ...
   *  Creates a <code>WritableRaster</code> based on a <code>SinglePixelPackedSampleModel</code>
   *  with the specified <code>DataBuffer</code>, width, height, scanline
   *  stride, and band masks. The number of bands is inferred from <code>bandMasks.length</code>
   *  . The upper left corner of the <code>WritableRaster</code> is given by the
   *  <code>location</code> argument. If <code>location</code> is <code>null</code>
   *  , (0, 0) will be used.
   *
   ...
   *      .
   * @param  scanlineStride             The desired scanline stride.
   * @param  bandMasks                  An array of <code>int</code>s indicating
   *      the bitmasks for each band within a pixel.
   * @param  location                   A <code>Point</code> indicating the
   *      starting coordinates of the <code>WritableRaster</code>.
   * @return                            Description of the Returned Value
   * @throws  IllegalArgumentException  is thrown if the <code>dataType</code>
   ...
   */
    ...
    /**
   *  Creates a <code>WritableRaster</code> based on a <code>MultiPixelPackedSampleModel</code>
   *  with the specified <code>DataBuffer</code>, width, height, and bits per
   *  pixel. The upper left corner of the <code>WritableRaster</code> is given
   *  by the <code>location</code> argument. If <code>location</code> is <code>null</code>
   *  , (0, 0) will be used.
   *
   * @param  dataBuffer                 The <code>DataBuffer</code> to be used.
   * @param  width                      The desired width of the <code>WritableRaster</code>
   ...
   * @return                            Description of the Returned Value
   * @throws  IllegalArgumentException  is thrown if the <code>dataType</code>
   *      of the <code>dataBuffer</code> is not of either TYPE_BYTE or
   ...
   */
    ...
    /**
   *  Creates a <code>WritableRaster</code> with the specified <code>SampleModel</code>
   *  and <code>DataBuffer</code>. The upper left corner of the <code>WritableRaster</code>
   *  is given by the <code>location</code> argument. If <code>location</code>
   *  is <code>null</code>, (0, 0) will be used.
   *
   ...
   *  getParent() and getWritableParent() methods. <p>
   *
   ...
   *  WritableRaster. The childMinX and childMinY parameters give the new (x, y)
   *  coordinate of the upper-left pixel of the returned WritableRaster; the
   ...
   *  bandList parameter. If bandList is null, it is taken to include all of the
   *  bands of the supplied WritableRaster in their current order. <p>
   *
   ...
   * @param  parentX                 X coordinate of the upper left corner of
   *      the shared rectangle in this WritableRaster's coordinates.
   * @param  parentY                 Y coordinate of the upper left corner of
   *      the shared rectangle in this WritableRaster's coordinates.
   ...
   *      the returned WritableRaster.
   * @param  bandList                Array of band indices, or null to use all
   *      bands.
   * @return                         Description of the Returned Value
   * @throws  RasterFormatException  if the subregion is outside of the raster
   *      bounds.
   */
   ...
   *  height, number of bands, bank indices, and band offsets. <p>
   *
   *  Note that the returned <code>SampleModel</code> will be of type <code>ComponentSampleModel</code>
   *  , not <code>BandedSampleModel</code> as might be expected. Its behavior
   *  will be equivalent to that of a <code>BandedSampleModel</code>, and in
   *  particular its pixel stride will always be 1.
   *
   * @param  dataType                   The data type of the <code>SampleModel</code>
   *      , one of <code>DataBuffer.TYPE_BYTE</code>, <code>TYPE_USHORT</code>,
   *      <code>TYPE_SHORT</code>, <code>TYPE_INT</code>, <code>TYPE_FLOAT</code>
   ...
   * @return                            Description of the Returned Value
   * @throws  IllegalArgumentException  if <code>numBands</code> is <code><1</code>
   *      , if <code>bandOffsets.length</code> is <code>!=</code> <code>bankIndices.length</code>
   *      .
   */
   ...
   *  particular its pixel stride will always be 1.
   *
   * @param  dataType  The data type of the <code>SampleModel</code>, one of
   *      <code>DataBuffer.TYPE_BYTE</code>, <code>TYPE_USHORT</code>, <code>TYPE_SHORT</code>
   *      , <code>TYPE_INT</code>, <code>TYPE_FLOAT</code>, or <code>TYPE_DOUBLE</code>
   *      .
   * @param  width     The desired width of the <code>SampleModel</code>.
   * @param  height    The desired height of the <code>SampleModel</code>.
   * @param  numBands  The desired number of bands.
   ...
   * @return                            Description of the Returned Value
   * @throws  IllegalArgumentException  if <code>bandOffsets</code> is <code>null</code>
   *      , if the <code>pixelStride*width</code> is <code>></code> than <code>scanlineStride</code>
   *      , if the <code>dataType</code> is not one of the above mentioned
   *      datatypes.
   */
   ...
   *  color space, and transparency type. Currently this method does not support
   *  data type <code>DataBuffer.TYPE_SHORT</code>. If useAlpha is false, both
   *  premultiplied and transparency input are ignored and they are set to be
   *  <code> false</code> and <code> Transparency.OPQAUE </code>, respectively.
   *
   ...
   *      .
   * @param  useAlpha                            <code>true</code> if alpha is
   *      to be used.
   * @param  premultiplied                       <code>true</code> if alpha
   *      values are premultiplied. If <code>useAlpha</code> is <code>false</code>
   ...
   *      . If <code>useAlpha</code> is <code>false</code>, the value of <code>transparency</code>
   *      is ignored. If <code>useAlpha</code> is <code>true</code>, <code>transparency</code>
   *      must not equal <code>Transparency.OPQAUE</code>.
   ...
   *      has an unknown value, if <code>useAlpha == true</code> but <code>transparency == Transparency.OPAQUE</code>
   *      , or if <code>dataType</code> is not one of the standard types listed
   *      above.
   */
