...
public final class ProductProperFreeElement extends ProperFreeElement implements ProductFreeElement {
     ...
     */
    public ProductProperFreeElement sum(ProductProperFreeElement element) throws DomainException {
     ...
     */
    public void add(ProductProperFreeElement element) throws DomainException {
        if (!getModule().equals(element.getModule())) {
            throw new DomainException(this.getModule(), element.getModule());
        }
        for (int i = 0; i < getLength(); i++) {
     ...
     */
    public ProductProperFreeElement difference(ProductProperFreeElement element) throws DomainException {
        if (!getModule().equals(element.getModule())) {
            throw new DomainException(this.getModule(), element.getModule());
        }
        ProductElement[] res = new ProductElement[getLength()];
     ...
     */
    public void subtract(ProductProperFreeElement element) throws DomainException {
        if (!getModule().equals(element.getModule())) {
            throw new DomainException(this.getModule(), element.getModule());
        }
        for (int i = 0; i < getLength(); i++) {
    ...
    public ProductProperFreeElement productCW(ProductProperFreeElement element) throws DomainException {
        if (getModule().equals(element.getModule())) {
            throw new DomainException(this.getModule(), element.getModule());
        }
        ProductElement[] res = new ProductElement[getLength()];
    ...
    public void multiplyCW(ProductProperFreeElement element) throws DomainException {
        if (!getModule().equals(element.getModule())) {
            throw new DomainException(this.getModule(), element.getModule());
        }
        for (int i = 0; i < getLength(); i++) {
     ...
     */
    public ProductProperFreeElement scaled(ProductElement element) throws DomainException {
    ...
    private static final XMLInputOutput<ModuleElement> xmlIO = new ProductProperFreeElement(null, null);
