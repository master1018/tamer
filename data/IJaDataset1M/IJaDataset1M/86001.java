...
public class Utils {
    ...
    public static void showMessage(String title, String msg, String btnText, Context cont) {
        showMessage(title, msg, null, btnText, cont);
    }

    public static void showMessage(String title, String msg, Integer icon, String btnText, Context cont) {
        AlertDialog alertDialog = new AlertDialog.Builder(cont).create();
        if (icon != null) {
    ...
    public static void showModalDialog(String title, String msg, String posText, String negText, Context cont) {
        showModalDialog(title, msg, null, posText, null, negText, null, cont);
    }

    public static void showModalDialog(String title, String msg, String posText, DialogInterface.OnClickListener posAction, String negText, Context cont) {
        showModalDialog(title, msg, null, posText, posAction, negText, null, cont);
    }

    public static void showModalDialog(String title, String msg, String posText, String negText, DialogInterface.OnClickListener negAction, Context cont) {
        showModalDialog(title, msg, null, posText, null, negText, negAction, cont);
    }

    public static void showModalDialog(String title, String msg, Integer icon, String posText, String negText, Context cont) {
        showModalDialog(title, msg, icon, posText, null, negText, null, cont);
    }

    public static void showModalDialog(String title, String msg, Integer icon, String posText, DialogInterface.OnClickListener posAction, String negText, Context cont) {
        showModalDialog(title, msg, icon, posText, posAction, negText, null, cont);
    }

    public static void showModalDialog(String title, String msg, Integer icon, String posText, String negText, DialogInterface.OnClickListener negAction, Context cont) {
        showModalDialog(title, msg, icon, posText, null, negText, negAction, cont);
    }

    public static void showModalDialog(String title, String msg, Integer icon, String posText, DialogInterface.OnClickListener posAction, String negText, DialogInterface.OnClickListener negAction, Context cont) {
