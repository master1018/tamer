...
public class BBIextraDemand {
    ...
    public BBIextraDemand(String demandFile, String timeStructure, String oldDemandTXLSXFoutFile, String newDemandBBIoutFile, double scaleFactor, Coord coordBBI, Coord coordTXL, Coord coordSXF) {
