...
public class Message {
    ...
    public void readMessage() throws LoggerException {
        ...
        for (GenericTable msg : vectGenTable) {
            if (msg.getParameterType().equals("soap")) vectSoapMsg.add(msg); else if (msg.getParameterType().equals("http")) vectHttpMsg.add(msg); else if (msg.getParameterType().equals("other")) vectOtherMsg.add(msg); else if (msg.getParameterType().equals("error")) vectErrorMsg.add(msg);
        }
