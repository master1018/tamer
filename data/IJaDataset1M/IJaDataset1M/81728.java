    ...
    public byte[] getEncoded() {
        try {
            ...
            if (destDeviceId == SIM_DEVICE_ID) {
                byte[] data = new byte[] { (byte) COMMAND_DETAILS_TAG, 3, 0x01, 0x26, 0x03, (byte) DEVICE_ID_TAG, 2, (byte) srcDeviceId, (byte) destDeviceId, (byte) RESULT_TAG, 1, 0x00 };
                out.write(data);
                ...
                dataOut.write(new byte[] { (byte) COMMAND_DETAILS_TAG, 3, 0x01, 0x26, 0x03, (byte) DEVICE_ID_TAG, 2, (byte) srcDeviceId, (byte) destDeviceId });
                out.write((byte) 0xD0);
