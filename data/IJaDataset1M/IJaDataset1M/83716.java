package de.uniwue.tm.textruler.whisk.token;
...
import de.uniwue.tm.textruler.TextRulerPlugin;
import de.uniwue.tm.textruler.extension.TextRulerController;
import de.uniwue.tm.textruler.extension.TextRulerLearnerController;
import de.uniwue.tm.textruler.extension.TextRulerLearnerFactory;
import de.uniwue.tm.textruler.extension.TextRulerLearnerParameter;

public class WhiskTokenPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {

    public static String ID = "de.uniwue.tm.textruler.algorithmPages";
    ...
    public WhiskTokenPreferencePage() {
        TextRulerLearnerController ctrl = TextRulerController.getControllerForID("de.uniwue.tm.textruler.whisk.token");
    ...
    protected void performDefaults() {
        for (FieldEditor f : fields) f.loadDefault();
    }

    @Override
    public boolean performOk() {
        for (FieldEditor f : fields) f.store();
        return true;
    }
}
