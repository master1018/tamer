        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                if (wasAbnormal && new File(AUTO_SAVE_FILE_NAME).exists()) {
                    int decision = view.showConfirmDialog("It appears that aplication was not closed normally in the previous session. Do you want to open the last auto-saved file?", "Auto-Save", IView.YES_NO_OPTION, IView.QUESTION_MESSAGE);
