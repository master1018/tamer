...
public class KnobListModel extends AbstractListModel implements KnobGroupListener, KnobsControllerListener {
	 ...
	 */
    protected static String warningLabel(final String label) {
	 ...
	 */
    public void knobsAdded(final KnobGroup group, final Collection addedKnobs) {
        fireContentsChanged(this, 0, getSize());
    }
	 ...
	 */
    public void knobsRemoved(final KnobGroup group, final Collection removedKnobs) {
        fireContentsChanged(this, 0, getSize());
    }
