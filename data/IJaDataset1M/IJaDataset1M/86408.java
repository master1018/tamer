...
public class Fighter_Behead extends FighterSkill {
    ...
    public int castingQuality(MOB mob, Environmental target) {
        if ((mob != null) && (target != null) && (target instanceof MOB)) {
            ...
            if (B != null) warrants = B.getWarrantsOf(CMLib.law().getLegalObject(mob.location()), (MOB) target);
            ...
            ww = (Weapon) w;
            if (ww.weaponType() != Weapon.TYPE_SLASHING) return Ability.QUALITY_INDIFFERENT;
    ...
    public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel) {
        ...
        if ((!super.invoke(mob, commands, givenTarget, auto, asLevel)) || (ww == null)) return false;
        ...
        if (success) {
            ...
            if (mob.location().okMessage(mob, msg)) {
                ...
                if ((R != null) && (R.myResources() != null) && (R.myResources().size() > 0)) for (int r = 0; r < R.myResources().size(); r++) {
        ...
        } else maliciousFizzle(mob, target, "<S-NAME> attempt(s) a beheading and fail(s)!");
        return success;
    }
}
