...
public class CompilationUnitSchedulingRule implements ISchedulingRule {
    ...
    private final URI _sourceToParse;
    ...
    public boolean contains(ISchedulingRule rule) {
        if (rule instanceof CompilationUnitSchedulingRule) return _sourceToParse.equals(((CompilationUnitSchedulingRule) rule).getSource());
        return false;
    }
