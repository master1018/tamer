...
public class OwlsAssignClientReorientCommand extends EditElementCommand {
    ...
    protected boolean canReorientSource() {
        ...
        return OwlsBaseItemSemanticEditPolicy.LinkConstraints.canExistOwlsAssignInputClient_3002(container, getNewSource(), target);
    }
    ...
    protected boolean canReorientTarget() {
        ...
        OwlsProcess container = (OwlsProcess) getLink().eContainer();
        return OwlsBaseItemSemanticEditPolicy.LinkConstraints.canExistOwlsAssignInputClient_3002(container, source, getNewTarget());
    }
