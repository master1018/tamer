...
public class DaoUtils {
    ...
    public static Integer getIntegerIfPresent(ResultSet rs, String columnName) throws SQLException {
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("getInteger() failed for column '" + columnName + "'. ResultSet doesn't contain that column");
            }
            return null;
        }
    ...
    public static Boolean getBooleanIfPresent(ResultSet rs, String columnName) throws SQLException {
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("getBoolean() failed for column '" + columnName + "'. ResultSet doesn't contain that column");
            }
            return null;
        }
    ...
    public static Double getDoubleIfPresent(ResultSet rs, String columnName) throws SQLException {
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("getDouble() failed for column '" + columnName + "'. ResultSet doesn't contain that column");
            }
            return null;
        }
    ...
    public static String getStringIfPresent(ResultSet rs, String columnName) throws SQLException {
        ...
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("getString() failed for column '" + columnName + "'. ResultSet doesn't contain that column");
            }
            return null;
        }
