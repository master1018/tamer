...
public class ProductTest extends ModuleTestBase {
    ...
    private String[] detailActions = { "Navigation.previous", "Navigation.first", "Navigation.next", "CRUD.new", "CRUD.save", "CRUD.delete", "CRUD.search", "CRUD.refresh", "EditableOnOff.setOn", "EditableOnOff.setOff", "Mode.list", "Mode.split", "Product.setLimitZoneTo1", "Product.setLimitZoneTo0", "Product.changeProductPrice", "Gallery.edit" };

    private String[] listActions = { "Print.generatePdf", "Print.generateExcel", "CRUD.new", "CRUD.deleteSelected", "CRUD.deleteRow", "Mode.detailAndFirst", "Mode.split", "List.filter", "List.customize", "List.orderBy", "List.viewDetail", "List.hideRows", "List.sumColumn" };
    ...
    public void testFiltersInDescriptionsEditor() throws Exception {
        ...
        key3.setNumber(3);
        String[][] zone1WarehouseValues = new String[][] { { "", "" }, { toKeyString(key1), "CENTRAL VALENCIA" }, { toKeyString(key3), "VALENCIA NORTE" }, { toKeyString(key2), "VALENCIA SURETE" } };
    ...
    public void testDepedentsStereotypesAndDescriptionsEditor_someDescriptions_and_formatters() throws Exception {
        ...
        String[][] hardwareValues = { { "", "" }, { "11", "011 SERVIDORES" }, { "12", "012 PC" }, { "13", "013 PERIFERICOS" } };
        assertValue("subfamilyNumber", "");
        assertValidValues("subfamilyNumber", hardwareValues);
        setValue("familyNumber", "1");
        String[][] softwareValues = { { "", "" }, { "1", "01 DESARROLLO" }, { "2", "02 GESTION" }, { "3", "03 SISTEMA" } };
        assertValue("subfamilyNumber", "");
    ...
    public void testEntityValidatorOnlyOnCreate() throws Exception {
        ...
        assertActions(detailActions);
        setValue("number", "66");
        setValue("description", "CUATRE CON PRECIO PROHIBIDO");
        setValue("familyNumber", "1");
        setValue("subfamilyNumber", "1");
        setValue("warehouseKey", "[.1.1.]");
        setValue("unitPrice", "555");
        execute("CRUD.save");
    ...
    public void testGoFromListToDetailAlwaysSetDefaultController_editableWellOnSearch() throws Exception {
        String[] changeProductPriceActions = { "Mode.list", "Mode.split", "ChangeProductsPrice.save", "ChangeProductsPrice.editDescription", "Gallery.edit" };
        assertActions(listActions);
        execute("Mode.detailAndFirst");
