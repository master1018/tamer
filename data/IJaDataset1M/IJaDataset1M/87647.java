...
public class ZnProperFreeElement extends ProperFreeElement implements ZnFreeElement {
    ...
    public ZnProperFreeElement sum(ModuleElement element) throws DomainException {
    ...
    public ZnProperFreeElement sum(ZnProperFreeElement element) throws DomainException {
        if (getModulus() == element.getModulus() && getLength() == element.getLength()) {
    ...
    public void add(ZnProperFreeElement element) throws DomainException {
        if (getModulus() == element.getModulus() && getLength() == element.getLength()) {
            for (int i = 0; i < getLength(); i++) {
    ...
    public ZnProperFreeElement difference(ModuleElement element) throws DomainException {
        if (element instanceof ZnProperFreeElement) {
    ...
    public ZnProperFreeElement difference(ZnProperFreeElement element) throws DomainException {
        if (getModulus() == element.getModulus() && getLength() == element.getLength()) {
            int res[] = new int[getLength()];
            for (int i = 0; i < getLength(); i++) {
                res[i] = value[i] - element.value[i];
    ...
    public void subtract(ZnProperFreeElement element) throws DomainException {
        if (getModulus() == element.getModulus() && getLength() == element.getLength()) {
            for (int i = 0; i < getLength(); i++) {
                value[i] = NumberTheory.mod(value[i] - element.value[i], modulus);
            }
    ...
    public ModuleElement productCW(ModuleElement element) throws DomainException {
        if (element instanceof ZnProperFreeElement) {
    ...
    public ZnProperFreeElement productCW(ZnProperFreeElement element) throws DomainException {
        if (getModulus() == element.getModulus() && getLength() == element.getLength()) {
            int res[] = new int[getLength()];
            for (int i = 0; i < getLength(); i++) {
                res[i] = value[i] * element.value[i];
    ...
    public void multiplyCW(ZnProperFreeElement element) throws DomainException {
        if (getModulus() == element.getModulus() && getLength() == element.getLength()) {
            for (int i = 0; i < getLength(); i++) {
                value[i] = NumberTheory.mod(value[i] * element.value[i], modulus);
            }
    ...
    public ZnProperFreeElement scaled(RingElement element) throws DomainException {
    ...
    public ZnProperFreeElement scaled(ZnElement element) throws DomainException {
    ...
    public void scale(ZnElement element) throws DomainException {
        if (getModulus() == element.getModulus()) {
            int val = element.getValue();
            for (int i = 0; i < getLength(); i++) {
                value[i] *= val;
    ...
    public void toXML(XMLWriter writer) {
        ...
        s += "\"";
        writer.emptyWithType(MODULEELEMENT, getElementTypeName(), MODULUS_ATTR, getModulus(), VALUES_ATTR, s);
    }
    ...
    private static final XMLInputOutput<ModuleElement> xmlIO = ZnProperFreeElement.make(new int[0], 2);
