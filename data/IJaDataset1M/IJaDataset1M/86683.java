...
public class PdfPCell extends Rectangle {
    ...
    public void setCellEvent(PdfPCellEvent cellEvent) {
        if (cellEvent == null) this.cellEvent = null; else if (this.cellEvent == null) this.cellEvent = cellEvent; else if (this.cellEvent instanceof PdfPCellEventForwarder) ((PdfPCellEventForwarder) this.cellEvent).addCellEvent(cellEvent); else {
    ...
    public float getMaxHeight() {
        ...
        if (img != null) {
            ...
            if (pivoted && hasFixedHeight()) setBottom(getTop() - getFixedHeight()); else {
                ...
                if (pivoted) setBottom(getTop() - getEffectivePaddingTop() - getEffectivePaddingBottom() - ct.getFilledWidth()); else {
        ...
        if (height < getFixedHeight()) height = getFixedHeight(); else if (height < getMinimumHeight()) height = getMinimumHeight();
        return height;
    }
}
