...
public class Sort {
    ...
    public static void QuickSort(Vector v, int lo0, int hi0) throws ClassCastException {
        ...
        if (hi0 > lo0) {
            ...
            while (lo <= hi) {
                while ((lo < hi0) && (0 > ((Ordered) v.elementAt(lo)).compare(mid))) ++lo;
                while ((hi > lo0) && (0 < ((Ordered) v.elementAt(hi)).compare(mid))) --hi;
    ...
    public static void QuickSort(Ordered[] a, int lo0, int hi0) {
        ...
        if (hi0 > lo0) {
            mid = a[(lo0 + hi0) / 2];
            while (lo <= hi) {
                while ((lo < hi0) && (0 > a[lo].compare(mid))) ++lo;
                while ((hi > lo0) && (0 < a[hi].compare(mid))) --hi;
    ...
    public static void QuickSort(String[] a, int lo0, int hi0) {
        ...
        if (hi0 > lo0) {
            mid = a[(lo0 + hi0) / 2];
            while (lo <= hi) {
                while ((lo < hi0) && (0 > a[lo].compareTo(mid))) ++lo;
                while ((hi > lo0) && (0 < a[hi].compareTo(mid))) --hi;
                if (lo <= hi) swap(a, lo++, hi--);
            }
            if (lo0 < hi) QuickSort(a, lo0, hi);
            if (lo < hi0) QuickSort(a, lo, hi0);
    ...
    public static void QuickSort(Sortable sortable, int lo0, int hi0) {
        ...
        if (hi0 > lo0) {
            ...
            test = null;
            while (lo <= hi) {
                while ((lo < hi0) && (0 > (test = sortable.fetch(lo, test)).compare(mid))) ++lo;
                while ((hi > lo0) && (0 < (test = sortable.fetch(hi, test)).compare(mid))) --hi;
    ...
    public static Object[] QuickSort(Hashtable h) throws ClassCastException {
        ...
        if (are_strings) QuickSort((String[]) ret); else QuickSort((Ordered[]) ret);
        return (ret);
    }
    ...
    public static int bsearch(Sortable set, Ordered ref, int lo, int hi) {
        ...
        while ((-1 == ret) && (lo <= hi)) {
            ...
            if (0 == result) ret = mid; else if (0 > result) {
                hi = mid - 1;
