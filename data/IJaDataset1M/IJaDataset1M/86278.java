 ...
 * 
 * <p>
 * Hay que tener en cuenta que al crear un expediente se indica el idioma de tramitaci�n del mismo, por lo que los textos asociados deben ir en ese 
 * idioma.
 * </p>
 * 
 *
...
public class EventoExpedientePAD extends ElementoExpedientePAD {
    ...
    /**
	 * A�ade un documento de tipo DocumentoExpedientePAD a la lista de documentos del evento
	 * @param documento
	 */
