...
public class SwoogleWebServiceWrapperPanel extends JPanel implements ActionListener, ListSelectionListener {
    ...
    public SwoogleWebServiceWrapperPanel(NameSpaceTable nsTable, OWLOntologySelectionPanel owlPanel) {
        ...
        acquiredOntologyJListScroll.setBorder(BorderFactory.createTitledBorder(Translator.getTerm("ExtractedOntologyList")));
        ...
        removedOntologyJListScroll.setBorder(BorderFactory.createTitledBorder(Translator.getTerm("UnnecessaryOntologyList")));
        ...
        labelPanel = new LiteralPanel(Translator.getTerm("LanguageLabel"), Translator.getTerm("LabelList"), LiteralPanel.LABEL);
        descriptionPanel = new LiteralPanel(Translator.getTerm("LanguageLabel"), Translator.getTerm("DescriptionList"), LiteralPanel.DESCRIPTION);
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        if (e.getSource() == acquiredOntologyJList) {
            ...
            if (classResource != null) {
                ...
                Double termRank = SwoogleWebServiceWrapper.getSwoogleWebServiceData().getTermRank(classResource.getURI());
                if (termRank != null) {
            ...
            if (propertyResource != null) {
                ...
                Double termRank = SwoogleWebServiceWrapper.getSwoogleWebServiceData().getTermRank(propertyResource.getURI());
                if (termRank != null) {
                    termRankLabel.setText(Translator.getTerm("TermRankLabel") + ": " + termRank);
                }
            }
