...
public class EgovCntcMessageController {
    ...
    public String insertCntcMessage(@ModelAttribute("cntcMessage") CntcMessage cntcMessage, BindingResult bindingResult, Map commandMap, ModelMap model) throws Exception {
    ...
    public String insertCntcMessageItem(@ModelAttribute("cntcMessageItem") CntcMessageItem cntcMessageItem, BindingResult bindingResult, Map commandMap, ModelMap model) throws Exception {
        String sCmd = commandMap.get("cmd") == null ? "" : (String) commandMap.get("cmd");
        if (sCmd.equals("")) {
            CntcMessageVO searchCntcMessageVO;
            searchCntcMessageVO = new CntcMessageVO();
    ...
    public String selectCntcMessageDetail(@ModelAttribute("cntcMessage") CntcMessage cntcMessage, @ModelAttribute("cntcMessageItemVO") CntcMessageItemVO cntcMessageItemVO, ModelMap model) throws Exception {
    ...
    public String selectCntcMessageList(@ModelAttribute("searchVO") CntcMessageVO searchVO, ModelMap model) throws Exception {
    ...
    public String updateCntcMessage(@ModelAttribute("cntcMessage") CntcMessage cntcMessage, BindingResult bindingResult, Map commandMap, ModelMap model) throws Exception {
        String sCmd = commandMap.get("cmd") == null ? "" : (String) commandMap.get("cmd");
        if (sCmd.equals("")) {
            CntcMessageVO searchCntcMessageVO;
            searchCntcMessageVO = new CntcMessageVO();
    ...
    public String updateCntcMessageItem(@ModelAttribute("cntcMessageItem") CntcMessageItem cntcMessageItem, BindingResult bindingResult, Map commandMap, ModelMap model) throws Exception {
        String sCmd = commandMap.get("cmd") == null ? "" : (String) commandMap.get("cmd");
        if (sCmd.equals("")) {
            CntcMessageVO searchCntcMessageVO;
            searchCntcMessageVO = new CntcMessageVO();
