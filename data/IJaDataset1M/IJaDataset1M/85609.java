...
public class ContactType {
    ...
    */
    ...
    public boolean equals(final Object object) {
        ...
        return Utilities.equals(this.address, that.address) && Utilities.equals(this.contactInstructions, that.contactInstructions) && Utilities.equals(this.hoursOfService, that.hoursOfService) && Utilities.equals(this.onlineResource, that.onlineResource) && Utilities.equals(this.phone, that.phone);
    }
    ...
    public String toString() {
        ...
        if (phone != null) s.append("phone=").append(phone.toString()).append('\n');
        if (address != null) s.append("address=").append(address.toString()).append('\n');
        if (onlineResource != null) s.append("onlineResource=").append(onlineResource.toString()).append('\n');
