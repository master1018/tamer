...
public class ConfigurationElementHandle extends Handle implements IConfigurationElement {
    ...
    public Object createExecutableExtension(String propertyName) throws CoreException {
        try {
            ...
            Status status = new Status(IStatus.ERROR, Platform.PI_RUNTIME, ConfigurationElement.PLUGIN_ERROR, "Invalid registry object", e);
    ...
    public IConfigurationElement[] getChildren(String name) {
        ...
        if (children.length == 0) return ConfigurationElementHandle.EMPTY_ARRAY;
        ...
        if (idx == 0) return ConfigurationElementHandle.EMPTY_ARRAY;
        return result;
    }
    ...
    public String getNamespace() {
        ...
        if (result == null) return getDeclaringExtension().getNamespace();
        return result;
    }
