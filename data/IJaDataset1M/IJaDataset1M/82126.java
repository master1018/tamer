...
public class JCAMapper {
    ...
    public MappedRecord mapFunctionMapValuesToMappedRecord(String bapiName, final RecordFactory recordFactory, final Map<String, Object> functionMap) throws ResourceException {
        ...
        for (final Entry<String, Object> entry : resultRecordMap.entrySet()) {
            ...
            if (recordValue instanceof MappedRecord) {
                ...
                for (Object object : indexedResultRecord) {
                    ...
                    @SuppressWarnings("unchecked") Set<String> keys = mr.keySet();
                    for (String key : keys) {
