...
public class HtmlTextInputTest extends WebTestCase {
    ...
    void type_StringIndexOutOfBoundsException(final String tag) throws Exception {
        final String html = "<html><head></head><body>\n" + tag + "\n" + "<script>\n" + "function copy(node) {\n" + "  e.value = '231';" + "}" + "var e = document.getElementById('t');\n" + "e.onkeyup = copy;\n" + "var c = e.cloneNode();\n" + "c.id = 't2';\n" + "document.body.appendChild(c);\n" + "</script>\n" + "</body></html>";
        final HtmlPage page = loadPage(getBrowserVersion(), html, null);
     ...
     */
    @Test
    @Alerts(IE = { "undefined,undefined", "undefined,undefined", "3,undefined", "3,10" }, FF = { "7,7", "11,11", "3,11", "3,10" })
     ...
     */
    @Test
    @Alerts(IE = { "undefined,undefined", "undefined,undefined", "-3,undefined", "-3,15" }, FF = { "7,7", "11,11", "0,11", "0,11" })
     ...
     */
    @Test
    @Alerts(IE = { "undefined,undefined", "undefined,undefined", "10,undefined", "10,5" }, FF = { "7,7", "11,11", "10,11", "5,5" })
    ...
    public void type_specialCharacters() throws Exception {
        final String html = "<html><head></head><body>" + "<form>" + "<input id='t' onkeyup='document.forms[0].lastKey.value = event.keyCode'>" + "<input id='lastKey'>" + "</form>" + "</body></html>";
        final HtmlPage page = loadPage(getBrowserVersion(), html, null);
        final HtmlTextInput t = page.getHtmlElementById("t");
