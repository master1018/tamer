...
public class ChangeLegModeWithParkLocationTest extends MatsimTestCase {
    ...
    private static class LegChainModesListener1 implements IterationEndsListener {
        ...
        public void notifyIterationEnds(final IterationEndsEvent event) {
            ...
            Plan plan = ctl.getPopulation().getPersons().values().iterator().next().getSelectedPlan();
            ...
            assertEquals("different legChainModes?", criterion, legChainModes.toString());
        }
    }

    private static class LegChainModesListener2 implements IterationEndsListener {
    ...
    private static class LegChainModesListener3 implements IterationEndsListener {
    ...
    private static class ChangeLegModeWithParkLocationControler extends Controler {
        ...
        protected StrategyManager loadStrategyManager() {
            ...
            strategy2.addStrategyModule(new ChangeLegModeWithParkLocation(config, network));
