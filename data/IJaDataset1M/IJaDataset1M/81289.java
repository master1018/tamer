...
public class UsernameRule implements Rule {
   ...
   */
    protected Map<String, ?> createRuleResultDetailParameters(final String username) {
   ...
   */
    ...
    public String toString() {
        return String.format("%s@%h::ignoreCase=%s,matchBackwards=%s", getClass().getName(), hashCode(), ignoreCase, matchBackwards);
    }
}
