...
public final class Client extends java.applet.Applet {
    ...
    */
    public void update(Graphics g) {
        ...
        if (ibuffer == null || ibuffer.getWidth(null) != tempW || ibuffer.getHeight(null) != tempH) {
    ...
    */
    public static Frame frame(Component component, String title) {
        if (component instanceof JComponent) {
            ...
            if (component instanceof WindowListener) frame.addWindowListener((WindowListener) component);
    ...
    */
    public static void main(String args[]) throws Exception {
        ...
        if (args.length > 0) {
            ...
            proxy = Remote.invoke(proxy, "getProxy", null);
            if (proxy instanceof MarshalledObject) proxy = ((MarshalledObject) proxy).get();
            if (!(proxy instanceof RemoteInvoke)) proxy = Remote.invoke(proxy, "init", new Remote(proxy));
            if (proxy instanceof Component) {
