...
public class DuckType implements InvocationHandler {
    ...
    public static Object implement(Class interfaceToImplement, Object object) {
        if (!instanceOf(interfaceToImplement, object)) throw new IllegalArgumentException("object: " + object + " does not have all the methods of: " + interfaceToImplement);
        return Proxy.newProxyInstance(interfaceToImplement.getClassLoader(), new Class[] { interfaceToImplement }, new DuckType(object));
    }
