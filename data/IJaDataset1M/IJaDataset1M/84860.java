...
public abstract class CommonBTHeaderNode extends CommonBTNode<CommonBTRecord> {
    ...
    private void validate() throws IllegalArgumentException {
        if (ic.records.size() != 3) throw new IllegalArgumentException("Illegal length of record array: " + ic.records.size() + " (expected 3)");
    ...
    public CommonBTHeaderRecord getHeaderRecord() {
        ...
        } else throw new RuntimeException("Unexpected type at records[0]: " + btr.getClass());
    }
    ...
    public CommonBTGenericDataRecord getUserDataRecord() {
        ...
        } else throw new RuntimeException("Unexpected type at records[1]: " + btr.getClass());
    }
    ...
    public CommonBTGenericDataRecord getBTreeMapRecord() {
        ...
        if (btr instanceof CommonBTGenericDataRecord) {
            return (CommonBTGenericDataRecord) btr;
        } else throw new RuntimeException("Unexpected type at records[2]: " + btr.getClass());
    }
