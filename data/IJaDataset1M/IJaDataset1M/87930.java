...
public final class Font {
    ...
    public void setAscent(final int dist) {
        if ((dist < Coder.SHORT_MIN) || (dist > Coder.SHORT_MAX)) {
            throw new IllegalArgumentRangeException(Coder.SHORT_MIN, Coder.SHORT_MAX, dist);
        }
        ascent = dist;
    }
     ...
     */
    public DefineFont2 defineFont(final int identifier, final List<Character> characters) {
