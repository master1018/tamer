...
public class AppearanceDisplayer extends StatefullWidget<DefaultAppearance> {
    ...
    public void paintContent(Graphics g, IOpenGL gl) {
        ...
        try {
            if (this.texture != null && texture.getTextureTypeKey().getImage() != ImageType.VOID && texture.getTexture() != null && texture.getTexture().getID() > 0) {
                if (flip) drawScaledTintedImage(g, gl, texture.getTexture(), appearance.getHighlightTexture().getTint(), 0, this.getHeight(), this.getWidth(), -this.getHeight()); else drawScaledTintedImage(g, gl, texture.getTexture(), appearance.getHighlightTexture().getTint(), 0, 0, this.getWidth(), this.getHeight());
            }
    ...
    public void setTexture(FengGUITexture texture) {
        if (this.texture != texture && this.texture != null) this.texture.setListener(null);
