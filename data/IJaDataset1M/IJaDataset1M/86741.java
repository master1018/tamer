...
public class WiretapServiceImplTest {
    ...
    public void testGetWiretapEvent() {
        ...
        mockery.checking(new Expectations() {
            ...
            {
                one(wiretapDao).findById(requestedWiretapEventId);
                will(returnValue(wiretapEvent));
                one(wiretapEvent).getModuleName();
    ...
    private void setWiretapEventExpectations(Payload[] payloads) {
        ...
        mockery.checking(new Expectations() {
            ...
            {
                allowing(event).getId();
                will(returnValue("eventId"));
                one(event).getPayloads();
                will(returnValue(payloadList));
            }
        });
    }
