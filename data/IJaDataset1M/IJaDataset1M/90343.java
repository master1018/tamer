 ...
 * 
 * @author jwhaley
 * @version $Id: ClassName.java 1931 2004-09-22 22:17:47Z joewhaley $
 */
        ...
        for (int i = 0; i < args.length; ++i) {
            try {
                ...
                if (cp.getTag(selfindex) != CONSTANT_ResolvedClass) {
                    System.err.println("constant pool entry " + (int) selfindex + ", referred to by field this_class" + ", is wrong type tag (expected=" + CONSTANT_Class + ", actual=" + cp.getTag(selfindex) + ")");
                }
