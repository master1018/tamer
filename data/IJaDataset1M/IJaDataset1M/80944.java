...
final class SymbolTable {
    ...
    public void excludeURI(String uri) {
        ...
        if (refcnt == null) refcnt = new Integer(1); else refcnt = new Integer(refcnt.intValue() + 1);
    ...
    public void excludeNamespaces(String prefixes) {
        if (prefixes != null) {
            ...
            while (tokens.hasMoreTokens()) {
                ...
                final String uri;
                if (prefix.equals("#default")) uri = lookupNamespace(Constants.EMPTYSTRING); else uri = lookupNamespace(prefix);
