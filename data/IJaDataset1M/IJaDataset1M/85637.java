...
public class NameInfoPatternMatcher extends TestCase {
    ...
    private void check(List<ClassType> cts, String... exp) {
        ...
        for (int i = 0; i < exp.length; i++) assertEquals(exp[i], cts.get(i).getFullName());
    }
    ...
    private String makeSigString(List<Type> signature, boolean fullName) {
        ...
        for (Type t : signature) {
            ...
            if (fullName) result.append(t.getFullName()); else result.append(t.getName());
        }
    ...
    public void testGetMethods() {
        ...
        check2(ms, "java.lang.Object.equals(Object)", "java.util.List.equals(Object)", "java.util.Collection.equals(Object)");
    }
}
