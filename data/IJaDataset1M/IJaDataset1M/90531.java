...
public class MyTransductions {
    ...
    public static void makeCompositeTransition(TransducerNivat t, List<Object> composite, Object firstInLabel, State from, State to) throws Exception {
        if (composite.size() == 0) {
    ...
    public static void addPrefixedRemainingTransitions(TransducerNivat t, MyAlphabet alphabet, List<Object> prefix, State from, State to) throws Exception {
    ...
    public static void addRemainingTransitions(TransducerNivat t, MyAlphabet alphabet, State from, State to) throws Exception {
        Set fromTrans = t.delta(from);
        Set<Object> existingInLabels = new HashSet<Object>();
        for (Iterator iter = fromTrans.iterator(); iter.hasNext(); ) {
            Transition trans = (Transition) iter.next();
