   ...
   */
    ...
    private class ModulesLabelProvider extends LabelProvider {
        ...
        public String getText(Object element) {
            ...
            return Signature.getSimpleName(qualifiedModuleName) + " - " + Signature.getQualifier(qualifiedModuleName);
        }
    }
    ...
    private void createListField() {
        ...
        modulesField = new ListDialogField(new ModulesSelectionAdapter(), buttons, new ModulesLabelProvider());
