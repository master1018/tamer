...
public class AtomicIntegerArrayTest extends JSR166TestCase {
    ...
    public void testConstructor() {
        ...
        for (int i = 0; i < SIZE; ++i) assertEquals(0, ai.get(i));
    }
    ...
    public void testConstructor2() {
        ...
        for (int i = 0; i < a.length; ++i) assertEquals(a[i], ai.get(i));
    }
            ...
            for (; ; ) {
                ...
                for (int i = 0; i < ai.length(); ++i) {
                    ...
                    if (v != 0) {
                        ...
                        if (ai.compareAndSet(i, v, v - 1)) ++counts;
                    }
                }
                if (done) break;
            }
    ...
    public void testCountingInMultipleThreads() {
        try {
            ...
            for (int i = 0; i < SIZE; ++i) ai.set(i, COUNTDOWN);
    ...
    public void testSerialization() {
        ...
        for (int i = 0; i < SIZE; ++i) l.set(i, -i);
        try {
