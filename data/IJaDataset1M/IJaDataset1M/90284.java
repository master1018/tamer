package it.unibo.deis.interaction.rtp.jmapps.jmstudio;

import it.unibo.deis.interaction.rtp.jmapps.ui.JMDialog;
import it.unibo.deis.interaction.rtp.jmapps.ui.JMPanel;
import it.unibo.deis.interaction.rtp.jmapps.ui.MessageDialog;
import it.unibo.deis.interaction.rtp.jmapps.util.JMAppsCfg;
import it.unibo.deis.interaction.rtp.jmapps.util.JMAppsCfg.RtpData;
import java.awt.*;
...
public class OpenRtpDialog extends JMDialog implements TextListener, FocusListener {
    ...
    private JMPanel createPanelSource() {
        ...
        if (dataRtp != null) fieldAddress0.setText(dataRtp.strAddress0);
        ...
        if (dataRtp != null) fieldAddress1.setText(dataRtp.strAddress1);
        ...
        if (dataRtp != null) fieldAddress2.setText(dataRtp.strAddress2);
        ...
        if (dataRtp != null) fieldAddress3.setText(dataRtp.strAddress3);
        ...
        if (dataRtp != null) fieldPort.setText(dataRtp.strPort);
        ...
        if (dataRtp != null) choiceTtl.select(dataRtp.strTtl);
        return (panelSource);
    }
    ...
    public void textValueChanged(TextEvent event) {
        ...
        if (objectSource instanceof TextField) {
            ...
            if (strValue.length() > 2) textField.transferFocus();
        }
    }
    ...
    public boolean validateData() {
        ...
        if (cfgJMApps != null) cfgJMApps.setLastOpenRtpData(dataRtp);
        return (true);
    }

    public void focusGained(FocusEvent fe) {
        Object source = fe.getSource();
        if (source instanceof TextField) ((TextField) source).selectAll();
    }

    public void focusLost(FocusEvent fe) {
        Object source = fe.getSource();
        if (source instanceof TextField) ((TextField) source).select(1, 0);
    }
}
