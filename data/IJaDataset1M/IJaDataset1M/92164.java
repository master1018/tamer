...
public final class OPT_GlobalValueNumberState {
   ...
   */
    public void mergeClasses(OPT_ValueGraphVertex v1, OPT_ValueGraphVertex v2) {
        ...
        while (true) {
            ...
            if (DEBUG) System.out.println("@@@@ moving vertex " + v + " from class " + val2 + " to class " + val1);
            class1.addVertex(v);
    ...
    */
    public boolean DS(Object name1, Object name2) {
        ...
        if (v1.getValueNumber() == v2.getValueNumber()) return true; else return false;
    }
   ...
   */
    private OPT_GVCongruenceClass findOrCreateCongruenceClass(Object label, HashMap labelMap) {
    ...
    private void partitionClass(OPT_GVCongruenceClass partition) {
        ...
        for (; i.hasNext(); ) {
            ...
            if (!checkCongruence(first, v)) {
                ...
                if (index > -1) {
                    OPT_GVCongruenceClass match = (OPT_GVCongruenceClass) B.elementAt(index);
                    match.addVertex(v);
