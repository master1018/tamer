...
public class SCXmlDocument extends SCDocument {
    ...
    private static final int magic = 0x586D6C00;
   ...
   */
    ...
    public SCXmlDocument(IRDTD d) {
        super(magic);
        if (d == null) d = NullDTD.prototype; else dtd = d;
    }
   ...
   */
    public void importDocument(Reader r) throws SCDocumentParseException {
        ...
        if (irNodes.length != 1) throw new SCDocumentParseException("parse error in the document");
        setRoot(irNodes[0]);
    }
   ...
   */
    public void exportNode(Writer w, IRNode n, Version v) throws IOException {
        if (n == null) throw new SCDocumentException("given node is null.");
        Version.saveVersion();
    ...
    public static boolean isRawTextNode(IRNode n) {
        ...
        if (name.equals("RawTextOperator")) return true; else return false;
    }
    ...
    public static IRNode ithChild(IRNode n, int i) {
        if ((i < 0) || (i >= numChildren(n))) throw new SCDocumentException("Index is out of bound !");
    ...
    public static int childNum(IRNode n) {
        ...
        if (parent == null) return -1; else return childNumOf(parent, n);
    }

    public static int childNumOf(IRNode p, IRNode n) {
        if ((p == null) || (n == null)) throw new SCDocumentException("Provided node is null !");
        Enumeration children = tree.children(p);
        int i = -1;
        for (int j = 0; i < 0 && children.hasMoreElements(); j++) {
            if (n.identity().equals(((IRNode) children.nextElement()).identity())) i = j;
        }
        if (i < 0) throw new SCDocumentException("Both of nodes are not in parent relationship");
        return i;
    }
   ...
   */
    public static int firstChildIndex(IRNode n, String name) {
        if (name != null) {
            ...
            for (int i = 0; i < num; i++) if (elementName(ithChild(n, i)).equalsIgnoreCase(name)) return i;
        }
        return -1;
    }
   ...
   */
    ...
    public static boolean isDeletable(IRNode n) {
        if (isRawTextNode(n)) return false; else if (parent(n) == null) return false; else return true;
    }
    ...
    public static boolean isHyperlinkable(IRNode n) {
        if (isRawTextNode(n) == false) return true; else return false;
    }
    ...
    public static String getAttributeValue(IRNode n, String attrName) {
        ...
        if (thisAttr != null) {
            if (n.valueExists(thisAttr)) return thisAttr.type().toString(n.getSlotValue(thisAttr)); else return null;
        } else {
            return null;
        }
    }
    ...
    public static void setTarget(IRNode n, String t) {
        if (t != null) setAttributeValue(n, "target", t); else setAttributeValue(n, "target", "");
    }
    ...
    public static void setAnchor(IRNode n, String t) {
        if (t != null) setAttributeValue(n, "anchor", t); else setAttributeValue(n, "anchor", "");
    }
    ...
    public static void setText(IRNode n, String t) {
        if (t != null) setAttributeValue(n, NullDTD.prototype.getRawTextOperatorAttrName(), t); else setAttributeValue(n, NullDTD.prototype.getRawTextOperatorAttrName(), "");
    }
    ...
    private static class AttributeEnumeration implements Enumeration {
        ...
        public boolean hasMoreElements() {
            if (nextAttribute != null) return true;
            SlotInfo nextAttr;
            String attrVal;
            while (itr.hasNext()) {
        ...
        public Object nextElement() {
            if (!hasMoreElements()) throw new SCDocumentException("No more attributes");
    ...
    public void insertChild(IRNode n, IRNode c, int pos) {
        if (getDocument(c) != this) throw new SCDocumentException("The given node is not in the same document");
        if (parent(c) != null) throw new SCDocumentException("The given node has a parent");
        if (pos < 0 || pos > numChildren(n)) throw new SCDocumentException("Index is out of bound");
        if (pos == 0) {
    ...
    public IRNode replaceChild(IRNode n, IRNode old, IRNode[] newNodes) {
        if (parent(old) != n) throw new SCDocumentException("The given node has different parent");
        if (newNodes == null || newNodes.length <= 0) throw new SCDocumentException("new nodes are null");
        for (int i = 0; i < newNodes.length; i++) {
            if (newNodes[i] == null) throw new SCDocumentException("node at " + i + "'th index is invalid");
        }
