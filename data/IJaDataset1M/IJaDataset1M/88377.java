...
public class OpenFlowMapGraphAction extends AbstractAction {
    ...
    private static final ImageIcon ICON = new ImageIcon(OpenFlowMapGraphAction.class.getResource("images/Open16-2.gif"));
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            if (confirm == JFileChooser.APPROVE_OPTION) {
                ...
                JComponent propertiesPanel = target.createPropertiesPanel(fc.getSelectedFile().getAbsolutePath());
                if (propertiesPanel != null) {
                    if (PropertiesDialog.showFor(app, StringUtils.firstUpper(target.getName()) + " properties", propertiesPanel)) {
                    }
                }
            }
        } catch (Exception ex) {
