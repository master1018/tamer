...
public class JmriMultiStatePropertyListener extends JmriSimplePropertyListener {
    ...
    JmriMultiStatePropertyListener(String propName, int type, String name, int varType, Conditional client, int state) {
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        log.debug("\"" + _varName + "\" sent PropertyChangeEvent " + evt.getPropertyName() + ", old value =\"" + evt.getOldValue() + "\", new value =\"" + evt.getNewValue() + ", enabled = " + _enabled);
    ...
    static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(JmriMultiStatePropertyListener.class.getName());
}
