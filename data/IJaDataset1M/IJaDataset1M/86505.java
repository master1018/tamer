...
public class AsyncResult implements java.io.Serializable {
    ...
    public AsyncResult(boolean done, java.lang.String id, java.lang.String message, int secondsToWait, com.sforce.soap._2006._04.metadata.AsyncRequestState state, com.sforce.soap._2006._04.metadata.StatusCode statusCode) {
        this.done = done;
        this.id = id;
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = true && this.done == other.isDone() && ((this.id == null && other.getId() == null) || (this.id != null && this.id.equals(other.getId()))) && ((this.message == null && other.getMessage() == null) || (this.message != null && this.message.equals(other.getMessage()))) && this.secondsToWait == other.getSecondsToWait() && ((this.state == null && other.getState() == null) || (this.state != null && this.state.equals(other.getState()))) && ((this.statusCode == null && other.getStatusCode() == null) || (this.statusCode != null && this.statusCode.equals(other.getStatusCode())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(AsyncResult.class, true);
