 ...
 */
public final class MxlTenuto implements MxlArticulationsContent {
    ...
    public static MxlTenuto read(Element e) {
        ...
        if (emptyPlacement != MxlEmptyPlacement.empty) return new MxlTenuto(emptyPlacement); else return defaultInstance;
    }
