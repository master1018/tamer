...
public class SubmissionErrorResource<U extends User> extends AbstractFreemarkerResource<U> {

    public SubmissionErrorResource() throws InitializationException {
        super();
        setContentTemplateName("submissionError.html.ftl");
    }

    @Override
    protected void fillDatamodel(Map<String, Object> datamodel) throws NoDataFoundException {
        datamodel.put("errors", getContext().getAttributes().get("errors"));
    }
