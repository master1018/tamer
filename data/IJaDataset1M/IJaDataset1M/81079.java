...
public class CampaignForm extends ValidatorForm {
    ...
    private long htmlPage;

    private String selectedHtmlPage;

    private long communicationInode;

    private boolean sendEmail;

    private String sendTo = "mailingList";

    private long userFilterInode;
	 ...
	 */
    public long getUserFilterInode() {
	 ...
	 */
    public void setUserFilterInode(long userFilterInode) {
	 ...
	 */
    public void setParentCampaign(long parentCampaign) {
