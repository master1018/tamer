...
public class AddColumnCommand extends AbstractRefactoringCommand {
    ...
    protected String[] generateSQLStatements() throws Exception {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(customDialog, s_stringMgr.getString("AbstractRefactoringCommand.unsupportedTypeMsg", _dialect.getDisplayName(), dataType), AbstractRefactoringCommand.i18n.UNSUPPORTED_TYPE_TITLE, JOptionPane.ERROR_MESSAGE);
        } catch (UnsupportedOperationException e2) {
            _session.showMessage(s_stringMgr.getString("AddColumnCommand.unsupportedOperationMsg", _dialect.getDisplayName()));
        }
        return result;
    }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                if (!isColumnNameUnique(columnName)) {
                    String message = s_stringMgr.getString("AddColumnCommand.columnAlreadyExistsMsg", customDialog.getTableName(), columnName);
                    JOptionPane.showMessageDialog(customDialog, message, i18n.COLUMN_ALREADY_EXISTS_TITLE, JOptionPane.ERROR_MESSAGE);
                } else {
