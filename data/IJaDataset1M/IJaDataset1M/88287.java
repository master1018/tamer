...
public class XTMPathTopicMapSource extends AbstractOntopolyTopicMapSource {
   ...
   */
    ...
    public TopicMapReferenceIF createReference(URL url, String id, String title, LocatorIF base_address) {
        XTMTopicMapReference ref = new XTMTopicMapReference(url, id, title, base_address);
        ref.setSource(this);
        ...
        if (ref_handler != null) ref.setExternalReferenceHandler(ref_handler); else ref.setFollowTopicRefs(followTopicRefs);
        return ref;
    }
