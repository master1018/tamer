...
public class PhpUtil {
    ...
    public static String ltrim(String str, String charList) {
        ...
        if (null == charList) for (int i = 0; i < len; i++) if (Character.isWhitespace(str.charAt(i))) start++; else break; else for (int i = 0; i < len; i++) if (charList.indexOf(str.charAt(i)) >= 0) start++; else break;
    ...
    public static String rtrim(String str, String charList) {
        ...
        if (null == charList) for (int i = end; i >= 0; i--) if (Character.isWhitespace(str.charAt(i))) end--; else break; else for (int i = end; i >= 0; i--) if (charList.indexOf(str.charAt(i)) >= 0) end--; else break;
