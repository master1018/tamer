...
public final class TableLayoutEditPolicy extends AbstractGridLayoutEditPolicy {
        ...
        if (m_target.m_valid) {
            ...
            return new EditCommand(m_layout) {
                ...
                protected void executeEdit() throws Exception {
                    m_layout.command_CREATE(component, m_target.m_column, m_target.m_columnInsert, m_target.m_row, m_target.m_rowInsert);
                }
            };
        }
        return null;
    ...
    protected Command getPasteCommand(PasteRequest request) {
        ...
        if (m_target.m_valid && mementos.size() == 1) {
            return LayoutPolicyUtils.getPasteCommand(m_layout, request, WidgetInfo.class, new IPasteProcessor<WidgetInfo>() {
        ...
        if (m_target.m_valid && request.getEditParts().size() == 1) {
            ...
            if (moveEditPart.getModel() instanceof WidgetInfo) {
                ...
                return new EditCommand(m_layout) {
                    ...
                    @Override
                    protected void executeEdit() throws Exception {
                        m_layout.command_MOVE(component, m_target.m_column, m_target.m_columnInsert, m_target.m_row, m_target.m_rowInsert);
                    }
                };
            }
        }
        ...
        if (m_target.m_valid && request.getEditParts().size() == 1) {
            ...
            if (moveEditPart.getModel() instanceof WidgetInfo) {
                ...
                return new EditCommand(m_layout) {
                    ...
                    @Override
                    protected void executeEdit() throws Exception {
                        m_layout.command_ADD(component, m_target.m_column, m_target.m_columnInsert, m_target.m_row, m_target.m_rowInsert);
                    }
                };
            }
        }
    ...
    protected void updateGridTarget(Point mouseLocation) throws Exception {
        ...
        for (int columnIndex = 0; columnIndex < columnIntervals.length; columnIndex++) {
            ...
            if (location.x < columnIntervals[0].begin) {
                ...
                int[] parameters = getInsertFeedbackParameters(new Interval(0, 0), interval, INSERT_COLUMN_SIZE);
        ...
        for (int rowIndex = 0; rowIndex < rowIntervals.length; rowIndex++) {
            ...
            if (location.y < rowIntervals[0].begin) {
                ...
                int[] parameters = getInsertFeedbackParameters(new Interval(0, 0), interval, INSERT_ROW_SIZE);
