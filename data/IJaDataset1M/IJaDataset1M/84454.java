...
public class LightTableAction extends AbstractTableAction {
    ...
    protected void createModel() {
        m = new BeanTableDataModel() {
            ...
            public String getColumnName(int col) {
                ...
                if (col == ENABLECOL) return enabledString; else return super.getColumnName(col);
            }

            public Class<?> getColumnClass(int col) {
                if (col == EDITCOL) return JButton.class;
                if (col == INTENSITYCOL) return Double.class;
                if (col == ENABLECOL) return Boolean.class; else return super.getColumnClass(col);
            }
            ...
            public int getPreferredWidth(int col) {
                ...
                if (col == ENABLECOL) return new JTextField(6).getPreferredSize().width; else return super.getPreferredWidth(col);
            }
            ...
            public boolean isCellEditable(int row, int col) {
                ...
                if (col == ENABLECOL) return true; else return super.isCellEditable(row, col);
            }
            ...
            public String getValue(String name) {
                ...
                switch(val) {
                    case Light.ON:
                        return rbean.getString("LightStateOn");
                    case Light.INTERMEDIATE:
                        return rbean.getString("LightStateIntermediate");
                    case Light.OFF:
                        return rbean.getString("LightStateOff");
                    case Light.TRANSITIONINGTOFULLON:
                        return rbean.getString("LightStateTransitioningToFullOn");
                    case Light.TRANSITIONINGHIGHER:
                        return rbean.getString("LightStateTransitioningHigher");
                    case Light.TRANSITIONINGLOWER:
                        return rbean.getString("LightStateTransitioningLower");
                    case Light.TRANSITIONINGTOFULLOFF:
                        return rbean.getString("LightStateTransitioningToFullOff");
                    default:
    ...
    protected void addPressed(ActionEvent e) {
        ...
        if (addFrame == null) {
            ...
            Border varPanelTitled = BorderFactory.createTitledBorder(varPanelBorder, rb.getString("LightVariableBorder"));
            ...
            Border panel3Titled = BorderFactory.createTitledBorder(panel3Border, rb.getString("LightControlBorder"));
    ...
    private void initializePrefixCombo() {
        ...
        if (jmri.InstanceManager.lightManagerInstance() instanceof jmri.managers.AbstractProxyManager) {
            ...
            if (p.getComboBoxLastSelection(systemSelectionCombo) != null) prefixBox.setSelectedItem(p.getComboBoxLastSelection(systemSelectionCombo));
        } else {
    ...
    void createPressed(ActionEvent e) {
        ...
        if (altName != "") {
            ...
            if (g != null) {
                status1.setText(rb.getString("LightError10") + " '" + altName + "' " + rb.getString("LightError11"));
                status2.setVisible(false);
                addFrame.pack();
                addFrame.setVisible(true);
                return;
        ...
        if (testT != null) {
            ...
            if (!noWarn) {
                int selectedValue = JOptionPane.showOptionDialog(addFrame, rb.getString("LightWarn5") + " " + sName + " " + rb.getString("LightWarn6") + " " + testSN + ".\n   " + rb.getString("LightWarn7"), rb.getString("WarningTitle"), JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, new Object[] { rb.getString("ButtonYes"), rb.getString("ButtonNo"), rb.getString("ButtonYesPlus") }, rb.getString("ButtonNo"));
        ...
        if ((InstanceManager.lightManagerInstance().allowMultipleAdditions(sName)) && addRangeBox.isSelected() && (fieldNumToAdd.getText().length() > 0)) {
            try {
    ...
    void handleCreateException(String sysName) {
        javax.swing.JOptionPane.showMessageDialog(addFrame, java.text.MessageFormat.format(rb.getString("ErrorLightAddFailed"), new Object[] { sysName }), rb.getString("ErrorTitle"), javax.swing.JOptionPane.ERROR_MESSAGE);
    }
    ...
    void cancelPressed(ActionEvent e) {
        ...
        if (lightCreatedOrUpdated && reminderActive) {
            int selectedValue = JOptionPane.showOptionDialog(addFrame, rb.getString("Reminder"), rb.getString("ReminderTitle"), JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE, null, new Object[] { rb.getString("ButtonOK"), rb.getString("ButtonOKPlus") }, rb.getString("ButtonOK"));
    ...
    private JTextField field1a = new JTextField(10);

    private JTextField field1a2 = new JTextField(10);

    private JTextField field1b = new JTextField(8);

    private JTextField field1c = new JTextField(10);

    private JTextField field1d = new JTextField(10);

    private JLabel f1Label = new JLabel(rb.getString("LightSensor"));

    private JTextField field2a = new JTextField(8);

    private JTextField field2b = new JTextField(8);
    ...
    private void addEditControlWindow() {
        if (addControlFrame == null) {
            ...
            panel33.add(f2Label);
            panel33.add(stateBox = new JComboBox(new String[] { rbean.getString("SensorStateActive"), rbean.getString("SensorStateInactive") }));
    ...
    protected void cancelControlPressed(ActionEvent e) {
        ...
        if (inEditMode) status1.setText(rb.getString("LightUpdateInst")); else status1.setText(rb.getString("LightCreateInst"));
        status2.setText("");
        status2.setVisible(false);
        addFrame.pack();
        addFrame.setVisible(true);
    ...
    private boolean setControlInformation(LightControl g) {
        if (sensorControl.equals(typeBox.getSelectedItem())) {
            ...
            if (sensorName.length() < 1) {
                ...
                s = InstanceManager.sensorManagerInstance().getByUserName(sensorName);
                if (s == null) {
                    s = InstanceManager.sensorManagerInstance().getBySystemName(sensorName);
                    if (s != null) {
            ...
            if (stateBox.getSelectedItem().equals(rbean.getString("SensorStateInactive"))) {
            ...
            if (turnoutName.length() < 1) {
                ...
                if (turnoutName.charAt(1) == 'T') {
                    String testSN = turnoutName.substring(0, 1) + "L" + turnoutName.substring(2, turnoutName.length());
                ...
                if (!error) {
                    t = InstanceManager.turnoutManagerInstance().getByUserName(turnoutName);
                    if (t == null) {
                        t = InstanceManager.turnoutManagerInstance().getBySystemName(turnoutName.toUpperCase());
                        if (t != null) {
            ...
            if (stateBox.getSelectedItem().equals(InstanceManager.turnoutManagerInstance().getThrownText())) {
            ...
            if (triggerSensorName.length() < 1) {
                ...
                if (s == null) {
                    s = InstanceManager.sensorManagerInstance().getBySystemName(triggerSensorName);
                    if (s != null) {
            ...
            if ((sensorName.length() < 1) || (sensor2Name.length() < 1)) {
                ...
                s2 = InstanceManager.sensorManagerInstance().getByUserName(sensor2Name);
                if (s2 == null) {
                    s2 = InstanceManager.sensorManagerInstance().getBySystemName(sensor2Name);
                    if (s2 != null) {
    ...
    public String getDescriptionText(LightControl lc, int type) {
        switch(type) {
            case Light.SENSOR_CONTROL:
                return java.text.MessageFormat.format(rb.getString("LightSensorControlDes"), new Object[] { lc.getControlSensorName(), getControlSensorSenseText(lc) });
            case Light.FAST_CLOCK_CONTROL:
                return java.text.MessageFormat.format(rb.getString("LightFastClockDes"), new Object[] { formatTime(lc.getFastClockOnHour(), lc.getFastClockOnMin()), formatTime(lc.getFastClockOffHour(), lc.getFastClockOffMin()) });
            case Light.TURNOUT_STATUS_CONTROL:
                return java.text.MessageFormat.format(rb.getString("LightTurnoutControlDes"), new Object[] { lc.getControlTurnoutName(), getControlTurnoutStateText(lc) });
            case Light.TIMED_ON_CONTROL:
                return java.text.MessageFormat.format(rb.getString("LightTimedOnControlDes"), new Object[] { "" + lc.getTimedOnDuration(), lc.getControlTimedOnSensorName(), getControlSensorSenseText(lc) });
            case Light.TWO_SENSOR_CONTROL:
                return java.text.MessageFormat.format(rb.getString("LightTwoSensorControlDes"), new Object[] { lc.getControlSensorName(), lc.getControlSensor2Name(), getControlSensorSenseText(lc) });
            default:
                return "";
        }
    }
	 ...
	 */
    public class LightControlTableModel extends javax.swing.table.AbstractTableModel implements java.beans.PropertyChangeListener {
        ...
        public String getColumnName(int col) {
            if (col == TYPE_COLUMN) return rb.getString("LightControlType"); else if (col == DESCRIPTION_COLUMN) return rb.getString("LightControlDescription");
            return "";
        }
    ...
    public String getClassDescription() {
        return rb.getString("TitleLightTable");
    }
