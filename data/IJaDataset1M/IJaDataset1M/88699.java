...
public class StatementCreator {
    ...
    private void buildTypeMap(Connection con) throws SQLException {
        ...
        registerSyntaxInfo(Ontology.ATTRIBUTE_VALUE, dataTypeToMDMap, Types.DOUBLE, Types.REAL, Types.FLOAT);
        registerSyntaxInfo(Ontology.BINOMINAL, dataTypeToMDMap, Types.VARCHAR);
    }
