package net.sf.istcontract.wsimport.tools.wsdl.document.schema;
...
public interface SchemaConstants {
    ...
    public static QName QNAME_ATTRIBUTE_GROUP = new QName(NS_XSD, "attributeGroup");

    public static QName QNAME_CHOICE = new QName(NS_XSD, "choice");

    public static QName QNAME_COMPLEX_CONTENT = new QName(NS_XSD, "complexContent");
    ...
    public static QName QNAME_FRACTION_DIGITS = new QName(NS_XSD, "fractionDigits");
    ...
    public static QName QNAME_SIMPLE_CONTENT = new QName(NS_XSD, "simpleContent");
    ...
    public static QName QNAME_TYPE_NORMALIZED_STRING = new QName(NS_XSD, "normalizedString");

    public static QName QNAME_TYPE_TOKEN = new QName(NS_XSD, "token");

    public static QName QNAME_TYPE_BYTE = new QName(NS_XSD, "byte");

    public static QName QNAME_TYPE_UNSIGNED_BYTE = new QName(NS_XSD, "unsignedByte");

    public static QName QNAME_TYPE_BASE64_BINARY = new QName(NS_XSD, "base64Binary");
    ...
    public static QName QNAME_TYPE_POSITIVE_INTEGER = new QName(NS_XSD, "positiveInteger");

    public static QName QNAME_TYPE_NEGATIVE_INTEGER = new QName(NS_XSD, "negativeInteger");

    public static QName QNAME_TYPE_NON_NEGATIVE_INTEGER = new QName(NS_XSD, "nonNegativeInteger");

    public static QName QNAME_TYPE_NON_POSITIVE_INTEGER = new QName(NS_XSD, "nonPositiveInteger");

    public static QName QNAME_TYPE_INT = new QName(NS_XSD, "int");

    public static QName QNAME_TYPE_UNSIGNED_INT = new QName(NS_XSD, "unsignedInt");

    public static QName QNAME_TYPE_LONG = new QName(NS_XSD, "long");

    public static QName QNAME_TYPE_UNSIGNED_LONG = new QName(NS_XSD, "unsignedLong");

    public static QName QNAME_TYPE_SHORT = new QName(NS_XSD, "short");

    public static QName QNAME_TYPE_UNSIGNED_SHORT = new QName(NS_XSD, "unsignedShort");
    ...
    public static QName QNAME_TYPE_G_YEAR_MONTH = new QName(NS_XSD, "gYearMonth");
    ...
    public static QName QNAME_TYPE_SIMPLE_URTYPE = new QName(NS_XSD, "anySimpleType");
}
