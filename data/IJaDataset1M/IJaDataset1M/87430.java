...
import net.sf.istcontract.wsimport.api.pipe.helper.AbstractFilterTubeImpl;
import net.sf.istcontract.wsimport.api.pipe.helper.AbstractTubeImpl;
import net.sf.istcontract.wsimport.api.server.Adapter;
...
public interface Tube {
     ...
     */
    @NotNull
    NextAction processResponse(@NotNull Packet response);
     ...
     */
    @NotNull
    NextAction processException(@NotNull Throwable t);
