...
public class RubyWorkbenchAdapter implements IWorkbenchAdapter {
    ...
    public ImageDescriptor getImageDescriptor(Object element) {
        IRubyElement je = getRubyElement(element);
        if (je != null) return fImageProvider.getRubyImageDescriptor(je, RubyElementImageProvider.OVERLAY_ICONS | RubyElementImageProvider.SMALL_ICONS);
        return null;
    }
    ...
    private IRubyElement getRubyElement(Object element) {
        ...
        if (element instanceof IRubyScriptEditorInput) return ((IRubyScriptEditorInput) element).getRubyScript().getPrimaryElement();
        return null;
    }
}
