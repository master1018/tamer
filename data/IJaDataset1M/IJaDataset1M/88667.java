...
public class TestReportEngineAboutBox extends javax.swing.JDialog {

    public TestReportEngineAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(testreportengine.TestReportEngineApp.class).getContext().getResourceMap(TestReportEngineAboutBox.class);
        setTitle(resourceMap.getString("title"));
        setModal(true);
        setName("aboutBox");
        setResizable(false);
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(testreportengine.TestReportEngineApp.class).getContext().getActionMap(TestReportEngineAboutBox.class, this);
