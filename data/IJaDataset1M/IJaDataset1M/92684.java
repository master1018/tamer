...
public class ClasspathUtil {
    ...
    public static boolean isJavaOrSunClass(String cls) {
        String[] pkgs = new String[] { "java.", "javax.", "sun.", "sunw.", "netscape.", "apple.", "com.apple.", "com.sun." };
        for (String pkg : pkgs) {
