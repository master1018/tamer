...
public class PresenceModelImpl extends BaseModelImpl {
    ...
    public static final Object[][] TABLE_COLUMNS = { { "presenceId", new Integer(Types.BIGINT) }, { "userId", new Integer(Types.BIGINT) }, { "modifiedDate", new Integer(Types.BIGINT) }, { "networkId", new Integer(Types.BIGINT) }, { "online_", new Integer(Types.BOOLEAN) } };
    ...
    public static final boolean CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get("value.object.finder.cache.enabled.com.liferay.ruon.model.Presence"), true);
    ...
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get("lock.expiration.time.com.liferay.ruon.model.Presence"));
    ...
    public Presence toEscapedModel() {
        if (isEscapedModel()) {
            ...
            model = (Presence) Proxy.newProxyInstance(Presence.class.getClassLoader(), new Class[] { Presence.class }, new ReadOnlyBeanHandler(model));
            return model;
        }
    }
    ...
    public ExpandoBridge getExpandoBridge() {
        if (_expandoBridge == null) {
            _expandoBridge = new ExpandoBridgeImpl(Presence.class.getName(), getPrimaryKey());
        }
