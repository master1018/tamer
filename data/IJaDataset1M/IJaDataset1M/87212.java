...
public class DistributionLibrary {
    ...
    public boolean showEulaOrNewVersion() {
        return EulaOrNewVersion.showEula(mActivity) || EulaOrNewVersion.showNewVersion(mActivity);
    }
    ...
    public void onCreateOptionsMenu(Menu menu) {
        ...
        if (UpdateDialog.isUpdateMenuNecessary(mActivity)) {
            menu.add(0, mFirstMenuId + OFFSET_UPDATE, 0, R.string.oi_distribution_menu_update).setIcon(android.R.drawable.ic_menu_info_details).setShortcut('9', 'u');
        }
        menu.add(0, mFirstMenuId + OFFSET_ABOUT, 0, R.string.oi_distribution_about).setIcon(android.R.drawable.ic_menu_info_details).setShortcut('0', 'a');
    }
