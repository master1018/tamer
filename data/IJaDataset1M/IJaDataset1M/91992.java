...
public class TestHTMLReporter extends TestListenerAdapter {
    ...
    public void onFinish(ITestContext context) {
        generateLog(m_testContext, null, m_testContext.getOutputDirectory(), getConfigurationFailures(), getConfigurationSkips(), getPassedTests(), getFailedTests(), getSkippedTests(), getFailedButWithinSuccessPercentageTests());
    }
        ...
        for (ITestResult tr : tests) {
            ...
            }
            {
                ...
                if (null != output && output.size() > 0) {
                    ...
                    sb.append("\n<a href=\"#").append(divId).append("\"").append(" onClick='toggleBox(\"").append(divId).append("\", this, \"Show output\", \"Hide output\");'>").append("Show output</a>\n").append("\n<a href=\"#").append(divId).append("\"").append(" onClick=\"toggleAllBoxes();\">Show all outputs</a>\n");
