...
public class AndroidJavaBlitter implements Blitter {
    ...
    public void blit(int srcX, int srcY, Surface srcSurf, int dstX, int dstY, Surface dstSurf, int width, int height, AffineTransform sysxform, AffineTransform xform, Composite comp, Color bgcolor, MultiRectArea clip) {
        if (xform == null) {
            blit(srcX, srcY, srcSurf, dstX, dstY, dstSurf, width, height, sysxform, comp, bgcolor, clip);
        } else {
            ...
            blit(srcX, srcY, srcSurf, 0, 0, dstSurf, width, height, sysxform, comp, bgcolor, clip);
        }
    }
    ...
    public void blit(int srcX, int srcY, Surface srcSurf, int dstX, int dstY, Surface dstSurf, int width, int height, AffineTransform sysxform, Composite comp, Color bgcolor, MultiRectArea clip) {
        ...
        switch(type) {
            ...
            case AffineTransform.TYPE_IDENTITY:
                simpleBlit(srcX, srcY, srcSurf, dstX, dstY, dstSurf, width, height, comp, bgcolor, clip);
                break;
            default:
                ...
                transformedBlit(srcCM, srcR, 0, 0, dstCM, dstR, dstX, dstY, w, h, sysxform, comp, bgcolor, clip);
        }
    }

    public void simpleBlit(int srcX, int srcY, Surface srcSurf, int dstX, int dstY, Surface dstSurf, int width, int height, Composite comp, Color bgcolor, MultiRectArea clip) {
    ...
    private Rectangle2D getBounds2D(AffineTransform at, Rectangle r) {
        ...
        int width = r.width;
        int height = r.height;
        float[] corners = { x, y, x + width, y, x + width, y + height, x, y + height };
