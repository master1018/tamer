...
public class ImageSearch extends Search {
   ...
   */
    public void setColorization(ColorizationValue value) {
        IMPL.setRestriction(this, ImageSearchRestrict.COLORIZATION.getValue(), value.getValue());
    }
   ...
   */
    public void setFileType(FileTypeValue value) {
        IMPL.setRestriction(this, ImageSearchRestrict.FILETYPE.getValue(), value.getValue());
    }
   ...
   */
    public void setImageSize(ImageSizeValue value) {
        IMPL.setRestriction(this, ImageSearchRestrict.IMAGESIZE.getValue(), value.getValue());
    }
   ...
   */
    public void setImageType(ImageTypeValue value) {
        IMPL.setRestriction(this, ImageSearchRestrict.IMAGETYPE.getValue(), value.getValue());
    }
   ...
   */
    public void setSafeSearch(SafeSearchValue value) {
        IMPL.setRestriction(this, ImageSearchRestrict.SAFESEARCH.getValue(), value.getValue());
    }
