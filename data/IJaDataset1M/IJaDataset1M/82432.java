...
public class NavigableImagePanel extends JPanel {
    ...
    public NavigableImagePanel() {
        ...
        addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseMoved(MouseEvent e) {
                ...
                if (isInImage(mousePosition)) setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR)); else setCursor(null);
            }
        });
    ...
    public void setZoom(double newZoom, Point zoomingCenter) {
        ...
        if (isFullImageInPanel() && newZoom <= oldZoom) return;
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (isHighQualityRendering()) {
            ...
            g2.drawImage(image, x0, y0, x0 + width - 1, y0 + height - 1, rect.x, rect.y, rect.x + rect.width - 1, rect.y + rect.height - 1, null);
        } else {
            g2.drawImage(image, originX, originY, getScreenImageWidth(), getScreenImageHeight(), null);
        }
        if (isNavigationImageEnabled()) {
