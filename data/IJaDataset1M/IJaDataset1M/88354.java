...
public class ProductsRecordAboutBox extends javax.swing.JDialog {

    public ProductsRecordAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(productsrecord.ProductsRecordApp.class).getContext().getResourceMap(ProductsRecordAboutBox.class);
        setTitle(resourceMap.getString("title"));
        setModal(true);
        setName("aboutBox");
        setResizable(false);
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(productsrecord.ProductsRecordApp.class).getContext().getActionMap(ProductsRecordAboutBox.class, this);
