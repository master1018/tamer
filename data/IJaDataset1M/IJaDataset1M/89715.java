 ...
 */
    private static void findProperty() {
        ...
        if (v != null) {
            ...
            for (int i = 0; i < v.size(); i++) server[i] = (String) v.elementAt(i);
        }
        v = null;
        for (int i = 1; i <= 5; i++) {
        ...
        if (v != null) {
            ...
            for (int i = 0; i < v.size(); i++) search[i] = new Name((String) v.elementAt(i));
        }
    }
 ...
 */
    private static void findUnix() {
        ...
        if (search == null && vsearch != null) {
            ...
            for (int i = 0; i < vsearch.size(); i++) search[i] = new Name((String) vsearch.elementAt(i));
        }
    }
    ...
    private static void probe() {
        ...
        probed = true;
        findProperty();
        if (server != null && search != null) return;
        findUnix();
        return;
    }
    ...
    public static String server() {
        ...
        if (array == null) return null; else return array[0];
    }
