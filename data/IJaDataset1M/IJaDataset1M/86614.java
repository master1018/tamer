...
public class GraphicsUtilities {
    ...
    public static RenderingHints getBasicRenderingHints() {
        if (hintsBasic == null) {
            hintsBasic = new RenderingHints(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_OFF);
            hintsBasic.add(new RenderingHints(RenderingHints.KEY_RENDERING, RenderingHints.VALUE_RENDER_QUALITY));
        }
        return hintsBasic;
    }
    ...
    public static RenderingHints getGoodRenderingHints() {
        if (hintsGood == null) {
            hintsGood = new RenderingHints(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            hintsGood.add(new RenderingHints(RenderingHints.KEY_RENDERING, RenderingHints.VALUE_RENDER_QUALITY));
        }
        return hintsGood;
    }
    ...
    public static RenderingHints getGreatRenderingHints() {
        if (hintsGreat == null) {
            hintsGreat = new RenderingHints(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            hintsGreat.add(new RenderingHints(RenderingHints.KEY_RENDERING, RenderingHints.VALUE_RENDER_QUALITY));
            hintsGreat.add(new RenderingHints(RenderingHints.KEY_INTERPOLATION, RenderingHints.VALUE_INTERPOLATION_BILINEAR));
        }
        return hintsGreat;
    }
