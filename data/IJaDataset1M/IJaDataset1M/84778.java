...
/**
 * A CrashOfSecondRemoteResourceBeforeItAnswersPrepareSOAPIIOPTestCase.
 * 
 * @author <a href="reverbel@ime.usp.br">Francisco Reverbel</a>
 * @author <a href="mailto:ivanneto@gmail.com">Ivan Neto</a>
 * @version $Revision: 37406 $
 */
public class CrashOfSecondRemoteResourceBeforeItAnswersPrepareSOAPIIOPTestCase extends JBossCrashRecoveryTestCase {

    private Logger log = Logger.getLogger(this.getClass());

    public CrashOfSecondRemoteResourceBeforeItAnswersPrepareSOAPIIOPTestCase(String name) throws Exception {
        super(name);
    }
    ...
    public void test() throws Exception {
        ...
        for (int i = 0; i < N; i++) xaResEnlisterCaller.callXAResourceEnlistersOverSOAPAndIIOP();
        ...
        try {
            secondResource.setAttribute(logger, new Attribute("CrashOnFailure", Boolean.TRUE));
            secondResource.setAttribute(logger, new Attribute("FailAfterPreparing", Boolean.TRUE));
            secondResource.setAttribute(logger, new Attribute("FailAfter", new Integer(0)));
            xaResEnlisterCaller.callXAResourceEnlistersOverSOAPAndIIOP();
    ...
    public static Test suite() throws Exception {
        return suite(CrashOfSecondRemoteResourceBeforeItAnswersPrepareSOAPIIOPTestCase.class);
    }
}
