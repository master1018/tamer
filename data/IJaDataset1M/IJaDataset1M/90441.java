...
public class MassEmailMessage extends com.sforce.soap.partner.Email implements java.io.Serializable {
    ...
    public MassEmailMessage(java.lang.Boolean bccSender, com.sforce.soap.partner.EmailPriority emailPriority, java.lang.String replyTo, java.lang.Boolean saveAsActivity, java.lang.String senderDisplayName, java.lang.String subject, java.lang.Boolean useSignature, java.lang.String description, java.lang.String[] targetObjectIds, java.lang.String templateId, java.lang.String[] whatIds) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = super.equals(obj) && ((this.description == null && other.getDescription() == null) || (this.description != null && this.description.equals(other.getDescription()))) && ((this.targetObjectIds == null && other.getTargetObjectIds() == null) || (this.targetObjectIds != null && java.util.Arrays.equals(this.targetObjectIds, other.getTargetObjectIds()))) && ((this.templateId == null && other.getTemplateId() == null) || (this.templateId != null && this.templateId.equals(other.getTemplateId()))) && ((this.whatIds == null && other.getWhatIds() == null) || (this.whatIds != null && java.util.Arrays.equals(this.whatIds, other.getWhatIds())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getTargetObjectIds() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getTargetObjectIds()); i++) {
        ...
        if (getWhatIds() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getWhatIds()); i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(MassEmailMessage.class, true);
