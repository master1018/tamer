        ...
        for (int i = 0; i < maxLength(); i++) {
            ...
            for (int j = 0; j < size(); j++) {
                if (sequences[j].sequence.length() > i) {
                    if (!(sequences[j].sequence.substring(i, i + 1).equals("-")) && !(sequences[j].sequence.substring(i, i + 1).equals(".")) && !(sequences[j].sequence.substring(i, i + 1).equals(" "))) {
                        flag = false;
                    }
                }
            }
