...
public final class LibraryManager {
    ...
    void initialize() {
        ...
        for (int i = loadedLibraries.length - 1; i >= 0; i--) libraries.add(loadedLibraries[i]);
    }
    ...
    public void addLibrary(String libraryClassname) throws ClassNotFoundException, InvalidLibraryException {
        ...
        if (library.getSuperclass().equals(alice.tuprolog.Library.class)) libraries.add(libraryClassname); else throw new InvalidLibraryException(libraryClassname, -1, -1);
    }
