...
public class ApplicationLauncher {
    ...
    public ApplicationLauncher(String startupContextPath, String[] rootContextConfigLocations) {
        ...
        Assert.notEmpty(rootContextConfigLocations, "One or more root rich client application context paths must be provided");
    ...
    private ApplicationContext loadRootApplicationContext(String[] configLocations, MessageSource messageSource) {
        ...
        if (splashScreen instanceof MonitoringSplashScreen) {
            ...
            applicationContext.addBeanFactoryPostProcessor(new ProgressMonitoringBeanFactoryPostProcessor(tracker, messageSource));
        }
    ...
    private void launchMyRichClient() {
        ...
        try {
            ...
            throw new IllegalArgumentException("A single bean definition with id " + APPLICATION_BEAN_ID + ", of type " + Application.class.getName() + " must be defined in the main application context", e);
        }
        try {
