 ...
 * All rights reserved.
 */
public class ViterbiClassifier<OUTCOME_TYPE> implements SequenceClassifier<OUTCOME_TYPE>, Initializable, TypeArgumentDelegator {
    ...
    public List<OUTCOME_TYPE> classify(List<List<Feature>> features) throws CleartkProcessingException {
        if (stackSize == 1) {
            ...
            try {
                ...
                throw CleartkProcessingException.unsupportedOperationSetParameter(delegatedClassifier, "score", PARAM_STACK_SIZE, 1);
            }
        }
    }
