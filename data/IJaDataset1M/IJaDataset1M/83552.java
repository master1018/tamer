...
public class FilterSyncedEvents extends EventFilter2D implements Observer {
     ...
     * *********************
     */
    private int DEFAULT_TIMESTAMP = 0;
    ...
    public EventPacket filterPacket(EventPacket in) {
        ...
        for (Object e : in) {
            ...
            if (pE.polarity == PolarityEvent.Polarity.Off) {
                ...
                if (lastOnTimestamp >= lastTriggerTimestamp + t0 & lastOnTimestamp < lastTriggerTimestamp + t0 + t1 & lastOffTimestamp > lastTriggerTimestamp + laserPeriod / 2) {
                    BasicEvent o = (BasicEvent) outItr.nextOutput();
                    o.copyFrom(pE);
                }
            }
