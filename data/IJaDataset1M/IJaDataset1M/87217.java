...
public class PolarClockWallpaper extends WallpaperService {
    ...
    abstract static class ClockPalette {
    ...
    static class FixedClockPalette extends ClockPalette {
        ...
        public static FixedClockPalette getFallback() {
            if (sFallbackPalette == null) {
                ...
                sFallbackPalette.mSecondColor = sFallbackPalette.mMinuteColor = sFallbackPalette.mHourColor = sFallbackPalette.mDayColor = sFallbackPalette.mMonthColor = Color.BLACK;
            }
        ...
        public static ClockPalette parseXmlPaletteTag(XmlResourceParser xrp) {
            ...
            String val;
            if ((val = xrp.getAttributeValue(null, "background")) != null) pal.mBackgroundColor = Color.parseColor(val);
            if ((val = xrp.getAttributeValue(null, "second")) != null) pal.mSecondColor = Color.parseColor(val);
            if ((val = xrp.getAttributeValue(null, "minute")) != null) pal.mMinuteColor = Color.parseColor(val);
            if ((val = xrp.getAttributeValue(null, "hour")) != null) pal.mHourColor = Color.parseColor(val);
            if ((val = xrp.getAttributeValue(null, "day")) != null) pal.mDayColor = Color.parseColor(val);
            if ((val = xrp.getAttributeValue(null, "month")) != null) pal.mMonthColor = Color.parseColor(val);
    ...
    static class CyclingClockPalette extends ClockPalette {
        ...
        public static ClockPalette parseXmlPaletteTag(XmlResourceParser xrp) {
            ...
            String val;
            if ((val = xrp.getAttributeValue(null, "background")) != null) pal.mBackgroundColor = Color.parseColor(val);
            if ((val = xrp.getAttributeValue(null, "saturation")) != null) pal.mSaturation = Float.parseFloat(val);
            if ((val = xrp.getAttributeValue(null, "brightness")) != null) pal.mBrightness = Float.parseFloat(val);
            if (pal.mId == null) {
                return null;
            } else {
        ...
        void drawFrame() {
            ...
            try {
                ...
                if (c != null) {
                    ...
                    rect.set(-size, -size, size, size);
                    angle = (calendar.monthDay - 1) / (float) (calendar.getActualMaximum(Time.MONTH_DAY) - 1);
