...
class DataPipe implements Pipe {
	 ...
	 */
    public DataPipe(final MethodSynthesizer synthesizer, final DataReader dtoRead, final DataWriter dtoWrite, final DataReader dtoParentKeyRead, final DataReader entityRead, final DataWriter entityWrite, final FieldPipeMetadata meta) throws AnnotationMissingBindingException, AnnotationValidatingBindingException {
        this.meta = meta;
        ...
        if (meta.isReadOnly()) {
            ...
            if (!usesConverter()) {
                PipeValidator.validateReadPipeTypes(this.dtoWrite, this.meta.getDtoFieldName(), this.entityRead, this.meta.getEntityFieldName());
            }
        } else {
            ...
            if (!usesConverter()) {
                PipeValidator.validatePipeTypes(this.dtoRead, this.dtoWrite, this.meta.getDtoFieldName(), this.entityRead, this.entityWrite, this.meta.getEntityFieldName());
            }
        }
    ...
    private Object getDtoValue(final Object dtoData, final Object entity, final Map<String, Object> converters, final BeanFactory entityBeanFactory) throws NotValueConverterException, ValueConverterNotFoundException {
        if (usesConverter()) {
    ...
    private Object getOrCreateParentEntityForDtoValue(final Object entity) throws BeanFactoryNotFoundException, BeanFactoryUnableToCreateInstanceException {
        if (entity instanceof NewDataProxy) {
    ...
    private void writeParentObject(final Object dtoData, final Object entity, final Map<String, Object> converters, final BeanFactory entityBeanFactory) throws BeanFactoryNotFoundException, BeanFactoryUnableToCreateInstanceException, NotEntityRetrieverException, EntityRetrieverNotFoundException {
        if (dtoData == null) {
            if (entity != null) {
                this.entityWrite.write(entity, NULL);
            }
            ...
            final Class beanClass = this.meta.newEntityBean(entityBeanFactory).getClass();
    ...
    private ValueConverter getConverter(final Map<String, Object> converters) throws NotValueConverterException, ValueConverterNotFoundException {
    ...
    private EntityRetriever getRetriever(final Map<String, Object> converters) throws NotEntityRetrieverException, EntityRetrieverNotFoundException {
