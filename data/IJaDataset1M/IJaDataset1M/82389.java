...
public class CompletionDialog extends JDialog implements KeyListener {
    ...
    void displayProfileIfShouldBeDisplayed() {
        try {
            ...
            for (i = line.length() - 1; i >= 0; i--) {
                if (line.charAt(i) == '(' && i < line.length() - 1 && i > 0 && line.charAt(i - 1) != ':' && line.charAt(i + 1) != ')') break;
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (code != KeyEvent.VK_UP && code != KeyEvent.VK_DOWN && code != KeyEvent.VK_KP_UP && code != KeyEvent.VK_KP_DOWN && code != KeyEvent.VK_PAGE_UP && code != KeyEvent.VK_PAGE_DOWN && code != KeyEvent.VK_LEFT && code != KeyEvent.VK_RIGHT && code != KeyEvent.VK_HOME && code != KeyEvent.VK_END) {
            e.consume();
        }
        if (code == KeyEvent.VK_ENTER) {
            ...
            Dispatch.dispatch(receipt, ndata);
        } else if (code == KeyEvent.VK_SPACE && (e.getModifiers() & InputEvent.CTRL_MASK) != 0) {
            closeDialog();
    ...
    public static void completion(org.gjt.sp.jedit.View view) {
        if (s.activeProject != null) {
            ...
            if (jEdit.getBooleanProperty(s.optCompletionOldDialog)) options.add("-jeditc1");
