...
public class GraphEventMulticaster extends EventMulticaster implements GraphEventListener {
    ...
    /**
     * @see edu.berkeley.guir.prefuse.graph.event.GraphEventListener#nodeAdded(edu.berkeley.guir.prefuse.graph.Graph,
     *      edu.berkeley.guir.prefuse.graph.Node)
     */
    ...
    /**
     * @see edu.berkeley.guir.prefuse.graph.event.GraphEventListener#nodeRemoved(edu.berkeley.guir.prefuse.graph.Graph,
     *      edu.berkeley.guir.prefuse.graph.Node)
     */
    ...
    /**
     * @see edu.berkeley.guir.prefuse.graph.event.GraphEventListener#nodeReplaced(edu.berkeley.guir.prefuse.graph.Graph,
     *      edu.berkeley.guir.prefuse.graph.Node,
     *      edu.berkeley.guir.prefuse.graph.Node)
     */
    ...
    /**
     * @see edu.berkeley.guir.prefuse.graph.event.GraphEventListener#edgeAdded(edu.berkeley.guir.prefuse.graph.Graph,
     *      edu.berkeley.guir.prefuse.graph.Edge)
     */
    ...
    /**
     * @see edu.berkeley.guir.prefuse.graph.event.GraphEventListener#edgeRemoved(edu.berkeley.guir.prefuse.graph.Graph,
     *      edu.berkeley.guir.prefuse.graph.Edge)
     */
    ...
    /**
     * @see edu.berkeley.guir.prefuse.graph.event.GraphEventListener#edgeReplaced(edu.berkeley.guir.prefuse.graph.Graph,
     *      edu.berkeley.guir.prefuse.graph.Edge,
     *      edu.berkeley.guir.prefuse.graph.Edge)
     */
     ...
     * and listener-b together. If listener-a is null, it returns
     * listener-b; If listener-b is null, it returns listener-a If
     * neither are null, then it creates and returns a new
     * AWTEventMulticaster instance which chains a with b.
     * 
     * @param a
     *            event listener-a
     * @param b
