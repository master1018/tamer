...
public class CFGFieldOutNode extends CFGDataNode<FieldUsageInfo> {
    ...
    public static CFGFieldOutNode getInstance(final FieldInfo field, final CallableUnitInfo unit) {
        ...
        final ExpressionInfo qualifierExpression = new ClassReferenceInfo(qualifierType, unit, fromLine, fromColumn, toLine, toColumn);
        final FieldUsageInfo fieldUsage = FieldUsageInfo.getInstance(qualifierExpression, qualifierType, field, false, true, unit, fromLine, fromColumn, toLine, toColumn);
    ...
    @Override
    FieldUsageInfo makeNewElement(final LocalSpaceInfo ownerSpace, final int fromLine, final int fromColumn, final int toLine, final int toColumn, final ExpressionInfo... requiredExpressions) {
        return null;
    }

    @Override
    FieldUsageInfo makeNewElement(final LocalSpaceInfo ownerSpace, final ExpressionInfo... requiredExpressions) {
        return null;
    }
}
