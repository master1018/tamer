...
public abstract class RemoteServiceProxy implements SerializationStreamFactory, ServiceDefTarget, HasRpcToken {
   ...
   */
     ...
     */
        public RequestBuilder finishForRequestBuilder(AsyncCallback callback, ResponseReader responseHeader) throws SerializationException {
            String payload = streamWriter.toString();
            boolean toss = statsContext.isStatsAvailable() && statsContext.stats(statsContext.timeStat(fullServiceName, "requestSerialized"));
     ...
     */
        public SerializationStreamWriter start(String remoteServiceInterfaceName, int paramCount) throws SerializationException {
   ...
   */
    public SerializationStreamWriter createStreamWriter() {
        ClientSerializationStreamWriter clientSerializationStreamWriter = new ClientSerializationStreamWriter(serializer, moduleBaseURL, serializationPolicyName);
