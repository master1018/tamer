...
public class DSSKeyPairGenerator implements IKeyPairGenerator {
   ...
   */
    public void setup(Map attributes) {
        ...
        if ((L % 64) != 0 || L < 512 || L > 1024) throw new IllegalArgumentException(MODULUS_LENGTH);
        Boolean useDefaults = (Boolean) attributes.get(USE_DEFAULTS);
        if (useDefaults == null) useDefaults = Boolean.TRUE;
        Boolean strictDefaults = (Boolean) attributes.get(STRICT_DEFAULTS);
        if (strictDefaults == null) strictDefaults = Boolean.FALSE;
        ...
        if (params != null) {
            ...
            switch(L) {
                ...
                case 1024:
                    ...
                    break;
                default:
                    if (strictDefaults.equals(Boolean.TRUE)) throw new IllegalArgumentException("Does not provide default parameters for " + L + "-bit modulus length"); else {
                        p = null;
                        q = null;
                        g = null;
                    }
