public class Constants {
    public static final String AXIS2_NAMESPACE_URI = "http:
    ...
    public static final String URI_SOAP11_ENV = "http:
    public static final String URI_SOAP12_ENV = "http:
    public static final String URI_LITERAL_ENC = "";
    public static final String URI_SOAP11_ENC = "http:
    public static final String URI_SOAP12_ENC = "http:
    public static final String URI_SOAP12_NOENC = "http:
    public static final String URI_SOAP11_NEXT_ACTOR = "http:
    public static final String URI_SOAP12_NEXT_ROLE = "http:
    public static final String URI_SOAP12_NEXT_ACTOR = URI_SOAP12_NEXT_ROLE;
    public static final String URI_SOAP12_RPC = "http:
    public static final String URI_SOAP12_NONE_ROLE = "http:
    public static final String URI_SOAP12_ULTIMATE_ROLE = "http:
    public static final String URI_SOAP11_HTTP = "http:
    public static final String URI_SOAP12_HTTP = "http:
    public static final String NS_URI_XMLNS = "http:
    public static final String NS_URI_XML = "http:
    public static final String URI_1999_SCHEMA_XSD = "http:
    public static final String URI_2000_SCHEMA_XSD = "http:
    public static final String URI_2001_SCHEMA_XSD = "http:
    public static final String URI_DEFAULT_SCHEMA_XSD = URI_2001_SCHEMA_XSD;
    public static final String URI_1999_SCHEMA_XSI = "http:
    public static final String URI_2000_SCHEMA_XSI = "http:
    public static final String URI_2001_SCHEMA_XSI = "http:
    public static final String URI_DEFAULT_SCHEMA_XSI = URI_2001_SCHEMA_XSI;
    public static final String URI_POLICY = "http:
    public static final String FORMAT_BINDING = "http:
    public static final String JAVA_NS = "http:
    public static final String NS_URI_WSDL11 = "http:
    public static final String NS_URI_WSDL20 = "http:
    public static final String URI_DIME_WSDL = "http:
    public static final String URI_DIME_CONTENT = "http:
    public static final String URI_DIME_REFERENCE = "http:
    public static final String URI_DIME_CLOSED_LAYOUT = "http:
    public static final String URI_DIME_OPEN_LAYOUT = "http:
    public static final String URI_XOP_INCLUDE = "http:
    public static final String ELEM_XOP_INCLUDE = "Include";
    public static final String URI_WSDL11_SOAP = "http:
    public static final String URI_WSDL12_SOAP = "http:
    ...
    public static final QName AXIS2_NONE = new QName("http:
    ...
    public static final QName XMIME_CONTENT_TYPE_QNAME = new QName("http:
    public static final String URI_SECURITYPOLICY = "http:
}
