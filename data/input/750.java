public class ContactsHome {
    ...
    public Contacts merge(Contacts detachedInstance) {
        ...
        try {
            Contacts result = (Contacts) sessionFactory.getCurrentSession().merge(detachedInstance);
    ...
    public Contacts findById(int id) {
        ...
        try {
            Contacts instance = (Contacts) sessionFactory.getCurrentSession().get("hbn.tools.Contacts", id);
            if (instance == null) {
    ...
    public List<Contacts> findByExample(Contacts instance) {
        ...
        try {
            List<Contacts> results = (List<Contacts>) sessionFactory.getCurrentSession().createCriteria("hbn.tools.Contacts").add(create(instance)).list();
