public class Resources_fr extends java.util.ListResourceBundle {
    private static final Object[][] contents = {
        ...
        {"Changes.an.entry.s.alias",
                "Modifie l'alias d'une entr\u00E9e"}, 
        {"Deletes.an.entry",
                "Supprime une entr\u00E9e"}, 
        {"Exports.certificate",
                "Exporte le certificat"}, 
        {"Generates.a.key.pair",
                "G\u00E9n\u00E8re une paire de cl\u00E9s"}, 
        {"Generates.a.secret.key",
                "G\u00E9n\u00E8re une cl\u00E9 secr\u00E8te"}, 
        {"Generates.certificate.from.a.certificate.request",
                "G\u00E9n\u00E8re le certificat \u00E0 partir d'une demande de certificat"}, 
        ...
        {"Clones.a.key.entry",
                "Clone une entr\u00E9e de cl\u00E9"}, 
        {"Changes.the.key.password.of.an.entry",
                "Modifie le mot de passe de cl\u00E9 d'une entr\u00E9e"}, 
        {"Lists.entries.in.a.keystore",
                "R\u00E9pertorie les entr\u00E9es d'un fichier de cl\u00E9s"}, 
        {"Prints.the.content.of.a.certificate",
                "Imprime le contenu d'un certificat"}, 
        {"Prints.the.content.of.a.certificate.request",
                "Imprime le contenu d'une demande de certificat"}, 
        {"Prints.the.content.of.a.CRL.file",
                "Imprime le contenu d'un fichier de liste des certificats r\u00E9voqu\u00E9s (CRL)"}, 
        {"Generates.a.self.signed.certificate",
                "G\u00E9n\u00E8re un certificat auto-sign\u00E9"}, 
        {"Changes.the.store.password.of.a.keystore",
                "Modifie le mot de passe de banque d'un fichier de cl\u00E9s"}, 
        {"alias.name.of.the.entry.to.process",
                "nom d'alias de l'entr\u00E9e \u00E0 traiter"}, 
        {"destination.alias",
                "alias de destination"}, 
        {"destination.key.password",
                "mot de passe de la cl\u00E9 de destination"}, 
        {"destination.keystore.name",
                "nom du fichier de cl\u00E9s de destination"}, 
        {"destination.keystore.password.protected",
                "mot de passe du fichier de cl\u00E9s de destination prot\u00E9g\u00E9"}, 
        {"destination.keystore.provider.name",
                "nom du fournisseur du fichier de cl\u00E9s de destination"}, 
        {"destination.keystore.password",
                "mot de passe du fichier de cl\u00E9s de destination"}, 
        {"destination.keystore.type",
                "type du fichier de cl\u00E9s de destination"}, 
        {"distinguished.name",
                "nom distinctif"}, 
        {"X.509.extension",
                "extension X.509"}, 
        ...
        {"key.algorithm.name",
                "nom de l'algorithme de cl\u00E9"}, 
        {"key.password",
                "mot de passe de la cl\u00E9"}, 
        {"key.bit.size",
                "taille en bits de la cl\u00E9"}, 
        {"keystore.name",
        ...
        {"password.through.protected.mechanism",
                "mot de passe via m\u00E9canisme prot\u00E9g\u00E9"}, 
        {"provider.argument",
                "argument du fournisseur"}, 
        {"provider.class.name",
                "nom de la classe de fournisseur"}, 
        {"provider.name",
                "nom du fournisseur"}, 
        {"provider.classpath",
                "variable d'environnement CLASSPATH du fournisseur"}, 
        {"output.in.RFC.style",
                "sortie au style RFC"}, 
        ...
        {"source.alias",
                "alias source"}, 
        {"source.key.password",
                "mot de passe de la cl\u00E9 source"}, 
        {"source.keystore.name",
                "nom du fichier de cl\u00E9s source"}, 
        {"source.keystore.password.protected",
                "mot de passe du fichier de cl\u00E9s source prot\u00E9g\u00E9"}, 
        {"source.keystore.provider.name",
                "nom du fournisseur du fichier de cl\u00E9s source"}, 
        {"source.keystore.password",
                "mot de passe du fichier de cl\u00E9s source"}, 
        {"source.keystore.type",
                "type du fichier de cl\u00E9s source"}, 
        {"SSL.server.host.and.port",
                "Port et h\u00F4te du serveur SSL"}, 
        {"signed.jar.file",
                "fichier JAR sign\u00E9"}, 
        {"certificate.validity.start.date.time",
                "date/heure de d\u00E9but de validit\u00E9 du certificat"}, 
        {"keystore.password",
                "mot de passe du fichier de cl\u00E9s"}, 
        {"keystore.type",
                "type du fichier de cl\u00E9s"}, 
        {"trust.certificates.from.cacerts",
                "certificats s\u00E9curis\u00E9s issus de certificats CA"}, 
        {"verbose.output",
                "sortie en mode verbose"}, 
        {"validity.number.of.days",
                "nombre de jours de validit\u00E9"}, 
        {"Serial.ID.of.cert.to.revoke",
                 "ID de s\u00E9rie du certificat \u00E0 r\u00E9voquer"}, 
