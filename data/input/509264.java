public final class PixelDensityQualifier extends ResourceQualifier {
    private final static Pattern sDensityLegacyPattern = Pattern.compile("^(\\d+)dpi$");
    public static final String NAME = "Pixel Density";
    private Density mValue = Density.MEDIUM;
    public static enum Density {
        HIGH("hdpi", "High Density", IDensityBasedResourceValue.Density.HIGH), 
        MEDIUM("mdpi", "Medium Density", IDensityBasedResourceValue.Density.MEDIUM), 
        LOW("ldpi", "Low Density", IDensityBasedResourceValue.Density.LOW), 
        NODPI("nodpi", "No Density", IDensityBasedResourceValue.Density.NODPI); 
