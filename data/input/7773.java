public class Resources_pt_BR extends java.util.ListResourceBundle {
    private static final Object[][] contents = {
        ...
        {"Generates.a.certificate.request",
                "Gera uma solicita\u00E7\u00E3o de certificado"}, 
        {"Changes.an.entry.s.alias",
                "Altera um alias de entrada"}, 
        {"Deletes.an.entry",
                "Deleta uma entrada"}, 
        {"Exports.certificate",
        ...
        {"Generates.certificate.from.a.certificate.request",
                "Gera um certificado de uma solicita\u00E7\u00E3o de certificado"}, 
        {"Generates.CRL", "Gera CRL"}, 
        {"Imports.entries.from.a.JDK.1.1.x.style.identity.database",
                "Importa entradas de um banco de dados de identidade JDK 1.1.x-style"}, 
        {"Imports.a.certificate.or.a.certificate.chain",
                "Importa um certificado ou uma cadeia de certificados"}, 
        {"Imports.one.or.all.entries.from.another.keystore",
                "Importa uma ou todas as entradas de outra \u00E1rea de armazenamento de chaves"}, 
        {"Clones.a.key.entry",
                "Clona uma entrada de chave"}, 
        {"Changes.the.key.password.of.an.entry",
                "Altera a senha da chave de uma entrada"}, 
        {"Lists.entries.in.a.keystore",
                "Lista entradas em uma \u00E1rea de armazenamento de chaves"}, 
        {"Prints.the.content.of.a.certificate",
                "Imprime o conte\u00FAdo de um certificado"}, 
        {"Prints.the.content.of.a.certificate.request",
                "Imprime o conte\u00FAdo de uma solicita\u00E7\u00E3o de certificado"}, 
        {"Prints.the.content.of.a.CRL.file",
                "Imprime o conte\u00FAdo de um arquivo CRL"}, 
        {"Generates.a.self.signed.certificate",
                "Gera um certificado autoassinado"}, 
        {"Changes.the.store.password.of.a.keystore",
                "Altera a senha de armazenamento de uma \u00E1rea de armazenamento de chaves"}, 
        {"alias.name.of.the.entry.to.process",
                "nome do alias da entrada a ser processada"}, 
        {"destination.alias",
                "alias de destino"}, 
        {"destination.key.password",
                "senha da chave de destino"}, 
        {"destination.keystore.name",
                "nome da \u00E1rea de armazenamento de chaves de destino"}, 
        {"destination.keystore.password.protected",
                "senha protegida da \u00E1rea de armazenamento de chaves de destino"}, 
        {"destination.keystore.provider.name",
                "nome do fornecedor da \u00E1rea de armazenamento de chaves de destino"}, 
        {"destination.keystore.password",
                "senha da \u00E1rea de armazenamento de chaves de destino"}, 
        {"destination.keystore.type",
                "tipo de \u00E1rea de armazenamento de chaves de destino"}, 
        {"distinguished.name",
                "nome distinto"}, 
        {"X.509.extension",
                "extens\u00E3o X.509"}, 
        ...
        {"password.through.protected.mechanism",
                "senha por meio de mecanismo protegido"}, 
        {"provider.argument",
                "argumento do fornecedor"}, 
        {"provider.class.name",
                "nome da classe do fornecedor"}, 
        {"provider.name",
                "nome do fornecedor"}, 
        {"provider.classpath",
                "classpath do fornecedor"}, 
        {"output.in.RFC.style",
                "sa\u00EDda no estilo RFC"}, 
        ...
        {"source.keystore.name",
                "nome da \u00E1rea de armazenamento de chaves de origem"}, 
        {"source.keystore.password.protected",
                "senha protegida da \u00E1rea de armazenamento de chaves de origem"}, 
        {"source.keystore.provider.name",
                "nome do fornecedor da \u00E1rea de armazenamento de chaves de origem"}, 
        {"source.keystore.password",
                "senha da \u00E1rea de armazenamento de chaves de origem"}, 
        {"source.keystore.type",
                "tipo de \u00E1rea de armazenamento de chaves de origem"}, 
        {"SSL.server.host.and.port",
                "porta e host do servidor SSL"}, 
        {"signed.jar.file",
                "arquivo jar assinado"}, 
        {"certificate.validity.start.date.time",
                "data/hora inicial de validade do certificado"}, 
        {"keystore.password",
                "senha da \u00E1rea de armazenamento de chaves"}, 
        {"keystore.type",
                "tipo de \u00E1rea de armazenamento de chaves"}, 
        {"trust.certificates.from.cacerts",
                "certificados confi\u00E1veis do cacerts"}, 
        {"verbose.output",
                "sa\u00EDda detalhada"}, 
        {"validity.number.of.days",
                "n\u00FAmero de dias da validade"}, 
        {"Serial.ID.of.cert.to.revoke",
                 "ID de s\u00E9rie do certificado a ser revogado"}, 
