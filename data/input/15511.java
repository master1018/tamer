public class SPARCV9Disassembler extends SPARCDisassembler
    ...
    private static final InstructionDecoder format3Decoders[][] = {
        {
          new LoadDecoder(LDUW, "ld" , RTLDT_UNSIGNED_WORD), new V9AlternateSpaceLoadDecoder(LDUWA, "lduwa", RTLDT_UNSIGNED_WORD),
        ...
        {
          new StoreDecoder(STW, "st" , RTLDT_UNSIGNED_WORD), new V9AlternateSpaceStoreDecoder(STWA, "stwa", RTLDT_UNSIGNED_WORD),
