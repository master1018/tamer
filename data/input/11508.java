public class DriverResource extends ListResourceBundle {
        ...
        private static final Object[][] resource= {
                ...
                {BAD_OPTION,"Bad option: {0}={1}"},
                {BAD_REPACK_OUTPUT,"Bad --repack output: {0}"},
                {DETECTED_ZIP_COMMENT,"Detected ZIP comment: {0}"},
                {SKIP_FOR_REPACKED,"Skipping because already repacked: {0}"},
                {WRITE_PACK_FILE,"To write a *.pack file, specify --no-gzip: {0}"},
                {WIRTE_PACKGZ_FILE,"To write a *.pack.gz file, specify --gzip: {0}"},
                {SKIP_FOR_MOVE_FAILED,"Skipping unpack because move failed: {0}"},
                ...
                {MORE_INFO,"(For more information, run {0} --help .)"},
                {DUPLICATE_OPTION,"duplicate option: {0}"},
                {BAD_SPEC,"bad spec for {0}: {1}"},
        };
