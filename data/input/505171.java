class GrassRS extends RenderScriptScene {
    ...
    private static final int LOCATION_UPDATE_MIN_TIME = DEBUG ? 5 * 60 * 1000 : 60 * 60 * 1000; 
    private static final int LOCATION_UPDATE_MIN_DISTANCE = DEBUG ? 10 : 150 * 1000; 
    ...
    private void updateLocation(Location location) {
        ...
        mWorldState.morning = mWorldState.dawn + 1.0f / 12.0f; 
        mWorldState.afternoon = mWorldState.dusk - 1.0f / 12.0f; 
        mState.data(mWorldState);
    }
