public class KeyMapDream {
    ...
    private static final int[] mKeyMap = {
            ...
            KeyEvent.KEYCODE_4 | ('\uffe5' << SHIFT_FWCH), 
            KeyEvent.KEYCODE_5 | ('\uff05' << SHIFT_FWCH), 
            KeyEvent.KEYCODE_6 | ('\u2026' << SHIFT_FWCH), 
            ...
            KeyEvent.KEYCODE_C | ('\u00a9' << SHIFT_FWCH), 
            KeyEvent.KEYCODE_D | ('\u3001' << SHIFT_FWCH), 
            KeyEvent.KEYCODE_E | ('_' << SHIFT_FWCH), 
