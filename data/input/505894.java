class MountService extends IMountService.Stub
    ...
    public boolean onEvent(int code, String raw, String[] cooked) {
        ...
        if (code == VoldResponseCode.VolumeStateChange) {
            ...
            if (code == VoldResponseCode.VolumeDiskInserted) {
                ...
                in = new Intent(Intent.ACTION_MEDIA_UNMOUNTED, Uri.parse("file:
                mContext.sendBroadcast(in);
                if (DEBUG_EVENTS) Slog.i(TAG, "Sending media removed");
                updatePublicVolumeState(path, Environment.MEDIA_REMOVED);
                in = new Intent(Intent.ACTION_MEDIA_REMOVED, Uri.parse("file:
                ...
                in = new Intent(Intent.ACTION_MEDIA_BAD_REMOVAL, Uri.parse("file:
            } else {
    ...
    private void notifyVolumeStateChange(String label, String path, int oldState, int newState) {
        ...
        if (newState == VolumeState.Init) {
            ...
            in = new Intent(Intent.ACTION_MEDIA_CHECKING, Uri.parse("file:
        } else if (newState == VolumeState.Mounted) {
            if (DEBUG_EVENTS) Slog.i(TAG, "updating volume state mounted");
            updatePublicVolumeState(path, Environment.MEDIA_MOUNTED);
            in = new Intent(Intent.ACTION_MEDIA_MOUNTED, Uri.parse("file:
            in.putExtra("read-only", false);
        } else if (newState == VolumeState.Unmounting) {
            in = new Intent(Intent.ACTION_MEDIA_EJECT, Uri.parse("file:
            ...
            in = new Intent(Intent.ACTION_MEDIA_SHARED, Uri.parse("file:
    ...
    private int doMountVolume(String path) {
        ...
        try {
            ...
            if (code == VoldResponseCode.OpFailedNoMedia) {
                ...
                in = new Intent(Intent.ACTION_MEDIA_NOFS, Uri.parse("file:
                rc = StorageResultCode.OperationFailedMediaBlank;
            } else if (code == VoldResponseCode.OpFailedMediaCorrupt) {
                if (DEBUG_EVENTS) Slog.i(TAG, "updating volume state media corrupt");
                updatePublicVolumeState(path, Environment.MEDIA_UNMOUNTABLE);
                in = new Intent(Intent.ACTION_MEDIA_UNMOUNTABLE, Uri.parse("file:
