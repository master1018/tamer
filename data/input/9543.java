public class Resources_de extends java.util.ListResourceBundle {
    private static final Object[][] contents = {
        ...
        {"Imports.entries.from.a.JDK.1.1.x.style.identity.database",
                "Importiert Eintr\u00E4ge aus einer Identity-Datenbank im JDK 1.1.x-Stil"}, 
        ...
        {"Generates.a.self.signed.certificate",
                "Generiert ein selbst signiertes Zertifikat"}, 
        {"Changes.the.store.password.of.a.keystore",
                "\u00C4ndert das Speicherkennwort eines Keystores"}, 
        {"alias.name.of.the.entry.to.process",
                "Aliasname des zu verarbeitenden Eintrags"}, 
        {"destination.alias",
                "Zielalias"}, 
        {"destination.key.password",
                "Zielschl\u00FCssel-Kennwort"}, 
        {"destination.keystore.name",
                "Ziel-Keystore-Name"}, 
        {"destination.keystore.password.protected",
                "Ziel-Keystore kennwortgesch\u00FCtzt"}, 
        {"destination.keystore.provider.name",
                "Ziel-Keystore-Providername"}, 
        {"destination.keystore.password",
                "Ziel-Keystore-Kennwort"}, 
        ...
        {"password.through.protected.mechanism",
                "Kennwort \u00FCber gesch\u00FCtzten Mechanismus"}, 
        {"provider.argument",
                "Providerargument"}, 
        {"provider.class.name",
                "Providerklassenname"}, 
        ...
        {"signature.algorithm.name",
                "Signaturalgorithmusname"}, 
        {"source.alias",
                "Quellalias"}, 
        {"source.key.password",
                "Quellschl\u00FCssel-Kennwort"}, 
        {"source.keystore.name",
                "Quell-Keystore-Name"}, 
        {"source.keystore.password.protected",
                "Quell-Keystore kennwortgesch\u00FCtzt"}, 
        {"source.keystore.provider.name",
                "Quell-Keystore-Providername"}, 
        {"source.keystore.password",
                "Quell-Keystore-Kennwort"}, 
        {"source.keystore.type",
                "Quell-Keystore-Typ"}, 
        {"SSL.server.host.and.port",
                "SSL-Serverhost und -port"}, 
        {"signed.jar.file",
                "Signierte JAR-Datei"}, 
        {"certificate.validity.start.date.time",
                "Anfangsdatum/-zeit f\u00FCr Zertifikatsg\u00FCltigkeit"}, 
        {"keystore.password",
                "Keystore-Kennwort"}, 
        {"keystore.type",
                "Keystore-Typ"}, 
        {"trust.certificates.from.cacerts",
                "Zertifikaten aus cacerts vertrauen"}, 
        {"verbose.output",
                "Verbose-Ausgabe"}, 
