public class IntMath {
    ...
    static void longOperCheck(long[] results) {
        ...
        assert(results[3] == -6833923606740729856L);    
    ...
    static void truncateCheck(Shorty shorts) {
        assert(shorts.mShort == -5597);     
        assert(shorts.mChar == 59939);      
        assert(shorts.mByte == 35);         
    }
    ...
    static void checkConsts(byte small, short medium, int large, long huge) {
        ...
        assert(large == -88888);                
        assert(large == -88888L);               
        assert(huge == 0x9922334455667788L);    
    }
    ...
    public static void run() {
        ...
        Shorty shorts = truncateTest(-16717277);    
