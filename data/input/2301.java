public class Resources_es extends java.util.ListResourceBundle {
    private static final Object[][] contents = {
        ...
        {"Generates.a.secret.key",
                "Genera un clave secreta"}, 
        {"Generates.certificate.from.a.certificate.request",
                "Genera un certificado a partir de una solicitud de certificado"}, 
        {"Generates.CRL", "Genera CRL"}, 
        {"Imports.entries.from.a.JDK.1.1.x.style.identity.database",
                "Importa entradas desde una base de datos de identidades JDK 1.1.x-style"}, 
        {"Imports.a.certificate.or.a.certificate.chain",
                "Importa un certificado o una cadena de certificados"}, 
        {"Imports.one.or.all.entries.from.another.keystore",
                "Importa una o todas las entradas desde otro almac\u00E9n de claves"}, 
        {"Clones.a.key.entry",
                "Clona una entrada de clave"}, 
        {"Changes.the.key.password.of.an.entry",
                "Cambia la contrase\u00F1a de clave de una entrada"}, 
        {"Lists.entries.in.a.keystore",
                "Enumera las entradas de un almac\u00E9n de claves"}, 
        {"Prints.the.content.of.a.certificate",
                "Imprime el contenido de un certificado"}, 
        {"Prints.the.content.of.a.certificate.request",
                "Imprime el contenido de una solicitud de certificado"}, 
        {"Prints.the.content.of.a.CRL.file",
                "Imprime el contenido de un archivo CRL"}, 
        {"Generates.a.self.signed.certificate",
                "Genera un certificado autofirmado"}, 
        {"Changes.the.store.password.of.a.keystore",
                "Cambia la contrase\u00F1a de almac\u00E9n de un almac\u00E9n de claves"}, 
        {"alias.name.of.the.entry.to.process",
                "nombre de alias de la entrada que se va a procesar"}, 
        {"destination.alias",
                "alias de destino"}, 
        {"destination.key.password",
                "contrase\u00F1a de clave de destino"}, 
        {"destination.keystore.name",
                "nombre de almac\u00E9n de claves de destino"}, 
        {"destination.keystore.password.protected",
                "almac\u00E9n de claves de destino protegido por contrase\u00F1a"}, 
        {"destination.keystore.provider.name",
                "nombre de proveedor de almac\u00E9n de claves de destino"}, 
        {"destination.keystore.password",
                "contrase\u00F1a de almac\u00E9n de claves de destino"}, 
        {"destination.keystore.type",
                "tipo de almac\u00E9n de claves de destino"}, 
        {"distinguished.name",
                "nombre distintivo"}, 
        {"X.509.extension",
                "extensi\u00F3n X.509"}, 
        ...
        {"key.algorithm.name",
                "nombre de algoritmo de clave"}, 
        {"key.password",
                "contrase\u00F1a de clave"}, 
        {"key.bit.size",
                "tama\u00F1o de bit de clave"}, 
        {"keystore.name",
                "nombre de almac\u00E9n de claves"}, 
        {"new.password",
                "nueva contrase\u00F1a"}, 
        {"do.not.prompt",
                "no solicitar"}, 
        {"password.through.protected.mechanism",
                "contrase\u00F1a a trav\u00E9s de mecanismo protegido"}, 
        {"provider.argument",
        ...
        {"provider.classpath",
                "classpath de proveedor"}, 
        {"output.in.RFC.style",
                "salida en estilo RFC"}, 
        {"signature.algorithm.name",
                "nombre de algoritmo de firma"}, 
        {"source.alias",
                "alias de origen"}, 
        {"source.key.password",
                "contrase\u00F1a de clave de origen"}, 
        {"source.keystore.name",
                "nombre de almac\u00E9n de claves de origen"}, 
        {"source.keystore.password.protected",
                "almac\u00E9n de claves de origen protegido por contrase\u00F1a"}, 
        {"source.keystore.provider.name",
                "nombre de proveedor de almac\u00E9n de claves de origen"}, 
        {"source.keystore.password",
                "contrase\u00F1a de almac\u00E9n de claves de origen"}, 
        {"source.keystore.type",
                "tipo de almac\u00E9n de claves de origen"}, 
        {"SSL.server.host.and.port",
                "puerto y host del servidor SSL"}, 
        {"signed.jar.file",
                "archivo jar firmado"}, 
        {"certificate.validity.start.date.time",
                "fecha/hora de inicio de validez del certificado"}, 
        {"keystore.password",
                "contrase\u00F1a de almac\u00E9n de claves"}, 
        {"keystore.type",
                "tipo de almac\u00E9n de claves"}, 
        {"trust.certificates.from.cacerts",
                "certificados de protecci\u00F3n de cacerts"}, 
        {"verbose.output",
                "salida detallada"}, 
        {"validity.number.of.days",
                "n\u00FAmero de validez de d\u00EDas"}, 
        {"Serial.ID.of.cert.to.revoke",
                 "identificador de serie del certificado que se va a revocar"}, 
