    public static String SearchForGeocachesJSON(String accessToken, Search search, ArrayList<Cache> cacheList, ArrayList<LogEntry> logList, ArrayList<ImageEntry> imageList, long gpxFilenameId) {
        String result = "";
        byte apiStatus = 0;
        boolean isLite = true;
